...
subtitle: "Synergy?"
layout: research
ip_v4_address: "148.109.38.65"
date: 2022-04-24T18:59:55+01:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like <code>148.109.38.65</code> or an IPv6 address like <code>2000:e2c8:f434:d696:d5aa:37f:e829:3567</code>. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>87:e2:65:27:e4:37</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://gislason.co you initially access a DNS server to translate the host portion (gislason) combined with the Top Level Domain (co) of the URL, to an IP address like <code>254.223.134.49</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (Windows NT 6.1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/41.0.2228.0 Safari/537.36</code>
...
<pre><code>
default   fe80:306e:34e3:53ee:1914%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {122.4.227.232, 153.161.222.156}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 87:e2:65:27:e4:37
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 99:f6:b5:88:11:58
}</code></pre>
