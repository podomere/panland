...
layout: research
ip_v4_address: "143.154.156.212"
date: 2023-02-04T16:26:03+00:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like ```143.154.156.212``` or an IPv6 address like ```2000:cf2e:b0c9:31be:1be9:27e7:31cb:28b6```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```94:f9:ab:aa:80:e3```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://von-senger.name you initially access a DNS server to translate the host portion (von-senger) combined with the Top Level Domain (name) of the URL, to an IP address like ```227.150.125.11```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows; U; Win 9x 4.90; SG; rv:1.9.2.4) Gecko/20101104 Netscape/9.1.0285```
...
<pre>
default   fe80:37fd:98d7:2491:b254%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {203.57.242.150, 47.15.66.11}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 94:f9:ab:aa:80:e3
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 7f:aa:f2:7a:e0:7c
}</pre>
