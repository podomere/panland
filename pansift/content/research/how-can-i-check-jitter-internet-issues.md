...
layout: research
ip_v4_address: "81.143.200.59"
date: 2023-02-04T17:08:37+00:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like ```81.143.200.59``` or an IPv6 address like ```2000:c677:9efa:142d:335d:31fc:7a32:76f2```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```c0:28:b8:be:f1:f4```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://kris.info you initially access a DNS server to translate the host portion (kris) combined with the Top Level Domain (info) of the URL, to an IP address like ```56.251.76.105```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/41.0.2228.0 Safari/537.36```
...
<pre>
default   fe80:7962:8849:f526:2f0d%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {251.252.221.231, 225.61.120.44}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr c0:28:b8:be:f1:f4
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 95:63:12:22:24:f7
}</pre>
