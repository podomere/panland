...
layout: research
ip_v4_address: "2.20.125.90"
date: 2023-02-04T16:26:03+00:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like ```2.20.125.90``` or an IPv6 address like ```2000:fc9b:5ad1:17ae:b917:57dd:bd51:eb43```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```2a:5f:27:c3:d1:94```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://beatty.net you initially access a DNS server to translate the host portion (beatty) combined with the Top Level Domain (net) of the URL, to an IP address like ```204.9.140.76```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT x.y; Win64; x64; rv:10.0) Gecko/20100101 Firefox/10.0```
...
<pre>
default   fe80:bb70:c0db:8ae9:f646%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {66.46.204.106, 238.211.145.106}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 2a:5f:27:c3:d1:94
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 61:48:10:41:bc:75
}</pre>
