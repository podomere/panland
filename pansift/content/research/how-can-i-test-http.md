---
title: "How Can I Test Http"
subtitle: "Expansion Play?"
layout: research
ip_v4_address: "149.16.204.14"
date: 2022-11-02T11:33:00+00:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like ```149.16.204.14``` or an IPv6 address like ```2000:c194:c2ea:f861:bf68:72ce:fb5f:39e1```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```cd:6d:6e:d9:df:84```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://lesch-simonis.com you initially access a DNS server to translate the host portion (lesch-simonis) combined with the Top Level Domain (com) of the URL, to an IP address like ```125.33.182.225```. Your computer and browser actually sends its type with all web requests e.g. <br>```Opera/9.80 (X11; Linux i686; Ubuntu/14.10) Presto/2.12.388 Version/12.16```

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```10.14.112.136``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  10.14.112.136    UGScg  en0
...
<pre>
default   fe80:62db:17c:4e54:19bd%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {105.56.37.7, 245.79.191.39}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr cd:6d:6e:d9:df:84
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 02:bb:e2:c4:18:d2
}</pre>
