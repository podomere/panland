...
layout: research
ip_v4_address: "42.77.129.38"
date: 2022-06-04T14:38:37+01:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like ```42.77.129.38``` or an IPv6 address like ```2000:7300:aef5:77cb:2ab6:c82d:a56e:c721```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```f0:8d:ee:dd:c6:96```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://cummerata-mayer.org you initially access a DNS server to translate the host portion (cummerata-mayer) combined with the Top Level Domain (org) of the URL, to an IP address like ```97.202.144.208```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (compatible; MSIE 9.0; AOL 9.7; AOLBuild 4343.19; Windows NT 6.1; WOW64; Trident/5.0; FunWebProducts)```
...
default  172.22.174.62    UGScg  en0
...
<pre>
default   fe80:b7b3:8d34:704:d99c%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {35.41.13.227, 196.137.59.176}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr f0:8d:ee:dd:c6:96
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 96:8c:50:7d:c7:23
}</pre>
