...
subtitle: "Impact Map?"
layout: research
ip_v4_address: "217.228.249.104"
date: 2023-10-29T15:13:30+00:00
draft: false
---

## Internet Addressing
On the Internet you may get a Public IPv4 address like ```217.228.249.104``` or an IPv6 address like ```2000:affc:3229:ff2f:47f8:a70:62d5:fc6e```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```cf:b6:58:b4:fe:e8```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://hettinger-west.org you initially access a DNS server to translate the host portion (hettinger-west) combined with the Top Level Domain (org) of the URL, to an IP address like ```229.37.104.219```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT x.y; Win64; x64; rv:10.0) Gecko/20100101 Firefox/10.0```
...
<pre>
default   fe80:ad9a:ced1:cf35:531e%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {183.199.214.228, 36.132.106.98}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr cf:b6:58:b4:fe:e8
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 8c:be:37:09:0f:85
}</pre>
