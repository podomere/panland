...
subtitle: "Etc. Etc.?"
layout: research
ip_v4_address: "201.114.31.177"
date: 2022-06-12T14:09:16+01:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like ```201.114.31.177``` or an IPv6 address like ```2000:b62d:ff9f:50d0:14b8:74b7:7182:9638```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```e8:6b:d9:8c:97:b5```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://wehner-kuvalis.name you initially access a DNS server to translate the host portion (wehner-kuvalis) combined with the Top Level Domain (name) of the URL, to an IP address like ```251.45.59.63```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_3) AppleWebKit/537.75.14 (KHTML, like Gecko) Version/7.0.3 Safari/7046A194A```
...
<pre>
default   fe80:e868:12b4:1742:af00%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {25.0.196.247, 231.68.40.65}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr e8:6b:d9:8c:97:b5
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr cb:a5:1f:bf:69:9a
}</pre>
