...
layout: research
ip_v4_address: "110.70.178.173"
date: 2023-02-04T16:26:03+00:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like ```110.70.178.173``` or an IPv6 address like ```2000:7272:da3:dfba:ec3b:40a5:8ce0:ecb```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```61:99:17:dc:2f:11```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://dickinson-johns.co you initially access a DNS server to translate the host portion (dickinson-johns) combined with the Top Level Domain (co) of the URL, to an IP address like ```77.251.11.212```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (compatible; MSIE 9.0; AOL 9.7; AOLBuild 4343.19; Windows NT 6.1; WOW64; Trident/5.0; FunWebProducts)```
...
default  10.83.103.60    UGScg  en0
...
<pre>
default   fe80:2a15:a55a:70a9:c1cc%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {59.136.31.184, 228.255.10.17}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 61:99:17:dc:2f:11
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 96:57:59:ab:db:ac
}</pre>
