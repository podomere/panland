...
subtitle: "Deep Dive?"
layout: research
ip_v4_address: "17.197.0.72"
date: 2023-10-06T17:10:31+01:00
draft: false
---

## Internet Addressing
On the Internet you may get a Public IPv4 address like ```17.197.0.72``` or an IPv6 address like ```2000:857f:1e23:5a6a:82c2:4f01:f288:8845```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```49:c9:b7:25:a2:b3```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://olson-dickens.name you initially access a DNS server to translate the host portion (olson-dickens) combined with the Top Level Domain (name) of the URL, to an IP address like ```108.227.111.165```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_3) AppleWebKit/537.75.14 (KHTML, like Gecko) Version/7.0.3 Safari/7046A194A```
...
<pre>
default   fe80:959e:ddbe:a8ca:ea9c%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {87.180.0.153, 110.81.80.42}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 49:c9:b7:25:a2:b3
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr ff:c5:4e:e7:4f:6b
}</pre>
