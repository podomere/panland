...
layout: research
ip_v4_address: "237.179.151.128"
date: 2022-05-05T14:28:25+01:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like ```237.179.151.128``` or an IPv6 address like ```2000:1e4a:8900:c86f:b2b0:98f:b2d5:b4d```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```7c:d8:c7:6d:60:7a```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://homenick-sauer.info you initially access a DNS server to translate the host portion (homenick-sauer) combined with the Top Level Domain (info) of the URL, to an IP address like ```79.20.239.59```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1; WOW64; Trident/7.0; AS; rv:11.0) like Gecko```
...
<pre>
default   fe80:c4c3:3cb:9800:c79f%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {38.51.108.213, 5.226.99.14}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 7c:d8:c7:6d:60:7a
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 0c:58:c9:d4:e5:9d
}</pre>
