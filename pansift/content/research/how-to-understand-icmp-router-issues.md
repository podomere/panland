...
layout: research
ip_v4_address: "13.187.23.28"
date: 2022-11-19T16:17:23+00:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like ```13.187.23.28``` or an IPv6 address like ```2000:2c94:2bc5:e2b:4598:6f6:b880:72d```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```2f:3b:bc:b2:29:de```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://friesen-kuhlman.org you initially access a DNS server to translate the host portion (friesen-kuhlman) combined with the Top Level Domain (org) of the URL, to an IP address like ```62.226.245.161```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_3) AppleWebKit/537.75.14 (KHTML, like Gecko) Version/7.0.3 Safari/7046A194A```
...
<pre>
default   fe80:fefc:67eb:13a8:29c7%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {237.64.55.5, 197.143.62.141}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 2f:3b:bc:b2:29:de
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 06:6a:93:4f:ca:6b
}</pre>
