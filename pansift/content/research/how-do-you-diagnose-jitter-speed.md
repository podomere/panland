...
subtitle: "Value Add?"
layout: research
ip_v4_address: "97.238.240.26"
date: 2023-10-06T17:11:06+01:00
draft: false
---

## Internet Addressing
On the Internet you may have a Public IPv4 address like ```97.238.240.26``` or an IPv6 address like ```2000:8660:d3ea:a66d:4f67:87f3:f6f:31fb```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```63:2c:36:8a:42:24```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://kuhlman.org you initially access a DNS server to translate the host portion (kuhlman) combined with the Top Level Domain (org) of the URL, to an IP address like ```18.24.143.23```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows; U; Win 9x 4.90; SG; rv:1.9.2.4) Gecko/20101104 Netscape/9.1.0285```

## Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```10.110.139.98``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  10.110.139.98    UGScg  en0
...
<pre>
default   fe80:cf92:4368:3599:5dde%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {180.229.76.21, 0.98.209.169}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 63:2c:36:8a:42:24
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr a3:62:28:53:29:46
}</pre>
...
### Apple macOS / OSX
No matter what version of OSX/macOS you are on, ```10.14.2```, ```11.6.9```, or ```12.2.8```, there are a range of tools for troubleshooting. Unfortunately, between these manual actions and scripts, they don't give you a series of correlated values over time. This is where automated remote troubleshooting comes in to its own, especially for teams that embrace remote work and Work From Anywhere (WFA).
