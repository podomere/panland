...
subtitle: "Impact Map?"
layout: research
ip_v4_address: "49.57.51.17"
date: 2022-12-15T13:50:11+00:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like ```49.57.51.17``` or an IPv6 address like ```2000:ccb8:6450:e10d:c2df:b7fa:91b6:fea3```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```cd:d1:1f:34:2b:f0```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://nikolaus.biz you initially access a DNS server to translate the host portion (nikolaus) combined with the Top Level Domain (biz) of the URL, to an IP address like ```6.220.69.132```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (compatible; MSIE 9.0; AOL 9.7; AOLBuild 4343.19; Windows NT 6.1; WOW64; Trident/5.0; FunWebProducts)```
...
<pre>
default   fe80:6e59:2806:9042:4698%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {253.202.158.229, 203.83.229.102}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr cd:d1:1f:34:2b:f0
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr ab:f3:0b:f4:59:72
}</pre>
