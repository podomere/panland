...
subtitle: "Synergy?"
layout: research
ip_v4_address: "128.80.42.227"
date: 2022-12-15T13:50:11+00:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like ```128.80.42.227``` or an IPv6 address like ```2000:c139:51d:2ea2:7f2a:1dab:6df0:8419```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```36:38:08:dc:e0:95```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://frami-wyman.co you initially access a DNS server to translate the host portion (frami-wyman) combined with the Top Level Domain (co) of the URL, to an IP address like ```11.55.126.174```. Your computer and browser actually sends its type with all web requests e.g. <br>```Opera/9.80 (X11; Linux i686; Ubuntu/14.10) Presto/2.12.388 Version/12.16```
...
<pre>
default   fe80:24d9:7562:1f99:8ce0%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {109.246.220.18, 70.30.177.88}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 36:38:08:dc:e0:95
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 43:e2:a4:96:32:2f
}</pre>
