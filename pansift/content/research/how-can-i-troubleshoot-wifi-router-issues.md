...
layout: research
ip_v4_address: "1.225.187.90"
date: 2022-11-19T16:17:05+00:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like ```1.225.187.90``` or an IPv6 address like ```2000:3c39:aded:6e24:8300:f810:8c61:447b```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```5a:0c:59:2f:dc:1e```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://block-dibbert.info you initially access a DNS server to translate the host portion (block-dibbert) combined with the Top Level Domain (info) of the URL, to an IP address like ```128.201.7.10```. Your computer and browser actually sends its type with all web requests e.g. <br>```Opera/9.80 (X11; Linux i686; Ubuntu/14.10) Presto/2.12.388 Version/12.16```

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```192.168.25.153``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  192.168.25.153    UGScg  en0
...
<pre>
default   fe80:a09:781f:87f0:97c9%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {167.197.215.15, 239.195.250.56}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 5a:0c:59:2f:dc:1e
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 4e:dc:09:c9:52:fa
}</pre>
