...
layout: research
ip_v4_address: "14.65.146.37"
date: 2023-02-04T16:26:18+00:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like ```14.65.146.37``` or an IPv6 address like ```2000:cbc:285b:6c9e:b7f4:a78f:8543:cf30```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```05:16:08:f7:5b:bc```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://lueilwitz-quigley.net you initially access a DNS server to translate the host portion (lueilwitz-quigley) combined with the Top Level Domain (net) of the URL, to an IP address like ```91.67.50.222```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_3) AppleWebKit/537.75.14 (KHTML, like Gecko) Version/7.0.3 Safari/7046A194A```

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```172.24.61.158``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  172.24.61.158    UGScg  en0
...
<pre>
default   fe80:32f9:69e5:40f3:bde%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {226.21.116.46, 76.163.121.79}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 05:16:08:f7:5b:bc
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr d5:00:9b:1f:9a:59
}</pre>
