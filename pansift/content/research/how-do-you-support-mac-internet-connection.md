...
layout: research
ip_v4_address: "22.36.107.207"
date: 2023-10-06T17:10:44+01:00
draft: false
---

## Internet Addressing
On the Internet you may have a Public IPv4 address like ```22.36.107.207``` or an IPv6 address like ```2000:2641:dab7:73d2:8ff4:dc6e:b87a:802c```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```3f:3a:6f:c6:75:39```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://damore.co you initially access a DNS server to translate the host portion (damore) combined with the Top Level Domain (co) of the URL, to an IP address like ```83.191.133.217```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT x.y; Win64; x64; rv:10.0) Gecko/20100101 Firefox/10.0```
...
<pre>
default   fe80:1e1e:9463:3e4e:98c8%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {82.66.251.56, 58.39.39.112}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 3f:3a:6f:c6:75:39
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr c4:50:6a:c6:f6:89
}</pre>
