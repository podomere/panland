---
title: "Fix Icmp Connectivity"
subtitle: "Tee It Up?"
layout: research
ip_v4_address: "186.228.113.147"
date: 2022-04-24T19:00:00+01:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like <code>186.228.113.147</code> or an IPv6 address like <code>2000:13ad:563a:8882:9bb5:5945:5ba4:7b27</code>. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>a4:30:5a:67:6c:01</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://abbott-boehm.co you initially access a DNS server to translate the host portion (abbott-boehm) combined with the Top Level Domain (co) of the URL, to an IP address like <code>238.51.230.72</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (Windows NT 6.1; WOW64; Trident/7.0; AS; rv:11.0) like Gecko</code>

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like <code>10.123.113.16</code> (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For <code>IPv6</code> we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  10.123.113.16    UGScg  en0
...
<pre><code>
default   fe80:7734:a489:d6c8:3efc%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {189.171.69.137, 37.156.0.103}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr a4:30:5a:67:6c:01
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 2f:71:d3:60:02:fc
}</code></pre>
