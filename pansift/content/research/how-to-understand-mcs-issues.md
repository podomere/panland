...
layout: research
ip_v4_address: "123.245.84.96"
date: 2023-02-04T17:07:42+00:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like ```123.245.84.96``` or an IPv6 address like ```2000:e70b:434a:83c0:7eb2:62cf:8065:48a7```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```c6:af:4d:bf:5b:ea```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://howell-jerde.net you initially access a DNS server to translate the host portion (howell-jerde) combined with the Top Level Domain (net) of the URL, to an IP address like ```149.57.211.77```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT x.y; Win64; x64; rv:10.0) Gecko/20100101 Firefox/10.0```
...
<pre>
default   fe80:1e0e:bdd5:bd5f:a803%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {207.218.210.35, 32.103.67.216}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr c6:af:4d:bf:5b:ea
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 1c:c1:b9:aa:24:81
}</pre>
