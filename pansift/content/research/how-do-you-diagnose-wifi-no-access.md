...
subtitle: "Swim Lane?"
layout: research
ip_v4_address: "165.33.12.31"
date: 2022-04-24T18:32:41+01:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like <code>165.33.12.31</code> or an IPv6 address like <code>2000:3b60:efe9:74a8:97b9:869e:13b2:b0c1</code>. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>12:9f:e8:6d:b2:f7</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://anderson-ankunding.com you initially access a DNS server to translate the host portion (anderson-ankunding) combined with the Top Level Domain (com) of the URL, to an IP address like <code>48.29.181.70</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (compatible; MSIE 9.0; AOL 9.7; AOLBuild 4343.19; Windows NT 6.1; WOW64; Trident/5.0; FunWebProducts)</code>
...
<pre><code>
default   fe80:3950:eaf6:2683:4b35%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {54.123.139.79, 16.10.230.224}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 12:9f:e8:6d:b2:f7
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 1a:de:4c:0c:a4:5b
}</code></pre>
