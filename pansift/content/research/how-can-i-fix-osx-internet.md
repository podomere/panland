...
layout: research
ip_v4_address: "27.134.245.221"
date: 2022-04-24T18:31:57+01:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like <code>27.134.245.221</code> or an IPv6 address like <code>2000:3c8c:dabb:97e8:2d06:4acf:8c0d:7819</code>. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>8d:a8:38:99:c8:23</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://hermann.io you initially access a DNS server to translate the host portion (hermann) combined with the Top Level Domain (io) of the URL, to an IP address like <code>80.174.222.115</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (Windows NT x.y; Win64; x64; rv:10.0) Gecko/20100101 Firefox/10.0</code>
...
<pre><code>
default   fe80:6081:c957:3bb0:9b8c%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {77.1.251.60, 225.168.148.86}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 8d:a8:38:99:c8:23
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr a7:3f:31:0e:93:c3
}</code></pre>
