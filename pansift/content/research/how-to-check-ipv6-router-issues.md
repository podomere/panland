...
subtitle: "Heads Down?"
layout: research
ip_v4_address: "27.121.191.251"
date: 2022-06-04T14:38:36+01:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like ```27.121.191.251``` or an IPv6 address like ```2000:1274:b3a5:86a7:195f:85ac:49d4:d68```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```7f:bc:ed:c7:17:0e```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://nitzsche-jenkins.io you initially access a DNS server to translate the host portion (nitzsche-jenkins) combined with the Top Level Domain (io) of the URL, to an IP address like ```192.121.240.127```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_3) AppleWebKit/537.75.14 (KHTML, like Gecko) Version/7.0.3 Safari/7046A194A```
...
<pre>
default   fe80:f1d9:c08b:38fa:3137%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {99.157.129.77, 145.45.55.65}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 7f:bc:ed:c7:17:0e
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 0c:91:ef:19:d9:ed
}</pre>
