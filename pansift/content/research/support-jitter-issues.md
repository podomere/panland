...
layout: research
ip_v4_address: "69.64.80.14"
date: 2022-11-19T19:13:25+00:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like ```69.64.80.14``` or an IPv6 address like ```2000:7a38:f76d:8f34:2155:8862:c4d7:53d7```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```f1:39:b4:50:d2:09```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://corwin.biz you initially access a DNS server to translate the host portion (corwin) combined with the Top Level Domain (biz) of the URL, to an IP address like ```15.193.8.206```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_3) AppleWebKit/537.75.14 (KHTML, like Gecko) Version/7.0.3 Safari/7046A194A```
...
<pre>
default   fe80:7b2b:e737:a5b:9b3c%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {223.238.19.127, 249.230.20.200}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr f1:39:b4:50:d2:09
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr da:c3:f7:07:15:7b
}</pre>
