...
subtitle: "Heads Down?"
layout: research
ip_v4_address: "183.119.214.158"
date: 2023-02-04T16:26:19+00:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like ```183.119.214.158``` or an IPv6 address like ```2000:43bd:1a05:e75c:9bed:6681:1559:2333```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```52:89:6d:45:56:92```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://little.io you initially access a DNS server to translate the host portion (little) combined with the Top Level Domain (io) of the URL, to an IP address like ```60.30.171.56```. Your computer and browser actually sends its type with all web requests e.g. <br>```Opera/9.80 (X11; Linux i686; Ubuntu/14.10) Presto/2.12.388 Version/12.16```
...
<pre>
default   fe80:f588:7013:7864:d392%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {33.41.208.109, 138.180.136.182}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 52:89:6d:45:56:92
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 0e:76:8d:e2:1f:a6
}</pre>
