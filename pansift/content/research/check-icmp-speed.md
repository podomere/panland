...
layout: research
ip_v4_address: "245.189.36.9"
date: 2022-04-24T19:00:00+01:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like <code>245.189.36.9</code> or an IPv6 address like <code>2000:64f1:c76b:1a16:6ea8:23c2:b01e:b6e7</code>. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>e3:92:df:c7:21:e2</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://pfeffer-effertz.biz you initially access a DNS server to translate the host portion (pfeffer-effertz) combined with the Top Level Domain (biz) of the URL, to an IP address like <code>35.100.57.72</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (Windows; U; Win 9x 4.90; SG; rv:1.9.2.4) Gecko/20101104 Netscape/9.1.0285</code>
...
<pre><code>
default   fe80:8512:222b:b9c7:76b3%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {77.232.5.223, 177.33.18.163}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr e3:92:df:c7:21:e2
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr b9:f3:3e:9e:f7:26
}</code></pre>
