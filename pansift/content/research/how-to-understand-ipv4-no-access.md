...
subtitle: "Heads Down?"
layout: research
ip_v4_address: "243.67.123.74"
date: 2023-02-04T17:08:35+00:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like ```243.67.123.74``` or an IPv6 address like ```2000:84ee:5f67:de08:e99a:d82c:f5b8:cef3```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```6a:81:74:c2:e7:8a```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://damore-lebsack.com you initially access a DNS server to translate the host portion (damore-lebsack) combined with the Top Level Domain (com) of the URL, to an IP address like ```110.216.205.221```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1; WOW64; Trident/7.0; AS; rv:11.0) like Gecko```

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```192.168.179.25``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  192.168.179.25    UGScg  en0
...
<pre>
default   fe80:b362:e942:6aa6:adb8%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {135.36.148.133, 201.67.110.73}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 6a:81:74:c2:e7:8a
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 40:c3:b4:fe:ca:3f
}</pre>
...
## Apple macOS / OSX
No matter what version of OSX/macOS you are on, ```10.15.2```, ```11.4.2```, or ```12.3.4```, there are a range of tools for troubleshooting. Unfortunately, between these manual actions and scripts, they don't give you a series of correlated values over time. This is where automated remote troubleshooting comes in to its own, especially for teams that embrace remote work and Work From Anywhere (WFA).
