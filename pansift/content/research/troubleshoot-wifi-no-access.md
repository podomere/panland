...
subtitle: "Synergy?"
layout: research
ip_v4_address: "6.40.198.131"
date: 2022-04-24T18:32:41+01:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like <code>6.40.198.131</code> or an IPv6 address like <code>2000:c2b2:2659:1740:d1a2:16bb:f4e2:ab44</code>. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>a5:d1:e1:a2:8a:62</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://stokes-kiehn.com you initially access a DNS server to translate the host portion (stokes-kiehn) combined with the Top Level Domain (com) of the URL, to an IP address like <code>195.224.13.64</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (Windows NT 6.1; WOW64; Trident/7.0; AS; rv:11.0) like Gecko</code>
...
<pre><code>
default   fe80:c747:8f83:b5c6:4c18%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {3.196.171.195, 65.207.164.56}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr a5:d1:e1:a2:8a:62
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr a9:29:88:e5:59:c9
}</code></pre>
