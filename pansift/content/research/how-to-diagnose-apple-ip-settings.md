...
subtitle: "Ideate?"
layout: research
ip_v4_address: "40.65.60.7"
date: 2022-04-24T18:31:58+01:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like <code>40.65.60.7</code> or an IPv6 address like <code>2000:1fb8:4dce:c36c:dae3:cb8:cc:d755</code>. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>17:c1:8a:48:1a:79</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://tillman-quigley.net you initially access a DNS server to translate the host portion (tillman-quigley) combined with the Top Level Domain (net) of the URL, to an IP address like <code>5.41.50.206</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Opera/9.80 (X11; Linux i686; Ubuntu/14.10) Presto/2.12.388 Version/12.16</code>
...
<pre><code>
default   fe80:6dc1:220d:609c:e%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {55.98.111.255, 9.36.119.207}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 17:c1:8a:48:1a:79
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 14:31:dd:66:84:8c
}</code></pre>
