...
subtitle: "Heads Down?"
layout: research
ip_v4_address: "106.243.193.49"
date: 2022-11-02T11:33:11+00:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like ```106.243.193.49``` or an IPv6 address like ```2000:a23d:8797:334:fec3:2e9f:2bc1:7ca5```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```09:79:f0:ac:43:ea```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://dubuque.org you initially access a DNS server to translate the host portion (dubuque) combined with the Top Level Domain (org) of the URL, to an IP address like ```193.68.92.141```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_3) AppleWebKit/537.75.14 (KHTML, like Gecko) Version/7.0.3 Safari/7046A194A```
...
<pre>
default   fe80:7858:7972:9894:7682%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {113.91.106.56, 99.217.166.89}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 09:79:f0:ac:43:ea
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 9b:f2:fd:e0:b1:d1
}</pre>
...
## Apple macOS / OSX
No matter what version of OSX/macOS you are on, ```10.11.4```, ```11.4.5```, or ```12.2.3```, there are a range of tools for troubleshooting. Unfortunately, between these manual actions and scripts, they don't give you a series of correlated values over time. This is where automated remote troubleshooting comes in to its own, especially for teams that embrace remote work and Work From Anywhere (WFA).
