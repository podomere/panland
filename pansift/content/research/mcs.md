...
layout: research
ip_v4_address: "68.181.216.196"
date: 2022-06-04T14:38:17+01:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like ```68.181.216.196``` or an IPv6 address like ```2000:8259:996e:ad9d:da96:6dd8:dd99:f94```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```75:19:f8:28:1b:46```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://huels-stracke.biz you initially access a DNS server to translate the host portion (huels-stracke) combined with the Top Level Domain (biz) of the URL, to an IP address like ```6.210.176.122```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_3) AppleWebKit/537.75.14 (KHTML, like Gecko) Version/7.0.3 Safari/7046A194A```
...
<pre>
default   fe80:20f4:c30a:bbaa:56c8%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {125.160.206.114, 232.93.176.133}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 75:19:f8:28:1b:46
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr c3:b9:f2:7d:7c:fe
}</pre>
