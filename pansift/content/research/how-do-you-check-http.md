...
subtitle: "Streamline?"
layout: research
ip_v4_address: "255.84.151.101"
date: 2023-02-04T16:26:23+00:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like ```255.84.151.101``` or an IPv6 address like ```2000:9bd:2aff:5144:8c36:9a83:6bb2:7e64```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```52:82:9d:1b:ef:27```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://lesch-gutmann.net you initially access a DNS server to translate the host portion (lesch-gutmann) combined with the Top Level Domain (net) of the URL, to an IP address like ```223.209.82.120```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (compatible; MSIE 9.0; AOL 9.7; AOLBuild 4343.19; Windows NT 6.1; WOW64; Trident/5.0; FunWebProducts)```
...
<pre>
default   fe80:254d:f37:3cca:cd38%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {174.33.144.111, 122.180.230.140}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 52:82:9d:1b:ef:27
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 72:34:52:9e:97:d1
}</pre>
