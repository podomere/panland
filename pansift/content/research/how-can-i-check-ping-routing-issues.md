...
layout: research
ip_v4_address: "7.129.145.209"
date: 2023-10-06T17:11:07+01:00
draft: false
---

## Internet Addressing
On the Internet you may have a Public IPv4 address like ```7.129.145.209``` or an IPv6 address like ```2000:61ac:883f:1389:4283:1c3b:d2cc:43d3```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```2e:28:b5:58:10:43```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://kreiger-conroy.org you initially access a DNS server to translate the host portion (kreiger-conroy) combined with the Top Level Domain (org) of the URL, to an IP address like ```127.86.85.104```. Your computer and browser actually sends its type with all web requests e.g. <br>```Opera/9.80 (X11; Linux i686; Ubuntu/14.10) Presto/2.12.388 Version/12.16```
...
<pre>
default   4a:b2c3:504d:3412:24a3:980e:c32b:f527%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {131.3.52.186, 102.146.65.169}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 2e:28:b5:58:10:43
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 22:45:00:49:11:18
}</pre>
