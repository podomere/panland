...
layout: research
ip_v4_address: "186.204.93.32"
date: 2022-06-12T14:09:24+01:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like ```186.204.93.32``` or an IPv6 address like ```2000:fa13:44e9:ec78:cbbe:2962:8954:a754```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```98:38:23:bc:75:ef```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://reichel-konopelski.io you initially access a DNS server to translate the host portion (reichel-konopelski) combined with the Top Level Domain (io) of the URL, to an IP address like ```248.241.13.115```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/41.0.2228.0 Safari/537.36```
...
<pre>
default   fe80:16b2:c392:82d8:938b%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {229.3.247.125, 226.40.225.190}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 98:38:23:bc:75:ef
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 0a:88:eb:98:cf:7c
}</pre>
