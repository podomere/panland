...
layout: research
ip_v4_address: "187.113.81.184"
date: 2023-02-04T16:26:18+00:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like ```187.113.81.184``` or an IPv6 address like ```2000:8aad:f9b4:e6d4:83cb:bb57:53eb:43bd```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```1a:04:81:b0:d7:54```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://bode-davis.info you initially access a DNS server to translate the host portion (bode-davis) combined with the Top Level Domain (info) of the URL, to an IP address like ```76.62.165.190```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_3) AppleWebKit/537.75.14 (KHTML, like Gecko) Version/7.0.3 Safari/7046A194A```
...
<pre>
default   fe80:bce9:3f87:9d47:898f%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {97.82.173.107, 48.207.76.147}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 1a:04:81:b0:d7:54
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr b6:7c:63:d4:b4:59
}</pre>
