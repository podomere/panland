...
layout: research
ip_v4_address: "204.240.33.162"
date: 2023-02-04T17:07:50+00:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like ```204.240.33.162``` or an IPv6 address like ```2000:3aa0:d1f2:5e6e:7d63:bda1:383b:17fc```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```f8:7b:ef:b3:f3:3a```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://kohler.com you initially access a DNS server to translate the host portion (kohler) combined with the Top Level Domain (com) of the URL, to an IP address like ```89.94.163.133```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows; U; Win 9x 4.90; SG; rv:1.9.2.4) Gecko/20101104 Netscape/9.1.0285```
...
<pre>
default   fe80:7db2:691d:ffcd:4762%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {126.106.165.201, 237.88.65.93}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr f8:7b:ef:b3:f3:3a
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 03:e6:4c:1f:6b:2d
}</pre>
