...
layout: research
ip_v4_address: "235.185.255.201"
date: 2022-06-12T14:09:16+01:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like ```235.185.255.201``` or an IPv6 address like ```2000:3576:68e0:ea0e:480d:dccc:9f21:d7c0```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```71:df:b4:24:9f:08```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://connelly-feest.org you initially access a DNS server to translate the host portion (connelly-feest) combined with the Top Level Domain (org) of the URL, to an IP address like ```47.159.223.134```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1; WOW64; Trident/7.0; AS; rv:11.0) like Gecko```
...
<pre>
default   fe80:b6a1:148b:6d42:d5a7%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {77.153.134.224, 71.65.52.77}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 71:df:b4:24:9f:08
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr e0:25:16:47:a7:78
}</pre>
