...
layout: research
ip_v4_address: "55.78.189.11"
date: 2022-11-19T16:17:12+00:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like ```55.78.189.11``` or an IPv6 address like ```2000:1e37:ae3:5fe2:5861:8c73:2158:a275```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```42:c8:1d:8d:e1:fe```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://kunze-klocko.io you initially access a DNS server to translate the host portion (kunze-klocko) combined with the Top Level Domain (io) of the URL, to an IP address like ```197.184.157.64```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/41.0.2228.0 Safari/537.36```
...
<pre>
default   fe80:e986:eb3f:f03f:4d49%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {168.84.127.33, 104.158.31.96}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 42:c8:1d:8d:e1:fe
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr bb:45:66:e9:a7:d3
}</pre>
