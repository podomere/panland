...
subtitle: "Streamline?"
layout: research
ip_v4_address: "87.66.135.14"
date: 2023-02-04T16:26:20+00:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like ```87.66.135.14``` or an IPv6 address like ```2000:db2b:f794:8042:a513:d105:b5d2:5fc```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```b0:7e:52:63:29:6f```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://nader-prohaska.biz you initially access a DNS server to translate the host portion (nader-prohaska) combined with the Top Level Domain (biz) of the URL, to an IP address like ```10.253.27.170```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1; WOW64; Trident/7.0; AS; rv:11.0) like Gecko```

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```10.99.170.210``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  10.99.170.210    UGScg  en0
...
<pre>
default   fe80:915:77c1:350f:f256%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {80.202.217.173, 19.99.14.225}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr b0:7e:52:63:29:6f
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr cf:c2:7b:2e:4f:4e
}</pre>
