...
subtitle: "Etc. Etc.?"
layout: research
ip_v4_address: "117.104.66.110"
date: 2023-02-04T16:26:20+00:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like ```117.104.66.110``` or an IPv6 address like ```2000:3302:dc38:e128:a61a:3a84:7716:d5b1```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```99:a5:0e:d0:0d:7c```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://schumm-langworth.info you initially access a DNS server to translate the host portion (schumm-langworth) combined with the Top Level Domain (info) of the URL, to an IP address like ```87.146.232.93```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_3) AppleWebKit/537.75.14 (KHTML, like Gecko) Version/7.0.3 Safari/7046A194A```
...
<pre>
default   fe80:fca3:ced6:ba0e:6c57%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {198.23.194.206, 66.77.169.148}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 99:a5:0e:d0:0d:7c
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 7d:08:f3:3a:a8:e1
}</pre>
