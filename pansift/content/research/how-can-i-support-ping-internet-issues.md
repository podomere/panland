...
layout: research
ip_v4_address: "54.2.80.68"
date: 2023-10-29T15:13:29+00:00
draft: false
---

## Internet Addressing
On the Internet you may have a Public IPv4 address like ```54.2.80.68``` or an IPv6 address like ```2000:53bb:c8e0:27f8:f163:d21f:f38a:1b4a```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```98:e7:f6:bf:6c:69```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://altenwerth-rodriguez.name you initially access a DNS server to translate the host portion (altenwerth-rodriguez) combined with the Top Level Domain (name) of the URL, to an IP address like ```144.171.185.45```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1; WOW64; Trident/7.0; AS; rv:11.0) like Gecko```

## Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```10.89.11.235``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  10.89.11.235    UGScg  en0
...
<pre>
default   fe80:64b4:a44b:dfe1:98cd%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {76.80.3.219, 79.191.240.190}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 98:e7:f6:bf:6c:69
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 1e:ec:37:9f:a4:11
}</pre>
...
### Apple macOS / OSX
No matter what version of OSX/macOS you are on, ```10.12.9```, ```11.1.7```, or ```12.1.5```, there are a range of tools for troubleshooting. Unfortunately, between these manual actions and scripts, they don't give you a series of correlated values over time. This is where automated remote troubleshooting comes in to its own, especially for teams that embrace remote work and Work From Anywhere (WFA).
