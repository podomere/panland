...
layout: research
ip_v4_address: "222.45.49.100"
date: 2022-12-15T13:50:20+00:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like ```222.45.49.100``` or an IPv6 address like ```2000:705d:a0f8:c420:a46b:c2f9:3ec0:55eb```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```38:f5:69:4c:41:1d```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://wyman-king.com you initially access a DNS server to translate the host portion (wyman-king) combined with the Top Level Domain (com) of the URL, to an IP address like ```237.80.147.108```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (compatible; MSIE 9.0; AOL 9.7; AOLBuild 4343.19; Windows NT 6.1; WOW64; Trident/5.0; FunWebProducts)```
...
<pre>
default   fe80:7733:2fc4:9570:18d4%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {197.6.215.112, 21.136.123.77}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 38:f5:69:4c:41:1d
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr bc:85:1a:21:a7:9e
}</pre>
