...
layout: research
ip_v4_address: "183.81.145.156"
date: 2023-11-18T17:37:15+00:00
draft: false
---

## Understanding Internet Addressing

When using the Internet, you are assigned a Public IPv4 or IPv6 address. These addresses can be checked using tools like [https://test-ipv6.com/](https://test-ipv6.com/), and they play a crucial role in communication. However, conveying and managing these addresses, including MAC addresses, can be complex. Furthermore, it is important to have access to historical data, especially when previous issues occurred.
