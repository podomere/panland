...
layout: research
ip_v4_address: "38.228.42.192"
date: 2022-11-19T19:13:25+00:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like ```38.228.42.192``` or an IPv6 address like ```2000:af6b:a3bc:8c1b:44:4d26:33c0:317```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```00:c6:2a:b2:d6:19```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://vonrueden-bogan.info you initially access a DNS server to translate the host portion (vonrueden-bogan) combined with the Top Level Domain (info) of the URL, to an IP address like ```177.93.104.167```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT x.y; Win64; x64; rv:10.0) Gecko/20100101 Firefox/10.0```
...
<pre>
default   fe80:8223:815c:c5fd:fee5%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {89.178.212.237, 199.20.62.3}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 00:c6:2a:b2:d6:19
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr d8:f5:1e:ea:f8:af
}</pre>
