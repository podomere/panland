...
layout: research
ip_v4_address: "146.193.0.42"
date: 2022-05-05T14:28:52+01:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like ```146.193.0.42``` or an IPv6 address like ```2000:4ded:702:d376:3bcb:599f:f0f5:9691```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```11:51:8e:f0:3e:62```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://crooks-king.biz you initially access a DNS server to translate the host portion (crooks-king) combined with the Top Level Domain (biz) of the URL, to an IP address like ```87.43.234.106```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/41.0.2228.0 Safari/537.36```
...
<pre>
default   fe80:5658:9c32:b8a1:8d95%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {59.7.85.19, 127.216.39.164}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 11:51:8e:f0:3e:62
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr b0:9e:d8:d1:3e:74
}</pre>
