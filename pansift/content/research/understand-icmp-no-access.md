...
layout: research
ip_v4_address: "213.16.197.12"
date: 2022-06-12T14:09:26+01:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like ```213.16.197.12``` or an IPv6 address like ```2000:a648:fa22:e94a:b45b:3944:38c5:e748```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```12:6d:0f:96:9a:b2```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://lockman.org you initially access a DNS server to translate the host portion (lockman) combined with the Top Level Domain (org) of the URL, to an IP address like ```224.208.11.75```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_3) AppleWebKit/537.75.14 (KHTML, like Gecko) Version/7.0.3 Safari/7046A194A```
...
<pre>
default   fe80:f553:d3d7:bdd2:9ed8%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {203.28.62.5, 199.68.71.161}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 12:6d:0f:96:9a:b2
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr eb:2d:b3:00:c8:8c
}</pre>
