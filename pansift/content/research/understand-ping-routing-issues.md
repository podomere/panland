...
subtitle: "Deep Dive?"
layout: research
ip_v4_address: "73.83.93.51"
date: 2023-10-29T15:13:28+00:00
draft: false
---

## Internet Addressing
On the Internet you may have a Public IPv4 address like ```73.83.93.51``` or an IPv6 address like ```2000:9d35:ccb8:fb8e:dcee:4bc2:bde8:973d```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```49:99:2c:76:8a:40```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://turcotte.org you initially access a DNS server to translate the host portion (turcotte) combined with the Top Level Domain (org) of the URL, to an IP address like ```33.154.125.226```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows; U; Win 9x 4.90; SG; rv:1.9.2.4) Gecko/20101104 Netscape/9.1.0285```
...
default  172.28.57.115    UGScg  en0
...
<pre>
default   fe80:d23f:5042:f05f:e755%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {59.73.22.244, 9.74.202.48}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 49:99:2c:76:8a:40
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr a3:09:b4:ee:f0:73
}</pre>
