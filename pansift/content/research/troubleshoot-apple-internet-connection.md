...
layout: research
ip_v4_address: "117.41.110.78"
date: 2022-04-24T18:31:58+01:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like <code>117.41.110.78</code> or an IPv6 address like <code>2000:98b1:eda8:6a50:36b9:b751:1e20:3ec0</code>. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>87:98:c2:2b:5b:64</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://kuhn-williamson.name you initially access a DNS server to translate the host portion (kuhn-williamson) combined with the Top Level Domain (name) of the URL, to an IP address like <code>59.246.70.254</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (Windows NT 6.1; WOW64; Trident/7.0; AS; rv:11.0) like Gecko</code>
...
<pre><code>
default   fe80:ea4e:fd05:b226:e0dc%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {37.54.116.209, 204.181.5.120}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 87:98:c2:2b:5b:64
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 99:c8:88:82:e3:a8
}</code></pre>
