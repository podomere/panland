...
layout: research
ip_v4_address: "86.215.153.45"
date: 2022-04-24T19:00:03+01:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like <code>86.215.153.45</code> or an IPv6 address like <code>2000:1295:5738:46ca:5c02:eed3:be61:9228</code>. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>15:1e:1b:56:72:28</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://hodkiewicz-huels.info you initially access a DNS server to translate the host portion (hodkiewicz-huels) combined with the Top Level Domain (info) of the URL, to an IP address like <code>34.32.135.162</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_3) AppleWebKit/537.75.14 (KHTML, like Gecko) Version/7.0.3 Safari/7046A194A</code>

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like <code>172.27.181.86</code> (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For <code>IPv6</code> we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  172.27.181.86    UGScg  en0
...
<pre><code>
default   fe80:b545:afe0:6758:4400%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {14.117.101.103, 118.114.212.209}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 15:1e:1b:56:72:28
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 9c:e3:f6:f7:24:91
}</code></pre>
