---
title: "IPv6 Routing Issues"
subtitle: "Thought Leadership?"
layout: research
ip_v4_address: "105.189.139.128"
date: 2023-10-06T17:11:03+01:00
draft: false
---

## Internet Addressing
On the Internet you might have a Public IPv4 address like ```105.189.139.128``` or an IPv6 address like ```2000:6be4:ffec:57f4:890c:4c72:f154:1d16```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```14:54:09:38:33:c7```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://moore-mitchell.biz you initially access a DNS server to translate the host portion (moore-mitchell) combined with the Top Level Domain (biz) of the URL, to an IP address like ```43.158.133.35```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1; WOW64; Trident/7.0; AS; rv:11.0) like Gecko```

## Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```172.29.72.36``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  172.29.72.36    UGScg  en0
...
<pre>
default   fe80:e2bf:584f:33f3:687a%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {244.9.233.20, 176.176.8.85}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 14:54:09:38:33:c7
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 88:4e:5e:08:8c:3c
}</pre>
