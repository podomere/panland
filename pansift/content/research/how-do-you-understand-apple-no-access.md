...
layout: research
ip_v4_address: "146.34.159.58"
date: 2023-02-04T16:26:11+00:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like ```146.34.159.58``` or an IPv6 address like ```2000:2aa8:b2ac:e1eb:38f1:f0aa:c894:d492```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```95:c7:91:30:b5:68```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://senger-rempel.org you initially access a DNS server to translate the host portion (senger-rempel) combined with the Top Level Domain (org) of the URL, to an IP address like ```250.20.103.207```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1; WOW64; Trident/7.0; AS; rv:11.0) like Gecko```
...
default  192.168.132.248    UGScg  en0
...
<pre>
default   fe80:a312:5081:7f7:5217%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {146.239.86.80, 82.132.177.136}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 95:c7:91:30:b5:68
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr b3:83:91:da:54:b1
}</pre>
