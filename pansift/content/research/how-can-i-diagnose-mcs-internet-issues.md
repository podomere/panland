...
layout: research
ip_v4_address: "156.229.59.8"
date: 2022-04-24T19:00:34+01:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like <code>156.229.59.8</code> or an IPv6 address like <code>2000:9259:4897:a618:c4b3:27f3:385e:f74a</code>. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>e7:9d:35:fc:b6:83</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://lakin.co you initially access a DNS server to translate the host portion (lakin) combined with the Top Level Domain (co) of the URL, to an IP address like <code>70.251.212.137</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Opera/9.80 (X11; Linux i686; Ubuntu/14.10) Presto/2.12.388 Version/12.16</code>

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like <code>10.157.45.66</code> (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For <code>IPv6</code> we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  10.157.45.66    UGScg  en0
...
<pre><code>
default   fe80:e44d:2afe:ad14:d20a%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {42.228.116.203, 165.204.201.76}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr e7:9d:35:fc:b6:83
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 2b:51:8a:69:12:a0
}</code></pre>
