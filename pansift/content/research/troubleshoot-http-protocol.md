...
subtitle: "Granular?"
layout: research
ip_v4_address: "65.90.71.81"
date: 2022-12-15T13:50:20+00:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like ```65.90.71.81``` or an IPv6 address like ```2000:2429:a4eb:fcb:d2b2:b31d:9a2:cc81```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```ea:0a:7a:e6:c5:20```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://rodriguez-pfannerstill.biz you initially access a DNS server to translate the host portion (rodriguez-pfannerstill) combined with the Top Level Domain (biz) of the URL, to an IP address like ```64.159.252.110```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT x.y; Win64; x64; rv:10.0) Gecko/20100101 Firefox/10.0```
...
<pre>
default   fe80:e856:60a2:5b0d:a28a%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {213.107.72.157, 130.98.245.95}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr ea:0a:7a:e6:c5:20
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr ad:36:8d:6c:e1:10
}</pre>
