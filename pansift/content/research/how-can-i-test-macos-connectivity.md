...
layout: research
ip_v4_address: "206.240.37.100"
date: 2022-04-24T19:00:23+01:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like <code>206.240.37.100</code> or an IPv6 address like <code>2000:fcbb:7414:a833:b88d:bd4f:6dab:ebb6</code>. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>c5:cc:41:76:83:6e</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://schneider-schneider.info you initially access a DNS server to translate the host portion (schneider-schneider) combined with the Top Level Domain (info) of the URL, to an IP address like <code>222.140.181.136</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (Windows; U; Win 9x 4.90; SG; rv:1.9.2.4) Gecko/20101104 Netscape/9.1.0285</code>
...
<pre><code>
default   fe80:db8d:7417:4800:295a%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {246.168.191.106, 42.237.34.13}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr c5:cc:41:76:83:6e
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 37:e4:93:2d:1c:c1
}</code></pre>
