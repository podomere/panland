...
layout: research
ip_v4_address: "239.81.223.161"
date: 2022-11-19T16:17:20+00:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like ```239.81.223.161``` or an IPv6 address like ```2000:5c65:5818:17bd:9769:d530:7ebd:914f```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```66:64:f8:c2:c1:7d```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://simonis-greenfelder.info you initially access a DNS server to translate the host portion (simonis-greenfelder) combined with the Top Level Domain (info) of the URL, to an IP address like ```19.159.231.241```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT x.y; Win64; x64; rv:10.0) Gecko/20100101 Firefox/10.0```
...
<pre>
default   fe80:f037:4877:ffdc:4539%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {131.235.253.125, 180.194.210.89}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 66:64:f8:c2:c1:7d
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 9d:b2:90:5e:88:b7
}</pre>
