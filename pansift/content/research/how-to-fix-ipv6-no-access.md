...
subtitle: "Learnings?"
layout: research
ip_v4_address: "98.164.61.204"
date: 2022-11-02T11:32:52+00:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like ```98.164.61.204``` or an IPv6 address like ```2000:7e43:be1e:78e4:ff63:3be0:c3bd:37ed```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```d1:89:3c:5f:04:90```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://morar.net you initially access a DNS server to translate the host portion (morar) combined with the Top Level Domain (net) of the URL, to an IP address like ```133.244.18.138```. Your computer and browser actually sends its type with all web requests e.g. <br>```Opera/9.80 (X11; Linux i686; Ubuntu/14.10) Presto/2.12.388 Version/12.16```
...
<pre>
default   fe80:28c7:a160:9042:6923%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {69.181.98.69, 191.141.91.35}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr d1:89:3c:5f:04:90
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 05:16:7c:0b:b0:23
}</pre>
...
## Apple macOS / OSX
No matter what version of OSX/macOS you are on, ```10.14.6```, ```11.4.5```, or ```12.2.7```, there are a range of tools for troubleshooting. Unfortunately, between these manual actions and scripts, they don't give you a series of correlated values over time. This is where automated remote troubleshooting comes in to its own, especially for teams that embrace remote work and Work From Anywhere (WFA).
