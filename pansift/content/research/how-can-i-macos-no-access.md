...
layout: research
ip_v4_address: "253.14.96.47"
date: 2022-04-24T19:00:23+01:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like <code>253.14.96.47</code> or an IPv6 address like <code>2000:19c2:a96b:73ac:c860:8ee:5186:37d7</code>. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>f8:67:bf:e4:e7:39</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://sipes-metz.net you initially access a DNS server to translate the host portion (sipes-metz) combined with the Top Level Domain (net) of the URL, to an IP address like <code>214.38.190.3</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Opera/9.80 (X11; Linux i686; Ubuntu/14.10) Presto/2.12.388 Version/12.16</code>
...
<pre><code>
default   fe80:d163:3ed2:54bd:cd22%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {129.1.37.97, 145.192.136.230}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr f8:67:bf:e4:e7:39
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr cf:10:c0:52:e3:45
}</code></pre>
