...
layout: research
ip_v4_address: "165.18.143.9"
date: 2023-02-04T17:08:40+00:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like ```165.18.143.9``` or an IPv6 address like ```2000:6c9a:c104:2b05:5b34:8463:43ad:656a```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```86:05:d2:66:0e:f0```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://cole.biz you initially access a DNS server to translate the host portion (cole) combined with the Top Level Domain (biz) of the URL, to an IP address like ```7.125.51.12```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/41.0.2228.0 Safari/537.36```

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```192.168.254.5``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  192.168.254.5    UGScg  en0
...
<pre>
default   fe80:5f90:fb5f:845f:d7c6%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {179.147.176.139, 255.186.104.203}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 86:05:d2:66:0e:f0
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 3f:c8:3a:7e:a5:e9
}</pre>
...
## Apple macOS / OSX
No matter what version of OSX/macOS you are on, ```10.13.3```, ```11.1.9```, or ```12.2.3```, there are a range of tools for troubleshooting. Unfortunately, between these manual actions and scripts, they don't give you a series of correlated values over time. This is where automated remote troubleshooting comes in to its own, especially for teams that embrace remote work and Work From Anywhere (WFA).
