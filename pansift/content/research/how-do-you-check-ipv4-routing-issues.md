...
layout: research
ip_v4_address: "199.40.56.40"
date: 2023-02-04T17:08:36+00:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like ```199.40.56.40``` or an IPv6 address like ```2000:d907:db84:a366:103f:cc3f:52be:8006```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```d9:c2:24:4c:a0:53```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://batz-torphy.name you initially access a DNS server to translate the host portion (batz-torphy) combined with the Top Level Domain (name) of the URL, to an IP address like ```242.112.139.138```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1; WOW64; Trident/7.0; AS; rv:11.0) like Gecko```

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```10.61.238.61``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  10.61.238.61    UGScg  en0
...
<pre>
default   fe80:b430:53e6:3bf0:67dd%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {147.143.31.168, 109.97.7.1}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr d9:c2:24:4c:a0:53
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 9b:ca:77:45:82:da
}</pre>
...
## Apple macOS / OSX
No matter what version of OSX/macOS you are on, ```10.11.7```, ```11.1.2```, or ```12.1.3```, there are a range of tools for troubleshooting. Unfortunately, between these manual actions and scripts, they don't give you a series of correlated values over time. This is where automated remote troubleshooting comes in to its own, especially for teams that embrace remote work and Work From Anywhere (WFA).
