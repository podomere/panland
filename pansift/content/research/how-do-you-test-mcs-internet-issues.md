---
title: "How Do You Test Mcs Internet Issues"
subtitle: "Heads Down?"
layout: research
ip_v4_address: "50.244.226.160"
date: 2022-11-02T11:32:25+00:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like ```50.244.226.160``` or an IPv6 address like ```2000:c943:be7a:cd85:641a:c9fa:3817:44a7```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```f2:26:07:dc:e1:e7```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://conroy-mcglynn.biz you initially access a DNS server to translate the host portion (conroy-mcglynn) combined with the Top Level Domain (biz) of the URL, to an IP address like ```222.39.151.80```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/41.0.2228.0 Safari/537.36```
...
<pre>
default   fe80:b1b8:e4f9:eff7:c423%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {242.168.212.131, 225.228.138.104}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr f2:26:07:dc:e1:e7
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 8c:c2:e7:b5:2a:c0
}</pre>
...
## Apple macOS / OSX
No matter what version of OSX/macOS you are on, ```10.11.6```, ```11.2.9```, or ```12.0.9```, there are a range of tools for troubleshooting. Unfortunately, between these manual actions and scripts, they don't give you a series of correlated values over time. This is where automated remote troubleshooting comes in to its own, especially for teams that embrace remote work and Work From Anywhere (WFA).
