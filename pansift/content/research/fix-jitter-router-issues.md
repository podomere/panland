...
layout: research
ip_v4_address: "119.135.126.216"
date: 2022-05-05T14:29:42+01:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like ```119.135.126.216``` or an IPv6 address like ```2000:a158:b0e5:e06e:b00d:4de4:986b:5719```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```d3:15:e7:14:16:9b```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://mosciski-kozey.com you initially access a DNS server to translate the host portion (mosciski-kozey) combined with the Top Level Domain (com) of the URL, to an IP address like ```181.142.47.82```. Your computer and browser actually sends its type with all web requests e.g. <br>```Opera/9.80 (X11; Linux i686; Ubuntu/14.10) Presto/2.12.388 Version/12.16```
...
<pre>
default   fe80:7437:661b:e588:9443%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {41.71.179.215, 220.2.49.231}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr d3:15:e7:14:16:9b
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr e7:56:08:6f:8f:85
}</pre>
