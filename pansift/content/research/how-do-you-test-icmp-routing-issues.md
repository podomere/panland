...
layout: research
ip_v4_address: "126.36.181.84"
date: 2023-10-06T17:11:06+01:00
draft: false
---

## Internet Addressing
On the Internet you may have a Public IPv4 address like ```126.36.181.84``` or an IPv6 address like ```2000:259d:f1d1:b283:c66f:626d:eeb5:30cd```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```5b:f0:2b:10:f8:2a```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://schaefer.net you initially access a DNS server to translate the host portion (schaefer) combined with the Top Level Domain (net) of the URL, to an IP address like ```87.154.177.49```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (compatible; MSIE 9.0; AOL 9.7; AOLBuild 4343.19; Windows NT 6.1; WOW64; Trident/5.0; FunWebProducts)```

## Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```192.168.146.57``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  192.168.146.57    UGScg  en0
...
<pre>
default   fe80:2da4:bf30:a7:5483%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {99.90.29.242, 137.45.216.33}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 5b:f0:2b:10:f8:2a
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr d9:19:ae:c6:89:73
}</pre>
...
### Apple macOS / OSX
No matter what version of OSX/macOS you are on, ```10.14.9```, ```11.4.1```, or ```12.3.8```, there are a range of tools for troubleshooting. Unfortunately, between these manual actions and scripts, they don't give you a series of correlated values over time. This is where automated remote troubleshooting comes in to its own, especially for teams that embrace remote work and Work From Anywhere (WFA).
