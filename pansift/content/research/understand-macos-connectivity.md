...
layout: research
ip_v4_address: "71.42.89.107"
date: 2022-06-04T14:38:27+01:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like ```71.42.89.107``` or an IPv6 address like ```2000:2db9:350:cf48:607:a0a6:476f:1fa8```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```12:68:d9:35:21:91```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://brown-schroeder.info you initially access a DNS server to translate the host portion (brown-schroeder) combined with the Top Level Domain (info) of the URL, to an IP address like ```227.74.30.26```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/41.0.2228.0 Safari/537.36```
...
<pre>
default   fe80:b3e8:e1a2:5d71:3376%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {10.177.189.129, 246.24.196.94}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 12:68:d9:35:21:91
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 71:e5:e8:15:66:89
}</pre>
