...
layout: research
ip_v4_address: "231.234.7.36"
date: 2022-11-19T19:13:23+00:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like ```231.234.7.36``` or an IPv6 address like ```2000:a0ac:6162:f006:bd62:4d57:327b:d68a```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```f2:95:b6:59:cb:e3```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://mcglynn-bauch.net you initially access a DNS server to translate the host portion (mcglynn-bauch) combined with the Top Level Domain (net) of the URL, to an IP address like ```87.61.108.252```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1; WOW64; Trident/7.0; AS; rv:11.0) like Gecko```
...
<pre>
default   fe80:1795:b293:fb0d:956f%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {251.121.77.42, 196.83.83.13}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr f2:95:b6:59:cb:e3
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 81:01:ed:68:91:d5
}</pre>
