...
layout: research
ip_v4_address: "109.209.77.194"
date: 2022-06-12T14:09:28+01:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like ```109.209.77.194``` or an IPv6 address like ```2000:fb4:f8ef:74a:635c:7619:27de:360a```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```7b:5c:db:8c:b5:49```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://ankunding-senger.net you initially access a DNS server to translate the host portion (ankunding-senger) combined with the Top Level Domain (net) of the URL, to an IP address like ```69.53.249.34```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT x.y; Win64; x64; rv:10.0) Gecko/20100101 Firefox/10.0```
...
<pre>
default   fe80:ccf1:21dd:92ae:54cb%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {14.203.171.117, 92.29.71.128}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 7b:5c:db:8c:b5:49
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 8c:4a:99:28:8a:92
}</pre>
