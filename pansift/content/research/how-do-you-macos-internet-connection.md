...
layout: research
ip_v4_address: "17.23.183.157"
date: 2022-06-04T14:38:28+01:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like ```17.23.183.157``` or an IPv6 address like ```2000:32fc:3e3c:6b55:45ae:b2c0:57ea:e70a```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```ff:26:13:09:b2:21```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://ratke.org you initially access a DNS server to translate the host portion (ratke) combined with the Top Level Domain (org) of the URL, to an IP address like ```89.167.199.97```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_3) AppleWebKit/537.75.14 (KHTML, like Gecko) Version/7.0.3 Safari/7046A194A```

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```10.181.172.149``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  10.181.172.149    UGScg  en0
...
<pre>
default   64:ae3f:d0a2:a709:f563:eee4:277b:b6a%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {155.166.97.83, 111.64.216.130}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr ff:26:13:09:b2:21
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 95:de:cd:5f:16:b3
}</pre>
