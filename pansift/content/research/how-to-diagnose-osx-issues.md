...
subtitle: "Ideate?"
layout: research
ip_v4_address: "60.145.167.185"
date: 2022-12-15T13:50:10+00:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like ```60.145.167.185``` or an IPv6 address like ```2000:c628:b22e:5095:fd7b:17b3:d313:a431```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```f9:cc:b7:76:e5:ac```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://gerlach.io you initially access a DNS server to translate the host portion (gerlach) combined with the Top Level Domain (io) of the URL, to an IP address like ```44.139.156.202```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT x.y; Win64; x64; rv:10.0) Gecko/20100101 Firefox/10.0```

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```10.243.148.58``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  10.243.148.58    UGScg  en0
...
<pre>
default   fe80:6fd:d500:715d:309a%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {239.54.236.255, 90.228.108.200}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr f9:cc:b7:76:e5:ac
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 59:1e:2c:62:2b:85
}</pre>
