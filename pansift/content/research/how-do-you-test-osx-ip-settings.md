...
layout: research
ip_v4_address: "148.223.67.132"
date: 2022-11-19T19:13:16+00:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like ```148.223.67.132``` or an IPv6 address like ```2000:e470:9d43:c27c:65da:4218:6384:c657```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```29:97:05:8b:66:5b```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://simonis-bauch.io you initially access a DNS server to translate the host portion (simonis-bauch) combined with the Top Level Domain (io) of the URL, to an IP address like ```156.86.242.14```. Your computer and browser actually sends its type with all web requests e.g. <br>```Opera/9.80 (X11; Linux i686; Ubuntu/14.10) Presto/2.12.388 Version/12.16```
...
<pre>
default   fe80:c510:f7e5:3b22:865b%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {40.29.224.1, 248.240.21.57}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 29:97:05:8b:66:5b
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr d2:b8:a8:bb:d1:90
}</pre>
