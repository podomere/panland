...
layout: research
ip_v4_address: "118.91.192.247"
date: 2022-06-12T14:09:24+01:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like ```118.91.192.247``` or an IPv6 address like ```2000:623f:8e1e:2e3:b118:54a1:7d0a:a1a9```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```05:9e:29:b9:94:9b```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://windler-reilly.io you initially access a DNS server to translate the host portion (windler-reilly) combined with the Top Level Domain (io) of the URL, to an IP address like ```7.158.128.90```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1; WOW64; Trident/7.0; AS; rv:11.0) like Gecko```
...
<pre>
default   fe80:9c1e:82c0:fe51:6c79%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {120.96.79.131, 100.232.46.119}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 05:9e:29:b9:94:9b
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 21:00:bd:b9:99:3a
}</pre>
