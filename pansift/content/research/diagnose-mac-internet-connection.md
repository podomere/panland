...
layout: research
ip_v4_address: "149.46.163.78"
date: 2023-02-04T17:07:49+00:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like ```149.46.163.78``` or an IPv6 address like ```2000:6897:6560:9392:196:c73e:b443:36bd```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```d6:72:a9:6e:6c:54```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://schumm-kulas.org you initially access a DNS server to translate the host portion (schumm-kulas) combined with the Top Level Domain (org) of the URL, to an IP address like ```84.198.34.177```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (compatible; MSIE 9.0; AOL 9.7; AOLBuild 4343.19; Windows NT 6.1; WOW64; Trident/5.0; FunWebProducts)```
...
<pre>
default   fe80:f1f9:4a0b:3d8:96ae%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {212.101.218.211, 78.216.113.75}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr d6:72:a9:6e:6c:54
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 6a:27:cb:41:cb:6d
}</pre>
