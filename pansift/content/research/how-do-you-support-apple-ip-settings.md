...
layout: research
ip_v4_address: "140.199.208.233"
date: 2022-12-15T13:50:11+00:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like ```140.199.208.233``` or an IPv6 address like ```2000:98f3:cd74:5069:dd5b:e75:9af0:8c7b```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```cc:5f:03:d1:49:ca```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://schumm-lindgren.name you initially access a DNS server to translate the host portion (schumm-lindgren) combined with the Top Level Domain (name) of the URL, to an IP address like ```150.16.164.184```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1; WOW64; Trident/7.0; AS; rv:11.0) like Gecko```
...
<pre>
default   fe80:b663:7229:3935:b756%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {0.127.202.78, 65.27.159.54}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr cc:5f:03:d1:49:ca
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr a8:bb:c6:7b:87:9a
}</pre>
