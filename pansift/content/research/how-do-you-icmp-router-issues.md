...
subtitle: "Learnings?"
layout: research
ip_v4_address: "87.119.208.187"
date: 2022-05-05T14:29:54+01:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like ```87.119.208.187``` or an IPv6 address like ```2000:6198:b28e:4313:2894:45d1:82ab:f1ec```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```7e:fa:b8:9b:18:c0```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://carter.org you initially access a DNS server to translate the host portion (carter) combined with the Top Level Domain (org) of the URL, to an IP address like ```55.44.232.14```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT x.y; Win64; x64; rv:10.0) Gecko/20100101 Firefox/10.0```

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```172.22.241.121``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  172.22.241.121    UGScg  en0
...
<pre>
default   fe80:81cf:98ae:4e0f:819%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {143.51.119.161, 221.13.132.163}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 7e:fa:b8:9b:18:c0
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr c3:6d:4c:4b:0d:c1
}</pre>
...
## Apple macOS / OSX
No matter what version of OSX/macOS you are on, ```10.13.6```, ```11.4.5```, or ```12.3.2```, there are a range of tools for troubleshooting. Unfortunately, between these manual actions and scripts, they don't give you a series of correlated values over time. This is where automated remote troubleshooting comes in to its own, especially for teams that embrace remote work and Work From Anywhere (WFA).
