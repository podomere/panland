...
subtitle: "Swim Lane?"
layout: research
ip_v4_address: "6.83.173.66"
date: 2022-11-19T16:17:23+00:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like ```6.83.173.66``` or an IPv6 address like ```2000:ee32:c911:d97d:fad1:7e7b:61ec:a889```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```6a:15:89:20:da:93```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://graham-medhurst.biz you initially access a DNS server to translate the host portion (graham-medhurst) combined with the Top Level Domain (biz) of the URL, to an IP address like ```240.202.198.146```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_3) AppleWebKit/537.75.14 (KHTML, like Gecko) Version/7.0.3 Safari/7046A194A```
...
<pre>
default   fe80:98f8:d46e:a56c:2e52%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {169.198.39.196, 9.249.168.111}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 6a:15:89:20:da:93
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 48:41:72:ed:0b:70
}</pre>
