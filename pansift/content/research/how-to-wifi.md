...
layout: research
ip_v4_address: "244.140.76.51"
date: 2023-02-04T16:26:02+00:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like ```244.140.76.51``` or an IPv6 address like ```2000:a028:e436:92:ed3f:6e6b:6ca7:a2b4```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```70:36:92:aa:48:6c```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://ondricka.info you initially access a DNS server to translate the host portion (ondricka) combined with the Top Level Domain (info) of the URL, to an IP address like ```222.28.186.120```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/41.0.2228.0 Safari/537.36```

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```10.201.227.182``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  10.201.227.182    UGScg  en0
...
<pre>
default   fe80:1a86:8d69:c703:f6d9%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {60.199.50.243, 180.19.1.100}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 70:36:92:aa:48:6c
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 90:a9:80:a4:81:b8
}</pre>
