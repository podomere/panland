...
subtitle: "Deep Dive?"
layout: research
ip_v4_address: "57.38.156.17"
date: 2022-11-19T16:17:25+00:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like ```57.38.156.17``` or an IPv6 address like ```2000:4fab:1cb0:23b6:9f9c:1e8d:8e22:a50f```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```ce:f1:bd:d0:f6:92```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://kub.org you initially access a DNS server to translate the host portion (kub) combined with the Top Level Domain (org) of the URL, to an IP address like ```60.253.49.27```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows; U; Win 9x 4.90; SG; rv:1.9.2.4) Gecko/20101104 Netscape/9.1.0285```

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```192.168.222.120``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  192.168.222.120    UGScg  en0
...
<pre>
default   fe80:6a3a:7ed9:98e2:3e92%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {232.75.144.122, 141.217.40.129}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr ce:f1:bd:d0:f6:92
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 80:1c:f7:9b:3e:1e
}</pre>
...
## Apple macOS / OSX
No matter what version of OSX/macOS you are on, ```10.12.3```, ```11.4.9```, or ```12.2.9```, there are a range of tools for troubleshooting. Unfortunately, between these manual actions and scripts, they don't give you a series of correlated values over time. This is where automated remote troubleshooting comes in to its own, especially for teams that embrace remote work and Work From Anywhere (WFA).
