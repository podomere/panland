...
subtitle: "Granular?"
layout: research
ip_v4_address: "15.190.28.13"
date: 2023-10-06T17:10:41+01:00
draft: false
---

## Internet Addressing
On the Internet you might get a Public IPv4 address like ```15.190.28.13``` or an IPv6 address like ```2000:a200:2ca3:aadc:ac3f:362c:4825:2c2c```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```64:e9:c7:89:c6:64```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://mitchell-mohr.com you initially access a DNS server to translate the host portion (mitchell-mohr) combined with the Top Level Domain (com) of the URL, to an IP address like ```207.103.1.226```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_3) AppleWebKit/537.75.14 (KHTML, like Gecko) Version/7.0.3 Safari/7046A194A```
...
<pre>
default   fe80:6baa:7c5e:e460:e80b%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {143.180.161.161, 0.93.33.155}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 64:e9:c7:89:c6:64
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 1d:2a:35:86:83:11
}</pre>
