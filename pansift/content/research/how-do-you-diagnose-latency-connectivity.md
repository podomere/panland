...
layout: research
ip_v4_address: "169.16.104.225"
date: 2023-02-04T17:08:37+00:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like ```169.16.104.225``` or an IPv6 address like ```2000:cdde:480d:dd53:22c9:7c37:5753:4c41```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```0c:e7:c2:d8:04:e4```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://torphy-steuber.name you initially access a DNS server to translate the host portion (torphy-steuber) combined with the Top Level Domain (name) of the URL, to an IP address like ```95.169.75.128```. Your computer and browser actually sends its type with all web requests e.g. <br>```Opera/9.80 (X11; Linux i686; Ubuntu/14.10) Presto/2.12.388 Version/12.16```
...
<pre>
default   fe80:d27a:69a6:c170:b93a%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {201.202.218.90, 71.29.86.5}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 0c:e7:c2:d8:04:e4
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 46:85:b0:d3:b5:0b
}</pre>
