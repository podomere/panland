...
layout: research
ip_v4_address: "210.125.163.181"
date: 2022-04-24T18:31:57+01:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like <code>210.125.163.181</code> or an IPv6 address like <code>2000:2ade:cbb0:861e:95e7:d27e:d16c:dd07</code>. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>af:7b:4f:a0:37:67</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://dibbert-kautzer.info you initially access a DNS server to translate the host portion (dibbert-kautzer) combined with the Top Level Domain (info) of the URL, to an IP address like <code>180.91.180.234</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (Windows NT x.y; Win64; x64; rv:10.0) Gecko/20100101 Firefox/10.0</code>
...
<pre><code>
default   fe80:60be:19a9:1614:337b%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {234.93.231.1, 164.251.149.251}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr af:7b:4f:a0:37:67
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr da:29:31:0a:e2:c6
}</code></pre>
