...
layout: research
ip_v4_address: "210.131.66.106"
date: 2022-11-19T19:13:27+00:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like ```210.131.66.106``` or an IPv6 address like ```2000:8fac:11a3:3e44:3e9e:a021:4858:60a5```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```72:81:fa:65:4e:96```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://hudson-rau.co you initially access a DNS server to translate the host portion (hudson-rau) combined with the Top Level Domain (co) of the URL, to an IP address like ```63.0.170.232```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows; U; Win 9x 4.90; SG; rv:1.9.2.4) Gecko/20101104 Netscape/9.1.0285```
...
<pre>
default   fe80:f284:f801:ae83:cf01%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {222.28.82.178, 19.50.2.85}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 72:81:fa:65:4e:96
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 97:4a:09:0e:ad:b3
}</pre>
