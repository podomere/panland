...
layout: research
ip_v4_address: "142.192.175.68"
date: 2023-10-06T17:11:05+01:00
draft: false
---

## Internet Addressing
On the Internet you may have a Public IPv4 address like ```142.192.175.68``` or an IPv6 address like ```2000:8560:1790:c750:b62f:3289:6c17:b54e```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```d4:a6:16:f4:59:c5```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://hettinger.net you initially access a DNS server to translate the host portion (hettinger) combined with the Top Level Domain (net) of the URL, to an IP address like ```77.9.163.254```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows; U; Win 9x 4.90; SG; rv:1.9.2.4) Gecko/20101104 Netscape/9.1.0285```

## Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```172.20.26.186``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  172.20.26.186    UGScg  en0
...
<pre>
default   fe80:7bf7:f1c2:d76f:63bc%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {119.194.161.145, 150.189.63.250}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr d4:a6:16:f4:59:c5
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 4d:53:f2:e1:ec:96
}</pre>
...
### Apple macOS / OSX
No matter what version of OSX/macOS you are on, ```10.12.8```, ```11.4.1```, or ```12.0.4```, there are a range of tools for troubleshooting. Unfortunately, between these manual actions and scripts, they don't give you a series of correlated values over time. This is where automated remote troubleshooting comes in to its own, especially for teams that embrace remote work and Work From Anywhere (WFA).
