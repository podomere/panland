...
subtitle: "Deep Dive?"
layout: research
ip_v4_address: "191.211.114.103"
date: 2023-02-04T16:26:23+00:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like ```191.211.114.103``` or an IPv6 address like ```2000:f1b3:420:5358:97d1:deda:7b8d:a987```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```8f:09:e6:41:a5:4b```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://hills-marks.info you initially access a DNS server to translate the host portion (hills-marks) combined with the Top Level Domain (info) of the URL, to an IP address like ```160.9.100.153```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/41.0.2228.0 Safari/537.36```
...
<pre>
default   fe80:90c6:30b8:6c57:e376%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {59.65.8.90, 9.199.218.135}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 8f:09:e6:41:a5:4b
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr d6:27:bd:9d:52:a6
}</pre>
