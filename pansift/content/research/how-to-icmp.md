...
layout: research
ip_v4_address: "54.185.32.153"
date: 2023-10-29T15:13:27+00:00
draft: false
---

## Internet Addressing
On the Internet you may get a Public IPv4 address like ```54.185.32.153``` or an IPv6 address like ```2000:b627:4ce4:a400:98e7:cb6d:5dbf:86f2```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```c3:28:56:ad:27:d7```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://yost-dare.biz you initially access a DNS server to translate the host portion (yost-dare) combined with the Top Level Domain (biz) of the URL, to an IP address like ```104.120.133.158```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows; U; Win 9x 4.90; SG; rv:1.9.2.4) Gecko/20101104 Netscape/9.1.0285```
...
<pre>
default   fe80:8af7:b9c7:2e3d:3853%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {129.207.74.215, 2.18.56.75}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr c3:28:56:ad:27:d7
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 52:5d:7e:c7:07:ae
}</pre>
