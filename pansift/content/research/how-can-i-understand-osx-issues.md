...
layout: research
ip_v4_address: "101.174.11.125"
date: 2023-10-29T15:13:19+00:00
draft: false
---

## Internet Addressing
On the Internet you might have a Public IPv4 address like ```101.174.11.125``` or an IPv6 address like ```2000:944a:842d:360f:f7f8:e6bb:8f98:d9b3```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```42:29:3d:d7:35:eb```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://oconner-pfeffer.com you initially access a DNS server to translate the host portion (oconner-pfeffer) combined with the Top Level Domain (com) of the URL, to an IP address like ```26.45.72.60```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (compatible; MSIE 9.0; AOL 9.7; AOLBuild 4343.19; Windows NT 6.1; WOW64; Trident/5.0; FunWebProducts)```
...
<pre>
default   fe80:1e1f:324e:e1c9:93fc%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {125.2.35.150, 186.210.105.113}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 42:29:3d:d7:35:eb
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 60:e3:d5:bc:01:b1
}</pre>
