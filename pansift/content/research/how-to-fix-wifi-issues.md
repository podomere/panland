...
layout: research
ip_v4_address: "146.92.8.51"
date: 2022-04-24T18:32:41+01:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like <code>146.92.8.51</code> or an IPv6 address like <code>2000:f1de:934a:7a5f:cb13:bae5:30ad:a60d</code>. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>15:de:2d:a3:30:8a</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://rippin.net you initially access a DNS server to translate the host portion (rippin) combined with the Top Level Domain (net) of the URL, to an IP address like <code>8.30.67.255</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Opera/9.80 (X11; Linux i686; Ubuntu/14.10) Presto/2.12.388 Version/12.16</code>
...
<pre><code>
default   fe80:da05:b13c:9b16:fd9f%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {88.249.192.190, 183.100.252.13}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 15:de:2d:a3:30:8a
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 32:10:52:2a:93:14
}</code></pre>
