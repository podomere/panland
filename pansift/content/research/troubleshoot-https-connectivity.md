---
title: "Troubleshoot Https Connectivity"
subtitle: "Out Of The Box?"
layout: research
ip_v4_address: "188.2.254.247"
date: 2022-04-24T19:00:05+01:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like <code>188.2.254.247</code> or an IPv6 address like <code>2000:1f9b:3dec:5737:964d:8215:3bd9:38b3</code>. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>da:99:1f:1e:d1:8a</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://daniel-barrows.name you initially access a DNS server to translate the host portion (daniel-barrows) combined with the Top Level Domain (name) of the URL, to an IP address like <code>115.60.249.70</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (Windows NT 6.1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/41.0.2228.0 Safari/537.36</code>
...
<pre><code>
default   fe80:1700:cd1c:2cc8:17e%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {50.56.158.36, 170.219.217.92}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr da:99:1f:1e:d1:8a
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 03:4b:28:6d:cd:7d
}</code></pre>
