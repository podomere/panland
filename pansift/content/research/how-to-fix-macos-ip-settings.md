...
layout: research
ip_v4_address: "192.185.148.184"
date: 2023-02-04T17:07:48+00:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like ```192.185.148.184``` or an IPv6 address like ```2000:7f25:af68:4bc5:8c9a:846f:f3a7:9faa```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```97:25:42:79:98:a3```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://rath.io you initially access a DNS server to translate the host portion (rath) combined with the Top Level Domain (io) of the URL, to an IP address like ```178.134.252.180```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT x.y; Win64; x64; rv:10.0) Gecko/20100101 Firefox/10.0```
...
<pre>
default   fe80:7db8:deeb:9e3f:c7e6%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {227.238.13.211, 95.80.243.39}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 97:25:42:79:98:a3
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 09:b2:d3:c4:90:bc
}</pre>
