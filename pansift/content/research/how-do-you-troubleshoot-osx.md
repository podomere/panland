...
layout: research
ip_v4_address: "132.253.115.118"
date: 2022-05-05T14:28:51+01:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like ```132.253.115.118``` or an IPv6 address like ```2000:6cfe:76ac:af6a:707a:1f89:6188:e7a```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```6e:43:ff:09:28:ad```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://hoeger-hackett.name you initially access a DNS server to translate the host portion (hoeger-hackett) combined with the Top Level Domain (name) of the URL, to an IP address like ```165.45.76.109```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1; WOW64; Trident/7.0; AS; rv:11.0) like Gecko```
...
<pre>
default   fe80:b246:afea:2756:7553%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {60.99.135.251, 133.199.127.9}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 6e:43:ff:09:28:ad
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 9c:55:3e:3c:68:b7
}</pre>
