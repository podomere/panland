...
layout: research
ip_v4_address: "188.43.47.32"
date: 2022-05-05T14:30:16+01:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like ```188.43.47.32``` or an IPv6 address like ```2000:889:72f4:9f75:26b7:66b1:a484:5986```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```71:dd:45:90:b8:60```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://farrell-quitzon.com you initially access a DNS server to translate the host portion (farrell-quitzon) combined with the Top Level Domain (com) of the URL, to an IP address like ```162.65.35.110```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1; WOW64; Trident/7.0; AS; rv:11.0) like Gecko```
...
<pre>
default   fe80:a41d:f825:98c4:221%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {20.91.82.184, 201.217.10.91}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 71:dd:45:90:b8:60
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 68:6e:2d:dd:d7:2b
}</pre>
