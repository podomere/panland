...
layout: research
ip_v4_address: "101.157.114.209"
date: 2022-05-05T14:28:24+01:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like ```101.157.114.209``` or an IPv6 address like ```2000:c1e8:545b:5f01:31b:4092:ba65:b656```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```2d:42:ca:0e:27:e0```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://hintz-schroeder.io you initially access a DNS server to translate the host portion (hintz-schroeder) combined with the Top Level Domain (io) of the URL, to an IP address like ```188.16.204.27```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (compatible; MSIE 9.0; AOL 9.7; AOLBuild 4343.19; Windows NT 6.1; WOW64; Trident/5.0; FunWebProducts)```
...
<pre>
default   fe80:2b4f:d782:97ed:426%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {101.146.49.181, 9.63.241.86}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 2d:42:ca:0e:27:e0
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr f0:6a:f7:8a:87:4d
}</pre>
