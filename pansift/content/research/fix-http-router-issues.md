...
layout: research
ip_v4_address: "136.84.143.50"
date: 2022-11-19T19:13:28+00:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like ```136.84.143.50``` or an IPv6 address like ```2000:dbd7:c29b:a2ec:45cf:34fc:a68d:7979```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```05:9e:a7:7b:a0:11```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://thiel-bogan.info you initially access a DNS server to translate the host portion (thiel-bogan) combined with the Top Level Domain (info) of the URL, to an IP address like ```144.131.4.166```. Your computer and browser actually sends its type with all web requests e.g. <br>```Opera/9.80 (X11; Linux i686; Ubuntu/14.10) Presto/2.12.388 Version/12.16```
...
<pre>
default   fe80:4f0:3929:545a:b0dc%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {62.82.15.159, 101.253.255.41}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 05:9e:a7:7b:a0:11
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 3f:00:5c:c2:19:e3
}</pre>
