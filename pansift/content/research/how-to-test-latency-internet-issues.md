...
subtitle: "Etc. Etc.?"
layout: research
ip_v4_address: "136.60.205.109"
date: 2023-10-06T17:11:04+01:00
draft: false
---

## Internet Addressing
On the Internet you may have a Public IPv4 address like ```136.60.205.109``` or an IPv6 address like ```2000:4d95:8948:29b:535e:e5ef:86df:5cba```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```4d:53:1b:77:bd:c5```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://gusikowski-sipes.org you initially access a DNS server to translate the host portion (gusikowski-sipes) combined with the Top Level Domain (org) of the URL, to an IP address like ```175.105.146.113```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1; WOW64; Trident/7.0; AS; rv:11.0) like Gecko```

## Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```10.153.227.97``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  10.153.227.97    UGScg  en0
...
<pre>
default   fe80:701d:662d:fa62:2f2f%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {162.73.147.203, 2.166.136.121}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 4d:53:1b:77:bd:c5
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 57:1a:a4:a6:36:ba
}</pre>
