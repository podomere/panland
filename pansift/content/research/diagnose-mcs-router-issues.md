...
subtitle: "Heads Down?"
layout: research
ip_v4_address: "249.163.132.124"
date: 2023-02-04T16:26:03+00:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like ```249.163.132.124``` or an IPv6 address like ```2000:23c5:f0de:f8d0:59d1:9de:ed30:e1e9```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```84:51:a4:92:63:7d```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://beahan.name you initially access a DNS server to translate the host portion (beahan) combined with the Top Level Domain (name) of the URL, to an IP address like ```81.137.213.4```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_3) AppleWebKit/537.75.14 (KHTML, like Gecko) Version/7.0.3 Safari/7046A194A```

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```172.16.230.213``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  172.16.230.213    UGScg  en0
...
<pre>
default   fe80:bf69:6c59:cac1:16bb%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {59.146.244.225, 54.92.238.231}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 84:51:a4:92:63:7d
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 30:6b:9a:ce:fe:db
}</pre>
