...
layout: research
ip_v4_address: "50.229.247.63"
date: 2022-11-19T16:17:13+00:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like ```50.229.247.63``` or an IPv6 address like ```2000:2f39:9dc8:604b:2029:ef4e:9986:caa0```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```ed:ae:e7:da:76:44```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://gerlach.org you initially access a DNS server to translate the host portion (gerlach) combined with the Top Level Domain (org) of the URL, to an IP address like ```156.21.80.249```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_3) AppleWebKit/537.75.14 (KHTML, like Gecko) Version/7.0.3 Safari/7046A194A```

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```10.168.73.211``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  10.168.73.211    UGScg  en0
...
<pre>
default   fe80:a030:bdd6:f594:2a16%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {119.113.211.92, 173.231.131.43}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr ed:ae:e7:da:76:44
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 72:1c:46:e1:cc:17
}</pre>
