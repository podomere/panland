...
layout: research
ip_v4_address: "146.87.78.162"
date: 2022-11-19T16:17:23+00:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like ```146.87.78.162``` or an IPv6 address like ```2000:13d:8983:9887:9afc:409c:c809:2605```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```02:b9:84:31:37:3c```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://bogan-pouros.net you initially access a DNS server to translate the host portion (bogan-pouros) combined with the Top Level Domain (net) of the URL, to an IP address like ```170.83.167.122```. Your computer and browser actually sends its type with all web requests e.g. <br>```Opera/9.80 (X11; Linux i686; Ubuntu/14.10) Presto/2.12.388 Version/12.16```
...
<pre>
default   fe80:e16e:663:dc47:87e4%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {60.96.59.67, 53.31.135.165}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 02:b9:84:31:37:3c
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 93:32:67:34:2f:6e
}</pre>
