...
layout: research
ip_v4_address: "119.91.43.161"
date: 2022-12-15T13:50:21+00:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like ```119.91.43.161``` or an IPv6 address like ```2000:1b3c:deb4:1eb0:4a5e:daf1:b08b:ce0d```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```38:e9:9e:e2:f9:f8```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://lindgren.biz you initially access a DNS server to translate the host portion (lindgren) combined with the Top Level Domain (biz) of the URL, to an IP address like ```186.216.76.112```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1; WOW64; Trident/7.0; AS; rv:11.0) like Gecko```

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```10.155.42.73``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  10.155.42.73    UGScg  en0
...
<pre>
default   fe80:cee5:11e1:2048:740%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {189.59.248.104, 132.163.41.10}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 38:e9:9e:e2:f9:f8
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr b3:95:80:f3:b8:71
}</pre>
