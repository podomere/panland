...
subtitle: "Swag?"
layout: research
ip_v4_address: "183.191.57.171"
date: 2023-10-06T17:11:05+01:00
draft: false
---

## Internet Addressing
On the Internet you might get a Public IPv4 address like ```183.191.57.171``` or an IPv6 address like ```2000:8f0:7562:168b:22ff:5e17:7822:e8ce```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```04:7b:50:c3:d3:bd```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://gislason-schamberger.co you initially access a DNS server to translate the host portion (gislason-schamberger) combined with the Top Level Domain (co) of the URL, to an IP address like ```223.182.233.247```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows; U; Win 9x 4.90; SG; rv:1.9.2.4) Gecko/20101104 Netscape/9.1.0285```
...
<pre>
default   fe80:658b:612b:d4f3:95b0%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {32.193.162.213, 205.112.201.3}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 04:7b:50:c3:d3:bd
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 6a:24:58:fe:5f:0d
}</pre>
