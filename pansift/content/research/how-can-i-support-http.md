...
layout: research
ip_v4_address: "106.80.207.214"
date: 2023-02-04T17:08:40+00:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like ```106.80.207.214``` or an IPv6 address like ```2000:96c3:45bf:b8e2:fb0e:f42b:ef33:a36d```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```c6:a8:55:c8:69:4b```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://legros-schoen.net you initially access a DNS server to translate the host portion (legros-schoen) combined with the Top Level Domain (net) of the URL, to an IP address like ```3.169.137.12```. Your computer and browser actually sends its type with all web requests e.g. <br>```Opera/9.80 (X11; Linux i686; Ubuntu/14.10) Presto/2.12.388 Version/12.16```
...
default  172.29.63.62    UGScg  en0
...
<pre>
default   fe80:8e0f:243a:1934:9eb7%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {243.94.112.244, 32.122.176.9}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr c6:a8:55:c8:69:4b
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 21:d8:84:52:6c:8d
}</pre>
