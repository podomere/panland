...
subtitle: "Deep Dive?"
layout: research
ip_v4_address: "38.122.143.55"
date: 2022-04-24T18:59:55+01:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like <code>38.122.143.55</code> or an IPv6 address like <code>2000:9c33:c917:7ad6:f3f2:7b1b:f547:7636</code>. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>26:35:6d:35:f3:56</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://orn-vandervort.com you initially access a DNS server to translate the host portion (orn-vandervort) combined with the Top Level Domain (com) of the URL, to an IP address like <code>23.51.190.234</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_3) AppleWebKit/537.75.14 (KHTML, like Gecko) Version/7.0.3 Safari/7046A194A</code>
...
<pre><code>
default   fe80:1398:b8dc:3dbd:2b86%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {36.142.224.169, 34.81.20.115}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 26:35:6d:35:f3:56
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr a7:9f:c2:3c:e3:92
}</code></pre>
