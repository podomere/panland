...
subtitle: "Synergy?"
layout: research
ip_v4_address: "142.49.221.246"
date: 2022-11-02T11:32:24+00:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like ```142.49.221.246``` or an IPv6 address like ```2000:acd3:19e1:cd07:e08:777b:cf17:781e```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```d4:aa:5d:94:71:0b```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://parisian-johnson.name you initially access a DNS server to translate the host portion (parisian-johnson) combined with the Top Level Domain (name) of the URL, to an IP address like ```70.191.16.14```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT x.y; Win64; x64; rv:10.0) Gecko/20100101 Firefox/10.0```
...
<pre>
default   fe80:e7c0:672b:5b07:a312%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {103.195.41.153, 39.84.134.239}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr d4:aa:5d:94:71:0b
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 62:66:56:35:89:5a
}</pre>
