...
layout: research
ip_v4_address: "42.252.19.84"
date: 2023-10-06T17:11:07+01:00
draft: false
---

## Internet Addressing
On the Internet you may have a Public IPv4 address like ```42.252.19.84``` or an IPv6 address like ```2000:c95c:de73:93b1:c3ce:6238:ea9c:a199```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```cd:f6:fd:ca:42:18```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://windler-bayer.net you initially access a DNS server to translate the host portion (windler-bayer) combined with the Top Level Domain (net) of the URL, to an IP address like ```14.19.64.52```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1; WOW64; Trident/7.0; AS; rv:11.0) like Gecko```
...
<pre>
default   fe80:17e2:e337:7e41:a68%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {50.55.28.8, 232.61.248.249}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr cd:f6:fd:ca:42:18
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr bb:65:6a:04:bb:fc
}</pre>
