...
layout: research
ip_v4_address: "87.220.30.212"
date: 2022-05-05T14:29:57+01:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like ```87.220.30.212``` or an IPv6 address like ```2000:7efd:97af:8007:dfc6:171b:2069:3ba1```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```84:d9:29:a6:75:02```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://thompson.io you initially access a DNS server to translate the host portion (thompson) combined with the Top Level Domain (io) of the URL, to an IP address like ```191.160.168.188```. Your computer and browser actually sends its type with all web requests e.g. <br>```Opera/9.80 (X11; Linux i686; Ubuntu/14.10) Presto/2.12.388 Version/12.16```
...
<pre>
default   fe80:4170:9ebe:e738:39a7%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {85.173.189.80, 125.126.137.167}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 84:d9:29:a6:75:02
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 68:4f:e5:da:63:d3
}</pre>
