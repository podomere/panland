...
layout: research
ip_v4_address: "104.131.136.210"
date: 2023-02-04T16:26:20+00:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like ```104.131.136.210``` or an IPv6 address like ```2000:1ea1:6079:95eb:fd58:3638:9849:a094```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```2b:36:34:45:c5:b0```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://hahn-turcotte.com you initially access a DNS server to translate the host portion (hahn-turcotte) combined with the Top Level Domain (com) of the URL, to an IP address like ```197.10.21.108```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1; WOW64; Trident/7.0; AS; rv:11.0) like Gecko```
...
<pre>
default   fe80:e693:864c:fa1d:e54d%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {104.138.57.31, 233.240.98.6}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 2b:36:34:45:c5:b0
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr ac:ab:1d:93:98:9b
}</pre>
