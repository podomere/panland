...
layout: research
ip_v4_address: "138.166.174.89"
date: 2022-12-15T13:50:10+00:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like ```138.166.174.89``` or an IPv6 address like ```2000:f22b:afdd:c889:c38:c929:1de7:a884```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```af:54:e7:b3:f0:c5```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://hyatt-nader.net you initially access a DNS server to translate the host portion (hyatt-nader) combined with the Top Level Domain (net) of the URL, to an IP address like ```101.202.38.169```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows; U; Win 9x 4.90; SG; rv:1.9.2.4) Gecko/20101104 Netscape/9.1.0285```
...
<pre>
default   fe80:13f3:ba12:4539:5393%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {182.179.31.80, 225.180.230.248}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr af:54:e7:b3:f0:c5
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 82:55:67:5a:2b:02
}</pre>
