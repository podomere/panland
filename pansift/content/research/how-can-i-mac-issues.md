...
layout: research
ip_v4_address: "26.231.35.137"
date: 2022-11-02T11:33:12+00:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like ```26.231.35.137``` or an IPv6 address like ```2000:7418:213f:7e9e:bf78:39b7:612d:58b5```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```c6:7a:0d:35:b4:3e```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://ratke.biz you initially access a DNS server to translate the host portion (ratke) combined with the Top Level Domain (biz) of the URL, to an IP address like ```49.62.255.66```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_3) AppleWebKit/537.75.14 (KHTML, like Gecko) Version/7.0.3 Safari/7046A194A```
...
<pre>
default   fe80:afce:327d:dcb8:8e38%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {148.1.248.98, 191.250.228.162}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr c6:7a:0d:35:b4:3e
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr d0:e2:b6:48:a5:89
}</pre>
