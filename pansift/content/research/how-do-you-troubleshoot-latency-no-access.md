...
layout: research
ip_v4_address: "160.32.230.228"
date: 2022-05-05T14:29:41+01:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like ```160.32.230.228``` or an IPv6 address like ```2000:db35:6a8f:25be:e232:5da1:25fc:fb40```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```27:dc:a3:c5:c6:63```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://oconnell.biz you initially access a DNS server to translate the host portion (oconnell) combined with the Top Level Domain (biz) of the URL, to an IP address like ```181.51.48.172```. Your computer and browser actually sends its type with all web requests e.g. <br>```Opera/9.80 (X11; Linux i686; Ubuntu/14.10) Presto/2.12.388 Version/12.16```
...
<pre>
default   fe80:4b74:2d91:4243:64b6%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {75.44.233.185, 9.174.125.252}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 27:dc:a3:c5:c6:63
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 9d:99:8d:f8:29:dd
}</pre>
...
## Apple macOS / OSX
No matter what version of OSX/macOS you are on, ```10.13.2```, ```11.4.7```, or ```12.2.5```, there are a range of tools for troubleshooting. Unfortunately, between these manual actions and scripts, they don't give you a series of correlated values over time. This is where automated remote troubleshooting comes in to its own, especially for teams that embrace remote work and Work From Anywhere (WFA).
