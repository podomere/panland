...
layout: research
ip_v4_address: "143.50.32.128"
date: 2022-11-19T19:13:16+00:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like ```143.50.32.128``` or an IPv6 address like ```2000:5fb7:94af:7a88:66d0:e8b9:77e0:fdba```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```d9:fc:d1:49:c4:b2```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://schulist-borer.io you initially access a DNS server to translate the host portion (schulist-borer) combined with the Top Level Domain (io) of the URL, to an IP address like ```87.190.204.95```. Your computer and browser actually sends its type with all web requests e.g. <br>```Opera/9.80 (X11; Linux i686; Ubuntu/14.10) Presto/2.12.388 Version/12.16```
...
<pre>
default   fe80:1a39:682d:7ad6:316b%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {219.31.215.128, 141.162.142.13}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr d9:fc:d1:49:c4:b2
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 4e:3a:20:51:56:5c
}</pre>
