...
layout: research
ip_v4_address: "153.194.36.100"
date: 2022-04-24T18:31:59+01:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like <code>153.194.36.100</code> or an IPv6 address like <code>2000:9cfc:38f3:6269:eb04:80ab:435e:a67f</code>. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>4d:a5:40:2c:38:41</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://nicolas-larson.biz you initially access a DNS server to translate the host portion (nicolas-larson) combined with the Top Level Domain (biz) of the URL, to an IP address like <code>241.96.249.0</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (Windows; U; Win 9x 4.90; SG; rv:1.9.2.4) Gecko/20101104 Netscape/9.1.0285</code>

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like <code>10.105.95.35</code> (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For <code>IPv6</code> we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  10.105.95.35    UGScg  en0
...
<pre><code>
default   fe80:f1a1:44af:a606:19a%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {153.162.163.111, 204.176.74.75}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 4d:a5:40:2c:38:41
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 52:2b:12:08:41:c4
}</code></pre>
