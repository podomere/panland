...
subtitle: "Impact Map?"
layout: research
ip_v4_address: "99.248.211.252"
date: 2023-02-04T17:08:37+00:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like ```99.248.211.252``` or an IPv6 address like ```2000:525a:30c3:5d0:b075:58cb:33f1:d4d7```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```4e:35:53:6f:a7:c9```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://williamson-raynor.org you initially access a DNS server to translate the host portion (williamson-raynor) combined with the Top Level Domain (org) of the URL, to an IP address like ```37.171.25.27```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (compatible; MSIE 9.0; AOL 9.7; AOLBuild 4343.19; Windows NT 6.1; WOW64; Trident/5.0; FunWebProducts)```
...
<pre>
default   fe80:425a:b85:43db:91d8%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {20.217.9.203, 96.220.73.82}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 4e:35:53:6f:a7:c9
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 8c:75:21:b5:bd:2f
}</pre>
