...
layout: research
ip_v4_address: "200.178.162.244"
date: 2022-06-12T14:09:05+01:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like ```200.178.162.244``` or an IPv6 address like ```2000:444d:3716:4ea1:d109:24bc:469a:c7b2```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```ca:07:a2:2f:58:b2```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://kassulke-witting.net you initially access a DNS server to translate the host portion (kassulke-witting) combined with the Top Level Domain (net) of the URL, to an IP address like ```233.217.10.34```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_3) AppleWebKit/537.75.14 (KHTML, like Gecko) Version/7.0.3 Safari/7046A194A```
...
<pre>
default   81:4648:9973:d77d:805b:d7f3:4e6f:e520%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {4.126.64.143, 200.228.94.105}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr ca:07:a2:2f:58:b2
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 72:35:6a:7a:a4:72
}</pre>
...
## Apple macOS / OSX
No matter what version of OSX/macOS you are on, ```10.12.8```, ```11.5.2```, or ```12.2.2```, there are a range of tools for troubleshooting. Unfortunately, between these manual actions and scripts, they don't give you a series of correlated values over time. This is where automated remote troubleshooting comes in to its own, especially for teams that embrace remote work and Work From Anywhere (WFA).
