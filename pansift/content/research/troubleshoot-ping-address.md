...
layout: research
ip_v4_address: "111.8.173.213"
date: 2023-02-04T17:08:39+00:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like ```111.8.173.213``` or an IPv6 address like ```2000:b209:29f6:9d95:7ec7:6cb7:bf24:a0c1```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```56:fc:cf:93:60:df```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://haag-auer.net you initially access a DNS server to translate the host portion (haag-auer) combined with the Top Level Domain (net) of the URL, to an IP address like ```165.166.235.97```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (compatible; MSIE 9.0; AOL 9.7; AOLBuild 4343.19; Windows NT 6.1; WOW64; Trident/5.0; FunWebProducts)```
...
<pre>
default   fe80:dca9:198c:7be6:8e5c%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {179.68.205.51, 135.52.52.79}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 56:fc:cf:93:60:df
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 6e:de:28:1c:8b:45
}</pre>
