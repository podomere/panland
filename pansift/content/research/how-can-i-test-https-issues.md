...
layout: research
ip_v4_address: "159.145.132.133"
date: 2023-10-06T17:11:08+01:00
draft: false
---

## Internet Addressing
On the Internet you might get a Public IPv4 address like ```159.145.132.133``` or an IPv6 address like ```2000:b1d6:849a:82df:b58a:aa0f:7445:b589```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```5b:00:82:40:5b:5e```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://williamson.name you initially access a DNS server to translate the host portion (williamson) combined with the Top Level Domain (name) of the URL, to an IP address like ```50.250.148.199```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1; WOW64; Trident/7.0; AS; rv:11.0) like Gecko```

## Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```192.168.115.1``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  192.168.115.1    UGScg  en0
...
<pre>
default   fe80:d01e:f347:df66:6519%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {69.118.59.46, 197.108.241.197}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 5b:00:82:40:5b:5e
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr ce:7a:b1:11:e4:3b
}</pre>
