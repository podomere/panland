...
subtitle: "Deep Dive?"
layout: research
ip_v4_address: "19.117.233.224"
date: 2022-04-24T19:00:23+01:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like <code>19.117.233.224</code> or an IPv6 address like <code>2000:bac5:64d7:5fab:330:b9f4:f391:ffe</code>. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>b8:53:83:e0:9c:f0</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://glover-ferry.net you initially access a DNS server to translate the host portion (glover-ferry) combined with the Top Level Domain (net) of the URL, to an IP address like <code>144.161.39.114</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (Windows NT x.y; Win64; x64; rv:10.0) Gecko/20100101 Firefox/10.0</code>
...
<pre><code>
default   fe80:faf:64d1:6ec2:9fb5%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {201.17.142.118, 41.165.88.158}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr b8:53:83:e0:9c:f0
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr af:ee:42:d0:35:07
}</code></pre>
