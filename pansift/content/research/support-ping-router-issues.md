...
layout: research
ip_v4_address: "47.140.100.95"
date: 2022-05-05T14:29:57+01:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like ```47.140.100.95``` or an IPv6 address like ```2000:4c0:1bf:89ba:de82:22de:1491:63c8```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```64:ee:f6:ca:45:b2```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://yost-conn.io you initially access a DNS server to translate the host portion (yost-conn) combined with the Top Level Domain (io) of the URL, to an IP address like ```68.6.25.229```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_3) AppleWebKit/537.75.14 (KHTML, like Gecko) Version/7.0.3 Safari/7046A194A```
...
<pre>
default   fe80:868d:f3d:cf98:7965%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {29.44.121.210, 84.221.68.50}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 64:ee:f6:ca:45:b2
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 6f:ac:7f:49:fd:ad
}</pre>
