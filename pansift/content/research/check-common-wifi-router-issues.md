...
subtitle: "Ideate?"
layout: research
ip_v4_address: "2.109.190.2"
date: 2022-04-24T18:32:42+01:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like <code>2.109.190.2</code> or an IPv6 address like <code>2000:819c:31d2:6ab3:58b4:6525:a55e:2057</code>. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>12:bb:35:44:24:93</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://cormier-bogisich.io you initially access a DNS server to translate the host portion (cormier-bogisich) combined with the Top Level Domain (io) of the URL, to an IP address like <code>50.117.127.117</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (compatible; MSIE 9.0; AOL 9.7; AOLBuild 4343.19; Windows NT 6.1; WOW64; Trident/5.0; FunWebProducts)</code>
...
<pre><code>
default   fe80:41e6:df58:b585:50f5%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {128.172.248.30, 29.148.194.251}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 12:bb:35:44:24:93
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr c7:c1:94:ee:6a:71
}</code></pre>
