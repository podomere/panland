...
layout: research
ip_v4_address: "227.135.60.255"
date: 2022-04-24T18:31:57+01:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like <code>227.135.60.255</code> or an IPv6 address like <code>2000:cb0f:d6b7:471c:9a09:29e8:5458:c1c3</code>. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>42:7d:bb:42:85:1c</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://stamm.io you initially access a DNS server to translate the host portion (stamm) combined with the Top Level Domain (io) of the URL, to an IP address like <code>214.14.207.75</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (Windows; U; Win 9x 4.90; SG; rv:1.9.2.4) Gecko/20101104 Netscape/9.1.0285</code>
...
<pre><code>
default   fe80:f7a3:e9f1:c2b:b9fa%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {216.205.156.207, 28.253.14.234}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 42:7d:bb:42:85:1c
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 49:ce:3d:e5:79:23
}</code></pre>
