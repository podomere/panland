...
layout: research
ip_v4_address: "24.244.49.105"
date: 2023-10-29T15:13:13+00:00
draft: false
---

## Internet Addressing
On the Internet you might get a Public IPv4 address like ```24.244.49.105``` or an IPv6 address like ```2000:7201:e2f1:ad14:ad20:9b4d:7f06:c804```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```73:ef:ee:b6:b4:08```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://rempel.com you initially access a DNS server to translate the host portion (rempel) combined with the Top Level Domain (com) of the URL, to an IP address like ```199.120.4.45```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (compatible; MSIE 9.0; AOL 9.7; AOLBuild 4343.19; Windows NT 6.1; WOW64; Trident/5.0; FunWebProducts)```
...
<pre>
default   fe80:2340:8b5c:3993:2ec3%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {226.186.152.135, 126.0.227.217}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 73:ef:ee:b6:b4:08
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 2f:22:ad:64:5f:e2
}</pre>
...
### Apple macOS / OSX
No matter what version of OSX/macOS you are on, ```10.11.9```, ```11.6.5```, or ```12.0.5```, there are a range of tools for troubleshooting. Unfortunately, between these manual actions and scripts, they don't give you a series of correlated values over time. This is where automated remote troubleshooting comes in to its own, especially for teams that embrace remote work and Work From Anywhere (WFA).
