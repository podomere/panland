...
layout: research
ip_v4_address: "235.32.98.203"
date: 2023-02-04T17:08:37+00:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like ```235.32.98.203``` or an IPv6 address like ```2000:6124:7e8:f44b:7119:4fb0:6af7:60a7```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```02:06:9d:1c:1f:6b```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://monahan-kovacek.name you initially access a DNS server to translate the host portion (monahan-kovacek) combined with the Top Level Domain (name) of the URL, to an IP address like ```179.120.78.251```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_3) AppleWebKit/537.75.14 (KHTML, like Gecko) Version/7.0.3 Safari/7046A194A```
...
<pre>
default   fe80:83a9:78f4:9d93:77b8%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {122.190.206.211, 25.5.121.94}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 02:06:9d:1c:1f:6b
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr ef:43:5d:dc:a7:84
}</pre>
