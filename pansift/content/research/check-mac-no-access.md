...
layout: research
ip_v4_address: "42.68.39.10"
date: 2022-04-24T19:00:25+01:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like <code>42.68.39.10</code> or an IPv6 address like <code>2000:5854:7fd4:c4cb:fbe4:a88b:2720:8789</code>. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>c2:5a:5f:45:0b:82</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://gerlach-gerhold.org you initially access a DNS server to translate the host portion (gerlach-gerhold) combined with the Top Level Domain (org) of the URL, to an IP address like <code>88.187.200.77</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (Windows; U; Win 9x 4.90; SG; rv:1.9.2.4) Gecko/20101104 Netscape/9.1.0285</code>
...
<pre><code>
default   fe80:69c0:d302:72c3:19be%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {142.2.113.181, 90.109.118.175}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr c2:5a:5f:45:0b:82
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr d7:b0:06:4a:77:6d
}</code></pre>
