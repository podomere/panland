...
layout: research
ip_v4_address: "102.103.167.157"
date: 2022-04-24T18:59:55+01:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like <code>102.103.167.157</code> or an IPv6 address like <code>2000:cbe4:a8d8:419a:ac:5c38:e81d:bb97</code>. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>c9:9d:58:81:75:67</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://hettinger-runolfsdottir.io you initially access a DNS server to translate the host portion (hettinger-runolfsdottir) combined with the Top Level Domain (io) of the URL, to an IP address like <code>80.54.216.71</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Opera/9.80 (X11; Linux i686; Ubuntu/14.10) Presto/2.12.388 Version/12.16</code>
...
<pre><code>
default   fe80:e4ae:f8a3:7a7b:2734%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {220.245.198.172, 6.0.218.178}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr c9:9d:58:81:75:67
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 90:62:42:b3:1f:52
}</code></pre>
