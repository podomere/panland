...
layout: research
ip_v4_address: "241.205.181.82"
date: 2022-04-24T19:00:04+01:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like <code>241.205.181.82</code> or an IPv6 address like <code>2000:c4b7:adf5:2de8:d406:482a:dbb:452d</code>. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>3c:fe:38:d2:49:6a</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://heaney-price.name you initially access a DNS server to translate the host portion (heaney-price) combined with the Top Level Domain (name) of the URL, to an IP address like <code>134.65.228.136</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Opera/9.80 (X11; Linux i686; Ubuntu/14.10) Presto/2.12.388 Version/12.16</code>
...
<pre><code>
default   fe80:1dff:2865:b227:d029%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {233.223.99.123, 214.248.40.199}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 3c:fe:38:d2:49:6a
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 57:f9:66:b1:db:90
}</code></pre>
