...
subtitle: "Granular?"
layout: research
ip_v4_address: "184.211.210.251"
date: 2022-11-19T16:17:20+00:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like ```184.211.210.251``` or an IPv6 address like ```2000:575a:785d:bfd:9713:7947:968c:ab8b```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```d2:48:2d:22:86:10```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://trantow-schultz.net you initially access a DNS server to translate the host portion (trantow-schultz) combined with the Top Level Domain (net) of the URL, to an IP address like ```100.186.203.58```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows; U; Win 9x 4.90; SG; rv:1.9.2.4) Gecko/20101104 Netscape/9.1.0285```
...
<pre>
default   fe80:2295:c0ff:7059:e247%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {245.17.102.154, 44.122.192.1}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr d2:48:2d:22:86:10
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr c4:e3:f8:7b:eb:d4
}</pre>
