...
layout: research
ip_v4_address: "177.38.139.77"
date: 2022-05-05T14:28:54+01:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like ```177.38.139.77``` or an IPv6 address like ```2000:fbc9:7ee0:da76:53c6:fe96:8835:6ff8```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```be:52:e1:be:5a:51```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://streich.com you initially access a DNS server to translate the host portion (streich) combined with the Top Level Domain (com) of the URL, to an IP address like ```221.179.206.8```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (compatible; MSIE 9.0; AOL 9.7; AOLBuild 4343.19; Windows NT 6.1; WOW64; Trident/5.0; FunWebProducts)```
...
<pre>
default   fe80:a200:e601:5a54:28a1%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {107.96.185.24, 194.191.53.27}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr be:52:e1:be:5a:51
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 14:1e:56:bf:72:dc
}</pre>
