...
layout: research
ip_v4_address: "66.53.20.219"
date: 2022-04-24T18:31:58+01:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like <code>66.53.20.219</code> or an IPv6 address like <code>2000:124a:ae93:845a:1275:1846:2b68:548f</code>. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>a3:50:5a:c3:28:a9</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://klein-west.info you initially access a DNS server to translate the host portion (klein-west) combined with the Top Level Domain (info) of the URL, to an IP address like <code>145.51.111.93</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (Windows NT 6.1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/41.0.2228.0 Safari/537.36</code>
...
<pre><code>
default   fe80:c245:cb13:7e3b:eda9%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {223.62.111.128, 56.207.111.150}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr a3:50:5a:c3:28:a9
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr d5:bd:29:50:e8:87
}</code></pre>
