...
layout: research
ip_v4_address: "131.153.100.136"
date: 2022-11-02T11:32:58+00:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like ```131.153.100.136``` or an IPv6 address like ```2000:813:fa5d:f5ec:fea8:2b2f:59e1:5b55```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```78:37:a0:8a:db:b5```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://stoltenberg.net you initially access a DNS server to translate the host portion (stoltenberg) combined with the Top Level Domain (net) of the URL, to an IP address like ```227.12.80.41```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1; WOW64; Trident/7.0; AS; rv:11.0) like Gecko```

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```10.124.162.53``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  10.124.162.53    UGScg  en0
...
<pre>
default   fe80:78b6:f377:8a97:e50a%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {92.202.54.219, 159.190.55.247}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 78:37:a0:8a:db:b5
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 0f:03:90:16:9a:d5
}</pre>
