...
layout: research
ip_v4_address: "159.218.233.199"
date: 2022-11-19T19:13:09+00:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like ```159.218.233.199``` or an IPv6 address like ```2000:f780:2ea2:1f55:529d:3bc0:ce9c:9883```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```c1:00:61:bf:cf:70```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://lakin-bruen.name you initially access a DNS server to translate the host portion (lakin-bruen) combined with the Top Level Domain (name) of the URL, to an IP address like ```81.35.220.31```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_3) AppleWebKit/537.75.14 (KHTML, like Gecko) Version/7.0.3 Safari/7046A194A```
...
<pre>
default   fe80:4694:1b4a:446b:efff%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {26.179.239.222, 195.50.217.242}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr c1:00:61:bf:cf:70
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr ee:be:5b:4a:72:38
}</pre>
