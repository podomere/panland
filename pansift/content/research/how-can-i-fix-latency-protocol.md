...
layout: research
ip_v4_address: "213.207.243.208"
date: 2022-11-19T19:13:25+00:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like ```213.207.243.208``` or an IPv6 address like ```2000:f158:c292:7d89:b4ba:7d4d:9667:c3d8```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```b5:22:92:22:0a:d7```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://schultz-lowe.biz you initially access a DNS server to translate the host portion (schultz-lowe) combined with the Top Level Domain (biz) of the URL, to an IP address like ```251.55.123.81```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows; U; Win 9x 4.90; SG; rv:1.9.2.4) Gecko/20101104 Netscape/9.1.0285```
...
<pre>
default   fe80:437d:400a:9506:fde6%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {8.33.213.197, 114.184.27.60}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr b5:22:92:22:0a:d7
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 47:6d:fb:b4:48:32
}</pre>
