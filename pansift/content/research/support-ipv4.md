...
layout: research
ip_v4_address: "38.248.213.19"
date: 2022-11-19T19:13:23+00:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like ```38.248.213.19``` or an IPv6 address like ```2000:cbda:5b40:dc11:37f4:cce5:934e:96f3```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```58:8c:8f:91:eb:6c```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://beahan.biz you initially access a DNS server to translate the host portion (beahan) combined with the Top Level Domain (biz) of the URL, to an IP address like ```216.236.15.100```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_3) AppleWebKit/537.75.14 (KHTML, like Gecko) Version/7.0.3 Safari/7046A194A```
...
<pre>
default   fe80:f301:7c21:8bfe:e0cc%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {136.25.200.227, 201.100.69.219}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 58:8c:8f:91:eb:6c
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr b7:e3:b0:e0:ec:36
}</pre>
