...
layout: research
ip_v4_address: "227.120.126.49"
date: 2023-02-04T16:26:19+00:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like ```227.120.126.49``` or an IPv6 address like ```2000:a54e:cb91:a4f4:d455:9880:81ca:910f```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```c4:b3:d7:9f:95:36```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://hahn-douglas.com you initially access a DNS server to translate the host portion (hahn-douglas) combined with the Top Level Domain (com) of the URL, to an IP address like ```205.203.177.84```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1; WOW64; Trident/7.0; AS; rv:11.0) like Gecko```
...
<pre>
default   fe80:408c:dc36:2492:c2f0%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {133.203.216.203, 125.200.162.136}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr c4:b3:d7:9f:95:36
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 8f:c8:2c:27:11:ec
}</pre>
