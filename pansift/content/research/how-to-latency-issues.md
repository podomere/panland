...
subtitle: "Swim Lane?"
layout: research
ip_v4_address: "192.13.28.196"
date: 2022-12-15T13:50:17+00:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like ```192.13.28.196``` or an IPv6 address like ```2000:ecb9:525b:4356:f895:2f64:c186:5392```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```74:f6:7b:0a:4f:8f```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://goldner-crooks.io you initially access a DNS server to translate the host portion (goldner-crooks) combined with the Top Level Domain (io) of the URL, to an IP address like ```232.173.227.151```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_3) AppleWebKit/537.75.14 (KHTML, like Gecko) Version/7.0.3 Safari/7046A194A```
...
<pre>
default   fe80:a3ce:1f0d:9562:976a%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {18.91.36.93, 81.202.224.110}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 74:f6:7b:0a:4f:8f
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 9f:da:77:c5:1f:45
}</pre>
