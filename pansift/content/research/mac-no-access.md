...
layout: research
ip_v4_address: "191.154.190.186"
date: 2022-04-24T18:31:59+01:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like <code>191.154.190.186</code> or an IPv6 address like <code>2000:d165:d6de:6f33:193d:c85b:4f00:fe11</code>. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>0f:c9:6b:b3:b8:ed</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://abernathy-casper.biz you initially access a DNS server to translate the host portion (abernathy-casper) combined with the Top Level Domain (biz) of the URL, to an IP address like <code>137.150.244.154</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_3) AppleWebKit/537.75.14 (KHTML, like Gecko) Version/7.0.3 Safari/7046A194A</code>
...
default  172.29.129.106    UGScg  en0
...
<pre><code>
default   fe80:ff39:a170:214c:7576%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {204.118.112.206, 158.235.109.199}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 0f:c9:6b:b3:b8:ed
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr b9:25:69:4d:52:28
}</code></pre>
