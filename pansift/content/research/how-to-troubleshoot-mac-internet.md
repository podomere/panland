...
layout: research
ip_v4_address: "186.124.23.151"
date: 2022-11-19T16:17:13+00:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like ```186.124.23.151``` or an IPv6 address like ```2000:5da1:6c58:3c00:88da:4052:4617:48f9```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```64:b6:60:d4:58:9a```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://brown-morissette.name you initially access a DNS server to translate the host portion (brown-morissette) combined with the Top Level Domain (name) of the URL, to an IP address like ```97.223.84.64```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows; U; Win 9x 4.90; SG; rv:1.9.2.4) Gecko/20101104 Netscape/9.1.0285```
...
<pre>
default   fe80:e319:d329:5cde:f901%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {186.106.105.98, 17.64.184.192}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 64:b6:60:d4:58:9a
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 6e:43:e9:ca:97:cb
}</pre>
