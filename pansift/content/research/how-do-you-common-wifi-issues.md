...
layout: research
ip_v4_address: "39.82.72.226"
date: 2022-04-24T18:32:42+01:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like <code>39.82.72.226</code> or an IPv6 address like <code>2000:6077:4506:235:58aa:651b:75ea:fe75</code>. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>49:91:7e:f9:d2:70</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://reichert-maggio.biz you initially access a DNS server to translate the host portion (reichert-maggio) combined with the Top Level Domain (biz) of the URL, to an IP address like <code>139.143.161.168</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (compatible; MSIE 9.0; AOL 9.7; AOLBuild 4343.19; Windows NT 6.1; WOW64; Trident/5.0; FunWebProducts)</code>
...
<pre><code>
default   fe80:e9f3:944d:52bd:c8fc%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {182.117.78.100, 101.128.65.183}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 49:91:7e:f9:d2:70
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 1c:f6:6c:be:70:5c
}</code></pre>
