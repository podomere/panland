...
subtitle: "Tee It Up?"
layout: research
ip_v4_address: "207.147.198.165"
date: 2022-05-05T14:28:57+01:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like ```207.147.198.165``` or an IPv6 address like ```2000:1227:ecf6:496f:4dcf:8b30:92d0:2d1c```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```43:8c:45:f9:0f:35```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://ortiz-becker.net you initially access a DNS server to translate the host portion (ortiz-becker) combined with the Top Level Domain (net) of the URL, to an IP address like ```225.246.226.140```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (compatible; MSIE 9.0; AOL 9.7; AOLBuild 4343.19; Windows NT 6.1; WOW64; Trident/5.0; FunWebProducts)```
...
default  172.21.34.124    UGScg  en0
...
<pre>
default   fe80:cc71:f3a6:382f:986a%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {249.108.145.71, 145.60.44.77}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 43:8c:45:f9:0f:35
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr f9:f6:18:ce:36:f3
}</pre>
