...
layout: research
ip_v4_address: "91.220.210.182"
date: 2023-10-29T15:13:27+00:00
draft: false
---

## Internet Addressing
On the Internet you may have a Public IPv4 address like ```91.220.210.182``` or an IPv6 address like ```2000:9c5b:5cf3:12c4:dcb6:b48b:76d7:f66d```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```4e:2d:b7:bc:06:39```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://nikolaus-raynor.com you initially access a DNS server to translate the host portion (nikolaus-raynor) combined with the Top Level Domain (com) of the URL, to an IP address like ```42.75.78.86```. Your computer and browser actually sends its type with all web requests e.g. <br>```Opera/9.80 (X11; Linux i686; Ubuntu/14.10) Presto/2.12.388 Version/12.16```
...
<pre>
default   fe80:f0cc:f51c:d7fb:47f0%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {169.12.67.90, 178.57.243.40}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 4e:2d:b7:bc:06:39
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 06:bf:90:d5:e3:15
}</pre>
