...
layout: research
ip_v4_address: "16.29.162.21"
date: 2022-11-19T16:17:21+00:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like ```16.29.162.21``` or an IPv6 address like ```2000:fa90:126f:db73:796f:8d95:bc2c:9ad7```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```29:dd:7c:8d:b5:21```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://johnston-conn.net you initially access a DNS server to translate the host portion (johnston-conn) combined with the Top Level Domain (net) of the URL, to an IP address like ```96.142.207.156```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT x.y; Win64; x64; rv:10.0) Gecko/20100101 Firefox/10.0```
...
<pre>
default   fe80:6c53:7391:804f:9837%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {127.55.79.6, 60.175.162.52}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 29:dd:7c:8d:b5:21
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 63:2d:d9:66:c9:e6
}</pre>
