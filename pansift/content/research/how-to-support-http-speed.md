...
layout: research
ip_v4_address: "141.90.94.68"
date: 2022-06-04T14:38:43+01:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like ```141.90.94.68``` or an IPv6 address like ```2000:6da:ebd2:a463:ce5c:258b:9c81:2bb6```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```4a:06:60:34:00:06```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://crist-watsica.com you initially access a DNS server to translate the host portion (crist-watsica) combined with the Top Level Domain (com) of the URL, to an IP address like ```141.46.58.119```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (compatible; MSIE 9.0; AOL 9.7; AOLBuild 4343.19; Windows NT 6.1; WOW64; Trident/5.0; FunWebProducts)```
...
<pre>
default   fe80:6694:4290:1833:cb86%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {47.106.241.239, 149.23.66.42}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 4a:06:60:34:00:06
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 61:ec:15:5c:61:0a
}</pre>
