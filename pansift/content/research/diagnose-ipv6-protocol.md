...
layout: research
ip_v4_address: "16.110.157.188"
date: 2023-10-06T17:11:03+01:00
draft: false
---

## Internet Addressing
On the Internet you might get a Public IPv4 address like ```16.110.157.188``` or an IPv6 address like ```2000:ba59:dc13:698f:52e0:1efa:c48a:e9f9```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```80:b6:c9:b2:f8:6e```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://brekke-barrows.io you initially access a DNS server to translate the host portion (brekke-barrows) combined with the Top Level Domain (io) of the URL, to an IP address like ```6.219.156.83```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (compatible; MSIE 9.0; AOL 9.7; AOLBuild 4343.19; Windows NT 6.1; WOW64; Trident/5.0; FunWebProducts)```
...
<pre>
default   fe80:e881:1489:9fe0:7e20%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {123.231.99.114, 129.170.81.2}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 80:b6:c9:b2:f8:6e
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 7d:9e:42:54:e7:cc
}</pre>
