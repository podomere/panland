...
subtitle: "Value Add?"
layout: research
ip_v4_address: "57.8.199.72"
date: 2022-04-24T19:00:07+01:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like <code>57.8.199.72</code> or an IPv6 address like <code>2000:408e:c26f:439c:2383:49e0:c41a:7397</code>. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>4a:df:97:f2:ff:89</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://bahringer.co you initially access a DNS server to translate the host portion (bahringer) combined with the Top Level Domain (co) of the URL, to an IP address like <code>231.171.221.95</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (Windows NT 6.1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/41.0.2228.0 Safari/537.36</code>

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like <code>10.250.31.158</code> (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For <code>IPv6</code> we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  10.250.31.158    UGScg  en0
...
<pre><code>
default   fe80:d925:c43e:b317:8d19%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {40.204.126.30, 101.130.124.83}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 4a:df:97:f2:ff:89
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 31:44:fd:e4:4d:60
}</code></pre>
