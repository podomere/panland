...
layout: research
ip_v4_address: "76.52.46.178"
date: 2022-04-24T19:00:01+01:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like <code>76.52.46.178</code> or an IPv6 address like <code>2000:5622:862a:ee75:d859:a595:2684:7102</code>. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>f6:e6:1d:f6:6c:b5</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://medhurst.com you initially access a DNS server to translate the host portion (medhurst) combined with the Top Level Domain (com) of the URL, to an IP address like <code>148.117.131.68</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_3) AppleWebKit/537.75.14 (KHTML, like Gecko) Version/7.0.3 Safari/7046A194A</code>
...
default  172.28.63.81    UGScg  en0
...
<pre><code>
default   fe80:f8b0:9931:a0fe:51e0%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {251.96.246.174, 220.242.192.98}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr f6:e6:1d:f6:6c:b5
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr b2:2e:86:f4:a5:0a
}</code></pre>
