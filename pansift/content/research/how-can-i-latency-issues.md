...
subtitle: "Heads Down?"
layout: research
ip_v4_address: "81.114.153.133"
date: 2023-10-06T17:11:05+01:00
draft: false
---

## Internet Addressing
On the Internet you may get a Public IPv4 address like ```81.114.153.133``` or an IPv6 address like ```2000:91bd:38da:285a:5a9a:6b40:303:f6e```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```f5:19:50:dd:ea:cc```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://mcglynn-lesch.co you initially access a DNS server to translate the host portion (mcglynn-lesch) combined with the Top Level Domain (co) of the URL, to an IP address like ```54.108.245.98```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_3) AppleWebKit/537.75.14 (KHTML, like Gecko) Version/7.0.3 Safari/7046A194A```
...
<pre>
default   fe80:4723:4ca4:3ad2:74c7%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {244.9.238.209, 199.40.105.86}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr f5:19:50:dd:ea:cc
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 6b:b6:9f:71:3e:68
}</pre>
