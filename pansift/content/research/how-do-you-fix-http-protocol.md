...
subtitle: "Granular?"
layout: research
ip_v4_address: "15.196.111.57"
date: 2022-11-19T19:13:28+00:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like ```15.196.111.57``` or an IPv6 address like ```2000:fc0:b786:35a5:a63:a4cc:6c35:3521```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```9c:bf:3d:aa:9c:e4```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://kling-breitenberg.name you initially access a DNS server to translate the host portion (kling-breitenberg) combined with the Top Level Domain (name) of the URL, to an IP address like ```38.24.143.225```. Your computer and browser actually sends its type with all web requests e.g. <br>```Opera/9.80 (X11; Linux i686; Ubuntu/14.10) Presto/2.12.388 Version/12.16```
...
<pre>
default   fe80:5e46:3875:16b8:919%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {47.18.233.182, 178.151.56.229}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 9c:bf:3d:aa:9c:e4
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 04:ac:58:39:45:4f
}</pre>
