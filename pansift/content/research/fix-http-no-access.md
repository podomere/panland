...
layout: research
ip_v4_address: "216.50.5.72"
date: 2023-02-04T16:26:22+00:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like ```216.50.5.72``` or an IPv6 address like ```2000:35b6:860b:44fe:80f9:befb:2a6a:62ee```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```43:9d:99:48:c6:ce```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://collier.info you initially access a DNS server to translate the host portion (collier) combined with the Top Level Domain (info) of the URL, to an IP address like ```49.192.183.10```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT x.y; Win64; x64; rv:10.0) Gecko/20100101 Firefox/10.0```

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```172.27.101.82``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  172.27.101.82    UGScg  en0
...
<pre>
default   fe80:d933:a68:fff2:bae2%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {177.146.226.121, 127.13.97.213}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 43:9d:99:48:c6:ce
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 94:a9:2e:e4:2c:5c
}</pre>
