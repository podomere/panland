...
layout: research
ip_v4_address: "141.128.16.45"
date: 2022-12-15T13:50:21+00:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like ```141.128.16.45``` or an IPv6 address like ```2000:f698:66:355b:ca0f:34ac:3812:267c```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```67:e1:e2:96:56:5a```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://emard.io you initially access a DNS server to translate the host portion (emard) combined with the Top Level Domain (io) of the URL, to an IP address like ```255.50.242.171```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_3) AppleWebKit/537.75.14 (KHTML, like Gecko) Version/7.0.3 Safari/7046A194A```
...
<pre>
default   fe80:773c:3dad:1e97:b794%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {127.28.183.147, 222.147.32.47}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 67:e1:e2:96:56:5a
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 89:e8:53:8f:5c:e8
}</pre>
