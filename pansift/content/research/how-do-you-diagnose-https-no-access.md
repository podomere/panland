...
subtitle: "Streamline?"
layout: research
ip_v4_address: "229.158.206.247"
date: 2022-05-05T14:30:15+01:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like ```229.158.206.247``` or an IPv6 address like ```2000:887:1b3b:9d33:3e6c:810f:ff4b:f77a```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```e5:e6:fc:16:11:9e```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://schuster-braun.name you initially access a DNS server to translate the host portion (schuster-braun) combined with the Top Level Domain (name) of the URL, to an IP address like ```155.67.121.130```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows; U; Win 9x 4.90; SG; rv:1.9.2.4) Gecko/20101104 Netscape/9.1.0285```

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```192.168.131.249``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  192.168.131.249    UGScg  en0
...
<pre>
default   fe80:e8:c505:3f7e:dbf1%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {101.219.130.150, 155.122.2.44}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr e5:e6:fc:16:11:9e
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 75:4f:5f:b6:dc:64
}</pre>
