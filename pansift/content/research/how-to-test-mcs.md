...
layout: research
ip_v4_address: "211.203.166.66"
date: 2022-12-15T13:50:04+00:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like ```211.203.166.66``` or an IPv6 address like ```2000:afd9:416f:12f9:5e80:d431:58be:5832```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```31:e7:42:1b:ef:42```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://hilpert-gerlach.io you initially access a DNS server to translate the host portion (hilpert-gerlach) combined with the Top Level Domain (io) of the URL, to an IP address like ```33.102.138.42```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/41.0.2228.0 Safari/537.36```
...
<pre>
default   fe80:f858:a900:c67f:fda7%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {88.106.243.46, 197.119.72.46}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 31:e7:42:1b:ef:42
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr b1:95:ea:26:65:88
}</pre>
