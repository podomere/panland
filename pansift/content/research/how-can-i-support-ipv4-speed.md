...
layout: research
ip_v4_address: "7.90.30.85"
date: 2023-02-04T16:26:19+00:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like ```7.90.30.85``` or an IPv6 address like ```2000:a73:dd96:1eb:847a:da9f:967a:96cb```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```9d:67:23:f2:26:4e```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://ritchie.io you initially access a DNS server to translate the host portion (ritchie) combined with the Top Level Domain (io) of the URL, to an IP address like ```212.231.188.110```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (compatible; MSIE 9.0; AOL 9.7; AOLBuild 4343.19; Windows NT 6.1; WOW64; Trident/5.0; FunWebProducts)```
...
<pre>
default   fe80:cd24:4b13:72bb:f44f%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {89.30.211.215, 125.11.192.70}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 9d:67:23:f2:26:4e
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 75:38:27:54:f1:5a
}</pre>
