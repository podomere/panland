...
layout: research
ip_v4_address: "93.181.14.242"
date: 2022-11-19T19:13:26+00:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like ```93.181.14.242``` or an IPv6 address like ```2000:e5b8:63a2:aa20:1c2e:82bf:9c81:6cbb```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```91:79:2b:ca:71:8c```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://deckow-lang.name you initially access a DNS server to translate the host portion (deckow-lang) combined with the Top Level Domain (name) of the URL, to an IP address like ```237.41.70.106```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_3) AppleWebKit/537.75.14 (KHTML, like Gecko) Version/7.0.3 Safari/7046A194A```
...
<pre>
default   fe80:6a1c:ff79:c997:73eb%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {30.230.94.136, 169.196.218.168}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 91:79:2b:ca:71:8c
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 46:a6:ec:d6:1e:7a
}</pre>
