...
subtitle: "Heads Down?"
layout: research
ip_v4_address: "219.66.127.8"
date: 2023-02-04T16:26:11+00:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like ```219.66.127.8``` or an IPv6 address like ```2000:d380:eaba:6ba2:7132:ce9e:1784:c7e4```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```61:de:e6:7e:ad:7c```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://rolfson-sauer.info you initially access a DNS server to translate the host portion (rolfson-sauer) combined with the Top Level Domain (info) of the URL, to an IP address like ```119.234.245.8```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (compatible; MSIE 9.0; AOL 9.7; AOLBuild 4343.19; Windows NT 6.1; WOW64; Trident/5.0; FunWebProducts)```
...
<pre>
default   fe80:26e0:42eb:2229:2747%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {69.86.2.106, 235.193.41.172}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 61:de:e6:7e:ad:7c
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 79:b7:ca:d6:6d:62
}</pre>
...
## Apple macOS / OSX
No matter what version of OSX/macOS you are on, ```10.12.1```, ```11.6.3```, or ```12.0.9```, there are a range of tools for troubleshooting. Unfortunately, between these manual actions and scripts, they don't give you a series of correlated values over time. This is where automated remote troubleshooting comes in to its own, especially for teams that embrace remote work and Work From Anywhere (WFA).
