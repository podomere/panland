...
layout: research
ip_v4_address: "241.78.195.242"
date: 2022-11-02T11:32:53+00:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like ```241.78.195.242``` or an IPv6 address like ```2000:7a7c:5c4d:e78:bea5:4fa0:9c31:3718```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```72:3a:12:56:d7:0e```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://schimmel-kuvalis.biz you initially access a DNS server to translate the host portion (schimmel-kuvalis) combined with the Top Level Domain (biz) of the URL, to an IP address like ```182.135.252.67```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (compatible; MSIE 9.0; AOL 9.7; AOLBuild 4343.19; Windows NT 6.1; WOW64; Trident/5.0; FunWebProducts)```

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```192.168.199.122``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  192.168.199.122    UGScg  en0
...
<pre>
default   fe80:b430:1a12:b2e:90d8%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {211.81.254.211, 100.81.207.218}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 72:3a:12:56:d7:0e
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr a3:9b:b9:70:a5:d9
}</pre>
