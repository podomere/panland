...
layout: research
ip_v4_address: "85.6.24.177"
date: 2022-06-12T14:09:23+01:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like ```85.6.24.177``` or an IPv6 address like ```2000:f25b:259a:802a:17:52d1:431f:9a7b```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```01:6b:f7:37:3a:bc```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://oconnell-okuneva.org you initially access a DNS server to translate the host portion (oconnell-okuneva) combined with the Top Level Domain (org) of the URL, to an IP address like ```137.24.207.95```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows; U; Win 9x 4.90; SG; rv:1.9.2.4) Gecko/20101104 Netscape/9.1.0285```
...
<pre>
default   fe80:9a5:302f:6b91:ffab%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {180.238.137.17, 233.121.45.113}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 01:6b:f7:37:3a:bc
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 70:ca:cc:5a:2b:18
}</pre>
