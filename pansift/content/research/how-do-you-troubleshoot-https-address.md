...
layout: research
ip_v4_address: "137.240.213.133"
date: 2022-05-05T14:30:15+01:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like ```137.240.213.133``` or an IPv6 address like ```2000:7988:1254:7728:4432:6d29:8196:c180```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```84:e4:76:db:7c:4c```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://cartwright-howe.net you initially access a DNS server to translate the host portion (cartwright-howe) combined with the Top Level Domain (net) of the URL, to an IP address like ```122.248.109.32```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/41.0.2228.0 Safari/537.36```
...
<pre>
default   fe80:a96a:b272:a0f0:77ef%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {189.226.241.172, 220.135.40.114}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 84:e4:76:db:7c:4c
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr e9:96:8c:47:24:19
}</pre>
