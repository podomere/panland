...
layout: research
ip_v4_address: "105.62.47.241"
date: 2022-11-02T11:32:53+00:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like ```105.62.47.241``` or an IPv6 address like ```2000:d1fd:4991:fde6:5fc5:4b65:c2b:4b51```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```21:f6:39:1b:81:0c```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://okuneva.io you initially access a DNS server to translate the host portion (okuneva) combined with the Top Level Domain (io) of the URL, to an IP address like ```95.59.12.164```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows; U; Win 9x 4.90; SG; rv:1.9.2.4) Gecko/20101104 Netscape/9.1.0285```

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```192.168.222.70``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  192.168.222.70    UGScg  en0
...
<pre>
default   fe80:d000:3dee:6f82:3588%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {40.73.143.208, 129.187.29.237}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 21:f6:39:1b:81:0c
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr f7:db:53:0d:3e:26
}</pre>
