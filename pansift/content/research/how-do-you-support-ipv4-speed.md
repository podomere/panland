...
subtitle: "Branding?"
layout: research
ip_v4_address: "59.96.8.136"
date: 2022-11-19T16:17:21+00:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like ```59.96.8.136``` or an IPv6 address like ```2000:ec07:f82d:2fa8:70b3:aba:2e01:f0e3```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```68:3d:4f:1f:08:15```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://gleason.com you initially access a DNS server to translate the host portion (gleason) combined with the Top Level Domain (com) of the URL, to an IP address like ```4.53.43.223```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/41.0.2228.0 Safari/537.36```
...
<pre>
default   fe80:70b5:622b:9254:2c4e%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {39.148.215.203, 69.176.106.42}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 68:3d:4f:1f:08:15
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr bb:d9:7d:3c:93:e5
}</pre>
