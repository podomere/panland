...
layout: research
ip_v4_address: "253.140.39.134"
date: 2022-12-15T13:50:10+00:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like ```253.140.39.134``` or an IPv6 address like ```2000:b35f:7874:8888:209e:e3a3:4bc4:3cb```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```48:d2:c0:c4:06:c6```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://kohler-schaden.biz you initially access a DNS server to translate the host portion (kohler-schaden) combined with the Top Level Domain (biz) of the URL, to an IP address like ```96.39.141.164```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/41.0.2228.0 Safari/537.36```
...
<pre>
default   fe80:32f8:264c:12db:3766%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {225.44.22.137, 116.13.119.188}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 48:d2:c0:c4:06:c6
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr db:d2:16:fa:f1:29
}</pre>
