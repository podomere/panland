...
subtitle: "Etc. Etc.?"
layout: research
ip_v4_address: "192.131.181.56"
date: 2022-04-24T19:00:07+01:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like <code>192.131.181.56</code> or an IPv6 address like <code>2000:2f17:9dfc:f411:c7ae:2f5b:e5e1:87c4</code>. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>08:30:6c:b5:41:b3</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://pagac-bins.biz you initially access a DNS server to translate the host portion (pagac-bins) combined with the Top Level Domain (biz) of the URL, to an IP address like <code>250.175.234.32</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_3) AppleWebKit/537.75.14 (KHTML, like Gecko) Version/7.0.3 Safari/7046A194A</code>
...
<pre><code>
default   fe80:854d:6074:fa0a:e3f5%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {255.33.33.172, 46.78.154.0}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 08:30:6c:b5:41:b3
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 6d:56:79:78:49:6e
}</code></pre>
