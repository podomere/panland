...
layout: research
ip_v4_address: "176.245.195.191"
date: 2022-12-15T13:50:21+00:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like ```176.245.195.191``` or an IPv6 address like ```2000:303e:7160:f279:d824:d51b:aa69:7015```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```9c:e6:c1:67:8a:78```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://west.org you initially access a DNS server to translate the host portion (west) combined with the Top Level Domain (org) of the URL, to an IP address like ```110.112.225.161```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_3) AppleWebKit/537.75.14 (KHTML, like Gecko) Version/7.0.3 Safari/7046A194A```
...
<pre>
default   fe80:d325:a6c:537f:f692%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {51.42.188.15, 179.159.204.68}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 9c:e6:c1:67:8a:78
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 71:17:0a:79:4c:97
}</pre>
