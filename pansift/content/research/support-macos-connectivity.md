...
layout: research
ip_v4_address: "141.195.101.52"
date: 2022-11-02T11:33:10+00:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like ```141.195.101.52``` or an IPv6 address like ```2000:2c7b:7dc6:48bc:dba1:3913:6a26:3d2a```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```f5:a5:0c:74:db:e9```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://glover-lueilwitz.biz you initially access a DNS server to translate the host portion (glover-lueilwitz) combined with the Top Level Domain (biz) of the URL, to an IP address like ```161.211.65.136```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows; U; Win 9x 4.90; SG; rv:1.9.2.4) Gecko/20101104 Netscape/9.1.0285```
...
<pre>
default   fe80:ffa2:366f:f08a:b212%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {66.241.45.97, 11.221.200.15}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr f5:a5:0c:74:db:e9
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 96:f6:d6:90:52:96
}</pre>
