...
layout: research
ip_v4_address: "38.135.104.131"
date: 2022-11-02T11:32:59+00:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like ```38.135.104.131``` or an IPv6 address like ```2000:878d:b43b:5a1f:f6ec:7dbf:6bf3:394d```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```a6:25:62:f0:5c:cf```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://lind-powlowski.org you initially access a DNS server to translate the host portion (lind-powlowski) combined with the Top Level Domain (org) of the URL, to an IP address like ```143.242.178.151```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows; U; Win 9x 4.90; SG; rv:1.9.2.4) Gecko/20101104 Netscape/9.1.0285```
...
<pre>
default   fe80:d660:76cf:c147:2a77%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {191.234.246.189, 9.53.123.1}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr a6:25:62:f0:5c:cf
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr b6:a4:7c:b0:c3:d5
}</pre>
