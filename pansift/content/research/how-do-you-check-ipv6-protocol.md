...
layout: research
ip_v4_address: "76.18.165.132"
date: 2022-11-02T11:32:53+00:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like ```76.18.165.132``` or an IPv6 address like ```2000:4bfa:cff7:51a3:14c2:52af:5cfb:e717```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```fc:a6:78:24:42:4d```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://rohan-wilkinson.com you initially access a DNS server to translate the host portion (rohan-wilkinson) combined with the Top Level Domain (com) of the URL, to an IP address like ```100.80.180.141```. Your computer and browser actually sends its type with all web requests e.g. <br>```Opera/9.80 (X11; Linux i686; Ubuntu/14.10) Presto/2.12.388 Version/12.16```
...
<pre>
default   fe80:c65c:129a:4014:984a%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {142.228.84.221, 216.98.24.85}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr fc:a6:78:24:42:4d
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 30:17:56:48:25:11
}</pre>
