...
layout: research
ip_v4_address: "232.115.92.46"
date: 2023-02-04T17:07:50+00:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like ```232.115.92.46``` or an IPv6 address like ```2000:a28:1cd9:b20:6f37:a705:8d5b:152```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```87:65:fe:e9:7f:4a```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://metz.name you initially access a DNS server to translate the host portion (metz) combined with the Top Level Domain (name) of the URL, to an IP address like ```40.24.43.245```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT x.y; Win64; x64; rv:10.0) Gecko/20100101 Firefox/10.0```

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```172.19.59.26``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  172.19.59.26    UGScg  en0
...
<pre>
default   fe80:23c6:cadf:d13d:4b16%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {231.16.67.163, 99.79.213.60}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 87:65:fe:e9:7f:4a
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr d0:91:42:be:1b:0b
}</pre>
