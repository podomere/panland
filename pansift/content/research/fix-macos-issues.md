...
layout: research
ip_v4_address: "198.110.183.166"
date: 2022-04-24T18:31:57+01:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like <code>198.110.183.166</code> or an IPv6 address like <code>2000:1d00:be8b:7589:e23b:af4e:41eb:22f8</code>. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>59:44:ec:a6:3a:c6</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://marks-simonis.co you initially access a DNS server to translate the host portion (marks-simonis) combined with the Top Level Domain (co) of the URL, to an IP address like <code>128.45.247.172</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (Windows; U; Win 9x 4.90; SG; rv:1.9.2.4) Gecko/20101104 Netscape/9.1.0285</code>
...
<pre><code>
default   fe80:4a3f:f7f8:4140:fd22%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {176.80.82.242, 253.37.20.196}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 59:44:ec:a6:3a:c6
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 60:8b:e4:3a:27:64
}</code></pre>
