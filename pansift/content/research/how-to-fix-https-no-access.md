---
title: "How To Fix Https No-access"
subtitle: "Snackable Content?"
layout: research
ip_v4_address: "32.35.156.115"
date: 2022-04-24T19:00:05+01:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like <code>32.35.156.115</code> or an IPv6 address like <code>2000:582f:2f5e:9c46:9ff9:49e0:492:3eae</code>. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>23:cd:10:9c:b7:3c</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://adams-thiel.org you initially access a DNS server to translate the host portion (adams-thiel) combined with the Top Level Domain (org) of the URL, to an IP address like <code>126.223.222.151</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (Windows NT 6.1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/41.0.2228.0 Safari/537.36</code>

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like <code>192.168.59.103</code> (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For <code>IPv6</code> we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  192.168.59.103    UGScg  en0
...
<pre><code>
default   fe80:17ea:c8fe:7c58:6e2d%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {75.10.239.139, 125.189.204.205}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 23:cd:10:9c:b7:3c
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 3a:21:92:3f:e8:fa
}</code></pre>
