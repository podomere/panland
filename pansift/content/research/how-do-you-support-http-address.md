...
subtitle: "Branding?"
layout: research
ip_v4_address: "132.213.111.242"
date: 2023-10-06T17:11:08+01:00
draft: false
---

## Internet Addressing
On the Internet you might have a Public IPv4 address like ```132.213.111.242``` or an IPv6 address like ```2000:420b:9839:c8:2b6:3eb9:e6cc:5d0a```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```f6:5d:c0:24:d5:b3```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://lakin-becker.io you initially access a DNS server to translate the host portion (lakin-becker) combined with the Top Level Domain (io) of the URL, to an IP address like ```1.65.48.130```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1; WOW64; Trident/7.0; AS; rv:11.0) like Gecko```
...
<pre>
default   fe80:1a9f:9586:ceeb:bd1e%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {13.189.88.137, 113.34.0.25}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr f6:5d:c0:24:d5:b3
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 76:9c:94:db:73:dd
}</pre>
