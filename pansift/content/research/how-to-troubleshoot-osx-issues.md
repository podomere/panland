...
subtitle: "Branding?"
layout: research
ip_v4_address: "124.254.54.243"
date: 2022-04-24T19:00:24+01:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like <code>124.254.54.243</code> or an IPv6 address like <code>2000:879d:735d:54cc:fa9a:bdb1:1ece:59f2</code>. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>ec:6a:50:52:63:8d</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://kihn-kreiger.org you initially access a DNS server to translate the host portion (kihn-kreiger) combined with the Top Level Domain (org) of the URL, to an IP address like <code>119.214.150.28</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_3) AppleWebKit/537.75.14 (KHTML, like Gecko) Version/7.0.3 Safari/7046A194A</code>
...
<pre><code>
default   fe80:2c19:3fe7:9131:28c%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {88.159.134.125, 132.219.209.18}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr ec:6a:50:52:63:8d
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr c1:d8:96:59:c4:03
}</code></pre>
