...
subtitle: "Learnings?"
layout: research
ip_v4_address: "142.94.181.159"
date: 2023-10-06T17:11:07+01:00
draft: false
---

## Internet Addressing
On the Internet you may get a Public IPv4 address like ```142.94.181.159``` or an IPv6 address like ```2000:a39:49b0:1793:f852:6c2b:2610:6c11```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```44:c4:a4:e3:ac:ec```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://cremin-mckenzie.io you initially access a DNS server to translate the host portion (cremin-mckenzie) combined with the Top Level Domain (io) of the URL, to an IP address like ```246.135.132.30```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_3) AppleWebKit/537.75.14 (KHTML, like Gecko) Version/7.0.3 Safari/7046A194A```
...
<pre>
default   fe80:34f7:5de0:1e3d:2c65%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {42.123.17.188, 137.82.218.213}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 44:c4:a4:e3:ac:ec
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 7a:82:33:10:c4:b8
}</pre>
