---
title: "Fix IPv4 Protocol"
subtitle: "Give You Some Time Back?"
layout: research
ip_v4_address: "203.189.132.192"
date: 2022-12-15T13:50:17+00:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like ```203.189.132.192``` or an IPv6 address like ```2000:c21:373a:f2b4:967:e563:c75c:4f65```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```95:f6:38:8f:d0:9a```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://lind-senger.io you initially access a DNS server to translate the host portion (lind-senger) combined with the Top Level Domain (io) of the URL, to an IP address like ```196.177.29.169```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (compatible; MSIE 9.0; AOL 9.7; AOLBuild 4343.19; Windows NT 6.1; WOW64; Trident/5.0; FunWebProducts)```
...
<pre>
default   fe80:feb7:6142:dbca:44d7%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {91.255.52.142, 43.240.86.143}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 95:f6:38:8f:d0:9a
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr ac:8f:c4:a8:a9:6c
}</pre>
