...
layout: research
ip_v4_address: "157.23.194.196"
date: 2022-11-02T11:33:01+00:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like ```157.23.194.196``` or an IPv6 address like ```2000:182f:5b62:8ffe:9bd2:94b:4549:69b5```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```d2:f9:81:81:c2:1e```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://leffler-schamberger.com you initially access a DNS server to translate the host portion (leffler-schamberger) combined with the Top Level Domain (com) of the URL, to an IP address like ```29.221.7.237```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/41.0.2228.0 Safari/537.36```
...
<pre>
default   fe80:129a:985f:5a5a:f55e%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {252.220.109.252, 25.42.179.36}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr d2:f9:81:81:c2:1e
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr b9:12:1a:6a:85:6a
}</pre>
