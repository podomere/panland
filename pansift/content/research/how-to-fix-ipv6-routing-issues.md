...
layout: research
ip_v4_address: "46.184.150.28"
date: 2022-11-02T11:32:52+00:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like ```46.184.150.28``` or an IPv6 address like ```2000:1917:6392:6ec4:c117:8d3f:f5d0:7b8c```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```d0:f3:fb:cb:17:64```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://hilpert.io you initially access a DNS server to translate the host portion (hilpert) combined with the Top Level Domain (io) of the URL, to an IP address like ```214.17.194.102```. Your computer and browser actually sends its type with all web requests e.g. <br>```Opera/9.80 (X11; Linux i686; Ubuntu/14.10) Presto/2.12.388 Version/12.16```
...
<pre>
default   fe80:cad4:9b32:33fc:dbdb%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {86.239.44.180, 19.64.105.0}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr d0:f3:fb:cb:17:64
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 3e:30:c4:4f:cc:e9
}</pre>
