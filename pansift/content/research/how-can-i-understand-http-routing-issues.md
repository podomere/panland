...
subtitle: "Synergy?"
layout: research
ip_v4_address: "112.206.121.169"
date: 2022-11-19T19:13:28+00:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like ```112.206.121.169``` or an IPv6 address like ```2000:a4ee:2b02:425d:1fe:bc6e:830b:35e3```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```38:7a:b8:77:16:cc```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://schneider-bartell.name you initially access a DNS server to translate the host portion (schneider-bartell) combined with the Top Level Domain (name) of the URL, to an IP address like ```125.209.231.147```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1; WOW64; Trident/7.0; AS; rv:11.0) like Gecko```
...
<pre>
default   fe80:1d0c:f30d:8d4b:708e%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {97.159.175.2, 95.109.118.77}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 38:7a:b8:77:16:cc
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 5e:36:a2:99:7b:2b
}</pre>
