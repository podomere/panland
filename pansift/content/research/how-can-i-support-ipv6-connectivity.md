...
layout: research
ip_v4_address: "149.36.55.63"
date: 2022-06-04T14:38:37+01:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like ```149.36.55.63``` or an IPv6 address like ```2000:d38:45ff:5309:bd9f:535e:1a83:ca32```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```20:87:04:42:4d:4d```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://mante.biz you initially access a DNS server to translate the host portion (mante) combined with the Top Level Domain (biz) of the URL, to an IP address like ```200.19.5.175```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (compatible; MSIE 9.0; AOL 9.7; AOLBuild 4343.19; Windows NT 6.1; WOW64; Trident/5.0; FunWebProducts)```
...
<pre>
default   fe80:9fcd:e381:c165:7e9e%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {136.56.90.120, 77.142.183.190}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 20:87:04:42:4d:4d
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 4d:cc:21:9e:d2:5f
}</pre>
