...
layout: research
ip_v4_address: "33.25.193.186"
date: 2023-10-06T17:11:07+01:00
draft: false
---

## Internet Addressing
On the Internet you might have a Public IPv4 address like ```33.25.193.186``` or an IPv6 address like ```2000:78:8bac:d957:f836:65d2:2ec9:9836```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```44:12:06:7b:29:22```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://ziemann.org you initially access a DNS server to translate the host portion (ziemann) combined with the Top Level Domain (org) of the URL, to an IP address like ```122.232.54.236```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1; WOW64; Trident/7.0; AS; rv:11.0) like Gecko```
...
<pre>
default   fe80:bcb5:7704:2263:655d%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {127.199.254.115, 246.193.126.207}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 44:12:06:7b:29:22
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr b2:a5:7d:e9:7c:20
}</pre>
