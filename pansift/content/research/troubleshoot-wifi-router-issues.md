...
subtitle: "Deep Dive?"
layout: research
ip_v4_address: "42.141.54.58"
date: 2022-04-24T19:00:32+01:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like <code>42.141.54.58</code> or an IPv6 address like <code>2000:1542:6bbd:dae0:75cd:6d3b:1af:7ecf</code>. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>4f:07:b0:a5:7f:41</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://hauck-friesen.net you initially access a DNS server to translate the host portion (hauck-friesen) combined with the Top Level Domain (net) of the URL, to an IP address like <code>39.136.11.133</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_3) AppleWebKit/537.75.14 (KHTML, like Gecko) Version/7.0.3 Safari/7046A194A</code>
...
<pre><code>
default   fe80:4710:666a:d219:8418%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {187.36.173.139, 136.103.29.181}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 4f:07:b0:a5:7f:41
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr ff:6f:df:04:2f:27
}</code></pre>
