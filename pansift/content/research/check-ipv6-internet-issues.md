...
layout: research
ip_v4_address: "230.0.67.41"
date: 2022-11-19T16:17:19+00:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like ```230.0.67.41``` or an IPv6 address like ```2000:bc81:7342:c73a:53c7:7f5b:b68f:3951```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```d8:4f:fe:82:2e:ee```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://zemlak-wolf.co you initially access a DNS server to translate the host portion (zemlak-wolf) combined with the Top Level Domain (co) of the URL, to an IP address like ```94.186.106.48```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/41.0.2228.0 Safari/537.36```
...
<pre>
default   fe80:e79d:df07:ec9d:a92e%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {29.28.127.154, 176.76.238.96}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr d8:4f:fe:82:2e:ee
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr d2:02:a5:83:78:73
}</pre>
