---
title: "How Can I Troubleshoot Latency"
subtitle: "Buying Cycle?"
layout: research
ip_v4_address: "27.196.71.85"
date: 2022-11-19T19:13:25+00:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like ```27.196.71.85``` or an IPv6 address like ```18:5f06:b42a:a0d9:b784:76df:d9cf:61c5```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```84:90:ce:ca:7c:16```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://okon-cremin.info you initially access a DNS server to translate the host portion (okon-cremin) combined with the Top Level Domain (info) of the URL, to an IP address like ```44.6.84.242```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (compatible; MSIE 9.0; AOL 9.7; AOLBuild 4343.19; Windows NT 6.1; WOW64; Trident/5.0; FunWebProducts)```

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```192.168.136.92``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  192.168.136.92    UGScg  en0
...
<pre>
default   fe80:2633:89e6:5512:e721%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {230.253.239.213, 254.250.75.140}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 84:90:ce:ca:7c:16
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 3e:6c:8f:48:15:70
}</pre>
