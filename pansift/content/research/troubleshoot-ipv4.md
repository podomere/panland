...
layout: research
ip_v4_address: "124.155.87.115"
date: 2022-04-24T18:59:56+01:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like <code>124.155.87.115</code> or an IPv6 address like <code>2000:3752:4ced:d96a:be48:38bf:d9e8:9f28</code>. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>ac:58:6b:ab:44:19</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://windler-cronin.name you initially access a DNS server to translate the host portion (windler-cronin) combined with the Top Level Domain (name) of the URL, to an IP address like <code>178.237.99.141</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (Windows NT 6.1; WOW64; Trident/7.0; AS; rv:11.0) like Gecko</code>
...
<pre><code>
default   fe80:2962:4e66:5d2f:597f%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {65.194.53.37, 141.217.58.240}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr ac:58:6b:ab:44:19
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr d7:ea:06:7a:6d:18
}</code></pre>
