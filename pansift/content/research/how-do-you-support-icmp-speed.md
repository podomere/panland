...
layout: research
ip_v4_address: "225.40.19.62"
date: 2022-12-15T13:50:19+00:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like ```225.40.19.62``` or an IPv6 address like ```2000:3164:56b5:8a41:e148:fba4:4a6f:4aab```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```e1:fa:56:e3:1b:5a```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://lesch.co you initially access a DNS server to translate the host portion (lesch) combined with the Top Level Domain (co) of the URL, to an IP address like ```190.241.237.51```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT x.y; Win64; x64; rv:10.0) Gecko/20100101 Firefox/10.0```
...
<pre>
default   fe80:358c:b17b:220:ce8d%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {218.20.216.229, 220.149.109.234}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr e1:fa:56:e3:1b:5a
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 65:b0:71:64:88:13
}</pre>
...
## Apple macOS / OSX
No matter what version of OSX/macOS you are on, ```10.11.3```, ```11.5.3```, or ```12.2.1```, there are a range of tools for troubleshooting. Unfortunately, between these manual actions and scripts, they don't give you a series of correlated values over time. This is where automated remote troubleshooting comes in to its own, especially for teams that embrace remote work and Work From Anywhere (WFA).
