---
title: "How Can I Troubleshoot Ping Protocol"
subtitle: "Branding?"
layout: research
ip_v4_address: "235.6.91.6"
date: 2022-11-02T11:32:59+00:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like ```235.6.91.6``` or an IPv6 address like ```2000:ca27:c9e6:4092:d418:70f6:ea63:c986```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```aa:d9:b6:20:88:76```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://koch-lang.name you initially access a DNS server to translate the host portion (koch-lang) combined with the Top Level Domain (name) of the URL, to an IP address like ```104.111.198.72```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/41.0.2228.0 Safari/537.36```

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```172.30.100.78``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  172.30.100.78    UGScg  en0
...
<pre>
default   24:f0a9:e21:1cd5:49ce:2870:ec1f:12dd%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {18.209.110.102, 113.110.95.135}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr aa:d9:b6:20:88:76
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 28:86:3b:54:4a:86
}</pre>
...
## Apple macOS / OSX
No matter what version of OSX/macOS you are on, ```10.14.8```, ```11.2.1```, or ```12.2.6```, there are a range of tools for troubleshooting. Unfortunately, between these manual actions and scripts, they don't give you a series of correlated values over time. This is where automated remote troubleshooting comes in to its own, especially for teams that embrace remote work and Work From Anywhere (WFA).
