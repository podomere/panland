...
subtitle: "Ideate?"
layout: research
ip_v4_address: "182.94.149.209"
date: 2022-04-24T18:59:56+01:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like <code>182.94.149.209</code> or an IPv6 address like <code>2000:df26:e8ab:95cd:a532:6063:2cae:ba40</code>. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>02:73:8f:34:a2:78</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://greenfelder-heller.co you initially access a DNS server to translate the host portion (greenfelder-heller) combined with the Top Level Domain (co) of the URL, to an IP address like <code>148.194.164.192</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (Windows NT 6.1; WOW64; Trident/7.0; AS; rv:11.0) like Gecko</code>
...
<pre><code>
default   fe80:7fd3:250f:72d1:91e4%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {209.29.249.67, 116.237.103.73}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 02:73:8f:34:a2:78
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 85:0c:70:7a:8a:a0
}</code></pre>
