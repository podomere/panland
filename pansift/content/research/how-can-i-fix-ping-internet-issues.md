...
layout: research
ip_v4_address: "67.201.1.96"
date: 2022-04-24T19:00:02+01:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like <code>67.201.1.96</code> or an IPv6 address like <code>2000:892e:586b:a014:19ad:9612:25b3:7590</code>. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>8d:79:d3:3d:ca:72</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://runolfsdottir-auer.info you initially access a DNS server to translate the host portion (runolfsdottir-auer) combined with the Top Level Domain (info) of the URL, to an IP address like <code>35.165.172.124</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Opera/9.80 (X11; Linux i686; Ubuntu/14.10) Presto/2.12.388 Version/12.16</code>
...
<pre><code>
default   fe80:d754:32d:3540:bab8%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {247.27.38.116, 103.238.177.97}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 8d:79:d3:3d:ca:72
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr e1:be:df:1b:a9:f8
}</code></pre>
