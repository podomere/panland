...
subtitle: "Ideate?"
layout: research
ip_v4_address: "15.230.115.48"
date: 2022-04-24T18:31:58+01:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like <code>15.230.115.48</code> or an IPv6 address like <code>2000:b482:3d35:9e0f:c6af:7f5a:44b2:45e6</code>. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>5a:22:39:fb:b6:98</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://murray-dickinson.org you initially access a DNS server to translate the host portion (murray-dickinson) combined with the Top Level Domain (org) of the URL, to an IP address like <code>18.5.147.194</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (Windows; U; Win 9x 4.90; SG; rv:1.9.2.4) Gecko/20101104 Netscape/9.1.0285</code>
...
<pre><code>
default   fe80:1a52:8912:8ae1:cbbc%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {171.240.114.171, 112.165.166.66}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 5a:22:39:fb:b6:98
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 9a:89:26:4d:3c:4c
}</code></pre>
