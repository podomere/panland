---
title: "Check IPv6 Connectivity"
subtitle: "Agile Marketing?"
layout: research
ip_v4_address: "43.63.35.164"
date: 2023-02-04T16:26:17+00:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like ```43.63.35.164``` or an IPv6 address like ```2000:d5e4:8a07:c73:5efd:6517:7d5c:851d```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```28:f6:d8:f7:b1:5a```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://davis-bechtelar.net you initially access a DNS server to translate the host portion (davis-bechtelar) combined with the Top Level Domain (net) of the URL, to an IP address like ```148.178.166.188```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (compatible; MSIE 9.0; AOL 9.7; AOLBuild 4343.19; Windows NT 6.1; WOW64; Trident/5.0; FunWebProducts)```

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```10.254.118.157``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  10.254.118.157    UGScg  en0
...
<pre>
default   fe80:af26:567d:abc2:efc6%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {47.159.151.131, 37.161.190.108}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 28:f6:d8:f7:b1:5a
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr ce:39:0c:fa:7e:c4
}</pre>
