...
subtitle: "Streamline?"
layout: research
ip_v4_address: "136.59.119.109"
date: 2022-04-24T18:59:55+01:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like <code>136.59.119.109</code> or an IPv6 address like <code>2000:e10e:12dd:d77:4db7:d116:bef9:ac17</code>. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>2c:9f:c8:d8:8f:41</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://denesik-runte.info you initially access a DNS server to translate the host portion (denesik-runte) combined with the Top Level Domain (info) of the URL, to an IP address like <code>169.6.119.121</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (Windows; U; Win 9x 4.90; SG; rv:1.9.2.4) Gecko/20101104 Netscape/9.1.0285</code>
...
<pre><code>
default   fe80:ceb6:3da6:954:8a7d%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {194.113.50.139, 186.147.108.119}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 2c:9f:c8:d8:8f:41
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr dd:71:c8:42:a6:b0
}</code></pre>
