...
layout: research
ip_v4_address: "0.204.211.8"
date: 2022-06-04T14:38:39+01:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like ```0.204.211.8``` or an IPv6 address like ```2000:fe0f:1fdb:2ed3:4f4e:b4cb:ecf0:7c8a```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```ca:e7:20:1e:64:8f```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://walsh-kovacek.name you initially access a DNS server to translate the host portion (walsh-kovacek) combined with the Top Level Domain (name) of the URL, to an IP address like ```144.225.159.199```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1; WOW64; Trident/7.0; AS; rv:11.0) like Gecko```
...
<pre>
default   fe80:dc10:3ec:1eb3:a609%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {232.214.219.136, 99.215.122.142}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr ca:e7:20:1e:64:8f
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 32:a1:fc:42:5c:e3
}</pre>
