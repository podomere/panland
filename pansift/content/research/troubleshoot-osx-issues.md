...
layout: research
ip_v4_address: "36.100.61.103"
date: 2022-04-24T19:00:24+01:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like <code>36.100.61.103</code> or an IPv6 address like <code>2000:7660:f93b:2c3c:9144:7765:be34:a91f</code>. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>b1:fc:d6:f3:c1:ee</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://rath-hettinger.biz you initially access a DNS server to translate the host portion (rath-hettinger) combined with the Top Level Domain (biz) of the URL, to an IP address like <code>139.244.201.166</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (compatible; MSIE 9.0; AOL 9.7; AOLBuild 4343.19; Windows NT 6.1; WOW64; Trident/5.0; FunWebProducts)</code>

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like <code>10.64.233.62</code> (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For <code>IPv6</code> we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  10.64.233.62    UGScg  en0
...
<pre><code>
default   fe80:8503:2675:fda1:936f%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {115.69.33.39, 103.178.33.195}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr b1:fc:d6:f3:c1:ee
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr b6:1f:7e:44:07:51
}</code></pre>
