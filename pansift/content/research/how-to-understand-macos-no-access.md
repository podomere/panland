...
layout: research
ip_v4_address: "48.105.145.167"
date: 2022-04-24T18:31:57+01:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like <code>48.105.145.167</code> or an IPv6 address like <code>2000:c733:a5fa:7405:c6f6:e22c:8d9:95a7</code>. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>bf:a0:13:64:77:1f</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://feil.net you initially access a DNS server to translate the host portion (feil) combined with the Top Level Domain (net) of the URL, to an IP address like <code>31.49.219.211</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Opera/9.80 (X11; Linux i686; Ubuntu/14.10) Presto/2.12.388 Version/12.16</code>
...
<pre><code>
default   fe80:29d7:a0bf:c25b:3326%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {90.50.187.210, 159.254.253.113}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr bf:a0:13:64:77:1f
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr ae:76:bb:ba:29:20
}</code></pre>
