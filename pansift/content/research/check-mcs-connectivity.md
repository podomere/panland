...
layout: research
ip_v4_address: "113.30.71.32"
date: 2023-10-29T15:13:12+00:00
draft: false
---

## Internet Addressing
On the Internet you might have a Public IPv4 address like ```113.30.71.32``` or an IPv6 address like ```2000:677f:af25:13be:3a11:cb2c:3ac:cfb9```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```51:00:71:b1:a1:26```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://bosco-brown.io you initially access a DNS server to translate the host portion (bosco-brown) combined with the Top Level Domain (io) of the URL, to an IP address like ```139.43.16.85```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (compatible; MSIE 9.0; AOL 9.7; AOLBuild 4343.19; Windows NT 6.1; WOW64; Trident/5.0; FunWebProducts)```
...
<pre>
default   fe80:ab87:c7a3:9eb2:3b8a%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {198.229.12.61, 184.35.198.147}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 51:00:71:b1:a1:26
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 65:49:04:1c:34:c2
}</pre>
