...
layout: research
ip_v4_address: "116.207.84.6"
date: 2022-12-15T13:50:04+00:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like ```116.207.84.6``` or an IPv6 address like ```2000:ec3b:c3fb:a491:7349:c64a:f470:b221```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```b7:91:8f:d3:97:27```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://rogahn.biz you initially access a DNS server to translate the host portion (rogahn) combined with the Top Level Domain (biz) of the URL, to an IP address like ```199.2.29.203```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows; U; Win 9x 4.90; SG; rv:1.9.2.4) Gecko/20101104 Netscape/9.1.0285```
...
<pre>
default   fe80:20d:596f:90a9:ed54%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {12.33.5.174, 108.224.102.20}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr b7:91:8f:d3:97:27
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 8a:c4:8d:31:5e:39
}</pre>
