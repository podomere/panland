...
subtitle: "Synergy?"
layout: research
ip_v4_address: "161.114.134.44"
date: 2023-10-06T17:11:03+01:00
draft: false
---

## Internet Addressing
On the Internet you may have a Public IPv4 address like ```161.114.134.44``` or an IPv6 address like ```2000:613c:6f89:8bfa:5ec6:2a09:984f:d1b7```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```8c:5a:d9:3d:9c:f2```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://vonrueden.org you initially access a DNS server to translate the host portion (vonrueden) combined with the Top Level Domain (org) of the URL, to an IP address like ```196.166.239.182```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/41.0.2228.0 Safari/537.36```

## Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```172.25.128.213``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  172.25.128.213    UGScg  en0
...
<pre>
default   fe80:94c1:2248:8e04:e663%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {66.35.83.27, 171.122.140.94}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 8c:5a:d9:3d:9c:f2
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 35:c5:be:8f:5c:36
}</pre>
