...
layout: research
ip_v4_address: "167.151.5.186"
date: 2022-11-19T19:13:27+00:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like ```167.151.5.186``` or an IPv6 address like ```2000:e031:d876:c45:d387:545:eb9c:ebeb```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```48:35:86:a2:6a:1b```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://aufderhar-kub.co you initially access a DNS server to translate the host portion (aufderhar-kub) combined with the Top Level Domain (co) of the URL, to an IP address like ```26.161.206.89```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT x.y; Win64; x64; rv:10.0) Gecko/20100101 Firefox/10.0```
...
<pre>
default   fe80:83fe:1ad4:1c98:cfd0%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {233.2.179.233, 103.76.32.125}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 48:35:86:a2:6a:1b
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr a5:65:e1:ad:f5:da
}</pre>
