...
layout: research
ip_v4_address: "107.160.198.23"
date: 2022-11-19T19:13:17+00:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like ```107.160.198.23``` or an IPv6 address like ```2000:bb58:dbc4:4ab7:2924:d648:ec52:7734```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```59:1c:d7:83:78:bb```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://bergstrom-boyer.net you initially access a DNS server to translate the host portion (bergstrom-boyer) combined with the Top Level Domain (net) of the URL, to an IP address like ```215.63.121.177```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows; U; Win 9x 4.90; SG; rv:1.9.2.4) Gecko/20101104 Netscape/9.1.0285```
...
<pre>
default   fe80:7917:30b1:2f27:5ccb%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {6.241.6.142, 71.2.86.194}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 59:1c:d7:83:78:bb
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr ca:7c:18:5a:e2:ac
}</pre>
