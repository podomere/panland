...
layout: research
ip_v4_address: "199.109.208.142"
date: 2023-10-29T15:13:18+00:00
draft: false
---

## Internet Addressing
On the Internet you may have a Public IPv4 address like ```199.109.208.142``` or an IPv6 address like ```2000:3ad9:bbb7:ff9c:9725:cc9c:9f9:80ce```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```79:65:78:1d:ed:5c```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://bashirian-cummings.io you initially access a DNS server to translate the host portion (bashirian-cummings) combined with the Top Level Domain (io) of the URL, to an IP address like ```12.185.54.90```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows; U; Win 9x 4.90; SG; rv:1.9.2.4) Gecko/20101104 Netscape/9.1.0285```
...
<pre>
default   fe80:2019:f963:80dd:d961%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {197.63.192.220, 225.121.104.123}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 79:65:78:1d:ed:5c
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 34:5c:16:6d:2d:0e
}</pre>
