...
layout: research
ip_v4_address: "93.3.125.192"
date: 2023-02-04T17:07:48+00:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like ```93.3.125.192``` or an IPv6 address like ```2000:941e:70a5:b871:bcd:9b8b:b097:5445```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```df:92:20:46:fa:1e```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://ortiz-kessler.name you initially access a DNS server to translate the host portion (ortiz-kessler) combined with the Top Level Domain (name) of the URL, to an IP address like ```188.251.177.237```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT x.y; Win64; x64; rv:10.0) Gecko/20100101 Firefox/10.0```
...
<pre>
default   fe80:9b0:dfe5:463d:e8b8%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {157.75.92.250, 61.67.83.163}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr df:92:20:46:fa:1e
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr ec:1c:e0:f6:4b:c0
}</pre>
