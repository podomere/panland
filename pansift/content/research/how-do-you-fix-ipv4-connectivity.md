---
title: "How Do You Fix IPv4 Connectivity"
subtitle: "Had To 'punt' On That?"
layout: research
ip_v4_address: "239.176.203.209"
date: 2022-11-19T19:13:24+00:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like ```239.176.203.209``` or an IPv6 address like ```2000:5fbc:69fd:97d8:352a:6753:7267:5589```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```ae:31:a5:cc:ec:18```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://berge-treutel.co you initially access a DNS server to translate the host portion (berge-treutel) combined with the Top Level Domain (co) of the URL, to an IP address like ```115.194.1.103```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1; WOW64; Trident/7.0; AS; rv:11.0) like Gecko```
...
<pre>
default   fe80:a8bd:dd7c:327d:8a04%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {35.179.188.150, 219.144.4.108}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr ae:31:a5:cc:ec:18
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 78:77:5e:d9:63:2e
}</pre>
...
## Apple macOS / OSX
No matter what version of OSX/macOS you are on, ```10.13.1```, ```11.6.2```, or ```12.3.5```, there are a range of tools for troubleshooting. Unfortunately, between these manual actions and scripts, they don't give you a series of correlated values over time. This is where automated remote troubleshooting comes in to its own, especially for teams that embrace remote work and Work From Anywhere (WFA).
