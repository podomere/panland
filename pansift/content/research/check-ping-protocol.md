...
layout: research
ip_v4_address: "147.60.127.150"
date: 2022-04-24T19:00:01+01:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like <code>147.60.127.150</code> or an IPv6 address like <code>2000:b7a2:cd66:86b3:992e:2678:7a29:51b5</code>. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>ce:82:d1:c8:ca:53</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://hartmann-nikolaus.name you initially access a DNS server to translate the host portion (hartmann-nikolaus) combined with the Top Level Domain (name) of the URL, to an IP address like <code>102.127.189.45</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Opera/9.80 (X11; Linux i686; Ubuntu/14.10) Presto/2.12.388 Version/12.16</code>

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like <code>10.88.151.11</code> (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For <code>IPv6</code> we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  10.88.151.11    UGScg  en0
...
<pre><code>
default   fe80:d55:b75c:9f21:4e3a%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {6.114.20.102, 91.96.80.221}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr ce:82:d1:c8:ca:53
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 0d:cb:55:1d:47:84
}</code></pre>
