...
layout: research
ip_v4_address: "176.80.129.222"
date: 2022-04-24T19:00:33+01:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like <code>176.80.129.222</code> or an IPv6 address like <code>2000:85c5:5e99:9008:29dc:9a39:8f44:8935</code>. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>1d:25:ec:f4:eb:c7</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://kertzmann-wintheiser.co you initially access a DNS server to translate the host portion (kertzmann-wintheiser) combined with the Top Level Domain (co) of the URL, to an IP address like <code>146.68.141.9</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (compatible; MSIE 9.0; AOL 9.7; AOLBuild 4343.19; Windows NT 6.1; WOW64; Trident/5.0; FunWebProducts)</code>

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like <code>192.168.167.203</code> (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For <code>IPv6</code> we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  192.168.167.203    UGScg  en0
...
<pre><code>
default   fe80:875d:66be:318:dd19%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {198.108.154.200, 108.56.171.128}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 1d:25:ec:f4:eb:c7
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr f9:eb:95:ad:bf:58
}</code></pre>
