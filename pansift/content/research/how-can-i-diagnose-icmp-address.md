...
subtitle: "Swim Lane?"
layout: research
ip_v4_address: "67.187.238.204"
date: 2022-04-24T19:00:01+01:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like <code>67.187.238.204</code> or an IPv6 address like <code>2000:7fb7:8f33:b889:448f:6c23:a1f8:ea96</code>. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>65:be:01:f9:e9:b2</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://flatley-rogahn.biz you initially access a DNS server to translate the host portion (flatley-rogahn) combined with the Top Level Domain (biz) of the URL, to an IP address like <code>111.208.116.32</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (Windows NT 6.1; WOW64; Trident/7.0; AS; rv:11.0) like Gecko</code>

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like <code>10.182.35.98</code> (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For <code>IPv6</code> we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  10.182.35.98    UGScg  en0
...
<pre><code>
default   68a:72fb:f8:c5f2:c101:d582:5437:5568%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {36.162.165.136, 120.93.171.111}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 65:be:01:f9:e9:b2
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 89:87:ca:c1:79:13
}</code></pre>
