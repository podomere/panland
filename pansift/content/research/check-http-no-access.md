...
layout: research
ip_v4_address: "210.66.88.170"
date: 2022-06-04T14:38:43+01:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like ```210.66.88.170``` or an IPv6 address like ```2000:4046:4450:9e40:6ae4:dc91:1cf8:749f```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```e1:fc:85:19:e7:fb```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://christiansen-kassulke.com you initially access a DNS server to translate the host portion (christiansen-kassulke) combined with the Top Level Domain (com) of the URL, to an IP address like ```38.79.14.130```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows; U; Win 9x 4.90; SG; rv:1.9.2.4) Gecko/20101104 Netscape/9.1.0285```
...
<pre>
default   fe80:6ddb:d9de:34f1:f764%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {216.35.58.114, 9.250.121.106}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr e1:fc:85:19:e7:fb
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr ab:9b:c0:af:2e:78
}</pre>
