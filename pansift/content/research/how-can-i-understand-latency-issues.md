...
subtitle: "Granular?"
layout: research
ip_v4_address: "153.111.138.76"
date: 2022-05-05T14:29:41+01:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like ```153.111.138.76``` or an IPv6 address like ```2000:56e1:e6da:fefc:2b8f:2146:a98b:6b11```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```a3:de:26:4e:a2:2e```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://leuschke-kozey.co you initially access a DNS server to translate the host portion (leuschke-kozey) combined with the Top Level Domain (co) of the URL, to an IP address like ```204.248.121.114```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/41.0.2228.0 Safari/537.36```

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```172.23.93.223``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  172.23.93.223    UGScg  en0
...
<pre>
default   fe80:ef1d:27e1:cfb4:cfa9%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {54.212.146.44, 59.206.87.107}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr a3:de:26:4e:a2:2e
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 38:44:b4:41:7c:1d
}</pre>
...
## Apple macOS / OSX
No matter what version of OSX/macOS you are on, ```10.12.1```, ```11.3.8```, or ```12.1.3```, there are a range of tools for troubleshooting. Unfortunately, between these manual actions and scripts, they don't give you a series of correlated values over time. This is where automated remote troubleshooting comes in to its own, especially for teams that embrace remote work and Work From Anywhere (WFA).
