...
layout: research
ip_v4_address: "99.151.86.5"
date: 2023-10-06T17:11:03+01:00
draft: false
---

## Internet Addressing
On the Internet you may have a Public IPv4 address like ```99.151.86.5``` or an IPv6 address like ```2000:b199:a2c7:9c7a:b79f:755b:2432:a341```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```c8:d3:c8:67:74:9a```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://schoen.biz you initially access a DNS server to translate the host portion (schoen) combined with the Top Level Domain (biz) of the URL, to an IP address like ```30.105.26.209```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows; U; Win 9x 4.90; SG; rv:1.9.2.4) Gecko/20101104 Netscape/9.1.0285```

## Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```192.168.42.235``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  192.168.42.235    UGScg  en0
...
<pre>
default   fe80:dc77:ab0a:64a1:d857%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {127.161.198.197, 133.116.184.166}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr c8:d3:c8:67:74:9a
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 32:7f:68:3d:a9:b0
}</pre>
