...
layout: research
ip_v4_address: "56.221.225.84"
date: 2023-02-04T17:07:41+00:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like ```56.221.225.84``` or an IPv6 address like ```2000:c84c:c963:702a:1c0c:f59a:a7b3:9821```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```09:98:b0:36:80:65```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://hand.org you initially access a DNS server to translate the host portion (hand) combined with the Top Level Domain (org) of the URL, to an IP address like ```196.222.155.49```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1; WOW64; Trident/7.0; AS; rv:11.0) like Gecko```

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```172.20.86.250``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  172.20.86.250    UGScg  en0
...
<pre>
default   fe80:7c9e:71f1:398:f5d4%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {108.90.157.76, 102.183.130.215}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 09:98:b0:36:80:65
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr e9:85:fa:4f:0d:d4
}</pre>
