...
layout: research
ip_v4_address: "218.222.155.240"
date: 2022-04-24T18:32:42+01:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like <code>218.222.155.240</code> or an IPv6 address like <code>2000:c60f:a2fc:7235:98c2:638c:7bc9:848e</code>. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>bc:4b:fc:d3:42:e2</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://lowe-wisoky.co you initially access a DNS server to translate the host portion (lowe-wisoky) combined with the Top Level Domain (co) of the URL, to an IP address like <code>126.189.215.158</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (compatible; MSIE 9.0; AOL 9.7; AOLBuild 4343.19; Windows NT 6.1; WOW64; Trident/5.0; FunWebProducts)</code>
...
<pre><code>
default   fe80:6e5e:a952:fa0c:855f%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {122.242.203.198, 17.114.17.194}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr bc:4b:fc:d3:42:e2
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 35:f5:3d:ec:f8:ef
}</code></pre>
