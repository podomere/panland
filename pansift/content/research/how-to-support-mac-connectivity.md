...
subtitle: "Tee It Up?"
layout: research
ip_v4_address: "186.25.152.132"
date: 2022-04-24T19:00:25+01:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like <code>186.25.152.132</code> or an IPv6 address like <code>2000:8e91:634e:cf9c:fd0f:e73b:394c:7c13</code>. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>b0:79:7f:25:ce:43</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://cartwright-lesch.com you initially access a DNS server to translate the host portion (cartwright-lesch) combined with the Top Level Domain (com) of the URL, to an IP address like <code>5.19.4.3</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (compatible; MSIE 9.0; AOL 9.7; AOLBuild 4343.19; Windows NT 6.1; WOW64; Trident/5.0; FunWebProducts)</code>
...
<pre><code>
default   fe80:d63c:6ab2:a136:bca%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {99.199.91.225, 200.23.111.226}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr b0:79:7f:25:ce:43
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr ce:e3:4b:ab:3a:4e
}</code></pre>
