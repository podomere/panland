...
layout: research
ip_v4_address: "122.92.226.157"
date: 2022-11-19T19:13:23+00:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like ```122.92.226.157``` or an IPv6 address like ```2000:e424:d534:d8f8:d08e:35f4:8547:be98```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```61:34:ef:d9:05:00```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://dicki-bogisich.co you initially access a DNS server to translate the host portion (dicki-bogisich) combined with the Top Level Domain (co) of the URL, to an IP address like ```128.52.116.168```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_3) AppleWebKit/537.75.14 (KHTML, like Gecko) Version/7.0.3 Safari/7046A194A```
...
<pre>
default   fe80:a60f:acf1:7456:2614%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {61.70.205.220, 128.149.146.23}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 61:34:ef:d9:05:00
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr bf:36:9e:06:68:03
}</pre>
