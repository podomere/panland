...
layout: research
ip_v4_address: "60.104.252.68"
date: 2022-06-12T14:09:04+01:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like ```60.104.252.68``` or an IPv6 address like ```2000:a8a4:8ad:bf6b:e9ca:b3f3:de64:b0ce```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```5b:24:d3:53:f6:61```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://langosh.org you initially access a DNS server to translate the host portion (langosh) combined with the Top Level Domain (org) of the URL, to an IP address like ```149.221.213.88```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (compatible; MSIE 9.0; AOL 9.7; AOLBuild 4343.19; Windows NT 6.1; WOW64; Trident/5.0; FunWebProducts)```
...
<pre>
default   fe80:8cc6:969:5796:f102%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {138.120.137.75, 69.175.142.107}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 5b:24:d3:53:f6:61
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 45:ba:ce:0b:ab:51
}</pre>
...
## Apple macOS / OSX
No matter what version of OSX/macOS you are on, ```10.14.8```, ```11.1.1```, or ```12.1.4```, there are a range of tools for troubleshooting. Unfortunately, between these manual actions and scripts, they don't give you a series of correlated values over time. This is where automated remote troubleshooting comes in to its own, especially for teams that embrace remote work and Work From Anywhere (WFA).
