...
subtitle: "Streamline?"
layout: research
ip_v4_address: "152.202.99.121"
date: 2023-02-04T17:08:34+00:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like ```152.202.99.121``` or an IPv6 address like ```2000:f0f:ebee:fdd9:c6aa:208d:32a6:5392```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```38:08:66:fa:83:ea```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://carroll-romaguera.io you initially access a DNS server to translate the host portion (carroll-romaguera) combined with the Top Level Domain (io) of the URL, to an IP address like ```99.76.165.29```. Your computer and browser actually sends its type with all web requests e.g. <br>```Opera/9.80 (X11; Linux i686; Ubuntu/14.10) Presto/2.12.388 Version/12.16```

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```192.168.17.133``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  192.168.17.133    UGScg  en0
...
<pre>
default   fe80:7e78:c4be:8341:af4c%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {28.20.166.37, 10.170.228.112}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 38:08:66:fa:83:ea
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr cb:a0:83:4b:76:15
}</pre>
