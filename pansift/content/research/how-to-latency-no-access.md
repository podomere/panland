...
subtitle: "Deep Dive?"
layout: research
ip_v4_address: "54.43.111.4"
date: 2022-06-04T14:38:38+01:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like ```54.43.111.4``` or an IPv6 address like ```2000:90cb:78e6:8ded:393b:1a0c:22f3:d2b7```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```ce:3e:bc:c4:b6:04```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://turner-doyle.biz you initially access a DNS server to translate the host portion (turner-doyle) combined with the Top Level Domain (biz) of the URL, to an IP address like ```86.53.235.110```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/41.0.2228.0 Safari/537.36```
...
<pre>
default   fe80:10a0:5825:5980:a328%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {14.61.205.138, 18.1.197.106}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr ce:3e:bc:c4:b6:04
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 25:68:75:ef:5e:c4
}</pre>
