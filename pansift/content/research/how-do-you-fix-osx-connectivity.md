...
layout: research
ip_v4_address: "170.82.76.137"
date: 2022-04-24T19:00:24+01:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like <code>170.82.76.137</code> or an IPv6 address like <code>2000:edb9:e9d:1973:ae2e:9660:c8c0:f301</code>. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>d3:d2:cc:3c:a6:db</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://grant-schamberger.biz you initially access a DNS server to translate the host portion (grant-schamberger) combined with the Top Level Domain (biz) of the URL, to an IP address like <code>180.72.65.242</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Opera/9.80 (X11; Linux i686; Ubuntu/14.10) Presto/2.12.388 Version/12.16</code>
...
<pre><code>
default   fe80:34a4:c33:5da4:1299%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {91.195.10.36, 123.117.177.160}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr d3:d2:cc:3c:a6:db
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 3e:f8:97:42:35:37
}</code></pre>
