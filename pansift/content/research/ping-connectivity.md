...
layout: research
ip_v4_address: "74.77.65.172"
date: 2022-05-05T14:29:55+01:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like ```74.77.65.172``` or an IPv6 address like ```2000:37bb:3f54:6e40:8d65:8fbf:c0e:7343```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```f4:37:69:ae:ff:c8```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://smith-huel.biz you initially access a DNS server to translate the host portion (smith-huel) combined with the Top Level Domain (biz) of the URL, to an IP address like ```82.164.157.197```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1; WOW64; Trident/7.0; AS; rv:11.0) like Gecko```
...
<pre>
default   fe80:2c70:1dc0:daf2:ebd6%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {7.98.238.32, 48.47.217.154}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr f4:37:69:ae:ff:c8
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr d4:b5:e6:cb:eb:49
}</pre>
