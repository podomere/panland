...
layout: research
ip_v4_address: "194.224.95.17"
date: 2023-02-04T16:26:19+00:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like ```194.224.95.17``` or an IPv6 address like ```2000:6d18:41a5:7c63:2b22:7978:e1fe:8fad```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```d1:b1:c6:e8:87:5a```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://senger-purdy.name you initially access a DNS server to translate the host portion (senger-purdy) combined with the Top Level Domain (name) of the URL, to an IP address like ```130.173.169.35```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows; U; Win 9x 4.90; SG; rv:1.9.2.4) Gecko/20101104 Netscape/9.1.0285```

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```10.35.148.205``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  10.35.148.205    UGScg  en0
...
<pre>
default   fe80:fefb:a6cb:c7f8:abe0%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {113.23.10.125, 129.67.117.243}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr d1:b1:c6:e8:87:5a
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr d1:89:4d:87:9c:6c
}</pre>
...
## Apple macOS / OSX
No matter what version of OSX/macOS you are on, ```10.11.6```, ```11.6.6```, or ```12.3.3```, there are a range of tools for troubleshooting. Unfortunately, between these manual actions and scripts, they don't give you a series of correlated values over time. This is where automated remote troubleshooting comes in to its own, especially for teams that embrace remote work and Work From Anywhere (WFA).
