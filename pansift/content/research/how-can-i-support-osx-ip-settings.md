...
layout: research
ip_v4_address: "79.74.175.87"
date: 2022-12-15T13:50:10+00:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like ```79.74.175.87``` or an IPv6 address like ```2000:76b4:18d2:7020:885d:d0c2:d8ec:6f8d```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```a2:51:7b:ad:c9:e2```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://gottlieb.org you initially access a DNS server to translate the host portion (gottlieb) combined with the Top Level Domain (org) of the URL, to an IP address like ```69.211.239.183```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1; WOW64; Trident/7.0; AS; rv:11.0) like Gecko```

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```172.24.174.246``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  172.24.174.246    UGScg  en0
...
<pre>
default   fe80:df90:9d57:d268:7abc%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {47.234.220.164, 31.221.0.194}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr a2:51:7b:ad:c9:e2
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr bf:48:08:e3:bd:e6
}</pre>
