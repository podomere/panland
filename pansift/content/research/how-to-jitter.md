...
layout: research
ip_v4_address: "171.197.130.224"
date: 2022-04-24T18:59:59+01:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like <code>171.197.130.224</code> or an IPv6 address like <code>2000:927d:e32f:8a16:6e2e:4630:30d4:f02</code>. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>90:83:81:fd:0c:5e</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://lemke-keeling.org you initially access a DNS server to translate the host portion (lemke-keeling) combined with the Top Level Domain (org) of the URL, to an IP address like <code>118.108.24.70</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Opera/9.80 (X11; Linux i686; Ubuntu/14.10) Presto/2.12.388 Version/12.16</code>
...
<pre><code>
default   fe80:d927:27d3:75ad:5414%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {183.148.20.79, 131.69.53.170}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 90:83:81:fd:0c:5e
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 36:b0:ab:d5:3d:07
}</code></pre>
