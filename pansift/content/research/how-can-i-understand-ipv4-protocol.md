...
subtitle: "Streamline?"
layout: research
ip_v4_address: "54.121.61.46"
date: 2023-10-29T15:13:25+00:00
draft: false
---

## Internet Addressing
On the Internet you might get a Public IPv4 address like ```54.121.61.46``` or an IPv6 address like ```2000:9cd:849c:431d:9721:ef44:fbd0:e46e```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```ae:dd:a3:68:40:44```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://nicolas-jerde.org you initially access a DNS server to translate the host portion (nicolas-jerde) combined with the Top Level Domain (org) of the URL, to an IP address like ```186.135.15.197```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1; WOW64; Trident/7.0; AS; rv:11.0) like Gecko```

## Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```172.26.59.67``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  172.26.59.67    UGScg  en0
...
<pre>
default   fe80:e191:f489:e55c:69ef%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {90.144.14.163, 248.79.180.83}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr ae:dd:a3:68:40:44
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 5b:22:5d:fb:a9:24
}</pre>
