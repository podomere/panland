...
layout: research
ip_v4_address: "249.145.239.60"
date: 2023-02-04T16:26:17+00:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like ```249.145.239.60``` or an IPv6 address like ```2000:663f:b937:b78d:d721:c4bd:b4a6:f26d```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```f2:94:dd:37:4d:73```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://schuster-jacobson.io you initially access a DNS server to translate the host portion (schuster-jacobson) combined with the Top Level Domain (io) of the URL, to an IP address like ```234.199.39.141```. Your computer and browser actually sends its type with all web requests e.g. <br>```Opera/9.80 (X11; Linux i686; Ubuntu/14.10) Presto/2.12.388 Version/12.16```
...
<pre>
default   fe80:209e:7fa1:9761:5506%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {247.220.96.132, 110.84.209.231}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr f2:94:dd:37:4d:73
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 0e:d8:c5:e9:0b:8f
}</pre>
