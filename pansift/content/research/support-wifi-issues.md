...
layout: research
ip_v4_address: "26.200.74.137"
date: 2022-06-04T14:38:16+01:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like ```26.200.74.137``` or an IPv6 address like ```2000:2de6:ae8d:146a:37fe:de8:ac39:b66d```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```99:c8:d3:22:59:77```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://little-hyatt.co you initially access a DNS server to translate the host portion (little-hyatt) combined with the Top Level Domain (co) of the URL, to an IP address like ```143.44.40.89```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows; U; Win 9x 4.90; SG; rv:1.9.2.4) Gecko/20101104 Netscape/9.1.0285```
...
<pre>
default   fe80:1dfa:aab2:1813:bff6%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {208.217.130.109, 172.218.114.34}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 99:c8:d3:22:59:77
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 1e:89:ce:95:69:dc
}</pre>
