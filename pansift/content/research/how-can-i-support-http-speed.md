...
layout: research
ip_v4_address: "109.96.133.75"
date: 2023-02-04T16:26:23+00:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like ```109.96.133.75``` or an IPv6 address like ```2000:4265:ac6e:14fb:235:e2f9:ea18:1a3c```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```4a:0f:b7:2f:05:c5```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://boyer-kohler.org you initially access a DNS server to translate the host portion (boyer-kohler) combined with the Top Level Domain (org) of the URL, to an IP address like ```43.91.55.148```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT x.y; Win64; x64; rv:10.0) Gecko/20100101 Firefox/10.0```
...
default  172.18.231.208    UGScg  en0
...
<pre>
default   fe80:4522:efac:82bd:ba44%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {152.61.203.151, 16.155.48.209}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 4a:0f:b7:2f:05:c5
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr df:f9:b9:7d:65:bd
}</pre>
