...
layout: research
ip_v4_address: "163.243.185.253"
date: 2022-11-02T11:32:54+00:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like ```163.243.185.253``` or an IPv6 address like ```2000:9b35:639c:7832:a1cf:5dc8:766c:79e6```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```4d:42:f2:54:ad:72```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://ferry-herzog.info you initially access a DNS server to translate the host portion (ferry-herzog) combined with the Top Level Domain (info) of the URL, to an IP address like ```44.151.155.213```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_3) AppleWebKit/537.75.14 (KHTML, like Gecko) Version/7.0.3 Safari/7046A194A```
...
<pre>
default   fe80:64ff:af25:700b:6fa8%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {45.233.82.159, 175.251.193.193}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 4d:42:f2:54:ad:72
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 4b:ee:49:9c:b8:a3
}</pre>
