...
layout: research
ip_v4_address: "168.36.114.205"
date: 2023-02-04T17:08:37+00:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like ```168.36.114.205``` or an IPv6 address like ```2000:892b:b10:cf69:ccf8:204e:28f9:8a5b```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```85:00:79:77:97:54```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://lockman.co you initially access a DNS server to translate the host portion (lockman) combined with the Top Level Domain (co) of the URL, to an IP address like ```53.124.246.153```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT x.y; Win64; x64; rv:10.0) Gecko/20100101 Firefox/10.0```

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```192.168.8.208``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  192.168.8.208    UGScg  en0
...
<pre>
default   fe80:471c:f4b3:b434:59cb%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {101.245.62.61, 238.52.92.99}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 85:00:79:77:97:54
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 47:43:0a:c1:9f:17
}</pre>
...
## Apple macOS / OSX
No matter what version of OSX/macOS you are on, ```10.11.9```, ```11.3.8```, or ```12.1.4```, there are a range of tools for troubleshooting. Unfortunately, between these manual actions and scripts, they don't give you a series of correlated values over time. This is where automated remote troubleshooting comes in to its own, especially for teams that embrace remote work and Work From Anywhere (WFA).
