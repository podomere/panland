...
layout: research
ip_v4_address: "159.80.38.248"
date: 2023-10-06T17:10:31+01:00
draft: false
---

## Internet Addressing
On the Internet you may have a Public IPv4 address like ```159.80.38.248``` or an IPv6 address like ```2000:fb4b:a3e3:a603:961a:cf8d:870c:16cc```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```81:65:9a:26:b1:dc```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://lubowitz-simonis.org you initially access a DNS server to translate the host portion (lubowitz-simonis) combined with the Top Level Domain (org) of the URL, to an IP address like ```71.124.184.254```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1; WOW64; Trident/7.0; AS; rv:11.0) like Gecko```
...
<pre>
default   fe80:db1b:fc58:1b37:5ae6%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {21.75.205.5, 241.57.48.89}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 81:65:9a:26:b1:dc
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 5e:9c:a5:6f:58:83
}</pre>
