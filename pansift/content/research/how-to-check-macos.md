...
subtitle: "Swag?"
layout: research
ip_v4_address: "122.24.55.57"
date: 2022-04-24T19:00:23+01:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like <code>122.24.55.57</code> or an IPv6 address like <code>2000:3f61:e944:3278:80e1:b2de:fac4:4bab</code>. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>4e:e3:d4:38:dc:1f</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://roberts.co you initially access a DNS server to translate the host portion (roberts) combined with the Top Level Domain (co) of the URL, to an IP address like <code>252.84.105.147</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (Windows NT x.y; Win64; x64; rv:10.0) Gecko/20100101 Firefox/10.0</code>
...
<pre><code>
default   fe80:a22:42c:c6c7:6deb%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {44.85.247.46, 105.79.43.139}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 4e:e3:d4:38:dc:1f
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 0c:c0:0a:1a:3d:67
}</code></pre>
