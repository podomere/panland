...
layout: research
ip_v4_address: "103.16.236.57"
date: 2023-02-04T16:26:04+00:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like ```103.16.236.57``` or an IPv6 address like ```2000:3295:d50d:b3:e043:31d4:1976:8dd5```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```1a:b5:d6:d8:38:91```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://smith-stehr.biz you initially access a DNS server to translate the host portion (smith-stehr) combined with the Top Level Domain (biz) of the URL, to an IP address like ```58.156.60.71```. Your computer and browser actually sends its type with all web requests e.g. <br>```Opera/9.80 (X11; Linux i686; Ubuntu/14.10) Presto/2.12.388 Version/12.16```
...
<pre>
default   fe80:1f2d:65f7:61b5:223b%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {49.57.223.13, 232.1.83.107}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 1a:b5:d6:d8:38:91
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 08:20:b5:2f:1e:4f
}</pre>
