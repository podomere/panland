...
layout: research
ip_v4_address: "5.159.39.243"
date: 2022-11-19T19:13:09+00:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like ```5.159.39.243``` or an IPv6 address like ```2000:f4c7:2b4e:86e7:483d:19e6:85e:5e36```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```32:d8:68:8e:5b:97```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://mitchell-beier.org you initially access a DNS server to translate the host portion (mitchell-beier) combined with the Top Level Domain (org) of the URL, to an IP address like ```27.79.239.94```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/41.0.2228.0 Safari/537.36```
...
<pre>
default   fe80:2988:7871:a24c:11ab%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {84.103.35.175, 195.139.59.150}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 32:d8:68:8e:5b:97
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 60:53:3b:2e:95:be
}</pre>
