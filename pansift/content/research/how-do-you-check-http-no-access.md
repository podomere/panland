...
layout: research
ip_v4_address: "139.193.179.60"
date: 2022-11-19T16:17:25+00:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like ```139.193.179.60``` or an IPv6 address like ```2000:d09e:a974:4766:2f78:424d:111b:a40f```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```50:99:b0:88:81:5b```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://grady.biz you initially access a DNS server to translate the host portion (grady) combined with the Top Level Domain (biz) of the URL, to an IP address like ```33.183.26.180```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows; U; Win 9x 4.90; SG; rv:1.9.2.4) Gecko/20101104 Netscape/9.1.0285```

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```172.23.68.201``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  172.23.68.201    UGScg  en0
...
<pre>
default   fe80:e34e:54cd:8ef6:2c78%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {76.106.224.206, 128.234.151.33}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 50:99:b0:88:81:5b
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 35:ff:a2:99:a0:d3
}</pre>
...
## Apple macOS / OSX
No matter what version of OSX/macOS you are on, ```10.13.1```, ```11.6.5```, or ```12.2.6```, there are a range of tools for troubleshooting. Unfortunately, between these manual actions and scripts, they don't give you a series of correlated values over time. This is where automated remote troubleshooting comes in to its own, especially for teams that embrace remote work and Work From Anywhere (WFA).
