...
layout: research
ip_v4_address: "48.116.230.167"
date: 2023-10-29T15:13:28+00:00
draft: false
---

## Internet Addressing
On the Internet you might have a Public IPv4 address like ```48.116.230.167``` or an IPv6 address like ```2000:bef4:ed76:6e7d:1c65:2e21:e625:14c6```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```22:58:28:db:92:6d```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://walter-rohan.com you initially access a DNS server to translate the host portion (walter-rohan) combined with the Top Level Domain (com) of the URL, to an IP address like ```36.119.55.207```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1; WOW64; Trident/7.0; AS; rv:11.0) like Gecko```
...
<pre>
default   fe80:f85e:1ce8:8ac0:b6e2%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {253.39.65.35, 180.104.66.189}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 22:58:28:db:92:6d
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr e7:9b:cb:fd:fe:e8
}</pre>
