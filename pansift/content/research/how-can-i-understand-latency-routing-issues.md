...
subtitle: "Synergy?"
layout: research
ip_v4_address: "49.78.232.217"
date: 2022-12-15T13:50:18+00:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like ```49.78.232.217``` or an IPv6 address like ```2000:6d70:32d1:2cf2:7212:52ca:f0c9:384b```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```7b:04:3b:45:a8:31```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://macejkovic-green.com you initially access a DNS server to translate the host portion (macejkovic-green) combined with the Top Level Domain (com) of the URL, to an IP address like ```218.30.236.183```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows; U; Win 9x 4.90; SG; rv:1.9.2.4) Gecko/20101104 Netscape/9.1.0285```
...
<pre>
default   fe80:37aa:6667:4cca:bf7d%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {130.247.175.42, 131.0.192.189}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 7b:04:3b:45:a8:31
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 22:10:be:72:0e:97
}</pre>
