...
layout: research
ip_v4_address: "252.237.214.128"
date: 2023-10-06T17:11:09+01:00
draft: false
---

## Internet Addressing
On the Internet you may have a Public IPv4 address like ```252.237.214.128``` or an IPv6 address like ```2000:eb5e:c828:2b1c:d5fa:211:da41:d8f9```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```a6:f9:fe:2b:5c:a0```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://rau-rohan.org you initially access a DNS server to translate the host portion (rau-rohan) combined with the Top Level Domain (org) of the URL, to an IP address like ```77.46.222.141```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (compatible; MSIE 9.0; AOL 9.7; AOLBuild 4343.19; Windows NT 6.1; WOW64; Trident/5.0; FunWebProducts)```
...
<pre>
default   fe80:b1c1:99da:6ab:4306%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {226.76.34.19, 77.13.64.229}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr a6:f9:fe:2b:5c:a0
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 6b:38:21:a7:84:60
}</pre>
