...
layout: research
ip_v4_address: "237.122.191.139"
date: 2023-10-06T17:10:43+01:00
draft: false
---

## Internet Addressing
On the Internet you may get a Public IPv4 address like ```237.122.191.139``` or an IPv6 address like ```2000:81ef:9cb9:13a4:2f84:ad01:2aa2:9440```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```d6:b4:68:0d:5f:7d```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://denesik.io you initially access a DNS server to translate the host portion (denesik) combined with the Top Level Domain (io) of the URL, to an IP address like ```92.254.132.130```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/41.0.2228.0 Safari/537.36```
...
<pre>
default   fe80:a42:503f:ef30:741a%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {243.242.133.225, 222.131.128.173}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr d6:b4:68:0d:5f:7d
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 49:6e:c4:65:4d:40
}</pre>
...
### Apple macOS / OSX
No matter what version of OSX/macOS you are on, ```10.13.4```, ```11.1.3```, or ```12.1.6```, there are a range of tools for troubleshooting. Unfortunately, between these manual actions and scripts, they don't give you a series of correlated values over time. This is where automated remote troubleshooting comes in to its own, especially for teams that embrace remote work and Work From Anywhere (WFA).
