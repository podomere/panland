...
layout: research
ip_v4_address: "162.171.254.138"
date: 2022-11-19T19:13:17+00:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like ```162.171.254.138``` or an IPv6 address like ```2000:9236:2d9f:1bd5:31b8:2ddd:ba00:5568```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```50:64:f0:e5:1c:a8```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://sipes-terry.io you initially access a DNS server to translate the host portion (sipes-terry) combined with the Top Level Domain (io) of the URL, to an IP address like ```17.66.88.121```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (compatible; MSIE 9.0; AOL 9.7; AOLBuild 4343.19; Windows NT 6.1; WOW64; Trident/5.0; FunWebProducts)```
...
default  172.18.101.60    UGScg  en0
...
<pre>
default   fe80:c838:e48c:960:8054%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {56.76.177.53, 229.247.196.19}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 50:64:f0:e5:1c:a8
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 0a:89:e6:d3:8d:42
}</pre>
