...
subtitle: "Streamline?"
layout: research
ip_v4_address: "231.79.242.125"
date: 2023-10-06T17:11:08+01:00
draft: false
---

## Internet Addressing
On the Internet you might get a Public IPv4 address like ```231.79.242.125``` or an IPv6 address like ```2000:86e7:7090:5659:7e62:9285:8a94:c22f```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```54:23:d7:00:f4:c7```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://barrows-mayer.org you initially access a DNS server to translate the host portion (barrows-mayer) combined with the Top Level Domain (org) of the URL, to an IP address like ```17.193.102.174```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT x.y; Win64; x64; rv:10.0) Gecko/20100101 Firefox/10.0```
...
<pre>
default   fe80:1d57:e14c:c7d8:53e3%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {73.124.144.97, 113.149.126.60}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 54:23:d7:00:f4:c7
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 71:46:1c:d1:47:c3
}</pre>
