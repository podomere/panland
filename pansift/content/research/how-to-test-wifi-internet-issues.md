...
subtitle: "Learnings?"
layout: research
ip_v4_address: "215.250.0.246"
date: 2022-04-24T19:00:33+01:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like <code>215.250.0.246</code> or an IPv6 address like <code>2000:e5e3:5f8b:be6c:d244:241:1c7c:9beb</code>. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>9a:bc:b7:0c:4c:46</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://nikolaus-dickens.info you initially access a DNS server to translate the host portion (nikolaus-dickens) combined with the Top Level Domain (info) of the URL, to an IP address like <code>99.252.255.98</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_3) AppleWebKit/537.75.14 (KHTML, like Gecko) Version/7.0.3 Safari/7046A194A</code>
...
<pre><code>
default   fe80:f08e:d729:ef1d:44a5%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {76.64.255.133, 77.159.5.223}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 9a:bc:b7:0c:4c:46
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr bc:46:06:95:53:ad
}</code></pre>
