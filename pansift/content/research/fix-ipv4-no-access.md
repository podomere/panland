...
subtitle: "Value Add?"
layout: research
ip_v4_address: "172.54.231.107"
date: 2022-04-24T18:59:56+01:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like <code>172.54.231.107</code> or an IPv6 address like <code>2000:f151:b0ca:e012:8000:ef49:d93a:656f</code>. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>94:ae:06:18:34:3d</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://koepp-funk.com you initially access a DNS server to translate the host portion (koepp-funk) combined with the Top Level Domain (com) of the URL, to an IP address like <code>92.14.137.146</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (Windows NT 6.1; WOW64; Trident/7.0; AS; rv:11.0) like Gecko</code>
...
<pre><code>
default   fe80:4e9a:3f27:26ad:fdb0%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {110.154.27.61, 168.44.54.38}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 94:ae:06:18:34:3d
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 08:58:e4:d2:d3:48
}</code></pre>
