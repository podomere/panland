...
layout: research
ip_v4_address: "91.24.35.206"
date: 2022-11-19T19:13:22+00:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like ```91.24.35.206``` or an IPv6 address like ```2000:707b:f1e8:f6ea:d53b:b1ae:dfb6:5fb2```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```20:8b:e7:27:20:83```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://mitchell-hoppe.org you initially access a DNS server to translate the host portion (mitchell-hoppe) combined with the Top Level Domain (org) of the URL, to an IP address like ```46.27.195.2```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (compatible; MSIE 9.0; AOL 9.7; AOLBuild 4343.19; Windows NT 6.1; WOW64; Trident/5.0; FunWebProducts)```
...
<pre>
default   fe80:fb75:d48a:4717:8628%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {247.96.7.82, 65.248.94.196}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 20:8b:e7:27:20:83
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 06:76:38:57:b2:c4
}</pre>
