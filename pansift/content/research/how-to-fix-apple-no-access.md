...
layout: research
ip_v4_address: "173.164.36.179"
date: 2022-11-02T11:33:11+00:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like ```173.164.36.179``` or an IPv6 address like ```2000:4646:70c6:d98f:115b:8413:e10e:8695```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```86:53:f1:6e:75:61```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://nikolaus-trantow.biz you initially access a DNS server to translate the host portion (nikolaus-trantow) combined with the Top Level Domain (biz) of the URL, to an IP address like ```152.228.201.248```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/41.0.2228.0 Safari/537.36```
...
<pre>
default   fe80:6643:6763:5081:45e8%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {199.68.40.202, 51.209.124.103}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 86:53:f1:6e:75:61
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 18:c1:53:88:50:48
}</pre>
