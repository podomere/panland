...
layout: research
ip_v4_address: "53.229.183.73"
date: 2023-02-04T17:08:35+00:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like ```53.229.183.73``` or an IPv6 address like ```2000:6905:ebf8:c278:8e17:3f92:2c6e:db19```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```d3:6d:8b:f4:c1:14```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://beer-walter.net you initially access a DNS server to translate the host portion (beer-walter) combined with the Top Level Domain (net) of the URL, to an IP address like ```162.194.231.213```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1; WOW64; Trident/7.0; AS; rv:11.0) like Gecko```
...
<pre>
default   fe80:b744:bb93:cf9d:a26b%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {146.173.167.75, 247.158.140.41}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr d3:6d:8b:f4:c1:14
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 5c:9f:b9:66:83:0f
}</pre>
