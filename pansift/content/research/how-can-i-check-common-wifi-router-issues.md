...
subtitle: "Tee It Up?"
layout: research
ip_v4_address: "174.128.214.149"
date: 2022-06-04T14:38:17+01:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like ```174.128.214.149``` or an IPv6 address like ```2000:3613:8309:d5d4:c957:7f5a:3d5c:34bb```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```f3:84:b1:05:3d:b6```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://kessler-dare.net you initially access a DNS server to translate the host portion (kessler-dare) combined with the Top Level Domain (net) of the URL, to an IP address like ```242.189.35.23```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows; U; Win 9x 4.90; SG; rv:1.9.2.4) Gecko/20101104 Netscape/9.1.0285```
...
<pre>
default   fe80:66db:836a:4320:1403%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {205.251.107.181, 221.121.94.5}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr f3:84:b1:05:3d:b6
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr ae:e7:14:9a:07:c9
}</pre>
