...
layout: research
ip_v4_address: "156.169.5.17"
date: 2022-11-19T19:13:25+00:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like ```156.169.5.17``` or an IPv6 address like ```2000:688b:a37e:4154:16a8:ff39:7525:326f```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```4a:eb:e9:fd:9f:10```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://berge.info you initially access a DNS server to translate the host portion (berge) combined with the Top Level Domain (info) of the URL, to an IP address like ```79.181.48.238```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows; U; Win 9x 4.90; SG; rv:1.9.2.4) Gecko/20101104 Netscape/9.1.0285```

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```172.22.134.175``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  172.22.134.175    UGScg  en0
...
<pre>
default   fe80:a5b6:3d95:7dba:da93%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {127.177.142.249, 131.14.2.45}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 4a:eb:e9:fd:9f:10
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 53:30:35:5a:4a:66
}</pre>
...
## Apple macOS / OSX
No matter what version of OSX/macOS you are on, ```10.14.3```, ```11.3.3```, or ```12.1.5```, there are a range of tools for troubleshooting. Unfortunately, between these manual actions and scripts, they don't give you a series of correlated values over time. This is where automated remote troubleshooting comes in to its own, especially for teams that embrace remote work and Work From Anywhere (WFA).
