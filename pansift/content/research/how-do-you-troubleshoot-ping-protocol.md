...
layout: research
ip_v4_address: "2.205.120.45"
date: 2022-11-19T19:13:27+00:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like ```2.205.120.45``` or an IPv6 address like ```2000:4b4e:d6e:bea7:7135:be83:50ab:f243```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```a2:28:86:3d:e2:d1```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://quigley.co you initially access a DNS server to translate the host portion (quigley) combined with the Top Level Domain (co) of the URL, to an IP address like ```72.220.100.32```. Your computer and browser actually sends its type with all web requests e.g. <br>```Opera/9.80 (X11; Linux i686; Ubuntu/14.10) Presto/2.12.388 Version/12.16```
...
<pre>
default   fe80:e6ee:2aea:e28d:df91%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {174.69.65.125, 31.125.239.207}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr a2:28:86:3d:e2:d1
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr dc:b0:4e:dd:16:0a
}</pre>
...
## Apple macOS / OSX
No matter what version of OSX/macOS you are on, ```10.11.4```, ```11.1.1```, or ```12.2.8```, there are a range of tools for troubleshooting. Unfortunately, between these manual actions and scripts, they don't give you a series of correlated values over time. This is where automated remote troubleshooting comes in to its own, especially for teams that embrace remote work and Work From Anywhere (WFA).
