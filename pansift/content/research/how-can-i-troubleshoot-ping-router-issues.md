---
title: "How Can I Troubleshoot Ping Router Issues"
subtitle: "Give You Some Time Back?"
layout: research
ip_v4_address: "122.208.51.7"
date: 2022-04-24T19:00:02+01:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like <code>122.208.51.7</code> or an IPv6 address like <code>2000:184d:b8a6:bb0b:320c:a255:eb26:fba6</code>. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>7b:ad:52:8f:a0:a5</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://spinka-jenkins.name you initially access a DNS server to translate the host portion (spinka-jenkins) combined with the Top Level Domain (name) of the URL, to an IP address like <code>40.146.50.253</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (compatible; MSIE 9.0; AOL 9.7; AOLBuild 4343.19; Windows NT 6.1; WOW64; Trident/5.0; FunWebProducts)</code>

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like <code>10.210.119.67</code> (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For <code>IPv6</code> we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  10.210.119.67    UGScg  en0
...
<pre><code>
default   fe80:222b:e560:fc73:9259%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {107.25.133.12, 50.169.71.213}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 7b:ad:52:8f:a0:a5
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr eb:55:10:da:2e:cc
}</code></pre>
...
## Apple macOS / OSX
No matter what version of OSX/macOS you are on, <code>10.15.7</code>, <code>11.0.5</code>, or <code>12.1.7</code>, there are a range of tools for troubleshooting. Unfortunately, between these manual actions and scripts, they don't give you a series of correlated values over time. This is where automated remote troubleshooting comes in to its own, especially for teams that embrace remote work and Work From Anywhere (WFA).
