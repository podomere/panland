...
layout: research
ip_v4_address: "97.99.15.0"
date: 2022-12-15T13:50:20+00:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like ```97.99.15.0``` or an IPv6 address like ```2000:29cc:5551:5f28:348b:68b8:cf5e:e7df```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```37:99:d0:a3:0d:8a```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://harber.net you initially access a DNS server to translate the host portion (harber) combined with the Top Level Domain (net) of the URL, to an IP address like ```101.167.199.179```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (compatible; MSIE 9.0; AOL 9.7; AOLBuild 4343.19; Windows NT 6.1; WOW64; Trident/5.0; FunWebProducts)```
...
<pre>
default   fe80:de2e:2919:ac10:ed99%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {255.131.115.229, 74.94.77.32}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 37:99:d0:a3:0d:8a
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 69:ae:80:49:64:04
}</pre>
