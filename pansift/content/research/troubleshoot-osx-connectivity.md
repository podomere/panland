...
layout: research
ip_v4_address: "123.60.103.23"
date: 2022-11-02T11:33:10+00:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like ```123.60.103.23``` or an IPv6 address like ```2000:f178:a31b:5ec:3fdb:bedf:a3ff:7923```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```ff:d8:8b:5e:6d:7c```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://lueilwitz-ernser.biz you initially access a DNS server to translate the host portion (lueilwitz-ernser) combined with the Top Level Domain (biz) of the URL, to an IP address like ```135.171.73.227```. Your computer and browser actually sends its type with all web requests e.g. <br>```Opera/9.80 (X11; Linux i686; Ubuntu/14.10) Presto/2.12.388 Version/12.16```
...
<pre>
default   fe80:e03f:5354:48d6:2d8f%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {5.61.21.69, 43.131.20.45}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr ff:d8:8b:5e:6d:7c
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 11:ae:85:fd:6c:54
}</pre>
