...
layout: research
ip_v4_address: "184.244.246.124"
date: 2023-10-29T15:13:25+00:00
draft: false
---

## Internet Addressing
On the Internet you might get a Public IPv4 address like ```184.244.246.124``` or an IPv6 address like ```2000:cb83:b37e:882a:3bf1:959d:d373:ba9e```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```4a:0b:ab:fc:cb:2e```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://durgan-steuber.biz you initially access a DNS server to translate the host portion (durgan-steuber) combined with the Top Level Domain (biz) of the URL, to an IP address like ```139.63.107.222```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1; WOW64; Trident/7.0; AS; rv:11.0) like Gecko```
...
<pre>
default   fe80:4f7e:20b1:5d30:b616%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {219.153.144.15, 0.156.144.129}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 4a:0b:ab:fc:cb:2e
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 29:f6:9b:68:6a:65
}</pre>
