...
layout: research
ip_v4_address: "134.107.108.183"
date: 2023-02-04T17:07:42+00:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like ```134.107.108.183``` or an IPv6 address like ```2000:1535:b137:1163:ff05:73bd:d1eb:d6e8```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```d6:7b:e3:c2:a0:39```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://kirlin-reichert.io you initially access a DNS server to translate the host portion (kirlin-reichert) combined with the Top Level Domain (io) of the URL, to an IP address like ```78.238.152.247```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_3) AppleWebKit/537.75.14 (KHTML, like Gecko) Version/7.0.3 Safari/7046A194A```
...
<pre>
default   fe80:f2d5:6636:752e:6dc1%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {226.198.66.143, 16.201.99.220}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr d6:7b:e3:c2:a0:39
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 51:3f:a5:a7:ce:d7
}</pre>
