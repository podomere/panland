...
layout: research
ip_v4_address: "97.91.133.59"
date: 2023-02-04T17:07:50+00:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like ```97.91.133.59``` or an IPv6 address like ```2000:87e1:c681:b60a:95a9:2a6b:776b:2a7d```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```e7:6c:dd:43:3d:db```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://mante.com you initially access a DNS server to translate the host portion (mante) combined with the Top Level Domain (com) of the URL, to an IP address like ```64.154.239.151```. Your computer and browser actually sends its type with all web requests e.g. <br>```Opera/9.80 (X11; Linux i686; Ubuntu/14.10) Presto/2.12.388 Version/12.16```
...
<pre>
default   fe80:fe76:1d27:9232:3798%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {8.47.245.156, 146.140.132.188}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr e7:6c:dd:43:3d:db
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr c2:e4:4f:bb:10:9f
}</pre>
