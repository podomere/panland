...
layout: research
ip_v4_address: "224.109.41.148"
date: 2022-11-02T11:32:58+00:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like ```224.109.41.148``` or an IPv6 address like ```2000:8e0e:35d9:6618:4b4f:72b6:c92c:a15```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```e6:06:0e:f7:ec:76```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://gerhold-rogahn.info you initially access a DNS server to translate the host portion (gerhold-rogahn) combined with the Top Level Domain (info) of the URL, to an IP address like ```60.193.26.0```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT x.y; Win64; x64; rv:10.0) Gecko/20100101 Firefox/10.0```
...
<pre>
default   fe80:11ba:8431:3d01:5521%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {84.204.73.218, 7.66.202.170}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr e6:06:0e:f7:ec:76
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr b9:71:47:ff:20:90
}</pre>
