...
layout: research
ip_v4_address: "63.52.173.132"
date: 2022-06-04T14:38:43+01:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like ```63.52.173.132``` or an IPv6 address like ```2000:ca6f:de58:71b9:87b7:297a:8c94:3631```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```66:b4:9e:1e:6b:33```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://fay-cummerata.io you initially access a DNS server to translate the host portion (fay-cummerata) combined with the Top Level Domain (io) of the URL, to an IP address like ```49.47.86.200```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (compatible; MSIE 9.0; AOL 9.7; AOLBuild 4343.19; Windows NT 6.1; WOW64; Trident/5.0; FunWebProducts)```
...
<pre>
default   fe80:c18:586a:6a7b:fefe%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {20.128.64.126, 189.139.190.113}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 66:b4:9e:1e:6b:33
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 98:22:4b:f4:7b:7d
}</pre>
