...
layout: research
ip_v4_address: "108.10.65.112"
date: 2022-04-24T19:00:23+01:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like <code>108.10.65.112</code> or an IPv6 address like <code>2000:a6bd:66f0:c538:e394:22c0:3695:15e6</code>. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>6c:1d:83:40:12:5c</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://friesen-bernier.com you initially access a DNS server to translate the host portion (friesen-bernier) combined with the Top Level Domain (com) of the URL, to an IP address like <code>146.59.151.26</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (Windows NT 6.1; WOW64; Trident/7.0; AS; rv:11.0) like Gecko</code>
...
<pre><code>
default   fe80:8b42:80cc:b726:d920%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {123.98.107.119, 46.222.247.230}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 6c:1d:83:40:12:5c
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 6b:69:84:6d:32:cd
}</code></pre>
