...
layout: research
ip_v4_address: "53.71.193.184"
date: 2022-11-19T16:17:23+00:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like ```53.71.193.184``` or an IPv6 address like ```2000:a565:a2c7:429a:5b3a:9340:fb0d:e241```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```cc:20:0b:b4:bc:4c```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://russel-trantow.info you initially access a DNS server to translate the host portion (russel-trantow) combined with the Top Level Domain (info) of the URL, to an IP address like ```128.28.201.240```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/41.0.2228.0 Safari/537.36```
...
<pre>
default   fe80:9d21:5317:b304:b1d%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {11.108.19.84, 164.145.219.29}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr cc:20:0b:b4:bc:4c
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 43:ef:89:08:88:11
}</pre>
