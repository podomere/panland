...
layout: research
ip_v4_address: "22.121.169.235"
date: 2022-04-24T18:31:57+01:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like <code>22.121.169.235</code> or an IPv6 address like <code>2000:dbd3:d3c2:ae35:fcae:d41f:b675:a22b</code>. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>02:6f:8d:b9:22:e1</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://lockman.net you initially access a DNS server to translate the host portion (lockman) combined with the Top Level Domain (net) of the URL, to an IP address like <code>202.237.33.64</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (compatible; MSIE 9.0; AOL 9.7; AOLBuild 4343.19; Windows NT 6.1; WOW64; Trident/5.0; FunWebProducts)</code>
...
<pre><code>
default   fe80:32a9:21fe:e2ae:862e%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {167.182.205.31, 169.159.127.5}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 02:6f:8d:b9:22:e1
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 8f:c8:d8:82:4d:c2
}</code></pre>
