...
subtitle: "Learnings?"
layout: research
ip_v4_address: "228.74.90.253"
date: 2022-11-19T16:17:22+00:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like ```228.74.90.253``` or an IPv6 address like ```2000:2a88:2744:dd1e:88de:36e2:3ac8:2f2b```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```93:ab:c4:c3:3d:dd```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://kuhlman-predovic.biz you initially access a DNS server to translate the host portion (kuhlman-predovic) combined with the Top Level Domain (biz) of the URL, to an IP address like ```182.48.21.162```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (compatible; MSIE 9.0; AOL 9.7; AOLBuild 4343.19; Windows NT 6.1; WOW64; Trident/5.0; FunWebProducts)```
...
<pre>
default   fe80:7508:fd6f:eddc:28b1%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {70.175.107.72, 131.9.49.92}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 93:ab:c4:c3:3d:dd
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 89:be:aa:52:b3:0b
}</pre>
