...
layout: research
ip_v4_address: "93.214.180.212"
date: 2023-10-06T17:10:41+01:00
draft: false
---

## Internet Addressing
On the Internet you might get a Public IPv4 address like ```93.214.180.212``` or an IPv6 address like ```2000:3cff:7aa9:dd51:720a:5869:d56a:4e5d```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```85:c3:39:b7:02:57```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://tromp-gislason.biz you initially access a DNS server to translate the host portion (tromp-gislason) combined with the Top Level Domain (biz) of the URL, to an IP address like ```44.203.8.52```. Your computer and browser actually sends its type with all web requests e.g. <br>```Opera/9.80 (X11; Linux i686; Ubuntu/14.10) Presto/2.12.388 Version/12.16```
...
<pre>
default   fe80:75d8:6ff5:42c9:a629%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {131.131.211.45, 192.180.249.92}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 85:c3:39:b7:02:57
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 7f:51:00:cb:fc:8a
}</pre>
...
### Apple macOS / OSX
No matter what version of OSX/macOS you are on, ```10.14.9```, ```11.5.6```, or ```12.2.3```, there are a range of tools for troubleshooting. Unfortunately, between these manual actions and scripts, they don't give you a series of correlated values over time. This is where automated remote troubleshooting comes in to its own, especially for teams that embrace remote work and Work From Anywhere (WFA).
