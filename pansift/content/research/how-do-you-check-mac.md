...
subtitle: "Streamline?"
layout: research
ip_v4_address: "75.38.223.31"
date: 2022-11-19T19:13:18+00:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like ```75.38.223.31``` or an IPv6 address like ```2000:b0a4:63bc:c67d:cfbb:44dc:c24c:4972```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```28:f2:b6:b3:e8:79```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://wintheiser.biz you initially access a DNS server to translate the host portion (wintheiser) combined with the Top Level Domain (biz) of the URL, to an IP address like ```112.119.67.152```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (compatible; MSIE 9.0; AOL 9.7; AOLBuild 4343.19; Windows NT 6.1; WOW64; Trident/5.0; FunWebProducts)```
...
<pre>
default   fe80:7bfc:b198:6670:e79%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {151.31.220.76, 175.130.216.7}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 28:f2:b6:b3:e8:79
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr ec:89:d1:48:88:bf
}</pre>
...
## Apple macOS / OSX
No matter what version of OSX/macOS you are on, ```10.11.2```, ```11.4.8```, or ```12.0.5```, there are a range of tools for troubleshooting. Unfortunately, between these manual actions and scripts, they don't give you a series of correlated values over time. This is where automated remote troubleshooting comes in to its own, especially for teams that embrace remote work and Work From Anywhere (WFA).
