...
layout: research
ip_v4_address: "254.152.133.10"
date: 2022-06-12T14:09:23+01:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like ```254.152.133.10``` or an IPv6 address like ```2000:bc00:9b0:71c9:d1ad:f34e:1a64:dc77```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```66:59:c9:2c:3e:99```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://hessel-bartell.co you initially access a DNS server to translate the host portion (hessel-bartell) combined with the Top Level Domain (co) of the URL, to an IP address like ```231.44.229.236```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT x.y; Win64; x64; rv:10.0) Gecko/20100101 Firefox/10.0```
...
<pre>
default   fe80:6ed6:90d5:1e20:f48b%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {23.15.87.250, 23.25.118.124}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 66:59:c9:2c:3e:99
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr e8:ed:9a:a8:be:1d
}</pre>
