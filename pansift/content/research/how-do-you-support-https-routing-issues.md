...
layout: research
ip_v4_address: "94.66.182.113"
date: 2022-04-24T19:00:07+01:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like <code>94.66.182.113</code> or an IPv6 address like <code>2000:dea7:242c:c7eb:acc3:577:fa49:40e8</code>. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>46:85:32:fb:d1:60</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://bradtke-bartell.info you initially access a DNS server to translate the host portion (bradtke-bartell) combined with the Top Level Domain (info) of the URL, to an IP address like <code>246.86.9.7</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (Windows; U; Win 9x 4.90; SG; rv:1.9.2.4) Gecko/20101104 Netscape/9.1.0285</code>
...
<pre><code>
default   fe80:4e69:9d4c:deb2:cc97%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {55.123.239.80, 141.97.22.10}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 46:85:32:fb:d1:60
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 7f:87:a2:2c:d9:bb
}</code></pre>
