...
layout: research
ip_v4_address: "28.244.183.25"
date: 2022-11-19T19:13:25+00:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like ```28.244.183.25``` or an IPv6 address like ```2000:f40:867c:344d:4d53:e5bf:3687:341d```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```2b:f8:7c:19:5d:55```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://stark-white.info you initially access a DNS server to translate the host portion (stark-white) combined with the Top Level Domain (info) of the URL, to an IP address like ```104.86.41.190```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT x.y; Win64; x64; rv:10.0) Gecko/20100101 Firefox/10.0```
...
<pre>
default   fe80:aca7:1460:4628:3f87%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {42.140.213.70, 55.26.160.144}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 2b:f8:7c:19:5d:55
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 4f:37:e9:4b:70:4c
}</pre>
