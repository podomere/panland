...
layout: research
ip_v4_address: "149.205.50.197"
date: 2022-04-24T18:31:59+01:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like <code>149.205.50.197</code> or an IPv6 address like <code>2000:e777:a13a:9802:c8:dec:803f:3835</code>. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>b5:eb:2a:80:e2:bc</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://heathcote-borer.net you initially access a DNS server to translate the host portion (heathcote-borer) combined with the Top Level Domain (net) of the URL, to an IP address like <code>138.250.15.69</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (Windows; U; Win 9x 4.90; SG; rv:1.9.2.4) Gecko/20101104 Netscape/9.1.0285</code>
...
<pre><code>
default   fe80:3245:5439:42a5:86ec%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {242.101.64.174, 212.97.237.35}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr b5:eb:2a:80:e2:bc
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr ec:41:e9:17:2e:9f
}</code></pre>
