...
layout: research
ip_v4_address: "61.131.6.246"
date: 2022-12-15T13:50:17+00:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like ```61.131.6.246``` or an IPv6 address like ```2000:9123:eb43:18bf:4b84:41c7:5f86:f4a7```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```1c:c3:bc:5e:28:c7```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://batz-effertz.name you initially access a DNS server to translate the host portion (batz-effertz) combined with the Top Level Domain (name) of the URL, to an IP address like ```241.244.27.73```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT x.y; Win64; x64; rv:10.0) Gecko/20100101 Firefox/10.0```
...
<pre>
default   fe80:38ad:e7d7:19d1:aa19%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {231.145.114.194, 225.15.33.224}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 1c:c3:bc:5e:28:c7
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 2d:b4:8c:02:6d:cd
}</pre>
