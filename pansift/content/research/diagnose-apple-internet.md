...
subtitle: "Swag?"
layout: research
ip_v4_address: "99.250.221.22"
date: 2023-10-29T15:13:19+00:00
draft: false
---

## Internet Addressing
On the Internet you might have a Public IPv4 address like ```99.250.221.22``` or an IPv6 address like ```2000:4d16:7fe8:58ae:8497:89ae:6c:d9ba```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```11:b2:93:7e:d9:81```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://schowalter-wisoky.io you initially access a DNS server to translate the host portion (schowalter-wisoky) combined with the Top Level Domain (io) of the URL, to an IP address like ```130.166.224.138```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows; U; Win 9x 4.90; SG; rv:1.9.2.4) Gecko/20101104 Netscape/9.1.0285```
...
<pre>
default   fe80:ecf4:4577:4306:c5f8%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {100.55.225.253, 180.130.216.123}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 11:b2:93:7e:d9:81
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 1b:1a:9f:b5:f3:2a
}</pre>
...
### Apple macOS / OSX
No matter what version of OSX/macOS you are on, ```10.11.6```, ```11.1.4```, or ```12.2.7```, there are a range of tools for troubleshooting. Unfortunately, between these manual actions and scripts, they don't give you a series of correlated values over time. This is where automated remote troubleshooting comes in to its own, especially for teams that embrace remote work and Work From Anywhere (WFA).
