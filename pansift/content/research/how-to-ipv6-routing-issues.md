...
layout: research
ip_v4_address: "93.200.135.252"
date: 2022-04-24T18:59:55+01:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like <code>93.200.135.252</code> or an IPv6 address like <code>2000:e5cc:2ab0:14a8:c44e:5025:bf3b:ce75</code>. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>4b:3e:b0:05:56:8a</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://lubowitz-koelpin.io you initially access a DNS server to translate the host portion (lubowitz-koelpin) combined with the Top Level Domain (io) of the URL, to an IP address like <code>229.88.199.27</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Opera/9.80 (X11; Linux i686; Ubuntu/14.10) Presto/2.12.388 Version/12.16</code>

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like <code>172.31.62.93</code> (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For <code>IPv6</code> we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  172.31.62.93    UGScg  en0
...
<pre><code>
default   fe80:5538:7c35:1875:28a8%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {116.1.23.239, 0.167.23.197}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 4b:3e:b0:05:56:8a
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 0f:a3:f2:08:fa:bb
}</code></pre>
