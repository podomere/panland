...
layout: research
ip_v4_address: "174.56.210.129"
date: 2022-11-19T19:13:23+00:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like ```174.56.210.129``` or an IPv6 address like ```2000:f3dc:d2ff:15f3:94d8:7fc1:b717:6cf5```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```78:bb:4d:8c:f2:61```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://damore-harris.biz you initially access a DNS server to translate the host portion (damore-harris) combined with the Top Level Domain (biz) of the URL, to an IP address like ```108.187.9.138```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_3) AppleWebKit/537.75.14 (KHTML, like Gecko) Version/7.0.3 Safari/7046A194A```
...
<pre>
default   fe80:f57a:f011:a86f:d56f%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {208.231.106.57, 24.202.124.141}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 78:bb:4d:8c:f2:61
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 51:2d:90:7a:1d:fb
}</pre>
