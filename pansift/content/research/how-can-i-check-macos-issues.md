...
layout: research
ip_v4_address: "69.159.9.141"
date: 2022-11-02T11:33:10+00:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like ```69.159.9.141``` or an IPv6 address like ```2000:8825:569a:dc5b:a8c5:193a:6c6b:5c1b```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```8d:0e:da:6d:56:ea```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://terry-ryan.co you initially access a DNS server to translate the host portion (terry-ryan) combined with the Top Level Domain (co) of the URL, to an IP address like ```230.86.82.141```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/41.0.2228.0 Safari/537.36```
...
<pre>
default   fe80:274d:2de9:1eac:33f%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {166.217.206.149, 180.127.49.233}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 8d:0e:da:6d:56:ea
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 40:18:5d:df:42:59
}</pre>
...
## Apple macOS / OSX
No matter what version of OSX/macOS you are on, ```10.14.4```, ```11.2.8```, or ```12.0.3```, there are a range of tools for troubleshooting. Unfortunately, between these manual actions and scripts, they don't give you a series of correlated values over time. This is where automated remote troubleshooting comes in to its own, especially for teams that embrace remote work and Work From Anywhere (WFA).
