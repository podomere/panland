...
subtitle: "Etc. Etc.?"
layout: research
ip_v4_address: "86.130.9.234"
date: 2023-10-29T15:13:18+00:00
draft: false
---

## Internet Addressing
On the Internet you might get a Public IPv4 address like ```86.130.9.234``` or an IPv6 address like ```2000:6c45:4a79:3fd5:aa60:b955:30d3:46fc```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```af:11:b4:b4:75:d3```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://murphy.net you initially access a DNS server to translate the host portion (murphy) combined with the Top Level Domain (net) of the URL, to an IP address like ```112.125.208.223```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/41.0.2228.0 Safari/537.36```
...
<pre>
default   fe80:e708:c1f7:d35f:4428%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {39.48.34.92, 246.89.95.98}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr af:11:b4:b4:75:d3
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 43:15:cb:75:76:3a
}</pre>
...
### Apple macOS / OSX
No matter what version of OSX/macOS you are on, ```10.12.2```, ```11.5.9```, or ```12.3.5```, there are a range of tools for troubleshooting. Unfortunately, between these manual actions and scripts, they don't give you a series of correlated values over time. This is where automated remote troubleshooting comes in to its own, especially for teams that embrace remote work and Work From Anywhere (WFA).
