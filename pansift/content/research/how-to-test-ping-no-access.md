...
layout: research
ip_v4_address: "48.41.47.248"
date: 2023-02-04T17:08:39+00:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like ```48.41.47.248``` or an IPv6 address like ```2000:b430:a1fa:ef26:c205:1563:bb68:8c07```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```d7:24:19:0a:58:de```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://gottlieb-crist.info you initially access a DNS server to translate the host portion (gottlieb-crist) combined with the Top Level Domain (info) of the URL, to an IP address like ```70.12.106.49```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (compatible; MSIE 9.0; AOL 9.7; AOLBuild 4343.19; Windows NT 6.1; WOW64; Trident/5.0; FunWebProducts)```
...
<pre>
default   fe80:ecbf:b024:13f3:2083%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {109.102.227.151, 97.110.184.58}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr d7:24:19:0a:58:de
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr e1:d0:60:20:c5:cc
}</pre>
