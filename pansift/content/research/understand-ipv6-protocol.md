...
subtitle: "Value Add?"
layout: research
ip_v4_address: "27.129.100.208"
date: 2022-06-04T14:38:36+01:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like ```27.129.100.208``` or an IPv6 address like ```2000:17bd:216f:762c:401:238f:cdf3:3d87```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```89:e9:7c:e1:5c:68```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://white.co you initially access a DNS server to translate the host portion (white) combined with the Top Level Domain (co) of the URL, to an IP address like ```144.59.196.203```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_3) AppleWebKit/537.75.14 (KHTML, like Gecko) Version/7.0.3 Safari/7046A194A```

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```10.255.215.113``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  10.255.215.113    UGScg  en0
...
<pre>
default   fe80:6b5a:762d:1bed:b447%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {64.134.191.229, 173.163.42.115}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 89:e9:7c:e1:5c:68
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr b4:b7:a0:15:f2:d7
}</pre>
