...
layout: research
ip_v4_address: "178.102.206.34"
date: 2022-04-24T19:00:05+01:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like <code>178.102.206.34</code> or an IPv6 address like <code>2000:ac70:b9fa:6456:ad55:8d2c:c507:6f69</code>. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>74:30:eb:98:d1:94</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://barton-rodriguez.info you initially access a DNS server to translate the host portion (barton-rodriguez) combined with the Top Level Domain (info) of the URL, to an IP address like <code>89.60.142.23</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Opera/9.80 (X11; Linux i686; Ubuntu/14.10) Presto/2.12.388 Version/12.16</code>
...
<pre><code>
default   fe80:2d22:c228:5166:91e1%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {170.193.95.207, 38.13.157.109}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 74:30:eb:98:d1:94
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr ad:a0:fa:e6:1d:9f
}</code></pre>
