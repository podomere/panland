...
layout: research
ip_v4_address: "235.142.60.219"
date: 2022-04-24T19:00:03+01:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like <code>235.142.60.219</code> or an IPv6 address like <code>2000:d8d0:4043:4e90:e5be:2bad:4bd1:321f</code>. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>74:1c:69:34:fe:ba</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://erdman-hirthe.org you initially access a DNS server to translate the host portion (erdman-hirthe) combined with the Top Level Domain (org) of the URL, to an IP address like <code>35.214.12.215</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Opera/9.80 (X11; Linux i686; Ubuntu/14.10) Presto/2.12.388 Version/12.16</code>
...
<pre><code>
default   fe80:1884:7f4:bf53:37f5%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {235.184.75.200, 130.95.249.87}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 74:1c:69:34:fe:ba
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr b0:b3:69:2f:2d:85
}</code></pre>
