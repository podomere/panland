...
subtitle: "Ideate?"
layout: research
ip_v4_address: "224.74.175.244"
date: 2023-02-04T16:26:20+00:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like ```224.74.175.244``` or an IPv6 address like ```2000:184a:4c64:5441:71cf:39d0:fc63:f36e```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```3e:7c:49:ae:26:95```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://abshire.biz you initially access a DNS server to translate the host portion (abshire) combined with the Top Level Domain (biz) of the URL, to an IP address like ```111.38.127.171```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows; U; Win 9x 4.90; SG; rv:1.9.2.4) Gecko/20101104 Netscape/9.1.0285```

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```172.24.152.219``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  172.24.152.219    UGScg  en0
...
<pre>
default   fe80:f036:fb4e:3862:7025%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {156.222.99.61, 51.124.100.122}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 3e:7c:49:ae:26:95
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 11:f9:35:2b:06:33
}</pre>
...
## Apple macOS / OSX
No matter what version of OSX/macOS you are on, ```10.12.5```, ```11.4.4```, or ```12.2.8```, there are a range of tools for troubleshooting. Unfortunately, between these manual actions and scripts, they don't give you a series of correlated values over time. This is where automated remote troubleshooting comes in to its own, especially for teams that embrace remote work and Work From Anywhere (WFA).
