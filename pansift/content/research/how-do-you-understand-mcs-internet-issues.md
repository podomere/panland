...
subtitle: "Ideate?"
layout: research
ip_v4_address: "213.186.158.75"
date: 2023-10-06T17:10:31+01:00
draft: false
---

## Internet Addressing
On the Internet you might have a Public IPv4 address like ```213.186.158.75``` or an IPv6 address like ```2000:80e3:17c2:eaa6:63ea:3963:ae27:97c9```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```51:90:69:aa:c3:11```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://johnson-abernathy.org you initially access a DNS server to translate the host portion (johnson-abernathy) combined with the Top Level Domain (org) of the URL, to an IP address like ```97.139.173.161```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1; WOW64; Trident/7.0; AS; rv:11.0) like Gecko```

## Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```192.168.76.239``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  192.168.76.239    UGScg  en0
...
<pre>
default   fe80:a67a:e9e0:b49f:8d0b%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {150.96.19.102, 179.104.216.153}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 51:90:69:aa:c3:11
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 22:51:1e:ad:48:e5
}</pre>
