...
layout: research
ip_v4_address: "253.117.78.136"
date: 2022-04-24T18:31:58+01:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like <code>253.117.78.136</code> or an IPv6 address like <code>2000:ffd3:8a85:8d28:41aa:760:d79b:e6ae</code>. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>39:0c:53:5b:d7:9f</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://funk-stroman.org you initially access a DNS server to translate the host portion (funk-stroman) combined with the Top Level Domain (org) of the URL, to an IP address like <code>92.168.49.138</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_3) AppleWebKit/537.75.14 (KHTML, like Gecko) Version/7.0.3 Safari/7046A194A</code>
...
<pre><code>
default   fe80:6c91:f958:6f43:a97c%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {156.238.56.242, 134.208.147.250}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 39:0c:53:5b:d7:9f
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr a8:bc:64:72:0e:05
}</code></pre>
