...
layout: research
ip_v4_address: "117.211.116.248"
date: 2022-11-19T19:13:17+00:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like ```117.211.116.248``` or an IPv6 address like ```2000:a4c9:c51c:b9a9:63f9:7711:a977:f427```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```a8:f6:9b:7a:09:e7```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://beier-mcglynn.org you initially access a DNS server to translate the host portion (beier-mcglynn) combined with the Top Level Domain (org) of the URL, to an IP address like ```96.175.26.162```. Your computer and browser actually sends its type with all web requests e.g. <br>```Opera/9.80 (X11; Linux i686; Ubuntu/14.10) Presto/2.12.388 Version/12.16```
...
<pre>
default   fe80:eb06:40b3:3121:6a3c%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {41.203.119.240, 38.60.56.48}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr a8:f6:9b:7a:09:e7
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 41:63:95:40:31:34
}</pre>
