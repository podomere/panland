...
subtitle: "Granular?"
layout: research
ip_v4_address: "119.152.253.68"
date: 2022-11-19T19:13:25+00:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like ```119.152.253.68``` or an IPv6 address like ```2000:e121:8b8b:b66f:b150:1a94:b8d:d66f```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```59:83:e5:80:ce:b2```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://lockman-oreilly.net you initially access a DNS server to translate the host portion (lockman-oreilly) combined with the Top Level Domain (net) of the URL, to an IP address like ```59.149.145.143```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1; WOW64; Trident/7.0; AS; rv:11.0) like Gecko```
...
<pre>
default   fe80:57c5:7647:2fc6:e4e0%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {159.22.118.137, 4.67.174.30}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 59:83:e5:80:ce:b2
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 49:4b:e2:93:7a:26
}</pre>
