...
layout: research
ip_v4_address: "25.216.158.120"
date: 2023-02-04T17:07:50+00:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like ```25.216.158.120``` or an IPv6 address like ```2000:7a64:c0f:75e8:2330:3c44:efac:711d```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```92:6c:40:10:39:97```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://swift-emard.io you initially access a DNS server to translate the host portion (swift-emard) combined with the Top Level Domain (io) of the URL, to an IP address like ```226.250.5.43```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1; WOW64; Trident/7.0; AS; rv:11.0) like Gecko```
...
<pre>
default   fe80:3f5f:9123:fd0:e8f4%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {170.107.14.164, 218.17.125.70}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 92:6c:40:10:39:97
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr d0:4e:4e:48:6c:bc
}</pre>
