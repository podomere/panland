...
subtitle: "Ideate?"
layout: research
ip_v4_address: "252.236.73.96"
date: 2022-11-02T11:32:57+00:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like ```252.236.73.96``` or an IPv6 address like ```2000:28e7:4616:6370:10bb:67bc:1f03:cce2```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```0f:1d:87:0a:9d:50```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://padberg.io you initially access a DNS server to translate the host portion (padberg) combined with the Top Level Domain (io) of the URL, to an IP address like ```29.198.98.5```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/41.0.2228.0 Safari/537.36```
...
<pre>
default   fe80:d0f4:3353:1ddb:7f0c%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {37.128.68.127, 169.185.161.239}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 0f:1d:87:0a:9d:50
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 32:9e:c8:e2:fb:1b
}</pre>
...
## Apple macOS / OSX
No matter what version of OSX/macOS you are on, ```10.12.2```, ```11.1.2```, or ```12.1.2```, there are a range of tools for troubleshooting. Unfortunately, between these manual actions and scripts, they don't give you a series of correlated values over time. This is where automated remote troubleshooting comes in to its own, especially for teams that embrace remote work and Work From Anywhere (WFA).
