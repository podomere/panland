...
layout: research
ip_v4_address: "112.151.115.97"
date: 2022-04-24T18:31:59+01:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like <code>112.151.115.97</code> or an IPv6 address like <code>2000:ee98:d7e4:92ca:ebe2:8fd6:f6a1:150e</code>. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>53:00:7d:0a:77:28</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://parker-weimann.io you initially access a DNS server to translate the host portion (parker-weimann) combined with the Top Level Domain (io) of the URL, to an IP address like <code>132.120.1.172</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (Windows NT x.y; Win64; x64; rv:10.0) Gecko/20100101 Firefox/10.0</code>
...
<pre><code>
default   fe80:e0df:4a87:1860:2248%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {166.59.247.73, 17.175.151.247}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 53:00:7d:0a:77:28
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr ec:b3:b4:9e:be:04
}</code></pre>
