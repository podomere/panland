...
subtitle: "Deep Dive?"
layout: research
ip_v4_address: "252.197.20.254"
date: 2022-05-05T14:28:26+01:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like ```252.197.20.254``` or an IPv6 address like ```2000:54aa:603b:ce8b:a66e:c31e:abfb:4642```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```d4:90:4a:13:23:fa```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://hettinger.net you initially access a DNS server to translate the host portion (hettinger) combined with the Top Level Domain (net) of the URL, to an IP address like ```187.196.225.138```. Your computer and browser actually sends its type with all web requests e.g. <br>```Opera/9.80 (X11; Linux i686; Ubuntu/14.10) Presto/2.12.388 Version/12.16```
...
<pre>
default   fe80:58cd:cd30:f6ae:b68d%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {219.152.16.191, 162.47.5.123}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr d4:90:4a:13:23:fa
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 13:60:d1:88:fc:7c
}</pre>
...
## Apple macOS / OSX
No matter what version of OSX/macOS you are on, ```10.11.5```, ```11.5.6```, or ```12.2.2```, there are a range of tools for troubleshooting. Unfortunately, between these manual actions and scripts, they don't give you a series of correlated values over time. This is where automated remote troubleshooting comes in to its own, especially for teams that embrace remote work and Work From Anywhere (WFA).
