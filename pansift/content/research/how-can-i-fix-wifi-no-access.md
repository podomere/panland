...
subtitle: "Branding?"
layout: research
ip_v4_address: "189.162.114.93"
date: 2022-06-12T14:09:05+01:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like ```189.162.114.93``` or an IPv6 address like ```2000:926a:5c74:9510:90ca:f20b:b4d0:8c02```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```7a:c1:2f:f2:dc:25```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://buckridge.net you initially access a DNS server to translate the host portion (buckridge) combined with the Top Level Domain (net) of the URL, to an IP address like ```115.85.106.121```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows; U; Win 9x 4.90; SG; rv:1.9.2.4) Gecko/20101104 Netscape/9.1.0285```
...
<pre>
default   fe80:ed38:ac4d:1afd:3807%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {255.113.96.18, 190.226.250.87}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 7a:c1:2f:f2:dc:25
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 64:7e:39:81:a5:23
}</pre>
...
## Apple macOS / OSX
No matter what version of OSX/macOS you are on, ```10.15.8```, ```11.3.5```, or ```12.1.5```, there are a range of tools for troubleshooting. Unfortunately, between these manual actions and scripts, they don't give you a series of correlated values over time. This is where automated remote troubleshooting comes in to its own, especially for teams that embrace remote work and Work From Anywhere (WFA).
