...
layout: research
ip_v4_address: "160.255.68.166"
date: 2022-06-12T14:09:26+01:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like ```160.255.68.166``` or an IPv6 address like ```2000:b377:7346:92c9:9557:4b61:6a3c:ab01```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```82:24:9b:00:42:e2```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://rodriguez-greenholt.biz you initially access a DNS server to translate the host portion (rodriguez-greenholt) combined with the Top Level Domain (biz) of the URL, to an IP address like ```35.21.190.157```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows; U; Win 9x 4.90; SG; rv:1.9.2.4) Gecko/20101104 Netscape/9.1.0285```

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```172.31.203.216``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  172.31.203.216    UGScg  en0
...
<pre>
default   fe80:f0d1:f16c:8f39:3cc5%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {104.252.159.173, 152.142.49.128}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 82:24:9b:00:42:e2
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 4c:f7:b4:1e:44:fb
}</pre>
