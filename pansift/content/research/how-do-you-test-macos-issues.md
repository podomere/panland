...
layout: research
ip_v4_address: "37.142.81.128"
date: 2022-05-05T14:28:47+01:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like ```37.142.81.128``` or an IPv6 address like ```2000:4adc:ea46:92a7:8fd2:10e7:77a7:2658```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```8b:84:25:7b:22:68```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://morar-okon.com you initially access a DNS server to translate the host portion (morar-okon) combined with the Top Level Domain (com) of the URL, to an IP address like ```181.91.40.22```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/41.0.2228.0 Safari/537.36```
...
<pre>
default   fe80:690b:e5d7:ced4:78e9%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {131.183.160.22, 133.192.3.163}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 8b:84:25:7b:22:68
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr fa:c1:69:44:8c:c7
}</pre>
