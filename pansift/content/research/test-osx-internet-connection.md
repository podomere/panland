...
layout: research
ip_v4_address: "56.237.172.214"
date: 2022-04-24T19:00:24+01:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like <code>56.237.172.214</code> or an IPv6 address like <code>2000:1f85:5cb6:91ad:6b1a:2a54:6959:2220</code>. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>74:9e:cb:ce:ae:87</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://ortiz-heathcote.biz you initially access a DNS server to translate the host portion (ortiz-heathcote) combined with the Top Level Domain (biz) of the URL, to an IP address like <code>82.243.230.126</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (Windows; U; Win 9x 4.90; SG; rv:1.9.2.4) Gecko/20101104 Netscape/9.1.0285</code>
...
<pre><code>
default   fe80:f64e:3a2d:cc17:d2d8%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {226.47.161.148, 34.45.253.180}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 74:9e:cb:ce:ae:87
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 43:27:07:dd:3a:52
}</code></pre>
