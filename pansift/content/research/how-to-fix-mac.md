...
layout: research
ip_v4_address: "229.199.214.59"
date: 2022-11-19T19:13:17+00:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like ```229.199.214.59``` or an IPv6 address like ```2000:6d19:1884:aed1:f154:cd57:3e64:a884```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```55:38:f8:7f:59:0c```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://beahan-farrell.org you initially access a DNS server to translate the host portion (beahan-farrell) combined with the Top Level Domain (org) of the URL, to an IP address like ```75.89.10.42```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (compatible; MSIE 9.0; AOL 9.7; AOLBuild 4343.19; Windows NT 6.1; WOW64; Trident/5.0; FunWebProducts)```
...
<pre>
default   fe80:1d3b:c113:f363:f445%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {66.86.61.87, 191.18.177.49}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 55:38:f8:7f:59:0c
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 93:37:a6:93:7f:41
}</pre>
