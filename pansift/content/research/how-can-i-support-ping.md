...
layout: research
ip_v4_address: "53.91.115.12"
date: 2022-06-12T14:09:27+01:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like ```53.91.115.12``` or an IPv6 address like ```2000:5eec:22d0:e988:c284:12e1:fb4:d931```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```1b:7c:9e:e9:49:ea```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://torp-kuphal.io you initially access a DNS server to translate the host portion (torp-kuphal) combined with the Top Level Domain (io) of the URL, to an IP address like ```132.15.196.113```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT x.y; Win64; x64; rv:10.0) Gecko/20100101 Firefox/10.0```
...
<pre>
default   fe80:4753:4af6:8e4e:d1e3%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {162.5.111.160, 141.165.85.236}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 1b:7c:9e:e9:49:ea
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr d1:fe:ca:77:87:be
}</pre>
