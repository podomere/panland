...
layout: research
ip_v4_address: "107.151.122.123"
date: 2022-05-05T14:28:29+01:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like ```107.151.122.123``` or an IPv6 address like ```2000:df33:9d4e:597b:8e26:8a25:19a8:e829```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```53:6a:a9:95:c8:f9```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://frami.org you initially access a DNS server to translate the host portion (frami) combined with the Top Level Domain (org) of the URL, to an IP address like ```132.25.124.18```. Your computer and browser actually sends its type with all web requests e.g. <br>```Opera/9.80 (X11; Linux i686; Ubuntu/14.10) Presto/2.12.388 Version/12.16```
...
<pre>
default   fe80:4856:a478:b5d4:5664%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {186.108.108.116, 23.9.116.160}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 53:6a:a9:95:c8:f9
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 17:f8:45:29:99:88
}</pre>
