...
layout: research
ip_v4_address: "190.138.231.201"
date: 2022-12-15T13:50:20+00:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like ```190.138.231.201``` or an IPv6 address like ```2000:d911:2d4e:93d6:8d8d:4b02:24f3:ae62```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```cd:4b:ff:7e:2e:70```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://von-koss.name you initially access a DNS server to translate the host portion (von-koss) combined with the Top Level Domain (name) of the URL, to an IP address like ```89.222.183.104```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows; U; Win 9x 4.90; SG; rv:1.9.2.4) Gecko/20101104 Netscape/9.1.0285```
...
<pre>
default   fe80:68d8:b5e:78a6:6a9b%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {62.72.107.51, 229.223.66.90}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr cd:4b:ff:7e:2e:70
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 48:9b:e5:7e:2d:75
}</pre>
