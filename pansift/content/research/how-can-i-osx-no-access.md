...
subtitle: "Value Add?"
layout: research
ip_v4_address: "70.123.7.131"
date: 2022-04-24T18:31:57+01:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like <code>70.123.7.131</code> or an IPv6 address like <code>2000:deb1:4a95:a9b1:458:15a2:86b2:c5a1</code>. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>d1:6b:c1:4c:ff:a6</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://turcotte-kilback.io you initially access a DNS server to translate the host portion (turcotte-kilback) combined with the Top Level Domain (io) of the URL, to an IP address like <code>135.224.78.123</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (compatible; MSIE 9.0; AOL 9.7; AOLBuild 4343.19; Windows NT 6.1; WOW64; Trident/5.0; FunWebProducts)</code>
...
<pre><code>
default   fe80:1b69:c91f:d23f:dcc8%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {246.199.93.250, 118.51.106.194}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr d1:6b:c1:4c:ff:a6
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 36:d1:43:de:d7:5a
}</code></pre>
