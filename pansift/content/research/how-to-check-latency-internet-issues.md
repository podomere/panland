---
title: "How To Check Latency Internet Issues"
subtitle: "Get A Pulse On?"
layout: research
ip_v4_address: "119.135.128.135"
date: 2022-11-19T19:13:25+00:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like ```119.135.128.135``` or an IPv6 address like ```2000:b6fd:f2de:3dc8:123d:f205:a76d:556c```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```93:b2:a9:e5:b1:ce```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://hayes.io you initially access a DNS server to translate the host portion (hayes) combined with the Top Level Domain (io) of the URL, to an IP address like ```30.142.194.38```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (compatible; MSIE 9.0; AOL 9.7; AOLBuild 4343.19; Windows NT 6.1; WOW64; Trident/5.0; FunWebProducts)```

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```172.27.76.43``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  172.27.76.43    UGScg  en0
...
<pre>
default   fe80:8116:8ba2:113:397b%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {90.50.133.125, 221.158.32.172}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 93:b2:a9:e5:b1:ce
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 3f:9e:1f:a9:3a:28
}</pre>
...
## Apple macOS / OSX
No matter what version of OSX/macOS you are on, ```10.14.4```, ```11.1.4```, or ```12.2.1```, there are a range of tools for troubleshooting. Unfortunately, between these manual actions and scripts, they don't give you a series of correlated values over time. This is where automated remote troubleshooting comes in to its own, especially for teams that embrace remote work and Work From Anywhere (WFA).
