...
layout: research
ip_v4_address: "124.92.96.28"
date: 2023-02-04T16:26:21+00:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like ```124.92.96.28``` or an IPv6 address like ```2000:5005:fe6e:d35b:838d:25fd:f81b:62b5```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```23:0a:35:0d:59:bd```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://koepp-batz.net you initially access a DNS server to translate the host portion (koepp-batz) combined with the Top Level Domain (net) of the URL, to an IP address like ```166.4.196.138```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (compatible; MSIE 9.0; AOL 9.7; AOLBuild 4343.19; Windows NT 6.1; WOW64; Trident/5.0; FunWebProducts)```
...
<pre>
default   fe80:7a5:69ba:27b5:c4e7%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {159.42.232.75, 253.45.116.181}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 23:0a:35:0d:59:bd
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr e7:6a:58:1a:09:c4
}</pre>
