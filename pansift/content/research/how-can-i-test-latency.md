...
layout: research
ip_v4_address: "27.220.73.146"
date: 2022-06-04T14:38:39+01:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like ```27.220.73.146``` or an IPv6 address like ```2000:b398:1b1:1e0a:98c9:fa4b:d205:39b5```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```82:8b:04:01:e3:54```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://green.info you initially access a DNS server to translate the host portion (green) combined with the Top Level Domain (info) of the URL, to an IP address like ```153.197.226.123```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT x.y; Win64; x64; rv:10.0) Gecko/20100101 Firefox/10.0```

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```172.18.253.129``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  172.18.253.129    UGScg  en0
...
<pre>
default   fe80:3d74:7a1e:41ef:c399%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {27.194.240.67, 160.69.84.182}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 82:8b:04:01:e3:54
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 78:bd:70:f0:2b:dd
}</pre>
