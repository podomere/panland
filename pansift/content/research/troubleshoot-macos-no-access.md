...
layout: research
ip_v4_address: "119.79.66.247"
date: 2023-02-04T16:26:10+00:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like ```119.79.66.247``` or an IPv6 address like ```2000:208b:397:abc8:201b:84e4:913e:9de4```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```3a:b4:39:7e:ff:8f```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://goldner-weber.biz you initially access a DNS server to translate the host portion (goldner-weber) combined with the Top Level Domain (biz) of the URL, to an IP address like ```34.28.189.235```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows; U; Win 9x 4.90; SG; rv:1.9.2.4) Gecko/20101104 Netscape/9.1.0285```
...
<pre>
default   fe80:e412:ddfe:9fba:f630%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {60.101.84.208, 43.190.246.183}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 3a:b4:39:7e:ff:8f
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr f8:c4:90:2f:31:8b
}</pre>
