...
layout: research
ip_v4_address: "49.159.124.243"
date: 2022-11-02T11:33:11+00:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like ```49.159.124.243``` or an IPv6 address like ```2000:d502:4973:66bb:ed1b:a425:da73:2d7a```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```a5:51:71:2a:6e:e6```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://monahan-thompson.io you initially access a DNS server to translate the host portion (monahan-thompson) combined with the Top Level Domain (io) of the URL, to an IP address like ```164.25.111.168```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/41.0.2228.0 Safari/537.36```
...
<pre>
default   fe80:f266:4918:d0e:a836%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {246.42.82.217, 187.170.156.229}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr a5:51:71:2a:6e:e6
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 56:80:e4:07:01:b1
}</pre>
