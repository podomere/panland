---
title: "How To Understand Https Protocol"
subtitle: "Streamline?"
layout: research
ip_v4_address: "101.177.125.165"
date: 2023-02-04T16:26:23+00:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like ```101.177.125.165``` or an IPv6 address like ```2000:7689:6488:8ae1:95a8:1a15:5850:8f55```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```cc:a5:c2:ff:c8:75```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://christiansen-schowalter.io you initially access a DNS server to translate the host portion (christiansen-schowalter) combined with the Top Level Domain (io) of the URL, to an IP address like ```232.92.105.200```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT x.y; Win64; x64; rv:10.0) Gecko/20100101 Firefox/10.0```

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```192.168.115.157``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  192.168.115.157    UGScg  en0
...
<pre>
default   fe80:614d:293:3eae:3f41%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {88.197.235.52, 212.144.169.181}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr cc:a5:c2:ff:c8:75
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr bc:8c:9d:a3:cc:f0
}</pre>
...
## Apple macOS / OSX
No matter what version of OSX/macOS you are on, ```10.11.8```, ```11.6.7```, or ```12.1.4```, there are a range of tools for troubleshooting. Unfortunately, between these manual actions and scripts, they don't give you a series of correlated values over time. This is where automated remote troubleshooting comes in to its own, especially for teams that embrace remote work and Work From Anywhere (WFA).
