...
layout: research
ip_v4_address: "188.27.155.250"
date: 2023-02-04T17:08:34+00:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like ```188.27.155.250``` or an IPv6 address like ```2000:ce01:4d67:4f46:6003:aef4:a856:f85d```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```a2:af:71:b3:18:0d```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://vandervort-kreiger.biz you initially access a DNS server to translate the host portion (vandervort-kreiger) combined with the Top Level Domain (biz) of the URL, to an IP address like ```0.194.219.186```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1; WOW64; Trident/7.0; AS; rv:11.0) like Gecko```
...
<pre>
default   fe80:80f2:8a23:fa56:dcf9%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {247.92.213.229, 93.38.90.120}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr a2:af:71:b3:18:0d
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 04:82:6f:34:3c:f3
}</pre>
