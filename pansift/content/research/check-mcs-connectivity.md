...
layout: research
ip_v4_address: "22.167.223.215"
date: 2022-05-05T14:28:31+01:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like ```22.167.223.215``` or an IPv6 address like ```2000:3810:36c1:5347:7ea:4b21:285c:f35a```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```5a:c8:fc:42:b7:cc```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://mann.co you initially access a DNS server to translate the host portion (mann) combined with the Top Level Domain (co) of the URL, to an IP address like ```163.98.48.141```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT x.y; Win64; x64; rv:10.0) Gecko/20100101 Firefox/10.0```

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```10.209.185.35``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  10.209.185.35    UGScg  en0
...
<pre>
default   fe80:9db9:661a:c396:a24f%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {171.197.93.36, 197.119.228.139}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 5a:c8:fc:42:b7:cc
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 36:55:2a:9b:2f:aa
}</pre>
