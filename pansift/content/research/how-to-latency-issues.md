...
layout: research
ip_v4_address: "92.69.103.70"
date: 2022-11-02T11:32:55+00:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like ```92.69.103.70``` or an IPv6 address like ```2000:edeb:8ded:bed7:6a1f:24a7:a941:d72d```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```19:54:39:54:a5:30```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://jones-wilderman.org you initially access a DNS server to translate the host portion (jones-wilderman) combined with the Top Level Domain (org) of the URL, to an IP address like ```48.18.108.15```. Your computer and browser actually sends its type with all web requests e.g. <br>```Opera/9.80 (X11; Linux i686; Ubuntu/14.10) Presto/2.12.388 Version/12.16```
...
<pre>
default   fe80:932a:5347:e455:678d%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {153.126.77.15, 66.200.232.195}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 19:54:39:54:a5:30
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr f7:d4:d6:41:c9:d6
}</pre>
