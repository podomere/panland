...
subtitle: "Learnings?"
layout: research
ip_v4_address: "17.254.9.221"
date: 2023-02-04T17:08:35+00:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like ```17.254.9.221``` or an IPv6 address like ```2000:23cc:1d9c:a697:a554:f96d:67b2:c26f```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```bc:fc:09:b2:19:33```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://volkman-farrell.co you initially access a DNS server to translate the host portion (volkman-farrell) combined with the Top Level Domain (co) of the URL, to an IP address like ```254.39.106.80```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/41.0.2228.0 Safari/537.36```
...
<pre>
default   fe80:ad51:1a3:d7aa:d161%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {209.140.192.151, 183.95.247.46}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr bc:fc:09:b2:19:33
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 79:68:3e:31:52:45
}</pre>
