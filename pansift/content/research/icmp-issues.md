...
layout: research
ip_v4_address: "188.239.192.250"
date: 2022-06-12T14:09:26+01:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like ```188.239.192.250``` or an IPv6 address like ```2000:7ce4:b04f:5e3:bcb6:2d3b:1f44:6c2a```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```7a:15:72:c2:e2:28```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://spencer-rice.io you initially access a DNS server to translate the host portion (spencer-rice) combined with the Top Level Domain (io) of the URL, to an IP address like ```45.159.193.115```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_3) AppleWebKit/537.75.14 (KHTML, like Gecko) Version/7.0.3 Safari/7046A194A```
...
<pre>
default   fe80:1b2:5b2a:322c:cbe9%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {192.73.43.213, 139.176.193.10}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 7a:15:72:c2:e2:28
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 78:99:88:c6:5c:7f
}</pre>
