...
subtitle: "Deep Dive?"
layout: research
ip_v4_address: "43.21.238.113"
date: 2022-11-19T16:17:05+00:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like ```43.21.238.113``` or an IPv6 address like ```2000:e0df:c0cf:69de:1a66:9068:1fb6:bdb4```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```43:35:1d:53:80:5b```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://frami-hoppe.net you initially access a DNS server to translate the host portion (frami-hoppe) combined with the Top Level Domain (net) of the URL, to an IP address like ```30.199.143.251```. Your computer and browser actually sends its type with all web requests e.g. <br>```Opera/9.80 (X11; Linux i686; Ubuntu/14.10) Presto/2.12.388 Version/12.16```
...
<pre>
default   fe80:69d1:8b51:aaf3:627d%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {55.70.102.208, 25.230.58.244}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 43:35:1d:53:80:5b
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr da:36:4a:a4:b5:2b
}</pre>
