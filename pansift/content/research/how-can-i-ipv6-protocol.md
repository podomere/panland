...
layout: research
ip_v4_address: "191.245.123.12"
date: 2022-11-02T11:32:52+00:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like ```191.245.123.12``` or an IPv6 address like ```2000:2cfe:12a7:60f1:5aff:946e:2ac6:c424```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```4f:d8:2e:c4:26:2f```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://jakubowski-bins.name you initially access a DNS server to translate the host portion (jakubowski-bins) combined with the Top Level Domain (name) of the URL, to an IP address like ```180.231.195.50```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_3) AppleWebKit/537.75.14 (KHTML, like Gecko) Version/7.0.3 Safari/7046A194A```
...
<pre>
default   fe80:f127:5806:99c3:2dd3%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {231.112.253.250, 216.171.37.0}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 4f:d8:2e:c4:26:2f
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 90:ad:be:3c:81:ca
}</pre>
