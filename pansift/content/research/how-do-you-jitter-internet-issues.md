...
layout: research
ip_v4_address: "236.81.242.212"
date: 2022-04-24T19:00:00+01:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like <code>236.81.242.212</code> or an IPv6 address like <code>2000:dcae:6c32:16a1:1d5e:23ac:1f93:c759</code>. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>05:96:72:e0:ee:a6</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://beier.name you initially access a DNS server to translate the host portion (beier) combined with the Top Level Domain (name) of the URL, to an IP address like <code>38.210.106.232</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (Windows NT x.y; Win64; x64; rv:10.0) Gecko/20100101 Firefox/10.0</code>

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like <code>192.168.46.237</code> (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For <code>IPv6</code> we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  192.168.46.237    UGScg  en0
...
<pre><code>
default   fe80:adbb:47e4:9acf:60b3%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {185.80.16.66, 121.77.112.95}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 05:96:72:e0:ee:a6
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 9d:0d:e6:b3:32:62
}</code></pre>
