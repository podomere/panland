...
layout: research
ip_v4_address: "224.246.21.233"
date: 2022-05-05T14:28:32+01:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like ```224.246.21.233``` or an IPv6 address like ```2000:d0c1:5c53:44c7:3fa3:9e81:1bdc:e93c```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```79:21:32:e1:64:b5```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://howe-luettgen.name you initially access a DNS server to translate the host portion (howe-luettgen) combined with the Top Level Domain (name) of the URL, to an IP address like ```134.152.18.178```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (compatible; MSIE 9.0; AOL 9.7; AOLBuild 4343.19; Windows NT 6.1; WOW64; Trident/5.0; FunWebProducts)```
...
<pre>
default   fe80:e8a9:9a02:efc7:1c51%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {159.154.225.5, 127.66.57.125}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 79:21:32:e1:64:b5
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 1f:80:e6:d6:22:7f
}</pre>
