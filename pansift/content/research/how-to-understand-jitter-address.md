...
subtitle: "Ideate?"
layout: research
ip_v4_address: "249.122.193.159"
date: 2022-04-24T19:00:00+01:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like <code>249.122.193.159</code> or an IPv6 address like <code>2000:a735:ee0:ce25:a903:7ed2:c6c3:e827</code>. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>82:a5:99:be:1c:fa</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://mcdermott.name you initially access a DNS server to translate the host portion (mcdermott) combined with the Top Level Domain (name) of the URL, to an IP address like <code>89.73.51.54</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (Windows NT 6.1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/41.0.2228.0 Safari/537.36</code>
...
<pre><code>
default   fe80:7523:3423:62b8:b63a%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {92.188.40.96, 68.55.190.73}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 82:a5:99:be:1c:fa
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 38:c6:4a:0a:9f:97
}</code></pre>
