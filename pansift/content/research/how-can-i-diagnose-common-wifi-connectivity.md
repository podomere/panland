...
layout: research
ip_v4_address: "31.0.7.55"
date: 2022-06-04T14:38:17+01:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like ```31.0.7.55``` or an IPv6 address like ```2000:bdaa:8ffd:1ae:ed2d:7f59:fc3c:c98b```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```79:96:51:59:f1:13```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://simonis-dibbert.co you initially access a DNS server to translate the host portion (simonis-dibbert) combined with the Top Level Domain (co) of the URL, to an IP address like ```18.155.234.171```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (compatible; MSIE 9.0; AOL 9.7; AOLBuild 4343.19; Windows NT 6.1; WOW64; Trident/5.0; FunWebProducts)```
...
default  192.168.132.80    UGScg  en0
...
<pre>
default   fe80:5d4c:e481:37c5:25b3%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {51.190.80.175, 9.2.148.44}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 79:96:51:59:f1:13
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 04:0e:1e:8a:33:83
}</pre>
