...
layout: research
ip_v4_address: "38.203.99.255"
date: 2022-06-12T14:09:28+01:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like ```38.203.99.255``` or an IPv6 address like ```2000:9976:fb6a:3deb:76a8:9b93:4a1d:9ed1```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```50:8e:7d:45:0d:4f```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://aufderhar-haley.com you initially access a DNS server to translate the host portion (aufderhar-haley) combined with the Top Level Domain (com) of the URL, to an IP address like ```194.27.201.82```. Your computer and browser actually sends its type with all web requests e.g. <br>```Opera/9.80 (X11; Linux i686; Ubuntu/14.10) Presto/2.12.388 Version/12.16```
...
<pre>
default   fe80:c858:e17d:f83d:3092%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {190.9.17.191, 12.24.138.201}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 50:8e:7d:45:0d:4f
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 89:27:5b:8e:c7:b8
}</pre>
...
## Apple macOS / OSX
No matter what version of OSX/macOS you are on, ```10.11.5```, ```11.6.7```, or ```12.1.8```, there are a range of tools for troubleshooting. Unfortunately, between these manual actions and scripts, they don't give you a series of correlated values over time. This is where automated remote troubleshooting comes in to its own, especially for teams that embrace remote work and Work From Anywhere (WFA).
