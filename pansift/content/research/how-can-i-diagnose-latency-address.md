...
layout: research
ip_v4_address: "178.142.195.127"
date: 2022-11-02T11:32:56+00:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like ```178.142.195.127``` or an IPv6 address like ```2000:18af:6f64:97a0:54c3:1466:fdea:3250```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```f9:6d:2c:d9:e3:17```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://stamm-lemke.com you initially access a DNS server to translate the host portion (stamm-lemke) combined with the Top Level Domain (com) of the URL, to an IP address like ```47.127.18.42```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows; U; Win 9x 4.90; SG; rv:1.9.2.4) Gecko/20101104 Netscape/9.1.0285```
...
<pre>
default   fe80:9373:b42c:c790:1fa3%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {125.3.89.180, 17.70.127.66}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr f9:6d:2c:d9:e3:17
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 5a:69:69:9b:a1:b4
}</pre>
