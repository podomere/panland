...
layout: research
ip_v4_address: "123.148.208.144"
date: 2022-11-02T11:32:54+00:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like ```123.148.208.144``` or an IPv6 address like ```2000:cc87:250b:d439:7a40:7096:2afe:b22f```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```fc:7b:3e:1f:55:4b```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://ullrich.io you initially access a DNS server to translate the host portion (ullrich) combined with the Top Level Domain (io) of the URL, to an IP address like ```150.145.75.29```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_3) AppleWebKit/537.75.14 (KHTML, like Gecko) Version/7.0.3 Safari/7046A194A```
...
<pre>
default   364:e472:8486:f1:d64e:ea43:3f6d:8a91%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {224.63.85.255, 133.79.60.160}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr fc:7b:3e:1f:55:4b
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr c3:07:2b:80:8d:e4
}</pre>
...
## Apple macOS / OSX
No matter what version of OSX/macOS you are on, ```10.13.5```, ```11.1.2```, or ```12.1.2```, there are a range of tools for troubleshooting. Unfortunately, between these manual actions and scripts, they don't give you a series of correlated values over time. This is where automated remote troubleshooting comes in to its own, especially for teams that embrace remote work and Work From Anywhere (WFA).
