...
subtitle: "Value Add?"
layout: research
ip_v4_address: "205.125.12.105"
date: 2023-02-04T17:08:36+00:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like ```205.125.12.105``` or an IPv6 address like ```2000:4ad6:780b:f280:9a4:230a:57cb:9395```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```ce:e9:c7:7b:b0:61```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://hodkiewicz-muller.com you initially access a DNS server to translate the host portion (hodkiewicz-muller) combined with the Top Level Domain (com) of the URL, to an IP address like ```176.93.153.28```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1; WOW64; Trident/7.0; AS; rv:11.0) like Gecko```
...
<pre>
default   fe80:3dab:2307:e66f:3af%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {68.50.205.255, 79.191.207.207}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr ce:e9:c7:7b:b0:61
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr c5:63:1a:23:79:11
}</pre>
