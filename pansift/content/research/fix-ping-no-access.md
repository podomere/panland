...
subtitle: "Streamline?"
layout: research
ip_v4_address: "145.173.255.116"
date: 2023-10-06T17:11:06+01:00
draft: false
---

## Internet Addressing
On the Internet you may get a Public IPv4 address like ```145.173.255.116``` or an IPv6 address like ```2000:9c6e:8737:3c8b:65c9:a7d4:4e31:b89b```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```e8:33:40:4c:54:a9```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://weber-cronin.net you initially access a DNS server to translate the host portion (weber-cronin) combined with the Top Level Domain (net) of the URL, to an IP address like ```46.124.72.176```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/41.0.2228.0 Safari/537.36```
...
<pre>
default   fe80:a9de:1485:5cc9:7cdb%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {209.124.23.115, 63.165.82.107}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr e8:33:40:4c:54:a9
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr d1:9a:a7:74:d7:3e
}</pre>
