...
layout: research
ip_v4_address: "233.108.63.164"
date: 2022-11-02T11:32:57+00:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like ```233.108.63.164``` or an IPv6 address like ```2000:715e:f4d8:3656:d703:426f:21f4:71f```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```f9:ba:99:04:81:2e```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://murray-hoppe.biz you initially access a DNS server to translate the host portion (murray-hoppe) combined with the Top Level Domain (biz) of the URL, to an IP address like ```32.190.2.212```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (compatible; MSIE 9.0; AOL 9.7; AOLBuild 4343.19; Windows NT 6.1; WOW64; Trident/5.0; FunWebProducts)```

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```172.30.170.120``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  172.30.170.120    UGScg  en0
...
<pre>
default   fe80:a174:ac62:7f63:ee59%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {208.100.108.174, 55.45.47.133}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr f9:ba:99:04:81:2e
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 88:4c:30:c5:4c:d4
}</pre>
