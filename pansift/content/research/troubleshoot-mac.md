...
layout: research
ip_v4_address: "117.104.201.123"
date: 2022-11-19T19:13:17+00:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like ```117.104.201.123``` or an IPv6 address like ```2000:7478:5036:a0f2:667a:56f1:46f1:453b```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```5d:d3:3d:bd:7c:02```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://thompson-cummerata.io you initially access a DNS server to translate the host portion (thompson-cummerata) combined with the Top Level Domain (io) of the URL, to an IP address like ```185.83.82.153```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_3) AppleWebKit/537.75.14 (KHTML, like Gecko) Version/7.0.3 Safari/7046A194A```
...
<pre>
default   fe80:7b44:941b:4ad:f5bc%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {134.192.24.216, 14.49.88.190}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 5d:d3:3d:bd:7c:02
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 2f:3c:d7:e1:3b:30
}</pre>
