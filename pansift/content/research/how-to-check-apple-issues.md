...
layout: research
ip_v4_address: "162.159.79.18"
date: 2023-10-29T15:13:19+00:00
draft: false
---

## Internet Addressing
On the Internet you might get a Public IPv4 address like ```162.159.79.18``` or an IPv6 address like ```2000:c756:5fb1:e3b1:ae67:63bc:6e5d:8791```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```06:05:53:b5:85:b6```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://lehner-grant.net you initially access a DNS server to translate the host portion (lehner-grant) combined with the Top Level Domain (net) of the URL, to an IP address like ```249.92.124.88```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_3) AppleWebKit/537.75.14 (KHTML, like Gecko) Version/7.0.3 Safari/7046A194A```
...
<pre>
default   fe80:586a:c79d:c10c:ed6d%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {88.152.10.35, 219.171.86.227}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 06:05:53:b5:85:b6
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 85:69:c2:87:9e:e1
}</pre>
