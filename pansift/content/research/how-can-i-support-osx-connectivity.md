...
subtitle: "Synergy?"
layout: research
ip_v4_address: "49.47.193.35"
date: 2023-02-04T17:07:49+00:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like ```49.47.193.35``` or an IPv6 address like ```2000:259f:f699:45c5:c7b:3237:594f:98b2```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```6e:a5:9e:43:6a:37```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://hahn.org you initially access a DNS server to translate the host portion (hahn) combined with the Top Level Domain (org) of the URL, to an IP address like ```197.240.204.120```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT x.y; Win64; x64; rv:10.0) Gecko/20100101 Firefox/10.0```
...
<pre>
default   fe80:51ff:866:1dd5:1ed7%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {70.85.59.74, 138.195.169.203}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 6e:a5:9e:43:6a:37
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 89:96:ce:af:4d:e6
}</pre>
