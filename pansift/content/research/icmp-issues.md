...
subtitle: "Streamline?"
layout: research
ip_v4_address: "97.165.43.63"
date: 2022-11-19T19:13:26+00:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like ```97.165.43.63``` or an IPv6 address like ```2000:e9fb:ce99:e521:7b58:fcbc:fad4:33c0```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```a4:ab:f0:ee:58:7d```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://doyle-wyman.io you initially access a DNS server to translate the host portion (doyle-wyman) combined with the Top Level Domain (io) of the URL, to an IP address like ```71.117.0.4```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows; U; Win 9x 4.90; SG; rv:1.9.2.4) Gecko/20101104 Netscape/9.1.0285```
...
<pre>
default   fe80:e0d0:8e7b:fb08:7f2c%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {63.71.218.48, 128.112.103.70}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr a4:ab:f0:ee:58:7d
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 59:34:e0:0b:56:f3
}</pre>
