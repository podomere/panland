...
subtitle: "Tee It Up?"
layout: research
ip_v4_address: "232.19.3.82"
date: 2023-10-06T17:11:09+01:00
draft: false
---

## Internet Addressing
On the Internet you may get a Public IPv4 address like ```232.19.3.82``` or an IPv6 address like ```2000:f9f2:cafb:1e3a:e5d:6b56:e338:b34f```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```fd:39:d9:a9:79:66```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://lakin-howe.co you initially access a DNS server to translate the host portion (lakin-howe) combined with the Top Level Domain (co) of the URL, to an IP address like ```36.38.73.40```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_3) AppleWebKit/537.75.14 (KHTML, like Gecko) Version/7.0.3 Safari/7046A194A```
...
<pre>
default   fe80:2dfe:5126:948:6484%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {138.76.96.235, 167.151.238.119}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr fd:39:d9:a9:79:66
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr fe:f7:0b:e2:2d:a9
}</pre>
