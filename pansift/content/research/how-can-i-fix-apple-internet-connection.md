...
subtitle: "Etc. Etc.?"
layout: research
ip_v4_address: "111.18.128.11"
date: 2023-10-06T17:10:43+01:00
draft: false
---

## Internet Addressing
On the Internet you might have a Public IPv4 address like ```111.18.128.11``` or an IPv6 address like ```2000:dada:5b49:d183:f172:ad74:16a0:8056```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```7b:44:6a:47:65:aa```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://wuckert-buckridge.info you initially access a DNS server to translate the host portion (wuckert-buckridge) combined with the Top Level Domain (info) of the URL, to an IP address like ```139.151.0.217```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_3) AppleWebKit/537.75.14 (KHTML, like Gecko) Version/7.0.3 Safari/7046A194A```
...
<pre>
default   fe80:4a00:5831:7c9a:d87f%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {234.216.40.32, 230.241.88.49}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 7b:44:6a:47:65:aa
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 3f:b4:bb:92:7b:02
}</pre>
