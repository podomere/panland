...
layout: research
ip_v4_address: "146.244.45.123"
date: 2022-04-24T19:00:01+01:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like <code>146.244.45.123</code> or an IPv6 address like <code>2000:fac7:977a:37d5:269e:5bf4:c3c3:8069</code>. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>26:16:b9:f0:e6:f6</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://kshlerin-pagac.com you initially access a DNS server to translate the host portion (kshlerin-pagac) combined with the Top Level Domain (com) of the URL, to an IP address like <code>217.5.50.108</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (Windows; U; Win 9x 4.90; SG; rv:1.9.2.4) Gecko/20101104 Netscape/9.1.0285</code>
...
<pre><code>
default   fe80:a507:159d:b8b6:6d79%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {206.7.212.19, 24.23.229.144}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 26:16:b9:f0:e6:f6
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 7e:36:40:fd:a4:2a
}</code></pre>
