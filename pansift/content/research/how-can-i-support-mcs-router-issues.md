...
layout: research
ip_v4_address: "10.78.32.225"
date: 2022-04-24T19:00:34+01:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like <code>10.78.32.225</code> or an IPv6 address like <code>2000:e850:726e:3228:ae87:bd3f:cd86:eb8b</code>. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>86:25:e5:9c:5d:58</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://schaden-rodriguez.co you initially access a DNS server to translate the host portion (schaden-rodriguez) combined with the Top Level Domain (co) of the URL, to an IP address like <code>158.133.39.117</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_3) AppleWebKit/537.75.14 (KHTML, like Gecko) Version/7.0.3 Safari/7046A194A</code>
...
<pre><code>
default   fe80:e0d1:c5b9:86d8:2343%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {6.107.143.35, 73.162.198.119}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 86:25:e5:9c:5d:58
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 95:fb:20:4b:44:de
}</code></pre>
