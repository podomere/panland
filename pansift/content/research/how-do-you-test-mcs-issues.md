...
layout: research
ip_v4_address: "96.36.192.254"
date: 2022-06-12T14:09:06+01:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like ```96.36.192.254``` or an IPv6 address like ```2000:4e90:686b:9050:af7a:4347:57a:7af8```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```3f:58:63:ec:08:83```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://bosco.co you initially access a DNS server to translate the host portion (bosco) combined with the Top Level Domain (co) of the URL, to an IP address like ```63.104.43.46```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT x.y; Win64; x64; rv:10.0) Gecko/20100101 Firefox/10.0```
...
<pre>
default   fe80:e116:e419:4818:c18b%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {104.57.69.58, 119.109.218.165}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 3f:58:63:ec:08:83
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr eb:13:64:ec:ed:8b
}</pre>
