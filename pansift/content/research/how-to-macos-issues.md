...
layout: research
ip_v4_address: "15.58.191.41"
date: 2022-05-05T14:28:44+01:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like ```15.58.191.41``` or an IPv6 address like ```2000:35c3:f552:2bd2:52b2:bb2a:4aaf:9596```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```85:19:31:cf:b2:f1```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://leannon-jerde.io you initially access a DNS server to translate the host portion (leannon-jerde) combined with the Top Level Domain (io) of the URL, to an IP address like ```163.188.166.102```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_3) AppleWebKit/537.75.14 (KHTML, like Gecko) Version/7.0.3 Safari/7046A194A```
...
<pre>
default   fe80:1965:df48:bd54:de1b%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {126.29.122.134, 211.224.129.8}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 85:19:31:cf:b2:f1
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 08:c7:3e:eb:74:36
}</pre>
