...
layout: research
ip_v4_address: "42.90.13.110"
date: 2022-12-15T13:50:19+00:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like ```42.90.13.110``` or an IPv6 address like ```2000:fae8:89db:27e:7347:7a5f:5faf:dbae```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```1e:bf:55:5d:14:be```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://moen.co you initially access a DNS server to translate the host portion (moen) combined with the Top Level Domain (co) of the URL, to an IP address like ```209.100.52.93```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/41.0.2228.0 Safari/537.36```
...
<pre>
default   fe80:e7ba:61b0:d63a:d9ab%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {204.120.3.4, 132.245.198.232}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 1e:bf:55:5d:14:be
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr ff:98:d6:f9:31:e3
}</pre>
...
## Apple macOS / OSX
No matter what version of OSX/macOS you are on, ```10.15.2```, ```11.5.6```, or ```12.2.8```, there are a range of tools for troubleshooting. Unfortunately, between these manual actions and scripts, they don't give you a series of correlated values over time. This is where automated remote troubleshooting comes in to its own, especially for teams that embrace remote work and Work From Anywhere (WFA).
