...
subtitle: "Heads Down?"
layout: research
ip_v4_address: "76.251.33.224"
date: 2023-10-29T15:13:27+00:00
draft: false
---

## Internet Addressing
On the Internet you might have a Public IPv4 address like ```76.251.33.224``` or an IPv6 address like ```2000:2faa:b3d2:606b:a720:3d51:bd83:61d1```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```ed:fa:da:e4:c4:f3```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://dietrich-hirthe.name you initially access a DNS server to translate the host portion (dietrich-hirthe) combined with the Top Level Domain (name) of the URL, to an IP address like ```33.187.6.238```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT x.y; Win64; x64; rv:10.0) Gecko/20100101 Firefox/10.0```
...
<pre>
default   fe80:dd64:1dbb:56f9:5eaa%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {132.72.30.180, 92.240.201.31}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr ed:fa:da:e4:c4:f3
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 5f:18:23:97:c2:17
}</pre>
