...
subtitle: "Granular?"
layout: research
ip_v4_address: "35.65.95.253"
date: 2023-10-29T15:13:18+00:00
draft: false
---

## Internet Addressing
On the Internet you might get a Public IPv4 address like ```35.65.95.253``` or an IPv6 address like ```2000:bc80:7968:fa4b:431d:6bfa:1b44:e6a1```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```3b:f2:be:7a:6a:3d```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://prosacco-bosco.info you initially access a DNS server to translate the host portion (prosacco-bosco) combined with the Top Level Domain (info) of the URL, to an IP address like ```56.31.186.123```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_3) AppleWebKit/537.75.14 (KHTML, like Gecko) Version/7.0.3 Safari/7046A194A```
...
<pre>
default   fe80:4f8b:844e:b7aa:deee%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {142.138.92.95, 148.104.206.234}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 3b:f2:be:7a:6a:3d
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 11:b7:09:9d:31:7e
}</pre>
