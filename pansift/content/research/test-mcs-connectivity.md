...
layout: research
ip_v4_address: "28.199.191.81"
date: 2022-04-24T18:32:42+01:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like <code>28.199.191.81</code> or an IPv6 address like <code>2000:93e:977e:ff72:fb68:72ce:837e:cd63</code>. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>49:e3:53:22:03:7c</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://pacocha.info you initially access a DNS server to translate the host portion (pacocha) combined with the Top Level Domain (info) of the URL, to an IP address like <code>235.10.33.219</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (Windows NT x.y; Win64; x64; rv:10.0) Gecko/20100101 Firefox/10.0</code>
...
default  192.168.138.231    UGScg  en0
...
<pre><code>
default   fe80:f6c:1a56:ddb1:6213%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {230.99.236.10, 124.102.211.102}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 49:e3:53:22:03:7c
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 31:66:3d:1a:fa:e0
}</code></pre>
