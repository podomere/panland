...
subtitle: "Tee It Up?"
layout: research
ip_v4_address: "134.215.227.114"
date: 2022-04-24T18:31:59+01:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like <code>134.215.227.114</code> or an IPv6 address like <code>2000:88f3:e977:beda:73b9:ad84:c799:f94e</code>. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>b6:10:22:05:a0:0f</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://abbott-marquardt.biz you initially access a DNS server to translate the host portion (abbott-marquardt) combined with the Top Level Domain (biz) of the URL, to an IP address like <code>83.51.246.7</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_3) AppleWebKit/537.75.14 (KHTML, like Gecko) Version/7.0.3 Safari/7046A194A</code>
...
<pre><code>
default   fe80:ecb3:aed2:2952:a0a3%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {99.198.2.253, 13.106.152.229}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr b6:10:22:05:a0:0f
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 63:fa:46:95:e7:4d
}</code></pre>
