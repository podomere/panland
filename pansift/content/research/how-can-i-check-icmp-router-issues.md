...
layout: research
ip_v4_address: "35.120.228.246"
date: 2023-02-04T17:08:38+00:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like ```35.120.228.246``` or an IPv6 address like ```2000:a93c:50e8:18a3:e6e5:f3f:49c3:9601```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```09:fd:dc:9b:3e:2f```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://rosenbaum-okeefe.org you initially access a DNS server to translate the host portion (rosenbaum-okeefe) combined with the Top Level Domain (org) of the URL, to an IP address like ```142.70.72.220```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_3) AppleWebKit/537.75.14 (KHTML, like Gecko) Version/7.0.3 Safari/7046A194A```
...
default  192.168.132.79    UGScg  en0
...
<pre>
default   fe80:4b75:f54e:8052:3fb%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {51.101.101.177, 64.13.254.61}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 09:fd:dc:9b:3e:2f
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr ac:8c:fb:03:7c:95
}</pre>
