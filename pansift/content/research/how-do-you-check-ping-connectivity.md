...
layout: research
ip_v4_address: "5.191.91.87"
date: 2022-11-02T11:33:00+00:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like ```5.191.91.87``` or an IPv6 address like ```2000:6263:fc43:34d0:bcd6:349:c136:a7e0```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```46:b8:44:56:67:0f```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://ankunding-halvorson.org you initially access a DNS server to translate the host portion (ankunding-halvorson) combined with the Top Level Domain (org) of the URL, to an IP address like ```120.8.51.147```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1; WOW64; Trident/7.0; AS; rv:11.0) like Gecko```
...
<pre>
default   fe80:9b92:8af1:77a3:a9ec%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {222.123.208.80, 214.79.19.49}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 46:b8:44:56:67:0f
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr d6:2f:f0:61:5c:e9
}</pre>
