...
layout: research
ip_v4_address: "242.216.160.164"
date: 2022-11-02T11:32:24+00:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like ```242.216.160.164``` or an IPv6 address like ```2000:e2fb:7f1:fa02:ae8c:253b:5d72:5ea5```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```03:8b:b3:30:a4:90```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://metz.co you initially access a DNS server to translate the host portion (metz) combined with the Top Level Domain (co) of the URL, to an IP address like ```192.56.124.101```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_3) AppleWebKit/537.75.14 (KHTML, like Gecko) Version/7.0.3 Safari/7046A194A```
...
<pre>
default   fe80:a194:4092:dd6:dae1%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {232.15.241.139, 131.55.91.110}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 03:8b:b3:30:a4:90
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 81:05:e5:b9:48:0a
}</pre>
