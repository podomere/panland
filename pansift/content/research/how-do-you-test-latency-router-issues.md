...
layout: research
ip_v4_address: "186.59.183.66"
date: 2023-02-04T16:26:20+00:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like ```186.59.183.66``` or an IPv6 address like ```2000:3d01:db88:fa98:c652:6a4b:36ce:285b```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```58:d4:1b:95:a4:71```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://hand.io you initially access a DNS server to translate the host portion (hand) combined with the Top Level Domain (io) of the URL, to an IP address like ```40.119.110.65```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT x.y; Win64; x64; rv:10.0) Gecko/20100101 Firefox/10.0```
...
<pre>
default   fe80:3196:55f2:32c9:c9a6%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {207.229.18.135, 212.164.230.179}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 58:d4:1b:95:a4:71
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr aa:96:d2:0b:41:d1
}</pre>
