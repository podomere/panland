...
layout: research
ip_v4_address: "243.191.57.170"
date: 2023-02-04T16:26:23+00:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like ```243.191.57.170``` or an IPv6 address like ```2000:a3c0:97e4:40d3:df44:1ef2:87fd:e6c1```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```53:f3:e5:de:6d:d3```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://armstrong.biz you initially access a DNS server to translate the host portion (armstrong) combined with the Top Level Domain (biz) of the URL, to an IP address like ```6.193.238.65```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT x.y; Win64; x64; rv:10.0) Gecko/20100101 Firefox/10.0```
...
default  172.18.187.246    UGScg  en0
...
<pre>
default   fe80:a668:4834:fc24:f63b%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {14.51.171.57, 23.104.250.155}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 53:f3:e5:de:6d:d3
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 75:84:5b:b4:8d:6b
}</pre>
...
## Apple macOS / OSX
No matter what version of OSX/macOS you are on, ```10.15.3```, ```11.6.6```, or ```12.0.3```, there are a range of tools for troubleshooting. Unfortunately, between these manual actions and scripts, they don't give you a series of correlated values over time. This is where automated remote troubleshooting comes in to its own, especially for teams that embrace remote work and Work From Anywhere (WFA).
