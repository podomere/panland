...
layout: research
ip_v4_address: "112.112.187.142"
date: 2022-04-24T19:00:33+01:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like <code>112.112.187.142</code> or an IPv6 address like <code>2000:37f0:2cde:38c6:a998:6675:ec0a:5fdd</code>. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>f7:e6:c2:ec:4b:a6</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://cummings-schulist.com you initially access a DNS server to translate the host portion (cummings-schulist) combined with the Top Level Domain (com) of the URL, to an IP address like <code>172.117.69.29</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_3) AppleWebKit/537.75.14 (KHTML, like Gecko) Version/7.0.3 Safari/7046A194A</code>
...
<pre><code>
default   fe80:13da:7278:690d:5955%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {62.145.122.34, 152.19.115.209}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr f7:e6:c2:ec:4b:a6
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 88:d7:e2:c5:02:ca
}</code></pre>
