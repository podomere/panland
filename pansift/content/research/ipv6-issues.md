...
layout: research
ip_v4_address: "112.56.75.203"
date: 2023-10-06T17:11:02+01:00
draft: false
---

## Internet Addressing
On the Internet you may have a Public IPv4 address like ```112.56.75.203``` or an IPv6 address like ```2000:ed5a:a39f:9b4a:e9d9:9761:9e88:1e41```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```44:40:04:81:e2:fe```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://koepp-cruickshank.org you initially access a DNS server to translate the host portion (koepp-cruickshank) combined with the Top Level Domain (org) of the URL, to an IP address like ```98.246.116.123```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/41.0.2228.0 Safari/537.36```
...
<pre>
default   fe80:e0ef:3e1b:7e29:8e07%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {192.208.80.104, 87.110.242.80}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 44:40:04:81:e2:fe
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr e1:b9:5c:e6:ae:43
}</pre>
...
### Apple macOS / OSX
No matter what version of OSX/macOS you are on, ```10.12.4```, ```11.3.3```, or ```12.1.6```, there are a range of tools for troubleshooting. Unfortunately, between these manual actions and scripts, they don't give you a series of correlated values over time. This is where automated remote troubleshooting comes in to its own, especially for teams that embrace remote work and Work From Anywhere (WFA).
