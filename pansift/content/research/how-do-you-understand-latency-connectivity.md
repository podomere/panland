...
layout: research
ip_v4_address: "186.176.50.78"
date: 2022-11-02T11:32:56+00:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like ```186.176.50.78``` or an IPv6 address like ```2000:eb93:62f:37c7:50c9:1d99:1ca9:2bb8```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```10:b3:40:e5:d6:dc```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://little.biz you initially access a DNS server to translate the host portion (little) combined with the Top Level Domain (biz) of the URL, to an IP address like ```64.233.87.155```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows; U; Win 9x 4.90; SG; rv:1.9.2.4) Gecko/20101104 Netscape/9.1.0285```

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```172.23.79.141``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  172.23.79.141    UGScg  en0
...
<pre>
default   fe80:9220:f461:72e2:705%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {137.133.78.186, 199.241.156.155}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 10:b3:40:e5:d6:dc
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr e7:c6:40:4d:e3:ad
}</pre>
...
## Apple macOS / OSX
No matter what version of OSX/macOS you are on, ```10.15.4```, ```11.5.2```, or ```12.3.3```, there are a range of tools for troubleshooting. Unfortunately, between these manual actions and scripts, they don't give you a series of correlated values over time. This is where automated remote troubleshooting comes in to its own, especially for teams that embrace remote work and Work From Anywhere (WFA).
