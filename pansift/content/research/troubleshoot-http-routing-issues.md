...
layout: research
ip_v4_address: "134.211.96.26"
date: 2023-02-04T17:08:39+00:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like ```134.211.96.26``` or an IPv6 address like ```2000:ddec:627c:b043:7ede:63c4:82d6:6c3a```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```6e:f6:88:f1:46:1c```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://torphy-cassin.io you initially access a DNS server to translate the host portion (torphy-cassin) combined with the Top Level Domain (io) of the URL, to an IP address like ```9.79.176.212```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows; U; Win 9x 4.90; SG; rv:1.9.2.4) Gecko/20101104 Netscape/9.1.0285```
...
<pre>
default   fe80:2cde:998c:40c7:530c%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {209.254.138.198, 100.9.86.65}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 6e:f6:88:f1:46:1c
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr a8:74:52:33:63:96
}</pre>
