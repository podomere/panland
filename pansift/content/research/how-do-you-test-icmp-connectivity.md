...
layout: research
ip_v4_address: "139.180.250.52"
date: 2023-10-29T15:13:28+00:00
draft: false
---

## Internet Addressing
On the Internet you may get a Public IPv4 address like ```139.180.250.52``` or an IPv6 address like ```2000:32d2:1344:e805:afd0:7ad2:779e:f047```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```2b:7b:cd:2e:65:8f```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://frami-sawayn.co you initially access a DNS server to translate the host portion (frami-sawayn) combined with the Top Level Domain (co) of the URL, to an IP address like ```163.187.27.151```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_3) AppleWebKit/537.75.14 (KHTML, like Gecko) Version/7.0.3 Safari/7046A194A```
...
<pre>
default   fe80:70ac:a8da:d53e:bb1f%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {8.228.40.161, 21.176.236.82}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 2b:7b:cd:2e:65:8f
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr b6:66:2e:c8:f5:1a
}</pre>
