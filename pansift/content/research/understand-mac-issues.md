...
subtitle: "Deep Dive?"
layout: research
ip_v4_address: "253.103.60.105"
date: 2022-04-24T18:31:59+01:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like <code>253.103.60.105</code> or an IPv6 address like <code>2000:5e5e:be10:1362:e6f6:e83d:1b89:4bee</code>. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>0e:18:31:b7:5c:c0</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://schmidt-schoen.info you initially access a DNS server to translate the host portion (schmidt-schoen) combined with the Top Level Domain (info) of the URL, to an IP address like <code>16.236.54.50</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Opera/9.80 (X11; Linux i686; Ubuntu/14.10) Presto/2.12.388 Version/12.16</code>
...
default  192.168.213.76    UGScg  en0
...
<pre><code>
default   fe80:99e5:870f:b011:518f%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {90.104.211.2, 44.215.107.61}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 0e:18:31:b7:5c:c0
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 91:f1:3d:8a:79:54
}</code></pre>
