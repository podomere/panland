...
layout: research
ip_v4_address: "103.152.221.108"
date: 2022-04-24T18:59:57+01:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like <code>103.152.221.108</code> or an IPv6 address like <code>2000:fb10:d3fd:a177:9d33:7447:d7c8:2368</code>. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>01:c3:32:4e:f6:7f</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://macejkovic.biz you initially access a DNS server to translate the host portion (macejkovic) combined with the Top Level Domain (biz) of the URL, to an IP address like <code>7.109.219.237</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (Windows NT 6.1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/41.0.2228.0 Safari/537.36</code>

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like <code>172.21.229.123</code> (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For <code>IPv6</code> we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  172.21.229.123    UGScg  en0
...
<pre><code>
default   fe80:5491:1ac2:c80e:3376%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {178.137.142.165, 120.153.6.78}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 01:c3:32:4e:f6:7f
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 20:33:e7:d8:03:68
}</code></pre>
