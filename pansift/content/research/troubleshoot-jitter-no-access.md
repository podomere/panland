---
title: "Troubleshoot Jitter No-access"
subtitle: "Expansion Play?"
layout: research
ip_v4_address: "49.69.42.204"
date: 2022-11-02T11:32:57+00:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like ```49.69.42.204``` or an IPv6 address like ```2000:631c:bd1:2885:6ec1:ad88:7157:10e3```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```75:33:bb:45:ed:96```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://mueller-heathcote.co you initially access a DNS server to translate the host portion (mueller-heathcote) combined with the Top Level Domain (co) of the URL, to an IP address like ```155.252.156.145```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT x.y; Win64; x64; rv:10.0) Gecko/20100101 Firefox/10.0```

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```10.193.1.66``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
<pre>
default   fe80:f2b3:ca9b:2d6a:317c%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {87.219.221.180, 77.246.202.250}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 75:33:bb:45:ed:96
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr a3:76:4f:ef:7c:91
}</pre>
