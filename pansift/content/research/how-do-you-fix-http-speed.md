---
title: "How Do You Fix Http Speed"
subtitle: "Thought Leader?"
layout: research
ip_v4_address: "77.59.206.176"
date: 2023-02-04T16:26:23+00:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like ```77.59.206.176``` or an IPv6 address like ```2000:d54c:88f:3c9b:85cb:640b:7835:d443```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```f9:f7:0b:3e:48:d3```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://grady-kuhic.info you initially access a DNS server to translate the host portion (grady-kuhic) combined with the Top Level Domain (info) of the URL, to an IP address like ```96.110.135.166```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (compatible; MSIE 9.0; AOL 9.7; AOLBuild 4343.19; Windows NT 6.1; WOW64; Trident/5.0; FunWebProducts)```
...
<pre>
default   fe80:36d9:46d8:1e4f:cfbe%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {30.207.32.91, 100.118.68.1}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr f9:f7:0b:3e:48:d3
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 82:47:25:71:a5:0d
}</pre>
