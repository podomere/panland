...
layout: research
ip_v4_address: "101.168.72.119"
date: 2022-11-19T19:13:22+00:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like ```101.168.72.119``` or an IPv6 address like ```2000:5863:2a:c7fe:90c8:4922:2baf:20fd```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```50:6b:85:ad:ec:45```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://gusikowski-hoppe.io you initially access a DNS server to translate the host portion (gusikowski-hoppe) combined with the Top Level Domain (io) of the URL, to an IP address like ```218.44.89.134```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT x.y; Win64; x64; rv:10.0) Gecko/20100101 Firefox/10.0```
...
<pre>
default   fe80:419b:b29e:e43a:ce74%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {87.114.7.249, 80.92.183.67}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 50:6b:85:ad:ec:45
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 58:60:ba:00:fd:bf
}</pre>
