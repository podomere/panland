...
layout: research
ip_v4_address: "43.255.163.6"
date: 2022-04-24T19:00:23+01:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like <code>43.255.163.6</code> or an IPv6 address like <code>2000:4124:e72b:858:5bbb:6b67:ec86:9f95</code>. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>df:f1:70:dd:f7:78</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://brekke-anderson.biz you initially access a DNS server to translate the host portion (brekke-anderson) combined with the Top Level Domain (biz) of the URL, to an IP address like <code>29.158.194.47</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (Windows; U; Win 9x 4.90; SG; rv:1.9.2.4) Gecko/20101104 Netscape/9.1.0285</code>
...
<pre><code>
default   fe80:2204:84cd:1d85:2d0c%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {171.68.12.248, 208.249.194.61}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr df:f1:70:dd:f7:78
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr af:71:ea:b8:89:f2
}</code></pre>
