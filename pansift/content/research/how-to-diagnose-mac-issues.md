...
layout: research
ip_v4_address: "239.139.186.230"
date: 2022-12-15T13:50:11+00:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like ```239.139.186.230``` or an IPv6 address like ```2000:2520:729e:9909:dc76:df1b:10e8:d2e```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```c8:33:aa:b0:61:fd```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://klocko-kovacek.io you initially access a DNS server to translate the host portion (klocko-kovacek) combined with the Top Level Domain (io) of the URL, to an IP address like ```204.207.237.115```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT x.y; Win64; x64; rv:10.0) Gecko/20100101 Firefox/10.0```
...
default  172.31.14.149    UGScg  en0
...
<pre>
default   fe80:b134:35ab:f131:c57f%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {53.27.133.179, 176.140.84.199}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr c8:33:aa:b0:61:fd
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 0f:a9:61:8e:38:a2
}</pre>
