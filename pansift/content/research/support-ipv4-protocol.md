...
subtitle: "Tee It Up?"
layout: research
ip_v4_address: "155.177.21.129"
date: 2023-02-04T17:08:35+00:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like ```155.177.21.129``` or an IPv6 address like ```2000:1bc8:7932:aa74:8309:75e8:7bcf:2367```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```b5:01:33:a3:b4:ff```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://kilback-spencer.com you initially access a DNS server to translate the host portion (kilback-spencer) combined with the Top Level Domain (com) of the URL, to an IP address like ```182.115.160.147```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1; WOW64; Trident/7.0; AS; rv:11.0) like Gecko```
...
<pre>
default   fe80:c98e:f847:25b6:5408%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {104.96.160.248, 114.195.102.155}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr b5:01:33:a3:b4:ff
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 21:36:3e:dd:a4:18
}</pre>
