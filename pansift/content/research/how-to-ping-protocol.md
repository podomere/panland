...
layout: research
ip_v4_address: "240.220.38.19"
date: 2023-10-06T17:11:07+01:00
draft: false
---

## Internet Addressing
On the Internet you may get a Public IPv4 address like ```240.220.38.19``` or an IPv6 address like ```2000:30e9:8aef:ed42:f110:f59c:6779:5af```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```98:e8:3e:3e:59:0c```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://leannon.biz you initially access a DNS server to translate the host portion (leannon) combined with the Top Level Domain (biz) of the URL, to an IP address like ```198.44.9.68```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT x.y; Win64; x64; rv:10.0) Gecko/20100101 Firefox/10.0```

## Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```172.17.99.247``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  172.17.99.247    UGScg  en0
...
<pre>
default   fe80:801b:9fa8:cc41:7c7b%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {36.241.10.104, 176.227.168.237}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 98:e8:3e:3e:59:0c
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 0f:8c:7e:58:d0:06
}</pre>
...
### Apple macOS / OSX
No matter what version of OSX/macOS you are on, ```10.12.7```, ```11.1.4```, or ```12.3.4```, there are a range of tools for troubleshooting. Unfortunately, between these manual actions and scripts, they don't give you a series of correlated values over time. This is where automated remote troubleshooting comes in to its own, especially for teams that embrace remote work and Work From Anywhere (WFA).
