...
layout: research
ip_v4_address: "184.78.159.192"
date: 2022-11-02T11:32:58+00:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like ```184.78.159.192``` or an IPv6 address like ```2000:7709:1999:b230:9215:9bf1:13ec:3fc4```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```1b:b6:36:d4:6f:a3```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://schinner-borer.info you initially access a DNS server to translate the host portion (schinner-borer) combined with the Top Level Domain (info) of the URL, to an IP address like ```218.112.56.218```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows; U; Win 9x 4.90; SG; rv:1.9.2.4) Gecko/20101104 Netscape/9.1.0285```
...
<pre>
default   fe80:7991:fb03:56b2:27b9%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {72.203.109.22, 90.243.2.223}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 1b:b6:36:d4:6f:a3
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 85:11:a3:6d:12:06
}</pre>
