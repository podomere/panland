...
subtitle: "Deep Dive?"
layout: research
ip_v4_address: "92.118.195.35"
date: 2022-11-19T19:13:24+00:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like ```92.118.195.35``` or an IPv6 address like ```2000:dced:de05:6d3c:58d9:b018:6676:34bf```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```2e:17:82:d9:ac:aa```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://quigley-spinka.co you initially access a DNS server to translate the host portion (quigley-spinka) combined with the Top Level Domain (co) of the URL, to an IP address like ```122.84.4.130```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1; WOW64; Trident/7.0; AS; rv:11.0) like Gecko```

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```10.175.116.186``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  10.175.116.186    UGScg  en0
...
<pre>
default   fe80:c3ee:4ec0:bf11:2a6a%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {42.151.122.156, 126.22.28.198}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 2e:17:82:d9:ac:aa
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr a8:a5:7a:f9:3a:13
}</pre>
...
## Apple macOS / OSX
No matter what version of OSX/macOS you are on, ```10.14.5```, ```11.4.3```, or ```12.3.6```, there are a range of tools for troubleshooting. Unfortunately, between these manual actions and scripts, they don't give you a series of correlated values over time. This is where automated remote troubleshooting comes in to its own, especially for teams that embrace remote work and Work From Anywhere (WFA).
