...
subtitle: "Swim Lane?"
layout: research
ip_v4_address: "15.175.219.28"
date: 2023-10-29T15:13:28+00:00
draft: false
---

## Internet Addressing
On the Internet you may have a Public IPv4 address like ```15.175.219.28``` or an IPv6 address like ```2000:a7c5:40f3:8766:59af:b341:1892:6381```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```0e:f3:1d:3e:82:8d```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://jast.biz you initially access a DNS server to translate the host portion (jast) combined with the Top Level Domain (biz) of the URL, to an IP address like ```132.153.6.24```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/41.0.2228.0 Safari/537.36```
...
<pre>
default   fe80:8b59:9e8b:79f4:13d2%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {33.178.2.181, 223.12.46.214}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 0e:f3:1d:3e:82:8d
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 4f:d9:2b:6e:94:a9
}</pre>
