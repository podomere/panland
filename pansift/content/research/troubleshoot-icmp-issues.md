...
layout: research
ip_v4_address: "88.196.77.163"
date: 2022-05-05T14:29:49+01:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like ```88.196.77.163``` or an IPv6 address like ```2000:8062:4ebd:d30b:7a69:bd00:64f3:ec5c```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```cc:87:fe:62:19:e8```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://brakus-purdy.co you initially access a DNS server to translate the host portion (brakus-purdy) combined with the Top Level Domain (co) of the URL, to an IP address like ```84.31.42.16```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/41.0.2228.0 Safari/537.36```
...
<pre>
default   fe80:e5c1:b74a:208b:263c%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {239.233.42.148, 114.196.172.85}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr cc:87:fe:62:19:e8
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 62:4d:7a:18:88:31
}</pre>
