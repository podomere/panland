...
subtitle: "Value Add?"
layout: research
ip_v4_address: "1.1.141.202"
date: 2023-10-06T17:11:08+01:00
draft: false
---

## Internet Addressing
On the Internet you might get a Public IPv4 address like ```1.1.141.202``` or an IPv6 address like ```2000:2c43:c74c:3f98:7f3c:d268:c08f:30e0```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```af:1e:91:21:25:ac```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://kozey-kertzmann.name you initially access a DNS server to translate the host portion (kozey-kertzmann) combined with the Top Level Domain (name) of the URL, to an IP address like ```58.58.75.179```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows; U; Win 9x 4.90; SG; rv:1.9.2.4) Gecko/20101104 Netscape/9.1.0285```

## Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```10.246.93.214``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  10.246.93.214    UGScg  en0
...
<pre>
default   fe80:11bf:57a3:4a3e:523d%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {63.24.98.251, 115.54.9.143}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr af:1e:91:21:25:ac
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 2f:b3:09:c6:ba:41
}</pre>
