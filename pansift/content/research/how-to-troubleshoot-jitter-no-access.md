...
subtitle: "Ideate?"
layout: research
ip_v4_address: "105.120.53.79"
date: 2022-06-12T14:09:26+01:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like ```105.120.53.79``` or an IPv6 address like ```2000:bdad:f924:8dd0:8b:b8fe:aacf:4214```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```4a:c7:41:07:7c:85```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://greenholt-williamson.com you initially access a DNS server to translate the host portion (greenholt-williamson) combined with the Top Level Domain (com) of the URL, to an IP address like ```156.24.122.113```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1; WOW64; Trident/7.0; AS; rv:11.0) like Gecko```
...
<pre>
default   fe80:700d:ac3:d522:938d%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {183.237.163.200, 132.41.101.59}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 4a:c7:41:07:7c:85
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 66:f3:e3:61:ea:91
}</pre>
