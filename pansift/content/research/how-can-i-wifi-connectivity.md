...
subtitle: "Ideate?"
layout: research
ip_v4_address: "161.60.87.144"
date: 2022-11-02T11:32:23+00:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like ```161.60.87.144``` or an IPv6 address like ```2000:9f2c:b0a4:3b3d:7ee:e569:532b:c900```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```59:0d:e0:35:fc:16```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://romaguera.org you initially access a DNS server to translate the host portion (romaguera) combined with the Top Level Domain (org) of the URL, to an IP address like ```180.127.3.53```. Your computer and browser actually sends its type with all web requests e.g. <br>```Opera/9.80 (X11; Linux i686; Ubuntu/14.10) Presto/2.12.388 Version/12.16```

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```10.237.152.91``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  10.237.152.91    UGScg  en0
...
<pre>
default   fe80:5ab5:b590:a2cb:492d%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {95.122.121.14, 50.244.141.70}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 59:0d:e0:35:fc:16
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 36:83:50:33:3b:96
}</pre>
