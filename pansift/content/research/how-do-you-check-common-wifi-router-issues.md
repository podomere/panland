...
subtitle: "Swim Lane?"
layout: research
ip_v4_address: "46.4.89.15"
date: 2022-06-12T14:09:05+01:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like ```46.4.89.15``` or an IPv6 address like ```2000:14b2:53d:1d81:e6f4:963a:146b:4768```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```05:0a:28:85:35:03```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://kerluke-gibson.biz you initially access a DNS server to translate the host portion (kerluke-gibson) combined with the Top Level Domain (biz) of the URL, to an IP address like ```29.217.1.20```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/41.0.2228.0 Safari/537.36```
...
<pre>
default   84:b88d:358b:581a:bd8e:159c:841b:fb11%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {7.180.196.71, 235.210.92.109}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 05:0a:28:85:35:03
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr ac:fc:b0:79:b7:70
}</pre>
