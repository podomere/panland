...
layout: research
ip_v4_address: "93.230.182.84"
date: 2022-04-24T18:59:57+01:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like <code>93.230.182.84</code> or an IPv6 address like <code>2000:29fe:351:4137:ae0f:da3c:89bd:bc7d</code>. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>c0:bd:39:b1:eb:25</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://mann.net you initially access a DNS server to translate the host portion (mann) combined with the Top Level Domain (net) of the URL, to an IP address like <code>149.224.37.186</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (Windows; U; Win 9x 4.90; SG; rv:1.9.2.4) Gecko/20101104 Netscape/9.1.0285</code>
...
<pre><code>
default   fe80:667:a4ac:d268:c3b8%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {247.47.233.96, 152.179.124.159}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr c0:bd:39:b1:eb:25
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 79:28:42:57:43:a9
}</code></pre>
