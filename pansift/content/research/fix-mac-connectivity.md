...
layout: research
ip_v4_address: "235.173.62.51"
date: 2023-10-06T17:10:43+01:00
draft: false
---

## Internet Addressing
On the Internet you may have a Public IPv4 address like ```235.173.62.51``` or an IPv6 address like ```2000:81d0:b89c:b7f2:f54c:ad6e:2218:339```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```1e:31:f6:35:1b:6a```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://mosciski.org you initially access a DNS server to translate the host portion (mosciski) combined with the Top Level Domain (org) of the URL, to an IP address like ```170.84.129.43```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/41.0.2228.0 Safari/537.36```

## Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```172.26.249.22``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  172.26.249.22    UGScg  en0
...
<pre>
default   fe80:cca7:9946:4d3f:d04c%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {52.64.157.65, 195.187.210.56}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 1e:31:f6:35:1b:6a
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 76:aa:86:04:e5:9d
}</pre>
