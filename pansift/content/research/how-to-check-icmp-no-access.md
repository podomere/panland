...
layout: research
ip_v4_address: "144.199.127.115"
date: 2022-06-04T14:38:41+01:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like ```144.199.127.115``` or an IPv6 address like ```2000:d470:c7fe:511b:b0e8:f09d:90b9:a58e```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```d2:7a:72:cb:69:fc```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://weber.com you initially access a DNS server to translate the host portion (weber) combined with the Top Level Domain (com) of the URL, to an IP address like ```232.225.41.98```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_3) AppleWebKit/537.75.14 (KHTML, like Gecko) Version/7.0.3 Safari/7046A194A```

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```192.168.246.181``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  192.168.246.181    UGScg  en0
...
<pre>
default   fe80:2716:320e:325b:be58%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {252.104.96.87, 140.232.14.190}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr d2:7a:72:cb:69:fc
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 65:7d:7f:e0:d0:31
}</pre>
