...
subtitle: "Streamline?"
layout: research
ip_v4_address: "248.173.57.173"
date: 2022-11-19T16:17:21+00:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like ```248.173.57.173``` or an IPv6 address like ```2000:859:4de6:b3da:3c90:1033:7ab4:574c```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```57:b6:39:02:15:8a```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://oconner-pouros.co you initially access a DNS server to translate the host portion (oconner-pouros) combined with the Top Level Domain (co) of the URL, to an IP address like ```146.83.180.60```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_3) AppleWebKit/537.75.14 (KHTML, like Gecko) Version/7.0.3 Safari/7046A194A```
...
<pre>
default   fe80:aab:7e5a:f9d8:dd1f%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {55.83.21.62, 241.243.253.23}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 57:b6:39:02:15:8a
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 3c:d5:43:4e:3b:5e
}</pre>
