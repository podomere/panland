...
subtitle: "Etc. Etc.?"
layout: research
ip_v4_address: "6.10.210.63"
date: 2022-04-24T18:59:58+01:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like <code>6.10.210.63</code> or an IPv6 address like <code>2000:8e96:29dd:f293:c4d:f03f:cb2f:56c7</code>. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>69:bd:2f:e5:1c:ba</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://corwin-predovic.co you initially access a DNS server to translate the host portion (corwin-predovic) combined with the Top Level Domain (co) of the URL, to an IP address like <code>230.47.131.43</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (Windows NT 6.1; WOW64; Trident/7.0; AS; rv:11.0) like Gecko</code>
...
<pre><code>
default   fe80:7b3b:c5ba:1eb4:6ee7%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {185.38.61.182, 59.117.108.197}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 69:bd:2f:e5:1c:ba
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 7e:db:0e:c4:db:51
}</code></pre>
