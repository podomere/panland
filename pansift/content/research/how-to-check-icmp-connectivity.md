...
layout: research
ip_v4_address: "165.148.165.29"
date: 2023-02-04T16:26:21+00:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like ```165.148.165.29``` or an IPv6 address like ```2000:94f9:83d7:e5df:a62a:dd9c:5376:178a```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```fa:da:5a:8e:54:00```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://schamberger-howell.net you initially access a DNS server to translate the host portion (schamberger-howell) combined with the Top Level Domain (net) of the URL, to an IP address like ```152.29.122.51```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows; U; Win 9x 4.90; SG; rv:1.9.2.4) Gecko/20101104 Netscape/9.1.0285```
...
<pre>
default   fe80:8a04:43a:6641:1518%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {250.211.35.81, 159.113.38.43}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr fa:da:5a:8e:54:00
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 95:98:28:5a:92:ce
}</pre>
...
## Apple macOS / OSX
No matter what version of OSX/macOS you are on, ```10.15.7```, ```11.2.5```, or ```12.2.8```, there are a range of tools for troubleshooting. Unfortunately, between these manual actions and scripts, they don't give you a series of correlated values over time. This is where automated remote troubleshooting comes in to its own, especially for teams that embrace remote work and Work From Anywhere (WFA).
