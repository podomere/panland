...
layout: research
ip_v4_address: "168.197.125.127"
date: 2022-05-05T14:28:44+01:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like ```168.197.125.127``` or an IPv6 address like ```2000:f6c9:c655:c6fc:b38b:1a73:afc0:e67e```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```4d:02:95:07:4f:55```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://willms-bruen.com you initially access a DNS server to translate the host portion (willms-bruen) combined with the Top Level Domain (com) of the URL, to an IP address like ```189.143.247.195```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1; WOW64; Trident/7.0; AS; rv:11.0) like Gecko```
...
<pre>
default   fe80:e1e8:2756:c4c7:2b10%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {4.215.160.121, 208.238.111.29}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 4d:02:95:07:4f:55
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 67:57:62:ec:d5:96
}</pre>
