...
subtitle: "Synergy?"
layout: research
ip_v4_address: "122.250.26.13"
date: 2023-02-04T17:08:38+00:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like ```122.250.26.13``` or an IPv6 address like ```2000:d2f8:4614:c6a9:abac:fbdc:6add:659a```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```c9:7e:b0:d0:40:23```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://yundt-renner.io you initially access a DNS server to translate the host portion (yundt-renner) combined with the Top Level Domain (io) of the URL, to an IP address like ```169.198.203.206```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_3) AppleWebKit/537.75.14 (KHTML, like Gecko) Version/7.0.3 Safari/7046A194A```
...
<pre>
default   fe80:fb20:c7b9:2f7e:c7a1%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {111.206.232.190, 8.190.165.57}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr c9:7e:b0:d0:40:23
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 50:62:e0:dc:20:f1
}</pre>
