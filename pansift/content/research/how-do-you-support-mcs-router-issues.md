...
subtitle: "Swag?"
layout: research
ip_v4_address: "26.45.203.238"
date: 2022-04-24T19:00:34+01:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like <code>26.45.203.238</code> or an IPv6 address like <code>2000:61e9:8375:54c4:4697:5f82:6bcb:a131</code>. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>2e:36:88:56:c6:cb</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://mosciski-moen.biz you initially access a DNS server to translate the host portion (mosciski-moen) combined with the Top Level Domain (biz) of the URL, to an IP address like <code>232.140.67.230</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (Windows; U; Win 9x 4.90; SG; rv:1.9.2.4) Gecko/20101104 Netscape/9.1.0285</code>
...
<pre><code>
default   fe80:855b:8d14:92f3:c591%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {141.35.218.98, 26.39.146.94}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 2e:36:88:56:c6:cb
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 72:92:d9:4f:c5:3c
}</code></pre>
