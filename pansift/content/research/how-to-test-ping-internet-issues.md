...
subtitle: "Synergy?"
layout: research
ip_v4_address: "89.161.209.96"
date: 2022-11-19T19:13:27+00:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like ```89.161.209.96``` or an IPv6 address like ```2000:6bae:7c6f:26e5:6e6b:3ec8:4f3a:7f50```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```5b:b8:15:68:52:f7```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://glover.net you initially access a DNS server to translate the host portion (glover) combined with the Top Level Domain (net) of the URL, to an IP address like ```7.95.154.1```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/41.0.2228.0 Safari/537.36```
...
<pre>
default   fe80:256f:733e:a8dd:4638%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {113.173.248.32, 84.37.22.166}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 5b:b8:15:68:52:f7
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr b7:59:9d:af:54:e8
}</pre>
