...
layout: research
ip_v4_address: "154.182.85.82"
date: 2022-11-02T11:32:53+00:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like ```154.182.85.82``` or an IPv6 address like ```2000:9730:1c3:a747:578b:fe4b:320d:7767```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```26:e2:4c:69:5b:0a```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://orn-erdman.io you initially access a DNS server to translate the host portion (orn-erdman) combined with the Top Level Domain (io) of the URL, to an IP address like ```27.101.116.71```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/41.0.2228.0 Safari/537.36```
...
<pre>
default   fe80:215e:ffac:2d49:6a44%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {16.85.126.188, 79.226.38.238}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 26:e2:4c:69:5b:0a
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 7e:79:db:44:5b:06
}</pre>
