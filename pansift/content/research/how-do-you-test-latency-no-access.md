...
subtitle: "Deep Dive?"
layout: research
ip_v4_address: "75.97.35.110"
date: 2023-02-04T17:08:37+00:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like ```75.97.35.110``` or an IPv6 address like ```2000:9553:6609:e02a:c9d4:6136:ee20:fb19```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```aa:8a:69:cb:8a:19```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://spencer.biz you initially access a DNS server to translate the host portion (spencer) combined with the Top Level Domain (biz) of the URL, to an IP address like ```205.140.209.178```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_3) AppleWebKit/537.75.14 (KHTML, like Gecko) Version/7.0.3 Safari/7046A194A```
...
<pre>
default   fe80:e4f5:c9f:9b21:41d2%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {65.108.249.221, 105.131.81.22}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr aa:8a:69:cb:8a:19
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 41:2b:da:6d:82:ea
}</pre>
