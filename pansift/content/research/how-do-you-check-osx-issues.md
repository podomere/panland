...
layout: research
ip_v4_address: "219.125.157.157"
date: 2022-04-24T18:31:58+01:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like <code>219.125.157.157</code> or an IPv6 address like <code>2000:5706:71db:f850:68af:9e98:e124:e4c</code>. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>0f:a9:8f:84:b6:aa</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://rippin-lubowitz.com you initially access a DNS server to translate the host portion (rippin-lubowitz) combined with the Top Level Domain (com) of the URL, to an IP address like <code>111.149.241.128</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (Windows NT 6.1; WOW64; Trident/7.0; AS; rv:11.0) like Gecko</code>
...
<pre><code>
default   fe80:4eb0:e933:e78e:8730%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {197.180.238.155, 52.149.223.103}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 0f:a9:8f:84:b6:aa
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr c9:3f:17:d2:fa:b5
}</code></pre>
