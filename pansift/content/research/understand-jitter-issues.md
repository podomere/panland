...
layout: research
ip_v4_address: "147.29.22.82"
date: 2022-11-19T16:17:22+00:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like ```147.29.22.82``` or an IPv6 address like ```2000:5b5f:94fe:a96a:636d:64f9:21e3:5448```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```9a:f4:53:a7:17:59```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://feil-haley.io you initially access a DNS server to translate the host portion (feil-haley) combined with the Top Level Domain (io) of the URL, to an IP address like ```42.177.250.197```. Your computer and browser actually sends its type with all web requests e.g. <br>```Opera/9.80 (X11; Linux i686; Ubuntu/14.10) Presto/2.12.388 Version/12.16```
...
<pre>
default   fe80:8034:2285:a65f:7f0%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {32.225.83.62, 166.118.135.177}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 9a:f4:53:a7:17:59
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 99:95:8b:34:63:4e
}</pre>
