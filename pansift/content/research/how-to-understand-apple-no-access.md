...
layout: research
ip_v4_address: "109.16.177.116"
date: 2022-04-24T18:31:58+01:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like <code>109.16.177.116</code> or an IPv6 address like <code>2000:c2bd:effc:9d6c:4083:1290:21f4:e2f6</code>. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>60:31:41:4e:09:ae</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://bailey-harris.biz you initially access a DNS server to translate the host portion (bailey-harris) combined with the Top Level Domain (biz) of the URL, to an IP address like <code>9.106.110.7</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (compatible; MSIE 9.0; AOL 9.7; AOLBuild 4343.19; Windows NT 6.1; WOW64; Trident/5.0; FunWebProducts)</code>
...
<pre><code>
default   fe80:ad98:2b80:ec4d:29db%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {227.120.147.33, 201.26.192.101}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 60:31:41:4e:09:ae
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 77:85:63:34:31:3a
}</code></pre>
