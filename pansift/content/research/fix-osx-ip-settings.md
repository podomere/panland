...
subtitle: "Streamline?"
layout: research
ip_v4_address: "222.222.119.113"
date: 2022-04-24T19:00:24+01:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like <code>222.222.119.113</code> or an IPv6 address like <code>2000:2963:557b:b59f:6345:9163:6c4f:6f44</code>. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>2f:75:d7:1f:03:70</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://schmidt-barrows.info you initially access a DNS server to translate the host portion (schmidt-barrows) combined with the Top Level Domain (info) of the URL, to an IP address like <code>181.44.11.91</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (Windows NT 6.1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/41.0.2228.0 Safari/537.36</code>
...
<pre><code>
default   fe80:8d30:2901:8419:15fb%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {23.36.188.163, 67.162.117.37}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 2f:75:d7:1f:03:70
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr f0:98:ae:09:71:e0
}</code></pre>
