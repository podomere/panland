...
subtitle: "Streamline?"
layout: research
ip_v4_address: "87.97.49.57"
date: 2023-10-29T15:13:26+00:00
draft: false
---

## Internet Addressing
On the Internet you might have a Public IPv4 address like ```87.97.49.57``` or an IPv6 address like ```2000:9b6f:2c25:a94c:dcfc:f1ba:fb34:c1f2```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```4c:18:e6:25:ed:c8```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://marquardt-howe.info you initially access a DNS server to translate the host portion (marquardt-howe) combined with the Top Level Domain (info) of the URL, to an IP address like ```109.124.150.98```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_3) AppleWebKit/537.75.14 (KHTML, like Gecko) Version/7.0.3 Safari/7046A194A```
...
<pre>
default   fe80:f97e:3e7a:b8b1:909c%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {179.72.223.247, 121.127.46.60}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 4c:18:e6:25:ed:c8
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 42:62:b2:57:b3:54
}</pre>
