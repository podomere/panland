...
layout: research
ip_v4_address: "58.245.51.197"
date: 2022-04-24T18:31:57+01:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like <code>58.245.51.197</code> or an IPv6 address like <code>2000:4570:18e9:98d3:193a:ec89:58d8:6e6b</code>. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>00:3d:5f:ab:9f:38</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://crooks-swift.biz you initially access a DNS server to translate the host portion (crooks-swift) combined with the Top Level Domain (biz) of the URL, to an IP address like <code>247.211.38.2</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (Windows NT x.y; Win64; x64; rv:10.0) Gecko/20100101 Firefox/10.0</code>
...
<pre><code>
default   fe80:e94f:a389:1f29:264d%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {208.4.226.77, 57.124.93.215}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 00:3d:5f:ab:9f:38
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 68:a3:d6:e7:da:14
}</code></pre>
