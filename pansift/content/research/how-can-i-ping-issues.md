...
layout: research
ip_v4_address: "70.27.168.77"
date: 2022-11-19T16:17:23+00:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like ```70.27.168.77``` or an IPv6 address like ```2000:1e05:331:4246:2560:70c1:3882:9566```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```01:35:ec:9e:b4:5b```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://bosco-mraz.co you initially access a DNS server to translate the host portion (bosco-mraz) combined with the Top Level Domain (co) of the URL, to an IP address like ```149.137.159.171```. Your computer and browser actually sends its type with all web requests e.g. <br>```Opera/9.80 (X11; Linux i686; Ubuntu/14.10) Presto/2.12.388 Version/12.16```
...
<pre>
default   fe80:5440:ccf7:a65f:ebec%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {186.217.88.29, 231.90.75.152}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 01:35:ec:9e:b4:5b
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 57:63:6e:89:0b:5b
}</pre>
