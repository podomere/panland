...
layout: research
ip_v4_address: "59.54.193.176"
date: 2022-11-02T11:32:58+00:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like ```59.54.193.176``` or an IPv6 address like ```2000:d8e9:2318:1e2f:74f6:4fbc:80db:ba51```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```1a:41:a3:ea:74:90```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://mitchell.io you initially access a DNS server to translate the host portion (mitchell) combined with the Top Level Domain (io) of the URL, to an IP address like ```222.149.130.142```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1; WOW64; Trident/7.0; AS; rv:11.0) like Gecko```

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```172.24.95.124``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  172.24.95.124    UGScg  en0
...
<pre>
default   fe80:b13:2e34:7448:a684%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {36.215.35.242, 127.230.136.153}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 1a:41:a3:ea:74:90
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 45:ab:28:d1:d5:4b
}</pre>
...
## Apple macOS / OSX
No matter what version of OSX/macOS you are on, ```10.14.3```, ```11.6.5```, or ```12.2.6```, there are a range of tools for troubleshooting. Unfortunately, between these manual actions and scripts, they don't give you a series of correlated values over time. This is where automated remote troubleshooting comes in to its own, especially for teams that embrace remote work and Work From Anywhere (WFA).
