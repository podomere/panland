...
layout: research
ip_v4_address: "197.228.112.43"
date: 2022-11-19T16:17:24+00:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like ```197.228.112.43``` or an IPv6 address like ```2000:f60f:8e43:bf39:4a71:f1f3:258b:71af```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```36:28:86:58:eb:f7```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://powlowski-heidenreich.name you initially access a DNS server to translate the host portion (powlowski-heidenreich) combined with the Top Level Domain (name) of the URL, to an IP address like ```139.254.250.124```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows; U; Win 9x 4.90; SG; rv:1.9.2.4) Gecko/20101104 Netscape/9.1.0285```

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```172.16.107.168``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  172.16.107.168    UGScg  en0
...
<pre>
default   fe80:b7aa:a5f:ca41:c9e8%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {141.27.4.20, 120.128.155.222}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 36:28:86:58:eb:f7
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 6d:9e:29:d1:67:1f
}</pre>
