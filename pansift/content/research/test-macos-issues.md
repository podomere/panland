...
layout: research
ip_v4_address: "5.144.238.54"
date: 2022-06-04T14:38:27+01:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like ```5.144.238.54``` or an IPv6 address like ```2000:b72a:6fb4:4544:4dae:a96f:3414:f6b0```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```ee:0e:55:48:83:14```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://runte-beatty.com you initially access a DNS server to translate the host portion (runte-beatty) combined with the Top Level Domain (com) of the URL, to an IP address like ```179.169.143.115```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1; WOW64; Trident/7.0; AS; rv:11.0) like Gecko```
...
<pre>
default   fe80:8d5d:e48e:2efc:c04a%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {240.195.180.93, 88.203.52.174}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr ee:0e:55:48:83:14
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr df:ec:b7:74:17:c5
}</pre>
