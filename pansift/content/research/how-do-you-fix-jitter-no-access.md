...
layout: research
ip_v4_address: "25.80.7.5"
date: 2022-11-19T16:17:22+00:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like ```25.80.7.5``` or an IPv6 address like ```2000:38f1:45e6:f55:f580:91d8:64eb:5359```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```3f:e5:be:55:ea:94```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://kozey-roob.info you initially access a DNS server to translate the host portion (kozey-roob) combined with the Top Level Domain (info) of the URL, to an IP address like ```85.60.106.157```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT x.y; Win64; x64; rv:10.0) Gecko/20100101 Firefox/10.0```
...
<pre>
default   fe80:c9f0:2efc:79f7:8289%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {39.161.185.122, 208.183.5.230}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 3f:e5:be:55:ea:94
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 6e:3a:f7:78:09:fc
}</pre>
