...
layout: research
ip_v4_address: "60.49.191.83"
date: 2023-10-06T17:10:43+01:00
draft: false
---

## Internet Addressing
On the Internet you may get a Public IPv4 address like ```60.49.191.83``` or an IPv6 address like ```2000:1ba9:951:8d93:262a:400b:2c63:7a93```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```b6:b1:e4:ab:0c:48```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://mertz-becker.info you initially access a DNS server to translate the host portion (mertz-becker) combined with the Top Level Domain (info) of the URL, to an IP address like ```110.119.154.152```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT x.y; Win64; x64; rv:10.0) Gecko/20100101 Firefox/10.0```

## Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```172.17.9.76``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
<pre>
default   fe80:9bab:9b2e:149:cfea%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {63.227.100.191, 237.148.177.193}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr b6:b1:e4:ab:0c:48
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr d1:5d:4f:12:0b:85
}</pre>
...
### Apple macOS / OSX
No matter what version of OSX/macOS you are on, ```10.11.6```, ```11.6.8```, or ```12.2.3```, there are a range of tools for troubleshooting. Unfortunately, between these manual actions and scripts, they don't give you a series of correlated values over time. This is where automated remote troubleshooting comes in to its own, especially for teams that embrace remote work and Work From Anywhere (WFA).
