...
layout: research
ip_v4_address: "117.246.0.18"
date: 2022-04-24T19:00:02+01:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like <code>117.246.0.18</code> or an IPv6 address like <code>2000:4737:c506:7233:15fa:748a:180b:6410</code>. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>80:22:21:e9:92:51</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://predovic-rogahn.co you initially access a DNS server to translate the host portion (predovic-rogahn) combined with the Top Level Domain (co) of the URL, to an IP address like <code>168.7.230.202</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (Windows NT 6.1; WOW64; Trident/7.0; AS; rv:11.0) like Gecko</code>
...
<pre><code>
default   fe80:638e:fbbf:8712:e412%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {190.44.68.178, 104.13.81.120}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 80:22:21:e9:92:51
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr f1:1d:fa:61:f0:22
}</code></pre>
