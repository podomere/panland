...
layout: research
ip_v4_address: "228.230.188.38"
date: 2022-06-04T14:38:28+01:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like ```228.230.188.38``` or an IPv6 address like ```2000:5625:47aa:191c:dcb6:4c51:40ae:8c47```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```33:aa:3b:c4:5b:00```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://ferry-leffler.io you initially access a DNS server to translate the host portion (ferry-leffler) combined with the Top Level Domain (io) of the URL, to an IP address like ```188.179.217.174```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows; U; Win 9x 4.90; SG; rv:1.9.2.4) Gecko/20101104 Netscape/9.1.0285```
...
<pre>
default   fe80:21af:208c:2429:927d%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {241.154.201.88, 251.155.119.38}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 33:aa:3b:c4:5b:00
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr b1:40:38:00:dc:14
}</pre>
