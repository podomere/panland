...
layout: research
ip_v4_address: "140.177.173.62"
date: 2023-10-29T15:13:18+00:00
draft: false
---

## Internet Addressing
On the Internet you may have a Public IPv4 address like ```140.177.173.62``` or an IPv6 address like ```2000:e012:b137:ceeb:f018:3df1:f956:7827```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```1f:7b:a4:d7:be:13```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://cronin-hyatt.biz you initially access a DNS server to translate the host portion (cronin-hyatt) combined with the Top Level Domain (biz) of the URL, to an IP address like ```62.233.110.58```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1; WOW64; Trident/7.0; AS; rv:11.0) like Gecko```
...
<pre>
default   fe80:5aef:a0e3:2dc4:30e9%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {89.29.35.78, 152.61.58.103}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 1f:7b:a4:d7:be:13
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 65:66:c1:dc:cd:f6
}</pre>
