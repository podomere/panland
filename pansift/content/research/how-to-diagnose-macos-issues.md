...
layout: research
ip_v4_address: "11.92.71.63"
date: 2022-05-05T14:28:44+01:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like ```11.92.71.63``` or an IPv6 address like ```2000:11ed:3198:4ca0:9d96:f262:e785:30fe```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```d1:7a:cd:48:e6:9a```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://toy.name you initially access a DNS server to translate the host portion (toy) combined with the Top Level Domain (name) of the URL, to an IP address like ```225.0.222.86```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_3) AppleWebKit/537.75.14 (KHTML, like Gecko) Version/7.0.3 Safari/7046A194A```
...
<pre>
default   fe80:c2f9:155e:4541:9300%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {170.54.132.18, 93.225.150.155}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr d1:7a:cd:48:e6:9a
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 05:0a:25:b9:fc:54
}</pre>
