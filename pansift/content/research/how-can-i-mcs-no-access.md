...
layout: research
ip_v4_address: "226.98.130.164"
date: 2022-12-15T13:50:04+00:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like ```226.98.130.164``` or an IPv6 address like ```2000:9180:e1e9:be44:d089:bc5f:847f:5add```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```83:03:e5:e1:2b:30```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://olson.com you initially access a DNS server to translate the host portion (olson) combined with the Top Level Domain (com) of the URL, to an IP address like ```24.127.26.54```. Your computer and browser actually sends its type with all web requests e.g. <br>```Opera/9.80 (X11; Linux i686; Ubuntu/14.10) Presto/2.12.388 Version/12.16```
...
<pre>
default   fe80:ecd7:e031:4b08:4c24%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {85.228.74.64, 173.80.15.236}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 83:03:e5:e1:2b:30
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr c9:d6:b7:3d:61:c1
}</pre>
