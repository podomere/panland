...
subtitle: "Etc. Etc.?"
layout: research
ip_v4_address: "48.80.82.151"
date: 2022-06-12T14:09:05+01:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like ```48.80.82.151``` or an IPv6 address like ```2000:9805:9c9a:119a:a94a:c1f5:fb14:575c```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```56:34:d1:c9:48:59```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://gleason-schamberger.name you initially access a DNS server to translate the host portion (gleason-schamberger) combined with the Top Level Domain (name) of the URL, to an IP address like ```251.28.143.193```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows; U; Win 9x 4.90; SG; rv:1.9.2.4) Gecko/20101104 Netscape/9.1.0285```

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```172.25.70.85``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  172.25.70.85    UGScg  en0
...
<pre>
default   fe80:e1b9:9f43:5c41:7e2%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {199.0.88.234, 131.109.122.184}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 56:34:d1:c9:48:59
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 11:cd:0f:d2:f8:82
}</pre>
