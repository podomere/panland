...
layout: research
ip_v4_address: "203.69.214.9"
date: 2022-11-19T19:13:29+00:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like ```203.69.214.9``` or an IPv6 address like ```2000:69ab:56bc:b621:9801:bcec:7ae5:f524```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```c4:b8:aa:6f:a4:17```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://armstrong-mills.io you initially access a DNS server to translate the host portion (armstrong-mills) combined with the Top Level Domain (io) of the URL, to an IP address like ```140.207.85.216```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1; WOW64; Trident/7.0; AS; rv:11.0) like Gecko```
...
<pre>
default   fe80:7886:8941:d8db:7ccf%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {233.141.243.42, 14.2.131.134}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr c4:b8:aa:6f:a4:17
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr ec:d1:8d:0f:cf:ed
}</pre>
