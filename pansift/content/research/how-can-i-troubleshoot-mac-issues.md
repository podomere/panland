...
layout: research
ip_v4_address: "162.204.13.162"
date: 2022-04-24T18:31:59+01:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like <code>162.204.13.162</code> or an IPv6 address like <code>2000:6eb1:2a34:8938:344d:4f2:c395:1886</code>. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>70:d8:2a:6c:64:e8</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://deckow-gibson.name you initially access a DNS server to translate the host portion (deckow-gibson) combined with the Top Level Domain (name) of the URL, to an IP address like <code>6.115.141.219</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (Windows; U; Win 9x 4.90; SG; rv:1.9.2.4) Gecko/20101104 Netscape/9.1.0285</code>

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like <code>172.28.191.220</code> (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For <code>IPv6</code> we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  172.28.191.220    UGScg  en0
...
<pre><code>
default   fe80:3d0e:cccc:f29c:7a02%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {254.113.138.234, 42.122.43.32}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 70:d8:2a:6c:64:e8
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr fe:34:04:97:9a:e7
}</code></pre>
