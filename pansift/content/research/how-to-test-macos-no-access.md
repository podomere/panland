...
layout: research
ip_v4_address: "223.173.15.99"
date: 2022-04-24T19:00:23+01:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like <code>223.173.15.99</code> or an IPv6 address like <code>2000:1c3:a317:ec09:dddb:db62:4085:211d</code>. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>c1:cc:f2:c3:c5:e7</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://pfeffer.name you initially access a DNS server to translate the host portion (pfeffer) combined with the Top Level Domain (name) of the URL, to an IP address like <code>108.230.6.45</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (Windows NT x.y; Win64; x64; rv:10.0) Gecko/20100101 Firefox/10.0</code>
...
<pre><code>
default   fe80:b3d8:c508:2c1c:bec2%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {116.60.146.37, 103.102.252.181}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr c1:cc:f2:c3:c5:e7
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr a8:43:a5:fb:e7:97
}</code></pre>
