...
layout: research
ip_v4_address: "155.87.230.119"
date: 2022-04-24T19:00:05+01:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like <code>155.87.230.119</code> or an IPv6 address like <code>2000:c364:9128:c844:dce1:b16a:fdf1:9557</code>. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>4f:14:de:5c:05:e4</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://gislason-quitzon.co you initially access a DNS server to translate the host portion (gislason-quitzon) combined with the Top Level Domain (co) of the URL, to an IP address like <code>113.59.112.99</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (compatible; MSIE 9.0; AOL 9.7; AOLBuild 4343.19; Windows NT 6.1; WOW64; Trident/5.0; FunWebProducts)</code>
...
<pre><code>
default   fe80:978b:9519:91f6:de10%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {53.18.201.40, 247.81.97.237}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 4f:14:de:5c:05:e4
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr dd:9e:49:fc:fb:e5
}</code></pre>
