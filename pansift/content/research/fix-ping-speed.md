...
subtitle: "Impact Map?"
layout: research
ip_v4_address: "187.251.78.100"
date: 2022-11-02T11:32:59+00:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like ```187.251.78.100``` or an IPv6 address like ```2000:2583:7db8:c792:c9e5:ac18:24aa:a9b4```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```52:8f:2a:3a:cb:a2```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://rowe-schultz.org you initially access a DNS server to translate the host portion (rowe-schultz) combined with the Top Level Domain (org) of the URL, to an IP address like ```223.177.107.133```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (compatible; MSIE 9.0; AOL 9.7; AOLBuild 4343.19; Windows NT 6.1; WOW64; Trident/5.0; FunWebProducts)```
...
<pre>
default   fe80:658f:cfcc:cad0:f44c%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {76.251.56.150, 218.71.136.238}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 52:8f:2a:3a:cb:a2
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 21:7d:26:c6:00:bf
}</pre>
