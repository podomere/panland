...
subtitle: "Swag?"
layout: research
ip_v4_address: "33.8.49.118"
date: 2023-10-06T17:11:05+01:00
draft: false
---

## Internet Addressing
On the Internet you may get a Public IPv4 address like ```33.8.49.118``` or an IPv6 address like ```2000:986a:1862:9717:6763:782c:122b:da7```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```66:a8:35:08:25:08```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://schmeler-schmeler.org you initially access a DNS server to translate the host portion (schmeler-schmeler) combined with the Top Level Domain (org) of the URL, to an IP address like ```219.135.98.42```. Your computer and browser actually sends its type with all web requests e.g. <br>```Opera/9.80 (X11; Linux i686; Ubuntu/14.10) Presto/2.12.388 Version/12.16```
...
<pre>
default   fe80:7108:9179:7054:c7f9%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {180.171.185.225, 54.251.244.17}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 66:a8:35:08:25:08
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr a5:d0:52:7b:17:db
}</pre>
