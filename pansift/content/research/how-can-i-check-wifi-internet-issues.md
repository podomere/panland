...
subtitle: "Value Add?"
layout: research
ip_v4_address: "178.136.245.142"
date: 2022-12-15T13:50:03+00:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like ```178.136.245.142``` or an IPv6 address like ```2000:7cf9:1a71:1fe3:d95b:1ffe:7ff3:b8c5```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```c7:3e:4f:85:3d:2a```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://hermiston-bergstrom.name you initially access a DNS server to translate the host portion (hermiston-bergstrom) combined with the Top Level Domain (name) of the URL, to an IP address like ```166.84.189.78```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows; U; Win 9x 4.90; SG; rv:1.9.2.4) Gecko/20101104 Netscape/9.1.0285```

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```10.124.142.53``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  10.124.142.53    UGScg  en0
...
<pre>
default   fe80:6f00:6d36:96aa:a10e%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {183.139.126.190, 173.226.153.84}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr c7:3e:4f:85:3d:2a
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 2c:dc:f8:0b:8e:84
}</pre>
