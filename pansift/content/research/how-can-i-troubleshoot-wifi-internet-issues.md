...
subtitle: "Swag?"
layout: research
ip_v4_address: "251.130.112.21"
date: 2022-04-24T18:32:41+01:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like <code>251.130.112.21</code> or an IPv6 address like <code>2000:9f6d:75a8:29d2:6522:d9ef:1436:d121</code>. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>45:d5:c1:1a:d4:8b</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://greenfelder.io you initially access a DNS server to translate the host portion (greenfelder) combined with the Top Level Domain (io) of the URL, to an IP address like <code>138.85.109.250</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Opera/9.80 (X11; Linux i686; Ubuntu/14.10) Presto/2.12.388 Version/12.16</code>

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like <code>192.168.254.46</code> (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For <code>IPv6</code> we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  192.168.254.46    UGScg  en0
...
<pre><code>
default   fe80:b0fd:a85b:1142:7afc%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {128.172.240.186, 230.107.165.179}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 45:d5:c1:1a:d4:8b
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr d2:a8:e0:54:69:40
}</code></pre>
