...
layout: research
ip_v4_address: "167.74.22.92"
date: 2022-04-24T19:00:01+01:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like <code>167.74.22.92</code> or an IPv6 address like <code>2000:7700:be02:6ccc:75dd:a1b:a435:fc11</code>. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>8c:31:f2:41:47:77</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://barrows-dietrich.net you initially access a DNS server to translate the host portion (barrows-dietrich) combined with the Top Level Domain (net) of the URL, to an IP address like <code>217.18.53.59</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (Windows NT x.y; Win64; x64; rv:10.0) Gecko/20100101 Firefox/10.0</code>
...
<pre><code>
default   fe80:5cab:abc8:da1d:dab0%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {225.188.123.248, 225.130.182.157}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 8c:31:f2:41:47:77
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 3d:b6:1a:48:d4:75
}</code></pre>
