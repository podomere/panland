...
subtitle: "Value Add?"
layout: research
ip_v4_address: "33.8.187.219"
date: 2022-11-19T19:13:28+00:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like ```33.8.187.219``` or an IPv6 address like ```2000:1130:7b5a:8638:2dc6:fbab:35b3:723e```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```86:6e:ed:0f:0e:fe```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://muller-king.info you initially access a DNS server to translate the host portion (muller-king) combined with the Top Level Domain (info) of the URL, to an IP address like ```1.21.120.89```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows; U; Win 9x 4.90; SG; rv:1.9.2.4) Gecko/20101104 Netscape/9.1.0285```
...
<pre>
default   fe80:6fb7:d899:dd20:2511%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {215.223.86.161, 128.156.212.53}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 86:6e:ed:0f:0e:fe
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr a8:96:24:2c:b2:d4
}</pre>
