...
layout: research
ip_v4_address: "116.212.176.47"
date: 2022-05-05T14:29:32+01:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like ```116.212.176.47``` or an IPv6 address like ```2000:1d40:fb36:a1df:4a0d:8b24:3cc4:8503```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```fc:8e:36:0c:51:c8```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://langosh.com you initially access a DNS server to translate the host portion (langosh) combined with the Top Level Domain (com) of the URL, to an IP address like ```142.91.143.248```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (compatible; MSIE 9.0; AOL 9.7; AOLBuild 4343.19; Windows NT 6.1; WOW64; Trident/5.0; FunWebProducts)```
...
<pre>
default   fe80:3870:9092:e321:7fbb%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {162.225.145.50, 148.90.48.105}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr fc:8e:36:0c:51:c8
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr ce:95:41:ea:cd:15
}</pre>
