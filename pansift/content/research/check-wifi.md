...
layout: research
ip_v4_address: "184.165.78.230"
date: 2022-04-24T19:00:32+01:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like <code>184.165.78.230</code> or an IPv6 address like <code>2000:1ef7:aae:d198:c1a9:ba8b:133d:5ff6</code>. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>e5:58:c4:26:9d:b7</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://tromp.net you initially access a DNS server to translate the host portion (tromp) combined with the Top Level Domain (net) of the URL, to an IP address like <code>177.250.71.224</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (Windows NT x.y; Win64; x64; rv:10.0) Gecko/20100101 Firefox/10.0</code>
...
default  172.30.89.252    UGScg  en0
...
<pre><code>
default   fe80:1a91:b788:6c32:1451%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {170.108.149.101, 240.7.13.132}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr e5:58:c4:26:9d:b7
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr f6:27:35:2a:54:d8
}</code></pre>
