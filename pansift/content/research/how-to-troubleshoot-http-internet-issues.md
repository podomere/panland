---
title: "How To Troubleshoot Http Internet Issues"
subtitle: "Thought Leadership?"
layout: research
ip_v4_address: "218.191.174.41"
date: 2022-11-19T16:17:24+00:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like ```218.191.174.41``` or an IPv6 address like ```2000:a974:31cf:f0a4:9e55:c4e0:95ce:4ac1```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```10:c2:db:85:e6:dd```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://kuvalis-pfeffer.name you initially access a DNS server to translate the host portion (kuvalis-pfeffer) combined with the Top Level Domain (name) of the URL, to an IP address like ```199.154.182.138```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT x.y; Win64; x64; rv:10.0) Gecko/20100101 Firefox/10.0```

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```192.168.39.177``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  192.168.39.177    UGScg  en0
...
<pre>
default   fe80:396:ef31:fbbb:3c8c%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {219.145.175.44, 41.9.97.142}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 10:c2:db:85:e6:dd
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 7c:58:2c:41:96:01
}</pre>
