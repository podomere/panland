...
layout: research
ip_v4_address: "71.224.212.141"
date: 2022-06-12T14:09:24+01:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like ```71.224.212.141``` or an IPv6 address like ```2000:cc0b:8d52:bfb:8c7f:581a:4562:6577```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```8b:90:1b:97:28:7c```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://wilderman-spencer.info you initially access a DNS server to translate the host portion (wilderman-spencer) combined with the Top Level Domain (info) of the URL, to an IP address like ```228.247.82.70```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (compatible; MSIE 9.0; AOL 9.7; AOLBuild 4343.19; Windows NT 6.1; WOW64; Trident/5.0; FunWebProducts)```
...
<pre>
default   fe80:5257:7575:d67c:9ba2%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {110.194.102.159, 238.84.240.12}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 8b:90:1b:97:28:7c
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr a5:63:44:ba:63:56
}</pre>
