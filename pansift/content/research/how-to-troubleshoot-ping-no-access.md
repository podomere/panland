...
layout: research
ip_v4_address: "1.51.114.93"
date: 2022-05-05T14:29:58+01:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like ```1.51.114.93``` or an IPv6 address like ```2000:1e55:5058:9bee:1cec:43e0:bc9:228e```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```bc:78:ad:9a:b9:7e```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://sauer.info you initially access a DNS server to translate the host portion (sauer) combined with the Top Level Domain (info) of the URL, to an IP address like ```251.160.40.69```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_3) AppleWebKit/537.75.14 (KHTML, like Gecko) Version/7.0.3 Safari/7046A194A```

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```172.18.110.170``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  172.18.110.170    UGScg  en0
...
<pre>
default   fe80:29c1:914b:9cd3:5b86%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {22.208.0.253, 30.103.155.22}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr bc:78:ad:9a:b9:7e
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr a0:a4:9d:90:e6:f5
}</pre>
