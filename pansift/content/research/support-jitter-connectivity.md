...
layout: research
ip_v4_address: "54.22.199.150"
date: 2022-11-19T16:17:22+00:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like ```54.22.199.150``` or an IPv6 address like ```2000:c6f8:3033:bdd4:679b:44dc:1b35:26c3```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```ed:c4:ee:6e:87:31```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://wilkinson.org you initially access a DNS server to translate the host portion (wilkinson) combined with the Top Level Domain (org) of the URL, to an IP address like ```236.35.35.210```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_3) AppleWebKit/537.75.14 (KHTML, like Gecko) Version/7.0.3 Safari/7046A194A```
...
<pre>
default   fe80:d6d5:c008:7e42:a324%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {241.111.252.255, 78.42.135.47}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr ed:c4:ee:6e:87:31
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr ef:0e:b2:43:06:d2
}</pre>
...
## Apple macOS / OSX
No matter what version of OSX/macOS you are on, ```10.13.6```, ```11.2.7```, or ```12.2.2```, there are a range of tools for troubleshooting. Unfortunately, between these manual actions and scripts, they don't give you a series of correlated values over time. This is where automated remote troubleshooting comes in to its own, especially for teams that embrace remote work and Work From Anywhere (WFA).
