...
layout: research
ip_v4_address: "184.232.155.8"
date: 2022-11-02T11:33:01+00:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like ```184.232.155.8``` or an IPv6 address like ```2000:7f73:e152:31e1:68f7:ea6e:ebac:470b```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```ce:3d:ce:8b:10:d7```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://fay-hettinger.biz you initially access a DNS server to translate the host portion (fay-hettinger) combined with the Top Level Domain (biz) of the URL, to an IP address like ```100.242.51.76```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows; U; Win 9x 4.90; SG; rv:1.9.2.4) Gecko/20101104 Netscape/9.1.0285```
...
<pre>
default   fe80:5e74:8388:ac6a:96d5%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {1.246.40.97, 43.26.160.106}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr ce:3d:ce:8b:10:d7
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr e4:70:f2:f4:c0:98
}</pre>
