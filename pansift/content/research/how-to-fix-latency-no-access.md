...
layout: research
ip_v4_address: "54.203.38.188"
date: 2022-11-19T16:17:21+00:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like ```54.203.38.188``` or an IPv6 address like ```2000:2145:80da:ab45:d302:a8f8:f0b8:a72c```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```6c:6c:c2:03:2a:85```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://ritchie-torp.info you initially access a DNS server to translate the host portion (ritchie-torp) combined with the Top Level Domain (info) of the URL, to an IP address like ```249.249.147.2```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_3) AppleWebKit/537.75.14 (KHTML, like Gecko) Version/7.0.3 Safari/7046A194A```
...
<pre>
default   fe80:e29:3b46:270b:bfdf%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {33.132.133.221, 200.162.169.111}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 6c:6c:c2:03:2a:85
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr cc:e4:b5:b5:a5:4c
}</pre>
