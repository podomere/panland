...
subtitle: "Branding?"
layout: research
ip_v4_address: "168.34.231.243"
date: 2022-11-02T11:32:59+00:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like ```168.34.231.243``` or an IPv6 address like ```2000:388b:2662:7fd7:c9bf:7a04:2e11:966b```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```b6:bb:3d:3a:74:d8```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://torp-fisher.org you initially access a DNS server to translate the host portion (torp-fisher) combined with the Top Level Domain (org) of the URL, to an IP address like ```187.103.8.189```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_3) AppleWebKit/537.75.14 (KHTML, like Gecko) Version/7.0.3 Safari/7046A194A```
...
<pre>
default   fe80:91f4:a6c8:5b4b:a138%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {84.236.65.26, 233.40.101.226}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr b6:bb:3d:3a:74:d8
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr d3:9d:53:89:3d:0d
}</pre>
