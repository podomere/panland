...
subtitle: "Impact Map?"
layout: research
ip_v4_address: "203.227.50.115"
date: 2022-04-24T18:31:57+01:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like <code>203.227.50.115</code> or an IPv6 address like <code>2000:f5ae:7628:38d1:4abf:bec3:2015:d14e</code>. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>d0:e8:c7:b7:93:e0</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://ratke-jacobson.co you initially access a DNS server to translate the host portion (ratke-jacobson) combined with the Top Level Domain (co) of the URL, to an IP address like <code>120.220.253.212</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Opera/9.80 (X11; Linux i686; Ubuntu/14.10) Presto/2.12.388 Version/12.16</code>

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like <code>10.171.143.188</code> (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For <code>IPv6</code> we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  10.171.143.188    UGScg  en0
...
<pre><code>
default   fe80:7d4a:49b4:9459:335d%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {85.224.224.178, 211.4.99.20}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr d0:e8:c7:b7:93:e0
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr d3:91:f8:40:24:14
}</code></pre>
