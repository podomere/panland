...
subtitle: "Streamline?"
layout: research
ip_v4_address: "237.250.84.95"
date: 2022-11-02T11:32:24+00:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like ```237.250.84.95``` or an IPv6 address like ```2000:480:5adc:14e7:275d:bb2:da2b:aaae```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```e4:e5:50:68:d6:61```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://schroeder-bernier.info you initially access a DNS server to translate the host portion (schroeder-bernier) combined with the Top Level Domain (info) of the URL, to an IP address like ```23.182.108.187```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1; WOW64; Trident/7.0; AS; rv:11.0) like Gecko```

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```172.16.237.13``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  172.16.237.13    UGScg  en0
...
<pre>
default   fe80:93ce:4bd9:56af:ed57%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {16.107.177.243, 84.165.144.187}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr e4:e5:50:68:d6:61
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr b2:ab:48:ec:5d:85
}</pre>
