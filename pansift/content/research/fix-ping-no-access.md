...
layout: research
ip_v4_address: "222.125.158.39"
date: 2023-10-29T15:13:28+00:00
draft: false
---

## Internet Addressing
On the Internet you may have a Public IPv4 address like ```222.125.158.39``` or an IPv6 address like ```2000:1d08:1d32:198d:b4c5:cd29:8a8:908a```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```66:5f:08:ad:76:f6```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://crooks-boyle.info you initially access a DNS server to translate the host portion (crooks-boyle) combined with the Top Level Domain (info) of the URL, to an IP address like ```50.207.13.183```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT x.y; Win64; x64; rv:10.0) Gecko/20100101 Firefox/10.0```
...
<pre>
default   fe80:9990:f257:4a5f:80d7%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {139.250.239.210, 17.121.216.139}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 66:5f:08:ad:76:f6
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 2c:41:9a:3a:c5:f6
}</pre>
