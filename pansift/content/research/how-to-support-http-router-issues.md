...
layout: research
ip_v4_address: "198.232.41.86"
date: 2023-10-29T15:13:29+00:00
draft: false
---

## Internet Addressing
On the Internet you might have a Public IPv4 address like ```198.232.41.86``` or an IPv6 address like ```2000:5498:978c:a894:374f:c710:ca35:40b1```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```1f:90:93:24:b2:85```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://ernser-bashirian.co you initially access a DNS server to translate the host portion (ernser-bashirian) combined with the Top Level Domain (co) of the URL, to an IP address like ```121.253.119.171```. Your computer and browser actually sends its type with all web requests e.g. <br>```Opera/9.80 (X11; Linux i686; Ubuntu/14.10) Presto/2.12.388 Version/12.16```
...
<pre>
default   fe80:a614:694e:f657:94c8%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {249.39.43.171, 18.124.19.185}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 1f:90:93:24:b2:85
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 43:60:85:5d:bb:47
}</pre>
