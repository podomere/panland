...
layout: research
ip_v4_address: "189.93.107.140"
date: 2022-12-15T13:50:10+00:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like ```189.93.107.140``` or an IPv6 address like ```2000:d7bb:5f7d:3af8:d954:3ba2:20ab:6920```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```88:e0:42:57:ff:79```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://lang-kertzmann.name you initially access a DNS server to translate the host portion (lang-kertzmann) combined with the Top Level Domain (name) of the URL, to an IP address like ```60.25.106.4```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT x.y; Win64; x64; rv:10.0) Gecko/20100101 Firefox/10.0```
...
<pre>
default   fe80:e425:34ba:e9d2:e049%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {43.64.77.168, 246.133.117.60}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 88:e0:42:57:ff:79
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 66:86:a5:5f:24:15
}</pre>
