...
subtitle: "Ideate?"
layout: research
ip_v4_address: "172.175.79.21"
date: 2022-04-24T19:00:00+01:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like <code>172.175.79.21</code> or an IPv6 address like <code>2000:5a24:dcbd:d297:81cd:3212:6fc3:efc2</code>. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>14:55:e7:2f:af:96</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://bernier-johnson.com you initially access a DNS server to translate the host portion (bernier-johnson) combined with the Top Level Domain (com) of the URL, to an IP address like <code>99.241.100.84</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_3) AppleWebKit/537.75.14 (KHTML, like Gecko) Version/7.0.3 Safari/7046A194A</code>
...
<pre><code>
default   fe80:d14b:68a9:5226:df39%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {97.212.233.141, 127.98.124.106}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 14:55:e7:2f:af:96
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr d9:16:21:2e:f0:fe
}</code></pre>
