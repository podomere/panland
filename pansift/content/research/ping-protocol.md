...
subtitle: "Ideate?"
layout: research
ip_v4_address: "72.219.178.168"
date: 2022-04-24T19:00:01+01:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like <code>72.219.178.168</code> or an IPv6 address like <code>2000:2d25:de13:241d:a00b:9682:a28:9160</code>. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>73:a1:2a:fc:ee:b7</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://corkery-kreiger.io you initially access a DNS server to translate the host portion (corkery-kreiger) combined with the Top Level Domain (io) of the URL, to an IP address like <code>81.241.223.231</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Opera/9.80 (X11; Linux i686; Ubuntu/14.10) Presto/2.12.388 Version/12.16</code>
...
<pre><code>
default   fe80:900d:166:20c4:2a95%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {222.14.7.58, 40.84.28.82}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 73:a1:2a:fc:ee:b7
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr ec:7e:7e:e9:ac:89
}</code></pre>
