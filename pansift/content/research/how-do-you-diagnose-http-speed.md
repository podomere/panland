...
layout: research
ip_v4_address: "90.254.30.197"
date: 2022-05-05T14:30:08+01:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like ```90.254.30.197``` or an IPv6 address like ```2000:6f7b:bc00:ab4a:a096:f743:a37f:942b```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```a9:db:46:ac:f5:7a```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://hessel-kub.org you initially access a DNS server to translate the host portion (hessel-kub) combined with the Top Level Domain (org) of the URL, to an IP address like ```116.144.65.108```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT x.y; Win64; x64; rv:10.0) Gecko/20100101 Firefox/10.0```

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```10.147.151.217``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  10.147.151.217    UGScg  en0
...
<pre>
default   fe80:d5d0:9cea:1ce9:ed6b%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {255.241.68.211, 89.48.222.199}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr a9:db:46:ac:f5:7a
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr f1:01:7f:0c:b8:16
}</pre>
