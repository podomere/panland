---
title: "How To Test Ping"
subtitle: "Bleeding Edge?"
layout: research
ip_v4_address: "251.214.38.137"
date: 2023-02-04T17:08:39+00:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like ```251.214.38.137``` or an IPv6 address like ```2000:46f5:85a2:911:107:3200:a442:7a92```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```2e:f0:43:69:46:2f```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://hilpert-labadie.com you initially access a DNS server to translate the host portion (hilpert-labadie) combined with the Top Level Domain (com) of the URL, to an IP address like ```61.182.18.4```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/41.0.2228.0 Safari/537.36```

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```192.168.49.77``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  192.168.49.77    UGScg  en0
...
<pre>
default   fe80:c25d:25e6:23a1:6c88%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {247.149.122.133, 230.195.56.129}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 2e:f0:43:69:46:2f
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 6d:49:3f:79:7a:68
}</pre>
...
## Apple macOS / OSX
No matter what version of OSX/macOS you are on, ```10.14.6```, ```11.3.6```, or ```12.1.4```, there are a range of tools for troubleshooting. Unfortunately, between these manual actions and scripts, they don't give you a series of correlated values over time. This is where automated remote troubleshooting comes in to its own, especially for teams that embrace remote work and Work From Anywhere (WFA).
