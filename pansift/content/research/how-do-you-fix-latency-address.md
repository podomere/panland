...
subtitle: "Learnings?"
layout: research
ip_v4_address: "221.178.96.233"
date: 2022-11-02T11:32:56+00:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like ```221.178.96.233``` or an IPv6 address like ```2000:908b:4d08:5030:4195:ed85:88ce:ebd8```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```e0:fd:9f:d1:ab:89```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://kutch-lindgren.biz you initially access a DNS server to translate the host portion (kutch-lindgren) combined with the Top Level Domain (biz) of the URL, to an IP address like ```164.192.31.28```. Your computer and browser actually sends its type with all web requests e.g. <br>```Opera/9.80 (X11; Linux i686; Ubuntu/14.10) Presto/2.12.388 Version/12.16```
...
<pre>
default   fe80:e95b:15d9:7d1d:e71%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {68.243.184.64, 76.71.100.133}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr e0:fd:9f:d1:ab:89
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr e2:f4:94:51:91:d9
}</pre>
