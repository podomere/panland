...
layout: research
ip_v4_address: "94.253.48.36"
date: 2023-10-06T17:11:03+01:00
draft: false
---

## Internet Addressing
On the Internet you may have a Public IPv4 address like ```94.253.48.36``` or an IPv6 address like ```2000:3999:c297:7e66:f186:580b:a834:c08b```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```09:e2:5d:4d:db:f4```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://koch-hansen.com you initially access a DNS server to translate the host portion (koch-hansen) combined with the Top Level Domain (com) of the URL, to an IP address like ```97.92.196.2```. Your computer and browser actually sends its type with all web requests e.g. <br>```Opera/9.80 (X11; Linux i686; Ubuntu/14.10) Presto/2.12.388 Version/12.16```
...
<pre>
default   fe80:5b8f:6dfa:40cc:3219%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {7.77.177.75, 19.240.58.186}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 09:e2:5d:4d:db:f4
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 2f:ea:dc:6f:ef:e9
}</pre>
