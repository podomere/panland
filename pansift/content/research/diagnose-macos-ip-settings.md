...
layout: research
ip_v4_address: "20.246.23.54"
date: 2023-10-06T17:10:40+01:00
draft: false
---

## Internet Addressing
On the Internet you might have a Public IPv4 address like ```20.246.23.54``` or an IPv6 address like ```2000:17f3:892b:fc76:b8e5:a5ae:827c:5433```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```22:1f:a0:b1:33:23```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://langworth.info you initially access a DNS server to translate the host portion (langworth) combined with the Top Level Domain (info) of the URL, to an IP address like ```251.165.118.228```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows; U; Win 9x 4.90; SG; rv:1.9.2.4) Gecko/20101104 Netscape/9.1.0285```
...
<pre>
default   fe80:fa45:d922:2b6:e4d1%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {192.147.167.217, 244.155.219.2}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 22:1f:a0:b1:33:23
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr e5:3c:03:14:c2:a3
}</pre>
...
### Apple macOS / OSX
No matter what version of OSX/macOS you are on, ```10.14.6```, ```11.3.1```, or ```12.1.7```, there are a range of tools for troubleshooting. Unfortunately, between these manual actions and scripts, they don't give you a series of correlated values over time. This is where automated remote troubleshooting comes in to its own, especially for teams that embrace remote work and Work From Anywhere (WFA).
