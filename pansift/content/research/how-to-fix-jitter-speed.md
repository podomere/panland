...
layout: research
ip_v4_address: "108.138.138.115"
date: 2023-10-29T15:13:27+00:00
draft: false
---

## Internet Addressing
On the Internet you may get a Public IPv4 address like ```108.138.138.115``` or an IPv6 address like ```2000:4090:a93e:ccb2:8a9d:378d:79c2:2202```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```1e:c5:16:24:51:e0```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://sporer-schultz.org you initially access a DNS server to translate the host portion (sporer-schultz) combined with the Top Level Domain (org) of the URL, to an IP address like ```162.124.139.6```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows; U; Win 9x 4.90; SG; rv:1.9.2.4) Gecko/20101104 Netscape/9.1.0285```
...
<pre>
default   fe80:5b14:d9d7:35b9:31e3%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {87.35.74.85, 223.208.40.252}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 1e:c5:16:24:51:e0
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 62:58:c3:5f:20:c0
}</pre>
