...
subtitle: "Deep Dive?"
layout: research
ip_v4_address: "225.48.244.25"
date: 2022-11-19T16:17:24+00:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like ```225.48.244.25``` or an IPv6 address like ```2000:61f6:7616:8a26:48be:f82e:43f6:d057```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```5b:a5:f9:b9:b8:02```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://boyer-ohara.io you initially access a DNS server to translate the host portion (boyer-ohara) combined with the Top Level Domain (io) of the URL, to an IP address like ```154.47.58.2```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_3) AppleWebKit/537.75.14 (KHTML, like Gecko) Version/7.0.3 Safari/7046A194A```
...
<pre>
default   fe80:f8ea:ab23:818e:7fa9%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {70.205.116.156, 100.220.172.69}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 5b:a5:f9:b9:b8:02
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 77:fa:f0:b4:86:94
}</pre>
