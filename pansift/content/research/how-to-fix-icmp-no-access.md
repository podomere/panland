---
title: "How To Fix Icmp No-access"
subtitle: "Infographic?"
layout: research
ip_v4_address: "239.160.46.143"
date: 2022-12-15T13:50:19+00:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like ```239.160.46.143``` or an IPv6 address like ```2000:5c18:c0d8:cce7:fafb:9934:7812:954f```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```fb:32:26:51:b5:58```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://spinka-runolfsdottir.name you initially access a DNS server to translate the host portion (spinka-runolfsdottir) combined with the Top Level Domain (name) of the URL, to an IP address like ```245.221.245.236```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_3) AppleWebKit/537.75.14 (KHTML, like Gecko) Version/7.0.3 Safari/7046A194A```

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```10.16.151.25``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  10.16.151.25    UGScg  en0
...
<pre>
default   118:5e8a:402d:bf:9a94:6859:fc84:e08b%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {180.90.217.82, 169.122.174.154}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr fb:32:26:51:b5:58
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 55:2c:f9:39:05:c8
}</pre>
