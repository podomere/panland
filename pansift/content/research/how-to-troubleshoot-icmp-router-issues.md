...
layout: research
ip_v4_address: "12.75.73.191"
date: 2022-11-19T19:13:26+00:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like ```12.75.73.191``` or an IPv6 address like ```2000:d859:8017:834:95ed:a1b4:de87:2481```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```ac:74:d3:c4:14:12```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://heller.io you initially access a DNS server to translate the host portion (heller) combined with the Top Level Domain (io) of the URL, to an IP address like ```144.164.202.35```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows; U; Win 9x 4.90; SG; rv:1.9.2.4) Gecko/20101104 Netscape/9.1.0285```
...
default  172.26.114.97    UGScg  en0
...
<pre>
default   fe80:226a:bcc5:96db:4f3f%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {254.236.59.169, 245.172.64.112}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr ac:74:d3:c4:14:12
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 65:7e:7e:ca:03:cb
}</pre>
