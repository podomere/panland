...
subtitle: "Deep Dive?"
layout: research
ip_v4_address: "78.21.166.78"
date: 2023-02-04T17:07:41+00:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like ```78.21.166.78``` or an IPv6 address like ```2000:278:87a8:5abf:eb75:9303:88ff:7740```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```10:02:aa:84:8f:8f```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://baumbach.co you initially access a DNS server to translate the host portion (baumbach) combined with the Top Level Domain (co) of the URL, to an IP address like ```125.245.249.238```. Your computer and browser actually sends its type with all web requests e.g. <br>```Opera/9.80 (X11; Linux i686; Ubuntu/14.10) Presto/2.12.388 Version/12.16```

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```172.17.240.243``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  172.17.240.243    UGScg  en0
...
<pre>
default   fe80:77b1:1c3c:caee:8ad4%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {26.202.162.118, 129.188.43.102}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 10:02:aa:84:8f:8f
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 71:26:01:e3:a2:67
}</pre>
...
## Apple macOS / OSX
No matter what version of OSX/macOS you are on, ```10.14.4```, ```11.3.6```, or ```12.2.5```, there are a range of tools for troubleshooting. Unfortunately, between these manual actions and scripts, they don't give you a series of correlated values over time. This is where automated remote troubleshooting comes in to its own, especially for teams that embrace remote work and Work From Anywhere (WFA).
