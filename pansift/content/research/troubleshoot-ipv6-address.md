...
layout: research
ip_v4_address: "219.10.142.97"
date: 2023-10-29T15:13:24+00:00
draft: false
---

## Internet Addressing
On the Internet you may have a Public IPv4 address like ```219.10.142.97``` or an IPv6 address like ```2000:bc6a:ecb3:9647:5b27:4ae2:e4b3:8d4b```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```ad:35:5d:5b:64:91```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://crona-quitzon.net you initially access a DNS server to translate the host portion (crona-quitzon) combined with the Top Level Domain (net) of the URL, to an IP address like ```249.165.212.62```. Your computer and browser actually sends its type with all web requests e.g. <br>```Opera/9.80 (X11; Linux i686; Ubuntu/14.10) Presto/2.12.388 Version/12.16```
...
<pre>
default   fe80:8170:4d85:3937:40b0%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {240.0.93.3, 165.136.123.251}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr ad:35:5d:5b:64:91
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 2b:59:18:5a:c3:2d
}</pre>
