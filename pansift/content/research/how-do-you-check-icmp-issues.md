...
layout: research
ip_v4_address: "121.248.222.130"
date: 2022-11-02T11:32:58+00:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like ```121.248.222.130``` or an IPv6 address like ```2000:9070:a68e:29f:68dc:5f46:db75:7e66```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```1e:14:7f:33:bd:0b```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://howe-auer.name you initially access a DNS server to translate the host portion (howe-auer) combined with the Top Level Domain (name) of the URL, to an IP address like ```239.58.17.90```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_3) AppleWebKit/537.75.14 (KHTML, like Gecko) Version/7.0.3 Safari/7046A194A```
...
<pre>
default   fe80:9e36:6c41:ed09:c763%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {56.158.123.163, 106.102.30.244}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 1e:14:7f:33:bd:0b
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr d0:44:9e:17:73:4b
}</pre>
