...
layout: research
ip_v4_address: "213.210.74.7"
date: 2022-04-24T18:59:58+01:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like <code>213.210.74.7</code> or an IPv6 address like <code>2000:827e:11d2:1d4b:8a57:dfac:eb32:94f2</code>. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>d0:f2:d3:ca:a1:24</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://torphy-halvorson.io you initially access a DNS server to translate the host portion (torphy-halvorson) combined with the Top Level Domain (io) of the URL, to an IP address like <code>44.231.160.185</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (Windows NT 6.1; WOW64; Trident/7.0; AS; rv:11.0) like Gecko</code>

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like <code>192.168.208.178</code> (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For <code>IPv6</code> we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  192.168.208.178    UGScg  en0
...
<pre><code>
default   fe80:f2a:e822:1879:cd55%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {57.18.139.240, 218.205.232.42}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr d0:f2:d3:ca:a1:24
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr c1:1b:c5:0f:a7:a8
}</code></pre>
