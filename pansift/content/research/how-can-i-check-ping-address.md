...
layout: research
ip_v4_address: "76.101.236.197"
date: 2022-11-19T16:17:24+00:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like ```76.101.236.197``` or an IPv6 address like ```2000:f179:8575:75fb:c282:4de0:d43d:8247```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```8d:e9:93:7b:32:96```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://weber-bednar.co you initially access a DNS server to translate the host portion (weber-bednar) combined with the Top Level Domain (co) of the URL, to an IP address like ```205.194.181.227```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows; U; Win 9x 4.90; SG; rv:1.9.2.4) Gecko/20101104 Netscape/9.1.0285```
...
<pre>
default   fe80:fe2e:3393:1234:4432%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {44.241.41.17, 147.151.38.92}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 8d:e9:93:7b:32:96
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 92:23:2d:20:c6:10
}</pre>
