...
layout: research
ip_v4_address: "241.188.7.131"
date: 2022-11-02T11:33:12+00:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like ```241.188.7.131``` or an IPv6 address like ```2000:404b:1abf:439:8ea8:c4d6:1e4b:c644```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```9c:fc:f3:73:fd:d6```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://keebler-spencer.biz you initially access a DNS server to translate the host portion (keebler-spencer) combined with the Top Level Domain (biz) of the URL, to an IP address like ```202.123.104.169```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows; U; Win 9x 4.90; SG; rv:1.9.2.4) Gecko/20101104 Netscape/9.1.0285```
...
<pre>
default   fe80:b220:d460:19ca:f31d%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {15.22.239.82, 122.12.70.53}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 9c:fc:f3:73:fd:d6
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr ab:d1:9c:02:6f:e2
}</pre>
