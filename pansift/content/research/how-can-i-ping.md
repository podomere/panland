...
subtitle: "Swim Lane?"
layout: research
ip_v4_address: "123.191.48.180"
date: 2022-06-12T14:09:27+01:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like ```123.191.48.180``` or an IPv6 address like ```2000:fa6e:bde4:2132:2570:5a25:903d:d6ce```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```bb:8c:5f:15:4d:2d```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://bartell-kuhlman.name you initially access a DNS server to translate the host portion (bartell-kuhlman) combined with the Top Level Domain (name) of the URL, to an IP address like ```103.152.24.177```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_3) AppleWebKit/537.75.14 (KHTML, like Gecko) Version/7.0.3 Safari/7046A194A```
...
<pre>
default   fe80:f524:c307:2e8a:be93%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {215.60.49.232, 128.246.240.8}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr bb:8c:5f:15:4d:2d
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr bf:9b:0a:6d:99:2a
}</pre>
