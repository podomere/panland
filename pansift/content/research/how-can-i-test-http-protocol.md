...
subtitle: "Swim Lane?"
layout: research
ip_v4_address: "244.69.137.241"
date: 2023-10-29T15:13:29+00:00
draft: false
---

## Internet Addressing
On the Internet you might have a Public IPv4 address like ```244.69.137.241``` or an IPv6 address like ```2000:504b:e99d:b03d:c847:9fe:232d:bf53```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```06:78:3d:73:42:a5```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://deckow.name you initially access a DNS server to translate the host portion (deckow) combined with the Top Level Domain (name) of the URL, to an IP address like ```35.224.145.75```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (compatible; MSIE 9.0; AOL 9.7; AOLBuild 4343.19; Windows NT 6.1; WOW64; Trident/5.0; FunWebProducts)```
...
<pre>
default   fe80:63ff:2369:7b90:4843%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {216.138.102.147, 48.30.181.135}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 06:78:3d:73:42:a5
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 4f:1f:1d:e4:17:58
}</pre>
