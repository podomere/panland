...
layout: research
ip_v4_address: "20.104.243.77"
date: 2022-04-24T19:00:25+01:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like <code>20.104.243.77</code> or an IPv6 address like <code>2000:bebe:ef51:3b63:10a1:2cad:fc6a:3b2c</code>. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>4a:32:01:69:2d:1e</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://rice-sporer.info you initially access a DNS server to translate the host portion (rice-sporer) combined with the Top Level Domain (info) of the URL, to an IP address like <code>39.162.28.150</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (Windows; U; Win 9x 4.90; SG; rv:1.9.2.4) Gecko/20101104 Netscape/9.1.0285</code>
...
<pre><code>
default   fe80:349d:5a60:67c5:d5b5%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {106.245.141.12, 185.13.58.18}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 4a:32:01:69:2d:1e
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr b5:8a:fd:06:97:9a
}</code></pre>
