...
layout: research
ip_v4_address: "160.238.45.95"
date: 2022-12-15T13:50:03+00:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like ```160.238.45.95``` or an IPv6 address like ```2000:9ff7:a831:2fa:db91:a2b5:bcb5:7d62```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```51:31:eb:4e:95:2d```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://kilback.co you initially access a DNS server to translate the host portion (kilback) combined with the Top Level Domain (co) of the URL, to an IP address like ```72.137.218.57```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_3) AppleWebKit/537.75.14 (KHTML, like Gecko) Version/7.0.3 Safari/7046A194A```
...
<pre>
default   fe80:7c19:2295:4a4d:f929%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {200.56.125.70, 155.82.55.179}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 51:31:eb:4e:95:2d
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 33:35:ef:d8:5d:ea
}</pre>
