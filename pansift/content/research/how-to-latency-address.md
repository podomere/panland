...
subtitle: "Etc. Etc.?"
layout: research
ip_v4_address: "104.101.231.115"
date: 2023-10-29T15:13:26+00:00
draft: false
---

## Internet Addressing
On the Internet you might have a Public IPv4 address like ```104.101.231.115``` or an IPv6 address like ```2000:af4d:be00:6f95:caf0:72f:77e3:22ce```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```11:0f:c4:b9:04:df```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://luettgen.info you initially access a DNS server to translate the host portion (luettgen) combined with the Top Level Domain (info) of the URL, to an IP address like ```85.195.113.109```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows; U; Win 9x 4.90; SG; rv:1.9.2.4) Gecko/20101104 Netscape/9.1.0285```
...
<pre>
default   fe80:edfc:f798:285e:5532%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {255.160.216.2, 229.195.93.208}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 11:0f:c4:b9:04:df
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr da:02:78:99:ac:c1
}</pre>
