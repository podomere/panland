...
layout: research
ip_v4_address: "134.187.153.46"
date: 2023-10-06T17:10:30+01:00
draft: false
---

## Internet Addressing
On the Internet you might get a Public IPv4 address like ```134.187.153.46``` or an IPv6 address like ```2000:f8f8:572d:3f32:2224:a6d3:3087:c761```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```a7:ed:2a:ad:ea:a9```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://miller-dicki.io you initially access a DNS server to translate the host portion (miller-dicki) combined with the Top Level Domain (io) of the URL, to an IP address like ```47.31.46.64```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1; WOW64; Trident/7.0; AS; rv:11.0) like Gecko```
...
<pre>
default   fe80:b0c8:2644:1ab3:6dd0%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {132.28.90.215, 160.94.111.248}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr a7:ed:2a:ad:ea:a9
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 9f:42:55:89:5b:90
}</pre>
...
### Apple macOS / OSX
No matter what version of OSX/macOS you are on, ```10.14.6```, ```11.6.3```, or ```12.1.2```, there are a range of tools for troubleshooting. Unfortunately, between these manual actions and scripts, they don't give you a series of correlated values over time. This is where automated remote troubleshooting comes in to its own, especially for teams that embrace remote work and Work From Anywhere (WFA).
