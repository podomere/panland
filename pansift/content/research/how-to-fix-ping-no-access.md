...
layout: research
ip_v4_address: "90.165.73.199"
date: 2022-12-15T13:50:20+00:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like ```90.165.73.199``` or an IPv6 address like ```2000:891d:70ab:610b:4504:356b:f711:bb84```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```f7:f7:64:a0:09:ce```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://goyette-rau.info you initially access a DNS server to translate the host portion (goyette-rau) combined with the Top Level Domain (info) of the URL, to an IP address like ```198.122.22.16```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/41.0.2228.0 Safari/537.36```
...
default  192.168.12.253    UGScg  en0
...
<pre>
default   fe80:8517:d86:7d81:3d40%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {94.173.181.39, 248.49.183.242}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr f7:f7:64:a0:09:ce
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 3b:e0:c4:b5:73:d6
}</pre>
