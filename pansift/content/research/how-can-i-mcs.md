...
layout: research
ip_v4_address: "123.193.15.9"
date: 2022-06-04T14:38:17+01:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like ```123.193.15.9``` or an IPv6 address like ```2000:efcb:2bc6:55b0:a44b:7ca1:83dd:b112```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```c4:e5:44:62:fd:b5```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://paucek.com you initially access a DNS server to translate the host portion (paucek) combined with the Top Level Domain (com) of the URL, to an IP address like ```109.230.19.207```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/41.0.2228.0 Safari/537.36```

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```10.75.26.121``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  10.75.26.121    UGScg  en0
...
<pre>
default   fe80:5cd:759b:448e:b6%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {117.155.243.171, 79.18.61.238}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr c4:e5:44:62:fd:b5
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr da:81:17:60:54:16
}</pre>
