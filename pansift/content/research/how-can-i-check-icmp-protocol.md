...
layout: research
ip_v4_address: "163.229.50.157"
date: 2022-06-04T14:38:41+01:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like ```163.229.50.157``` or an IPv6 address like ```2000:baf4:d43e:dc05:2050:f866:1c94:25d3```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```19:0f:ff:68:56:32```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://treutel-feest.net you initially access a DNS server to translate the host portion (treutel-feest) combined with the Top Level Domain (net) of the URL, to an IP address like ```165.172.224.73```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_3) AppleWebKit/537.75.14 (KHTML, like Gecko) Version/7.0.3 Safari/7046A194A```
...
<pre>
default   fe80:ece:2db0:6121:29a3%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {188.43.192.243, 153.2.126.160}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 19:0f:ff:68:56:32
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr f1:fb:17:3e:43:49
}</pre>
