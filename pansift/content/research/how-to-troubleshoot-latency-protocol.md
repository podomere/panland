...
layout: research
ip_v4_address: "73.237.250.200"
date: 2023-10-29T15:13:26+00:00
draft: false
---

## Internet Addressing
On the Internet you might have a Public IPv4 address like ```73.237.250.200``` or an IPv6 address like ```2000:f1e1:4b11:fdef:9027:e5f8:3bfe:84d6```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```40:7a:98:b6:f8:ea```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://conn-mohr.org you initially access a DNS server to translate the host portion (conn-mohr) combined with the Top Level Domain (org) of the URL, to an IP address like ```234.22.220.15```. Your computer and browser actually sends its type with all web requests e.g. <br>```Opera/9.80 (X11; Linux i686; Ubuntu/14.10) Presto/2.12.388 Version/12.16```
...
<pre>
default   fe80:d444:9159:499b:aec2%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {21.150.38.150, 148.15.5.17}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 40:7a:98:b6:f8:ea
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 79:72:49:26:76:48
}</pre>
