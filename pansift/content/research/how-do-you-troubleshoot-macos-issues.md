...
layout: research
ip_v4_address: "185.91.160.149"
date: 2022-06-04T14:38:28+01:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like ```185.91.160.149``` or an IPv6 address like ```2000:95f1:339b:6795:c7d0:a026:4c9f:3750```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```eb:18:4f:0e:32:7d```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://kshlerin.co you initially access a DNS server to translate the host portion (kshlerin) combined with the Top Level Domain (co) of the URL, to an IP address like ```141.241.170.245```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows; U; Win 9x 4.90; SG; rv:1.9.2.4) Gecko/20101104 Netscape/9.1.0285```
...
<pre>
default   fe80:2d49:f8a1:590f:3b4%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {34.177.97.179, 126.226.115.60}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr eb:18:4f:0e:32:7d
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr d2:04:38:f1:bd:f8
}</pre>
