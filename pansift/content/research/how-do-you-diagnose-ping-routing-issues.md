...
layout: research
ip_v4_address: "89.16.244.187"
date: 2022-11-19T16:17:24+00:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like ```89.16.244.187``` or an IPv6 address like ```2000:82af:ad9e:f55c:7f61:72a6:1267:9d81```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```b9:28:40:56:74:20```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://huels-stark.biz you initially access a DNS server to translate the host portion (huels-stark) combined with the Top Level Domain (biz) of the URL, to an IP address like ```85.75.184.34```. Your computer and browser actually sends its type with all web requests e.g. <br>```Opera/9.80 (X11; Linux i686; Ubuntu/14.10) Presto/2.12.388 Version/12.16```
...
<pre>
default   fe80:35c:7ff0:4ac3:acf8%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {193.78.98.202, 24.101.69.90}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr b9:28:40:56:74:20
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr e7:eb:af:46:63:54
}</pre>
