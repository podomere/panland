...
layout: research
ip_v4_address: "52.204.187.133"
date: 2022-04-24T18:59:56+01:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like <code>52.204.187.133</code> or an IPv6 address like <code>2000:5f9b:2410:e3ac:c761:ce12:8719:4918</code>. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>cc:f0:44:f3:37:53</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://mayer-nicolas.name you initially access a DNS server to translate the host portion (mayer-nicolas) combined with the Top Level Domain (name) of the URL, to an IP address like <code>33.89.190.182</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (Windows NT 6.1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/41.0.2228.0 Safari/537.36</code>
...
<pre><code>
default   fe80:8e7:ba95:4fec:5aee%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {108.19.200.219, 45.72.41.181}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr cc:f0:44:f3:37:53
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr ea:46:76:bf:8b:ee
}</code></pre>
