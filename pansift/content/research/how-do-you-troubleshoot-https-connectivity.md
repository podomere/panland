...
layout: research
ip_v4_address: "209.135.148.25"
date: 2022-11-02T11:33:01+00:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like ```209.135.148.25``` or an IPv6 address like ```2000:b5b:dec1:bf77:5101:bedf:4608:e950```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```40:c2:d2:5f:5f:4d```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://volkman-boyle.io you initially access a DNS server to translate the host portion (volkman-boyle) combined with the Top Level Domain (io) of the URL, to an IP address like ```152.221.51.87```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_3) AppleWebKit/537.75.14 (KHTML, like Gecko) Version/7.0.3 Safari/7046A194A```
...
<pre>
default   fe80:a734:f2b5:ca83:82e9%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {115.54.147.220, 211.242.189.202}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 40:c2:d2:5f:5f:4d
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 91:66:80:af:23:05
}</pre>
