...
layout: research
ip_v4_address: "249.148.84.33"
date: 2023-02-04T16:26:10+00:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like ```249.148.84.33``` or an IPv6 address like ```2000:b140:789a:48ba:6b8f:4e1f:cdb8:1fe0```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```10:ec:c5:5b:0d:0e```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://bins-jerde.name you initially access a DNS server to translate the host portion (bins-jerde) combined with the Top Level Domain (name) of the URL, to an IP address like ```91.198.128.228```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/41.0.2228.0 Safari/537.36```
...
<pre>
default   fe80:b497:5e88:8a4b:c418%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {137.61.103.184, 191.159.40.237}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 10:ec:c5:5b:0d:0e
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 0f:5c:c5:04:f7:05
}</pre>
