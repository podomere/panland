...
layout: research
ip_v4_address: "6.47.65.216"
date: 2022-05-05T14:28:30+01:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like ```6.47.65.216``` or an IPv6 address like ```2000:c5f0:adb1:9ccf:b96f:2728:22fc:c4af```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```67:17:62:e6:65:82```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://murazik-feeney.co you initially access a DNS server to translate the host portion (murazik-feeney) combined with the Top Level Domain (co) of the URL, to an IP address like ```29.241.233.49```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_3) AppleWebKit/537.75.14 (KHTML, like Gecko) Version/7.0.3 Safari/7046A194A```

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```172.25.134.244``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  172.25.134.244    UGScg  en0
...
<pre>
default   fe80:7b9f:f9bd:399d:2d6a%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {99.155.56.99, 29.62.30.198}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 67:17:62:e6:65:82
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr b0:4e:65:c1:09:39
}</pre>
