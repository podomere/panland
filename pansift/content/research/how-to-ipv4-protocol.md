...
layout: research
ip_v4_address: "24.120.137.30"
date: 2023-10-06T17:11:04+01:00
draft: false
---

## Internet Addressing
On the Internet you may get a Public IPv4 address like ```24.120.137.30``` or an IPv6 address like ```2000:8a44:c1f8:8bc6:9893:f287:7588:d82e```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```be:92:1b:c9:30:03```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://schaden-wilkinson.name you initially access a DNS server to translate the host portion (schaden-wilkinson) combined with the Top Level Domain (name) of the URL, to an IP address like ```27.143.85.61```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1; WOW64; Trident/7.0; AS; rv:11.0) like Gecko```
...
<pre>
default   fe80:6353:ae77:5a60:f070%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {22.84.45.100, 25.134.132.213}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr be:92:1b:c9:30:03
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr ba:f8:46:3f:74:9f
}</pre>
