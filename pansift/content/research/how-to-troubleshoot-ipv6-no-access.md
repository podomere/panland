...
subtitle: "Learnings?"
layout: research
ip_v4_address: "102.164.58.69"
date: 2023-10-06T17:11:03+01:00
draft: false
---

## Internet Addressing
On the Internet you may get a Public IPv4 address like ```102.164.58.69``` or an IPv6 address like ```2000:9873:8167:e278:1c64:4ca5:64cb:1896```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```f5:9f:fc:fe:9b:83```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://hermann-klein.name you initially access a DNS server to translate the host portion (hermann-klein) combined with the Top Level Domain (name) of the URL, to an IP address like ```50.70.170.19```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_3) AppleWebKit/537.75.14 (KHTML, like Gecko) Version/7.0.3 Safari/7046A194A```
...
<pre>
default   fe80:43de:e514:9d1e:334d%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {5.128.131.144, 136.58.231.250}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr f5:9f:fc:fe:9b:83
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 75:b3:3b:70:4b:be
}</pre>
