...
layout: research
ip_v4_address: "154.254.22.12"
date: 2023-02-04T17:08:41+00:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like ```154.254.22.12``` or an IPv6 address like ```2000:d81f:45d7:216:6c86:bf3a:f472:d0d4```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```5a:98:6b:c6:84:e9```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://gorczany-hamill.io you initially access a DNS server to translate the host portion (gorczany-hamill) combined with the Top Level Domain (io) of the URL, to an IP address like ```121.243.156.244```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_3) AppleWebKit/537.75.14 (KHTML, like Gecko) Version/7.0.3 Safari/7046A194A```
...
<pre>
default   fe80:eaa:947f:eea4:58c6%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {10.168.60.50, 87.42.217.25}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 5a:98:6b:c6:84:e9
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 26:70:86:eb:f2:1a
}</pre>
