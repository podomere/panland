...
subtitle: "Tee It Up?"
layout: research
ip_v4_address: "202.14.133.38"
date: 2023-02-04T16:26:02+00:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like ```202.14.133.38``` or an IPv6 address like ```2000:cceb:5e18:d251:d418:6411:4ad3:5e48```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```e0:b9:8a:30:ed:1e```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://kertzmann.net you initially access a DNS server to translate the host portion (kertzmann) combined with the Top Level Domain (net) of the URL, to an IP address like ```27.113.227.95```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT x.y; Win64; x64; rv:10.0) Gecko/20100101 Firefox/10.0```

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```192.168.166.92``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  192.168.166.92    UGScg  en0
...
<pre>
default   fe80:71b3:ebd7:fa99:89d8%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {20.148.5.198, 11.20.12.25}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr e0:b9:8a:30:ed:1e
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 08:e1:b6:5d:05:ff
}</pre>
