...
subtitle: "Streamline?"
layout: research
ip_v4_address: "12.135.38.215"
date: 2022-05-05T14:29:27+01:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like ```12.135.38.215``` or an IPv6 address like ```2000:6c8d:dc02:4d5a:6579:d1f6:7496:95a7```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```5d:58:75:27:77:6b```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://stokes.info you initially access a DNS server to translate the host portion (stokes) combined with the Top Level Domain (info) of the URL, to an IP address like ```65.50.123.149```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows; U; Win 9x 4.90; SG; rv:1.9.2.4) Gecko/20101104 Netscape/9.1.0285```

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```10.198.163.178``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  10.198.163.178    UGScg  en0
...
<pre>
default   fe80:a41c:f7f6:a0ba:450e%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {59.1.54.228, 233.101.217.140}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 5d:58:75:27:77:6b
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr a8:ad:10:e7:9b:7d
}</pre>
