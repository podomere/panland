...
subtitle: "Value Add?"
layout: research
ip_v4_address: "39.245.185.105"
date: 2023-10-29T15:13:30+00:00
draft: false
---

## Internet Addressing
On the Internet you might have a Public IPv4 address like ```39.245.185.105``` or an IPv6 address like ```2000:4252:ac29:aae5:96c9:a0f4:de15:2997```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```31:c3:d5:7c:a2:86```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://monahan-russel.biz you initially access a DNS server to translate the host portion (monahan-russel) combined with the Top Level Domain (biz) of the URL, to an IP address like ```96.171.75.106```. Your computer and browser actually sends its type with all web requests e.g. <br>```Opera/9.80 (X11; Linux i686; Ubuntu/14.10) Presto/2.12.388 Version/12.16```
...
<pre>
default   9c41:ec53:81:f782:34d9:65f9:b9a3:ee10%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {130.81.23.144, 28.124.242.34}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 31:c3:d5:7c:a2:86
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 62:7a:d6:1a:74:1f
}</pre>
