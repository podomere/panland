...
layout: research
ip_v4_address: "46.194.138.160"
date: 2022-11-02T11:32:58+00:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like ```46.194.138.160``` or an IPv6 address like ```2000:9b6b:a059:e0bf:87cf:45f3:c3cf:2533```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```3e:7f:05:ae:06:54```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://kozey-schimmel.io you initially access a DNS server to translate the host portion (kozey-schimmel) combined with the Top Level Domain (io) of the URL, to an IP address like ```127.150.94.167```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (compatible; MSIE 9.0; AOL 9.7; AOLBuild 4343.19; Windows NT 6.1; WOW64; Trident/5.0; FunWebProducts)```
...
<pre>
default   fe80:99dc:855c:b9b2:5caf%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {166.79.81.232, 234.143.61.137}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 3e:7f:05:ae:06:54
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 20:54:5a:7a:7c:0d
}</pre>
