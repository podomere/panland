...
layout: research
ip_v4_address: "243.27.117.8"
date: 2023-10-06T17:11:08+01:00
draft: false
---

## Internet Addressing
On the Internet you might get a Public IPv4 address like ```243.27.117.8``` or an IPv6 address like ```2000:2389:37c6:a5b5:fb30:8809:ad20:f061```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```18:37:00:9e:72:6e```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://kunze-steuber.com you initially access a DNS server to translate the host portion (kunze-steuber) combined with the Top Level Domain (com) of the URL, to an IP address like ```237.172.96.131```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows; U; Win 9x 4.90; SG; rv:1.9.2.4) Gecko/20101104 Netscape/9.1.0285```
...
<pre>
default   fe80:3058:c735:bc1c:6800%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {189.8.115.178, 124.184.204.5}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 18:37:00:9e:72:6e
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr fe:1d:58:8d:66:d1
}</pre>
