...
layout: research
ip_v4_address: "196.163.143.79"
date: 2022-11-19T16:17:05+00:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like ```196.163.143.79``` or an IPv6 address like ```2000:8cea:1d47:ce66:ae96:4420:71ae:f192```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```a4:df:d1:75:e2:84```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://purdy-fritsch.co you initially access a DNS server to translate the host portion (purdy-fritsch) combined with the Top Level Domain (co) of the URL, to an IP address like ```180.79.225.112```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (compatible; MSIE 9.0; AOL 9.7; AOLBuild 4343.19; Windows NT 6.1; WOW64; Trident/5.0; FunWebProducts)```
...
<pre>
default   fe80:fefa:a185:9910:670%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {74.141.205.184, 214.23.116.103}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr a4:df:d1:75:e2:84
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr ad:d5:9c:57:4f:a1
}</pre>
