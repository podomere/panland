...
layout: research
ip_v4_address: "211.217.165.37"
date: 2022-11-19T16:17:11+00:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like ```211.217.165.37``` or an IPv6 address like ```2000:8ac7:beaa:72bf:bfa6:e3f9:a85c:7d1e```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```b9:dc:28:90:4e:fb```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://bogan.io you initially access a DNS server to translate the host portion (bogan) combined with the Top Level Domain (io) of the URL, to an IP address like ```168.106.249.54```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows; U; Win 9x 4.90; SG; rv:1.9.2.4) Gecko/20101104 Netscape/9.1.0285```
...
<pre>
default   fe80:a23e:a79f:374a:aede%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {99.194.93.175, 157.86.251.225}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr b9:dc:28:90:4e:fb
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 24:90:65:e3:41:91
}</pre>
...
## Apple macOS / OSX
No matter what version of OSX/macOS you are on, ```10.14.6```, ```11.5.9```, or ```12.3.8```, there are a range of tools for troubleshooting. Unfortunately, between these manual actions and scripts, they don't give you a series of correlated values over time. This is where automated remote troubleshooting comes in to its own, especially for teams that embrace remote work and Work From Anywhere (WFA).
