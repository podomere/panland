...
layout: research
ip_v4_address: "74.138.105.160"
date: 2022-12-15T13:50:11+00:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like ```74.138.105.160``` or an IPv6 address like ```2000:8fbe:fe89:c184:61d4:c53e:fbf:448c```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```1a:f1:aa:ea:df:5e```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://conroy-hermiston.co you initially access a DNS server to translate the host portion (conroy-hermiston) combined with the Top Level Domain (co) of the URL, to an IP address like ```28.78.206.82```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows; U; Win 9x 4.90; SG; rv:1.9.2.4) Gecko/20101104 Netscape/9.1.0285```

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```192.168.69.42``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  192.168.69.42    UGScg  en0
...
<pre>
default   fe80:258:166e:fa96:b5d3%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {237.14.214.191, 174.76.26.11}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 1a:f1:aa:ea:df:5e
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr b6:95:b5:76:f3:da
}</pre>
