...
layout: research
ip_v4_address: "77.184.5.3"
date: 2023-10-29T15:13:19+00:00
draft: false
---

## Internet Addressing
On the Internet you may have a Public IPv4 address like ```77.184.5.3``` or an IPv6 address like ```2000:f48:35f6:4e5e:764a:206d:8f0d:c937```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```ed:43:17:78:db:fb```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://gottlieb-spinka.com you initially access a DNS server to translate the host portion (gottlieb-spinka) combined with the Top Level Domain (com) of the URL, to an IP address like ```197.204.210.138```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1; WOW64; Trident/7.0; AS; rv:11.0) like Gecko```
...
<pre>
default   fe80:b30:4790:8b28:a1fb%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {141.65.13.174, 134.230.54.110}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr ed:43:17:78:db:fb
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 60:aa:ba:b1:44:e2
}</pre>
