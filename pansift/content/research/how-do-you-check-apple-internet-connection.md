...
layout: research
ip_v4_address: "71.203.143.182"
date: 2022-06-04T14:38:30+01:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like ```71.203.143.182``` or an IPv6 address like ```2000:3fa1:c5d2:987c:b9eb:bc45:b91:2282```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```be:4b:4b:10:2f:7b```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://rolfson-kautzer.org you initially access a DNS server to translate the host portion (rolfson-kautzer) combined with the Top Level Domain (org) of the URL, to an IP address like ```64.14.99.216```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows; U; Win 9x 4.90; SG; rv:1.9.2.4) Gecko/20101104 Netscape/9.1.0285```
...
<pre>
default   fe80:7503:49dd:3928:f893%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {190.23.26.205, 0.44.247.194}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr be:4b:4b:10:2f:7b
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 31:6c:5f:75:e0:62
}</pre>
