...
layout: research
ip_v4_address: "235.45.106.210"
date: 2022-11-02T11:32:52+00:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like ```235.45.106.210``` or an IPv6 address like ```2000:d873:a964:eaf7:a590:a821:9c23:9432```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```0c:ea:db:8a:6e:50```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://kiehn-mosciski.info you initially access a DNS server to translate the host portion (kiehn-mosciski) combined with the Top Level Domain (info) of the URL, to an IP address like ```13.201.204.50```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (compatible; MSIE 9.0; AOL 9.7; AOLBuild 4343.19; Windows NT 6.1; WOW64; Trident/5.0; FunWebProducts)```
...
<pre>
default   fe80:2707:c503:92fa:73dd%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {167.143.206.29, 52.67.133.58}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 0c:ea:db:8a:6e:50
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 7c:d5:16:73:a5:0c
}</pre>
