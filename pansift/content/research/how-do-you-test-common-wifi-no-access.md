...
layout: research
ip_v4_address: "143.120.123.82"
date: 2022-12-15T13:50:04+00:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like ```143.120.123.82``` or an IPv6 address like ```2000:4414:1aa6:9819:5cd:fdb3:6d8:6faf```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```e4:6e:a2:77:4a:12```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://schneider-wisozk.net you initially access a DNS server to translate the host portion (schneider-wisozk) combined with the Top Level Domain (net) of the URL, to an IP address like ```68.35.61.242```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_3) AppleWebKit/537.75.14 (KHTML, like Gecko) Version/7.0.3 Safari/7046A194A```
...
<pre>
default   fe80:7e84:46a9:642b:298a%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {173.176.28.214, 153.191.80.220}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr e4:6e:a2:77:4a:12
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 09:ed:15:fb:14:20
}</pre>
