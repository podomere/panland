...
subtitle: "Deep Dive?"
layout: research
ip_v4_address: "234.7.223.223"
date: 2022-12-15T13:50:16+00:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like ```234.7.223.223``` or an IPv6 address like ```2000:e2b9:6fa3:5eea:1add:f551:f8e7:63cd```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```7d:e9:76:24:6d:6d```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://satterfield-littel.biz you initially access a DNS server to translate the host portion (satterfield-littel) combined with the Top Level Domain (biz) of the URL, to an IP address like ```215.234.59.33```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT x.y; Win64; x64; rv:10.0) Gecko/20100101 Firefox/10.0```
...
<pre>
default   fe80:666c:aa0d:532e:4910%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {52.53.5.35, 162.125.232.188}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 7d:e9:76:24:6d:6d
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 70:c3:1c:fc:9e:83
}</pre>
