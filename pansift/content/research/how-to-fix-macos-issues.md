...
subtitle: "Value Add?"
layout: research
ip_v4_address: "166.92.51.36"
date: 2023-10-06T17:10:40+01:00
draft: false
---

## Internet Addressing
On the Internet you might have a Public IPv4 address like ```166.92.51.36``` or an IPv6 address like ```2000:83e0:72aa:9395:78e6:3e4f:db31:c0f0```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```1c:05:de:8c:6b:74```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://denesik-funk.com you initially access a DNS server to translate the host portion (denesik-funk) combined with the Top Level Domain (com) of the URL, to an IP address like ```197.4.71.114```. Your computer and browser actually sends its type with all web requests e.g. <br>```Opera/9.80 (X11; Linux i686; Ubuntu/14.10) Presto/2.12.388 Version/12.16```
...
<pre>
default   fe80:187f:35e8:fcbc:9bd4%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {191.188.205.101, 67.221.33.215}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 1c:05:de:8c:6b:74
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr c0:44:c5:15:c5:f9
}</pre>
