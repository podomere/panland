...
subtitle: "Swim Lane?"
layout: research
ip_v4_address: "192.37.38.86"
date: 2022-04-24T18:32:41+01:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like <code>192.37.38.86</code> or an IPv6 address like <code>2000:370f:9485:441e:9f53:e429:1f84:cae</code>. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>4d:ad:25:4e:ac:9d</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://von.name you initially access a DNS server to translate the host portion (von) combined with the Top Level Domain (name) of the URL, to an IP address like <code>151.148.238.188</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (Windows NT x.y; Win64; x64; rv:10.0) Gecko/20100101 Firefox/10.0</code>
...
default  172.27.170.220    UGScg  en0
...
<pre><code>
default   fe80:4c28:4321:701d:d286%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {93.210.109.6, 10.192.211.159}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 4d:ad:25:4e:ac:9d
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr cb:41:ab:57:0c:10
}</code></pre>
