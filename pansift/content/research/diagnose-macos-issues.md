...
layout: research
ip_v4_address: "21.162.223.99"
date: 2022-11-19T16:17:11+00:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like ```21.162.223.99``` or an IPv6 address like ```2000:7d03:5876:633d:f9e6:d90b:4745:8eb7```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```c5:42:58:dc:96:32```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://smith-jacobi.name you initially access a DNS server to translate the host portion (smith-jacobi) combined with the Top Level Domain (name) of the URL, to an IP address like ```232.29.45.240```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_3) AppleWebKit/537.75.14 (KHTML, like Gecko) Version/7.0.3 Safari/7046A194A```
...
<pre>
default   fe80:314a:9f60:58b0:6ede%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {6.66.230.199, 203.125.255.239}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr c5:42:58:dc:96:32
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 1e:a0:80:33:3a:0e
}</pre>
