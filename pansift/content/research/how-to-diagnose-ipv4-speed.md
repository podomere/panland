...
layout: research
ip_v4_address: "81.150.238.99"
date: 2022-12-15T13:50:17+00:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like ```81.150.238.99``` or an IPv6 address like ```2000:7bfc:75f4:4ff6:2cd7:3d4d:c96d:ee8d```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```b8:45:2f:17:b4:cc```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://stracke.co you initially access a DNS server to translate the host portion (stracke) combined with the Top Level Domain (co) of the URL, to an IP address like ```255.199.215.247```. Your computer and browser actually sends its type with all web requests e.g. <br>```Opera/9.80 (X11; Linux i686; Ubuntu/14.10) Presto/2.12.388 Version/12.16```
...
<pre>
default   fe80:2fb4:bee8:49e7:ed3e%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {97.101.115.61, 77.125.146.17}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr b8:45:2f:17:b4:cc
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr dd:96:f5:e1:d6:c9
}</pre>
