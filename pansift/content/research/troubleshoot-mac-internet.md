...
layout: research
ip_v4_address: "196.80.53.96"
date: 2022-11-02T11:33:11+00:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like ```196.80.53.96``` or an IPv6 address like ```2000:bb26:56ee:eff7:31a6:4c4e:27e8:c968```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```3d:5d:d8:c9:ab:42```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://feeney-schiller.biz you initially access a DNS server to translate the host portion (feeney-schiller) combined with the Top Level Domain (biz) of the URL, to an IP address like ```59.56.103.15```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT x.y; Win64; x64; rv:10.0) Gecko/20100101 Firefox/10.0```
...
<pre>
default   fe80:5eb2:a88c:46ac:747%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {152.242.195.43, 151.211.83.244}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 3d:5d:d8:c9:ab:42
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 51:33:3e:08:7e:f6
}</pre>
