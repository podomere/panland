...
layout: research
ip_v4_address: "180.82.231.79"
date: 2022-11-19T19:13:26+00:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like ```180.82.231.79``` or an IPv6 address like ```2000:24dd:5cb5:4676:736a:d171:55ca:3c25```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```7a:8b:ef:c3:ab:d8```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://altenwerth.info you initially access a DNS server to translate the host portion (altenwerth) combined with the Top Level Domain (info) of the URL, to an IP address like ```192.125.163.59```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_3) AppleWebKit/537.75.14 (KHTML, like Gecko) Version/7.0.3 Safari/7046A194A```
...
default  172.18.24.78    UGScg  en0
...
<pre>
default   fe80:684f:9c0:b226:493c%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {79.126.177.128, 194.232.195.73}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 7a:8b:ef:c3:ab:d8
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr be:54:6d:b8:93:55
}</pre>
