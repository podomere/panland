...
subtitle: "Tee It Up?"
layout: research
ip_v4_address: "159.26.148.33"
date: 2022-11-19T16:17:21+00:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like ```159.26.148.33``` or an IPv6 address like ```2000:d314:9f51:5a1:4f49:da00:3a34:56b1```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```83:73:7b:12:7c:43```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://abernathy.io you initially access a DNS server to translate the host portion (abernathy) combined with the Top Level Domain (io) of the URL, to an IP address like ```230.244.6.72```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT x.y; Win64; x64; rv:10.0) Gecko/20100101 Firefox/10.0```

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```192.168.118.20``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  192.168.118.20    UGScg  en0
...
<pre>
default   fe80:8bfb:3374:46f3:bf57%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {36.75.182.222, 18.187.242.3}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 83:73:7b:12:7c:43
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr da:61:4f:28:b8:c3
}</pre>
...
## Apple macOS / OSX
No matter what version of OSX/macOS you are on, ```10.12.1```, ```11.4.6```, or ```12.1.8```, there are a range of tools for troubleshooting. Unfortunately, between these manual actions and scripts, they don't give you a series of correlated values over time. This is where automated remote troubleshooting comes in to its own, especially for teams that embrace remote work and Work From Anywhere (WFA).
