...
layout: research
ip_v4_address: "113.152.126.142"
date: 2022-06-04T14:38:40+01:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like ```113.152.126.142``` or an IPv6 address like ```2000:46b:b8f3:c881:4706:a65e:a363:bdc3```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```8b:69:23:56:6e:e7```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://bahringer.net you initially access a DNS server to translate the host portion (bahringer) combined with the Top Level Domain (net) of the URL, to an IP address like ```249.74.246.43```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_3) AppleWebKit/537.75.14 (KHTML, like Gecko) Version/7.0.3 Safari/7046A194A```
...
<pre>
default   fe80:f4bf:367b:a8a4:14b7%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {149.248.22.76, 242.63.53.77}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 8b:69:23:56:6e:e7
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 38:91:d5:44:24:b1
}</pre>
