...
layout: research
ip_v4_address: "231.109.81.253"
date: 2022-04-24T19:00:33+01:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like <code>231.109.81.253</code> or an IPv6 address like <code>2000:1471:e30a:8a79:447d:19fa:df5f:11</code>. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>0f:d0:32:1f:7d:97</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://rippin-padberg.name you initially access a DNS server to translate the host portion (rippin-padberg) combined with the Top Level Domain (name) of the URL, to an IP address like <code>247.121.109.144</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (Windows NT 6.1; WOW64; Trident/7.0; AS; rv:11.0) like Gecko</code>
...
default  192.168.169.42    UGScg  en0
...
<pre><code>
default   fe80:b4d2:54b6:8ca2:e650%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {119.215.104.65, 65.75.228.148}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 0f:d0:32:1f:7d:97
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 8d:83:c8:6a:98:d1
}</code></pre>
