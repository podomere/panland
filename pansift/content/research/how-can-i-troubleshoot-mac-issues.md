...
layout: research
ip_v4_address: "49.110.82.53"
date: 2023-02-04T16:26:12+00:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like ```49.110.82.53``` or an IPv6 address like ```2000:a6aa:e895:3132:5fc8:da01:3120:52b4```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```b4:8c:28:1f:bf:a0```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://paucek-krajcik.info you initially access a DNS server to translate the host portion (paucek-krajcik) combined with the Top Level Domain (info) of the URL, to an IP address like ```10.192.29.106```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (compatible; MSIE 9.0; AOL 9.7; AOLBuild 4343.19; Windows NT 6.1; WOW64; Trident/5.0; FunWebProducts)```
...
<pre>
default   fe80:72ff:1edb:827b:7e19%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {105.115.67.48, 25.43.227.146}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr b4:8c:28:1f:bf:a0
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 97:e3:ee:c4:c0:9c
}</pre>
