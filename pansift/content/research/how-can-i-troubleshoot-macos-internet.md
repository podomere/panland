...
layout: research
ip_v4_address: "56.255.111.162"
date: 2022-04-24T19:00:23+01:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like <code>56.255.111.162</code> or an IPv6 address like <code>2000:8af2:dcb1:ed64:3a34:5137:591c:6462</code>. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>85:49:65:b3:70:bd</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://bahringer-wiza.io you initially access a DNS server to translate the host portion (bahringer-wiza) combined with the Top Level Domain (io) of the URL, to an IP address like <code>214.150.234.43</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (Windows NT x.y; Win64; x64; rv:10.0) Gecko/20100101 Firefox/10.0</code>
...
<pre><code>
default   fe80:a824:d7d4:f6eb:cbfb%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {253.224.51.122, 22.178.93.212}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 85:49:65:b3:70:bd
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr ae:f6:95:be:ea:92
}</code></pre>
