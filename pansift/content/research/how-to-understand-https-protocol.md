...
layout: research
ip_v4_address: "99.150.205.90"
date: 2022-04-24T19:00:06+01:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like <code>99.150.205.90</code> or an IPv6 address like <code>2000:f154:ceaa:5d42:b36a:4b4b:b0ed:e039</code>. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>9a:5c:e5:fe:9a:1a</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://brekke-legros.biz you initially access a DNS server to translate the host portion (brekke-legros) combined with the Top Level Domain (biz) of the URL, to an IP address like <code>94.194.200.59</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (compatible; MSIE 9.0; AOL 9.7; AOLBuild 4343.19; Windows NT 6.1; WOW64; Trident/5.0; FunWebProducts)</code>
...
<pre><code>
default   fe80:884b:cdf4:1315:7112%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {242.157.112.65, 157.183.121.26}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 9a:5c:e5:fe:9a:1a
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 42:76:06:c3:0d:5e
}</code></pre>
