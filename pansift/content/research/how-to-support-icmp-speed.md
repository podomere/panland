...
layout: research
ip_v4_address: "86.0.187.221"
date: 2023-02-04T16:26:21+00:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like ```86.0.187.221``` or an IPv6 address like ```2000:95cc:3ae6:c67:8f34:505c:1289:deb2```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```b2:1b:91:ae:19:5b```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://douglas-rempel.biz you initially access a DNS server to translate the host portion (douglas-rempel) combined with the Top Level Domain (biz) of the URL, to an IP address like ```55.143.10.100```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (compatible; MSIE 9.0; AOL 9.7; AOLBuild 4343.19; Windows NT 6.1; WOW64; Trident/5.0; FunWebProducts)```
...
<pre>
default   fe80:ee81:1107:a66e:e57c%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {190.187.249.50, 185.241.32.56}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr b2:1b:91:ae:19:5b
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 4f:31:d6:2b:ee:61
}</pre>
