...
layout: research
ip_v4_address: "3.26.95.161"
date: 2023-10-29T15:13:29+00:00
draft: false
---

## Internet Addressing
On the Internet you might get a Public IPv4 address like ```3.26.95.161``` or an IPv6 address like ```2000:928e:36dc:14ba:9e5b:db6f:7774:22bd```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```83:a8:8a:71:82:de```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://rogahn-ohara.info you initially access a DNS server to translate the host portion (rogahn-ohara) combined with the Top Level Domain (info) of the URL, to an IP address like ```134.189.244.177```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows; U; Win 9x 4.90; SG; rv:1.9.2.4) Gecko/20101104 Netscape/9.1.0285```
...
<pre>
default   fe80:9ad8:5486:756d:5402%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {231.58.197.239, 98.111.146.80}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 83:a8:8a:71:82:de
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr da:79:ae:70:88:b5
}</pre>
