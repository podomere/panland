...
subtitle: "Swim Lane?"
layout: research
ip_v4_address: "247.50.78.59"
date: 2023-02-04T17:07:49+00:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like ```247.50.78.59``` or an IPv6 address like ```2000:9d0b:3b8e:c46b:be57:3212:d699:de15```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```ab:ab:38:03:36:00```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://green-stracke.co you initially access a DNS server to translate the host portion (green-stracke) combined with the Top Level Domain (co) of the URL, to an IP address like ```200.217.204.213```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (compatible; MSIE 9.0; AOL 9.7; AOLBuild 4343.19; Windows NT 6.1; WOW64; Trident/5.0; FunWebProducts)```
...
<pre>
default   fe80:3125:1bd2:b319:eacc%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {83.191.243.139, 207.34.28.115}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr ab:ab:38:03:36:00
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr ff:aa:2e:01:d3:66
}</pre>
