...
subtitle: "Swag?"
layout: research
ip_v4_address: "253.65.251.156"
date: 2022-11-19T19:13:09+00:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like ```253.65.251.156``` or an IPv6 address like ```2000:95c8:6e85:30b:6778:5d2d:2d24:8dd5```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```1b:d6:c0:11:49:7b```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://boyle-crooks.name you initially access a DNS server to translate the host portion (boyle-crooks) combined with the Top Level Domain (name) of the URL, to an IP address like ```23.57.20.86```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1; WOW64; Trident/7.0; AS; rv:11.0) like Gecko```
...
<pre>
default   fe80:78b8:6a4c:355f:ee83%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {224.139.149.159, 201.37.177.85}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 1b:d6:c0:11:49:7b
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 35:17:c2:d9:d1:a9
}</pre>
