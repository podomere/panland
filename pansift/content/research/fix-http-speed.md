...
layout: research
ip_v4_address: "108.140.210.44"
date: 2023-02-04T16:26:22+00:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like ```108.140.210.44``` or an IPv6 address like ```2000:51d1:8fbf:e8b6:f9a6:dd9d:8068:ad68```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```2c:78:48:6c:e3:6d```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://kihn-schulist.name you initially access a DNS server to translate the host portion (kihn-schulist) combined with the Top Level Domain (name) of the URL, to an IP address like ```13.28.92.254```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (compatible; MSIE 9.0; AOL 9.7; AOLBuild 4343.19; Windows NT 6.1; WOW64; Trident/5.0; FunWebProducts)```
...
<pre>
default   fe80:76d:deb5:8d5d:6731%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {246.233.111.52, 194.251.154.174}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 2c:78:48:6c:e3:6d
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 9d:25:37:25:8f:56
}</pre>
