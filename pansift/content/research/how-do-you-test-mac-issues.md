...
layout: research
ip_v4_address: "82.219.166.170"
date: 2022-04-24T18:31:59+01:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like <code>82.219.166.170</code> or an IPv6 address like <code>2000:dc99:c34a:c7d1:1154:d353:ecca:b83b</code>. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>83:74:8b:27:97:01</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://bode-rau.com you initially access a DNS server to translate the host portion (bode-rau) combined with the Top Level Domain (com) of the URL, to an IP address like <code>194.116.176.248</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Opera/9.80 (X11; Linux i686; Ubuntu/14.10) Presto/2.12.388 Version/12.16</code>
...
<pre><code>
default   fe80:d6e2:26c7:7277:ba11%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {6.49.118.211, 60.83.86.2}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 83:74:8b:27:97:01
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 58:5f:0c:3d:ea:07
}</code></pre>
