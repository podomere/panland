---
title: "How Can I Troubleshoot Http Internet Issues"
subtitle: "Button Up The Loose Ends?"
layout: research
ip_v4_address: "8.50.41.227"
date: 2022-11-19T16:17:24+00:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like ```8.50.41.227``` or an IPv6 address like ```2000:e0ea:24a9:5777:ab20:80fd:6de8:8899```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```ec:07:17:f8:16:3d```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://macgyver.biz you initially access a DNS server to translate the host portion (macgyver) combined with the Top Level Domain (biz) of the URL, to an IP address like ```155.58.175.28```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT x.y; Win64; x64; rv:10.0) Gecko/20100101 Firefox/10.0```

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```192.168.160.163``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  192.168.160.163    UGScg  en0
...
<pre>
default   fe80:f518:1302:ad7:7c6a%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {236.191.201.228, 37.216.179.221}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr ec:07:17:f8:16:3d
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 9e:2b:f5:40:ec:19
}</pre>
...
## Apple macOS / OSX
No matter what version of OSX/macOS you are on, ```10.15.5```, ```11.6.3```, or ```12.1.3```, there are a range of tools for troubleshooting. Unfortunately, between these manual actions and scripts, they don't give you a series of correlated values over time. This is where automated remote troubleshooting comes in to its own, especially for teams that embrace remote work and Work From Anywhere (WFA).
