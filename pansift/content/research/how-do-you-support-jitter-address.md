...
layout: research
ip_v4_address: "191.130.44.133"
date: 2022-04-24T19:00:00+01:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like <code>191.130.44.133</code> or an IPv6 address like <code>2000:417a:c826:cf0a:fbbd:3d42:e2c2:92e</code>. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>ff:c9:18:0e:a0:04</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://weimann-runolfsdottir.io you initially access a DNS server to translate the host portion (weimann-runolfsdottir) combined with the Top Level Domain (io) of the URL, to an IP address like <code>8.58.155.19</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (Windows NT 6.1; WOW64; Trident/7.0; AS; rv:11.0) like Gecko</code>

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like <code>172.17.170.72</code> (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For <code>IPv6</code> we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  172.17.170.72    UGScg  en0
...
<pre><code>
default   fe80:8c3e:b2c8:3239:cf8d%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {144.31.239.84, 115.151.200.30}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr ff:c9:18:0e:a0:04
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 56:26:ec:4e:56:de
}</code></pre>
