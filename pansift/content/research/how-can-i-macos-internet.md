...
subtitle: "Value Add?"
layout: research
ip_v4_address: "208.65.52.69"
date: 2022-06-12T14:09:15+01:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like ```208.65.52.69``` or an IPv6 address like ```2000:ce2a:f6c2:187d:d036:250e:f8fe:348d```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```8b:3f:d8:ab:e1:19```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://greenholt-jenkins.info you initially access a DNS server to translate the host portion (greenholt-jenkins) combined with the Top Level Domain (info) of the URL, to an IP address like ```3.138.128.39```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1; WOW64; Trident/7.0; AS; rv:11.0) like Gecko```
...
<pre>
default   fe80:fc13:3152:9418:2dc4%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {125.247.244.53, 187.107.16.252}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 8b:3f:d8:ab:e1:19
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr e2:b4:ab:43:f1:14
}</pre>
...
## Apple macOS / OSX
No matter what version of OSX/macOS you are on, ```10.13.8```, ```11.3.7```, or ```12.2.1```, there are a range of tools for troubleshooting. Unfortunately, between these manual actions and scripts, they don't give you a series of correlated values over time. This is where automated remote troubleshooting comes in to its own, especially for teams that embrace remote work and Work From Anywhere (WFA).
