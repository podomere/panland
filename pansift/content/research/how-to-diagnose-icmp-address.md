...
layout: research
ip_v4_address: "44.141.107.61"
date: 2023-10-29T15:13:27+00:00
draft: false
---

## Internet Addressing
On the Internet you might have a Public IPv4 address like ```44.141.107.61``` or an IPv6 address like ```2000:d335:e9df:aed1:90d1:4f4f:e88a:a916```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```d5:3e:9e:fe:d4:4b```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://windler-mann.name you initially access a DNS server to translate the host portion (windler-mann) combined with the Top Level Domain (name) of the URL, to an IP address like ```225.37.155.162```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (compatible; MSIE 9.0; AOL 9.7; AOLBuild 4343.19; Windows NT 6.1; WOW64; Trident/5.0; FunWebProducts)```
...
<pre>
default   fe80:6102:857e:5f2c:3585%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {129.220.69.81, 7.88.105.38}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr d5:3e:9e:fe:d4:4b
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr b3:df:cf:3f:f0:ad
}</pre>
