...
layout: research
ip_v4_address: "40.132.38.105"
date: 2022-11-19T19:13:15+00:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like ```40.132.38.105``` or an IPv6 address like ```2000:8818:14bb:172f:a55b:470b:1898:864a```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```ac:90:92:ff:3a:c7```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://harber.io you initially access a DNS server to translate the host portion (harber) combined with the Top Level Domain (io) of the URL, to an IP address like ```235.22.99.109```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_3) AppleWebKit/537.75.14 (KHTML, like Gecko) Version/7.0.3 Safari/7046A194A```
...
default  192.168.170.61    UGScg  en0
...
<pre>
default   fe80:d012:92b1:55bb:4e9c%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {147.33.194.175, 222.85.154.53}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr ac:90:92:ff:3a:c7
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 95:cf:dd:d1:fb:b8
}</pre>
