...
layout: research
ip_v4_address: "10.241.18.191"
date: 2022-04-24T19:00:01+01:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like <code>10.241.18.191</code> or an IPv6 address like <code>2000:593c:20a8:3a5:b0b4:43cb:6ffc:9128</code>. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>7a:4f:4c:4c:50:0f</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://stanton-west.name you initially access a DNS server to translate the host portion (stanton-west) combined with the Top Level Domain (name) of the URL, to an IP address like <code>5.51.46.229</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (Windows NT x.y; Win64; x64; rv:10.0) Gecko/20100101 Firefox/10.0</code>
...
<pre><code>
default   fe80:cdc6:1b22:51b2:b941%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {177.248.69.32, 12.112.240.66}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 7a:4f:4c:4c:50:0f
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 05:d6:09:f0:57:ef
}</code></pre>
