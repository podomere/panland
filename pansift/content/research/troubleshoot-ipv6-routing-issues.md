...
layout: research
ip_v4_address: "236.127.143.71"
date: 2022-11-19T16:17:19+00:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like ```236.127.143.71``` or an IPv6 address like ```2000:32f7:b376:e5a2:e857:ed0e:1dc:b79d```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```39:a3:e1:43:23:78```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://lueilwitz-crona.net you initially access a DNS server to translate the host portion (lueilwitz-crona) combined with the Top Level Domain (net) of the URL, to an IP address like ```83.233.229.116```. Your computer and browser actually sends its type with all web requests e.g. <br>```Opera/9.80 (X11; Linux i686; Ubuntu/14.10) Presto/2.12.388 Version/12.16```
...
<pre>
default   fe80:1eff:3665:3c50:954e%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {66.72.241.64, 58.52.139.205}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 39:a3:e1:43:23:78
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr ee:52:d7:77:18:19
}</pre>
