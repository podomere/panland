...
subtitle: "Impact Map?"
layout: research
ip_v4_address: "22.116.165.254"
date: 2022-06-12T14:09:05+01:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like ```22.116.165.254``` or an IPv6 address like ```2000:a126:269a:9a72:147b:e8ac:e19c:af72```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```ff:8b:df:54:c3:e4```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://koepp-feest.io you initially access a DNS server to translate the host portion (koepp-feest) combined with the Top Level Domain (io) of the URL, to an IP address like ```68.60.197.254```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_3) AppleWebKit/537.75.14 (KHTML, like Gecko) Version/7.0.3 Safari/7046A194A```
...
<pre>
default   fe80:231e:9a5c:f847:ae71%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {173.153.96.201, 104.156.203.62}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr ff:8b:df:54:c3:e4
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 88:6d:91:d4:fb:18
}</pre>
