...
layout: research
ip_v4_address: "226.123.122.91"
date: 2022-06-04T14:38:44+01:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like ```226.123.122.91``` or an IPv6 address like ```2000:a339:1ff3:1992:a7fc:7701:4bc8:cb3```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```24:f2:8b:72:e2:3b```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://berge-barrows.io you initially access a DNS server to translate the host portion (berge-barrows) combined with the Top Level Domain (io) of the URL, to an IP address like ```104.96.1.67```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (compatible; MSIE 9.0; AOL 9.7; AOLBuild 4343.19; Windows NT 6.1; WOW64; Trident/5.0; FunWebProducts)```
...
<pre>
default   fe80:7c6d:61f3:5bf8:606%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {154.25.11.65, 205.179.147.241}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 24:f2:8b:72:e2:3b
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr aa:01:ef:64:45:fd
}</pre>
