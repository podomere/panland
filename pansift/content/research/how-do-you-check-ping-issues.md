...
subtitle: "Synergy?"
layout: research
ip_v4_address: "137.51.122.120"
date: 2022-06-12T14:09:27+01:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like ```137.51.122.120``` or an IPv6 address like ```2000:ac94:d5ab:9a30:c48f:f361:f35c:a214```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```d4:17:1e:a4:64:fa```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://hahn.co you initially access a DNS server to translate the host portion (hahn) combined with the Top Level Domain (co) of the URL, to an IP address like ```83.206.163.133```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/41.0.2228.0 Safari/537.36```
...
<pre>
default   fe80:af3c:d06a:d2fc:57b3%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {147.107.253.81, 53.94.69.25}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr d4:17:1e:a4:64:fa
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 37:da:01:9f:78:72
}</pre>
