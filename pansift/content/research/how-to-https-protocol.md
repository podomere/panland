...
layout: research
ip_v4_address: "53.126.114.218"
date: 2022-11-02T11:33:01+00:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like ```53.126.114.218``` or an IPv6 address like ```2000:191c:c680:c44f:f17:5a15:4b89:8d63```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```d3:2d:fc:ef:72:44```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://durgan-nolan.co you initially access a DNS server to translate the host portion (durgan-nolan) combined with the Top Level Domain (co) of the URL, to an IP address like ```225.128.87.89```. Your computer and browser actually sends its type with all web requests e.g. <br>```Opera/9.80 (X11; Linux i686; Ubuntu/14.10) Presto/2.12.388 Version/12.16```
...
<pre>
default   fe80:30e6:9345:dabb:d31f%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {203.66.187.254, 63.32.116.198}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr d3:2d:fc:ef:72:44
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 3e:13:90:ea:3f:d1
}</pre>
