...
layout: research
ip_v4_address: "126.90.152.186"
date: 2022-04-24T18:31:59+01:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like <code>126.90.152.186</code> or an IPv6 address like <code>2000:a1f0:2638:3af1:9ecf:8b5a:25e6:b6de</code>. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>1f:57:75:df:f8:c7</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://aufderhar.net you initially access a DNS server to translate the host portion (aufderhar) combined with the Top Level Domain (net) of the URL, to an IP address like <code>239.31.43.169</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (compatible; MSIE 9.0; AOL 9.7; AOLBuild 4343.19; Windows NT 6.1; WOW64; Trident/5.0; FunWebProducts)</code>

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like <code>10.152.153.19</code> (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For <code>IPv6</code> we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  10.152.153.19    UGScg  en0
...
<pre><code>
default   fe80:5b29:2d1:e094:5b3f%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {7.27.15.184, 103.10.144.12}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 1f:57:75:df:f8:c7
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr c4:f5:2a:1c:cc:b1
}</code></pre>
