...
layout: research
ip_v4_address: "71.242.83.69"
date: 2023-02-04T17:08:40+00:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like ```71.242.83.69``` or an IPv6 address like ```2000:16dc:91b9:9be2:94fd:9e23:12af:9a63```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```a1:7c:13:33:f0:fd```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://yundt-kling.biz you initially access a DNS server to translate the host portion (yundt-kling) combined with the Top Level Domain (biz) of the URL, to an IP address like ```164.130.162.216```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1; WOW64; Trident/7.0; AS; rv:11.0) like Gecko```

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```172.21.78.218``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  172.21.78.218    UGScg  en0
...
<pre>
default   fe80:e4da:1a43:154:8518%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {61.40.207.103, 242.207.181.151}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr a1:7c:13:33:f0:fd
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 81:8e:b3:36:60:a1
}</pre>
...
## Apple macOS / OSX
No matter what version of OSX/macOS you are on, ```10.14.3```, ```11.6.6```, or ```12.1.3```, there are a range of tools for troubleshooting. Unfortunately, between these manual actions and scripts, they don't give you a series of correlated values over time. This is where automated remote troubleshooting comes in to its own, especially for teams that embrace remote work and Work From Anywhere (WFA).
