...
layout: research
ip_v4_address: "169.77.88.195"
date: 2023-10-29T15:13:25+00:00
draft: false
---

## Internet Addressing
On the Internet you may have a Public IPv4 address like ```169.77.88.195``` or an IPv6 address like ```2000:5dfa:4082:c22:fa3e:9f01:5129:7a94```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```25:4e:44:29:0c:7c```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://jacobs-ohara.biz you initially access a DNS server to translate the host portion (jacobs-ohara) combined with the Top Level Domain (biz) of the URL, to an IP address like ```194.38.80.59```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/41.0.2228.0 Safari/537.36```
...
<pre>
default   fe80:1477:ff8:3d3f:d5d6%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {63.6.87.47, 243.84.211.163}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 25:4e:44:29:0c:7c
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 43:6d:bb:83:84:39
}</pre>
