...
layout: research
ip_v4_address: "246.183.191.98"
date: 2022-04-24T19:00:22+01:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like <code>246.183.191.98</code> or an IPv6 address like <code>2000:fccc:ce31:9231:edd5:45b7:1212:c3bc</code>. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>3d:56:76:68:fc:be</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://haag-witting.io you initially access a DNS server to translate the host portion (haag-witting) combined with the Top Level Domain (io) of the URL, to an IP address like <code>27.65.2.219</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_3) AppleWebKit/537.75.14 (KHTML, like Gecko) Version/7.0.3 Safari/7046A194A</code>
...
<pre><code>
default   fe80:6dee:b2e1:f7b8:5822%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {2.51.158.69, 180.206.233.155}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 3d:56:76:68:fc:be
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 56:dc:99:41:77:bd
}</code></pre>
