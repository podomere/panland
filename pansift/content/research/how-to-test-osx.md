...
subtitle: "Learnings?"
layout: research
ip_v4_address: "197.69.145.142"
date: 2022-11-02T11:33:11+00:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like ```197.69.145.142``` or an IPv6 address like ```2000:8e46:1923:2a86:9cdb:2b3f:9b71:b63e```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```31:29:40:1b:1c:84```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://davis-grimes.com you initially access a DNS server to translate the host portion (davis-grimes) combined with the Top Level Domain (com) of the URL, to an IP address like ```134.230.93.80```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/41.0.2228.0 Safari/537.36```

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```10.44.230.164``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  10.44.230.164    UGScg  en0
...
<pre>
default   fe80:d4bc:ad42:9d6a:188a%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {152.210.73.216, 82.29.248.213}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 31:29:40:1b:1c:84
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 93:5f:b1:1e:10:c1
}</pre>
