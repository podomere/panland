...
subtitle: "Learnings?"
layout: research
ip_v4_address: "168.216.238.245"
date: 2022-04-24T18:32:42+01:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like <code>168.216.238.245</code> or an IPv6 address like <code>2000:80ce:52ac:6c8c:aefe:3d58:da56:da44</code>. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>f3:ba:ee:be:ed:ce</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://oreilly.name you initially access a DNS server to translate the host portion (oreilly) combined with the Top Level Domain (name) of the URL, to an IP address like <code>81.32.92.176</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_3) AppleWebKit/537.75.14 (KHTML, like Gecko) Version/7.0.3 Safari/7046A194A</code>

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like <code>172.25.34.193</code> (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For <code>IPv6</code> we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  172.25.34.193    UGScg  en0
...
<pre><code>
default   fe80:624c:2da2:3825:b683%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {57.117.124.129, 85.63.225.63}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr f3:ba:ee:be:ed:ce
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr cc:b1:3b:1f:11:bf
}</code></pre>
