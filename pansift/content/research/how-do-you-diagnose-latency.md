...
layout: research
ip_v4_address: "140.47.101.248"
date: 2022-04-24T18:59:58+01:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like <code>140.47.101.248</code> or an IPv6 address like <code>2000:3a92:b536:b07d:a4ea:25ed:4ccf:e2d9</code>. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>cc:93:01:75:44:2d</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://orn-bednar.net you initially access a DNS server to translate the host portion (orn-bednar) combined with the Top Level Domain (net) of the URL, to an IP address like <code>64.97.81.197</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_3) AppleWebKit/537.75.14 (KHTML, like Gecko) Version/7.0.3 Safari/7046A194A</code>
...
<pre><code>
default   fe80:119b:6a86:985f:6d20%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {220.116.105.130, 150.196.250.135}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr cc:93:01:75:44:2d
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr bb:18:78:f4:66:3e
}</code></pre>
