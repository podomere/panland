...
layout: research
ip_v4_address: "19.203.241.195"
date: 2023-02-04T16:26:21+00:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like ```19.203.241.195``` or an IPv6 address like ```2000:733d:9605:936c:f525:4842:5375:dba1```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```b5:a4:61:65:fe:ff```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://mann-dibbert.com you initially access a DNS server to translate the host portion (mann-dibbert) combined with the Top Level Domain (com) of the URL, to an IP address like ```221.213.108.136```. Your computer and browser actually sends its type with all web requests e.g. <br>```Opera/9.80 (X11; Linux i686; Ubuntu/14.10) Presto/2.12.388 Version/12.16```
...
<pre>
default   fe80:c30a:64b5:6d90:327e%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {101.39.59.199, 7.119.74.210}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr b5:a4:61:65:fe:ff
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr d5:86:bf:3c:ba:1b
}</pre>
