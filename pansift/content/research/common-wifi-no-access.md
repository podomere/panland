...
layout: research
ip_v4_address: "58.175.33.170"
date: 2022-04-24T19:00:33+01:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like <code>58.175.33.170</code> or an IPv6 address like <code>2000:c08d:cdc8:bad2:2779:1bc7:5ec0:a5db</code>. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>35:81:8d:6d:02:b6</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://schamberger-schneider.name you initially access a DNS server to translate the host portion (schamberger-schneider) combined with the Top Level Domain (name) of the URL, to an IP address like <code>136.52.16.56</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (compatible; MSIE 9.0; AOL 9.7; AOLBuild 4343.19; Windows NT 6.1; WOW64; Trident/5.0; FunWebProducts)</code>
...
<pre><code>
default   fe80:7821:41f2:80b6:4994%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {218.247.19.24, 73.150.254.109}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 35:81:8d:6d:02:b6
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 44:93:33:69:7c:79
}</code></pre>
