...
subtitle: "Streamline?"
layout: research
ip_v4_address: "221.173.199.71"
date: 2022-06-12T14:09:05+01:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like ```221.173.199.71``` or an IPv6 address like ```2000:588c:7c99:bd02:39de:d195:1498:ffad```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```73:5b:a2:0c:ea:81```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://waters-ryan.org you initially access a DNS server to translate the host portion (waters-ryan) combined with the Top Level Domain (org) of the URL, to an IP address like ```98.5.191.230```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows; U; Win 9x 4.90; SG; rv:1.9.2.4) Gecko/20101104 Netscape/9.1.0285```
...
<pre>
default   fe80:3d4b:65fb:bf7f:faab%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {37.96.245.155, 150.176.139.35}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 73:5b:a2:0c:ea:81
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 5a:8a:43:6a:22:29
}</pre>
