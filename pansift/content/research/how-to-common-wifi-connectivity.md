...
layout: research
ip_v4_address: "100.123.252.138"
date: 2022-05-05T14:28:28+01:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like ```100.123.252.138``` or an IPv6 address like ```2000:a03b:4a4f:9935:e788:b089:1478:74ca```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```f2:3e:ba:01:88:f3```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://parker-williamson.io you initially access a DNS server to translate the host portion (parker-williamson) combined with the Top Level Domain (io) of the URL, to an IP address like ```231.193.250.102```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1; WOW64; Trident/7.0; AS; rv:11.0) like Gecko```
...
<pre>
default   fe80:bbc3:c0f5:f6c8:ba3b%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {232.23.255.147, 201.186.123.36}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr f2:3e:ba:01:88:f3
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr f9:eb:bd:f2:42:1a
}</pre>
