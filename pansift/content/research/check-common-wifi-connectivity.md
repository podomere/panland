...
subtitle: "Swag?"
layout: research
ip_v4_address: "64.3.246.203"
date: 2022-11-19T19:13:09+00:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like ```64.3.246.203``` or an IPv6 address like ```2000:f707:eabf:c5f4:9b3b:9ae7:b213:e813```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```04:6b:83:2a:ee:b3```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://kirlin-upton.info you initially access a DNS server to translate the host portion (kirlin-upton) combined with the Top Level Domain (info) of the URL, to an IP address like ```236.57.244.59```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (compatible; MSIE 9.0; AOL 9.7; AOLBuild 4343.19; Windows NT 6.1; WOW64; Trident/5.0; FunWebProducts)```
...
<pre>
default   fe80:1807:5c13:ffd6:7949%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {135.235.36.144, 52.105.136.147}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 04:6b:83:2a:ee:b3
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr e8:2c:d5:11:4c:be
}</pre>
