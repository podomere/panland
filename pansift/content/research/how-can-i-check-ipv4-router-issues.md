...
layout: research
ip_v4_address: "14.105.229.65"
date: 2022-06-04T14:38:38+01:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like ```14.105.229.65``` or an IPv6 address like ```2000:eb1b:7716:78e8:dea3:f85d:d359:a235```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```49:03:af:bb:44:9a```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://farrell-buckridge.io you initially access a DNS server to translate the host portion (farrell-buckridge) combined with the Top Level Domain (io) of the URL, to an IP address like ```58.255.138.9```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (compatible; MSIE 9.0; AOL 9.7; AOLBuild 4343.19; Windows NT 6.1; WOW64; Trident/5.0; FunWebProducts)```
...
<pre>
default   fe80:8c9d:bbad:5612:6089%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {22.57.184.90, 53.178.87.73}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 49:03:af:bb:44:9a
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 7b:eb:f4:ee:89:89
}</pre>
