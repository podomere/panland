...
layout: research
ip_v4_address: "166.226.158.24"
date: 2022-04-24T18:31:57+01:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like <code>166.226.158.24</code> or an IPv6 address like <code>2000:24c1:5ffa:d68f:c8b3:38b3:e8d6:ebb6</code>. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>59:6d:5b:41:77:38</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://bednar-hayes.biz you initially access a DNS server to translate the host portion (bednar-hayes) combined with the Top Level Domain (biz) of the URL, to an IP address like <code>169.193.150.82</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (Windows; U; Win 9x 4.90; SG; rv:1.9.2.4) Gecko/20101104 Netscape/9.1.0285</code>
...
<pre><code>
default   fe80:9c5a:21c2:74bf:5962%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {93.41.17.3, 179.27.179.18}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 59:6d:5b:41:77:38
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 03:69:1f:dd:51:c3
}</code></pre>
