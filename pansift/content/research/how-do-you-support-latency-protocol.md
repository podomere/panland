...
layout: research
ip_v4_address: "6.100.154.33"
date: 2022-04-24T18:59:59+01:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like <code>6.100.154.33</code> or an IPv6 address like <code>2000:e4a:ebdc:3792:b4e9:faf2:b38a:d900</code>. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>9e:a2:d7:4a:db:2f</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://west-nienow.name you initially access a DNS server to translate the host portion (west-nienow) combined with the Top Level Domain (name) of the URL, to an IP address like <code>161.253.39.221</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (Windows NT 6.1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/41.0.2228.0 Safari/537.36</code>
...
<pre><code>
default   fe80:d2d5:4eeb:2694:4884%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {207.29.179.206, 112.152.242.41}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 9e:a2:d7:4a:db:2f
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr f9:26:ee:b0:f8:59
}</code></pre>
