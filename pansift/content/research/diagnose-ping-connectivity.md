...
layout: research
ip_v4_address: "120.106.70.191"
date: 2023-10-06T17:11:07+01:00
draft: false
---

## Internet Addressing
On the Internet you might get a Public IPv4 address like ```120.106.70.191``` or an IPv6 address like ```2000:f590:3093:c66c:f3c8:9198:7ec3:4d61```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```8d:85:8b:4a:68:f4```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://bailey.org you initially access a DNS server to translate the host portion (bailey) combined with the Top Level Domain (org) of the URL, to an IP address like ```45.38.101.8```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1; WOW64; Trident/7.0; AS; rv:11.0) like Gecko```
...
default  192.168.138.232    UGScg  en0
...
<pre>
default   fe80:e7e:a086:a342:5ff5%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {226.95.104.60, 194.8.51.45}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 8d:85:8b:4a:68:f4
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr d0:92:10:7f:f0:27
}</pre>
