...
layout: research
ip_v4_address: "133.254.61.212"
date: 2022-11-02T11:32:58+00:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like ```133.254.61.212``` or an IPv6 address like ```2000:b2a:5d78:c2c3:669a:2f49:6364:3872```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```19:08:37:9f:ca:e4```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://kuhn-nikolaus.net you initially access a DNS server to translate the host portion (kuhn-nikolaus) combined with the Top Level Domain (net) of the URL, to an IP address like ```150.251.190.118```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1; WOW64; Trident/7.0; AS; rv:11.0) like Gecko```
...
<pre>
default   fe80:72c2:dc0f:9cfe:ae05%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {154.168.36.145, 213.10.106.203}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 19:08:37:9f:ca:e4
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 7d:df:d7:67:79:0c
}</pre>
