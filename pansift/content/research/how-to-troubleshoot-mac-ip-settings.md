...
subtitle: "Learnings?"
layout: research
ip_v4_address: "161.30.117.244"
date: 2022-11-19T19:13:17+00:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like ```161.30.117.244``` or an IPv6 address like ```2000:24e4:7b2f:65e5:696:7ae:30e1:5e33```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```40:89:77:56:bf:dd```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://crooks-batz.biz you initially access a DNS server to translate the host portion (crooks-batz) combined with the Top Level Domain (biz) of the URL, to an IP address like ```72.173.243.31```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT x.y; Win64; x64; rv:10.0) Gecko/20100101 Firefox/10.0```
...
<pre>
default   fe80:67d2:225d:bd3d:241b%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {224.128.148.157, 135.217.137.157}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 40:89:77:56:bf:dd
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr ee:b8:02:a1:6a:fd
}</pre>
