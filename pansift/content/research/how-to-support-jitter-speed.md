...
layout: research
ip_v4_address: "63.42.20.224"
date: 2023-02-04T16:26:20+00:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like ```63.42.20.224``` or an IPv6 address like ```2000:53a6:6129:d4d5:4a8d:4bf3:5b74:10ac```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```06:22:56:d4:6f:c4```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://gutmann-murray.io you initially access a DNS server to translate the host portion (gutmann-murray) combined with the Top Level Domain (io) of the URL, to an IP address like ```230.190.36.214```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_3) AppleWebKit/537.75.14 (KHTML, like Gecko) Version/7.0.3 Safari/7046A194A```
...
<pre>
default   fe80:a499:ec5f:b0ef:b3b%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {85.195.236.146, 43.38.134.148}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 06:22:56:d4:6f:c4
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr cb:b1:c1:e3:24:83
}</pre>
