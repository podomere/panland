...
layout: research
ip_v4_address: "23.23.30.128"
date: 2023-02-04T17:07:41+00:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like ```23.23.30.128``` or an IPv6 address like ```2000:7e9f:b20b:64d0:7655:e9b7:d9fa:9fe9```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```03:75:cf:ad:90:3d```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://block-stanton.net you initially access a DNS server to translate the host portion (block-stanton) combined with the Top Level Domain (net) of the URL, to an IP address like ```220.203.48.124```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows; U; Win 9x 4.90; SG; rv:1.9.2.4) Gecko/20101104 Netscape/9.1.0285```
...
<pre>
default   fe80:3b49:5add:1f3c:2d46%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {212.151.60.21, 136.209.36.199}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 03:75:cf:ad:90:3d
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr db:8e:df:de:24:fb
}</pre>
