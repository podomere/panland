...
layout: research
ip_v4_address: "136.122.240.212"
date: 2022-05-05T14:28:57+01:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like ```136.122.240.212``` or an IPv6 address like ```2000:600c:e589:259e:e82a:179a:bacd:68d3```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```6d:cb:ff:13:74:ff```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://altenwerth-dicki.io you initially access a DNS server to translate the host portion (altenwerth-dicki) combined with the Top Level Domain (io) of the URL, to an IP address like ```101.244.120.76```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows; U; Win 9x 4.90; SG; rv:1.9.2.4) Gecko/20101104 Netscape/9.1.0285```
...
<pre>
default   fe80:3aad:80a1:5c2e:c455%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {30.215.28.34, 150.111.102.42}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 6d:cb:ff:13:74:ff
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 91:b1:bc:60:92:f7
}</pre>
