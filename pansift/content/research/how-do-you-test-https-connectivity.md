...
layout: research
ip_v4_address: "237.30.207.51"
date: 2022-06-12T14:09:29+01:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like ```237.30.207.51``` or an IPv6 address like ```2000:78c:b8df:25d7:e4a6:e5fa:a259:a98a```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```35:67:0c:e0:da:9d```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://marvin-johns.info you initially access a DNS server to translate the host portion (marvin-johns) combined with the Top Level Domain (info) of the URL, to an IP address like ```146.116.56.96```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (compatible; MSIE 9.0; AOL 9.7; AOLBuild 4343.19; Windows NT 6.1; WOW64; Trident/5.0; FunWebProducts)```
...
<pre>
default   fe80:e3fe:b65c:7d71:6a63%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {152.203.178.195, 3.179.218.127}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 35:67:0c:e0:da:9d
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr ee:f6:ed:bf:c2:70
}</pre>
