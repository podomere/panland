...
subtitle: "Etc. Etc.?"
layout: research
ip_v4_address: "96.150.58.72"
date: 2022-11-02T11:32:53+00:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like ```96.150.58.72``` or an IPv6 address like ```2000:2fe:7170:70a4:37a:6f99:35b9:56ce```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```56:91:07:2d:f6:7a```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://ankunding-okuneva.org you initially access a DNS server to translate the host portion (ankunding-okuneva) combined with the Top Level Domain (org) of the URL, to an IP address like ```214.183.127.68```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_3) AppleWebKit/537.75.14 (KHTML, like Gecko) Version/7.0.3 Safari/7046A194A```
...
default  172.18.125.12    UGScg  en0
...
<pre>
default   fe80:4e73:f223:6903:bf69%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {78.138.92.211, 55.135.11.212}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 56:91:07:2d:f6:7a
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 1a:1c:b2:36:a7:84
}</pre>
