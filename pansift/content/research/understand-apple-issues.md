...
subtitle: "Synergy?"
layout: research
ip_v4_address: "13.105.238.216"
date: 2023-10-06T17:10:42+01:00
draft: false
---

## Internet Addressing
On the Internet you might have a Public IPv4 address like ```13.105.238.216``` or an IPv6 address like ```2000:6ce2:b208:d2e:5af2:b793:eaf7:940e```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```04:a1:50:54:4f:f2```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://ratke-roberts.net you initially access a DNS server to translate the host portion (ratke-roberts) combined with the Top Level Domain (net) of the URL, to an IP address like ```116.94.49.135```. Your computer and browser actually sends its type with all web requests e.g. <br>```Opera/9.80 (X11; Linux i686; Ubuntu/14.10) Presto/2.12.388 Version/12.16```
...
<pre>
default   fe80:b7b9:197d:efa7:3f68%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {210.75.7.19, 52.193.10.142}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 04:a1:50:54:4f:f2
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 86:1d:62:07:9d:b4
}</pre>
