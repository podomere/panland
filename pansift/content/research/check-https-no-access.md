...
layout: research
ip_v4_address: "235.216.152.104"
date: 2022-12-15T13:50:21+00:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like ```235.216.152.104``` or an IPv6 address like ```2000:1a80:b1ad:74b9:ec9a:faa9:fd89:292```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```a2:88:9e:ae:89:e8```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://stroman-marvin.org you initially access a DNS server to translate the host portion (stroman-marvin) combined with the Top Level Domain (org) of the URL, to an IP address like ```70.70.145.243```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (compatible; MSIE 9.0; AOL 9.7; AOLBuild 4343.19; Windows NT 6.1; WOW64; Trident/5.0; FunWebProducts)```
...
<pre>
default   fe80:9271:cda9:f255:ec65%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {161.128.42.244, 197.194.22.167}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr a2:88:9e:ae:89:e8
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 5f:1b:9e:fd:6f:1d
}</pre>
