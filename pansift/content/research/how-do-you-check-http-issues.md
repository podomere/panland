...
layout: research
ip_v4_address: "130.21.138.137"
date: 2023-02-04T16:26:23+00:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like ```130.21.138.137``` or an IPv6 address like ```2000:82c8:97e8:d468:da99:151a:6a43:78e6```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```fe:67:72:91:58:c7```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://paucek.name you initially access a DNS server to translate the host portion (paucek) combined with the Top Level Domain (name) of the URL, to an IP address like ```98.237.112.146```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT x.y; Win64; x64; rv:10.0) Gecko/20100101 Firefox/10.0```

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```10.144.19.152``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  10.144.19.152    UGScg  en0
...
<pre>
default   fe80:6d68:781a:c36:7596%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {249.52.237.198, 11.199.204.85}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr fe:67:72:91:58:c7
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr bd:09:11:9f:71:8c
}</pre>
