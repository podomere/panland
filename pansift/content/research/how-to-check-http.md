...
layout: research
ip_v4_address: "224.56.204.128"
date: 2023-10-06T17:11:08+01:00
draft: false
---

## Internet Addressing
On the Internet you might have a Public IPv4 address like ```224.56.204.128``` or an IPv6 address like ```2000:cbe:2389:7fb9:f1d0:ab9:e73d:40f1```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```5d:aa:7b:d1:92:25```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://bashirian-kerluke.name you initially access a DNS server to translate the host portion (bashirian-kerluke) combined with the Top Level Domain (name) of the URL, to an IP address like ```167.190.128.211```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_3) AppleWebKit/537.75.14 (KHTML, like Gecko) Version/7.0.3 Safari/7046A194A```
...
<pre>
default   fe80:c0d6:6aee:7130:6576%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {19.102.13.0, 106.131.79.92}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 5d:aa:7b:d1:92:25
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 34:d4:b1:0c:1d:ac
}</pre>
