...
layout: research
ip_v4_address: "246.50.84.245"
date: 2022-05-05T14:28:50+01:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like ```246.50.84.245``` or an IPv6 address like ```2000:52bf:f394:ee02:94b4:1f2f:d7ac:adf```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```57:f2:df:52:27:7f```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://rogahn-smith.com you initially access a DNS server to translate the host portion (rogahn-smith) combined with the Top Level Domain (com) of the URL, to an IP address like ```94.124.163.3```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows; U; Win 9x 4.90; SG; rv:1.9.2.4) Gecko/20101104 Netscape/9.1.0285```
...
<pre>
default   fe80:33ea:bb7a:452e:384a%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {54.56.116.205, 7.233.221.166}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 57:f2:df:52:27:7f
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 86:89:9a:69:b2:dd
}</pre>
