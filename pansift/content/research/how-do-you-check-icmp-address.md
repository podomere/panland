...
layout: research
ip_v4_address: "88.208.114.100"
date: 2022-11-02T11:32:58+00:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like ```88.208.114.100``` or an IPv6 address like ```2000:5e9d:7906:4bde:2380:be03:e09f:45fa```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```7c:92:61:1d:0b:66```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://stehr.co you initially access a DNS server to translate the host portion (stehr) combined with the Top Level Domain (co) of the URL, to an IP address like ```252.181.184.49```. Your computer and browser actually sends its type with all web requests e.g. <br>```Opera/9.80 (X11; Linux i686; Ubuntu/14.10) Presto/2.12.388 Version/12.16```

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```10.107.191.65``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  10.107.191.65    UGScg  en0
...
<pre>
default   fe80:24bc:af14:9479:407f%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {89.84.188.253, 180.206.180.20}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 7c:92:61:1d:0b:66
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr ba:64:7e:c5:1f:f2
}</pre>
