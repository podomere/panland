...
layout: research
ip_v4_address: "53.118.5.248"
date: 2023-10-06T17:11:08+01:00
draft: false
---

## Internet Addressing
On the Internet you may have a Public IPv4 address like ```53.118.5.248``` or an IPv6 address like ```2000:24f1:20a3:6238:ccfc:5835:62fd:a37```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```b0:c7:5a:86:1a:b5```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://deckow-toy.net you initially access a DNS server to translate the host portion (deckow-toy) combined with the Top Level Domain (net) of the URL, to an IP address like ```88.182.92.252```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_3) AppleWebKit/537.75.14 (KHTML, like Gecko) Version/7.0.3 Safari/7046A194A```
...
<pre>
default   fe80:3760:46d4:c95c:1da0%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {12.206.130.52, 80.89.14.179}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr b0:c7:5a:86:1a:b5
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 46:73:44:1c:f5:cb
}</pre>
