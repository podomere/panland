...
layout: research
ip_v4_address: "12.127.9.217"
date: 2023-10-29T15:13:26+00:00
draft: false
---

## Internet Addressing
On the Internet you might have a Public IPv4 address like ```12.127.9.217``` or an IPv6 address like ```2000:df94:8561:b0ee:df37:15f2:39d2:ac23```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```2b:63:16:37:a8:e4```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://durgan-heaney.net you initially access a DNS server to translate the host portion (durgan-heaney) combined with the Top Level Domain (net) of the URL, to an IP address like ```22.151.236.11```. Your computer and browser actually sends its type with all web requests e.g. <br>```Opera/9.80 (X11; Linux i686; Ubuntu/14.10) Presto/2.12.388 Version/12.16```
...
<pre>
default   fe80:7067:49b5:9bb9:f249%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {167.202.117.201, 235.239.127.217}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 2b:63:16:37:a8:e4
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr a4:30:4b:9f:c3:c0
}</pre>
