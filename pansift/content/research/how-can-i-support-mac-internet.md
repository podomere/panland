...
subtitle: "Deep Dive?"
layout: research
ip_v4_address: "162.245.59.196"
date: 2022-04-24T18:31:59+01:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like <code>162.245.59.196</code> or an IPv6 address like <code>2000:a22c:6902:f2c7:aa8:8f9e:5f5d:3998</code>. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>a1:88:4a:42:dd:eb</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://padberg-schroeder.com you initially access a DNS server to translate the host portion (padberg-schroeder) combined with the Top Level Domain (com) of the URL, to an IP address like <code>186.213.248.173</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (Windows; U; Win 9x 4.90; SG; rv:1.9.2.4) Gecko/20101104 Netscape/9.1.0285</code>
...
<pre><code>
default   fe80:dd26:2f6c:b0df:15ca%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {182.71.192.49, 41.17.83.15}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr a1:88:4a:42:dd:eb
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 26:b7:f1:95:9c:45
}</code></pre>
