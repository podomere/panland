...
layout: research
ip_v4_address: "10.169.224.157"
date: 2022-11-02T11:32:57+00:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like ```10.169.224.157``` or an IPv6 address like ```2000:6b8a:d719:2fca:f363:c71e:eab8:2346```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```e2:fb:69:73:69:ee```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://wiegand-rice.name you initially access a DNS server to translate the host portion (wiegand-rice) combined with the Top Level Domain (name) of the URL, to an IP address like ```187.213.250.103```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1; WOW64; Trident/7.0; AS; rv:11.0) like Gecko```
...
<pre>
default   fe80:2c14:b49:6fa5:6c19%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {246.220.39.188, 73.166.118.91}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr e2:fb:69:73:69:ee
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 47:04:78:d5:da:ac
}</pre>
