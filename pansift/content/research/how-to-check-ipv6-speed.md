...
subtitle: "Impact Map?"
layout: research
ip_v4_address: "186.252.33.174"
date: 2023-10-06T17:11:03+01:00
draft: false
---

## Internet Addressing
On the Internet you might get a Public IPv4 address like ```186.252.33.174``` or an IPv6 address like ```2000:96a0:73f3:e2cc:16b7:77b:a956:85ce```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```5a:3e:a7:7f:86:f9```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://zieme.io you initially access a DNS server to translate the host portion (zieme) combined with the Top Level Domain (io) of the URL, to an IP address like ```220.88.84.107```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows; U; Win 9x 4.90; SG; rv:1.9.2.4) Gecko/20101104 Netscape/9.1.0285```

## Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```172.17.37.225``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  172.17.37.225    UGScg  en0
...
<pre>
default   fe80:b5a2:71f8:e5ec:39aa%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {194.24.104.200, 251.94.157.0}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 5a:3e:a7:7f:86:f9
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 7d:0f:fb:38:db:ab
}</pre>
