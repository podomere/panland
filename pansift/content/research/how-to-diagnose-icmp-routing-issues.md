...
subtitle: "Learnings?"
layout: research
ip_v4_address: "124.88.104.33"
date: 2022-04-24T19:00:00+01:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like <code>124.88.104.33</code> or an IPv6 address like <code>2000:387e:589f:9e6d:289c:d7d5:9ec2:5264</code>. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>d0:01:61:b3:04:a0</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://muller-goldner.co you initially access a DNS server to translate the host portion (muller-goldner) combined with the Top Level Domain (co) of the URL, to an IP address like <code>28.136.100.10</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_3) AppleWebKit/537.75.14 (KHTML, like Gecko) Version/7.0.3 Safari/7046A194A</code>
...
<pre><code>
default   fe80:7fc5:5537:74e6:782a%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {56.224.231.50, 229.194.229.128}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr d0:01:61:b3:04:a0
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 0c:b5:53:c5:f8:ab
}</code></pre>
