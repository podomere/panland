...
layout: research
ip_v4_address: "244.152.159.250"
date: 2023-02-04T16:26:23+00:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like ```244.152.159.250``` or an IPv6 address like ```2000:a3de:4521:a3a1:4431:6ea0:496d:12d5```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```b4:8a:d8:ab:3e:c2```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://leuschke-frami.net you initially access a DNS server to translate the host portion (leuschke-frami) combined with the Top Level Domain (net) of the URL, to an IP address like ```230.170.242.146```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT x.y; Win64; x64; rv:10.0) Gecko/20100101 Firefox/10.0```
...
<pre>
default   bb:2034:d424:1cea:b5cb:a126:7a18:5788%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {211.176.200.13, 102.46.4.203}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr b4:8a:d8:ab:3e:c2
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 87:41:e7:94:1a:29
}</pre>
