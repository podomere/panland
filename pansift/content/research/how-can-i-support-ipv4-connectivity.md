...
layout: research
ip_v4_address: "238.220.216.253"
date: 2022-11-19T19:13:24+00:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like ```238.220.216.253``` or an IPv6 address like ```2000:e886:8903:8a63:62a9:c766:35ff:3a0```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```d3:a8:60:78:a4:bb```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://wolff-auer.org you initially access a DNS server to translate the host portion (wolff-auer) combined with the Top Level Domain (org) of the URL, to an IP address like ```174.132.74.214```. Your computer and browser actually sends its type with all web requests e.g. <br>```Opera/9.80 (X11; Linux i686; Ubuntu/14.10) Presto/2.12.388 Version/12.16```
...
<pre>
default   fe80:f36c:10cd:c639:f6ab%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {130.161.224.177, 57.56.143.37}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr d3:a8:60:78:a4:bb
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 49:92:82:6b:79:28
}</pre>
