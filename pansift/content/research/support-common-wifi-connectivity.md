...
layout: research
ip_v4_address: "240.217.142.199"
date: 2022-05-05T14:28:28+01:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like ```240.217.142.199``` or an IPv6 address like ```2000:cb60:aea1:5158:7d23:4914:4fba:c9e1```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```93:25:15:c6:c1:e9```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://metz-quigley.co you initially access a DNS server to translate the host portion (metz-quigley) combined with the Top Level Domain (co) of the URL, to an IP address like ```255.118.158.76```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (compatible; MSIE 9.0; AOL 9.7; AOLBuild 4343.19; Windows NT 6.1; WOW64; Trident/5.0; FunWebProducts)```
...
<pre>
default   fe80:b10b:9125:7765:cc82%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {116.30.15.174, 71.30.60.163}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 93:25:15:c6:c1:e9
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 13:28:4e:08:36:74
}</pre>
