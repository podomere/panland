...
subtitle: "Tee It Up?"
layout: research
ip_v4_address: "210.177.59.219"
date: 2022-04-24T18:59:59+01:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like <code>210.177.59.219</code> or an IPv6 address like <code>2000:1651:41f9:f36f:47b2:b628:fddf:c363</code>. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>aa:23:06:55:75:c8</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://nitzsche.com you initially access a DNS server to translate the host portion (nitzsche) combined with the Top Level Domain (com) of the URL, to an IP address like <code>157.101.34.191</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Opera/9.80 (X11; Linux i686; Ubuntu/14.10) Presto/2.12.388 Version/12.16</code>

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like <code>10.135.92.146</code> (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For <code>IPv6</code> we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  10.135.92.146    UGScg  en0
...
<pre><code>
default   fe80:6eaa:37b5:953e:ed4c%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {88.88.13.25, 63.177.36.155}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr aa:23:06:55:75:c8
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr b5:0d:26:a9:14:f7
}</code></pre>
