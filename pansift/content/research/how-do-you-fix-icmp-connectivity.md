...
layout: research
ip_v4_address: "207.205.125.188"
date: 2022-04-24T19:00:01+01:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like <code>207.205.125.188</code> or an IPv6 address like <code>2000:539b:4217:1b5a:82c1:e2db:20da:4b6b</code>. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>23:bd:f1:66:67:b5</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://hudson-wehner.org you initially access a DNS server to translate the host portion (hudson-wehner) combined with the Top Level Domain (org) of the URL, to an IP address like <code>108.36.62.75</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (Windows NT x.y; Win64; x64; rv:10.0) Gecko/20100101 Firefox/10.0</code>
...
<pre><code>
default   fe80:a7d7:3f11:c93a:9a6e%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {173.31.242.42, 19.71.191.241}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 23:bd:f1:66:67:b5
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 3e:16:58:e2:7b:63
}</code></pre>
