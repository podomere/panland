...
layout: research
ip_v4_address: "193.236.247.170"
date: 2022-04-24T19:00:06+01:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like <code>193.236.247.170</code> or an IPv6 address like <code>2000:e061:d8e8:2a08:e309:acbe:b63d:f11a</code>. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>73:2c:e7:98:24:a9</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://spencer.com you initially access a DNS server to translate the host portion (spencer) combined with the Top Level Domain (com) of the URL, to an IP address like <code>136.33.85.143</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (Windows NT 6.1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/41.0.2228.0 Safari/537.36</code>
...
<pre><code>
default   fe80:6e9c:513a:288:e593%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {246.169.192.13, 124.136.254.108}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 73:2c:e7:98:24:a9
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 4c:64:96:a1:52:71
}</code></pre>
