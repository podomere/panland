...
layout: research
ip_v4_address: "12.142.100.37"
date: 2023-10-29T15:13:25+00:00
draft: false
---

## Internet Addressing
On the Internet you may have a Public IPv4 address like ```12.142.100.37``` or an IPv6 address like ```2000:d3ab:32a5:adf3:3785:a08d:a37e:265c```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```3a:5d:66:bc:7b:e1```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://pollich-weber.info you initially access a DNS server to translate the host portion (pollich-weber) combined with the Top Level Domain (info) of the URL, to an IP address like ```150.142.59.71```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows; U; Win 9x 4.90; SG; rv:1.9.2.4) Gecko/20101104 Netscape/9.1.0285```
...
<pre>
default   fe80:6a6:6e31:24bc:3b1f%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {56.40.73.192, 244.246.29.248}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 3a:5d:66:bc:7b:e1
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 74:3a:78:65:43:18
}</pre>
