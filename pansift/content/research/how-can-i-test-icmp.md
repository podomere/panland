...
subtitle: "Value Add?"
layout: research
ip_v4_address: "125.221.254.94"
date: 2022-04-24T19:00:01+01:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like <code>125.221.254.94</code> or an IPv6 address like <code>2000:ebcc:5c90:31b7:7834:2f20:4c25:921</code>. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>0d:7e:06:97:b1:bb</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://turcotte-kirlin.io you initially access a DNS server to translate the host portion (turcotte-kirlin) combined with the Top Level Domain (io) of the URL, to an IP address like <code>198.174.168.148</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (Windows NT 6.1; WOW64; Trident/7.0; AS; rv:11.0) like Gecko</code>
...
default  172.20.0.125    UGScg  en0
...
<pre><code>
default   fe80:a6ab:d6b9:dc44:ae3c%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {124.92.185.45, 157.178.72.164}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 0d:7e:06:97:b1:bb
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr d5:ce:d2:82:c7:0e
}</code></pre>
