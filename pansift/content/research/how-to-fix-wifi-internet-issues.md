...
layout: research
ip_v4_address: "18.165.197.80"
date: 2023-02-04T16:26:02+00:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like ```18.165.197.80``` or an IPv6 address like ```2000:f894:d4d1:a2e9:8c58:4128:649d:9609```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```09:88:fb:41:2b:f5```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://legros.info you initially access a DNS server to translate the host portion (legros) combined with the Top Level Domain (info) of the URL, to an IP address like ```123.33.194.39```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (compatible; MSIE 9.0; AOL 9.7; AOLBuild 4343.19; Windows NT 6.1; WOW64; Trident/5.0; FunWebProducts)```
...
<pre>
default   fe80:8997:f2f7:8ebe:d991%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {143.135.150.170, 121.147.145.43}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 09:88:fb:41:2b:f5
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 79:bb:05:ef:18:20
}</pre>
