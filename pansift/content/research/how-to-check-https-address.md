...
subtitle: "Swim Lane?"
layout: research
ip_v4_address: "95.162.5.247"
date: 2022-05-05T14:30:12+01:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like ```95.162.5.247``` or an IPv6 address like ```2000:4596:4550:76cf:b341:16bf:6235:6009```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```72:42:32:dd:bc:2b```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://anderson.biz you initially access a DNS server to translate the host portion (anderson) combined with the Top Level Domain (biz) of the URL, to an IP address like ```77.189.6.27```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1; WOW64; Trident/7.0; AS; rv:11.0) like Gecko```
...
default  192.168.12.95    UGScg  en0
...
<pre>
default   fe80:a0a8:8d95:51fb:fd5f%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {217.83.236.141, 163.227.145.211}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 72:42:32:dd:bc:2b
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr a4:66:16:f4:a2:11
}</pre>
