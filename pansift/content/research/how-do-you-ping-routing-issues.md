---
title: "How Do You Ping Routing Issues"
subtitle: "Put A Bow On It?"
layout: research
ip_v4_address: "216.121.243.238"
date: 2022-04-24T19:00:02+01:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like <code>216.121.243.238</code> or an IPv6 address like <code>2000:ff2f:4bc5:1942:7bc5:4f96:5942:74e0</code>. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>14:2b:f7:a1:ca:e5</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://gorczany-abbott.info you initially access a DNS server to translate the host portion (gorczany-abbott) combined with the Top Level Domain (info) of the URL, to an IP address like <code>76.204.218.161</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (Windows NT 6.1; WOW64; Trident/7.0; AS; rv:11.0) like Gecko</code>

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like <code>192.168.228.151</code> (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For <code>IPv6</code> we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  192.168.228.151    UGScg  en0
...
<pre><code>
default   fe80:548f:6200:1204:df7d%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {47.217.93.50, 78.156.137.227}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 14:2b:f7:a1:ca:e5
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr c5:ab:7a:9f:e6:c5
}</code></pre>
