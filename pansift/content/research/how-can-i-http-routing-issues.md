...
layout: research
ip_v4_address: "227.41.105.212"
date: 2022-11-19T19:13:28+00:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like ```227.41.105.212``` or an IPv6 address like ```2000:223c:8648:d922:59de:3f14:4de5:91e8```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```ee:3f:00:36:46:e1```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://lemke.co you initially access a DNS server to translate the host portion (lemke) combined with the Top Level Domain (co) of the URL, to an IP address like ```142.105.229.113```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows; U; Win 9x 4.90; SG; rv:1.9.2.4) Gecko/20101104 Netscape/9.1.0285```

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```192.168.87.47``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  192.168.87.47    UGScg  en0
...
<pre>
default   fe80:aff5:2472:38f9:9702%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {33.29.97.223, 8.69.232.34}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr ee:3f:00:36:46:e1
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr d5:d6:f8:d3:0d:83
}</pre>
