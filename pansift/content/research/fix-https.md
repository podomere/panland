...
subtitle: "Deep Dive?"
layout: research
ip_v4_address: "74.146.178.204"
date: 2022-04-24T19:00:05+01:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like <code>74.146.178.204</code> or an IPv6 address like <code>2000:9fd8:2799:d909:e744:913a:1e11:ccfc</code>. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>fe:9e:9f:bb:f2:45</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://hamill-torp.biz you initially access a DNS server to translate the host portion (hamill-torp) combined with the Top Level Domain (biz) of the URL, to an IP address like <code>223.167.208.220</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Opera/9.80 (X11; Linux i686; Ubuntu/14.10) Presto/2.12.388 Version/12.16</code>
...
<pre><code>
default   fe80:cf25:4717:4f59:4458%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {174.100.168.5, 123.168.171.30}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr fe:9e:9f:bb:f2:45
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 99:73:32:f8:4b:75
}</code></pre>
