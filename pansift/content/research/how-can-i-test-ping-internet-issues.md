---
title: "How Can I Test Ping Internet Issues"
subtitle: "Bleeding Edge?"
layout: research
ip_v4_address: "202.58.44.166"
date: 2022-11-19T19:13:27+00:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like ```202.58.44.166``` or an IPv6 address like ```2000:2d44:b07e:3dc1:908:f96:3212:1d14```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```4a:06:94:49:b3:b8```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://kessler-schmitt.info you initially access a DNS server to translate the host portion (kessler-schmitt) combined with the Top Level Domain (info) of the URL, to an IP address like ```100.120.200.8```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/41.0.2228.0 Safari/537.36```

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```172.20.38.77``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  172.20.38.77    UGScg  en0
...
<pre>
default   fe80:d054:6409:c65a:14c6%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {161.225.211.149, 18.110.187.217}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 4a:06:94:49:b3:b8
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 6e:34:c7:55:e0:f6
}</pre>
