...
layout: research
ip_v4_address: "64.144.66.38"
date: 2022-11-19T16:17:19+00:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like ```64.144.66.38``` or an IPv6 address like ```2000:5c46:6918:51e1:2cc9:93b5:2ba9:9823```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```58:98:ad:15:52:f5```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://aufderhar.net you initially access a DNS server to translate the host portion (aufderhar) combined with the Top Level Domain (net) of the URL, to an IP address like ```235.240.113.13```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows; U; Win 9x 4.90; SG; rv:1.9.2.4) Gecko/20101104 Netscape/9.1.0285```

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```172.31.179.101``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  172.31.179.101    UGScg  en0
...
<pre>
default   fe80:1e83:4a2c:b433:9b93%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {181.72.170.97, 132.131.234.177}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 58:98:ad:15:52:f5
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 8c:99:0e:28:c3:6d
}</pre>
