...
layout: research
ip_v4_address: "122.240.141.142"
date: 2022-04-24T18:59:55+01:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like <code>122.240.141.142</code> or an IPv6 address like <code>2000:714f:9af:86cf:13f0:b090:1e69:4ce2</code>. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>c8:af:00:53:f7:17</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://schulist-renner.biz you initially access a DNS server to translate the host portion (schulist-renner) combined with the Top Level Domain (biz) of the URL, to an IP address like <code>77.107.133.99</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (Windows NT x.y; Win64; x64; rv:10.0) Gecko/20100101 Firefox/10.0</code>
...
<pre><code>
default   fe80:a1b8:d3:2b3f:b15e%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {144.171.213.141, 39.47.156.180}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr c8:af:00:53:f7:17
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 40:6b:e1:cc:3b:71
}</code></pre>
