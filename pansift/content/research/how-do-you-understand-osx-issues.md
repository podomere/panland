...
layout: research
ip_v4_address: "86.172.190.214"
date: 2022-05-05T14:28:51+01:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like ```86.172.190.214``` or an IPv6 address like ```2000:eda:2eb2:ed8f:cd35:7cab:8dd4:8bf8```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```47:4d:ce:81:d8:df```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://roberts-heidenreich.name you initially access a DNS server to translate the host portion (roberts-heidenreich) combined with the Top Level Domain (name) of the URL, to an IP address like ```179.43.103.44```. Your computer and browser actually sends its type with all web requests e.g. <br>```Opera/9.80 (X11; Linux i686; Ubuntu/14.10) Presto/2.12.388 Version/12.16```
...
<pre>
default   fe80:44da:f8be:7992:dbb1%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {163.14.252.147, 68.117.54.205}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 47:4d:ce:81:d8:df
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 53:3f:e6:0b:fa:a5
}</pre>
