...
layout: research
ip_v4_address: "30.73.120.252"
date: 2023-10-06T17:11:04+01:00
draft: false
---

## Internet Addressing
On the Internet you might have a Public IPv4 address like ```30.73.120.252``` or an IPv6 address like ```2000:24:b127:eec8:af6d:6e6f:1e0e:edd8```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```41:1c:ad:28:75:69```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://koss.biz you initially access a DNS server to translate the host portion (koss) combined with the Top Level Domain (biz) of the URL, to an IP address like ```213.126.77.124```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT x.y; Win64; x64; rv:10.0) Gecko/20100101 Firefox/10.0```

## Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```192.168.149.142``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  192.168.149.142    UGScg  en0
...
<pre>
default   fe80:f2c8:372:2ca4:26ae%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {248.118.111.176, 233.102.26.146}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 41:1c:ad:28:75:69
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 2f:ee:96:c0:32:2e
}</pre>
