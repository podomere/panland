...
subtitle: "Tee It Up?"
layout: research
ip_v4_address: "15.53.234.115"
date: 2023-10-29T15:13:20+00:00
draft: false
---

## Internet Addressing
On the Internet you might have a Public IPv4 address like ```15.53.234.115``` or an IPv6 address like ```2000:7cce:f5f8:14e2:2724:ed6e:9d5b:e77f```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```77:aa:9f:6c:cd:9b```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://steuber-feeney.com you initially access a DNS server to translate the host portion (steuber-feeney) combined with the Top Level Domain (com) of the URL, to an IP address like ```27.32.221.12```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT x.y; Win64; x64; rv:10.0) Gecko/20100101 Firefox/10.0```
...
<pre>
default   fe80:710d:a111:fb3d:7108%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {195.23.160.171, 200.231.99.158}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 77:aa:9f:6c:cd:9b
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 39:0e:af:4a:ef:67
}</pre>
