...
layout: research
ip_v4_address: "173.178.207.200"
date: 2023-10-06T17:11:03+01:00
draft: false
---

## Internet Addressing
On the Internet you might get a Public IPv4 address like ```173.178.207.200``` or an IPv6 address like ```2000:2f89:31da:ade9:d7cb:ed3d:fd03:99be```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```49:79:13:48:e2:89```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://pollich-welch.org you initially access a DNS server to translate the host portion (pollich-welch) combined with the Top Level Domain (org) of the URL, to an IP address like ```150.209.206.92```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1; WOW64; Trident/7.0; AS; rv:11.0) like Gecko```
...
<pre>
default   fe80:c4a9:9dbf:cfef:708f%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {61.21.131.74, 86.37.242.187}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 49:79:13:48:e2:89
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 03:98:ca:58:da:19
}</pre>
