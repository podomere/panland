...
layout: research
ip_v4_address: "45.72.233.24"
date: 2022-04-24T18:31:57+01:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like <code>45.72.233.24</code> or an IPv6 address like <code>2000:e013:7953:7760:2529:665e:7b8b:a8ec</code>. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>db:f9:db:57:f2:86</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://ebert-kirlin.io you initially access a DNS server to translate the host portion (ebert-kirlin) combined with the Top Level Domain (io) of the URL, to an IP address like <code>39.133.30.117</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (Windows NT 6.1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/41.0.2228.0 Safari/537.36</code>
...
<pre><code>
default   fe80:5eb2:12c0:c927:6240%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {212.80.81.58, 126.170.23.83}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr db:f9:db:57:f2:86
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 3f:86:2e:a7:60:58
}</code></pre>
