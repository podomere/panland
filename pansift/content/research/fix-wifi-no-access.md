...
subtitle: "Streamline?"
layout: research
ip_v4_address: "213.28.30.67"
date: 2023-10-06T17:10:30+01:00
draft: false
---

## Internet Addressing
On the Internet you might get a Public IPv4 address like ```213.28.30.67``` or an IPv6 address like ```2000:944:4834:f36e:9d5f:c45d:1daf:ccd0```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```43:4b:fd:98:fa:ae```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://fahey-trantow.org you initially access a DNS server to translate the host portion (fahey-trantow) combined with the Top Level Domain (org) of the URL, to an IP address like ```81.51.63.181```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows; U; Win 9x 4.90; SG; rv:1.9.2.4) Gecko/20101104 Netscape/9.1.0285```
...
<pre>
default   fe80:de0e:da75:5765:b2b5%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {194.214.77.41, 208.203.21.189}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 43:4b:fd:98:fa:ae
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 12:d0:26:44:5f:45
}</pre>
...
### Apple macOS / OSX
No matter what version of OSX/macOS you are on, ```10.15.8```, ```11.1.6```, or ```12.1.5```, there are a range of tools for troubleshooting. Unfortunately, between these manual actions and scripts, they don't give you a series of correlated values over time. This is where automated remote troubleshooting comes in to its own, especially for teams that embrace remote work and Work From Anywhere (WFA).
