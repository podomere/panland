...
layout: research
ip_v4_address: "240.245.203.115"
date: 2022-05-05T14:28:45+01:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like ```240.245.203.115``` or an IPv6 address like ```2000:bc26:761:b3c1:e7cb:d6eb:7d9f:2a6```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```e6:cc:25:b5:a0:0c```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://torp.info you initially access a DNS server to translate the host portion (torp) combined with the Top Level Domain (info) of the URL, to an IP address like ```49.134.206.50```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT x.y; Win64; x64; rv:10.0) Gecko/20100101 Firefox/10.0```

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```10.219.109.29``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  10.219.109.29    UGScg  en0
...
<pre>
default   fe80:1bbb:f0a4:f25d:ee61%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {171.54.226.101, 84.42.241.173}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr e6:cc:25:b5:a0:0c
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 1a:bf:4d:cd:50:de
}</pre>
