...
layout: research
ip_v4_address: "40.44.26.52"
date: 2023-02-04T17:07:48+00:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like ```40.44.26.52``` or an IPv6 address like ```2000:55c9:5e5e:cffb:1571:6b6a:6933:264e```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```b5:9a:2d:9f:d3:26```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://mueller-krajcik.biz you initially access a DNS server to translate the host portion (mueller-krajcik) combined with the Top Level Domain (biz) of the URL, to an IP address like ```25.13.237.129```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows; U; Win 9x 4.90; SG; rv:1.9.2.4) Gecko/20101104 Netscape/9.1.0285```
...
<pre>
default   fe80:bd4c:ff80:fcf0:69d6%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {237.182.156.189, 55.193.153.167}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr b5:9a:2d:9f:d3:26
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 6f:ff:4d:9e:0e:25
}</pre>
