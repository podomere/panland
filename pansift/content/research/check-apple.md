...
subtitle: "Tee It Up?"
layout: research
ip_v4_address: "200.189.30.157"
date: 2022-05-05T14:28:52+01:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like ```200.189.30.157``` or an IPv6 address like ```2000:2ff0:86be:ccfb:84e7:1e97:d38c:62d8```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```ac:51:d5:ec:ec:bd```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://emard.com you initially access a DNS server to translate the host portion (emard) combined with the Top Level Domain (com) of the URL, to an IP address like ```153.184.210.166```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1; WOW64; Trident/7.0; AS; rv:11.0) like Gecko```
...
<pre>
default   fe80:6b52:5ddc:421b:8b03%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {104.72.105.70, 33.6.214.89}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr ac:51:d5:ec:ec:bd
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr da:3c:7f:bc:81:db
}</pre>
