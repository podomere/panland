...
layout: research
ip_v4_address: "128.83.38.28"
date: 2022-11-19T19:13:17+00:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like ```128.83.38.28``` or an IPv6 address like ```2000:6550:d05c:28bb:b8de:c8b3:4ab9:b5c1```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```67:36:1c:6a:6f:41```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://kuhic-koss.co you initially access a DNS server to translate the host portion (kuhic-koss) combined with the Top Level Domain (co) of the URL, to an IP address like ```173.148.0.85```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows; U; Win 9x 4.90; SG; rv:1.9.2.4) Gecko/20101104 Netscape/9.1.0285```
...
<pre>
default   fe80:a303:5f15:26b6:87d7%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {144.97.222.99, 15.124.142.180}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 67:36:1c:6a:6f:41
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 32:db:9f:e7:a9:48
}</pre>
