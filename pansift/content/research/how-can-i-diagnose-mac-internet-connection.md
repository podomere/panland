...
subtitle: "Value Add?"
layout: research
ip_v4_address: "72.133.131.100"
date: 2022-06-04T14:38:30+01:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like ```72.133.131.100``` or an IPv6 address like ```2000:444d:d894:6b8a:d215:1e69:4eee:dfef```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```e4:02:70:67:2d:51```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://nienow-huel.io you initially access a DNS server to translate the host portion (nienow-huel) combined with the Top Level Domain (io) of the URL, to an IP address like ```113.244.49.47```. Your computer and browser actually sends its type with all web requests e.g. <br>```Opera/9.80 (X11; Linux i686; Ubuntu/14.10) Presto/2.12.388 Version/12.16```
...
<pre>
default   fe80:856e:1d2b:4e79:ed3%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {18.32.202.182, 112.132.39.7}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr e4:02:70:67:2d:51
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 41:73:ee:56:6b:c4
}</pre>
