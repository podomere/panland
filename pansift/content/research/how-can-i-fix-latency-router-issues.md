...
layout: research
ip_v4_address: "172.35.247.58"
date: 2022-04-24T18:59:58+01:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like <code>172.35.247.58</code> or an IPv6 address like <code>2000:f696:b5ca:6fbb:3f24:8824:1800:3dc1</code>. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>00:48:cc:2f:c0:92</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://kub-feil.net you initially access a DNS server to translate the host portion (kub-feil) combined with the Top Level Domain (net) of the URL, to an IP address like <code>128.38.200.97</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_3) AppleWebKit/537.75.14 (KHTML, like Gecko) Version/7.0.3 Safari/7046A194A</code>
...
<pre><code>
default   fe80:2ef4:4874:30d4:97a6%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {100.32.24.232, 174.134.123.125}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 00:48:cc:2f:c0:92
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 1e:dc:db:75:18:1c
}</code></pre>
