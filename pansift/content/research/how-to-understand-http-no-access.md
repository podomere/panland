...
layout: research
ip_v4_address: "245.225.234.0"
date: 2023-02-04T16:26:23+00:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like ```245.225.234.0``` or an IPv6 address like ```2000:f19f:7300:b679:f610:efc4:a7b5:1019```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```68:79:d0:c7:ae:05```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://ebert.biz you initially access a DNS server to translate the host portion (ebert) combined with the Top Level Domain (biz) of the URL, to an IP address like ```119.157.245.224```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT x.y; Win64; x64; rv:10.0) Gecko/20100101 Firefox/10.0```
...
<pre>
default   fe80:da9c:c89b:aeed:ff3d%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {76.109.120.92, 63.220.40.179}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 68:79:d0:c7:ae:05
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 74:7d:3f:03:2e:bb
}</pre>
...
## Apple macOS / OSX
No matter what version of OSX/macOS you are on, ```10.15.9```, ```11.4.8```, or ```12.1.1```, there are a range of tools for troubleshooting. Unfortunately, between these manual actions and scripts, they don't give you a series of correlated values over time. This is where automated remote troubleshooting comes in to its own, especially for teams that embrace remote work and Work From Anywhere (WFA).
