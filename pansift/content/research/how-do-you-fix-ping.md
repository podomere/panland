---
title: "How Do You Fix Ping"
subtitle: "Had To 'punt' On That?"
layout: research
ip_v4_address: "193.132.29.182"
date: 2022-04-24T19:00:02+01:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like <code>193.132.29.182</code> or an IPv6 address like <code>2000:ff90:c980:7790:a538:8683:aef6:49ff</code>. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>f0:b9:6a:82:ea:a5</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://klocko-collier.net you initially access a DNS server to translate the host portion (klocko-collier) combined with the Top Level Domain (net) of the URL, to an IP address like <code>186.183.16.47</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (Windows; U; Win 9x 4.90; SG; rv:1.9.2.4) Gecko/20101104 Netscape/9.1.0285</code>

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like <code>10.76.134.82</code> (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For <code>IPv6</code> we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  10.76.134.82    UGScg  en0
...
<pre><code>
default   fe80:1111:3208:7a9f:b301%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {8.188.13.29, 178.128.209.36}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr f0:b9:6a:82:ea:a5
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr ed:23:16:00:d7:cd
}</code></pre>
