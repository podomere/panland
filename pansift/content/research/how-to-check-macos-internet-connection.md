...
layout: research
ip_v4_address: "3.185.4.108"
date: 2022-11-19T19:13:16+00:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like ```3.185.4.108``` or an IPv6 address like ```2000:8784:9a58:279e:8108:5b61:df0f:c3e3```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```d2:f9:ba:33:b8:88```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://cassin-hilpert.io you initially access a DNS server to translate the host portion (cassin-hilpert) combined with the Top Level Domain (io) of the URL, to an IP address like ```7.118.54.242```. Your computer and browser actually sends its type with all web requests e.g. <br>```Opera/9.80 (X11; Linux i686; Ubuntu/14.10) Presto/2.12.388 Version/12.16```
...
<pre>
default   fe80:fb4e:6c15:6b45:1138%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {197.129.237.237, 101.216.206.236}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr d2:f9:ba:33:b8:88
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 42:6f:31:14:be:0d
}</pre>
...
## Apple macOS / OSX
No matter what version of OSX/macOS you are on, ```10.14.2```, ```11.5.7```, or ```12.3.7```, there are a range of tools for troubleshooting. Unfortunately, between these manual actions and scripts, they don't give you a series of correlated values over time. This is where automated remote troubleshooting comes in to its own, especially for teams that embrace remote work and Work From Anywhere (WFA).
