...
subtitle: "Branding?"
layout: research
ip_v4_address: "202.83.248.11"
date: 2023-10-06T17:11:06+01:00
draft: false
---

## Internet Addressing
On the Internet you might get a Public IPv4 address like ```202.83.248.11``` or an IPv6 address like ```2000:4af4:d77b:6b25:ff2f:1ef1:df69:ac85```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```a8:a1:cf:9a:dc:bf```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://adams.net you initially access a DNS server to translate the host portion (adams) combined with the Top Level Domain (net) of the URL, to an IP address like ```68.125.170.123```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows; U; Win 9x 4.90; SG; rv:1.9.2.4) Gecko/20101104 Netscape/9.1.0285```
...
<pre>
default   fe80:ac2d:9cc1:2c00:927e%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {51.155.91.157, 255.78.185.193}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr a8:a1:cf:9a:dc:bf
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 89:25:4b:fc:2d:71
}</pre>
