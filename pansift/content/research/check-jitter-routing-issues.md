...
subtitle: "Ideate?"
layout: research
ip_v4_address: "11.172.183.61"
date: 2022-12-15T13:50:18+00:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like ```11.172.183.61``` or an IPv6 address like ```2000:f73b:3be4:bb9f:c48f:2dc7:2339:b784```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```f9:7b:3e:7d:7f:2e```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://trantow.com you initially access a DNS server to translate the host portion (trantow) combined with the Top Level Domain (com) of the URL, to an IP address like ```64.171.206.141```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows; U; Win 9x 4.90; SG; rv:1.9.2.4) Gecko/20101104 Netscape/9.1.0285```
...
<pre>
default   fe80:1948:44c7:b5b8:23a7%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {230.124.112.182, 140.12.162.144}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr f9:7b:3e:7d:7f:2e
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 04:21:b4:ee:8e:91
}</pre>
