...
subtitle: "Tee It Up?"
layout: research
ip_v4_address: "84.1.80.76"
date: 2023-02-04T16:26:03+00:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like ```84.1.80.76``` or an IPv6 address like ```2000:8c8f:54d:3199:8a12:d23e:c79a:8ef2```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```3a:5c:12:9f:cb:3d```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://crona-stamm.name you initially access a DNS server to translate the host portion (crona-stamm) combined with the Top Level Domain (name) of the URL, to an IP address like ```228.147.3.213```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows; U; Win 9x 4.90; SG; rv:1.9.2.4) Gecko/20101104 Netscape/9.1.0285```
...
<pre>
default   fe80:2048:9490:3396:64be%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {169.12.90.70, 1.4.106.39}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 3a:5c:12:9f:cb:3d
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 38:92:ce:8a:dd:f3
}</pre>
