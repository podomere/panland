...
layout: research
ip_v4_address: "218.162.98.204"
date: 2022-04-24T19:00:23+01:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like <code>218.162.98.204</code> or an IPv6 address like <code>2000:7a6:4182:5d1f:8851:720a:cfa2:54f3</code>. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>10:d9:7e:10:91:48</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://adams-thiel.info you initially access a DNS server to translate the host portion (adams-thiel) combined with the Top Level Domain (info) of the URL, to an IP address like <code>236.182.96.124</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (Windows NT 6.1; WOW64; Trident/7.0; AS; rv:11.0) like Gecko</code>
...
<pre><code>
default   fe80:8e35:1207:d2e9:c7f6%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {120.240.236.197, 28.145.207.209}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 10:d9:7e:10:91:48
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr b1:30:61:3a:19:66
}</code></pre>
