...
subtitle: "Granular?"
layout: research
ip_v4_address: "242.88.132.70"
date: 2022-04-24T18:32:42+01:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like <code>242.88.132.70</code> or an IPv6 address like <code>2000:e256:3ee3:80a2:55c0:2dd5:de5e:3003</code>. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>d9:f6:f4:36:90:15</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://deckow.io you initially access a DNS server to translate the host portion (deckow) combined with the Top Level Domain (io) of the URL, to an IP address like <code>35.97.215.78</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Opera/9.80 (X11; Linux i686; Ubuntu/14.10) Presto/2.12.388 Version/12.16</code>
...
<pre><code>
default   fe80:3497:45a4:5d8c:a7d5%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {183.142.37.215, 193.49.193.117}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr d9:f6:f4:36:90:15
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 4d:80:81:35:e7:2c
}</code></pre>
