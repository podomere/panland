...
layout: research
ip_v4_address: "49.196.47.202"
date: 2022-04-24T19:00:07+01:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like <code>49.196.47.202</code> or an IPv6 address like <code>2000:904f:2aff:e086:eb55:d530:d4c1:c4b9</code>. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>46:98:65:7d:b7:a4</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://gulgowski-terry.info you initially access a DNS server to translate the host portion (gulgowski-terry) combined with the Top Level Domain (info) of the URL, to an IP address like <code>151.174.25.170</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (Windows NT 6.1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/41.0.2228.0 Safari/537.36</code>
...
<pre><code>
default   fe80:76e8:a33:f366:994d%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {226.176.212.149, 76.15.223.11}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 46:98:65:7d:b7:a4
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 93:7b:51:43:23:b0
}</code></pre>
