...
layout: research
ip_v4_address: "153.162.214.86"
date: 2022-11-19T16:17:23+00:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like ```153.162.214.86``` or an IPv6 address like ```2000:a246:2784:fac7:15aa:423:15f8:310f```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```92:4d:29:0a:02:57```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://turcotte-bednar.org you initially access a DNS server to translate the host portion (turcotte-bednar) combined with the Top Level Domain (org) of the URL, to an IP address like ```134.134.158.136```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1; WOW64; Trident/7.0; AS; rv:11.0) like Gecko```
...
<pre>
default   fe80:e0b9:a534:489d:ecac%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {9.211.107.254, 184.82.249.210}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 92:4d:29:0a:02:57
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 89:5c:6e:13:fa:2f
}</pre>
