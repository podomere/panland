...
layout: research
ip_v4_address: "189.164.3.6"
date: 2022-04-24T19:00:24+01:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like <code>189.164.3.6</code> or an IPv6 address like <code>2000:5de0:7f07:e70b:fa16:403d:5de:1951</code>. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>34:3a:32:d3:96:f0</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://pollich-schuster.info you initially access a DNS server to translate the host portion (pollich-schuster) combined with the Top Level Domain (info) of the URL, to an IP address like <code>108.136.147.178</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (Windows NT 6.1; WOW64; Trident/7.0; AS; rv:11.0) like Gecko</code>
...
<pre><code>
default   fe80:34a4:24d0:eb35:2320%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {143.108.30.225, 36.228.68.84}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 34:3a:32:d3:96:f0
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr c6:bb:24:31:fd:25
}</code></pre>
