...
layout: research
ip_v4_address: "79.11.176.183"
date: 2023-02-04T16:26:20+00:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like ```79.11.176.183``` or an IPv6 address like ```2000:7236:7c6d:c1bf:1693:897e:657e:8251```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```2c:f2:c5:1a:a1:ad```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://harvey-brown.name you initially access a DNS server to translate the host portion (harvey-brown) combined with the Top Level Domain (name) of the URL, to an IP address like ```68.71.75.175```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows; U; Win 9x 4.90; SG; rv:1.9.2.4) Gecko/20101104 Netscape/9.1.0285```
...
<pre>
default   fe80:88e5:45c3:d03f:80c5%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {122.144.223.23, 179.31.41.193}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 2c:f2:c5:1a:a1:ad
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr ed:bd:c2:11:61:8d
}</pre>
