---
title: "How To Troubleshoot Http Routing Issues"
subtitle: "T-shirt Sizes?"
layout: research
ip_v4_address: "138.181.11.46"
date: 2022-11-02T11:33:00+00:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like ```138.181.11.46``` or an IPv6 address like ```2000:6435:7f2c:6287:ea7a:77b5:17bd:63ab```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```9b:03:3d:09:3c:9c```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://terry-mckenzie.info you initially access a DNS server to translate the host portion (terry-mckenzie) combined with the Top Level Domain (info) of the URL, to an IP address like ```155.66.154.91```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/41.0.2228.0 Safari/537.36```

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```10.51.222.24``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  10.51.222.24    UGScg  en0
...
<pre>
default   fe80:2fec:457d:4880:fbf4%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {75.176.138.215, 153.156.1.196}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 9b:03:3d:09:3c:9c
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr d2:9a:ce:8b:ac:4b
}</pre>
...
## Apple macOS / OSX
No matter what version of OSX/macOS you are on, ```10.12.4```, ```11.4.5```, or ```12.2.3```, there are a range of tools for troubleshooting. Unfortunately, between these manual actions and scripts, they don't give you a series of correlated values over time. This is where automated remote troubleshooting comes in to its own, especially for teams that embrace remote work and Work From Anywhere (WFA).
