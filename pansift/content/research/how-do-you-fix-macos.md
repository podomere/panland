...
layout: research
ip_v4_address: "241.95.131.25"
date: 2023-10-06T17:10:41+01:00
draft: false
---

## Internet Addressing
On the Internet you might have a Public IPv4 address like ```241.95.131.25``` or an IPv6 address like ```2000:10f3:e66d:d528:3995:9939:6ff2:d03```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```8b:ff:34:4c:17:fb```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://wilkinson.info you initially access a DNS server to translate the host portion (wilkinson) combined with the Top Level Domain (info) of the URL, to an IP address like ```135.149.163.75```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1; WOW64; Trident/7.0; AS; rv:11.0) like Gecko```
...
default  172.18.35.106    UGScg  en0
...
<pre>
default   fe80:8f63:9c02:ef38:b4a5%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {204.197.35.98, 33.213.231.219}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 8b:ff:34:4c:17:fb
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 92:d4:ba:34:28:0e
}</pre>
