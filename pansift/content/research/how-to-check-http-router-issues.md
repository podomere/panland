...
layout: research
ip_v4_address: "234.231.48.64"
date: 2023-10-06T17:11:08+01:00
draft: false
---

## Internet Addressing
On the Internet you may have a Public IPv4 address like ```234.231.48.64``` or an IPv6 address like ```2000:42d:fa5e:60d8:990e:ae8e:49f6:c2fc```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```48:c4:c4:a2:d0:b3```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://moore-langworth.net you initially access a DNS server to translate the host portion (moore-langworth) combined with the Top Level Domain (net) of the URL, to an IP address like ```205.80.50.161```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (compatible; MSIE 9.0; AOL 9.7; AOLBuild 4343.19; Windows NT 6.1; WOW64; Trident/5.0; FunWebProducts)```
...
<pre>
default   fe80:8109:7f92:ae3b:8d17%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {245.234.102.218, 53.231.221.30}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 48:c4:c4:a2:d0:b3
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 88:c5:8b:09:40:71
}</pre>
...
### Apple macOS / OSX
No matter what version of OSX/macOS you are on, ```10.12.1```, ```11.1.7```, or ```12.2.1```, there are a range of tools for troubleshooting. Unfortunately, between these manual actions and scripts, they don't give you a series of correlated values over time. This is where automated remote troubleshooting comes in to its own, especially for teams that embrace remote work and Work From Anywhere (WFA).
