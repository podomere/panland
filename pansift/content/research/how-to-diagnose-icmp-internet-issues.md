...
layout: research
ip_v4_address: "161.153.19.71"
date: 2022-06-04T14:38:41+01:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like ```161.153.19.71``` or an IPv6 address like ```2000:2fcd:4d4b:1cf4:ed79:be5:769e:1d3```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```51:a1:90:89:bf:86```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://doyle-weimann.name you initially access a DNS server to translate the host portion (doyle-weimann) combined with the Top Level Domain (name) of the URL, to an IP address like ```124.224.230.236```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (compatible; MSIE 9.0; AOL 9.7; AOLBuild 4343.19; Windows NT 6.1; WOW64; Trident/5.0; FunWebProducts)```
...
<pre>
default   fe80:b07d:d508:8e05:a790%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {159.205.136.246, 30.40.235.65}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 51:a1:90:89:bf:86
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr de:8c:fb:b9:26:b8
}</pre>
