...
subtitle: "Swag?"
layout: research
ip_v4_address: "70.81.220.232"
date: 2022-06-12T14:09:24+01:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like ```70.81.220.232``` or an IPv6 address like ```2000:3909:158b:4197:1568:46c:77ea:32f7```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```72:03:ed:56:13:13```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://west.io you initially access a DNS server to translate the host portion (west) combined with the Top Level Domain (io) of the URL, to an IP address like ```162.149.39.162```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (compatible; MSIE 9.0; AOL 9.7; AOLBuild 4343.19; Windows NT 6.1; WOW64; Trident/5.0; FunWebProducts)```
...
<pre>
default   fe80:e0e4:8694:8632:c63e%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {34.149.10.146, 36.201.249.7}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 72:03:ed:56:13:13
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 8a:36:af:fe:b1:4d
}</pre>
