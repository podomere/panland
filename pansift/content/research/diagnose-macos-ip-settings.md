...
layout: research
ip_v4_address: "34.250.1.244"
date: 2022-06-04T14:38:27+01:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like ```34.250.1.244``` or an IPv6 address like ```2000:6422:c16:e1ea:d2ab:b8e:2729:38f2```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```26:6d:1e:3b:b3:9d```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://mante.co you initially access a DNS server to translate the host portion (mante) combined with the Top Level Domain (co) of the URL, to an IP address like ```172.189.73.161```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT x.y; Win64; x64; rv:10.0) Gecko/20100101 Firefox/10.0```
...
<pre>
default   fe80:6085:f33c:9f06:5276%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {203.234.174.226, 71.138.190.70}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 26:6d:1e:3b:b3:9d
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 29:1f:b5:6d:88:97
}</pre>
