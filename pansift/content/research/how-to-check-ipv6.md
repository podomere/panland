...
layout: research
ip_v4_address: "117.58.221.49"
date: 2022-04-24T18:59:55+01:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like <code>117.58.221.49</code> or an IPv6 address like <code>2000:bbd7:2b71:5ddb:4a35:fa74:e531:2a17</code>. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>35:9e:eb:b5:c0:c1</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://aufderhar.org you initially access a DNS server to translate the host portion (aufderhar) combined with the Top Level Domain (org) of the URL, to an IP address like <code>226.180.32.191</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (Windows; U; Win 9x 4.90; SG; rv:1.9.2.4) Gecko/20101104 Netscape/9.1.0285</code>
...
<pre><code>
default   fe80:a5af:b65f:1796:9c4b%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {216.11.142.78, 253.104.174.148}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 35:9e:eb:b5:c0:c1
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr b9:6d:10:1d:43:91
}</code></pre>
