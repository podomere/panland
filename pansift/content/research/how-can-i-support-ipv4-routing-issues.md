...
layout: research
ip_v4_address: "182.157.205.135"
date: 2022-04-24T18:59:57+01:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like <code>182.157.205.135</code> or an IPv6 address like <code>2000:2c89:f4e9:e16a:7b20:6e89:fa20:d30e</code>. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>12:c2:8e:a3:73:d3</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://russel-lemke.biz you initially access a DNS server to translate the host portion (russel-lemke) combined with the Top Level Domain (biz) of the URL, to an IP address like <code>214.111.48.128</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (compatible; MSIE 9.0; AOL 9.7; AOLBuild 4343.19; Windows NT 6.1; WOW64; Trident/5.0; FunWebProducts)</code>
...
<pre><code>
default   fe80:8fc2:4495:da2d:a075%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {204.60.125.158, 240.61.9.42}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 12:c2:8e:a3:73:d3
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr cb:80:d5:a7:59:bb
}</code></pre>
