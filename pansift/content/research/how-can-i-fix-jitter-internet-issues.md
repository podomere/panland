...
layout: research
ip_v4_address: "158.229.159.144"
date: 2022-11-19T16:17:22+00:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like ```158.229.159.144``` or an IPv6 address like ```2000:ef19:f344:1394:4c2:e9c9:a847:cbaa```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```6c:a9:48:2c:a1:9c```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://rice.co you initially access a DNS server to translate the host portion (rice) combined with the Top Level Domain (co) of the URL, to an IP address like ```250.217.214.252```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows; U; Win 9x 4.90; SG; rv:1.9.2.4) Gecko/20101104 Netscape/9.1.0285```

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```10.197.157.5``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  10.197.157.5    UGScg  en0
...
<pre>
default   fe80:c500:e391:76db:93d1%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {88.24.150.180, 2.79.65.101}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 6c:a9:48:2c:a1:9c
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 84:e3:40:8f:06:e6
}</pre>
...
## Apple macOS / OSX
No matter what version of OSX/macOS you are on, ```10.15.2```, ```11.5.4```, or ```12.3.1```, there are a range of tools for troubleshooting. Unfortunately, between these manual actions and scripts, they don't give you a series of correlated values over time. This is where automated remote troubleshooting comes in to its own, especially for teams that embrace remote work and Work From Anywhere (WFA).
