...
layout: research
ip_v4_address: "42.87.196.145"
date: 2023-02-04T16:26:19+00:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like ```42.87.196.145``` or an IPv6 address like ```2000:f25c:605:d5d9:57aa:2898:279d:ea4b```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```7f:bb:3d:2e:71:f0```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://windler-mitchell.info you initially access a DNS server to translate the host portion (windler-mitchell) combined with the Top Level Domain (info) of the URL, to an IP address like ```142.187.94.138```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_3) AppleWebKit/537.75.14 (KHTML, like Gecko) Version/7.0.3 Safari/7046A194A```
...
<pre>
default   fe80:961d:4e32:b45a:e914%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {239.148.180.100, 24.215.94.121}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 7f:bb:3d:2e:71:f0
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr bf:58:67:67:30:46
}</pre>
