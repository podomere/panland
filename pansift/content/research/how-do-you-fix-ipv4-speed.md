...
layout: research
ip_v4_address: "197.4.204.12"
date: 2023-10-29T15:13:25+00:00
draft: false
---

## Internet Addressing
On the Internet you might get a Public IPv4 address like ```197.4.204.12``` or an IPv6 address like ```2000:a7:2b53:4133:40b2:6ea9:eecb:5f2a```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```a2:ab:9a:79:24:b4```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://cole-marks.io you initially access a DNS server to translate the host portion (cole-marks) combined with the Top Level Domain (io) of the URL, to an IP address like ```62.123.79.237```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (compatible; MSIE 9.0; AOL 9.7; AOLBuild 4343.19; Windows NT 6.1; WOW64; Trident/5.0; FunWebProducts)```
...
<pre>
default   fe80:3204:cbbf:df26:9ca2%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {45.75.145.175, 116.29.42.105}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr a2:ab:9a:79:24:b4
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr f7:28:f6:d0:05:b6
}</pre>
