...
subtitle: "Granular?"
layout: research
ip_v4_address: "223.213.84.237"
date: 2022-06-04T14:38:16+01:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like ```223.213.84.237``` or an IPv6 address like ```2000:38d5:a469:9690:84ed:77e7:80ff:deb0```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```4d:88:d8:15:23:eb```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://zulauf-berge.biz you initially access a DNS server to translate the host portion (zulauf-berge) combined with the Top Level Domain (biz) of the URL, to an IP address like ```43.241.43.3```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT x.y; Win64; x64; rv:10.0) Gecko/20100101 Firefox/10.0```

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```172.30.46.83``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  172.30.46.83    UGScg  en0
...
<pre>
default   fe80:4138:6651:7b95:4184%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {227.237.240.83, 145.68.64.21}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 4d:88:d8:15:23:eb
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr b0:84:64:50:42:eb
}</pre>
