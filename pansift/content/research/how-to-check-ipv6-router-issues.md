...
subtitle: "Ideate?"
layout: research
ip_v4_address: "101.126.244.211"
date: 2023-10-06T17:11:03+01:00
draft: false
---

## Internet Addressing
On the Internet you may get a Public IPv4 address like ```101.126.244.211``` or an IPv6 address like ```2000:d0d1:922f:5a85:af07:4a83:6859:fb1d```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```27:4d:db:9d:20:90```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://hegmann-ankunding.io you initially access a DNS server to translate the host portion (hegmann-ankunding) combined with the Top Level Domain (io) of the URL, to an IP address like ```163.72.0.167```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (compatible; MSIE 9.0; AOL 9.7; AOLBuild 4343.19; Windows NT 6.1; WOW64; Trident/5.0; FunWebProducts)```
...
<pre>
default   fe80:23c5:75c4:d807:e42a%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {101.55.109.201, 156.179.107.119}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 27:4d:db:9d:20:90
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr f2:eb:25:d8:e1:c0
}</pre>
