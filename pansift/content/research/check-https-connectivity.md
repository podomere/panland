...
layout: research
ip_v4_address: "105.81.134.207"
date: 2022-05-05T14:30:10+01:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like ```105.81.134.207``` or an IPv6 address like ```2000:419c:1574:ac50:ab9d:6dfc:e5bf:51dd```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```5d:05:63:f7:91:e7```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://botsford-ebert.info you initially access a DNS server to translate the host portion (botsford-ebert) combined with the Top Level Domain (info) of the URL, to an IP address like ```246.79.160.161```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_3) AppleWebKit/537.75.14 (KHTML, like Gecko) Version/7.0.3 Safari/7046A194A```
...
<pre>
default   fe80:5403:b75:1e2f:f2cb%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {200.151.206.196, 198.49.50.141}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 5d:05:63:f7:91:e7
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 1f:c7:35:a4:75:ef
}</pre>
