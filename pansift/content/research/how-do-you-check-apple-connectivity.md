...
layout: research
ip_v4_address: "110.30.21.215"
date: 2022-11-02T11:33:11+00:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like ```110.30.21.215``` or an IPv6 address like ```2000:49a7:263:fea4:3012:d581:61e0:9f8d```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```d3:84:f1:57:0f:00```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://swift-schmeler.co you initially access a DNS server to translate the host portion (swift-schmeler) combined with the Top Level Domain (co) of the URL, to an IP address like ```53.102.211.242```. Your computer and browser actually sends its type with all web requests e.g. <br>```Opera/9.80 (X11; Linux i686; Ubuntu/14.10) Presto/2.12.388 Version/12.16```
...
<pre>
default   fe80:9793:bbc7:afd8:a880%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {174.226.236.234, 173.120.117.109}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr d3:84:f1:57:0f:00
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 91:20:d3:a5:1c:b5
}</pre>
