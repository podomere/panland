...
layout: research
ip_v4_address: "60.4.30.242"
date: 2023-10-29T15:13:30+00:00
draft: false
---

## Internet Addressing
On the Internet you may get a Public IPv4 address like ```60.4.30.242``` or an IPv6 address like ```2000:8bb:6b7a:f14a:97be:c0f9:5044:5665```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```50:f6:9f:ab:27:19```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://wilderman-feil.org you initially access a DNS server to translate the host portion (wilderman-feil) combined with the Top Level Domain (org) of the URL, to an IP address like ```195.219.189.15```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1; WOW64; Trident/7.0; AS; rv:11.0) like Gecko```
...
<pre>
default   fe80:ecc:f50e:155:8ee%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {123.119.249.89, 137.48.112.169}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 50:f6:9f:ab:27:19
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 0f:de:04:de:c1:5d
}</pre>
