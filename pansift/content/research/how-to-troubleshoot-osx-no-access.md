...
layout: research
ip_v4_address: "41.56.228.112"
date: 2023-02-04T17:07:48+00:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like ```41.56.228.112``` or an IPv6 address like ```2000:644c:63eb:9f28:f36:f0e8:cb7:42b6```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```54:a2:54:6e:ad:72```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://hintz-fay.io you initially access a DNS server to translate the host portion (hintz-fay) combined with the Top Level Domain (io) of the URL, to an IP address like ```205.216.223.116```. Your computer and browser actually sends its type with all web requests e.g. <br>```Opera/9.80 (X11; Linux i686; Ubuntu/14.10) Presto/2.12.388 Version/12.16```
...
<pre>
default   fe80:b569:408d:8b74:6e1%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {73.223.151.235, 75.255.255.253}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 54:a2:54:6e:ad:72
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 36:f7:4e:58:22:42
}</pre>
