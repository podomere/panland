...
layout: research
ip_v4_address: "87.138.73.54"
date: 2022-05-05T14:28:46+01:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like ```87.138.73.54``` or an IPv6 address like ```2000:fb91:79db:a67:2d08:7811:cb26:6ef5```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```e4:15:3f:36:57:79```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://carroll-bruen.net you initially access a DNS server to translate the host portion (carroll-bruen) combined with the Top Level Domain (net) of the URL, to an IP address like ```212.59.183.251```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_3) AppleWebKit/537.75.14 (KHTML, like Gecko) Version/7.0.3 Safari/7046A194A```

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```172.25.241.40``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  172.25.241.40    UGScg  en0
...
<pre>
default   fe80:de59:72f:153f:c84f%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {114.140.51.180, 129.26.100.49}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr e4:15:3f:36:57:79
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 5b:25:c4:9c:c3:69
}</pre>
