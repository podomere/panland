...
layout: research
ip_v4_address: "240.200.162.106"
date: 2022-11-19T19:13:15+00:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like ```240.200.162.106``` or an IPv6 address like ```2000:9176:1a51:11f7:2939:1996:3cff:1d6```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```9d:1d:16:9e:2f:94```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://heathcote.org you initially access a DNS server to translate the host portion (heathcote) combined with the Top Level Domain (org) of the URL, to an IP address like ```94.216.215.44```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT x.y; Win64; x64; rv:10.0) Gecko/20100101 Firefox/10.0```
...
<pre>
default   fe80:97ab:4bf:a441:dad1%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {210.155.198.24, 123.56.28.163}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 9d:1d:16:9e:2f:94
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 3d:5b:13:fc:e6:0d
}</pre>
