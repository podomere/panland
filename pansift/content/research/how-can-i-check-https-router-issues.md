...
subtitle: "Learnings?"
layout: research
ip_v4_address: "236.73.150.249"
date: 2022-06-12T14:09:29+01:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like ```236.73.150.249``` or an IPv6 address like ```2000:c703:5085:49be:2f20:c9b3:83b4:49b1```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```fb:07:2e:4d:fd:df```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://sauer.com you initially access a DNS server to translate the host portion (sauer) combined with the Top Level Domain (com) of the URL, to an IP address like ```28.157.123.223```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows; U; Win 9x 4.90; SG; rv:1.9.2.4) Gecko/20101104 Netscape/9.1.0285```
...
default  172.28.52.187    UGScg  en0
...
<pre>
default   fe80:82f3:4501:e230:c45b%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {20.128.190.67, 101.73.58.48}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr fb:07:2e:4d:fd:df
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 1d:c2:0e:e7:ff:6a
}</pre>
...
## Apple macOS / OSX
No matter what version of OSX/macOS you are on, ```10.13.5```, ```11.6.1```, or ```12.1.8```, there are a range of tools for troubleshooting. Unfortunately, between these manual actions and scripts, they don't give you a series of correlated values over time. This is where automated remote troubleshooting comes in to its own, especially for teams that embrace remote work and Work From Anywhere (WFA).
