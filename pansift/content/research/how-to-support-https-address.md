---
title: "How To Support Https Address"
subtitle: "Etc. Etc.?"
layout: research
ip_v4_address: "97.56.232.4"
date: 2022-11-02T11:33:01+00:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like ```97.56.232.4``` or an IPv6 address like ```2000:693d:8c8f:de05:a10f:64ba:1046:5f0d```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```6e:6e:f8:6a:be:68```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://bartoletti-nicolas.org you initially access a DNS server to translate the host portion (bartoletti-nicolas) combined with the Top Level Domain (org) of the URL, to an IP address like ```117.178.79.231```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT x.y; Win64; x64; rv:10.0) Gecko/20100101 Firefox/10.0```

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```172.21.142.115``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  172.21.142.115    UGScg  en0
...
<pre>
default   fe80:238c:4945:784d:be8%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {134.96.43.127, 107.13.157.64}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 6e:6e:f8:6a:be:68
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 66:3d:2b:1e:7a:da
}</pre>
