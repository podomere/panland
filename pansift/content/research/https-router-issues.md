...
layout: research
ip_v4_address: "187.226.190.169"
date: 2022-11-19T19:13:28+00:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like ```187.226.190.169``` or an IPv6 address like ```2000:d0c:f8ea:ed54:8a7a:f1f9:5695:d956```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```bd:6c:97:e8:f0:fa```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://gerhold-dibbert.com you initially access a DNS server to translate the host portion (gerhold-dibbert) combined with the Top Level Domain (com) of the URL, to an IP address like ```91.13.79.45```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_3) AppleWebKit/537.75.14 (KHTML, like Gecko) Version/7.0.3 Safari/7046A194A```
...
<pre>
default   fe80:57f2:b6a3:adb5:2472%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {234.247.169.224, 15.152.71.228}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr bd:6c:97:e8:f0:fa
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 81:38:3e:1e:9d:1b
}</pre>
