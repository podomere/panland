...
layout: research
ip_v4_address: "167.9.217.101"
date: 2023-10-29T15:13:19+00:00
draft: false
---

## Internet Addressing
On the Internet you might get a Public IPv4 address like ```167.9.217.101``` or an IPv6 address like ```2000:6962:d345:b084:ea14:b0b0:2f6b:6825```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```49:7f:e7:6e:7a:00```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://hoeger-simonis.com you initially access a DNS server to translate the host portion (hoeger-simonis) combined with the Top Level Domain (com) of the URL, to an IP address like ```76.140.174.43```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (compatible; MSIE 9.0; AOL 9.7; AOLBuild 4343.19; Windows NT 6.1; WOW64; Trident/5.0; FunWebProducts)```
...
<pre>
default   fe80:9b40:ee43:dd36:2d6a%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {240.215.71.96, 211.23.36.128}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 49:7f:e7:6e:7a:00
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr aa:1e:2b:01:4f:c5
}</pre>
