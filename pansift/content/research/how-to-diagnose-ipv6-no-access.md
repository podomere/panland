...
layout: research
ip_v4_address: "225.156.109.6"
date: 2022-11-02T11:32:52+00:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like ```225.156.109.6``` or an IPv6 address like ```2000:4bc9:e06:d92:e3c8:f08f:1e42:5ec5```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```24:63:44:29:e4:1a```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://fay-osinski.name you initially access a DNS server to translate the host portion (fay-osinski) combined with the Top Level Domain (name) of the URL, to an IP address like ```217.128.81.215```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1; WOW64; Trident/7.0; AS; rv:11.0) like Gecko```
...
<pre>
default   fe80:f53e:f479:4237:6e4c%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {211.230.71.23, 154.233.249.35}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 24:63:44:29:e4:1a
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr bf:1c:f2:f9:71:57
}</pre>
