...
layout: research
ip_v4_address: "23.252.160.95"
date: 2022-04-24T18:59:58+01:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like <code>23.252.160.95</code> or an IPv6 address like <code>2000:216:f462:411e:6bb0:90f2:3e2d:e426</code>. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>8e:3f:00:65:05:fe</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://borer.biz you initially access a DNS server to translate the host portion (borer) combined with the Top Level Domain (biz) of the URL, to an IP address like <code>82.17.207.164</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (Windows NT 6.1; WOW64; Trident/7.0; AS; rv:11.0) like Gecko</code>

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like <code>10.237.34.187</code> (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For <code>IPv6</code> we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  10.237.34.187    UGScg  en0
...
<pre><code>
default   fe80:394f:472:341b:3f1%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {214.50.31.99, 52.6.30.162}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 8e:3f:00:65:05:fe
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr b2:82:76:20:5c:c2
}</code></pre>
