---
title: "How Can I Troubleshoot IPv4 Speed"
subtitle: "Streamline?"
layout: research
ip_v4_address: "209.100.216.145"
date: 2022-11-19T19:13:24+00:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like ```209.100.216.145``` or an IPv6 address like ```2000:cfcc:5eca:146:b551:ebe7:1164:2803```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```1b:f1:87:03:d7:c6```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://veum-breitenberg.info you initially access a DNS server to translate the host portion (veum-breitenberg) combined with the Top Level Domain (info) of the URL, to an IP address like ```11.200.7.241```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/41.0.2228.0 Safari/537.36```

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```172.24.108.50``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  172.24.108.50    UGScg  en0
...
<pre>
default   fe80:383f:6fb7:df00:9bfd%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {72.185.8.81, 200.12.107.102}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 1b:f1:87:03:d7:c6
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 86:57:bb:f0:8a:27
}</pre>
