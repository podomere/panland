---
title: "How Do You DiagnOSe Ping Speed"
subtitle: "Button Up The Loose Ends?"
layout: research
ip_v4_address: "39.178.202.47"
date: 2022-11-19T19:13:27+00:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like ```39.178.202.47``` or an IPv6 address like ```2000:f32d:e489:c3d0:80d5:675c:c6de:a190```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```46:16:2f:c7:45:40```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://tremblay-mosciski.org you initially access a DNS server to translate the host portion (tremblay-mosciski) combined with the Top Level Domain (org) of the URL, to an IP address like ```225.165.186.129```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (compatible; MSIE 9.0; AOL 9.7; AOLBuild 4343.19; Windows NT 6.1; WOW64; Trident/5.0; FunWebProducts)```

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```192.168.205.148``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  192.168.205.148    UGScg  en0
...
<pre>
default   fe80:fd38:8055:3350:2749%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {123.254.139.165, 109.185.208.100}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 46:16:2f:c7:45:40
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 3f:96:2e:e3:42:c9
}</pre>
