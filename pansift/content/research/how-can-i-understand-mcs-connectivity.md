...
subtitle: "Ideate?"
layout: research
ip_v4_address: "110.234.3.104"
date: 2022-06-12T14:09:05+01:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like ```110.234.3.104``` or an IPv6 address like ```2000:8d5:1377:aace:72cb:e03:d6e7:3410```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```71:b7:b1:91:92:13```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://metz-okeefe.info you initially access a DNS server to translate the host portion (metz-okeefe) combined with the Top Level Domain (info) of the URL, to an IP address like ```137.215.120.144```. Your computer and browser actually sends its type with all web requests e.g. <br>```Opera/9.80 (X11; Linux i686; Ubuntu/14.10) Presto/2.12.388 Version/12.16```

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```192.168.167.35``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  192.168.167.35    UGScg  en0
...
<pre>
default   fe80:c76f:b531:1219:dfb8%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {58.130.204.69, 29.53.44.213}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 71:b7:b1:91:92:13
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 35:22:43:a6:18:4b
}</pre>
