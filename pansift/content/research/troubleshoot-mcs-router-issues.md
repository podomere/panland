...
subtitle: "Synergy?"
layout: research
ip_v4_address: "14.136.178.102"
date: 2022-04-24T19:00:34+01:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like <code>14.136.178.102</code> or an IPv6 address like <code>2000:b415:4312:5a40:ef32:fdd9:7aa4:7216</code>. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>a5:db:66:82:42:54</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://labadie-pouros.name you initially access a DNS server to translate the host portion (labadie-pouros) combined with the Top Level Domain (name) of the URL, to an IP address like <code>229.246.42.113</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (compatible; MSIE 9.0; AOL 9.7; AOLBuild 4343.19; Windows NT 6.1; WOW64; Trident/5.0; FunWebProducts)</code>
...
default  172.18.120.56    UGScg  en0
...
<pre><code>
default   fe80:1bd0:e8f3:ee4e:7315%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {45.50.228.94, 184.13.39.152}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr a5:db:66:82:42:54
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr ca:14:7c:1f:6f:e3
}</code></pre>
