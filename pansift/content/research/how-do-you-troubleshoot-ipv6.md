...
subtitle: "Value Add?"
layout: research
ip_v4_address: "212.233.84.69"
date: 2022-04-24T18:59:56+01:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like <code>212.233.84.69</code> or an IPv6 address like <code>2000:1f90:70a:da5f:f25d:35b5:ea88:aa58</code>. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>f3:06:1e:14:86:5a</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://sanford-considine.name you initially access a DNS server to translate the host portion (sanford-considine) combined with the Top Level Domain (name) of the URL, to an IP address like <code>204.68.93.119</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (Windows NT 6.1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/41.0.2228.0 Safari/537.36</code>
...
<pre><code>
default   fe80:7244:bb3a:6ed:dd41%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {198.90.222.252, 50.51.248.172}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr f3:06:1e:14:86:5a
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 9c:90:73:2b:a8:6c
}</code></pre>
