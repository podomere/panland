...
subtitle: "Deep Dive?"
layout: research
ip_v4_address: "146.99.6.89"
date: 2022-04-24T19:00:03+01:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like <code>146.99.6.89</code> or an IPv6 address like <code>2000:edd:cf5a:cfcc:3f03:5c14:c7f7:801c</code>. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>01:25:7c:aa:cb:60</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://mante-rau.info you initially access a DNS server to translate the host portion (mante-rau) combined with the Top Level Domain (info) of the URL, to an IP address like <code>47.225.182.14</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Opera/9.80 (X11; Linux i686; Ubuntu/14.10) Presto/2.12.388 Version/12.16</code>

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like <code>10.141.189.7</code> (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For <code>IPv6</code> we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  10.141.189.7    UGScg  en0
...
<pre><code>
default   fe80:43fa:e473:4066:eb9d%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {69.191.75.248, 215.138.97.24}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 01:25:7c:aa:cb:60
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 92:8f:97:cb:b4:b4
}</code></pre>
