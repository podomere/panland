...
layout: research
ip_v4_address: "241.226.83.105"
date: 2023-10-06T17:11:06+01:00
draft: false
---

## Internet Addressing
On the Internet you may have a Public IPv4 address like ```241.226.83.105``` or an IPv6 address like ```2000:3b7e:254a:cdc0:45e4:5e5:59f0:38c2```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```52:ac:8b:ed:e2:4e```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://koch-thompson.co you initially access a DNS server to translate the host portion (koch-thompson) combined with the Top Level Domain (co) of the URL, to an IP address like ```69.26.20.229```. Your computer and browser actually sends its type with all web requests e.g. <br>```Opera/9.80 (X11; Linux i686; Ubuntu/14.10) Presto/2.12.388 Version/12.16```
...
<pre>
default   fe80:a4c:36fe:b8e2:4470%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {214.154.222.41, 175.108.144.98}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 52:ac:8b:ed:e2:4e
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 98:f8:aa:af:83:39
}</pre>
