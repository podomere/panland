...
layout: research
ip_v4_address: "108.7.127.64"
date: 2022-04-24T19:00:07+01:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like <code>108.7.127.64</code> or an IPv6 address like <code>2000:e903:a761:a695:73e8:6d70:ed26:f423</code>. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>43:e5:0f:f3:26:81</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://mcclure-hagenes.com you initially access a DNS server to translate the host portion (mcclure-hagenes) combined with the Top Level Domain (com) of the URL, to an IP address like <code>55.61.118.185</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (compatible; MSIE 9.0; AOL 9.7; AOLBuild 4343.19; Windows NT 6.1; WOW64; Trident/5.0; FunWebProducts)</code>
...
default  172.21.194.222    UGScg  en0
...
<pre><code>
default   fe80:97b3:cce4:36b1:183e%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {210.189.171.181, 169.237.205.221}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 43:e5:0f:f3:26:81
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 8a:c2:63:cf:ed:76
}</code></pre>
