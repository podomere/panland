...
layout: research
ip_v4_address: "82.132.176.13"
date: 2022-11-19T19:13:25+00:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like ```82.132.176.13``` or an IPv6 address like ```2000:8162:e8bd:6086:758:ebcc:fe92:b555```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```d2:d9:f4:31:48:87```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://bergstrom-osinski.info you initially access a DNS server to translate the host portion (bergstrom-osinski) combined with the Top Level Domain (info) of the URL, to an IP address like ```231.31.129.216```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows; U; Win 9x 4.90; SG; rv:1.9.2.4) Gecko/20101104 Netscape/9.1.0285```
...
<pre>
default   fe80:f5dd:d7bc:4add:c994%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {95.154.249.69, 76.222.46.23}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr d2:d9:f4:31:48:87
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 58:fb:9e:54:ec:65
}</pre>
