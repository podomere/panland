...
layout: research
ip_v4_address: "137.128.58.204"
date: 2022-04-24T19:00:03+01:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like <code>137.128.58.204</code> or an IPv6 address like <code>2000:982c:1059:abac:ccdd:6972:c357:bbcd</code>. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>03:78:73:ed:ab:65</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://kuhic-goldner.co you initially access a DNS server to translate the host portion (kuhic-goldner) combined with the Top Level Domain (co) of the URL, to an IP address like <code>104.235.228.87</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_3) AppleWebKit/537.75.14 (KHTML, like Gecko) Version/7.0.3 Safari/7046A194A</code>
...
default  172.29.209.180    UGScg  en0
...
<pre><code>
default   fe80:1623:acad:c4d:a0b5%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {67.250.184.203, 80.106.111.176}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 03:78:73:ed:ab:65
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 03:66:1f:85:ea:43
}</code></pre>
