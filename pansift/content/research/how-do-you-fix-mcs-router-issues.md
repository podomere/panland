---
title: "How Do You Fix Mcs Router Issues"
subtitle: "Bucketize It?"
layout: research
ip_v4_address: "9.180.204.38"
date: 2022-04-24T18:32:42+01:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like <code>9.180.204.38</code> or an IPv6 address like <code>2000:8e37:2bd5:b786:30b2:cbcf:2d9e:79d3</code>. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>21:7b:2d:30:0f:5c</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://doyle-abernathy.biz you initially access a DNS server to translate the host portion (doyle-abernathy) combined with the Top Level Domain (biz) of the URL, to an IP address like <code>222.153.200.74</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (Windows; U; Win 9x 4.90; SG; rv:1.9.2.4) Gecko/20101104 Netscape/9.1.0285</code>

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like <code>10.119.109.68</code> (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For <code>IPv6</code> we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  10.119.109.68    UGScg  en0
...
<pre><code>
default   fe80:acc2:9ec2:37d2:e0e5%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {10.244.246.92, 206.74.153.220}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 21:7b:2d:30:0f:5c
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 45:77:ea:b1:f6:60
}</code></pre>
