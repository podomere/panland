...
subtitle: "Ideate?"
layout: research
ip_v4_address: "153.218.7.157"
date: 2022-11-19T19:13:15+00:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like ```153.218.7.157``` or an IPv6 address like ```2000:9f48:c9d6:5c0b:3b79:df5:2b02:71```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```b8:8b:21:b2:4f:9f```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://hermiston-mclaughlin.com you initially access a DNS server to translate the host portion (hermiston-mclaughlin) combined with the Top Level Domain (com) of the URL, to an IP address like ```111.194.106.228```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (compatible; MSIE 9.0; AOL 9.7; AOLBuild 4343.19; Windows NT 6.1; WOW64; Trident/5.0; FunWebProducts)```
...
<pre>
default   fe80:b14e:a30:87c6:66ca%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {40.163.31.94, 143.95.195.92}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr b8:8b:21:b2:4f:9f
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 2e:1c:85:cb:38:e4
}</pre>
