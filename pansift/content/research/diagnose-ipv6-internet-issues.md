...
subtitle: "Ideate?"
layout: research
ip_v4_address: "178.210.202.184"
date: 2023-02-04T16:26:17+00:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like ```178.210.202.184``` or an IPv6 address like ```2000:7cd6:1276:7e08:93a:a35c:b18e:6b0a```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```e8:c0:eb:4b:1e:c1```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://gusikowski-marquardt.com you initially access a DNS server to translate the host portion (gusikowski-marquardt) combined with the Top Level Domain (com) of the URL, to an IP address like ```102.8.34.179```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1; WOW64; Trident/7.0; AS; rv:11.0) like Gecko```

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```10.110.188.14``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  10.110.188.14    UGScg  en0
...
<pre>
default   fe80:7bb3:539f:f095:55ff%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {131.239.229.80, 159.73.228.104}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr e8:c0:eb:4b:1e:c1
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr f2:5a:68:38:f0:b0
}</pre>
