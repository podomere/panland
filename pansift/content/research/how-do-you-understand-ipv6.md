...
layout: research
ip_v4_address: "160.239.59.19"
date: 2022-11-19T16:17:20+00:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like ```160.239.59.19``` or an IPv6 address like ```2000:2f97:8f9b:a1aa:1104:1408:b95d:2072```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```ed:96:bd:d1:3d:4f```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://cartwright.com you initially access a DNS server to translate the host portion (cartwright) combined with the Top Level Domain (com) of the URL, to an IP address like ```33.140.18.25```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows; U; Win 9x 4.90; SG; rv:1.9.2.4) Gecko/20101104 Netscape/9.1.0285```
...
<pre>
default   fe80:cc7d:dc10:bf4a:f879%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {118.94.210.67, 198.127.248.178}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr ed:96:bd:d1:3d:4f
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 8e:40:05:cf:77:41
}</pre>
