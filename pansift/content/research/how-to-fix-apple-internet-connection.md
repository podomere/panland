...
layout: research
ip_v4_address: "137.109.245.225"
date: 2022-11-19T19:13:17+00:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like ```137.109.245.225``` or an IPv6 address like ```2000:cdd7:f36e:d53e:8560:a168:f108:ca84```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```23:95:1a:b6:3f:33```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://botsford-wolff.io you initially access a DNS server to translate the host portion (botsford-wolff) combined with the Top Level Domain (io) of the URL, to an IP address like ```184.42.206.70```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1; WOW64; Trident/7.0; AS; rv:11.0) like Gecko```
...
<pre>
default   fe80:636a:6647:b4d0:2176%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {219.106.53.85, 7.242.118.202}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 23:95:1a:b6:3f:33
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr c9:20:28:91:ee:1f
}</pre>
