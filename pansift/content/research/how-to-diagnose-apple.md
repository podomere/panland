...
layout: research
ip_v4_address: "164.36.70.104"
date: 2022-04-24T18:31:58+01:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like <code>164.36.70.104</code> or an IPv6 address like <code>2000:6d00:1a05:3f3a:2e5d:45f5:cf69:c949</code>. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>76:56:02:e5:c0:69</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://mcclure-kunze.net you initially access a DNS server to translate the host portion (mcclure-kunze) combined with the Top Level Domain (net) of the URL, to an IP address like <code>117.61.88.97</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (Windows NT 6.1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/41.0.2228.0 Safari/537.36</code>
...
default  172.22.235.176    UGScg  en0
...
<pre><code>
default   fe80:e8d3:8e48:9338:936f%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {34.72.189.39, 189.98.77.62}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 76:56:02:e5:c0:69
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 34:0b:f9:c2:b0:5a
}</code></pre>
