...
layout: research
ip_v4_address: "200.83.194.24"
date: 2022-04-24T19:00:24+01:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like <code>200.83.194.24</code> or an IPv6 address like <code>2000:b849:8981:7d8f:5b78:b2ec:8815:436b</code>. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>db:0a:6d:19:c0:c7</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://homenick-wiegand.name you initially access a DNS server to translate the host portion (homenick-wiegand) combined with the Top Level Domain (name) of the URL, to an IP address like <code>122.225.18.139</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (Windows NT 6.1; WOW64; Trident/7.0; AS; rv:11.0) like Gecko</code>
...
<pre><code>
default   fe80:bc20:2064:5fb9:e5d%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {49.129.210.138, 117.9.59.169}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr db:0a:6d:19:c0:c7
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr ad:df:d7:7b:54:08
}</code></pre>
