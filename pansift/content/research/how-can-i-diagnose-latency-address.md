...
layout: research
ip_v4_address: "158.77.147.122"
date: 2023-10-29T15:13:26+00:00
draft: false
---

## Internet Addressing
On the Internet you might get a Public IPv4 address like ```158.77.147.122``` or an IPv6 address like ```2000:f494:f89d:b20d:c83:bab4:9efa:9e5b```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```38:c2:de:aa:6f:69```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://senger-nolan.biz you initially access a DNS server to translate the host portion (senger-nolan) combined with the Top Level Domain (biz) of the URL, to an IP address like ```205.106.154.99```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_3) AppleWebKit/537.75.14 (KHTML, like Gecko) Version/7.0.3 Safari/7046A194A```
...
<pre>
default   fe80:ebc1:3e7a:bd89:f9f9%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {159.88.149.186, 209.6.13.12}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 38:c2:de:aa:6f:69
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr d2:33:a2:b7:bd:83
}</pre>
