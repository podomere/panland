...
layout: research
ip_v4_address: "65.114.203.70"
date: 2022-04-24T18:59:56+01:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like <code>65.114.203.70</code> or an IPv6 address like <code>2000:f04:701a:c557:f6b7:a679:54b:a69b</code>. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>f4:a5:2c:da:e9:24</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://metz-bins.info you initially access a DNS server to translate the host portion (metz-bins) combined with the Top Level Domain (info) of the URL, to an IP address like <code>0.171.153.128</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_3) AppleWebKit/537.75.14 (KHTML, like Gecko) Version/7.0.3 Safari/7046A194A</code>
...
<pre><code>
default   fe80:6679:5927:cd0b:4ab6%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {253.5.42.45, 51.43.226.138}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr f4:a5:2c:da:e9:24
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr ab:bf:8f:d4:9d:ba
}</code></pre>
