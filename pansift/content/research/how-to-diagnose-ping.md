...
subtitle: "Streamline?"
layout: research
ip_v4_address: "157.5.224.198"
date: 2023-02-04T16:26:22+00:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like ```157.5.224.198``` or an IPv6 address like ```2000:949:1dbe:7da4:f241:5df7:ed8:616d```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```e0:cd:21:c0:1d:c7```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://blick.info you initially access a DNS server to translate the host portion (blick) combined with the Top Level Domain (info) of the URL, to an IP address like ```189.104.117.30```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT x.y; Win64; x64; rv:10.0) Gecko/20100101 Firefox/10.0```

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```10.109.160.41``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  10.109.160.41    UGScg  en0
...
<pre>
default   fe80:abea:ca08:de65:bac4%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {182.127.71.7, 46.218.6.127}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr e0:cd:21:c0:1d:c7
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr bc:91:d9:c7:11:7a
}</pre>
