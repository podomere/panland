...
layout: research
ip_v4_address: "136.45.32.187"
date: 2023-02-04T17:08:39+00:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like ```136.45.32.187``` or an IPv6 address like ```2000:8e87:f3b3:cc79:f93b:94bf:eff5:7c29```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```60:43:84:90:ef:da```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://farrell-wiza.net you initially access a DNS server to translate the host portion (farrell-wiza) combined with the Top Level Domain (net) of the URL, to an IP address like ```45.136.74.248```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT x.y; Win64; x64; rv:10.0) Gecko/20100101 Firefox/10.0```
...
<pre>
default   fe80:5541:4caa:f932:d36b%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {201.178.48.188, 140.109.167.142}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 60:43:84:90:ef:da
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 1e:ce:7d:24:58:b4
}</pre>
