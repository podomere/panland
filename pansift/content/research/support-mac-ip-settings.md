...
layout: research
ip_v4_address: "16.56.128.223"
date: 2022-04-24T18:31:59+01:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like <code>16.56.128.223</code> or an IPv6 address like <code>2000:69b3:6010:a85a:12b5:a976:8d71:dca</code>. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>93:51:07:14:c3:67</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://kemmer-stamm.com you initially access a DNS server to translate the host portion (kemmer-stamm) combined with the Top Level Domain (com) of the URL, to an IP address like <code>143.126.95.93</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (Windows; U; Win 9x 4.90; SG; rv:1.9.2.4) Gecko/20101104 Netscape/9.1.0285</code>
...
<pre><code>
default   fe80:d389:49f4:488b:bcd8%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {52.189.163.79, 249.219.68.173}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 93:51:07:14:c3:67
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr ca:43:8c:46:cf:c9
}</code></pre>
