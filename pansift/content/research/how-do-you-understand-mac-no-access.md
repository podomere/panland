...
subtitle: "Ideate?"
layout: research
ip_v4_address: "248.59.52.109"
date: 2022-04-24T18:31:59+01:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like <code>248.59.52.109</code> or an IPv6 address like <code>2000:b049:6da5:5e3a:3f62:ad61:d2fc:135</code>. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>eb:b2:bb:a1:89:94</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://wyman-schiller.info you initially access a DNS server to translate the host portion (wyman-schiller) combined with the Top Level Domain (info) of the URL, to an IP address like <code>82.70.71.63</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (compatible; MSIE 9.0; AOL 9.7; AOLBuild 4343.19; Windows NT 6.1; WOW64; Trident/5.0; FunWebProducts)</code>
...
<pre><code>
default   fe80:808b:46c:fb80:d912%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {110.118.221.3, 25.3.131.47}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr eb:b2:bb:a1:89:94
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 50:49:79:8f:d1:72
}</code></pre>
