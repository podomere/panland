...
layout: research
ip_v4_address: "233.221.107.198"
date: 2023-02-04T17:08:39+00:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like ```233.221.107.198``` or an IPv6 address like ```2000:bc69:e294:c9b3:235c:de01:f61d:22c9```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```67:e0:b6:6d:bf:9c```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://sipes-labadie.org you initially access a DNS server to translate the host portion (sipes-labadie) combined with the Top Level Domain (org) of the URL, to an IP address like ```173.99.254.106```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1; WOW64; Trident/7.0; AS; rv:11.0) like Gecko```
...
<pre>
default   fe80:28b6:de4d:af4f:3639%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {120.14.138.52, 241.94.38.106}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 67:e0:b6:6d:bf:9c
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 6d:2b:7a:68:4a:da
}</pre>
