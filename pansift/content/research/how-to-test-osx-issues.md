...
layout: research
ip_v4_address: "221.126.235.200"
date: 2023-02-04T17:07:48+00:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like ```221.126.235.200``` or an IPv6 address like ```2000:4b7f:7f6b:d82c:3315:e1a2:47fe:666f```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```1a:ce:19:bd:23:bd```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://dietrich.com you initially access a DNS server to translate the host portion (dietrich) combined with the Top Level Domain (com) of the URL, to an IP address like ```254.9.202.168```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1; WOW64; Trident/7.0; AS; rv:11.0) like Gecko```

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```10.63.192.181``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  10.63.192.181    UGScg  en0
...
<pre>
default   fe80:e903:ecb4:a274:442b%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {127.9.213.245, 173.126.205.178}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 1a:ce:19:bd:23:bd
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr d6:cf:bb:cc:58:45
}</pre>
...
## Apple macOS / OSX
No matter what version of OSX/macOS you are on, ```10.11.4```, ```11.4.2```, or ```12.0.9```, there are a range of tools for troubleshooting. Unfortunately, between these manual actions and scripts, they don't give you a series of correlated values over time. This is where automated remote troubleshooting comes in to its own, especially for teams that embrace remote work and Work From Anywhere (WFA).
