...
layout: research
ip_v4_address: "196.184.40.127"
date: 2023-10-29T15:13:19+00:00
draft: false
---

## Internet Addressing
On the Internet you might get a Public IPv4 address like ```196.184.40.127``` or an IPv6 address like ```2000:cc76:5e4a:334e:bf39:359:5412:6ca5```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```e9:92:19:6d:a4:b2```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://kertzmann-hane.net you initially access a DNS server to translate the host portion (kertzmann-hane) combined with the Top Level Domain (net) of the URL, to an IP address like ```13.146.209.97```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT x.y; Win64; x64; rv:10.0) Gecko/20100101 Firefox/10.0```
...
<pre>
default   fe80:12c2:6a8:87a4:dfa0%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {27.27.228.4, 112.66.110.55}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr e9:92:19:6d:a4:b2
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 0b:77:15:9d:3f:10
}</pre>
