...
layout: research
ip_v4_address: "248.255.141.230"
date: 2023-10-06T17:10:43+01:00
draft: false
---

## Internet Addressing
On the Internet you might have a Public IPv4 address like ```248.255.141.230``` or an IPv6 address like ```2000:b749:c6e2:6071:3c8a:a509:616b:25fc```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```ca:3d:af:b5:19:c6```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://wisozk-adams.org you initially access a DNS server to translate the host portion (wisozk-adams) combined with the Top Level Domain (org) of the URL, to an IP address like ```188.43.46.173```. Your computer and browser actually sends its type with all web requests e.g. <br>```Opera/9.80 (X11; Linux i686; Ubuntu/14.10) Presto/2.12.388 Version/12.16```
...
<pre>
default   fe80:aad6:53b0:f8a8:202c%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {110.92.57.102, 218.45.75.255}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr ca:3d:af:b5:19:c6
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr ff:93:99:97:a7:91
}</pre>
