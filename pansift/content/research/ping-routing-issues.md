...
layout: research
ip_v4_address: "250.45.240.106"
date: 2022-06-04T14:38:42+01:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like ```250.45.240.106``` or an IPv6 address like ```2000:3256:c38a:25f2:c963:f01:40da:452a```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```81:3c:e9:da:c8:68```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://gutmann.biz you initially access a DNS server to translate the host portion (gutmann) combined with the Top Level Domain (biz) of the URL, to an IP address like ```250.23.158.24```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1; WOW64; Trident/7.0; AS; rv:11.0) like Gecko```
...
<pre>
default   fe80:90cc:62e6:c988:4e4c%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {153.70.166.113, 203.165.150.115}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 81:3c:e9:da:c8:68
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 2b:c0:53:b4:43:a5
}</pre>
...
## Apple macOS / OSX
No matter what version of OSX/macOS you are on, ```10.15.9```, ```11.5.7```, or ```12.3.4```, there are a range of tools for troubleshooting. Unfortunately, between these manual actions and scripts, they don't give you a series of correlated values over time. This is where automated remote troubleshooting comes in to its own, especially for teams that embrace remote work and Work From Anywhere (WFA).
