...
layout: research
ip_v4_address: "94.183.201.140"
date: 2022-04-24T19:00:25+01:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like <code>94.183.201.140</code> or an IPv6 address like <code>2000:d28b:c412:91bb:b2b4:9caa:10f:5951</code>. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>9a:93:8a:dd:e9:6e</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://johns-casper.com you initially access a DNS server to translate the host portion (johns-casper) combined with the Top Level Domain (com) of the URL, to an IP address like <code>209.64.178.173</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (compatible; MSIE 9.0; AOL 9.7; AOLBuild 4343.19; Windows NT 6.1; WOW64; Trident/5.0; FunWebProducts)</code>
...
<pre><code>
default   fe80:c8ca:855b:ecc:d70b%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {169.255.229.118, 29.197.194.246}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 9a:93:8a:dd:e9:6e
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 58:4e:a6:26:7a:49
}</code></pre>
