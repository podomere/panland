...
layout: research
ip_v4_address: "227.224.207.182"
date: 2022-12-15T13:50:04+00:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like ```227.224.207.182``` or an IPv6 address like ```2000:30a7:6511:fae6:42ce:ea45:2048:242b```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```4a:00:db:ed:ec:43```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://romaguera-reilly.info you initially access a DNS server to translate the host portion (romaguera-reilly) combined with the Top Level Domain (info) of the URL, to an IP address like ```142.165.26.96```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT x.y; Win64; x64; rv:10.0) Gecko/20100101 Firefox/10.0```
...
<pre>
default   fe80:d1b7:b8d:47be:b447%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {202.189.101.112, 216.199.134.243}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 4a:00:db:ed:ec:43
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr e2:e8:d9:6b:bf:94
}</pre>
