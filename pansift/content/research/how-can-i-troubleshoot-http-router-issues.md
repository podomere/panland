...
layout: research
ip_v4_address: "70.187.5.66"
date: 2022-04-24T19:00:04+01:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like <code>70.187.5.66</code> or an IPv6 address like <code>2000:cfc8:89ce:2b58:e9f0:4822:bc17:daa9</code>. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>d5:c5:e6:5c:19:ae</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://okon-feest.io you initially access a DNS server to translate the host portion (okon-feest) combined with the Top Level Domain (io) of the URL, to an IP address like <code>237.172.141.194</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (Windows NT x.y; Win64; x64; rv:10.0) Gecko/20100101 Firefox/10.0</code>

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like <code>10.95.109.182</code> (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For <code>IPv6</code> we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  10.95.109.182    UGScg  en0
...
<pre><code>
default   fe80:c544:dc9c:ee37:8e50%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {224.22.218.70, 100.169.122.166}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr d5:c5:e6:5c:19:ae
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 19:69:2b:80:2a:76
}</code></pre>
