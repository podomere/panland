...
layout: research
ip_v4_address: "239.26.253.157"
date: 2023-10-29T15:13:25+00:00
draft: false
---

## Internet Addressing
On the Internet you might have a Public IPv4 address like ```239.26.253.157``` or an IPv6 address like ```2000:b3f2:e95b:5f93:c4d7:ad65:b542:adf0```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```99:3b:bb:9b:05:8e```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://bauch-schinner.net you initially access a DNS server to translate the host portion (bauch-schinner) combined with the Top Level Domain (net) of the URL, to an IP address like ```86.38.83.156```. Your computer and browser actually sends its type with all web requests e.g. <br>```Opera/9.80 (X11; Linux i686; Ubuntu/14.10) Presto/2.12.388 Version/12.16```
...
<pre>
default   fe80:edd1:cf52:7f1b:a361%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {148.233.12.192, 254.124.103.149}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 99:3b:bb:9b:05:8e
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 9e:c5:75:06:37:71
}</pre>
