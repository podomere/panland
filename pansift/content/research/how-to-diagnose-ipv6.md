...
layout: research
ip_v4_address: "0.147.143.180"
date: 2023-10-06T17:11:03+01:00
draft: false
---

## Internet Addressing
On the Internet you may get a Public IPv4 address like ```0.147.143.180``` or an IPv6 address like ```2000:441a:c943:57e3:a59a:782c:e1a:8910```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```fc:c9:ab:01:83:d3```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://stokes-simonis.io you initially access a DNS server to translate the host portion (stokes-simonis) combined with the Top Level Domain (io) of the URL, to an IP address like ```51.183.49.73```. Your computer and browser actually sends its type with all web requests e.g. <br>```Opera/9.80 (X11; Linux i686; Ubuntu/14.10) Presto/2.12.388 Version/12.16```
...
<pre>
default   fe80:43d2:48cf:79a9:ea42%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {136.67.235.55, 74.196.150.193}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr fc:c9:ab:01:83:d3
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 4e:21:3b:ee:71:e7
}</pre>
