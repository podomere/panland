...
layout: research
ip_v4_address: "184.114.167.66"
date: 2022-11-02T11:33:10+00:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like ```184.114.167.66``` or an IPv6 address like ```2000:c719:1b4a:690a:ba54:44c2:5107:9d53```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```4d:16:e7:24:82:92```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://satterfield-glover.biz you initially access a DNS server to translate the host portion (satterfield-glover) combined with the Top Level Domain (biz) of the URL, to an IP address like ```163.73.83.179```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_3) AppleWebKit/537.75.14 (KHTML, like Gecko) Version/7.0.3 Safari/7046A194A```
...
<pre>
default   fe80:ac23:ef47:abc0:d06e%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {144.81.108.244, 99.74.160.157}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 4d:16:e7:24:82:92
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 1c:ac:6f:f6:d1:87
}</pre>
