...
layout: research
ip_v4_address: "127.204.64.214"
date: 2022-05-05T14:29:23+01:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like ```127.204.64.214``` or an IPv6 address like ```2000:3884:9949:ea3:259f:3df0:7e07:498```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```d7:e7:89:ff:e1:15```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://buckridge-smith.org you initially access a DNS server to translate the host portion (buckridge-smith) combined with the Top Level Domain (org) of the URL, to an IP address like ```31.221.40.21```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows; U; Win 9x 4.90; SG; rv:1.9.2.4) Gecko/20101104 Netscape/9.1.0285```
...
<pre>
default   fe80:5d9f:aaa4:e84:d9ab%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {143.7.228.168, 195.192.16.226}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr d7:e7:89:ff:e1:15
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 43:ae:02:42:84:77
}</pre>
