...
layout: research
ip_v4_address: "119.61.83.138"
date: 2022-12-15T13:50:19+00:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like ```119.61.83.138``` or an IPv6 address like ```2000:669e:5a9d:97b1:666:cf03:8096:6ba```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```71:69:eb:8b:73:d9```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://lang-altenwerth.biz you initially access a DNS server to translate the host portion (lang-altenwerth) combined with the Top Level Domain (biz) of the URL, to an IP address like ```104.198.109.26```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1; WOW64; Trident/7.0; AS; rv:11.0) like Gecko```
...
<pre>
default   fe80:13b1:27c8:81a8:cff%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {68.177.236.252, 120.232.245.193}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 71:69:eb:8b:73:d9
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr e2:98:90:80:3b:f9
}</pre>
