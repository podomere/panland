...
layout: research
ip_v4_address: "46.168.224.225"
date: 2023-02-04T17:07:49+00:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like ```46.168.224.225``` or an IPv6 address like ```2000:1c30:1a85:5f34:efa3:9416:d9d6:23f4```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```3d:d0:6d:f0:c9:b0```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://schneider-mckenzie.biz you initially access a DNS server to translate the host portion (schneider-mckenzie) combined with the Top Level Domain (biz) of the URL, to an IP address like ```102.45.78.123```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT x.y; Win64; x64; rv:10.0) Gecko/20100101 Firefox/10.0```
...
<pre>
default   fe80:9a20:f394:729f:a7%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {3.26.195.179, 36.60.224.169}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 3d:d0:6d:f0:c9:b0
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 53:c6:c6:40:ed:c7
}</pre>
