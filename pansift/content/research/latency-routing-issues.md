...
subtitle: "Impact Map?"
layout: research
ip_v4_address: "18.213.101.192"
date: 2022-04-24T18:59:57+01:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like <code>18.213.101.192</code> or an IPv6 address like <code>2000:dd1f:6a68:38e5:2f5d:c003:d08b:b0dc</code>. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>46:55:97:fb:01:a7</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://mueller-lockman.com you initially access a DNS server to translate the host portion (mueller-lockman) combined with the Top Level Domain (com) of the URL, to an IP address like <code>114.36.84.191</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Opera/9.80 (X11; Linux i686; Ubuntu/14.10) Presto/2.12.388 Version/12.16</code>
...
<pre><code>
default   fe80:d87b:c9ba:91ed:ba0a%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {11.248.162.120, 204.101.30.26}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 46:55:97:fb:01:a7
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 5d:56:a3:16:6e:5a
}</code></pre>
