...
layout: research
ip_v4_address: "172.155.97.155"
date: 2022-11-02T11:33:11+00:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like ```172.155.97.155``` or an IPv6 address like ```2000:dbf9:9fd0:c18b:f348:e826:e0de:85e4```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```9e:d8:23:ec:d5:a9```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://beer-smith.net you initially access a DNS server to translate the host portion (beer-smith) combined with the Top Level Domain (net) of the URL, to an IP address like ```151.194.16.46```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (compatible; MSIE 9.0; AOL 9.7; AOLBuild 4343.19; Windows NT 6.1; WOW64; Trident/5.0; FunWebProducts)```
...
<pre>
default   fe80:636a:344a:195b:a7cf%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {250.239.248.16, 197.158.105.1}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 9e:d8:23:ec:d5:a9
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 8d:89:86:ad:bd:f3
}</pre>
