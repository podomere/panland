...
layout: research
ip_v4_address: "96.189.134.76"
date: 2022-11-02T11:32:55+00:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like ```96.189.134.76``` or an IPv6 address like ```2000:215d:5b92:481b:81d4:2da4:b7a3:1255```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```b7:ab:3d:f8:cb:35```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://schneider.com you initially access a DNS server to translate the host portion (schneider) combined with the Top Level Domain (com) of the URL, to an IP address like ```54.150.81.125```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows; U; Win 9x 4.90; SG; rv:1.9.2.4) Gecko/20101104 Netscape/9.1.0285```
...
<pre>
default   fe80:d0fc:dece:7a4d:66de%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {158.216.192.104, 181.186.100.131}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr b7:ab:3d:f8:cb:35
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr e2:10:48:6e:8a:58
}</pre>
...
## Apple macOS / OSX
No matter what version of OSX/macOS you are on, ```10.14.9```, ```11.1.8```, or ```12.0.6```, there are a range of tools for troubleshooting. Unfortunately, between these manual actions and scripts, they don't give you a series of correlated values over time. This is where automated remote troubleshooting comes in to its own, especially for teams that embrace remote work and Work From Anywhere (WFA).
