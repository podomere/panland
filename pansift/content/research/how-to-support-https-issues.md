...
layout: research
ip_v4_address: "47.110.171.147"
date: 2022-11-19T19:13:29+00:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like ```47.110.171.147``` or an IPv6 address like ```2000:df7:e538:dae7:8b77:7c53:6b94:1493```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```a3:6d:b6:1d:85:7a```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://goyette.name you initially access a DNS server to translate the host portion (goyette) combined with the Top Level Domain (name) of the URL, to an IP address like ```182.155.253.153```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1; WOW64; Trident/7.0; AS; rv:11.0) like Gecko```
...
<pre>
default   fe80:6117:df71:aeff:da1d%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {133.186.83.166, 147.150.2.107}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr a3:6d:b6:1d:85:7a
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 01:46:51:74:c2:81
}</pre>
...
## Apple macOS / OSX
No matter what version of OSX/macOS you are on, ```10.11.2```, ```11.2.1```, or ```12.1.4```, there are a range of tools for troubleshooting. Unfortunately, between these manual actions and scripts, they don't give you a series of correlated values over time. This is where automated remote troubleshooting comes in to its own, especially for teams that embrace remote work and Work From Anywhere (WFA).
