...
layout: research
ip_v4_address: "252.49.1.176"
date: 2022-04-24T19:00:03+01:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like <code>252.49.1.176</code> or an IPv6 address like <code>2000:11:b588:cfab:fdd3:e529:6bff:86a5</code>. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>46:6d:13:e6:08:01</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://mills-bailey.org you initially access a DNS server to translate the host portion (mills-bailey) combined with the Top Level Domain (org) of the URL, to an IP address like <code>130.64.102.53</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (compatible; MSIE 9.0; AOL 9.7; AOLBuild 4343.19; Windows NT 6.1; WOW64; Trident/5.0; FunWebProducts)</code>
...
<pre><code>
default   fe80:3a4e:46f6:4a8d:e265%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {196.69.132.80, 175.9.11.65}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 46:6d:13:e6:08:01
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 78:8e:29:4f:94:dc
}</code></pre>
