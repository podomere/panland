...
subtitle: "Deep Dive?"
layout: research
ip_v4_address: "104.176.168.210"
date: 2022-06-12T14:09:15+01:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like ```104.176.168.210``` or an IPv6 address like ```2000:49e5:6d0e:59:d871:d1de:5f01:456```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```37:9f:07:2c:43:5b```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://rosenbaum-oberbrunner.name you initially access a DNS server to translate the host portion (rosenbaum-oberbrunner) combined with the Top Level Domain (name) of the URL, to an IP address like ```79.83.196.85```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (compatible; MSIE 9.0; AOL 9.7; AOLBuild 4343.19; Windows NT 6.1; WOW64; Trident/5.0; FunWebProducts)```

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```172.26.8.132``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  172.26.8.132    UGScg  en0
...
<pre>
default   fe80:8721:2048:f885:bddb%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {30.146.37.15, 105.135.196.199}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 37:9f:07:2c:43:5b
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr fd:67:4a:06:12:6b
}</pre>
