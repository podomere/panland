...
layout: research
ip_v4_address: "88.40.77.145"
date: 2022-11-02T11:32:56+00:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like ```88.40.77.145``` or an IPv6 address like ```2000:1b0a:28e9:6192:be06:a09e:7e37:3daf```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```c7:20:2a:21:c3:23```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://damore-rice.org you initially access a DNS server to translate the host portion (damore-rice) combined with the Top Level Domain (org) of the URL, to an IP address like ```227.241.123.32```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (compatible; MSIE 9.0; AOL 9.7; AOLBuild 4343.19; Windows NT 6.1; WOW64; Trident/5.0; FunWebProducts)```
...
<pre>
default   fe80:cd83:1a0f:e0cb:406f%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {109.183.185.166, 52.53.204.206}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr c7:20:2a:21:c3:23
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr e4:d2:62:19:a0:9d
}</pre>
