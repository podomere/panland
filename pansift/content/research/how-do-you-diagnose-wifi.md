...
layout: research
ip_v4_address: "195.101.45.98"
date: 2022-04-24T18:32:41+01:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like <code>195.101.45.98</code> or an IPv6 address like <code>2000:675:4261:7256:653a:6f52:d3a:9e2f</code>. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>fb:b7:29:5e:11:69</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://schuppe-klein.co you initially access a DNS server to translate the host portion (schuppe-klein) combined with the Top Level Domain (co) of the URL, to an IP address like <code>112.189.1.24</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_3) AppleWebKit/537.75.14 (KHTML, like Gecko) Version/7.0.3 Safari/7046A194A</code>
...
<pre><code>
default   fe80:c1e3:aa64:7875:4632%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {121.131.251.195, 116.98.233.170}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr fb:b7:29:5e:11:69
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 51:90:9b:ee:c9:0f
}</code></pre>
