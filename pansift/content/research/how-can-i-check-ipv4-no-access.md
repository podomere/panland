...
subtitle: "Ideate?"
layout: research
ip_v4_address: "169.198.160.164"
date: 2023-10-29T15:13:25+00:00
draft: false
---

## Internet Addressing
On the Internet you may have a Public IPv4 address like ```169.198.160.164``` or an IPv6 address like ```2000:1d28:9f9a:c65d:573a:b9b1:c887:572f```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```1c:5c:09:66:b8:af```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://streich-marquardt.name you initially access a DNS server to translate the host portion (streich-marquardt) combined with the Top Level Domain (name) of the URL, to an IP address like ```22.233.31.82```. Your computer and browser actually sends its type with all web requests e.g. <br>```Opera/9.80 (X11; Linux i686; Ubuntu/14.10) Presto/2.12.388 Version/12.16```
...
<pre>
default   fe80:851e:f131:5a6f:cde3%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {32.54.88.147, 220.208.237.83}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 1c:5c:09:66:b8:af
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 25:53:4c:73:1b:b9
}</pre>
