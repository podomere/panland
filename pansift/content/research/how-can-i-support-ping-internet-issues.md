...
subtitle: "Learnings?"
layout: research
ip_v4_address: "154.214.130.171"
date: 2023-10-06T17:11:07+01:00
draft: false
---

## Internet Addressing
On the Internet you may get a Public IPv4 address like ```154.214.130.171``` or an IPv6 address like ```2000:54f2:b94:780b:7655:9413:b374:e3fa```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```6c:25:14:33:2d:28```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://heathcote.name you initially access a DNS server to translate the host portion (heathcote) combined with the Top Level Domain (name) of the URL, to an IP address like ```215.197.35.49```. Your computer and browser actually sends its type with all web requests e.g. <br>```Opera/9.80 (X11; Linux i686; Ubuntu/14.10) Presto/2.12.388 Version/12.16```

## Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```10.123.168.238``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  10.123.168.238    UGScg  en0
...
<pre>
default   fe80:c528:8e31:2b0e:b3a7%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {177.193.56.202, 220.222.220.67}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 6c:25:14:33:2d:28
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr b3:62:0b:ec:0c:59
}</pre>
