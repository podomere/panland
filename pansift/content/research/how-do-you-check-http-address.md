...
subtitle: "Granular?"
layout: research
ip_v4_address: "207.170.90.158"
date: 2022-11-19T19:13:28+00:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like ```207.170.90.158``` or an IPv6 address like ```2000:bc9c:6bb6:a84d:d7c4:e9d5:2723:5046```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```2c:15:9d:05:81:f2```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://oreilly-rodriguez.io you initially access a DNS server to translate the host portion (oreilly-rodriguez) combined with the Top Level Domain (io) of the URL, to an IP address like ```147.125.118.15```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows; U; Win 9x 4.90; SG; rv:1.9.2.4) Gecko/20101104 Netscape/9.1.0285```
...
default  172.22.69.255    UGScg  en0
...
<pre>
default   fe80:7c1a:5ec2:1760:7d25%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {254.68.159.64, 121.198.81.16}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 2c:15:9d:05:81:f2
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 9f:18:f7:8d:2e:7a
}</pre>
