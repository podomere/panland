...
layout: research
ip_v4_address: "72.122.175.141"
date: 2022-06-12T14:09:15+01:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like ```72.122.175.141``` or an IPv6 address like ```2000:d968:d555:e007:c490:5670:c880:65e1```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```5a:67:a9:7e:70:92```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://schamberger.com you initially access a DNS server to translate the host portion (schamberger) combined with the Top Level Domain (com) of the URL, to an IP address like ```233.166.135.119```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/41.0.2228.0 Safari/537.36```

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```172.31.57.222``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  172.31.57.222    UGScg  en0
...
<pre>
default   652f:9bb9:44:f2f2:3036:d65a:1a8e:c13a%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {59.237.197.78, 190.210.233.68}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 5a:67:a9:7e:70:92
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 0d:79:e8:57:b3:ca
}</pre>
