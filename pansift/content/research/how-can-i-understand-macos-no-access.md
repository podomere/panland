...
layout: research
ip_v4_address: "131.105.238.31"
date: 2022-06-04T14:38:28+01:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like ```131.105.238.31``` or an IPv6 address like ```2000:c34c:6239:e634:fd01:ee55:e678:fa31```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```78:7d:97:9c:26:1f```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://watsica-kunze.name you initially access a DNS server to translate the host portion (watsica-kunze) combined with the Top Level Domain (name) of the URL, to an IP address like ```24.74.29.90```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT x.y; Win64; x64; rv:10.0) Gecko/20100101 Firefox/10.0```
...
<pre>
default   fe80:6479:27a4:3d2f:b31f%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {76.250.57.74, 156.35.64.93}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 78:7d:97:9c:26:1f
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 7d:2c:dc:68:d2:8d
}</pre>
