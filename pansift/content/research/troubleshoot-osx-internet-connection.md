...
layout: research
ip_v4_address: "78.193.163.11"
date: 2022-12-15T13:50:10+00:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like ```78.193.163.11``` or an IPv6 address like ```2000:70f3:7099:8dc3:6ee7:eed9:e34b:6899```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```9a:4c:98:50:37:11```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://stiedemann-smitham.io you initially access a DNS server to translate the host portion (stiedemann-smitham) combined with the Top Level Domain (io) of the URL, to an IP address like ```30.53.240.155```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows; U; Win 9x 4.90; SG; rv:1.9.2.4) Gecko/20101104 Netscape/9.1.0285```
...
<pre>
default   fe80:156f:a640:ca39:3419%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {158.172.78.166, 25.15.66.6}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 9a:4c:98:50:37:11
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 59:4c:85:dd:1b:59
}</pre>
