...
subtitle: "Impact Map?"
layout: research
ip_v4_address: "173.223.120.106"
date: 2022-11-19T19:13:27+00:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like ```173.223.120.106``` or an IPv6 address like ```2000:8811:3270:9bc9:48fc:fcda:ced3:86a0```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```50:fc:7d:1e:a2:af```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://cassin-hoppe.org you initially access a DNS server to translate the host portion (cassin-hoppe) combined with the Top Level Domain (org) of the URL, to an IP address like ```179.231.11.145```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT x.y; Win64; x64; rv:10.0) Gecko/20100101 Firefox/10.0```
...
<pre>
default   fe80:b7d8:b67f:e76:cb84%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {159.181.94.160, 216.40.17.226}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 50:fc:7d:1e:a2:af
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 50:04:91:00:71:82
}</pre>
...
## Apple macOS / OSX
No matter what version of OSX/macOS you are on, ```10.14.9```, ```11.5.1```, or ```12.3.6```, there are a range of tools for troubleshooting. Unfortunately, between these manual actions and scripts, they don't give you a series of correlated values over time. This is where automated remote troubleshooting comes in to its own, especially for teams that embrace remote work and Work From Anywhere (WFA).
