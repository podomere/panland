...
layout: research
ip_v4_address: "104.194.16.148"
date: 2022-06-12T14:09:05+01:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like ```104.194.16.148``` or an IPv6 address like ```2000:7dd5:bafe:65b:ca50:14ef:ce28:eff2```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```f8:1b:95:be:57:54```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://satterfield.name you initially access a DNS server to translate the host portion (satterfield) combined with the Top Level Domain (name) of the URL, to an IP address like ```176.87.187.100```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/41.0.2228.0 Safari/537.36```
...
<pre>
default   fe80:cac6:e891:2af7:2eb2%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {112.225.97.50, 150.23.23.188}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr f8:1b:95:be:57:54
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr b6:d1:f2:24:eb:5e
}</pre>
...
## Apple macOS / OSX
No matter what version of OSX/macOS you are on, ```10.13.5```, ```11.1.4```, or ```12.0.5```, there are a range of tools for troubleshooting. Unfortunately, between these manual actions and scripts, they don't give you a series of correlated values over time. This is where automated remote troubleshooting comes in to its own, especially for teams that embrace remote work and Work From Anywhere (WFA).
