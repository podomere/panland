...
subtitle: "Synergy?"
layout: research
ip_v4_address: "66.158.96.84"
date: 2022-04-24T18:59:55+01:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like <code>66.158.96.84</code> or an IPv6 address like <code>2000:68d3:d998:94bd:6c54:7dd:a38c:cbca</code>. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>2e:25:10:89:64:22</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://runolfsson-stamm.org you initially access a DNS server to translate the host portion (runolfsson-stamm) combined with the Top Level Domain (org) of the URL, to an IP address like <code>149.208.115.22</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Opera/9.80 (X11; Linux i686; Ubuntu/14.10) Presto/2.12.388 Version/12.16</code>
...
<pre><code>
default   fe80:b527:6350:5729:22dc%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {21.34.67.216, 196.242.212.189}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 2e:25:10:89:64:22
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr ec:f9:cb:c4:dc:6b
}</code></pre>
