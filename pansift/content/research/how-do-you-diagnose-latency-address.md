...
layout: research
ip_v4_address: "208.190.114.14"
date: 2022-11-02T11:32:56+00:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like ```208.190.114.14``` or an IPv6 address like ```2000:9a34:ed61:8ea9:2e6b:651b:d418:dc19```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```93:03:5a:38:9c:d8```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://williamson-gottlieb.com you initially access a DNS server to translate the host portion (williamson-gottlieb) combined with the Top Level Domain (com) of the URL, to an IP address like ```252.108.70.82```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/41.0.2228.0 Safari/537.36```
...
<pre>
default   fe80:e251:3ec1:c721:529%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {176.111.121.119, 27.161.27.255}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 93:03:5a:38:9c:d8
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 17:a3:fc:92:67:96
}</pre>
