...
layout: research
ip_v4_address: "212.226.11.208"
date: 2022-11-19T19:13:24+00:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like ```212.226.11.208``` or an IPv6 address like ```2000:8775:2f04:7ff4:fc3f:6363:1b30:6170```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```ee:24:56:01:5b:27```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://haley-boehm.name you initially access a DNS server to translate the host portion (haley-boehm) combined with the Top Level Domain (name) of the URL, to an IP address like ```133.83.161.187```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1; WOW64; Trident/7.0; AS; rv:11.0) like Gecko```
...
default  172.26.238.176    UGScg  en0
...
<pre>
default   fe80:950a:7998:1ea6:1d22%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {88.248.42.40, 237.56.204.178}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr ee:24:56:01:5b:27
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr ea:af:90:51:4c:7d
}</pre>
