...
layout: research
ip_v4_address: "229.80.181.112"
date: 2022-11-02T11:33:12+00:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like ```229.80.181.112``` or an IPv6 address like ```2000:3050:77b6:6391:ed0d:a148:bd08:b17e```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```b3:e1:50:72:6e:76```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://konopelski-hansen.net you initially access a DNS server to translate the host portion (konopelski-hansen) combined with the Top Level Domain (net) of the URL, to an IP address like ```73.124.102.52```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT x.y; Win64; x64; rv:10.0) Gecko/20100101 Firefox/10.0```
...
<pre>
default   fe80:909f:4c71:2e1f:d2e6%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {58.184.120.185, 130.188.44.20}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr b3:e1:50:72:6e:76
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr c0:45:d0:ce:84:91
}</pre>
