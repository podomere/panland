...
subtitle: "Impact Map?"
layout: research
ip_v4_address: "114.135.53.95"
date: 2022-11-19T16:17:19+00:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like ```114.135.53.95``` or an IPv6 address like ```2000:e5ff:2bae:3990:56d:6f20:5700:58a3```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```a4:43:b3:f7:f1:db```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://russel-glover.net you initially access a DNS server to translate the host portion (russel-glover) combined with the Top Level Domain (net) of the URL, to an IP address like ```246.124.109.175```. Your computer and browser actually sends its type with all web requests e.g. <br>```Opera/9.80 (X11; Linux i686; Ubuntu/14.10) Presto/2.12.388 Version/12.16```
...
<pre>
default   fe80:8069:cde0:1745:bb18%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {1.115.105.215, 85.209.194.222}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr a4:43:b3:f7:f1:db
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 69:d0:9c:d0:d1:ef
}</pre>
...
## Apple macOS / OSX
No matter what version of OSX/macOS you are on, ```10.12.8```, ```11.1.3```, or ```12.1.5```, there are a range of tools for troubleshooting. Unfortunately, between these manual actions and scripts, they don't give you a series of correlated values over time. This is where automated remote troubleshooting comes in to its own, especially for teams that embrace remote work and Work From Anywhere (WFA).
