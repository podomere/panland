...
layout: research
ip_v4_address: "148.19.209.194"
date: 2022-04-24T19:00:23+01:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like <code>148.19.209.194</code> or an IPv6 address like <code>2000:aeaf:1437:57c6:4d04:a176:5ecf:5df1</code>. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>9e:c1:cf:9f:7b:8c</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://homenick.org you initially access a DNS server to translate the host portion (homenick) combined with the Top Level Domain (org) of the URL, to an IP address like <code>149.194.128.207</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (Windows NT 6.1; WOW64; Trident/7.0; AS; rv:11.0) like Gecko</code>
...
<pre><code>
default   fe80:c3a2:786d:e8c6:c295%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {99.175.229.182, 225.78.173.155}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 9e:c1:cf:9f:7b:8c
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr b0:a5:10:59:bd:0d
}</code></pre>
