(function ($) { 
  ...
  if(document.getElementsByClassName("video-js") !== null && $('.video-js')[0] !== undefined ){
    ...
    setTimeout(function(){
      ...
      var overlay_content = '<div class="col-12 justify-content-center align-items-center"><a href="/why"><div style="font-weight: bold; color: white !important;" class="btn btn-success mb-1 ml-1">Manager</div></a><a href="/pricing"><div style="font-weight: bold; color: white !important;" class="btn btn-primary ml-1 mb-1">Recruiter</div></a><a href="#pracsims"><div style="font-weight: bold; color: white !important;" class="btn btn-info ml-1 mb-1">Engineer</div></a></div>';
  ...
  if(document.getElementById("mapid") !== null){
    ...
    function new_champion(lat,lng) {
      var popup = L.popup({closeButton:false})
        .setLatLng([lat, lng])
        .setContent("<center><b>Champion Identified</b></center>")
        .openOn(mymap);
