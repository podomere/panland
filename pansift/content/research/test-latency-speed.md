...
layout: research
ip_v4_address: "189.19.62.197"
date: 2022-11-19T16:17:21+00:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like ```189.19.62.197``` or an IPv6 address like ```2000:93bb:8a73:8bde:9964:b4d0:298c:7653```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```81:87:ac:17:2b:d0```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://lesch-fadel.org you initially access a DNS server to translate the host portion (lesch-fadel) combined with the Top Level Domain (org) of the URL, to an IP address like ```228.248.144.240```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_3) AppleWebKit/537.75.14 (KHTML, like Gecko) Version/7.0.3 Safari/7046A194A```
...
<pre>
default   fe80:abd8:6f40:2caa:d9d9%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {185.45.192.108, 111.211.230.138}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 81:87:ac:17:2b:d0
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 77:b4:c2:b9:5d:40
}</pre>
