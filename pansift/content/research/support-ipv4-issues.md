...
layout: research
ip_v4_address: "248.92.218.214"
date: 2022-04-24T18:59:56+01:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like <code>248.92.218.214</code> or an IPv6 address like <code>2000:ca33:7c0a:80bb:4fce:c815:3ed8:672</code>. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>75:5d:3e:af:99:1f</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://labadie-buckridge.co you initially access a DNS server to translate the host portion (labadie-buckridge) combined with the Top Level Domain (co) of the URL, to an IP address like <code>114.146.129.230</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (Windows NT 6.1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/41.0.2228.0 Safari/537.36</code>
...
default  192.168.12.212    UGScg  en0
...
<pre><code>
default   fe80:bef5:931f:d853:93d4%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {218.87.86.181, 66.157.240.47}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 75:5d:3e:af:99:1f
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 94:48:2d:09:4a:c9
}</code></pre>
