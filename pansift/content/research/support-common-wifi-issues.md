...
layout: research
ip_v4_address: "76.227.7.133"
date: 2022-11-19T16:17:05+00:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like ```76.227.7.133``` or an IPv6 address like ```2000:8495:80d9:f64f:8216:fdaa:7ebb:ae4b```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```98:72:38:5c:3d:4a```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://macejkovic-beer.org you initially access a DNS server to translate the host portion (macejkovic-beer) combined with the Top Level Domain (org) of the URL, to an IP address like ```47.151.214.220```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1; WOW64; Trident/7.0; AS; rv:11.0) like Gecko```
...
<pre>
default   fe80:39b9:e610:d727:2de0%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {159.185.231.122, 18.8.45.59}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 98:72:38:5c:3d:4a
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 4a:08:2e:17:49:e9
}</pre>
...
## Apple macOS / OSX
No matter what version of OSX/macOS you are on, ```10.11.9```, ```11.1.8```, or ```12.3.8```, there are a range of tools for troubleshooting. Unfortunately, between these manual actions and scripts, they don't give you a series of correlated values over time. This is where automated remote troubleshooting comes in to its own, especially for teams that embrace remote work and Work From Anywhere (WFA).
