...
layout: research
ip_v4_address: "34.49.17.189"
date: 2023-10-29T15:13:30+00:00
draft: false
---

## Internet Addressing
On the Internet you may get a Public IPv4 address like ```34.49.17.189``` or an IPv6 address like ```2000:86a3:637c:6e27:9c2c:6720:dcb7:88ec```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```22:dc:fa:61:3a:1b```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://aufderhar.name you initially access a DNS server to translate the host portion (aufderhar) combined with the Top Level Domain (name) of the URL, to an IP address like ```46.68.123.244```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (compatible; MSIE 9.0; AOL 9.7; AOLBuild 4343.19; Windows NT 6.1; WOW64; Trident/5.0; FunWebProducts)```
...
<pre>
default   fe80:905:fc20:6e8e:b0c7%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {126.64.2.118, 51.164.136.102}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 22:dc:fa:61:3a:1b
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 68:3d:93:88:24:c6
}</pre>
...
### Apple macOS / OSX
No matter what version of OSX/macOS you are on, ```10.15.8```, ```11.2.4```, or ```12.3.6```, there are a range of tools for troubleshooting. Unfortunately, between these manual actions and scripts, they don't give you a series of correlated values over time. This is where automated remote troubleshooting comes in to its own, especially for teams that embrace remote work and Work From Anywhere (WFA).
