...
layout: research
ip_v4_address: "139.162.83.61"
date: 2022-11-19T19:13:16+00:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like ```139.162.83.61``` or an IPv6 address like ```2000:eb91:e8f8:144b:af50:84c1:2f2d:6b57```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```18:7e:a7:52:1c:f1```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://murazik-rowe.info you initially access a DNS server to translate the host portion (murazik-rowe) combined with the Top Level Domain (info) of the URL, to an IP address like ```87.251.61.103```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows; U; Win 9x 4.90; SG; rv:1.9.2.4) Gecko/20101104 Netscape/9.1.0285```
...
<pre>
default   fe80:b0fa:a386:fc74:2d6f%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {35.55.124.17, 65.104.172.3}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 18:7e:a7:52:1c:f1
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 26:69:28:bf:30:36
}</pre>
