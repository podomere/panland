...
subtitle: "Tee It Up?"
layout: research
ip_v4_address: "150.30.65.55"
date: 2023-10-29T15:13:27+00:00
draft: false
---

## Internet Addressing
On the Internet you might have a Public IPv4 address like ```150.30.65.55``` or an IPv6 address like ```2000:d592:7e09:d977:10ac:1fb7:bc56:12d5```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```bc:e9:e7:aa:9a:b8```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://christiansen.info you initially access a DNS server to translate the host portion (christiansen) combined with the Top Level Domain (info) of the URL, to an IP address like ```243.8.231.255```. Your computer and browser actually sends its type with all web requests e.g. <br>```Opera/9.80 (X11; Linux i686; Ubuntu/14.10) Presto/2.12.388 Version/12.16```

## Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```172.23.105.60``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  172.23.105.60    UGScg  en0
...
<pre>
default   fe80:869c:33e5:4b1:9bc1%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {64.224.196.93, 190.51.39.75}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr bc:e9:e7:aa:9a:b8
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 52:fd:f9:e6:dc:3e
}</pre>
