...
layout: research
ip_v4_address: "253.113.119.128"
date: 2022-11-19T19:13:24+00:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like ```253.113.119.128``` or an IPv6 address like ```2000:ebef:fed0:84e8:ac5f:183d:28a2:1cea```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```11:34:fd:2b:01:95```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://auer-skiles.name you initially access a DNS server to translate the host portion (auer-skiles) combined with the Top Level Domain (name) of the URL, to an IP address like ```59.59.221.56```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1; WOW64; Trident/7.0; AS; rv:11.0) like Gecko```
...
<pre>
default   fe80:44a:4f90:1633:53ba%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {92.133.210.67, 71.186.207.114}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 11:34:fd:2b:01:95
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 18:e2:44:f3:93:6c
}</pre>
