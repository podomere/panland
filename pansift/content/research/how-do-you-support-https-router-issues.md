...
subtitle: "Streamline?"
layout: research
ip_v4_address: "253.10.185.88"
date: 2022-05-05T14:30:16+01:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like ```253.10.185.88``` or an IPv6 address like ```2000:2265:6f43:b4fd:1673:49d8:a6cd:f290```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```1c:ac:15:82:b3:11```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://schaefer-nicolas.biz you initially access a DNS server to translate the host portion (schaefer-nicolas) combined with the Top Level Domain (biz) of the URL, to an IP address like ```205.240.86.50```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_3) AppleWebKit/537.75.14 (KHTML, like Gecko) Version/7.0.3 Safari/7046A194A```
...
<pre>
default   fe80:703d:a0a9:4d14:4c9c%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {168.255.213.166, 133.132.35.6}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 1c:ac:15:82:b3:11
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 13:17:8f:59:06:bd
}</pre>
