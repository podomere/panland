...
layout: research
ip_v4_address: "193.200.222.114"
date: 2022-06-04T14:38:30+01:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like ```193.200.222.114``` or an IPv6 address like ```2000:aedf:6841:c178:a27e:9292:9dac:543c```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```85:aa:4c:5d:d5:30```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://emmerich-buckridge.info you initially access a DNS server to translate the host portion (emmerich-buckridge) combined with the Top Level Domain (info) of the URL, to an IP address like ```62.143.75.98```. Your computer and browser actually sends its type with all web requests e.g. <br>```Opera/9.80 (X11; Linux i686; Ubuntu/14.10) Presto/2.12.388 Version/12.16```
...
<pre>
default   fe80:9338:cc5d:7f6d:e7c6%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {172.97.167.230, 174.249.99.62}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 85:aa:4c:5d:d5:30
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 07:72:ed:6d:ba:26
}</pre>
