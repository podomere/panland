...
subtitle: "Granular?"
layout: research
ip_v4_address: "239.249.171.190"
date: 2022-05-05T14:28:57+01:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like ```239.249.171.190``` or an IPv6 address like ```2000:9144:f59d:e7fc:71e9:a59f:4a40:9269```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```64:f7:bf:28:29:81```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://morar-ruecker.co you initially access a DNS server to translate the host portion (morar-ruecker) combined with the Top Level Domain (co) of the URL, to an IP address like ```188.125.112.89```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT x.y; Win64; x64; rv:10.0) Gecko/20100101 Firefox/10.0```
...
<pre>
default   fe80:a2d1:9585:4fa8:a303%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {146.92.226.195, 172.228.246.93}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 64:f7:bf:28:29:81
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 77:35:5b:03:61:16
}</pre>
...
## Apple macOS / OSX
No matter what version of OSX/macOS you are on, ```10.14.1```, ```11.2.5```, or ```12.3.6```, there are a range of tools for troubleshooting. Unfortunately, between these manual actions and scripts, they don't give you a series of correlated values over time. This is where automated remote troubleshooting comes in to its own, especially for teams that embrace remote work and Work From Anywhere (WFA).
