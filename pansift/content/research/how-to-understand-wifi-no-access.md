...
subtitle: "Swim Lane?"
layout: research
ip_v4_address: "166.3.230.225"
date: 2023-10-06T17:10:30+01:00
draft: false
---

## Internet Addressing
On the Internet you might get a Public IPv4 address like ```166.3.230.225``` or an IPv6 address like ```2000:98c5:dfcd:8436:6b36:9596:835:dd00```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```17:22:36:08:c2:96```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://turner.co you initially access a DNS server to translate the host portion (turner) combined with the Top Level Domain (co) of the URL, to an IP address like ```183.136.7.202```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1; WOW64; Trident/7.0; AS; rv:11.0) like Gecko```
...
<pre>
default   fe80:1fb9:cb94:12b3:8dc1%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {156.157.218.77, 234.84.66.47}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 17:22:36:08:c2:96
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr f3:48:83:a6:71:96
}</pre>
...
### Apple macOS / OSX
No matter what version of OSX/macOS you are on, ```10.15.1```, ```11.1.6```, or ```12.0.9```, there are a range of tools for troubleshooting. Unfortunately, between these manual actions and scripts, they don't give you a series of correlated values over time. This is where automated remote troubleshooting comes in to its own, especially for teams that embrace remote work and Work From Anywhere (WFA).
