...
layout: research
ip_v4_address: "80.32.103.63"
date: 2022-11-02T11:32:23+00:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like ```80.32.103.63``` or an IPv6 address like ```2000:8623:2390:c67e:d478:2cb7:f97f:5353```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```05:77:50:44:16:fa```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://yost-pollich.biz you initially access a DNS server to translate the host portion (yost-pollich) combined with the Top Level Domain (biz) of the URL, to an IP address like ```56.215.188.73```. Your computer and browser actually sends its type with all web requests e.g. <br>```Opera/9.80 (X11; Linux i686; Ubuntu/14.10) Presto/2.12.388 Version/12.16```
...
<pre>
default   fe80:567d:9baf:30ec:6a00%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {139.17.217.68, 209.186.48.111}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 05:77:50:44:16:fa
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 7c:76:66:5c:c0:78
}</pre>
