...
subtitle: "Deep Dive?"
layout: research
ip_v4_address: "142.251.241.2"
date: 2022-12-15T13:50:09+00:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like ```142.251.241.2``` or an IPv6 address like ```2000:ffc9:c0ab:7f74:4e75:1c4a:2e58:673d```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```05:7f:ea:b3:e9:08```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://beahan-fay.info you initially access a DNS server to translate the host portion (beahan-fay) combined with the Top Level Domain (info) of the URL, to an IP address like ```155.148.56.34```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1; WOW64; Trident/7.0; AS; rv:11.0) like Gecko```
...
<pre>
default   fe80:773d:dc5b:f4ba:72fc%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {57.85.35.97, 10.14.191.182}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 05:7f:ea:b3:e9:08
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 05:3c:2e:9e:1a:a2
}</pre>
