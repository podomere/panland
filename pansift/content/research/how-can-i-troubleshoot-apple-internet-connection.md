...
layout: research
ip_v4_address: "254.219.39.244"
date: 2022-04-24T19:00:25+01:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like <code>254.219.39.244</code> or an IPv6 address like <code>2000:4e32:5c99:9ceb:2082:477b:ca2c:d006</code>. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>b8:c5:1f:a9:fc:9d</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://sporer-carter.org you initially access a DNS server to translate the host portion (sporer-carter) combined with the Top Level Domain (org) of the URL, to an IP address like <code>41.63.191.77</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (Windows NT 6.1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/41.0.2228.0 Safari/537.36</code>
...
default  172.22.167.238    UGScg  en0
...
<pre><code>
default   fe80:1474:8a46:c91a:33cf%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {28.39.9.196, 22.95.108.139}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr b8:c5:1f:a9:fc:9d
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr d9:6f:5e:48:a6:82
}</code></pre>
