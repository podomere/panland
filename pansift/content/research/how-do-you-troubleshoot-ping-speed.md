...
layout: research
ip_v4_address: "229.79.114.221"
date: 2022-04-24T19:00:02+01:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like <code>229.79.114.221</code> or an IPv6 address like <code>2000:8a4a:8d06:b9cf:9dbd:5ce4:ab60:65a1</code>. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>e9:4f:b8:ad:7b:ab</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://powlowski-crist.net you initially access a DNS server to translate the host portion (powlowski-crist) combined with the Top Level Domain (net) of the URL, to an IP address like <code>48.196.174.80</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_3) AppleWebKit/537.75.14 (KHTML, like Gecko) Version/7.0.3 Safari/7046A194A</code>
...
<pre><code>
default   fe80:6da7:3ea8:be34:31a%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {254.4.45.96, 229.45.92.144}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr e9:4f:b8:ad:7b:ab
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 06:fa:24:09:53:ce
}</code></pre>
