...
layout: research
ip_v4_address: "207.98.94.72"
date: 2022-11-02T11:33:11+00:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like ```207.98.94.72``` or an IPv6 address like ```2000:a700:1ad:46d4:40d1:40b4:8cff:266b```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```50:0a:62:7c:84:83```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://okeefe-roob.info you initially access a DNS server to translate the host portion (okeefe-roob) combined with the Top Level Domain (info) of the URL, to an IP address like ```202.97.245.119```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/41.0.2228.0 Safari/537.36```
...
<pre>
default   fe80:53e6:25eb:1d82:f5f8%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {196.8.74.79, 194.87.179.230}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 50:0a:62:7c:84:83
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr a0:be:75:67:67:5a
}</pre>
