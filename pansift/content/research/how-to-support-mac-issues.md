...
layout: research
ip_v4_address: "214.133.170.47"
date: 2022-04-24T18:31:59+01:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like <code>214.133.170.47</code> or an IPv6 address like <code>2000:3497:3e42:d137:67c5:b6f1:3a5c:c24e</code>. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>e2:5f:43:93:13:d5</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://zieme-kuhlman.co you initially access a DNS server to translate the host portion (zieme-kuhlman) combined with the Top Level Domain (co) of the URL, to an IP address like <code>110.152.232.129</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (Windows; U; Win 9x 4.90; SG; rv:1.9.2.4) Gecko/20101104 Netscape/9.1.0285</code>
...
<pre><code>
default   fe80:c9b9:5e15:7baa:c8af%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {176.161.69.230, 20.59.52.210}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr e2:5f:43:93:13:d5
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 51:e4:33:0f:db:fe
}</code></pre>
