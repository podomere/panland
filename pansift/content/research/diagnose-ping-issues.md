...
layout: research
ip_v4_address: "3.236.98.246"
date: 2023-10-06T17:11:07+01:00
draft: false
---

## Internet Addressing
On the Internet you might get a Public IPv4 address like ```3.236.98.246``` or an IPv6 address like ```2000:b647:b75e:e16b:fb61:178e:ffef:3ae6```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```2e:43:e5:c1:a3:a8```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://collins-emard.net you initially access a DNS server to translate the host portion (collins-emard) combined with the Top Level Domain (net) of the URL, to an IP address like ```222.34.180.176```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows; U; Win 9x 4.90; SG; rv:1.9.2.4) Gecko/20101104 Netscape/9.1.0285```
...
<pre>
default   be31:5c36:a07e:1:c603:8c56:694e:ba9f%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {147.147.3.160, 16.217.165.70}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 2e:43:e5:c1:a3:a8
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 74:1b:ad:a9:70:31
}</pre>
