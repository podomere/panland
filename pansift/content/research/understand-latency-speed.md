...
subtitle: "Streamline?"
layout: research
ip_v4_address: "196.230.108.186"
date: 2022-11-19T19:13:24+00:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like ```196.230.108.186``` or an IPv6 address like ```2000:fbde:f694:3810:5671:c236:8cd9:7db3```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```95:6e:f3:4b:a9:2e```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://gutkowski.name you initially access a DNS server to translate the host portion (gutkowski) combined with the Top Level Domain (name) of the URL, to an IP address like ```156.255.150.200```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1; WOW64; Trident/7.0; AS; rv:11.0) like Gecko```

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```10.71.232.252``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  10.71.232.252    UGScg  en0
...
<pre>
default   fe80:2f7b:3d31:8140:6967%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {191.35.98.127, 157.179.112.23}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 95:6e:f3:4b:a9:2e
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr ca:8a:41:24:a7:e7
}</pre>
...
## Apple macOS / OSX
No matter what version of OSX/macOS you are on, ```10.15.5```, ```11.6.6```, or ```12.3.5```, there are a range of tools for troubleshooting. Unfortunately, between these manual actions and scripts, they don't give you a series of correlated values over time. This is where automated remote troubleshooting comes in to its own, especially for teams that embrace remote work and Work From Anywhere (WFA).
