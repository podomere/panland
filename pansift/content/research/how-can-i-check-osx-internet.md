...
layout: research
ip_v4_address: "83.173.48.78"
date: 2022-11-19T19:13:16+00:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like ```83.173.48.78``` or an IPv6 address like ```2000:ff32:acfa:2823:1576:1c0a:bd74:6abd```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```57:1d:51:8a:68:60```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://moen.net you initially access a DNS server to translate the host portion (moen) combined with the Top Level Domain (net) of the URL, to an IP address like ```250.153.189.33```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows; U; Win 9x 4.90; SG; rv:1.9.2.4) Gecko/20101104 Netscape/9.1.0285```
...
<pre>
default   fe80:ace8:77d7:d904:566%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {108.224.145.98, 146.76.221.99}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 57:1d:51:8a:68:60
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr d5:57:94:c2:b7:7f
}</pre>
