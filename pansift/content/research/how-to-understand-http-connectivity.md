...
layout: research
ip_v4_address: "193.248.220.253"
date: 2023-10-29T15:13:29+00:00
draft: false
---

## Internet Addressing
On the Internet you may have a Public IPv4 address like ```193.248.220.253``` or an IPv6 address like ```2000:21b8:b400:5497:69ee:5850:f34:7d9f```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```ca:64:bd:e3:46:c8```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://schiller.co you initially access a DNS server to translate the host portion (schiller) combined with the Top Level Domain (co) of the URL, to an IP address like ```168.96.82.71```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (compatible; MSIE 9.0; AOL 9.7; AOLBuild 4343.19; Windows NT 6.1; WOW64; Trident/5.0; FunWebProducts)```
...
<pre>
default   fe80:e8d8:827:1f4:9ad8%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {244.232.90.239, 145.123.127.43}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr ca:64:bd:e3:46:c8
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 7b:01:8f:ba:d7:49
}</pre>
