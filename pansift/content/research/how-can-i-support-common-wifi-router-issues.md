...
layout: research
ip_v4_address: "93.61.83.217"
date: 2022-06-04T14:38:17+01:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like ```93.61.83.217``` or an IPv6 address like ```2000:449b:528:4816:4702:f8c5:9399:7562```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```b2:e7:9b:6b:57:2e```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://trantow.biz you initially access a DNS server to translate the host portion (trantow) combined with the Top Level Domain (biz) of the URL, to an IP address like ```236.23.40.130```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (compatible; MSIE 9.0; AOL 9.7; AOLBuild 4343.19; Windows NT 6.1; WOW64; Trident/5.0; FunWebProducts)```
...
<pre>
default   fe80:9543:a17e:44c8:530b%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {72.9.73.62, 30.95.55.230}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr b2:e7:9b:6b:57:2e
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 39:fc:65:84:5b:27
}</pre>
