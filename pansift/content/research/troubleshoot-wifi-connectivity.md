...
subtitle: "Heads Down?"
layout: research
ip_v4_address: "112.8.144.152"
date: 2022-12-15T13:50:03+00:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like ```112.8.144.152``` or an IPv6 address like ```2000:f6a1:cb7e:86a3:ec90:d23c:34e3:61e4```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```ff:7a:34:19:58:da```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://kiehn-wolf.io you initially access a DNS server to translate the host portion (kiehn-wolf) combined with the Top Level Domain (io) of the URL, to an IP address like ```237.138.90.192```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT x.y; Win64; x64; rv:10.0) Gecko/20100101 Firefox/10.0```
...
<pre>
default   fe80:2da0:5800:9bcf:e26%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {189.166.51.30, 212.202.149.201}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr ff:7a:34:19:58:da
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr c6:af:35:ed:64:3a
}</pre>
