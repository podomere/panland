...
subtitle: "Granular?"
layout: research
ip_v4_address: "219.74.238.209"
date: 2022-06-12T14:09:17+01:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like ```219.74.238.209``` or an IPv6 address like ```2000:3acc:4c61:eedd:f567:33b5:4410:3d06```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```bc:78:82:27:c5:88```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://hilll-ohara.co you initially access a DNS server to translate the host portion (hilll-ohara) combined with the Top Level Domain (co) of the URL, to an IP address like ```74.48.89.200```. Your computer and browser actually sends its type with all web requests e.g. <br>```Opera/9.80 (X11; Linux i686; Ubuntu/14.10) Presto/2.12.388 Version/12.16```
...
<pre>
default   fe80:2c67:e148:4bff:4ff2%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {231.37.180.193, 58.84.190.250}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr bc:78:82:27:c5:88
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 6b:fa:0e:42:78:c2
}</pre>
