...
layout: research
ip_v4_address: "168.68.111.92"
date: 2023-10-29T15:13:13+00:00
draft: false
---

## Internet Addressing
On the Internet you might have a Public IPv4 address like ```168.68.111.92``` or an IPv6 address like ```2000:525e:7032:99af:27bd:ef0d:11df:465c```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```82:20:97:0b:46:5c```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://monahan.net you initially access a DNS server to translate the host portion (monahan) combined with the Top Level Domain (net) of the URL, to an IP address like ```211.151.166.80```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT x.y; Win64; x64; rv:10.0) Gecko/20100101 Firefox/10.0```

## Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```172.31.15.232``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  172.31.15.232    UGScg  en0
...
<pre>
default   fe80:411a:c7df:9053:b746%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {210.149.38.125, 16.235.139.133}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 82:20:97:0b:46:5c
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 99:e2:e1:f5:a9:a1
}</pre>
...
### Apple macOS / OSX
No matter what version of OSX/macOS you are on, ```10.12.7```, ```11.1.3```, or ```12.1.2```, there are a range of tools for troubleshooting. Unfortunately, between these manual actions and scripts, they don't give you a series of correlated values over time. This is where automated remote troubleshooting comes in to its own, especially for teams that embrace remote work and Work From Anywhere (WFA).
