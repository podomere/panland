...
layout: research
ip_v4_address: "27.131.27.244"
date: 2022-05-05T14:28:24+01:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like ```27.131.27.244``` or an IPv6 address like ```2000:cec4:e66f:d473:295f:5c19:e0e:8823```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```af:e1:f6:0b:06:5f```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://corwin-homenick.io you initially access a DNS server to translate the host portion (corwin-homenick) combined with the Top Level Domain (io) of the URL, to an IP address like ```170.183.145.84```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT x.y; Win64; x64; rv:10.0) Gecko/20100101 Firefox/10.0```
...
<pre>
default   fe80:2df4:ebd7:2029:8eb%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {151.119.222.164, 103.26.6.63}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr af:e1:f6:0b:06:5f
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr e5:12:36:a1:0b:93
}</pre>
...
## Apple macOS / OSX
No matter what version of OSX/macOS you are on, ```10.12.1```, ```11.1.3```, or ```12.2.6```, there are a range of tools for troubleshooting. Unfortunately, between these manual actions and scripts, they don't give you a series of correlated values over time. This is where automated remote troubleshooting comes in to its own, especially for teams that embrace remote work and Work From Anywhere (WFA).
