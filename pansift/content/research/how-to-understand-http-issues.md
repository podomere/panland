...
layout: research
ip_v4_address: "188.229.16.132"
date: 2022-12-15T13:50:21+00:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like ```188.229.16.132``` or an IPv6 address like ```2000:d6a9:80b6:ab36:c462:c596:517f:e629```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```b1:a3:12:bb:b4:97```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://berge.org you initially access a DNS server to translate the host portion (berge) combined with the Top Level Domain (org) of the URL, to an IP address like ```146.201.174.134```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows; U; Win 9x 4.90; SG; rv:1.9.2.4) Gecko/20101104 Netscape/9.1.0285```
...
<pre>
default   fe80:d1e6:d0c8:979a:f4d7%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {244.54.148.95, 56.98.24.57}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr b1:a3:12:bb:b4:97
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 8d:f6:f7:d4:8d:72
}</pre>
