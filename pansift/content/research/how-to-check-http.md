...
subtitle: "Granular?"
layout: research
ip_v4_address: "161.141.97.25"
date: 2022-05-05T14:30:05+01:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like ```161.141.97.25``` or an IPv6 address like ```2000:ba55:ff24:ee2c:ddfa:3dad:2703:423d```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```8c:e6:ab:28:81:ca```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://hagenes-nicolas.com you initially access a DNS server to translate the host portion (hagenes-nicolas) combined with the Top Level Domain (com) of the URL, to an IP address like ```61.44.228.32```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows; U; Win 9x 4.90; SG; rv:1.9.2.4) Gecko/20101104 Netscape/9.1.0285```

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```10.214.89.244``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  10.214.89.244    UGScg  en0
...
<pre>
default   fe80:ac52:326e:2cda:66d0%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {100.9.235.12, 158.11.153.235}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 8c:e6:ab:28:81:ca
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 8b:32:35:67:d3:e9
}</pre>
