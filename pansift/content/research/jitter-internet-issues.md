...
layout: research
ip_v4_address: "181.232.112.183"
date: 2023-02-04T17:08:37+00:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like ```181.232.112.183``` or an IPv6 address like ```2000:42d5:193d:4af9:891f:288e:e313:50f4```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```1f:f6:ea:fa:2b:d1```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://haley-franecki.org you initially access a DNS server to translate the host portion (haley-franecki) combined with the Top Level Domain (org) of the URL, to an IP address like ```29.5.228.201```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT x.y; Win64; x64; rv:10.0) Gecko/20100101 Firefox/10.0```
...
<pre>
default   fe80:cd71:e742:1070:61c0%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {136.150.40.230, 111.143.168.243}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 1f:f6:ea:fa:2b:d1
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 15:e3:87:bd:ed:bb
}</pre>
