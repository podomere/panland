...
subtitle: "Granular?"
layout: research
ip_v4_address: "186.86.14.231"
date: 2022-05-05T14:30:09+01:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like ```186.86.14.231``` or an IPv6 address like ```2000:25d7:aa5:1fef:d25e:a1b1:f6b7:2c0b```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```70:b2:4b:a4:df:c2```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://miller.org you initially access a DNS server to translate the host portion (miller) combined with the Top Level Domain (org) of the URL, to an IP address like ```201.18.70.52```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1; WOW64; Trident/7.0; AS; rv:11.0) like Gecko```
...
<pre>
default   fe80:a7e5:6be1:edae:4aa9%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {254.106.140.89, 144.12.70.250}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 70:b2:4b:a4:df:c2
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr d3:be:03:c8:8f:cf
}</pre>
