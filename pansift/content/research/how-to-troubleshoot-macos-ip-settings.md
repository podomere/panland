...
layout: research
ip_v4_address: "5.230.165.14"
date: 2022-04-24T19:00:23+01:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like <code>5.230.165.14</code> or an IPv6 address like <code>2000:8432:b21f:e27c:52d3:831b:5167:a16e</code>. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>2e:3c:9b:68:e1:b5</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://treutel-friesen.net you initially access a DNS server to translate the host portion (treutel-friesen) combined with the Top Level Domain (net) of the URL, to an IP address like <code>54.78.220.189</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (Windows; U; Win 9x 4.90; SG; rv:1.9.2.4) Gecko/20101104 Netscape/9.1.0285</code>
...
<pre><code>
default   fe80:3deb:ef68:eebd:a589%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {180.105.174.190, 56.4.35.202}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 2e:3c:9b:68:e1:b5
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr e4:1c:5d:8d:b5:c8
}</code></pre>
