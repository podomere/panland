...
layout: research
ip_v4_address: "57.185.81.244"
date: 2023-10-29T15:13:25+00:00
draft: false
---

## Internet Addressing
On the Internet you may get a Public IPv4 address like ```57.185.81.244``` or an IPv6 address like ```2000:f293:6406:5d91:4a7e:56d8:2eb:56ca```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```f0:6c:ff:3c:6f:01```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://schaden-feil.org you initially access a DNS server to translate the host portion (schaden-feil) combined with the Top Level Domain (org) of the URL, to an IP address like ```237.99.20.158```. Your computer and browser actually sends its type with all web requests e.g. <br>```Opera/9.80 (X11; Linux i686; Ubuntu/14.10) Presto/2.12.388 Version/12.16```
...
<pre>
default   fe80:5a9a:6f26:d519:b2c8%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {165.153.224.114, 149.53.180.102}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr f0:6c:ff:3c:6f:01
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr cd:c6:97:0e:46:e6
}</pre>
