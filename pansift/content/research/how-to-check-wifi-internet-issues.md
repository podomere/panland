...
layout: research
ip_v4_address: "56.25.206.53"
date: 2022-06-12T14:09:05+01:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like ```56.25.206.53``` or an IPv6 address like ```2000:2a6:9f7d:4fa1:e88f:33cd:20bc:4d4a```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```dc:90:93:30:28:4b```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://morissette-kerluke.name you initially access a DNS server to translate the host portion (morissette-kerluke) combined with the Top Level Domain (name) of the URL, to an IP address like ```46.226.240.124```. Your computer and browser actually sends its type with all web requests e.g. <br>```Opera/9.80 (X11; Linux i686; Ubuntu/14.10) Presto/2.12.388 Version/12.16```
...
<pre>
default   fe80:8014:eaa9:86f5:6827%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {146.114.250.34, 186.201.190.231}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr dc:90:93:30:28:4b
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 43:cb:5a:49:64:40
}</pre>
