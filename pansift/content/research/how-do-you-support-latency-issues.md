...
layout: research
ip_v4_address: "42.132.190.248"
date: 2022-11-19T16:17:21+00:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like ```42.132.190.248``` or an IPv6 address like ```2000:dfe3:b70d:aa1d:b8ff:7e80:8e0d:7302```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```fe:69:50:a9:e5:bf```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://yundt.org you initially access a DNS server to translate the host portion (yundt) combined with the Top Level Domain (org) of the URL, to an IP address like ```92.173.76.53```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (compatible; MSIE 9.0; AOL 9.7; AOLBuild 4343.19; Windows NT 6.1; WOW64; Trident/5.0; FunWebProducts)```

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```172.25.203.66``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  172.25.203.66    UGScg  en0
...
<pre>
default   fe80:b570:da1:6f87:e2a5%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {59.100.181.223, 57.91.34.221}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr fe:69:50:a9:e5:bf
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 2a:d2:2d:96:ce:39
}</pre>
