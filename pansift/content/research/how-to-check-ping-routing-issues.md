...
layout: research
ip_v4_address: "105.34.139.23"
date: 2022-11-19T16:17:23+00:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like ```105.34.139.23``` or an IPv6 address like ```2000:415c:b5d:ec14:4ced:a9f6:f5d5:5f6c```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```75:9b:3f:a2:8d:8d```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://upton-welch.name you initially access a DNS server to translate the host portion (upton-welch) combined with the Top Level Domain (name) of the URL, to an IP address like ```89.41.21.21```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT x.y; Win64; x64; rv:10.0) Gecko/20100101 Firefox/10.0```
...
<pre>
default   fe80:f20f:196c:8d2c:661%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {23.72.59.121, 19.230.155.142}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 75:9b:3f:a2:8d:8d
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr c6:f2:82:78:52:98
}</pre>
