...
layout: research
ip_v4_address: "244.136.65.168"
date: 2022-05-05T14:30:03+01:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like ```244.136.65.168``` or an IPv6 address like ```2000:e7a6:edc6:4864:316f:7846:44a2:7530```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```bb:b6:ee:7b:78:a7```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://murazik-brekke.co you initially access a DNS server to translate the host portion (murazik-brekke) combined with the Top Level Domain (co) of the URL, to an IP address like ```196.249.13.170```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows; U; Win 9x 4.90; SG; rv:1.9.2.4) Gecko/20101104 Netscape/9.1.0285```
...
<pre>
default   fe80:d058:2651:318b:9b81%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {211.169.113.43, 87.81.196.185}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr bb:b6:ee:7b:78:a7
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 00:d1:04:0d:7d:5a
}</pre>
...
## Apple macOS / OSX
No matter what version of OSX/macOS you are on, ```10.14.6```, ```11.4.4```, or ```12.1.5```, there are a range of tools for troubleshooting. Unfortunately, between these manual actions and scripts, they don't give you a series of correlated values over time. This is where automated remote troubleshooting comes in to its own, especially for teams that embrace remote work and Work From Anywhere (WFA).
