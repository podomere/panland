...
layout: research
ip_v4_address: "58.204.221.221"
date: 2023-10-29T15:13:27+00:00
draft: false
---

## Internet Addressing
On the Internet you might have a Public IPv4 address like ```58.204.221.221``` or an IPv6 address like ```2000:64d:a79c:4361:6ec4:82a4:3aa4:d731```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```f8:05:5f:ef:aa:a1```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).
...
<pre>
default   fe80:9137:2fe:dd57:a8fe%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {81.234.251.35, 61.126.226.56}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr f8:05:5f:ef:aa:a1
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 42:c0:16:a4:56:a0
}</pre>
