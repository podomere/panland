...
layout: research
ip_v4_address: "116.88.211.101"
date: 2023-10-29T15:13:29+00:00
draft: false
---

## Internet Addressing
On the Internet you might have a Public IPv4 address like ```116.88.211.101``` or an IPv6 address like ```2000:cf6c:bcda:90e:9fa1:691f:9cab:d8ea```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```76:cd:99:e2:bc:86```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://smitham-aufderhar.io you initially access a DNS server to translate the host portion (smitham-aufderhar) combined with the Top Level Domain (io) of the URL, to an IP address like ```242.233.65.115```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT x.y; Win64; x64; rv:10.0) Gecko/20100101 Firefox/10.0```

## Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```10.115.220.45``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  10.115.220.45    UGScg  en0
...
<pre>
default   fe80:e4ba:ce88:f6ba:b68c%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {145.172.5.58, 138.180.141.119}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 76:cd:99:e2:bc:86
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 5b:59:ac:5c:8c:6c
}</pre>
