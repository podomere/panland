---
title: "How Do You Support Https Routing Issues"
subtitle: "Thought Leadership?"
layout: research
ip_v4_address: "41.242.212.101"
date: 2022-12-15T13:50:22+00:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like ```41.242.212.101``` or an IPv6 address like ```2000:f119:7fcf:aceb:77b3:13c8:face:b4af```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```26:4c:89:5b:a6:26```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://oberbrunner.name you initially access a DNS server to translate the host portion (oberbrunner) combined with the Top Level Domain (name) of the URL, to an IP address like ```80.245.160.171```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/41.0.2228.0 Safari/537.36```
...
<pre>
default   fe80:2e2d:bc56:7f27:c27a%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {102.113.118.154, 134.90.35.155}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 26:4c:89:5b:a6:26
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 19:91:da:b2:50:a4
}</pre>
