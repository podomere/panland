...
layout: research
ip_v4_address: "147.115.40.216"
date: 2022-11-19T16:17:24+00:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like ```147.115.40.216``` or an IPv6 address like ```2000:1234:80ec:2f89:4bcd:e305:6de7:62e7```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```41:fa:11:81:38:c8```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://turner-glover.co you initially access a DNS server to translate the host portion (turner-glover) combined with the Top Level Domain (co) of the URL, to an IP address like ```56.200.164.76```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1; WOW64; Trident/7.0; AS; rv:11.0) like Gecko```
...
<pre>
default   fe80:c2b8:77ca:19b8:4ef8%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {140.132.18.206, 125.192.144.55}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 41:fa:11:81:38:c8
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr e5:79:6f:8b:a3:5a
}</pre>
