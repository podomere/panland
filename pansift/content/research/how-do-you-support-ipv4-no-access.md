...
subtitle: "Impact Map?"
layout: research
ip_v4_address: "174.92.53.194"
date: 2023-10-29T15:13:26+00:00
draft: false
---

## Internet Addressing
On the Internet you might have a Public IPv4 address like ```174.92.53.194``` or an IPv6 address like ```2000:a3f6:df2c:4b38:b899:1608:5a8f:3aca```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```0d:d9:9f:11:3f:9f```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://waelchi.co you initially access a DNS server to translate the host portion (waelchi) combined with the Top Level Domain (co) of the URL, to an IP address like ```41.117.63.247```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (compatible; MSIE 9.0; AOL 9.7; AOLBuild 4343.19; Windows NT 6.1; WOW64; Trident/5.0; FunWebProducts)```
...
<pre>
default   fe80:49af:ad85:5a6f:e4ae%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {110.93.71.153, 252.153.167.79}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 0d:d9:9f:11:3f:9f
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr af:8c:b1:b5:24:55
}</pre>
...
### Apple macOS / OSX
No matter what version of OSX/macOS you are on, ```10.15.7```, ```11.4.9```, or ```12.3.8```, there are a range of tools for troubleshooting. Unfortunately, between these manual actions and scripts, they don't give you a series of correlated values over time. This is where automated remote troubleshooting comes in to its own, especially for teams that embrace remote work and Work From Anywhere (WFA).
