...
layout: research
ip_v4_address: "157.20.157.196"
date: 2023-02-04T16:26:22+00:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like ```157.20.157.196``` or an IPv6 address like ```2000:bb4b:2790:ff74:9d07:8e1f:5ec:45f```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```73:2f:bc:0e:c9:dd```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://deckow.com you initially access a DNS server to translate the host portion (deckow) combined with the Top Level Domain (com) of the URL, to an IP address like ```149.5.255.57```. Your computer and browser actually sends its type with all web requests e.g. <br>```Opera/9.80 (X11; Linux i686; Ubuntu/14.10) Presto/2.12.388 Version/12.16```

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```172.31.229.75``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  172.31.229.75    UGScg  en0
...
<pre>
default   fe80:79f8:78d4:591b:d57f%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {10.64.34.253, 113.224.214.125}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 73:2f:bc:0e:c9:dd
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr b9:4e:31:29:8d:5f
}</pre>
