...
layout: research
ip_v4_address: "206.128.201.103"
date: 2022-11-02T11:32:23+00:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like ```206.128.201.103``` or an IPv6 address like ```2000:37cd:b1e8:bb3:b2ce:28e1:d687:b70e```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```e2:28:58:ab:c2:56```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://kertzmann.net you initially access a DNS server to translate the host portion (kertzmann) combined with the Top Level Domain (net) of the URL, to an IP address like ```108.166.130.189```. Your computer and browser actually sends its type with all web requests e.g. <br>```Opera/9.80 (X11; Linux i686; Ubuntu/14.10) Presto/2.12.388 Version/12.16```

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```10.89.72.222``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  10.89.72.222    UGScg  en0
...
<pre>
default   fe80:f80:3d21:5ff5:4ac1%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {52.75.16.210, 20.86.76.188}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr e2:28:58:ab:c2:56
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 75:f1:69:85:05:5c
}</pre>
...
## Apple macOS / OSX
No matter what version of OSX/macOS you are on, ```10.12.5```, ```11.5.9```, or ```12.0.6```, there are a range of tools for troubleshooting. Unfortunately, between these manual actions and scripts, they don't give you a series of correlated values over time. This is where automated remote troubleshooting comes in to its own, especially for teams that embrace remote work and Work From Anywhere (WFA).
