...
layout: research
ip_v4_address: "236.84.90.208"
date: 2022-04-24T18:59:56+01:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like <code>236.84.90.208</code> or an IPv6 address like <code>2000:a0b6:88f8:bee1:d427:3a84:b45b:b1db</code>. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>64:e8:7e:4d:fc:58</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://grant-skiles.com you initially access a DNS server to translate the host portion (grant-skiles) combined with the Top Level Domain (com) of the URL, to an IP address like <code>93.131.140.114</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (compatible; MSIE 9.0; AOL 9.7; AOLBuild 4343.19; Windows NT 6.1; WOW64; Trident/5.0; FunWebProducts)</code>
...
<pre><code>
default   fe80:6f31:ab9c:6d8e:c7f7%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {123.144.175.219, 17.82.158.164}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 64:e8:7e:4d:fc:58
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr f2:a3:af:37:af:21
}</code></pre>
