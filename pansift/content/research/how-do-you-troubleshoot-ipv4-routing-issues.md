...
layout: research
ip_v4_address: "209.106.210.99"
date: 2022-06-04T14:38:38+01:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like ```209.106.210.99``` or an IPv6 address like ```2000:c31a:6f2e:27bd:b30d:830f:de8f:1690```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```89:75:c4:e1:de:89```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://runolfsdottir-kerluke.co you initially access a DNS server to translate the host portion (runolfsdottir-kerluke) combined with the Top Level Domain (co) of the URL, to an IP address like ```237.199.87.169```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (compatible; MSIE 9.0; AOL 9.7; AOLBuild 4343.19; Windows NT 6.1; WOW64; Trident/5.0; FunWebProducts)```
...
<pre>
default   fe80:c66:daea:8f4c:2b0e%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {42.77.122.50, 17.75.58.183}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 89:75:c4:e1:de:89
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr ba:18:d2:9c:cd:a8
}</pre>
