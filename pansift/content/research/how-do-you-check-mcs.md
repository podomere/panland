...
layout: research
ip_v4_address: "191.78.25.83"
date: 2022-04-24T19:00:34+01:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like <code>191.78.25.83</code> or an IPv6 address like <code>2000:f4cb:1ed:2e8e:6fd1:7764:edf6:674</code>. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>2f:eb:86:f6:9f:f0</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://botsford-harvey.net you initially access a DNS server to translate the host portion (botsford-harvey) combined with the Top Level Domain (net) of the URL, to an IP address like <code>169.40.188.75</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (Windows NT 6.1; WOW64; Trident/7.0; AS; rv:11.0) like Gecko</code>

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like <code>10.181.143.128</code> (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For <code>IPv6</code> we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  10.181.143.128    UGScg  en0
...
<pre><code>
default   fe80:9f3d:3bfd:c82e:b850%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {113.49.213.122, 193.21.188.1}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 2f:eb:86:f6:9f:f0
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr c0:39:bc:f5:60:57
}</code></pre>
