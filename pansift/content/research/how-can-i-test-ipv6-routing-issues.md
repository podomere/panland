...
layout: research
ip_v4_address: "110.216.118.88"
date: 2023-10-06T17:11:03+01:00
draft: false
---

## Internet Addressing
On the Internet you may get a Public IPv4 address like ```110.216.118.88``` or an IPv6 address like ```2000:dff9:127e:354c:5f9b:2325:daa:619c```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```ba:54:95:a5:e5:a0```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://haley.co you initially access a DNS server to translate the host portion (haley) combined with the Top Level Domain (co) of the URL, to an IP address like ```80.242.245.49```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows; U; Win 9x 4.90; SG; rv:1.9.2.4) Gecko/20101104 Netscape/9.1.0285```

## Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```192.168.182.21``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  192.168.182.21    UGScg  en0
...
<pre>
default   fe80:352d:d582:e6dd:4613%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {82.167.165.203, 247.16.21.177}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr ba:54:95:a5:e5:a0
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr ae:ae:7c:bb:2d:2f
}</pre>
...
### Apple macOS / OSX
No matter what version of OSX/macOS you are on, ```10.13.3```, ```11.2.6```, or ```12.0.5```, there are a range of tools for troubleshooting. Unfortunately, between these manual actions and scripts, they don't give you a series of correlated values over time. This is where automated remote troubleshooting comes in to its own, especially for teams that embrace remote work and Work From Anywhere (WFA).
