...
subtitle: "Heads Down?"
layout: research
ip_v4_address: "9.173.182.183"
date: 2022-05-05T14:29:41+01:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like ```9.173.182.183``` or an IPv6 address like ```2000:e8fc:359d:8554:5547:feee:9cb2:9e8d```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```02:ec:17:e3:53:48```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://baumbach.name you initially access a DNS server to translate the host portion (baumbach) combined with the Top Level Domain (name) of the URL, to an IP address like ```220.36.134.181```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/41.0.2228.0 Safari/537.36```

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```192.168.130.247``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  192.168.130.247    UGScg  en0
...
<pre>
default   fe80:f8ca:5f4c:5218:c505%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {143.153.51.109, 15.96.184.236}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 02:ec:17:e3:53:48
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr cb:2b:67:60:c0:da
}</pre>
