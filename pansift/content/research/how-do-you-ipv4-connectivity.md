...
layout: research
ip_v4_address: "206.4.133.81"
date: 2023-10-06T17:11:04+01:00
draft: false
---

## Internet Addressing
On the Internet you might get a Public IPv4 address like ```206.4.133.81``` or an IPv6 address like ```2000:4272:b8de:5ffa:4445:1c80:20ae:3ef5```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```7f:66:56:f5:56:b9```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://kohler-huels.com you initially access a DNS server to translate the host portion (kohler-huels) combined with the Top Level Domain (com) of the URL, to an IP address like ```205.189.31.136```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_3) AppleWebKit/537.75.14 (KHTML, like Gecko) Version/7.0.3 Safari/7046A194A```
...
<pre>
default   fe80:5b7f:9a2d:b25b:1468%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {3.47.195.138, 29.227.208.75}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 7f:66:56:f5:56:b9
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr c6:79:fc:6a:39:dd
}</pre>
