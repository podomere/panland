...
subtitle: "Etc. Etc.?"
layout: research
ip_v4_address: "60.90.197.124"
date: 2022-05-05T14:29:36+01:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like ```60.90.197.124``` or an IPv6 address like ```2000:4215:1fc:8bbf:8f56:aa88:bac1:c178```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```08:7d:12:20:23:f8```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://mitchell.name you initially access a DNS server to translate the host portion (mitchell) combined with the Top Level Domain (name) of the URL, to an IP address like ```173.131.194.131```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (compatible; MSIE 9.0; AOL 9.7; AOLBuild 4343.19; Windows NT 6.1; WOW64; Trident/5.0; FunWebProducts)```

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```172.17.195.84``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  172.17.195.84    UGScg  en0
...
<pre>
default   fe80:dc63:751c:7d6a:1943%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {33.107.191.170, 112.153.168.46}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 08:7d:12:20:23:f8
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 85:ba:b2:7b:f8:84
}</pre>
