...
subtitle: "Tee It Up?"
layout: research
ip_v4_address: "104.98.126.141"
date: 2023-02-04T17:08:40+00:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like ```104.98.126.141``` or an IPv6 address like ```2000:1287:6e14:a085:afed:2a2e:efb:42af```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```29:18:72:b0:52:c4```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://hauck-mccullough.info you initially access a DNS server to translate the host portion (hauck-mccullough) combined with the Top Level Domain (info) of the URL, to an IP address like ```147.207.250.67```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (compatible; MSIE 9.0; AOL 9.7; AOLBuild 4343.19; Windows NT 6.1; WOW64; Trident/5.0; FunWebProducts)```
...
<pre>
default   fe80:919e:1eb3:1f4c:15a7%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {17.1.198.229, 55.102.76.217}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 29:18:72:b0:52:c4
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr a0:ad:47:bd:f0:64
}</pre>
