---
title: "DiagnOSe Http Routing Issues"
subtitle: "Etc. Etc.?"
layout: research
ip_v4_address: "190.190.49.87"
date: 2023-02-04T17:08:39+00:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like ```190.190.49.87``` or an IPv6 address like ```2000:79d2:8808:a169:5c86:b388:753c:1327```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```51:22:3d:4c:68:ca```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://medhurst.name you initially access a DNS server to translate the host portion (medhurst) combined with the Top Level Domain (name) of the URL, to an IP address like ```224.21.117.136```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (compatible; MSIE 9.0; AOL 9.7; AOLBuild 4343.19; Windows NT 6.1; WOW64; Trident/5.0; FunWebProducts)```

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```172.16.86.224``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  172.16.86.224    UGScg  en0
...
<pre>
default   fe80:416a:37d9:c2a1:4b20%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {59.172.37.99, 157.130.1.20}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 51:22:3d:4c:68:ca
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr ef:5c:0a:af:f8:6a
}</pre>
...
## Apple macOS / OSX
No matter what version of OSX/macOS you are on, ```10.13.6```, ```11.0.9```, or ```12.3.2```, there are a range of tools for troubleshooting. Unfortunately, between these manual actions and scripts, they don't give you a series of correlated values over time. This is where automated remote troubleshooting comes in to its own, especially for teams that embrace remote work and Work From Anywhere (WFA).
