...
layout: research
ip_v4_address: "16.232.4.158"
date: 2022-11-19T19:13:26+00:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like ```16.232.4.158``` or an IPv6 address like ```2000:a5f0:ecfe:2393:ed03:85d6:7c28:3560```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```e3:21:7b:9e:81:af```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://senger-grimes.io you initially access a DNS server to translate the host portion (senger-grimes) combined with the Top Level Domain (io) of the URL, to an IP address like ```205.88.163.68```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_3) AppleWebKit/537.75.14 (KHTML, like Gecko) Version/7.0.3 Safari/7046A194A```
...
<pre>
default   fe80:80b3:8459:5c08:630b%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {4.204.41.141, 55.122.206.100}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr e3:21:7b:9e:81:af
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr d3:0e:2f:0d:2e:7a
}</pre>
