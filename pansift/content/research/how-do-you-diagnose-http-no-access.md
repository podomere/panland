...
layout: research
ip_v4_address: "27.81.212.198"
date: 2022-12-15T13:50:21+00:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like ```27.81.212.198``` or an IPv6 address like ```2000:5597:49b0:1af2:5fae:97ae:572:18cc```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```fa:9e:c4:a3:61:0c```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://heaney-hodkiewicz.net you initially access a DNS server to translate the host portion (heaney-hodkiewicz) combined with the Top Level Domain (net) of the URL, to an IP address like ```192.66.90.148```. Your computer and browser actually sends its type with all web requests e.g. <br>```Opera/9.80 (X11; Linux i686; Ubuntu/14.10) Presto/2.12.388 Version/12.16```
...
default  172.17.120.4    UGScg  en0
...
<pre>
default   fe80:8c8c:f7c8:3c48:520b%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {226.36.96.171, 84.253.196.86}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr fa:9e:c4:a3:61:0c
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr d7:94:5b:1a:47:28
}</pre>
