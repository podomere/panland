...
layout: research
ip_v4_address: "170.223.95.180"
date: 2023-02-04T16:26:18+00:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like ```170.223.95.180``` or an IPv6 address like ```2000:2358:ecf3:53dd:e23d:e47e:6426:691c```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```16:98:3b:de:71:0e```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://frami.io you initially access a DNS server to translate the host portion (frami) combined with the Top Level Domain (io) of the URL, to an IP address like ```249.142.67.219```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT x.y; Win64; x64; rv:10.0) Gecko/20100101 Firefox/10.0```
...
<pre>
default   fe80:60be:25c9:4aa5:1ab7%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {194.247.110.90, 231.80.46.23}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 16:98:3b:de:71:0e
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr d8:e1:d3:96:bc:ae
}</pre>
...
## Apple macOS / OSX
No matter what version of OSX/macOS you are on, ```10.13.2```, ```11.6.3```, or ```12.2.1```, there are a range of tools for troubleshooting. Unfortunately, between these manual actions and scripts, they don't give you a series of correlated values over time. This is where automated remote troubleshooting comes in to its own, especially for teams that embrace remote work and Work From Anywhere (WFA).
