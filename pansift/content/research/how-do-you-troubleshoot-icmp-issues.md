...
layout: research
ip_v4_address: "63.125.200.255"
date: 2022-04-24T19:00:01+01:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like <code>63.125.200.255</code> or an IPv6 address like <code>2000:e0d7:3940:49d5:c2c7:e987:6d40:3eeb</code>. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>66:c8:69:8b:94:fe</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://ritchie-sanford.info you initially access a DNS server to translate the host portion (ritchie-sanford) combined with the Top Level Domain (info) of the URL, to an IP address like <code>83.191.135.98</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (Windows NT 6.1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/41.0.2228.0 Safari/537.36</code>
...
<pre><code>
default   fe80:e2f0:6357:c2e6:8d1f%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {218.69.163.234, 176.89.54.97}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 66:c8:69:8b:94:fe
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 78:f2:b5:c9:16:29
}</code></pre>
