...
layout: research
ip_v4_address: "217.27.58.250"
date: 2022-12-15T13:50:11+00:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like ```217.27.58.250``` or an IPv6 address like ```2000:7454:ec07:55b3:a69:9344:f910:5926```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```b3:79:cb:13:72:28```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://hane-gerlach.name you initially access a DNS server to translate the host portion (hane-gerlach) combined with the Top Level Domain (name) of the URL, to an IP address like ```143.208.172.137```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT x.y; Win64; x64; rv:10.0) Gecko/20100101 Firefox/10.0```
...
<pre>
default   fe80:80ec:599:2cc1:64eb%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {147.109.230.235, 150.107.122.213}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr b3:79:cb:13:72:28
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr bf:ae:ed:3a:16:94
}</pre>
