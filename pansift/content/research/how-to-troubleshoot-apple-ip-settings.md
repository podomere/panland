...
layout: research
ip_v4_address: "244.99.253.87"
date: 2022-06-12T14:09:16+01:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like ```244.99.253.87``` or an IPv6 address like ```2000:3ff3:d725:ac01:ad1c:e628:a7bb:d57a```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```ad:e7:5d:44:12:9f```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://jenkins.com you initially access a DNS server to translate the host portion (jenkins) combined with the Top Level Domain (com) of the URL, to an IP address like ```97.211.162.177```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows; U; Win 9x 4.90; SG; rv:1.9.2.4) Gecko/20101104 Netscape/9.1.0285```
...
<pre>
default   fe80:924:643d:e7d8:bee8%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {122.179.244.182, 197.245.83.19}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr ad:e7:5d:44:12:9f
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 6f:df:58:74:5c:9f
}</pre>
