...
subtitle: "Swim Lane?"
layout: research
ip_v4_address: "13.125.52.93"
date: 2023-02-04T17:08:38+00:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like ```13.125.52.93``` or an IPv6 address like ```2000:c634:f9e7:d88a:76d9:155b:6463:9cf4```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```92:a7:cc:f9:fb:a8```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://dickinson.net you initially access a DNS server to translate the host portion (dickinson) combined with the Top Level Domain (net) of the URL, to an IP address like ```21.58.18.22```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_3) AppleWebKit/537.75.14 (KHTML, like Gecko) Version/7.0.3 Safari/7046A194A```
...
<pre>
default   fe80:4f97:3ed2:6ddb:a4f2%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {109.225.33.177, 146.131.96.99}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 92:a7:cc:f9:fb:a8
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 14:23:f5:32:a1:ac
}</pre>
