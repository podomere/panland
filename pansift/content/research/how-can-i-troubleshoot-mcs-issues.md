---
title: "How Can I Troubleshoot Mcs Issues"
subtitle: "Learnings?"
layout: research
ip_v4_address: "130.172.246.246"
date: 2022-11-02T11:32:24+00:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like ```130.172.246.246``` or an IPv6 address like ```2000:8288:c5b2:b4cb:3e3c:65bb:e092:120e```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```14:a7:17:5b:25:cb```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://morar-bauch.biz you initially access a DNS server to translate the host portion (morar-bauch) combined with the Top Level Domain (biz) of the URL, to an IP address like ```233.209.184.69```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (compatible; MSIE 9.0; AOL 9.7; AOLBuild 4343.19; Windows NT 6.1; WOW64; Trident/5.0; FunWebProducts)```

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```10.63.137.132``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  10.63.137.132    UGScg  en0
...
<pre>
default   fe80:c9bb:8310:bcd7:9bd5%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {5.15.132.57, 231.166.54.183}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 14:a7:17:5b:25:cb
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr f0:4f:d4:71:ec:00
}</pre>
