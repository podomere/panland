...
subtitle: "Learnings?"
layout: research
ip_v4_address: "252.112.133.4"
date: 2023-10-29T15:13:19+00:00
draft: false
---

## Internet Addressing
On the Internet you might have a Public IPv4 address like ```252.112.133.4``` or an IPv6 address like ```2000:7c6:6f5f:9fca:dcfa:341b:93c4:bcc1```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```0b:54:c5:ab:09:57```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://rowe.net you initially access a DNS server to translate the host portion (rowe) combined with the Top Level Domain (net) of the URL, to an IP address like ```6.24.215.19```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT x.y; Win64; x64; rv:10.0) Gecko/20100101 Firefox/10.0```
...
<pre>
default   fe80:d11:a33f:2c30:fb89%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {31.104.29.54, 114.167.239.201}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 0b:54:c5:ab:09:57
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 5a:0b:32:ce:53:1a
}</pre>
