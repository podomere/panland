...
layout: research
ip_v4_address: "13.40.141.44"
date: 2022-11-02T11:32:52+00:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like ```13.40.141.44``` or an IPv6 address like ```2000:d6fc:ef8f:6c5:bcd6:fb0b:a122:2b0d```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```99:bb:e9:f0:6a:2d```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://cronin-stanton.biz you initially access a DNS server to translate the host portion (cronin-stanton) combined with the Top Level Domain (biz) of the URL, to an IP address like ```84.160.146.17```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT x.y; Win64; x64; rv:10.0) Gecko/20100101 Firefox/10.0```

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```172.26.221.1``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  172.26.221.1    UGScg  en0
...
<pre>
default   fe80:7551:f933:c2a8:f11b%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {82.169.139.246, 243.119.31.6}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 99:bb:e9:f0:6a:2d
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 55:96:6c:35:e6:17
}</pre>
