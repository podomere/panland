...
layout: research
ip_v4_address: "132.109.141.219"
date: 2022-04-24T19:00:06+01:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like <code>132.109.141.219</code> or an IPv6 address like <code>2000:2b26:45df:5fc3:a871:299f:5c00:5970</code>. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>f2:4c:27:42:21:88</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://medhurst-heathcote.org you initially access a DNS server to translate the host portion (medhurst-heathcote) combined with the Top Level Domain (org) of the URL, to an IP address like <code>209.221.76.13</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (Windows NT 6.1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/41.0.2228.0 Safari/537.36</code>
...
<pre><code>
default   fe80:b295:fc5f:8b40:8589%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {51.230.234.131, 234.110.162.235}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr f2:4c:27:42:21:88
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 2d:31:4d:f7:cc:77
}</code></pre>
