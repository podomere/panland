...
layout: research
ip_v4_address: "96.3.224.246"
date: 2022-11-02T11:33:11+00:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like ```96.3.224.246``` or an IPv6 address like ```2000:b801:4f11:f2f5:4a38:87e9:44d1:86ef```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```8c:9c:50:fa:62:f3```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://anderson-bogan.co you initially access a DNS server to translate the host portion (anderson-bogan) combined with the Top Level Domain (co) of the URL, to an IP address like ```99.107.57.175```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (compatible; MSIE 9.0; AOL 9.7; AOLBuild 4343.19; Windows NT 6.1; WOW64; Trident/5.0; FunWebProducts)```
...
<pre>
default   fe80:7c7d:6518:a009:4b1a%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {86.84.183.46, 16.135.202.236}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 8c:9c:50:fa:62:f3
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 6d:1c:7d:4b:14:97
}</pre>
