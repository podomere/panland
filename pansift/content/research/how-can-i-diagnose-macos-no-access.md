...
layout: research
ip_v4_address: "94.101.127.29"
date: 2022-04-24T18:31:57+01:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like <code>94.101.127.29</code> or an IPv6 address like <code>2000:4518:99f9:be35:ac43:d1af:bce7:7fd2</code>. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>5b:4d:bf:97:9c:f2</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://raynor-corkery.name you initially access a DNS server to translate the host portion (raynor-corkery) combined with the Top Level Domain (name) of the URL, to an IP address like <code>27.172.141.140</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_3) AppleWebKit/537.75.14 (KHTML, like Gecko) Version/7.0.3 Safari/7046A194A</code>
...
<pre><code>
default   fe80:1150:dd17:6c6b:1103%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {41.18.56.151, 179.93.1.166}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 5b:4d:bf:97:9c:f2
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr dd:46:b6:a6:fe:d9
}</code></pre>
