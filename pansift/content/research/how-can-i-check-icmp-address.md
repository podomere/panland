...
layout: research
ip_v4_address: "54.119.90.18"
date: 2022-11-02T11:32:58+00:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like ```54.119.90.18``` or an IPv6 address like ```2000:cea6:8d7b:8add:aa96:c47a:a6d8:8b9f```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```9d:37:ee:e1:26:01```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://friesen-little.org you initially access a DNS server to translate the host portion (friesen-little) combined with the Top Level Domain (org) of the URL, to an IP address like ```167.159.164.132```. Your computer and browser actually sends its type with all web requests e.g. <br>```Opera/9.80 (X11; Linux i686; Ubuntu/14.10) Presto/2.12.388 Version/12.16```
...
<pre>
default   fe80:9d57:fa23:ee05:7f09%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {223.246.192.153, 73.6.230.176}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 9d:37:ee:e1:26:01
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr ca:a1:3a:64:36:82
}</pre>
