...
subtitle: "Branding?"
layout: research
ip_v4_address: "111.106.162.125"
date: 2023-10-29T15:13:29+00:00
draft: false
---

## Internet Addressing
On the Internet you might have a Public IPv4 address like ```111.106.162.125``` or an IPv6 address like ```2000:2c3d:6e9e:7230:b1d7:3c9:7fe4:a291```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```31:a4:ee:24:18:5b```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://welch.net you initially access a DNS server to translate the host portion (welch) combined with the Top Level Domain (net) of the URL, to an IP address like ```51.150.144.148```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1; WOW64; Trident/7.0; AS; rv:11.0) like Gecko```

## Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```10.155.93.215``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  10.155.93.215    UGScg  en0
...
<pre>
default   fe80:34c5:5e2d:ccb6:eca0%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {20.98.195.151, 182.41.148.147}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 31:a4:ee:24:18:5b
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr a7:05:df:01:68:15
}</pre>
...
### Apple macOS / OSX
No matter what version of OSX/macOS you are on, ```10.13.8```, ```11.5.4```, or ```12.1.9```, there are a range of tools for troubleshooting. Unfortunately, between these manual actions and scripts, they don't give you a series of correlated values over time. This is where automated remote troubleshooting comes in to its own, especially for teams that embrace remote work and Work From Anywhere (WFA).
