...
layout: research
ip_v4_address: "16.31.223.222"
date: 2023-02-04T17:07:49+00:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like ```16.31.223.222``` or an IPv6 address like ```2000:6b9d:6cd0:762:236:dc37:6ce8:df0c```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```6a:ac:43:9f:c9:dc```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://rowe-damore.net you initially access a DNS server to translate the host portion (rowe-damore) combined with the Top Level Domain (net) of the URL, to an IP address like ```119.180.197.206```. Your computer and browser actually sends its type with all web requests e.g. <br>```Opera/9.80 (X11; Linux i686; Ubuntu/14.10) Presto/2.12.388 Version/12.16```
...
<pre>
default   fe80:f93d:58f7:23e3:520d%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {54.36.145.169, 65.79.200.227}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 6a:ac:43:9f:c9:dc
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 75:a9:a0:e0:8b:bf
}</pre>
