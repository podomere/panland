...
subtitle: "Value Add?"
layout: research
ip_v4_address: "3.153.183.233"
date: 2022-04-24T19:00:25+01:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like <code>3.153.183.233</code> or an IPv6 address like <code>2000:a678:ab36:bd7f:1555:d1d2:bf9d:950d</code>. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>c4:7a:89:ad:99:f6</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://kunze-hilll.com you initially access a DNS server to translate the host portion (kunze-hilll) combined with the Top Level Domain (com) of the URL, to an IP address like <code>27.17.95.240</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (Windows NT x.y; Win64; x64; rv:10.0) Gecko/20100101 Firefox/10.0</code>
...
default  172.23.118.212    UGScg  en0
...
<pre><code>
default   fe80:ff05:d9ae:df93:ccd2%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {233.249.246.251, 175.197.234.95}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr c4:7a:89:ad:99:f6
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr e7:a6:fd:bf:0c:34
}</code></pre>
