...
subtitle: "Swag?"
layout: research
ip_v4_address: "138.166.203.202"
date: 2023-10-06T17:10:31+01:00
draft: false
---

## Internet Addressing
On the Internet you might get a Public IPv4 address like ```138.166.203.202``` or an IPv6 address like ```2000:6275:de55:ff40:f1ae:e5a4:aaef:a9b6```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```e6:64:05:47:3b:ce```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://stark-bosco.name you initially access a DNS server to translate the host portion (stark-bosco) combined with the Top Level Domain (name) of the URL, to an IP address like ```14.232.245.136```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows; U; Win 9x 4.90; SG; rv:1.9.2.4) Gecko/20101104 Netscape/9.1.0285```

## Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```10.182.176.241``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  10.182.176.241    UGScg  en0
...
<pre>
default   fe80:c9e3:ef07:c1ab:4e66%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {88.224.166.67, 8.176.158.59}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr e6:64:05:47:3b:ce
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr dc:fa:f2:15:ee:dc
}</pre>
