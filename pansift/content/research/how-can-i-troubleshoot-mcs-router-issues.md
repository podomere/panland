...
layout: research
ip_v4_address: "232.234.236.251"
date: 2022-05-05T14:28:32+01:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like ```232.234.236.251``` or an IPv6 address like ```2000:a896:e9d9:1587:9902:458f:29f6:d021```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```70:35:0e:d8:9f:6c```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://welch-morar.co you initially access a DNS server to translate the host portion (welch-morar) combined with the Top Level Domain (co) of the URL, to an IP address like ```140.18.78.151```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows; U; Win 9x 4.90; SG; rv:1.9.2.4) Gecko/20101104 Netscape/9.1.0285```
...
<pre>
default   fe80:9941:2b3d:63cb:821d%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {196.170.118.216, 3.75.143.134}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 70:35:0e:d8:9f:6c
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 44:cb:88:f1:17:e7
}</pre>
