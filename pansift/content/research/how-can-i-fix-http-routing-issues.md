...
layout: research
ip_v4_address: "231.129.7.198"
date: 2022-06-12T14:09:28+01:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like ```231.129.7.198``` or an IPv6 address like ```2000:801a:d32a:2be8:aa2c:9a2b:c0f8:3100```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```b3:65:cd:23:54:76```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://hessel.co you initially access a DNS server to translate the host portion (hessel) combined with the Top Level Domain (co) of the URL, to an IP address like ```6.61.75.188```. Your computer and browser actually sends its type with all web requests e.g. <br>```Opera/9.80 (X11; Linux i686; Ubuntu/14.10) Presto/2.12.388 Version/12.16```
...
<pre>
default   fe80:2bc9:3609:9347:3fed%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {202.74.194.60, 210.23.223.60}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr b3:65:cd:23:54:76
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 51:0b:c1:dc:f9:34
}</pre>
