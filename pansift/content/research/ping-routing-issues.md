...
subtitle: "Ideate?"
layout: research
ip_v4_address: "32.51.127.142"
date: 2023-10-06T17:11:06+01:00
draft: false
---

## Internet Addressing
On the Internet you might have a Public IPv4 address like ```32.51.127.142``` or an IPv6 address like ```2000:80dc:6bf5:f7d2:f57f:5132:af3a:314d```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```60:ba:cd:54:0b:93```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://halvorson-kulas.info you initially access a DNS server to translate the host portion (halvorson-kulas) combined with the Top Level Domain (info) of the URL, to an IP address like ```17.98.9.55```. Your computer and browser actually sends its type with all web requests e.g. <br>```Opera/9.80 (X11; Linux i686; Ubuntu/14.10) Presto/2.12.388 Version/12.16```
...
<pre>
default   fe80:d809:a26:f5fa:7d05%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {242.151.122.29, 65.190.206.208}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 60:ba:cd:54:0b:93
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr b8:18:bc:3f:32:19
}</pre>
