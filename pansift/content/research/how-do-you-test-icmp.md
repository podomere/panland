...
layout: research
ip_v4_address: "65.209.74.16"
date: 2022-12-15T13:50:19+00:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like ```65.209.74.16``` or an IPv6 address like ```2000:4332:f3d0:de:bc09:2b57:92b2:14ec```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```42:b0:8c:57:f4:f3```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://okuneva-cole.io you initially access a DNS server to translate the host portion (okuneva-cole) combined with the Top Level Domain (io) of the URL, to an IP address like ```202.188.28.137```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/41.0.2228.0 Safari/537.36```
...
<pre>
default   fe80:a804:dbeb:41b0:e13a%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {153.46.142.98, 81.65.140.79}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 42:b0:8c:57:f4:f3
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 3c:de:5b:c4:81:d4
}</pre>
