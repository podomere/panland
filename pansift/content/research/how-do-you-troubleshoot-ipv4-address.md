...
layout: research
ip_v4_address: "175.14.114.241"
date: 2022-06-04T14:38:38+01:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like ```175.14.114.241``` or an IPv6 address like ```2000:cfc0:fd32:3d5b:1650:a2cd:cc9f:7683```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```c5:78:6b:d3:f1:31```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://jast.io you initially access a DNS server to translate the host portion (jast) combined with the Top Level Domain (io) of the URL, to an IP address like ```70.203.166.161```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows; U; Win 9x 4.90; SG; rv:1.9.2.4) Gecko/20101104 Netscape/9.1.0285```

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```172.16.9.149``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  172.16.9.149    UGScg  en0
...
<pre>
default   fe80:45e8:ef6d:5dbe:1ee1%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {191.158.58.53, 85.136.211.185}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr c5:78:6b:d3:f1:31
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 78:ce:3f:eb:0e:f8
}</pre>
