...
layout: research
ip_v4_address: "11.143.229.177"
date: 2022-05-05T14:29:36+01:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like ```11.143.229.177``` or an IPv6 address like ```2000:c314:3d60:63f7:cdd7:61e9:a1fd:c70d```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```68:41:0a:71:24:84```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://watsica-quigley.com you initially access a DNS server to translate the host portion (watsica-quigley) combined with the Top Level Domain (com) of the URL, to an IP address like ```6.138.172.171```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (compatible; MSIE 9.0; AOL 9.7; AOLBuild 4343.19; Windows NT 6.1; WOW64; Trident/5.0; FunWebProducts)```
...
<pre>
default   fe80:3be4:ac42:bfaf:56d1%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {8.46.192.220, 120.115.92.51}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 68:41:0a:71:24:84
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 13:f9:fb:6d:7d:50
}</pre>
