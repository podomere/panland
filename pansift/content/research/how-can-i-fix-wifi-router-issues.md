...
layout: research
ip_v4_address: "70.23.244.21"
date: 2022-11-19T19:13:08+00:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like ```70.23.244.21``` or an IPv6 address like ```2000:99b4:5115:5cac:b311:a3ed:f934:d801```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```9b:2b:a0:59:b5:ac```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://cremin-hickle.biz you initially access a DNS server to translate the host portion (cremin-hickle) combined with the Top Level Domain (biz) of the URL, to an IP address like ```65.55.84.11```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows; U; Win 9x 4.90; SG; rv:1.9.2.4) Gecko/20101104 Netscape/9.1.0285```
...
<pre>
default   fe80:7e07:7292:7614:173a%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {241.250.145.101, 124.235.170.202}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 9b:2b:a0:59:b5:ac
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 56:5e:65:05:76:d9
}</pre>
