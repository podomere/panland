...
layout: research
ip_v4_address: "171.135.103.189"
date: 2022-04-24T18:32:41+01:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like <code>171.135.103.189</code> or an IPv6 address like <code>2000:45fe:5a7e:b2f0:8ee2:e2a0:bac3:eefd</code>. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>14:23:7f:5c:81:07</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://tillman-haley.com you initially access a DNS server to translate the host portion (tillman-haley) combined with the Top Level Domain (com) of the URL, to an IP address like <code>168.50.156.90</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (Windows; U; Win 9x 4.90; SG; rv:1.9.2.4) Gecko/20101104 Netscape/9.1.0285</code>
...
<pre><code>
default   fe80:9138:fed2:3992:e833%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {91.199.90.216, 102.83.166.253}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 14:23:7f:5c:81:07
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr bb:e0:f5:6e:24:34
}</code></pre>
