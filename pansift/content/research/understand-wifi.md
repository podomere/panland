...
layout: research
ip_v4_address: "44.10.126.250"
date: 2022-12-15T13:50:03+00:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like ```44.10.126.250``` or an IPv6 address like ```2000:552d:75cf:1630:5af9:f4cf:e3b1:5964```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```68:97:9d:7a:40:a2```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).
...
<pre>
default   fe80:2fb7:ca8:98cf:c68c%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {201.23.75.226, 95.92.98.104}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 68:97:9d:7a:40:a2
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 8e:16:90:b3:6e:f5
}</pre>
