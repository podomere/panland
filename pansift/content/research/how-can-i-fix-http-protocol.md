...
subtitle: "Tee It Up?"
layout: research
ip_v4_address: "35.33.60.72"
date: 2022-06-04T14:38:43+01:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like ```35.33.60.72``` or an IPv6 address like ```2000:52e6:46cc:acc6:f0bf:a8d:34dd:52eb```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```95:dd:c6:d4:c2:78```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://weber-mclaughlin.io you initially access a DNS server to translate the host portion (weber-mclaughlin) combined with the Top Level Domain (io) of the URL, to an IP address like ```70.188.157.154```. Your computer and browser actually sends its type with all web requests e.g. <br>```Opera/9.80 (X11; Linux i686; Ubuntu/14.10) Presto/2.12.388 Version/12.16```
...
<pre>
default   fe80:c653:a6b6:c55f:c160%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {94.230.107.6, 182.240.17.188}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 95:dd:c6:d4:c2:78
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 02:f8:90:b7:b0:d2
}</pre>
