...
layout: research
ip_v4_address: "75.89.121.96"
date: 2023-02-04T17:07:48+00:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like ```75.89.121.96``` or an IPv6 address like ```2000:b927:f334:20b4:316b:b576:243f:16c3```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```6d:b1:c7:3e:4a:aa```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://barton-boyer.name you initially access a DNS server to translate the host portion (barton-boyer) combined with the Top Level Domain (name) of the URL, to an IP address like ```35.53.63.93```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (compatible; MSIE 9.0; AOL 9.7; AOLBuild 4343.19; Windows NT 6.1; WOW64; Trident/5.0; FunWebProducts)```
...
<pre>
default   fe80:3f70:7e68:ab47:10a2%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {136.57.7.21, 51.38.192.235}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 6d:b1:c7:3e:4a:aa
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 8c:4d:88:1a:56:34
}</pre>
