...
subtitle: "Granular?"
layout: research
ip_v4_address: "243.111.188.29"
date: 2022-04-24T18:32:42+01:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like <code>243.111.188.29</code> or an IPv6 address like <code>2000:34cd:7dea:e729:a745:abda:4ede:2d11</code>. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>df:39:d2:7f:c1:e5</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://hintz-hyatt.com you initially access a DNS server to translate the host portion (hintz-hyatt) combined with the Top Level Domain (com) of the URL, to an IP address like <code>37.78.163.19</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (Windows NT x.y; Win64; x64; rv:10.0) Gecko/20100101 Firefox/10.0</code>
...
<pre><code>
default   fe80:4abc:2f1c:599f:371c%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {255.180.16.182, 196.131.105.86}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr df:39:d2:7f:c1:e5
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 19:36:98:04:f2:7a
}</code></pre>
