...
layout: research
ip_v4_address: "22.92.75.22"
date: 2022-05-05T14:28:55+01:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like ```22.92.75.22``` or an IPv6 address like ```2000:95b2:296b:541:5a30:fe49:802d:9534```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```a6:60:75:f8:78:9d```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://johns-harvey.org you initially access a DNS server to translate the host portion (johns-harvey) combined with the Top Level Domain (org) of the URL, to an IP address like ```33.247.169.43```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows; U; Win 9x 4.90; SG; rv:1.9.2.4) Gecko/20101104 Netscape/9.1.0285```

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```10.14.115.74``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  10.14.115.74    UGScg  en0
...
<pre>
default   fe80:9466:4f13:fcdb:338a%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {28.44.201.86, 175.169.89.116}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr a6:60:75:f8:78:9d
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 82:b3:f4:3b:ec:e7
}</pre>
