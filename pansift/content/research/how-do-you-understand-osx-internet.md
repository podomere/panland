...
subtitle: "Deep Dive?"
layout: research
ip_v4_address: "254.240.240.215"
date: 2023-10-06T17:10:42+01:00
draft: false
---

## Internet Addressing
On the Internet you might have a Public IPv4 address like ```254.240.240.215``` or an IPv6 address like ```2000:7d93:4da0:5855:b74b:7cc0:3ca3:cc0```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```1a:84:bd:f9:cf:c1```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://marks-dicki.name you initially access a DNS server to translate the host portion (marks-dicki) combined with the Top Level Domain (name) of the URL, to an IP address like ```213.104.2.36```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT x.y; Win64; x64; rv:10.0) Gecko/20100101 Firefox/10.0```
...
<pre>
default   fe80:d066:de39:ec57:62fe%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {182.186.132.185, 135.245.116.122}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 1a:84:bd:f9:cf:c1
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 86:50:68:52:8e:32
}</pre>
...
### Apple macOS / OSX
No matter what version of OSX/macOS you are on, ```10.12.9```, ```11.2.7```, or ```12.1.9```, there are a range of tools for troubleshooting. Unfortunately, between these manual actions and scripts, they don't give you a series of correlated values over time. This is where automated remote troubleshooting comes in to its own, especially for teams that embrace remote work and Work From Anywhere (WFA).
