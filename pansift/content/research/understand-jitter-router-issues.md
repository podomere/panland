...
layout: research
ip_v4_address: "136.144.205.242"
date: 2023-02-04T17:08:37+00:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like ```136.144.205.242``` or an IPv6 address like ```2000:e50f:9323:cdcb:ef98:6c44:1c5b:39cd```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```e4:c6:4a:45:cc:1c```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://klocko-bogan.net you initially access a DNS server to translate the host portion (klocko-bogan) combined with the Top Level Domain (net) of the URL, to an IP address like ```160.72.101.16```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1; WOW64; Trident/7.0; AS; rv:11.0) like Gecko```
...
<pre>
default   fe80:397b:9f85:4950:3aa5%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {50.114.19.5, 107.3.72.206}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr e4:c6:4a:45:cc:1c
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 7d:3a:20:da:01:e3
}</pre>
