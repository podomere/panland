...
subtitle: "Value Add?"
layout: research
ip_v4_address: "122.130.187.110"
date: 2022-11-19T16:17:20+00:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like ```122.130.187.110``` or an IPv6 address like ```2000:c368:624b:80db:dee5:7566:4d99:3bfe```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```a2:bb:c1:ed:ef:9a```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://predovic-gulgowski.info you initially access a DNS server to translate the host portion (predovic-gulgowski) combined with the Top Level Domain (info) of the URL, to an IP address like ```208.230.19.38```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (compatible; MSIE 9.0; AOL 9.7; AOLBuild 4343.19; Windows NT 6.1; WOW64; Trident/5.0; FunWebProducts)```
...
default  192.168.138.107    UGScg  en0
...
<pre>
default   fe80:e340:f6f0:75ed:3d57%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {17.218.204.119, 190.83.66.215}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr a2:bb:c1:ed:ef:9a
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 3f:53:bc:cd:bd:1a
}</pre>
