...
layout: research
ip_v4_address: "148.236.155.12"
date: 2022-06-04T14:38:17+01:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like ```148.236.155.12``` or an IPv6 address like ```2000:99fe:aa00:386d:98b3:3bf7:bb6d:8273```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```e1:15:29:06:11:38```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://auer.io you initially access a DNS server to translate the host portion (auer) combined with the Top Level Domain (io) of the URL, to an IP address like ```204.223.193.6```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1; WOW64; Trident/7.0; AS; rv:11.0) like Gecko```
...
<pre>
default   fe80:2896:73e2:9b4f:729b%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {133.66.230.102, 54.139.67.127}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr e1:15:29:06:11:38
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 07:06:ce:97:86:65
}</pre>
