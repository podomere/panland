...
subtitle: "Deep Dive?"
layout: research
ip_v4_address: "46.109.77.88"
date: 2022-04-24T18:31:58+01:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like <code>46.109.77.88</code> or an IPv6 address like <code>2000:6ace:a3c9:c27c:95b6:b219:57b1:e549</code>. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>5f:df:59:61:b4:d8</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://littel-mitchell.net you initially access a DNS server to translate the host portion (littel-mitchell) combined with the Top Level Domain (net) of the URL, to an IP address like <code>160.212.10.176</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (compatible; MSIE 9.0; AOL 9.7; AOLBuild 4343.19; Windows NT 6.1; WOW64; Trident/5.0; FunWebProducts)</code>

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like <code>192.168.153.89</code> (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For <code>IPv6</code> we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  192.168.153.89    UGScg  en0
...
<pre><code>
default   fe80:41b8:7a4c:61c5:dc3a%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {73.138.75.174, 202.253.160.229}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 5f:df:59:61:b4:d8
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 0e:0d:25:eb:56:fc
}</code></pre>
