---
title: "How Can I Troubleshoot Jitter Router Issues"
subtitle: "Sales Funnel?"
layout: research
ip_v4_address: "148.87.152.159"
date: 2023-10-06T17:11:05+01:00
draft: false
---

## Internet Addressing
On the Internet you may have a Public IPv4 address like ```148.87.152.159``` or an IPv6 address like ```2000:3e56:1004:6670:9bb3:e2cf:79c6:e473```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```73:ba:c6:06:42:e2```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://thompson.org you initially access a DNS server to translate the host portion (thompson) combined with the Top Level Domain (org) of the URL, to an IP address like ```15.177.218.13```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (compatible; MSIE 9.0; AOL 9.7; AOLBuild 4343.19; Windows NT 6.1; WOW64; Trident/5.0; FunWebProducts)```

## Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```10.4.40.212``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
<pre>
default   fe80:76f4:c72c:b1e4:1b1e%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {199.216.53.178, 99.149.74.176}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 73:ba:c6:06:42:e2
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 93:75:3e:15:49:0e
}</pre>
...
### Apple macOS / OSX
No matter what version of OSX/macOS you are on, ```10.12.8```, ```11.6.1```, or ```12.1.5```, there are a range of tools for troubleshooting. Unfortunately, between these manual actions and scripts, they don't give you a series of correlated values over time. This is where automated remote troubleshooting comes in to its own, especially for teams that embrace remote work and Work From Anywhere (WFA).
