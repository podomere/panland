...
subtitle: "Ideate?"
layout: research
ip_v4_address: "246.141.93.217"
date: 2023-02-04T16:26:20+00:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like ```246.141.93.217``` or an IPv6 address like ```2000:290c:9942:8c40:d259:9ac9:da3d:b3b5```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```b7:14:da:b0:c6:d9```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://kemmer-balistreri.org you initially access a DNS server to translate the host portion (kemmer-balistreri) combined with the Top Level Domain (org) of the URL, to an IP address like ```245.115.183.143```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/41.0.2228.0 Safari/537.36```

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```192.168.81.39``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  192.168.81.39    UGScg  en0
...
<pre>
default   fe80:44c9:9a0e:913d:a525%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {5.140.232.182, 100.173.29.152}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr b7:14:da:b0:c6:d9
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 9c:e3:0e:39:00:5c
}</pre>
