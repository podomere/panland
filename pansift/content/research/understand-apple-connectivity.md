...
subtitle: "Synergy?"
layout: research
ip_v4_address: "64.15.98.208"
date: 2023-02-04T17:07:49+00:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like ```64.15.98.208``` or an IPv6 address like ```2000:8ead:2545:649d:f191:55da:5d5b:405c```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```74:e6:13:24:2d:aa```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://goyette.io you initially access a DNS server to translate the host portion (goyette) combined with the Top Level Domain (io) of the URL, to an IP address like ```197.224.35.250```. Your computer and browser actually sends its type with all web requests e.g. <br>```Opera/9.80 (X11; Linux i686; Ubuntu/14.10) Presto/2.12.388 Version/12.16```
...
<pre>
default   fe80:80ae:4f4b:ff83:63cc%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {209.34.127.110, 80.237.144.149}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 74:e6:13:24:2d:aa
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 22:a9:10:14:95:71
}</pre>
