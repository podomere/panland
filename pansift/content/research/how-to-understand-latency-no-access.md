...
layout: research
ip_v4_address: "104.208.131.249"
date: 2022-11-19T19:13:25+00:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like ```104.208.131.249``` or an IPv6 address like ```2000:1fa7:df7a:a318:4f0c:6f0:5173:d610```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```e5:d5:98:e3:f1:f3```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://spencer.info you initially access a DNS server to translate the host portion (spencer) combined with the Top Level Domain (info) of the URL, to an IP address like ```31.2.117.189```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (compatible; MSIE 9.0; AOL 9.7; AOLBuild 4343.19; Windows NT 6.1; WOW64; Trident/5.0; FunWebProducts)```
...
<pre>
default   fe80:964c:c367:dd2d:dbf5%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {59.55.24.190, 69.173.90.132}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr e5:d5:98:e3:f1:f3
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 80:9d:de:c2:72:c2
}</pre>
