...
layout: research
ip_v4_address: "90.127.123.190"
date: 2022-12-15T13:50:17+00:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like ```90.127.123.190``` or an IPv6 address like ```2000:cced:6f57:3b8b:95f7:875c:a24d:e3cf```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```0c:c4:ca:11:50:74```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://fahey.co you initially access a DNS server to translate the host portion (fahey) combined with the Top Level Domain (co) of the URL, to an IP address like ```231.216.176.232```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows; U; Win 9x 4.90; SG; rv:1.9.2.4) Gecko/20101104 Netscape/9.1.0285```
...
<pre>
default   fe80:28b6:5490:745f:a950%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {61.211.54.107, 66.96.82.248}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 0c:c4:ca:11:50:74
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr f6:0f:52:23:c6:b6
}</pre>
