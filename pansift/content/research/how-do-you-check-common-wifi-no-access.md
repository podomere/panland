...
layout: research
ip_v4_address: "88.38.147.155"
date: 2022-04-24T18:32:42+01:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like <code>88.38.147.155</code> or an IPv6 address like <code>2000:ffe0:897f:aac1:77b6:3ab0:58cd:3255</code>. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>51:87:e2:db:4e:7c</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://mann-brekke.co you initially access a DNS server to translate the host portion (mann-brekke) combined with the Top Level Domain (co) of the URL, to an IP address like <code>155.249.165.197</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_3) AppleWebKit/537.75.14 (KHTML, like Gecko) Version/7.0.3 Safari/7046A194A</code>
...
<pre><code>
default   fe80:9c3e:bf1c:ce5e:5bfe%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {58.223.228.23, 192.99.248.164}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 51:87:e2:db:4e:7c
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 8d:59:32:da:8c:58
}</code></pre>
