...
subtitle: "Branding?"
layout: research
ip_v4_address: "194.112.99.33"
date: 2023-02-04T16:26:04+00:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like ```194.112.99.33``` or an IPv6 address like ```2000:4641:f692:4565:796a:e4f7:47eb:1270```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```1e:9e:3c:73:26:28```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://pagac-prosacco.net you initially access a DNS server to translate the host portion (pagac-prosacco) combined with the Top Level Domain (net) of the URL, to an IP address like ```155.11.49.178```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows; U; Win 9x 4.90; SG; rv:1.9.2.4) Gecko/20101104 Netscape/9.1.0285```
...
<pre>
default   fe80:f457:4aa4:501b:70fb%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {36.216.183.175, 32.216.214.240}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 1e:9e:3c:73:26:28
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr ec:09:f3:b2:17:42
}</pre>
