...
layout: research
ip_v4_address: "123.5.141.185"
date: 2022-06-12T14:09:27+01:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like ```123.5.141.185``` or an IPv6 address like ```2000:2758:7feb:a2a5:f34e:c2e7:1eaa:2c42```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```ce:06:fc:c5:ce:0a```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://spinka.biz you initially access a DNS server to translate the host portion (spinka) combined with the Top Level Domain (biz) of the URL, to an IP address like ```147.29.143.211```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1; WOW64; Trident/7.0; AS; rv:11.0) like Gecko```

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```192.168.20.6``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  192.168.20.6    UGScg  en0
...
<pre>
default   fe80:72a6:57e3:8ce4:a78%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {186.170.57.124, 98.46.18.79}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr ce:06:fc:c5:ce:0a
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr ce:98:30:ce:ca:7a
}</pre>
