...
layout: research
ip_v4_address: "166.243.185.83"
date: 2023-10-06T17:11:04+01:00
draft: false
---

## Internet Addressing
On the Internet you might get a Public IPv4 address like ```166.243.185.83``` or an IPv6 address like ```2000:ae21:ab4:a61c:5f24:16ef:986d:98da```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```08:e1:85:e0:4f:2f```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://ferry-vonrueden.io you initially access a DNS server to translate the host portion (ferry-vonrueden) combined with the Top Level Domain (io) of the URL, to an IP address like ```193.99.1.77```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_3) AppleWebKit/537.75.14 (KHTML, like Gecko) Version/7.0.3 Safari/7046A194A```
...
<pre>
default   fe80:702e:70ec:5a5b:cc32%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {57.43.252.7, 21.157.131.161}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 08:e1:85:e0:4f:2f
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr d4:78:5e:bf:fb:9b
}</pre>
