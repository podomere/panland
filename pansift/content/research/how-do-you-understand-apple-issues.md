...
layout: research
ip_v4_address: "243.129.137.11"
date: 2022-11-19T16:17:13+00:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like ```243.129.137.11``` or an IPv6 address like ```2000:9490:c37b:be5c:df3d:d562:68b:d506```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```2e:e2:6b:ca:cd:45```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://graham-schaden.io you initially access a DNS server to translate the host portion (graham-schaden) combined with the Top Level Domain (io) of the URL, to an IP address like ```249.156.41.237```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT x.y; Win64; x64; rv:10.0) Gecko/20100101 Firefox/10.0```
...
<pre>
default   fe80:d3e3:611:e29:2f9f%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {76.237.184.44, 220.183.208.145}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 2e:e2:6b:ca:cd:45
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 6c:2c:b3:a7:95:4c
}</pre>
