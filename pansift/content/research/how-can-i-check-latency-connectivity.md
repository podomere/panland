...
layout: research
ip_v4_address: "194.236.215.93"
date: 2022-11-19T19:13:25+00:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like ```194.236.215.93``` or an IPv6 address like ```2000:d8b3:2d18:dab4:4c35:d296:94c2:2046```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```c5:05:cd:a9:d5:6c```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://swaniawski.io you initially access a DNS server to translate the host portion (swaniawski) combined with the Top Level Domain (io) of the URL, to an IP address like ```108.101.215.177```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/41.0.2228.0 Safari/537.36```
...
<pre>
default   fe80:4f0d:3170:a003:7a22%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {73.29.47.22, 133.21.136.58}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr c5:05:cd:a9:d5:6c
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr f9:53:7d:97:e4:db
}</pre>
