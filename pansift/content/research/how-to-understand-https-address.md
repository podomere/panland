...
layout: research
ip_v4_address: "66.200.0.242"
date: 2022-11-19T19:13:29+00:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like ```66.200.0.242``` or an IPv6 address like ```2000:900f:c88a:d73c:4979:67ae:2437:aab9```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```2f:60:f2:51:9b:c4```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://koch-kerluke.net you initially access a DNS server to translate the host portion (koch-kerluke) combined with the Top Level Domain (net) of the URL, to an IP address like ```122.81.131.224```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1; WOW64; Trident/7.0; AS; rv:11.0) like Gecko```
...
<pre>
default   fe80:e4a8:3222:c344:d96f%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {35.197.154.83, 172.81.87.248}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 2f:60:f2:51:9b:c4
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr a0:71:aa:1a:59:fd
}</pre>
