...
layout: research
ip_v4_address: "164.193.89.150"
date: 2023-10-06T17:11:03+01:00
draft: false
---

## Internet Addressing
On the Internet you may get a Public IPv4 address like ```164.193.89.150``` or an IPv6 address like ```2000:4937:bed4:505:e552:71d4:cfce:9573```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```e1:a3:df:76:e3:8a```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://buckridge-williamson.name you initially access a DNS server to translate the host portion (buckridge-williamson) combined with the Top Level Domain (name) of the URL, to an IP address like ```85.36.213.254```. Your computer and browser actually sends its type with all web requests e.g. <br>```Opera/9.80 (X11; Linux i686; Ubuntu/14.10) Presto/2.12.388 Version/12.16```
...
<pre>
default   fe80:3736:8e33:fe18:9d6f%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {119.38.55.119, 15.2.29.221}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr e1:a3:df:76:e3:8a
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 48:76:6b:ab:1a:2f
}</pre>
