...
layout: research
ip_v4_address: "62.4.199.240"
date: 2022-04-24T18:32:42+01:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like <code>62.4.199.240</code> or an IPv6 address like <code>2000:8999:1a99:946c:40e8:84a0:eed3:749d</code>. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>00:5b:a0:78:5f:60</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://hamill.io you initially access a DNS server to translate the host portion (hamill) combined with the Top Level Domain (io) of the URL, to an IP address like <code>20.86.124.143</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Opera/9.80 (X11; Linux i686; Ubuntu/14.10) Presto/2.12.388 Version/12.16</code>

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like <code>172.22.135.17</code> (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For <code>IPv6</code> we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  172.22.135.17    UGScg  en0
...
<pre><code>
default   fe80:530e:df78:f674:3cb9%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {85.147.62.81, 61.29.59.50}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 00:5b:a0:78:5f:60
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr d6:df:99:5b:b1:0e
}</code></pre>
