...
layout: research
ip_v4_address: "192.12.216.205"
date: 2022-12-15T13:50:17+00:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like ```192.12.216.205``` or an IPv6 address like ```2000:46d:9cf8:a814:53bf:626c:96e6:53e2```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```68:99:06:75:83:e5```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://kulas-keebler.info you initially access a DNS server to translate the host portion (kulas-keebler) combined with the Top Level Domain (info) of the URL, to an IP address like ```18.26.50.188```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (compatible; MSIE 9.0; AOL 9.7; AOLBuild 4343.19; Windows NT 6.1; WOW64; Trident/5.0; FunWebProducts)```
...
<pre>
default   fe80:de9e:4360:518:d8dc%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {77.110.7.226, 28.48.132.57}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 68:99:06:75:83:e5
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 91:31:5f:de:0d:bb
}</pre>
