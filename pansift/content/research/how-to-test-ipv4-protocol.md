...
subtitle: "Learnings?"
layout: research
ip_v4_address: "119.122.121.6"
date: 2022-04-24T18:59:56+01:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like <code>119.122.121.6</code> or an IPv6 address like <code>2000:dce8:4238:e930:292c:5d97:f9b3:3713</code>. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>1b:3d:f7:8f:ed:73</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://stoltenberg-prosacco.biz you initially access a DNS server to translate the host portion (stoltenberg-prosacco) combined with the Top Level Domain (biz) of the URL, to an IP address like <code>108.183.132.136</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (Windows NT 6.1; WOW64; Trident/7.0; AS; rv:11.0) like Gecko</code>
...
<pre><code>
default   fe80:d7a5:3423:53c:ba96%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {137.67.177.104, 37.211.183.209}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 1b:3d:f7:8f:ed:73
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 1a:a5:bd:ee:02:7a
}</code></pre>
