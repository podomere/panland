...
subtitle: "Swag?"
layout: research
ip_v4_address: "163.87.34.229"
date: 2023-10-29T15:13:30+00:00
draft: false
---

## Internet Addressing
On the Internet you may have a Public IPv4 address like ```163.87.34.229``` or an IPv6 address like ```2000:23bf:9d8e:808d:d465:5a54:a4cd:38ad```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```d1:f7:27:8b:b6:dd```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://gottlieb-durgan.org you initially access a DNS server to translate the host portion (gottlieb-durgan) combined with the Top Level Domain (org) of the URL, to an IP address like ```137.224.91.150```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_3) AppleWebKit/537.75.14 (KHTML, like Gecko) Version/7.0.3 Safari/7046A194A```
...
<pre>
default   fe80:2cd9:508d:e788:acce%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {184.87.222.208, 129.142.85.248}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr d1:f7:27:8b:b6:dd
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 19:3a:91:02:8f:70
}</pre>
