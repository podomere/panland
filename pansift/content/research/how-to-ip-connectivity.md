...
layout: research
ip_v4_address: "50.168.167.103"
date: 2022-05-05T13:59:46+01:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like ```50.168.167.103``` or an IPv6 address like ```2000:24ae:20e1:9999:d1ba:b016:93d8:e34e```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```cb:cf:bd:a0:4f:a7```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://streich-bode.net you initially access a DNS server to translate the host portion (streich-bode) combined with the Top Level Domain (net) of the URL, to an IP address like ```227.88.147.216```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_3) AppleWebKit/537.75.14 (KHTML, like Gecko) Version/7.0.3 Safari/7046A194A```
...
<pre>
default   fe80:33b5:654a:7dd3:3f28%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {93.150.194.238, 32.153.220.141}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr cb:cf:bd:a0:4f:a7
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 2f:f0:36:5b:d1:08
}</pre>
