...
subtitle: "Swag?"
layout: research
ip_v4_address: "30.170.201.188"
date: 2023-10-06T17:11:05+01:00
draft: false
---

## Internet Addressing
On the Internet you might have a Public IPv4 address like ```30.170.201.188``` or an IPv6 address like ```2000:d465:98da:658b:8a4:4440:62b0:9489```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```c1:d8:c1:58:e3:eb```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://reichel-weimann.info you initially access a DNS server to translate the host portion (reichel-weimann) combined with the Top Level Domain (info) of the URL, to an IP address like ```35.129.113.213```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (compatible; MSIE 9.0; AOL 9.7; AOLBuild 4343.19; Windows NT 6.1; WOW64; Trident/5.0; FunWebProducts)```
...
<pre>
default   fe80:3a25:3161:aafc:9342%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {7.249.214.68, 229.124.197.151}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr c1:d8:c1:58:e3:eb
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 99:11:3c:09:ff:99
}</pre>
