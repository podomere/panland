...
layout: research
ip_v4_address: "209.72.12.155"
date: 2022-04-24T19:00:01+01:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like <code>209.72.12.155</code> or an IPv6 address like <code>2000:c57e:a720:a5f1:73d2:6d76:dd26:beb1</code>. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>1c:21:bc:f9:0a:c2</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://kutch-west.com you initially access a DNS server to translate the host portion (kutch-west) combined with the Top Level Domain (com) of the URL, to an IP address like <code>210.182.199.145</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (Windows; U; Win 9x 4.90; SG; rv:1.9.2.4) Gecko/20101104 Netscape/9.1.0285</code>
...
<pre><code>
default   fe80:5add:c730:8d3c:3ae2%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {25.134.125.23, 213.241.100.43}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 1c:21:bc:f9:0a:c2
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr b6:4a:ee:c5:3d:66
}</code></pre>
