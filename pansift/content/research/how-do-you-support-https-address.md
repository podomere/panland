...
subtitle: "Heads Down?"
layout: research
ip_v4_address: "207.25.26.180"
date: 2022-12-15T13:50:22+00:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like ```207.25.26.180``` or an IPv6 address like ```2000:72fe:7598:3ab3:6a6e:1ec3:5083:cd9b```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```40:9a:c0:89:74:d6```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://schumm.com you initially access a DNS server to translate the host portion (schumm) combined with the Top Level Domain (com) of the URL, to an IP address like ```101.55.55.78```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1; WOW64; Trident/7.0; AS; rv:11.0) like Gecko```
...
<pre>
default   fe80:370c:7edf:5a17:ac3a%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {203.76.175.73, 145.12.250.163}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 40:9a:c0:89:74:d6
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 4b:3d:5b:79:87:06
}</pre>
