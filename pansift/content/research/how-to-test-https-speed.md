...
layout: research
ip_v4_address: "25.237.118.241"
date: 2023-02-04T16:26:23+00:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like ```25.237.118.241``` or an IPv6 address like ```2000:6c22:2417:651:a0cb:2240:dded:dd82```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```5b:78:44:cf:02:39```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://sanford-beatty.net you initially access a DNS server to translate the host portion (sanford-beatty) combined with the Top Level Domain (net) of the URL, to an IP address like ```1.222.52.213```. Your computer and browser actually sends its type with all web requests e.g. <br>```Opera/9.80 (X11; Linux i686; Ubuntu/14.10) Presto/2.12.388 Version/12.16```
...
<pre>
default   fe80:48f:900f:d4b5:9b2f%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {88.229.231.221, 54.169.71.64}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 5b:78:44:cf:02:39
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 3e:0b:42:43:c9:2c
}</pre>
