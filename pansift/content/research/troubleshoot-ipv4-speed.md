...
layout: research
ip_v4_address: "5.186.43.150"
date: 2022-04-24T18:59:56+01:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like <code>5.186.43.150</code> or an IPv6 address like <code>2000:b552:88cc:1d4c:2b27:7847:ea65:e3bc</code>. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>08:a7:4a:10:b3:df</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://kessler.org you initially access a DNS server to translate the host portion (kessler) combined with the Top Level Domain (org) of the URL, to an IP address like <code>66.236.153.141</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (Windows NT x.y; Win64; x64; rv:10.0) Gecko/20100101 Firefox/10.0</code>
...
<pre><code>
default   fe80:7f63:292a:5536:b1f%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {107.100.55.221, 23.131.141.179}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 08:a7:4a:10:b3:df
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 7d:53:b4:10:f8:36
}</code></pre>
