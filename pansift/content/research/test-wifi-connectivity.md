...
layout: research
ip_v4_address: "121.115.251.39"
date: 2022-11-19T19:13:08+00:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like ```121.115.251.39``` or an IPv6 address like ```2000:fe2f:27b:5cf9:aae5:ffd3:3c47:87b0```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```b2:73:6a:99:2d:d9```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://rolfson.name you initially access a DNS server to translate the host portion (rolfson) combined with the Top Level Domain (name) of the URL, to an IP address like ```14.78.42.14```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows; U; Win 9x 4.90; SG; rv:1.9.2.4) Gecko/20101104 Netscape/9.1.0285```

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```10.57.42.254``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  10.57.42.254    UGScg  en0
...
<pre>
default   fe80:b902:3897:f5be:6425%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {121.144.111.104, 170.191.197.9}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr b2:73:6a:99:2d:d9
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 6a:05:c2:13:73:ce
}</pre>
