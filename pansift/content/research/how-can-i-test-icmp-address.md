...
subtitle: "Impact Map?"
layout: research
ip_v4_address: "162.248.96.191"
date: 2022-11-02T11:32:58+00:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like ```162.248.96.191``` or an IPv6 address like ```2000:6add:9274:9ebc:7dec:d7d3:c752:dc1a```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```d8:d5:15:c2:f5:b7```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://cronin.com you initially access a DNS server to translate the host portion (cronin) combined with the Top Level Domain (com) of the URL, to an IP address like ```153.133.99.39```. Your computer and browser actually sends its type with all web requests e.g. <br>```Opera/9.80 (X11; Linux i686; Ubuntu/14.10) Presto/2.12.388 Version/12.16```

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```172.25.33.57``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  172.25.33.57    UGScg  en0
...
<pre>
default   fe80:c7aa:6697:a032:85dd%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {105.136.197.134, 203.120.214.73}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr d8:d5:15:c2:f5:b7
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr a9:60:cf:94:38:a9
}</pre>
