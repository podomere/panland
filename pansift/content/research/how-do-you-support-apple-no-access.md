...
layout: research
ip_v4_address: "48.231.121.254"
date: 2023-10-29T15:13:19+00:00
draft: false
---

## Internet Addressing
On the Internet you may have a Public IPv4 address like ```48.231.121.254``` or an IPv6 address like ```2000:14f9:6f38:f3ee:7d9e:ce8b:a6f0:6923```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```aa:82:3d:ff:02:20```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://pollich.net you initially access a DNS server to translate the host portion (pollich) combined with the Top Level Domain (net) of the URL, to an IP address like ```218.154.95.111```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (compatible; MSIE 9.0; AOL 9.7; AOLBuild 4343.19; Windows NT 6.1; WOW64; Trident/5.0; FunWebProducts)```
...
<pre>
default   fe80:1559:9b8f:b495:80c2%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {96.35.8.99, 180.138.82.188}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr aa:82:3d:ff:02:20
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr fa:c2:6a:6f:cd:68
}</pre>
...
### Apple macOS / OSX
No matter what version of OSX/macOS you are on, ```10.15.3```, ```11.4.8```, or ```12.3.3```, there are a range of tools for troubleshooting. Unfortunately, between these manual actions and scripts, they don't give you a series of correlated values over time. This is where automated remote troubleshooting comes in to its own, especially for teams that embrace remote work and Work From Anywhere (WFA).
