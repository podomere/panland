...
subtitle: "Swag?"
layout: research
ip_v4_address: "169.180.202.204"
date: 2023-02-04T16:26:23+00:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like ```169.180.202.204``` or an IPv6 address like ```2000:e61a:9292:a84f:7b34:88b7:675d:3e7```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```7f:b8:0e:8f:9b:a7```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://connelly.name you initially access a DNS server to translate the host portion (connelly) combined with the Top Level Domain (name) of the URL, to an IP address like ```38.17.127.51```. Your computer and browser actually sends its type with all web requests e.g. <br>```Opera/9.80 (X11; Linux i686; Ubuntu/14.10) Presto/2.12.388 Version/12.16```

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```192.168.135.56``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  192.168.135.56    UGScg  en0
...
<pre>
default   fe80:1d0f:ba79:b7d:4235%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {106.105.9.58, 44.153.73.236}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 7f:b8:0e:8f:9b:a7
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr e1:a1:25:a8:78:c3
}</pre>
