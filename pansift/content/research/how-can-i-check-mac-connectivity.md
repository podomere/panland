...
subtitle: "Learnings?"
layout: research
ip_v4_address: "110.50.27.93"
date: 2022-06-12T14:09:17+01:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like ```110.50.27.93``` or an IPv6 address like ```2000:dab0:95c2:7c51:6a54:bcbb:41d6:8e78```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```c8:92:8b:e5:91:8f```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://feeney-labadie.co you initially access a DNS server to translate the host portion (feeney-labadie) combined with the Top Level Domain (co) of the URL, to an IP address like ```114.184.36.21```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_3) AppleWebKit/537.75.14 (KHTML, like Gecko) Version/7.0.3 Safari/7046A194A```
...
<pre>
default   fe80:57e7:f56b:c8f3:cbc7%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {237.157.24.165, 185.182.109.235}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr c8:92:8b:e5:91:8f
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr f9:53:76:00:76:9b
}</pre>
