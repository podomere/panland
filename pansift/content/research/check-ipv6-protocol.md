...
layout: research
ip_v4_address: "2.108.198.16"
date: 2023-02-04T17:08:34+00:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like ```2.108.198.16``` or an IPv6 address like ```2000:1b12:5fcf:cb:d9b:2286:1fdc:8e80```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```26:54:76:c0:16:f4```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://okuneva-kling.info you initially access a DNS server to translate the host portion (okuneva-kling) combined with the Top Level Domain (info) of the URL, to an IP address like ```151.245.99.141```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT x.y; Win64; x64; rv:10.0) Gecko/20100101 Firefox/10.0```
...
<pre>
default   fe80:3b0c:c84a:a92:40b6%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {195.92.134.188, 41.170.42.220}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 26:54:76:c0:16:f4
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr d1:59:cd:92:2a:fe
}</pre>
