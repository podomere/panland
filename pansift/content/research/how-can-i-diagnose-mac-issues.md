...
layout: research
ip_v4_address: "37.66.80.213"
date: 2023-02-04T17:07:50+00:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like ```37.66.80.213``` or an IPv6 address like ```2000:7acf:e78e:117d:1fa4:c00c:7409:b48e```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```e7:af:41:71:d0:24```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://schinner-marks.name you initially access a DNS server to translate the host portion (schinner-marks) combined with the Top Level Domain (name) of the URL, to an IP address like ```187.91.207.82```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (compatible; MSIE 9.0; AOL 9.7; AOLBuild 4343.19; Windows NT 6.1; WOW64; Trident/5.0; FunWebProducts)```
...
<pre>
default   fe80:de5c:6644:c953:e78f%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {94.114.180.21, 145.207.82.232}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr e7:af:41:71:d0:24
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 0f:f4:80:bf:e8:bb
}</pre>
