...
subtitle: "Learnings?"
layout: research
ip_v4_address: "85.193.166.127"
date: 2022-04-24T19:00:23+01:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like <code>85.193.166.127</code> or an IPv6 address like <code>2000:f1fa:31dc:2d97:4201:821:178f:da91</code>. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>72:18:73:0c:33:6e</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://green-stroman.net you initially access a DNS server to translate the host portion (green-stroman) combined with the Top Level Domain (net) of the URL, to an IP address like <code>61.153.92.171</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (compatible; MSIE 9.0; AOL 9.7; AOLBuild 4343.19; Windows NT 6.1; WOW64; Trident/5.0; FunWebProducts)</code>
...
<pre><code>
default   fe80:e358:673f:e29a:9d74%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {17.16.241.21, 246.218.224.5}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 72:18:73:0c:33:6e
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 7d:ab:eb:67:35:eb
}</code></pre>
