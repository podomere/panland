...
layout: research
ip_v4_address: "143.149.241.137"
date: 2022-04-24T19:00:00+01:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like <code>143.149.241.137</code> or an IPv6 address like <code>2000:b8bf:cc18:651c:9cea:3203:dfc7:98</code>. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>d6:c7:78:11:ee:d2</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://smith-fay.info you initially access a DNS server to translate the host portion (smith-fay) combined with the Top Level Domain (info) of the URL, to an IP address like <code>238.195.196.170</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Opera/9.80 (X11; Linux i686; Ubuntu/14.10) Presto/2.12.388 Version/12.16</code>
...
<pre><code>
default   fe80:971b:8919:4778:c4b1%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {123.116.92.40, 234.52.179.200}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr d6:c7:78:11:ee:d2
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr a7:cf:fa:b6:cf:93
}</code></pre>
