...
layout: research
ip_v4_address: "73.68.118.95"
date: 2023-02-04T17:07:42+00:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like ```73.68.118.95``` or an IPv6 address like ```2000:7a3c:1db9:60fe:873c:df8f:c870:8397```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```a6:31:52:cc:cf:10```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://schultz-powlowski.org you initially access a DNS server to translate the host portion (schultz-powlowski) combined with the Top Level Domain (org) of the URL, to an IP address like ```43.77.32.65```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT x.y; Win64; x64; rv:10.0) Gecko/20100101 Firefox/10.0```
...
<pre>
default   fe80:ddca:734d:53c0:2807%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {77.137.142.125, 96.193.117.186}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr a6:31:52:cc:cf:10
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 1a:7b:ab:d9:e6:d2
}</pre>
