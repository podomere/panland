...
layout: research
ip_v4_address: "18.115.93.71"
date: 2023-02-04T16:26:23+00:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like ```18.115.93.71``` or an IPv6 address like ```2000:8f29:7ad3:3e32:f966:2fa1:5b5d:7a81```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```c7:d5:c2:f0:5c:a0```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://shanahan.biz you initially access a DNS server to translate the host portion (shanahan) combined with the Top Level Domain (biz) of the URL, to an IP address like ```101.142.46.118```. Your computer and browser actually sends its type with all web requests e.g. <br>```Opera/9.80 (X11; Linux i686; Ubuntu/14.10) Presto/2.12.388 Version/12.16```
...
<pre>
default   fe80:a8a5:da17:c5da:f9c1%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {73.255.39.165, 12.238.99.100}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr c7:d5:c2:f0:5c:a0
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 6c:b6:c5:19:31:3f
}</pre>
