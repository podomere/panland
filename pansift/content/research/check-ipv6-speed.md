---
title: "Check IPv6 Speed"
subtitle: "Let's Take This Offline?"
layout: research
ip_v4_address: "3.76.63.218"
date: 2022-12-15T13:50:16+00:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like ```3.76.63.218``` or an IPv6 address like ```2000:43ad:7aa8:82a6:a66c:4a39:ba22:bab1```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```fb:99:08:57:53:97```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://borer-hammes.com you initially access a DNS server to translate the host portion (borer-hammes) combined with the Top Level Domain (com) of the URL, to an IP address like ```101.112.57.161```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (compatible; MSIE 9.0; AOL 9.7; AOLBuild 4343.19; Windows NT 6.1; WOW64; Trident/5.0; FunWebProducts)```
...
<pre>
default   fe80:a847:a2bc:15ff:5b38%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {120.48.97.72, 201.48.98.78}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr fb:99:08:57:53:97
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 60:c0:6e:0b:16:e2
}</pre>
