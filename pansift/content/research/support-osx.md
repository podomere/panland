...
layout: research
ip_v4_address: "57.50.250.66"
date: 2022-04-24T19:00:24+01:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like <code>57.50.250.66</code> or an IPv6 address like <code>2000:be90:e10a:4df1:7793:aea:91db:5413</code>. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>1a:e7:6f:f2:0f:b9</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://homenick-haag.co you initially access a DNS server to translate the host portion (homenick-haag) combined with the Top Level Domain (co) of the URL, to an IP address like <code>99.195.134.85</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (compatible; MSIE 9.0; AOL 9.7; AOLBuild 4343.19; Windows NT 6.1; WOW64; Trident/5.0; FunWebProducts)</code>
...
<pre><code>
default   fe80:3168:4715:933f:ce89%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {186.57.110.160, 79.128.36.26}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 1a:e7:6f:f2:0f:b9
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 53:15:60:d4:e3:20
}</code></pre>
