...
layout: research
ip_v4_address: "17.242.33.205"
date: 2022-04-24T18:59:57+01:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like <code>17.242.33.205</code> or an IPv6 address like <code>2000:1262:b159:db23:2002:a275:401c:d1fa</code>. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>ac:2e:e4:27:c6:9f</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://muller-wolff.net you initially access a DNS server to translate the host portion (muller-wolff) combined with the Top Level Domain (net) of the URL, to an IP address like <code>57.146.149.203</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (compatible; MSIE 9.0; AOL 9.7; AOLBuild 4343.19; Windows NT 6.1; WOW64; Trident/5.0; FunWebProducts)</code>
...
<pre><code>
default   fe80:9a60:f1f9:f1af:de0a%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {81.221.211.91, 234.212.243.244}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr ac:2e:e4:27:c6:9f
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 38:2f:20:aa:c6:ac
}</code></pre>
