...
layout: research
ip_v4_address: "176.86.182.226"
date: 2022-04-24T18:32:41+01:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like <code>176.86.182.226</code> or an IPv6 address like <code>2000:93ff:7882:fe5e:510a:4adf:1842:7caa</code>. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>91:13:40:90:f1:74</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://zieme-donnelly.com you initially access a DNS server to translate the host portion (zieme-donnelly) combined with the Top Level Domain (com) of the URL, to an IP address like <code>33.34.36.255</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Opera/9.80 (X11; Linux i686; Ubuntu/14.10) Presto/2.12.388 Version/12.16</code>
...
<pre><code>
default   fe80:40a0:b88c:fc8c:7bd8%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {14.12.163.93, 148.122.186.204}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 91:13:40:90:f1:74
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr da:89:bd:57:86:47
}</code></pre>
