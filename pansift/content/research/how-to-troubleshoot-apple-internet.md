...
subtitle: "Learnings?"
layout: research
ip_v4_address: "155.126.150.226"
date: 2022-04-24T18:31:58+01:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like <code>155.126.150.226</code> or an IPv6 address like <code>2000:dba5:7b3:b581:37f2:5ece:547a:d250</code>. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>c2:a2:a4:bb:8b:75</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://mraz-abshire.io you initially access a DNS server to translate the host portion (mraz-abshire) combined with the Top Level Domain (io) of the URL, to an IP address like <code>189.237.17.200</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (compatible; MSIE 9.0; AOL 9.7; AOLBuild 4343.19; Windows NT 6.1; WOW64; Trident/5.0; FunWebProducts)</code>
...
<pre><code>
default   fe80:a04f:e360:3a81:5256%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {222.2.165.221, 234.242.13.55}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr c2:a2:a4:bb:8b:75
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 98:7f:b4:49:e7:8e
}</code></pre>
