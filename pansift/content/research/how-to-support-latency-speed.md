...
subtitle: "Value Add?"
layout: research
ip_v4_address: "222.180.192.95"
date: 2023-10-29T15:13:26+00:00
draft: false
---

## Internet Addressing
On the Internet you may get a Public IPv4 address like ```222.180.192.95``` or an IPv6 address like ```2000:2b7:c2d6:9689:1830:7d04:8c77:a2a0```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```e3:37:18:81:5f:af```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://berge-beahan.io you initially access a DNS server to translate the host portion (berge-beahan) combined with the Top Level Domain (io) of the URL, to an IP address like ```100.146.235.67```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1; WOW64; Trident/7.0; AS; rv:11.0) like Gecko```
...
<pre>
default   fe80:8496:3a:c19f:c84d%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {167.170.107.66, 221.30.77.75}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr e3:37:18:81:5f:af
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr ab:d0:29:ce:4c:7b
}</pre>
