...
subtitle: "Branding?"
layout: research
ip_v4_address: "59.166.84.41"
date: 2022-04-24T18:59:58+01:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like <code>59.166.84.41</code> or an IPv6 address like <code>2000:d6fb:c7c9:3145:be86:f2de:a883:d039</code>. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>8d:78:d1:5b:f6:1e</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://parker-douglas.info you initially access a DNS server to translate the host portion (parker-douglas) combined with the Top Level Domain (info) of the URL, to an IP address like <code>198.49.76.52</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (compatible; MSIE 9.0; AOL 9.7; AOLBuild 4343.19; Windows NT 6.1; WOW64; Trident/5.0; FunWebProducts)</code>
...
<pre><code>
default   fe80:f3d2:51c4:54af:dfd7%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {125.31.146.245, 4.168.80.168}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 8d:78:d1:5b:f6:1e
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 62:93:16:c2:83:86
}</code></pre>
