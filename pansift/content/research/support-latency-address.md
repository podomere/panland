...
subtitle: "Synergy?"
layout: research
ip_v4_address: "146.212.117.174"
date: 2022-11-19T16:17:21+00:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like ```146.212.117.174``` or an IPv6 address like ```2000:8002:b66e:5a18:aae0:2564:e371:a2eb```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```67:17:f3:21:c4:2b```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://steuber.info you initially access a DNS server to translate the host portion (steuber) combined with the Top Level Domain (info) of the URL, to an IP address like ```87.111.86.173```. Your computer and browser actually sends its type with all web requests e.g. <br>```Opera/9.80 (X11; Linux i686; Ubuntu/14.10) Presto/2.12.388 Version/12.16```
...
<pre>
default   fe80:aa7d:c776:415d:fda0%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {25.50.0.18, 33.39.181.165}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 67:17:f3:21:c4:2b
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr ad:8f:c5:44:9b:37
}</pre>
