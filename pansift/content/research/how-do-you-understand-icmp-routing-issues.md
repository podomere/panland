...
layout: research
ip_v4_address: "193.138.81.190"
date: 2022-05-05T14:29:55+01:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like ```193.138.81.190``` or an IPv6 address like ```2000:aba:6751:7cf4:aec8:e3cd:45cc:baa9```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```82:1f:4b:b3:8e:2b```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://nader.org you initially access a DNS server to translate the host portion (nader) combined with the Top Level Domain (org) of the URL, to an IP address like ```143.15.117.166```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/41.0.2228.0 Safari/537.36```

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```192.168.1.206``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  192.168.1.206    UGScg  en0
...
<pre>
default   fe80:e6da:4bc:18b:fe93%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {186.170.149.237, 252.209.166.139}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 82:1f:4b:b3:8e:2b
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 3e:f4:b3:a6:44:64
}</pre>
