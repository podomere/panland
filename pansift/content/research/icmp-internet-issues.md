...
layout: research
ip_v4_address: "76.218.133.182"
date: 2023-10-29T15:13:27+00:00
draft: false
---

## Internet Addressing
On the Internet you might get a Public IPv4 address like ```76.218.133.182``` or an IPv6 address like ```2000:776d:e4e3:7873:c41:6b5:7769:49ed```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```cc:79:d6:0d:bf:30```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://damore-wilderman.co you initially access a DNS server to translate the host portion (damore-wilderman) combined with the Top Level Domain (co) of the URL, to an IP address like ```107.95.116.215```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT x.y; Win64; x64; rv:10.0) Gecko/20100101 Firefox/10.0```
...
<pre>
default   fe80:d0c5:62da:93ad:d391%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {168.59.77.67, 189.234.84.38}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr cc:79:d6:0d:bf:30
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 24:cc:6c:f3:00:85
}</pre>
