...
subtitle: "Heads Down?"
layout: research
ip_v4_address: "5.131.120.60"
date: 2022-06-12T14:09:28+01:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like ```5.131.120.60``` or an IPv6 address like ```2000:c0df:76af:e4c1:5228:939d:495b:487b```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```45:a5:37:55:1a:75```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://hyatt.name you initially access a DNS server to translate the host portion (hyatt) combined with the Top Level Domain (name) of the URL, to an IP address like ```44.121.61.141```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_3) AppleWebKit/537.75.14 (KHTML, like Gecko) Version/7.0.3 Safari/7046A194A```
...
<pre>
default   fe80:37d9:be69:d917:152c%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {35.109.69.93, 150.71.180.80}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 45:a5:37:55:1a:75
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 1a:4d:2b:c9:72:3c
}</pre>
