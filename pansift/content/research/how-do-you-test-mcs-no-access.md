...
layout: research
ip_v4_address: "75.89.161.210"
date: 2022-06-12T14:09:06+01:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like ```75.89.161.210``` or an IPv6 address like ```2000:b061:506b:1a63:5c33:58d4:4ca9:2f06```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```cf:c0:7f:f2:34:68```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://toy.co you initially access a DNS server to translate the host portion (toy) combined with the Top Level Domain (co) of the URL, to an IP address like ```31.0.187.0```. Your computer and browser actually sends its type with all web requests e.g. <br>```Opera/9.80 (X11; Linux i686; Ubuntu/14.10) Presto/2.12.388 Version/12.16```

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```10.49.251.255``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  10.49.251.255    UGScg  en0
...
<pre>
default   fe80:2371:325:715f:e5aa%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {206.191.30.18, 136.200.91.192}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr cf:c0:7f:f2:34:68
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 14:6e:ac:3c:4b:dd
}</pre>
