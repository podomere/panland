...
layout: research
ip_v4_address: "53.156.129.244"
date: 2023-02-04T17:08:35+00:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like ```53.156.129.244``` or an IPv6 address like ```2000:73ae:8ea4:bf81:9e6c:de1:1920:371c```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```58:78:02:1b:6b:b2```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://kunde-jerde.co you initially access a DNS server to translate the host portion (kunde-jerde) combined with the Top Level Domain (co) of the URL, to an IP address like ```174.184.159.204```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows; U; Win 9x 4.90; SG; rv:1.9.2.4) Gecko/20101104 Netscape/9.1.0285```
...
<pre>
default   fe80:3b50:bb8b:8d6f:eb35%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {157.34.51.187, 176.230.6.195}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 58:78:02:1b:6b:b2
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr a0:63:9f:b1:43:34
}</pre>
