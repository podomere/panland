...
layout: research
ip_v4_address: "68.148.206.106"
date: 2022-11-19T16:17:25+00:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like ```68.148.206.106``` or an IPv6 address like ```2000:7b7a:c64:16b7:6076:2ef9:9aeb:884e```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```65:dd:3d:ed:22:85```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://cummerata-kovacek.biz you initially access a DNS server to translate the host portion (cummerata-kovacek) combined with the Top Level Domain (biz) of the URL, to an IP address like ```16.194.82.41```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT x.y; Win64; x64; rv:10.0) Gecko/20100101 Firefox/10.0```
...
<pre>
default   fe80:3e6c:da2:a7ab:83b%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {168.33.110.124, 60.63.21.246}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 65:dd:3d:ed:22:85
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 2f:34:7b:ec:7d:e1
}</pre>
