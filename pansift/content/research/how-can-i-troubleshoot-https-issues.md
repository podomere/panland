...
layout: research
ip_v4_address: "98.15.8.100"
date: 2023-10-06T17:11:08+01:00
draft: false
---

## Internet Addressing
On the Internet you may have a Public IPv4 address like ```98.15.8.100``` or an IPv6 address like ```2000:d017:6cc8:ff50:7774:58c0:a37b:37af```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```c1:75:2e:09:bc:db```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://ebert-reinger.name you initially access a DNS server to translate the host portion (ebert-reinger) combined with the Top Level Domain (name) of the URL, to an IP address like ```126.10.132.209```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT x.y; Win64; x64; rv:10.0) Gecko/20100101 Firefox/10.0```
...
<pre>
default   fe80:9a:a018:e44b:af59%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {10.69.143.24, 9.31.20.185}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr c1:75:2e:09:bc:db
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr dc:33:65:7a:8f:8f
}</pre>
