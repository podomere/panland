...
layout: research
ip_v4_address: "126.58.72.15"
date: 2022-04-24T18:59:55+01:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like <code>126.58.72.15</code> or an IPv6 address like <code>2000:c525:3cc5:6702:3235:fefb:2958:c1f2</code>. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>8b:80:45:d1:5b:02</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://dickinson-farrell.info you initially access a DNS server to translate the host portion (dickinson-farrell) combined with the Top Level Domain (info) of the URL, to an IP address like <code>35.242.66.102</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (Windows; U; Win 9x 4.90; SG; rv:1.9.2.4) Gecko/20101104 Netscape/9.1.0285</code>
...
<pre><code>
default   fe80:cc01:89d6:7e4e:a94a%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {164.135.115.105, 231.81.128.243}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 8b:80:45:d1:5b:02
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 9a:b9:8e:47:00:c7
}</code></pre>
