...
layout: research
ip_v4_address: "154.209.134.120"
date: 2023-02-04T17:08:39+00:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like ```154.209.134.120``` or an IPv6 address like ```2000:7d60:12e2:fc1c:cf81:78a3:da11:c91b```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```7a:63:b4:0d:02:77```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://bogan-strosin.co you initially access a DNS server to translate the host portion (bogan-strosin) combined with the Top Level Domain (co) of the URL, to an IP address like ```194.212.194.226```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_3) AppleWebKit/537.75.14 (KHTML, like Gecko) Version/7.0.3 Safari/7046A194A```
...
<pre>
default   fe80:d2b8:91e5:a153:94e%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {163.110.235.150, 175.40.26.76}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 7a:63:b4:0d:02:77
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr dc:2a:bd:6d:9f:36
}</pre>
