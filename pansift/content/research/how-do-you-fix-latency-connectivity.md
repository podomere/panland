...
layout: research
ip_v4_address: "196.119.216.115"
date: 2022-12-15T13:50:18+00:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like ```196.119.216.115``` or an IPv6 address like ```2000:176f:23e2:29:ad4c:5160:8033:1955```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```56:68:52:76:96:56```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://swaniawski.name you initially access a DNS server to translate the host portion (swaniawski) combined with the Top Level Domain (name) of the URL, to an IP address like ```162.0.82.183```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows; U; Win 9x 4.90; SG; rv:1.9.2.4) Gecko/20101104 Netscape/9.1.0285```

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```192.168.10.116``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  192.168.10.116    UGScg  en0
...
<pre>
default   fe80:e754:57c1:2075:eeda%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {223.107.187.44, 111.167.16.58}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 56:68:52:76:96:56
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr bc:94:b2:6d:65:a2
}</pre>
...
## Apple macOS / OSX
No matter what version of OSX/macOS you are on, ```10.13.5```, ```11.1.1```, or ```12.2.6```, there are a range of tools for troubleshooting. Unfortunately, between these manual actions and scripts, they don't give you a series of correlated values over time. This is where automated remote troubleshooting comes in to its own, especially for teams that embrace remote work and Work From Anywhere (WFA).
