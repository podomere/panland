---
title: "How To Test Https Router Issues"
subtitle: "Out Of The Box?"
layout: research
ip_v4_address: "23.212.206.166"
date: 2022-04-24T19:00:06+01:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like <code>23.212.206.166</code> or an IPv6 address like <code>2000:fed4:6064:4588:b0c7:6100:48b9:314</code>. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>85:4d:b4:6b:6a:ca</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://kling-powlowski.net you initially access a DNS server to translate the host portion (kling-powlowski) combined with the Top Level Domain (net) of the URL, to an IP address like <code>185.232.21.162</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Opera/9.80 (X11; Linux i686; Ubuntu/14.10) Presto/2.12.388 Version/12.16</code>

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like <code>192.168.248.34</code> (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For <code>IPv6</code> we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  192.168.248.34    UGScg  en0
...
<pre><code>
default   fe80:7d7d:7aff:30c8:123a%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {49.81.11.138, 57.41.67.37}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 85:4d:b4:6b:6a:ca
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr c4:54:f1:6f:69:f2
}</code></pre>
