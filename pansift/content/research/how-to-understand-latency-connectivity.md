...
layout: research
ip_v4_address: "22.139.77.197"
date: 2023-10-06T17:11:04+01:00
draft: false
---

## Internet Addressing
On the Internet you might have a Public IPv4 address like ```22.139.77.197``` or an IPv6 address like ```2000:9ded:9a2c:ff56:557e:2023:e4a9:a89a```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```18:86:36:35:bd:f5```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://fadel.biz you initially access a DNS server to translate the host portion (fadel) combined with the Top Level Domain (biz) of the URL, to an IP address like ```252.54.61.198```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_3) AppleWebKit/537.75.14 (KHTML, like Gecko) Version/7.0.3 Safari/7046A194A```
...
<pre>
default   fe80:d02c:dca4:5971:b830%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {41.74.210.219, 239.161.59.161}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 18:86:36:35:bd:f5
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 2c:3c:29:6f:d6:85
}</pre>
