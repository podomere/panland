...
subtitle: "Value Add?"
layout: research
ip_v4_address: "37.173.50.126"
date: 2022-04-24T18:31:58+01:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like <code>37.173.50.126</code> or an IPv6 address like <code>2000:f9b6:a1fa:6dfe:a7cf:e354:112e:d736</code>. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>b1:43:79:be:8d:9c</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://dietrich-goyette.biz you initially access a DNS server to translate the host portion (dietrich-goyette) combined with the Top Level Domain (biz) of the URL, to an IP address like <code>146.46.87.202</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (Windows NT 6.1; WOW64; Trident/7.0; AS; rv:11.0) like Gecko</code>
...
<pre><code>
default   fe80:1985:f8ee:dfb0:37be%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {162.123.71.92, 237.91.14.144}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr b1:43:79:be:8d:9c
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 87:07:8d:2f:82:e3
}</code></pre>
