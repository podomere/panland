...
layout: research
ip_v4_address: "60.52.68.105"
date: 2022-11-02T11:32:25+00:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like ```60.52.68.105``` or an IPv6 address like ```2000:2aed:dfb3:a35d:4cfb:5199:c06b:1f9```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```72:9d:9f:a4:6a:5e```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://gleichner-kunde.io you initially access a DNS server to translate the host portion (gleichner-kunde) combined with the Top Level Domain (io) of the URL, to an IP address like ```191.224.25.28```. Your computer and browser actually sends its type with all web requests e.g. <br>```Opera/9.80 (X11; Linux i686; Ubuntu/14.10) Presto/2.12.388 Version/12.16```
...
<pre>
default   fe80:5db5:aa91:fae7:45ce%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {200.149.123.175, 115.246.119.222}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 72:9d:9f:a4:6a:5e
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr fb:77:62:2e:59:0f
}</pre>
