...
layout: research
ip_v4_address: "99.31.212.201"
date: 2023-02-04T16:26:03+00:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like ```99.31.212.201``` or an IPv6 address like ```2000:cbaa:993d:e84:8406:e6c2:72e8:f65d```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```52:19:dd:dc:c9:99```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://rohan-purdy.biz you initially access a DNS server to translate the host portion (rohan-purdy) combined with the Top Level Domain (biz) of the URL, to an IP address like ```7.156.235.86```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/41.0.2228.0 Safari/537.36```
...
<pre>
default   fe80:f922:59eb:be87:1327%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {41.32.91.4, 93.103.170.50}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 52:19:dd:dc:c9:99
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 4d:b3:5a:04:64:cc
}</pre>
