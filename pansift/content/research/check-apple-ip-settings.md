...
layout: research
ip_v4_address: "103.185.71.155"
date: 2022-11-02T11:33:11+00:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like ```103.185.71.155``` or an IPv6 address like ```2000:b21f:2f52:6dc2:7c1c:cb18:7118:960d```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```d7:8a:62:56:f6:18```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://braun-erdman.biz you initially access a DNS server to translate the host portion (braun-erdman) combined with the Top Level Domain (biz) of the URL, to an IP address like ```82.45.170.98```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (compatible; MSIE 9.0; AOL 9.7; AOLBuild 4343.19; Windows NT 6.1; WOW64; Trident/5.0; FunWebProducts)```
...
<pre>
default   fe80:ce12:4d9d:8dfc:20a0%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {181.38.36.254, 106.180.120.73}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr d7:8a:62:56:f6:18
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 85:03:7f:2d:5a:77
}</pre>
