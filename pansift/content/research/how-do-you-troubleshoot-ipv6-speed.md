...
layout: research
ip_v4_address: "85.234.193.153"
date: 2022-11-19T19:13:23+00:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like ```85.234.193.153``` or an IPv6 address like ```2000:d1b4:b309:9a2d:cec8:bab2:eb50:157```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```c2:9e:ba:3d:92:02```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://cronin.name you initially access a DNS server to translate the host portion (cronin) combined with the Top Level Domain (name) of the URL, to an IP address like ```80.69.168.21```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1; WOW64; Trident/7.0; AS; rv:11.0) like Gecko```
...
default  172.17.51.149    UGScg  en0
...
<pre>
default   fe80:a9dc:3922:147c:f29b%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {123.247.63.173, 126.221.85.89}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr c2:9e:ba:3d:92:02
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 9b:bc:28:ae:26:ea
}</pre>
