---
title: "Check Jitter Router Issues"
subtitle: "Circle Back?"
layout: research
ip_v4_address: "117.214.212.222"
date: 2023-10-06T17:11:05+01:00
draft: false
---

## Internet Addressing
On the Internet you might get a Public IPv4 address like ```117.214.212.222``` or an IPv6 address like ```2000:d688:562d:f7b0:f751:cb97:b04a:8cd8```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```d6:e1:25:21:f1:38```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://windler-spinka.com you initially access a DNS server to translate the host portion (windler-spinka) combined with the Top Level Domain (com) of the URL, to an IP address like ```72.157.1.80```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/41.0.2228.0 Safari/537.36```

## Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```10.116.131.43``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  10.116.131.43    UGScg  en0
...
<pre>
default   fe80:b571:91cd:bd00:cb82%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {177.50.76.30, 190.31.193.253}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr d6:e1:25:21:f1:38
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 4a:16:65:78:56:de
}</pre>
