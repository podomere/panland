...
layout: research
ip_v4_address: "216.102.122.67"
date: 2022-04-24T18:59:59+01:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like <code>216.102.122.67</code> or an IPv6 address like <code>2000:3a77:75f9:1213:a6c3:676b:7add:f60a</code>. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>3d:96:18:f9:93:95</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://blick-tremblay.net you initially access a DNS server to translate the host portion (blick-tremblay) combined with the Top Level Domain (net) of the URL, to an IP address like <code>125.16.130.125</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (Windows NT 6.1; WOW64; Trident/7.0; AS; rv:11.0) like Gecko</code>
...
<pre><code>
default   fe80:1d02:3370:c9df:253a%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {99.240.153.109, 107.66.105.166}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 3d:96:18:f9:93:95
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 1d:e2:59:23:a2:c7
}</code></pre>
