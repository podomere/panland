...
layout: research
ip_v4_address: "35.227.28.120"
date: 2022-06-12T14:09:24+01:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like ```35.227.28.120``` or an IPv6 address like ```2000:858f:da48:17e9:2aca:72e6:dc90:85dd```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```f0:b7:56:40:e4:9e```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://oconnell-grady.info you initially access a DNS server to translate the host portion (oconnell-grady) combined with the Top Level Domain (info) of the URL, to an IP address like ```83.40.156.210```. Your computer and browser actually sends its type with all web requests e.g. <br>```Opera/9.80 (X11; Linux i686; Ubuntu/14.10) Presto/2.12.388 Version/12.16```

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```172.25.155.167``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  172.25.155.167    UGScg  en0
...
<pre>
default   fe80:318a:ace3:e47:da04%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {51.171.181.252, 134.60.144.26}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr f0:b7:56:40:e4:9e
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 7f:32:9e:1f:93:3d
}</pre>
