...
layout: research
ip_v4_address: "33.142.163.37"
date: 2022-05-05T14:30:07+01:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like ```33.142.163.37``` or an IPv6 address like ```2000:10bf:10e5:3a1b:6c80:fa6e:13cb:517```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```17:39:65:31:1a:83```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://rolfson-crona.biz you initially access a DNS server to translate the host portion (rolfson-crona) combined with the Top Level Domain (biz) of the URL, to an IP address like ```225.38.134.98```. Your computer and browser actually sends its type with all web requests e.g. <br>```Opera/9.80 (X11; Linux i686; Ubuntu/14.10) Presto/2.12.388 Version/12.16```
...
<pre>
default   fe80:756e:b74d:5757:a4ea%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {186.140.20.28, 156.165.100.254}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 17:39:65:31:1a:83
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr b0:07:bc:ac:a4:f9
}</pre>
