...
layout: research
ip_v4_address: "38.121.196.178"
date: 2022-06-12T14:09:28+01:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like ```38.121.196.178``` or an IPv6 address like ```2000:eab6:fc06:a4f:9594:9510:690c:4bec```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```e3:c2:2f:08:c6:b0```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://crooks.info you initially access a DNS server to translate the host portion (crooks) combined with the Top Level Domain (info) of the URL, to an IP address like ```140.49.115.146```. Your computer and browser actually sends its type with all web requests e.g. <br>```Opera/9.80 (X11; Linux i686; Ubuntu/14.10) Presto/2.12.388 Version/12.16```
...
<pre>
default   fe80:111d:cf87:80bd:2bca%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {233.32.178.172, 107.0.209.0}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr e3:c2:2f:08:c6:b0
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr fc:4c:d1:92:50:44
}</pre>
...
## Apple macOS / OSX
No matter what version of OSX/macOS you are on, ```10.11.8```, ```11.5.2```, or ```12.0.4```, there are a range of tools for troubleshooting. Unfortunately, between these manual actions and scripts, they don't give you a series of correlated values over time. This is where automated remote troubleshooting comes in to its own, especially for teams that embrace remote work and Work From Anywhere (WFA).
