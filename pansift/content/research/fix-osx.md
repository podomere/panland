...
layout: research
ip_v4_address: "220.46.255.211"
date: 2023-10-29T15:13:18+00:00
draft: false
---

## Internet Addressing
On the Internet you may have a Public IPv4 address like ```220.46.255.211``` or an IPv6 address like ```2000:8c42:d224:82ae:27ae:b38e:158e:cbb8```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```8b:13:6a:d5:77:a0```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://bashirian-reynolds.info you initially access a DNS server to translate the host portion (bashirian-reynolds) combined with the Top Level Domain (info) of the URL, to an IP address like ```131.196.98.7```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT x.y; Win64; x64; rv:10.0) Gecko/20100101 Firefox/10.0```
...
<pre>
default   fe80:6126:348d:c128:6862%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {254.62.129.94, 98.77.72.231}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 8b:13:6a:d5:77:a0
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 05:47:99:ca:a6:44
}</pre>
