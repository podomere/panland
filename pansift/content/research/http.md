...
subtitle: "Synergy?"
layout: research
ip_v4_address: "234.208.175.110"
date: 2022-04-24T19:00:03+01:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like <code>234.208.175.110</code> or an IPv6 address like <code>2000:a8c0:f132:a722:8ecd:b413:31af:2383</code>. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>dd:7c:3b:7a:72:77</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://boehm-lang.org you initially access a DNS server to translate the host portion (boehm-lang) combined with the Top Level Domain (org) of the URL, to an IP address like <code>234.111.11.221</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (compatible; MSIE 9.0; AOL 9.7; AOLBuild 4343.19; Windows NT 6.1; WOW64; Trident/5.0; FunWebProducts)</code>
...
<pre><code>
default   fe80:50cf:7452:e376:5687%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {185.147.204.88, 164.176.102.116}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr dd:7c:3b:7a:72:77
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr a8:dd:c7:17:02:b3
}</code></pre>
