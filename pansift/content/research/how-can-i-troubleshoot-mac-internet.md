...
subtitle: "Impact Map?"
layout: research
ip_v4_address: "156.217.101.200"
date: 2023-02-04T16:26:12+00:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like ```156.217.101.200``` or an IPv6 address like ```2000:15bc:ce10:81d7:e807:4e8f:ce3f:7b8e```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```e4:06:9f:19:ce:7b```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://jacobson.org you initially access a DNS server to translate the host portion (jacobson) combined with the Top Level Domain (org) of the URL, to an IP address like ```103.34.124.181```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows; U; Win 9x 4.90; SG; rv:1.9.2.4) Gecko/20101104 Netscape/9.1.0285```
...
<pre>
default   fe80:d87:12d1:37ed:e057%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {83.173.193.219, 21.183.32.77}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr e4:06:9f:19:ce:7b
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 92:80:8c:78:b5:50
}</pre>
