...
layout: research
ip_v4_address: "219.163.134.202"
date: 2022-06-04T14:38:16+01:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like ```219.163.134.202``` or an IPv6 address like ```2000:8413:d093:78b3:9d63:9bf:d866:403e```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```3b:41:c6:d1:00:3f```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://bergstrom-monahan.name you initially access a DNS server to translate the host portion (bergstrom-monahan) combined with the Top Level Domain (name) of the URL, to an IP address like ```111.1.54.89```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT x.y; Win64; x64; rv:10.0) Gecko/20100101 Firefox/10.0```
...
<pre>
default   fe80:57c9:2abe:7f29:ed8%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {74.166.240.79, 218.168.15.233}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 3b:41:c6:d1:00:3f
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 14:d3:13:f6:b0:ab
}</pre>
