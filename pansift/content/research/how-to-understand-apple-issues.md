...
subtitle: "Etc. Etc.?"
layout: research
ip_v4_address: "172.33.163.115"
date: 2022-06-04T14:38:29+01:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like ```172.33.163.115``` or an IPv6 address like ```2000:cb6:112b:e7b3:2017:13e6:6463:99f8```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```36:e2:68:06:74:92```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://ullrich-nitzsche.info you initially access a DNS server to translate the host portion (ullrich-nitzsche) combined with the Top Level Domain (info) of the URL, to an IP address like ```135.76.53.175```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_3) AppleWebKit/537.75.14 (KHTML, like Gecko) Version/7.0.3 Safari/7046A194A```
...
<pre>
default   fe80:2f6d:6703:1f9a:b513%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {68.33.68.205, 116.179.183.21}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 36:e2:68:06:74:92
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 91:5b:1a:a0:df:6d
}</pre>
