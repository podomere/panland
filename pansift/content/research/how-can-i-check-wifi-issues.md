...
layout: research
ip_v4_address: "81.25.67.61"
date: 2023-10-29T15:13:12+00:00
draft: false
---

## Internet Addressing
On the Internet you may have a Public IPv4 address like ```81.25.67.61``` or an IPv6 address like ```2000:6237:5124:2857:a7c6:28b6:7826:6a88```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```15:ef:92:9b:27:64```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://turcotte-heller.org you initially access a DNS server to translate the host portion (turcotte-heller) combined with the Top Level Domain (org) of the URL, to an IP address like ```2.215.184.241```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/41.0.2228.0 Safari/537.36```
...
<pre>
default   fe80:bdb1:f6d3:ea40:a7a1%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {92.59.239.131, 191.211.177.236}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 15:ef:92:9b:27:64
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 78:8c:43:7a:a6:2e
}</pre>
