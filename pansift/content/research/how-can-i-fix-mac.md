...
subtitle: "Value Add?"
layout: research
ip_v4_address: "162.109.138.77"
date: 2022-11-19T16:17:13+00:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like ```162.109.138.77``` or an IPv6 address like ```2000:e45:1d4c:2fa9:c723:fe4e:1987:bc09```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```e0:1f:8b:e0:de:92```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://mccullough-ankunding.biz you initially access a DNS server to translate the host portion (mccullough-ankunding) combined with the Top Level Domain (biz) of the URL, to an IP address like ```123.11.104.160```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_3) AppleWebKit/537.75.14 (KHTML, like Gecko) Version/7.0.3 Safari/7046A194A```

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```10.30.87.131``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  10.30.87.131    UGScg  en0
...
<pre>
default   fe80:c2c3:aec1:d328:eadc%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {253.64.44.147, 157.187.10.7}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr e0:1f:8b:e0:de:92
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr f6:44:f7:cb:06:d5
}</pre>
