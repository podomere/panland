...
layout: research
ip_v4_address: "243.17.221.76"
date: 2023-10-29T15:13:26+00:00
draft: false
---

## Internet Addressing
On the Internet you may get a Public IPv4 address like ```243.17.221.76``` or an IPv6 address like ```2000:273a:a42f:8d5e:2ee:2318:2298:110a```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```0e:5b:64:42:ca:da```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://zboncak-emard.co you initially access a DNS server to translate the host portion (zboncak-emard) combined with the Top Level Domain (co) of the URL, to an IP address like ```210.15.213.223```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows; U; Win 9x 4.90; SG; rv:1.9.2.4) Gecko/20101104 Netscape/9.1.0285```
...
<pre>
default   fe80:ab1c:175b:f761:4f37%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {4.172.46.97, 254.201.237.75}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 0e:5b:64:42:ca:da
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr ae:a5:be:24:81:88
}</pre>
