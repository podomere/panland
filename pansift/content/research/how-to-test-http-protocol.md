...
layout: research
ip_v4_address: "175.17.109.248"
date: 2022-04-24T19:00:03+01:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like <code>175.17.109.248</code> or an IPv6 address like <code>2000:e062:64e1:656c:d233:74af:4d33:22b8</code>. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>b3:ed:82:a7:56:9c</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://treutel-kuhlman.net you initially access a DNS server to translate the host portion (treutel-kuhlman) combined with the Top Level Domain (net) of the URL, to an IP address like <code>217.7.221.227</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (Windows; U; Win 9x 4.90; SG; rv:1.9.2.4) Gecko/20101104 Netscape/9.1.0285</code>
...
<pre><code>
default   fe80:3b79:3876:96bc:e250%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {189.143.136.115, 91.50.57.53}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr b3:ed:82:a7:56:9c
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr e7:88:19:28:09:47
}</code></pre>
