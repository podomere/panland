...
layout: research
ip_v4_address: "129.211.211.238"
date: 2023-10-29T15:13:27+00:00
draft: false
---

## Internet Addressing
On the Internet you might get a Public IPv4 address like ```129.211.211.238``` or an IPv6 address like ```2000:b999:53d:6838:e1c0:1edf:b156:4d63```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```7e:10:90:08:99:b4```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://lockman.io you initially access a DNS server to translate the host portion (lockman) combined with the Top Level Domain (io) of the URL, to an IP address like ```140.127.20.230```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT x.y; Win64; x64; rv:10.0) Gecko/20100101 Firefox/10.0```
...
<pre>
default   fe80:4472:29c3:912a:6db6%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {46.19.109.237, 77.238.51.236}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 7e:10:90:08:99:b4
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 9a:0e:07:8b:48:63
}</pre>
...
### Apple macOS / OSX
No matter what version of OSX/macOS you are on, ```10.12.5```, ```11.2.4```, or ```12.0.6```, there are a range of tools for troubleshooting. Unfortunately, between these manual actions and scripts, they don't give you a series of correlated values over time. This is where automated remote troubleshooting comes in to its own, especially for teams that embrace remote work and Work From Anywhere (WFA).
