...
layout: research
ip_v4_address: "246.193.144.155"
date: 2022-04-24T18:59:59+01:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like <code>246.193.144.155</code> or an IPv6 address like <code>2000:9190:44ba:d7f5:6a43:c1e7:24df:bcb2</code>. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>b4:ad:19:12:29:12</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://sanford-beer.org you initially access a DNS server to translate the host portion (sanford-beer) combined with the Top Level Domain (org) of the URL, to an IP address like <code>60.178.165.70</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_3) AppleWebKit/537.75.14 (KHTML, like Gecko) Version/7.0.3 Safari/7046A194A</code>
...
<pre><code>
default   fe80:607f:a431:7b13:aff1%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {150.21.180.208, 131.145.178.39}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr b4:ad:19:12:29:12
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 55:dd:84:72:40:4b
}</code></pre>
