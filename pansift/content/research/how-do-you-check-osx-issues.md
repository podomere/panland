...
layout: research
ip_v4_address: "58.52.219.24"
date: 2023-10-06T17:10:42+01:00
draft: false
---

## Internet Addressing
On the Internet you may get a Public IPv4 address like ```58.52.219.24``` or an IPv6 address like ```2000:d936:316d:8c8:4b21:eb98:d6ef:65a3```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```21:cf:d6:4c:81:35```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://bartoletti-ondricka.com you initially access a DNS server to translate the host portion (bartoletti-ondricka) combined with the Top Level Domain (com) of the URL, to an IP address like ```102.117.87.221```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1; WOW64; Trident/7.0; AS; rv:11.0) like Gecko```
...
default  172.30.34.187    UGScg  en0
...
<pre>
default   fe80:e83f:a89f:7356:3c6f%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {209.36.76.57, 8.222.164.69}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 21:cf:d6:4c:81:35
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr b6:4a:cd:96:09:55
}</pre>
