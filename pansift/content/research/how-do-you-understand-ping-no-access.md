...
subtitle: "Synergy?"
layout: research
ip_v4_address: "100.159.9.143"
date: 2023-10-06T17:11:07+01:00
draft: false
---

## Internet Addressing
On the Internet you may have a Public IPv4 address like ```100.159.9.143``` or an IPv6 address like ```2000:dedd:f51e:797c:2998:1950:f946:2e6```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```93:b7:ab:8f:ac:17```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://ritchie-oconner.co you initially access a DNS server to translate the host portion (ritchie-oconner) combined with the Top Level Domain (co) of the URL, to an IP address like ```52.130.234.107```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT x.y; Win64; x64; rv:10.0) Gecko/20100101 Firefox/10.0```
...
<pre>
default   fe80:14b8:2637:b79c:3b0e%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {64.71.149.211, 105.178.80.107}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 93:b7:ab:8f:ac:17
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 76:89:8a:db:45:d3
}</pre>
