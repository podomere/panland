...
layout: research
ip_v4_address: "53.115.83.218"
date: 2023-02-04T17:07:41+00:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like ```53.115.83.218``` or an IPv6 address like ```2000:799b:b4e6:6000:8afe:25cd:7ffc:47e9```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```f8:c7:7c:7f:c9:36```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://hartmann-willms.com you initially access a DNS server to translate the host portion (hartmann-willms) combined with the Top Level Domain (com) of the URL, to an IP address like ```226.38.245.9```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/41.0.2228.0 Safari/537.36```
...
<pre>
default   fe80:1257:803b:b682:3e13%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {65.220.102.209, 70.140.61.214}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr f8:c7:7c:7f:c9:36
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr c0:b9:61:f0:da:cd
}</pre>
