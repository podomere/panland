...
layout: research
ip_v4_address: "10.162.158.129"
date: 2023-10-29T15:13:30+00:00
draft: false
---

## Internet Addressing
On the Internet you may have a Public IPv4 address like ```10.162.158.129``` or an IPv6 address like ```2000:f3c4:846b:7cd4:c258:5e0d:2de3:944a```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```cb:b9:70:e0:db:f8```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://dicki-klein.biz you initially access a DNS server to translate the host portion (dicki-klein) combined with the Top Level Domain (biz) of the URL, to an IP address like ```249.222.135.64```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT x.y; Win64; x64; rv:10.0) Gecko/20100101 Firefox/10.0```
...
<pre>
default   fe80:c68b:6478:9539:fa85%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {182.27.67.220, 76.57.20.254}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr cb:b9:70:e0:db:f8
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 2f:51:78:30:44:25
}</pre>
