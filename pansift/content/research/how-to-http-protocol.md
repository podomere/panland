...
layout: research
ip_v4_address: "9.183.49.56"
date: 2022-06-04T14:38:43+01:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like ```9.183.49.56``` or an IPv6 address like ```2000:39c2:a94c:5853:664b:763c:4288:7bfc```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```7c:1e:1c:c5:8c:0b```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://becker-howell.co you initially access a DNS server to translate the host portion (becker-howell) combined with the Top Level Domain (co) of the URL, to an IP address like ```25.27.134.150```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1; WOW64; Trident/7.0; AS; rv:11.0) like Gecko```
...
<pre>
default   fe80:b3e7:b0af:84f4:c0f9%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {134.152.100.161, 63.25.143.46}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 7c:1e:1c:c5:8c:0b
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr e5:40:27:7d:6e:62
}</pre>
