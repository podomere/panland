...
layout: research
ip_v4_address: "81.134.249.140"
date: 2022-12-15T13:50:10+00:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like ```81.134.249.140``` or an IPv6 address like ```2000:19f3:530c:360e:abe:16d7:7fb:aa36```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```b8:fc:ad:4b:8f:03```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://weber-skiles.biz you initially access a DNS server to translate the host portion (weber-skiles) combined with the Top Level Domain (biz) of the URL, to an IP address like ```232.116.150.27```. Your computer and browser actually sends its type with all web requests e.g. <br>```Opera/9.80 (X11; Linux i686; Ubuntu/14.10) Presto/2.12.388 Version/12.16```
...
<pre>
default   fe80:9b99:2fb0:5b57:9a51%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {246.191.130.241, 209.250.232.232}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr b8:fc:ad:4b:8f:03
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 35:f7:42:ff:88:f0
}</pre>
