...
subtitle: "Synergy?"
layout: research
ip_v4_address: "69.237.24.233"
date: 2022-05-05T14:28:58+01:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like ```69.237.24.233``` or an IPv6 address like ```2000:64ac:b1fd:6811:8354:c2e3:6fe3:19b2```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```a5:62:0c:8a:0c:5f```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://marks.net you initially access a DNS server to translate the host portion (marks) combined with the Top Level Domain (net) of the URL, to an IP address like ```121.199.94.0```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows; U; Win 9x 4.90; SG; rv:1.9.2.4) Gecko/20101104 Netscape/9.1.0285```
...
<pre>
default   fe80:23ef:2b31:4455:fd43%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {117.109.178.236, 165.118.103.251}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr a5:62:0c:8a:0c:5f
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 08:78:30:e8:a0:b8
}</pre>
