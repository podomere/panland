...
layout: research
ip_v4_address: "170.74.209.98"
date: 2023-02-04T17:08:34+00:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like ```170.74.209.98``` or an IPv6 address like ```2000:97b7:5a8d:7c02:e692:689b:329e:65ff```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```1b:e4:0a:2a:7e:8b```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://larkin-baumbach.name you initially access a DNS server to translate the host portion (larkin-baumbach) combined with the Top Level Domain (name) of the URL, to an IP address like ```223.194.116.185```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_3) AppleWebKit/537.75.14 (KHTML, like Gecko) Version/7.0.3 Safari/7046A194A```
...
<pre>
default   fe80:4b1d:dcba:20aa:d3b3%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {62.161.82.119, 47.199.50.149}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 1b:e4:0a:2a:7e:8b
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 35:72:f6:7c:cf:64
}</pre>
