...
subtitle: "Swag?"
layout: research
ip_v4_address: "167.97.1.121"
date: 2023-02-04T17:07:49+00:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like ```167.97.1.121``` or an IPv6 address like ```2000:5715:4be0:8084:cb8a:efe4:585b:3823```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```04:a7:fd:ee:f0:0c```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://beer-gulgowski.io you initially access a DNS server to translate the host portion (beer-gulgowski) combined with the Top Level Domain (io) of the URL, to an IP address like ```61.234.226.36```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (compatible; MSIE 9.0; AOL 9.7; AOLBuild 4343.19; Windows NT 6.1; WOW64; Trident/5.0; FunWebProducts)```
...
<pre>
default   fe80:348c:3dd3:61ab:6ae1%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {161.48.234.161, 136.240.124.203}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 04:a7:fd:ee:f0:0c
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 72:55:5e:df:52:00
}</pre>
