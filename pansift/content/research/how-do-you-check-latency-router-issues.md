...
layout: research
ip_v4_address: "121.134.110.67"
date: 2022-06-12T14:09:25+01:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like ```121.134.110.67``` or an IPv6 address like ```2000:c4d7:a907:11cc:8897:c7e8:3d65:b23a```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```40:f3:aa:d3:c8:c7```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://murphy-wintheiser.name you initially access a DNS server to translate the host portion (murphy-wintheiser) combined with the Top Level Domain (name) of the URL, to an IP address like ```27.207.184.188```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows; U; Win 9x 4.90; SG; rv:1.9.2.4) Gecko/20101104 Netscape/9.1.0285```
...
<pre>
default   fe80:6dd7:92c4:3e4:5cf5%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {220.121.219.250, 252.228.138.75}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 40:f3:aa:d3:c8:c7
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr ca:a2:f5:cc:ae:b7
}</pre>
