...
subtitle: "Deep Dive?"
layout: research
ip_v4_address: "244.211.6.113"
date: 2023-10-06T17:10:31+01:00
draft: false
---

## Internet Addressing
On the Internet you might get a Public IPv4 address like ```244.211.6.113``` or an IPv6 address like ```2000:3ebf:2c95:afa:762c:8e1d:5929:bb3```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```46:fb:20:59:9c:28```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://mclaughlin-christiansen.io you initially access a DNS server to translate the host portion (mclaughlin-christiansen) combined with the Top Level Domain (io) of the URL, to an IP address like ```175.103.34.36```. Your computer and browser actually sends its type with all web requests e.g. <br>```Opera/9.80 (X11; Linux i686; Ubuntu/14.10) Presto/2.12.388 Version/12.16```
...
<pre>
default   fe80:a88:dd96:6bc:6cf1%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {100.117.55.106, 128.198.146.107}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 46:fb:20:59:9c:28
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 57:bc:96:29:16:81
}</pre>
