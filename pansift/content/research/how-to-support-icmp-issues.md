...
subtitle: "Branding?"
layout: research
ip_v4_address: "47.175.207.9"
date: 2023-02-04T16:26:21+00:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like ```47.175.207.9``` or an IPv6 address like ```2000:ad4:c1cd:e62c:fbd5:a5c:f0bc:358d```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```05:d2:1a:f3:33:95```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://rempel-okeefe.org you initially access a DNS server to translate the host portion (rempel-okeefe) combined with the Top Level Domain (org) of the URL, to an IP address like ```187.42.248.153```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1; WOW64; Trident/7.0; AS; rv:11.0) like Gecko```
...
<pre>
default   fe80:a5db:95b7:b02f:813d%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {110.129.108.133, 109.65.234.128}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 05:d2:1a:f3:33:95
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 9d:e4:69:15:50:6f
}</pre>
