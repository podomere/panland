...
layout: research
ip_v4_address: "164.250.78.250"
date: 2022-11-02T11:32:56+00:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like ```164.250.78.250``` or an IPv6 address like ```2000:6da5:6a5:c8f8:65c3:a03c:a08d:dded```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```d1:94:2d:05:e8:8b```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://hodkiewicz-kerluke.net you initially access a DNS server to translate the host portion (hodkiewicz-kerluke) combined with the Top Level Domain (net) of the URL, to an IP address like ```61.67.222.147```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT x.y; Win64; x64; rv:10.0) Gecko/20100101 Firefox/10.0```

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```192.168.164.242``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  192.168.164.242    UGScg  en0
...
<pre>
default   fe80:9383:7da2:c44c:d122%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {238.100.151.52, 201.47.101.108}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr d1:94:2d:05:e8:8b
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 1a:07:4a:3c:8e:7b
}</pre>
...
## Apple macOS / OSX
No matter what version of OSX/macOS you are on, ```10.13.6```, ```11.3.1```, or ```12.1.3```, there are a range of tools for troubleshooting. Unfortunately, between these manual actions and scripts, they don't give you a series of correlated values over time. This is where automated remote troubleshooting comes in to its own, especially for teams that embrace remote work and Work From Anywhere (WFA).
