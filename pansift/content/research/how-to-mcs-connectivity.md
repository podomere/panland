...
subtitle: "Ideate?"
layout: research
ip_v4_address: "46.78.211.229"
date: 2022-11-19T16:17:06+00:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like ```46.78.211.229``` or an IPv6 address like ```2000:ded1:d04e:4f4d:21fd:3e4e:c6fa:c4b9```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```b8:c9:e9:48:4d:17```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://jerde.net you initially access a DNS server to translate the host portion (jerde) combined with the Top Level Domain (net) of the URL, to an IP address like ```205.251.131.199```. Your computer and browser actually sends its type with all web requests e.g. <br>```Opera/9.80 (X11; Linux i686; Ubuntu/14.10) Presto/2.12.388 Version/12.16```
...
<pre>
default   fe80:d2c1:24e1:a580:910b%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {98.141.255.59, 82.120.131.5}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr b8:c9:e9:48:4d:17
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 03:d6:0f:9d:00:bb
}</pre>
