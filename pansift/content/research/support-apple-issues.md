...
layout: research
ip_v4_address: "47.113.41.120"
date: 2022-04-24T18:31:58+01:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like <code>47.113.41.120</code> or an IPv6 address like <code>2000:f97e:7a4b:c2c2:cbad:56e2:4a27:74ce</code>. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>81:a9:46:74:af:cb</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://fisher-osinski.net you initially access a DNS server to translate the host portion (fisher-osinski) combined with the Top Level Domain (net) of the URL, to an IP address like <code>173.51.122.84</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (Windows NT 6.1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/41.0.2228.0 Safari/537.36</code>
...
<pre><code>
default   fe80:62a5:db0c:5a03:54a3%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {75.43.147.157, 70.100.180.184}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 81:a9:46:74:af:cb
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr c4:cd:45:d0:f2:cf
}</code></pre>
