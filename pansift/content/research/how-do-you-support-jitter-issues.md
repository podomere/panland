...
subtitle: "Branding?"
layout: research
ip_v4_address: "80.40.172.17"
date: 2022-12-15T13:50:19+00:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like ```80.40.172.17``` or an IPv6 address like ```2000:1d0:c91:902c:872:3437:f0ae:5249```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```b7:9a:b9:5b:23:26```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://walker-kuvalis.name you initially access a DNS server to translate the host portion (walker-kuvalis) combined with the Top Level Domain (name) of the URL, to an IP address like ```156.109.27.189```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (compatible; MSIE 9.0; AOL 9.7; AOLBuild 4343.19; Windows NT 6.1; WOW64; Trident/5.0; FunWebProducts)```
...
<pre>
default   fe80:501f:caaf:c3ee:bd96%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {234.122.223.180, 28.65.1.64}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr b7:9a:b9:5b:23:26
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 2e:c7:81:18:ea:bb
}</pre>
...
## Apple macOS / OSX
No matter what version of OSX/macOS you are on, ```10.15.8```, ```11.6.1```, or ```12.1.9```, there are a range of tools for troubleshooting. Unfortunately, between these manual actions and scripts, they don't give you a series of correlated values over time. This is where automated remote troubleshooting comes in to its own, especially for teams that embrace remote work and Work From Anywhere (WFA).
