...
layout: research
ip_v4_address: "61.179.249.55"
date: 2023-02-04T17:08:37+00:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like ```61.179.249.55``` or an IPv6 address like ```2000:b81:1d0b:8da0:7fb7:539a:cd2b:6bed```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```d0:76:66:04:0b:e3```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://stark-kovacek.net you initially access a DNS server to translate the host portion (stark-kovacek) combined with the Top Level Domain (net) of the URL, to an IP address like ```45.194.54.110```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1; WOW64; Trident/7.0; AS; rv:11.0) like Gecko```
...
<pre>
default   fe80:ab14:86e0:c8b8:50b6%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {41.146.172.193, 246.175.17.84}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr d0:76:66:04:0b:e3
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 22:85:92:c8:ac:1a
}</pre>
