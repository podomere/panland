...
subtitle: "Streamline?"
layout: research
ip_v4_address: "103.83.59.80"
date: 2023-10-06T17:10:43+01:00
draft: false
---

## Internet Addressing
On the Internet you might get a Public IPv4 address like ```103.83.59.80``` or an IPv6 address like ```2000:bd92:51d:15ac:9ff9:a1b3:93ed:333f```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```a0:a7:00:f1:8f:7c```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://leffler-fahey.co you initially access a DNS server to translate the host portion (leffler-fahey) combined with the Top Level Domain (co) of the URL, to an IP address like ```1.51.95.160```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/41.0.2228.0 Safari/537.36```
...
<pre>
default   fe80:32e1:ba9e:4eb7:9202%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {151.221.70.226, 116.63.1.186}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr a0:a7:00:f1:8f:7c
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr a5:93:e8:49:3d:2f
}</pre>
