...
subtitle: "Synergy?"
layout: research
ip_v4_address: "12.193.253.73"
date: 2022-12-15T13:50:20+00:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like ```12.193.253.73``` or an IPv6 address like ```2000:870f:14c:cc6b:2d5b:921:61a:16a2```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```8f:b6:16:0f:01:bd```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://hauck-nader.net you initially access a DNS server to translate the host portion (hauck-nader) combined with the Top Level Domain (net) of the URL, to an IP address like ```150.155.139.100```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT x.y; Win64; x64; rv:10.0) Gecko/20100101 Firefox/10.0```
...
<pre>
default   fe80:667a:c5bd:856b:8c22%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {55.168.115.88, 127.30.87.159}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 8f:b6:16:0f:01:bd
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr c9:c3:d1:75:69:74
}</pre>
