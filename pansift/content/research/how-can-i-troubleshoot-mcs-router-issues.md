...
layout: research
ip_v4_address: "122.127.233.5"
date: 2022-04-24T19:00:34+01:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like <code>122.127.233.5</code> or an IPv6 address like <code>2000:6df:15e9:6453:30c2:f2c0:ef0d:b029</code>. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>55:48:00:48:b4:25</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://bruen-greenholt.info you initially access a DNS server to translate the host portion (bruen-greenholt) combined with the Top Level Domain (info) of the URL, to an IP address like <code>3.187.27.120</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (compatible; MSIE 9.0; AOL 9.7; AOLBuild 4343.19; Windows NT 6.1; WOW64; Trident/5.0; FunWebProducts)</code>
...
<pre><code>
default   fe80:e7d4:2928:bc59:4f54%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {182.97.193.13, 81.226.182.108}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 55:48:00:48:b4:25
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 64:e3:54:cf:cb:c2
}</code></pre>
