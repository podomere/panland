...
layout: research
ip_v4_address: "131.235.43.248"
date: 2023-02-04T17:07:43+00:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like ```131.235.43.248``` or an IPv6 address like ```2000:2b6b:e7eb:e227:a0d4:afc7:bb07:d4fd```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```f5:21:3c:38:1c:47```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://lakin-wilkinson.info you initially access a DNS server to translate the host portion (lakin-wilkinson) combined with the Top Level Domain (info) of the URL, to an IP address like ```229.177.129.196```. Your computer and browser actually sends its type with all web requests e.g. <br>```Opera/9.80 (X11; Linux i686; Ubuntu/14.10) Presto/2.12.388 Version/12.16```
...
<pre>
default   fe80:1a19:f129:fd56:1ff2%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {136.235.7.60, 27.151.194.10}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr f5:21:3c:38:1c:47
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 8f:12:a1:38:52:75
}</pre>
