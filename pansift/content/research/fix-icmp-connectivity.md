...
subtitle: "Deep Dive?"
layout: research
ip_v4_address: "198.184.195.246"
date: 2023-02-04T16:26:20+00:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like ```198.184.195.246``` or an IPv6 address like ```2000:c11:71e3:8ee8:d32c:fe3c:4067:2f9f```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```cf:23:fe:06:11:35```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://ledner-wolf.org you initially access a DNS server to translate the host portion (ledner-wolf) combined with the Top Level Domain (org) of the URL, to an IP address like ```202.226.95.250```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows; U; Win 9x 4.90; SG; rv:1.9.2.4) Gecko/20101104 Netscape/9.1.0285```
...
<pre>
default   fe80:7ba8:d210:e0ad:bdc7%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {199.194.60.162, 173.76.11.145}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr cf:23:fe:06:11:35
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 4e:ba:14:37:cb:3f
}</pre>
