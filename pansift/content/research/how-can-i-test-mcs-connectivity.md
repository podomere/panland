...
subtitle: "Deep Dive?"
layout: research
ip_v4_address: "25.96.153.130"
date: 2022-04-24T18:32:42+01:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like <code>25.96.153.130</code> or an IPv6 address like <code>2000:af32:5f18:e9e4:3791:fb17:beb8:e956</code>. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>30:98:e5:03:4c:35</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://pacocha-langosh.io you initially access a DNS server to translate the host portion (pacocha-langosh) combined with the Top Level Domain (io) of the URL, to an IP address like <code>242.81.148.194</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Opera/9.80 (X11; Linux i686; Ubuntu/14.10) Presto/2.12.388 Version/12.16</code>
...
<pre><code>
default   fe80:a8fb:5b4c:1b39:15d5%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {122.24.41.81, 245.101.27.53}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 30:98:e5:03:4c:35
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 65:46:08:9b:8b:23
}</code></pre>
