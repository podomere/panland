...
layout: research
ip_v4_address: "65.233.38.112"
date: 2023-10-06T17:10:42+01:00
draft: false
---

## Internet Addressing
On the Internet you might have a Public IPv4 address like ```65.233.38.112``` or an IPv6 address like ```2000:105f:9d83:bc65:b342:b266:7fd8:6374```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```30:53:ca:c8:21:41```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://funk-batz.com you initially access a DNS server to translate the host portion (funk-batz) combined with the Top Level Domain (com) of the URL, to an IP address like ```32.229.112.73```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_3) AppleWebKit/537.75.14 (KHTML, like Gecko) Version/7.0.3 Safari/7046A194A```
...
default  172.17.77.179    UGScg  en0
...
<pre>
default   fe80:4738:866c:ed1f:9c13%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {34.70.210.61, 65.66.41.174}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 30:53:ca:c8:21:41
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 22:54:0e:ff:76:9c
}</pre>
