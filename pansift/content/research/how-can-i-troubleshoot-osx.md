...
layout: research
ip_v4_address: "108.21.95.185"
date: 2022-11-19T19:13:16+00:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like ```108.21.95.185``` or an IPv6 address like ```2000:75e0:ddd3:ca01:f496:9e06:ddac:351d```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```70:c2:53:ef:5f:39```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://oconnell-vandervort.net you initially access a DNS server to translate the host portion (oconnell-vandervort) combined with the Top Level Domain (net) of the URL, to an IP address like ```102.139.221.247```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/41.0.2228.0 Safari/537.36```
...
<pre>
default   fe80:e1e8:c573:6ff:ca3%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {166.43.135.219, 48.254.41.174}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 70:c2:53:ef:5f:39
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 1e:75:3c:e4:ed:5b
}</pre>
