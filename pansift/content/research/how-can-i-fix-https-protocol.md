...
subtitle: "Deep Dive?"
layout: research
ip_v4_address: "253.184.208.105"
date: 2023-10-29T15:13:30+00:00
draft: false
---

## Internet Addressing
On the Internet you might get a Public IPv4 address like ```253.184.208.105``` or an IPv6 address like ```2000:4bb:d7f:e84c:3cca:b20f:6649:730e```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```d3:b4:1c:57:5e:7e```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://huel.info you initially access a DNS server to translate the host portion (huel) combined with the Top Level Domain (info) of the URL, to an IP address like ```29.119.45.252```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (compatible; MSIE 9.0; AOL 9.7; AOLBuild 4343.19; Windows NT 6.1; WOW64; Trident/5.0; FunWebProducts)```
...
<pre>
default   fe80:4bc5:43fa:cb53:383f%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {20.177.30.236, 150.20.236.180}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr d3:b4:1c:57:5e:7e
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 9a:82:46:bf:8d:dc
}</pre>
