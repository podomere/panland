...
layout: research
ip_v4_address: "160.73.250.210"
date: 2023-10-29T15:13:24+00:00
draft: false
---

## Internet Addressing
On the Internet you might get a Public IPv4 address like ```160.73.250.210``` or an IPv6 address like ```2000:dc3b:4a9a:44f6:8036:89bc:c41f:a1c4```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```4c:04:27:fa:91:9f```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://beahan.org you initially access a DNS server to translate the host portion (beahan) combined with the Top Level Domain (org) of the URL, to an IP address like ```236.19.106.240```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (compatible; MSIE 9.0; AOL 9.7; AOLBuild 4343.19; Windows NT 6.1; WOW64; Trident/5.0; FunWebProducts)```
...
<pre>
default   fe80:ad5a:6d8c:2ecb:c2d7%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {186.83.176.40, 88.72.125.94}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 4c:04:27:fa:91:9f
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr aa:94:fd:c5:ba:d5
}</pre>
