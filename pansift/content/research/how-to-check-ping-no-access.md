...
layout: research
ip_v4_address: "112.234.46.255"
date: 2022-05-05T14:29:58+01:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like ```112.234.46.255``` or an IPv6 address like ```2000:432b:4bbc:8cab:c3dd:a0f7:6dcb:728e```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```be:63:e1:fb:f6:bb```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://glover.name you initially access a DNS server to translate the host portion (glover) combined with the Top Level Domain (name) of the URL, to an IP address like ```15.91.100.241```. Your computer and browser actually sends its type with all web requests e.g. <br>```Opera/9.80 (X11; Linux i686; Ubuntu/14.10) Presto/2.12.388 Version/12.16```
...
default  192.168.170.223    UGScg  en0
...
<pre>
default   fe80:38b9:b37d:ee34:df74%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {195.40.210.134, 109.41.109.103}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr be:63:e1:fb:f6:bb
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr fe:ca:75:18:5a:2a
}</pre>
