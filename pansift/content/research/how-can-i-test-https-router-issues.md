...
layout: research
ip_v4_address: "54.102.204.221"
date: 2022-11-19T16:17:25+00:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like ```54.102.204.221``` or an IPv6 address like ```2000:cd3a:9094:503d:a8d5:5e19:204d:457f```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```31:e1:c4:35:14:a2```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://fritsch-sanford.org you initially access a DNS server to translate the host portion (fritsch-sanford) combined with the Top Level Domain (org) of the URL, to an IP address like ```87.11.11.25```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT x.y; Win64; x64; rv:10.0) Gecko/20100101 Firefox/10.0```
...
<pre>
default   fe80:4697:d704:6f34:9b15%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {21.48.235.0, 212.184.74.192}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 31:e1:c4:35:14:a2
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr e2:d3:18:e1:33:25
}</pre>
