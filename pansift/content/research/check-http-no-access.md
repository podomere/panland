---
title: "Check Http No-access"
subtitle: "Swag?"
layout: research
ip_v4_address: "111.233.113.93"
date: 2022-04-24T19:00:03+01:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like <code>111.233.113.93</code> or an IPv6 address like <code>2000:7b88:b9bc:f023:1d5:2c7:71e2:3808</code>. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>d2:20:a4:16:d7:20</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://powlowski-douglas.org you initially access a DNS server to translate the host portion (powlowski-douglas) combined with the Top Level Domain (org) of the URL, to an IP address like <code>50.139.106.148</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (Windows NT 6.1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/41.0.2228.0 Safari/537.36</code>

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like <code>192.168.79.24</code> (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For <code>IPv6</code> we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  192.168.79.24    UGScg  en0
...
<pre><code>
default   fe80:7a40:1aeb:3df0:7116%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {177.187.133.215, 248.142.247.171}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr d2:20:a4:16:d7:20
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr a4:d6:de:c8:56:e2
}</code></pre>
...
## Apple macOS / OSX
No matter what version of OSX/macOS you are on, <code>10.11.1</code>, <code>11.5.5</code>, or <code>12.0.3</code>, there are a range of tools for troubleshooting. Unfortunately, between these manual actions and scripts, they don't give you a series of correlated values over time. This is where automated remote troubleshooting comes in to its own, especially for teams that embrace remote work and Work From Anywhere (WFA).
