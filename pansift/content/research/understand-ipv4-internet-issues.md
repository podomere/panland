...
subtitle: "Swag?"
layout: research
ip_v4_address: "38.215.72.71"
date: 2022-11-19T19:13:23+00:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like ```38.215.72.71``` or an IPv6 address like ```2000:cfba:2415:5b38:3c20:d1e7:4914:b7d```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```ac:fd:49:d6:63:22```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://lindgren-wiza.co you initially access a DNS server to translate the host portion (lindgren-wiza) combined with the Top Level Domain (co) of the URL, to an IP address like ```232.19.229.105```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/41.0.2228.0 Safari/537.36```
...
<pre>
default   fe80:f1cd:508:fb65:54d3%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {135.156.122.108, 28.130.234.91}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr ac:fd:49:d6:63:22
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr bd:0f:d3:c8:2c:56
}</pre>
