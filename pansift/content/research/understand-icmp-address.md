...
subtitle: "Branding?"
layout: research
ip_v4_address: "253.187.123.176"
date: 2022-04-24T19:00:00+01:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like <code>253.187.123.176</code> or an IPv6 address like <code>2000:e829:76a2:1aab:b562:4731:7ae7:8766</code>. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>04:f8:7e:ee:a1:38</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://considine-emmerich.biz you initially access a DNS server to translate the host portion (considine-emmerich) combined with the Top Level Domain (biz) of the URL, to an IP address like <code>227.91.183.124</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (Windows NT 6.1; WOW64; Trident/7.0; AS; rv:11.0) like Gecko</code>
...
<pre><code>
default   fe80:ebb2:e4ce:6079:18a6%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {114.182.7.135, 208.3.203.2}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 04:f8:7e:ee:a1:38
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr d1:2b:2c:19:50:5f
}</code></pre>
