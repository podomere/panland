...
layout: research
ip_v4_address: "243.255.218.223"
date: 2022-05-05T14:28:26+01:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like ```243.255.218.223``` or an IPv6 address like ```2000:ca74:1f50:2254:96b3:766c:5b49:32d```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```8e:ea:70:10:64:8a```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://schinner.org you initially access a DNS server to translate the host portion (schinner) combined with the Top Level Domain (org) of the URL, to an IP address like ```238.214.201.162```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (compatible; MSIE 9.0; AOL 9.7; AOLBuild 4343.19; Windows NT 6.1; WOW64; Trident/5.0; FunWebProducts)```
...
<pre>
default   fe80:91e6:10d2:bbad:5430%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {2.239.207.236, 241.229.133.47}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 8e:ea:70:10:64:8a
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 32:f8:8c:ee:e8:85
}</pre>
