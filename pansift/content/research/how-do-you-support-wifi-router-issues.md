...
subtitle: "Synergy?"
layout: research
ip_v4_address: "169.13.134.215"
date: 2022-11-02T11:32:24+00:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like ```169.13.134.215``` or an IPv6 address like ```2000:ce1f:e265:418c:2f2e:8a4d:3bf9:b5a6```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```e3:4d:3a:83:ba:90```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://kilback-batz.co you initially access a DNS server to translate the host portion (kilback-batz) combined with the Top Level Domain (co) of the URL, to an IP address like ```63.104.202.219```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (compatible; MSIE 9.0; AOL 9.7; AOLBuild 4343.19; Windows NT 6.1; WOW64; Trident/5.0; FunWebProducts)```
...
default  172.31.14.36    UGScg  en0
...
<pre>
default   fe80:cef:c3bf:8d41:27c%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {48.253.39.20, 81.13.50.230}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr e3:4d:3a:83:ba:90
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr d2:fc:ae:29:7f:94
}</pre>
