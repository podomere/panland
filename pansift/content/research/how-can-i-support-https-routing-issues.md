...
layout: research
ip_v4_address: "143.55.100.210"
date: 2022-06-04T14:38:44+01:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like ```143.55.100.210``` or an IPv6 address like ```2000:34b1:6f0f:9f14:7a50:8f65:162c:a1e8```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```ae:c2:3a:09:32:91```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://mraz-lind.io you initially access a DNS server to translate the host portion (mraz-lind) combined with the Top Level Domain (io) of the URL, to an IP address like ```227.84.251.134```. Your computer and browser actually sends its type with all web requests e.g. <br>```Opera/9.80 (X11; Linux i686; Ubuntu/14.10) Presto/2.12.388 Version/12.16```
...
<pre>
default   fe80:aa43:b6f0:2e9a:c9e9%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {129.54.120.224, 252.212.252.136}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr ae:c2:3a:09:32:91
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 56:5a:1e:e2:a0:96
}</pre>
