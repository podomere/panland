...
layout: research
ip_v4_address: "248.76.116.139"
date: 2022-06-04T14:38:37+01:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like ```248.76.116.139``` or an IPv6 address like ```2000:4463:1c22:6d64:64c0:4f79:564b:eaff```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```c2:bb:a7:f3:38:04```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://turcotte.biz you initially access a DNS server to translate the host portion (turcotte) combined with the Top Level Domain (biz) of the URL, to an IP address like ```94.229.92.111```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1; WOW64; Trident/7.0; AS; rv:11.0) like Gecko```
...
<pre>
default   fe80:bcc6:35b2:229d:5c6e%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {111.184.44.8, 228.61.49.236}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr c2:bb:a7:f3:38:04
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 06:58:bf:60:06:47
}</pre>
