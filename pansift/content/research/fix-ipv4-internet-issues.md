...
layout: research
ip_v4_address: "44.17.124.102"
date: 2022-11-19T16:17:20+00:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like ```44.17.124.102``` or an IPv6 address like ```2000:9639:cbd6:21e5:4dca:5eae:fe09:4768```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```0b:12:1d:ac:20:13```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://beer-schiller.net you initially access a DNS server to translate the host portion (beer-schiller) combined with the Top Level Domain (net) of the URL, to an IP address like ```109.252.222.96```. Your computer and browser actually sends its type with all web requests e.g. <br>```Opera/9.80 (X11; Linux i686; Ubuntu/14.10) Presto/2.12.388 Version/12.16```
...
<pre>
default   fe80:a3d0:636e:b3dc:927c%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {38.141.29.63, 86.215.37.196}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 0b:12:1d:ac:20:13
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 2e:4d:1a:20:88:4e
}</pre>
