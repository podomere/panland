...
subtitle: "Learnings?"
layout: research
ip_v4_address: "171.108.54.224"
date: 2022-12-15T13:50:17+00:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like ```171.108.54.224``` or an IPv6 address like ```2000:8212:8239:6680:20c4:6d87:5c70:d2c8```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```1c:41:ea:fa:4c:93```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://bogisich-smith.co you initially access a DNS server to translate the host portion (bogisich-smith) combined with the Top Level Domain (co) of the URL, to an IP address like ```218.39.176.16```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1; WOW64; Trident/7.0; AS; rv:11.0) like Gecko```
...
<pre>
default   fe80:72bb:72b5:4aa0:50ae%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {247.46.114.70, 96.61.63.91}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 1c:41:ea:fa:4c:93
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr b5:dd:fe:6e:13:e0
}</pre>
