...
layout: research
ip_v4_address: "235.42.84.125"
date: 2023-10-29T15:13:27+00:00
draft: false
---

## Internet Addressing
On the Internet you might get a Public IPv4 address like ```235.42.84.125``` or an IPv6 address like ```2000:3517:ad9a:1128:daa4:32e3:23f8:c661```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```59:cf:87:b4:98:db```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://lockman.info you initially access a DNS server to translate the host portion (lockman) combined with the Top Level Domain (info) of the URL, to an IP address like ```12.184.241.131```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT x.y; Win64; x64; rv:10.0) Gecko/20100101 Firefox/10.0```

## Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```172.22.189.126``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  172.22.189.126    UGScg  en0
...
<pre>
default   fe80:2bc9:2b92:9fbf:d58b%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {92.214.212.104, 111.254.17.61}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 59:cf:87:b4:98:db
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 35:53:ba:63:d4:1e
}</pre>
...
### Apple macOS / OSX
No matter what version of OSX/macOS you are on, ```10.15.9```, ```11.3.1```, or ```12.0.2```, there are a range of tools for troubleshooting. Unfortunately, between these manual actions and scripts, they don't give you a series of correlated values over time. This is where automated remote troubleshooting comes in to its own, especially for teams that embrace remote work and Work From Anywhere (WFA).
