...
layout: research
ip_v4_address: "127.160.162.6"
date: 2022-06-04T14:38:16+01:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like ```127.160.162.6``` or an IPv6 address like ```2000:51ef:a5ea:cd65:38b0:ffd3:b3d4:85e3```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```be:cf:c3:40:33:b8```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://stroman-stracke.name you initially access a DNS server to translate the host portion (stroman-stracke) combined with the Top Level Domain (name) of the URL, to an IP address like ```74.97.243.139```. Your computer and browser actually sends its type with all web requests e.g. <br>```Opera/9.80 (X11; Linux i686; Ubuntu/14.10) Presto/2.12.388 Version/12.16```
...
<pre>
default   fe80:eca5:3aa3:6c2a:37f8%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {164.248.132.66, 250.107.69.173}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr be:cf:c3:40:33:b8
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr d7:d6:a6:f9:4c:3b
}</pre>
