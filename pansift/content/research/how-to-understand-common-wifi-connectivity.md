...
layout: research
ip_v4_address: "133.222.1.41"
date: 2022-04-24T18:32:41+01:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like <code>133.222.1.41</code> or an IPv6 address like <code>2000:c914:3d82:6b21:8b46:d87:98a9:f3b</code>. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>ba:f0:4a:66:a6:2c</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://ritchie-prohaska.com you initially access a DNS server to translate the host portion (ritchie-prohaska) combined with the Top Level Domain (com) of the URL, to an IP address like <code>133.159.31.35</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Opera/9.80 (X11; Linux i686; Ubuntu/14.10) Presto/2.12.388 Version/12.16</code>
...
<pre><code>
default   fe80:f66a:1c94:6b18:3a58%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {154.8.168.84, 69.16.188.33}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr ba:f0:4a:66:a6:2c
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr b7:35:e5:1b:22:82
}</code></pre>
