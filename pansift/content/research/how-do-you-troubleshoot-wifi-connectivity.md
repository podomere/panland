...
subtitle: "Tee It Up?"
layout: research
ip_v4_address: "108.87.214.158"
date: 2023-10-06T17:10:30+01:00
draft: false
---

## Internet Addressing
On the Internet you may get a Public IPv4 address like ```108.87.214.158``` or an IPv6 address like ```2000:6929:aa82:9866:e301:7fad:c771:816d```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```15:46:be:ce:ea:a2```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://ohara-greenholt.io you initially access a DNS server to translate the host portion (ohara-greenholt) combined with the Top Level Domain (io) of the URL, to an IP address like ```233.202.111.16```. Your computer and browser actually sends its type with all web requests e.g. <br>```Opera/9.80 (X11; Linux i686; Ubuntu/14.10) Presto/2.12.388 Version/12.16```
...
<pre>
default   fe80:4814:b2d:fd34:2bbb%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {130.121.75.78, 41.104.35.70}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 15:46:be:ce:ea:a2
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr b7:de:64:23:93:1f
}</pre>
