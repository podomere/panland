...
layout: research
ip_v4_address: "248.11.203.155"
date: 2023-10-29T15:13:25+00:00
draft: false
---

## Internet Addressing
On the Internet you may get a Public IPv4 address like ```248.11.203.155``` or an IPv6 address like ```2000:38f9:9929:8cc:de3f:bf7c:3683:c38e```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```2f:56:45:9d:cf:16```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://osinski-konopelski.name you initially access a DNS server to translate the host portion (osinski-konopelski) combined with the Top Level Domain (name) of the URL, to an IP address like ```245.232.93.43```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/41.0.2228.0 Safari/537.36```
...
<pre>
default   fe80:9ede:d5c5:c00e:5a5e%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {202.141.66.23, 43.16.168.97}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 2f:56:45:9d:cf:16
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 39:b4:8c:48:c4:18
}</pre>
