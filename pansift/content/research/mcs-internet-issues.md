...
subtitle: "Deep Dive?"
layout: research
ip_v4_address: "188.74.8.43"
date: 2022-11-19T19:13:09+00:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like ```188.74.8.43``` or an IPv6 address like ```2000:ab13:a16d:fa8e:2e5a:41ca:481:16d9```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```c6:ee:63:ed:b5:3d```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://rodriguez.io you initially access a DNS server to translate the host portion (rodriguez) combined with the Top Level Domain (io) of the URL, to an IP address like ```238.97.138.200```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT x.y; Win64; x64; rv:10.0) Gecko/20100101 Firefox/10.0```

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```192.168.188.219``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  192.168.188.219    UGScg  en0
...
<pre>
default   fe80:5840:75c0:e148:d708%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {44.115.224.208, 126.42.169.203}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr c6:ee:63:ed:b5:3d
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 1a:ff:1e:cf:03:18
}</pre>
