...
layout: research
ip_v4_address: "23.143.113.173"
date: 2023-02-04T17:08:37+00:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like ```23.143.113.173``` or an IPv6 address like ```2000:38dd:8592:6b5f:b680:6f99:5779:9039```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```2d:aa:c0:0b:84:17```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://crooks-kertzmann.org you initially access a DNS server to translate the host portion (crooks-kertzmann) combined with the Top Level Domain (org) of the URL, to an IP address like ```108.16.54.59```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1; WOW64; Trident/7.0; AS; rv:11.0) like Gecko```
...
<pre>
default   fe80:f96c:4459:f412:e67d%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {54.90.39.159, 214.176.237.163}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 2d:aa:c0:0b:84:17
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 22:38:2b:42:3a:db
}</pre>
