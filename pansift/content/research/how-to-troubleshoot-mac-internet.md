...
layout: research
ip_v4_address: "200.109.216.216"
date: 2022-06-04T14:38:30+01:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like ```200.109.216.216``` or an IPv6 address like ```2000:d49f:b450:10ab:5ef3:cd05:5866:e38```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```b8:e0:4e:03:c3:3d```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://tillman.name you initially access a DNS server to translate the host portion (tillman) combined with the Top Level Domain (name) of the URL, to an IP address like ```121.216.111.159```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows; U; Win 9x 4.90; SG; rv:1.9.2.4) Gecko/20101104 Netscape/9.1.0285```
...
<pre>
default   fe80:d2c7:37a6:e90f:d313%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {141.207.185.196, 117.53.167.123}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr b8:e0:4e:03:c3:3d
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 96:16:b2:d4:90:17
}</pre>
...
## Apple macOS / OSX
No matter what version of OSX/macOS you are on, ```10.14.9```, ```11.4.3```, or ```12.1.8```, there are a range of tools for troubleshooting. Unfortunately, between these manual actions and scripts, they don't give you a series of correlated values over time. This is where automated remote troubleshooting comes in to its own, especially for teams that embrace remote work and Work From Anywhere (WFA).
