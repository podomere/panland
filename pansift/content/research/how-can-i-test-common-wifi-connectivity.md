...
layout: research
ip_v4_address: "150.209.170.174"
date: 2022-04-24T18:32:41+01:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like <code>150.209.170.174</code> or an IPv6 address like <code>2000:4844:e3c8:6782:9814:93e:a05c:eb3c</code>. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>e5:f7:0b:83:90:65</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://windler.info you initially access a DNS server to translate the host portion (windler) combined with the Top Level Domain (info) of the URL, to an IP address like <code>232.214.237.97</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (Windows NT 6.1; WOW64; Trident/7.0; AS; rv:11.0) like Gecko</code>
...
<pre><code>
default   fe80:69d7:27af:4ef6:e417%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {165.11.120.187, 131.110.233.51}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr e5:f7:0b:83:90:65
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr a4:9d:a1:b9:fc:64
}</code></pre>
