...
subtitle: "Granular?"
layout: research
ip_v4_address: "122.195.8.136"
date: 2023-10-06T17:11:03+01:00
draft: false
---

## Internet Addressing
On the Internet you may have a Public IPv4 address like ```122.195.8.136``` or an IPv6 address like ```2000:3694:6c6e:c695:419f:c487:9b57:3ddd```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```2c:4a:2f:fd:f2:ef```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://sporer-wuckert.info you initially access a DNS server to translate the host portion (sporer-wuckert) combined with the Top Level Domain (info) of the URL, to an IP address like ```207.149.76.209```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_3) AppleWebKit/537.75.14 (KHTML, like Gecko) Version/7.0.3 Safari/7046A194A```
...
<pre>
default   fe80:87f4:7abf:5e49:c10a%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {141.203.240.24, 83.226.186.166}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 2c:4a:2f:fd:f2:ef
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr be:b2:70:31:d8:dd
}</pre>
