...
layout: research
ip_v4_address: "249.222.65.153"
date: 2022-11-19T19:13:16+00:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like ```249.222.65.153``` or an IPv6 address like ```2000:216d:8de7:3983:d77e:c7e8:c34a:32ed```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```94:ee:24:a0:9c:e2```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://nienow-heathcote.org you initially access a DNS server to translate the host portion (nienow-heathcote) combined with the Top Level Domain (org) of the URL, to an IP address like ```249.14.253.89```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_3) AppleWebKit/537.75.14 (KHTML, like Gecko) Version/7.0.3 Safari/7046A194A```
...
<pre>
default   fe80:4e32:779b:3982:dffb%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {47.208.38.243, 2.23.58.180}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 94:ee:24:a0:9c:e2
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 12:75:3d:86:57:76
}</pre>
