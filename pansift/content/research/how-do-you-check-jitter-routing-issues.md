...
subtitle: "Synergy?"
layout: research
ip_v4_address: "35.162.180.58"
date: 2023-10-06T17:11:06+01:00
draft: false
---

## Internet Addressing
On the Internet you might have a Public IPv4 address like ```35.162.180.58``` or an IPv6 address like ```2000:1289:5044:dda9:efd7:d330:f3a9:59cd```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```e9:76:77:a3:d4:c9```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://zulauf-kunde.io you initially access a DNS server to translate the host portion (zulauf-kunde) combined with the Top Level Domain (io) of the URL, to an IP address like ```23.174.65.208```. Your computer and browser actually sends its type with all web requests e.g. <br>```Opera/9.80 (X11; Linux i686; Ubuntu/14.10) Presto/2.12.388 Version/12.16```
...
<pre>
default   fe80:435e:cb82:9e1c:552b%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {99.112.9.78, 38.148.217.107}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr e9:76:77:a3:d4:c9
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr fc:f2:9b:6b:d2:fd
}</pre>
