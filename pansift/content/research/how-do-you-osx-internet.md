...
layout: research
ip_v4_address: "28.217.152.208"
date: 2022-11-02T11:33:11+00:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like ```28.217.152.208``` or an IPv6 address like ```2000:b375:8f7c:3f80:31ff:854f:55:bd26```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```81:2b:3f:19:d1:dc```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://lindgren-schroeder.org you initially access a DNS server to translate the host portion (lindgren-schroeder) combined with the Top Level Domain (org) of the URL, to an IP address like ```179.176.151.203```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows; U; Win 9x 4.90; SG; rv:1.9.2.4) Gecko/20101104 Netscape/9.1.0285```
...
<pre>
default   fe80:c420:7018:83e8:5433%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {79.46.67.174, 101.165.167.170}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 81:2b:3f:19:d1:dc
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr d0:f6:51:14:ac:b5
}</pre>
