...
layout: research
ip_v4_address: "36.99.165.39"
date: 2022-06-04T14:38:44+01:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like ```36.99.165.39``` or an IPv6 address like ```2000:975f:5cb6:22d4:b0de:73e6:725b:4b25```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```11:0b:83:30:f4:07```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://kerluke.name you initially access a DNS server to translate the host portion (kerluke) combined with the Top Level Domain (name) of the URL, to an IP address like ```93.230.249.29```. Your computer and browser actually sends its type with all web requests e.g. <br>```Opera/9.80 (X11; Linux i686; Ubuntu/14.10) Presto/2.12.388 Version/12.16```

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```10.247.179.217``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  10.247.179.217    UGScg  en0
...
<pre>
default   fe80:1864:2acb:f877:7730%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {191.246.125.245, 87.232.35.4}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 11:0b:83:30:f4:07
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 26:27:5f:8e:a4:1b
}</pre>
