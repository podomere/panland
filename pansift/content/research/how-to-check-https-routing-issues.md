...
layout: research
ip_v4_address: "72.209.168.118"
date: 2022-11-19T19:13:29+00:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like ```72.209.168.118``` or an IPv6 address like ```2000:7ebc:1958:90d0:d414:bac1:a1bd:90d0```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```15:23:03:23:bf:a0```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://kovacek-nitzsche.biz you initially access a DNS server to translate the host portion (kovacek-nitzsche) combined with the Top Level Domain (biz) of the URL, to an IP address like ```229.253.143.191```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1; WOW64; Trident/7.0; AS; rv:11.0) like Gecko```
...
<pre>
default   fe80:9e86:2054:3cf2:d4c2%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {167.156.193.117, 14.52.32.159}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 15:23:03:23:bf:a0
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 58:bf:f2:fd:95:97
}</pre>
