...
layout: research
ip_v4_address: "24.86.132.136"
date: 2022-04-24T18:59:57+01:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like <code>24.86.132.136</code> or an IPv6 address like <code>2000:6d6:403:3ad5:3dc3:563b:c246:d2cf</code>. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>69:00:93:48:4e:0a</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://sawayn-harris.org you initially access a DNS server to translate the host portion (sawayn-harris) combined with the Top Level Domain (org) of the URL, to an IP address like <code>239.192.201.99</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (compatible; MSIE 9.0; AOL 9.7; AOLBuild 4343.19; Windows NT 6.1; WOW64; Trident/5.0; FunWebProducts)</code>
...
<pre><code>
default   fe80:f189:ff29:d182:4039%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {235.52.208.218, 250.117.222.150}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 69:00:93:48:4e:0a
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr e9:72:27:3e:f6:2e
}</code></pre>
