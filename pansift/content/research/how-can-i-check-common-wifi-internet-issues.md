...
layout: research
ip_v4_address: "125.122.249.2"
date: 2022-06-04T14:38:17+01:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like ```125.122.249.2``` or an IPv6 address like ```2000:7e02:ee8d:8710:6649:5c27:cd60:83a3```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```c3:c2:bd:10:0e:7d```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://bogisich-purdy.info you initially access a DNS server to translate the host portion (bogisich-purdy) combined with the Top Level Domain (info) of the URL, to an IP address like ```127.66.32.54```. Your computer and browser actually sends its type with all web requests e.g. <br>```Opera/9.80 (X11; Linux i686; Ubuntu/14.10) Presto/2.12.388 Version/12.16```
...
<pre>
default   fe80:20e9:f9b4:1106:2a4%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {187.157.179.149, 139.145.25.226}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr c3:c2:bd:10:0e:7d
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 40:86:2e:e4:d0:a5
}</pre>
