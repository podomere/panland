...
subtitle: "Streamline?"
layout: research
ip_v4_address: "149.203.208.238"
date: 2022-11-19T16:17:12+00:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like ```149.203.208.238``` or an IPv6 address like ```2000:a7d8:6b85:3b35:2748:c93c:2a35:c153```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```73:88:51:79:8d:5d```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://steuber-leannon.net you initially access a DNS server to translate the host portion (steuber-leannon) combined with the Top Level Domain (net) of the URL, to an IP address like ```4.48.120.190```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT x.y; Win64; x64; rv:10.0) Gecko/20100101 Firefox/10.0```
...
<pre>
default   fc18:decf:8130:33:946a:dd0a:4fa0:7e88%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {38.208.88.143, 182.91.231.96}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 73:88:51:79:8d:5d
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 85:db:ea:94:b2:1c
}</pre>
