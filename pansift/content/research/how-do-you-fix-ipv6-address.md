...
layout: research
ip_v4_address: "49.104.67.82"
date: 2023-02-04T16:26:18+00:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like ```49.104.67.82``` or an IPv6 address like ```2000:74a1:d3b2:d252:dd52:1ded:57e0:b45f```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```5a:20:12:a5:b4:14```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://spencer-greenholt.info you initially access a DNS server to translate the host portion (spencer-greenholt) combined with the Top Level Domain (info) of the URL, to an IP address like ```41.115.171.229```. Your computer and browser actually sends its type with all web requests e.g. <br>```Opera/9.80 (X11; Linux i686; Ubuntu/14.10) Presto/2.12.388 Version/12.16```
...
<pre>
default   fe80:1824:2c1c:975d:4a93%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {115.2.31.172, 189.155.87.183}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 5a:20:12:a5:b4:14
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 54:16:ef:6c:e0:7e
}</pre>
