...
layout: research
ip_v4_address: "129.135.227.111"
date: 2022-06-04T14:38:30+01:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like ```129.135.227.111``` or an IPv6 address like ```2000:9d8f:13f9:819:19f3:da1f:2a6e:6f9d```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```b6:01:83:a5:65:df```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://roob-mills.io you initially access a DNS server to translate the host portion (roob-mills) combined with the Top Level Domain (io) of the URL, to an IP address like ```225.183.134.249```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT x.y; Win64; x64; rv:10.0) Gecko/20100101 Firefox/10.0```

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```172.29.201.238``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  172.29.201.238    UGScg  en0
...
<pre>
default   fe80:5714:62ae:1fa3:de34%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {149.16.229.227, 186.198.62.227}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr b6:01:83:a5:65:df
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 1d:5a:5e:4c:39:bb
}</pre>
