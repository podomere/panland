...
layout: research
ip_v4_address: "156.108.132.220"
date: 2022-04-24T18:32:41+01:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like <code>156.108.132.220</code> or an IPv6 address like <code>2000:31:5349:3a39:1c3:74b9:11fb:87c8</code>. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>b6:c0:66:23:e8:ab</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://herman-thompson.com you initially access a DNS server to translate the host portion (herman-thompson) combined with the Top Level Domain (com) of the URL, to an IP address like <code>64.189.222.227</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (Windows; U; Win 9x 4.90; SG; rv:1.9.2.4) Gecko/20101104 Netscape/9.1.0285</code>
...
<pre><code>
default   fe80:b3f7:c18b:fd00:3710%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {134.147.191.228, 215.52.20.41}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr b6:c0:66:23:e8:ab
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 7a:12:9e:f5:b1:53
}</code></pre>
