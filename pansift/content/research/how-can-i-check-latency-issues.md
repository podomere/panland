...
layout: research
ip_v4_address: "78.84.137.48"
date: 2022-06-04T14:38:39+01:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like ```78.84.137.48``` or an IPv6 address like ```2000:efbd:317e:6ca9:4247:a9a1:1a75:fef2```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```5d:01:0f:c5:d1:27```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://fritsch-cole.io you initially access a DNS server to translate the host portion (fritsch-cole) combined with the Top Level Domain (io) of the URL, to an IP address like ```255.205.23.75```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows; U; Win 9x 4.90; SG; rv:1.9.2.4) Gecko/20101104 Netscape/9.1.0285```
...
default  172.30.34.149    UGScg  en0
...
<pre>
default   fe80:8437:36e:5ff5:c15d%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {202.23.18.129, 183.233.186.163}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 5d:01:0f:c5:d1:27
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 7b:2c:a7:39:cd:53
}</pre>
...
## Apple macOS / OSX
No matter what version of OSX/macOS you are on, ```10.15.5```, ```11.5.3```, or ```12.3.8```, there are a range of tools for troubleshooting. Unfortunately, between these manual actions and scripts, they don't give you a series of correlated values over time. This is where automated remote troubleshooting comes in to its own, especially for teams that embrace remote work and Work From Anywhere (WFA).
