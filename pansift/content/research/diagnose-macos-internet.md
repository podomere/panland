...
layout: research
ip_v4_address: "192.143.133.253"
date: 2022-05-05T14:28:43+01:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like ```192.143.133.253``` or an IPv6 address like ```2000:28a4:3b08:588:463d:b4c8:41c0:61d0```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```ce:35:f1:28:0a:8c```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://mitchell-prosacco.info you initially access a DNS server to translate the host portion (mitchell-prosacco) combined with the Top Level Domain (info) of the URL, to an IP address like ```219.215.229.223```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_3) AppleWebKit/537.75.14 (KHTML, like Gecko) Version/7.0.3 Safari/7046A194A```

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```172.24.44.122``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  172.24.44.122    UGScg  en0
...
<pre>
default   fe80:deb6:985a:2a9f:84fb%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {220.243.4.156, 226.7.200.43}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr ce:35:f1:28:0a:8c
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr c9:14:4d:5f:0f:88
}</pre>
