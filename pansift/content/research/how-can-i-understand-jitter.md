...
subtitle: "Streamline?"
layout: research
ip_v4_address: "123.82.204.21"
date: 2023-02-04T16:26:20+00:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like ```123.82.204.21``` or an IPv6 address like ```2000:29ea:c917:9341:7327:d79f:43b1:e423```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```e4:81:98:71:cf:b9```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://lindgren.name you initially access a DNS server to translate the host portion (lindgren) combined with the Top Level Domain (name) of the URL, to an IP address like ```4.7.178.173```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT x.y; Win64; x64; rv:10.0) Gecko/20100101 Firefox/10.0```
...
default  172.18.175.54    UGScg  en0
...
<pre>
default   fe80:2dfa:7219:cc7:a467%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {106.97.250.213, 101.29.179.128}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr e4:81:98:71:cf:b9
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 25:a5:b1:83:a1:77
}</pre>
