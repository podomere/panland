...
layout: research
ip_v4_address: "177.62.222.87"
date: 2023-10-06T17:10:43+01:00
draft: false
---

## Internet Addressing
On the Internet you might get a Public IPv4 address like ```177.62.222.87``` or an IPv6 address like ```2000:14e1:e58b:753f:6180:caca:45d9:bcd9```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```6f:66:29:a2:0a:15```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://kutch-zieme.org you initially access a DNS server to translate the host portion (kutch-zieme) combined with the Top Level Domain (org) of the URL, to an IP address like ```245.198.136.169```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1; WOW64; Trident/7.0; AS; rv:11.0) like Gecko```
...
<pre>
default   fe80:5875:75c5:24e6:e0df%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {76.196.43.118, 191.190.127.134}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 6f:66:29:a2:0a:15
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr eb:86:be:cd:6d:e8
}</pre>
