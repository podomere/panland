...
subtitle: "Branding?"
layout: research
ip_v4_address: "121.165.160.249"
date: 2022-04-24T19:00:33+01:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like <code>121.165.160.249</code> or an IPv6 address like <code>2000:6d4f:64b3:b30c:80ff:7dd4:1b89:fe5a</code>. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>19:0e:d1:fc:9b:30</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://waelchi-corwin.net you initially access a DNS server to translate the host portion (waelchi-corwin) combined with the Top Level Domain (net) of the URL, to an IP address like <code>250.180.5.229</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (Windows NT 6.1; WOW64; Trident/7.0; AS; rv:11.0) like Gecko</code>
...
<pre><code>
default   fe80:85e9:8cda:5587:dc2d%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {171.168.44.103, 105.5.90.108}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 19:0e:d1:fc:9b:30
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 37:4f:f6:bd:74:9e
}</code></pre>
