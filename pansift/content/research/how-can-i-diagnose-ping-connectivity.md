...
layout: research
ip_v4_address: "14.28.179.92"
date: 2022-12-15T13:50:20+00:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like ```14.28.179.92``` or an IPv6 address like ```2000:aa24:4ec2:5c98:9c45:6213:d385:b699```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```44:41:99:3a:6b:82```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://rippin-hagenes.name you initially access a DNS server to translate the host portion (rippin-hagenes) combined with the Top Level Domain (name) of the URL, to an IP address like ```94.61.93.235```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/41.0.2228.0 Safari/537.36```
...
<pre>
default   fe80:53b9:b63f:14f6:a70b%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {1.161.156.34, 154.160.197.224}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 44:41:99:3a:6b:82
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 1b:78:0f:a7:d3:5d
}</pre>
