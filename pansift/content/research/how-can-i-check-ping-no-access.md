---
title: "How Can I Check Ping No-access"
subtitle: "Circle Back?"
layout: research
ip_v4_address: "25.22.64.191"
date: 2022-04-24T19:00:02+01:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like <code>25.22.64.191</code> or an IPv6 address like <code>2000:5caa:944d:32a8:c44f:2f34:31bd:7dd2</code>. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>a5:b8:6e:47:98:64</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://harris-heidenreich.net you initially access a DNS server to translate the host portion (harris-heidenreich) combined with the Top Level Domain (net) of the URL, to an IP address like <code>29.59.69.23</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (Windows NT 6.1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/41.0.2228.0 Safari/537.36</code>

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like <code>10.181.79.101</code> (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For <code>IPv6</code> we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  10.181.79.101    UGScg  en0
...
<pre><code>
default   fe80:fcae:b298:5732:ac1d%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {51.134.164.253, 202.21.189.83}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr a5:b8:6e:47:98:64
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 5d:a3:11:a3:65:39
}</code></pre>
