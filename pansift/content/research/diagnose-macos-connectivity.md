...
layout: research
ip_v4_address: "77.131.150.208"
date: 2022-04-24T18:31:57+01:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like <code>77.131.150.208</code> or an IPv6 address like <code>2000:25a8:27f7:963:eabe:eb9b:69d6:5b6f</code>. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>10:e2:1d:90:66:69</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://ebert.io you initially access a DNS server to translate the host portion (ebert) combined with the Top Level Domain (io) of the URL, to an IP address like <code>35.166.225.39</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Opera/9.80 (X11; Linux i686; Ubuntu/14.10) Presto/2.12.388 Version/12.16</code>

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like <code>10.182.145.76</code> (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For <code>IPv6</code> we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  10.182.145.76    UGScg  en0
...
<pre><code>
default   fe80:1916:f048:14c4:b6ce%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {232.232.193.127, 95.17.17.94}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 10:e2:1d:90:66:69
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 37:74:4a:0d:70:34
}</code></pre>
