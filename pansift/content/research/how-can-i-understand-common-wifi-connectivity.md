...
subtitle: "Deep Dive?"
layout: research
ip_v4_address: "188.214.218.51"
date: 2022-06-04T14:38:17+01:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like ```188.214.218.51``` or an IPv6 address like ```2000:36f6:8af5:54ef:f16f:4b03:a9dd:2f02```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```ae:04:30:c5:5f:a6```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://lind-reichert.io you initially access a DNS server to translate the host portion (lind-reichert) combined with the Top Level Domain (io) of the URL, to an IP address like ```12.105.50.187```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/41.0.2228.0 Safari/537.36```
...
<pre>
default   fe80:2fb8:e68d:ea5c:efff%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {60.25.6.255, 243.86.58.120}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr ae:04:30:c5:5f:a6
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 74:dd:d4:c0:36:33
}</pre>
