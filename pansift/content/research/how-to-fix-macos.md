...
layout: research
ip_v4_address: "78.90.73.75"
date: 2022-11-19T19:13:15+00:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like ```78.90.73.75``` or an IPv6 address like ```2000:4c9:4684:d0be:58f3:6a3e:3efe:4e52```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```fa:69:0b:09:30:09```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://nader-fadel.biz you initially access a DNS server to translate the host portion (nader-fadel) combined with the Top Level Domain (biz) of the URL, to an IP address like ```62.247.214.139```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1; WOW64; Trident/7.0; AS; rv:11.0) like Gecko```
...
default  172.28.103.180    UGScg  en0
...
<pre>
default   fe80:bd75:b554:70e4:d101%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {31.85.212.172, 138.1.8.27}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr fa:69:0b:09:30:09
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr c0:c1:5e:11:26:49
}</pre>
