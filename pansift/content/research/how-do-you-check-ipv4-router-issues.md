---
title: "How Do You Check IPv4 Router Issues"
subtitle: "Synergy?"
layout: research
ip_v4_address: "87.116.55.134"
date: 2022-04-24T18:59:57+01:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like <code>87.116.55.134</code> or an IPv6 address like <code>2000:1d34:331a:32ca:75de:724b:c04d:3a28</code>. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>e9:ae:8e:3c:cd:84</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://sauer-hessel.name you initially access a DNS server to translate the host portion (sauer-hessel) combined with the Top Level Domain (name) of the URL, to an IP address like <code>29.130.87.25</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (Windows NT 6.1; WOW64; Trident/7.0; AS; rv:11.0) like Gecko</code>

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like <code>192.168.216.82</code> (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For <code>IPv6</code> we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  192.168.216.82    UGScg  en0
...
<pre><code>
default   fe80:7ad7:252c:e333:f3aa%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {210.76.79.172, 93.230.119.148}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr e9:ae:8e:3c:cd:84
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr f8:29:1e:b9:a4:4c
}</code></pre>
