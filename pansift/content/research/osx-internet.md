...
subtitle: "Deep Dive?"
layout: research
ip_v4_address: "60.66.86.1"
date: 2022-05-05T14:28:48+01:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like ```60.66.86.1``` or an IPv6 address like ```2000:d6e4:bfeb:3cc:1879:e98c:9ea6:bdbc```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```ad:a4:5c:ef:1f:97```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://brown-marks.biz you initially access a DNS server to translate the host portion (brown-marks) combined with the Top Level Domain (biz) of the URL, to an IP address like ```26.65.229.67```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_3) AppleWebKit/537.75.14 (KHTML, like Gecko) Version/7.0.3 Safari/7046A194A```

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```10.217.213.185``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  10.217.213.185    UGScg  en0
...
<pre>
default   fe80:1805:6af9:451:ef8f%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {0.177.12.5, 217.27.247.173}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr ad:a4:5c:ef:1f:97
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 80:b5:e3:6a:39:88
}</pre>
