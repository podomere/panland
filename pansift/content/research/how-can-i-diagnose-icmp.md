...
layout: research
ip_v4_address: "150.118.230.104"
date: 2023-10-06T17:11:06+01:00
draft: false
---

## Internet Addressing
On the Internet you may get a Public IPv4 address like ```150.118.230.104``` or an IPv6 address like ```2000:7793:63da:2608:3104:abc8:dd67:acc2```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```5b:19:d4:74:58:63```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://kuvalis.info you initially access a DNS server to translate the host portion (kuvalis) combined with the Top Level Domain (info) of the URL, to an IP address like ```63.169.54.51```. Your computer and browser actually sends its type with all web requests e.g. <br>```Opera/9.80 (X11; Linux i686; Ubuntu/14.10) Presto/2.12.388 Version/12.16```
...
<pre>
default   fe80:26fa:f1e6:d974:f01a%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {68.12.241.17, 112.16.199.149}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 5b:19:d4:74:58:63
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr b7:92:67:5d:ff:d7
}</pre>
