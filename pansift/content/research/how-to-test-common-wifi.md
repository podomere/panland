...
layout: research
ip_v4_address: "40.40.170.160"
date: 2023-02-04T16:26:03+00:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like ```40.40.170.160``` or an IPv6 address like ```2000:62cd:835b:c51e:469b:65b6:364f:6c4```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```d3:aa:d9:bb:02:c1```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://okuneva-haley.io you initially access a DNS server to translate the host portion (okuneva-haley) combined with the Top Level Domain (io) of the URL, to an IP address like ```3.77.188.127```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/41.0.2228.0 Safari/537.36```
...
<pre>
default   fe80:d052:f51f:1b47:4076%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {125.133.43.27, 250.223.169.136}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr d3:aa:d9:bb:02:c1
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr fa:a0:3f:eb:ba:08
}</pre>
