...
layout: research
ip_v4_address: "40.97.104.210"
date: 2023-10-06T17:11:07+01:00
draft: false
---

## Internet Addressing
On the Internet you may get a Public IPv4 address like ```40.97.104.210``` or an IPv6 address like ```2000:1a48:61b:7b5:5abe:60e4:b427:c4fc```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```6b:34:00:00:19:90```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://dooley.name you initially access a DNS server to translate the host portion (dooley) combined with the Top Level Domain (name) of the URL, to an IP address like ```254.75.172.128```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (compatible; MSIE 9.0; AOL 9.7; AOLBuild 4343.19; Windows NT 6.1; WOW64; Trident/5.0; FunWebProducts)```
...
<pre>
default   fe80:c36a:595b:21be:e9a1%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {95.205.115.191, 93.68.107.163}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 6b:34:00:00:19:90
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 72:02:72:ff:60:19
}</pre>
