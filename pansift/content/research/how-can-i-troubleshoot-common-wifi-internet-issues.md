...
layout: research
ip_v4_address: "120.166.111.123"
date: 2023-10-06T17:10:31+01:00
draft: false
---

## Internet Addressing
On the Internet you may have a Public IPv4 address like ```120.166.111.123``` or an IPv6 address like ```2000:7e15:a5fe:c148:2053:2c04:d90a:1cbb```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```07:e9:6b:2f:1b:6a```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://bednar-hirthe.name you initially access a DNS server to translate the host portion (bednar-hirthe) combined with the Top Level Domain (name) of the URL, to an IP address like ```77.91.179.149```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1; WOW64; Trident/7.0; AS; rv:11.0) like Gecko```

## Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```10.243.216.203``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  10.243.216.203    UGScg  en0
...
<pre>
default   fe80:2c65:1938:8cca:137c%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {129.49.1.189, 250.128.8.122}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 07:e9:6b:2f:1b:6a
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr c7:92:03:70:28:bb
}</pre>
