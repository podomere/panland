...
layout: research
ip_v4_address: "245.66.137.247"
date: 2022-11-02T11:32:56+00:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like ```245.66.137.247``` or an IPv6 address like ```2000:34ba:788c:9765:5969:5fb3:9b59:5f5d```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```3f:06:51:00:97:b4```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://spencer.com you initially access a DNS server to translate the host portion (spencer) combined with the Top Level Domain (com) of the URL, to an IP address like ```31.108.111.221```. Your computer and browser actually sends its type with all web requests e.g. <br>```Opera/9.80 (X11; Linux i686; Ubuntu/14.10) Presto/2.12.388 Version/12.16```
...
<pre>
default   fe80:247e:a0db:b171:ca9e%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {52.178.245.153, 164.178.244.155}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 3f:06:51:00:97:b4
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 76:ae:e7:1a:39:81
}</pre>
