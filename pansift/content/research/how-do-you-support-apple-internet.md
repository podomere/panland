...
subtitle: "Heads Down?"
layout: research
ip_v4_address: "249.68.230.75"
date: 2022-04-24T19:00:25+01:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like <code>249.68.230.75</code> or an IPv6 address like <code>2000:24ff:dd84:9097:4418:f3d0:39f6:6897</code>. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>61:65:6f:ba:c2:1e</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://homenick-hammes.org you initially access a DNS server to translate the host portion (homenick-hammes) combined with the Top Level Domain (org) of the URL, to an IP address like <code>243.90.65.87</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Opera/9.80 (X11; Linux i686; Ubuntu/14.10) Presto/2.12.388 Version/12.16</code>
...
<pre><code>
default   fe80:3fca:8b3:713e:2f6d%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {173.78.143.139, 136.250.164.218}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 61:65:6f:ba:c2:1e
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 9a:10:3e:74:eb:82
}</code></pre>
