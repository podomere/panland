...
subtitle: "Streamline?"
layout: research
ip_v4_address: "95.230.200.43"
date: 2022-04-24T19:00:33+01:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like <code>95.230.200.43</code> or an IPv6 address like <code>2000:4c36:daa0:a307:a45:9e34:6e46:4f55</code>. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>82:11:96:69:69:fb</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://hoeger-wuckert.name you initially access a DNS server to translate the host portion (hoeger-wuckert) combined with the Top Level Domain (name) of the URL, to an IP address like <code>19.202.187.135</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (Windows NT 6.1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/41.0.2228.0 Safari/537.36</code>
...
<pre><code>
default   fe80:75c7:fb0d:93fd:a69d%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {224.49.67.211, 36.21.204.186}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 82:11:96:69:69:fb
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 83:79:7c:20:76:0b
}</code></pre>
