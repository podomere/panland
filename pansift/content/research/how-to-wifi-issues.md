...
subtitle: "Deep Dive?"
layout: research
ip_v4_address: "212.25.84.169"
date: 2023-10-06T17:10:30+01:00
draft: false
---

## Internet Addressing
On the Internet you may get a Public IPv4 address like ```212.25.84.169``` or an IPv6 address like ```2000:c30e:e8a5:399e:33e8:18bf:13c1:baa0```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```c5:27:68:6a:04:08```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://nienow.name you initially access a DNS server to translate the host portion (nienow) combined with the Top Level Domain (name) of the URL, to an IP address like ```127.145.105.184```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (compatible; MSIE 9.0; AOL 9.7; AOLBuild 4343.19; Windows NT 6.1; WOW64; Trident/5.0; FunWebProducts)```
...
<pre>
default   fe80:56e0:9231:c53e:be46%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {103.47.121.1, 184.35.178.42}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr c5:27:68:6a:04:08
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 76:54:ec:e8:7d:ae
}</pre>
