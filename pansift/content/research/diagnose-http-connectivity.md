...
layout: research
ip_v4_address: "162.10.217.188"
date: 2022-06-12T14:09:28+01:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like ```162.10.217.188``` or an IPv6 address like ```2000:d1ff:78bc:8e53:2b63:871e:9349:3ad7```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```33:47:b4:25:0d:1d```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://langosh-ledner.info you initially access a DNS server to translate the host portion (langosh-ledner) combined with the Top Level Domain (info) of the URL, to an IP address like ```83.204.6.145```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_3) AppleWebKit/537.75.14 (KHTML, like Gecko) Version/7.0.3 Safari/7046A194A```

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```192.168.31.64``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  192.168.31.64    UGScg  en0
...
<pre>
default   fe80:c3b1:38ef:8785:68dd%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {91.239.173.134, 254.197.175.83}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 33:47:b4:25:0d:1d
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr bf:e5:4c:51:43:0f
}</pre>
