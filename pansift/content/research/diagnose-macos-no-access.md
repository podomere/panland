...
layout: research
ip_v4_address: "179.219.157.91"
date: 2022-11-02T11:33:10+00:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like ```179.219.157.91``` or an IPv6 address like ```2000:138e:b7f8:2194:7850:3508:e749:b756```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```6a:3f:d2:a9:99:09```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://hilpert.io you initially access a DNS server to translate the host portion (hilpert) combined with the Top Level Domain (io) of the URL, to an IP address like ```152.80.214.1```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_3) AppleWebKit/537.75.14 (KHTML, like Gecko) Version/7.0.3 Safari/7046A194A```

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```10.202.74.114``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  10.202.74.114    UGScg  en0
...
<pre>
default   fe80:a26d:124a:684:4bb8%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {159.132.219.169, 242.251.209.128}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 6a:3f:d2:a9:99:09
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 5a:d2:e3:8e:21:50
}</pre>
