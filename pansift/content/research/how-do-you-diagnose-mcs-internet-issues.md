...
layout: research
ip_v4_address: "58.232.249.200"
date: 2022-11-02T11:32:24+00:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like ```58.232.249.200``` or an IPv6 address like ```2000:d026:77ef:92e0:f5f9:3382:8977:ff75```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```10:56:20:5e:98:b6```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://gutmann-rath.org you initially access a DNS server to translate the host portion (gutmann-rath) combined with the Top Level Domain (org) of the URL, to an IP address like ```90.229.196.114```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows; U; Win 9x 4.90; SG; rv:1.9.2.4) Gecko/20101104 Netscape/9.1.0285```
...
default  10.199.117.246    UGScg  en0
...
<pre>
default   fe80:edd6:3714:7d48:9750%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {195.5.42.243, 71.149.255.246}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 10:56:20:5e:98:b6
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 0d:9d:d1:0a:4b:2c
}</pre>
