...
layout: research
ip_v4_address: "161.229.235.105"
date: 2022-11-19T19:13:26+00:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like ```161.229.235.105``` or an IPv6 address like ```2000:f999:9ba5:44f:cd2e:a522:fb97:1024```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```9e:55:2f:64:34:91```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://dach-mills.net you initially access a DNS server to translate the host portion (dach-mills) combined with the Top Level Domain (net) of the URL, to an IP address like ```239.212.251.67```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows; U; Win 9x 4.90; SG; rv:1.9.2.4) Gecko/20101104 Netscape/9.1.0285```
...
<pre>
default   fe80:e181:6b95:df7c:3400%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {3.46.228.228, 188.218.173.75}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 9e:55:2f:64:34:91
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 5e:7f:82:3b:94:ce
}</pre>
