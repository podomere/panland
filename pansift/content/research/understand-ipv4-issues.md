...
layout: research
ip_v4_address: "18.125.232.34"
date: 2023-02-04T16:26:18+00:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like ```18.125.232.34``` or an IPv6 address like ```2000:ea75:91e:577c:f8bb:1333:9341:ba5d```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```7e:58:2f:f3:3f:d7```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://tromp-padberg.info you initially access a DNS server to translate the host portion (tromp-padberg) combined with the Top Level Domain (info) of the URL, to an IP address like ```19.107.173.38```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (compatible; MSIE 9.0; AOL 9.7; AOLBuild 4343.19; Windows NT 6.1; WOW64; Trident/5.0; FunWebProducts)```
...
<pre>
default   fe80:6c8:e589:4ab9:413f%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {173.180.151.107, 67.158.105.55}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 7e:58:2f:f3:3f:d7
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr c2:41:2b:af:b6:43
}</pre>
