...
layout: research
ip_v4_address: "93.189.110.127"
date: 2023-02-04T16:26:04+00:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like ```93.189.110.127``` or an IPv6 address like ```2000:aab9:ae90:865a:d488:d3e4:7ea9:3ef2```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```0d:de:b2:10:fc:ea```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://hilpert.biz you initially access a DNS server to translate the host portion (hilpert) combined with the Top Level Domain (biz) of the URL, to an IP address like ```234.246.217.237```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_3) AppleWebKit/537.75.14 (KHTML, like Gecko) Version/7.0.3 Safari/7046A194A```

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```192.168.213.237``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  192.168.213.237    UGScg  en0
...
<pre>
default   fe80:497:6d4d:ff4:b8ed%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {242.68.233.221, 199.28.255.7}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 0d:de:b2:10:fc:ea
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 12:36:9c:1b:0e:85
}</pre>
