...
layout: research
ip_v4_address: "174.183.145.130"
date: 2023-02-04T17:07:42+00:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like ```174.183.145.130``` or an IPv6 address like ```2000:95c8:d7ec:faef:c440:57fb:72b1:19cf```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```60:1b:3b:09:51:66```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://kuphal.org you initially access a DNS server to translate the host portion (kuphal) combined with the Top Level Domain (org) of the URL, to an IP address like ```246.80.168.96```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows; U; Win 9x 4.90; SG; rv:1.9.2.4) Gecko/20101104 Netscape/9.1.0285```
...
<pre>
default   fe80:7c4d:c334:fd4:d47a%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {241.197.117.0, 25.95.8.238}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 60:1b:3b:09:51:66
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr bf:fa:9e:25:37:1a
}</pre>
