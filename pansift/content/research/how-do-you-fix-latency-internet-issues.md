...
layout: research
ip_v4_address: "180.79.80.38"
date: 2022-06-12T14:09:25+01:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like ```180.79.80.38``` or an IPv6 address like ```2000:2f33:f8f5:13fe:da2a:c954:5733:226d```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```b8:85:4a:2e:84:ea```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://renner.io you initially access a DNS server to translate the host portion (renner) combined with the Top Level Domain (io) of the URL, to an IP address like ```211.71.158.15```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (compatible; MSIE 9.0; AOL 9.7; AOLBuild 4343.19; Windows NT 6.1; WOW64; Trident/5.0; FunWebProducts)```
...
default  172.25.37.34    UGScg  en0
...
<pre>
default   fe80:a53:aa33:faeb:6eac%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {202.250.11.108, 167.21.37.102}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr b8:85:4a:2e:84:ea
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 86:8a:af:0d:ff:ed
}</pre>
