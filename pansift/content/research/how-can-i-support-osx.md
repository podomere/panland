...
layout: research
ip_v4_address: "237.177.93.169"
date: 2022-12-15T13:50:10+00:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like ```237.177.93.169``` or an IPv6 address like ```2000:ee7:916e:1d22:eb9:c619:ebe2:da27```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```da:63:3a:33:1c:d9```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://jast-wilderman.net you initially access a DNS server to translate the host portion (jast-wilderman) combined with the Top Level Domain (net) of the URL, to an IP address like ```35.235.45.171```. Your computer and browser actually sends its type with all web requests e.g. <br>```Opera/9.80 (X11; Linux i686; Ubuntu/14.10) Presto/2.12.388 Version/12.16```
...
<pre>
default   fe80:7fc4:c052:998f:883f%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {244.243.201.125, 53.144.138.84}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr da:63:3a:33:1c:d9
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 1d:a5:57:36:cd:81
}</pre>
