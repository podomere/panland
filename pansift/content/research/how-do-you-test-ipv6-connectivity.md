...
layout: research
ip_v4_address: "172.247.113.228"
date: 2022-06-04T14:38:37+01:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like ```172.247.113.228``` or an IPv6 address like ```2000:286d:5677:3c36:da79:d8e5:69c:4bf0```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```f3:a0:86:cb:50:9a```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://beier-skiles.name you initially access a DNS server to translate the host portion (beier-skiles) combined with the Top Level Domain (name) of the URL, to an IP address like ```204.232.134.21```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_3) AppleWebKit/537.75.14 (KHTML, like Gecko) Version/7.0.3 Safari/7046A194A```
...
<pre>
default   fe80:919:2953:826e:640e%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {105.27.146.39, 170.33.6.255}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr f3:a0:86:cb:50:9a
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 04:47:80:f0:b4:53
}</pre>
