...
subtitle: "Swag?"
layout: research
ip_v4_address: "192.197.0.105"
date: 2022-04-24T18:59:56+01:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like <code>192.197.0.105</code> or an IPv6 address like <code>2000:fd96:eae3:b3ba:2f70:1fee:4350:8d70</code>. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>7c:8c:7a:ab:7f:e8</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://doyle.org you initially access a DNS server to translate the host portion (doyle) combined with the Top Level Domain (org) of the URL, to an IP address like <code>219.113.47.50</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (Windows; U; Win 9x 4.90; SG; rv:1.9.2.4) Gecko/20101104 Netscape/9.1.0285</code>
...
<pre><code>
default   fe80:5450:1aec:8202:4cbe%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {87.167.189.178, 202.136.62.112}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 7c:8c:7a:ab:7f:e8
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr c8:35:16:8b:99:aa
}</code></pre>
