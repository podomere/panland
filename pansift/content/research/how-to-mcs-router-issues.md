...
layout: research
ip_v4_address: "36.2.200.229"
date: 2022-12-15T13:50:04+00:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like ```36.2.200.229``` or an IPv6 address like ```2000:894e:89b5:eb37:b372:1ea4:3513:a5c2```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```5d:10:75:d6:81:f3```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://bayer-kuhn.net you initially access a DNS server to translate the host portion (bayer-kuhn) combined with the Top Level Domain (net) of the URL, to an IP address like ```20.225.207.88```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT x.y; Win64; x64; rv:10.0) Gecko/20100101 Firefox/10.0```
...
default  192.168.138.27    UGScg  en0
...
<pre>
default   fe80:6c5a:ceea:a727:76e0%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {9.67.23.224, 217.52.215.166}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 5d:10:75:d6:81:f3
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr e4:7c:c8:24:2d:9a
}</pre>
