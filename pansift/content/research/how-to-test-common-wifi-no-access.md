...
layout: research
ip_v4_address: "54.72.38.155"
date: 2022-11-19T19:13:09+00:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like ```54.72.38.155``` or an IPv6 address like ```2000:fd81:c0b3:cbf4:da7a:aff9:c62:5da4```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```d9:8f:96:a9:5d:7d```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://kozey.info you initially access a DNS server to translate the host portion (kozey) combined with the Top Level Domain (info) of the URL, to an IP address like ```37.36.161.41```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1; WOW64; Trident/7.0; AS; rv:11.0) like Gecko```
...
<pre>
default   fe80:a820:373:33e7:7729%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {142.82.27.151, 199.53.34.188}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr d9:8f:96:a9:5d:7d
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 56:f2:0c:6e:74:7a
}</pre>
