...
subtitle: "Streamline?"
layout: research
ip_v4_address: "126.128.15.53"
date: 2022-05-05T14:29:30+01:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like ```126.128.15.53``` or an IPv6 address like ```2000:7576:f71:487:3e13:e956:7b8d:14ad```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```6f:f2:16:d1:66:09```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://jakubowski.org you initially access a DNS server to translate the host portion (jakubowski) combined with the Top Level Domain (org) of the URL, to an IP address like ```96.124.92.239```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1; WOW64; Trident/7.0; AS; rv:11.0) like Gecko```

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```10.245.111.117``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  10.245.111.117    UGScg  en0
...
<pre>
default   fe80:6a5d:5380:c514:4675%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {203.15.43.230, 225.203.135.157}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 6f:f2:16:d1:66:09
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 7b:c1:aa:7c:c3:70
}</pre>
