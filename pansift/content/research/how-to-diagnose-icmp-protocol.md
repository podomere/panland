...
subtitle: "Etc. Etc.?"
layout: research
ip_v4_address: "45.32.161.153"
date: 2023-10-06T17:11:06+01:00
draft: false
---

## Internet Addressing
On the Internet you may get a Public IPv4 address like ```45.32.161.153``` or an IPv6 address like ```2000:c48a:7960:257:6603:6f30:af2e:eb3b```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```64:68:87:91:75:2b```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://pouros-witting.org you initially access a DNS server to translate the host portion (pouros-witting) combined with the Top Level Domain (org) of the URL, to an IP address like ```175.65.172.191```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (compatible; MSIE 9.0; AOL 9.7; AOLBuild 4343.19; Windows NT 6.1; WOW64; Trident/5.0; FunWebProducts)```
...
<pre>
default   fe80:bea0:dd9a:347e:fb37%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {198.156.158.230, 174.147.201.86}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 64:68:87:91:75:2b
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr d6:82:64:77:58:37
}</pre>
