...
subtitle: "Heads Down?"
layout: research
ip_v4_address: "143.62.238.166"
date: 2023-02-04T17:07:41+00:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like ```143.62.238.166``` or an IPv6 address like ```2000:1e1f:b8b0:4d76:6eca:bd11:7cc1:6395```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```45:20:74:57:52:69```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://von.net you initially access a DNS server to translate the host portion (von) combined with the Top Level Domain (net) of the URL, to an IP address like ```121.234.76.75```. Your computer and browser actually sends its type with all web requests e.g. <br>```Opera/9.80 (X11; Linux i686; Ubuntu/14.10) Presto/2.12.388 Version/12.16```

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```172.24.82.89``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  172.24.82.89    UGScg  en0
...
<pre>
default   fe80:7ce:c3:7da0:e679%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {29.26.195.146, 217.146.220.166}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 45:20:74:57:52:69
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 24:09:58:af:45:e2
}</pre>
