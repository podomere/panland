...
layout: research
ip_v4_address: "114.137.131.144"
date: 2022-11-02T11:32:24+00:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like ```114.137.131.144``` or an IPv6 address like ```2000:8a4e:180d:bd4:506d:4239:4243:59bb```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```f6:3c:d7:2a:94:b4```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://hoppe-schroeder.io you initially access a DNS server to translate the host portion (hoppe-schroeder) combined with the Top Level Domain (io) of the URL, to an IP address like ```243.56.168.86```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1; WOW64; Trident/7.0; AS; rv:11.0) like Gecko```
...
<pre>
default   fe80:65da:7e97:2e11:4b02%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {240.170.94.88, 212.122.69.129}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr f6:3c:d7:2a:94:b4
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr ca:7c:2b:b8:3f:b4
}</pre>
