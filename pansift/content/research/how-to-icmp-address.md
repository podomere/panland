...
layout: research
ip_v4_address: "203.174.131.177"
date: 2022-04-24T19:00:00+01:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like <code>203.174.131.177</code> or an IPv6 address like <code>2000:8ad3:524e:db09:151b:8434:2b48:226</code>. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>42:b3:47:42:7f:a2</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://waelchi-hettinger.info you initially access a DNS server to translate the host portion (waelchi-hettinger) combined with the Top Level Domain (info) of the URL, to an IP address like <code>206.174.21.91</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (Windows NT 6.1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/41.0.2228.0 Safari/537.36</code>
...
<pre><code>
default   fe80:f13f:20d8:e06a:e463%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {106.87.124.199, 140.93.218.30}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 42:b3:47:42:7f:a2
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 53:5a:66:d9:03:73
}</code></pre>
