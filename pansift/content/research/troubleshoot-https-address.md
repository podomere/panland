...
subtitle: "Deep Dive?"
layout: research
ip_v4_address: "120.159.90.47"
date: 2022-11-19T16:17:25+00:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like ```120.159.90.47``` or an IPv6 address like ```2000:9f9d:90c7:ea7e:2c2b:c5ec:c616:a1bb```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```40:68:c6:e0:cb:de```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://jakubowski-abernathy.net you initially access a DNS server to translate the host portion (jakubowski-abernathy) combined with the Top Level Domain (net) of the URL, to an IP address like ```178.217.207.17```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_3) AppleWebKit/537.75.14 (KHTML, like Gecko) Version/7.0.3 Safari/7046A194A```
...
<pre>
default   fe80:c901:e00f:b44:9141%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {127.83.107.45, 85.41.14.32}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 40:68:c6:e0:cb:de
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 51:76:6a:0b:78:ef
}</pre>
