...
layout: research
ip_v4_address: "124.60.104.107"
date: 2023-10-29T15:13:18+00:00
draft: false
---

## Internet Addressing
On the Internet you may have a Public IPv4 address like ```124.60.104.107``` or an IPv6 address like ```2000:25b7:64b6:eb3e:7d00:1ca6:4784:ee64```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```37:46:91:c0:76:3b```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://yundt-prohaska.info you initially access a DNS server to translate the host portion (yundt-prohaska) combined with the Top Level Domain (info) of the URL, to an IP address like ```16.204.225.49```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (compatible; MSIE 9.0; AOL 9.7; AOLBuild 4343.19; Windows NT 6.1; WOW64; Trident/5.0; FunWebProducts)```
...
<pre>
default   fe80:abbf:9b27:fd93:10b9%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {65.179.137.12, 78.98.23.218}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 37:46:91:c0:76:3b
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr b8:30:8d:cd:eb:54
}</pre>
