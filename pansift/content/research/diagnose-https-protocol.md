...
layout: research
ip_v4_address: "81.25.170.188"
date: 2022-04-24T19:00:05+01:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like <code>81.25.170.188</code> or an IPv6 address like <code>2000:54f8:238b:2546:6de:3f2a:736a:4a84</code>. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>e3:ed:d7:73:c6:69</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://hermiston.com you initially access a DNS server to translate the host portion (hermiston) combined with the Top Level Domain (com) of the URL, to an IP address like <code>144.201.240.104</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (Windows NT x.y; Win64; x64; rv:10.0) Gecko/20100101 Firefox/10.0</code>

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like <code>172.30.201.254</code> (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For <code>IPv6</code> we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  172.30.201.254    UGScg  en0
...
<pre><code>
default   fe80:af96:cbce:dcc:f90%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {45.140.67.27, 213.17.204.57}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr e3:ed:d7:73:c6:69
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr e0:e1:1d:53:a8:4d
}</code></pre>
