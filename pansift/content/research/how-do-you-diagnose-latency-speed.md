...
subtitle: "Granular?"
layout: research
ip_v4_address: "190.237.158.158"
date: 2022-12-15T13:50:18+00:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like ```190.237.158.158``` or an IPv6 address like ```2000:e0e7:4c69:c600:fc19:7fdd:790d:50fc```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```7f:ef:3b:f9:0d:aa```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://turcotte-jakubowski.io you initially access a DNS server to translate the host portion (turcotte-jakubowski) combined with the Top Level Domain (io) of the URL, to an IP address like ```241.161.60.77```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1; WOW64; Trident/7.0; AS; rv:11.0) like Gecko```

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```10.154.203.86``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  10.154.203.86    UGScg  en0
...
<pre>
default   fe80:6b7a:a5e4:8818:9e16%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {252.54.32.239, 211.140.73.60}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 7f:ef:3b:f9:0d:aa
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr b8:03:b6:eb:bf:56
}</pre>
