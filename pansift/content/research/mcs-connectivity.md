...
subtitle: "Granular?"
layout: research
ip_v4_address: "111.86.248.135"
date: 2022-04-24T18:32:42+01:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like <code>111.86.248.135</code> or an IPv6 address like <code>2000:6f39:8375:fd1a:3d66:865c:bc12:5681</code>. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>0f:4a:b2:e7:17:33</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://kulas-mayert.org you initially access a DNS server to translate the host portion (kulas-mayert) combined with the Top Level Domain (org) of the URL, to an IP address like <code>20.149.200.75</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (Windows; U; Win 9x 4.90; SG; rv:1.9.2.4) Gecko/20101104 Netscape/9.1.0285</code>
...
<pre><code>
default   fe80:5d4d:c1ec:e225:3d03%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {95.78.238.2, 59.161.191.128}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 0f:4a:b2:e7:17:33
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 8f:d3:ec:ce:e1:ab
}</code></pre>
