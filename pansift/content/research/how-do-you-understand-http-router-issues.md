...
subtitle: "Branding?"
layout: research
ip_v4_address: "126.74.43.32"
date: 2022-12-15T13:50:21+00:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like ```126.74.43.32``` or an IPv6 address like ```2000:43ee:b2d5:b54d:4641:f8dc:c172:d345```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```51:43:8c:f4:cc:47```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://kozey-padberg.name you initially access a DNS server to translate the host portion (kozey-padberg) combined with the Top Level Domain (name) of the URL, to an IP address like ```22.241.100.46```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows; U; Win 9x 4.90; SG; rv:1.9.2.4) Gecko/20101104 Netscape/9.1.0285```

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```172.20.75.48``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  172.20.75.48    UGScg  en0
...
<pre>
default   fe80:acea:a4dc:5c1f:e273%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {94.139.253.3, 114.96.201.145}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 51:43:8c:f4:cc:47
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 25:0e:f5:cc:fa:77
}</pre>
