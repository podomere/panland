...
subtitle: "Value Add?"
layout: research
ip_v4_address: "130.2.200.204"
date: 2023-10-06T17:11:03+01:00
draft: false
---

## Internet Addressing
On the Internet you may get a Public IPv4 address like ```130.2.200.204``` or an IPv6 address like ```2000:4c2d:7660:b931:1b22:ee98:1e42:d9e0```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```70:65:a5:b9:bb:65```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://roberts-dickens.com you initially access a DNS server to translate the host portion (roberts-dickens) combined with the Top Level Domain (com) of the URL, to an IP address like ```197.154.149.139```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1; WOW64; Trident/7.0; AS; rv:11.0) like Gecko```

## Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```172.17.203.153``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  172.17.203.153    UGScg  en0
...
<pre>
default   fe80:886e:8b6b:4e98:d9cb%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {33.48.203.239, 189.88.188.17}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 70:65:a5:b9:bb:65
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 3a:bc:80:ae:09:a2
}</pre>
...
### Apple macOS / OSX
No matter what version of OSX/macOS you are on, ```10.14.1```, ```11.6.3```, or ```12.0.5```, there are a range of tools for troubleshooting. Unfortunately, between these manual actions and scripts, they don't give you a series of correlated values over time. This is where automated remote troubleshooting comes in to its own, especially for teams that embrace remote work and Work From Anywhere (WFA).
