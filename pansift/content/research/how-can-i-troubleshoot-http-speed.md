...
layout: research
ip_v4_address: "33.30.100.60"
date: 2022-05-05T14:30:06+01:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like ```33.30.100.60``` or an IPv6 address like ```2000:3f08:daa6:8573:9630:5b5e:8366:b6c8```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```60:1c:01:c8:7b:bb```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://gutkowski-weimann.name you initially access a DNS server to translate the host portion (gutkowski-weimann) combined with the Top Level Domain (name) of the URL, to an IP address like ```222.143.42.232```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1; WOW64; Trident/7.0; AS; rv:11.0) like Gecko```
...
<pre>
default   fe80:8381:5bbf:cd6d:495%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {124.251.117.211, 205.218.155.167}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 60:1c:01:c8:7b:bb
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr be:ee:39:3e:e4:66
}</pre>
