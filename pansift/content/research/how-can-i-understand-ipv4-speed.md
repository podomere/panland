...
subtitle: "Tee It Up?"
layout: research
ip_v4_address: "50.39.23.176"
date: 2022-11-02T11:32:54+00:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like ```50.39.23.176``` or an IPv6 address like ```2000:9707:eec8:504e:9226:8a0f:88d8:299c```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```d2:72:f3:eb:fd:f4```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://shanahan-little.name you initially access a DNS server to translate the host portion (shanahan-little) combined with the Top Level Domain (name) of the URL, to an IP address like ```102.26.231.34```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows; U; Win 9x 4.90; SG; rv:1.9.2.4) Gecko/20101104 Netscape/9.1.0285```
...
<pre>
default   fe80:b58a:ad44:9506:d23c%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {117.182.40.143, 246.36.192.60}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr d2:72:f3:eb:fd:f4
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 2e:63:ae:69:8d:9b
}</pre>
...
## Apple macOS / OSX
No matter what version of OSX/macOS you are on, ```10.15.2```, ```11.2.7```, or ```12.2.5```, there are a range of tools for troubleshooting. Unfortunately, between these manual actions and scripts, they don't give you a series of correlated values over time. This is where automated remote troubleshooting comes in to its own, especially for teams that embrace remote work and Work From Anywhere (WFA).
