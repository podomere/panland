...
layout: research
ip_v4_address: "13.239.50.253"
date: 2023-10-06T17:10:41+01:00
draft: false
---

## Internet Addressing
On the Internet you might get a Public IPv4 address like ```13.239.50.253``` or an IPv6 address like ```2000:e6bf:9a7c:ce50:a0cc:f96a:262d:582c```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```3c:de:b6:31:dc:c4```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://mcglynn.info you initially access a DNS server to translate the host portion (mcglynn) combined with the Top Level Domain (info) of the URL, to an IP address like ```88.123.216.185```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT x.y; Win64; x64; rv:10.0) Gecko/20100101 Firefox/10.0```
...
<pre>
default   fe80:b45:6d21:92df:9dab%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {63.12.97.217, 238.96.75.72}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 3c:de:b6:31:dc:c4
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 40:4e:71:79:5d:e8
}</pre>
