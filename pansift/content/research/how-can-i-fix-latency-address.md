...
layout: research
ip_v4_address: "159.183.34.189"
date: 2023-10-06T17:11:05+01:00
draft: false
---

## Internet Addressing
On the Internet you might get a Public IPv4 address like ```159.183.34.189``` or an IPv6 address like ```2000:0:c844:c143:3a50:4ebc:f21b:2334```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```b7:0c:8e:bc:6d:11```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://romaguera.biz you initially access a DNS server to translate the host portion (romaguera) combined with the Top Level Domain (biz) of the URL, to an IP address like ```108.132.49.7```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows; U; Win 9x 4.90; SG; rv:1.9.2.4) Gecko/20101104 Netscape/9.1.0285```

## Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```10.189.7.140``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  10.189.7.140    UGScg  en0
...
<pre>
default   fe80:6af0:4b52:9575:3195%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {140.196.231.88, 189.21.139.65}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr b7:0c:8e:bc:6d:11
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 67:88:c2:6e:a8:cb
}</pre>
