...
subtitle: "Granular?"
layout: research
ip_v4_address: "0.121.29.60"
date: 2022-04-24T19:00:22+01:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like <code>0.121.29.60</code> or an IPv6 address like <code>2000:149a:36d:277f:ce:2de7:646b:a6a0</code>. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>0f:62:df:ed:6f:80</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://nicolas-johnson.org you initially access a DNS server to translate the host portion (nicolas-johnson) combined with the Top Level Domain (org) of the URL, to an IP address like <code>139.217.115.247</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_3) AppleWebKit/537.75.14 (KHTML, like Gecko) Version/7.0.3 Safari/7046A194A</code>
...
<pre><code>
default   fe80:5a60:c58a:6e2a:9dca%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {71.239.50.34, 208.12.16.1}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 0f:62:df:ed:6f:80
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 3c:7b:ad:64:96:55
}</code></pre>
