...
layout: research
ip_v4_address: "228.154.135.106"
date: 2022-04-24T19:00:24+01:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like <code>228.154.135.106</code> or an IPv6 address like <code>2000:9d2e:d3d0:38f8:f6c0:fd9a:4a75:534e</code>. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>05:1f:19:ec:3f:69</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://farrell.io you initially access a DNS server to translate the host portion (farrell) combined with the Top Level Domain (io) of the URL, to an IP address like <code>174.223.210.35</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (Windows NT 6.1; WOW64; Trident/7.0; AS; rv:11.0) like Gecko</code>
...
<pre><code>
default   fe80:fe31:3246:6a11:880d%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {14.31.223.1, 196.91.178.107}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 05:1f:19:ec:3f:69
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 20:d2:2d:95:2e:d5
}</code></pre>
