...
layout: research
ip_v4_address: "253.203.31.94"
date: 2022-04-24T19:00:22+01:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like <code>253.203.31.94</code> or an IPv6 address like <code>2000:12b5:ef2b:7f32:db55:6200:e8c0:2c3b</code>. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>e0:56:32:9d:63:c0</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://stamm.com you initially access a DNS server to translate the host portion (stamm) combined with the Top Level Domain (com) of the URL, to an IP address like <code>190.130.249.98</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_3) AppleWebKit/537.75.14 (KHTML, like Gecko) Version/7.0.3 Safari/7046A194A</code>
...
<pre><code>
default   fe80:a697:362:8d38:c522%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {246.126.129.140, 20.69.188.115}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr e0:56:32:9d:63:c0
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 3f:8f:84:91:f6:be
}</code></pre>
