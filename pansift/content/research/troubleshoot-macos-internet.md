...
layout: research
ip_v4_address: "234.92.116.25"
date: 2022-11-19T19:13:15+00:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like ```234.92.116.25``` or an IPv6 address like ```2000:cf07:8228:17ea:e73b:cd91:6dea:a013```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```53:34:ac:f5:19:d3```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://feeney-stamm.org you initially access a DNS server to translate the host portion (feeney-stamm) combined with the Top Level Domain (org) of the URL, to an IP address like ```40.244.227.156```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (compatible; MSIE 9.0; AOL 9.7; AOLBuild 4343.19; Windows NT 6.1; WOW64; Trident/5.0; FunWebProducts)```
...
<pre>
default   fe80:fef6:6b1f:146d:d59d%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {146.124.177.73, 73.140.63.209}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 53:34:ac:f5:19:d3
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr c7:d0:36:3c:0b:72
}</pre>
