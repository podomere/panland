...
subtitle: "Swag?"
layout: research
ip_v4_address: "119.252.230.201"
date: 2022-11-19T19:13:17+00:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like ```119.252.230.201``` or an IPv6 address like ```2000:18fc:f3e5:38aa:98a0:16ee:559c:aee2```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```46:c3:ba:1c:be:cc```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://towne-hartmann.io you initially access a DNS server to translate the host portion (towne-hartmann) combined with the Top Level Domain (io) of the URL, to an IP address like ```37.14.142.118```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/41.0.2228.0 Safari/537.36```
...
<pre>
default   fe80:6de7:64a6:4537:3a6c%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {99.212.46.150, 7.159.83.103}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 46:c3:ba:1c:be:cc
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr e5:54:5e:0f:35:f8
}</pre>
