...
layout: research
ip_v4_address: "20.102.45.154"
date: 2023-10-06T17:10:31+01:00
draft: false
---

## Internet Addressing
On the Internet you may get a Public IPv4 address like ```20.102.45.154``` or an IPv6 address like ```2000:e3f0:462e:bb01:eacd:d70a:ceda:75fd```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```5a:38:76:7f:b4:ed```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://osinski-pouros.name you initially access a DNS server to translate the host portion (osinski-pouros) combined with the Top Level Domain (name) of the URL, to an IP address like ```37.72.24.226```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1; WOW64; Trident/7.0; AS; rv:11.0) like Gecko```
...
<pre>
default   fe80:a084:3839:d47c:7ad3%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {213.238.63.196, 13.80.199.0}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 5a:38:76:7f:b4:ed
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr a0:17:0a:8c:e8:32
}</pre>
