...
layout: research
ip_v4_address: "5.41.102.191"
date: 2023-10-29T15:13:29+00:00
draft: false
---

## Internet Addressing
On the Internet you might get a Public IPv4 address like ```5.41.102.191``` or an IPv6 address like ```2000:c663:a37e:8a36:1736:f0b8:4ee4:74d6```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```55:9c:b3:62:77:c6```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://harber-ziemann.biz you initially access a DNS server to translate the host portion (harber-ziemann) combined with the Top Level Domain (biz) of the URL, to an IP address like ```196.200.11.148```. Your computer and browser actually sends its type with all web requests e.g. <br>```Opera/9.80 (X11; Linux i686; Ubuntu/14.10) Presto/2.12.388 Version/12.16```
...
<pre>
default   fe80:6ae:516f:fcea:9dc2%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {113.22.1.224, 63.36.176.218}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 55:9c:b3:62:77:c6
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 56:01:c0:9d:f4:80
}</pre>
