...
layout: research
ip_v4_address: "192.184.255.252"
date: 2023-02-04T17:08:34+00:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like ```192.184.255.252``` or an IPv6 address like ```2000:118c:2fff:867c:16ee:14b2:bf6a:b000```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```dd:16:43:73:a4:87```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://jones-gutkowski.net you initially access a DNS server to translate the host portion (jones-gutkowski) combined with the Top Level Domain (net) of the URL, to an IP address like ```88.103.169.218```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows; U; Win 9x 4.90; SG; rv:1.9.2.4) Gecko/20101104 Netscape/9.1.0285```

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```192.168.30.241``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  192.168.30.241    UGScg  en0
...
<pre>
default   fe80:b88d:3878:248c:a8f1%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {202.242.54.39, 201.66.53.33}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr dd:16:43:73:a4:87
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 49:33:2a:78:45:e3
}</pre>
...
## Apple macOS / OSX
No matter what version of OSX/macOS you are on, ```10.11.2```, ```11.5.5```, or ```12.3.1```, there are a range of tools for troubleshooting. Unfortunately, between these manual actions and scripts, they don't give you a series of correlated values over time. This is where automated remote troubleshooting comes in to its own, especially for teams that embrace remote work and Work From Anywhere (WFA).
