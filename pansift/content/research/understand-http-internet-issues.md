...
subtitle: "Granular?"
layout: research
ip_v4_address: "46.102.253.118"
date: 2022-05-05T14:30:04+01:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like ```46.102.253.118``` or an IPv6 address like ```2000:8ec0:c038:3a81:63e9:cf3a:408c:85b3```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```bb:66:43:96:a9:6f```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://schinner-connelly.net you initially access a DNS server to translate the host portion (schinner-connelly) combined with the Top Level Domain (net) of the URL, to an IP address like ```161.176.31.242```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1; WOW64; Trident/7.0; AS; rv:11.0) like Gecko```
...
default  172.27.97.129    UGScg  en0
...
<pre>
default   fe80:4eac:6b7d:2b2d:d242%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {230.5.76.48, 144.99.102.153}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr bb:66:43:96:a9:6f
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 68:f3:91:c7:18:72
}</pre>
