...
subtitle: "Granular?"
layout: research
ip_v4_address: "163.126.50.168"
date: 2022-06-04T14:38:28+01:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like ```163.126.50.168``` or an IPv6 address like ```2000:1e90:867b:d95e:b92d:cc5b:10a7:8dbf```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```e3:2e:d2:2b:db:e2```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://goldner.name you initially access a DNS server to translate the host portion (goldner) combined with the Top Level Domain (name) of the URL, to an IP address like ```46.91.230.189```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1; WOW64; Trident/7.0; AS; rv:11.0) like Gecko```

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```192.168.134.14``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  192.168.134.14    UGScg  en0
...
<pre>
default   fe80:d405:3a5f:5ea4:eeda%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {103.63.233.20, 110.198.58.255}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr e3:2e:d2:2b:db:e2
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr dd:5f:e4:bc:66:b6
}</pre>
