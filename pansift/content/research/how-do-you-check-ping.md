...
layout: research
ip_v4_address: "128.45.254.94"
date: 2022-11-02T11:33:00+00:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like ```128.45.254.94``` or an IPv6 address like ```2000:9cda:5df2:d93c:d402:c510:2c21:a1f8```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```6c:ba:92:ca:e3:eb```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://collins.co you initially access a DNS server to translate the host portion (collins) combined with the Top Level Domain (co) of the URL, to an IP address like ```27.30.128.6```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1; WOW64; Trident/7.0; AS; rv:11.0) like Gecko```

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```10.148.59.247``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  10.148.59.247    UGScg  en0
...
<pre>
default   fe80:b81b:dcfa:4a25:78b1%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {83.144.101.236, 65.54.136.113}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 6c:ba:92:ca:e3:eb
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 66:2e:79:31:ed:b6
}</pre>
