...
layout: research
ip_v4_address: "56.69.61.247"
date: 2023-10-06T17:11:03+01:00
draft: false
---

## Internet Addressing
On the Internet you might get a Public IPv4 address like ```56.69.61.247``` or an IPv6 address like ```2000:9955:512f:100:5105:aa14:16d9:efdf```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```27:a9:89:df:f3:bb```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://yundt-bruen.net you initially access a DNS server to translate the host portion (yundt-bruen) combined with the Top Level Domain (net) of the URL, to an IP address like ```110.244.88.112```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1; WOW64; Trident/7.0; AS; rv:11.0) like Gecko```
...
<pre>
default   fe80:4478:cd9d:9dbb:ca19%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {39.136.211.111, 137.67.30.204}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 27:a9:89:df:f3:bb
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr a8:01:43:e6:95:e3
}</pre>
