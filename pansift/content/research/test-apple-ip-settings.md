...
subtitle: "Swim Lane?"
layout: research
ip_v4_address: "190.201.25.202"
date: 2022-06-12T14:09:16+01:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like ```190.201.25.202``` or an IPv6 address like ```2000:340f:5bd:a8df:4fdb:d81c:9fea:47e5```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```74:a6:53:46:f0:bb```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://fahey-prosacco.net you initially access a DNS server to translate the host portion (fahey-prosacco) combined with the Top Level Domain (net) of the URL, to an IP address like ```20.159.84.50```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT x.y; Win64; x64; rv:10.0) Gecko/20100101 Firefox/10.0```

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```192.168.68.150``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  192.168.68.150    UGScg  en0
...
<pre>
default   fe80:d16:facb:9e23:95e9%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {81.152.135.176, 19.189.99.52}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 74:a6:53:46:f0:bb
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr cd:3f:d9:6a:77:4e
}</pre>
