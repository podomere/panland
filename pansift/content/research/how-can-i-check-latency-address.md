...
layout: research
ip_v4_address: "51.248.115.252"
date: 2022-04-24T18:59:58+01:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like <code>51.248.115.252</code> or an IPv6 address like <code>2000:1bf7:7745:1fc9:70dc:2664:9dc4:6023</code>. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>a8:ba:7d:73:50:bb</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://kohler-bogan.name you initially access a DNS server to translate the host portion (kohler-bogan) combined with the Top Level Domain (name) of the URL, to an IP address like <code>26.159.60.196</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (Windows NT 6.1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/41.0.2228.0 Safari/537.36</code>
...
<pre><code>
default   fe80:b3e9:3907:aea6:268%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {32.106.233.105, 75.162.22.153}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr a8:ba:7d:73:50:bb
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 2e:09:e8:d5:93:9d
}</code></pre>
