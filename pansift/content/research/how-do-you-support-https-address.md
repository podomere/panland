...
layout: research
ip_v4_address: "1.126.220.98"
date: 2022-11-19T16:17:25+00:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like ```1.126.220.98``` or an IPv6 address like ```2000:b45:2bff:298a:dc0b:79b3:5b96:e8a7```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```07:7a:b1:33:b7:db```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://simonis-auer.biz you initially access a DNS server to translate the host portion (simonis-auer) combined with the Top Level Domain (biz) of the URL, to an IP address like ```106.10.110.27```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (compatible; MSIE 9.0; AOL 9.7; AOLBuild 4343.19; Windows NT 6.1; WOW64; Trident/5.0; FunWebProducts)```
...
<pre>
default   fe80:2491:1325:954d:8697%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {47.186.9.215, 14.132.115.113}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 07:7a:b1:33:b7:db
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 1a:ac:d7:03:45:c0
}</pre>
