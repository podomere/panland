...
layout: research
ip_v4_address: "217.46.187.251"
date: 2022-11-02T11:33:12+00:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like ```217.46.187.251``` or an IPv6 address like ```2000:b3fc:111a:ed63:375:ba5e:1cbd:74d6```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```7b:c8:a7:2f:29:cb```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://hickle-schiller.info you initially access a DNS server to translate the host portion (hickle-schiller) combined with the Top Level Domain (info) of the URL, to an IP address like ```27.49.44.255```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows; U; Win 9x 4.90; SG; rv:1.9.2.4) Gecko/20101104 Netscape/9.1.0285```
...
<pre>
default   fe80:3a72:5979:840b:bdd4%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {176.54.3.113, 163.232.30.183}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 7b:c8:a7:2f:29:cb
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr b5:f4:2e:85:cc:86
}</pre>
