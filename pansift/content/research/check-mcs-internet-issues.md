...
layout: research
ip_v4_address: "237.245.9.86"
date: 2023-10-29T15:13:12+00:00
draft: false
---

## Internet Addressing
On the Internet you might have a Public IPv4 address like ```237.245.9.86``` or an IPv6 address like ```2000:2078:c981:9c86:663d:86d9:168e:ee0```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```b3:cd:0b:be:b5:aa```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://damore-schneider.org you initially access a DNS server to translate the host portion (damore-schneider) combined with the Top Level Domain (org) of the URL, to an IP address like ```208.187.230.120```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1; WOW64; Trident/7.0; AS; rv:11.0) like Gecko```
...
<pre>
default   fe80:ac53:1fdd:2b0f:9f64%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {112.141.64.64, 73.73.161.105}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr b3:cd:0b:be:b5:aa
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr b6:77:a6:73:2e:ba
}</pre>
...
### Apple macOS / OSX
No matter what version of OSX/macOS you are on, ```10.13.3```, ```11.3.7```, or ```12.0.3```, there are a range of tools for troubleshooting. Unfortunately, between these manual actions and scripts, they don't give you a series of correlated values over time. This is where automated remote troubleshooting comes in to its own, especially for teams that embrace remote work and Work From Anywhere (WFA).
