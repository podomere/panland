...
layout: research
ip_v4_address: "193.162.2.105"
date: 2022-04-24T19:00:34+01:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like <code>193.162.2.105</code> or an IPv6 address like <code>2000:90f0:e50c:7567:3f48:46a5:9a5f:debc</code>. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>0b:7c:31:cd:45:f3</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://okeefe.org you initially access a DNS server to translate the host portion (okeefe) combined with the Top Level Domain (org) of the URL, to an IP address like <code>132.157.76.173</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Opera/9.80 (X11; Linux i686; Ubuntu/14.10) Presto/2.12.388 Version/12.16</code>

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like <code>10.35.42.230</code> (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For <code>IPv6</code> we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  10.35.42.230    UGScg  en0
...
<pre><code>
default   fe80:68b5:a119:29cd:d5ab%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {247.78.206.59, 214.96.185.127}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 0b:7c:31:cd:45:f3
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 94:3a:c3:fe:d8:29
}</code></pre>
