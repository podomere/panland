...
subtitle: "Etc. Etc.?"
layout: research
ip_v4_address: "135.151.230.25"
date: 2022-06-04T14:38:27+01:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like ```135.151.230.25``` or an IPv6 address like ```2000:2fa7:a135:3675:b1a8:6110:6ba9:abaf```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```27:0c:cb:80:45:41```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://hickle-jakubowski.io you initially access a DNS server to translate the host portion (hickle-jakubowski) combined with the Top Level Domain (io) of the URL, to an IP address like ```9.23.219.97```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (compatible; MSIE 9.0; AOL 9.7; AOLBuild 4343.19; Windows NT 6.1; WOW64; Trident/5.0; FunWebProducts)```
...
<pre>
default   fe80:3b3c:44ea:2a6f:f6ea%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {117.86.223.96, 127.176.195.191}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 27:0c:cb:80:45:41
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 07:ed:2c:48:98:a0
}</pre>
