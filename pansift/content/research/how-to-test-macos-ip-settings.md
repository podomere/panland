...
layout: research
ip_v4_address: "227.17.69.87"
date: 2022-12-15T13:50:09+00:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like ```227.17.69.87``` or an IPv6 address like ```2000:ea38:6eb2:c5b5:3a84:92f2:6463:6192```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```b7:2b:e1:0c:2f:22```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://dach-kerluke.net you initially access a DNS server to translate the host portion (dach-kerluke) combined with the Top Level Domain (net) of the URL, to an IP address like ```197.162.23.218```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1; WOW64; Trident/7.0; AS; rv:11.0) like Gecko```

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```10.247.81.97``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  10.247.81.97    UGScg  en0
...
<pre>
default   fe80:fb30:526f:1ba1:8e0e%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {95.143.86.151, 82.180.84.235}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr b7:2b:e1:0c:2f:22
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 78:5a:5c:ab:0c:a5
}</pre>
