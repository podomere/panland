...
layout: research
ip_v4_address: "117.38.68.43"
date: 2022-11-19T19:13:09+00:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like ```117.38.68.43``` or an IPv6 address like ```2000:511:a5e4:ede6:af31:df06:35b8:478c```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```78:dd:77:cb:fd:e1```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://wuckert-schuppe.com you initially access a DNS server to translate the host portion (wuckert-schuppe) combined with the Top Level Domain (com) of the URL, to an IP address like ```243.22.67.119```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows; U; Win 9x 4.90; SG; rv:1.9.2.4) Gecko/20101104 Netscape/9.1.0285```
...
<pre>
default   fe80:4dbc:a067:67f5:5d6a%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {148.201.59.120, 102.2.247.85}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 78:dd:77:cb:fd:e1
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 1d:ca:e8:cf:10:c6
}</pre>
