...
layout: research
ip_v4_address: "5.211.172.192"
date: 2023-10-29T15:13:30+00:00
draft: false
---

## Internet Addressing
On the Internet you might get a Public IPv4 address like ```5.211.172.192``` or an IPv6 address like ```2000:7961:2181:f72f:1d28:fc56:91b3:55cf```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```29:9e:3d:28:4f:94```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://macejkovic-bruen.info you initially access a DNS server to translate the host portion (macejkovic-bruen) combined with the Top Level Domain (info) of the URL, to an IP address like ```176.220.44.206```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (compatible; MSIE 9.0; AOL 9.7; AOLBuild 4343.19; Windows NT 6.1; WOW64; Trident/5.0; FunWebProducts)```
...
<pre>
default   fe80:fb57:1d96:1c25:ecc3%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {25.223.162.97, 177.153.179.13}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 29:9e:3d:28:4f:94
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr ce:43:66:7c:6a:16
}</pre>
