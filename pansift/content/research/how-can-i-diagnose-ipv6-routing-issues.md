...
layout: research
ip_v4_address: "54.36.152.210"
date: 2023-02-04T17:08:34+00:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like ```54.36.152.210``` or an IPv6 address like ```2000:a257:8d43:e1a5:3164:c573:39a5:a3fc```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```c9:87:47:7a:d9:74```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://watsica-langworth.io you initially access a DNS server to translate the host portion (watsica-langworth) combined with the Top Level Domain (io) of the URL, to an IP address like ```94.86.255.123```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (compatible; MSIE 9.0; AOL 9.7; AOLBuild 4343.19; Windows NT 6.1; WOW64; Trident/5.0; FunWebProducts)```
...
<pre>
default   fe80:a084:aa48:90a8:ba42%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {201.163.227.35, 133.159.89.205}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr c9:87:47:7a:d9:74
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr ad:1c:6a:8a:df:69
}</pre>
