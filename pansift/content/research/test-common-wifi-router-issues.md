...
layout: research
ip_v4_address: "192.129.237.212"
date: 2022-06-04T14:38:17+01:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like ```192.129.237.212``` or an IPv6 address like ```2000:d2d2:d731:4931:d55f:1a2c:8cd2:986c```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```2a:b6:55:a4:df:42```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://shields-corwin.co you initially access a DNS server to translate the host portion (shields-corwin) combined with the Top Level Domain (co) of the URL, to an IP address like ```195.225.89.82```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT x.y; Win64; x64; rv:10.0) Gecko/20100101 Firefox/10.0```
...
<pre>
default   fe80:e2ec:6f0f:8b50:5cba%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {251.201.95.136, 69.19.135.199}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 2a:b6:55:a4:df:42
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 7c:18:9e:ac:32:d9
}</pre>
