---
title: "How Do You Support Ping Issues"
subtitle: "Let's Take This Offline?"
layout: research
ip_v4_address: "13.8.216.75"
date: 2022-04-24T19:00:02+01:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like <code>13.8.216.75</code> or an IPv6 address like <code>2000:6a8d:3da2:1529:61b0:9df8:db70:25b3</code>. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>a7:e9:3f:e8:da:31</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://willms-rutherford.net you initially access a DNS server to translate the host portion (willms-rutherford) combined with the Top Level Domain (net) of the URL, to an IP address like <code>8.35.218.71</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (Windows NT 6.1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/41.0.2228.0 Safari/537.36</code>

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like <code>192.168.154.218</code> (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For <code>IPv6</code> we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  192.168.154.218    UGScg  en0
...
<pre><code>
default   fe80:3cda:f82b:4ab4:9186%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {185.208.3.12, 98.185.97.250}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr a7:e9:3f:e8:da:31
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 75:5a:5d:30:c9:16
}</code></pre>
