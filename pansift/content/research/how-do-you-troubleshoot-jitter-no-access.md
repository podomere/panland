...
layout: research
ip_v4_address: "21.234.98.148"
date: 2022-05-05T14:29:48+01:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like ```21.234.98.148``` or an IPv6 address like ```2000:f93f:ce78:3c44:9aea:31d9:cdc4:9aa8```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```bc:95:d7:5b:34:c0```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://bashirian-wisozk.org you initially access a DNS server to translate the host portion (bashirian-wisozk) combined with the Top Level Domain (org) of the URL, to an IP address like ```19.129.213.12```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows; U; Win 9x 4.90; SG; rv:1.9.2.4) Gecko/20101104 Netscape/9.1.0285```
...
<pre>
default   fe80:84dc:adfa:3ef5:cacb%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {217.34.69.56, 154.251.208.218}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr bc:95:d7:5b:34:c0
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 79:46:cc:bc:0b:e1
}</pre>
