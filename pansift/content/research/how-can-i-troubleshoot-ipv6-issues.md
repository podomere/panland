...
subtitle: "Impact Map?"
layout: research
ip_v4_address: "50.238.86.224"
date: 2023-02-04T17:08:34+00:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like ```50.238.86.224``` or an IPv6 address like ```2000:5b6a:230a:9115:82d4:2c4e:e50a:1ce1```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```87:4b:18:f0:1f:3f```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://ohara-cummerata.co you initially access a DNS server to translate the host portion (ohara-cummerata) combined with the Top Level Domain (co) of the URL, to an IP address like ```182.242.137.246```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1; WOW64; Trident/7.0; AS; rv:11.0) like Gecko```
...
<pre>
default   fe80:7d06:81b8:56fd:c0%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {99.166.57.6, 7.231.225.4}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 87:4b:18:f0:1f:3f
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 7a:d2:44:76:9f:0a
}</pre>
