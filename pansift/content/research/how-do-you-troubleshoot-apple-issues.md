...
layout: research
ip_v4_address: "145.222.159.70"
date: 2022-11-19T19:13:17+00:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like ```145.222.159.70``` or an IPv6 address like ```2000:e8eb:c4fe:453:f587:ba49:b074:1178```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```7e:e5:d4:41:08:01```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://block-kiehn.name you initially access a DNS server to translate the host portion (block-kiehn) combined with the Top Level Domain (name) of the URL, to an IP address like ```211.136.4.129```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows; U; Win 9x 4.90; SG; rv:1.9.2.4) Gecko/20101104 Netscape/9.1.0285```
...
<pre>
default   fe80:5d83:da07:44f6:66fb%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {180.196.198.63, 117.185.89.188}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 7e:e5:d4:41:08:01
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 32:18:d2:06:b7:6d
}</pre>
