...
layout: research
ip_v4_address: "61.129.155.164"
date: 2022-06-12T14:09:24+01:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like ```61.129.155.164``` or an IPv6 address like ```2000:e30c:d3db:6c13:164b:5d28:f25c:2fdf```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```84:a1:21:31:a8:d6```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://kling-lubowitz.name you initially access a DNS server to translate the host portion (kling-lubowitz) combined with the Top Level Domain (name) of the URL, to an IP address like ```160.167.255.217```. Your computer and browser actually sends its type with all web requests e.g. <br>```Opera/9.80 (X11; Linux i686; Ubuntu/14.10) Presto/2.12.388 Version/12.16```
...
default  172.19.34.144    UGScg  en0
...
<pre>
default   fe80:32a4:13c0:df9a:2a55%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {22.10.44.55, 11.19.181.15}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 84:a1:21:31:a8:d6
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 86:8b:a5:2b:58:d4
}</pre>
