...
subtitle: "Granular?"
layout: research
ip_v4_address: "150.203.229.230"
date: 2022-04-24T18:59:56+01:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like <code>150.203.229.230</code> or an IPv6 address like <code>2000:55d1:fcbf:4f38:246c:5139:f834:383a</code>. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>4f:19:9d:e2:8e:63</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://windler.com you initially access a DNS server to translate the host portion (windler) combined with the Top Level Domain (com) of the URL, to an IP address like <code>46.124.237.144</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (Windows NT 6.1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/41.0.2228.0 Safari/537.36</code>
...
<pre><code>
default   fe80:d6bb:8772:c469:897%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {66.53.71.123, 50.33.246.126}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 4f:19:9d:e2:8e:63
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr b6:e4:93:4e:1e:77
}</code></pre>
