...
layout: research
ip_v4_address: "44.84.86.170"
date: 2023-02-04T16:26:11+00:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like ```44.84.86.170``` or an IPv6 address like ```2000:77aa:a51a:be53:102a:3ca7:4226:32ad```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```8b:2a:cf:7a:e9:82```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://pouros-bosco.biz you initially access a DNS server to translate the host portion (pouros-bosco) combined with the Top Level Domain (biz) of the URL, to an IP address like ```58.187.122.235```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_3) AppleWebKit/537.75.14 (KHTML, like Gecko) Version/7.0.3 Safari/7046A194A```
...
<pre>
default   fe80:6ec4:1775:98b9:a290%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {36.244.98.80, 167.117.132.206}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 8b:2a:cf:7a:e9:82
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr df:b9:57:34:76:eb
}</pre>
