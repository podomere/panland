...
layout: research
ip_v4_address: "89.181.44.196"
date: 2022-05-05T14:29:34+01:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like ```89.181.44.196``` or an IPv6 address like ```d9:d9f1:4c2e:4121:2f2a:b056:c8c3:df6a```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```70:e3:4f:01:51:f4```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://yundt.info you initially access a DNS server to translate the host portion (yundt) combined with the Top Level Domain (info) of the URL, to an IP address like ```156.136.73.11```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_3) AppleWebKit/537.75.14 (KHTML, like Gecko) Version/7.0.3 Safari/7046A194A```
...
<pre>
default   fe80:933b:ec02:23e5:d9b%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {46.13.126.186, 66.93.3.206}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 70:e3:4f:01:51:f4
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 10:a7:26:45:24:fe
}</pre>
