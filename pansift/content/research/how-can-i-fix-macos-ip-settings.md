...
subtitle: "Deep Dive?"
layout: research
ip_v4_address: "21.227.210.244"
date: 2022-06-12T14:09:15+01:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like ```21.227.210.244``` or an IPv6 address like ```2000:5a59:868:f180:2144:ec8a:a282:4b7a```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```c7:cf:9d:17:ba:7f```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://brekke.net you initially access a DNS server to translate the host portion (brekke) combined with the Top Level Domain (net) of the URL, to an IP address like ```18.43.181.35```. Your computer and browser actually sends its type with all web requests e.g. <br>```Opera/9.80 (X11; Linux i686; Ubuntu/14.10) Presto/2.12.388 Version/12.16```

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```10.88.198.162``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  10.88.198.162    UGScg  en0
...
<pre>
default   fe80:7e8f:b4ef:c1f9:364d%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {165.210.161.187, 178.160.112.118}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr c7:cf:9d:17:ba:7f
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 31:bb:c7:5f:90:28
}</pre>
...
## Apple macOS / OSX
No matter what version of OSX/macOS you are on, ```10.11.6```, ```11.2.5```, or ```12.3.4```, there are a range of tools for troubleshooting. Unfortunately, between these manual actions and scripts, they don't give you a series of correlated values over time. This is where automated remote troubleshooting comes in to its own, especially for teams that embrace remote work and Work From Anywhere (WFA).
