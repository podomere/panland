...
layout: research
ip_v4_address: "208.208.36.186"
date: 2022-11-02T11:33:01+00:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like ```208.208.36.186``` or an IPv6 address like ```2000:781a:6291:ff0:b1f2:62fe:c5bf:905f```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```52:1e:c4:bc:7f:1b```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://ortiz-hirthe.co you initially access a DNS server to translate the host portion (ortiz-hirthe) combined with the Top Level Domain (co) of the URL, to an IP address like ```199.190.124.30```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (compatible; MSIE 9.0; AOL 9.7; AOLBuild 4343.19; Windows NT 6.1; WOW64; Trident/5.0; FunWebProducts)```
...
<pre>
default   fe80:4d9f:186d:4338:2dc3%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {129.239.59.215, 220.130.187.50}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 52:1e:c4:bc:7f:1b
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 12:ef:fb:e9:08:57
}</pre>
