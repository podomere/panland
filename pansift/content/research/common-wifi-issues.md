...
subtitle: "Granular?"
layout: research
ip_v4_address: "5.61.223.89"
date: 2022-04-24T19:00:33+01:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like <code>5.61.223.89</code> or an IPv6 address like <code>2000:e820:1bae:d2a5:f2f:918e:f744:bb56</code>. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>fb:0f:da:ca:f9:13</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://howell-gibson.io you initially access a DNS server to translate the host portion (howell-gibson) combined with the Top Level Domain (io) of the URL, to an IP address like <code>174.161.25.191</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_3) AppleWebKit/537.75.14 (KHTML, like Gecko) Version/7.0.3 Safari/7046A194A</code>
...
<pre><code>
default   fe80:8827:a773:42be:3e30%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {184.173.76.127, 102.34.91.71}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr fb:0f:da:ca:f9:13
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr d7:0b:c9:d9:6a:6a
}</code></pre>
