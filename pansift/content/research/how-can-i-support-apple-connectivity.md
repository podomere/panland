...
layout: research
ip_v4_address: "92.146.232.200"
date: 2023-10-29T15:13:19+00:00
draft: false
---

## Internet Addressing
On the Internet you may have a Public IPv4 address like ```92.146.232.200``` or an IPv6 address like ```2000:3b3a:1f2f:8523:9068:5ddb:4433:f6ed```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```53:f4:44:24:7c:60```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://kreiger-rutherford.co you initially access a DNS server to translate the host portion (kreiger-rutherford) combined with the Top Level Domain (co) of the URL, to an IP address like ```31.42.212.124```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1; WOW64; Trident/7.0; AS; rv:11.0) like Gecko```
...
<pre>
default   fe80:5a4f:60d1:2627:a382%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {69.54.75.25, 192.222.58.12}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 53:f4:44:24:7c:60
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr d1:23:71:eb:7a:fd
}</pre>
