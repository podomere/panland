...
subtitle: "Granular?"
layout: research
ip_v4_address: "53.188.74.215"
date: 2023-10-29T15:13:12+00:00
draft: false
---

## Internet Addressing
On the Internet you might get a Public IPv4 address like ```53.188.74.215``` or an IPv6 address like ```2000:65b8:14ed:9274:34b5:903:9320:6fcc```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```e6:8f:d1:7b:14:ea```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://harber.name you initially access a DNS server to translate the host portion (harber) combined with the Top Level Domain (name) of the URL, to an IP address like ```3.8.210.49```. Your computer and browser actually sends its type with all web requests e.g. <br>```Opera/9.80 (X11; Linux i686; Ubuntu/14.10) Presto/2.12.388 Version/12.16```
...
<pre>
default   fe80:ca2e:bf50:552c:4318%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {66.6.220.115, 19.240.146.42}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr e6:8f:d1:7b:14:ea
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 70:d9:40:54:10:0d
}</pre>
