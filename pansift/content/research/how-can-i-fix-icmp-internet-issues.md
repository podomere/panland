...
subtitle: "Swim Lane?"
layout: research
ip_v4_address: "98.58.132.63"
date: 2023-10-29T15:13:28+00:00
draft: false
---

## Internet Addressing
On the Internet you may have a Public IPv4 address like ```98.58.132.63``` or an IPv6 address like ```2000:3232:47cc:66d8:2461:4c2d:f64c:4d54```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```da:b0:d2:0e:61:d4```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://mcdermott.io you initially access a DNS server to translate the host portion (mcdermott) combined with the Top Level Domain (io) of the URL, to an IP address like ```189.239.96.44```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1; WOW64; Trident/7.0; AS; rv:11.0) like Gecko```

## Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```10.204.102.163``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  10.204.102.163    UGScg  en0
...
<pre>
default   fe80:39dd:4fff:22ea:eebe%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {46.152.45.70, 193.150.84.234}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr da:b0:d2:0e:61:d4
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 65:f3:71:1b:c6:62
}</pre>
...
### Apple macOS / OSX
No matter what version of OSX/macOS you are on, ```10.12.8```, ```11.1.1```, or ```12.1.9```, there are a range of tools for troubleshooting. Unfortunately, between these manual actions and scripts, they don't give you a series of correlated values over time. This is where automated remote troubleshooting comes in to its own, especially for teams that embrace remote work and Work From Anywhere (WFA).
