...
subtitle: "Impact Map?"
layout: research
ip_v4_address: "31.205.208.141"
date: 2023-10-29T15:13:29+00:00
draft: false
---

## Internet Addressing
On the Internet you may have a Public IPv4 address like ```31.205.208.141``` or an IPv6 address like ```2000:c891:6b2b:e140:84a0:9050:8fd1:5362```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```1b:74:ae:e8:40:16```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://gusikowski.net you initially access a DNS server to translate the host portion (gusikowski) combined with the Top Level Domain (net) of the URL, to an IP address like ```59.188.212.244```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (compatible; MSIE 9.0; AOL 9.7; AOLBuild 4343.19; Windows NT 6.1; WOW64; Trident/5.0; FunWebProducts)```
...
<pre>
default   fe80:4abf:f3d1:9f93:cfdc%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {123.169.88.222, 146.159.59.77}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 1b:74:ae:e8:40:16
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr ce:29:2c:0f:e4:30
}</pre>
