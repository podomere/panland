...
layout: research
ip_v4_address: "238.198.28.35"
date: 2022-11-19T16:17:06+00:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like ```238.198.28.35``` or an IPv6 address like ```2000:3767:7c33:f075:4b58:4079:de5e:9f11```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```80:cf:40:a6:a2:61```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://kshlerin-balistreri.name you initially access a DNS server to translate the host portion (kshlerin-balistreri) combined with the Top Level Domain (name) of the URL, to an IP address like ```39.215.129.46```. Your computer and browser actually sends its type with all web requests e.g. <br>```Opera/9.80 (X11; Linux i686; Ubuntu/14.10) Presto/2.12.388 Version/12.16```
...
<pre>
default   fe80:40d8:100f:3c03:e531%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {121.182.114.179, 76.26.166.130}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 80:cf:40:a6:a2:61
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 84:41:44:46:45:0e
}</pre>
