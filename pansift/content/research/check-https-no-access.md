...
subtitle: "Heads Down?"
layout: research
ip_v4_address: "209.219.147.9"
date: 2022-11-19T16:17:25+00:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like ```209.219.147.9``` or an IPv6 address like ```2000:47f6:dd3e:eadb:b0ee:bc22:f84b:540d```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```ba:17:e0:51:c7:41```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://skiles-beahan.biz you initially access a DNS server to translate the host portion (skiles-beahan) combined with the Top Level Domain (biz) of the URL, to an IP address like ```39.51.238.71```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_3) AppleWebKit/537.75.14 (KHTML, like Gecko) Version/7.0.3 Safari/7046A194A```
...
<pre>
default   fe80:dd00:73f:a73d:7ff9%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {239.76.221.25, 136.55.132.100}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr ba:17:e0:51:c7:41
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 4d:51:93:d3:30:d7
}</pre>
