...
subtitle: "Value Add?"
layout: research
ip_v4_address: "147.102.197.244"
date: 2022-11-19T16:17:19+00:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like ```147.102.197.244``` or an IPv6 address like ```2000:47b:9797:8706:ea86:83f2:57d2:d130```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```90:b3:e0:21:b9:a6```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://denesik-klein.co you initially access a DNS server to translate the host portion (denesik-klein) combined with the Top Level Domain (co) of the URL, to an IP address like ```248.208.72.141```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT x.y; Win64; x64; rv:10.0) Gecko/20100101 Firefox/10.0```
...
<pre>
default   fe80:a4d:9e13:b1ad:3b34%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {220.147.72.237, 248.142.165.238}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 90:b3:e0:21:b9:a6
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 9e:19:25:53:1b:8a
}</pre>
