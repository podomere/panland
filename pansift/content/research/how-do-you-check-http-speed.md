...
subtitle: "Streamline?"
layout: research
ip_v4_address: "41.166.32.52"
date: 2022-11-19T19:13:28+00:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like ```41.166.32.52``` or an IPv6 address like ```2000:4114:2ca:4189:721d:debb:6e86:7afa```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```ae:c7:1a:38:8b:e1```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://grant-lesch.name you initially access a DNS server to translate the host portion (grant-lesch) combined with the Top Level Domain (name) of the URL, to an IP address like ```7.135.229.186```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/41.0.2228.0 Safari/537.36```
...
default  192.168.132.249    UGScg  en0
...
<pre>
default   fe80:99e0:d32a:b15d:dad0%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {183.171.197.99, 82.157.137.182}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr ae:c7:1a:38:8b:e1
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr d1:f3:75:fb:a2:a3
}</pre>
