...
layout: research
ip_v4_address: "18.8.43.83"
date: 2022-06-12T14:09:06+01:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like ```18.8.43.83``` or an IPv6 address like ```2000:df9b:f07a:8ef5:1725:642b:4633:aab0```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```cb:12:5b:05:cb:04```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://schneider-schumm.io you initially access a DNS server to translate the host portion (schneider-schumm) combined with the Top Level Domain (io) of the URL, to an IP address like ```136.252.137.211```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT x.y; Win64; x64; rv:10.0) Gecko/20100101 Firefox/10.0```
...
<pre>
default   fe80:bc0d:9f36:35c1:41b0%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {139.38.39.177, 225.219.158.216}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr cb:12:5b:05:cb:04
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr f4:67:22:9e:8c:b0
}</pre>
