...
layout: research
ip_v4_address: "48.49.18.214"
date: 2022-04-24T19:00:25+01:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like <code>48.49.18.214</code> or an IPv6 address like <code>2000:b398:51f7:1216:11a3:4158:64f3:e4c8</code>. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>2b:25:44:20:e1:b3</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://mayert-batz.biz you initially access a DNS server to translate the host portion (mayert-batz) combined with the Top Level Domain (biz) of the URL, to an IP address like <code>86.156.24.72</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (Windows NT x.y; Win64; x64; rv:10.0) Gecko/20100101 Firefox/10.0</code>
...
<pre><code>
default   fe80:595:52e8:2767:2ace%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {7.205.141.133, 142.166.183.255}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 2b:25:44:20:e1:b3
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 1e:47:33:a4:9b:1f
}</code></pre>
