...
layout: research
ip_v4_address: "70.213.255.25"
date: 2022-11-19T16:17:22+00:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like ```70.213.255.25``` or an IPv6 address like ```2000:57d8:1650:f081:dd11:fd8c:5d66:4576```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```af:8e:62:dc:c9:ec```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://towne-hartmann.com you initially access a DNS server to translate the host portion (towne-hartmann) combined with the Top Level Domain (com) of the URL, to an IP address like ```70.50.177.161```. Your computer and browser actually sends its type with all web requests e.g. <br>```Opera/9.80 (X11; Linux i686; Ubuntu/14.10) Presto/2.12.388 Version/12.16```
...
<pre>
default   fe80:aa14:9b3f:584d:d632%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {17.17.117.5, 77.140.233.204}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr af:8e:62:dc:c9:ec
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr a2:f8:93:9d:91:7f
}</pre>
