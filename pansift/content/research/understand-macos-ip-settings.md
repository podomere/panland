...
subtitle: "Deep Dive?"
layout: research
ip_v4_address: "222.21.240.112"
date: 2023-02-04T17:07:48+00:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like ```222.21.240.112``` or an IPv6 address like ```2000:5186:603e:9670:22e6:3b2f:312a:1d6```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```f1:c4:fa:f2:4f:2b```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://bayer-nolan.info you initially access a DNS server to translate the host portion (bayer-nolan) combined with the Top Level Domain (info) of the URL, to an IP address like ```226.27.70.252```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (compatible; MSIE 9.0; AOL 9.7; AOLBuild 4343.19; Windows NT 6.1; WOW64; Trident/5.0; FunWebProducts)```
...
<pre>
default   fe80:8aec:88d0:b3bd:553f%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {3.248.157.102, 204.117.241.142}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr f1:c4:fa:f2:4f:2b
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 47:f1:5f:2e:1c:54
}</pre>
