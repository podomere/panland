...
layout: research
ip_v4_address: "71.146.114.36"
date: 2023-02-04T17:08:39+00:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like ```71.146.114.36``` or an IPv6 address like ```2000:94a4:97cd:4107:73e7:f6f9:598:d2e6```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```5f:a8:1f:76:1b:1f```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://lesch-zboncak.biz you initially access a DNS server to translate the host portion (lesch-zboncak) combined with the Top Level Domain (biz) of the URL, to an IP address like ```77.229.228.211```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/41.0.2228.0 Safari/537.36```
...
<pre>
default   fe80:6a6c:ecc8:89c3:8f37%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {42.253.106.247, 209.109.118.132}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 5f:a8:1f:76:1b:1f
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 74:60:cd:a9:b4:67
}</pre>
