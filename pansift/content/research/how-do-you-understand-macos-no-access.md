...
subtitle: "Swag?"
layout: research
ip_v4_address: "252.151.224.49"
date: 2022-04-24T18:31:57+01:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like <code>252.151.224.49</code> or an IPv6 address like <code>2000:400c:65fe:8626:3731:c4d5:e80d:6f0b</code>. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>7d:ff:96:4f:05:0b</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://stoltenberg-dubuque.io you initially access a DNS server to translate the host portion (stoltenberg-dubuque) combined with the Top Level Domain (io) of the URL, to an IP address like <code>74.110.218.236</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (Windows NT 6.1; WOW64; Trident/7.0; AS; rv:11.0) like Gecko</code>
...
<pre><code>
default   fe80:8225:4554:9802:50b3%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {66.248.11.148, 231.224.7.78}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 7d:ff:96:4f:05:0b
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 30:2b:a5:e7:7a:ca
}</code></pre>
