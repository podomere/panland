...
subtitle: "Deep Dive?"
layout: research
ip_v4_address: "255.30.135.85"
date: 2022-06-04T14:38:29+01:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like ```255.30.135.85``` or an IPv6 address like ```2000:33e1:800a:acda:2a3:ccdd:7cc0:dfe6```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```27:15:71:2a:24:ef```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://hegmann-leuschke.info you initially access a DNS server to translate the host portion (hegmann-leuschke) combined with the Top Level Domain (info) of the URL, to an IP address like ```49.5.251.68```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (compatible; MSIE 9.0; AOL 9.7; AOLBuild 4343.19; Windows NT 6.1; WOW64; Trident/5.0; FunWebProducts)```
...
default  172.24.18.188    UGScg  en0
...
<pre>
default   fe80:e43e:6303:9169:c242%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {126.63.247.239, 2.208.28.205}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 27:15:71:2a:24:ef
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr b5:b9:d2:c7:20:46
}</pre>
