...
layout: research
ip_v4_address: "185.100.25.53"
date: 2022-12-15T13:50:03+00:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like ```185.100.25.53``` or an IPv6 address like ```2000:2c71:3f2e:c800:3291:9542:6855:cbfd```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```66:90:fb:ce:dd:28```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://koss-kovacek.name you initially access a DNS server to translate the host portion (koss-kovacek) combined with the Top Level Domain (name) of the URL, to an IP address like ```36.247.245.45```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (compatible; MSIE 9.0; AOL 9.7; AOLBuild 4343.19; Windows NT 6.1; WOW64; Trident/5.0; FunWebProducts)```

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```10.204.23.190``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  10.204.23.190    UGScg  en0
...
<pre>
default   fe80:32e8:4b53:6bfc:9b0d%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {33.34.20.99, 215.28.14.19}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 66:90:fb:ce:dd:28
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr e7:e4:be:a5:9e:a2
}</pre>
