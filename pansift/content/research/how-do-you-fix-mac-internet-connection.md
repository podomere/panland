...
subtitle: "Etc. Etc.?"
layout: research
ip_v4_address: "151.137.47.64"
date: 2022-12-15T13:50:11+00:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like ```151.137.47.64``` or an IPv6 address like ```2000:8578:6d61:7490:6d67:a580:b50:7d0```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```94:bb:94:4e:47:76```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://kautzer.org you initially access a DNS server to translate the host portion (kautzer) combined with the Top Level Domain (org) of the URL, to an IP address like ```140.69.169.107```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (compatible; MSIE 9.0; AOL 9.7; AOLBuild 4343.19; Windows NT 6.1; WOW64; Trident/5.0; FunWebProducts)```
...
<pre>
default   fe80:7b54:c2a:2922:67de%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {65.212.142.56, 159.255.207.173}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 94:bb:94:4e:47:76
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 68:9d:ae:17:5b:0f
}</pre>
