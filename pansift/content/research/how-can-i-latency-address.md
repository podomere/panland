...
subtitle: "Etc. Etc.?"
layout: research
ip_v4_address: "109.221.130.185"
date: 2022-11-19T16:17:21+00:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like ```109.221.130.185``` or an IPv6 address like ```2000:e9ff:7c3a:4d76:c0f2:e8ea:7875:f733```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```ff:58:7f:f1:a8:8d```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://frami-kessler.com you initially access a DNS server to translate the host portion (frami-kessler) combined with the Top Level Domain (com) of the URL, to an IP address like ```142.69.116.1```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (compatible; MSIE 9.0; AOL 9.7; AOLBuild 4343.19; Windows NT 6.1; WOW64; Trident/5.0; FunWebProducts)```
...
<pre>
default   fe80:3fa9:29d4:3782:eaef%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {164.216.81.52, 170.254.252.220}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr ff:58:7f:f1:a8:8d
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 90:b9:0c:9a:3f:25
}</pre>
