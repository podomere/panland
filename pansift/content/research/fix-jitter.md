...
subtitle: "Ideate?"
layout: research
ip_v4_address: "31.90.198.244"
date: 2022-06-12T14:09:25+01:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like ```31.90.198.244``` or an IPv6 address like ```2000:c862:613f:58f:60c4:c772:263e:d27c```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```5d:d1:1d:0b:71:82```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://strosin.net you initially access a DNS server to translate the host portion (strosin) combined with the Top Level Domain (net) of the URL, to an IP address like ```18.150.203.212```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows; U; Win 9x 4.90; SG; rv:1.9.2.4) Gecko/20101104 Netscape/9.1.0285```
...
<pre>
default   fe80:79e5:b5f5:5ce3:79d4%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {166.198.151.137, 51.109.104.160}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 5d:d1:1d:0b:71:82
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 12:98:d7:57:d6:af
}</pre>
