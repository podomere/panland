...
layout: research
ip_v4_address: "63.34.16.181"
date: 2023-02-04T17:07:49+00:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like ```63.34.16.181``` or an IPv6 address like ```2000:f718:8ee4:6da2:bb23:39b5:c1dc:5301```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```cd:7e:4b:a8:f2:88```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://frami-baumbach.com you initially access a DNS server to translate the host portion (frami-baumbach) combined with the Top Level Domain (com) of the URL, to an IP address like ```213.245.66.93```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1; WOW64; Trident/7.0; AS; rv:11.0) like Gecko```
...
<pre>
default   fe80:6d63:83d6:e72f:82c3%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {40.68.147.47, 138.58.92.249}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr cd:7e:4b:a8:f2:88
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 9c:34:f8:d1:e6:45
}</pre>
