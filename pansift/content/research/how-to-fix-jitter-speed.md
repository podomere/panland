...
layout: research
ip_v4_address: "149.149.255.13"
date: 2022-11-02T11:32:57+00:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like ```149.149.255.13``` or an IPv6 address like ```2000:f5e4:9e4b:c01c:86d5:821:9654:a535```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```a6:c2:d5:95:de:50```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://ruecker.com you initially access a DNS server to translate the host portion (ruecker) combined with the Top Level Domain (com) of the URL, to an IP address like ```159.187.91.193```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (compatible; MSIE 9.0; AOL 9.7; AOLBuild 4343.19; Windows NT 6.1; WOW64; Trident/5.0; FunWebProducts)```

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```172.24.219.177``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  172.24.219.177    UGScg  en0
...
<pre>
default   fe80:c104:d20d:a0e9:fa1%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {185.108.218.80, 180.94.86.107}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr a6:c2:d5:95:de:50
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 2d:c6:b7:45:bd:3d
}</pre>
...
## Apple macOS / OSX
No matter what version of OSX/macOS you are on, ```10.13.3```, ```11.6.8```, or ```12.1.1```, there are a range of tools for troubleshooting. Unfortunately, between these manual actions and scripts, they don't give you a series of correlated values over time. This is where automated remote troubleshooting comes in to its own, especially for teams that embrace remote work and Work From Anywhere (WFA).
