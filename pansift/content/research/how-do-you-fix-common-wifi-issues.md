...
layout: research
ip_v4_address: "240.209.132.99"
date: 2022-04-24T18:32:42+01:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like <code>240.209.132.99</code> or an IPv6 address like <code>2000:5c89:7b10:d4a0:9196:9520:9615:17e</code>. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>13:c6:2d:5c:1e:3a</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://harvey-will.biz you initially access a DNS server to translate the host portion (harvey-will) combined with the Top Level Domain (biz) of the URL, to an IP address like <code>130.146.130.163</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Opera/9.80 (X11; Linux i686; Ubuntu/14.10) Presto/2.12.388 Version/12.16</code>
...
<pre><code>
default   fe80:660c:42c5:16f2:b83e%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {71.252.98.24, 106.138.218.176}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 13:c6:2d:5c:1e:3a
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr d1:61:19:47:48:04
}</code></pre>
