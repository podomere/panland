...
layout: research
ip_v4_address: "66.122.65.193"
date: 2022-05-05T14:30:01+01:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like ```66.122.65.193``` or an IPv6 address like ```2000:3eec:9dd3:dc2b:85a6:9edb:2024:8eb3```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```1c:2c:db:73:52:be```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://kuhlman.co you initially access a DNS server to translate the host portion (kuhlman) combined with the Top Level Domain (co) of the URL, to an IP address like ```212.226.44.246```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows; U; Win 9x 4.90; SG; rv:1.9.2.4) Gecko/20101104 Netscape/9.1.0285```
...
default  172.18.86.30    UGScg  en0
...
<pre>
default   fe80:f341:9253:b9b5:72b3%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {185.29.179.104, 116.189.222.21}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 1c:2c:db:73:52:be
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr c5:e8:a8:bd:90:d3
}</pre>
