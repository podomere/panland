...
subtitle: "Impact Map?"
layout: research
ip_v4_address: "10.132.98.34"
date: 2022-11-02T11:33:11+00:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like ```10.132.98.34``` or an IPv6 address like ```2000:e30e:8119:542b:545a:f235:2071:62ea```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```75:5b:71:16:ae:51```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://kuhic-robel.co you initially access a DNS server to translate the host portion (kuhic-robel) combined with the Top Level Domain (co) of the URL, to an IP address like ```221.178.187.116```. Your computer and browser actually sends its type with all web requests e.g. <br>```Opera/9.80 (X11; Linux i686; Ubuntu/14.10) Presto/2.12.388 Version/12.16```
...
<pre>
default   fe80:613d:8b65:c3db:22ce%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {188.111.214.6, 14.23.148.107}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 75:5b:71:16:ae:51
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 6b:f2:24:0e:1b:53
}</pre>
