...
layout: research
ip_v4_address: "159.112.154.207"
date: 2023-10-29T15:13:26+00:00
draft: false
---

## Internet Addressing
On the Internet you may get a Public IPv4 address like ```159.112.154.207``` or an IPv6 address like ```2000:d3f6:b3a8:c651:3587:f84d:16f8:9ad7```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```c2:06:22:f5:33:21```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://rippin-wiegand.info you initially access a DNS server to translate the host portion (rippin-wiegand) combined with the Top Level Domain (info) of the URL, to an IP address like ```27.223.152.124```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows; U; Win 9x 4.90; SG; rv:1.9.2.4) Gecko/20101104 Netscape/9.1.0285```
...
<pre>
default   fe80:fb9c:b537:234f:f9e%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {149.106.147.129, 163.128.79.206}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr c2:06:22:f5:33:21
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 85:37:10:7c:34:3e
}</pre>
