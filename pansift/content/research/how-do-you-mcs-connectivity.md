...
subtitle: "Tee It Up?"
layout: research
ip_v4_address: "63.250.147.190"
date: 2022-06-12T14:09:05+01:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like ```63.250.147.190``` or an IPv6 address like ```2000:a08b:8702:c843:12c0:ba4c:f29c:aba7```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```da:76:cc:ce:3f:5f```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://batz.info you initially access a DNS server to translate the host portion (batz) combined with the Top Level Domain (info) of the URL, to an IP address like ```166.142.182.216```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1; WOW64; Trident/7.0; AS; rv:11.0) like Gecko```
...
<pre>
default   fe80:a944:d0be:4048:2a32%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {87.100.241.38, 29.161.49.8}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr da:76:cc:ce:3f:5f
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr d7:c4:0b:bd:18:bd
}</pre>
...
## Apple macOS / OSX
No matter what version of OSX/macOS you are on, ```10.12.8```, ```11.3.7```, or ```12.3.5```, there are a range of tools for troubleshooting. Unfortunately, between these manual actions and scripts, they don't give you a series of correlated values over time. This is where automated remote troubleshooting comes in to its own, especially for teams that embrace remote work and Work From Anywhere (WFA).
