...
subtitle: "Synergy?"
layout: research
ip_v4_address: "102.232.149.162"
date: 2022-11-19T19:13:09+00:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like ```102.232.149.162``` or an IPv6 address like ```2000:c6f2:f875:2dc0:71a1:fc8e:7ea:4d69```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```6a:63:ac:35:a3:9e```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://kuhn.biz you initially access a DNS server to translate the host portion (kuhn) combined with the Top Level Domain (biz) of the URL, to an IP address like ```213.193.224.19```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT x.y; Win64; x64; rv:10.0) Gecko/20100101 Firefox/10.0```

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```192.168.179.113``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  192.168.179.113    UGScg  en0
...
<pre>
default   fe80:5c4d:7a3a:4c72:a816%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {37.93.223.108, 126.106.177.33}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 6a:63:ac:35:a3:9e
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr fe:65:08:6e:64:fd
}</pre>
