...
subtitle: "Impact Map?"
layout: research
ip_v4_address: "244.129.78.10"
date: 2023-10-29T15:13:19+00:00
draft: false
---

## Internet Addressing
On the Internet you might have a Public IPv4 address like ```244.129.78.10``` or an IPv6 address like ```2000:e696:1d26:bd6b:aa03:2351:9209:bf09```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```a2:cc:bb:07:07:2e```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://schumm-hermiston.co you initially access a DNS server to translate the host portion (schumm-hermiston) combined with the Top Level Domain (co) of the URL, to an IP address like ```1.142.133.192```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1; WOW64; Trident/7.0; AS; rv:11.0) like Gecko```
...
<pre>
default   fe80:2548:6e92:47b3:4a6a%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {124.213.1.233, 38.85.10.80}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr a2:cc:bb:07:07:2e
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr f5:98:11:b1:17:ac
}</pre>
