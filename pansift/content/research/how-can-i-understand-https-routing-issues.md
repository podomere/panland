...
layout: research
ip_v4_address: "68.184.50.101"
date: 2022-12-15T13:50:22+00:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like ```68.184.50.101``` or an IPv6 address like ```2000:daf3:a62c:1003:f99d:e693:3754:f1b3```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```91:bc:86:c6:57:81```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://wintheiser-brekke.biz you initially access a DNS server to translate the host portion (wintheiser-brekke) combined with the Top Level Domain (biz) of the URL, to an IP address like ```17.95.236.42```. Your computer and browser actually sends its type with all web requests e.g. <br>```Opera/9.80 (X11; Linux i686; Ubuntu/14.10) Presto/2.12.388 Version/12.16```
...
<pre>
default   fe80:5339:8836:932c:e2d%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {183.137.134.82, 136.48.90.223}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 91:bc:86:c6:57:81
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 39:d5:c1:94:e8:cf
}</pre>
