...
layout: research
ip_v4_address: "56.209.121.239"
date: 2022-04-24T19:00:24+01:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like <code>56.209.121.239</code> or an IPv6 address like <code>2000:e33d:c544:a59a:1936:a769:b4a1:cd68</code>. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>5e:1a:43:e4:d3:25</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://bosco-brakus.info you initially access a DNS server to translate the host portion (bosco-brakus) combined with the Top Level Domain (info) of the URL, to an IP address like <code>253.199.39.156</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (compatible; MSIE 9.0; AOL 9.7; AOLBuild 4343.19; Windows NT 6.1; WOW64; Trident/5.0; FunWebProducts)</code>
...
<pre><code>
default   fe80:b07c:cd26:67ee:2da4%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {86.121.124.136, 51.26.205.209}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 5e:1a:43:e4:d3:25
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 8e:35:70:fd:c4:71
}</code></pre>
