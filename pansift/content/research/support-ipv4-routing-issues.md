...
layout: research
ip_v4_address: "226.130.0.17"
date: 2022-06-04T14:38:37+01:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like ```226.130.0.17``` or an IPv6 address like ```2000:a082:89bd:8686:cbd5:8911:cc08:4b17```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```25:f9:06:13:e9:7b```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://ledner.io you initially access a DNS server to translate the host portion (ledner) combined with the Top Level Domain (io) of the URL, to an IP address like ```91.0.30.149```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/41.0.2228.0 Safari/537.36```

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```172.24.97.62``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  172.24.97.62    UGScg  en0
...
<pre>
default   fe80:76ee:72c7:141:c207%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {244.114.108.238, 239.248.129.132}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 25:f9:06:13:e9:7b
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr f9:7b:3a:a2:54:89
}</pre>
...
## Apple macOS / OSX
No matter what version of OSX/macOS you are on, ```10.14.7```, ```11.6.9```, or ```12.3.2```, there are a range of tools for troubleshooting. Unfortunately, between these manual actions and scripts, they don't give you a series of correlated values over time. This is where automated remote troubleshooting comes in to its own, especially for teams that embrace remote work and Work From Anywhere (WFA).
