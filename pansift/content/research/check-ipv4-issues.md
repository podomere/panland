...
layout: research
ip_v4_address: "34.212.181.123"
date: 2023-10-29T15:13:25+00:00
draft: false
---

## Internet Addressing
On the Internet you might get a Public IPv4 address like ```34.212.181.123``` or an IPv6 address like ```2000:1da6:a7b9:d01b:f249:9cfc:45b7:38c3```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```34:6d:ff:7b:be:d9```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://parker.net you initially access a DNS server to translate the host portion (parker) combined with the Top Level Domain (net) of the URL, to an IP address like ```13.214.247.230```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_3) AppleWebKit/537.75.14 (KHTML, like Gecko) Version/7.0.3 Safari/7046A194A```
...
<pre>
default   fe80:ca20:9c15:78fe:1ccc%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {38.93.94.120, 54.191.146.118}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 34:6d:ff:7b:be:d9
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr c8:af:2d:6d:06:a7
}</pre>
