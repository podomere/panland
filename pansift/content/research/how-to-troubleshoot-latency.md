...
subtitle: "Streamline?"
layout: research
ip_v4_address: "71.249.227.130"
date: 2022-04-24T18:59:58+01:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like <code>71.249.227.130</code> or an IPv6 address like <code>2000:f134:a96e:e5c0:73e4:5707:a726:3856</code>. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>26:86:bd:3b:47:88</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://mcclure-wolf.net you initially access a DNS server to translate the host portion (mcclure-wolf) combined with the Top Level Domain (net) of the URL, to an IP address like <code>4.153.73.82</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (Windows; U; Win 9x 4.90; SG; rv:1.9.2.4) Gecko/20101104 Netscape/9.1.0285</code>
...
<pre><code>
default   fe80:d7c7:aa13:7fa:9bd1%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {178.56.244.4, 45.248.147.31}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 26:86:bd:3b:47:88
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 1a:74:f0:e5:0f:d4
}</code></pre>
