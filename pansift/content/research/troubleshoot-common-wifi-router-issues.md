...
subtitle: "Deep Dive?"
layout: research
ip_v4_address: "125.33.216.77"
date: 2022-11-02T11:32:24+00:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like ```125.33.216.77``` or an IPv6 address like ```2000:5100:dcd6:d7be:50cb:4407:7fe4:4ffb```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```20:a3:18:18:f5:9c```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://mertz-west.net you initially access a DNS server to translate the host portion (mertz-west) combined with the Top Level Domain (net) of the URL, to an IP address like ```104.117.207.52```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT x.y; Win64; x64; rv:10.0) Gecko/20100101 Firefox/10.0```
...
<pre>
default   fe80:3de4:f920:fe6b:4e6e%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {128.59.168.111, 73.28.40.115}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 20:a3:18:18:f5:9c
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr ff:2a:52:c0:5b:eb
}</pre>
