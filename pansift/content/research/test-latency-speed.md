---
title: "Test Latency Speed"
subtitle: "Penetrate The Market?"
layout: research
ip_v4_address: "76.99.55.70"
date: 2022-11-19T19:13:24+00:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like ```76.99.55.70``` or an IPv6 address like ```2000:ec7d:92c5:bc55:6e32:d76a:98ba:ffcb```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```f8:73:a9:20:94:6c```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://bashirian-cruickshank.co you initially access a DNS server to translate the host portion (bashirian-cruickshank) combined with the Top Level Domain (co) of the URL, to an IP address like ```149.18.105.107```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT x.y; Win64; x64; rv:10.0) Gecko/20100101 Firefox/10.0```

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```10.97.173.55``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  10.97.173.55    UGScg  en0
...
<pre>
default   fe80:cbf6:3a2f:39c2:713f%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {227.122.136.9, 3.30.127.63}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr f8:73:a9:20:94:6c
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 97:a5:b5:5f:a7:05
}</pre>
