...
layout: research
ip_v4_address: "33.101.250.7"
date: 2022-11-19T16:17:23+00:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like ```33.101.250.7``` or an IPv6 address like ```2000:f3a2:61b9:f8bd:5951:c442:a94f:b016```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```fe:f1:1f:10:8f:c2```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://walter-boyle.biz you initially access a DNS server to translate the host portion (walter-boyle) combined with the Top Level Domain (biz) of the URL, to an IP address like ```185.117.253.138```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows; U; Win 9x 4.90; SG; rv:1.9.2.4) Gecko/20101104 Netscape/9.1.0285```
...
<pre>
default   fe80:d2de:3e84:1f66:dd2e%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {195.26.1.187, 111.125.127.28}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr fe:f1:1f:10:8f:c2
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 62:b1:e2:58:cb:68
}</pre>
