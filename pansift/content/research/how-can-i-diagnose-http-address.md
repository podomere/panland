...
layout: research
ip_v4_address: "218.45.229.52"
date: 2023-02-04T16:26:23+00:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like ```218.45.229.52``` or an IPv6 address like ```2000:fbfd:11d8:1e1d:9dff:753e:7460:c637```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```83:d2:ac:e2:1f:3a```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://reynolds-muller.biz you initially access a DNS server to translate the host portion (reynolds-muller) combined with the Top Level Domain (biz) of the URL, to an IP address like ```135.147.162.231```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1; WOW64; Trident/7.0; AS; rv:11.0) like Gecko```
...
<pre>
default   fe80:838a:33a4:80e4:862b%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {42.42.216.150, 247.248.187.61}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 83:d2:ac:e2:1f:3a
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr f8:73:f1:4d:72:58
}</pre>
