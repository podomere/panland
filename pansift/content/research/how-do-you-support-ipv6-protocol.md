...
layout: research
ip_v4_address: "196.183.95.16"
date: 2022-12-15T13:50:16+00:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like ```196.183.95.16``` or an IPv6 address like ```2000:198b:849c:6c68:c44e:a347:f907:1175```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```7c:d8:73:a9:f5:3b```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://johnston-wilderman.org you initially access a DNS server to translate the host portion (johnston-wilderman) combined with the Top Level Domain (org) of the URL, to an IP address like ```189.243.75.247```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/41.0.2228.0 Safari/537.36```
...
<pre>
default   fe80:b749:fcbf:711c:8ba1%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {225.139.193.117, 170.177.21.156}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 7c:d8:73:a9:f5:3b
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr be:08:3f:b8:7c:77
}</pre>
