...
layout: research
ip_v4_address: "127.255.209.1"
date: 2022-05-05T14:29:29+01:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like ```127.255.209.1``` or an IPv6 address like ```2000:51b:5e4c:cdd5:1b3a:ab56:e161:565d```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```e8:b0:d9:5c:56:e2```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://stamm-price.co you initially access a DNS server to translate the host portion (stamm-price) combined with the Top Level Domain (co) of the URL, to an IP address like ```178.234.38.2```. Your computer and browser actually sends its type with all web requests e.g. <br>```Opera/9.80 (X11; Linux i686; Ubuntu/14.10) Presto/2.12.388 Version/12.16```

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```172.21.166.222``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  172.21.166.222    UGScg  en0
...
<pre>
default   fe80:75c0:b8d6:1ee3:a7fa%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {168.70.153.22, 192.253.196.193}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr e8:b0:d9:5c:56:e2
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 80:21:f4:e4:45:25
}</pre>
