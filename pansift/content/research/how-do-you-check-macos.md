...
layout: research
ip_v4_address: "97.235.89.169"
date: 2022-11-02T11:33:10+00:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like ```97.235.89.169``` or an IPv6 address like ```2000:b073:9dc:1b40:425c:2f12:bba4:a5b7```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```64:1c:41:65:89:10```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://veum.io you initially access a DNS server to translate the host portion (veum) combined with the Top Level Domain (io) of the URL, to an IP address like ```221.172.212.30```. Your computer and browser actually sends its type with all web requests e.g. <br>```Opera/9.80 (X11; Linux i686; Ubuntu/14.10) Presto/2.12.388 Version/12.16```
...
<pre>
default   fe80:5021:3823:6597:cbea%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {180.85.20.135, 105.1.49.130}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 64:1c:41:65:89:10
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 6a:1d:64:b3:07:51
}</pre>
