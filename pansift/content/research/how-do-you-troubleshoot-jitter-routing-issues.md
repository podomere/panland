...
layout: research
ip_v4_address: "73.196.150.197"
date: 2023-10-29T15:13:27+00:00
draft: false
---

## Internet Addressing
On the Internet you may have a Public IPv4 address like ```73.196.150.197``` or an IPv6 address like ```2000:27e8:c9bb:a902:86f0:5d6a:ba27:5a81```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```d6:9c:09:20:31:ad```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://cartwright-barton.info you initially access a DNS server to translate the host portion (cartwright-barton) combined with the Top Level Domain (info) of the URL, to an IP address like ```95.65.98.119```. Your computer and browser actually sends its type with all web requests e.g. <br>```Opera/9.80 (X11; Linux i686; Ubuntu/14.10) Presto/2.12.388 Version/12.16```
...
<pre>
default   fe80:6443:10cc:e274:ab03%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {187.163.142.195, 240.202.13.230}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr d6:9c:09:20:31:ad
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 90:07:24:e1:dd:de
}</pre>
