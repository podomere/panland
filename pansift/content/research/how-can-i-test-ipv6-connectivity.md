...
subtitle: "Learnings?"
layout: research
ip_v4_address: "246.160.208.204"
date: 2022-04-24T18:59:56+01:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like <code>246.160.208.204</code> or an IPv6 address like <code>2000:7fb8:ced0:471a:5ae4:6e0a:4775:e06d</code>. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>51:98:dd:26:0d:33</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://bartell-bartoletti.co you initially access a DNS server to translate the host portion (bartell-bartoletti) combined with the Top Level Domain (co) of the URL, to an IP address like <code>102.241.115.99</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (Windows; U; Win 9x 4.90; SG; rv:1.9.2.4) Gecko/20101104 Netscape/9.1.0285</code>
...
<pre><code>
default   fe80:c69d:bfc6:fda:917%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {102.233.68.133, 9.211.130.69}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 51:98:dd:26:0d:33
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr c1:c2:7c:53:8f:67
}</code></pre>
