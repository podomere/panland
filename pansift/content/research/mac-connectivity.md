...
layout: research
ip_v4_address: "57.197.127.245"
date: 2022-04-24T19:00:25+01:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like <code>57.197.127.245</code> or an IPv6 address like <code>2000:e451:3d1e:c28e:9748:a6ca:7573:6c09</code>. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>a3:e0:1a:b3:cf:62</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://mayer-green.name you initially access a DNS server to translate the host portion (mayer-green) combined with the Top Level Domain (name) of the URL, to an IP address like <code>95.196.253.0</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (Windows; U; Win 9x 4.90; SG; rv:1.9.2.4) Gecko/20101104 Netscape/9.1.0285</code>
...
<pre><code>
default   fe80:2d65:4383:3802:8e86%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {87.239.26.186, 205.236.26.147}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr a3:e0:1a:b3:cf:62
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr ea:c9:18:26:01:dc
}</code></pre>
