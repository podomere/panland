...
layout: research
ip_v4_address: "38.24.81.240"
date: 2022-11-19T19:13:08+00:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like ```38.24.81.240``` or an IPv6 address like ```2000:848:4af1:8601:574f:3613:948e:e6ba```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```6e:ae:4b:04:4e:9b```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://dubuque-gerlach.biz you initially access a DNS server to translate the host portion (dubuque-gerlach) combined with the Top Level Domain (biz) of the URL, to an IP address like ```115.3.119.203```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows; U; Win 9x 4.90; SG; rv:1.9.2.4) Gecko/20101104 Netscape/9.1.0285```
...
<pre>
default   fe80:995f:a900:c35e:add8%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {222.25.78.183, 169.151.82.250}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 6e:ae:4b:04:4e:9b
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr a2:b8:a6:d7:a9:65
}</pre>
