...
subtitle: "Streamline?"
layout: research
ip_v4_address: "97.66.40.39"
date: 2022-12-15T13:50:18+00:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like ```97.66.40.39``` or an IPv6 address like ```2000:2766:a76f:694:f0c3:efea:27d3:1bb4```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```d5:3b:45:88:ad:00```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://fisher-orn.net you initially access a DNS server to translate the host portion (fisher-orn) combined with the Top Level Domain (net) of the URL, to an IP address like ```25.15.150.74```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows; U; Win 9x 4.90; SG; rv:1.9.2.4) Gecko/20101104 Netscape/9.1.0285```
...
<pre>
default   fe80:7976:5c0d:71bb:b882%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {174.231.92.71, 230.247.153.98}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr d5:3b:45:88:ad:00
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 4e:04:f0:29:87:ba
}</pre>
