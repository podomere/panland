...
layout: research
ip_v4_address: "7.42.253.97"
date: 2022-11-19T16:17:13+00:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like ```7.42.253.97``` or an IPv6 address like ```2000:c88f:45cd:e7cc:7909:7df2:9e3f:fef6```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```9a:04:95:fb:2c:c6```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://hane-sipes.info you initially access a DNS server to translate the host portion (hane-sipes) combined with the Top Level Domain (info) of the URL, to an IP address like ```53.161.85.116```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT x.y; Win64; x64; rv:10.0) Gecko/20100101 Firefox/10.0```

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```192.168.54.30``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  192.168.54.30    UGScg  en0
...
<pre>
default   fe80:a7aa:6aec:b913:767a%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {147.248.181.14, 14.112.218.143}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 9a:04:95:fb:2c:c6
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 19:29:10:b8:03:99
}</pre>
