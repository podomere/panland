...
layout: research
ip_v4_address: "130.232.14.83"
date: 2022-11-02T11:32:58+00:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like ```130.232.14.83``` or an IPv6 address like ```2000:3317:a4e8:d1cc:b4a0:4d88:92cf:105e```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```63:16:cd:9c:14:71```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://willms-rempel.org you initially access a DNS server to translate the host portion (willms-rempel) combined with the Top Level Domain (org) of the URL, to an IP address like ```248.96.115.151```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1; WOW64; Trident/7.0; AS; rv:11.0) like Gecko```
...
<pre>
default   fe80:91a7:d601:bd05:136b%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {180.192.69.63, 170.9.197.58}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 63:16:cd:9c:14:71
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr f3:39:11:c2:89:01
}</pre>
