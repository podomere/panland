...
subtitle: "Heads Down?"
layout: research
ip_v4_address: "76.193.119.76"
date: 2023-02-04T17:08:36+00:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like ```76.193.119.76``` or an IPv6 address like ```2000:aba0:4fec:6154:d9a2:5e7b:86aa:ccbf```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```c9:dc:5b:42:a3:09```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://baumbach.com you initially access a DNS server to translate the host portion (baumbach) combined with the Top Level Domain (com) of the URL, to an IP address like ```85.149.107.40```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT x.y; Win64; x64; rv:10.0) Gecko/20100101 Firefox/10.0```
...
<pre>
default   fe80:5560:2ce5:4e67:d974%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {119.199.25.173, 98.217.108.187}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr c9:dc:5b:42:a3:09
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 0d:4b:f8:d2:b5:c1
}</pre>
...
## Apple macOS / OSX
No matter what version of OSX/macOS you are on, ```10.11.3```, ```11.6.9```, or ```12.3.8```, there are a range of tools for troubleshooting. Unfortunately, between these manual actions and scripts, they don't give you a series of correlated values over time. This is where automated remote troubleshooting comes in to its own, especially for teams that embrace remote work and Work From Anywhere (WFA).
