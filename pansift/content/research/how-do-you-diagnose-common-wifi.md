...
layout: research
ip_v4_address: "122.58.151.247"
date: 2022-11-19T19:13:09+00:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like ```122.58.151.247``` or an IPv6 address like ```2000:72fb:bb94:a47f:ae06:bdf0:3e33:b2ea```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```76:5d:45:92:94:bb```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://davis.info you initially access a DNS server to translate the host portion (davis) combined with the Top Level Domain (info) of the URL, to an IP address like ```183.180.29.118```. Your computer and browser actually sends its type with all web requests e.g. <br>```Opera/9.80 (X11; Linux i686; Ubuntu/14.10) Presto/2.12.388 Version/12.16```

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```10.208.191.2``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  10.208.191.2    UGScg  en0
...
<pre>
default   fe80:3ac0:5626:b1c2:abea%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {153.136.167.13, 196.143.201.215}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 76:5d:45:92:94:bb
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr b1:d1:9c:9e:b7:ce
}</pre>
