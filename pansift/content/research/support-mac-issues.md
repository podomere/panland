...
layout: research
ip_v4_address: "71.88.246.123"
date: 2022-04-24T18:31:59+01:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like <code>71.88.246.123</code> or an IPv6 address like <code>2000:88b1:7c41:46ce:5d5f:1ab5:6bd6:cc9a</code>. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>8d:c4:16:48:42:f1</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://fahey-hane.io you initially access a DNS server to translate the host portion (fahey-hane) combined with the Top Level Domain (io) of the URL, to an IP address like <code>60.234.91.249</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Opera/9.80 (X11; Linux i686; Ubuntu/14.10) Presto/2.12.388 Version/12.16</code>
...
<pre><code>
default   fe80:e7d9:563e:2214:f1af%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {173.223.125.152, 142.214.7.67}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 8d:c4:16:48:42:f1
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 01:d0:4e:f5:86:64
}</code></pre>
