...
layout: research
ip_v4_address: "105.215.53.127"
date: 2022-04-24T18:31:59+01:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like <code>105.215.53.127</code> or an IPv6 address like <code>2000:a211:91c4:164c:a140:86ab:5f95:9f5</code>. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>50:90:bd:66:e4:f1</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://hills-heathcote.name you initially access a DNS server to translate the host portion (hills-heathcote) combined with the Top Level Domain (name) of the URL, to an IP address like <code>250.178.97.46</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_3) AppleWebKit/537.75.14 (KHTML, like Gecko) Version/7.0.3 Safari/7046A194A</code>
...
<pre><code>
default   fe80:37c1:cd7e:39f0:959c%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {88.250.24.243, 183.105.113.226}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 50:90:bd:66:e4:f1
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 48:73:3b:17:57:1b
}</code></pre>
