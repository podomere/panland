...
subtitle: "Branding?"
layout: research
ip_v4_address: "245.133.184.3"
date: 2022-05-05T14:28:55+01:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like ```245.133.184.3``` or an IPv6 address like ```2000:8a3e:df54:353f:e430:4940:1dc1:9be9```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```e7:ad:52:0f:f0:9e```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://conroy.com you initially access a DNS server to translate the host portion (conroy) combined with the Top Level Domain (com) of the URL, to an IP address like ```98.131.244.220```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT x.y; Win64; x64; rv:10.0) Gecko/20100101 Firefox/10.0```

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```172.21.144.22``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  172.21.144.22    UGScg  en0
...
<pre>
default   fe80:540b:cd93:9946:f27%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {44.125.44.97, 55.127.190.229}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr e7:ad:52:0f:f0:9e
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr f4:d4:ca:21:bb:e6
}</pre>
