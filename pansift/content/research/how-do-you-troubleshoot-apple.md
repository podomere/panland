...
layout: research
ip_v4_address: "93.89.224.107"
date: 2022-11-19T19:13:17+00:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like ```93.89.224.107``` or an IPv6 address like ```2000:bf6e:c64c:fbf6:8f1:891f:9bd0:bfd2```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```01:36:6e:1e:62:5e```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://nader-thompson.co you initially access a DNS server to translate the host portion (nader-thompson) combined with the Top Level Domain (co) of the URL, to an IP address like ```169.245.162.113```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT x.y; Win64; x64; rv:10.0) Gecko/20100101 Firefox/10.0```
...
<pre>
default   fe80:cdbc:d393:3c24:8ac5%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {21.160.84.196, 231.87.226.243}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 01:36:6e:1e:62:5e
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 9d:1d:99:60:5c:c9
}</pre>
