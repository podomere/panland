...
layout: research
ip_v4_address: "43.202.152.21"
date: 2023-10-29T15:13:19+00:00
draft: false
---

## Internet Addressing
On the Internet you might have a Public IPv4 address like ```43.202.152.21``` or an IPv6 address like ```2000:62ba:8973:70ea:c8d6:15f:c6c7:9c22```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```36:ac:aa:d5:68:2d```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://mosciski-hoppe.net you initially access a DNS server to translate the host portion (mosciski-hoppe) combined with the Top Level Domain (net) of the URL, to an IP address like ```26.77.158.203```. Your computer and browser actually sends its type with all web requests e.g. <br>```Opera/9.80 (X11; Linux i686; Ubuntu/14.10) Presto/2.12.388 Version/12.16```

## Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```192.168.220.125``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  192.168.220.125    UGScg  en0
...
<pre>
default   fe80:92c5:d443:c98b:4ee5%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {47.51.244.222, 48.183.240.62}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 36:ac:aa:d5:68:2d
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 9a:d5:13:70:9b:22
}</pre>
