...
layout: research
ip_v4_address: "11.117.113.37"
date: 2022-06-04T14:38:16+01:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like ```11.117.113.37``` or an IPv6 address like ```2000:23b:1368:b7f9:1ae2:8d5d:7b82:cfc3```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```d6:b7:c7:62:55:e4```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://feil-baumbach.com you initially access a DNS server to translate the host portion (feil-baumbach) combined with the Top Level Domain (com) of the URL, to an IP address like ```240.125.13.124```. Your computer and browser actually sends its type with all web requests e.g. <br>```Opera/9.80 (X11; Linux i686; Ubuntu/14.10) Presto/2.12.388 Version/12.16```
...
<pre>
default   fe80:7414:f01:c391:fc15%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {226.2.136.57, 220.182.81.69}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr d6:b7:c7:62:55:e4
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 50:13:74:18:31:c1
}</pre>
