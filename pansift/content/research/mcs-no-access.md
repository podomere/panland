...
subtitle: "Swim Lane?"
layout: research
ip_v4_address: "174.139.13.56"
date: 2023-10-29T15:13:12+00:00
draft: false
---

## Internet Addressing
On the Internet you might have a Public IPv4 address like ```174.139.13.56``` or an IPv6 address like ```2000:649:6359:79ae:8fa1:3cf:f397:3fbd```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```e3:de:b5:b8:1a:ca```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://pagac-cummerata.name you initially access a DNS server to translate the host portion (pagac-cummerata) combined with the Top Level Domain (name) of the URL, to an IP address like ```13.152.9.234```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (compatible; MSIE 9.0; AOL 9.7; AOLBuild 4343.19; Windows NT 6.1; WOW64; Trident/5.0; FunWebProducts)```
...
default  172.31.14.181    UGScg  en0
...
<pre>
default   fe80:160b:951e:86b8:3c8c%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {202.137.130.102, 221.154.102.62}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr e3:de:b5:b8:1a:ca
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 9e:7a:f5:cc:e2:49
}</pre>
