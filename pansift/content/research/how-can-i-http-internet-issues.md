...
layout: research
ip_v4_address: "23.57.96.201"
date: 2022-12-15T13:50:21+00:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like ```23.57.96.201``` or an IPv6 address like ```2000:2c58:cb3:c06e:cb7e:dac1:889c:b1c2```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```8e:92:77:56:46:92```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://muller-durgan.com you initially access a DNS server to translate the host portion (muller-durgan) combined with the Top Level Domain (com) of the URL, to an IP address like ```239.137.57.6```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1; WOW64; Trident/7.0; AS; rv:11.0) like Gecko```
...
<pre>
default   fe80:ef25:5ec:f1a6:36c9%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {19.88.214.76, 91.0.79.69}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 8e:92:77:56:46:92
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 29:29:14:7c:4d:bd
}</pre>
