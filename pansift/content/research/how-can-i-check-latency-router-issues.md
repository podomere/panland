...
subtitle: "Granular?"
layout: research
ip_v4_address: "77.164.102.56"
date: 2023-10-06T17:11:05+01:00
draft: false
---

## Internet Addressing
On the Internet you might have a Public IPv4 address like ```77.164.102.56``` or an IPv6 address like ```2000:bec3:1e41:1695:8dfa:593a:a910:18d1```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```31:0a:e4:f5:53:3c```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://kuphal.org you initially access a DNS server to translate the host portion (kuphal) combined with the Top Level Domain (org) of the URL, to an IP address like ```187.37.132.93```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows; U; Win 9x 4.90; SG; rv:1.9.2.4) Gecko/20101104 Netscape/9.1.0285```
...
<pre>
default   fe80:3355:b9f9:ae26:20ed%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {147.157.157.38, 148.238.121.233}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 31:0a:e4:f5:53:3c
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr c2:63:4e:eb:f3:a3
}</pre>
