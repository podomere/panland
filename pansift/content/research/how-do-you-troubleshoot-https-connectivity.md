...
layout: research
ip_v4_address: "251.155.151.218"
date: 2023-10-29T15:13:30+00:00
draft: false
---

## Internet Addressing
On the Internet you may get a Public IPv4 address like ```251.155.151.218``` or an IPv6 address like ```2000:1ac7:5173:b9:1292:cb57:ffae:ed59```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```79:10:2f:cb:43:86```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://treutel-schowalter.name you initially access a DNS server to translate the host portion (treutel-schowalter) combined with the Top Level Domain (name) of the URL, to an IP address like ```105.56.104.155```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows; U; Win 9x 4.90; SG; rv:1.9.2.4) Gecko/20101104 Netscape/9.1.0285```
...
<pre>
default   fe80:5a46:58ee:6dc2:e45d%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {239.69.125.139, 23.12.192.150}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 79:10:2f:cb:43:86
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 71:c6:6b:89:e5:6a
}</pre>
...
### Apple macOS / OSX
No matter what version of OSX/macOS you are on, ```10.15.7```, ```11.5.9```, or ```12.1.8```, there are a range of tools for troubleshooting. Unfortunately, between these manual actions and scripts, they don't give you a series of correlated values over time. This is where automated remote troubleshooting comes in to its own, especially for teams that embrace remote work and Work From Anywhere (WFA).
