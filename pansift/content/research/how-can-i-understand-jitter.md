...
layout: research
ip_v4_address: "99.214.152.72"
date: 2022-05-05T14:29:47+01:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like ```99.214.152.72``` or an IPv6 address like ```2000:6aeb:e54d:9e6:9f83:1799:469d:a2d8```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```bd:7a:64:a8:e3:e3```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://corkery-denesik.name you initially access a DNS server to translate the host portion (corkery-denesik) combined with the Top Level Domain (name) of the URL, to an IP address like ```170.88.165.82```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT x.y; Win64; x64; rv:10.0) Gecko/20100101 Firefox/10.0```
...
<pre>
default   fe80:1684:9772:84e6:7db8%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {78.192.205.47, 99.187.105.66}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr bd:7a:64:a8:e3:e3
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr dd:66:5f:ef:91:23
}</pre>
