...
layout: research
ip_v4_address: "116.89.86.171"
date: 2022-04-24T19:00:03+01:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like <code>116.89.86.171</code> or an IPv6 address like <code>2000:e8df:95f:1cbb:95c3:25f1:7d42:bebe</code>. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>64:e2:5f:34:7d:1d</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://abshire.name you initially access a DNS server to translate the host portion (abshire) combined with the Top Level Domain (name) of the URL, to an IP address like <code>250.222.238.83</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Opera/9.80 (X11; Linux i686; Ubuntu/14.10) Presto/2.12.388 Version/12.16</code>
...
<pre><code>
default   fe80:e85c:2aec:af8f:2157%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {165.49.45.237, 31.168.172.58}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 64:e2:5f:34:7d:1d
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 7c:6d:47:94:2e:9f
}</code></pre>
