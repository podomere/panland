...
layout: research
ip_v4_address: "140.151.33.111"
date: 2022-05-05T14:29:34+01:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like ```140.151.33.111``` or an IPv6 address like ```2000:878f:5b40:426f:f0c:da7a:809c:9455```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```10:f8:0c:74:2e:00```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://frami-streich.info you initially access a DNS server to translate the host portion (frami-streich) combined with the Top Level Domain (info) of the URL, to an IP address like ```215.151.73.113```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows; U; Win 9x 4.90; SG; rv:1.9.2.4) Gecko/20101104 Netscape/9.1.0285```
...
<pre>
default   fe80:8fe3:45f:f552:b08a%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {68.210.233.13, 0.111.7.94}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 10:f8:0c:74:2e:00
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 24:49:ee:f4:b3:5b
}</pre>
...
## Apple macOS / OSX
No matter what version of OSX/macOS you are on, ```10.12.8```, ```11.4.3```, or ```12.2.4```, there are a range of tools for troubleshooting. Unfortunately, between these manual actions and scripts, they don't give you a series of correlated values over time. This is where automated remote troubleshooting comes in to its own, especially for teams that embrace remote work and Work From Anywhere (WFA).
