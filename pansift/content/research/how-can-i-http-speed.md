...
subtitle: "Value Add?"
layout: research
ip_v4_address: "13.236.111.231"
date: 2023-10-06T17:11:08+01:00
draft: false
---

## Internet Addressing
On the Internet you may get a Public IPv4 address like ```13.236.111.231``` or an IPv6 address like ```2000:687e:85b0:6f4c:c81b:9846:87a:e011```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```43:6c:4e:a7:32:cf```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://kreiger-torphy.name you initially access a DNS server to translate the host portion (kreiger-torphy) combined with the Top Level Domain (name) of the URL, to an IP address like ```248.151.32.13```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT x.y; Win64; x64; rv:10.0) Gecko/20100101 Firefox/10.0```
...
<pre>
default   fe80:88e7:5c4:727f:c46e%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {100.26.3.111, 61.198.196.235}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 43:6c:4e:a7:32:cf
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr eb:86:db:f4:30:91
}</pre>
