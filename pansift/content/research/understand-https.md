...
layout: research
ip_v4_address: "200.160.22.117"
date: 2023-10-29T15:13:30+00:00
draft: false
---

## Internet Addressing
On the Internet you may have a Public IPv4 address like ```200.160.22.117``` or an IPv6 address like ```2000:45dc:6b9a:229b:7b59:c4ed:9fe9:98d5```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```63:b3:8f:64:a3:e5```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://morissette-koch.org you initially access a DNS server to translate the host portion (morissette-koch) combined with the Top Level Domain (org) of the URL, to an IP address like ```252.118.54.25```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows; U; Win 9x 4.90; SG; rv:1.9.2.4) Gecko/20101104 Netscape/9.1.0285```

## Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```10.245.5.118``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  10.245.5.118    UGScg  en0
...
<pre>
default   fe80:1644:ac4c:d732:2229%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {136.35.65.37, 202.142.162.252}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 63:b3:8f:64:a3:e5
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 1a:d4:d1:8f:39:e9
}</pre>
