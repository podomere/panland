...
layout: research
ip_v4_address: "113.74.167.148"
date: 2022-06-04T14:38:39+01:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like ```113.74.167.148``` or an IPv6 address like ```2000:f65c:b0b0:4001:d668:5a33:48a8:4d97```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```12:ea:ae:e4:5c:18```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://block-weimann.com you initially access a DNS server to translate the host portion (block-weimann) combined with the Top Level Domain (com) of the URL, to an IP address like ```212.174.164.255```. Your computer and browser actually sends its type with all web requests e.g. <br>```Opera/9.80 (X11; Linux i686; Ubuntu/14.10) Presto/2.12.388 Version/12.16```
...
<pre>
default   fe80:fb68:6340:da67:c45a%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {84.6.60.251, 9.74.90.226}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 12:ea:ae:e4:5c:18
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr dd:10:21:84:72:33
}</pre>
