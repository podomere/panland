...
layout: research
ip_v4_address: "177.253.87.112"
date: 2022-04-24T19:00:01+01:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like <code>177.253.87.112</code> or an IPv6 address like <code>2000:8a80:cdc4:3ff1:52ca:4df6:2e5d:da79</code>. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>02:96:8a:10:c3:8d</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://bergnaum-upton.org you initially access a DNS server to translate the host portion (bergnaum-upton) combined with the Top Level Domain (org) of the URL, to an IP address like <code>205.9.22.195</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (Windows NT 6.1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/41.0.2228.0 Safari/537.36</code>
...
<pre><code>
default   fe80:5010:dff5:2ff0:910c%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {77.8.104.226, 180.149.40.100}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 02:96:8a:10:c3:8d
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 12:44:f4:c4:d9:24
}</code></pre>
