...
subtitle: "Etc. Etc.?"
layout: research
ip_v4_address: "128.176.24.199"
date: 2022-06-04T14:38:39+01:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like ```128.176.24.199``` or an IPv6 address like ```2000:5034:5956:f0ed:d38:a0c8:fa2:ea30```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```42:0a:3b:72:a6:0c```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://effertz-gottlieb.io you initially access a DNS server to translate the host portion (effertz-gottlieb) combined with the Top Level Domain (io) of the URL, to an IP address like ```48.40.142.95```. Your computer and browser actually sends its type with all web requests e.g. <br>```Opera/9.80 (X11; Linux i686; Ubuntu/14.10) Presto/2.12.388 Version/12.16```
...
<pre>
default   fe80:bba1:156e:729f:4d62%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {18.123.113.252, 91.55.191.220}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 42:0a:3b:72:a6:0c
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 6a:ea:fd:27:c5:85
}</pre>
