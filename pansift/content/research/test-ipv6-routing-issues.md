...
subtitle: "Ideate?"
layout: research
ip_v4_address: "125.144.5.88"
date: 2023-10-06T17:11:03+01:00
draft: false
---

## Internet Addressing
On the Internet you might get a Public IPv4 address like ```125.144.5.88``` or an IPv6 address like ```2000:f163:2f70:3817:943e:decc:9c6a:dbfb```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```90:ca:c3:2d:27:f6```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://raynor-christiansen.co you initially access a DNS server to translate the host portion (raynor-christiansen) combined with the Top Level Domain (co) of the URL, to an IP address like ```172.60.254.47```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows; U; Win 9x 4.90; SG; rv:1.9.2.4) Gecko/20101104 Netscape/9.1.0285```
...
<pre>
default   fe80:26a2:caab:ff45:1728%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {12.249.179.5, 187.225.117.158}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 90:ca:c3:2d:27:f6
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr a5:cb:3b:3e:0d:08
}</pre>
