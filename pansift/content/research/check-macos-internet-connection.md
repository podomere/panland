...
layout: research
ip_v4_address: "242.249.143.43"
date: 2023-02-04T17:07:48+00:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like ```242.249.143.43``` or an IPv6 address like ```2000:dbe8:5de9:9efa:bf95:49f7:3a98:1376```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```5a:e2:fe:10:a0:de```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://cummings-quigley.name you initially access a DNS server to translate the host portion (cummings-quigley) combined with the Top Level Domain (name) of the URL, to an IP address like ```99.250.154.3```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows; U; Win 9x 4.90; SG; rv:1.9.2.4) Gecko/20101104 Netscape/9.1.0285```

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```10.62.201.99``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  10.62.201.99    UGScg  en0
...
<pre>
default   fe80:f1b4:2873:4811:bfae%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {86.66.208.58, 55.225.51.102}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 5a:e2:fe:10:a0:de
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 2c:e6:21:97:71:5c
}</pre>
