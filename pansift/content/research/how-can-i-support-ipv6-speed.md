...
layout: research
ip_v4_address: "53.2.154.146"
date: 2022-11-19T19:13:23+00:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like ```53.2.154.146``` or an IPv6 address like ```2000:cf87:8da:9612:e7ad:ae55:5620:1393```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```0b:be:fe:33:56:50```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://roberts.net you initially access a DNS server to translate the host portion (roberts) combined with the Top Level Domain (net) of the URL, to an IP address like ```115.241.163.132```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1; WOW64; Trident/7.0; AS; rv:11.0) like Gecko```
...
<pre>
default   fe80:ac8b:a43b:cc65:f77b%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {224.39.179.207, 250.112.192.133}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 0b:be:fe:33:56:50
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr b5:49:58:63:00:18
}</pre>
...
## Apple macOS / OSX
No matter what version of OSX/macOS you are on, ```10.11.6```, ```11.4.5```, or ```12.3.1```, there are a range of tools for troubleshooting. Unfortunately, between these manual actions and scripts, they don't give you a series of correlated values over time. This is where automated remote troubleshooting comes in to its own, especially for teams that embrace remote work and Work From Anywhere (WFA).
