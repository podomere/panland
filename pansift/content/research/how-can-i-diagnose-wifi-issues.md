...
subtitle: "Etc. Etc.?"
layout: research
ip_v4_address: "174.237.113.1"
date: 2023-10-06T17:10:30+01:00
draft: false
---

## Internet Addressing
On the Internet you might get a Public IPv4 address like ```174.237.113.1``` or an IPv6 address like ```2000:8e42:c18a:3b5d:c83e:4ed6:b938:39ec```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```36:2d:f9:10:41:0b```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://watsica.name you initially access a DNS server to translate the host portion (watsica) combined with the Top Level Domain (name) of the URL, to an IP address like ```103.82.142.211```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/41.0.2228.0 Safari/537.36```

## Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```172.23.77.128``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  172.23.77.128    UGScg  en0
...
<pre>
default   fe80:e9a7:1b45:7998:341c%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {34.224.77.163, 187.21.126.24}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 36:2d:f9:10:41:0b
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 52:0c:c8:da:6f:3b
}</pre>
