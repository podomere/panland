...
subtitle: "Heads Down?"
layout: research
ip_v4_address: "210.61.140.70"
date: 2022-12-15T13:50:03+00:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like ```210.61.140.70``` or an IPv6 address like ```2000:cf08:bfe0:5e50:25fc:9257:d370:a894```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```70:0d:e4:28:a2:f9```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://marquardt.biz you initially access a DNS server to translate the host portion (marquardt) combined with the Top Level Domain (biz) of the URL, to an IP address like ```91.85.17.43```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_3) AppleWebKit/537.75.14 (KHTML, like Gecko) Version/7.0.3 Safari/7046A194A```
...
<pre>
default   fe80:3d6c:4e3c:cfdc:5037%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {196.64.246.75, 68.245.145.72}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 70:0d:e4:28:a2:f9
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 5b:61:64:1b:11:db
}</pre>
