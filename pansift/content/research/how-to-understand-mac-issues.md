...
layout: research
ip_v4_address: "35.72.21.87"
date: 2022-06-04T14:38:30+01:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like ```35.72.21.87``` or an IPv6 address like ```2000:e790:3668:81ff:4ca8:34da:455d:a184```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```a9:e8:a5:d0:40:ac```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://quitzon-kreiger.co you initially access a DNS server to translate the host portion (quitzon-kreiger) combined with the Top Level Domain (co) of the URL, to an IP address like ```75.42.36.46```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/41.0.2228.0 Safari/537.36```

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```10.201.100.11``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  10.201.100.11    UGScg  en0
...
<pre>
default   fe80:6c90:7a62:bc6f:7081%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {65.131.167.75, 4.14.156.43}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr a9:e8:a5:d0:40:ac
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 35:d8:3e:5a:85:7c
}</pre>
