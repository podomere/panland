---
title: "How Can I Understand IPv4 No-access"
subtitle: "Tee It Up?"
layout: research
ip_v4_address: "220.143.17.14"
date: 2023-02-04T16:26:19+00:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like ```220.143.17.14``` or an IPv6 address like ```2000:640c:d2f9:ff00:3af0:6785:7b3f:2588```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```cd:5e:75:70:d0:df```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://mclaughlin-jacobi.com you initially access a DNS server to translate the host portion (mclaughlin-jacobi) combined with the Top Level Domain (com) of the URL, to an IP address like ```235.207.50.123```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (compatible; MSIE 9.0; AOL 9.7; AOLBuild 4343.19; Windows NT 6.1; WOW64; Trident/5.0; FunWebProducts)```

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```192.168.154.102``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  192.168.154.102    UGScg  en0
...
<pre>
default   fe80:abd1:f352:299e:bdab%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {87.173.251.91, 36.0.192.43}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr cd:5e:75:70:d0:df
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 60:ef:26:b5:23:7a
}</pre>
