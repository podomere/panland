...
layout: research
ip_v4_address: "251.87.96.155"
date: 2022-04-24T19:00:25+01:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like <code>251.87.96.155</code> or an IPv6 address like <code>2000:58c4:13a2:5846:38e2:8fa6:90ab:7d5e</code>. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>4f:7f:df:bf:0d:f6</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://hodkiewicz-littel.co you initially access a DNS server to translate the host portion (hodkiewicz-littel) combined with the Top Level Domain (co) of the URL, to an IP address like <code>37.27.133.184</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (Windows NT 6.1; WOW64; Trident/7.0; AS; rv:11.0) like Gecko</code>
...
<pre><code>
default   fe80:e67f:1928:8619:be11%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {127.64.77.32, 189.41.106.79}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 4f:7f:df:bf:0d:f6
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr a6:a0:18:d0:05:bc
}</code></pre>
