...
layout: research
ip_v4_address: "176.145.134.105"
date: 2023-02-04T16:26:21+00:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like ```176.145.134.105``` or an IPv6 address like ```2000:14c6:e98d:c5dc:9e35:fb2d:f09d:bc61```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```05:e7:50:48:fd:f7```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://hand-fadel.co you initially access a DNS server to translate the host portion (hand-fadel) combined with the Top Level Domain (co) of the URL, to an IP address like ```5.169.102.25```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT x.y; Win64; x64; rv:10.0) Gecko/20100101 Firefox/10.0```
...
<pre>
default   fe80:352b:e49a:3768:cc75%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {146.101.142.26, 208.138.18.101}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 05:e7:50:48:fd:f7
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr a6:83:8e:fb:3e:42
}</pre>
