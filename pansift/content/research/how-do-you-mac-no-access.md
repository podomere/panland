...
layout: research
ip_v4_address: "197.3.112.144"
date: 2023-02-04T17:07:50+00:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like ```197.3.112.144``` or an IPv6 address like ```2000:56f7:79ce:7208:5b73:e077:89b:88f2```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```3b:64:23:99:05:09```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://hintz-bauch.co you initially access a DNS server to translate the host portion (hintz-bauch) combined with the Top Level Domain (co) of the URL, to an IP address like ```249.87.163.196```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_3) AppleWebKit/537.75.14 (KHTML, like Gecko) Version/7.0.3 Safari/7046A194A```
...
<pre>
default   fe80:648d:5141:c23c:25a4%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {136.82.22.163, 254.72.2.41}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 3b:64:23:99:05:09
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr a7:99:b8:d5:a0:4f
}</pre>
