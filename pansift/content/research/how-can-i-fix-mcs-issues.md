...
subtitle: "Learnings?"
layout: research
ip_v4_address: "243.87.239.175"
date: 2022-04-24T19:00:34+01:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like <code>243.87.239.175</code> or an IPv6 address like <code>2000:c0cc:1c1:52b0:7158:199e:8f3:2124</code>. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>6e:a6:60:f3:4e:e9</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://mcclure-okeefe.org you initially access a DNS server to translate the host portion (mcclure-okeefe) combined with the Top Level Domain (org) of the URL, to an IP address like <code>87.250.56.71</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Opera/9.80 (X11; Linux i686; Ubuntu/14.10) Presto/2.12.388 Version/12.16</code>

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like <code>172.23.179.18</code> (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For <code>IPv6</code> we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  172.23.179.18    UGScg  en0
...
<pre><code>
default   fe80:5ed6:1eb4:3398:7480%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {131.117.29.140, 209.14.247.104}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 6e:a6:60:f3:4e:e9
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 23:dd:04:8d:9e:ff
}</code></pre>
