...
layout: research
ip_v4_address: "27.71.193.254"
date: 2022-04-24T19:00:25+01:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like <code>27.71.193.254</code> or an IPv6 address like <code>2000:41e1:8e79:adfb:db8f:8dfe:ede:7f9a</code>. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>a9:28:57:44:a4:49</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://mohr-emard.com you initially access a DNS server to translate the host portion (mohr-emard) combined with the Top Level Domain (com) of the URL, to an IP address like <code>154.65.242.201</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Opera/9.80 (X11; Linux i686; Ubuntu/14.10) Presto/2.12.388 Version/12.16</code>
...
<pre><code>
default   fe80:cc8c:b4f7:7989:af45%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {8.79.126.2, 158.167.103.247}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr a9:28:57:44:a4:49
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 70:40:a4:1b:94:c7
}</code></pre>
