...
subtitle: "Deep Dive?"
layout: research
ip_v4_address: "14.101.200.201"
date: 2022-06-12T14:09:28+01:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like ```14.101.200.201``` or an IPv6 address like ```2000:849e:9930:1ffc:1cd1:abe8:d1f3:3f03```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```5f:34:7a:47:1c:75```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://ledner-lehner.name you initially access a DNS server to translate the host portion (ledner-lehner) combined with the Top Level Domain (name) of the URL, to an IP address like ```46.242.80.196```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (compatible; MSIE 9.0; AOL 9.7; AOLBuild 4343.19; Windows NT 6.1; WOW64; Trident/5.0; FunWebProducts)```
...
<pre>
default   fe80:7070:26ba:c251:18aa%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {210.193.24.196, 227.118.185.127}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 5f:34:7a:47:1c:75
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 22:fa:c4:cd:a8:f6
}</pre>
