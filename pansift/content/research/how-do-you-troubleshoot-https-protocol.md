...
layout: research
ip_v4_address: "69.13.141.234"
date: 2023-10-29T15:13:30+00:00
draft: false
---

## Internet Addressing
On the Internet you might get a Public IPv4 address like ```69.13.141.234``` or an IPv6 address like ```2000:e72d:ae02:fb19:2b97:9b0a:ba22:7a3```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```c0:0b:33:cd:68:18```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://white.com you initially access a DNS server to translate the host portion (white) combined with the Top Level Domain (com) of the URL, to an IP address like ```254.198.80.46```. Your computer and browser actually sends its type with all web requests e.g. <br>```Opera/9.80 (X11; Linux i686; Ubuntu/14.10) Presto/2.12.388 Version/12.16```
...
<pre>
default   fe80:aeef:b845:464c:effa%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {50.194.213.86, 38.167.115.232}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr c0:0b:33:cd:68:18
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 77:38:e9:10:22:bb
}</pre>
