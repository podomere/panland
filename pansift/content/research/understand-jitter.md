...
layout: research
ip_v4_address: "66.207.218.152"
date: 2022-11-02T11:32:57+00:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like ```66.207.218.152``` or an IPv6 address like ```2000:d7c6:47ab:7c3:86c4:2a43:91ec:de29```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```c7:8a:1e:2e:2d:e8```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://reynolds-hahn.name you initially access a DNS server to translate the host portion (reynolds-hahn) combined with the Top Level Domain (name) of the URL, to an IP address like ```146.194.66.1```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_3) AppleWebKit/537.75.14 (KHTML, like Gecko) Version/7.0.3 Safari/7046A194A```
...
<pre>
default   fe80:68cb:241c:811c:f910%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {248.151.123.242, 203.135.91.85}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr c7:8a:1e:2e:2d:e8
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 16:fe:18:23:9a:39
}</pre>
