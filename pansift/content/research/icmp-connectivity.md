...
subtitle: "Branding?"
layout: research
ip_v4_address: "114.191.41.35"
date: 2022-06-12T14:09:26+01:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like ```114.191.41.35``` or an IPv6 address like ```2000:9910:40f6:7f1e:c580:3c19:7a4d:4b52```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```1c:84:47:1f:44:46```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://feest-mosciski.info you initially access a DNS server to translate the host portion (feest-mosciski) combined with the Top Level Domain (info) of the URL, to an IP address like ```173.95.107.68```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1; WOW64; Trident/7.0; AS; rv:11.0) like Gecko```
...
<pre>
default   fe80:3673:a665:d503:ee50%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {222.224.255.150, 23.117.10.250}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 1c:84:47:1f:44:46
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr a8:52:7f:45:4c:c2
}</pre>
