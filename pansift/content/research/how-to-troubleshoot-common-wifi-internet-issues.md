...
subtitle: "Impact Map?"
layout: research
ip_v4_address: "57.58.137.23"
date: 2022-04-24T19:00:33+01:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like <code>57.58.137.23</code> or an IPv6 address like <code>2000:367:a6a1:7c7b:9789:4ac8:6bf9:ff2d</code>. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>c0:89:9d:5b:9f:ce</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://balistreri-krajcik.name you initially access a DNS server to translate the host portion (balistreri-krajcik) combined with the Top Level Domain (name) of the URL, to an IP address like <code>153.40.106.205</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (Windows NT 6.1; WOW64; Trident/7.0; AS; rv:11.0) like Gecko</code>
...
<pre><code>
default   fe80:af32:52b8:e8b2:fba%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {234.119.198.152, 44.114.32.187}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr c0:89:9d:5b:9f:ce
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr ca:c7:13:22:ef:5b
}</code></pre>
