...
layout: research
ip_v4_address: "61.164.105.50"
date: 2023-02-04T17:07:49+00:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like ```61.164.105.50``` or an IPv6 address like ```2000:c09c:f39:765:7aac:e0ff:ceaa:7c99```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```03:d5:6f:7b:8d:30```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://hintz-baumbach.name you initially access a DNS server to translate the host portion (hintz-baumbach) combined with the Top Level Domain (name) of the URL, to an IP address like ```224.40.209.103```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1; WOW64; Trident/7.0; AS; rv:11.0) like Gecko```
...
<pre>
default   fe80:f851:a4cd:8541:e790%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {103.142.200.219, 108.101.83.101}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 03:d5:6f:7b:8d:30
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr fe:53:2a:90:29:93
}</pre>
