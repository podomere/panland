...
layout: research
ip_v4_address: "26.239.199.91"
date: 2022-04-24T19:00:01+01:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like <code>26.239.199.91</code> or an IPv6 address like <code>2000:2a6a:3b19:b5df:8be3:c405:20e5:8477</code>. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>f7:d6:4f:a3:7f:1a</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://leannon-balistreri.co you initially access a DNS server to translate the host portion (leannon-balistreri) combined with the Top Level Domain (co) of the URL, to an IP address like <code>153.123.179.205</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (compatible; MSIE 9.0; AOL 9.7; AOLBuild 4343.19; Windows NT 6.1; WOW64; Trident/5.0; FunWebProducts)</code>
...
default  172.23.61.56    UGScg  en0
...
<pre><code>
default   fe80:2081:f0e3:df88:4fd7%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {221.208.151.208, 249.214.210.36}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr f7:d6:4f:a3:7f:1a
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 01:b0:f8:26:02:24
}</code></pre>
