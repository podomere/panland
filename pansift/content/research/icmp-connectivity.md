...
layout: research
ip_v4_address: "139.64.39.90"
date: 2023-10-29T15:13:27+00:00
draft: false
---

## Internet Addressing
On the Internet you might get a Public IPv4 address like ```139.64.39.90``` or an IPv6 address like ```2000:cac9:1996:20c8:7566:e00:4592:65af```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```71:d7:57:0b:69:23```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://sauer-swift.info you initially access a DNS server to translate the host portion (sauer-swift) combined with the Top Level Domain (info) of the URL, to an IP address like ```187.60.33.10```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows; U; Win 9x 4.90; SG; rv:1.9.2.4) Gecko/20101104 Netscape/9.1.0285```
...
<pre>
default   fe80:635b:9e03:a76c:2295%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {141.5.88.157, 65.95.183.183}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 71:d7:57:0b:69:23
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 7c:97:84:28:7b:1a
}</pre>
