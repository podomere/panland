---
title: "How Can I Fix Jitter Protocol"
subtitle: "Data Points?"
layout: research
ip_v4_address: "216.127.249.222"
date: 2022-12-15T13:50:18+00:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like ```216.127.249.222``` or an IPv6 address like ```2000:365f:8ca1:725b:8038:710:39bf:e8a2```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```d6:32:5c:86:01:39```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://wolf-medhurst.io you initially access a DNS server to translate the host portion (wolf-medhurst) combined with the Top Level Domain (io) of the URL, to an IP address like ```90.89.238.139```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT x.y; Win64; x64; rv:10.0) Gecko/20100101 Firefox/10.0```

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```10.212.231.33``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  10.212.231.33    UGScg  en0
...
<pre>
default   fe80:1bee:72eb:7623:1a43%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {76.82.89.36, 174.62.181.24}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr d6:32:5c:86:01:39
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 2d:23:53:80:2c:c3
}</pre>
