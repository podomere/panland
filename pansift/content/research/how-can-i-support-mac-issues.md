...
subtitle: "Ideate?"
layout: research
ip_v4_address: "70.86.1.187"
date: 2023-02-04T16:26:12+00:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like ```70.86.1.187``` or an IPv6 address like ```2000:702f:87b2:fc6e:b69b:fa9:5aa0:1cf0```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```5c:4a:9b:ce:d0:e8```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://bauch-upton.co you initially access a DNS server to translate the host portion (bauch-upton) combined with the Top Level Domain (co) of the URL, to an IP address like ```60.58.54.12```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1; WOW64; Trident/7.0; AS; rv:11.0) like Gecko```
...
<pre>
default   fe80:b493:4b24:5669:bdef%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {74.83.209.75, 45.204.46.87}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 5c:4a:9b:ce:d0:e8
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 3a:57:2a:6d:cb:4a
}</pre>
