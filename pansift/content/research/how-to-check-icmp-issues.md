...
layout: research
ip_v4_address: "9.201.114.167"
date: 2022-11-19T16:17:23+00:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like ```9.201.114.167``` or an IPv6 address like ```2000:8ee5:90b2:e488:e285:4e9a:973f:1ab8```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```4e:5c:bc:f5:e6:23```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://durgan-pagac.io you initially access a DNS server to translate the host portion (durgan-pagac) combined with the Top Level Domain (io) of the URL, to an IP address like ```145.33.223.161```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT x.y; Win64; x64; rv:10.0) Gecko/20100101 Firefox/10.0```
...
<pre>
default   fe80:7aa5:c7ed:34d1:c9%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {76.88.39.60, 205.57.252.76}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 4e:5c:bc:f5:e6:23
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 6d:fd:c6:ae:fd:03
}</pre>
