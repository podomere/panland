...
subtitle: "Etc. Etc.?"
layout: research
ip_v4_address: "31.50.131.156"
date: 2022-06-04T14:38:16+01:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like ```31.50.131.156``` or an IPv6 address like ```2000:5c1f:ddc5:d3f1:12dc:90c7:8261:934f```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```6d:c3:e9:a1:ef:73```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://lockman-rodriguez.net you initially access a DNS server to translate the host portion (lockman-rodriguez) combined with the Top Level Domain (net) of the URL, to an IP address like ```36.126.249.10```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1; WOW64; Trident/7.0; AS; rv:11.0) like Gecko```
...
<pre>
default   fe80:99e2:ee4:618e:2e8b%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {37.224.47.49, 80.216.167.116}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 6d:c3:e9:a1:ef:73
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr a6:4d:ae:d2:b6:bf
}</pre>
