...
layout: research
ip_v4_address: "40.176.68.103"
date: 2022-04-24T18:31:57+01:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like <code>40.176.68.103</code> or an IPv6 address like <code>2000:40ea:5e53:3df8:1dde:dbda:5804:95ec</code>. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>ec:7e:9e:2c:60:0e</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://conroy-ziemann.biz you initially access a DNS server to translate the host portion (conroy-ziemann) combined with the Top Level Domain (biz) of the URL, to an IP address like <code>16.36.243.86</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_3) AppleWebKit/537.75.14 (KHTML, like Gecko) Version/7.0.3 Safari/7046A194A</code>
...
<pre><code>
default   fe80:2dfd:b6c6:4985:356e%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {238.202.196.146, 128.218.15.46}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr ec:7e:9e:2c:60:0e
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 88:aa:a5:5d:86:89
}</code></pre>
