...
layout: research
ip_v4_address: "128.89.40.84"
date: 2022-04-24T19:00:07+01:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like <code>128.89.40.84</code> or an IPv6 address like <code>2000:a1c0:870f:7351:288d:ae75:7cbd:828a</code>. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>98:9f:09:36:1b:40</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://boyer-buckridge.co you initially access a DNS server to translate the host portion (boyer-buckridge) combined with the Top Level Domain (co) of the URL, to an IP address like <code>131.109.91.215</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (Windows NT x.y; Win64; x64; rv:10.0) Gecko/20100101 Firefox/10.0</code>
...
<pre><code>
default   fe80:325d:83bb:c7ca:c4e1%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {142.75.4.27, 72.181.59.19}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 98:9f:09:36:1b:40
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 50:5e:14:6b:2e:d6
}</code></pre>
