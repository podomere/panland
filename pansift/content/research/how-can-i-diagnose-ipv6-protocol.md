...
layout: research
ip_v4_address: "192.42.222.117"
date: 2022-11-19T19:13:23+00:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like ```192.42.222.117``` or an IPv6 address like ```2000:93a5:503a:f33a:f08b:55fa:1012:5783```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```13:3e:49:ec:83:fb```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://ullrich-bode.net you initially access a DNS server to translate the host portion (ullrich-bode) combined with the Top Level Domain (net) of the URL, to an IP address like ```187.71.114.217```. Your computer and browser actually sends its type with all web requests e.g. <br>```Opera/9.80 (X11; Linux i686; Ubuntu/14.10) Presto/2.12.388 Version/12.16```
...
<pre>
default   fe80:ee2f:4350:41e6:a854%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {37.143.213.245, 191.46.125.247}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 13:3e:49:ec:83:fb
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr ac:e6:72:2d:19:0d
}</pre>
