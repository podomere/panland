...
layout: research
ip_v4_address: "200.29.208.20"
date: 2023-10-06T17:10:43+01:00
draft: false
---

## Internet Addressing
On the Internet you may get a Public IPv4 address like ```200.29.208.20``` or an IPv6 address like ```2000:2c6b:ac03:c6c4:5ecb:e2df:1c8e:c97b```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```7a:56:0f:80:62:cf```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://weimann-senger.io you initially access a DNS server to translate the host portion (weimann-senger) combined with the Top Level Domain (io) of the URL, to an IP address like ```155.104.98.89```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (compatible; MSIE 9.0; AOL 9.7; AOLBuild 4343.19; Windows NT 6.1; WOW64; Trident/5.0; FunWebProducts)```
...
<pre>
default   fe80:e71f:f605:8c83:8c83%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {245.96.143.184, 135.114.132.96}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 7a:56:0f:80:62:cf
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 48:0b:37:f6:38:f5
}</pre>
