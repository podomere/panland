...
layout: research
ip_v4_address: "83.96.196.122"
date: 2022-12-15T13:50:16+00:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like ```83.96.196.122``` or an IPv6 address like ```2000:d9a5:bf22:927d:b0f6:9c0c:6ccf:32ab```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```89:04:5f:4d:33:c8```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).
...
<pre>
default   fe80:9c5a:7be1:fd14:f4e9%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {48.228.185.104, 108.62.218.89}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 89:04:5f:4d:33:c8
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr e5:b2:ca:f3:84:92
}</pre>
