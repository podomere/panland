...
subtitle: "Deep Dive?"
layout: research
ip_v4_address: "103.141.13.147"
date: 2023-10-06T17:10:31+01:00
draft: false
---

## Internet Addressing
On the Internet you might have a Public IPv4 address like ```103.141.13.147``` or an IPv6 address like ```2000:3c99:ad77:4c5f:c818:9eed:cd94:5760```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```57:54:6b:0f:f1:dc```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://torphy.info you initially access a DNS server to translate the host portion (torphy) combined with the Top Level Domain (info) of the URL, to an IP address like ```74.243.166.144```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows; U; Win 9x 4.90; SG; rv:1.9.2.4) Gecko/20101104 Netscape/9.1.0285```
...
<pre>
default   fe80:5f60:aea4:c1df:2e4%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {61.26.121.81, 198.238.214.17}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 57:54:6b:0f:f1:dc
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr ed:ad:f4:d9:e9:32
}</pre>
...
### Apple macOS / OSX
No matter what version of OSX/macOS you are on, ```10.12.5```, ```11.4.8```, or ```12.1.7```, there are a range of tools for troubleshooting. Unfortunately, between these manual actions and scripts, they don't give you a series of correlated values over time. This is where automated remote troubleshooting comes in to its own, especially for teams that embrace remote work and Work From Anywhere (WFA).
