...
layout: research
ip_v4_address: "146.44.17.123"
date: 2022-06-04T14:38:17+01:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like ```146.44.17.123``` or an IPv6 address like ```2000:ec84:3ae8:3a14:c814:4b9a:3824:e4d4```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```fc:19:45:92:f2:70```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://block.io you initially access a DNS server to translate the host portion (block) combined with the Top Level Domain (io) of the URL, to an IP address like ```239.107.250.83```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_3) AppleWebKit/537.75.14 (KHTML, like Gecko) Version/7.0.3 Safari/7046A194A```
...
<pre>
default   fe80:10a9:3381:3d11:8b9d%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {165.141.0.55, 189.227.17.72}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr fc:19:45:92:f2:70
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr f4:f8:6d:3f:31:e5
}</pre>
