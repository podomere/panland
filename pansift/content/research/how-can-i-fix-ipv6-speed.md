---
title: "How Can I Fix IPv6 Speed"
subtitle: "Best Practice?"
layout: research
ip_v4_address: "91.81.73.100"
date: 2022-11-19T19:13:23+00:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like ```91.81.73.100``` or an IPv6 address like ```2000:ef86:21e:49f3:1891:632b:60c0:171c```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```b1:8d:6c:b4:6a:8a```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://friesen.name you initially access a DNS server to translate the host portion (friesen) combined with the Top Level Domain (name) of the URL, to an IP address like ```153.77.209.240```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (compatible; MSIE 9.0; AOL 9.7; AOLBuild 4343.19; Windows NT 6.1; WOW64; Trident/5.0; FunWebProducts)```

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```192.168.75.111``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  192.168.75.111    UGScg  en0
...
<pre>
default   fe80:1bef:dde5:1960:1f8%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {80.71.97.230, 215.98.166.123}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr b1:8d:6c:b4:6a:8a
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 98:af:8c:23:74:f7
}</pre>
