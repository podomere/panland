...
layout: research
ip_v4_address: "95.87.88.216"
date: 2023-10-06T17:10:30+01:00
draft: false
---

## Internet Addressing
On the Internet you might get a Public IPv4 address like ```95.87.88.216``` or an IPv6 address like ```2000:25a:c479:3dfd:7ed7:3ff7:29d5:f29e```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```9c:19:cc:b9:ed:6a```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://reichert-kassulke.biz you initially access a DNS server to translate the host portion (reichert-kassulke) combined with the Top Level Domain (biz) of the URL, to an IP address like ```166.160.42.105```. Your computer and browser actually sends its type with all web requests e.g. <br>```Opera/9.80 (X11; Linux i686; Ubuntu/14.10) Presto/2.12.388 Version/12.16```
...
<pre>
default   99:b41c:bbd3:5379:cdbe:3ee:f6d3:2957%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {145.46.189.218, 225.157.76.235}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 9c:19:cc:b9:ed:6a
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr df:c4:9b:a6:71:de
}</pre>
