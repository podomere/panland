...
subtitle: "Branding?"
layout: research
ip_v4_address: "156.109.85.192"
date: 2022-11-19T19:13:16+00:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like ```156.109.85.192``` or an IPv6 address like ```2000:46da:a0c9:45dc:1339:d431:2fc5:7120```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```e9:76:03:bf:36:89```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://crooks.biz you initially access a DNS server to translate the host portion (crooks) combined with the Top Level Domain (biz) of the URL, to an IP address like ```216.182.68.116```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/41.0.2228.0 Safari/537.36```
...
<pre>
default   fe80:882a:7788:2d95:591a%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {73.64.87.186, 30.221.179.133}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr e9:76:03:bf:36:89
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr d5:2c:b0:13:b7:aa
}</pre>
