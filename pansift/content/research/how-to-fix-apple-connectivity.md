...
layout: research
ip_v4_address: "115.49.173.91"
date: 2022-04-24T19:00:24+01:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like <code>115.49.173.91</code> or an IPv6 address like <code>2000:d724:8576:b633:e783:2cba:bba9:4107</code>. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>f8:b1:92:a0:47:18</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://maggio.io you initially access a DNS server to translate the host portion (maggio) combined with the Top Level Domain (io) of the URL, to an IP address like <code>222.218.116.92</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Opera/9.80 (X11; Linux i686; Ubuntu/14.10) Presto/2.12.388 Version/12.16</code>
...
default  172.21.221.63    UGScg  en0
...
<pre><code>
default   fe80:7256:158d:fd5d:80b6%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {43.26.228.1, 39.114.154.31}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr f8:b1:92:a0:47:18
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 82:79:0f:cf:ad:6b
}</code></pre>
