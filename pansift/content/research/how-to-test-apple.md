...
layout: research
ip_v4_address: "154.75.103.255"
date: 2022-04-24T18:31:58+01:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like <code>154.75.103.255</code> or an IPv6 address like <code>2000:8cab:d2d:224a:ad96:59ca:e9:d5e5</code>. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>ed:19:f5:3d:52:d1</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://lind-douglas.net you initially access a DNS server to translate the host portion (lind-douglas) combined with the Top Level Domain (net) of the URL, to an IP address like <code>72.113.147.25</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (Windows NT 6.1; WOW64; Trident/7.0; AS; rv:11.0) like Gecko</code>
...
<pre><code>
default   fe80:81f5:c331:65ee:25e3%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {249.100.237.10, 189.229.58.185}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr ed:19:f5:3d:52:d1
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 50:25:63:7b:1f:8b
}</code></pre>
