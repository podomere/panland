...
layout: research
ip_v4_address: "115.70.177.153"
date: 2022-11-02T11:33:11+00:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like ```115.70.177.153``` or an IPv6 address like ```2000:190:d022:1e5d:8fb2:4486:7ce4:8360```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```4d:84:ba:1d:a1:ae```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://gottlieb-dare.info you initially access a DNS server to translate the host portion (gottlieb-dare) combined with the Top Level Domain (info) of the URL, to an IP address like ```52.105.129.227```. Your computer and browser actually sends its type with all web requests e.g. <br>```Opera/9.80 (X11; Linux i686; Ubuntu/14.10) Presto/2.12.388 Version/12.16```
...
<pre>
default   fe80:4f7a:7574:cd67:a091%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {213.200.177.100, 135.191.233.156}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 4d:84:ba:1d:a1:ae
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr ae:5c:22:6e:21:c1
}</pre>
