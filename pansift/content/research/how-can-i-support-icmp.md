...
layout: research
ip_v4_address: "233.169.131.101"
date: 2022-11-19T16:17:23+00:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like ```233.169.131.101``` or an IPv6 address like ```2000:e706:6467:1383:b2d6:5db1:dad6:d01d```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```96:ad:87:d0:c1:e7```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://rutherford-jacobs.name you initially access a DNS server to translate the host portion (rutherford-jacobs) combined with the Top Level Domain (name) of the URL, to an IP address like ```208.203.107.18```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows; U; Win 9x 4.90; SG; rv:1.9.2.4) Gecko/20101104 Netscape/9.1.0285```
...
<pre>
default   fe80:1856:f1ca:f981:931a%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {95.65.133.143, 226.1.80.126}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 96:ad:87:d0:c1:e7
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 1b:0d:36:cb:a3:9e
}</pre>
