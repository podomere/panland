...
layout: research
ip_v4_address: "246.113.194.236"
date: 2022-11-02T11:33:12+00:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like ```246.113.194.236``` or an IPv6 address like ```2000:94e5:8c83:554e:e118:2ebf:fae7:ead1```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```7a:2b:d2:8f:33:c9```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://hoeger.io you initially access a DNS server to translate the host portion (hoeger) combined with the Top Level Domain (io) of the URL, to an IP address like ```156.124.12.80```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_3) AppleWebKit/537.75.14 (KHTML, like Gecko) Version/7.0.3 Safari/7046A194A```
...
<pre>
default   fe80:ecc9:ea17:982f:680%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {21.81.203.214, 17.91.191.213}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 7a:2b:d2:8f:33:c9
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 53:51:97:b2:de:55
}</pre>
