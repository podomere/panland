...
subtitle: "Tee It Up?"
layout: research
ip_v4_address: "5.152.17.248"
date: 2022-05-05T14:29:57+01:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like ```5.152.17.248``` or an IPv6 address like ```2000:3c8b:2a93:53e4:5666:facb:f341:5d08```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```39:51:66:89:a6:ed```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://pacocha-streich.io you initially access a DNS server to translate the host portion (pacocha-streich) combined with the Top Level Domain (io) of the URL, to an IP address like ```92.249.212.141```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/41.0.2228.0 Safari/537.36```

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```10.224.183.166``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  10.224.183.166    UGScg  en0
...
<pre>
default   fe80:7f0c:cd56:856a:f0fd%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {57.22.50.169, 82.115.153.1}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 39:51:66:89:a6:ed
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 82:c0:da:44:42:a9
}</pre>
