...
layout: research
ip_v4_address: "254.17.243.132"
date: 2023-10-29T15:13:27+00:00
draft: false
---

## Internet Addressing
On the Internet you might get a Public IPv4 address like ```254.17.243.132``` or an IPv6 address like ```2000:fb5d:b28d:3888:d38a:d9f6:2ae9:616d```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```27:d9:59:3e:9d:fb```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://lakin-hodkiewicz.net you initially access a DNS server to translate the host portion (lakin-hodkiewicz) combined with the Top Level Domain (net) of the URL, to an IP address like ```145.152.238.17```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (compatible; MSIE 9.0; AOL 9.7; AOLBuild 4343.19; Windows NT 6.1; WOW64; Trident/5.0; FunWebProducts)```
...
<pre>
default   fe80:79bb:ec03:1e3f:ba72%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {2.249.249.80, 137.201.153.166}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 27:d9:59:3e:9d:fb
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr a7:d7:19:03:1f:df
}</pre>
...
### Apple macOS / OSX
No matter what version of OSX/macOS you are on, ```10.13.8```, ```11.6.8```, or ```12.3.6```, there are a range of tools for troubleshooting. Unfortunately, between these manual actions and scripts, they don't give you a series of correlated values over time. This is where automated remote troubleshooting comes in to its own, especially for teams that embrace remote work and Work From Anywhere (WFA).
