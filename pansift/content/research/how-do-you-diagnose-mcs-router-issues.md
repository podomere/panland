...
layout: research
ip_v4_address: "160.10.27.223"
date: 2022-11-02T11:32:24+00:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like ```160.10.27.223``` or an IPv6 address like ```2000:b4d6:7cd6:9b72:9e0c:ffea:c21d:b20e```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```cd:78:9e:72:d4:0c```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://lynch-conn.io you initially access a DNS server to translate the host portion (lynch-conn) combined with the Top Level Domain (io) of the URL, to an IP address like ```184.107.132.107```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows; U; Win 9x 4.90; SG; rv:1.9.2.4) Gecko/20101104 Netscape/9.1.0285```
...
<pre>
default   fe80:3a88:4b78:fb2b:72a4%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {170.83.108.165, 196.123.14.100}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr cd:78:9e:72:d4:0c
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr b0:70:4d:c8:2e:cf
}</pre>
