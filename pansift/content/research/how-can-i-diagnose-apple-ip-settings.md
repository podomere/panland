...
layout: research
ip_v4_address: "233.134.155.92"
date: 2022-12-15T13:50:11+00:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like ```233.134.155.92``` or an IPv6 address like ```2000:748e:3662:359:5f60:cc58:6854:1c28```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```81:24:0c:05:26:f1```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://toy-bogisich.name you initially access a DNS server to translate the host portion (toy-bogisich) combined with the Top Level Domain (name) of the URL, to an IP address like ```129.62.214.111```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_3) AppleWebKit/537.75.14 (KHTML, like Gecko) Version/7.0.3 Safari/7046A194A```
...
<pre>
default   fe80:a5ba:6bac:56c6:c27c%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {230.65.151.24, 141.220.11.233}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 81:24:0c:05:26:f1
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 92:c8:fc:a9:f8:6c
}</pre>
