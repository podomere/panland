...
layout: research
ip_v4_address: "116.196.31.176"
date: 2022-04-24T19:00:33+01:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like <code>116.196.31.176</code> or an IPv6 address like <code>2000:1b4f:6354:52c3:68b1:5dab:9efe:9a8d</code>. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>2b:ef:cb:c8:c6:5f</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://hirthe-purdy.io you initially access a DNS server to translate the host portion (hirthe-purdy) combined with the Top Level Domain (io) of the URL, to an IP address like <code>104.251.115.204</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Opera/9.80 (X11; Linux i686; Ubuntu/14.10) Presto/2.12.388 Version/12.16</code>
...
<pre><code>
default   fe80:abd6:497a:c9d8:f8a4%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {254.54.28.38, 22.14.224.3}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 2b:ef:cb:c8:c6:5f
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr ff:09:08:af:d5:d5
}</code></pre>
