...
subtitle: "Impact Map?"
layout: research
ip_v4_address: "179.93.246.169"
date: 2022-11-19T19:13:24+00:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like ```179.93.246.169``` or an IPv6 address like ```2000:9cd0:3d6f:e54f:a258:5896:d92b:3b27```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```93:09:de:7e:b9:0f```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://hermiston.info you initially access a DNS server to translate the host portion (hermiston) combined with the Top Level Domain (info) of the URL, to an IP address like ```106.57.215.182```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1; WOW64; Trident/7.0; AS; rv:11.0) like Gecko```

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```10.123.5.98``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
<pre>
default   fe80:469d:95a2:3199:7577%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {243.217.77.237, 100.254.94.27}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 93:09:de:7e:b9:0f
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr bf:cd:9d:d9:ad:6f
}</pre>
