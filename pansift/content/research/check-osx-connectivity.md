...
layout: research
ip_v4_address: "221.185.203.253"
date: 2022-11-19T19:13:16+00:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like ```221.185.203.253``` or an IPv6 address like ```2000:5101:37af:81b3:cbe3:5dfa:498:165c```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```da:f3:d4:b4:27:74```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://keebler-considine.org you initially access a DNS server to translate the host portion (keebler-considine) combined with the Top Level Domain (org) of the URL, to an IP address like ```105.214.3.113```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT x.y; Win64; x64; rv:10.0) Gecko/20100101 Firefox/10.0```
...
<pre>
default   fe80:4969:3532:8fc7:b504%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {211.177.255.55, 193.251.114.134}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr da:f3:d4:b4:27:74
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr ce:c1:6b:1d:46:5c
}</pre>
