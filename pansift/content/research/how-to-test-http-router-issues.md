...
subtitle: "Synergy?"
layout: research
ip_v4_address: "178.235.119.8"
date: 2023-02-04T16:26:22+00:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like ```178.235.119.8``` or an IPv6 address like ```2000:cf2a:f287:8446:e2b7:771e:13c:9994```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```ef:7f:52:f7:45:02```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://keebler-hintz.name you initially access a DNS server to translate the host portion (keebler-hintz) combined with the Top Level Domain (name) of the URL, to an IP address like ```115.172.215.200```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT x.y; Win64; x64; rv:10.0) Gecko/20100101 Firefox/10.0```
...
<pre>
default   fe80:55b3:efea:4063:b9eb%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {171.38.241.155, 179.81.110.203}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr ef:7f:52:f7:45:02
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr e5:18:ee:27:f4:4c
}</pre>
