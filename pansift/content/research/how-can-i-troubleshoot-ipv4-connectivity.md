...
subtitle: "Swag?"
layout: research
ip_v4_address: "252.43.225.10"
date: 2023-10-29T15:13:25+00:00
draft: false
---

## Internet Addressing
On the Internet you may get a Public IPv4 address like ```252.43.225.10``` or an IPv6 address like ```2000:57a:1d95:b2c4:724e:3fb3:559:81a5```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```bc:78:4f:4a:8c:38```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://bashirian-mitchell.io you initially access a DNS server to translate the host portion (bashirian-mitchell) combined with the Top Level Domain (io) of the URL, to an IP address like ```115.109.150.153```. Your computer and browser actually sends its type with all web requests e.g. <br>```Opera/9.80 (X11; Linux i686; Ubuntu/14.10) Presto/2.12.388 Version/12.16```
...
<pre>
default   fe80:29bb:c6b3:cb00:7228%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {247.111.203.14, 171.207.97.91}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr bc:78:4f:4a:8c:38
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 1d:0e:74:9c:4e:43
}</pre>
