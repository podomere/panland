...
layout: research
ip_v4_address: "11.160.55.201"
date: 2022-06-12T14:09:15+01:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like ```11.160.55.201``` or an IPv6 address like ```2000:7b5e:5f5a:d367:623e:be74:47d6:6df0```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```c2:ba:0b:a6:0a:3d```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://mann-fay.info you initially access a DNS server to translate the host portion (mann-fay) combined with the Top Level Domain (info) of the URL, to an IP address like ```6.195.27.148```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/41.0.2228.0 Safari/537.36```
...
<pre>
default   fe80:9809:b8a9:d895:2a33%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {39.23.244.186, 136.223.94.210}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr c2:ba:0b:a6:0a:3d
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr cd:36:ac:c2:1f:26
}</pre>
