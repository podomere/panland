...
layout: research
ip_v4_address: "179.138.193.182"
date: 2022-06-04T14:38:17+01:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like ```179.138.193.182``` or an IPv6 address like ```2000:83f9:c4ec:a3:26d3:6928:e6c4:e2d4```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```17:0f:9e:9d:e6:cc```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://keebler-emard.com you initially access a DNS server to translate the host portion (keebler-emard) combined with the Top Level Domain (com) of the URL, to an IP address like ```29.207.65.28```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_3) AppleWebKit/537.75.14 (KHTML, like Gecko) Version/7.0.3 Safari/7046A194A```

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```172.31.111.172``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  172.31.111.172    UGScg  en0
...
<pre>
default   fe80:2e1d:29c9:d6b2:b2a7%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {4.224.121.45, 175.104.74.149}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 17:0f:9e:9d:e6:cc
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 63:63:56:b5:8d:74
}</pre>
