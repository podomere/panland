...
subtitle: "Value Add?"
layout: research
ip_v4_address: "126.248.228.159"
date: 2022-11-19T16:17:19+00:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like ```126.248.228.159``` or an IPv6 address like ```2000:13b0:9c06:47b0:9851:bf19:268e:69ed```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```72:80:1c:4b:4a:6b```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://johns-pouros.co you initially access a DNS server to translate the host portion (johns-pouros) combined with the Top Level Domain (co) of the URL, to an IP address like ```55.15.162.44```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows; U; Win 9x 4.90; SG; rv:1.9.2.4) Gecko/20101104 Netscape/9.1.0285```

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```10.77.183.113``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  10.77.183.113    UGScg  en0
...
<pre>
default   fe80:acaa:3275:dc8:3d56%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {220.142.4.234, 165.171.167.23}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 72:80:1c:4b:4a:6b
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 9a:18:b8:bb:c1:a2
}</pre>
