...
layout: research
ip_v4_address: "114.175.146.105"
date: 2023-02-04T17:07:42+00:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like ```114.175.146.105``` or an IPv6 address like ```2000:f991:d7c9:ec1a:e61c:776d:fb99:189c```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```e3:c0:c9:67:df:c2```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://wisozk-bogisich.name you initially access a DNS server to translate the host portion (wisozk-bogisich) combined with the Top Level Domain (name) of the URL, to an IP address like ```253.120.99.115```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (compatible; MSIE 9.0; AOL 9.7; AOLBuild 4343.19; Windows NT 6.1; WOW64; Trident/5.0; FunWebProducts)```
...
<pre>
default   fe80:f75c:2d7b:f0e4:d822%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {187.62.206.42, 168.249.5.128}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr e3:c0:c9:67:df:c2
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 4b:72:ab:59:f9:3d
}</pre>
