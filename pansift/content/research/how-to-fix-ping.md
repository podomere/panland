...
layout: research
ip_v4_address: "183.188.243.69"
date: 2022-06-04T14:38:42+01:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like ```183.188.243.69``` or an IPv6 address like ```2000:5079:5f30:fd83:3d8f:f715:30e3:1670```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```94:b3:28:4c:94:7d```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://wiegand-zboncak.name you initially access a DNS server to translate the host portion (wiegand-zboncak) combined with the Top Level Domain (name) of the URL, to an IP address like ```54.192.76.34```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_3) AppleWebKit/537.75.14 (KHTML, like Gecko) Version/7.0.3 Safari/7046A194A```
...
<pre>
default   fe80:c5fe:d919:4733:2c8a%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {219.158.47.164, 45.219.65.220}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 94:b3:28:4c:94:7d
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 77:ac:12:df:85:a7
}</pre>
