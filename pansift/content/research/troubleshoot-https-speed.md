...
layout: research
ip_v4_address: "244.149.255.38"
date: 2022-06-12T14:09:28+01:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like ```244.149.255.38``` or an IPv6 address like ```2000:405f:dc9:950d:2521:78dc:4fca:53dc```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```15:15:96:8c:42:b7```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://predovic-kunze.com you initially access a DNS server to translate the host portion (predovic-kunze) combined with the Top Level Domain (com) of the URL, to an IP address like ```67.133.98.217```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT x.y; Win64; x64; rv:10.0) Gecko/20100101 Firefox/10.0```
...
<pre>
default   fe80:8cd6:8c2b:f89a:193c%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {223.97.61.78, 183.244.5.255}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 15:15:96:8c:42:b7
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 82:fe:a3:57:13:9a
}</pre>
