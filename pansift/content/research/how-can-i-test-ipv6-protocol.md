...
layout: research
ip_v4_address: "200.149.92.68"
date: 2023-10-06T17:11:03+01:00
draft: false
---

## Internet Addressing
On the Internet you might get a Public IPv4 address like ```200.149.92.68``` or an IPv6 address like ```2000:e36a:82b:bd22:69bd:eba:9efb:6f7c```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```36:c1:8e:47:16:6b```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://ritchie-casper.co you initially access a DNS server to translate the host portion (ritchie-casper) combined with the Top Level Domain (co) of the URL, to an IP address like ```45.197.110.159```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1; WOW64; Trident/7.0; AS; rv:11.0) like Gecko```
...
<pre>
default   f255:86:5b0:d65:76ba:3de4:2c79:7ccd%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {77.75.223.10, 115.95.32.201}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 36:c1:8e:47:16:6b
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 4d:ba:14:7b:94:c1
}</pre>
