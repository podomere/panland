...
subtitle: "Granular?"
layout: research
ip_v4_address: "179.117.112.75"
date: 2023-02-04T16:26:17+00:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like ```179.117.112.75``` or an IPv6 address like ```2000:c3f1:ec7f:114b:cfcf:85ca:51f8:43fd```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```a3:79:5e:e7:d2:30```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://hauck-corwin.name you initially access a DNS server to translate the host portion (hauck-corwin) combined with the Top Level Domain (name) of the URL, to an IP address like ```20.195.138.81```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_3) AppleWebKit/537.75.14 (KHTML, like Gecko) Version/7.0.3 Safari/7046A194A```
...
<pre>
default   fe80:ad1c:2520:fe9:6933%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {156.197.132.175, 206.153.72.209}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr a3:79:5e:e7:d2:30
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 18:fe:5f:b6:0c:9f
}</pre>
...
## Apple macOS / OSX
No matter what version of OSX/macOS you are on, ```10.15.6```, ```11.5.8```, or ```12.0.9```, there are a range of tools for troubleshooting. Unfortunately, between these manual actions and scripts, they don't give you a series of correlated values over time. This is where automated remote troubleshooting comes in to its own, especially for teams that embrace remote work and Work From Anywhere (WFA).
