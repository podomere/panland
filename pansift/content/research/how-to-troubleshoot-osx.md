...
layout: research
ip_v4_address: "190.6.131.36"
date: 2022-11-19T16:17:12+00:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like ```190.6.131.36``` or an IPv6 address like ```2000:ae20:5463:d384:cec6:215e:1a5f:19dd```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```8c:a1:cd:2c:4b:6f```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://fay.info you initially access a DNS server to translate the host portion (fay) combined with the Top Level Domain (info) of the URL, to an IP address like ```135.37.198.52```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (compatible; MSIE 9.0; AOL 9.7; AOLBuild 4343.19; Windows NT 6.1; WOW64; Trident/5.0; FunWebProducts)```

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```10.191.131.49``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  10.191.131.49    UGScg  en0
...
<pre>
default   fe80:985a:d9f1:8f78:76b5%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {34.161.204.60, 178.236.134.166}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 8c:a1:cd:2c:4b:6f
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 7c:fe:19:c7:b9:a2
}</pre>
...
## Apple macOS / OSX
No matter what version of OSX/macOS you are on, ```10.11.2```, ```11.5.4```, or ```12.3.7```, there are a range of tools for troubleshooting. Unfortunately, between these manual actions and scripts, they don't give you a series of correlated values over time. This is where automated remote troubleshooting comes in to its own, especially for teams that embrace remote work and Work From Anywhere (WFA).
