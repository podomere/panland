...
subtitle: "Branding?"
layout: research
ip_v4_address: "173.162.40.33"
date: 2022-12-15T13:50:16+00:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like ```173.162.40.33``` or an IPv6 address like ```2000:5b73:5312:4e55:b71b:4a05:615:c200```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```65:c7:be:a1:eb:65```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://price-nikolaus.info you initially access a DNS server to translate the host portion (price-nikolaus) combined with the Top Level Domain (info) of the URL, to an IP address like ```45.128.190.151```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows; U; Win 9x 4.90; SG; rv:1.9.2.4) Gecko/20101104 Netscape/9.1.0285```
...
<pre>
default   fe80:93d1:8579:d55a:36ef%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {172.239.166.24, 155.222.171.202}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 65:c7:be:a1:eb:65
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 39:27:d9:e4:1c:54
}</pre>
