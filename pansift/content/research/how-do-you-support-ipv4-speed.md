---
title: "How Do You Support IPv4 Speed"
subtitle: "Heads Down?"
layout: research
ip_v4_address: "199.228.155.233"
date: 2022-11-02T11:32:54+00:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like ```199.228.155.233``` or an IPv6 address like ```2000:a541:e0ee:1f1d:f2cf:9c5f:9692:4a90```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```8a:ee:27:c0:6f:21```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://jerde-heaney.co you initially access a DNS server to translate the host portion (jerde-heaney) combined with the Top Level Domain (co) of the URL, to an IP address like ```125.225.161.37```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (compatible; MSIE 9.0; AOL 9.7; AOLBuild 4343.19; Windows NT 6.1; WOW64; Trident/5.0; FunWebProducts)```
...
<pre>
default   fe80:76c9:ef47:5b53:e3d1%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {206.19.184.138, 150.226.55.190}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 8a:ee:27:c0:6f:21
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr d1:56:65:26:43:07
}</pre>
...
## Apple macOS / OSX
No matter what version of OSX/macOS you are on, ```10.13.1```, ```11.3.6```, or ```12.1.7```, there are a range of tools for troubleshooting. Unfortunately, between these manual actions and scripts, they don't give you a series of correlated values over time. This is where automated remote troubleshooting comes in to its own, especially for teams that embrace remote work and Work From Anywhere (WFA).
