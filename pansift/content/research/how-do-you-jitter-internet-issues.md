...
subtitle: "Granular?"
layout: research
ip_v4_address: "106.107.48.242"
date: 2023-10-29T15:13:27+00:00
draft: false
---

## Internet Addressing
On the Internet you may get a Public IPv4 address like ```106.107.48.242``` or an IPv6 address like ```2000:3475:19a5:9f86:996d:68ec:e7b0:3cfb```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```dd:67:22:23:a8:36```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://lynch.biz you initially access a DNS server to translate the host portion (lynch) combined with the Top Level Domain (biz) of the URL, to an IP address like ```232.128.192.181```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT x.y; Win64; x64; rv:10.0) Gecko/20100101 Firefox/10.0```
...
<pre>
default   fe80:af86:238b:71bb:e34e%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {153.175.129.220, 251.53.133.11}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr dd:67:22:23:a8:36
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 00:d4:ad:e8:6d:28
}</pre>
...
### Apple macOS / OSX
No matter what version of OSX/macOS you are on, ```10.11.9```, ```11.6.7```, or ```12.1.3```, there are a range of tools for troubleshooting. Unfortunately, between these manual actions and scripts, they don't give you a series of correlated values over time. This is where automated remote troubleshooting comes in to its own, especially for teams that embrace remote work and Work From Anywhere (WFA).
