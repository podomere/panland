...
layout: research
ip_v4_address: "177.213.226.206"
date: 2022-04-24T19:00:34+01:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like <code>177.213.226.206</code> or an IPv6 address like <code>2000:5164:92e:556f:9544:337b:74fc:4898</code>. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>12:c6:b5:c0:bf:20</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://yundt.name you initially access a DNS server to translate the host portion (yundt) combined with the Top Level Domain (name) of the URL, to an IP address like <code>104.197.111.220</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Opera/9.80 (X11; Linux i686; Ubuntu/14.10) Presto/2.12.388 Version/12.16</code>
...
default  172.24.66.223    UGScg  en0
...
<pre><code>
default   fe80:e7d:9072:3379:8bbd%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {227.213.41.107, 100.200.251.92}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 12:c6:b5:c0:bf:20
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 42:7e:94:0b:1a:0d
}</code></pre>
