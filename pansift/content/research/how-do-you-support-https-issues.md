...
layout: research
ip_v4_address: "204.42.155.22"
date: 2022-06-12T14:09:29+01:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like ```204.42.155.22``` or an IPv6 address like ```2000:612:4cdd:7b90:6338:1ab9:4510:e4a2```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```78:90:0f:f9:8b:c8```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://torp-doyle.net you initially access a DNS server to translate the host portion (torp-doyle) combined with the Top Level Domain (net) of the URL, to an IP address like ```190.35.19.34```. Your computer and browser actually sends its type with all web requests e.g. <br>```Opera/9.80 (X11; Linux i686; Ubuntu/14.10) Presto/2.12.388 Version/12.16```
...
<pre>
default   fe80:adda:8588:aafc:4a3f%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {54.219.171.248, 190.125.101.80}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 78:90:0f:f9:8b:c8
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 4c:6f:4e:bd:f9:a9
}</pre>
