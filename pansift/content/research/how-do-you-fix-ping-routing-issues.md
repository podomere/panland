...
subtitle: "Heads Down?"
layout: research
ip_v4_address: "35.36.65.32"
date: 2023-10-06T17:11:07+01:00
draft: false
---

## Internet Addressing
On the Internet you may have a Public IPv4 address like ```35.36.65.32``` or an IPv6 address like ```2000:697e:b841:a39a:1321:9641:967f:c8```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```8d:ed:93:2e:52:29```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://watsica-ferry.name you initially access a DNS server to translate the host portion (watsica-ferry) combined with the Top Level Domain (name) of the URL, to an IP address like ```237.28.177.39```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_3) AppleWebKit/537.75.14 (KHTML, like Gecko) Version/7.0.3 Safari/7046A194A```
...
<pre>
default   fe80:b422:e4c1:ec05:8ed3%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {197.113.94.204, 200.188.39.93}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 8d:ed:93:2e:52:29
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 79:84:e2:fe:07:3f
}</pre>
