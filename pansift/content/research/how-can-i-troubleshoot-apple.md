...
subtitle: "Swim Lane?"
layout: research
ip_v4_address: "226.237.125.209"
date: 2022-06-04T14:38:29+01:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like ```226.237.125.209``` or an IPv6 address like ```2000:dd10:2c90:e7a4:c392:7737:dbcc:2999```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```bb:f9:84:31:9a:0b```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://macejkovic-mclaughlin.com you initially access a DNS server to translate the host portion (macejkovic-mclaughlin) combined with the Top Level Domain (com) of the URL, to an IP address like ```69.201.251.228```. Your computer and browser actually sends its type with all web requests e.g. <br>```Opera/9.80 (X11; Linux i686; Ubuntu/14.10) Presto/2.12.388 Version/12.16```

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```172.25.150.244``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  172.25.150.244    UGScg  en0
...
<pre>
default   fe80:a5b9:711b:85b8:d79e%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {37.118.251.93, 169.207.66.218}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr bb:f9:84:31:9a:0b
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 5b:ac:81:5c:2c:2e
}</pre>
