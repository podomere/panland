---
title: "How Can I Support Latency No-access"
subtitle: "Had To 'punt' On That?"
layout: research
ip_v4_address: "64.4.111.78"
date: 2023-10-29T15:13:26+00:00
draft: false
---

## Internet Addressing
On the Internet you might get a Public IPv4 address like ```64.4.111.78``` or an IPv6 address like ```2000:5d03:6410:dc07:70b0:c57d:46eb:6dd6```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```d0:fb:ee:74:e8:1e```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://olson-predovic.org you initially access a DNS server to translate the host portion (olson-predovic) combined with the Top Level Domain (org) of the URL, to an IP address like ```205.239.190.230```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (compatible; MSIE 9.0; AOL 9.7; AOLBuild 4343.19; Windows NT 6.1; WOW64; Trident/5.0; FunWebProducts)```
...
<pre>
default   fe80:1d5d:a6be:5b7d:876c%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {7.170.100.84, 46.127.47.255}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr d0:fb:ee:74:e8:1e
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr aa:49:96:1f:2a:17
}</pre>
...
### Apple macOS / OSX
No matter what version of OSX/macOS you are on, ```10.11.3```, ```11.2.1```, or ```12.3.8```, there are a range of tools for troubleshooting. Unfortunately, between these manual actions and scripts, they don't give you a series of correlated values over time. This is where automated remote troubleshooting comes in to its own, especially for teams that embrace remote work and Work From Anywhere (WFA).
