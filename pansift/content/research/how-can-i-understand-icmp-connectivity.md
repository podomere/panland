...
layout: research
ip_v4_address: "219.123.198.146"
date: 2023-10-06T17:11:06+01:00
draft: false
---

## Internet Addressing
On the Internet you may have a Public IPv4 address like ```219.123.198.146``` or an IPv6 address like ```2000:bdae:2bae:6e7f:4cb9:45e4:f7e0:8a18```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```fe:77:4d:25:f9:62```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://kuphal.com you initially access a DNS server to translate the host portion (kuphal) combined with the Top Level Domain (com) of the URL, to an IP address like ```41.12.134.109```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (compatible; MSIE 9.0; AOL 9.7; AOLBuild 4343.19; Windows NT 6.1; WOW64; Trident/5.0; FunWebProducts)```
...
<pre>
default   fe80:fb92:c9ad:ec1f:cb16%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {39.224.63.154, 240.249.115.130}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr fe:77:4d:25:f9:62
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 23:59:cc:0f:c3:64
}</pre>
...
### Apple macOS / OSX
No matter what version of OSX/macOS you are on, ```10.14.5```, ```11.1.4```, or ```12.1.1```, there are a range of tools for troubleshooting. Unfortunately, between these manual actions and scripts, they don't give you a series of correlated values over time. This is where automated remote troubleshooting comes in to its own, especially for teams that embrace remote work and Work From Anywhere (WFA).
