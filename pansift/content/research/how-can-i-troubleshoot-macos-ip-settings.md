...
layout: research
ip_v4_address: "106.140.46.166"
date: 2023-10-06T17:10:41+01:00
draft: false
---

## Internet Addressing
On the Internet you may get a Public IPv4 address like ```106.140.46.166``` or an IPv6 address like ```2000:a045:b17b:7404:6821:d027:d6e4:89a9```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```1a:8f:9e:1a:a6:f4```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://rempel-fisher.name you initially access a DNS server to translate the host portion (rempel-fisher) combined with the Top Level Domain (name) of the URL, to an IP address like ```27.53.157.42```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT x.y; Win64; x64; rv:10.0) Gecko/20100101 Firefox/10.0```
...
<pre>
default   fe80:9a63:127e:1f71:70e0%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {152.248.45.38, 88.4.139.152}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 1a:8f:9e:1a:a6:f4
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr f8:cf:5e:c4:14:a5
}</pre>
