...
layout: research
ip_v4_address: "52.206.215.8"
date: 2023-10-06T17:10:30+01:00
draft: false
---

## Internet Addressing
On the Internet you may have a Public IPv4 address like ```52.206.215.8``` or an IPv6 address like ```2000:1b26:86a3:2a8d:9852:d402:86a0:1260```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```04:7e:47:0f:88:7e```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://stehr-simonis.name you initially access a DNS server to translate the host portion (stehr-simonis) combined with the Top Level Domain (name) of the URL, to an IP address like ```208.214.216.220```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (compatible; MSIE 9.0; AOL 9.7; AOLBuild 4343.19; Windows NT 6.1; WOW64; Trident/5.0; FunWebProducts)```
...
<pre>
default   fe80:8137:8a23:a77f:b677%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {212.188.253.153, 249.159.37.79}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 04:7e:47:0f:88:7e
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 83:79:c9:92:ff:d5
}</pre>
