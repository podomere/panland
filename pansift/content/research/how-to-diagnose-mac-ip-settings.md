...
subtitle: "Synergy?"
layout: research
ip_v4_address: "46.205.66.90"
date: 2023-10-29T15:13:19+00:00
draft: false
---

## Internet Addressing
On the Internet you may have a Public IPv4 address like ```46.205.66.90``` or an IPv6 address like ```2000:2956:282e:8b50:bbe:9191:9a42:86fc```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```9d:cc:cb:b4:cd:75```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://champlin-heathcote.info you initially access a DNS server to translate the host portion (champlin-heathcote) combined with the Top Level Domain (info) of the URL, to an IP address like ```156.136.70.192```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (compatible; MSIE 9.0; AOL 9.7; AOLBuild 4343.19; Windows NT 6.1; WOW64; Trident/5.0; FunWebProducts)```
...
<pre>
default   fe80:4fc4:1532:bc0d:1fef%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {62.63.93.214, 8.226.145.175}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 9d:cc:cb:b4:cd:75
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 7b:f0:12:5e:a8:53
}</pre>
...
### Apple macOS / OSX
No matter what version of OSX/macOS you are on, ```10.11.5```, ```11.2.5```, or ```12.2.9```, there are a range of tools for troubleshooting. Unfortunately, between these manual actions and scripts, they don't give you a series of correlated values over time. This is where automated remote troubleshooting comes in to its own, especially for teams that embrace remote work and Work From Anywhere (WFA).
