...
subtitle: "Synergy?"
layout: research
ip_v4_address: "204.184.167.184"
date: 2023-02-04T16:26:03+00:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like ```204.184.167.184``` or an IPv6 address like ```2000:dca3:e0f3:15d4:44ac:a899:2527:e6d4```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```0e:97:44:f7:70:3c```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://nicolas-grant.co you initially access a DNS server to translate the host portion (nicolas-grant) combined with the Top Level Domain (co) of the URL, to an IP address like ```225.244.18.13```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT x.y; Win64; x64; rv:10.0) Gecko/20100101 Firefox/10.0```
...
<pre>
default   fe80:528f:2de3:9dba:4d58%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {166.193.30.47, 239.98.16.124}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 0e:97:44:f7:70:3c
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr c3:b0:d7:98:b9:e2
}</pre>
