...
layout: research
ip_v4_address: "122.244.0.220"
date: 2022-04-24T18:32:42+01:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like <code>122.244.0.220</code> or an IPv6 address like <code>2000:fd10:d147:55ef:5128:3a62:9dd9:8a81</code>. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>74:5f:c1:3a:0b:3a</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://okon-gleason.biz you initially access a DNS server to translate the host portion (okon-gleason) combined with the Top Level Domain (biz) of the URL, to an IP address like <code>220.45.207.162</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_3) AppleWebKit/537.75.14 (KHTML, like Gecko) Version/7.0.3 Safari/7046A194A</code>
...
<pre><code>
default   fe80:f382:b218:b839:6ba2%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {123.59.149.60, 1.40.250.172}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 74:5f:c1:3a:0b:3a
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 1e:24:7f:b2:11:30
}</code></pre>
