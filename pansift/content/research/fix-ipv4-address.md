...
layout: research
ip_v4_address: "116.155.158.255"
date: 2022-04-24T18:59:56+01:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like <code>116.155.158.255</code> or an IPv6 address like <code>2000:1e4b:ea10:de88:b2ce:3871:9ae1:5f15</code>. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>7e:94:77:d4:24:3d</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://wiegand-beer.biz you initially access a DNS server to translate the host portion (wiegand-beer) combined with the Top Level Domain (biz) of the URL, to an IP address like <code>193.18.178.51</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (Windows; U; Win 9x 4.90; SG; rv:1.9.2.4) Gecko/20101104 Netscape/9.1.0285</code>
...
<pre><code>
default   fe80:7efa:184b:342:5931%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {78.106.173.154, 92.187.113.153}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 7e:94:77:d4:24:3d
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr b3:3f:5c:eb:47:fe
}</code></pre>
