...
subtitle: "Etc. Etc.?"
layout: research
ip_v4_address: "248.246.202.79"
date: 2023-10-29T15:13:30+00:00
draft: false
---

## Internet Addressing
On the Internet you might have a Public IPv4 address like ```248.246.202.79``` or an IPv6 address like ```2000:f383:5294:3ab:e3b0:69a4:8a88:e828```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```07:23:7f:b5:29:98```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://stroman-purdy.com you initially access a DNS server to translate the host portion (stroman-purdy) combined with the Top Level Domain (com) of the URL, to an IP address like ```8.144.177.234```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows; U; Win 9x 4.90; SG; rv:1.9.2.4) Gecko/20101104 Netscape/9.1.0285```
...
<pre>
default   fe80:f130:7eca:ac2d:bbc7%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {81.165.145.211, 89.140.158.226}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 07:23:7f:b5:29:98
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 36:ad:45:00:2c:10
}</pre>
