...
layout: research
ip_v4_address: "143.163.103.30"
date: 2022-11-19T19:13:25+00:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like ```143.163.103.30``` or an IPv6 address like ```2000:f821:7e6b:9a21:576e:bdaa:e4b2:e00```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```f3:77:9f:f9:bc:8b```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://keeling-oconner.info you initially access a DNS server to translate the host portion (keeling-oconner) combined with the Top Level Domain (info) of the URL, to an IP address like ```9.199.1.200```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/41.0.2228.0 Safari/537.36```
...
<pre>
default   fe80:3344:5e58:c435:f6e9%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {166.252.62.81, 64.7.114.224}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr f3:77:9f:f9:bc:8b
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr a4:a2:e7:3f:7a:d8
}</pre>
