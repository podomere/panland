...
layout: research
ip_v4_address: "93.116.171.6"
date: 2023-10-06T17:11:08+01:00
draft: false
---

## Internet Addressing
On the Internet you may have a Public IPv4 address like ```93.116.171.6``` or an IPv6 address like ```2000:878f:d650:eaf7:550e:6494:2b59:f017```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```58:7d:47:88:61:4d```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://tromp.info you initially access a DNS server to translate the host portion (tromp) combined with the Top Level Domain (info) of the URL, to an IP address like ```103.137.89.3```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (compatible; MSIE 9.0; AOL 9.7; AOLBuild 4343.19; Windows NT 6.1; WOW64; Trident/5.0; FunWebProducts)```
...
<pre>
default   fe80:b8a3:ce72:2d9a:590%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {104.200.221.206, 253.166.234.113}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 58:7d:47:88:61:4d
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 0c:22:89:2d:43:2b
}</pre>
