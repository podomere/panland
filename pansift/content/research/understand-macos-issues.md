...
layout: research
ip_v4_address: "176.218.238.192"
date: 2022-04-24T19:00:23+01:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like <code>176.218.238.192</code> or an IPv6 address like <code>2000:5f78:dd0b:59:17dd:1f6e:dba6:e0b3</code>. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>58:64:be:70:59:63</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://halvorson-yost.com you initially access a DNS server to translate the host portion (halvorson-yost) combined with the Top Level Domain (com) of the URL, to an IP address like <code>190.56.130.55</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (Windows NT x.y; Win64; x64; rv:10.0) Gecko/20100101 Firefox/10.0</code>
...
<pre><code>
default   fe80:470:c559:f5f2:c491%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {203.142.60.153, 224.0.48.140}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 58:64:be:70:59:63
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr f5:83:ce:a1:82:26
}</code></pre>
