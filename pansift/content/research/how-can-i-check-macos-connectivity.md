...
layout: research
ip_v4_address: "174.204.146.129"
date: 2022-05-05T14:28:46+01:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like ```174.204.146.129``` or an IPv6 address like ```2000:1d18:bf8b:c053:71ab:d7bb:4dad:db1e```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```ca:5d:ad:9a:99:5e```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://hackett-kihn.name you initially access a DNS server to translate the host portion (hackett-kihn) combined with the Top Level Domain (name) of the URL, to an IP address like ```41.81.59.223```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT x.y; Win64; x64; rv:10.0) Gecko/20100101 Firefox/10.0```
...
<pre>
default   fe80:313d:eb9a:2676:577%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {112.158.100.43, 151.59.186.18}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr ca:5d:ad:9a:99:5e
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr c2:09:b6:48:c0:e2
}</pre>
