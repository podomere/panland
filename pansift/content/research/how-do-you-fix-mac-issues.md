...
layout: research
ip_v4_address: "222.184.114.28"
date: 2022-05-05T14:28:58+01:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like ```222.184.114.28``` or an IPv6 address like ```2000:8a2a:8bd4:62a4:2a6b:c8a5:e50f:ca81```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```ea:fd:ee:9b:96:df```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://sanford-hane.info you initially access a DNS server to translate the host portion (sanford-hane) combined with the Top Level Domain (info) of the URL, to an IP address like ```34.144.202.162```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows; U; Win 9x 4.90; SG; rv:1.9.2.4) Gecko/20101104 Netscape/9.1.0285```
...
<pre>
default   fe80:1d55:a54e:4dbe:6e35%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {238.69.56.249, 186.244.33.201}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr ea:fd:ee:9b:96:df
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr a4:f5:72:f5:7b:e4
}</pre>
