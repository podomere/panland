...
layout: research
ip_v4_address: "29.133.30.141"
date: 2022-04-24T19:00:03+01:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like <code>29.133.30.141</code> or an IPv6 address like <code>2000:e0f1:ba24:54f0:e8b0:2951:942d:882c</code>. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>71:ce:f2:d4:c0:99</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://sanford-lang.net you initially access a DNS server to translate the host portion (sanford-lang) combined with the Top Level Domain (net) of the URL, to an IP address like <code>232.92.23.238</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (Windows NT 6.1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/41.0.2228.0 Safari/537.36</code>
...
<pre><code>
default   fe80:349:32ae:8da2:575b%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {190.55.44.53, 139.205.181.240}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 71:ce:f2:d4:c0:99
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 65:6f:50:ab:a3:b7
}</code></pre>
