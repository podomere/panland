...
layout: research
ip_v4_address: "96.55.136.238"
date: 2022-04-24T19:00:00+01:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like <code>96.55.136.238</code> or an IPv6 address like <code>2000:fda6:15d4:9b3c:5475:6770:ea6a:c592</code>. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>a0:09:72:fe:08:0f</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://denesik-bashirian.info you initially access a DNS server to translate the host portion (denesik-bashirian) combined with the Top Level Domain (info) of the URL, to an IP address like <code>161.74.149.120</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_3) AppleWebKit/537.75.14 (KHTML, like Gecko) Version/7.0.3 Safari/7046A194A</code>
...
<pre><code>
default   fe80:4a28:d94b:fda0:2275%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {152.157.74.227, 152.252.81.201}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr a0:09:72:fe:08:0f
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 13:e9:13:ac:18:78
}</code></pre>
