...
layout: research
ip_v4_address: "44.135.25.53"
date: 2022-12-15T13:50:10+00:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like ```44.135.25.53``` or an IPv6 address like ```2000:68e9:ade:e36e:c453:a610:9fa9:7a6a```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```97:08:1c:5c:bc:c7```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://cartwright.co you initially access a DNS server to translate the host portion (cartwright) combined with the Top Level Domain (co) of the URL, to an IP address like ```241.86.147.164```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/41.0.2228.0 Safari/537.36```

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```192.168.128.42``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  192.168.128.42    UGScg  en0
...
<pre>
default   fe80:bd21:122d:27d1:136a%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {190.138.222.149, 116.197.133.157}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 97:08:1c:5c:bc:c7
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr d8:69:ae:90:36:0e
}</pre>
