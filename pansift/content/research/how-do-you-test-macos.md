...
subtitle: "Deep Dive?"
layout: research
ip_v4_address: "216.168.183.26"
date: 2022-06-12T14:09:15+01:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like ```216.168.183.26``` or an IPv6 address like ```2000:c64a:63e8:12e8:f865:72a5:57ce:99a8```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```71:5d:d5:61:51:4c```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://feeney.io you initially access a DNS server to translate the host portion (feeney) combined with the Top Level Domain (io) of the URL, to an IP address like ```38.55.193.247```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (compatible; MSIE 9.0; AOL 9.7; AOLBuild 4343.19; Windows NT 6.1; WOW64; Trident/5.0; FunWebProducts)```

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```172.28.79.24``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  172.28.79.24    UGScg  en0
...
<pre>
default   fe80:18ab:3f8:d54:40bf%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {254.94.8.72, 80.38.39.133}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 71:5d:d5:61:51:4c
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 43:20:26:f8:17:76
}</pre>
...
## Apple macOS / OSX
No matter what version of OSX/macOS you are on, ```10.14.4```, ```11.2.3```, or ```12.1.6```, there are a range of tools for troubleshooting. Unfortunately, between these manual actions and scripts, they don't give you a series of correlated values over time. This is where automated remote troubleshooting comes in to its own, especially for teams that embrace remote work and Work From Anywhere (WFA).
