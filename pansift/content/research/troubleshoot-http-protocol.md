...
layout: research
ip_v4_address: "191.204.19.146"
date: 2022-05-05T14:30:03+01:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like ```191.204.19.146``` or an IPv6 address like ```2000:55d8:52d:76f2:b96c:83c0:930d:9799```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```9b:54:70:7f:f4:2b```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://leffler-herzog.net you initially access a DNS server to translate the host portion (leffler-herzog) combined with the Top Level Domain (net) of the URL, to an IP address like ```129.124.140.150```. Your computer and browser actually sends its type with all web requests e.g. <br>```Opera/9.80 (X11; Linux i686; Ubuntu/14.10) Presto/2.12.388 Version/12.16```
...
<pre>
default   fe80:40f7:6a32:7a65:2e3%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {225.210.91.136, 146.126.39.153}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 9b:54:70:7f:f4:2b
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr b0:34:80:71:11:6f
}</pre>
...
## Apple macOS / OSX
No matter what version of OSX/macOS you are on, ```10.11.4```, ```11.6.6```, or ```12.1.5```, there are a range of tools for troubleshooting. Unfortunately, between these manual actions and scripts, they don't give you a series of correlated values over time. This is where automated remote troubleshooting comes in to its own, especially for teams that embrace remote work and Work From Anywhere (WFA).
