...
subtitle: "Swim Lane?"
layout: research
ip_v4_address: "3.251.241.199"
date: 2023-10-29T15:13:26+00:00
draft: false
---

## Internet Addressing
On the Internet you may get a Public IPv4 address like ```3.251.241.199``` or an IPv6 address like ```2000:6302:4e40:9685:92fb:c633:c2f3:c667```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```8e:1f:25:39:52:84```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://hartmann.org you initially access a DNS server to translate the host portion (hartmann) combined with the Top Level Domain (org) of the URL, to an IP address like ```164.203.233.2```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows; U; Win 9x 4.90; SG; rv:1.9.2.4) Gecko/20101104 Netscape/9.1.0285```
...
<pre>
default   fe80:4738:fef9:ba8e:53d%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {168.254.33.33, 218.238.101.217}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 8e:1f:25:39:52:84
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr f2:61:bd:bb:8f:d4
}</pre>
...
### Apple macOS / OSX
No matter what version of OSX/macOS you are on, ```10.15.5```, ```11.4.3```, or ```12.1.9```, there are a range of tools for troubleshooting. Unfortunately, between these manual actions and scripts, they don't give you a series of correlated values over time. This is where automated remote troubleshooting comes in to its own, especially for teams that embrace remote work and Work From Anywhere (WFA).
