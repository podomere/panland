...
subtitle: "Impact Map?"
layout: research
ip_v4_address: "17.192.209.170"
date: 2023-02-04T17:08:38+00:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like ```17.192.209.170``` or an IPv6 address like ```2000:d1f2:653f:b31e:8ad6:4ae6:a233:402a```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```5c:34:7a:cb:1f:be```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://hammes-daniel.info you initially access a DNS server to translate the host portion (hammes-daniel) combined with the Top Level Domain (info) of the URL, to an IP address like ```29.206.25.153```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT x.y; Win64; x64; rv:10.0) Gecko/20100101 Firefox/10.0```
...
<pre>
default   fe80:b8a2:c465:6cad:ca9d%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {167.2.40.250, 38.64.112.70}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 5c:34:7a:cb:1f:be
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 8c:0f:ff:38:d2:8d
}</pre>
