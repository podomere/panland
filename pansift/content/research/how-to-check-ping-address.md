...
layout: research
ip_v4_address: "5.184.103.113"
date: 2022-11-19T16:17:23+00:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like ```5.184.103.113``` or an IPv6 address like ```2000:6778:822c:2d24:59b:b46:bff8:6890```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```af:e2:7a:eb:fb:4b```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://hermiston.biz you initially access a DNS server to translate the host portion (hermiston) combined with the Top Level Domain (biz) of the URL, to an IP address like ```228.124.61.255```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_3) AppleWebKit/537.75.14 (KHTML, like Gecko) Version/7.0.3 Safari/7046A194A```
...
<pre>
default   fe80:6d8b:6f6f:78df:eae5%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {9.236.230.243, 251.169.149.245}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr af:e2:7a:eb:fb:4b
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 6c:20:4e:5e:61:a4
}</pre>
