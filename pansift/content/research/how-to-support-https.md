...
subtitle: "Value Add?"
layout: research
ip_v4_address: "175.251.86.147"
date: 2022-06-04T14:38:44+01:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like ```175.251.86.147``` or an IPv6 address like ```2000:b592:e7a5:8b2c:77ef:4554:38e4:aa12```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```26:fd:88:af:03:51```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://maggio-waters.org you initially access a DNS server to translate the host portion (maggio-waters) combined with the Top Level Domain (org) of the URL, to an IP address like ```52.253.30.227```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_3) AppleWebKit/537.75.14 (KHTML, like Gecko) Version/7.0.3 Safari/7046A194A```
...
<pre>
default   fe80:3c95:88b:326a:468e%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {124.5.63.149, 160.168.215.182}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 26:fd:88:af:03:51
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 29:ba:f4:96:05:6b
}</pre>
