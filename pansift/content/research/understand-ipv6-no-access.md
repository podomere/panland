...
layout: research
ip_v4_address: "175.42.131.52"
date: 2022-04-24T18:59:55+01:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like <code>175.42.131.52</code> or an IPv6 address like <code>2000:9014:9659:c13d:f0c5:bd06:689c:cd03</code>. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>9c:71:cd:3c:f6:e1</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://kshlerin-pfeffer.net you initially access a DNS server to translate the host portion (kshlerin-pfeffer) combined with the Top Level Domain (net) of the URL, to an IP address like <code>172.68.241.232</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_3) AppleWebKit/537.75.14 (KHTML, like Gecko) Version/7.0.3 Safari/7046A194A</code>

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like <code>172.27.50.135</code> (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For <code>IPv6</code> we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  172.27.50.135    UGScg  en0
...
<pre><code>
default   fe80:78f8:849b:18de:54b%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {197.26.188.109, 198.144.223.103}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 9c:71:cd:3c:f6:e1
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 60:b9:7d:26:c7:7a
}</code></pre>
