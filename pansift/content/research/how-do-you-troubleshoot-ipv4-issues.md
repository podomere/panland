...
layout: research
ip_v4_address: "90.167.63.156"
date: 2023-10-06T17:11:04+01:00
draft: false
---

## Internet Addressing
On the Internet you may have a Public IPv4 address like ```90.167.63.156``` or an IPv6 address like ```2000:ed00:aa89:a326:f030:5aca:e0ca:78e0```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```2f:4a:f2:0c:0a:cd```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://langworth.biz you initially access a DNS server to translate the host portion (langworth) combined with the Top Level Domain (biz) of the URL, to an IP address like ```91.67.46.79```. Your computer and browser actually sends its type with all web requests e.g. <br>```Opera/9.80 (X11; Linux i686; Ubuntu/14.10) Presto/2.12.388 Version/12.16```

## Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```10.128.81.44``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  10.128.81.44    UGScg  en0
...
<pre>
default   fe80:6c15:e843:d9b4:cb2d%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {25.87.203.174, 219.222.182.68}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 2f:4a:f2:0c:0a:cd
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 38:2a:f6:35:2f:42
}</pre>
