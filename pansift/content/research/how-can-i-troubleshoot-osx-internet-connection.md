...
subtitle: "Ideate?"
layout: research
ip_v4_address: "180.50.127.172"
date: 2023-02-04T17:07:49+00:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like ```180.50.127.172``` or an IPv6 address like ```2000:dc0c:5b4d:8b2f:19ba:406b:3850:cdcb```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```5e:75:dc:13:1e:b1```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://mcdermott-braun.biz you initially access a DNS server to translate the host portion (mcdermott-braun) combined with the Top Level Domain (biz) of the URL, to an IP address like ```82.58.11.194```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1; WOW64; Trident/7.0; AS; rv:11.0) like Gecko```

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```172.29.11.177``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  172.29.11.177    UGScg  en0
...
<pre>
default   fe80:573e:a644:794:473c%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {140.210.215.81, 67.255.108.194}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 5e:75:dc:13:1e:b1
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 22:aa:3f:86:2b:80
}</pre>
