...
layout: research
ip_v4_address: "250.53.121.87"
date: 2022-11-19T16:17:21+00:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like ```250.53.121.87``` or an IPv6 address like ```2000:daa9:a4ff:b729:cbf7:44cc:9f2a:2d45```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```7c:1b:3c:c1:4e:1a```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://batz-oconnell.info you initially access a DNS server to translate the host portion (batz-oconnell) combined with the Top Level Domain (info) of the URL, to an IP address like ```140.170.29.239```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows; U; Win 9x 4.90; SG; rv:1.9.2.4) Gecko/20101104 Netscape/9.1.0285```
...
<pre>
default   fe80:83a:cac3:9ff:6ed4%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {155.188.178.232, 171.21.16.247}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 7c:1b:3c:c1:4e:1a
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr e0:90:2c:0a:54:0e
}</pre>
