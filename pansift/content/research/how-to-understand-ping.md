...
layout: research
ip_v4_address: "11.233.208.163"
date: 2023-02-04T16:26:22+00:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like ```11.233.208.163``` or an IPv6 address like ```2000:69a8:f5c:535b:cb17:9ec5:d70:53bd```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```62:63:3b:06:0b:b5```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://kunze-lubowitz.info you initially access a DNS server to translate the host portion (kunze-lubowitz) combined with the Top Level Domain (info) of the URL, to an IP address like ```88.247.66.128```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows; U; Win 9x 4.90; SG; rv:1.9.2.4) Gecko/20101104 Netscape/9.1.0285```
...
<pre>
default   fe80:2268:a58a:89b3:ea66%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {199.152.156.229, 72.208.119.103}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 62:63:3b:06:0b:b5
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 86:c8:3d:4f:ec:c1
}</pre>
