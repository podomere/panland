...
subtitle: "Ideate?"
layout: research
ip_v4_address: "151.124.158.19"
date: 2022-11-19T16:17:11+00:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like ```151.124.158.19``` or an IPv6 address like ```2000:ca3d:e05c:f08b:bee2:f1b5:739b:a168```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```53:a8:1f:55:0f:aa```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://sanford-klocko.name you initially access a DNS server to translate the host portion (sanford-klocko) combined with the Top Level Domain (name) of the URL, to an IP address like ```35.156.70.47```. Your computer and browser actually sends its type with all web requests e.g. <br>```Opera/9.80 (X11; Linux i686; Ubuntu/14.10) Presto/2.12.388 Version/12.16```

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```172.22.115.143``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  172.22.115.143    UGScg  en0
...
<pre>
default   fe80:22cc:c49b:bbfb:7fa7%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {73.72.188.37, 32.138.144.95}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 53:a8:1f:55:0f:aa
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 58:90:7e:25:88:00
}</pre>
