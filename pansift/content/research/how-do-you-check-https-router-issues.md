...
layout: research
ip_v4_address: "92.200.40.10"
date: 2023-10-06T17:11:09+01:00
draft: false
---

## Internet Addressing
On the Internet you might get a Public IPv4 address like ```92.200.40.10``` or an IPv6 address like ```2000:355c:2ee1:84ea:7eca:7638:5d2b:8e91```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```7d:1a:72:65:d9:6a```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://grimes.io you initially access a DNS server to translate the host portion (grimes) combined with the Top Level Domain (io) of the URL, to an IP address like ```60.252.98.128```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (compatible; MSIE 9.0; AOL 9.7; AOLBuild 4343.19; Windows NT 6.1; WOW64; Trident/5.0; FunWebProducts)```
...
<pre>
default   fe80:f810:d3ae:e27a:1008%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {49.28.171.190, 159.236.128.9}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 7d:1a:72:65:d9:6a
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 8d:21:36:08:62:08
}</pre>
...
### Apple macOS / OSX
No matter what version of OSX/macOS you are on, ```10.14.3```, ```11.2.8```, or ```12.2.6```, there are a range of tools for troubleshooting. Unfortunately, between these manual actions and scripts, they don't give you a series of correlated values over time. This is where automated remote troubleshooting comes in to its own, especially for teams that embrace remote work and Work From Anywhere (WFA).
