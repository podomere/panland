...
layout: research
ip_v4_address: "214.227.8.129"
date: 2022-11-19T16:17:12+00:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like ```214.227.8.129``` or an IPv6 address like ```2000:ff1:eaa4:4ed1:962b:4aa7:c235:7ab7```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```de:37:1d:fa:e1:3e```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://schuppe-cremin.net you initially access a DNS server to translate the host portion (schuppe-cremin) combined with the Top Level Domain (net) of the URL, to an IP address like ```97.133.32.86```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows; U; Win 9x 4.90; SG; rv:1.9.2.4) Gecko/20101104 Netscape/9.1.0285```
...
<pre>
default   fe80:8ed2:42d3:11e2:cddf%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {52.179.117.16, 181.224.191.212}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr de:37:1d:fa:e1:3e
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr b0:03:23:99:8a:28
}</pre>
