...
layout: research
ip_v4_address: "228.79.204.163"
date: 2022-06-12T14:09:24+01:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like ```228.79.204.163``` or an IPv6 address like ```2000:397d:f86b:c3eb:53be:21ae:6f36:9646```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```ea:55:a8:a0:0b:4c```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://stokes-west.com you initially access a DNS server to translate the host portion (stokes-west) combined with the Top Level Domain (com) of the URL, to an IP address like ```75.79.132.245```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_3) AppleWebKit/537.75.14 (KHTML, like Gecko) Version/7.0.3 Safari/7046A194A```
...
<pre>
default   fe80:e7a3:9c20:63a9:5a7a%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {241.37.38.77, 116.119.90.90}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr ea:55:a8:a0:0b:4c
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 5d:f9:3e:14:bc:6b
}</pre>
