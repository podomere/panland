...
layout: research
ip_v4_address: "65.196.12.152"
date: 2022-11-19T16:17:19+00:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like ```65.196.12.152``` or an IPv6 address like ```2000:f42e:d2c3:b963:aedf:863b:48:f749```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```94:2f:56:e6:8d:79```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://roberts.co you initially access a DNS server to translate the host portion (roberts) combined with the Top Level Domain (co) of the URL, to an IP address like ```53.160.10.141```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1; WOW64; Trident/7.0; AS; rv:11.0) like Gecko```
...
<pre>
default   fe80:df58:4e22:6d90:30e3%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {174.233.35.69, 29.145.117.166}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 94:2f:56:e6:8d:79
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr bb:e7:af:f5:30:d0
}</pre>
