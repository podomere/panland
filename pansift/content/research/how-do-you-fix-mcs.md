...
layout: research
ip_v4_address: "112.74.171.146"
date: 2022-06-12T14:09:05+01:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like ```112.74.171.146``` or an IPv6 address like ```2000:8ee2:8438:4c95:ad8c:903f:af57:1e43```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```62:d0:ae:ca:86:a0```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://bergstrom-leffler.name you initially access a DNS server to translate the host portion (bergstrom-leffler) combined with the Top Level Domain (name) of the URL, to an IP address like ```98.12.188.184```. Your computer and browser actually sends its type with all web requests e.g. <br>```Opera/9.80 (X11; Linux i686; Ubuntu/14.10) Presto/2.12.388 Version/12.16```
...
<pre>
default   fe80:c10a:42e3:ab39:6655%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {117.220.237.149, 85.130.40.218}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 62:d0:ae:ca:86:a0
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 68:09:df:36:45:da
}</pre>
