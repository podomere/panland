...
layout: research
ip_v4_address: "244.59.92.63"
date: 2023-10-29T15:13:13+00:00
draft: false
---

## Internet Addressing
On the Internet you may have a Public IPv4 address like ```244.59.92.63``` or an IPv6 address like ```2000:ad63:974c:db09:2302:e87d:348b:3dc9```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```ed:b3:73:9b:37:99```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://shanahan-swaniawski.info you initially access a DNS server to translate the host portion (shanahan-swaniawski) combined with the Top Level Domain (info) of the URL, to an IP address like ```101.175.233.143```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT x.y; Win64; x64; rv:10.0) Gecko/20100101 Firefox/10.0```
...
<pre>
default   fe80:e2f0:6141:c6bc:9036%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {239.92.249.39, 158.98.214.196}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr ed:b3:73:9b:37:99
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 36:00:b1:77:0f:42
}</pre>
