...
layout: research
ip_v4_address: "189.74.156.233"
date: 2022-05-05T14:28:28+01:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like ```189.74.156.233``` or an IPv6 address like ```2000:4ca1:f2d7:e33a:6a99:5a38:1ad3:3999```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```ee:2d:4d:9e:e6:c7```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://botsford-kunze.net you initially access a DNS server to translate the host portion (botsford-kunze) combined with the Top Level Domain (net) of the URL, to an IP address like ```173.4.38.239```. Your computer and browser actually sends its type with all web requests e.g. <br>```Opera/9.80 (X11; Linux i686; Ubuntu/14.10) Presto/2.12.388 Version/12.16```
...
<pre>
default   fe80:181a:ba6b:27b0:31dd%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {170.40.222.146, 165.242.186.219}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr ee:2d:4d:9e:e6:c7
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr a8:e9:fd:dc:87:82
}</pre>
