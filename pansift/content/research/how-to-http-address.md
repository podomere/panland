---
title: "How To Http Address"
subtitle: "Tee It Up?"
layout: research
ip_v4_address: "154.173.32.202"
date: 2023-02-04T17:08:40+00:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like ```154.173.32.202``` or an IPv6 address like ```2000:7f13:ee68:2ea:50d2:9ac0:9af4:397d```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```02:07:3c:2e:86:ce```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://langworth-mertz.co you initially access a DNS server to translate the host portion (langworth-mertz) combined with the Top Level Domain (co) of the URL, to an IP address like ```212.150.228.49```. Your computer and browser actually sends its type with all web requests e.g. <br>```Opera/9.80 (X11; Linux i686; Ubuntu/14.10) Presto/2.12.388 Version/12.16```

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```172.17.71.143``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  172.17.71.143    UGScg  en0
...
<pre>
default   fe80:27ac:1b12:197b:a847%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {5.62.16.42, 11.155.152.17}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 02:07:3c:2e:86:ce
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr a1:db:94:18:2a:82
}</pre>
