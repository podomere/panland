...
subtitle: "Learnings?"
layout: research
ip_v4_address: "137.98.247.59"
date: 2022-11-02T11:32:56+00:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like ```137.98.247.59``` or an IPv6 address like ```2000:4704:8eb:714a:a651:791f:dd70:4d3f```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```7b:01:b4:33:f8:b4```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://nikolaus-waters.info you initially access a DNS server to translate the host portion (nikolaus-waters) combined with the Top Level Domain (info) of the URL, to an IP address like ```94.26.36.151```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows; U; Win 9x 4.90; SG; rv:1.9.2.4) Gecko/20101104 Netscape/9.1.0285```
...
default  192.168.12.38    UGScg  en0
...
<pre>
default   fe80:23b6:2bea:907d:6291%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {251.234.157.173, 33.135.119.14}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 7b:01:b4:33:f8:b4
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 0b:86:9d:a7:30:5b
}</pre>
...
## Apple macOS / OSX
No matter what version of OSX/macOS you are on, ```10.14.5```, ```11.2.7```, or ```12.3.4```, there are a range of tools for troubleshooting. Unfortunately, between these manual actions and scripts, they don't give you a series of correlated values over time. This is where automated remote troubleshooting comes in to its own, especially for teams that embrace remote work and Work From Anywhere (WFA).
