...
subtitle: "Ideate?"
layout: research
ip_v4_address: "177.55.52.215"
date: 2022-12-15T13:50:10+00:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like ```177.55.52.215``` or an IPv6 address like ```2000:b4d5:5a29:39f0:32d1:662:f10a:5569```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```af:ea:f4:81:0a:7a```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://jaskolski.biz you initially access a DNS server to translate the host portion (jaskolski) combined with the Top Level Domain (biz) of the URL, to an IP address like ```56.168.89.112```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1; WOW64; Trident/7.0; AS; rv:11.0) like Gecko```

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```10.115.102.38``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  10.115.102.38    UGScg  en0
...
<pre>
default   fe80:d408:9298:3b43:3121%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {51.114.176.171, 203.184.50.251}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr af:ea:f4:81:0a:7a
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr bf:97:64:8f:de:86
}</pre>
...
## Apple macOS / OSX
No matter what version of OSX/macOS you are on, ```10.11.5```, ```11.5.8```, or ```12.1.2```, there are a range of tools for troubleshooting. Unfortunately, between these manual actions and scripts, they don't give you a series of correlated values over time. This is where automated remote troubleshooting comes in to its own, especially for teams that embrace remote work and Work From Anywhere (WFA).
