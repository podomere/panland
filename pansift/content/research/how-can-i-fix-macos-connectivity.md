...
layout: research
ip_v4_address: "187.36.193.221"
date: 2022-06-04T14:38:27+01:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like ```187.36.193.221``` or an IPv6 address like ```2000:25ac:db40:2bf5:1acf:b53c:7a7b:1e8a```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```4d:e3:79:53:d8:8c```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://reinger-cummings.co you initially access a DNS server to translate the host portion (reinger-cummings) combined with the Top Level Domain (co) of the URL, to an IP address like ```236.196.189.76```. Your computer and browser actually sends its type with all web requests e.g. <br>```Opera/9.80 (X11; Linux i686; Ubuntu/14.10) Presto/2.12.388 Version/12.16```
...
<pre>
default   fe80:252:5278:bb4f:329f%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {84.146.195.78, 121.80.174.72}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 4d:e3:79:53:d8:8c
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr ef:68:9f:96:b8:5a
}</pre>
