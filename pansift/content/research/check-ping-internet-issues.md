...
subtitle: "Streamline?"
layout: research
ip_v4_address: "238.246.63.121"
date: 2022-04-24T19:00:01+01:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like <code>238.246.63.121</code> or an IPv6 address like <code>2000:96e4:a9ea:9c81:f12c:bfb0:c2e:9e57</code>. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>ab:15:64:c3:0f:b3</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://hilll.co you initially access a DNS server to translate the host portion (hilll) combined with the Top Level Domain (co) of the URL, to an IP address like <code>20.150.64.232</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (compatible; MSIE 9.0; AOL 9.7; AOLBuild 4343.19; Windows NT 6.1; WOW64; Trident/5.0; FunWebProducts)</code>
...
<pre><code>
default   fe80:64fb:18d7:540c:7367%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {38.48.29.129, 56.129.46.73}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr ab:15:64:c3:0f:b3
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 6b:b8:ea:2f:b4:d4
}</code></pre>
