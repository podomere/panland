...
layout: research
ip_v4_address: "192.203.171.125"
date: 2023-02-04T17:08:37+00:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like ```192.203.171.125``` or an IPv6 address like ```2000:6905:3742:3dae:239b:acb2:e8db:db9e```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```59:68:b8:fa:77:99```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://sauer-lueilwitz.co you initially access a DNS server to translate the host portion (sauer-lueilwitz) combined with the Top Level Domain (co) of the URL, to an IP address like ```73.191.129.166```. Your computer and browser actually sends its type with all web requests e.g. <br>```Opera/9.80 (X11; Linux i686; Ubuntu/14.10) Presto/2.12.388 Version/12.16```
...
<pre>
default   fe80:40c0:8893:d488:9665%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {15.217.79.114, 136.2.176.134}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 59:68:b8:fa:77:99
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 67:82:ae:89:e0:60
}</pre>
