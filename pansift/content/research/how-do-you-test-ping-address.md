...
layout: research
ip_v4_address: "15.124.234.44"
date: 2022-06-04T14:38:43+01:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like ```15.124.234.44``` or an IPv6 address like ```2000:d45:e70e:3553:9af0:3103:9bdb:813e```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```f2:6b:eb:75:2f:10```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://yost-smitham.biz you initially access a DNS server to translate the host portion (yost-smitham) combined with the Top Level Domain (biz) of the URL, to an IP address like ```82.190.81.77```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1; WOW64; Trident/7.0; AS; rv:11.0) like Gecko```
...
<pre>
default   fe80:5453:84fc:6fc9:2de8%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {154.51.161.44, 51.117.217.42}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr f2:6b:eb:75:2f:10
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 62:22:67:f1:f6:78
}</pre>
