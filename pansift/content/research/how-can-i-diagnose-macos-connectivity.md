...
subtitle: "Swag?"
layout: research
ip_v4_address: "4.101.214.63"
date: 2022-11-19T19:13:16+00:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like ```4.101.214.63``` or an IPv6 address like ```2000:1f16:aed1:db75:61d2:e34b:9bef:16b7```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```86:eb:76:0b:17:35```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://koelpin.io you initially access a DNS server to translate the host portion (koelpin) combined with the Top Level Domain (io) of the URL, to an IP address like ```145.154.30.89```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (compatible; MSIE 9.0; AOL 9.7; AOLBuild 4343.19; Windows NT 6.1; WOW64; Trident/5.0; FunWebProducts)```
...
<pre>
default   fe80:dbb6:f1e5:bca6:5df2%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {228.201.107.209, 60.65.131.222}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 86:eb:76:0b:17:35
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr af:53:e8:4e:04:26
}</pre>
...
## Apple macOS / OSX
No matter what version of OSX/macOS you are on, ```10.12.6```, ```11.3.5```, or ```12.2.5```, there are a range of tools for troubleshooting. Unfortunately, between these manual actions and scripts, they don't give you a series of correlated values over time. This is where automated remote troubleshooting comes in to its own, especially for teams that embrace remote work and Work From Anywhere (WFA).
