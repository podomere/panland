...
subtitle: "Etc. Etc.?"
layout: research
ip_v4_address: "51.246.68.204"
date: 2022-05-05T14:29:25+01:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like ```51.246.68.204``` or an IPv6 address like ```2000:3500:d9b0:b643:7eb:2733:7f76:911d```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```ba:91:f3:a0:25:f2```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://weber-homenick.org you initially access a DNS server to translate the host portion (weber-homenick) combined with the Top Level Domain (org) of the URL, to an IP address like ```91.136.156.15```. Your computer and browser actually sends its type with all web requests e.g. <br>```Opera/9.80 (X11; Linux i686; Ubuntu/14.10) Presto/2.12.388 Version/12.16```
...
<pre>
default   fe80:d6a:eaa4:5c3f:e171%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {227.116.40.235, 165.101.157.97}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr ba:91:f3:a0:25:f2
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 1f:ec:3d:7e:cb:30
}</pre>
