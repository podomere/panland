...
layout: research
ip_v4_address: "137.2.102.52"
date: 2022-11-02T11:32:58+00:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like ```137.2.102.52``` or an IPv6 address like ```2000:c795:597f:5622:15b4:11ce:e6fe:9d7b```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```2f:62:19:c9:82:ed```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://grant-bins.info you initially access a DNS server to translate the host portion (grant-bins) combined with the Top Level Domain (info) of the URL, to an IP address like ```179.229.36.201```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (compatible; MSIE 9.0; AOL 9.7; AOLBuild 4343.19; Windows NT 6.1; WOW64; Trident/5.0; FunWebProducts)```
...
<pre>
default   fe80:cc3e:33c3:bca2:995e%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {76.93.239.54, 132.30.0.67}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 2f:62:19:c9:82:ed
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr a1:70:0c:eb:9d:15
}</pre>
