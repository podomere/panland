...
subtitle: "Granular?"
layout: research
ip_v4_address: "134.255.116.146"
date: 2023-02-04T16:26:10+00:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like ```134.255.116.146``` or an IPv6 address like ```2000:6412:d03a:94e8:f8af:5cd1:cf83:98b6```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```cc:13:1d:bd:72:a4```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://dare-kiehn.biz you initially access a DNS server to translate the host portion (dare-kiehn) combined with the Top Level Domain (biz) of the URL, to an IP address like ```135.66.229.83```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/41.0.2228.0 Safari/537.36```
...
<pre>
default   fe80:f9de:ac71:d639:b4ee%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {104.204.178.71, 165.245.219.61}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr cc:13:1d:bd:72:a4
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 24:41:f9:e7:a6:b2
}</pre>
