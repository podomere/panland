...
layout: research
ip_v4_address: "90.220.215.57"
date: 2023-02-04T16:26:19+00:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like ```90.220.215.57``` or an IPv6 address like ```2000:7f9b:828a:9a72:44e9:99f0:f57e:54e3```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```f1:ef:89:85:29:40```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://considine-moen.info you initially access a DNS server to translate the host portion (considine-moen) combined with the Top Level Domain (info) of the URL, to an IP address like ```231.11.123.177```. Your computer and browser actually sends its type with all web requests e.g. <br>```Opera/9.80 (X11; Linux i686; Ubuntu/14.10) Presto/2.12.388 Version/12.16```
...
<pre>
default   fe80:c4a3:fdee:8d76:886d%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {134.170.199.41, 225.85.203.127}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr f1:ef:89:85:29:40
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr e4:0a:bc:d9:08:41
}</pre>
