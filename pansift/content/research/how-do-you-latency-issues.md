...
subtitle: "Impact Map?"
layout: research
ip_v4_address: "168.94.75.95"
date: 2022-05-05T14:29:41+01:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like ```168.94.75.95``` or an IPv6 address like ```2000:e9:197c:b44e:bd38:bc13:afd0:fbc3```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```59:51:fc:a9:cc:9c```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://jerde-thiel.co you initially access a DNS server to translate the host portion (jerde-thiel) combined with the Top Level Domain (co) of the URL, to an IP address like ```206.205.60.125```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT x.y; Win64; x64; rv:10.0) Gecko/20100101 Firefox/10.0```
...
<pre>
default   fe80:afab:d6a8:5e40:5ff9%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {96.137.188.128, 62.157.28.38}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 59:51:fc:a9:cc:9c
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr c1:69:b3:01:11:81
}</pre>
