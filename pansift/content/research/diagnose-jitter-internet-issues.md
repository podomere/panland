...
subtitle: "Streamline?"
layout: research
ip_v4_address: "238.95.108.56"
date: 2022-06-04T14:38:39+01:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like ```238.95.108.56``` or an IPv6 address like ```2000:39bb:3eec:d64c:34a2:3d68:940c:87b8```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```98:9a:f4:d4:31:99```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://volkman.io you initially access a DNS server to translate the host portion (volkman) combined with the Top Level Domain (io) of the URL, to an IP address like ```253.58.136.18```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows; U; Win 9x 4.90; SG; rv:1.9.2.4) Gecko/20101104 Netscape/9.1.0285```

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```172.30.121.165``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  172.30.121.165    UGScg  en0
...
<pre>
default   fe80:d71b:3567:2952:cd4d%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {137.2.200.123, 89.38.181.69}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 98:9a:f4:d4:31:99
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr ff:a0:36:82:27:1c
}</pre>
