...
subtitle: "Learnings?"
layout: research
ip_v4_address: "6.193.117.196"
date: 2023-02-04T16:26:22+00:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like ```6.193.117.196``` or an IPv6 address like ```2000:4a69:376a:9170:24d:5292:2f18:f048```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```62:e3:8e:b3:bf:1c```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://huels-casper.io you initially access a DNS server to translate the host portion (huels-casper) combined with the Top Level Domain (io) of the URL, to an IP address like ```73.181.236.119```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows; U; Win 9x 4.90; SG; rv:1.9.2.4) Gecko/20101104 Netscape/9.1.0285```

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```172.21.85.105``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  172.21.85.105    UGScg  en0
...
<pre>
default   fe80:942d:78d6:5e60:5411%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {124.54.31.140, 189.63.64.154}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 62:e3:8e:b3:bf:1c
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr db:1f:0f:7b:df:d9
}</pre>
