...
layout: research
ip_v4_address: "255.121.20.88"
date: 2023-10-29T15:13:27+00:00
draft: false
---

## Internet Addressing
On the Internet you may have a Public IPv4 address like ```255.121.20.88``` or an IPv6 address like ```2000:d990:a894:375d:1a72:6add:55f6:c0a4```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```de:49:5e:95:85:90```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://lind-lubowitz.com you initially access a DNS server to translate the host portion (lind-lubowitz) combined with the Top Level Domain (com) of the URL, to an IP address like ```26.18.73.169```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_3) AppleWebKit/537.75.14 (KHTML, like Gecko) Version/7.0.3 Safari/7046A194A```
...
<pre>
default   fe80:1abd:664a:cb53:350c%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {99.8.74.249, 39.49.143.210}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr de:49:5e:95:85:90
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 67:93:24:27:54:64
}</pre>
...
### Apple macOS / OSX
No matter what version of OSX/macOS you are on, ```10.14.4```, ```11.3.2```, or ```12.0.1```, there are a range of tools for troubleshooting. Unfortunately, between these manual actions and scripts, they don't give you a series of correlated values over time. This is where automated remote troubleshooting comes in to its own, especially for teams that embrace remote work and Work From Anywhere (WFA).
