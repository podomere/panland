...
layout: research
ip_v4_address: "48.7.236.240"
date: 2022-04-24T18:31:58+01:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like <code>48.7.236.240</code> or an IPv6 address like <code>2000:11e6:87e2:f2b9:d384:548e:4afe:14ef</code>. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>f0:23:d3:51:d6:4b</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://welch-jacobson.info you initially access a DNS server to translate the host portion (welch-jacobson) combined with the Top Level Domain (info) of the URL, to an IP address like <code>54.8.237.216</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (Windows NT 6.1; WOW64; Trident/7.0; AS; rv:11.0) like Gecko</code>
...
<pre><code>
default   fe80:9afc:7ee5:76af:4641%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {96.165.0.220, 91.31.149.167}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr f0:23:d3:51:d6:4b
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 58:25:68:8f:bd:12
}</code></pre>
