...
layout: research
ip_v4_address: "127.88.115.47"
date: 2022-04-24T19:00:24+01:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like <code>127.88.115.47</code> or an IPv6 address like <code>2000:198:407a:43d1:2683:ad35:dfd:f103</code>. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>aa:0b:fc:92:ec:cd</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://mertz.net you initially access a DNS server to translate the host portion (mertz) combined with the Top Level Domain (net) of the URL, to an IP address like <code>31.115.254.8</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Opera/9.80 (X11; Linux i686; Ubuntu/14.10) Presto/2.12.388 Version/12.16</code>
...
default  172.18.121.208    UGScg  en0
...
<pre><code>
default   fe80:bb6f:ff90:5e0e:eab%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {8.53.73.230, 81.94.198.50}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr aa:0b:fc:92:ec:cd
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 8b:58:aa:7e:61:ce
}</code></pre>
