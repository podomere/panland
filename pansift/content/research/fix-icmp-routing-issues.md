...
layout: research
ip_v4_address: "28.83.21.120"
date: 2022-06-04T14:38:41+01:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like ```28.83.21.120``` or an IPv6 address like ```2000:d336:8bdf:e221:a19d:2e1a:7a97:1466```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```5d:c8:25:52:84:3e```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://corkery.org you initially access a DNS server to translate the host portion (corkery) combined with the Top Level Domain (org) of the URL, to an IP address like ```64.100.34.120```. Your computer and browser actually sends its type with all web requests e.g. <br>```Opera/9.80 (X11; Linux i686; Ubuntu/14.10) Presto/2.12.388 Version/12.16```
...
<pre>
default   fe80:ef0c:695e:4dc5:3607%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {99.98.246.140, 150.20.145.249}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 5d:c8:25:52:84:3e
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 32:90:ad:50:ae:76
}</pre>
