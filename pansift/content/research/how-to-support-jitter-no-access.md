---
title: "How To Support Jitter No-access"
subtitle: "Streamline?"
layout: research
ip_v4_address: "48.211.115.43"
date: 2022-11-19T19:13:25+00:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like ```48.211.115.43``` or an IPv6 address like ```2000:f4c2:c4d1:5494:e962:eb16:adf8:2c1```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```26:61:f2:38:66:37```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://muller-bernier.io you initially access a DNS server to translate the host portion (muller-bernier) combined with the Top Level Domain (io) of the URL, to an IP address like ```82.159.116.216```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/41.0.2228.0 Safari/537.36```

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```192.168.35.237``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  192.168.35.237    UGScg  en0
...
<pre>
default   fe80:22da:a271:7418:9362%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {52.145.89.252, 103.163.17.149}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 26:61:f2:38:66:37
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr d0:80:5d:07:55:b4
}</pre>
