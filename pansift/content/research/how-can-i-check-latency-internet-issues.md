...
layout: research
ip_v4_address: "28.79.209.174"
date: 2023-02-04T16:26:19+00:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like ```28.79.209.174``` or an IPv6 address like ```2000:39f7:2ab:4238:6a12:5573:1693:8a9e```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```10:31:76:cf:cc:97```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://nitzsche-harris.co you initially access a DNS server to translate the host portion (nitzsche-harris) combined with the Top Level Domain (co) of the URL, to an IP address like ```194.219.61.177```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT x.y; Win64; x64; rv:10.0) Gecko/20100101 Firefox/10.0```
...
<pre>
default   fe80:566d:aef:cddc:809f%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {193.50.107.120, 239.69.80.175}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 10:31:76:cf:cc:97
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 8f:fa:b1:17:8b:7f
}</pre>
