...
layout: research
ip_v4_address: "57.141.62.85"
date: 2022-12-15T13:50:17+00:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like ```57.141.62.85``` or an IPv6 address like ```2000:afbe:1c26:b39a:7a82:3c11:925:7aca```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```b6:07:a7:55:a0:e8```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://runolfsdottir-orn.net you initially access a DNS server to translate the host portion (runolfsdottir-orn) combined with the Top Level Domain (net) of the URL, to an IP address like ```118.227.234.164```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_3) AppleWebKit/537.75.14 (KHTML, like Gecko) Version/7.0.3 Safari/7046A194A```
...
<pre>
default   fe80:9f31:2152:5723:d96%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {145.102.216.27, 197.35.119.198}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr b6:07:a7:55:a0:e8
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr f5:dc:34:57:91:cf
}</pre>
