...
layout: research
ip_v4_address: "204.176.122.24"
date: 2022-11-02T11:33:10+00:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like ```204.176.122.24``` or an IPv6 address like ```2000:6269:edfe:5f51:7596:f262:9160:e86c```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```36:6b:18:26:35:61```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://cassin.co you initially access a DNS server to translate the host portion (cassin) combined with the Top Level Domain (co) of the URL, to an IP address like ```107.121.223.74```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (compatible; MSIE 9.0; AOL 9.7; AOLBuild 4343.19; Windows NT 6.1; WOW64; Trident/5.0; FunWebProducts)```

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```192.168.102.156``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  192.168.102.156    UGScg  en0
...
<pre>
default   fe80:c8f1:4eaf:678:8d42%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {8.178.247.5, 194.75.185.222}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 36:6b:18:26:35:61
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr bc:e9:c0:c4:15:88
}</pre>
...
## Apple macOS / OSX
No matter what version of OSX/macOS you are on, ```10.13.9```, ```11.5.6```, or ```12.3.7```, there are a range of tools for troubleshooting. Unfortunately, between these manual actions and scripts, they don't give you a series of correlated values over time. This is where automated remote troubleshooting comes in to its own, especially for teams that embrace remote work and Work From Anywhere (WFA).
