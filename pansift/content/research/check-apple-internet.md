...
layout: research
ip_v4_address: "230.222.112.252"
date: 2023-02-04T17:07:49+00:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like ```230.222.112.252``` or an IPv6 address like ```2000:9b50:a53c:f5cd:cf3f:a12:c54d:4ae9```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```7b:bc:74:a7:f4:7e```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://yundt-emard.com you initially access a DNS server to translate the host portion (yundt-emard) combined with the Top Level Domain (com) of the URL, to an IP address like ```219.221.168.67```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/41.0.2228.0 Safari/537.36```
...
<pre>
default   fe80:b577:d69f:d973:4845%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {195.19.232.234, 68.226.47.58}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 7b:bc:74:a7:f4:7e
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 3a:ce:1c:77:32:33
}</pre>
