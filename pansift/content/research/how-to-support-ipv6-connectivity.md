...
subtitle: "Branding?"
layout: research
ip_v4_address: "98.115.68.193"
date: 2022-04-24T18:59:55+01:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like <code>98.115.68.193</code> or an IPv6 address like <code>2000:99ae:f07c:c028:4966:ccb7:6dff:e7ae</code>. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>52:da:ff:c5:e8:a1</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://green-labadie.co you initially access a DNS server to translate the host portion (green-labadie) combined with the Top Level Domain (co) of the URL, to an IP address like <code>234.32.146.149</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Opera/9.80 (X11; Linux i686; Ubuntu/14.10) Presto/2.12.388 Version/12.16</code>
...
<pre><code>
default   fe80:71f:fd7f:788a:ab2c%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {236.37.251.141, 234.28.79.41}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 52:da:ff:c5:e8:a1
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr ea:e0:f3:9b:b7:e1
}</code></pre>
