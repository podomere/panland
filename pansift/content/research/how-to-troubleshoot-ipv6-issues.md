...
layout: research
ip_v4_address: "228.92.166.202"
date: 2022-06-04T14:38:36+01:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like ```228.92.166.202``` or an IPv6 address like ```2000:fe15:3af1:5fa5:4081:a3bc:1eec:6fa7```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```c0:db:39:7a:7b:c5```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://terry.io you initially access a DNS server to translate the host portion (terry) combined with the Top Level Domain (io) of the URL, to an IP address like ```89.115.8.137```. Your computer and browser actually sends its type with all web requests e.g. <br>```Opera/9.80 (X11; Linux i686; Ubuntu/14.10) Presto/2.12.388 Version/12.16```
...
<pre>
default   fe80:966:9b29:b58e:b794%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {30.195.234.206, 138.248.55.160}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr c0:db:39:7a:7b:c5
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 0d:07:7f:b3:27:28
}</pre>
