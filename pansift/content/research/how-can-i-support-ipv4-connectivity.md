...
layout: research
ip_v4_address: "46.168.11.87"
date: 2023-02-04T17:08:35+00:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like ```46.168.11.87``` or an IPv6 address like ```2000:1a5b:efd9:78c4:a6cc:9e98:955:5425```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```17:36:2d:fe:f1:12```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://morissette-carter.name you initially access a DNS server to translate the host portion (morissette-carter) combined with the Top Level Domain (name) of the URL, to an IP address like ```37.88.206.219```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows; U; Win 9x 4.90; SG; rv:1.9.2.4) Gecko/20101104 Netscape/9.1.0285```
...
<pre>
default   fe80:497d:f981:c1c1:138e%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {243.218.89.200, 207.67.209.25}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 17:36:2d:fe:f1:12
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 36:c0:38:80:52:8a
}</pre>
