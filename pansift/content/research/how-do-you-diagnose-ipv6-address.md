...
layout: research
ip_v4_address: "82.137.122.39"
date: 2022-04-24T18:59:56+01:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like <code>82.137.122.39</code> or an IPv6 address like <code>2000:4d2b:565b:840f:1fef:b42d:6906:611a</code>. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>e2:89:01:d0:6b:05</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://hermann-cassin.net you initially access a DNS server to translate the host portion (hermann-cassin) combined with the Top Level Domain (net) of the URL, to an IP address like <code>101.150.94.181</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (Windows NT 6.1; WOW64; Trident/7.0; AS; rv:11.0) like Gecko</code>
...
<pre><code>
default   fe80:3b6:a14f:ca96:9aa5%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {126.12.206.129, 127.18.199.189}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr e2:89:01:d0:6b:05
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr d0:20:dc:fc:61:76
}</code></pre>
