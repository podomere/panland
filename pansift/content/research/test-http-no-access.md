...
layout: research
ip_v4_address: "61.47.52.70"
date: 2023-02-04T16:26:22+00:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like ```61.47.52.70``` or an IPv6 address like ```2000:5cf3:3cb5:4dda:b5ce:1259:e9af:2125```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```87:02:a8:25:33:e6```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://bayer-beer.info you initially access a DNS server to translate the host portion (bayer-beer) combined with the Top Level Domain (info) of the URL, to an IP address like ```87.74.8.206```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_3) AppleWebKit/537.75.14 (KHTML, like Gecko) Version/7.0.3 Safari/7046A194A```
...
<pre>
default   fe80:562b:f5f3:c6e1:46bc%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {84.101.163.62, 48.191.88.144}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 87:02:a8:25:33:e6
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 73:7b:d6:6b:91:f0
}</pre>
