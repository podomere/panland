...
layout: research
ip_v4_address: "80.152.34.64"
date: 2022-06-12T14:09:29+01:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like ```80.152.34.64``` or an IPv6 address like ```2000:2d0f:8dc2:35e9:4866:546a:c36c:1a68```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```52:71:f6:a7:e0:d7```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://morar-grady.biz you initially access a DNS server to translate the host portion (morar-grady) combined with the Top Level Domain (biz) of the URL, to an IP address like ```122.224.106.43```. Your computer and browser actually sends its type with all web requests e.g. <br>```Opera/9.80 (X11; Linux i686; Ubuntu/14.10) Presto/2.12.388 Version/12.16```
...
<pre>
default   fe80:1fd6:ed2d:26d3:cc30%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {108.20.154.183, 57.56.197.97}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 52:71:f6:a7:e0:d7
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr b2:99:b2:97:f4:54
}</pre>
