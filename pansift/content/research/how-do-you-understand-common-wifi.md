...
subtitle: "Learnings?"
layout: research
ip_v4_address: "4.47.185.8"
date: 2023-02-04T16:26:03+00:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like ```4.47.185.8``` or an IPv6 address like ```2000:c455:f2e:8cfe:6cac:6ece:ebe:eb8f```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```b3:d7:b0:2a:0d:ff```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://russel-brekke.biz you initially access a DNS server to translate the host portion (russel-brekke) combined with the Top Level Domain (biz) of the URL, to an IP address like ```216.108.188.233```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows; U; Win 9x 4.90; SG; rv:1.9.2.4) Gecko/20101104 Netscape/9.1.0285```
...
<pre>
default   fe80:1c7:af89:1939:5461%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {19.39.144.9, 94.241.213.238}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr b3:d7:b0:2a:0d:ff
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 5d:75:0a:6c:44:04
}</pre>
