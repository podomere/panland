...
layout: research
ip_v4_address: "170.219.227.2"
date: 2022-11-19T16:17:20+00:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like ```170.219.227.2``` or an IPv6 address like ```2000:f63a:8c9c:bb1a:d4e5:8ea:f8de:f709```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```01:47:1e:35:6b:1b```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://wilderman-zemlak.co you initially access a DNS server to translate the host portion (wilderman-zemlak) combined with the Top Level Domain (co) of the URL, to an IP address like ```120.2.176.130```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT x.y; Win64; x64; rv:10.0) Gecko/20100101 Firefox/10.0```
...
<pre>
default   fe80:7501:1e83:3109:4dd2%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {91.204.205.170, 24.143.217.170}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 01:47:1e:35:6b:1b
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr e7:9b:34:e1:f1:0b
}</pre>
