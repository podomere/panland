...
layout: research
ip_v4_address: "24.125.141.211"
date: 2023-10-29T15:13:12+00:00
draft: false
---

## Internet Addressing
On the Internet you might get a Public IPv4 address like ```24.125.141.211``` or an IPv6 address like ```2000:d62e:a8b1:2cd6:dc1a:e4bb:8a9c:8fef```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```7c:30:74:7a:f8:f1```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://lakin-johnson.name you initially access a DNS server to translate the host portion (lakin-johnson) combined with the Top Level Domain (name) of the URL, to an IP address like ```150.17.16.143```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_3) AppleWebKit/537.75.14 (KHTML, like Gecko) Version/7.0.3 Safari/7046A194A```
...
<pre>
default   fe80:478:7bb0:f159:539e%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {19.178.196.22, 141.4.52.37}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 7c:30:74:7a:f8:f1
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 14:8d:ae:6a:dc:5a
}</pre>
