...
subtitle: "Tee It Up?"
layout: research
ip_v4_address: "102.238.66.202"
date: 2022-04-24T19:00:06+01:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like <code>102.238.66.202</code> or an IPv6 address like <code>2000:be29:4401:f1d:4319:280c:1b3c:b493</code>. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>e3:12:89:a0:d7:21</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://lakin-mueller.com you initially access a DNS server to translate the host portion (lakin-mueller) combined with the Top Level Domain (com) of the URL, to an IP address like <code>82.100.11.117</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_3) AppleWebKit/537.75.14 (KHTML, like Gecko) Version/7.0.3 Safari/7046A194A</code>
...
<pre><code>
default   fe80:a90:abc9:c6b3:f284%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {226.36.124.133, 175.167.55.88}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr e3:12:89:a0:d7:21
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr e3:86:5c:80:20:9b
}</code></pre>
