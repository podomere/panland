---
title: "How To Check Mcs No Access"
subtitle: "Learnings?"
layout: research
ip_v4_address: "217.90.153.247"
date: 2022-11-19T16:17:06+00:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like ```217.90.153.247``` or an IPv6 address like ```2000:42a0:1686:c5c8:8b57:a82e:99f9:5da0```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```e4:06:fc:69:cc:f2```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://waelchi-weber.net you initially access a DNS server to translate the host portion (waelchi-weber) combined with the Top Level Domain (net) of the URL, to an IP address like ```166.246.66.14```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT x.y; Win64; x64; rv:10.0) Gecko/20100101 Firefox/10.0```

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```10.220.89.206``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  10.220.89.206    UGScg  en0
...
<pre>
default   fe80:904a:9146:281d:d9df%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {22.77.32.76, 174.134.29.102}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr e4:06:fc:69:cc:f2
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 2c:f7:d7:d1:5c:6d
}</pre>
