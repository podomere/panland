...
subtitle: "Ideate?"
layout: research
ip_v4_address: "255.244.55.74"
date: 2022-06-12T14:09:05+01:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like ```255.244.55.74``` or an IPv6 address like ```2000:b4c0:348a:1c09:cb7d:1dbe:4556:7ae4```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```24:95:d4:68:d3:ec```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://pollich-dach.co you initially access a DNS server to translate the host portion (pollich-dach) combined with the Top Level Domain (co) of the URL, to an IP address like ```151.131.86.254```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/41.0.2228.0 Safari/537.36```
...
<pre>
default   fe80:1e18:745d:a436:10ef%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {154.135.93.13, 51.172.0.215}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 24:95:d4:68:d3:ec
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 02:fb:33:03:37:56
}</pre>
