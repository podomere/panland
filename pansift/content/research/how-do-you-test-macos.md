...
layout: research
ip_v4_address: "24.160.228.195"
date: 2022-11-02T11:33:10+00:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like ```24.160.228.195``` or an IPv6 address like ```2000:24bb:3eca:234b:f2f4:e847:dde3:badf```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```8b:5c:da:6a:52:cb```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://little-okon.net you initially access a DNS server to translate the host portion (little-okon) combined with the Top Level Domain (net) of the URL, to an IP address like ```111.103.240.164```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows; U; Win 9x 4.90; SG; rv:1.9.2.4) Gecko/20101104 Netscape/9.1.0285```
...
<pre>
default   fe80:9a40:da9d:3ff0:e7fb%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {166.232.10.16, 32.42.253.200}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 8b:5c:da:6a:52:cb
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr ca:ec:25:4a:00:b3
}</pre>
