...
layout: research
ip_v4_address: "35.206.26.123"
date: 2022-11-19T19:13:24+00:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like ```35.206.26.123``` or an IPv6 address like ```2000:12d5:acb6:af94:be90:daf7:a94:929c```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```66:3d:a9:79:db:ac```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://runte.io you initially access a DNS server to translate the host portion (runte) combined with the Top Level Domain (io) of the URL, to an IP address like ```178.44.47.158```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT x.y; Win64; x64; rv:10.0) Gecko/20100101 Firefox/10.0```
...
<pre>
default   fe80:c2b4:8:1bd8:7c92%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {53.120.208.216, 82.217.139.97}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 66:3d:a9:79:db:ac
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr ed:57:0a:46:32:f4
}</pre>
