...
subtitle: "Tee It Up?"
layout: research
ip_v4_address: "56.115.113.105"
date: 2022-11-02T11:32:58+00:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like ```56.115.113.105``` or an IPv6 address like ```2000:5e49:3538:492f:899b:261f:bd9a:ecb6```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```07:e6:d4:13:23:fe```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://mills-schinner.name you initially access a DNS server to translate the host portion (mills-schinner) combined with the Top Level Domain (name) of the URL, to an IP address like ```166.17.43.214```. Your computer and browser actually sends its type with all web requests e.g. <br>```Opera/9.80 (X11; Linux i686; Ubuntu/14.10) Presto/2.12.388 Version/12.16```
...
<pre>
default   fe80:e15f:77d1:5685:dd72%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {224.181.77.222, 238.130.195.9}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 07:e6:d4:13:23:fe
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 00:ea:96:79:18:44
}</pre>
