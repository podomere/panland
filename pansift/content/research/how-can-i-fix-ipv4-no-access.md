...
subtitle: "Granular?"
layout: research
ip_v4_address: "177.219.147.255"
date: 2022-11-19T19:13:24+00:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like ```177.219.147.255``` or an IPv6 address like ```2000:4202:214f:10e8:b265:b9ee:3c67:56e8```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```71:7d:30:2d:0b:0d```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://purdy.io you initially access a DNS server to translate the host portion (purdy) combined with the Top Level Domain (io) of the URL, to an IP address like ```215.249.38.122```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/41.0.2228.0 Safari/537.36```
...
<pre>
default   fe80:2e2c:7ecb:6aa:1333%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {191.181.156.241, 4.17.106.52}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 71:7d:30:2d:0b:0d
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 94:5e:58:4f:43:d8
}</pre>
