...
subtitle: "Deep Dive?"
layout: research
ip_v4_address: "126.140.188.224"
date: 2023-02-04T17:07:48+00:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like ```126.140.188.224``` or an IPv6 address like ```2000:c0f3:6c1f:95d:b49a:7835:ca5:1384```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```12:b4:76:1e:ef:db```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://ferry-jerde.org you initially access a DNS server to translate the host portion (ferry-jerde) combined with the Top Level Domain (org) of the URL, to an IP address like ```141.16.104.190```. Your computer and browser actually sends its type with all web requests e.g. <br>```Opera/9.80 (X11; Linux i686; Ubuntu/14.10) Presto/2.12.388 Version/12.16```
...
<pre>
default   fe80:3ac:30:faae:6e19%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {102.205.49.17, 8.58.164.107}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 12:b4:76:1e:ef:db
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr d2:5b:39:e1:26:f8
}</pre>
