...
layout: research
ip_v4_address: "0.189.217.151"
date: 2023-10-29T15:13:18+00:00
draft: false
---

## Internet Addressing
On the Internet you may have a Public IPv4 address like ```0.189.217.151``` or an IPv6 address like ```2000:1e78:a9ef:f9ed:4c99:f06b:8ba6:20f1```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```94:d7:10:f5:e2:e9```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://padberg-stoltenberg.com you initially access a DNS server to translate the host portion (padberg-stoltenberg) combined with the Top Level Domain (com) of the URL, to an IP address like ```235.117.247.172```. Your computer and browser actually sends its type with all web requests e.g. <br>```Opera/9.80 (X11; Linux i686; Ubuntu/14.10) Presto/2.12.388 Version/12.16```
...
<pre>
default   fe80:eae:5fb3:c2c5:bbbd%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {174.230.230.141, 212.11.187.104}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 94:d7:10:f5:e2:e9
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 6a:48:5d:93:40:f1
}</pre>
...
### Apple macOS / OSX
No matter what version of OSX/macOS you are on, ```10.11.1```, ```11.4.2```, or ```12.3.6```, there are a range of tools for troubleshooting. Unfortunately, between these manual actions and scripts, they don't give you a series of correlated values over time. This is where automated remote troubleshooting comes in to its own, especially for teams that embrace remote work and Work From Anywhere (WFA).
