...
layout: research
ip_v4_address: "184.86.142.214"
date: 2022-04-24T18:31:57+01:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like <code>184.86.142.214</code> or an IPv6 address like <code>2000:a26f:486:cef8:661c:9ac:9c4b:d5b9</code>. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>e3:17:d9:cc:9f:1a</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://hilpert-jast.name you initially access a DNS server to translate the host portion (hilpert-jast) combined with the Top Level Domain (name) of the URL, to an IP address like <code>251.100.130.19</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (Windows NT 6.1; WOW64; Trident/7.0; AS; rv:11.0) like Gecko</code>

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like <code>172.29.100.26</code> (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For <code>IPv6</code> we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  172.29.100.26    UGScg  en0
...
<pre><code>
default   fe80:7ed8:30fa:eacd:7e71%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {249.202.188.97, 31.66.121.34}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr e3:17:d9:cc:9f:1a
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr af:5c:d8:c0:65:44
}</code></pre>
