...
subtitle: "Learnings?"
layout: research
ip_v4_address: "68.91.119.42"
date: 2022-05-05T14:28:26+01:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like ```68.91.119.42``` or an IPv6 address like ```2000:a496:a98b:5f73:ab2d:1989:c34e:b8cc```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```8d:3b:e4:7e:08:db```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://waters-smith.name you initially access a DNS server to translate the host portion (waters-smith) combined with the Top Level Domain (name) of the URL, to an IP address like ```145.250.56.41```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1; WOW64; Trident/7.0; AS; rv:11.0) like Gecko```
...
<pre>
default   fe80:4d7d:56b0:957b:c62f%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {219.201.15.231, 149.91.172.18}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 8d:3b:e4:7e:08:db
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr c4:9e:5b:1a:71:8d
}</pre>
