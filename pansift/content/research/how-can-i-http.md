...
subtitle: "Impact Map?"
layout: research
ip_v4_address: "19.248.29.97"
date: 2023-10-06T17:11:08+01:00
draft: false
---

## Internet Addressing
On the Internet you might have a Public IPv4 address like ```19.248.29.97``` or an IPv6 address like ```2000:cf6:2110:46d3:945c:5d93:c944:71f5```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```01:1d:fd:34:25:4f```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://lakin-sauer.io you initially access a DNS server to translate the host portion (lakin-sauer) combined with the Top Level Domain (io) of the URL, to an IP address like ```67.69.20.45```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (compatible; MSIE 9.0; AOL 9.7; AOLBuild 4343.19; Windows NT 6.1; WOW64; Trident/5.0; FunWebProducts)```
...
<pre>
default   fe80:17ec:176d:faa8:778a%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {235.176.206.251, 176.189.48.11}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 01:1d:fd:34:25:4f
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 57:14:bb:f5:e0:95
}</pre>
