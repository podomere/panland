...
layout: research
ip_v4_address: "204.56.108.62"
date: 2023-10-29T15:13:27+00:00
draft: false
---

## Internet Addressing
On the Internet you might get a Public IPv4 address like ```204.56.108.62``` or an IPv6 address like ```2000:9c86:aa85:2256:c3ff:e039:5eea:3b06```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```8a:5a:af:81:bf:d4```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://schroeder.name you initially access a DNS server to translate the host portion (schroeder) combined with the Top Level Domain (name) of the URL, to an IP address like ```95.41.24.222```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows; U; Win 9x 4.90; SG; rv:1.9.2.4) Gecko/20101104 Netscape/9.1.0285```
...
<pre>
default   fe80:a0ef:bd01:95f0:909%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {0.11.139.112, 39.157.73.30}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 8a:5a:af:81:bf:d4
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 0c:bc:12:2d:84:31
}</pre>
