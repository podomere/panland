...
subtitle: "Granular?"
layout: research
ip_v4_address: "250.105.158.76"
date: 2022-04-24T18:31:58+01:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like <code>250.105.158.76</code> or an IPv6 address like <code>2000:e853:ae3e:3ace:73e7:e705:9c94:ed3e</code>. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>6d:f0:bb:9b:d1:67</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://predovic-botsford.org you initially access a DNS server to translate the host portion (predovic-botsford) combined with the Top Level Domain (org) of the URL, to an IP address like <code>92.210.171.61</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (Windows; U; Win 9x 4.90; SG; rv:1.9.2.4) Gecko/20101104 Netscape/9.1.0285</code>
...
<pre><code>
default   fe80:4ef0:fce1:ce69:8bf5%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {163.117.181.145, 98.167.167.82}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 6d:f0:bb:9b:d1:67
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr dd:c9:55:bf:26:33
}</code></pre>
