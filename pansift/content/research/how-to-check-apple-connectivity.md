...
layout: research
ip_v4_address: "226.97.217.249"
date: 2022-04-24T19:00:24+01:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like <code>226.97.217.249</code> or an IPv6 address like <code>2000:55ff:5776:cc8b:3477:196d:446c:9d0</code>. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>c9:04:7d:3d:a8:27</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://kautzer-rice.io you initially access a DNS server to translate the host portion (kautzer-rice) combined with the Top Level Domain (io) of the URL, to an IP address like <code>125.173.112.183</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Opera/9.80 (X11; Linux i686; Ubuntu/14.10) Presto/2.12.388 Version/12.16</code>
...
<pre><code>
default   fe80:68f1:b07e:6698:f498%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {53.44.77.82, 91.173.214.1}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr c9:04:7d:3d:a8:27
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr fa:cc:fb:cc:3d:99
}</code></pre>
