...
layout: research
ip_v4_address: "48.111.173.226"
date: 2022-04-24T19:00:24+01:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like <code>48.111.173.226</code> or an IPv6 address like <code>2000:ef55:25f7:3252:613a:af40:26c3:6823</code>. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>72:4e:b1:54:fb:ab</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://haley-kertzmann.org you initially access a DNS server to translate the host portion (haley-kertzmann) combined with the Top Level Domain (org) of the URL, to an IP address like <code>143.41.160.10</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (compatible; MSIE 9.0; AOL 9.7; AOLBuild 4343.19; Windows NT 6.1; WOW64; Trident/5.0; FunWebProducts)</code>
...
default  172.17.183.223    UGScg  en0
...
<pre><code>
default   fe80:af1c:23f:8f71:5175%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {55.185.17.117, 70.9.118.213}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 72:4e:b1:54:fb:ab
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 34:cd:b0:19:04:46
}</code></pre>
