...
layout: research
ip_v4_address: "216.0.224.101"
date: 2023-10-06T17:11:07+01:00
draft: false
---

## Internet Addressing
On the Internet you might get a Public IPv4 address like ```216.0.224.101``` or an IPv6 address like ```2000:81bb:55b9:dc05:1506:ffb0:7c88:b4ba```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```84:ce:57:12:f8:ff```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://gutkowski-weimann.biz you initially access a DNS server to translate the host portion (gutkowski-weimann) combined with the Top Level Domain (biz) of the URL, to an IP address like ```57.53.134.109```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1; WOW64; Trident/7.0; AS; rv:11.0) like Gecko```
...
<pre>
default   fe80:e05a:9c74:fcc0:c17b%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {132.65.92.194, 19.88.170.35}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 84:ce:57:12:f8:ff
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 44:28:5c:82:35:8c
}</pre>
