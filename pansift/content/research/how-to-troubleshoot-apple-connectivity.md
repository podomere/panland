...
subtitle: "Heads Down?"
layout: research
ip_v4_address: "0.236.114.55"
date: 2022-04-24T18:31:58+01:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like <code>0.236.114.55</code> or an IPv6 address like <code>2000:c591:d61b:853b:c122:6f23:cc6b:9f47</code>. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>fa:e6:a0:1a:5f:fa</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://kihn-harber.name you initially access a DNS server to translate the host portion (kihn-harber) combined with the Top Level Domain (name) of the URL, to an IP address like <code>5.197.87.170</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (Windows NT x.y; Win64; x64; rv:10.0) Gecko/20100101 Firefox/10.0</code>

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like <code>192.168.108.206</code> (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For <code>IPv6</code> we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  192.168.108.206    UGScg  en0
...
<pre><code>
default   fe80:ce28:41b5:4b67:b2cd%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {226.67.190.83, 204.87.102.237}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr fa:e6:a0:1a:5f:fa
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 8e:3b:00:ab:44:04
}</code></pre>
