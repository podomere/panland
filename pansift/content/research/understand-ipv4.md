...
layout: research
ip_v4_address: "149.221.153.105"
date: 2022-05-05T14:29:31+01:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like ```149.221.153.105``` or an IPv6 address like ```2000:f428:dd86:7089:5cee:f97d:77e2:8ecf```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```be:a8:0e:2d:ed:b8```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://cruickshank-quitzon.net you initially access a DNS server to translate the host portion (cruickshank-quitzon) combined with the Top Level Domain (net) of the URL, to an IP address like ```159.145.22.0```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_3) AppleWebKit/537.75.14 (KHTML, like Gecko) Version/7.0.3 Safari/7046A194A```
...
<pre>
default   fe80:a2dc:26:95fc:e790%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {247.186.18.217, 116.93.62.189}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr be:a8:0e:2d:ed:b8
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 60:be:f3:1f:4a:bf
}</pre>
