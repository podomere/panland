...
layout: research
ip_v4_address: "94.145.103.132"
date: 2023-10-29T15:13:27+00:00
draft: false
---

## Internet Addressing
On the Internet you may get a Public IPv4 address like ```94.145.103.132``` or an IPv6 address like ```2000:b7cf:d5de:abc8:266b:2718:90e5:5312```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```20:c7:42:13:c5:71```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://ledner.com you initially access a DNS server to translate the host portion (ledner) combined with the Top Level Domain (com) of the URL, to an IP address like ```71.188.216.85```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows; U; Win 9x 4.90; SG; rv:1.9.2.4) Gecko/20101104 Netscape/9.1.0285```

## Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```172.26.206.129``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  172.26.206.129    UGScg  en0
...
<pre>
default   fe80:d3cc:46f4:74a3:8e0d%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {26.24.154.199, 197.30.93.100}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 20:c7:42:13:c5:71
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr e6:c4:ce:22:24:39
}</pre>
