...
layout: research
ip_v4_address: "84.239.109.225"
date: 2023-02-04T17:07:49+00:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like ```84.239.109.225``` or an IPv6 address like ```2000:86de:5f5c:f660:1a51:3e27:9b1c:8a76```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```15:7c:f7:e9:b3:8a```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://gutmann-baumbach.name you initially access a DNS server to translate the host portion (gutmann-baumbach) combined with the Top Level Domain (name) of the URL, to an IP address like ```28.11.68.222```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT x.y; Win64; x64; rv:10.0) Gecko/20100101 Firefox/10.0```
...
<pre>
default   fe80:dd9e:c8e7:bdeb:b486%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {153.151.175.1, 53.246.54.201}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 15:7c:f7:e9:b3:8a
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 12:26:90:cf:c4:2c
}</pre>
