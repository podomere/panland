...
layout: research
ip_v4_address: "192.19.21.150"
date: 2022-06-04T14:38:37+01:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like ```192.19.21.150``` or an IPv6 address like ```2000:1645:69eb:291f:3728:b23e:b03d:fd79```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```21:76:8a:5d:26:48```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://hayes-upton.co you initially access a DNS server to translate the host portion (hayes-upton) combined with the Top Level Domain (co) of the URL, to an IP address like ```74.64.208.223```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows; U; Win 9x 4.90; SG; rv:1.9.2.4) Gecko/20101104 Netscape/9.1.0285```
...
<pre>
default   fe80:d125:7e3b:2921:2df0%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {71.190.148.27, 134.241.212.54}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 21:76:8a:5d:26:48
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 1b:bd:d4:4a:30:32
}</pre>
