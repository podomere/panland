...
layout: research
ip_v4_address: "184.2.81.3"
date: 2022-11-19T16:17:12+00:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like ```184.2.81.3``` or an IPv6 address like ```2000:d4dd:bd08:b147:e9fa:1b9e:d453:1b9```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```51:0b:09:18:b2:9b```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://rutherford-lubowitz.org you initially access a DNS server to translate the host portion (rutherford-lubowitz) combined with the Top Level Domain (org) of the URL, to an IP address like ```225.205.204.249```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1; WOW64; Trident/7.0; AS; rv:11.0) like Gecko```
...
<pre>
default   fe80:397e:a48:9f4d:e921%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {73.187.197.214, 249.239.96.117}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 51:0b:09:18:b2:9b
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 96:34:a9:66:c3:12
}</pre>
