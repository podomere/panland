...
layout: research
ip_v4_address: "94.114.23.115"
date: 2022-11-19T19:13:24+00:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like ```94.114.23.115``` or an IPv6 address like ```2000:5732:6a56:da1f:c9b4:d425:a04f:fb42```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```85:f5:71:b1:63:07```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://klocko.biz you initially access a DNS server to translate the host portion (klocko) combined with the Top Level Domain (biz) of the URL, to an IP address like ```254.45.24.233```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/41.0.2228.0 Safari/537.36```

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```10.24.28.121``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  10.24.28.121    UGScg  en0
...
<pre>
default   fe80:2b68:f9ff:d43b:a673%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {248.135.172.47, 17.24.176.180}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 85:f5:71:b1:63:07
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr f0:ee:ca:dd:94:e0
}</pre>
...
## Apple macOS / OSX
No matter what version of OSX/macOS you are on, ```10.13.9```, ```11.1.5```, or ```12.1.8```, there are a range of tools for troubleshooting. Unfortunately, between these manual actions and scripts, they don't give you a series of correlated values over time. This is where automated remote troubleshooting comes in to its own, especially for teams that embrace remote work and Work From Anywhere (WFA).
