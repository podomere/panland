...
subtitle: "Swag?"
layout: research
ip_v4_address: "25.253.147.121"
date: 2022-04-24T18:59:56+01:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like <code>25.253.147.121</code> or an IPv6 address like <code>2000:e9af:744:e405:ccbd:9a88:167d:d4fb</code>. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>ad:dc:0e:f2:aa:a7</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://braun.org you initially access a DNS server to translate the host portion (braun) combined with the Top Level Domain (org) of the URL, to an IP address like <code>58.246.87.54</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (Windows NT 6.1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/41.0.2228.0 Safari/537.36</code>
...
default  172.30.111.56    UGScg  en0
...
<pre><code>
default   fe80:752b:dde8:cdb0:663%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {190.96.80.76, 255.140.208.140}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr ad:dc:0e:f2:aa:a7
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 12:f3:da:ca:15:7d
}</code></pre>
