...
layout: research
ip_v4_address: "59.192.106.77"
date: 2022-04-24T19:00:00+01:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like <code>59.192.106.77</code> or an IPv6 address like <code>2000:f5e1:201:b8e:544a:530f:87d4:cce3</code>. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>4f:00:4e:e0:23:f9</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://corkery.org you initially access a DNS server to translate the host portion (corkery) combined with the Top Level Domain (org) of the URL, to an IP address like <code>6.79.82.13</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Opera/9.80 (X11; Linux i686; Ubuntu/14.10) Presto/2.12.388 Version/12.16</code>

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like <code>10.10.232.46</code> (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For <code>IPv6</code> we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  10.10.232.46    UGScg  en0
...
<pre><code>
default   fe80:6a78:12e2:f073:2254%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {26.15.246.48, 28.93.82.122}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 4f:00:4e:e0:23:f9
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr cb:70:92:22:6c:7b
}</code></pre>
