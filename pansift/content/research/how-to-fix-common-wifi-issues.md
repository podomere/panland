...
layout: research
ip_v4_address: "193.242.205.6"
date: 2023-02-04T17:07:42+00:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like ```193.242.205.6``` or an IPv6 address like ```2000:e377:35cf:eac9:d4f5:ed4e:870b:165c```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```ec:ad:42:4a:ac:ea```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://lueilwitz.io you initially access a DNS server to translate the host portion (lueilwitz) combined with the Top Level Domain (io) of the URL, to an IP address like ```194.81.97.99```. Your computer and browser actually sends its type with all web requests e.g. <br>```Opera/9.80 (X11; Linux i686; Ubuntu/14.10) Presto/2.12.388 Version/12.16```
...
<pre>
default   fe80:50e4:491d:194:b71c%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {206.200.28.113, 114.133.210.232}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr ec:ad:42:4a:ac:ea
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr dc:e0:09:92:26:4c
}</pre>
