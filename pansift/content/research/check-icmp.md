...
layout: research
ip_v4_address: "97.233.76.209"
date: 2022-11-19T16:17:22+00:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like ```97.233.76.209``` or an IPv6 address like ```2000:bafc:824d:f24d:c573:5c56:b387:3b6e```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```df:ca:d5:ac:03:f3```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://nicolas-walsh.info you initially access a DNS server to translate the host portion (nicolas-walsh) combined with the Top Level Domain (info) of the URL, to an IP address like ```241.235.216.212```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_3) AppleWebKit/537.75.14 (KHTML, like Gecko) Version/7.0.3 Safari/7046A194A```
...
<pre>
default   fe80:9e2f:877c:ed00:b645%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {31.147.61.183, 238.164.244.4}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr df:ca:d5:ac:03:f3
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 23:27:8e:c5:01:77
}</pre>
