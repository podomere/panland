...
subtitle: "Impact Map?"
layout: research
ip_v4_address: "33.198.56.84"
date: 2022-11-19T16:17:24+00:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like ```33.198.56.84``` or an IPv6 address like ```2000:a1bd:2a13:28b0:7a32:1f4d:4294:3a2e```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```7b:a2:05:37:20:ba```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://greenfelder.info you initially access a DNS server to translate the host portion (greenfelder) combined with the Top Level Domain (info) of the URL, to an IP address like ```100.56.203.55```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT x.y; Win64; x64; rv:10.0) Gecko/20100101 Firefox/10.0```
...
<pre>
default   fe80:8a5:4c95:5d68:8da4%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {106.159.124.76, 223.213.93.180}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 7b:a2:05:37:20:ba
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 67:ab:0b:de:1a:09
}</pre>
...
## Apple macOS / OSX
No matter what version of OSX/macOS you are on, ```10.12.4```, ```11.1.1```, or ```12.1.4```, there are a range of tools for troubleshooting. Unfortunately, between these manual actions and scripts, they don't give you a series of correlated values over time. This is where automated remote troubleshooting comes in to its own, especially for teams that embrace remote work and Work From Anywhere (WFA).
