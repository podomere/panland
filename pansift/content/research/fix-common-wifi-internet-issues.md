...
layout: research
ip_v4_address: "168.119.36.153"
date: 2023-02-04T17:07:42+00:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like ```168.119.36.153``` or an IPv6 address like ```2000:835b:10:2654:3962:fbea:f5d2:df54```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```d8:a8:a1:31:a0:df```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://lynch-ankunding.net you initially access a DNS server to translate the host portion (lynch-ankunding) combined with the Top Level Domain (net) of the URL, to an IP address like ```98.134.152.124```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1; WOW64; Trident/7.0; AS; rv:11.0) like Gecko```
...
<pre>
default   fe80:8f08:329b:dd74:4d8d%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {173.215.111.55, 156.251.49.226}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr d8:a8:a1:31:a0:df
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 11:61:cb:e0:2b:84
}</pre>
