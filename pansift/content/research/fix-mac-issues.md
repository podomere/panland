...
layout: research
ip_v4_address: "182.200.252.6"
date: 2023-10-06T17:10:43+01:00
draft: false
---

## Internet Addressing
On the Internet you might get a Public IPv4 address like ```182.200.252.6``` or an IPv6 address like ```2000:422c:98f7:eaa8:352:acc0:f0c5:a0ab```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```48:79:4c:e1:33:92```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://hermiston-lindgren.org you initially access a DNS server to translate the host portion (hermiston-lindgren) combined with the Top Level Domain (org) of the URL, to an IP address like ```97.132.53.174```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_3) AppleWebKit/537.75.14 (KHTML, like Gecko) Version/7.0.3 Safari/7046A194A```

## Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```192.168.60.84``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  192.168.60.84    UGScg  en0
...
<pre>
default   fe80:e3b5:ed4f:51bb:80d2%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {17.97.167.221, 105.124.64.139}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 48:79:4c:e1:33:92
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 52:6d:85:3f:c9:da
}</pre>
