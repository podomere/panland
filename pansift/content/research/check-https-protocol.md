...
subtitle: "Ideate?"
layout: research
ip_v4_address: "100.208.114.246"
date: 2023-02-04T16:26:23+00:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like ```100.208.114.246``` or an IPv6 address like ```2000:975e:e13:d4a8:efe3:a939:9700:a70```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```79:15:99:c9:78:02```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://torp.com you initially access a DNS server to translate the host portion (torp) combined with the Top Level Domain (com) of the URL, to an IP address like ```117.76.249.137```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_3) AppleWebKit/537.75.14 (KHTML, like Gecko) Version/7.0.3 Safari/7046A194A```

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```192.168.225.222``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  192.168.225.222    UGScg  en0
...
<pre>
default   fe80:9794:84d2:8dd0:c5c5%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {133.5.51.56, 109.246.233.94}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 79:15:99:c9:78:02
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 5d:00:36:df:e2:fe
}</pre>
