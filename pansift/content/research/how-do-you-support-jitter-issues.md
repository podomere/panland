...
layout: research
ip_v4_address: "125.3.151.253"
date: 2022-11-02T11:32:57+00:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like ```125.3.151.253``` or an IPv6 address like ```2000:7e91:d6de:f4ce:d332:1ae8:ff17:c02c```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```5e:53:98:2e:38:7d```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://rempel-kuhn.io you initially access a DNS server to translate the host portion (rempel-kuhn) combined with the Top Level Domain (io) of the URL, to an IP address like ```33.76.20.220```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT x.y; Win64; x64; rv:10.0) Gecko/20100101 Firefox/10.0```
...
default  172.19.106.247    UGScg  en0
...
<pre>
default   fe80:5d8c:16f6:be51:fb86%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {86.222.8.9, 153.82.224.99}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 5e:53:98:2e:38:7d
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr c9:82:1f:b4:f9:93
}</pre>
...
## Apple macOS / OSX
No matter what version of OSX/macOS you are on, ```10.12.7```, ```11.4.9```, or ```12.3.4```, there are a range of tools for troubleshooting. Unfortunately, between these manual actions and scripts, they don't give you a series of correlated values over time. This is where automated remote troubleshooting comes in to its own, especially for teams that embrace remote work and Work From Anywhere (WFA).
