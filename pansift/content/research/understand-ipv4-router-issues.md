---
title: "Understand IPv4 Router Issues"
subtitle: "Sprint To The Finish Line?"
layout: research
ip_v4_address: "187.6.112.152"
date: 2022-12-15T13:50:17+00:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like ```187.6.112.152``` or an IPv6 address like ```2000:62b:592c:1ef5:497e:ccf1:9774:f50```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```3a:e0:09:ea:e7:ff```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://emard.name you initially access a DNS server to translate the host portion (emard) combined with the Top Level Domain (name) of the URL, to an IP address like ```198.56.75.198```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (compatible; MSIE 9.0; AOL 9.7; AOLBuild 4343.19; Windows NT 6.1; WOW64; Trident/5.0; FunWebProducts)```

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```192.168.63.248``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  192.168.63.248    UGScg  en0
...
<pre>
default   fe80:38fe:1036:2c08:ae33%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {159.238.233.199, 231.166.103.45}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 3a:e0:09:ea:e7:ff
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 76:23:4c:44:09:af
}</pre>
...
## Apple macOS / OSX
No matter what version of OSX/macOS you are on, ```10.13.5```, ```11.2.8```, or ```12.2.1```, there are a range of tools for troubleshooting. Unfortunately, between these manual actions and scripts, they don't give you a series of correlated values over time. This is where automated remote troubleshooting comes in to its own, especially for teams that embrace remote work and Work From Anywhere (WFA).
