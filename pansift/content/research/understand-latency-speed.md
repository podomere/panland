...
layout: research
ip_v4_address: "10.218.107.100"
date: 2023-10-29T15:13:26+00:00
draft: false
---

## Internet Addressing
On the Internet you might get a Public IPv4 address like ```10.218.107.100``` or an IPv6 address like ```2000:1108:82a8:978d:3b7:9536:6c9c:4920```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```91:ba:01:24:48:de```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://dooley-tremblay.biz you initially access a DNS server to translate the host portion (dooley-tremblay) combined with the Top Level Domain (biz) of the URL, to an IP address like ```127.72.40.152```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (compatible; MSIE 9.0; AOL 9.7; AOLBuild 4343.19; Windows NT 6.1; WOW64; Trident/5.0; FunWebProducts)```
...
<pre>
default   fe80:7bef:8b:4901:530%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {6.66.53.157, 32.241.248.23}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 91:ba:01:24:48:de
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 3d:7f:05:88:2b:b3
}</pre>
