...
layout: research
ip_v4_address: "78.82.141.177"
date: 2022-05-05T14:28:27+01:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like ```78.82.141.177``` or an IPv6 address like ```2000:2c69:fa50:12f8:3da2:a5ec:5c50:f7ad```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```77:5e:cc:79:19:16```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://oconner-stracke.net you initially access a DNS server to translate the host portion (oconner-stracke) combined with the Top Level Domain (net) of the URL, to an IP address like ```193.116.21.93```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows; U; Win 9x 4.90; SG; rv:1.9.2.4) Gecko/20101104 Netscape/9.1.0285```
...
<pre>
default   fe80:f440:68ce:3221:a2b7%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {106.101.110.123, 15.186.18.69}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 77:5e:cc:79:19:16
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 46:58:9b:ec:9f:39
}</pre>
