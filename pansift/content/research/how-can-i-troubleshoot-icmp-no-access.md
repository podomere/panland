...
layout: research
ip_v4_address: "180.126.50.250"
date: 2022-05-05T14:29:53+01:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like ```180.126.50.250``` or an IPv6 address like ```2000:9cb9:f21:cd31:dd0e:f38e:4f90:c567```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```13:5f:f4:6a:42:0e```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://nader.com you initially access a DNS server to translate the host portion (nader) combined with the Top Level Domain (com) of the URL, to an IP address like ```235.58.250.32```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1; WOW64; Trident/7.0; AS; rv:11.0) like Gecko```
...
<pre>
default   fe80:63:ff50:9a57:355e%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {23.31.246.155, 36.110.54.28}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 13:5f:f4:6a:42:0e
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 20:de:bf:47:3a:f0
}</pre>
