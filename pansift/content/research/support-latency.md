...
layout: research
ip_v4_address: "165.106.255.135"
date: 2022-12-15T13:50:17+00:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like ```165.106.255.135``` or an IPv6 address like ```2000:f320:2c9d:73c6:5dca:f239:5c16:af58```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```2f:1d:e1:ca:b2:af```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://dach-stiedemann.net you initially access a DNS server to translate the host portion (dach-stiedemann) combined with the Top Level Domain (net) of the URL, to an IP address like ```240.53.227.118```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_3) AppleWebKit/537.75.14 (KHTML, like Gecko) Version/7.0.3 Safari/7046A194A```
...
<pre>
default   fe80:6c2d:3a6:1862:a747%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {213.116.183.50, 25.187.101.12}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 2f:1d:e1:ca:b2:af
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr d6:44:3f:b5:1b:e7
}</pre>
