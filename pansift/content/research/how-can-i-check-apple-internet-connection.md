...
layout: research
ip_v4_address: "66.194.218.222"
date: 2022-04-24T19:00:25+01:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like <code>66.194.218.222</code> or an IPv6 address like <code>2000:94fa:2511:121d:e3f5:129e:24d2:9d93</code>. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>6e:7c:b4:8e:42:be</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://cartwright-mann.co you initially access a DNS server to translate the host portion (cartwright-mann) combined with the Top Level Domain (co) of the URL, to an IP address like <code>221.64.31.87</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (compatible; MSIE 9.0; AOL 9.7; AOLBuild 4343.19; Windows NT 6.1; WOW64; Trident/5.0; FunWebProducts)</code>
...
<pre><code>
default   fe80:5e15:bd8f:7075:6489%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {118.197.137.223, 1.53.249.21}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 6e:7c:b4:8e:42:be
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr f2:a5:f9:39:26:1b
}</code></pre>
