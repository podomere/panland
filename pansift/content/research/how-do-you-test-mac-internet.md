...
layout: research
ip_v4_address: "215.57.146.207"
date: 2022-11-02T11:33:12+00:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like ```215.57.146.207``` or an IPv6 address like ```2000:e4f4:429f:8a7c:703a:8a33:541c:6964```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```13:63:8f:a8:81:35```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://franecki-wuckert.co you initially access a DNS server to translate the host portion (franecki-wuckert) combined with the Top Level Domain (co) of the URL, to an IP address like ```118.233.60.75```. Your computer and browser actually sends its type with all web requests e.g. <br>```Opera/9.80 (X11; Linux i686; Ubuntu/14.10) Presto/2.12.388 Version/12.16```
...
<pre>
default   fe80:71a1:503e:2733:2fc0%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {38.40.7.174, 230.151.29.157}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 13:63:8f:a8:81:35
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 39:71:40:8f:42:fb
}</pre>
