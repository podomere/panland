...
subtitle: "Deep Dive?"
layout: research
ip_v4_address: "25.150.51.39"
date: 2022-11-02T11:33:11+00:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like ```25.150.51.39``` or an IPv6 address like ```2000:532d:adcb:6a2b:7478:d425:32c7:88d5```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```5f:36:bc:fe:54:b9```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://jakubowski.org you initially access a DNS server to translate the host portion (jakubowski) combined with the Top Level Domain (org) of the URL, to an IP address like ```188.173.44.183```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows; U; Win 9x 4.90; SG; rv:1.9.2.4) Gecko/20101104 Netscape/9.1.0285```
...
<pre>
default   fe80:d7f2:b775:4e6c:10f1%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {62.157.11.223, 113.190.149.143}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 5f:36:bc:fe:54:b9
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 14:33:fd:65:a4:4e
}</pre>
