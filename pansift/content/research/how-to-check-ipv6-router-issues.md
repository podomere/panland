...
layout: research
ip_v4_address: "68.75.177.225"
date: 2023-10-29T15:13:24+00:00
draft: false
---

## Internet Addressing
On the Internet you may have a Public IPv4 address like ```68.75.177.225``` or an IPv6 address like ```2000:64a1:3013:6e09:dc99:7ecc:24a5:6895```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```96:7e:ff:4e:eb:68```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://moen-kuphal.net you initially access a DNS server to translate the host portion (moen-kuphal) combined with the Top Level Domain (net) of the URL, to an IP address like ```168.222.255.206```. Your computer and browser actually sends its type with all web requests e.g. <br>```Opera/9.80 (X11; Linux i686; Ubuntu/14.10) Presto/2.12.388 Version/12.16```
...
<pre>
default   fe80:6151:a78e:9093:67b4%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {206.215.8.141, 112.117.199.96}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 96:7e:ff:4e:eb:68
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr ec:bb:28:c7:da:95
}</pre>
