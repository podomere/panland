...
layout: research
ip_v4_address: "240.49.165.230"
date: 2022-11-19T16:17:21+00:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like ```240.49.165.230``` or an IPv6 address like ```2000:d313:f2cc:6c7e:1501:9eba:e3cc:c028```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```f1:bd:2f:61:a8:0c```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://hessel-emard.co you initially access a DNS server to translate the host portion (hessel-emard) combined with the Top Level Domain (co) of the URL, to an IP address like ```16.240.176.130```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_3) AppleWebKit/537.75.14 (KHTML, like Gecko) Version/7.0.3 Safari/7046A194A```
...
<pre>
default   fe80:41d8:c96f:7749:f176%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {59.145.139.8, 138.235.92.197}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr f1:bd:2f:61:a8:0c
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 0c:77:76:01:49:a5
}</pre>
