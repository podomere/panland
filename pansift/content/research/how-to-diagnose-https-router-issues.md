...
layout: research
ip_v4_address: "67.218.203.246"
date: 2022-11-02T11:33:01+00:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like ```67.218.203.246``` or an IPv6 address like ```2000:977a:59ae:5b9a:5c08:15b9:5dc7:a239```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```04:94:96:56:26:c2```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://robel-lang.co you initially access a DNS server to translate the host portion (robel-lang) combined with the Top Level Domain (co) of the URL, to an IP address like ```44.74.169.101```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1; WOW64; Trident/7.0; AS; rv:11.0) like Gecko```
...
<pre>
default   fe80:e742:b977:2113:3899%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {128.144.164.208, 103.220.178.76}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 04:94:96:56:26:c2
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 90:47:4d:9c:ae:82
}</pre>
