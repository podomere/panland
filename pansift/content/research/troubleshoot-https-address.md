---
title: "Troubleshoot Https Address"
subtitle: "Etc. Etc.?"
layout: research
ip_v4_address: "207.135.236.10"
date: 2022-04-24T19:00:05+01:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like <code>207.135.236.10</code> or an IPv6 address like <code>2000:db29:7bad:b0db:ae14:70e9:24b6:e8e9</code>. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>ae:87:d3:fc:9a:bb</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://langosh-wilderman.com you initially access a DNS server to translate the host portion (langosh-wilderman) combined with the Top Level Domain (com) of the URL, to an IP address like <code>232.29.197.74</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Opera/9.80 (X11; Linux i686; Ubuntu/14.10) Presto/2.12.388 Version/12.16</code>

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like <code>10.26.65.121</code> (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For <code>IPv6</code> we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  10.26.65.121    UGScg  en0
...
<pre><code>
default   fe80:f169:607d:83:8e30%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {236.81.227.128, 82.103.117.116}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr ae:87:d3:fc:9a:bb
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 17:af:30:9b:25:61
}</code></pre>
