...
subtitle: "Heads Down?"
layout: research
ip_v4_address: "85.104.201.44"
date: 2023-10-29T15:13:19+00:00
draft: false
---

## Internet Addressing
On the Internet you may get a Public IPv4 address like ```85.104.201.44``` or an IPv6 address like ```2000:8296:e9eb:dad3:94e5:6855:409:e720```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```f2:74:a2:97:06:26```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://adams.info you initially access a DNS server to translate the host portion (adams) combined with the Top Level Domain (info) of the URL, to an IP address like ```58.91.125.52```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows; U; Win 9x 4.90; SG; rv:1.9.2.4) Gecko/20101104 Netscape/9.1.0285```

## Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```172.19.10.240``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  172.19.10.240    UGScg  en0
...
<pre>
default   fe80:f34d:c12d:50b6:10de%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {145.85.212.162, 103.239.152.13}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr f2:74:a2:97:06:26
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr da:af:c0:df:10:9a
}</pre>
