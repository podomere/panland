...
subtitle: "Ideate?"
layout: research
ip_v4_address: "34.3.122.232"
date: 2022-11-19T16:17:25+00:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like ```34.3.122.232``` or an IPv6 address like ```2000:1bea:d012:70b:f892:5df7:8268:5c7f```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```c4:83:fb:f4:b7:83```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://ratke-fadel.info you initially access a DNS server to translate the host portion (ratke-fadel) combined with the Top Level Domain (info) of the URL, to an IP address like ```162.63.182.226```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT x.y; Win64; x64; rv:10.0) Gecko/20100101 Firefox/10.0```
...
<pre>
default   fe80:67b2:c2d2:e88d:82ef%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {12.203.114.127, 12.119.25.23}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr c4:83:fb:f4:b7:83
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr cd:bf:23:3c:af:97
}</pre>
