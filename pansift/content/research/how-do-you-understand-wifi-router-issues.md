...
layout: research
ip_v4_address: "172.167.5.129"
date: 2022-04-24T18:32:41+01:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like <code>172.167.5.129</code> or an IPv6 address like <code>2000:a590:51c5:e76:d0b2:475f:1854:bd5d</code>. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>81:fc:b6:3d:7b:e9</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://wolff-keeling.net you initially access a DNS server to translate the host portion (wolff-keeling) combined with the Top Level Domain (net) of the URL, to an IP address like <code>112.55.107.200</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Opera/9.80 (X11; Linux i686; Ubuntu/14.10) Presto/2.12.388 Version/12.16</code>
...
<pre><code>
default   fe80:470f:acf5:fddb:3236%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {147.214.101.206, 189.5.225.250}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 81:fc:b6:3d:7b:e9
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 99:d0:bc:44:c5:bc
}</code></pre>
