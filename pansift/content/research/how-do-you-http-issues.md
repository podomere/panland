...
layout: research
ip_v4_address: "178.55.162.223"
date: 2023-02-04T16:26:23+00:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like ```178.55.162.223``` or an IPv6 address like ```2000:d521:18cf:66ea:c01a:ed22:db98:50cc```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```88:ec:34:7a:89:1f```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://paucek.info you initially access a DNS server to translate the host portion (paucek) combined with the Top Level Domain (info) of the URL, to an IP address like ```52.43.133.17```. Your computer and browser actually sends its type with all web requests e.g. <br>```Opera/9.80 (X11; Linux i686; Ubuntu/14.10) Presto/2.12.388 Version/12.16```
...
<pre>
default   fe80:6703:909f:bde2:7416%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {139.148.195.134, 138.101.11.53}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 88:ec:34:7a:89:1f
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 2a:e1:51:dc:ca:5f
}</pre>
