...
layout: research
ip_v4_address: "239.3.10.123"
date: 2022-06-04T14:38:17+01:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like ```239.3.10.123``` or an IPv6 address like ```2000:7b31:6e8c:74aa:f068:c7fb:1959:873c```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```fe:07:6a:bd:b7:23```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://wolff-mertz.io you initially access a DNS server to translate the host portion (wolff-mertz) combined with the Top Level Domain (io) of the URL, to an IP address like ```78.58.18.1```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows; U; Win 9x 4.90; SG; rv:1.9.2.4) Gecko/20101104 Netscape/9.1.0285```
...
<pre>
default   fe80:8386:f2c:1f5a:9f5a%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {19.203.215.16, 162.121.6.244}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr fe:07:6a:bd:b7:23
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr c1:c4:74:64:c6:a9
}</pre>
