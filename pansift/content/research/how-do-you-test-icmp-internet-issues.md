...
subtitle: "Tee It Up?"
layout: research
ip_v4_address: "127.9.194.61"
date: 2022-11-02T11:32:58+00:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like ```127.9.194.61``` or an IPv6 address like ```2000:7763:2bc3:a606:7d15:cf1f:54c2:343c```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```5f:5c:f9:c7:c7:0b```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://frami.net you initially access a DNS server to translate the host portion (frami) combined with the Top Level Domain (net) of the URL, to an IP address like ```166.163.224.227```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1; WOW64; Trident/7.0; AS; rv:11.0) like Gecko```
...
<pre>
default   fe80:d4cb:b164:3123:ef27%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {64.127.118.202, 174.36.245.51}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 5f:5c:f9:c7:c7:0b
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr e0:44:54:34:29:c7
}</pre>
