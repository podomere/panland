...
layout: research
ip_v4_address: "83.6.91.126"
date: 2022-11-02T11:33:01+00:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like ```83.6.91.126``` or an IPv6 address like ```2000:a529:92ff:c7d6:7840:4604:bd6e:3f72```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```10:39:f3:b1:7d:46```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://barton.biz you initially access a DNS server to translate the host portion (barton) combined with the Top Level Domain (biz) of the URL, to an IP address like ```213.67.120.57```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1; WOW64; Trident/7.0; AS; rv:11.0) like Gecko```

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```192.168.196.53``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  192.168.196.53    UGScg  en0
...
<pre>
default   fe80:9746:ea36:4c9c:5565%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {244.84.153.206, 190.122.43.67}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 10:39:f3:b1:7d:46
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 84:09:fc:a2:d9:a7
}</pre>
