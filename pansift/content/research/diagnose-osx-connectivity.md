...
layout: research
ip_v4_address: "100.255.197.52"
date: 2022-11-19T19:13:16+00:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like ```100.255.197.52``` or an IPv6 address like ```2000:22c1:9060:343b:62fb:214c:410d:7050```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```09:0c:9c:65:dd:9b```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://dicki.io you initially access a DNS server to translate the host portion (dicki) combined with the Top Level Domain (io) of the URL, to an IP address like ```100.192.126.137```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_3) AppleWebKit/537.75.14 (KHTML, like Gecko) Version/7.0.3 Safari/7046A194A```
...
<pre>
default   fe80:126a:eefc:3c12:75f%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {4.248.226.46, 163.53.45.213}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 09:0c:9c:65:dd:9b
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr e6:20:4a:c1:49:bc
}</pre>
