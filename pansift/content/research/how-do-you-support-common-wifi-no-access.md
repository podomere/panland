...
subtitle: "Ideate?"
layout: research
ip_v4_address: "100.96.245.249"
date: 2022-04-24T18:32:42+01:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like <code>100.96.245.249</code> or an IPv6 address like <code>2000:a837:96a7:2e3d:7bf9:8765:c044:fd07</code>. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>74:71:39:4d:f8:7a</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://moore-bradtke.net you initially access a DNS server to translate the host portion (moore-bradtke) combined with the Top Level Domain (net) of the URL, to an IP address like <code>177.240.37.11</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (Windows NT x.y; Win64; x64; rv:10.0) Gecko/20100101 Firefox/10.0</code>

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like <code>172.29.157.198</code> (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For <code>IPv6</code> we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  172.29.157.198    UGScg  en0
...
<pre><code>
default   e498:84:9973:df84:98cd:977a:4746:13d%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {239.57.95.175, 170.200.136.245}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 74:71:39:4d:f8:7a
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr aa:11:81:bd:fc:49
}</code></pre>
