...
layout: research
ip_v4_address: "151.219.215.150"
date: 2022-11-19T16:17:21+00:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like ```151.219.215.150``` or an IPv6 address like ```2000:ba2f:ef04:6622:5824:e47:4726:ff18```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```45:1b:e0:2e:6f:28```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://hoppe-schimmel.org you initially access a DNS server to translate the host portion (hoppe-schimmel) combined with the Top Level Domain (org) of the URL, to an IP address like ```58.3.163.108```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1; WOW64; Trident/7.0; AS; rv:11.0) like Gecko```
...
<pre>
default   fe80:e3df:54d2:b290:cafb%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {73.94.73.50, 245.86.52.83}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 45:1b:e0:2e:6f:28
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 70:d4:9d:67:9d:70
}</pre>
