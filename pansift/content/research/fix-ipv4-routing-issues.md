...
subtitle: "Streamline?"
layout: research
ip_v4_address: "216.129.19.202"
date: 2022-04-24T18:59:56+01:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like <code>216.129.19.202</code> or an IPv6 address like <code>2000:2c76:89a8:41b7:e209:e54:ee48:5431</code>. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>9a:fd:b7:45:c0:29</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://heidenreich.com you initially access a DNS server to translate the host portion (heidenreich) combined with the Top Level Domain (com) of the URL, to an IP address like <code>84.39.84.50</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (Windows; U; Win 9x 4.90; SG; rv:1.9.2.4) Gecko/20101104 Netscape/9.1.0285</code>
...
<pre><code>
default   a2f8:637e:7f67:b2:4220:a186:2797:a5ff%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {57.170.50.18, 87.218.123.233}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 9a:fd:b7:45:c0:29
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 34:8d:5f:05:57:46
}</code></pre>
