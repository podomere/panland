...
layout: research
ip_v4_address: "107.2.196.177"
date: 2023-11-18T18:58:12+00:00
draft: false
---

## Understanding Internet Addressing

When using the Internet, you are assigned a Public IPv4 or IPv6 address. To verify this, visit [https://test-ipv6.com/](https://test-ipv6.com/). However, communicating these addresses to non-technical individuals, or even mentioning MAC addresses, can be prone to errors. This also lacks historical data for past issues.
...
The default gateway is usually automatically configured through DHCP and typically ends in .1 or .254. This is the designated address where your computer forwards all traffic to be routed. For IPv6, detailed instructions can be found in the blog post [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/). On Mac or Linux, use the command:
```
```
