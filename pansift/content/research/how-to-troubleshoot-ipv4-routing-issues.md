...
subtitle: "Tee It Up?"
layout: research
ip_v4_address: "152.104.128.155"
date: 2023-10-06T17:11:04+01:00
draft: false
---

## Internet Addressing
On the Internet you might get a Public IPv4 address like ```152.104.128.155``` or an IPv6 address like ```2000:ef8f:bb94:72fb:1f97:ed2d:28ab:ec55```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```bf:32:90:2e:d8:13```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://lueilwitz-larson.info you initially access a DNS server to translate the host portion (lueilwitz-larson) combined with the Top Level Domain (info) of the URL, to an IP address like ```199.184.147.106```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (compatible; MSIE 9.0; AOL 9.7; AOLBuild 4343.19; Windows NT 6.1; WOW64; Trident/5.0; FunWebProducts)```

## Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```10.153.16.43``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  10.153.16.43    UGScg  en0
...
<pre>
default   fe80:3486:fc73:ade9:6492%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {190.143.120.34, 172.221.109.244}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr bf:32:90:2e:d8:13
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr f5:88:93:89:56:b9
}</pre>
...
### Apple macOS / OSX
No matter what version of OSX/macOS you are on, ```10.11.8```, ```11.4.8```, or ```12.2.4```, there are a range of tools for troubleshooting. Unfortunately, between these manual actions and scripts, they don't give you a series of correlated values over time. This is where automated remote troubleshooting comes in to its own, especially for teams that embrace remote work and Work From Anywhere (WFA).
