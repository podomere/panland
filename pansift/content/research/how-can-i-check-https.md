...
subtitle: "Value Add?"
layout: research
ip_v4_address: "83.69.83.127"
date: 2022-04-24T19:00:06+01:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like <code>83.69.83.127</code> or an IPv6 address like <code>2000:4932:c8a4:c014:a5af:f37f:9c9f:9ee2</code>. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>31:c8:3b:25:eb:bd</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://oconner-okeefe.com you initially access a DNS server to translate the host portion (oconner-okeefe) combined with the Top Level Domain (com) of the URL, to an IP address like <code>246.21.134.185</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (Windows NT 6.1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/41.0.2228.0 Safari/537.36</code>
...
<pre><code>
default   fe80:312d:7733:4917:5f56%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {199.211.200.174, 227.175.24.19}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 31:c8:3b:25:eb:bd
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr b2:f4:b9:32:14:cc
}</code></pre>
