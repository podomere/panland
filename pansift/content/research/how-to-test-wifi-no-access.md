...
layout: research
ip_v4_address: "88.119.200.181"
date: 2022-04-24T19:00:33+01:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like <code>88.119.200.181</code> or an IPv6 address like <code>2000:1098:c104:1818:540f:eb71:9de4:e987</code>. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>cd:32:5c:06:ff:86</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://bosco-shields.biz you initially access a DNS server to translate the host portion (bosco-shields) combined with the Top Level Domain (biz) of the URL, to an IP address like <code>212.13.23.40</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (compatible; MSIE 9.0; AOL 9.7; AOLBuild 4343.19; Windows NT 6.1; WOW64; Trident/5.0; FunWebProducts)</code>
...
<pre><code>
default   fe80:2f6f:49f4:7df0:8472%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {52.139.4.230, 77.159.198.96}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr cd:32:5c:06:ff:86
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 77:ef:3d:88:87:86
}</code></pre>
