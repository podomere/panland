...
layout: research
ip_v4_address: "82.107.60.236"
date: 2022-12-15T13:50:03+00:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like ```82.107.60.236``` or an IPv6 address like ```2000:c9f3:bf78:ebd9:e11f:22f3:97ff:b841```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```33:51:75:68:59:ea```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://swift-legros.com you initially access a DNS server to translate the host portion (swift-legros) combined with the Top Level Domain (com) of the URL, to an IP address like ```12.27.182.66```. Your computer and browser actually sends its type with all web requests e.g. <br>```Opera/9.80 (X11; Linux i686; Ubuntu/14.10) Presto/2.12.388 Version/12.16```
...
<pre>
default   fe80:903b:bd7b:9691:ba92%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {36.196.26.197, 216.229.46.156}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 33:51:75:68:59:ea
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 1b:5f:3a:85:c2:86
}</pre>
