...
layout: research
ip_v4_address: "124.62.110.63"
date: 2022-06-12T14:09:26+01:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like ```124.62.110.63``` or an IPv6 address like ```2000:8d17:4dec:aeb7:9028:e4d4:9552:aed9```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```ed:5e:2a:99:06:6a```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://rowe-hackett.net you initially access a DNS server to translate the host portion (rowe-hackett) combined with the Top Level Domain (net) of the URL, to an IP address like ```36.254.96.85```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows; U; Win 9x 4.90; SG; rv:1.9.2.4) Gecko/20101104 Netscape/9.1.0285```

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```192.168.47.239``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  192.168.47.239    UGScg  en0
...
<pre>
default   fe80:44a5:b36c:2eae:3cf7%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {220.42.249.63, 218.69.172.137}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr ed:5e:2a:99:06:6a
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 8c:0f:ea:86:7c:9b
}</pre>
