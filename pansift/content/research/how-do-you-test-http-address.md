...
layout: research
ip_v4_address: "61.252.17.211"
date: 2022-06-12T14:09:28+01:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like ```61.252.17.211``` or an IPv6 address like ```2000:aae2:2846:15d5:14b9:4304:3e4d:58c```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```86:b9:ac:f9:92:98```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://tillman.info you initially access a DNS server to translate the host portion (tillman) combined with the Top Level Domain (info) of the URL, to an IP address like ```33.235.124.204```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_3) AppleWebKit/537.75.14 (KHTML, like Gecko) Version/7.0.3 Safari/7046A194A```
...
<pre>
default   fe80:8b74:df58:e05a:b464%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {84.194.40.26, 183.160.18.133}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 86:b9:ac:f9:92:98
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 05:b0:51:97:f1:b5
}</pre>
