...
subtitle: "Swag?"
layout: research
ip_v4_address: "20.37.205.206"
date: 2022-12-15T13:50:21+00:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like ```20.37.205.206``` or an IPv6 address like ```2000:1045:72ef:13:9f53:ad37:54a2:e154```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```e3:15:d3:99:fe:fb```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://kirlin-casper.name you initially access a DNS server to translate the host portion (kirlin-casper) combined with the Top Level Domain (name) of the URL, to an IP address like ```92.180.249.78```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_3) AppleWebKit/537.75.14 (KHTML, like Gecko) Version/7.0.3 Safari/7046A194A```
...
<pre>
default   fe80:db6b:a643:4bd2:4b69%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {65.223.211.205, 106.188.77.107}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr e3:15:d3:99:fe:fb
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr db:b6:65:ca:a3:cd
}</pre>
