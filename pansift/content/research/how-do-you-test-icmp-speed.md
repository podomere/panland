...
layout: research
ip_v4_address: "208.198.36.131"
date: 2023-02-04T16:26:21+00:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like ```208.198.36.131``` or an IPv6 address like ```2000:d184:3ce8:d1ed:69a0:498c:3c79:fd9f```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```da:73:cf:3b:8d:61```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://williamson.io you initially access a DNS server to translate the host portion (williamson) combined with the Top Level Domain (io) of the URL, to an IP address like ```192.37.96.79```. Your computer and browser actually sends its type with all web requests e.g. <br>```Opera/9.80 (X11; Linux i686; Ubuntu/14.10) Presto/2.12.388 Version/12.16```
...
<pre>
default   fe80:b613:51bc:31e6:e663%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {192.124.249.172, 20.150.180.44}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr da:73:cf:3b:8d:61
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 4b:a5:0c:67:f4:cb
}</pre>
