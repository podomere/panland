...
layout: research
ip_v4_address: "4.20.70.20"
date: 2022-04-24T18:31:57+01:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like <code>4.20.70.20</code> or an IPv6 address like <code>2000:3b83:5f23:971c:6a3c:2e2b:2098:b9ea</code>. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>fc:a0:5e:3a:2f:bf</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://hand.biz you initially access a DNS server to translate the host portion (hand) combined with the Top Level Domain (biz) of the URL, to an IP address like <code>154.238.4.55</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (Windows; U; Win 9x 4.90; SG; rv:1.9.2.4) Gecko/20101104 Netscape/9.1.0285</code>
...
<pre><code>
default   fe80:2f5b:11d6:799:70d5%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {147.194.117.70, 51.187.19.32}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr fc:a0:5e:3a:2f:bf
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr e0:df:f7:35:f0:1b
}</code></pre>
