...
layout: research
ip_v4_address: "139.220.93.119"
date: 2023-02-04T16:26:19+00:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like ```139.220.93.119``` or an IPv6 address like ```2000:a18d:c67f:3b28:50f8:923:888b:4172```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```a2:59:72:4c:a7:c9```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://rau-wisoky.name you initially access a DNS server to translate the host portion (rau-wisoky) combined with the Top Level Domain (name) of the URL, to an IP address like ```71.208.209.0```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT x.y; Win64; x64; rv:10.0) Gecko/20100101 Firefox/10.0```
...
<pre>
default   fe80:2a92:267f:7b81:5c36%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {239.164.35.96, 131.214.56.140}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr a2:59:72:4c:a7:c9
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 17:8b:ae:11:23:80
}</pre>
...
## Apple macOS / OSX
No matter what version of OSX/macOS you are on, ```10.12.3```, ```11.6.5```, or ```12.3.1```, there are a range of tools for troubleshooting. Unfortunately, between these manual actions and scripts, they don't give you a series of correlated values over time. This is where automated remote troubleshooting comes in to its own, especially for teams that embrace remote work and Work From Anywhere (WFA).
