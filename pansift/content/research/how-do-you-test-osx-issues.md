...
layout: research
ip_v4_address: "117.127.233.48"
date: 2022-04-24T18:31:58+01:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like <code>117.127.233.48</code> or an IPv6 address like <code>2000:9f2f:4763:8f1f:e887:6563:d651:a962</code>. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>2a:2b:78:c0:b3:70</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://schoen-rempel.com you initially access a DNS server to translate the host portion (schoen-rempel) combined with the Top Level Domain (com) of the URL, to an IP address like <code>106.214.246.115</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (Windows NT 6.1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/41.0.2228.0 Safari/537.36</code>
...
<pre><code>
default   fe80:dda6:c2f5:c33c:c1e6%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {253.162.218.17, 225.227.206.248}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 2a:2b:78:c0:b3:70
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 87:c6:4e:08:ff:8e
}</code></pre>
