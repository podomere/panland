...
layout: research
ip_v4_address: "3.250.9.245"
date: 2022-04-24T19:00:01+01:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like <code>3.250.9.245</code> or an IPv6 address like <code>2000:623e:8009:3def:a7f0:33d0:f833:c188</code>. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>d7:0b:7b:62:e1:0b</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://kling.name you initially access a DNS server to translate the host portion (kling) combined with the Top Level Domain (name) of the URL, to an IP address like <code>128.127.29.195</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_3) AppleWebKit/537.75.14 (KHTML, like Gecko) Version/7.0.3 Safari/7046A194A</code>
...
default  10.45.214.244    UGScg  en0
...
<pre><code>
default   fe80:a467:6f56:effa:dfa2%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {156.147.114.39, 228.30.111.111}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr d7:0b:7b:62:e1:0b
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 36:02:c5:c9:d4:7d
}</code></pre>
