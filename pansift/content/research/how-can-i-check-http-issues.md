...
layout: research
ip_v4_address: "152.203.201.196"
date: 2022-04-24T19:00:04+01:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like <code>152.203.201.196</code> or an IPv6 address like <code>2000:e74d:7b08:c165:3b9a:f003:b1df:847f</code>. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>df:bc:38:14:1f:fe</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://jenkins-rempel.co you initially access a DNS server to translate the host portion (jenkins-rempel) combined with the Top Level Domain (co) of the URL, to an IP address like <code>250.26.148.41</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (Windows NT 6.1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/41.0.2228.0 Safari/537.36</code>
...
<pre><code>
default   fe80:93f7:ed36:9650:1bc3%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {89.192.99.162, 41.148.242.36}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr df:bc:38:14:1f:fe
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 01:db:8a:65:34:f0
}</code></pre>
