...
subtitle: "Ideate?"
layout: research
ip_v4_address: "74.195.40.16"
date: 2022-05-05T14:29:42+01:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like ```74.195.40.16``` or an IPv6 address like ```2000:4c0e:9ce9:d147:7198:f90f:4c6d:4030```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```ec:66:33:23:23:f7```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://osinski.biz you initially access a DNS server to translate the host portion (osinski) combined with the Top Level Domain (biz) of the URL, to an IP address like ```84.108.14.70```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (compatible; MSIE 9.0; AOL 9.7; AOLBuild 4343.19; Windows NT 6.1; WOW64; Trident/5.0; FunWebProducts)```
...
<pre>
default   fe80:f0ae:4d8f:b683:19ff%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {30.230.30.172, 134.195.209.139}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr ec:66:33:23:23:f7
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 73:9f:45:1d:5c:58
}</pre>
