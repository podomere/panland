...
layout: research
ip_v4_address: "202.165.248.230"
date: 2022-11-19T16:17:23+00:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like ```202.165.248.230``` or an IPv6 address like ```2000:458a:f32c:607f:1f00:b801:c3b5:4314```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```d7:80:1d:d6:38:91```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://olson-rice.org you initially access a DNS server to translate the host portion (olson-rice) combined with the Top Level Domain (org) of the URL, to an IP address like ```223.65.41.58```. Your computer and browser actually sends its type with all web requests e.g. <br>```Opera/9.80 (X11; Linux i686; Ubuntu/14.10) Presto/2.12.388 Version/12.16```

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```10.182.150.208``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  10.182.150.208    UGScg  en0
...
<pre>
default   fe80:5e59:1fce:db28:d10e%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {82.49.178.229, 223.178.31.48}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr d7:80:1d:d6:38:91
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 6f:1e:65:b5:ad:7c
}</pre>
...
## Apple macOS / OSX
No matter what version of OSX/macOS you are on, ```10.11.1```, ```11.2.6```, or ```12.1.6```, there are a range of tools for troubleshooting. Unfortunately, between these manual actions and scripts, they don't give you a series of correlated values over time. This is where automated remote troubleshooting comes in to its own, especially for teams that embrace remote work and Work From Anywhere (WFA).
