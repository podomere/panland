...
layout: research
ip_v4_address: "202.227.162.147"
date: 2022-12-15T13:50:11+00:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like ```202.227.162.147``` or an IPv6 address like ```2000:c4b3:f822:c547:5ca5:c45b:c7e3:3ff7```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```b0:a0:ae:89:68:86```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://nitzsche.net you initially access a DNS server to translate the host portion (nitzsche) combined with the Top Level Domain (net) of the URL, to an IP address like ```241.252.115.201```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (compatible; MSIE 9.0; AOL 9.7; AOLBuild 4343.19; Windows NT 6.1; WOW64; Trident/5.0; FunWebProducts)```
...
<pre>
default   fe80:1246:81c6:5680:e685%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {64.132.44.217, 101.143.29.56}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr b0:a0:ae:89:68:86
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr de:83:cf:78:15:4e
}</pre>
