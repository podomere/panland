...
layout: research
ip_v4_address: "165.85.173.198"
date: 2023-10-29T15:13:30+00:00
draft: false
---

## Internet Addressing
On the Internet you might have a Public IPv4 address like ```165.85.173.198``` or an IPv6 address like ```2000:c5d6:d555:8edf:9988:72e:2c1d:d703```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```5f:15:77:50:f0:2e```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://williamson-wisozk.co you initially access a DNS server to translate the host portion (williamson-wisozk) combined with the Top Level Domain (co) of the URL, to an IP address like ```31.215.168.218```. Your computer and browser actually sends its type with all web requests e.g. <br>```Opera/9.80 (X11; Linux i686; Ubuntu/14.10) Presto/2.12.388 Version/12.16```
...
<pre>
default   fe80:82db:137e:5e33:3249%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {200.178.181.112, 182.205.19.142}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 5f:15:77:50:f0:2e
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 14:2e:0e:3e:f6:c2
}</pre>
