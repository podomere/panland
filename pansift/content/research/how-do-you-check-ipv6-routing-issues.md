...
subtitle: "Learnings?"
layout: research
ip_v4_address: "93.33.63.7"
date: 2022-05-05T14:29:29+01:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like ```93.33.63.7``` or an IPv6 address like ```2000:582c:a918:1a39:1eb0:9b41:471:fc18```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```ef:0b:67:95:08:3e```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://bins.biz you initially access a DNS server to translate the host portion (bins) combined with the Top Level Domain (biz) of the URL, to an IP address like ```36.88.246.219```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_3) AppleWebKit/537.75.14 (KHTML, like Gecko) Version/7.0.3 Safari/7046A194A```
...
<pre>
default   fe80:345a:d103:6a7:15d9%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {109.117.77.79, 205.203.7.174}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr ef:0b:67:95:08:3e
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 64:c1:8e:81:e1:db
}</pre>
