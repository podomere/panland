...
subtitle: "Synergy?"
layout: research
ip_v4_address: "116.188.116.110"
date: 2022-04-24T19:00:25+01:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like <code>116.188.116.110</code> or an IPv6 address like <code>2000:8a8d:e3c1:6695:9ef2:f338:77ff:2c42</code>. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>dd:e3:e3:44:bb:bd</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://balistreri-ruecker.info you initially access a DNS server to translate the host portion (balistreri-ruecker) combined with the Top Level Domain (info) of the URL, to an IP address like <code>193.73.60.128</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (Windows NT 6.1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/41.0.2228.0 Safari/537.36</code>

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like <code>10.48.97.152</code> (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For <code>IPv6</code> we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  10.48.97.152    UGScg  en0
...
<pre><code>
default   fe80:f2db:8e52:8c74:cc8%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {171.101.193.199, 163.69.203.167}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr dd:e3:e3:44:bb:bd
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 46:72:a3:1b:83:4a
}</code></pre>
