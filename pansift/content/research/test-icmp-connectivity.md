...
subtitle: "Value Add?"
layout: research
ip_v4_address: "175.202.163.169"
date: 2023-10-06T17:11:06+01:00
draft: false
---

## Internet Addressing
On the Internet you may get a Public IPv4 address like ```175.202.163.169``` or an IPv6 address like ```2000:ce2f:aa9b:c9ab:7ed9:7f0c:c3e6:ea0b```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```9c:d2:d5:8d:a3:4e```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://tillman-thiel.name you initially access a DNS server to translate the host portion (tillman-thiel) combined with the Top Level Domain (name) of the URL, to an IP address like ```5.22.197.49```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/41.0.2228.0 Safari/537.36```

## Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```172.21.72.249``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  172.21.72.249    UGScg  en0
...
<pre>
default   fe80:2bd3:442a:159:9119%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {96.116.164.84, 34.207.55.159}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 9c:d2:d5:8d:a3:4e
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr ee:38:83:44:6a:3c
}</pre>
