...
layout: research
ip_v4_address: "181.39.49.75"
date: 2022-11-19T19:13:29+00:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like ```181.39.49.75``` or an IPv6 address like ```2000:ae1f:123f:6925:7fd2:b3d5:aee6:586b```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```96:2d:d1:d2:54:d7```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://runte-rau.com you initially access a DNS server to translate the host portion (runte-rau) combined with the Top Level Domain (com) of the URL, to an IP address like ```151.119.124.248```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1; WOW64; Trident/7.0; AS; rv:11.0) like Gecko```
...
<pre>
default   fe80:eee7:1899:7a7d:9938%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {234.62.222.29, 12.113.108.26}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 96:2d:d1:d2:54:d7
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 50:51:05:38:c0:20
}</pre>
