...
layout: research
ip_v4_address: "59.205.162.132"
date: 2022-11-02T11:33:00+00:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like ```59.205.162.132``` or an IPv6 address like ```2000:f69f:9e69:6652:ab42:84bd:8ce2:988e```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```b3:61:8b:05:2b:ae```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://dietrich-hessel.name you initially access a DNS server to translate the host portion (dietrich-hessel) combined with the Top Level Domain (name) of the URL, to an IP address like ```196.232.216.14```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT x.y; Win64; x64; rv:10.0) Gecko/20100101 Firefox/10.0```
...
<pre>
default   fe80:5dd8:62fe:f12:921d%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {166.128.148.62, 81.83.211.125}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr b3:61:8b:05:2b:ae
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr ba:89:27:34:4a:e4
}</pre>
