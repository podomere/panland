...
subtitle: "Learnings?"
layout: research
ip_v4_address: "156.183.160.149"
date: 2022-05-05T14:29:45+01:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like ```156.183.160.149``` or an IPv6 address like ```2000:9c80:7372:8f49:8806:5301:e7b5:e578```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```85:9b:61:c2:6d:25```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://waelchi-welch.io you initially access a DNS server to translate the host portion (waelchi-welch) combined with the Top Level Domain (io) of the URL, to an IP address like ```239.234.218.91```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_3) AppleWebKit/537.75.14 (KHTML, like Gecko) Version/7.0.3 Safari/7046A194A```
...
<pre>
default   fe80:9370:46c:1aa6:43ea%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {173.167.13.196, 16.71.76.42}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 85:9b:61:c2:6d:25
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 94:6f:62:a6:26:7c
}</pre>
