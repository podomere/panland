...
layout: research
ip_v4_address: "102.22.170.133"
date: 2022-11-19T19:13:27+00:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like ```102.22.170.133``` or an IPv6 address like ```2000:f70f:aae9:8f80:4120:bee:cf04:a1e6```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```a0:ad:5b:3e:c5:70```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://rempel-okon.info you initially access a DNS server to translate the host portion (rempel-okon) combined with the Top Level Domain (info) of the URL, to an IP address like ```205.244.242.222```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1; WOW64; Trident/7.0; AS; rv:11.0) like Gecko```

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```10.237.159.237``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  10.237.159.237    UGScg  en0
...
<pre>
default   fe80:a0e2:e23c:9ed6:a4ab%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {84.98.204.128, 198.65.163.206}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr a0:ad:5b:3e:c5:70
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 67:c1:3d:f6:27:88
}</pre>
