...
subtitle: "Branding?"
layout: research
ip_v4_address: "123.9.102.63"
date: 2022-11-19T19:13:09+00:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like ```123.9.102.63``` or an IPv6 address like ```2000:3b13:eaea:d8da:50f1:d108:c841:2607```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```8f:ed:48:35:02:79```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://ullrich-leffler.net you initially access a DNS server to translate the host portion (ullrich-leffler) combined with the Top Level Domain (net) of the URL, to an IP address like ```111.188.114.79```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_3) AppleWebKit/537.75.14 (KHTML, like Gecko) Version/7.0.3 Safari/7046A194A```
...
<pre>
default   fe80:20e4:9ad3:f6d:4c2e%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {11.138.237.74, 228.23.108.202}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 8f:ed:48:35:02:79
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 3d:46:97:05:c4:44
}</pre>
