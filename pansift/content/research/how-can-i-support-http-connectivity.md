...
layout: research
ip_v4_address: "17.114.110.212"
date: 2022-04-24T19:00:04+01:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like <code>17.114.110.212</code> or an IPv6 address like <code>2000:cfb0:4e69:98c9:924e:413e:65d4:c5e2</code>. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>11:6f:20:5c:c5:cc</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://hoeger-wisozk.net you initially access a DNS server to translate the host portion (hoeger-wisozk) combined with the Top Level Domain (net) of the URL, to an IP address like <code>101.175.132.32</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Opera/9.80 (X11; Linux i686; Ubuntu/14.10) Presto/2.12.388 Version/12.16</code>
...
<pre><code>
default   fe80:17b:d176:aafe:b94e%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {245.69.73.211, 225.251.237.100}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 11:6f:20:5c:c5:cc
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 9b:3c:dd:2e:3b:ca
}</code></pre>
