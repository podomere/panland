...
layout: research
ip_v4_address: "49.6.224.246"
date: 2022-06-12T14:09:24+01:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like ```49.6.224.246``` or an IPv6 address like ```2000:e87a:a2ce:7220:5208:788e:bb1e:2b1```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```28:5c:70:9b:6b:fe```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://bruen-paucek.biz you initially access a DNS server to translate the host portion (bruen-paucek) combined with the Top Level Domain (biz) of the URL, to an IP address like ```198.245.95.40```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows; U; Win 9x 4.90; SG; rv:1.9.2.4) Gecko/20101104 Netscape/9.1.0285```
...
<pre>
default   fe80:98b1:e735:fd0f:869b%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {221.126.67.252, 248.217.148.120}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 28:5c:70:9b:6b:fe
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 54:5a:44:67:00:eb
}</pre>
