...
subtitle: "Tee It Up?"
layout: research
ip_v4_address: "199.182.3.215"
date: 2023-02-04T16:26:21+00:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like ```199.182.3.215``` or an IPv6 address like ```2000:1ba7:ca3f:a29a:f06:224b:4b62:a0ea```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```b5:d1:7e:1a:d5:42```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://bashirian-stiedemann.io you initially access a DNS server to translate the host portion (bashirian-stiedemann) combined with the Top Level Domain (io) of the URL, to an IP address like ```204.183.167.243```. Your computer and browser actually sends its type with all web requests e.g. <br>```Opera/9.80 (X11; Linux i686; Ubuntu/14.10) Presto/2.12.388 Version/12.16```
...
<pre>
default   fe80:8e90:b50e:7ea:a21e%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {75.216.50.95, 64.67.83.193}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr b5:d1:7e:1a:d5:42
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr d6:af:53:87:6c:fa
}</pre>
