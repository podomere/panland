...
subtitle: "Branding?"
layout: research
ip_v4_address: "96.84.31.10"
date: 2022-11-19T16:17:22+00:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like ```96.84.31.10``` or an IPv6 address like ```2000:135a:29b2:1bb7:7c73:a114:edb3:dc96```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```5a:8c:fe:c6:be:3f```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://hintz-conn.info you initially access a DNS server to translate the host portion (hintz-conn) combined with the Top Level Domain (info) of the URL, to an IP address like ```234.144.29.117```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1; WOW64; Trident/7.0; AS; rv:11.0) like Gecko```

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```10.98.138.155``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  10.98.138.155    UGScg  en0
...
<pre>
default   fe80:23b4:4fce:6e5b:70cf%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {30.219.154.182, 46.0.142.131}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 5a:8c:fe:c6:be:3f
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 35:88:19:44:32:9f
}</pre>
