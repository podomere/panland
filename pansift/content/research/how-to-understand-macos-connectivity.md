...
layout: research
ip_v4_address: "37.14.53.118"
date: 2022-11-02T11:33:10+00:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like ```37.14.53.118``` or an IPv6 address like ```2000:1e7d:88ad:fdc4:f3e9:a731:50da:5515```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```b6:3f:ee:db:7e:3c```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://mills-gutkowski.co you initially access a DNS server to translate the host portion (mills-gutkowski) combined with the Top Level Domain (co) of the URL, to an IP address like ```124.117.163.93```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1; WOW64; Trident/7.0; AS; rv:11.0) like Gecko```
...
<pre>
default   fe80:e908:e283:7307:2cac%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {36.156.229.58, 118.175.209.220}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr b6:3f:ee:db:7e:3c
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr c5:c2:17:09:45:95
}</pre>
