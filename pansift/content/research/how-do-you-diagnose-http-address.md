...
layout: research
ip_v4_address: "96.152.24.228"
date: 2022-04-24T19:00:04+01:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like <code>96.152.24.228</code> or an IPv6 address like <code>2000:eab1:95fd:bdc7:9fea:c10b:ab64:7578</code>. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>b3:81:02:d2:d2:84</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://mckenzie-marquardt.biz you initially access a DNS server to translate the host portion (mckenzie-marquardt) combined with the Top Level Domain (biz) of the URL, to an IP address like <code>63.150.56.104</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Opera/9.80 (X11; Linux i686; Ubuntu/14.10) Presto/2.12.388 Version/12.16</code>
...
<pre><code>
default   fe80:1ad:f496:7d52:24b3%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {152.35.135.50, 214.189.26.151}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr b3:81:02:d2:d2:84
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 72:b8:bb:0b:70:cb
}</code></pre>
