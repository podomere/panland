...
layout: research
ip_v4_address: "219.18.202.239"
date: 2022-04-24T19:00:02+01:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like <code>219.18.202.239</code> or an IPv6 address like <code>2000:26f8:71f1:b01e:f412:9387:2e99:cf30</code>. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>3e:7c:5f:dc:b4:b3</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://schmitt-sauer.info you initially access a DNS server to translate the host portion (schmitt-sauer) combined with the Top Level Domain (info) of the URL, to an IP address like <code>60.83.219.234</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_3) AppleWebKit/537.75.14 (KHTML, like Gecko) Version/7.0.3 Safari/7046A194A</code>
...
<pre><code>
default   fe80:aaf5:60af:aebc:1a95%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {190.132.252.107, 79.86.102.155}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 3e:7c:5f:dc:b4:b3
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 72:7f:d7:e8:0c:ef
}</code></pre>
