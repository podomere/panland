...
layout: research
ip_v4_address: "150.115.190.103"
date: 2022-04-24T19:00:33+01:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like <code>150.115.190.103</code> or an IPv6 address like <code>2000:7ba:c20c:b337:b589:ad3e:ab36:ff92</code>. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>7d:df:ed:ce:4b:ce</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://runolfsdottir-rippin.name you initially access a DNS server to translate the host portion (runolfsdottir-rippin) combined with the Top Level Domain (name) of the URL, to an IP address like <code>190.85.170.136</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Opera/9.80 (X11; Linux i686; Ubuntu/14.10) Presto/2.12.388 Version/12.16</code>
...
<pre><code>
default   fe80:8169:7dd1:4795:e414%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {205.204.222.181, 124.27.191.92}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 7d:df:ed:ce:4b:ce
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 57:8e:ce:cf:de:4e
}</code></pre>
