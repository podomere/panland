...
layout: research
ip_v4_address: "31.163.132.89"
date: 2023-10-29T15:13:28+00:00
draft: false
---

## Internet Addressing
On the Internet you may get a Public IPv4 address like ```31.163.132.89``` or an IPv6 address like ```2000:471d:8eb3:565:4bcb:73fe:9ad8:22b3```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```0a:90:c3:01:8b:75```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://harvey-hettinger.org you initially access a DNS server to translate the host portion (harvey-hettinger) combined with the Top Level Domain (org) of the URL, to an IP address like ```198.94.176.161```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT x.y; Win64; x64; rv:10.0) Gecko/20100101 Firefox/10.0```
...
<pre>
default   fe80:334f:3f3e:d53a:f874%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {222.190.130.61, 110.115.108.73}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 0a:90:c3:01:8b:75
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 12:b9:ab:7c:f4:d2
}</pre>
