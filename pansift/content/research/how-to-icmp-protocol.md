...
layout: research
ip_v4_address: "3.227.83.86"
date: 2023-10-29T15:13:27+00:00
draft: false
---

## Internet Addressing
On the Internet you may have a Public IPv4 address like ```3.227.83.86``` or an IPv6 address like ```2000:4c07:db2d:ddd9:7e67:e92:8bd8:7c17```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```e1:ba:65:de:15:f7```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://ratke-mills.info you initially access a DNS server to translate the host portion (ratke-mills) combined with the Top Level Domain (info) of the URL, to an IP address like ```3.152.98.174```. Your computer and browser actually sends its type with all web requests e.g. <br>```Opera/9.80 (X11; Linux i686; Ubuntu/14.10) Presto/2.12.388 Version/12.16```
...
<pre>
default   fe80:a76a:a94b:9079:7cf0%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {13.18.165.252, 216.249.105.208}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr e1:ba:65:de:15:f7
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 45:05:77:a7:48:de
}</pre>
