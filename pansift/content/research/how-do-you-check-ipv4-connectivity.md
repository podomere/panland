...
subtitle: "Branding?"
layout: research
ip_v4_address: "57.215.184.118"
date: 2023-02-04T17:08:36+00:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like ```57.215.184.118``` or an IPv6 address like ```2000:b8fc:a46b:cd4a:b99a:4e0c:fec3:5fb8```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```92:2f:43:f6:df:13```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://olson-hane.co you initially access a DNS server to translate the host portion (olson-hane) combined with the Top Level Domain (co) of the URL, to an IP address like ```180.70.173.179```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/41.0.2228.0 Safari/537.36```
...
<pre>
default   fe80:e559:bd3c:babc:7912%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {186.89.104.238, 99.146.103.229}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 92:2f:43:f6:df:13
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr ed:9d:de:e5:66:01
}</pre>
