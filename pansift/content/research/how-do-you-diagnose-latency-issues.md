...
layout: research
ip_v4_address: "153.204.124.0"
date: 2023-02-04T17:08:37+00:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like ```153.204.124.0``` or an IPv6 address like ```2000:1f66:3ca1:e9ec:23e2:fd8c:1c3d:e025```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```9a:31:e7:95:62:1e```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://krajcik.biz you initially access a DNS server to translate the host portion (krajcik) combined with the Top Level Domain (biz) of the URL, to an IP address like ```193.249.5.182```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_3) AppleWebKit/537.75.14 (KHTML, like Gecko) Version/7.0.3 Safari/7046A194A```
...
<pre>
default   fe80:4c7d:5475:d924:f43c%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {43.179.234.5, 43.37.100.37}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 9a:31:e7:95:62:1e
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 2a:72:49:19:cb:91
}</pre>
