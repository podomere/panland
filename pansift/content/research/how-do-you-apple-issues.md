...
layout: research
ip_v4_address: "18.51.186.79"
date: 2022-11-19T16:17:13+00:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like ```18.51.186.79``` or an IPv6 address like ```2000:5b6b:b3c1:c95:c2e:603c:3876:1dab```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```31:b0:99:11:c5:46```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://batz-king.com you initially access a DNS server to translate the host portion (batz-king) combined with the Top Level Domain (com) of the URL, to an IP address like ```230.81.52.215```. Your computer and browser actually sends its type with all web requests e.g. <br>```Opera/9.80 (X11; Linux i686; Ubuntu/14.10) Presto/2.12.388 Version/12.16```
...
<pre>
default   fe80:9b02:924a:e210:e76e%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {214.153.0.132, 0.228.235.99}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 31:b0:99:11:c5:46
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr e8:1a:20:dc:31:82
}</pre>
