...
subtitle: "Synergy?"
layout: research
ip_v4_address: "49.99.165.235"
date: 2023-10-06T17:11:03+01:00
draft: false
---

## Internet Addressing
On the Internet you might have a Public IPv4 address like ```49.99.165.235``` or an IPv6 address like ```2000:cd5f:e4d9:f953:c7e3:5db3:d83:ae7```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```76:6c:6a:9c:8f:19```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://orn.com you initially access a DNS server to translate the host portion (orn) combined with the Top Level Domain (com) of the URL, to an IP address like ```23.63.250.101```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_3) AppleWebKit/537.75.14 (KHTML, like Gecko) Version/7.0.3 Safari/7046A194A```

## Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```172.28.194.213``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  172.28.194.213    UGScg  en0
...
<pre>
default   fe80:7edf:a0ef:4cb6:ca6%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {0.200.224.196, 24.122.237.179}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 76:6c:6a:9c:8f:19
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 8e:c6:88:63:38:bf
}</pre>
