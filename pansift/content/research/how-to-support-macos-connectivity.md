...
layout: research
ip_v4_address: "115.191.126.146"
date: 2022-04-24T18:31:57+01:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like <code>115.191.126.146</code> or an IPv6 address like <code>2000:d2fd:5c3d:9334:44c9:e99b:373e:b1bc</code>. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>e0:07:95:f1:d9:91</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://wisoky-ondricka.info you initially access a DNS server to translate the host portion (wisoky-ondricka) combined with the Top Level Domain (info) of the URL, to an IP address like <code>126.83.69.95</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_3) AppleWebKit/537.75.14 (KHTML, like Gecko) Version/7.0.3 Safari/7046A194A</code>
...
<pre><code>
default   fe80:dc8a:64d4:ea58:fad3%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {137.103.143.74, 96.89.64.92}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr e0:07:95:f1:d9:91
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 0d:e7:25:da:7a:e5
}</code></pre>
