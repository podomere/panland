...
layout: research
ip_v4_address: "35.134.0.220"
date: 2023-10-06T17:11:06+01:00
draft: false
---

## Internet Addressing
On the Internet you may have a Public IPv4 address like ```35.134.0.220``` or an IPv6 address like ```2000:b3fb:a3e1:b48a:42f5:add9:8934:5cbf```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```79:30:d5:9d:15:cc```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://mclaughlin.biz you initially access a DNS server to translate the host portion (mclaughlin) combined with the Top Level Domain (biz) of the URL, to an IP address like ```31.224.15.20```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT x.y; Win64; x64; rv:10.0) Gecko/20100101 Firefox/10.0```

## Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```10.118.202.224``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  10.118.202.224    UGScg  en0
...
<pre>
default   fe80:9d2:9b17:3a80:2894%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {39.171.191.41, 71.32.145.246}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 79:30:d5:9d:15:cc
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 04:1e:c0:67:a1:30
}</pre>
...
### Apple macOS / OSX
No matter what version of OSX/macOS you are on, ```10.13.1```, ```11.6.8```, or ```12.1.3```, there are a range of tools for troubleshooting. Unfortunately, between these manual actions and scripts, they don't give you a series of correlated values over time. This is where automated remote troubleshooting comes in to its own, especially for teams that embrace remote work and Work From Anywhere (WFA).
