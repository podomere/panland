...
layout: research
ip_v4_address: "33.239.251.177"
date: 2022-11-19T19:13:26+00:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like ```33.239.251.177``` or an IPv6 address like ```2000:70f2:4996:3aaa:c2a8:c860:2885:e755```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```d5:63:e8:34:8c:ee```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://weissnat.net you initially access a DNS server to translate the host portion (weissnat) combined with the Top Level Domain (net) of the URL, to an IP address like ```51.195.179.168```. Your computer and browser actually sends its type with all web requests e.g. <br>```Opera/9.80 (X11; Linux i686; Ubuntu/14.10) Presto/2.12.388 Version/12.16```

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```10.242.81.13``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  10.242.81.13    UGScg  en0
...
<pre>
default   fe80:e160:b84f:e6f3:2606%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {32.141.172.132, 228.0.19.19}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr d5:63:e8:34:8c:ee
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr ea:00:a7:bb:63:c4
}</pre>
