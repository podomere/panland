...
subtitle: "Deep Dive?"
layout: research
ip_v4_address: "56.88.180.114"
date: 2022-04-24T18:59:58+01:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like <code>56.88.180.114</code> or an IPv6 address like <code>2000:b89f:5372:6727:cc9b:8995:1354:b8e7</code>. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>16:c2:7d:49:be:13</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://wolf-ohara.io you initially access a DNS server to translate the host portion (wolf-ohara) combined with the Top Level Domain (io) of the URL, to an IP address like <code>157.33.185.93</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (Windows NT 6.1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/41.0.2228.0 Safari/537.36</code>
...
<pre><code>
default   fe80:4d40:d3b5:3488:14d2%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {194.217.189.178, 48.94.155.237}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 16:c2:7d:49:be:13
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 7d:f5:00:4a:41:be
}</code></pre>
