---
title: "How Do You Test Ping Connectivity"
subtitle: "Granular?"
layout: research
ip_v4_address: "191.96.16.218"
date: 2022-11-19T19:13:27+00:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like ```191.96.16.218``` or an IPv6 address like ```2000:8676:1904:b08d:3c5a:3b78:d6f2:3e73```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```cb:11:46:e2:f3:de```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://bailey-jacobs.name you initially access a DNS server to translate the host portion (bailey-jacobs) combined with the Top Level Domain (name) of the URL, to an IP address like ```58.141.135.167```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (compatible; MSIE 9.0; AOL 9.7; AOLBuild 4343.19; Windows NT 6.1; WOW64; Trident/5.0; FunWebProducts)```

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```10.150.204.161``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  10.150.204.161    UGScg  en0
...
<pre>
default   fe80:2c4a:a746:b424:e18e%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {66.197.3.102, 29.211.151.173}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr cb:11:46:e2:f3:de
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 69:43:cd:97:7c:59
}</pre>
