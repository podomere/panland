...
layout: research
ip_v4_address: "120.231.47.243"
date: 2022-12-15T13:50:21+00:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like ```120.231.47.243``` or an IPv6 address like ```2000:ffb6:74eb:ac8:fe0:38ef:f205:30cf```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```01:a1:7c:ce:12:38```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://harber.com you initially access a DNS server to translate the host portion (harber) combined with the Top Level Domain (com) of the URL, to an IP address like ```247.51.238.106```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/41.0.2228.0 Safari/537.36```
...
<pre>
default   fe80:6231:91f8:758d:ad9f%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {210.73.32.160, 60.72.231.202}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 01:a1:7c:ce:12:38
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 87:b7:0b:03:b9:55
}</pre>
