...
layout: research
ip_v4_address: "18.217.26.217"
date: 2022-04-24T19:00:00+01:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like <code>18.217.26.217</code> or an IPv6 address like <code>2000:dc01:9037:103d:4efc:daa:d3fc:9736</code>. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>bd:5a:c0:6d:c0:e7</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://collier.name you initially access a DNS server to translate the host portion (collier) combined with the Top Level Domain (name) of the URL, to an IP address like <code>57.73.165.15</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Opera/9.80 (X11; Linux i686; Ubuntu/14.10) Presto/2.12.388 Version/12.16</code>
...
<pre><code>
default   fe80:7374:799f:37c4:8b59%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {84.5.171.244, 26.89.82.243}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr bd:5a:c0:6d:c0:e7
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr e2:5e:bb:46:b9:ea
}</code></pre>
