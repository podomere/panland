...
subtitle: "Ideate?"
layout: research
ip_v4_address: "254.180.225.195"
date: 2022-11-19T16:17:05+00:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like ```254.180.225.195``` or an IPv6 address like ```2000:ad63:e574:d02e:701d:65a2:a0b8:8d77```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```3f:04:ce:fc:1e:b0```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://schmitt-buckridge.info you initially access a DNS server to translate the host portion (schmitt-buckridge) combined with the Top Level Domain (info) of the URL, to an IP address like ```170.229.250.213```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1; WOW64; Trident/7.0; AS; rv:11.0) like Gecko```

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```10.13.167.93``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  10.13.167.93    UGScg  en0
...
<pre>
default   fe80:2f4b:6c71:2421:3bf4%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {223.215.250.186, 41.88.117.157}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 3f:04:ce:fc:1e:b0
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr e9:1f:94:39:4a:a0
}</pre>
