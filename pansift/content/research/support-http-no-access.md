...
layout: research
ip_v4_address: "0.119.70.5"
date: 2022-12-15T13:50:20+00:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like ```0.119.70.5``` or an IPv6 address like ```2000:ee63:256a:8a79:34c9:d49c:c056:8ba9```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```65:74:11:60:36:19```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://bernhard.io you initially access a DNS server to translate the host portion (bernhard) combined with the Top Level Domain (io) of the URL, to an IP address like ```103.203.254.225```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (compatible; MSIE 9.0; AOL 9.7; AOLBuild 4343.19; Windows NT 6.1; WOW64; Trident/5.0; FunWebProducts)```

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```172.17.96.243``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  172.17.96.243    UGScg  en0
...
<pre>
default   fe80:5208:ddbe:77e5:e28a%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {192.231.114.84, 79.94.132.119}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 65:74:11:60:36:19
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr e1:07:3c:db:cc:f9
}</pre>
...
## Apple macOS / OSX
No matter what version of OSX/macOS you are on, ```10.12.9```, ```11.2.4```, or ```12.3.3```, there are a range of tools for troubleshooting. Unfortunately, between these manual actions and scripts, they don't give you a series of correlated values over time. This is where automated remote troubleshooting comes in to its own, especially for teams that embrace remote work and Work From Anywhere (WFA).
