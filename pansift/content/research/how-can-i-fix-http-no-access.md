...
layout: research
ip_v4_address: "8.101.133.245"
date: 2022-06-04T14:38:43+01:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like ```8.101.133.245``` or an IPv6 address like ```2000:a7dc:80af:ddc:1c22:e5e:52f7:26db```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```78:46:e2:e0:aa:c7```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://beier.info you initially access a DNS server to translate the host portion (beier) combined with the Top Level Domain (info) of the URL, to an IP address like ```68.24.73.41```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT x.y; Win64; x64; rv:10.0) Gecko/20100101 Firefox/10.0```

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```172.20.235.125``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  172.20.235.125    UGScg  en0
...
<pre>
default   fe80:5690:453d:f84f:dca2%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {100.13.109.208, 150.164.152.189}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 78:46:e2:e0:aa:c7
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 6f:fe:c3:91:0f:75
}</pre>
...
## Apple macOS / OSX
No matter what version of OSX/macOS you are on, ```10.14.9```, ```11.1.2```, or ```12.0.4```, there are a range of tools for troubleshooting. Unfortunately, between these manual actions and scripts, they don't give you a series of correlated values over time. This is where automated remote troubleshooting comes in to its own, especially for teams that embrace remote work and Work From Anywhere (WFA).
