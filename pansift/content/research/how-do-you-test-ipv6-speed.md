...
layout: research
ip_v4_address: "202.116.49.170"
date: 2023-10-29T15:13:25+00:00
draft: false
---

## Internet Addressing
On the Internet you might get a Public IPv4 address like ```202.116.49.170``` or an IPv6 address like ```2000:e5dc:8e39:6253:23d3:a812:47b4:458e```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```0b:24:d8:19:78:e4```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://torphy.co you initially access a DNS server to translate the host portion (torphy) combined with the Top Level Domain (co) of the URL, to an IP address like ```33.191.0.68```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT x.y; Win64; x64; rv:10.0) Gecko/20100101 Firefox/10.0```
...
<pre>
default   fe80:d3f5:f6f7:ebba:7cf8%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {122.199.153.205, 185.199.251.64}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 0b:24:d8:19:78:e4
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 98:95:9d:9e:46:6b
}</pre>
