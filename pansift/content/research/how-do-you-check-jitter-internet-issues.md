...
layout: research
ip_v4_address: "65.167.163.46"
date: 2022-04-24T19:00:00+01:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like <code>65.167.163.46</code> or an IPv6 address like <code>2000:c2c9:ff02:4b03:65dc:5347:a97b:391f</code>. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>cd:82:bf:58:97:af</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://casper.info you initially access a DNS server to translate the host portion (casper) combined with the Top Level Domain (info) of the URL, to an IP address like <code>75.208.115.245</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (Windows NT x.y; Win64; x64; rv:10.0) Gecko/20100101 Firefox/10.0</code>

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like <code>192.168.148.48</code> (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For <code>IPv6</code> we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  192.168.148.48    UGScg  en0
...
<pre><code>
default   fe80:9c56:beb8:a9d5:4be%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {179.110.84.163, 65.161.208.93}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr cd:82:bf:58:97:af
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr e6:bc:af:e7:6f:27
}</code></pre>
