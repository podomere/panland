---
title: "How To Test IPv6 Protocol"
subtitle: "T-shirt Sizes?"
layout: research
ip_v4_address: "78.175.154.95"
date: 2022-11-19T16:17:19+00:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like ```78.175.154.95``` or an IPv6 address like ```2000:19e7:9332:a0c3:8c63:e1c4:db6c:3fc2```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```6b:a4:1c:5a:6d:b4```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://tillman-koepp.org you initially access a DNS server to translate the host portion (tillman-koepp) combined with the Top Level Domain (org) of the URL, to an IP address like ```30.104.133.132```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (compatible; MSIE 9.0; AOL 9.7; AOLBuild 4343.19; Windows NT 6.1; WOW64; Trident/5.0; FunWebProducts)```

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```10.26.106.44``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  10.26.106.44    UGScg  en0
...
<pre>
default   fe80:b253:34ed:b7b4:ac0d%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {231.68.176.25, 45.82.67.45}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 6b:a4:1c:5a:6d:b4
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 66:d2:5b:d8:38:6f
}</pre>
