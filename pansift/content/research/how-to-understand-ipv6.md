...
layout: research
ip_v4_address: "63.106.151.111"
date: 2022-06-12T14:09:24+01:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like ```63.106.151.111``` or an IPv6 address like ```2000:3869:9f4a:ea86:700d:f8e5:822f:e203```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```d0:33:3f:72:a8:f8```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://kulas-gutkowski.co you initially access a DNS server to translate the host portion (kulas-gutkowski) combined with the Top Level Domain (co) of the URL, to an IP address like ```125.132.215.34```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT x.y; Win64; x64; rv:10.0) Gecko/20100101 Firefox/10.0```
...
<pre>
default   fe80:bab:aedd:ff78:c7e1%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {243.7.117.148, 197.146.99.48}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr d0:33:3f:72:a8:f8
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 45:34:a8:56:c9:79
}</pre>
