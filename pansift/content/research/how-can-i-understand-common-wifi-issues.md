...
layout: research
ip_v4_address: "108.100.25.25"
date: 2022-05-05T14:28:29+01:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like ```108.100.25.25``` or an IPv6 address like ```2000:b4dd:98cc:167e:b5ba:b5d4:1d6b:8b33```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```6c:77:58:53:ab:6b```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://windler.biz you initially access a DNS server to translate the host portion (windler) combined with the Top Level Domain (biz) of the URL, to an IP address like ```69.200.76.37```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (compatible; MSIE 9.0; AOL 9.7; AOLBuild 4343.19; Windows NT 6.1; WOW64; Trident/5.0; FunWebProducts)```

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```172.22.225.7``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  172.22.225.7    UGScg  en0
...
<pre>
default   fe80:7562:2ee2:c400:b570%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {105.236.26.197, 255.245.3.156}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 6c:77:58:53:ab:6b
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 1d:ac:12:df:55:66
}</pre>
...
## Apple macOS / OSX
No matter what version of OSX/macOS you are on, ```10.15.9```, ```11.3.4```, or ```12.2.6```, there are a range of tools for troubleshooting. Unfortunately, between these manual actions and scripts, they don't give you a series of correlated values over time. This is where automated remote troubleshooting comes in to its own, especially for teams that embrace remote work and Work From Anywhere (WFA).
