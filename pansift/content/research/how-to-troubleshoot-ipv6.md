...
layout: research
ip_v4_address: "178.176.210.153"
date: 2022-12-15T13:50:16+00:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like ```178.176.210.153``` or an IPv6 address like ```2000:af5a:399c:224f:3d19:84b0:e131:72c5```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```e0:bc:c8:dc:46:ba```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://fadel.org you initially access a DNS server to translate the host portion (fadel) combined with the Top Level Domain (org) of the URL, to an IP address like ```150.122.61.5```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1; WOW64; Trident/7.0; AS; rv:11.0) like Gecko```
...
<pre>
default   fe80:3a4d:1bc3:37da:8b35%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {127.39.136.93, 22.61.195.68}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr e0:bc:c8:dc:46:ba
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 82:ef:da:88:39:29
}</pre>
