...
layout: research
ip_v4_address: "156.80.184.197"
date: 2023-10-06T17:10:31+01:00
draft: false
---

## Internet Addressing
On the Internet you might have a Public IPv4 address like ```156.80.184.197``` or an IPv6 address like ```2000:f6e7:904b:d57f:5cb:bab3:2dd3:e6ee```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```01:3b:ad:ce:d3:76```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://brakus-wehner.org you initially access a DNS server to translate the host portion (brakus-wehner) combined with the Top Level Domain (org) of the URL, to an IP address like ```205.63.82.253```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1; WOW64; Trident/7.0; AS; rv:11.0) like Gecko```

## Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```10.125.187.81``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  10.125.187.81    UGScg  en0
...
<pre>
default   fe80:c3e8:e35e:2684:e9be%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {206.240.159.141, 184.223.142.179}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 01:3b:ad:ce:d3:76
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 44:1e:9e:6c:f7:c9
}</pre>
