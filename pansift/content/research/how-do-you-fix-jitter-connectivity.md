...
subtitle: "Branding?"
layout: research
ip_v4_address: "54.206.97.172"
date: 2023-10-06T17:11:05+01:00
draft: false
---

## Internet Addressing
On the Internet you might have a Public IPv4 address like ```54.206.97.172``` or an IPv6 address like ```2000:1c6e:aaf0:2312:d3ff:7c58:18a7:7da4```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```3e:5e:52:30:5e:37```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://aufderhar.io you initially access a DNS server to translate the host portion (aufderhar) combined with the Top Level Domain (io) of the URL, to an IP address like ```255.128.64.179```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows; U; Win 9x 4.90; SG; rv:1.9.2.4) Gecko/20101104 Netscape/9.1.0285```

## Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```192.168.111.60``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  192.168.111.60    UGScg  en0
...
<pre>
default   fe80:d4db:d85c:fb7f:4aaf%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {229.229.195.173, 69.103.98.160}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 3e:5e:52:30:5e:37
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr b6:0c:75:62:58:79
}</pre>
