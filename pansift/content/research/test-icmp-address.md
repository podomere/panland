...
subtitle: "Etc. Etc.?"
layout: research
ip_v4_address: "140.8.238.202"
date: 2022-06-12T14:09:26+01:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like ```140.8.238.202``` or an IPv6 address like ```2000:5e53:5eb0:b95d:c312:776d:9ed8:33df```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```d2:ae:8f:03:d7:7c```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://ratke-ullrich.io you initially access a DNS server to translate the host portion (ratke-ullrich) combined with the Top Level Domain (io) of the URL, to an IP address like ```175.23.192.189```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT x.y; Win64; x64; rv:10.0) Gecko/20100101 Firefox/10.0```
...
<pre>
default   fe80:411b:5011:6031:efd5%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {208.55.104.95, 141.193.147.38}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr d2:ae:8f:03:d7:7c
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 48:0b:58:e0:f8:4f
}</pre>
...
## Apple macOS / OSX
No matter what version of OSX/macOS you are on, ```10.14.8```, ```11.3.6```, or ```12.0.3```, there are a range of tools for troubleshooting. Unfortunately, between these manual actions and scripts, they don't give you a series of correlated values over time. This is where automated remote troubleshooting comes in to its own, especially for teams that embrace remote work and Work From Anywhere (WFA).
