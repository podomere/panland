...
layout: research
ip_v4_address: "252.159.215.131"
date: 2023-02-04T17:07:49+00:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like ```252.159.215.131``` or an IPv6 address like ```2000:660c:7c0b:374:8703:1b8d:c30e:4859```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```02:45:26:01:14:bb```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://schultz-larkin.com you initially access a DNS server to translate the host portion (schultz-larkin) combined with the Top Level Domain (com) of the URL, to an IP address like ```23.128.41.209```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT x.y; Win64; x64; rv:10.0) Gecko/20100101 Firefox/10.0```
...
default  172.19.89.232    UGScg  en0
...
<pre>
default   fe80:93c5:9e67:3a89:5943%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {100.88.252.56, 121.136.55.166}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 02:45:26:01:14:bb
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 2c:2a:77:f0:4c:5b
}</pre>
