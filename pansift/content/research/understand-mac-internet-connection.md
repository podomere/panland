...
layout: research
ip_v4_address: "232.131.113.65"
date: 2022-06-04T14:38:30+01:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like ```232.131.113.65``` or an IPv6 address like ```2000:9301:d904:4a3f:cdf6:2231:2014:c319```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```49:55:25:c9:78:3b```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://cruickshank-goyette.info you initially access a DNS server to translate the host portion (cruickshank-goyette) combined with the Top Level Domain (info) of the URL, to an IP address like ```136.105.196.154```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1; WOW64; Trident/7.0; AS; rv:11.0) like Gecko```
...
<pre>
default   fe80:fec7:37c4:eb05:f104%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {66.126.191.65, 90.220.21.54}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 49:55:25:c9:78:3b
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 1f:c4:50:2b:11:4c
}</pre>
