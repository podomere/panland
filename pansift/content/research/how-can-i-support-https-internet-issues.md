...
layout: research
ip_v4_address: "223.146.132.78"
date: 2022-11-19T19:13:29+00:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like ```223.146.132.78``` or an IPv6 address like ```2000:f234:7489:6428:33a7:be47:96a4:b579```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```f3:d9:2c:6b:26:0c```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://witting-marvin.net you initially access a DNS server to translate the host portion (witting-marvin) combined with the Top Level Domain (net) of the URL, to an IP address like ```244.36.131.243```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_3) AppleWebKit/537.75.14 (KHTML, like Gecko) Version/7.0.3 Safari/7046A194A```
...
<pre>
default   fe80:a740:fae7:8e9d:4e03%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {62.57.170.89, 69.63.1.33}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr f3:d9:2c:6b:26:0c
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr b3:a2:14:24:5f:82
}</pre>
