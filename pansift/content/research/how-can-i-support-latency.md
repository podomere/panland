...
layout: research
ip_v4_address: "179.18.161.195"
date: 2022-12-15T13:50:18+00:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like ```179.18.161.195``` or an IPv6 address like ```2000:beec:c470:c369:e431:ae6b:e598:5b68```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```38:dd:18:26:b7:62```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://romaguera-watsica.net you initially access a DNS server to translate the host portion (romaguera-watsica) combined with the Top Level Domain (net) of the URL, to an IP address like ```51.56.6.243```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1; WOW64; Trident/7.0; AS; rv:11.0) like Gecko```

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```192.168.235.86``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  192.168.235.86    UGScg  en0
...
<pre>
default   81b:87c:f33f:ef:2ce9:14ca:78fa:aed8%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {45.15.58.212, 7.52.16.215}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 38:dd:18:26:b7:62
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr bd:38:b8:8a:95:48
}</pre>
