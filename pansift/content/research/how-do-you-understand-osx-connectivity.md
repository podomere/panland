...
layout: research
ip_v4_address: "180.251.212.104"
date: 2023-02-04T16:26:11+00:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like ```180.251.212.104``` or an IPv6 address like ```2000:faf:966f:61e8:ec13:89f8:c7d2:d648```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```1d:ad:f1:ac:a9:50```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://hilpert-beatty.co you initially access a DNS server to translate the host portion (hilpert-beatty) combined with the Top Level Domain (co) of the URL, to an IP address like ```72.150.65.183```. Your computer and browser actually sends its type with all web requests e.g. <br>```Opera/9.80 (X11; Linux i686; Ubuntu/14.10) Presto/2.12.388 Version/12.16```
...
<pre>
default   fe80:7f90:5bce:e7a8:955%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {63.43.80.49, 79.65.189.130}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 1d:ad:f1:ac:a9:50
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 32:a8:03:19:b6:79
}</pre>
