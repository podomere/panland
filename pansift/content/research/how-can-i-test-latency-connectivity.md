...
layout: research
ip_v4_address: "193.108.162.242"
date: 2023-10-29T15:13:26+00:00
draft: false
---

## Internet Addressing
On the Internet you might get a Public IPv4 address like ```193.108.162.242``` or an IPv6 address like ```2000:4319:f53c:4363:89c:2800:f7ac:485a```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```7c:33:82:36:a8:29```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://lang-vandervort.net you initially access a DNS server to translate the host portion (lang-vandervort) combined with the Top Level Domain (net) of the URL, to an IP address like ```190.191.77.235```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows; U; Win 9x 4.90; SG; rv:1.9.2.4) Gecko/20101104 Netscape/9.1.0285```
...
<pre>
default   fe80:8303:2f72:a33e:8af3%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {161.38.250.149, 124.66.185.243}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 7c:33:82:36:a8:29
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 57:70:bb:54:a7:44
}</pre>
...
### Apple macOS / OSX
No matter what version of OSX/macOS you are on, ```10.15.2```, ```11.2.3```, or ```12.0.5```, there are a range of tools for troubleshooting. Unfortunately, between these manual actions and scripts, they don't give you a series of correlated values over time. This is where automated remote troubleshooting comes in to its own, especially for teams that embrace remote work and Work From Anywhere (WFA).
