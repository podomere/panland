...
layout: research
ip_v4_address: "92.237.194.1"
date: 2022-04-24T18:31:58+01:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like <code>92.237.194.1</code> or an IPv6 address like <code>2000:b27b:f344:1cbf:408b:cbad:c706:54af</code>. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>0c:96:46:63:21:ac</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://morar-weber.name you initially access a DNS server to translate the host portion (morar-weber) combined with the Top Level Domain (name) of the URL, to an IP address like <code>53.186.221.179</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Opera/9.80 (X11; Linux i686; Ubuntu/14.10) Presto/2.12.388 Version/12.16</code>
...
<pre><code>
default   fe80:a5a0:308b:57e5:8e61%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {222.177.249.154, 251.99.128.84}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 0c:96:46:63:21:ac
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr d7:bf:62:4c:2e:e8
}</code></pre>
