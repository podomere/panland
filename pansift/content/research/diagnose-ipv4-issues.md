...
subtitle: "Synergy?"
layout: research
ip_v4_address: "84.212.162.242"
date: 2022-11-02T11:32:53+00:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like ```84.212.162.242``` or an IPv6 address like ```2000:159f:d9a5:91ff:5bc5:64dd:4001:f733```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```aa:e7:05:7f:c7:33```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://block-kautzer.co you initially access a DNS server to translate the host portion (block-kautzer) combined with the Top Level Domain (co) of the URL, to an IP address like ```74.208.31.232```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_3) AppleWebKit/537.75.14 (KHTML, like Gecko) Version/7.0.3 Safari/7046A194A```
...
<pre>
default   fe80:a193:a6ef:9634:6d0a%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {154.58.108.21, 177.90.30.209}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr aa:e7:05:7f:c7:33
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr da:07:fd:a2:10:4b
}</pre>
