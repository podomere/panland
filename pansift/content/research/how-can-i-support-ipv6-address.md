...
subtitle: "Etc. Etc.?"
layout: research
ip_v4_address: "102.147.139.129"
date: 2022-04-24T18:59:56+01:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like <code>102.147.139.129</code> or an IPv6 address like <code>2000:853a:a529:ecff:5467:2791:e526:a545</code>. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>18:df:2e:b9:95:14</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://jakubowski-spinka.name you initially access a DNS server to translate the host portion (jakubowski-spinka) combined with the Top Level Domain (name) of the URL, to an IP address like <code>226.115.201.123</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (Windows NT x.y; Win64; x64; rv:10.0) Gecko/20100101 Firefox/10.0</code>
...
<pre><code>
default   fe80:8b5b:160c:9803:892c%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {96.50.66.115, 0.111.99.150}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 18:df:2e:b9:95:14
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr f6:98:b7:81:f3:aa
}</code></pre>
