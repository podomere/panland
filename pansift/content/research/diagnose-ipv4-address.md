...
layout: research
ip_v4_address: "136.48.99.24"
date: 2023-02-04T16:26:18+00:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like ```136.48.99.24``` or an IPv6 address like ```2000:459f:2cc8:e35e:85ca:98a6:2823:e837```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```e6:95:e8:52:a6:0a```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://strosin.net you initially access a DNS server to translate the host portion (strosin) combined with the Top Level Domain (net) of the URL, to an IP address like ```195.19.101.19```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (compatible; MSIE 9.0; AOL 9.7; AOLBuild 4343.19; Windows NT 6.1; WOW64; Trident/5.0; FunWebProducts)```
...
<pre>
default   fe80:de1:27b:5389:71e%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {134.188.83.33, 174.40.75.169}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr e6:95:e8:52:a6:0a
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr f8:5c:07:da:f7:0f
}</pre>
