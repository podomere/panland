...
layout: research
ip_v4_address: "164.201.137.176"
date: 2023-02-04T16:26:18+00:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like ```164.201.137.176``` or an IPv6 address like ```2000:876e:371d:a0c2:6322:d3d5:d02e:b4d1```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```8b:2a:73:9f:48:52```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://bayer-christiansen.net you initially access a DNS server to translate the host portion (bayer-christiansen) combined with the Top Level Domain (net) of the URL, to an IP address like ```75.214.191.59```. Your computer and browser actually sends its type with all web requests e.g. <br>```Opera/9.80 (X11; Linux i686; Ubuntu/14.10) Presto/2.12.388 Version/12.16```

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```172.19.186.134``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  172.19.186.134    UGScg  en0
...
<pre>
default   fe80:e26f:5280:ae16:29a4%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {243.255.191.241, 238.38.113.223}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 8b:2a:73:9f:48:52
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr af:3f:74:4b:4b:5e
}</pre>
...
## Apple macOS / OSX
No matter what version of OSX/macOS you are on, ```10.14.5```, ```11.5.4```, or ```12.2.2```, there are a range of tools for troubleshooting. Unfortunately, between these manual actions and scripts, they don't give you a series of correlated values over time. This is where automated remote troubleshooting comes in to its own, especially for teams that embrace remote work and Work From Anywhere (WFA).
