...
subtitle: "Ideate?"
layout: research
ip_v4_address: "130.192.111.188"
date: 2023-10-06T17:11:03+01:00
draft: false
---

## Internet Addressing
On the Internet you may have a Public IPv4 address like ```130.192.111.188``` or an IPv6 address like ```2000:3c3d:3e3c:a6ef:c880:e222:dc96:af99```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```0e:24:88:79:ae:29```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://pouros-doyle.name you initially access a DNS server to translate the host portion (pouros-doyle) combined with the Top Level Domain (name) of the URL, to an IP address like ```96.177.119.2```. Your computer and browser actually sends its type with all web requests e.g. <br>```Opera/9.80 (X11; Linux i686; Ubuntu/14.10) Presto/2.12.388 Version/12.16```
...
<pre>
default   fe80:d5fc:348a:5e3e:743c%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {25.199.60.49, 80.137.100.255}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 0e:24:88:79:ae:29
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr b6:0d:9e:19:f8:ab
}</pre>
