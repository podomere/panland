...
layout: research
ip_v4_address: "170.167.132.62"
date: 2022-04-24T19:00:24+01:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like <code>170.167.132.62</code> or an IPv6 address like <code>2000:72ca:af88:14aa:1a6d:b2a1:1691:30f3</code>. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>d3:f5:41:16:6f:8e</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://kub.net you initially access a DNS server to translate the host portion (kub) combined with the Top Level Domain (net) of the URL, to an IP address like <code>119.68.243.7</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (Windows NT x.y; Win64; x64; rv:10.0) Gecko/20100101 Firefox/10.0</code>
...
<pre><code>
default   fe80:c36b:7052:25a1:1c8c%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {5.4.63.50, 56.92.212.162}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr d3:f5:41:16:6f:8e
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 82:cd:79:4e:bf:92
}</code></pre>
