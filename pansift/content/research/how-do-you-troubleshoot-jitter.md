...
layout: research
ip_v4_address: "179.146.54.184"
date: 2022-04-24T19:00:00+01:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like <code>179.146.54.184</code> or an IPv6 address like <code>2000:118d:d31b:ca52:d15:3114:8467:ed4c</code>. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>e0:86:cb:83:14:db</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://frami.net you initially access a DNS server to translate the host portion (frami) combined with the Top Level Domain (net) of the URL, to an IP address like <code>35.211.87.248</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (Windows NT 6.1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/41.0.2228.0 Safari/537.36</code>
...
<pre><code>
default   fe80:834:638b:cc33:4b60%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {101.246.201.117, 26.237.191.222}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr e0:86:cb:83:14:db
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 4b:4d:a7:83:93:4c
}</code></pre>
