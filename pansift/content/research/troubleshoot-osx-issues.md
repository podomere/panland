...
layout: research
ip_v4_address: "186.218.75.224"
date: 2022-04-24T18:31:58+01:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like <code>186.218.75.224</code> or an IPv6 address like <code>2000:554c:46d2:7bbc:3708:8da:2c02:2148</code>. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>d6:3c:cd:16:ca:60</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://okon-waelchi.co you initially access a DNS server to translate the host portion (okon-waelchi) combined with the Top Level Domain (co) of the URL, to an IP address like <code>149.31.17.199</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (Windows NT x.y; Win64; x64; rv:10.0) Gecko/20100101 Firefox/10.0</code>

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like <code>172.27.118.231</code> (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For <code>IPv6</code> we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  172.27.118.231    UGScg  en0
...
<pre><code>
default   fe80:8928:b806:a73:7198%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {155.140.183.86, 101.20.107.68}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr d6:3c:cd:16:ca:60
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr ac:9f:75:80:1a:74
}</code></pre>
