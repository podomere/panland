...
layout: research
ip_v4_address: "168.20.77.21"
date: 2023-10-29T15:13:27+00:00
draft: false
---

## Internet Addressing
On the Internet you might get a Public IPv4 address like ```168.20.77.21``` or an IPv6 address like ```2000:12ae:d922:4531:ae7d:e40a:a177:23c9```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```99:8d:5a:05:31:0d```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://mccullough-rippin.biz you initially access a DNS server to translate the host portion (mccullough-rippin) combined with the Top Level Domain (biz) of the URL, to an IP address like ```254.86.227.133```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1; WOW64; Trident/7.0; AS; rv:11.0) like Gecko```
...
<pre>
default   fe80:8d1c:cbe6:c2a5:8916%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {22.195.201.131, 77.80.195.121}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 99:8d:5a:05:31:0d
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr fc:10:da:08:31:ba
}</pre>
...
### Apple macOS / OSX
No matter what version of OSX/macOS you are on, ```10.12.7```, ```11.1.5```, or ```12.1.6```, there are a range of tools for troubleshooting. Unfortunately, between these manual actions and scripts, they don't give you a series of correlated values over time. This is where automated remote troubleshooting comes in to its own, especially for teams that embrace remote work and Work From Anywhere (WFA).
