...
layout: research
ip_v4_address: "74.243.242.81"
date: 2023-02-04T16:26:10+00:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like ```74.243.242.81``` or an IPv6 address like ```2000:1a95:4c53:aa8d:691:ea5c:8a76:9244```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```b1:d1:e1:e3:52:32```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://dibbert-streich.net you initially access a DNS server to translate the host portion (dibbert-streich) combined with the Top Level Domain (net) of the URL, to an IP address like ```54.19.181.232```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows; U; Win 9x 4.90; SG; rv:1.9.2.4) Gecko/20101104 Netscape/9.1.0285```
...
<pre>
default   fe80:4aa0:343f:74b8:b0c0%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {249.232.117.100, 120.21.173.249}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr b1:d1:e1:e3:52:32
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr fd:7b:15:a4:82:50
}</pre>
