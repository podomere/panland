...
layout: research
ip_v4_address: "244.208.177.11"
date: 2023-02-04T16:26:20+00:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like ```244.208.177.11``` or an IPv6 address like ```2000:680e:8db8:2a9e:a07a:5158:7a3b:6522```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```8f:81:d2:cc:5c:e9```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://klein-dubuque.io you initially access a DNS server to translate the host portion (klein-dubuque) combined with the Top Level Domain (io) of the URL, to an IP address like ```65.72.235.55```. Your computer and browser actually sends its type with all web requests e.g. <br>```Opera/9.80 (X11; Linux i686; Ubuntu/14.10) Presto/2.12.388 Version/12.16```
...
<pre>
default   fe80:63ca:23d2:a131:b736%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {53.201.77.106, 244.191.252.226}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 8f:81:d2:cc:5c:e9
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr c6:7d:fa:29:5b:ea
}</pre>
