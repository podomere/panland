...
layout: research
ip_v4_address: "32.25.195.192"
date: 2023-10-29T15:13:26+00:00
draft: false
---

## Internet Addressing
On the Internet you might get a Public IPv4 address like ```32.25.195.192``` or an IPv6 address like ```2000:6914:dade:53c:d50:bf9b:c624:1654```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```c1:ed:ce:5b:f4:ae```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://heathcote.net you initially access a DNS server to translate the host portion (heathcote) combined with the Top Level Domain (net) of the URL, to an IP address like ```133.17.86.167```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT x.y; Win64; x64; rv:10.0) Gecko/20100101 Firefox/10.0```

## Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```172.26.241.242``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  172.26.241.242    UGScg  en0
...
<pre>
default   fe80:7918:eb3:43e2:b49f%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {123.197.23.163, 117.167.25.241}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr c1:ed:ce:5b:f4:ae
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 41:b0:f9:fc:f3:03
}</pre>
