...
layout: research
ip_v4_address: "190.191.196.48"
date: 2023-10-29T15:13:26+00:00
draft: false
---

## Internet Addressing
On the Internet you might get a Public IPv4 address like ```190.191.196.48``` or an IPv6 address like ```2000:8dd7:3ec4:c20b:de88:4452:c7a8:3021```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```24:b2:ba:3f:d4:9c```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://bahringer-price.net you initially access a DNS server to translate the host portion (bahringer-price) combined with the Top Level Domain (net) of the URL, to an IP address like ```233.146.5.233```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows; U; Win 9x 4.90; SG; rv:1.9.2.4) Gecko/20101104 Netscape/9.1.0285```

## Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```192.168.35.26``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  192.168.35.26    UGScg  en0
...
<pre>
default   fe80:a3d0:b52b:5dc5:9092%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {119.173.37.206, 157.137.161.134}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 24:b2:ba:3f:d4:9c
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr d9:55:d6:ac:63:32
}</pre>
