...
layout: research
ip_v4_address: "26.218.142.19"
date: 2023-10-06T17:11:03+01:00
draft: false
---

## Internet Addressing
On the Internet you might get a Public IPv4 address like ```26.218.142.19``` or an IPv6 address like ```2000:ee94:c81f:1dcb:6830:d207:f042:a0dc```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```ee:51:0b:b3:40:71```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://jast-armstrong.org you initially access a DNS server to translate the host portion (jast-armstrong) combined with the Top Level Domain (org) of the URL, to an IP address like ```133.219.233.205```. Your computer and browser actually sends its type with all web requests e.g. <br>```Opera/9.80 (X11; Linux i686; Ubuntu/14.10) Presto/2.12.388 Version/12.16```

## Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```172.30.109.80``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  172.30.109.80    UGScg  en0
...
<pre>
default   fe80:3c3d:1952:b004:5ca7%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {139.101.31.14, 116.211.125.127}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr ee:51:0b:b3:40:71
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr e6:c3:44:5c:2a:d3
}</pre>
