...
subtitle: "Deep Dive?"
layout: research
ip_v4_address: "151.225.217.209"
date: 2022-04-24T18:31:58+01:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like <code>151.225.217.209</code> or an IPv6 address like <code>2000:93ce:7281:38d3:ac15:42de:13e:bae6</code>. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>fe:71:2d:34:32:f2</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://murazik-koch.io you initially access a DNS server to translate the host portion (murazik-koch) combined with the Top Level Domain (io) of the URL, to an IP address like <code>161.173.109.200</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (Windows NT 6.1; WOW64; Trident/7.0; AS; rv:11.0) like Gecko</code>
...
<pre><code>
default   fe80:f4b6:35ec:6ba5:2e22%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {62.52.41.217, 170.102.35.97}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr fe:71:2d:34:32:f2
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr ae:76:9b:4a:97:00
}</code></pre>
