...
layout: research
ip_v4_address: "213.87.251.205"
date: 2022-11-02T11:33:00+00:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like ```213.87.251.205``` or an IPv6 address like ```2000:a8fb:9a0c:7a4c:2101:4850:4fa5:870c```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```1f:7b:98:9c:ce:c6```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://swift.io you initially access a DNS server to translate the host portion (swift) combined with the Top Level Domain (io) of the URL, to an IP address like ```56.199.251.169```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (compatible; MSIE 9.0; AOL 9.7; AOLBuild 4343.19; Windows NT 6.1; WOW64; Trident/5.0; FunWebProducts)```
...
<pre>
default   fe80:f43a:f30a:8912:731%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {255.98.216.25, 56.177.157.116}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 1f:7b:98:9c:ce:c6
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 9c:8a:50:98:08:7b
}</pre>
