...
layout: research
ip_v4_address: "54.107.140.40"
date: 2022-11-19T16:17:12+00:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like ```54.107.140.40``` or an IPv6 address like ```2000:1c2a:2460:a4e3:fc9:ab39:e77a:b614```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```c1:a1:08:4b:80:ab```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://schiller-braun.org you initially access a DNS server to translate the host portion (schiller-braun) combined with the Top Level Domain (org) of the URL, to an IP address like ```191.250.16.139```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1; WOW64; Trident/7.0; AS; rv:11.0) like Gecko```
...
<pre>
default   fe80:bbd7:2875:5ed0:9d4e%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {93.222.119.142, 171.154.87.165}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr c1:a1:08:4b:80:ab
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 58:e2:25:39:41:3b
}</pre>
