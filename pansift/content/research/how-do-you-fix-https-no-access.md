...
layout: research
ip_v4_address: "202.204.108.64"
date: 2022-04-24T19:00:07+01:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like <code>202.204.108.64</code> or an IPv6 address like <code>2000:1da5:2e93:53d6:5f1d:cfe:5b3f:b415</code>. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>39:7b:6e:b3:1d:51</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://hoeger-dubuque.name you initially access a DNS server to translate the host portion (hoeger-dubuque) combined with the Top Level Domain (name) of the URL, to an IP address like <code>25.72.30.224</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (Windows; U; Win 9x 4.90; SG; rv:1.9.2.4) Gecko/20101104 Netscape/9.1.0285</code>
...
<pre><code>
default   fe80:e49a:5aa6:792c:3a26%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {144.62.98.132, 121.59.27.61}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 39:7b:6e:b3:1d:51
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 4e:c8:37:f8:b1:7f
}</code></pre>
