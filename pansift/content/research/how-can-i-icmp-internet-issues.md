...
subtitle: "Learnings?"
layout: research
ip_v4_address: "169.152.2.28"
date: 2022-04-24T19:00:01+01:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like <code>169.152.2.28</code> or an IPv6 address like <code>2000:6701:2aaf:6946:64ad:1c21:df1a:c0cc</code>. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>b5:a4:94:17:b2:1f</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://hoppe-kuhn.org you initially access a DNS server to translate the host portion (hoppe-kuhn) combined with the Top Level Domain (org) of the URL, to an IP address like <code>145.226.46.7</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_3) AppleWebKit/537.75.14 (KHTML, like Gecko) Version/7.0.3 Safari/7046A194A</code>
...
<pre><code>
default   fe80:d5eb:f27d:c56a:1c34%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {118.125.239.119, 170.170.50.61}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr b5:a4:94:17:b2:1f
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 82:7c:3c:f9:2d:c8
}</code></pre>
