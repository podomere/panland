...
layout: research
ip_v4_address: "200.93.70.140"
date: 2022-04-24T18:31:59+01:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like <code>200.93.70.140</code> or an IPv6 address like <code>2000:decd:5b9b:78c6:808d:5b3d:25d9:1716</code>. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>77:10:99:0a:a8:96</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://johnston-goyette.com you initially access a DNS server to translate the host portion (johnston-goyette) combined with the Top Level Domain (com) of the URL, to an IP address like <code>240.121.154.146</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (Windows; U; Win 9x 4.90; SG; rv:1.9.2.4) Gecko/20101104 Netscape/9.1.0285</code>
...
<pre><code>
default   fe80:bc88:91bb:8e4f:e56d%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {99.59.107.61, 78.151.104.242}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 77:10:99:0a:a8:96
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 56:19:10:8e:38:3f
}</code></pre>
