...
layout: research
ip_v4_address: "254.202.137.245"
date: 2023-10-06T17:10:42+01:00
draft: false
---

## Internet Addressing
On the Internet you might get a Public IPv4 address like ```254.202.137.245``` or an IPv6 address like ```2000:8840:7354:c225:1e3d:89:aa7:d72a```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```4d:c5:a8:cf:fb:78```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://aufderhar.name you initially access a DNS server to translate the host portion (aufderhar) combined with the Top Level Domain (name) of the URL, to an IP address like ```28.190.134.247```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows; U; Win 9x 4.90; SG; rv:1.9.2.4) Gecko/20101104 Netscape/9.1.0285```
...
<pre>
default   fe80:6717:3dcc:aecd:5413%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {35.83.212.142, 187.3.6.69}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 4d:c5:a8:cf:fb:78
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr d0:f0:66:b4:9f:7b
}</pre>
