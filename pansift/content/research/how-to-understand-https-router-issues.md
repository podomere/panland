...
subtitle: "Heads Down?"
layout: research
ip_v4_address: "19.198.12.225"
date: 2023-10-29T15:13:30+00:00
draft: false
---

## Internet Addressing
On the Internet you may get a Public IPv4 address like ```19.198.12.225``` or an IPv6 address like ```2000:3b19:9cee:39ab:f793:1b72:ceb4:7f95```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```bb:b9:0d:33:8e:79```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://bosco-leffler.co you initially access a DNS server to translate the host portion (bosco-leffler) combined with the Top Level Domain (co) of the URL, to an IP address like ```166.141.118.156```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows; U; Win 9x 4.90; SG; rv:1.9.2.4) Gecko/20101104 Netscape/9.1.0285```
...
<pre>
default   ca72:2b7f:6fb9:1e:9d4d:3330:21ec:3e96%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {55.25.138.45, 32.172.214.247}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr bb:b9:0d:33:8e:79
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr be:b2:94:b2:2f:e3
}</pre>
