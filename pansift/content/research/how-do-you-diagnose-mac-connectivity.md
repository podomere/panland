...
subtitle: "Tee It Up?"
layout: research
ip_v4_address: "6.185.187.239"
date: 2022-06-04T14:38:30+01:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like ```6.185.187.239``` or an IPv6 address like ```2000:97ea:da36:e152:f01a:f6b1:40d5:50d5```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```97:55:c3:f0:e0:3c```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://koelpin.co you initially access a DNS server to translate the host portion (koelpin) combined with the Top Level Domain (co) of the URL, to an IP address like ```203.53.17.23```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows; U; Win 9x 4.90; SG; rv:1.9.2.4) Gecko/20101104 Netscape/9.1.0285```
...
default  192.168.138.219    UGScg  en0
...
<pre>
default   fe80:dcd2:ac95:5c06:9f10%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {255.139.2.213, 31.141.34.27}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 97:55:c3:f0:e0:3c
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr f9:27:62:78:e0:e9
}</pre>
...
## Apple macOS / OSX
No matter what version of OSX/macOS you are on, ```10.15.3```, ```11.4.7```, or ```12.0.6```, there are a range of tools for troubleshooting. Unfortunately, between these manual actions and scripts, they don't give you a series of correlated values over time. This is where automated remote troubleshooting comes in to its own, especially for teams that embrace remote work and Work From Anywhere (WFA).
