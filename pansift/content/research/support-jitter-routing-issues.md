...
layout: research
ip_v4_address: "58.194.144.138"
date: 2022-11-19T19:13:25+00:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like ```58.194.144.138``` or an IPv6 address like ```2000:44c:134d:dcdd:153d:dec1:520b:bb41```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```50:4b:0d:f5:57:45```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://yost.io you initially access a DNS server to translate the host portion (yost) combined with the Top Level Domain (io) of the URL, to an IP address like ```1.181.84.114```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_3) AppleWebKit/537.75.14 (KHTML, like Gecko) Version/7.0.3 Safari/7046A194A```
...
<pre>
default   fe80:2979:5443:8e65:3c49%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {167.98.152.26, 109.62.189.252}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 50:4b:0d:f5:57:45
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 4b:f9:7d:27:0c:37
}</pre>
