...
layout: research
ip_v4_address: "153.150.1.100"
date: 2022-06-12T14:09:05+01:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like ```153.150.1.100``` or an IPv6 address like ```64:6584:14ee:146a:3e80:a1bc:e55b:d71b```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```e8:d0:e9:72:7d:7a```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://hudson-gutmann.co you initially access a DNS server to translate the host portion (hudson-gutmann) combined with the Top Level Domain (co) of the URL, to an IP address like ```246.176.117.84```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows; U; Win 9x 4.90; SG; rv:1.9.2.4) Gecko/20101104 Netscape/9.1.0285```
...
<pre>
default   fe80:fce7:9c43:d975:c6bb%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {99.98.47.11, 196.22.134.101}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr e8:d0:e9:72:7d:7a
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 80:80:53:05:a2:7f
}</pre>
