---
title: "DiagnOSe Latency Routing Issues"
subtitle: "Expansion Play?"
layout: research
ip_v4_address: "87.255.228.62"
date: 2022-04-24T18:59:57+01:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like <code>87.255.228.62</code> or an IPv6 address like <code>2000:b8c7:ab2:c3fd:249a:572f:1169:561f</code>. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>d9:b4:8a:f8:1a:b1</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://thompson-goodwin.org you initially access a DNS server to translate the host portion (thompson-goodwin) combined with the Top Level Domain (org) of the URL, to an IP address like <code>39.219.88.49</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (compatible; MSIE 9.0; AOL 9.7; AOLBuild 4343.19; Windows NT 6.1; WOW64; Trident/5.0; FunWebProducts)</code>

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like <code>192.168.27.244</code> (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For <code>IPv6</code> we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  192.168.27.244    UGScg  en0
...
<pre><code>
default   fe80:1be:3c17:d110:a4f5%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {124.232.53.88, 22.19.217.71}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr d9:b4:8a:f8:1a:b1
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr a0:53:56:7b:3b:3f
}</code></pre>
...
## Apple macOS / OSX
No matter what version of OSX/macOS you are on, <code>10.13.4</code>, <code>11.3.2</code>, or <code>12.3.6</code>, there are a range of tools for troubleshooting. Unfortunately, between these manual actions and scripts, they don't give you a series of correlated values over time. This is where automated remote troubleshooting comes in to its own, especially for teams that embrace remote work and Work From Anywhere (WFA).
