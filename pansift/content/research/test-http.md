...
subtitle: "Heads Down?"
layout: research
ip_v4_address: "209.173.92.70"
date: 2022-06-12T14:09:28+01:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like ```209.173.92.70``` or an IPv6 address like ```2000:20c9:6d72:6bb3:515f:a183:b01a:d0e9```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```9f:9b:37:b1:cf:d4```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://hirthe-kerluke.com you initially access a DNS server to translate the host portion (hirthe-kerluke) combined with the Top Level Domain (com) of the URL, to an IP address like ```139.193.70.126```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1; WOW64; Trident/7.0; AS; rv:11.0) like Gecko```
...
<pre>
default   fe80:2c13:aea5:f4aa:c46b%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {157.214.90.134, 51.187.144.41}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 9f:9b:37:b1:cf:d4
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 9b:a1:5d:bf:03:c4
}</pre>
