...
layout: research
ip_v4_address: "103.128.24.154"
date: 2022-04-24T19:00:24+01:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like <code>103.128.24.154</code> or an IPv6 address like <code>2000:99a9:4332:2b:f7a3:9497:f337:b7d4</code>. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>19:e4:f7:b0:a9:0d</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://hane-parker.name you initially access a DNS server to translate the host portion (hane-parker) combined with the Top Level Domain (name) of the URL, to an IP address like <code>158.107.234.244</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (Windows NT x.y; Win64; x64; rv:10.0) Gecko/20100101 Firefox/10.0</code>
...
<pre><code>
default   fe80:8aa0:8d47:6915:6267%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {188.56.233.80, 93.98.67.237}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 19:e4:f7:b0:a9:0d
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 63:f6:06:11:7a:b5
}</code></pre>
