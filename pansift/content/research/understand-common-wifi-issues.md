...
subtitle: "Branding?"
layout: research
ip_v4_address: "13.71.114.62"
date: 2022-11-19T16:17:05+00:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like ```13.71.114.62``` or an IPv6 address like ```2000:a120:10b0:5f8d:1cf5:719a:c665:dd78```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```6c:c9:50:05:a6:e9```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://christiansen-mante.org you initially access a DNS server to translate the host portion (christiansen-mante) combined with the Top Level Domain (org) of the URL, to an IP address like ```143.163.17.22```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/41.0.2228.0 Safari/537.36```
...
<pre>
default   fe80:5401:c26b:91da:4d9b%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {105.94.97.120, 232.104.82.6}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 6c:c9:50:05:a6:e9
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 64:5d:28:1a:1b:37
}</pre>
