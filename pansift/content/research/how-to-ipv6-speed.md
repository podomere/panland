...
layout: research
ip_v4_address: "119.132.119.202"
date: 2022-11-19T16:17:19+00:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like ```119.132.119.202``` or an IPv6 address like ```2000:ff42:ddbb:4c7c:371b:a6f8:4e94:dd33```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```93:71:2d:d7:78:0f```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://murazik-champlin.biz you initially access a DNS server to translate the host portion (murazik-champlin) combined with the Top Level Domain (biz) of the URL, to an IP address like ```86.178.225.14```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/41.0.2228.0 Safari/537.36```

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```172.29.179.137``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  172.29.179.137    UGScg  en0
...
<pre>
default   fe80:3e96:717:7c7c:9d90%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {112.130.232.177, 223.42.219.43}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 93:71:2d:d7:78:0f
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 37:9a:0d:73:1f:ae
}</pre>
...
## Apple macOS / OSX
No matter what version of OSX/macOS you are on, ```10.12.3```, ```11.4.5```, or ```12.2.6```, there are a range of tools for troubleshooting. Unfortunately, between these manual actions and scripts, they don't give you a series of correlated values over time. This is where automated remote troubleshooting comes in to its own, especially for teams that embrace remote work and Work From Anywhere (WFA).
