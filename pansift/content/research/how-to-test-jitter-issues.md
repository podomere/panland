...
layout: research
ip_v4_address: "85.61.206.71"
date: 2022-06-04T14:38:40+01:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like ```85.61.206.71``` or an IPv6 address like ```2000:2172:1991:1bd6:4173:80f8:1d0c:831```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```72:de:a0:9a:d4:8f```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://robel-bednar.name you initially access a DNS server to translate the host portion (robel-bednar) combined with the Top Level Domain (name) of the URL, to an IP address like ```57.64.15.211```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1; WOW64; Trident/7.0; AS; rv:11.0) like Gecko```
...
<pre>
default   fe80:d095:1668:be49:68a0%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {68.210.73.93, 105.99.83.84}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 72:de:a0:9a:d4:8f
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 15:bf:20:de:e7:47
}</pre>
