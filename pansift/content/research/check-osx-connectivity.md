...
layout: research
ip_v4_address: "220.242.218.128"
date: 2023-02-04T16:26:10+00:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like ```220.242.218.128``` or an IPv6 address like ```2000:bcec:b155:feee:8d89:9220:23b8:72d1```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```60:50:2e:f5:2a:46```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://orn-torp.name you initially access a DNS server to translate the host portion (orn-torp) combined with the Top Level Domain (name) of the URL, to an IP address like ```128.118.242.224```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (compatible; MSIE 9.0; AOL 9.7; AOLBuild 4343.19; Windows NT 6.1; WOW64; Trident/5.0; FunWebProducts)```
...
<pre>
default   fe80:e7c7:4e65:c3c0:9af1%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {167.154.245.141, 167.159.178.164}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 60:50:2e:f5:2a:46
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr da:a5:59:55:25:3a
}</pre>
