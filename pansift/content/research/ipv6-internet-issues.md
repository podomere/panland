...
subtitle: "Impact Map?"
layout: research
ip_v4_address: "53.93.209.186"
date: 2022-12-15T13:50:16+00:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like ```53.93.209.186``` or an IPv6 address like ```2000:4f03:d46e:20eb:d5b6:79ed:5c19:a81d```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```69:bf:a1:c4:e7:15```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://schamberger-bayer.name you initially access a DNS server to translate the host portion (schamberger-bayer) combined with the Top Level Domain (name) of the URL, to an IP address like ```209.19.41.121```. Your computer and browser actually sends its type with all web requests e.g. <br>```Opera/9.80 (X11; Linux i686; Ubuntu/14.10) Presto/2.12.388 Version/12.16```
...
<pre>
default   fe80:c154:dc36:5aa5:2e13%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {218.247.150.80, 195.238.79.145}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 69:bf:a1:c4:e7:15
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 27:0a:71:c0:b1:80
}</pre>
