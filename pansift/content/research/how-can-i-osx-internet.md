---
title: "How Can I OSX Internet"
subtitle: "Heavy Lifting?"
layout: research
ip_v4_address: "199.92.133.101"
date: 2022-04-24T18:31:57+01:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like <code>199.92.133.101</code> or an IPv6 address like <code>2000:d924:4417:e95:bb6:e37d:6d01:a07d</code>. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>aa:97:f3:53:0c:97</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://zieme-gusikowski.name you initially access a DNS server to translate the host portion (zieme-gusikowski) combined with the Top Level Domain (name) of the URL, to an IP address like <code>178.192.155.23</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (Windows NT 6.1; WOW64; Trident/7.0; AS; rv:11.0) like Gecko</code>

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like <code>192.168.82.79</code> (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For <code>IPv6</code> we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  192.168.82.79    UGScg  en0
...
<pre><code>
default   fe80:8614:fdb8:c009:b85%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {214.180.246.10, 109.254.167.54}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr aa:97:f3:53:0c:97
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 78:fb:4c:ce:62:f2
}</code></pre>
