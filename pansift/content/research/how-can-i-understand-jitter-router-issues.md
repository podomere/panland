...
layout: research
ip_v4_address: "199.249.249.159"
date: 2022-04-24T19:00:00+01:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like <code>199.249.249.159</code> or an IPv6 address like <code>2000:d2d7:895d:9cc3:b08:d83a:bc13:dad7</code>. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>83:17:7f:fb:42:15</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://little-crona.info you initially access a DNS server to translate the host portion (little-crona) combined with the Top Level Domain (info) of the URL, to an IP address like <code>134.162.140.164</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (Windows NT 6.1; WOW64; Trident/7.0; AS; rv:11.0) like Gecko</code>

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like <code>172.22.169.128</code> (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For <code>IPv6</code> we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  172.22.169.128    UGScg  en0
...
<pre><code>
default   fe80:2db2:a59e:733a:d277%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {104.125.85.211, 184.212.78.49}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 83:17:7f:fb:42:15
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 89:da:e9:3f:1f:fb
}</code></pre>
