...
layout: research
ip_v4_address: "83.11.50.140"
date: 2022-04-24T19:00:00+01:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like <code>83.11.50.140</code> or an IPv6 address like <code>2000:bca2:5a77:6345:df0d:fee1:ecf3:fbfc</code>. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>1f:ea:85:bf:8d:00</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://huels-roberts.info you initially access a DNS server to translate the host portion (huels-roberts) combined with the Top Level Domain (info) of the URL, to an IP address like <code>236.237.199.113</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (compatible; MSIE 9.0; AOL 9.7; AOLBuild 4343.19; Windows NT 6.1; WOW64; Trident/5.0; FunWebProducts)</code>
...
<pre><code>
default   fe80:979f:78e3:f629:1e1d%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {44.234.46.9, 14.87.172.23}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 1f:ea:85:bf:8d:00
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr c0:9e:9c:7f:7c:04
}</code></pre>
