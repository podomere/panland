...
subtitle: "Deep Dive?"
layout: research
ip_v4_address: "195.117.194.37"
date: 2023-10-06T17:11:07+01:00
draft: false
---

## Internet Addressing
On the Internet you might have a Public IPv4 address like ```195.117.194.37``` or an IPv6 address like ```2000:2d80:c84f:60cb:6bc:89e8:9a9:946e```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```1f:bf:99:53:55:c1```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://dibbert-reichel.co you initially access a DNS server to translate the host portion (dibbert-reichel) combined with the Top Level Domain (co) of the URL, to an IP address like ```127.130.120.216```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/41.0.2228.0 Safari/537.36```
...
<pre>
default   fe80:96e3:af08:7cf0:e8e3%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {0.31.93.44, 151.24.93.79}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 1f:bf:99:53:55:c1
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr fa:a7:d8:76:1c:64
}</pre>
