...
subtitle: "Granular?"
layout: research
ip_v4_address: "241.23.52.141"
date: 2022-04-24T19:00:05+01:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like <code>241.23.52.141</code> or an IPv6 address like <code>2000:80cf:98ce:bf4c:746f:7b18:9f73:f972</code>. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>4f:80:3f:6a:ca:42</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://deckow-weimann.io you initially access a DNS server to translate the host portion (deckow-weimann) combined with the Top Level Domain (io) of the URL, to an IP address like <code>5.75.231.106</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (Windows NT 6.1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/41.0.2228.0 Safari/537.36</code>
...
<pre><code>
default   fe80:946d:f3a9:5fb0:6c2f%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {104.205.72.137, 151.201.99.49}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 4f:80:3f:6a:ca:42
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 70:e6:b9:69:d6:3b
}</code></pre>
