...
layout: research
ip_v4_address: "63.98.29.206"
date: 2022-04-24T19:00:25+01:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like <code>63.98.29.206</code> or an IPv6 address like <code>2000:8dd5:f4fd:5bd3:b605:49e0:cc36:aa48</code>. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>29:ac:0a:25:28:ed</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://bradtke-bauch.com you initially access a DNS server to translate the host portion (bradtke-bauch) combined with the Top Level Domain (com) of the URL, to an IP address like <code>21.213.248.47</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (Windows NT 6.1; WOW64; Trident/7.0; AS; rv:11.0) like Gecko</code>
...
<pre><code>
default   fe80:8e7a:b12e:e3f6:ef0c%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {18.67.184.238, 132.19.195.244}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 29:ac:0a:25:28:ed
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 71:a4:58:8b:bc:99
}</code></pre>
