...
subtitle: "Deep Dive?"
layout: research
ip_v4_address: "41.75.144.81"
date: 2022-06-12T14:09:05+01:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like ```41.75.144.81``` or an IPv6 address like ```2000:ef4d:921f:ffff:8454:a00b:e8b4:19a0```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```33:4c:3b:78:0b:bc```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://johnston.name you initially access a DNS server to translate the host portion (johnston) combined with the Top Level Domain (name) of the URL, to an IP address like ```53.71.249.90```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_3) AppleWebKit/537.75.14 (KHTML, like Gecko) Version/7.0.3 Safari/7046A194A```
...
<pre>
default   fe80:a101:bd76:d4e8:59d5%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {90.12.227.109, 46.42.81.232}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 33:4c:3b:78:0b:bc
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 29:ec:e4:cb:ff:1c
}</pre>
