...
subtitle: "Learnings?"
layout: research
ip_v4_address: "194.51.170.81"
date: 2022-04-24T19:00:24+01:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like <code>194.51.170.81</code> or an IPv6 address like <code>2000:9431:5f74:7b48:b9a9:76ea:f6c4:8d8f</code>. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>48:e7:0d:4c:fe:5c</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://marks-emard.name you initially access a DNS server to translate the host portion (marks-emard) combined with the Top Level Domain (name) of the URL, to an IP address like <code>59.17.144.159</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (Windows NT 6.1; WOW64; Trident/7.0; AS; rv:11.0) like Gecko</code>
...
<pre><code>
default   fe80:1d89:4b9d:5046:7004%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {122.157.200.63, 249.239.26.251}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 48:e7:0d:4c:fe:5c
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr c0:de:26:8d:3d:11
}</code></pre>
