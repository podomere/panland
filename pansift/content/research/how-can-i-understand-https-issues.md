...
layout: research
ip_v4_address: "90.245.236.75"
date: 2022-06-12T14:09:29+01:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like ```90.245.236.75``` or an IPv6 address like ```2000:fd4d:1c56:6d9b:b84c:33e5:3f5b:2c47```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```84:a3:b9:50:f4:d4```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://gibson.org you initially access a DNS server to translate the host portion (gibson) combined with the Top Level Domain (org) of the URL, to an IP address like ```89.249.36.220```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows; U; Win 9x 4.90; SG; rv:1.9.2.4) Gecko/20101104 Netscape/9.1.0285```
...
<pre>
default   fe80:c622:6ef4:a4d1:ac4a%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {247.6.226.240, 204.31.242.77}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 84:a3:b9:50:f4:d4
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr f4:c1:b7:b3:cf:4e
}</pre>
