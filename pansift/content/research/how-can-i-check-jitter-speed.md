...
subtitle: "Swim Lane?"
layout: research
ip_v4_address: "234.35.65.137"
date: 2022-04-24T19:00:00+01:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like <code>234.35.65.137</code> or an IPv6 address like <code>2000:7121:1b74:3f27:64fb:2025:4830:8b0f</code>. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>37:52:54:d3:ed:1a</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://prosacco-macgyver.io you initially access a DNS server to translate the host portion (prosacco-macgyver) combined with the Top Level Domain (io) of the URL, to an IP address like <code>174.43.116.11</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (Windows; U; Win 9x 4.90; SG; rv:1.9.2.4) Gecko/20101104 Netscape/9.1.0285</code>
...
<pre><code>
default   fe80:fca3:b1ad:5a61:8ad6%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {36.209.179.187, 201.196.53.150}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 37:52:54:d3:ed:1a
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr bf:e3:1e:30:b0:cf
}</code></pre>
