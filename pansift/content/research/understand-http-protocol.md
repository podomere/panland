...
layout: research
ip_v4_address: "158.57.86.252"
date: 2022-05-05T14:30:04+01:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like ```158.57.86.252``` or an IPv6 address like ```2000:4c56:870b:6553:a77b:9d4d:7987:bac6```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```5a:9e:d3:c4:c5:06```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://haley-bins.com you initially access a DNS server to translate the host portion (haley-bins) combined with the Top Level Domain (com) of the URL, to an IP address like ```155.92.219.37```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/41.0.2228.0 Safari/537.36```
...
<pre>
default   fe80:b98:2dab:70:804f%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {198.170.143.86, 202.106.116.143}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 5a:9e:d3:c4:c5:06
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr b2:52:b3:41:11:ff
}</pre>
