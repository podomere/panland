...
layout: research
ip_v4_address: "41.101.40.84"
date: 2023-10-29T15:13:30+00:00
draft: false
---

## Internet Addressing
On the Internet you might get a Public IPv4 address like ```41.101.40.84``` or an IPv6 address like ```2000:2ca:38c7:abb0:6bc1:ff99:740e:3eb1```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```ca:a1:71:a8:36:8d```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://price-pfeffer.info you initially access a DNS server to translate the host portion (price-pfeffer) combined with the Top Level Domain (info) of the URL, to an IP address like ```11.199.173.5```. Your computer and browser actually sends its type with all web requests e.g. <br>```Opera/9.80 (X11; Linux i686; Ubuntu/14.10) Presto/2.12.388 Version/12.16```
...
<pre>
default   fe80:ba7e:522e:71c3:78f3%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {131.163.220.162, 195.123.96.82}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr ca:a1:71:a8:36:8d
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 3e:7c:bc:d7:27:51
}</pre>
