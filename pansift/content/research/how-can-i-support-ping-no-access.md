...
layout: research
ip_v4_address: "211.188.72.155"
date: 2022-11-19T19:13:27+00:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like ```211.188.72.155``` or an IPv6 address like ```2000:d022:3135:7168:6a:b86:7ddb:5880```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```29:09:c3:3e:72:26```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://spencer-oberbrunner.io you initially access a DNS server to translate the host portion (spencer-oberbrunner) combined with the Top Level Domain (io) of the URL, to an IP address like ```184.174.219.147```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT x.y; Win64; x64; rv:10.0) Gecko/20100101 Firefox/10.0```
...
<pre>
default   fe80:e48a:ef37:d6de:d50c%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {36.208.112.124, 51.144.36.125}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 29:09:c3:3e:72:26
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr c1:18:ba:45:de:a8
}</pre>
