...
layout: research
ip_v4_address: "208.110.198.81"
date: 2023-02-04T17:08:40+00:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like ```208.110.198.81``` or an IPv6 address like ```2000:7b1b:c092:ee7d:f444:2de0:4f35:8a85```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```9e:b9:4c:8c:26:61```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://stehr-thompson.biz you initially access a DNS server to translate the host portion (stehr-thompson) combined with the Top Level Domain (biz) of the URL, to an IP address like ```151.41.220.160```. Your computer and browser actually sends its type with all web requests e.g. <br>```Opera/9.80 (X11; Linux i686; Ubuntu/14.10) Presto/2.12.388 Version/12.16```
...
<pre>
default   fe80:897:11a0:c814:894e%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {208.111.82.179, 121.13.224.125}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 9e:b9:4c:8c:26:61
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 97:9c:06:64:2e:8d
}</pre>
