...
layout: research
ip_v4_address: "80.245.46.83"
date: 2023-02-04T17:08:36+00:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like ```80.245.46.83``` or an IPv6 address like ```2000:5255:79db:c07b:8285:742a:a9b:bb9```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```c9:95:e7:70:58:61```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://walter-goyette.name you initially access a DNS server to translate the host portion (walter-goyette) combined with the Top Level Domain (name) of the URL, to an IP address like ```20.169.216.115```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/41.0.2228.0 Safari/537.36```
...
<pre>
default   fe80:eebc:89a3:418d:76d3%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {168.152.138.16, 157.134.117.53}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr c9:95:e7:70:58:61
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 3b:cc:01:62:20:0a
}</pre>
