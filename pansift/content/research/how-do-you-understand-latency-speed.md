---
title: "How Do You Understand Latency Speed"
subtitle: "Home Stretch?"
layout: research
ip_v4_address: "241.149.123.143"
date: 2022-04-24T18:59:59+01:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like <code>241.149.123.143</code> or an IPv6 address like <code>2000:c107:5fd6:34ea:264d:7aec:3a6e:daab</code>. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>3b:2b:78:b7:f6:cb</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://homenick.name you initially access a DNS server to translate the host portion (homenick) combined with the Top Level Domain (name) of the URL, to an IP address like <code>247.226.218.34</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (compatible; MSIE 9.0; AOL 9.7; AOLBuild 4343.19; Windows NT 6.1; WOW64; Trident/5.0; FunWebProducts)</code>

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like <code>192.168.40.40</code> (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For <code>IPv6</code> we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  192.168.40.40    UGScg  en0
...
<pre><code>
default   fe80:4932:42d2:28a1:ee73%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {196.166.228.207, 236.30.164.108}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 3b:2b:78:b7:f6:cb
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr a8:71:87:04:4b:34
}</code></pre>
