...
layout: research
ip_v4_address: "21.134.156.57"
date: 2022-11-19T19:13:27+00:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like ```21.134.156.57``` or an IPv6 address like ```2000:11f1:c21c:49e5:689c:d83c:4bc4:716b```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```70:e7:90:48:2d:03```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://zboncak-dickens.com you initially access a DNS server to translate the host portion (zboncak-dickens) combined with the Top Level Domain (com) of the URL, to an IP address like ```116.235.188.29```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT x.y; Win64; x64; rv:10.0) Gecko/20100101 Firefox/10.0```
...
<pre>
default   fe80:ed1a:82ea:668a:8b07%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {93.197.81.41, 128.82.102.158}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 70:e7:90:48:2d:03
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 4e:ca:65:de:b5:78
}</pre>
