...
subtitle: "Value Add?"
layout: research
ip_v4_address: "90.215.79.99"
date: 2022-11-19T19:13:28+00:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like ```90.215.79.99``` or an IPv6 address like ```2000:a940:eb5e:dfd3:a1af:4d11:767e:3f81```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```fc:ae:ab:5d:e0:29```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://langworth.net you initially access a DNS server to translate the host portion (langworth) combined with the Top Level Domain (net) of the URL, to an IP address like ```63.246.115.39```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (compatible; MSIE 9.0; AOL 9.7; AOLBuild 4343.19; Windows NT 6.1; WOW64; Trident/5.0; FunWebProducts)```

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```10.18.232.136``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  10.18.232.136    UGScg  en0
...
<pre>
default   fe80:16b:600f:a6ca:8e99%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {115.124.55.149, 25.149.11.219}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr fc:ae:ab:5d:e0:29
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr f7:a8:0d:35:b9:00
}</pre>
