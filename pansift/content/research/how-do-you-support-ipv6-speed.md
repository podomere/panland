...
subtitle: "Granular?"
layout: research
ip_v4_address: "41.158.249.121"
date: 2023-02-04T16:26:18+00:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like ```41.158.249.121``` or an IPv6 address like ```2000:f57e:3da1:e6ac:e3b6:2299:48f3:18bf```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```c4:ac:a4:d1:bf:c2```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://koss-runolfsson.org you initially access a DNS server to translate the host portion (koss-runolfsson) combined with the Top Level Domain (org) of the URL, to an IP address like ```247.206.205.191```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT x.y; Win64; x64; rv:10.0) Gecko/20100101 Firefox/10.0```
...
<pre>
default   fe80:6867:48fd:a26d:c931%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {140.100.207.210, 248.115.186.38}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr c4:ac:a4:d1:bf:c2
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 48:75:f0:93:8c:66
}</pre>
