...
layout: research
ip_v4_address: "165.215.54.123"
date: 2022-06-12T14:09:16+01:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like ```165.215.54.123``` or an IPv6 address like ```2000:e0b4:5ee2:a46b:a961:751:2920:acc8```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```0f:92:bc:66:1b:17```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://gibson.net you initially access a DNS server to translate the host portion (gibson) combined with the Top Level Domain (net) of the URL, to an IP address like ```195.206.112.163```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1; WOW64; Trident/7.0; AS; rv:11.0) like Gecko```

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```172.27.42.55``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  172.27.42.55    UGScg  en0
...
<pre>
default   fe80:d410:e6ce:9f8d:532%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {59.255.59.68, 191.69.63.160}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 0f:92:bc:66:1b:17
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 03:56:5a:62:e0:1d
}</pre>
