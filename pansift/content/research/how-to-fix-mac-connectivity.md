...
layout: research
ip_v4_address: "84.229.19.219"
date: 2022-11-19T16:17:13+00:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like ```84.229.19.219``` or an IPv6 address like ```2000:a967:37eb:2046:425d:843d:4e08:d93a```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```51:09:a2:3b:2d:b6```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://dach-sauer.io you initially access a DNS server to translate the host portion (dach-sauer) combined with the Top Level Domain (io) of the URL, to an IP address like ```30.212.141.30```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_3) AppleWebKit/537.75.14 (KHTML, like Gecko) Version/7.0.3 Safari/7046A194A```
...
<pre>
default   fe80:a9b6:e6e6:ac96:7e4f%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {222.172.52.50, 210.128.164.244}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 51:09:a2:3b:2d:b6
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr ba:03:fe:a0:9c:f5
}</pre>
