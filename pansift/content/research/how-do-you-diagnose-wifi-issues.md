...
layout: research
ip_v4_address: "234.19.185.20"
date: 2022-12-15T13:50:03+00:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like ```234.19.185.20``` or an IPv6 address like ```2000:49f4:f5ea:9654:957a:a7c1:1fb9:58e7```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```bf:89:ec:2d:e4:21```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://schulist-johns.org you initially access a DNS server to translate the host portion (schulist-johns) combined with the Top Level Domain (org) of the URL, to an IP address like ```65.189.142.176```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows; U; Win 9x 4.90; SG; rv:1.9.2.4) Gecko/20101104 Netscape/9.1.0285```
...
<pre>
default   fe80:7572:5fc1:fc69:9412%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {21.185.194.229, 50.227.104.146}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr bf:89:ec:2d:e4:21
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 99:5d:02:5c:02:48
}</pre>
