...
layout: research
ip_v4_address: "61.58.186.9"
date: 2022-11-02T11:32:52+00:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like ```61.58.186.9``` or an IPv6 address like ```2000:366b:9e85:4cc2:d504:227e:9957:1661```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```a5:f8:15:48:3c:69```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://metz-kuvalis.name you initially access a DNS server to translate the host portion (metz-kuvalis) combined with the Top Level Domain (name) of the URL, to an IP address like ```238.212.209.74```. Your computer and browser actually sends its type with all web requests e.g. <br>```Opera/9.80 (X11; Linux i686; Ubuntu/14.10) Presto/2.12.388 Version/12.16```
...
<pre>
default   fe80:2963:8085:207a:cb56%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {162.140.232.149, 93.102.35.179}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr a5:f8:15:48:3c:69
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 3e:43:05:6f:fb:74
}</pre>
