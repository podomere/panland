...
layout: research
ip_v4_address: "26.173.202.114"
date: 2023-10-29T15:13:28+00:00
draft: false
---

## Internet Addressing
On the Internet you might have a Public IPv4 address like ```26.173.202.114``` or an IPv6 address like ```2000:3b3e:358a:22d1:2bdc:aa05:879d:a9d5```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```10:a1:c8:76:be:50```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://moore-kutch.io you initially access a DNS server to translate the host portion (moore-kutch) combined with the Top Level Domain (io) of the URL, to an IP address like ```206.233.12.71```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1; WOW64; Trident/7.0; AS; rv:11.0) like Gecko```
...
<pre>
default   fe80:9ba0:bd92:d798:ae9a%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {118.37.50.52, 62.100.222.48}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 10:a1:c8:76:be:50
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 79:b7:6a:28:25:bc
}</pre>
