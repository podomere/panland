...
layout: research
ip_v4_address: "13.56.122.25"
date: 2022-05-05T14:30:13+01:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like ```13.56.122.25``` or an IPv6 address like ```2000:3c90:9dc4:ee5f:eb11:95ac:3702:867```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```06:ba:09:63:cb:6b```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://mcglynn.org you initially access a DNS server to translate the host portion (mcglynn) combined with the Top Level Domain (org) of the URL, to an IP address like ```201.25.124.180```. Your computer and browser actually sends its type with all web requests e.g. <br>```Opera/9.80 (X11; Linux i686; Ubuntu/14.10) Presto/2.12.388 Version/12.16```
...
<pre>
default   fe80:bf4f:37a0:6614:31ff%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {197.29.215.180, 247.26.144.102}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 06:ba:09:63:cb:6b
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr d7:06:5a:0a:52:a3
}</pre>
