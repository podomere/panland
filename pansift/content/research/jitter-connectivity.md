...
subtitle: "Streamline?"
layout: research
ip_v4_address: "100.148.163.7"
date: 2022-12-15T13:50:18+00:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like ```100.148.163.7``` or an IPv6 address like ```2000:baa5:83db:3928:94c2:cf44:71a9:31e```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```04:40:6d:d6:1b:92```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://bruen-klein.biz you initially access a DNS server to translate the host portion (bruen-klein) combined with the Top Level Domain (biz) of the URL, to an IP address like ```44.109.146.26```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (compatible; MSIE 9.0; AOL 9.7; AOLBuild 4343.19; Windows NT 6.1; WOW64; Trident/5.0; FunWebProducts)```
...
<pre>
default   fe80:242c:169e:df06:311f%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {190.217.192.104, 22.212.5.96}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 04:40:6d:d6:1b:92
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 7a:b0:74:a6:c2:7e
}</pre>
