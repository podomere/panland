...
subtitle: "Branding?"
layout: research
ip_v4_address: "178.232.8.216"
date: 2023-10-29T15:13:25+00:00
draft: false
---

## Internet Addressing
On the Internet you may get a Public IPv4 address like ```178.232.8.216``` or an IPv6 address like ```2000:66db:9906:edb3:ae54:9edf:bec6:5f52```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```74:37:d2:64:72:af```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://swaniawski.info you initially access a DNS server to translate the host portion (swaniawski) combined with the Top Level Domain (info) of the URL, to an IP address like ```154.52.63.33```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (compatible; MSIE 9.0; AOL 9.7; AOLBuild 4343.19; Windows NT 6.1; WOW64; Trident/5.0; FunWebProducts)```

## Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```172.25.219.46``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  172.25.219.46    UGScg  en0
...
<pre>
default   fe80:3328:48eb:db8c:7d42%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {67.252.127.31, 221.58.67.88}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 74:37:d2:64:72:af
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr f2:0e:12:04:d7:28
}</pre>
...
### Apple macOS / OSX
No matter what version of OSX/macOS you are on, ```10.15.9```, ```11.5.1```, or ```12.3.5```, there are a range of tools for troubleshooting. Unfortunately, between these manual actions and scripts, they don't give you a series of correlated values over time. This is where automated remote troubleshooting comes in to its own, especially for teams that embrace remote work and Work From Anywhere (WFA).
