...
subtitle: "Swag?"
layout: research
ip_v4_address: "5.187.219.3"
date: 2023-10-29T15:13:12+00:00
draft: false
---

## Internet Addressing
On the Internet you may get a Public IPv4 address like ```5.187.219.3``` or an IPv6 address like ```2000:9851:5875:1bce:cd3f:521b:1c95:c6e3```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```f8:da:4c:16:ee:29```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://abshire.com you initially access a DNS server to translate the host portion (abshire) combined with the Top Level Domain (com) of the URL, to an IP address like ```80.97.165.133```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (compatible; MSIE 9.0; AOL 9.7; AOLBuild 4343.19; Windows NT 6.1; WOW64; Trident/5.0; FunWebProducts)```

## Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```172.27.197.110``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  172.27.197.110    UGScg  en0
...
<pre>
default   fe80:9bd6:41cd:522f:c31c%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {241.247.96.213, 123.159.12.233}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr f8:da:4c:16:ee:29
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 97:a3:3b:15:76:95
}</pre>
...
### Apple macOS / OSX
No matter what version of OSX/macOS you are on, ```10.15.5```, ```11.2.8```, or ```12.3.1```, there are a range of tools for troubleshooting. Unfortunately, between these manual actions and scripts, they don't give you a series of correlated values over time. This is where automated remote troubleshooting comes in to its own, especially for teams that embrace remote work and Work From Anywhere (WFA).
