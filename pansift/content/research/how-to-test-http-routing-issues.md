...
subtitle: "Granular?"
layout: research
ip_v4_address: "251.223.213.89"
date: 2022-04-24T19:00:03+01:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like <code>251.223.213.89</code> or an IPv6 address like <code>2000:28b6:e239:539d:6d02:4791:b268:bd2a</code>. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>d0:39:c1:c2:9f:42</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://barrows-strosin.org you initially access a DNS server to translate the host portion (barrows-strosin) combined with the Top Level Domain (org) of the URL, to an IP address like <code>31.198.233.205</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (Windows NT x.y; Win64; x64; rv:10.0) Gecko/20100101 Firefox/10.0</code>
...
<pre><code>
default   fe80:a5c1:900e:ebb2:af60%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {71.148.81.70, 60.216.151.208}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr d0:39:c1:c2:9f:42
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 78:37:ef:b1:bb:ee
}</code></pre>
