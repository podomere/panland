...
subtitle: "Branding?"
layout: research
ip_v4_address: "219.28.57.129"
date: 2022-11-02T11:33:01+00:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like ```219.28.57.129``` or an IPv6 address like ```2000:4f5e:d79:8823:dfd7:b459:38d8:3c9d```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```33:12:c6:b3:e4:cf```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://kunde.info you initially access a DNS server to translate the host portion (kunde) combined with the Top Level Domain (info) of the URL, to an IP address like ```75.16.84.232```. Your computer and browser actually sends its type with all web requests e.g. <br>```Opera/9.80 (X11; Linux i686; Ubuntu/14.10) Presto/2.12.388 Version/12.16```

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```172.22.8.236``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  172.22.8.236    UGScg  en0
...
<pre>
default   fe80:cc4:d:2732:e91d%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {203.242.244.58, 203.152.232.169}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 33:12:c6:b3:e4:cf
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 7f:48:1e:d0:3b:3f
}</pre>
