...
layout: research
ip_v4_address: "67.44.102.174"
date: 2022-04-24T18:59:56+01:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like <code>67.44.102.174</code> or an IPv6 address like <code>2000:2e65:2977:9e70:80c8:5a49:fa15:d2b1</code>. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>52:db:9c:56:6f:31</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://schroeder.io you initially access a DNS server to translate the host portion (schroeder) combined with the Top Level Domain (io) of the URL, to an IP address like <code>189.255.246.106</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Opera/9.80 (X11; Linux i686; Ubuntu/14.10) Presto/2.12.388 Version/12.16</code>
...
<pre><code>
default   fe80:73d4:1f5d:977c:db72%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {105.201.240.210, 101.178.16.209}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 52:db:9c:56:6f:31
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 71:c3:20:0d:78:6c
}</code></pre>
