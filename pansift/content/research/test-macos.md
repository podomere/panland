...
layout: research
ip_v4_address: "87.246.84.144"
date: 2023-10-29T15:13:18+00:00
draft: false
---

## Internet Addressing
On the Internet you might get a Public IPv4 address like ```87.246.84.144``` or an IPv6 address like ```2000:87b3:81a8:814b:1f4c:34d7:997a:4091```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```dd:18:1c:e5:ae:3b```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://swift-altenwerth.biz you initially access a DNS server to translate the host portion (swift-altenwerth) combined with the Top Level Domain (biz) of the URL, to an IP address like ```111.191.151.112```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_3) AppleWebKit/537.75.14 (KHTML, like Gecko) Version/7.0.3 Safari/7046A194A```
...
<pre>
default   fe80:6379:18c9:202:d321%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {182.198.169.194, 40.3.151.241}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr dd:18:1c:e5:ae:3b
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr f3:48:2a:d2:66:59
}</pre>
