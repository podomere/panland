...
layout: research
ip_v4_address: "4.114.143.29"
date: 2022-04-24T19:00:33+01:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like <code>4.114.143.29</code> or an IPv6 address like <code>2000:9865:d479:ae31:2a03:7eea:5070:381b</code>. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>59:6b:81:86:6f:56</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://cole-mcdermott.biz you initially access a DNS server to translate the host portion (cole-mcdermott) combined with the Top Level Domain (biz) of the URL, to an IP address like <code>193.79.228.72</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (Windows NT 6.1; WOW64; Trident/7.0; AS; rv:11.0) like Gecko</code>
...
<pre><code>
default   fe80:5273:3fe:209:b224%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {222.2.160.55, 74.0.161.106}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 59:6b:81:86:6f:56
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 7a:c3:e1:0e:dc:73
}</code></pre>
