...
subtitle: "Ideate?"
layout: research
ip_v4_address: "7.144.162.110"
date: 2022-04-24T18:32:41+01:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like <code>7.144.162.110</code> or an IPv6 address like <code>2000:2089:76d8:83e6:6dce:6d0a:76d0:1784</code>. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>c7:91:a1:e4:85:a7</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://hilll-hilll.com you initially access a DNS server to translate the host portion (hilll-hilll) combined with the Top Level Domain (com) of the URL, to an IP address like <code>42.105.100.58</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (Windows; U; Win 9x 4.90; SG; rv:1.9.2.4) Gecko/20101104 Netscape/9.1.0285</code>

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like <code>10.52.238.235</code> (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For <code>IPv6</code> we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  10.52.238.235    UGScg  en0
...
<pre><code>
default   fe80:b9e6:491e:1863:4ad8%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {179.21.243.62, 93.159.22.171}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr c7:91:a1:e4:85:a7
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr ac:62:51:2e:d1:eb
}</code></pre>
