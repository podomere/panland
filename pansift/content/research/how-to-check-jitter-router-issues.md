...
subtitle: "Streamline?"
layout: research
ip_v4_address: "205.129.217.131"
date: 2022-04-24T19:00:00+01:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like <code>205.129.217.131</code> or an IPv6 address like <code>2000:f99b:9605:8978:4efa:8f3b:c609:9497</code>. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>e9:81:04:16:18:25</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://stehr-roob.co you initially access a DNS server to translate the host portion (stehr-roob) combined with the Top Level Domain (co) of the URL, to an IP address like <code>193.102.33.186</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (Windows; U; Win 9x 4.90; SG; rv:1.9.2.4) Gecko/20101104 Netscape/9.1.0285</code>
...
<pre><code>
default   fe80:d965:e335:25c5:7bac%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {78.154.206.96, 29.79.247.128}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr e9:81:04:16:18:25
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr c9:cf:d2:1b:14:24
}</code></pre>
