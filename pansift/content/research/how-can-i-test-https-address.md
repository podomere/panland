...
layout: research
ip_v4_address: "121.69.161.64"
date: 2023-02-04T16:26:24+00:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like ```121.69.161.64``` or an IPv6 address like ```2000:5f1:bbf4:b813:b5b9:223a:dcbf:5cb2```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```9e:d2:76:76:7b:ff```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://bednar-koepp.name you initially access a DNS server to translate the host portion (bednar-koepp) combined with the Top Level Domain (name) of the URL, to an IP address like ```201.173.200.158```. Your computer and browser actually sends its type with all web requests e.g. <br>```Opera/9.80 (X11; Linux i686; Ubuntu/14.10) Presto/2.12.388 Version/12.16```
...
<pre>
default   fe80:12a:614e:ec9b:bc56%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {185.152.81.233, 144.90.166.156}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 9e:d2:76:76:7b:ff
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr d0:c2:88:80:64:bb
}</pre>
