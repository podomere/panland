---
title: "How Do You Mcs Connectivity"
subtitle: "Deep Dive?"
layout: research
ip_v4_address: "20.58.161.104"
date: 2022-11-19T19:13:09+00:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like ```20.58.161.104``` or an IPv6 address like ```2000:b988:892:163c:a980:156a:6903:26b0```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```e6:e9:cd:c7:2c:2a```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://mraz-maggio.co you initially access a DNS server to translate the host portion (mraz-maggio) combined with the Top Level Domain (co) of the URL, to an IP address like ```34.208.64.224```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (compatible; MSIE 9.0; AOL 9.7; AOLBuild 4343.19; Windows NT 6.1; WOW64; Trident/5.0; FunWebProducts)```
...
<pre>
default   fe80:262c:923:530d:2af1%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {63.252.75.226, 126.7.54.103}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr e6:e9:cd:c7:2c:2a
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 18:14:8c:32:fb:30
}</pre>
