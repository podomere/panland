...
layout: research
ip_v4_address: "112.14.187.200"
date: 2022-11-19T16:17:06+00:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like ```112.14.187.200``` or an IPv6 address like ```2000:5517:8323:e1b1:7673:36bb:71b9:5cef```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```b5:d0:44:86:af:51```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://orn-willms.co you initially access a DNS server to translate the host portion (orn-willms) combined with the Top Level Domain (co) of the URL, to an IP address like ```14.196.133.118```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/41.0.2228.0 Safari/537.36```

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```10.124.127.85``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  10.124.127.85    UGScg  en0
...
<pre>
default   fe80:287:4ebe:4506:92b4%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {211.119.23.130, 89.99.165.162}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr b5:d0:44:86:af:51
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 32:cd:66:89:3e:a3
}</pre>
