...
layout: research
ip_v4_address: "185.141.1.144"
date: 2023-10-06T17:10:44+01:00
draft: false
---

## Internet Addressing
On the Internet you might have a Public IPv4 address like ```185.141.1.144``` or an IPv6 address like ```2000:d9a1:527a:b10f:f9fd:d5ce:3d63:c677```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```b2:7e:d8:9a:1c:68```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://turcotte-upton.co you initially access a DNS server to translate the host portion (turcotte-upton) combined with the Top Level Domain (co) of the URL, to an IP address like ```127.80.154.61```. Your computer and browser actually sends its type with all web requests e.g. <br>```Opera/9.80 (X11; Linux i686; Ubuntu/14.10) Presto/2.12.388 Version/12.16```
...
<pre>
default   fe80:b48b:ee7a:1c0a:4c15%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {242.250.55.35, 101.132.89.190}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr b2:7e:d8:9a:1c:68
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 89:2c:fd:b9:5d:e9
}</pre>
