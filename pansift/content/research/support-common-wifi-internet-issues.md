...
layout: research
ip_v4_address: "185.205.88.221"
date: 2023-02-04T16:26:03+00:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like ```185.205.88.221``` or an IPv6 address like ```2000:6e85:2f48:52f1:8aee:ebb6:14e3:4448```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```a9:74:89:38:b4:de```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://bartell-mertz.io you initially access a DNS server to translate the host portion (bartell-mertz) combined with the Top Level Domain (io) of the URL, to an IP address like ```227.231.138.217```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT x.y; Win64; x64; rv:10.0) Gecko/20100101 Firefox/10.0```
...
<pre>
default   fe80:af56:1094:3b3:e430%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {192.84.185.245, 94.252.191.62}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr a9:74:89:38:b4:de
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 7b:37:f8:3f:5e:0c
}</pre>
