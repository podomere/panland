...
layout: research
ip_v4_address: "119.171.131.130"
date: 2022-12-15T13:50:19+00:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like ```119.171.131.130``` or an IPv6 address like ```2000:3e14:f9ed:c0e7:ca8b:59d0:fd8b:8fb0```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```2a:b2:95:2b:24:2d```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://bosco-cassin.org you initially access a DNS server to translate the host portion (bosco-cassin) combined with the Top Level Domain (org) of the URL, to an IP address like ```166.251.58.38```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows; U; Win 9x 4.90; SG; rv:1.9.2.4) Gecko/20101104 Netscape/9.1.0285```
...
<pre>
default   fe80:9a34:298b:720c:4833%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {142.239.208.86, 133.128.51.177}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 2a:b2:95:2b:24:2d
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 2f:f5:41:e2:c3:43
}</pre>
