...
layout: research
ip_v4_address: "237.187.191.201"
date: 2022-04-24T19:00:04+01:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like <code>237.187.191.201</code> or an IPv6 address like <code>2000:a327:ab00:4062:5bd1:839f:79d9:fab1</code>. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>bd:0f:85:b0:25:7a</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://rolfson-baumbach.biz you initially access a DNS server to translate the host portion (rolfson-baumbach) combined with the Top Level Domain (biz) of the URL, to an IP address like <code>157.169.89.148</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (compatible; MSIE 9.0; AOL 9.7; AOLBuild 4343.19; Windows NT 6.1; WOW64; Trident/5.0; FunWebProducts)</code>
...
<pre><code>
default   fe80:aa38:313e:b9ed:be73%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {219.32.244.24, 204.103.255.133}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr bd:0f:85:b0:25:7a
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 18:06:e8:90:ab:43
}</code></pre>
