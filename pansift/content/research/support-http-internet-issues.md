...
layout: research
ip_v4_address: "222.253.175.190"
date: 2022-04-24T19:00:03+01:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like <code>222.253.175.190</code> or an IPv6 address like <code>2000:2bed:134:553a:f0c0:57ad:8102:5a06</code>. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>3e:fa:bc:89:be:49</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://buckridge-okon.com you initially access a DNS server to translate the host portion (buckridge-okon) combined with the Top Level Domain (com) of the URL, to an IP address like <code>134.220.130.143</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (Windows NT x.y; Win64; x64; rv:10.0) Gecko/20100101 Firefox/10.0</code>
...
<pre><code>
default   fe80:eb78:4401:20c8:ee1c%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {203.44.92.111, 15.89.86.233}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 3e:fa:bc:89:be:49
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr b5:19:bf:2d:46:af
}</code></pre>
