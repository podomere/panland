...
subtitle: "Granular?"
layout: research
ip_v4_address: "209.117.174.83"
date: 2023-02-04T16:26:21+00:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like ```209.117.174.83``` or an IPv6 address like ```2000:7780:eb7b:7f5e:d3cf:53d0:56ff:f1f7```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```b3:a4:ab:53:8e:03```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://durgan-oberbrunner.co you initially access a DNS server to translate the host portion (durgan-oberbrunner) combined with the Top Level Domain (co) of the URL, to an IP address like ```32.99.91.82```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (compatible; MSIE 9.0; AOL 9.7; AOLBuild 4343.19; Windows NT 6.1; WOW64; Trident/5.0; FunWebProducts)```
...
<pre>
default   fe80:a01:cb09:8917:b7f1%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {95.120.80.30, 235.53.122.97}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr b3:a4:ab:53:8e:03
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 1d:8c:b5:c8:1f:54
}</pre>
