...
subtitle: "Synergy?"
layout: research
ip_v4_address: "209.102.54.138"
date: 2023-10-29T15:13:29+00:00
draft: false
---

## Internet Addressing
On the Internet you may have a Public IPv4 address like ```209.102.54.138``` or an IPv6 address like ```2000:32df:e74b:3ed7:496d:e066:c41b:527f```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```9f:1d:28:da:8e:2f```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://huels.name you initially access a DNS server to translate the host portion (huels) combined with the Top Level Domain (name) of the URL, to an IP address like ```225.47.151.239```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1; WOW64; Trident/7.0; AS; rv:11.0) like Gecko```

## Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```172.29.112.220``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  172.29.112.220    UGScg  en0
...
<pre>
default   fe80:19b6:c7fe:3806:7c8a%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {75.95.108.110, 215.162.96.8}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 9f:1d:28:da:8e:2f
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr eb:6f:01:fb:34:ca
}</pre>
...
### Apple macOS / OSX
No matter what version of OSX/macOS you are on, ```10.11.8```, ```11.1.2```, or ```12.1.8```, there are a range of tools for troubleshooting. Unfortunately, between these manual actions and scripts, they don't give you a series of correlated values over time. This is where automated remote troubleshooting comes in to its own, especially for teams that embrace remote work and Work From Anywhere (WFA).
