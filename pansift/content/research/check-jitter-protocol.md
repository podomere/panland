...
subtitle: "Synergy?"
layout: research
ip_v4_address: "111.87.91.6"
date: 2022-06-04T14:38:40+01:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like ```111.87.91.6``` or an IPv6 address like ```2000:de06:ea8a:109b:cf4c:56eb:c561:6f0a```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```78:72:57:17:64:bc```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://conroy-donnelly.name you initially access a DNS server to translate the host portion (conroy-donnelly) combined with the Top Level Domain (name) of the URL, to an IP address like ```230.24.78.216```. Your computer and browser actually sends its type with all web requests e.g. <br>```Opera/9.80 (X11; Linux i686; Ubuntu/14.10) Presto/2.12.388 Version/12.16```
...
<pre>
default   fe80:faaa:fc24:459e:e07%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {49.210.17.141, 77.23.171.184}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 78:72:57:17:64:bc
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 24:65:88:61:6d:b5
}</pre>
