...
subtitle: "Impact Map?"
layout: research
ip_v4_address: "110.143.212.207"
date: 2023-02-04T16:26:23+00:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like ```110.143.212.207``` or an IPv6 address like ```2000:e365:7608:e486:4a67:a1a7:9208:cba7```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```e6:08:ef:43:1b:ce```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://mcclure-leannon.io you initially access a DNS server to translate the host portion (mcclure-leannon) combined with the Top Level Domain (io) of the URL, to an IP address like ```20.195.20.210```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/41.0.2228.0 Safari/537.36```

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```172.19.210.73``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  172.19.210.73    UGScg  en0
...
<pre>
default   fe80:38cd:672f:a885:7d41%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {108.86.246.23, 209.26.196.174}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr e6:08:ef:43:1b:ce
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr dd:91:c8:e9:9e:e1
}</pre>
