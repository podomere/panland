...
layout: research
ip_v4_address: "189.51.202.143"
date: 2023-02-04T17:08:38+00:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like ```189.51.202.143``` or an IPv6 address like ```2000:9084:ca5f:fffa:2143:1540:7e04:fcf7```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```54:c3:40:5a:8c:29```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://boyer-little.info you initially access a DNS server to translate the host portion (boyer-little) combined with the Top Level Domain (info) of the URL, to an IP address like ```207.195.66.169```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_3) AppleWebKit/537.75.14 (KHTML, like Gecko) Version/7.0.3 Safari/7046A194A```
...
<pre>
default   fe80:754f:29fa:ebfc:a%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {123.176.163.78, 27.137.192.112}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 54:c3:40:5a:8c:29
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 88:9e:7a:7e:5d:19
}</pre>
