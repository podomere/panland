...
layout: research
ip_v4_address: "158.87.233.39"
date: 2022-11-19T19:13:26+00:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like ```158.87.233.39``` or an IPv6 address like ```2000:661:714a:a451:ef81:d9a5:b2d6:bc79```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```55:d4:15:f3:a4:a2```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://schulist-dickens.name you initially access a DNS server to translate the host portion (schulist-dickens) combined with the Top Level Domain (name) of the URL, to an IP address like ```185.29.55.26```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1; WOW64; Trident/7.0; AS; rv:11.0) like Gecko```
...
<pre>
default   fe80:24ab:5db1:9694:db6f%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {255.80.176.184, 231.81.159.216}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 55:d4:15:f3:a4:a2
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 98:6f:57:e6:8e:36
}</pre>
