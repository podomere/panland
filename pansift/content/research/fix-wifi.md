...
layout: research
ip_v4_address: "177.199.197.225"
date: 2022-04-24T18:32:41+01:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like <code>177.199.197.225</code> or an IPv6 address like <code>2000:d951:9742:853b:770:e6e1:9480:844c</code>. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>36:a7:44:0d:59:76</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://lehner.name you initially access a DNS server to translate the host portion (lehner) combined with the Top Level Domain (name) of the URL, to an IP address like <code>37.58.255.239</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (Windows NT 6.1; WOW64; Trident/7.0; AS; rv:11.0) like Gecko</code>
...
<pre><code>
default   fe80:9c65:efec:fcc9:f831%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {234.3.34.198, 41.223.158.117}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 36:a7:44:0d:59:76
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr f2:7b:4f:f8:c4:48
}</code></pre>
