...
layout: research
ip_v4_address: "118.98.56.8"
date: 2023-02-04T17:08:37+00:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like ```118.98.56.8``` or an IPv6 address like ```2000:24b4:3914:9bda:ac71:1bef:af22:a39b```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```1d:23:93:25:6f:66```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://upton-medhurst.biz you initially access a DNS server to translate the host portion (upton-medhurst) combined with the Top Level Domain (biz) of the URL, to an IP address like ```87.164.108.11```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/41.0.2228.0 Safari/537.36```
...
<pre>
default   fe80:bd97:7b6b:3f54:4c72%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {167.28.77.175, 84.178.71.178}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 1d:23:93:25:6f:66
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr dd:0e:df:30:7f:c4
}</pre>
