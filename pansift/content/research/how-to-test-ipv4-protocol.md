...
layout: research
ip_v4_address: "219.41.27.204"
date: 2022-12-15T13:50:17+00:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like ```219.41.27.204``` or an IPv6 address like ```2000:5d38:5b83:57d5:5818:fae1:18d8:78ad```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```dd:ac:ea:dc:9e:39```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://champlin.info you initially access a DNS server to translate the host portion (champlin) combined with the Top Level Domain (info) of the URL, to an IP address like ```50.167.234.53```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT x.y; Win64; x64; rv:10.0) Gecko/20100101 Firefox/10.0```
...
<pre>
default   fe80:4e40:739c:7f09:bc22%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {121.145.88.247, 45.243.22.120}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr dd:ac:ea:dc:9e:39
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr f3:64:69:41:14:df
}</pre>
