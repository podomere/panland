...
layout: research
ip_v4_address: "153.103.124.143"
date: 2022-06-04T14:38:17+01:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like ```153.103.124.143``` or an IPv6 address like ```2000:88ec:db02:52a9:dd02:a13d:54ba:25b```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```ce:17:c0:bf:58:c2```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://stracke.info you initially access a DNS server to translate the host portion (stracke) combined with the Top Level Domain (info) of the URL, to an IP address like ```44.83.45.211```. Your computer and browser actually sends its type with all web requests e.g. <br>```Opera/9.80 (X11; Linux i686; Ubuntu/14.10) Presto/2.12.388 Version/12.16```
...
<pre>
default   fe80:221d:9895:e179:ad93%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {106.143.168.238, 77.237.247.201}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr ce:17:c0:bf:58:c2
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 5a:5b:88:0d:24:a9
}</pre>
...
## Apple macOS / OSX
No matter what version of OSX/macOS you are on, ```10.13.4```, ```11.3.8```, or ```12.2.8```, there are a range of tools for troubleshooting. Unfortunately, between these manual actions and scripts, they don't give you a series of correlated values over time. This is where automated remote troubleshooting comes in to its own, especially for teams that embrace remote work and Work From Anywhere (WFA).
