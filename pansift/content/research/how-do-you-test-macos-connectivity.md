...
layout: research
ip_v4_address: "142.93.3.155"
date: 2023-02-04T17:07:48+00:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like ```142.93.3.155``` or an IPv6 address like ```2000:5d:81c7:2012:1a6d:fcbc:c060:d558```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```ec:99:14:33:aa:69```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://smitham-mueller.name you initially access a DNS server to translate the host portion (smitham-mueller) combined with the Top Level Domain (name) of the URL, to an IP address like ```42.110.190.102```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows; U; Win 9x 4.90; SG; rv:1.9.2.4) Gecko/20101104 Netscape/9.1.0285```
...
<pre>
default   fe80:9294:f0ac:1330:a7f2%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {170.25.48.210, 121.150.125.138}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr ec:99:14:33:aa:69
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 0c:a8:a9:ef:55:af
}</pre>
