...
layout: research
ip_v4_address: "106.234.183.177"
date: 2022-04-24T19:00:06+01:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like <code>106.234.183.177</code> or an IPv6 address like <code>2000:86bb:d182:7e1a:65ee:8bd4:17e1:f569</code>. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>0e:bb:f7:d2:c9:7a</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://windler-thompson.name you initially access a DNS server to translate the host portion (windler-thompson) combined with the Top Level Domain (name) of the URL, to an IP address like <code>130.87.141.55</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (Windows NT 6.1; WOW64; Trident/7.0; AS; rv:11.0) like Gecko</code>
...
<pre><code>
default   fe80:6815:380f:a584:3559%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {55.172.202.180, 186.232.115.188}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 0e:bb:f7:d2:c9:7a
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 61:b9:85:e6:c3:2d
}</code></pre>
