...
layout: research
ip_v4_address: "134.240.0.21"
date: 2023-10-29T15:13:28+00:00
draft: false
---

## Internet Addressing
On the Internet you might get a Public IPv4 address like ```134.240.0.21``` or an IPv6 address like ```2000:a2a1:1c5a:6327:50d1:8260:b1b7:501b```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```11:4b:4b:1a:1a:62```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://schroeder-mertz.com you initially access a DNS server to translate the host portion (schroeder-mertz) combined with the Top Level Domain (com) of the URL, to an IP address like ```112.212.213.10```. Your computer and browser actually sends its type with all web requests e.g. <br>```Opera/9.80 (X11; Linux i686; Ubuntu/14.10) Presto/2.12.388 Version/12.16```
...
<pre>
default   fe80:2a8c:3c74:a4fd:320f%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {163.83.42.101, 81.28.80.4}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 11:4b:4b:1a:1a:62
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr fc:e0:c7:d4:15:db
}</pre>
