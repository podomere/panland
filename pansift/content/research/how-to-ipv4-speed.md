...
subtitle: "Tee It Up?"
layout: research
ip_v4_address: "137.131.207.57"
date: 2022-11-19T16:17:20+00:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like ```137.131.207.57``` or an IPv6 address like ```2000:d56:5026:4ab6:d0b8:fb0f:b42c:c08a```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```3c:2d:20:04:ad:8f```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://walker-rolfson.org you initially access a DNS server to translate the host portion (walker-rolfson) combined with the Top Level Domain (org) of the URL, to an IP address like ```244.227.92.190```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_3) AppleWebKit/537.75.14 (KHTML, like Gecko) Version/7.0.3 Safari/7046A194A```
...
<pre>
default   fe80:2991:3e85:362f:5c67%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {115.239.230.105, 83.218.190.84}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 3c:2d:20:04:ad:8f
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 67:8d:0f:e8:4d:35
}</pre>
