...
subtitle: "Tee It Up?"
layout: research
ip_v4_address: "117.253.208.244"
date: 2022-06-12T14:09:27+01:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like ```117.253.208.244``` or an IPv6 address like ```2000:edcb:4676:666a:ad98:c43:d9c7:299c```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```1c:3b:7a:35:3f:df```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://heidenreich-kuvalis.info you initially access a DNS server to translate the host portion (heidenreich-kuvalis) combined with the Top Level Domain (info) of the URL, to an IP address like ```107.108.116.145```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1; WOW64; Trident/7.0; AS; rv:11.0) like Gecko```

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```192.168.107.146``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  192.168.107.146    UGScg  en0
...
<pre>
default   fe80:f7f3:800:5699:6e93%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {202.219.207.63, 75.188.93.31}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 1c:3b:7a:35:3f:df
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 42:52:dd:2e:e0:c8
}</pre>
