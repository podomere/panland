...
subtitle: "Ideate?"
layout: research
ip_v4_address: "5.233.109.75"
date: 2023-02-04T17:08:39+00:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like ```5.233.109.75``` or an IPv6 address like ```2000:3b18:2c6f:b2c4:8228:302b:d4f3:397a```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```ec:f1:f9:15:a9:47```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://murray-kulas.net you initially access a DNS server to translate the host portion (murray-kulas) combined with the Top Level Domain (net) of the URL, to an IP address like ```230.109.228.104```. Your computer and browser actually sends its type with all web requests e.g. <br>```Opera/9.80 (X11; Linux i686; Ubuntu/14.10) Presto/2.12.388 Version/12.16```

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```192.168.207.167``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  192.168.207.167    UGScg  en0
...
<pre>
default   fe80:aa39:3752:8fec:ca6%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {237.128.195.111, 248.83.29.244}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr ec:f1:f9:15:a9:47
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr ba:9d:af:2f:63:cc
}</pre>
