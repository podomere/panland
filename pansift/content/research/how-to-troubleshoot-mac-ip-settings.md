...
subtitle: "Heads Down?"
layout: research
ip_v4_address: "193.214.60.168"
date: 2022-04-24T19:00:25+01:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like <code>193.214.60.168</code> or an IPv6 address like <code>2000:237:5fd2:d612:7a22:c6e0:b9a1:c4b1</code>. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>db:3d:9d:72:f2:c2</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://ebert-durgan.name you initially access a DNS server to translate the host portion (ebert-durgan) combined with the Top Level Domain (name) of the URL, to an IP address like <code>74.114.197.203</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (Windows NT 6.1; WOW64; Trident/7.0; AS; rv:11.0) like Gecko</code>
...
<pre><code>
default   fe80:56a0:409f:2fe5:630a%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {190.90.188.234, 119.70.30.40}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr db:3d:9d:72:f2:c2
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 9d:0e:21:ef:4e:d4
}</code></pre>
