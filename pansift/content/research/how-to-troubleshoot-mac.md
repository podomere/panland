...
layout: research
ip_v4_address: "162.237.177.30"
date: 2022-04-24T18:31:59+01:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like <code>162.237.177.30</code> or an IPv6 address like <code>2000:c00:17e4:530e:ebc5:e81d:5726:5eb7</code>. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>5b:28:cc:cb:10:ef</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://schmidt-strosin.io you initially access a DNS server to translate the host portion (schmidt-strosin) combined with the Top Level Domain (io) of the URL, to an IP address like <code>132.48.10.244</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (Windows NT x.y; Win64; x64; rv:10.0) Gecko/20100101 Firefox/10.0</code>
...
<pre><code>
default   fe80:79d6:957b:51d5:8ef6%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {149.136.225.105, 84.184.93.64}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 5b:28:cc:cb:10:ef
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 94:26:51:c1:ab:9d
}</code></pre>
