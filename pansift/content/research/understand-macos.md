...
layout: research
ip_v4_address: "122.168.172.154"
date: 2022-04-24T19:00:23+01:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like <code>122.168.172.154</code> or an IPv6 address like <code>2000:57e:dbe6:24a8:234c:2881:37b4:c92f</code>. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>ab:10:7e:8f:d3:e7</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://becker-stroman.biz you initially access a DNS server to translate the host portion (becker-stroman) combined with the Top Level Domain (biz) of the URL, to an IP address like <code>220.145.207.73</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Opera/9.80 (X11; Linux i686; Ubuntu/14.10) Presto/2.12.388 Version/12.16</code>
...
<pre><code>
default   fe80:50d6:292e:9fd8:7abb%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {170.233.238.133, 139.98.73.168}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr ab:10:7e:8f:d3:e7
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr dc:0a:d0:8a:a5:a4
}</code></pre>
