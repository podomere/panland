...
layout: research
ip_v4_address: "26.103.155.152"
date: 2022-06-12T14:09:04+01:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like ```26.103.155.152``` or an IPv6 address like ```2000:5f0:db35:9ba7:3e2b:18e4:7592:6504```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```92:85:d3:71:59:a7```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://bayer-dach.com you initially access a DNS server to translate the host portion (bayer-dach) combined with the Top Level Domain (com) of the URL, to an IP address like ```197.171.58.95```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1; WOW64; Trident/7.0; AS; rv:11.0) like Gecko```

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```10.93.66.30``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
<pre>
default   fe80:9d59:794b:96d6:b3ea%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {229.185.25.112, 48.204.31.199}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 92:85:d3:71:59:a7
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr b6:8c:d6:e6:e5:52
}</pre>
...
## Apple macOS / OSX
No matter what version of OSX/macOS you are on, ```10.15.4```, ```11.1.2```, or ```12.1.7```, there are a range of tools for troubleshooting. Unfortunately, between these manual actions and scripts, they don't give you a series of correlated values over time. This is where automated remote troubleshooting comes in to its own, especially for teams that embrace remote work and Work From Anywhere (WFA).
