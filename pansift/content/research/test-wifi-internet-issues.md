...
layout: research
ip_v4_address: "23.223.26.249"
date: 2022-06-12T14:09:04+01:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like ```23.223.26.249``` or an IPv6 address like ```2000:6521:e483:e52b:dce6:30b4:5363:84d6```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```e6:7c:72:f4:25:54```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://morar-beier.name you initially access a DNS server to translate the host portion (morar-beier) combined with the Top Level Domain (name) of the URL, to an IP address like ```198.116.75.67```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT x.y; Win64; x64; rv:10.0) Gecko/20100101 Firefox/10.0```

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```192.168.63.114``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  192.168.63.114    UGScg  en0
...
<pre>
default   fe80:d4f3:f90b:18ee:4bff%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {198.254.3.149, 105.68.56.59}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr e6:7c:72:f4:25:54
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 19:a6:35:86:85:2e
}</pre>
