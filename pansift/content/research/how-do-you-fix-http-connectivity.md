...
layout: research
ip_v4_address: "15.77.203.16"
date: 2023-10-06T17:11:08+01:00
draft: false
---

## Internet Addressing
On the Internet you may have a Public IPv4 address like ```15.77.203.16``` or an IPv6 address like ```2000:7b05:b938:837b:4b39:bb62:601c:d01c```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```07:13:eb:af:80:7c```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://ullrich-keeling.net you initially access a DNS server to translate the host portion (ullrich-keeling) combined with the Top Level Domain (net) of the URL, to an IP address like ```29.221.105.196```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT x.y; Win64; x64; rv:10.0) Gecko/20100101 Firefox/10.0```
...
<pre>
default   fe80:e620:c54f:af9d:d5ca%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {187.49.101.120, 222.199.63.128}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 07:13:eb:af:80:7c
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 72:97:5b:18:2e:91
}</pre>
