---
title: "How Can I Support Jitter Connectivity"
subtitle: "Rubber Meets The Road?"
layout: research
ip_v4_address: "147.203.187.114"
date: 2023-10-06T17:11:05+01:00
draft: false
---

## Internet Addressing
On the Internet you might have a Public IPv4 address like ```147.203.187.114``` or an IPv6 address like ```2000:42a1:81e4:c763:be7c:d8c6:87f2:a55d```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```10:04:ab:c5:2e:9b```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://franecki-reichert.biz you initially access a DNS server to translate the host portion (franecki-reichert) combined with the Top Level Domain (biz) of the URL, to an IP address like ```193.177.76.11```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (compatible; MSIE 9.0; AOL 9.7; AOLBuild 4343.19; Windows NT 6.1; WOW64; Trident/5.0; FunWebProducts)```

## Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```172.27.153.61``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  172.27.153.61    UGScg  en0
...
<pre>
default   fe80:4318:e860:6fb3:1ec7%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {221.48.236.115, 186.2.64.192}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 10:04:ab:c5:2e:9b
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 50:78:74:6a:ed:6f
}</pre>
