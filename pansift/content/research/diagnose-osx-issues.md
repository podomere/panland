...
layout: research
ip_v4_address: "69.137.171.63"
date: 2022-06-12T14:09:15+01:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like ```69.137.171.63``` or an IPv6 address like ```2000:9cde:d5c4:82ea:6d81:9718:4f8d:7a44```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```37:73:40:7d:90:45```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://dare-hilll.io you initially access a DNS server to translate the host portion (dare-hilll) combined with the Top Level Domain (io) of the URL, to an IP address like ```132.180.74.160```. Your computer and browser actually sends its type with all web requests e.g. <br>```Opera/9.80 (X11; Linux i686; Ubuntu/14.10) Presto/2.12.388 Version/12.16```
...
<pre>
default   fe80:5a3e:41b:f022:e28%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {166.53.39.211, 38.210.146.24}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 37:73:40:7d:90:45
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr a1:51:c8:1d:06:ad
}</pre>
