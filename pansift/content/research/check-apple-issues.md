...
layout: research
ip_v4_address: "247.42.91.42"
date: 2022-06-04T14:38:29+01:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like ```247.42.91.42``` or an IPv6 address like ```2000:d154:8d35:caf7:e5e6:c123:dbb6:9c32```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```d8:31:56:73:28:13```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://jenkins-little.com you initially access a DNS server to translate the host portion (jenkins-little) combined with the Top Level Domain (com) of the URL, to an IP address like ```117.65.194.5```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/41.0.2228.0 Safari/537.36```
...
<pre>
default   fe80:5966:b21c:a357:8171%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {217.155.199.171, 141.94.144.124}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr d8:31:56:73:28:13
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 0c:7f:da:c9:32:47
}</pre>
