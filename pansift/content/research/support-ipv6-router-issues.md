...
layout: research
ip_v4_address: "212.120.138.207"
date: 2023-10-29T15:13:24+00:00
draft: false
---

## Internet Addressing
On the Internet you might get a Public IPv4 address like ```212.120.138.207``` or an IPv6 address like ```2000:e86c:a380:8e8f:864a:ee0:e3f1:f717```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```46:be:b6:d5:c3:af```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://von-von.info you initially access a DNS server to translate the host portion (von-von) combined with the Top Level Domain (info) of the URL, to an IP address like ```156.0.235.45```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1; WOW64; Trident/7.0; AS; rv:11.0) like Gecko```
...
<pre>
default   fe80:6b04:f41e:4d9b:95bb%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {191.99.129.13, 129.92.247.171}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 46:be:b6:d5:c3:af
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 2a:da:f8:8d:f7:02
}</pre>
