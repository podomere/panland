...
layout: research
ip_v4_address: "235.166.250.133"
date: 2022-11-19T19:13:27+00:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like ```235.166.250.133``` or an IPv6 address like ```2000:ed8a:edec:12df:d592:37c6:7278:4270```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```ee:84:3a:62:5e:94```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://lockman-zboncak.co you initially access a DNS server to translate the host portion (lockman-zboncak) combined with the Top Level Domain (co) of the URL, to an IP address like ```251.70.254.150```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows; U; Win 9x 4.90; SG; rv:1.9.2.4) Gecko/20101104 Netscape/9.1.0285```
...
<pre>
default   8334:480e:70:64c1:8549:c12d:b656:bc27%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {159.112.169.138, 54.116.123.88}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr ee:84:3a:62:5e:94
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 39:d7:38:e3:04:56
}</pre>
