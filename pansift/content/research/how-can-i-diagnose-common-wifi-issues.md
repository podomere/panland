...
layout: research
ip_v4_address: "88.122.45.231"
date: 2022-11-02T11:32:24+00:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like ```88.122.45.231``` or an IPv6 address like ```2000:b45e:d1c3:6acf:e939:4ed4:5963:a849```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```d1:d0:17:f6:15:30```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://sawayn-cruickshank.biz you initially access a DNS server to translate the host portion (sawayn-cruickshank) combined with the Top Level Domain (biz) of the URL, to an IP address like ```190.122.65.78```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (compatible; MSIE 9.0; AOL 9.7; AOLBuild 4343.19; Windows NT 6.1; WOW64; Trident/5.0; FunWebProducts)```
...
<pre>
default   fe80:f7b0:f3b9:934c:cb32%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {98.133.201.176, 166.219.55.141}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr d1:d0:17:f6:15:30
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr aa:58:03:e9:9d:57
}</pre>
