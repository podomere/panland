...
subtitle: "Swag?"
layout: research
ip_v4_address: "149.27.115.190"
date: 2022-06-04T14:38:17+01:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like ```149.27.115.190``` or an IPv6 address like ```2000:1708:63bd:b01b:fce0:775e:c1bc:ce76```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```e0:9f:53:23:69:95```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://williamson.org you initially access a DNS server to translate the host portion (williamson) combined with the Top Level Domain (org) of the URL, to an IP address like ```235.234.202.199```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/41.0.2228.0 Safari/537.36```
...
<pre>
default   fe80:d0bf:6c96:e76b:81d3%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {138.8.28.254, 85.116.197.187}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr e0:9f:53:23:69:95
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 0a:aa:36:cb:fa:3d
}</pre>
