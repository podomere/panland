...
layout: research
ip_v4_address: "119.208.88.139"
date: 2022-05-05T14:30:00+01:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like ```119.208.88.139``` or an IPv6 address like ```2000:85bb:8913:bde9:816c:f0a1:9be5:d691```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```2d:e7:21:19:c4:17```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://purdy-gutkowski.name you initially access a DNS server to translate the host portion (purdy-gutkowski) combined with the Top Level Domain (name) of the URL, to an IP address like ```252.194.255.78```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (compatible; MSIE 9.0; AOL 9.7; AOLBuild 4343.19; Windows NT 6.1; WOW64; Trident/5.0; FunWebProducts)```

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```10.68.133.30``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  10.68.133.30    UGScg  en0
...
<pre>
default   fe80:98a3:5171:17bc:e9db%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {237.76.195.79, 154.19.192.184}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 2d:e7:21:19:c4:17
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr a7:8a:2e:6e:9f:e6
}</pre>
