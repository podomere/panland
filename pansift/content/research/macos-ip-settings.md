...
layout: research
ip_v4_address: "107.198.232.244"
date: 2022-04-24T19:00:22+01:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like <code>107.198.232.244</code> or an IPv6 address like <code>2000:3a11:ff4:7fe8:e304:69ba:2e75:a683</code>. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>11:11:87:ec:f0:98</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://treutel.org you initially access a DNS server to translate the host portion (treutel) combined with the Top Level Domain (org) of the URL, to an IP address like <code>186.184.210.65</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_3) AppleWebKit/537.75.14 (KHTML, like Gecko) Version/7.0.3 Safari/7046A194A</code>
...
<pre><code>
default   fe80:e6ce:f312:6fcf:c4f%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {147.130.130.9, 183.162.134.203}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 11:11:87:ec:f0:98
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr d9:a5:32:23:0e:8e
}</code></pre>
