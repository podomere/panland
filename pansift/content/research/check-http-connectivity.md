...
layout: research
ip_v4_address: "51.135.9.100"
date: 2022-04-24T19:00:03+01:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like <code>51.135.9.100</code> or an IPv6 address like <code>2000:1595:592f:681:c2ac:b54b:2880:b139</code>. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>60:18:98:bc:93:c3</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://dubuque-hegmann.name you initially access a DNS server to translate the host portion (dubuque-hegmann) combined with the Top Level Domain (name) of the URL, to an IP address like <code>217.122.134.11</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (compatible; MSIE 9.0; AOL 9.7; AOLBuild 4343.19; Windows NT 6.1; WOW64; Trident/5.0; FunWebProducts)</code>
...
<pre><code>
default   fe80:b260:5863:3d4:b4c0%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {37.11.225.123, 180.215.160.175}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 60:18:98:bc:93:c3
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr d8:03:1b:03:2a:89
}</code></pre>
