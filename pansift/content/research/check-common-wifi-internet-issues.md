...
subtitle: "Etc. Etc.?"
layout: research
ip_v4_address: "194.204.3.103"
date: 2022-05-05T14:28:28+01:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like ```194.204.3.103``` or an IPv6 address like ```2000:9cfe:b445:edea:de4b:7796:e7c7:bd94```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```b7:16:99:f5:18:3b```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://senger-beahan.net you initially access a DNS server to translate the host portion (senger-beahan) combined with the Top Level Domain (net) of the URL, to an IP address like ```135.69.196.147```. Your computer and browser actually sends its type with all web requests e.g. <br>```Opera/9.80 (X11; Linux i686; Ubuntu/14.10) Presto/2.12.388 Version/12.16```
...
<pre>
default   fe80:a41a:574e:dfa6:ef8%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {136.12.29.30, 100.23.105.145}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr b7:16:99:f5:18:3b
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr c1:25:10:32:d5:9e
}</pre>
...
## Apple macOS / OSX
No matter what version of OSX/macOS you are on, ```10.14.6```, ```11.5.8```, or ```12.2.1```, there are a range of tools for troubleshooting. Unfortunately, between these manual actions and scripts, they don't give you a series of correlated values over time. This is where automated remote troubleshooting comes in to its own, especially for teams that embrace remote work and Work From Anywhere (WFA).
