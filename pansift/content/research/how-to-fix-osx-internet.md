...
subtitle: "Ideate?"
layout: research
ip_v4_address: "68.36.58.0"
date: 2022-04-24T19:00:24+01:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like <code>68.36.58.0</code> or an IPv6 address like <code>2000:8bfa:b8fd:af92:73a8:e693:c799:6a16</code>. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>a1:2d:5c:38:97:53</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://jerde-crona.name you initially access a DNS server to translate the host portion (jerde-crona) combined with the Top Level Domain (name) of the URL, to an IP address like <code>39.123.148.100</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_3) AppleWebKit/537.75.14 (KHTML, like Gecko) Version/7.0.3 Safari/7046A194A</code>
...
default  172.16.122.252    UGScg  en0
...
<pre><code>
default   fe80:c250:c743:9ef6:36dc%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {151.95.148.29, 203.106.156.41}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr a1:2d:5c:38:97:53
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 25:96:80:57:97:8f
}</code></pre>
