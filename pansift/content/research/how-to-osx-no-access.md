...
subtitle: "Etc. Etc.?"
layout: research
ip_v4_address: "73.226.8.0"
date: 2022-11-19T16:17:12+00:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like ```73.226.8.0``` or an IPv6 address like ```2000:f466:2e8d:daa3:4abf:add:1277:7513```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```5d:fb:21:93:15:8b```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://johns.io you initially access a DNS server to translate the host portion (johns) combined with the Top Level Domain (io) of the URL, to an IP address like ```199.145.14.7```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (compatible; MSIE 9.0; AOL 9.7; AOLBuild 4343.19; Windows NT 6.1; WOW64; Trident/5.0; FunWebProducts)```
...
<pre>
default   fe80:2d8d:1a8d:7fae:ba97%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {34.0.156.19, 119.205.144.115}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 5d:fb:21:93:15:8b
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr f6:f8:b6:ec:2a:cd
}</pre>
