...
layout: research
ip_v4_address: "27.244.125.153"
date: 2022-11-19T16:17:22+00:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like ```27.244.125.153``` or an IPv6 address like ```2000:673:a6dd:11ec:7c90:e7b:baad:d7b0```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```f0:17:6e:22:9a:c1```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://adams-ondricka.io you initially access a DNS server to translate the host portion (adams-ondricka) combined with the Top Level Domain (io) of the URL, to an IP address like ```140.85.201.21```. Your computer and browser actually sends its type with all web requests e.g. <br>```Opera/9.80 (X11; Linux i686; Ubuntu/14.10) Presto/2.12.388 Version/12.16```
...
<pre>
default   fe80:b3f4:fd3a:ea88:8c38%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {202.238.96.8, 234.156.215.212}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr f0:17:6e:22:9a:c1
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 19:e2:98:35:b6:cb
}</pre>
