...
subtitle: "Streamline?"
layout: research
ip_v4_address: "86.105.242.190"
date: 2022-04-24T19:00:01+01:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like <code>86.105.242.190</code> or an IPv6 address like <code>2000:7b05:b1a1:30bc:8772:8259:56fc:71e7</code>. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>75:dd:c8:84:91:9c</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://rutherford-stroman.co you initially access a DNS server to translate the host portion (rutherford-stroman) combined with the Top Level Domain (co) of the URL, to an IP address like <code>225.89.241.34</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (Windows NT x.y; Win64; x64; rv:10.0) Gecko/20100101 Firefox/10.0</code>
...
<pre><code>
default   fe80:8153:654a:ab75:9fae%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {18.55.154.32, 99.160.6.24}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 75:dd:c8:84:91:9c
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 87:48:05:84:e6:08
}</code></pre>
