...
layout: research
ip_v4_address: "3.2.107.38"
date: 2022-11-19T16:17:19+00:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like ```3.2.107.38``` or an IPv6 address like ```2000:f66f:b2c4:5df4:dc2b:dd00:c000:6db1```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```8c:d9:ab:09:05:f2```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://hane-gottlieb.io you initially access a DNS server to translate the host portion (hane-gottlieb) combined with the Top Level Domain (io) of the URL, to an IP address like ```33.216.150.233```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (compatible; MSIE 9.0; AOL 9.7; AOLBuild 4343.19; Windows NT 6.1; WOW64; Trident/5.0; FunWebProducts)```
...
<pre>
default   fe80:469e:9f08:9bb1:2cbe%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {249.61.12.151, 66.205.41.128}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 8c:d9:ab:09:05:f2
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr cd:03:03:37:93:e5
}</pre>
