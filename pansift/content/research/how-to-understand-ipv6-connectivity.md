...
layout: research
ip_v4_address: "228.235.67.51"
date: 2022-11-02T11:32:52+00:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like ```228.235.67.51``` or an IPv6 address like ```2000:49e1:711e:32ef:2760:118a:fe77:5435```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```21:ee:03:6b:5f:c7```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://koelpin-klein.com you initially access a DNS server to translate the host portion (koelpin-klein) combined with the Top Level Domain (com) of the URL, to an IP address like ```151.111.234.93```. Your computer and browser actually sends its type with all web requests e.g. <br>```Opera/9.80 (X11; Linux i686; Ubuntu/14.10) Presto/2.12.388 Version/12.16```
...
<pre>
default   fe80:a789:e61b:b11e:ec30%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {235.58.104.144, 122.226.222.150}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 21:ee:03:6b:5f:c7
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr c1:f7:62:29:44:90
}</pre>
...
## Apple macOS / OSX
No matter what version of OSX/macOS you are on, ```10.12.2```, ```11.6.5```, or ```12.1.6```, there are a range of tools for troubleshooting. Unfortunately, between these manual actions and scripts, they don't give you a series of correlated values over time. This is where automated remote troubleshooting comes in to its own, especially for teams that embrace remote work and Work From Anywhere (WFA).
