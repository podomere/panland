...
layout: research
ip_v4_address: "211.52.223.108"
date: 2022-04-24T18:59:55+01:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like <code>211.52.223.108</code> or an IPv6 address like <code>2000:3e78:c9e2:f92:12cb:3837:8e6e:9e3a</code>. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>c8:7b:42:1f:5f:61</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://weber-hoeger.org you initially access a DNS server to translate the host portion (weber-hoeger) combined with the Top Level Domain (org) of the URL, to an IP address like <code>193.140.111.232</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (Windows; U; Win 9x 4.90; SG; rv:1.9.2.4) Gecko/20101104 Netscape/9.1.0285</code>
...
<pre><code>
default   fe80:b92d:567f:3e77:e972%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {244.72.43.26, 204.91.143.150}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr c8:7b:42:1f:5f:61
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 88:e8:ab:ea:05:a5
}</code></pre>
