...
layout: research
ip_v4_address: "42.76.246.45"
date: 2022-11-19T19:13:17+00:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like ```42.76.246.45``` or an IPv6 address like ```2000:7b39:a93:670a:bd7d:4851:dad4:2f20```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```99:9a:23:4c:38:41```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://corwin.org you initially access a DNS server to translate the host portion (corwin) combined with the Top Level Domain (org) of the URL, to an IP address like ```205.106.83.133```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1; WOW64; Trident/7.0; AS; rv:11.0) like Gecko```
...
<pre>
default   fe80:980f:6cd7:9dce:28e4%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {35.84.107.24, 201.197.213.116}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 99:9a:23:4c:38:41
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr f3:60:11:af:54:b8
}</pre>
