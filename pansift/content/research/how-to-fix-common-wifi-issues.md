...
layout: research
ip_v4_address: "199.244.19.169"
date: 2023-02-04T16:26:03+00:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like ```199.244.19.169``` or an IPv6 address like ```2000:73c7:3875:afb9:dace:5d9e:3498:4475```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```5e:2f:d8:d3:68:09```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://macejkovic-mraz.biz you initially access a DNS server to translate the host portion (macejkovic-mraz) combined with the Top Level Domain (biz) of the URL, to an IP address like ```219.10.61.167```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (compatible; MSIE 9.0; AOL 9.7; AOLBuild 4343.19; Windows NT 6.1; WOW64; Trident/5.0; FunWebProducts)```
...
<pre>
default   fe80:4f47:7871:f35d:88e9%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {160.187.255.124, 88.201.106.239}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 5e:2f:d8:d3:68:09
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 79:d7:9e:d4:6f:0f
}</pre>
