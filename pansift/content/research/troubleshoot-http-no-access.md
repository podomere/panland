...
layout: research
ip_v4_address: "163.110.239.62"
date: 2023-10-29T15:13:29+00:00
draft: false
---

## Internet Addressing
On the Internet you might have a Public IPv4 address like ```163.110.239.62``` or an IPv6 address like ```2000:4451:7598:d6e9:3a6c:9964:f3bc:d17```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```e2:ff:ad:59:67:73```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://lang.io you initially access a DNS server to translate the host portion (lang) combined with the Top Level Domain (io) of the URL, to an IP address like ```213.38.88.42```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1; WOW64; Trident/7.0; AS; rv:11.0) like Gecko```
...
<pre>
default   fe80:9695:442b:da8:560d%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {134.115.8.68, 191.52.83.213}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr e2:ff:ad:59:67:73
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 41:cf:18:42:14:c8
}</pre>
