...
layout: research
ip_v4_address: "70.121.184.159"
date: 2022-12-15T13:50:22+00:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like ```70.121.184.159``` or an IPv6 address like ```2000:85f3:2569:63df:e0aa:656b:69d3:43e6```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```09:b9:2b:1d:08:64```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://witting-beatty.com you initially access a DNS server to translate the host portion (witting-beatty) combined with the Top Level Domain (com) of the URL, to an IP address like ```103.141.150.178```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/41.0.2228.0 Safari/537.36```
...
<pre>
default   fe80:3822:7711:c90d:9192%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {112.118.50.82, 104.118.54.52}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 09:b9:2b:1d:08:64
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr d2:de:ea:6e:bc:24
}</pre>
