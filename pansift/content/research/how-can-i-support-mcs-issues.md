...
layout: research
ip_v4_address: "162.128.148.37"
date: 2022-06-12T14:09:05+01:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like ```162.128.148.37``` or an IPv6 address like ```2000:9486:e078:9b19:8a1b:197c:947a:435a```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```20:0f:02:25:2b:30```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://jenkins.net you initially access a DNS server to translate the host portion (jenkins) combined with the Top Level Domain (net) of the URL, to an IP address like ```197.117.232.239```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (compatible; MSIE 9.0; AOL 9.7; AOLBuild 4343.19; Windows NT 6.1; WOW64; Trident/5.0; FunWebProducts)```
...
<pre>
default   fe80:a342:494a:d85d:9f39%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {180.29.5.150, 140.178.243.206}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 20:0f:02:25:2b:30
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr f8:8b:ce:21:b3:f6
}</pre>
...
## Apple macOS / OSX
No matter what version of OSX/macOS you are on, ```10.11.3```, ```11.5.2```, or ```12.2.8```, there are a range of tools for troubleshooting. Unfortunately, between these manual actions and scripts, they don't give you a series of correlated values over time. This is where automated remote troubleshooting comes in to its own, especially for teams that embrace remote work and Work From Anywhere (WFA).
