...
layout: research
ip_v4_address: "33.55.42.172"
date: 2022-11-19T19:13:23+00:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like ```33.55.42.172``` or an IPv6 address like ```2000:233e:f28a:b0db:6eef:99bf:80d1:bb5d```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```04:b4:5c:3f:46:ce```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://stokes-witting.com you initially access a DNS server to translate the host portion (stokes-witting) combined with the Top Level Domain (com) of the URL, to an IP address like ```171.70.58.70```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows; U; Win 9x 4.90; SG; rv:1.9.2.4) Gecko/20101104 Netscape/9.1.0285```
...
<pre>
default   fe80:1e89:8d15:a40:4231%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {84.21.62.103, 191.162.80.158}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 04:b4:5c:3f:46:ce
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 04:21:20:4d:da:4e
}</pre>
