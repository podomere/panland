...
layout: research
ip_v4_address: "132.135.109.216"
date: 2022-06-12T14:09:15+01:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like ```132.135.109.216``` or an IPv6 address like ```2000:e4b:d244:b725:4a9a:fb99:83bc:b53b```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```e8:79:5a:30:10:dd```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://hackett-torp.org you initially access a DNS server to translate the host portion (hackett-torp) combined with the Top Level Domain (org) of the URL, to an IP address like ```55.209.108.99```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT x.y; Win64; x64; rv:10.0) Gecko/20100101 Firefox/10.0```
...
<pre>
default   fe80:cb97:7981:b6b2:ac7%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {212.205.204.128, 52.239.85.29}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr e8:79:5a:30:10:dd
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 43:da:57:e8:5c:95
}</pre>
