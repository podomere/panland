...
layout: research
ip_v4_address: "167.123.180.223"
date: 2022-04-24T19:00:32+01:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like <code>167.123.180.223</code> or an IPv6 address like <code>2000:b0ff:6122:d40f:ca5c:332:7050:ca79</code>. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>9a:97:3c:31:8e:5a</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://torphy-ratke.biz you initially access a DNS server to translate the host portion (torphy-ratke) combined with the Top Level Domain (biz) of the URL, to an IP address like <code>185.103.187.103</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (compatible; MSIE 9.0; AOL 9.7; AOLBuild 4343.19; Windows NT 6.1; WOW64; Trident/5.0; FunWebProducts)</code>
...
<pre><code>
default   fe80:dbad:6b15:502f:b3f2%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {56.67.62.6, 189.121.147.199}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 9a:97:3c:31:8e:5a
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 64:4c:a2:58:5f:2e
}</code></pre>
