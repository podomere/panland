...
layout: research
ip_v4_address: "24.88.188.198"
date: 2022-06-12T14:09:26+01:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like ```24.88.188.198``` or an IPv6 address like ```2000:404:352e:96c3:3eeb:e0dd:aeeb:362d```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```05:90:57:0b:d2:30```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://kris-crooks.net you initially access a DNS server to translate the host portion (kris-crooks) combined with the Top Level Domain (net) of the URL, to an IP address like ```229.93.137.29```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_3) AppleWebKit/537.75.14 (KHTML, like Gecko) Version/7.0.3 Safari/7046A194A```
...
<pre>
default   fe80:f6e9:452a:b389:c274%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {151.32.174.191, 241.204.41.228}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 05:90:57:0b:d2:30
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 5b:65:c8:1a:1a:4c
}</pre>
