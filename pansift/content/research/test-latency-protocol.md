...
layout: research
ip_v4_address: "244.56.123.123"
date: 2022-04-24T18:59:57+01:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like <code>244.56.123.123</code> or an IPv6 address like <code>2000:35de:5c0f:f074:ba4b:f527:6ef8:c0bb</code>. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>e3:d1:85:05:e2:46</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://champlin-bernier.info you initially access a DNS server to translate the host portion (champlin-bernier) combined with the Top Level Domain (info) of the URL, to an IP address like <code>165.150.114.101</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_3) AppleWebKit/537.75.14 (KHTML, like Gecko) Version/7.0.3 Safari/7046A194A</code>
...
<pre><code>
default   fe80:d8e1:a7aa:33b3:228e%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {42.91.29.231, 70.179.223.89}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr e3:d1:85:05:e2:46
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr ee:93:00:2d:44:46
}</code></pre>
