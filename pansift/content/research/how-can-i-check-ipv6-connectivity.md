...
layout: research
ip_v4_address: "116.33.82.43"
date: 2022-06-04T14:38:37+01:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like ```116.33.82.43``` or an IPv6 address like ```2000:10d6:31a5:a3e7:96cb:b49f:c70:2d75```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```ba:68:ee:7a:d3:3f```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://west.name you initially access a DNS server to translate the host portion (west) combined with the Top Level Domain (name) of the URL, to an IP address like ```80.146.134.10```. Your computer and browser actually sends its type with all web requests e.g. <br>```Opera/9.80 (X11; Linux i686; Ubuntu/14.10) Presto/2.12.388 Version/12.16```
...
<pre>
default   fe80:d934:6ffc:6fe3:3696%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {121.97.208.225, 53.87.92.111}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr ba:68:ee:7a:d3:3f
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 43:ec:a4:76:de:f9
}</pre>
...
## Apple macOS / OSX
No matter what version of OSX/macOS you are on, ```10.15.8```, ```11.5.8```, or ```12.2.3```, there are a range of tools for troubleshooting. Unfortunately, between these manual actions and scripts, they don't give you a series of correlated values over time. This is where automated remote troubleshooting comes in to its own, especially for teams that embrace remote work and Work From Anywhere (WFA).
