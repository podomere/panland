---
title: "Test Jitter Connectivity"
subtitle: "Let's Take This Offline?"
layout: research
ip_v4_address: "5.239.143.13"
date: 2022-04-24T18:59:59+01:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like <code>5.239.143.13</code> or an IPv6 address like <code>2000:251e:8b86:807c:8fd3:9f7:5d13:b5de</code>. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>d7:af:0e:27:16:c8</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://olson-kshlerin.co you initially access a DNS server to translate the host portion (olson-kshlerin) combined with the Top Level Domain (co) of the URL, to an IP address like <code>226.114.103.239</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Opera/9.80 (X11; Linux i686; Ubuntu/14.10) Presto/2.12.388 Version/12.16</code>

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like <code>10.187.68.67</code> (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For <code>IPv6</code> we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  10.187.68.67    UGScg  en0
...
<pre><code>
default   fe80:685b:6acf:d7c:65c%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {203.182.172.247, 192.47.201.210}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr d7:af:0e:27:16:c8
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 0b:5f:d7:3c:4c:a0
}</code></pre>
