...
layout: research
ip_v4_address: "129.224.250.168"
date: 2023-10-29T15:13:27+00:00
draft: false
---

## Internet Addressing
On the Internet you might have a Public IPv4 address like ```129.224.250.168``` or an IPv6 address like ```2000:6a2b:82bd:934f:ff84:746:5ac2:f36b```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```05:b4:3a:2f:c2:dd```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://schuppe.info you initially access a DNS server to translate the host portion (schuppe) combined with the Top Level Domain (info) of the URL, to an IP address like ```5.235.99.190```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_3) AppleWebKit/537.75.14 (KHTML, like Gecko) Version/7.0.3 Safari/7046A194A```
...
<pre>
default   fe80:e6cb:8b4b:a9fb:c019%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {210.47.20.142, 191.86.228.173}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 05:b4:3a:2f:c2:dd
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 6e:42:f1:f5:7c:9e
}</pre>
