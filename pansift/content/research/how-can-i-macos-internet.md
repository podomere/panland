...
subtitle: "Swim Lane?"
layout: research
ip_v4_address: "219.68.202.213"
date: 2022-04-24T19:00:23+01:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like <code>219.68.202.213</code> or an IPv6 address like <code>2000:506b:b399:b813:ffae:777b:3529:e41e</code>. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>8d:79:b0:dd:78:27</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://gutkowski-abbott.info you initially access a DNS server to translate the host portion (gutkowski-abbott) combined with the Top Level Domain (info) of the URL, to an IP address like <code>174.118.59.165</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (Windows NT 6.1; WOW64; Trident/7.0; AS; rv:11.0) like Gecko</code>

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like <code>172.18.78.12</code> (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For <code>IPv6</code> we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  172.18.78.12    UGScg  en0
...
<pre><code>
default   fe80:b05:3756:79e3:e2b6%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {52.110.244.193, 107.0.46.209}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 8d:79:b0:dd:78:27
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 73:2c:08:60:60:00
}</code></pre>
