...
subtitle: "Deep Dive?"
layout: research
ip_v4_address: "144.117.45.198"
date: 2023-10-06T17:10:43+01:00
draft: false
---

## Internet Addressing
On the Internet you may have a Public IPv4 address like ```144.117.45.198``` or an IPv6 address like ```2000:acd8:649e:67d0:97df:fa01:8719:13e6```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```d8:02:ca:c8:04:7b```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://willms-kulas.org you initially access a DNS server to translate the host portion (willms-kulas) combined with the Top Level Domain (org) of the URL, to an IP address like ```23.127.3.57```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows; U; Win 9x 4.90; SG; rv:1.9.2.4) Gecko/20101104 Netscape/9.1.0285```
...
<pre>
default   fe80:b792:d070:9de8:5913%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {111.129.144.144, 130.248.222.64}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr d8:02:ca:c8:04:7b
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 16:9a:00:b4:34:10
}</pre>
