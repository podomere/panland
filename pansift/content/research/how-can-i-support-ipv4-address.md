...
layout: research
ip_v4_address: "98.149.139.206"
date: 2022-11-19T19:13:24+00:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like ```98.149.139.206``` or an IPv6 address like ```2000:b498:373c:3da5:6ba:17f3:4ccc:cc75```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```9b:01:00:e7:d4:4b```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://kling-shields.co you initially access a DNS server to translate the host portion (kling-shields) combined with the Top Level Domain (co) of the URL, to an IP address like ```121.27.32.142```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows; U; Win 9x 4.90; SG; rv:1.9.2.4) Gecko/20101104 Netscape/9.1.0285```
...
<pre>
default   fe80:c8d9:2cd9:21c:5381%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {228.186.149.15, 183.86.96.172}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 9b:01:00:e7:d4:4b
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 1c:bc:e2:c4:47:fd
}</pre>
