...
layout: research
ip_v4_address: "66.215.84.154"
date: 2023-10-29T15:13:12+00:00
draft: false
---

## Internet Addressing
On the Internet you might get a Public IPv4 address like ```66.215.84.154``` or an IPv6 address like ```2000:d5ba:9b20:c330:807c:90da:1b85:9169```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```08:00:5e:13:3a:62```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://klocko.com you initially access a DNS server to translate the host portion (klocko) combined with the Top Level Domain (com) of the URL, to an IP address like ```137.103.28.130```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_3) AppleWebKit/537.75.14 (KHTML, like Gecko) Version/7.0.3 Safari/7046A194A```
...
<pre>
default   fe80:826a:d93f:d469:4ceb%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {218.142.18.155, 48.97.42.244}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 08:00:5e:13:3a:62
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 2a:3f:be:d3:16:21
}</pre>
...
### Apple macOS / OSX
No matter what version of OSX/macOS you are on, ```10.15.7```, ```11.2.9```, or ```12.0.3```, there are a range of tools for troubleshooting. Unfortunately, between these manual actions and scripts, they don't give you a series of correlated values over time. This is where automated remote troubleshooting comes in to its own, especially for teams that embrace remote work and Work From Anywhere (WFA).
