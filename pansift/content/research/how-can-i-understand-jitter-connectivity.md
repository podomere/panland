...
layout: research
ip_v4_address: "110.59.227.151"
date: 2023-02-04T17:08:37+00:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like ```110.59.227.151``` or an IPv6 address like ```2000:f297:359b:8b09:ca7c:15aa:a9f5:a964```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```23:87:1a:46:f3:bd```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://daniel-kutch.com you initially access a DNS server to translate the host portion (daniel-kutch) combined with the Top Level Domain (com) of the URL, to an IP address like ```33.47.27.104```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1; WOW64; Trident/7.0; AS; rv:11.0) like Gecko```
...
<pre>
default   fe80:1935:e2d8:6783:f03%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {48.70.152.170, 84.184.131.165}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 23:87:1a:46:f3:bd
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr d7:07:03:ca:76:72
}</pre>
