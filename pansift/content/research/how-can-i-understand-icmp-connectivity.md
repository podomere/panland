---
title: "How Can I Understand Icmp Connectivity"
subtitle: "Value Proposition?"
layout: research
ip_v4_address: "9.75.28.187"
date: 2022-11-19T16:17:23+00:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like ```9.75.28.187``` or an IPv6 address like ```2000:5e54:55a8:3085:85ed:571a:78f9:e64c```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```6f:54:76:e8:06:d3```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://lindgren-reichert.io you initially access a DNS server to translate the host portion (lindgren-reichert) combined with the Top Level Domain (io) of the URL, to an IP address like ```84.244.7.198```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (compatible; MSIE 9.0; AOL 9.7; AOLBuild 4343.19; Windows NT 6.1; WOW64; Trident/5.0; FunWebProducts)```

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```192.168.217.205``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  192.168.217.205    UGScg  en0
...
<pre>
default   fe80:867c:3e39:8df8:935b%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {111.213.129.27, 183.180.81.21}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 6f:54:76:e8:06:d3
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 8c:7d:d4:7a:63:b9
}</pre>
