...
layout: research
ip_v4_address: "88.3.139.195"
date: 2022-04-24T19:00:33+01:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like <code>88.3.139.195</code> or an IPv6 address like <code>2000:22c4:2fc0:b2d4:e0ca:4dec:bb29:1235</code>. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>9c:79:9c:7a:49:4f</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://kling.biz you initially access a DNS server to translate the host portion (kling) combined with the Top Level Domain (biz) of the URL, to an IP address like <code>173.27.199.142</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Opera/9.80 (X11; Linux i686; Ubuntu/14.10) Presto/2.12.388 Version/12.16</code>
...
<pre><code>
default   fe80:6f7d:58a2:35a4:531d%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {185.101.216.198, 106.92.58.249}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 9c:79:9c:7a:49:4f
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr b6:fb:0a:ca:16:c7
}</code></pre>
