...
layout: research
ip_v4_address: "122.163.249.88"
date: 2023-10-06T17:11:03+01:00
draft: false
---

## Internet Addressing
On the Internet you may get a Public IPv4 address like ```122.163.249.88``` or an IPv6 address like ```2000:c30c:4c50:4603:62c7:13a:c1dd:7048```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```83:3e:9e:b8:af:7b```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://macejkovic.biz you initially access a DNS server to translate the host portion (macejkovic) combined with the Top Level Domain (biz) of the URL, to an IP address like ```31.166.244.38```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows; U; Win 9x 4.90; SG; rv:1.9.2.4) Gecko/20101104 Netscape/9.1.0285```

## Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```10.142.159.165``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  10.142.159.165    UGScg  en0
...
<pre>
default   fe80:2525:c44d:6a4f:e9c0%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {120.138.90.211, 57.240.61.247}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 83:3e:9e:b8:af:7b
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr bc:b6:6c:b0:45:64
}</pre>
...
### Apple macOS / OSX
No matter what version of OSX/macOS you are on, ```10.14.3```, ```11.2.3```, or ```12.1.1```, there are a range of tools for troubleshooting. Unfortunately, between these manual actions and scripts, they don't give you a series of correlated values over time. This is where automated remote troubleshooting comes in to its own, especially for teams that embrace remote work and Work From Anywhere (WFA).
