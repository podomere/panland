...
layout: research
ip_v4_address: "59.37.209.123"
date: 2023-10-06T17:10:43+01:00
draft: false
---

## Internet Addressing
On the Internet you may have a Public IPv4 address like ```59.37.209.123``` or an IPv6 address like ```2000:7606:15d6:d3f7:7d8:97d2:428c:9c9b```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```9d:18:65:65:24:5f```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://boehm.net you initially access a DNS server to translate the host portion (boehm) combined with the Top Level Domain (net) of the URL, to an IP address like ```247.60.47.29```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (compatible; MSIE 9.0; AOL 9.7; AOLBuild 4343.19; Windows NT 6.1; WOW64; Trident/5.0; FunWebProducts)```

## Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```10.146.194.251``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  10.146.194.251    UGScg  en0
...
<pre>
default   fe80:27c1:faf:75d8:fc55%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {15.151.242.204, 46.61.85.74}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 9d:18:65:65:24:5f
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 85:d7:a9:3b:b1:e1
}</pre>
...
### Apple macOS / OSX
No matter what version of OSX/macOS you are on, ```10.15.1```, ```11.2.2```, or ```12.3.6```, there are a range of tools for troubleshooting. Unfortunately, between these manual actions and scripts, they don't give you a series of correlated values over time. This is where automated remote troubleshooting comes in to its own, especially for teams that embrace remote work and Work From Anywhere (WFA).
