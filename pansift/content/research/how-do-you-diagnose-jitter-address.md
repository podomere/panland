...
subtitle: "Heads Down?"
layout: research
ip_v4_address: "113.253.225.109"
date: 2023-10-29T15:13:27+00:00
draft: false
---

## Internet Addressing
On the Internet you might have a Public IPv4 address like ```113.253.225.109``` or an IPv6 address like ```2000:2443:11db:6664:605e:1008:aaaf:5dc3```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```59:27:c3:88:d9:fc```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://stoltenberg-klocko.io you initially access a DNS server to translate the host portion (stoltenberg-klocko) combined with the Top Level Domain (io) of the URL, to an IP address like ```136.197.78.5```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT x.y; Win64; x64; rv:10.0) Gecko/20100101 Firefox/10.0```

## Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```10.99.21.230``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  10.99.21.230    UGScg  en0
...
<pre>
default   fe80:74f6:f5d0:d730:9e6d%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {35.198.23.85, 195.150.10.14}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 59:27:c3:88:d9:fc
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr bd:82:0a:d4:41:a3
}</pre>
...
### Apple macOS / OSX
No matter what version of OSX/macOS you are on, ```10.12.3```, ```11.6.4```, or ```12.3.3```, there are a range of tools for troubleshooting. Unfortunately, between these manual actions and scripts, they don't give you a series of correlated values over time. This is where automated remote troubleshooting comes in to its own, especially for teams that embrace remote work and Work From Anywhere (WFA).
