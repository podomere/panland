...
layout: research
ip_v4_address: "122.30.147.226"
date: 2022-04-24T18:32:41+01:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like <code>122.30.147.226</code> or an IPv6 address like <code>2000:3736:8baf:b98a:4802:8d78:6db9:44e</code>. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>06:7c:43:53:91:d9</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://jacobson.name you initially access a DNS server to translate the host portion (jacobson) combined with the Top Level Domain (name) of the URL, to an IP address like <code>146.30.221.117</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (Windows NT 6.1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/41.0.2228.0 Safari/537.36</code>

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like <code>172.28.241.175</code> (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For <code>IPv6</code> we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  172.28.241.175    UGScg  en0
...
<pre><code>
default   fe80:1b5a:9a5f:a1c2:3ca5%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {100.228.124.89, 234.197.155.93}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 06:7c:43:53:91:d9
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 21:7c:ef:84:7a:db
}</code></pre>
