...
layout: research
ip_v4_address: "179.163.72.192"
date: 2022-11-19T19:13:27+00:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like ```179.163.72.192``` or an IPv6 address like ```2000:faba:bce6:36eb:29a8:673f:84ec:a6e1```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```09:27:51:fd:d4:2b```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://mcglynn-carter.name you initially access a DNS server to translate the host portion (mcglynn-carter) combined with the Top Level Domain (name) of the URL, to an IP address like ```61.195.124.26```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_3) AppleWebKit/537.75.14 (KHTML, like Gecko) Version/7.0.3 Safari/7046A194A```

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```192.168.61.134``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
<pre>
default   fe80:6378:f193:ec30:8d00%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {180.183.78.252, 0.40.109.254}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 09:27:51:fd:d4:2b
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr c8:5c:38:c1:8a:21
}</pre>
...
## Apple macOS / OSX
No matter what version of OSX/macOS you are on, ```10.13.8```, ```11.3.3```, or ```12.3.7```, there are a range of tools for troubleshooting. Unfortunately, between these manual actions and scripts, they don't give you a series of correlated values over time. This is where automated remote troubleshooting comes in to its own, especially for teams that embrace remote work and Work From Anywhere (WFA).
