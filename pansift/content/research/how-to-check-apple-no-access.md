...
layout: research
ip_v4_address: "159.183.152.80"
date: 2022-04-24T18:31:58+01:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like <code>159.183.152.80</code> or an IPv6 address like <code>2000:6fcc:98d9:77e3:100b:f31f:fe36:81c6</code>. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>29:e8:ba:7d:26:17</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://quigley-sanford.io you initially access a DNS server to translate the host portion (quigley-sanford) combined with the Top Level Domain (io) of the URL, to an IP address like <code>222.134.53.50</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Opera/9.80 (X11; Linux i686; Ubuntu/14.10) Presto/2.12.388 Version/12.16</code>
...
<pre><code>
default   fe80:e9d3:ba10:d991:a499%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {162.114.247.82, 134.2.247.136}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 29:e8:ba:7d:26:17
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr e7:41:8e:a1:81:cf
}</code></pre>
