...
layout: research
ip_v4_address: "102.100.216.133"
date: 2022-12-15T13:50:10+00:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like ```102.100.216.133``` or an IPv6 address like ```2000:8208:9ebb:d1c2:55c6:7e8f:6af4:ac19```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```cf:e3:93:0b:f8:ee```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://kreiger-greenholt.biz you initially access a DNS server to translate the host portion (kreiger-greenholt) combined with the Top Level Domain (biz) of the URL, to an IP address like ```235.208.158.190```. Your computer and browser actually sends its type with all web requests e.g. <br>```Opera/9.80 (X11; Linux i686; Ubuntu/14.10) Presto/2.12.388 Version/12.16```
...
<pre>
default   fe80:c2ca:4394:39e4:3c03%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {134.100.224.90, 90.204.55.193}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr cf:e3:93:0b:f8:ee
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr ad:54:ef:70:a3:70
}</pre>
