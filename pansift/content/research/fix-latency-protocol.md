...
layout: research
ip_v4_address: "64.142.197.194"
date: 2022-11-19T19:13:24+00:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like ```64.142.197.194``` or an IPv6 address like ```2000:1aee:5755:37a3:3f43:c6f2:282a:d7fc```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```89:b6:59:85:c4:49```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://bartoletti.io you initially access a DNS server to translate the host portion (bartoletti) combined with the Top Level Domain (io) of the URL, to an IP address like ```125.255.59.136```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/41.0.2228.0 Safari/537.36```
...
default  172.24.92.250    UGScg  en0
...
<pre>
default   fe80:b9f5:5443:634c:9c97%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {63.242.119.180, 146.199.189.228}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 89:b6:59:85:c4:49
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr e7:e2:98:54:f9:5d
}</pre>
