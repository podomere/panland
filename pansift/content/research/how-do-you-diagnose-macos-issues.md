...
subtitle: "Swag?"
layout: research
ip_v4_address: "180.93.145.78"
date: 2022-11-19T16:17:12+00:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like ```180.93.145.78``` or an IPv6 address like ```2000:6a4b:5598:ee45:9452:ed4d:e526:d5c1```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```f4:a8:ef:6b:f7:08```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://stiedemann-fahey.co you initially access a DNS server to translate the host portion (stiedemann-fahey) combined with the Top Level Domain (co) of the URL, to an IP address like ```45.232.149.220```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1; WOW64; Trident/7.0; AS; rv:11.0) like Gecko```
...
<pre>
default   fe80:5637:972e:a09d:4ad2%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {115.23.89.47, 64.233.6.163}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr f4:a8:ef:6b:f7:08
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 51:b6:d5:d7:d7:cd
}</pre>
