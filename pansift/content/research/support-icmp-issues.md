...
subtitle: "Etc. Etc.?"
layout: research
ip_v4_address: "204.216.147.218"
date: 2022-11-02T11:32:58+00:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like ```204.216.147.218``` or an IPv6 address like ```2000:a7ea:b9c2:5950:7843:f3b6:b22c:5deb```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```3b:81:36:d9:ec:e9```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://becker.info you initially access a DNS server to translate the host portion (becker) combined with the Top Level Domain (info) of the URL, to an IP address like ```255.157.55.175```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_3) AppleWebKit/537.75.14 (KHTML, like Gecko) Version/7.0.3 Safari/7046A194A```
...
<pre>
default   fe80:39bf:4c87:e9ad:64e6%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {166.47.4.163, 27.178.165.162}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 3b:81:36:d9:ec:e9
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr b0:b5:a0:6b:16:43
}</pre>
...
## Apple macOS / OSX
No matter what version of OSX/macOS you are on, ```10.15.1```, ```11.4.3```, or ```12.1.4```, there are a range of tools for troubleshooting. Unfortunately, between these manual actions and scripts, they don't give you a series of correlated values over time. This is where automated remote troubleshooting comes in to its own, especially for teams that embrace remote work and Work From Anywhere (WFA).
