...
subtitle: "Streamline?"
layout: research
ip_v4_address: "232.167.225.192"
date: 2022-11-19T16:17:13+00:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like ```232.167.225.192``` or an IPv6 address like ```2000:ba09:6182:6a40:71f4:3ba7:44c1:cfaa```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```6f:4f:db:1b:f7:30```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://marquardt.org you initially access a DNS server to translate the host portion (marquardt) combined with the Top Level Domain (org) of the URL, to an IP address like ```125.67.62.106```. Your computer and browser actually sends its type with all web requests e.g. <br>```Opera/9.80 (X11; Linux i686; Ubuntu/14.10) Presto/2.12.388 Version/12.16```
...
<pre>
default   fe80:1df9:7df4:abb3:9132%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {110.132.160.221, 29.253.211.224}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 6f:4f:db:1b:f7:30
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 95:09:77:2c:4d:99
}</pre>
