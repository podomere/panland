---
title: "How Can I Fix Icmp No-access"
subtitle: "Deep Dive?"
layout: research
ip_v4_address: "7.115.143.15"
date: 2022-11-02T11:32:58+00:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like ```7.115.143.15``` or an IPv6 address like ```2000:79c1:f1c4:a3fa:45ee:636a:dc00:3815```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```a0:65:81:8d:48:d9```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://barton-hessel.io you initially access a DNS server to translate the host portion (barton-hessel) combined with the Top Level Domain (io) of the URL, to an IP address like ```220.161.110.91```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (compatible; MSIE 9.0; AOL 9.7; AOLBuild 4343.19; Windows NT 6.1; WOW64; Trident/5.0; FunWebProducts)```

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```10.57.90.121``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  10.57.90.121    UGScg  en0
...
<pre>
default   fe80:10b0:6776:8c3d:26b8%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {8.85.56.218, 66.207.19.10}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr a0:65:81:8d:48:d9
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr db:62:30:5f:37:0f
}</pre>
