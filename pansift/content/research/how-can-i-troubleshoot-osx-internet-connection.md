...
layout: research
ip_v4_address: "151.35.24.152"
date: 2022-04-24T19:00:24+01:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like <code>151.35.24.152</code> or an IPv6 address like <code>2000:4d9a:49e6:5ecf:4a3f:e48:a2f6:5c7c</code>. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>cc:35:90:f4:d5:02</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://hermann.co you initially access a DNS server to translate the host portion (hermann) combined with the Top Level Domain (co) of the URL, to an IP address like <code>83.233.60.162</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (compatible; MSIE 9.0; AOL 9.7; AOLBuild 4343.19; Windows NT 6.1; WOW64; Trident/5.0; FunWebProducts)</code>
...
<pre><code>
default   fe80:8c95:262a:3fce:d554%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {75.78.90.69, 233.65.68.118}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr cc:35:90:f4:d5:02
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr e1:38:dd:d1:09:cf
}</code></pre>
