...
layout: research
ip_v4_address: "28.83.213.163"
date: 2023-02-04T17:07:41+00:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like ```28.83.213.163``` or an IPv6 address like ```2000:c76f:724a:fb87:20c4:b5a6:8afc:9ea0```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```fd:04:e2:eb:51:2f```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://glover.info you initially access a DNS server to translate the host portion (glover) combined with the Top Level Domain (info) of the URL, to an IP address like ```84.84.149.97```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows; U; Win 9x 4.90; SG; rv:1.9.2.4) Gecko/20101104 Netscape/9.1.0285```
...
<pre>
default   fe80:d192:99c6:2311:700%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {101.178.133.133, 99.63.245.216}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr fd:04:e2:eb:51:2f
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 23:4b:28:3b:e1:72
}</pre>
