...
layout: research
ip_v4_address: "235.23.193.234"
date: 2023-10-06T17:11:06+01:00
draft: false
---

## Internet Addressing
On the Internet you may get a Public IPv4 address like ```235.23.193.234``` or an IPv6 address like ```2000:3448:dad4:5bb8:b539:1379:d779:e12a```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```5a:c0:c4:cd:bb:e3```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://lang.co you initially access a DNS server to translate the host portion (lang) combined with the Top Level Domain (co) of the URL, to an IP address like ```163.28.160.161```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows; U; Win 9x 4.90; SG; rv:1.9.2.4) Gecko/20101104 Netscape/9.1.0285```
...
<pre>
default   fe80:f5e3:c3d9:8c:9ef2%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {120.11.221.185, 160.89.146.202}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 5a:c0:c4:cd:bb:e3
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 0d:c5:44:a8:cd:e0
}</pre>
...
### Apple macOS / OSX
No matter what version of OSX/macOS you are on, ```10.14.5```, ```11.1.4```, or ```12.0.1```, there are a range of tools for troubleshooting. Unfortunately, between these manual actions and scripts, they don't give you a series of correlated values over time. This is where automated remote troubleshooting comes in to its own, especially for teams that embrace remote work and Work From Anywhere (WFA).
