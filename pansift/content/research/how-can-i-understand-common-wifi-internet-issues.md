...
layout: research
ip_v4_address: "57.138.77.17"
date: 2022-11-19T16:17:06+00:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like ```57.138.77.17``` or an IPv6 address like ```2000:ea11:b42f:102f:a425:73b7:a763:e43a```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```df:e9:74:74:26:11```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://daniel-bernier.io you initially access a DNS server to translate the host portion (daniel-bernier) combined with the Top Level Domain (io) of the URL, to an IP address like ```43.140.97.69```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1; WOW64; Trident/7.0; AS; rv:11.0) like Gecko```
...
<pre>
default   fe80:7992:3545:a1ce:6092%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {183.32.174.69, 183.243.72.155}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr df:e9:74:74:26:11
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr e7:d1:b8:df:77:45
}</pre>
