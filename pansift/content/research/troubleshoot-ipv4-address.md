...
subtitle: "Synergy?"
layout: research
ip_v4_address: "143.124.154.178"
date: 2022-04-24T18:59:56+01:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like <code>143.124.154.178</code> or an IPv6 address like <code>2000:df46:b73e:5e09:5e33:dbdf:5a3d:492</code>. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>61:75:8a:70:25:c0</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://pfannerstill-kilback.org you initially access a DNS server to translate the host portion (pfannerstill-kilback) combined with the Top Level Domain (org) of the URL, to an IP address like <code>208.25.147.11</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (Windows; U; Win 9x 4.90; SG; rv:1.9.2.4) Gecko/20101104 Netscape/9.1.0285</code>
...
<pre><code>
default   fe80:4933:3966:7096:6e2c%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {17.225.40.59, 253.225.235.152}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 61:75:8a:70:25:c0
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 27:61:e0:e8:ee:91
}</code></pre>
