...
layout: research
ip_v4_address: "164.208.12.98"
date: 2022-05-05T14:29:54+01:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like ```164.208.12.98``` or an IPv6 address like ```2000:6099:b0c7:ccce:e766:834f:2987:456c```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```7d:c8:f9:e4:45:77```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://kozey-stanton.io you initially access a DNS server to translate the host portion (kozey-stanton) combined with the Top Level Domain (io) of the URL, to an IP address like ```125.124.213.250```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (compatible; MSIE 9.0; AOL 9.7; AOLBuild 4343.19; Windows NT 6.1; WOW64; Trident/5.0; FunWebProducts)```
...
<pre>
default   fe80:9653:b655:e757:1f6d%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {26.68.92.93, 221.148.208.2}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 7d:c8:f9:e4:45:77
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr eb:2a:fe:4a:a8:ea
}</pre>
