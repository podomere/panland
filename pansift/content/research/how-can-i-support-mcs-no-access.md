...
subtitle: "Swim Lane?"
layout: research
ip_v4_address: "45.121.19.14"
date: 2023-02-04T16:26:04+00:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like ```45.121.19.14``` or an IPv6 address like ```2000:3e0f:7015:d1de:4e9d:7bdb:f52e:94c1```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```17:46:c6:ad:bb:bb```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://thompson-spinka.co you initially access a DNS server to translate the host portion (thompson-spinka) combined with the Top Level Domain (co) of the URL, to an IP address like ```241.56.62.168```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (compatible; MSIE 9.0; AOL 9.7; AOLBuild 4343.19; Windows NT 6.1; WOW64; Trident/5.0; FunWebProducts)```
...
<pre>
default   fe80:6635:22be:f0a9:5158%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {26.192.114.122, 63.142.155.64}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 17:46:c6:ad:bb:bb
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr d5:1e:10:4f:a1:03
}</pre>
