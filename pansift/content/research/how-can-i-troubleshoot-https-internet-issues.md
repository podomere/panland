...
layout: research
ip_v4_address: "149.197.171.162"
date: 2022-12-15T13:50:21+00:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like ```149.197.171.162``` or an IPv6 address like ```2000:e19b:c7a1:a241:636e:6f4f:bfb2:54f7```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```fc:0d:ef:3c:c1:8f```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://deckow-langworth.biz you initially access a DNS server to translate the host portion (deckow-langworth) combined with the Top Level Domain (biz) of the URL, to an IP address like ```199.196.240.70```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows; U; Win 9x 4.90; SG; rv:1.9.2.4) Gecko/20101104 Netscape/9.1.0285```
...
<pre>
default   fe80:f5f0:3290:8bcc:c751%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {90.221.7.202, 1.4.105.202}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr fc:0d:ef:3c:c1:8f
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 5b:b8:0b:02:c8:89
}</pre>
