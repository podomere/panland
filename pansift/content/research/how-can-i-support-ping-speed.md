...
subtitle: "Impact Map?"
layout: research
ip_v4_address: "25.97.76.199"
date: 2022-05-05T14:30:00+01:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like ```25.97.76.199``` or an IPv6 address like ```2000:f3e4:a2a9:bdc0:be98:e029:c262:6264```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```6c:1b:f2:34:ec:0b```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://ward-damore.io you initially access a DNS server to translate the host portion (ward-damore) combined with the Top Level Domain (io) of the URL, to an IP address like ```122.133.80.37```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT x.y; Win64; x64; rv:10.0) Gecko/20100101 Firefox/10.0```
...
<pre>
default   fe80:7ec3:79d2:29c0:d77b%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {186.164.169.144, 154.101.30.30}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 6c:1b:f2:34:ec:0b
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 82:79:34:58:69:a5
}</pre>
