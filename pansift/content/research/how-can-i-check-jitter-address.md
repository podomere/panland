...
layout: research
ip_v4_address: "117.226.194.33"
date: 2022-11-02T11:32:57+00:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like ```117.226.194.33``` or an IPv6 address like ```2000:d57a:c9a:475d:2208:3b4d:6f8f:2c39```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```ac:a9:d2:d3:23:87```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://muller-leuschke.info you initially access a DNS server to translate the host portion (muller-leuschke) combined with the Top Level Domain (info) of the URL, to an IP address like ```183.253.30.175```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_3) AppleWebKit/537.75.14 (KHTML, like Gecko) Version/7.0.3 Safari/7046A194A```
...
<pre>
default   fe80:5a81:9cf3:3636:a9d8%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {62.186.232.207, 255.118.57.207}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr ac:a9:d2:d3:23:87
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr e2:db:61:1b:0d:7e
}</pre>
