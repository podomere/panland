...
subtitle: "Tee It Up?"
layout: research
ip_v4_address: "215.139.176.33"
date: 2022-04-24T19:00:24+01:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like <code>215.139.176.33</code> or an IPv6 address like <code>2000:ac79:b13f:44c6:5cc5:ee2e:88b1:d209</code>. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>0f:dd:d6:f0:9c:b0</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://breitenberg-reichert.com you initially access a DNS server to translate the host portion (breitenberg-reichert) combined with the Top Level Domain (com) of the URL, to an IP address like <code>128.169.198.10</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (Windows NT 6.1; WOW64; Trident/7.0; AS; rv:11.0) like Gecko</code>
...
<pre><code>
default   fe80:6fd3:a6b5:732b:9141%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {17.242.175.18, 179.24.18.196}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 0f:dd:d6:f0:9c:b0
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr f4:a2:21:77:bf:8f
}</code></pre>
