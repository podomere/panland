...
subtitle: "Branding?"
layout: research
ip_v4_address: "215.40.194.95"
date: 2022-11-19T19:13:26+00:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like ```215.40.194.95``` or an IPv6 address like ```2000:e2db:c28d:a3ca:5ef9:5d3e:f6c9:81ab```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```c5:d6:f6:1c:81:12```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://olson.co you initially access a DNS server to translate the host portion (olson) combined with the Top Level Domain (co) of the URL, to an IP address like ```0.156.154.236```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT x.y; Win64; x64; rv:10.0) Gecko/20100101 Firefox/10.0```

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```172.21.119.230``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  172.21.119.230    UGScg  en0
...
<pre>
default   fe80:bd0b:fee2:8b47:96f7%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {50.3.18.149, 143.57.246.202}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr c5:d6:f6:1c:81:12
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 15:98:ff:c5:6f:92
}</pre>
