...
layout: research
ip_v4_address: "158.152.19.66"
date: 2023-10-29T15:13:19+00:00
draft: false
---

## Internet Addressing
On the Internet you may get a Public IPv4 address like ```158.152.19.66``` or an IPv6 address like ```2000:6965:7132:d98:a0c5:d2f7:9d19:7185```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```13:3f:a9:84:f5:c1```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://reichel.com you initially access a DNS server to translate the host portion (reichel) combined with the Top Level Domain (com) of the URL, to an IP address like ```114.53.58.248```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (compatible; MSIE 9.0; AOL 9.7; AOLBuild 4343.19; Windows NT 6.1; WOW64; Trident/5.0; FunWebProducts)```
...
<pre>
default   fe80:e5ab:36da:535c:17a7%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {79.233.209.145, 81.154.157.79}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 13:3f:a9:84:f5:c1
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 4b:ff:ea:c3:f2:81
}</pre>
