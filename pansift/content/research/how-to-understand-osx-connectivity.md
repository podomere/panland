...
layout: research
ip_v4_address: "47.38.65.196"
date: 2022-04-24T19:00:24+01:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like <code>47.38.65.196</code> or an IPv6 address like <code>2000:8a28:b6fb:f3f1:475f:670f:c2e7:4f83</code>. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>7d:bb:0e:e5:a8:da</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://armstrong.com you initially access a DNS server to translate the host portion (armstrong) combined with the Top Level Domain (com) of the URL, to an IP address like <code>234.183.0.134</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Opera/9.80 (X11; Linux i686; Ubuntu/14.10) Presto/2.12.388 Version/12.16</code>
...
<pre><code>
default   fe80:5bde:a0:7d65:83ab%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {11.124.60.4, 205.222.165.201}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 7d:bb:0e:e5:a8:da
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr d3:72:22:ec:fb:f7
}</code></pre>
