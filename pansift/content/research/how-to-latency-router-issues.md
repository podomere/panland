...
layout: research
ip_v4_address: "33.143.169.148"
date: 2022-04-24T18:59:57+01:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like <code>33.143.169.148</code> or an IPv6 address like <code>2000:37ca:4761:fca:3abe:f39c:6163:e01b</code>. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>2f:d0:60:0f:e9:c0</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://flatley-bashirian.info you initially access a DNS server to translate the host portion (flatley-bashirian) combined with the Top Level Domain (info) of the URL, to an IP address like <code>97.215.149.42</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (Windows NT 6.1; WOW64; Trident/7.0; AS; rv:11.0) like Gecko</code>
...
<pre><code>
default   fe80:d5a5:82d7:e349:1739%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {18.72.24.176, 29.31.242.181}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 2f:d0:60:0f:e9:c0
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 36:5a:c4:de:4f:1c
}</code></pre>
