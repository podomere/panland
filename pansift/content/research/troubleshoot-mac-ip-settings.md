...
layout: research
ip_v4_address: "188.189.78.160"
date: 2022-12-15T13:50:11+00:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like ```188.189.78.160``` or an IPv6 address like ```2000:44ee:145e:2b68:2f6:3a53:7e7f:1faa```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```31:99:2a:68:58:08```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://quitzon-kutch.biz you initially access a DNS server to translate the host portion (quitzon-kutch) combined with the Top Level Domain (biz) of the URL, to an IP address like ```133.33.35.11```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_3) AppleWebKit/537.75.14 (KHTML, like Gecko) Version/7.0.3 Safari/7046A194A```
...
<pre>
default   fe80:d071:19c2:8009:fab3%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {18.49.48.172, 78.123.43.102}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 31:99:2a:68:58:08
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 70:86:7e:78:1c:97
}</pre>
