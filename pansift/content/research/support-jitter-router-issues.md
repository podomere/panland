...
subtitle: "Value Add?"
layout: research
ip_v4_address: "155.220.219.30"
date: 2023-02-04T16:26:20+00:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like ```155.220.219.30``` or an IPv6 address like ```2000:4487:ede9:59fe:e57:5866:98e:2512```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```75:cd:76:26:54:6a```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://ebert-yost.net you initially access a DNS server to translate the host portion (ebert-yost) combined with the Top Level Domain (net) of the URL, to an IP address like ```236.38.93.231```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1; WOW64; Trident/7.0; AS; rv:11.0) like Gecko```
...
<pre>
default   fe80:13ce:9d02:ab4c:d852%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {19.87.66.59, 165.195.212.164}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 75:cd:76:26:54:6a
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr af:17:62:72:55:22
}</pre>
