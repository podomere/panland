...
layout: research
ip_v4_address: "30.211.128.250"
date: 2022-04-24T18:32:41+01:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like <code>30.211.128.250</code> or an IPv6 address like <code>2000:8b5c:f263:1cef:16ef:bc63:d01b:1496</code>. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>dc:ce:0a:7e:02:45</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://kuhic.name you initially access a DNS server to translate the host portion (kuhic) combined with the Top Level Domain (name) of the URL, to an IP address like <code>17.90.93.113</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (compatible; MSIE 9.0; AOL 9.7; AOLBuild 4343.19; Windows NT 6.1; WOW64; Trident/5.0; FunWebProducts)</code>
...
<pre><code>
default   fe80:26a6:fea0:69aa:3eff%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {64.83.50.94, 176.126.195.192}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr dc:ce:0a:7e:02:45
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr b6:51:fb:43:85:a8
}</code></pre>
