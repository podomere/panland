...
layout: research
ip_v4_address: "222.2.243.228"
date: 2022-12-15T13:50:20+00:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like ```222.2.243.228``` or an IPv6 address like ```2000:beaf:8352:61b4:26db:88ad:3f0b:80c0```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```02:4b:66:43:ae:a3```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://feest-ruecker.name you initially access a DNS server to translate the host portion (feest-ruecker) combined with the Top Level Domain (name) of the URL, to an IP address like ```252.202.78.183```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (compatible; MSIE 9.0; AOL 9.7; AOLBuild 4343.19; Windows NT 6.1; WOW64; Trident/5.0; FunWebProducts)```

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```172.23.62.45``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  172.23.62.45    UGScg  en0
...
<pre>
default   fe80:ffd1:1d51:22f1:2544%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {217.130.205.251, 196.131.5.97}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 02:4b:66:43:ae:a3
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr c3:8b:19:e7:99:28
}</pre>
...
## Apple macOS / OSX
No matter what version of OSX/macOS you are on, ```10.14.7```, ```11.6.1```, or ```12.1.8```, there are a range of tools for troubleshooting. Unfortunately, between these manual actions and scripts, they don't give you a series of correlated values over time. This is where automated remote troubleshooting comes in to its own, especially for teams that embrace remote work and Work From Anywhere (WFA).
