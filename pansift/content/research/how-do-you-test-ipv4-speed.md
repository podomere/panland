---
title: "How Do You Test IPv4 Speed"
subtitle: "Put A Pin In It?"
layout: research
ip_v4_address: "21.247.89.208"
date: 2023-10-29T15:13:26+00:00
draft: false
---

## Internet Addressing
On the Internet you may have a Public IPv4 address like ```21.247.89.208``` or an IPv6 address like ```2000:cfcb:177f:f37d:8a74:b5bd:dc3d:fc0f```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```ad:5f:f5:4e:b0:d9```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://carter-balistreri.net you initially access a DNS server to translate the host portion (carter-balistreri) combined with the Top Level Domain (net) of the URL, to an IP address like ```250.162.140.147```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (compatible; MSIE 9.0; AOL 9.7; AOLBuild 4343.19; Windows NT 6.1; WOW64; Trident/5.0; FunWebProducts)```

## Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```172.26.62.123``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  172.26.62.123    UGScg  en0
...
<pre>
default   fe80:585f:f85d:e181:a7fb%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {16.103.186.138, 69.165.118.48}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr ad:5f:f5:4e:b0:d9
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 7d:a5:fe:d0:87:79
}</pre>
