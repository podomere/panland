...
layout: research
ip_v4_address: "72.158.230.129"
date: 2023-02-04T16:26:03+00:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like ```72.158.230.129``` or an IPv6 address like ```2000:2468:3a85:855c:5c9b:cf92:9278:81f9```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```50:bd:8c:0a:e3:18```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://rodriguez.io you initially access a DNS server to translate the host portion (rodriguez) combined with the Top Level Domain (io) of the URL, to an IP address like ```93.187.105.254```. Your computer and browser actually sends its type with all web requests e.g. <br>```Opera/9.80 (X11; Linux i686; Ubuntu/14.10) Presto/2.12.388 Version/12.16```

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```172.22.20.65``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  172.22.20.65    UGScg  en0
...
<pre>
default   fe80:8ddd:31d:4cc4:e6f4%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {21.158.149.165, 10.31.32.73}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 50:bd:8c:0a:e3:18
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr e5:d3:32:8f:fa:1a
}</pre>
