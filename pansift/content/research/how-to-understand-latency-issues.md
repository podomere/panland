...
subtitle: "Granular?"
layout: research
ip_v4_address: "110.109.136.242"
date: 2023-02-04T16:26:19+00:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like ```110.109.136.242``` or an IPv6 address like ```2000:8a1a:9a52:db16:7b57:393e:9fbf:6a9c```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```af:8a:8a:8a:70:e2```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://cormier.biz you initially access a DNS server to translate the host portion (cormier) combined with the Top Level Domain (biz) of the URL, to an IP address like ```6.5.120.233```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1; WOW64; Trident/7.0; AS; rv:11.0) like Gecko```

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```10.249.233.210``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  10.249.233.210    UGScg  en0
...
<pre>
default   fe80:58f8:7c7c:79e7:dfd0%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {142.221.0.43, 119.158.225.49}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr af:8a:8a:8a:70:e2
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 02:4d:75:de:d7:68
}</pre>
...
## Apple macOS / OSX
No matter what version of OSX/macOS you are on, ```10.15.3```, ```11.4.7```, or ```12.2.8```, there are a range of tools for troubleshooting. Unfortunately, between these manual actions and scripts, they don't give you a series of correlated values over time. This is where automated remote troubleshooting comes in to its own, especially for teams that embrace remote work and Work From Anywhere (WFA).
