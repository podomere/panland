...
layout: research
ip_v4_address: "21.235.138.154"
date: 2022-11-19T16:17:05+00:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like ```21.235.138.154``` or an IPv6 address like ```2000:a8b4:5113:fc93:992b:c479:b286:9e44```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```70:1e:ee:f1:e8:c7```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://franecki-wisoky.io you initially access a DNS server to translate the host portion (franecki-wisoky) combined with the Top Level Domain (io) of the URL, to an IP address like ```85.26.136.103```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows; U; Win 9x 4.90; SG; rv:1.9.2.4) Gecko/20101104 Netscape/9.1.0285```
...
<pre>
default   fe80:f719:6082:4a78:82ce%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {71.175.5.216, 108.122.190.228}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 70:1e:ee:f1:e8:c7
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr e8:da:42:45:96:3d
}</pre>
