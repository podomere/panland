...
layout: research
ip_v4_address: "249.122.103.19"
date: 2022-04-24T18:31:57+01:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like <code>249.122.103.19</code> or an IPv6 address like <code>2000:aa52:d57c:3f5a:df50:a1b9:fda3:2b8d</code>. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>8e:6b:e1:4b:3c:ab</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://romaguera.com you initially access a DNS server to translate the host portion (romaguera) combined with the Top Level Domain (com) of the URL, to an IP address like <code>159.193.13.25</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (Windows NT x.y; Win64; x64; rv:10.0) Gecko/20100101 Firefox/10.0</code>

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like <code>172.16.233.179</code> (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For <code>IPv6</code> we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  172.16.233.179    UGScg  en0
...
<pre><code>
default   aa7e:7aa7:9795:2c:9059:607e:23f3:5ccb%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {50.107.47.154, 158.152.21.111}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 8e:6b:e1:4b:3c:ab
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr e1:38:56:fc:a3:4b
}</code></pre>
