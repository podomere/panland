...
layout: research
ip_v4_address: "98.46.159.94"
date: 2022-04-24T19:00:24+01:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like <code>98.46.159.94</code> or an IPv6 address like <code>2000:a87a:7c6b:ae04:1b1f:735e:fd49:1134</code>. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>08:54:3d:df:52:3b</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://anderson.biz you initially access a DNS server to translate the host portion (anderson) combined with the Top Level Domain (biz) of the URL, to an IP address like <code>251.131.7.139</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (Windows NT x.y; Win64; x64; rv:10.0) Gecko/20100101 Firefox/10.0</code>

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like <code>192.168.251.214</code> (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For <code>IPv6</code> we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  192.168.251.214    UGScg  en0
...
<pre><code>
default   fe80:b6fc:d14f:ad77:a912%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {124.181.158.59, 214.135.116.170}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 08:54:3d:df:52:3b
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 93:70:62:39:53:71
}</code></pre>
