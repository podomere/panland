...
layout: research
ip_v4_address: "255.119.250.74"
date: 2022-04-24T19:00:03+01:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like <code>255.119.250.74</code> or an IPv6 address like <code>2000:42a7:f1bc:7b5d:fb0d:75b4:e24a:a3c9</code>. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>41:69:d6:75:d0:49</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://macejkovic-beer.net you initially access a DNS server to translate the host portion (macejkovic-beer) combined with the Top Level Domain (net) of the URL, to an IP address like <code>154.38.190.4</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (Windows NT 6.1; WOW64; Trident/7.0; AS; rv:11.0) like Gecko</code>
...
<pre><code>
default   fe80:b063:19da:d68b:2f58%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {178.47.52.151, 100.209.167.90}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 41:69:d6:75:d0:49
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 68:73:db:c1:0d:09
}</code></pre>
