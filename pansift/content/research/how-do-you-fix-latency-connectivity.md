...
subtitle: "Learnings?"
layout: research
ip_v4_address: "11.51.100.24"
date: 2022-11-02T11:32:56+00:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like ```11.51.100.24``` or an IPv6 address like ```2000:d2de:759a:849f:615:c018:5ca1:f323```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```04:2a:ae:ec:fa:b0```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://lynch-walsh.name you initially access a DNS server to translate the host portion (lynch-walsh) combined with the Top Level Domain (name) of the URL, to an IP address like ```1.145.124.198```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (compatible; MSIE 9.0; AOL 9.7; AOLBuild 4343.19; Windows NT 6.1; WOW64; Trident/5.0; FunWebProducts)```
...
<pre>
default   fe80:611:fd8a:bb42:73c5%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {189.72.193.208, 175.212.236.176}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 04:2a:ae:ec:fa:b0
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 36:66:ee:8e:cd:52
}</pre>
