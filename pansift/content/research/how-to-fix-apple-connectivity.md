...
layout: research
ip_v4_address: "237.55.37.85"
date: 2023-10-29T15:13:19+00:00
draft: false
---

## Internet Addressing
On the Internet you might have a Public IPv4 address like ```237.55.37.85``` or an IPv6 address like ```2000:1ab3:19e9:eaea:1c43:7525:80a1:292a```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```05:8c:d5:11:15:c6```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://dietrich-schimmel.name you initially access a DNS server to translate the host portion (dietrich-schimmel) combined with the Top Level Domain (name) of the URL, to an IP address like ```232.47.86.22```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_3) AppleWebKit/537.75.14 (KHTML, like Gecko) Version/7.0.3 Safari/7046A194A```
...
<pre>
default   fe80:3bd3:d936:8e83:d3ac%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {242.55.198.235, 189.116.111.156}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 05:8c:d5:11:15:c6
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr d6:22:fc:e3:a0:e4
}</pre>
