...
subtitle: "Streamline?"
layout: research
ip_v4_address: "255.172.248.95"
date: 2022-05-05T14:28:55+01:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like ```255.172.248.95``` or an IPv6 address like ```2000:7222:1536:8573:700f:af4d:ec85:b604```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```f5:54:a9:c7:da:4b```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://conroy-davis.org you initially access a DNS server to translate the host portion (conroy-davis) combined with the Top Level Domain (org) of the URL, to an IP address like ```149.49.11.250```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT x.y; Win64; x64; rv:10.0) Gecko/20100101 Firefox/10.0```

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```172.21.72.211``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  172.21.72.211    UGScg  en0
...
<pre>
default   fe80:c83b:adda:241f:b321%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {212.6.41.68, 74.181.203.60}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr f5:54:a9:c7:da:4b
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr d5:e9:0e:00:20:73
}</pre>
