...
subtitle: "Tee It Up?"
layout: research
ip_v4_address: "238.46.203.6"
date: 2022-04-24T18:59:56+01:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like <code>238.46.203.6</code> or an IPv6 address like <code>2000:b3f7:8872:9df4:1a80:5e39:12ff:6ad3</code>. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>0f:24:46:3b:b8:e0</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://green-leuschke.co you initially access a DNS server to translate the host portion (green-leuschke) combined with the Top Level Domain (co) of the URL, to an IP address like <code>32.174.167.79</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (Windows; U; Win 9x 4.90; SG; rv:1.9.2.4) Gecko/20101104 Netscape/9.1.0285</code>
...
<pre><code>
default   fe80:a137:78b7:dfba:e259%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {73.23.245.189, 80.0.38.128}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 0f:24:46:3b:b8:e0
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr e5:c1:f4:c7:ea:a5
}</code></pre>
