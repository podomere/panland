...
layout: research
ip_v4_address: "113.102.30.252"
date: 2023-10-06T17:11:08+01:00
draft: false
---

## Internet Addressing
On the Internet you may have a Public IPv4 address like ```113.102.30.252``` or an IPv6 address like ```2000:40a3:7787:a1f1:42ca:47c7:ddb6:d051```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```dc:eb:11:d0:4d:e6```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://parker-rempel.biz you initially access a DNS server to translate the host portion (parker-rempel) combined with the Top Level Domain (biz) of the URL, to an IP address like ```114.38.70.201```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (compatible; MSIE 9.0; AOL 9.7; AOLBuild 4343.19; Windows NT 6.1; WOW64; Trident/5.0; FunWebProducts)```
...
<pre>
default   fe80:e69c:a9ad:7629:87a%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {124.83.200.192, 3.156.16.147}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr dc:eb:11:d0:4d:e6
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 55:8c:e7:0a:d4:2f
}</pre>
