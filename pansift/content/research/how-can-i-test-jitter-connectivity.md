...
layout: research
ip_v4_address: "29.117.126.248"
date: 2022-11-19T16:17:22+00:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like ```29.117.126.248``` or an IPv6 address like ```9:c955:2ae5:ab72:6e2e:1f94:69c7:4595```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```a4:c7:d0:56:74:4b```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://lindgren-green.org you initially access a DNS server to translate the host portion (lindgren-green) combined with the Top Level Domain (org) of the URL, to an IP address like ```217.176.128.148```. Your computer and browser actually sends its type with all web requests e.g. <br>```Opera/9.80 (X11; Linux i686; Ubuntu/14.10) Presto/2.12.388 Version/12.16```
...
<pre>
default   fe80:6df5:d260:a13c:67e9%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {99.107.124.209, 20.251.79.2}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr a4:c7:d0:56:74:4b
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 8e:7e:eb:48:ef:5f
}</pre>
