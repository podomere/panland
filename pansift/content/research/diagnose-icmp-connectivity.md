...
layout: research
ip_v4_address: "135.163.121.244"
date: 2023-10-06T17:11:06+01:00
draft: false
---

## Internet Addressing
On the Internet you might get a Public IPv4 address like ```135.163.121.244``` or an IPv6 address like ```2000:e375:2b06:a3c0:5c7f:3c3c:8412:4394```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```41:91:a3:73:f5:09```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://grimes.net you initially access a DNS server to translate the host portion (grimes) combined with the Top Level Domain (net) of the URL, to an IP address like ```233.90.84.181```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/41.0.2228.0 Safari/537.36```
...
<pre>
default   fe80:9dd0:3ee7:8216:d1b8%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {247.180.163.85, 35.71.53.180}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 41:91:a3:73:f5:09
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 0d:93:35:8c:e4:bc
}</pre>
...
### Apple macOS / OSX
No matter what version of OSX/macOS you are on, ```10.15.6```, ```11.1.2```, or ```12.1.4```, there are a range of tools for troubleshooting. Unfortunately, between these manual actions and scripts, they don't give you a series of correlated values over time. This is where automated remote troubleshooting comes in to its own, especially for teams that embrace remote work and Work From Anywhere (WFA).
