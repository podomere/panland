...
layout: research
ip_v4_address: "107.198.227.24"
date: 2022-11-19T16:17:11+00:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like ```107.198.227.24``` or an IPv6 address like ```2000:f360:a6db:11dc:fe2f:24e1:63d4:c167```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```b7:af:a1:77:eb:61```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://hessel-rolfson.co you initially access a DNS server to translate the host portion (hessel-rolfson) combined with the Top Level Domain (co) of the URL, to an IP address like ```37.184.195.71```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1; WOW64; Trident/7.0; AS; rv:11.0) like Gecko```
...
<pre>
default   fe80:a8c4:b304:8980:bf1d%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {14.128.85.215, 26.201.87.41}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr b7:af:a1:77:eb:61
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 34:d6:01:18:7e:ba
}</pre>
