...
layout: research
ip_v4_address: "80.141.186.53"
date: 2022-04-24T18:32:41+01:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like <code>80.141.186.53</code> or an IPv6 address like <code>2000:10b0:ef14:c722:5130:9658:c543:7b1b</code>. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>0f:4b:73:ed:de:9a</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://mertz-carroll.com you initially access a DNS server to translate the host portion (mertz-carroll) combined with the Top Level Domain (com) of the URL, to an IP address like <code>61.52.58.245</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (Windows NT x.y; Win64; x64; rv:10.0) Gecko/20100101 Firefox/10.0</code>
...
<pre><code>
default   fe80:aef0:caff:ac48:eedc%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {17.218.144.152, 135.104.97.176}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 0f:4b:73:ed:de:9a
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 77:ef:ce:6a:69:e7
}</code></pre>
