...
layout: research
ip_v4_address: "172.37.160.111"
date: 2022-04-24T19:00:24+01:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like <code>172.37.160.111</code> or an IPv6 address like <code>2000:e6b0:6bb3:a4dc:b3c2:37a7:cbcf:65ae</code>. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>6d:48:51:42:82:3f</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://gerhold-prosacco.biz you initially access a DNS server to translate the host portion (gerhold-prosacco) combined with the Top Level Domain (biz) of the URL, to an IP address like <code>143.141.246.191</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (Windows NT x.y; Win64; x64; rv:10.0) Gecko/20100101 Firefox/10.0</code>
...
<pre><code>
default   fe80:659:5739:9b78:7e18%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {208.225.133.128, 243.127.154.229}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 6d:48:51:42:82:3f
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr bd:9c:1c:b3:f7:da
}</code></pre>
