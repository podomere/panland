...
layout: research
ip_v4_address: "125.25.62.57"
date: 2022-04-24T19:00:34+01:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like <code>125.25.62.57</code> or an IPv6 address like <code>2000:6c7e:6385:c581:9597:b07a:70b3:1552</code>. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>be:15:8c:21:80:38</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://runte-barrows.net you initially access a DNS server to translate the host portion (runte-barrows) combined with the Top Level Domain (net) of the URL, to an IP address like <code>20.13.230.125</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (Windows NT 6.1; WOW64; Trident/7.0; AS; rv:11.0) like Gecko</code>
...
<pre><code>
default   fe80:7340:1a8c:7f75:3505%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {115.193.68.35, 187.216.224.74}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr be:15:8c:21:80:38
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr cc:e6:a7:4c:20:bb
}</code></pre>
