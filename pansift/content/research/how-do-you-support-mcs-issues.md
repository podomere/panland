...
layout: research
ip_v4_address: "156.17.247.156"
date: 2022-04-24T18:32:42+01:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like <code>156.17.247.156</code> or an IPv6 address like <code>2000:da57:3d68:329b:6f21:3baf:69e6:f0a3</code>. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>ef:59:96:db:f5:2a</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://schroeder-zemlak.org you initially access a DNS server to translate the host portion (schroeder-zemlak) combined with the Top Level Domain (org) of the URL, to an IP address like <code>54.56.76.185</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (Windows NT x.y; Win64; x64; rv:10.0) Gecko/20100101 Firefox/10.0</code>
...
<pre><code>
default   fe80:41d1:7501:ddfb:753e%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {107.194.174.145, 86.202.5.72}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr ef:59:96:db:f5:2a
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 15:6b:a1:f1:92:09
}</code></pre>
