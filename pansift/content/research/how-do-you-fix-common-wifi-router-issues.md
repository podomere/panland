...
layout: research
ip_v4_address: "87.65.91.200"
date: 2022-04-24T18:32:42+01:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like <code>87.65.91.200</code> or an IPv6 address like <code>2000:416f:c265:d753:7f8d:7532:c444:913a</code>. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>06:3c:3a:c5:7b:1d</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://lindgren-keebler.co you initially access a DNS server to translate the host portion (lindgren-keebler) combined with the Top Level Domain (co) of the URL, to an IP address like <code>30.247.224.144</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (compatible; MSIE 9.0; AOL 9.7; AOLBuild 4343.19; Windows NT 6.1; WOW64; Trident/5.0; FunWebProducts)</code>
...
<pre><code>
default   fe80:c7cc:cd65:cb90:2d9c%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {234.55.45.201, 94.189.235.249}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 06:3c:3a:c5:7b:1d
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 86:7e:4b:65:14:51
}</code></pre>
