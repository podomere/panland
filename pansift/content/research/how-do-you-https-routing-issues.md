...
layout: research
ip_v4_address: "180.95.94.14"
date: 2023-10-29T15:13:30+00:00
draft: false
---

## Internet Addressing
On the Internet you might have a Public IPv4 address like ```180.95.94.14``` or an IPv6 address like ```2000:e8f7:759a:a108:ddc9:65e7:ec3a:aa73```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```e0:6a:5c:6a:f0:44```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://will-towne.co you initially access a DNS server to translate the host portion (will-towne) combined with the Top Level Domain (co) of the URL, to an IP address like ```182.244.140.172```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows; U; Win 9x 4.90; SG; rv:1.9.2.4) Gecko/20101104 Netscape/9.1.0285```
...
<pre>
default   fe80:79cd:7a0a:9fce:be5e%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {237.215.56.23, 9.108.111.1}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr e0:6a:5c:6a:f0:44
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 1f:2f:88:21:11:57
}</pre>
