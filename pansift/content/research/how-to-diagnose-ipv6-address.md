...
subtitle: "Streamline?"
layout: research
ip_v4_address: "105.37.13.108"
date: 2022-11-19T19:13:23+00:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like ```105.37.13.108``` or an IPv6 address like ```2000:d54b:e24d:38e6:601:1f5e:2311:84a1```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```4e:d5:aa:68:5b:96```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://rodriguez-tillman.io you initially access a DNS server to translate the host portion (rodriguez-tillman) combined with the Top Level Domain (io) of the URL, to an IP address like ```62.234.238.4```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1; WOW64; Trident/7.0; AS; rv:11.0) like Gecko```

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```192.168.77.36``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  192.168.77.36    UGScg  en0
...
<pre>
default   fe80:2c6c:2dc1:8b3:62d%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {36.94.201.171, 6.137.225.47}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 4e:d5:aa:68:5b:96
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 47:65:05:a0:a0:d5
}</pre>
