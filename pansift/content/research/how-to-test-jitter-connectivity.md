...
subtitle: "Learnings?"
layout: research
ip_v4_address: "100.162.176.253"
date: 2023-10-06T17:11:05+01:00
draft: false
---

## Internet Addressing
On the Internet you might get a Public IPv4 address like ```100.162.176.253``` or an IPv6 address like ```2000:bf5a:5df2:c626:546f:a419:7c48:cc5f```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```0c:a3:f3:a1:20:ad```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://pagac.com you initially access a DNS server to translate the host portion (pagac) combined with the Top Level Domain (com) of the URL, to an IP address like ```93.238.160.161```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows; U; Win 9x 4.90; SG; rv:1.9.2.4) Gecko/20101104 Netscape/9.1.0285```
...
<pre>
default   fe80:1f89:7282:930e:73fc%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {121.55.60.116, 153.32.60.77}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 0c:a3:f3:a1:20:ad
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 93:b0:94:69:99:0f
}</pre>
