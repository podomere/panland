...
layout: research
ip_v4_address: "188.157.127.54"
date: 2022-06-12T14:09:26+01:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like ```188.157.127.54``` or an IPv6 address like ```2000:7e98:e8ab:c2ac:4491:2ee7:ec97:47bd```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```a9:68:90:74:41:a8```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://labadie-funk.net you initially access a DNS server to translate the host portion (labadie-funk) combined with the Top Level Domain (net) of the URL, to an IP address like ```186.96.75.211```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_3) AppleWebKit/537.75.14 (KHTML, like Gecko) Version/7.0.3 Safari/7046A194A```
...
<pre>
default   fe80:718b:49ad:6310:9568%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {202.129.134.207, 187.96.89.4}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr a9:68:90:74:41:a8
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr fa:f7:98:f2:0d:dd
}</pre>
