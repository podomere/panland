...
subtitle: "Swag?"
layout: research
ip_v4_address: "87.247.0.54"
date: 2022-11-19T19:13:29+00:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like ```87.247.0.54``` or an IPv6 address like ```2000:326:771e:b9b:7917:50b4:8869:36ce```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```b2:e4:69:7c:95:0e```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://gislason-leannon.info you initially access a DNS server to translate the host portion (gislason-leannon) combined with the Top Level Domain (info) of the URL, to an IP address like ```245.175.139.114```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/41.0.2228.0 Safari/537.36```
...
<pre>
default   fe80:fcec:f21b:898b:f79c%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {168.0.132.133, 192.14.27.141}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr b2:e4:69:7c:95:0e
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 57:80:06:da:12:05
}</pre>
