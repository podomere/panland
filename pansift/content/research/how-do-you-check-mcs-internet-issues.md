...
subtitle: "Tee It Up?"
layout: research
ip_v4_address: "235.138.80.20"
date: 2022-04-24T18:32:42+01:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like <code>235.138.80.20</code> or an IPv6 address like <code>2000:da5c:ebce:bd49:2faa:528a:e6a6:cf55</code>. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>fc:4b:34:20:3b:d2</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://kshlerin.biz you initially access a DNS server to translate the host portion (kshlerin) combined with the Top Level Domain (biz) of the URL, to an IP address like <code>223.232.249.140</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (Windows; U; Win 9x 4.90; SG; rv:1.9.2.4) Gecko/20101104 Netscape/9.1.0285</code>

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like <code>172.31.180.136</code> (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For <code>IPv6</code> we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  172.31.180.136    UGScg  en0
...
<pre><code>
default   fe80:361c:21b:10b0:6d3c%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {244.102.14.101, 202.102.59.51}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr fc:4b:34:20:3b:d2
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 98:61:7c:b9:42:81
}</code></pre>
