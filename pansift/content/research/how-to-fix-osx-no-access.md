...
layout: research
ip_v4_address: "43.121.221.18"
date: 2022-05-05T14:28:49+01:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like ```43.121.221.18``` or an IPv6 address like ```2000:d5f8:5675:a90d:3e51:134c:a12e:cc69```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```25:cc:b5:90:88:36```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://yundt.org you initially access a DNS server to translate the host portion (yundt) combined with the Top Level Domain (org) of the URL, to an IP address like ```37.43.40.195```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1; WOW64; Trident/7.0; AS; rv:11.0) like Gecko```
...
<pre>
default   fe80:59a0:a0b:68f6:d82d%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {104.132.174.90, 230.63.40.33}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 25:cc:b5:90:88:36
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr e8:ac:46:3f:21:32
}</pre>
