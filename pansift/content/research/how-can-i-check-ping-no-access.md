...
subtitle: "Swag?"
layout: research
ip_v4_address: "52.246.95.37"
date: 2023-02-04T17:08:39+00:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like ```52.246.95.37``` or an IPv6 address like ```2000:bdd9:ace6:7ed9:447d:909d:ec22:a0d6```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```b7:6a:49:f9:27:34```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://spencer-hansen.org you initially access a DNS server to translate the host portion (spencer-hansen) combined with the Top Level Domain (org) of the URL, to an IP address like ```56.115.90.111```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1; WOW64; Trident/7.0; AS; rv:11.0) like Gecko```
...
<pre>
default   fe80:f73:8d8f:53ed:4cf1%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {244.251.165.51, 80.63.204.185}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr b7:6a:49:f9:27:34
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 40:2b:b6:51:64:ca
}</pre>
