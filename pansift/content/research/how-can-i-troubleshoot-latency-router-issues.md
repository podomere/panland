---
title: "How Can I Troubleshoot Latency Router Issues"
subtitle: "Bucketize It?"
layout: research
ip_v4_address: "222.104.232.0"
date: 2023-02-04T16:26:19+00:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like ```222.104.232.0``` or an IPv6 address like ```2000:b6fd:c821:5991:b71d:3127:9e5e:ea3c```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```a4:05:a8:0b:b1:58```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://cassin-windler.name you initially access a DNS server to translate the host portion (cassin-windler) combined with the Top Level Domain (name) of the URL, to an IP address like ```148.123.102.45```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (compatible; MSIE 9.0; AOL 9.7; AOLBuild 4343.19; Windows NT 6.1; WOW64; Trident/5.0; FunWebProducts)```

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```192.168.84.8``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  192.168.84.8    UGScg  en0
...
<pre>
default   fe80:b6bc:e92a:7fe5:890a%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {243.177.206.242, 248.234.209.234}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr a4:05:a8:0b:b1:58
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 2d:fa:8c:4c:d2:e8
}</pre>
...
## Apple macOS / OSX
No matter what version of OSX/macOS you are on, ```10.11.5```, ```11.4.6```, or ```12.3.8```, there are a range of tools for troubleshooting. Unfortunately, between these manual actions and scripts, they don't give you a series of correlated values over time. This is where automated remote troubleshooting comes in to its own, especially for teams that embrace remote work and Work From Anywhere (WFA).
