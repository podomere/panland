...
layout: research
ip_v4_address: "204.242.25.121"
date: 2022-04-24T19:00:00+01:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like <code>204.242.25.121</code> or an IPv6 address like <code>2000:5e61:a9cf:7257:727d:1500:1b9d:ae65</code>. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>e1:0c:be:3c:4b:75</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://boyle-stroman.co you initially access a DNS server to translate the host portion (boyle-stroman) combined with the Top Level Domain (co) of the URL, to an IP address like <code>123.94.71.48</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_3) AppleWebKit/537.75.14 (KHTML, like Gecko) Version/7.0.3 Safari/7046A194A</code>
...
<pre><code>
default   fe80:dfc:3fa6:d82d:f3f8%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {160.39.172.124, 178.83.128.230}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr e1:0c:be:3c:4b:75
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr fe:cb:35:b9:8c:6c
}</code></pre>
