...
layout: research
ip_v4_address: "110.92.184.119"
date: 2022-06-04T14:38:43+01:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like ```110.92.184.119``` or an IPv6 address like ```2000:818d:c04b:9389:76d2:ec47:cc1f:a46c```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```32:8b:82:d8:b2:45```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://morar-kirlin.net you initially access a DNS server to translate the host portion (morar-kirlin) combined with the Top Level Domain (net) of the URL, to an IP address like ```23.167.214.98```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_3) AppleWebKit/537.75.14 (KHTML, like Gecko) Version/7.0.3 Safari/7046A194A```
...
<pre>
default   fe80:e19c:4a9f:3847:13e4%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {47.8.119.65, 90.10.160.180}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 32:8b:82:d8:b2:45
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 44:06:2b:d7:23:c7
}</pre>
