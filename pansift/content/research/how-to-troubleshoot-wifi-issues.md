...
layout: research
ip_v4_address: "53.213.118.159"
date: 2022-06-04T14:38:16+01:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like ```53.213.118.159``` or an IPv6 address like ```2000:8e86:2a31:fdca:9786:fb63:b7bd:c4c```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```7c:43:9d:01:82:9e```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://mckenzie.org you initially access a DNS server to translate the host portion (mckenzie) combined with the Top Level Domain (org) of the URL, to an IP address like ```193.181.135.43```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows; U; Win 9x 4.90; SG; rv:1.9.2.4) Gecko/20101104 Netscape/9.1.0285```
...
<pre>
default   fe80:1ff2:d5a1:8fd5:fddf%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {44.245.83.229, 26.128.251.159}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 7c:43:9d:01:82:9e
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr ed:86:29:15:4d:93
}</pre>
