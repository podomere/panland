...
layout: research
ip_v4_address: "231.226.96.157"
date: 2022-06-04T14:38:17+01:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like ```231.226.96.157``` or an IPv6 address like ```2000:6c8a:ab8d:8afc:2b77:e622:2e1b:1f82```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```60:be:35:bb:5e:62```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://hauck-wehner.net you initially access a DNS server to translate the host portion (hauck-wehner) combined with the Top Level Domain (net) of the URL, to an IP address like ```199.120.118.207```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT x.y; Win64; x64; rv:10.0) Gecko/20100101 Firefox/10.0```
...
<pre>
default   fe80:5dc6:976:6aaa:461a%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {102.187.51.249, 96.70.43.194}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 60:be:35:bb:5e:62
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 3a:4f:f4:7c:00:3b
}</pre>
