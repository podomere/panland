...
layout: research
ip_v4_address: "87.115.72.202"
date: 2023-10-29T15:13:27+00:00
draft: false
---

## Internet Addressing
On the Internet you may have a Public IPv4 address like ```87.115.72.202``` or an IPv6 address like ```2000:190b:d90c:defe:e4ad:fd7f:c022:2716```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```b3:d9:82:f4:d2:18```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://rippin-schaden.net you initially access a DNS server to translate the host portion (rippin-schaden) combined with the Top Level Domain (net) of the URL, to an IP address like ```184.175.41.244```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (compatible; MSIE 9.0; AOL 9.7; AOLBuild 4343.19; Windows NT 6.1; WOW64; Trident/5.0; FunWebProducts)```
...
<pre>
default   fe80:7e06:b538:58db:882c%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {131.38.90.181, 177.162.152.98}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr b3:d9:82:f4:d2:18
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr fb:c9:54:57:5b:01
}</pre>
