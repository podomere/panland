---
title: "How Do You Ping Protocol"
subtitle: "Heavy Lifting?"
layout: research
ip_v4_address: "175.75.53.112"
date: 2022-04-24T19:00:02+01:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like <code>175.75.53.112</code> or an IPv6 address like <code>2000:50a2:fa30:d8c7:8ee1:81f1:b66e:f8e4</code>. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>bd:39:99:5b:eb:d8</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://koepp.org you initially access a DNS server to translate the host portion (koepp) combined with the Top Level Domain (org) of the URL, to an IP address like <code>120.22.101.100</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (Windows NT 6.1; WOW64; Trident/7.0; AS; rv:11.0) like Gecko</code>

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like <code>10.55.70.163</code> (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For <code>IPv6</code> we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  10.55.70.163    UGScg  en0
...
<pre><code>
default   fe80:3e7d:7a5e:a55f:c1df%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {173.235.220.149, 120.166.43.175}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr bd:39:99:5b:eb:d8
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 61:36:a2:d5:19:23
}</code></pre>
