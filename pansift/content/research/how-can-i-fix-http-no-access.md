...
layout: research
ip_v4_address: "230.234.82.150"
date: 2022-11-19T19:13:28+00:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like ```230.234.82.150``` or an IPv6 address like ```2000:2e9f:4cfe:3025:28f7:89ad:c036:a811```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```51:2c:ff:90:4c:2e```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://greenholt-larson.co you initially access a DNS server to translate the host portion (greenholt-larson) combined with the Top Level Domain (co) of the URL, to an IP address like ```169.8.100.158```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows; U; Win 9x 4.90; SG; rv:1.9.2.4) Gecko/20101104 Netscape/9.1.0285```
...
<pre>
default   fe80:4c4f:7bef:575e:5cc7%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {69.114.48.195, 53.92.26.230}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 51:2c:ff:90:4c:2e
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 7a:e6:b7:a4:d1:1b
}</pre>
