...
layout: research
ip_v4_address: "45.94.154.78"
date: 2022-04-24T19:00:04+01:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like <code>45.94.154.78</code> or an IPv6 address like <code>2000:9483:f079:e9d9:209b:54d5:35ec:d25c</code>. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>57:c1:d1:45:66:34</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://boehm-murray.co you initially access a DNS server to translate the host portion (boehm-murray) combined with the Top Level Domain (co) of the URL, to an IP address like <code>147.153.133.10</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (compatible; MSIE 9.0; AOL 9.7; AOLBuild 4343.19; Windows NT 6.1; WOW64; Trident/5.0; FunWebProducts)</code>

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like <code>192.168.183.65</code> (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For <code>IPv6</code> we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  192.168.183.65    UGScg  en0
...
<pre><code>
default   fe80:cfef:fa52:c7f:5453%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {231.54.235.133, 74.50.16.112}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 57:c1:d1:45:66:34
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 6a:6e:f5:e4:7e:b1
}</code></pre>
