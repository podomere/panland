...
layout: research
ip_v4_address: "155.105.58.175"
date: 2022-06-04T14:38:44+01:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like ```155.105.58.175``` or an IPv6 address like ```2000:280f:466e:aa:565:7ec7:4c30:b832```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```ef:25:19:15:5c:16```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://funk-hand.biz you initially access a DNS server to translate the host portion (funk-hand) combined with the Top Level Domain (biz) of the URL, to an IP address like ```129.54.55.60```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows; U; Win 9x 4.90; SG; rv:1.9.2.4) Gecko/20101104 Netscape/9.1.0285```
...
<pre>
default   fe80:d75a:3243:3d8d:8d52%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {73.159.144.93, 214.67.199.47}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr ef:25:19:15:5c:16
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr bf:95:8d:c0:01:9e
}</pre>
