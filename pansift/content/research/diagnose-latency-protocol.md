...
layout: research
ip_v4_address: "241.40.229.7"
date: 2022-12-15T13:50:17+00:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like ```241.40.229.7``` or an IPv6 address like ```2000:1474:7243:aa6:5c28:cd90:230a:6c67```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```c4:24:00:db:16:b3```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://torp-hartmann.biz you initially access a DNS server to translate the host portion (torp-hartmann) combined with the Top Level Domain (biz) of the URL, to an IP address like ```31.74.155.32```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_3) AppleWebKit/537.75.14 (KHTML, like Gecko) Version/7.0.3 Safari/7046A194A```
...
<pre>
default   fe80:5d20:f907:5189:4435%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {165.78.165.249, 172.221.80.105}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr c4:24:00:db:16:b3
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 48:dc:a7:6e:dc:df
}</pre>
