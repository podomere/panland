---
title: "Support Jitter Routing Issues"
subtitle: "Agile Marketing?"
layout: research
ip_v4_address: "61.149.108.193"
date: 2022-11-19T16:17:22+00:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like ```61.149.108.193``` or an IPv6 address like ```2000:7356:bafa:bde2:4c94:973c:927:e47a```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```42:4f:21:b7:87:20```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://wisoky-goldner.name you initially access a DNS server to translate the host portion (wisoky-goldner) combined with the Top Level Domain (name) of the URL, to an IP address like ```115.43.77.128```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/41.0.2228.0 Safari/537.36```

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```172.17.212.81``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  172.17.212.81    UGScg  en0
...
<pre>
default   fe80:a373:413c:7107:62a7%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {245.116.194.209, 94.136.109.153}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 42:4f:21:b7:87:20
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr a0:b8:8b:49:2f:73
}</pre>
