---
title: "How Do You Understand IPv4 Address"
subtitle: "Value Proposition?"
layout: research
ip_v4_address: "27.252.245.93"
date: 2022-04-24T18:59:57+01:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like <code>27.252.245.93</code> or an IPv6 address like <code>2000:45b3:d518:60af:1bc2:8ea:d1c7:28a</code>. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>22:0a:cf:ec:f9:b4</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://oberbrunner-krajcik.co you initially access a DNS server to translate the host portion (oberbrunner-krajcik) combined with the Top Level Domain (co) of the URL, to an IP address like <code>225.158.186.135</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (Windows NT 6.1; WOW64; Trident/7.0; AS; rv:11.0) like Gecko</code>

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like <code>10.211.190.205</code> (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For <code>IPv6</code> we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  10.211.190.205    UGScg  en0
...
<pre><code>
default   fe80:220c:4fc9:89e8:20e1%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {223.208.78.137, 184.255.24.174}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 22:0a:cf:ec:f9:b4
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 55:31:cf:aa:6c:50
}</code></pre>
