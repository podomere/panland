...
layout: research
ip_v4_address: "126.17.36.116"
date: 2022-11-19T16:17:21+00:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like ```126.17.36.116``` or an IPv6 address like ```2000:7591:6640:a8c9:106c:9c8:d0eb:6080```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```ed:73:74:d7:2d:e5```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://gutmann-zulauf.name you initially access a DNS server to translate the host portion (gutmann-zulauf) combined with the Top Level Domain (name) of the URL, to an IP address like ```5.81.201.174```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_3) AppleWebKit/537.75.14 (KHTML, like Gecko) Version/7.0.3 Safari/7046A194A```
...
<pre>
default   fe80:fbcf:54fb:6847:610b%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {166.250.15.173, 107.214.233.114}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr ed:73:74:d7:2d:e5
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 02:82:3e:02:bf:a0
}</pre>
