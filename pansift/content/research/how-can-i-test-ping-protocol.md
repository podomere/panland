...
layout: research
ip_v4_address: "93.13.102.214"
date: 2023-10-29T15:13:28+00:00
draft: false
---

## Internet Addressing
On the Internet you might have a Public IPv4 address like ```93.13.102.214``` or an IPv6 address like ```2000:c71e:9350:be:d8ad:7d95:aa3c:a74c```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```76:ce:51:5f:db:a0```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://dibbert-shields.net you initially access a DNS server to translate the host portion (dibbert-shields) combined with the Top Level Domain (net) of the URL, to an IP address like ```48.101.56.53```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/41.0.2228.0 Safari/537.36```
...
<pre>
default   fe80:fc5a:5fa5:6d7d:320%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {98.112.5.133, 39.139.135.254}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 76:ce:51:5f:db:a0
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr be:68:66:29:0a:dc
}</pre>
