...
subtitle: "Deep Dive?"
layout: research
ip_v4_address: "125.6.48.219"
date: 2023-10-29T15:13:29+00:00
draft: false
---

## Internet Addressing
On the Internet you might have a Public IPv4 address like ```125.6.48.219``` or an IPv6 address like ```2000:8091:4809:92a2:a424:b9eb:ac29:9ffc```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```51:5e:d2:75:e0:cf```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://kunze.com you initially access a DNS server to translate the host portion (kunze) combined with the Top Level Domain (com) of the URL, to an IP address like ```131.152.130.40```. Your computer and browser actually sends its type with all web requests e.g. <br>```Opera/9.80 (X11; Linux i686; Ubuntu/14.10) Presto/2.12.388 Version/12.16```

## Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```192.168.11.123``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  192.168.11.123    UGScg  en0
...
<pre>
default   fe80:3cbb:6d17:ad57:e210%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {197.111.167.129, 77.25.222.149}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 51:5e:d2:75:e0:cf
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr c9:4c:fd:da:ad:9e
}</pre>
