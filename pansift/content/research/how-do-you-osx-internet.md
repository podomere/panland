...
layout: research
ip_v4_address: "139.64.7.36"
date: 2022-04-24T19:00:24+01:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like <code>139.64.7.36</code> or an IPv6 address like <code>2000:199f:93d5:faf0:8dc:bda1:524f:6b33</code>. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>b1:1c:23:35:68:e3</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://kuhlman-mann.io you initially access a DNS server to translate the host portion (kuhlman-mann) combined with the Top Level Domain (io) of the URL, to an IP address like <code>116.112.237.254</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (Windows; U; Win 9x 4.90; SG; rv:1.9.2.4) Gecko/20101104 Netscape/9.1.0285</code>
...
<pre><code>
default   fe80:714f:3764:9000:e728%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {249.74.171.239, 32.9.37.227}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr b1:1c:23:35:68:e3
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 1c:08:c7:dc:2c:34
}</code></pre>
