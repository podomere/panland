...
subtitle: "Swim Lane?"
layout: research
ip_v4_address: "238.178.245.187"
date: 2022-05-05T14:29:36+01:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like ```238.178.245.187``` or an IPv6 address like ```2000:b5f8:f4c4:f981:2fcc:eecc:e4a0:5103```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```a5:d3:c3:03:0b:b8```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://lueilwitz.info you initially access a DNS server to translate the host portion (lueilwitz) combined with the Top Level Domain (info) of the URL, to an IP address like ```136.23.40.159```. Your computer and browser actually sends its type with all web requests e.g. <br>```Opera/9.80 (X11; Linux i686; Ubuntu/14.10) Presto/2.12.388 Version/12.16```

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```172.18.59.61``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  172.18.59.61    UGScg  en0
...
<pre>
default   fe80:77d1:e80:b708:ce48%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {120.180.20.20, 179.33.35.242}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr a5:d3:c3:03:0b:b8
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 43:a1:6f:e1:64:86
}</pre>
