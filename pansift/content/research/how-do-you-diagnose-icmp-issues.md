...
layout: research
ip_v4_address: "233.225.162.139"
date: 2023-10-06T17:11:06+01:00
draft: false
---

## Internet Addressing
On the Internet you may get a Public IPv4 address like ```233.225.162.139``` or an IPv6 address like ```2000:70c8:d610:9539:ec02:a8f8:7ddd:ce5a```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```4e:ca:63:e5:c9:a9```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://ruecker-upton.net you initially access a DNS server to translate the host portion (ruecker-upton) combined with the Top Level Domain (net) of the URL, to an IP address like ```78.91.129.94```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT x.y; Win64; x64; rv:10.0) Gecko/20100101 Firefox/10.0```
...
<pre>
default   fe80:fa15:ded2:744d:5829%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {250.12.76.20, 8.117.124.160}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 4e:ca:63:e5:c9:a9
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 25:db:3f:bf:e4:fe
}</pre>
