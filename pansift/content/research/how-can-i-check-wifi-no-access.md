...
layout: research
ip_v4_address: "103.50.74.0"
date: 2022-04-24T18:32:41+01:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like <code>103.50.74.0</code> or an IPv6 address like <code>2000:1cff:c43d:2b9a:ace2:b499:d96:f550</code>. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>a9:7c:25:b0:12:7b</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://mante-maggio.com you initially access a DNS server to translate the host portion (mante-maggio) combined with the Top Level Domain (com) of the URL, to an IP address like <code>198.245.47.106</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (Windows NT 6.1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/41.0.2228.0 Safari/537.36</code>
...
<pre><code>
default   fe80:8fe4:5196:d2c1:618e%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {213.247.124.248, 197.61.140.59}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr a9:7c:25:b0:12:7b
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 8a:29:5f:08:dd:9e
}</code></pre>
