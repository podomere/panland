...
layout: research
ip_v4_address: "71.153.3.21"
date: 2022-12-15T13:50:17+00:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like ```71.153.3.21``` or an IPv6 address like ```2000:79e1:931c:80e4:36d4:42e1:dd61:8561```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```5d:f5:06:2d:97:5a```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://streich-wintheiser.co you initially access a DNS server to translate the host portion (streich-wintheiser) combined with the Top Level Domain (co) of the URL, to an IP address like ```172.87.142.55```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows; U; Win 9x 4.90; SG; rv:1.9.2.4) Gecko/20101104 Netscape/9.1.0285```
...
<pre>
default   fe80:cfd0:303d:d84e:ad8c%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {120.222.185.35, 245.23.183.101}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 5d:f5:06:2d:97:5a
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 25:0d:29:61:3b:91
}</pre>
