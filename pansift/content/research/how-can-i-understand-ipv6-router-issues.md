...
subtitle: "Branding?"
layout: research
ip_v4_address: "50.241.126.214"
date: 2022-12-15T13:50:16+00:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like ```50.241.126.214``` or an IPv6 address like ```2000:55e3:73b3:57bc:f388:57a5:6116:e7e3```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```31:c4:14:45:84:37```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://rolfson-rolfson.io you initially access a DNS server to translate the host portion (rolfson-rolfson) combined with the Top Level Domain (io) of the URL, to an IP address like ```251.125.212.95```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_3) AppleWebKit/537.75.14 (KHTML, like Gecko) Version/7.0.3 Safari/7046A194A```

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```10.214.194.127``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  10.214.194.127    UGScg  en0
...
<pre>
default   fe80:4d37:dd97:8383:a5e2%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {113.151.121.179, 136.181.96.235}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 31:c4:14:45:84:37
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 91:bf:6b:bb:5e:66
}</pre>
