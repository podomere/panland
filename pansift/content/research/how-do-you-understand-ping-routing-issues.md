...
subtitle: "Heads Down?"
layout: research
ip_v4_address: "13.1.14.36"
date: 2023-02-04T16:26:22+00:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like ```13.1.14.36``` or an IPv6 address like ```2000:1366:6ebc:fae7:65c3:4ef8:3512:1ff3```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```9a:39:c1:3d:f9:71```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://jenkins-raynor.org you initially access a DNS server to translate the host portion (jenkins-raynor) combined with the Top Level Domain (org) of the URL, to an IP address like ```185.226.78.162```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT x.y; Win64; x64; rv:10.0) Gecko/20100101 Firefox/10.0```
...
<pre>
default   fe80:962c:4179:9a5f:df39%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {71.246.214.223, 253.50.43.220}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 9a:39:c1:3d:f9:71
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 1e:30:5a:48:c4:42
}</pre>
