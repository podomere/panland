---
title: "Understand IPv4 Internet Issues"
subtitle: "Granular?"
layout: research
ip_v4_address: "221.13.22.144"
date: 2022-04-24T18:59:56+01:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like <code>221.13.22.144</code> or an IPv6 address like <code>2000:4c1b:9667:a464:adac:f451:9ade:2257</code>. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>d6:e3:df:1b:88:98</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://jaskolski-rau.name you initially access a DNS server to translate the host portion (jaskolski-rau) combined with the Top Level Domain (name) of the URL, to an IP address like <code>185.188.215.184</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (Windows NT 6.1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/41.0.2228.0 Safari/537.36</code>

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like <code>192.168.107.215</code> (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For <code>IPv6</code> we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  192.168.107.215    UGScg  en0
...
<pre><code>
default   fe80:ddfc:f631:3267:d95b%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {15.239.103.2, 77.171.25.68}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr d6:e3:df:1b:88:98
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr b1:17:78:c3:5c:fc
}</code></pre>
