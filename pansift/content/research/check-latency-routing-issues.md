---
title: "Check Latency Routing Issues"
subtitle: "Granular?"
layout: research
ip_v4_address: "17.111.114.164"
date: 2022-11-02T11:32:55+00:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like ```17.111.114.164``` or an IPv6 address like ```2000:6d9e:d6a9:9ecf:1d6c:7c3e:7a96:e139```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```0d:42:07:46:76:8e```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://hodkiewicz-gusikowski.com you initially access a DNS server to translate the host portion (hodkiewicz-gusikowski) combined with the Top Level Domain (com) of the URL, to an IP address like ```218.96.138.145```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (compatible; MSIE 9.0; AOL 9.7; AOLBuild 4343.19; Windows NT 6.1; WOW64; Trident/5.0; FunWebProducts)```
...
<pre>
default   fe80:eb43:ccf1:3058:f7ff%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {28.209.32.33, 112.63.109.174}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 0d:42:07:46:76:8e
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 5d:be:64:f6:b4:c7
}</pre>
