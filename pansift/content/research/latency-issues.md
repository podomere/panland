...
layout: research
ip_v4_address: "192.137.41.203"
date: 2023-10-29T15:13:26+00:00
draft: false
---

## Internet Addressing
On the Internet you might have a Public IPv4 address like ```192.137.41.203``` or an IPv6 address like ```2000:d06a:d957:aa5c:36b2:f55f:4dda:fbdb```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```7b:28:88:61:78:16```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://marvin-hansen.biz you initially access a DNS server to translate the host portion (marvin-hansen) combined with the Top Level Domain (biz) of the URL, to an IP address like ```214.38.112.3```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_3) AppleWebKit/537.75.14 (KHTML, like Gecko) Version/7.0.3 Safari/7046A194A```
...
<pre>
default   fe80:13f3:a8c3:aed1:462b%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {84.47.53.169, 168.253.177.202}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 7b:28:88:61:78:16
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr f7:34:39:00:39:e5
}</pre>
