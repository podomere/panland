...
layout: research
ip_v4_address: "89.252.217.23"
date: 2022-05-05T14:28:43+01:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like ```89.252.217.23``` or an IPv6 address like ```2000:5aa5:2f2d:fe3f:1464:4a1f:c5ef:7d78```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```f4:be:44:a9:eb:c4```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://block-smitham.org you initially access a DNS server to translate the host portion (block-smitham) combined with the Top Level Domain (org) of the URL, to an IP address like ```251.43.4.254```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (compatible; MSIE 9.0; AOL 9.7; AOLBuild 4343.19; Windows NT 6.1; WOW64; Trident/5.0; FunWebProducts)```
...
<pre>
default   fe80:97c2:dd59:2b39:4ba6%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {188.32.202.169, 100.63.21.166}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr f4:be:44:a9:eb:c4
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 27:60:28:d7:a7:22
}</pre>
