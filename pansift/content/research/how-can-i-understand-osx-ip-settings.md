...
layout: research
ip_v4_address: "227.250.186.35"
date: 2022-04-24T18:31:57+01:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like <code>227.250.186.35</code> or an IPv6 address like <code>2000:c8db:7c4:d621:4cb1:57af:cff1:1d63</code>. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>60:32:5b:8a:eb:69</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://torp-wilderman.name you initially access a DNS server to translate the host portion (torp-wilderman) combined with the Top Level Domain (name) of the URL, to an IP address like <code>86.117.144.199</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (Windows; U; Win 9x 4.90; SG; rv:1.9.2.4) Gecko/20101104 Netscape/9.1.0285</code>

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like <code>10.171.119.235</code> (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For <code>IPv6</code> we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  10.171.119.235    UGScg  en0
...
<pre><code>
default   fe80:a3b4:2b96:df70:99c3%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {252.222.6.170, 53.207.40.245}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 60:32:5b:8a:eb:69
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr b7:3c:b9:5d:24:81
}</code></pre>
