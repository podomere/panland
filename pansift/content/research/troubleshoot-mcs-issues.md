...
layout: research
ip_v4_address: "142.113.154.164"
date: 2022-06-12T14:09:05+01:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like ```142.113.154.164``` or an IPv6 address like ```2000:7dc3:3da3:21ac:3923:c0e:f9bd:c73e```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```78:f2:f1:ad:f9:32```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://mohr-ernser.org you initially access a DNS server to translate the host portion (mohr-ernser) combined with the Top Level Domain (org) of the URL, to an IP address like ```23.211.117.194```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1; WOW64; Trident/7.0; AS; rv:11.0) like Gecko```
...
<pre>
default   fe80:94b3:29a0:ea13:4310%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {45.70.254.245, 141.188.41.90}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 78:f2:f1:ad:f9:32
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 5f:d9:1d:88:1d:73
}</pre>
