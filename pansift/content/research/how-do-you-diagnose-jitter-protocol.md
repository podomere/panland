...
subtitle: "Impact Map?"
layout: research
ip_v4_address: "124.78.189.55"
date: 2023-02-04T17:08:37+00:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like ```124.78.189.55``` or an IPv6 address like ```2000:e82d:3cc9:6808:bfee:43b6:5e93:afcc```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```45:a9:49:55:ca:69```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://okuneva-zemlak.io you initially access a DNS server to translate the host portion (okuneva-zemlak) combined with the Top Level Domain (io) of the URL, to an IP address like ```125.35.213.125```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1; WOW64; Trident/7.0; AS; rv:11.0) like Gecko```
...
<pre>
default   fe80:ec04:c74:53f4:d169%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {54.221.169.118, 150.82.82.36}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 45:a9:49:55:ca:69
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 2a:a8:3a:50:c6:25
}</pre>
