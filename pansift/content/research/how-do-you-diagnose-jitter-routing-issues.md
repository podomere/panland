...
layout: research
ip_v4_address: "126.237.140.50"
date: 2022-04-24T19:00:00+01:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like <code>126.237.140.50</code> or an IPv6 address like <code>2000:c203:5222:55ab:95ee:da23:924b:3c14</code>. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>7c:b2:a8:ba:0b:db</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://hansen-mayert.biz you initially access a DNS server to translate the host portion (hansen-mayert) combined with the Top Level Domain (biz) of the URL, to an IP address like <code>209.64.195.41</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_3) AppleWebKit/537.75.14 (KHTML, like Gecko) Version/7.0.3 Safari/7046A194A</code>
...
default  172.23.28.212    UGScg  en0
...
<pre><code>
default   fe80:6e48:83a4:dc6c:682a%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {116.19.231.53, 218.222.157.102}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 7c:b2:a8:ba:0b:db
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr e4:6f:df:6b:bd:94
}</code></pre>
