...
subtitle: "Learnings?"
layout: research
ip_v4_address: "72.173.218.217"
date: 2022-12-15T13:50:19+00:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like ```72.173.218.217``` or an IPv6 address like ```2000:c72d:d6d8:d845:2f64:1fff:3e1a:838```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```fc:22:50:02:e6:9d```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://keeling-price.net you initially access a DNS server to translate the host portion (keeling-price) combined with the Top Level Domain (net) of the URL, to an IP address like ```230.10.39.200```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows; U; Win 9x 4.90; SG; rv:1.9.2.4) Gecko/20101104 Netscape/9.1.0285```
...
<pre>
default   fe80:c82d:6991:9ee:c735%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {173.130.16.55, 72.71.235.223}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr fc:22:50:02:e6:9d
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 90:4d:f3:88:26:0c
}</pre>
