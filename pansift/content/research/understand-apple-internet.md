...
layout: research
ip_v4_address: "219.177.199.146"
date: 2023-02-04T17:07:49+00:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like ```219.177.199.146``` or an IPv6 address like ```2000:ef5c:67ec:f93d:897a:41d8:6f95:4cfd```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```74:0b:2c:ee:c2:f1```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://douglas-west.info you initially access a DNS server to translate the host portion (douglas-west) combined with the Top Level Domain (info) of the URL, to an IP address like ```38.202.204.210```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/41.0.2228.0 Safari/537.36```
...
<pre>
default   fe80:30b2:b783:7fec:b33a%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {8.130.204.19, 237.129.103.227}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 74:0b:2c:ee:c2:f1
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 95:f0:b6:30:eb:dc
}</pre>
