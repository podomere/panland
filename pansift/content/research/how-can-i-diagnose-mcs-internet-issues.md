...
subtitle: "Swag?"
layout: research
ip_v4_address: "194.15.27.244"
date: 2023-02-04T17:07:43+00:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like ```194.15.27.244``` or an IPv6 address like ```2000:de01:4851:7981:937b:4eb4:d5e3:d246```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```3b:35:a7:72:ee:b0```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://west-anderson.net you initially access a DNS server to translate the host portion (west-anderson) combined with the Top Level Domain (net) of the URL, to an IP address like ```44.17.60.71```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1; WOW64; Trident/7.0; AS; rv:11.0) like Gecko```
...
<pre>
default   fe80:3be:39eb:505:e1d6%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {48.253.179.64, 189.136.138.212}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 3b:35:a7:72:ee:b0
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 63:2e:07:c8:0b:93
}</pre>
