...
subtitle: "Impact Map?"
layout: research
ip_v4_address: "84.51.167.50"
date: 2022-11-02T11:32:23+00:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like ```84.51.167.50``` or an IPv6 address like ```2000:b7e2:b820:9c99:d954:31e7:e781:6da2```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```8c:b8:69:02:84:f8```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://nikolaus-wilkinson.name you initially access a DNS server to translate the host portion (nikolaus-wilkinson) combined with the Top Level Domain (name) of the URL, to an IP address like ```50.249.144.246```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT x.y; Win64; x64; rv:10.0) Gecko/20100101 Firefox/10.0```
...
<pre>
default   fe80:8c41:d9d:edf7:a974%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {190.137.154.66, 184.97.110.24}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 8c:b8:69:02:84:f8
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 0b:3b:c1:73:7a:27
}</pre>
