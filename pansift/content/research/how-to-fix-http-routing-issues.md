...
subtitle: "Swag?"
layout: research
ip_v4_address: "229.135.78.34"
date: 2022-11-19T16:17:24+00:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like ```229.135.78.34``` or an IPv6 address like ```2000:ebdc:dff8:4e5f:1790:4d00:dbd7:90a8```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```a5:99:80:2a:5a:49```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://swift-kassulke.co you initially access a DNS server to translate the host portion (swift-kassulke) combined with the Top Level Domain (co) of the URL, to an IP address like ```16.172.207.230```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1; WOW64; Trident/7.0; AS; rv:11.0) like Gecko```
...
<pre>
default   fe80:33c2:39da:9175:e014%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {27.88.35.220, 80.232.4.113}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr a5:99:80:2a:5a:49
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 0f:ef:e3:f6:70:27
}</pre>
