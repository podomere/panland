...
subtitle: "Granular?"
layout: research
ip_v4_address: "50.34.19.40"
date: 2022-12-15T13:50:22+00:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like ```50.34.19.40``` or an IPv6 address like ```2000:5f33:4980:fae7:114d:9248:1d67:67e4```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```4c:52:a4:81:af:92```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://kuhlman.info you initially access a DNS server to translate the host portion (kuhlman) combined with the Top Level Domain (info) of the URL, to an IP address like ```249.30.238.10```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows; U; Win 9x 4.90; SG; rv:1.9.2.4) Gecko/20101104 Netscape/9.1.0285```

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```192.168.199.28``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  192.168.199.28    UGScg  en0
...
<pre>
default   fe80:95d7:6bbb:4590:3dba%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {148.85.248.4, 112.16.196.234}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 4c:52:a4:81:af:92
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 5c:3b:5b:7a:29:ff
}</pre>
