...
layout: research
ip_v4_address: "178.232.245.130"
date: 2023-10-29T15:13:28+00:00
draft: false
---

## Internet Addressing
On the Internet you may have a Public IPv4 address like ```178.232.245.130``` or an IPv6 address like ```2000:6f9f:30c4:2351:693:908e:f40f:ffc9```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```69:c4:bc:d5:a6:84```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://lind-bradtke.info you initially access a DNS server to translate the host portion (lind-bradtke) combined with the Top Level Domain (info) of the URL, to an IP address like ```51.42.95.161```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT x.y; Win64; x64; rv:10.0) Gecko/20100101 Firefox/10.0```

## Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```192.168.142.154``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  192.168.142.154    UGScg  en0
...
<pre>
default   fe80:57a4:84d1:8fc9:25aa%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {101.154.45.152, 42.111.246.144}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 69:c4:bc:d5:a6:84
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 46:78:dd:6b:57:6b
}</pre>
