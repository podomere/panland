...
layout: research
ip_v4_address: "58.103.105.169"
date: 2023-02-04T17:08:40+00:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like ```58.103.105.169``` or an IPv6 address like ```2000:dff:9d2d:19fc:6066:ea9:9297:1b4c```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```b7:3f:c5:ed:32:98```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://hilll-thiel.net you initially access a DNS server to translate the host portion (hilll-thiel) combined with the Top Level Domain (net) of the URL, to an IP address like ```157.166.150.121```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows; U; Win 9x 4.90; SG; rv:1.9.2.4) Gecko/20101104 Netscape/9.1.0285```
...
<pre>
default   fe80:7306:2814:b9fa:8414%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {210.215.139.43, 223.27.99.7}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr b7:3f:c5:ed:32:98
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr ab:f3:32:d5:d9:b5
}</pre>
