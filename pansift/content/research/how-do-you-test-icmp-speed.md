...
layout: research
ip_v4_address: "240.126.29.113"
date: 2022-04-24T19:00:01+01:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like <code>240.126.29.113</code> or an IPv6 address like <code>2000:e459:6f35:fe13:f35c:f8ae:14e5:e808</code>. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>cc:9c:22:8b:d9:51</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://collins.net you initially access a DNS server to translate the host portion (collins) combined with the Top Level Domain (net) of the URL, to an IP address like <code>106.206.99.192</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Opera/9.80 (X11; Linux i686; Ubuntu/14.10) Presto/2.12.388 Version/12.16</code>
...
default  172.17.12.102    UGScg  en0
...
<pre><code>
default   fe80:8b7f:d30f:b151:532%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {153.230.167.247, 227.119.58.127}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr cc:9c:22:8b:d9:51
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 32:7a:c7:7c:c9:9a
}</code></pre>
