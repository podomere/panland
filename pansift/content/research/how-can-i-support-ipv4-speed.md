...
layout: research
ip_v4_address: "126.66.137.171"
date: 2022-11-19T16:17:20+00:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like ```126.66.137.171``` or an IPv6 address like ```2000:7bdf:ac76:36f:a14f:256b:31dc:d883```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```e5:51:b9:e2:fa:23```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://cremin.info you initially access a DNS server to translate the host portion (cremin) combined with the Top Level Domain (info) of the URL, to an IP address like ```113.143.181.254```. Your computer and browser actually sends its type with all web requests e.g. <br>```Opera/9.80 (X11; Linux i686; Ubuntu/14.10) Presto/2.12.388 Version/12.16```

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```172.16.88.130``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  172.16.88.130    UGScg  en0
...
<pre>
default   fe80:f329:f3ec:db15:dc8%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {101.211.85.30, 177.23.24.146}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr e5:51:b9:e2:fa:23
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 83:1b:68:19:e9:15
}</pre>
...
## Apple macOS / OSX
No matter what version of OSX/macOS you are on, ```10.13.1```, ```11.4.8```, or ```12.3.2```, there are a range of tools for troubleshooting. Unfortunately, between these manual actions and scripts, they don't give you a series of correlated values over time. This is where automated remote troubleshooting comes in to its own, especially for teams that embrace remote work and Work From Anywhere (WFA).
