...
subtitle: "Etc. Etc.?"
layout: research
ip_v4_address: "48.210.176.84"
date: 2022-04-24T19:00:05+01:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like <code>48.210.176.84</code> or an IPv6 address like <code>2000:2080:85a:e58b:7f09:172b:9aea:dbd0</code>. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>c7:4b:e1:76:f6:c5</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://brekke-brown.biz you initially access a DNS server to translate the host portion (brekke-brown) combined with the Top Level Domain (biz) of the URL, to an IP address like <code>10.110.152.183</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Opera/9.80 (X11; Linux i686; Ubuntu/14.10) Presto/2.12.388 Version/12.16</code>

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like <code>192.168.131.111</code> (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For <code>IPv6</code> we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  192.168.131.111    UGScg  en0
...
<pre><code>
default   fe80:8de8:e90e:ba44:788e%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {15.35.139.67, 117.128.139.235}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr c7:4b:e1:76:f6:c5
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 73:1d:9a:be:dd:c5
}</code></pre>
