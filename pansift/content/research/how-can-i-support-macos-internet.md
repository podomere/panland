...
layout: research
ip_v4_address: "229.185.41.44"
date: 2022-04-24T18:31:57+01:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like <code>229.185.41.44</code> or an IPv6 address like <code>2000:e17:b05e:960:8762:2812:7a83:26de</code>. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>88:a8:36:38:88:71</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://klein.co you initially access a DNS server to translate the host portion (klein) combined with the Top Level Domain (co) of the URL, to an IP address like <code>205.114.95.35</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (Windows NT x.y; Win64; x64; rv:10.0) Gecko/20100101 Firefox/10.0</code>
...
<pre><code>
default   fe80:72a7:c2dc:c68d:c2b2%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {0.102.6.157, 243.22.199.34}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 88:a8:36:38:88:71
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr be:13:81:c8:15:c3
}</code></pre>
