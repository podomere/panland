...
subtitle: "Granular?"
layout: research
ip_v4_address: "75.86.140.4"
date: 2022-04-24T18:32:42+01:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like <code>75.86.140.4</code> or an IPv6 address like <code>2000:7d0a:3e79:8ebc:9e9d:42f8:259b:f53f</code>. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>15:aa:93:23:dd:47</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://russel-medhurst.com you initially access a DNS server to translate the host portion (russel-medhurst) combined with the Top Level Domain (com) of the URL, to an IP address like <code>213.75.41.232</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (Windows NT 6.1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/41.0.2228.0 Safari/537.36</code>
...
<pre><code>
default   fe80:1275:35d2:632c:df9d%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {16.47.28.161, 99.0.122.15}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 15:aa:93:23:dd:47
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 77:96:cf:8b:6e:91
}</code></pre>
