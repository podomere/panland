...
layout: research
ip_v4_address: "102.63.142.177"
date: 2022-04-24T19:00:00+01:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like <code>102.63.142.177</code> or an IPv6 address like <code>2000:e452:5725:1bfb:3587:c714:935b:f474</code>. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>3c:24:aa:6a:92:44</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://ernser-hagenes.net you initially access a DNS server to translate the host portion (ernser-hagenes) combined with the Top Level Domain (net) of the URL, to an IP address like <code>75.215.137.231</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (Windows NT 6.1; WOW64; Trident/7.0; AS; rv:11.0) like Gecko</code>

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like <code>172.17.66.225</code> (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For <code>IPv6</code> we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  172.17.66.225    UGScg  en0
...
<pre><code>
default   fe80:c21f:9f2a:847f:d05d%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {0.201.187.194, 134.114.105.73}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 3c:24:aa:6a:92:44
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr ae:bc:52:b2:d2:e3
}</code></pre>
