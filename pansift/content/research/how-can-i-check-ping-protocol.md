...
layout: research
ip_v4_address: "187.34.85.221"
date: 2023-10-06T17:11:07+01:00
draft: false
---

## Internet Addressing
On the Internet you might get a Public IPv4 address like ```187.34.85.221``` or an IPv6 address like ```2000:ed84:62bc:d857:59b:a9ed:168d:c60```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```e5:75:63:dc:6f:f2```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://nolan-roob.net you initially access a DNS server to translate the host portion (nolan-roob) combined with the Top Level Domain (net) of the URL, to an IP address like ```158.112.10.207```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (compatible; MSIE 9.0; AOL 9.7; AOLBuild 4343.19; Windows NT 6.1; WOW64; Trident/5.0; FunWebProducts)```

## Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```172.31.7.26``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
<pre>
default   fe80:b53c:4ef3:afab:35d%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {87.52.119.249, 183.237.34.155}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr e5:75:63:dc:6f:f2
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr f2:6a:45:c3:0c:1b
}</pre>
...
### Apple macOS / OSX
No matter what version of OSX/macOS you are on, ```10.13.4```, ```11.5.1```, or ```12.3.7```, there are a range of tools for troubleshooting. Unfortunately, between these manual actions and scripts, they don't give you a series of correlated values over time. This is where automated remote troubleshooting comes in to its own, especially for teams that embrace remote work and Work From Anywhere (WFA).
