...
layout: research
ip_v4_address: "102.192.79.196"
date: 2023-10-06T17:10:43+01:00
draft: false
---

## Internet Addressing
On the Internet you may get a Public IPv4 address like ```102.192.79.196``` or an IPv6 address like ```2000:f19c:5115:6b3:ecae:1bbf:3dc1:4e5f```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```4a:37:d9:76:f7:b9```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://mayer.biz you initially access a DNS server to translate the host portion (mayer) combined with the Top Level Domain (biz) of the URL, to an IP address like ```46.203.96.24```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT x.y; Win64; x64; rv:10.0) Gecko/20100101 Firefox/10.0```
...
<pre>
default   fe80:8d9f:cee5:bb09:524d%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {218.69.104.1, 133.81.165.131}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 4a:37:d9:76:f7:b9
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 6e:23:5f:20:3f:45
}</pre>
