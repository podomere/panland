...
layout: research
ip_v4_address: "141.33.229.235"
date: 2023-10-29T15:13:27+00:00
draft: false
---

## Internet Addressing
On the Internet you might get a Public IPv4 address like ```141.33.229.235``` or an IPv6 address like ```2000:9368:909b:60f1:2aff:578:3bc2:a24c```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```26:52:54:5b:f6:46```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://dietrich-gutkowski.com you initially access a DNS server to translate the host portion (dietrich-gutkowski) combined with the Top Level Domain (com) of the URL, to an IP address like ```64.166.159.153```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/41.0.2228.0 Safari/537.36```
...
<pre>
default   fe80:e977:469c:8bae:cac7%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {190.180.24.124, 244.133.184.9}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 26:52:54:5b:f6:46
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 6c:0d:f8:78:e2:bb
}</pre>
