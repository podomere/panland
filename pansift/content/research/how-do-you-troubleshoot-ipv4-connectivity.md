...
layout: research
ip_v4_address: "66.124.201.199"
date: 2022-04-24T18:59:57+01:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like <code>66.124.201.199</code> or an IPv6 address like <code>2000:9c54:7630:d7f9:5720:cd44:2ec4:b6d9</code>. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>66:ee:c4:62:2e:08</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://littel-torphy.com you initially access a DNS server to translate the host portion (littel-torphy) combined with the Top Level Domain (com) of the URL, to an IP address like <code>0.164.113.13</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (Windows NT x.y; Win64; x64; rv:10.0) Gecko/20100101 Firefox/10.0</code>
...
<pre><code>
default   fe80:6271:af82:751b:d787%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {132.16.147.125, 34.3.111.41}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 66:ee:c4:62:2e:08
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 5c:d3:20:7a:84:38
}</code></pre>
