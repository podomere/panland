...
layout: research
ip_v4_address: "18.237.46.53"
date: 2023-02-04T17:08:37+00:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like ```18.237.46.53``` or an IPv6 address like ```2000:aac6:f834:e516:bd8d:a34d:e192:aa14```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```b1:32:61:5a:dc:04```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://green-kuphal.io you initially access a DNS server to translate the host portion (green-kuphal) combined with the Top Level Domain (io) of the URL, to an IP address like ```224.221.224.86```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT x.y; Win64; x64; rv:10.0) Gecko/20100101 Firefox/10.0```
...
<pre>
default   fe80:ff27:96e2:b7b:c9ee%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {154.10.255.204, 40.101.130.113}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr b1:32:61:5a:dc:04
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr f8:c0:8d:80:d7:03
}</pre>
