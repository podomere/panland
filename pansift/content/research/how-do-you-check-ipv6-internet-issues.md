...
layout: research
ip_v4_address: "233.106.46.73"
date: 2022-11-19T19:13:23+00:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like ```233.106.46.73``` or an IPv6 address like ```2000:6d77:d5ae:a65a:5ed3:ac3:79b1:b584```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```23:b6:a4:e0:a4:be```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://conroy-wiegand.net you initially access a DNS server to translate the host portion (conroy-wiegand) combined with the Top Level Domain (net) of the URL, to an IP address like ```189.114.250.179```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/41.0.2228.0 Safari/537.36```
...
<pre>
default   fe80:d49:b13e:10a4:d880%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {178.77.109.63, 248.13.183.137}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 23:b6:a4:e0:a4:be
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 32:fc:69:41:24:fd
}</pre>
