...
subtitle: "Streamline?"
layout: research
ip_v4_address: "119.173.254.111"
date: 2023-02-04T16:26:22+00:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like ```119.173.254.111``` or an IPv6 address like ```2000:3adf:ca4c:44f7:7ca7:d4dc:45a7:f5bb```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```bd:a4:01:29:7e:cd```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://wehner-greenfelder.io you initially access a DNS server to translate the host portion (wehner-greenfelder) combined with the Top Level Domain (io) of the URL, to an IP address like ```2.232.60.179```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/41.0.2228.0 Safari/537.36```
...
<pre>
default   fe80:147a:9e33:411a:e734%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {193.181.193.15, 176.173.38.152}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr bd:a4:01:29:7e:cd
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 5a:c0:31:fb:c6:86
}</pre>
