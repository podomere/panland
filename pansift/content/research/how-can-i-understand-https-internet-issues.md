...
layout: research
ip_v4_address: "174.131.196.160"
date: 2023-02-04T16:26:24+00:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like ```174.131.196.160``` or an IPv6 address like ```2000:8433:ef94:350d:fd18:3b4e:302d:4b36```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```51:06:79:fa:b2:c1```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://wisozk.net you initially access a DNS server to translate the host portion (wisozk) combined with the Top Level Domain (net) of the URL, to an IP address like ```32.137.76.29```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_3) AppleWebKit/537.75.14 (KHTML, like Gecko) Version/7.0.3 Safari/7046A194A```

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```172.23.236.9``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  172.23.236.9    UGScg  en0
...
<pre>
default   fe80:5a2e:4805:cf01:5a7%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {67.228.72.190, 212.175.186.217}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 51:06:79:fa:b2:c1
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 7f:4f:d2:74:3b:fa
}</pre>
