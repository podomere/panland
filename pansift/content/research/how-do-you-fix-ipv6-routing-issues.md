...
layout: research
ip_v4_address: "231.249.32.221"
date: 2022-05-05T14:29:28+01:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like ```231.249.32.221``` or an IPv6 address like ```2000:6bfd:3fb4:5c70:fa5e:a8ee:5ace:5f49```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```7f:66:39:19:ba:fd```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://tremblay-mccullough.info you initially access a DNS server to translate the host portion (tremblay-mccullough) combined with the Top Level Domain (info) of the URL, to an IP address like ```199.77.211.129```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows; U; Win 9x 4.90; SG; rv:1.9.2.4) Gecko/20101104 Netscape/9.1.0285```
...
<pre>
default   fe80:dae9:439c:d514:e85e%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {184.221.9.86, 118.202.75.173}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 7f:66:39:19:ba:fd
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr de:09:cc:38:ac:30
}</pre>
