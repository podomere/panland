...
layout: research
ip_v4_address: "130.230.82.126"
date: 2022-04-24T18:59:59+01:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like <code>130.230.82.126</code> or an IPv6 address like <code>2000:f354:e543:9547:a602:1c19:f144:2684</code>. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>ed:f8:a8:ef:73:8b</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://barton-hackett.co you initially access a DNS server to translate the host portion (barton-hackett) combined with the Top Level Domain (co) of the URL, to an IP address like <code>51.157.149.179</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (compatible; MSIE 9.0; AOL 9.7; AOLBuild 4343.19; Windows NT 6.1; WOW64; Trident/5.0; FunWebProducts)</code>
...
<pre><code>
default   fe80:57e0:9812:3063:8549%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {24.199.238.1, 202.164.84.116}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr ed:f8:a8:ef:73:8b
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 16:ff:84:7d:8a:2c
}</code></pre>
