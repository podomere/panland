...
layout: research
ip_v4_address: "23.4.251.241"
date: 2022-05-05T14:29:52+01:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like ```23.4.251.241``` or an IPv6 address like ```2000:6e35:a170:61f3:5a1a:b2bc:ca0e:1be3```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```46:ed:82:28:0d:d5```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://powlowski-barton.io you initially access a DNS server to translate the host portion (powlowski-barton) combined with the Top Level Domain (io) of the URL, to an IP address like ```151.128.78.221```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (compatible; MSIE 9.0; AOL 9.7; AOLBuild 4343.19; Windows NT 6.1; WOW64; Trident/5.0; FunWebProducts)```
...
<pre>
default   fe80:6dc6:8a0c:ef35:51dd%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {56.213.146.119, 103.138.138.129}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 46:ed:82:28:0d:d5
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 57:21:7f:2d:e7:0e
}</pre>
