...
layout: research
ip_v4_address: "81.151.10.151"
date: 2022-04-24T19:00:07+01:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like <code>81.151.10.151</code> or an IPv6 address like <code>2000:bd51:6143:b7a1:fa6b:9cd2:f9c0:c6c9</code>. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>8e:41:85:6d:01:d8</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://hintz-tromp.co you initially access a DNS server to translate the host portion (hintz-tromp) combined with the Top Level Domain (co) of the URL, to an IP address like <code>250.140.255.193</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Opera/9.80 (X11; Linux i686; Ubuntu/14.10) Presto/2.12.388 Version/12.16</code>
...
<pre><code>
default   fe80:72b2:8be8:3674:8134%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {15.136.255.254, 18.88.82.23}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 8e:41:85:6d:01:d8
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr cd:55:55:40:9c:1d
}</code></pre>
