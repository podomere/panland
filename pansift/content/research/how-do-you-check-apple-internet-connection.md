...
layout: research
ip_v4_address: "68.250.241.116"
date: 2022-11-19T16:17:13+00:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like ```68.250.241.116``` or an IPv6 address like ```2000:9e93:69ae:cbaf:988:c633:9fb2:9ffb```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```13:28:0a:59:0e:c3```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://rolfson-tromp.biz you initially access a DNS server to translate the host portion (rolfson-tromp) combined with the Top Level Domain (biz) of the URL, to an IP address like ```159.167.184.6```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (compatible; MSIE 9.0; AOL 9.7; AOLBuild 4343.19; Windows NT 6.1; WOW64; Trident/5.0; FunWebProducts)```
...
<pre>
default   fe80:1b80:f74a:79bc:3f92%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {3.109.109.41, 103.96.117.122}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 13:28:0a:59:0e:c3
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 83:87:5c:6d:5b:f3
}</pre>
