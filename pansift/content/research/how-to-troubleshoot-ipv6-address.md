...
layout: research
ip_v4_address: "9.142.242.93"
date: 2022-11-19T16:17:19+00:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like ```9.142.242.93``` or an IPv6 address like ```2000:48e4:1ec4:7aff:46ae:455d:51fc:fbc5```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```36:35:70:ea:70:8b```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://jaskolski-block.co you initially access a DNS server to translate the host portion (jaskolski-block) combined with the Top Level Domain (co) of the URL, to an IP address like ```137.97.164.153```. Your computer and browser actually sends its type with all web requests e.g. <br>```Opera/9.80 (X11; Linux i686; Ubuntu/14.10) Presto/2.12.388 Version/12.16```
...
<pre>
default   fe80:ab49:fb9d:3a2b:1489%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {152.165.133.203, 62.23.132.95}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 36:35:70:ea:70:8b
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 35:b8:da:ca:b9:5c
}</pre>
