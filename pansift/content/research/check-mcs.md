...
layout: research
ip_v4_address: "49.237.118.253"
date: 2022-11-02T11:32:24+00:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like ```49.237.118.253``` or an IPv6 address like ```2000:4b72:7da5:a8b9:e32f:884f:c99c:3e75```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```57:cd:35:1b:63:0d```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://champlin.com you initially access a DNS server to translate the host portion (champlin) combined with the Top Level Domain (com) of the URL, to an IP address like ```68.155.152.122```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT x.y; Win64; x64; rv:10.0) Gecko/20100101 Firefox/10.0```
...
<pre>
default   fe80:537a:91e9:bca6:b39e%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {218.76.164.40, 81.174.104.153}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 57:cd:35:1b:63:0d
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 5f:3f:a8:20:75:a8
}</pre>
