---
title: "Check IPv4 Router Issues"
subtitle: "Agile Marketing?"
layout: research
ip_v4_address: "69.64.234.200"
date: 2023-10-29T15:13:25+00:00
draft: false
---

## Internet Addressing
On the Internet you may get a Public IPv4 address like ```69.64.234.200``` or an IPv6 address like ```2000:d396:fc66:1c8:c6ce:5e34:4138:9c19```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```34:b2:a2:e1:95:62```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://hane-romaguera.info you initially access a DNS server to translate the host portion (hane-romaguera) combined with the Top Level Domain (info) of the URL, to an IP address like ```226.143.95.154```. Your computer and browser actually sends its type with all web requests e.g. <br>```Opera/9.80 (X11; Linux i686; Ubuntu/14.10) Presto/2.12.388 Version/12.16```

## Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```10.37.23.114``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  10.37.23.114    UGScg  en0
...
<pre>
default   fe80:e589:a49a:eae9:cdac%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {3.9.248.52, 50.251.194.93}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 34:b2:a2:e1:95:62
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr c4:a9:53:71:7e:16
}</pre>
