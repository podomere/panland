...
layout: research
ip_v4_address: "125.27.41.12"
date: 2023-02-04T17:07:48+00:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like ```125.27.41.12``` or an IPv6 address like ```2000:b6ad:5dca:c311:48c9:771d:4efd:e64a```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```12:b2:7a:07:a7:75```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://kuhlman-spencer.org you initially access a DNS server to translate the host portion (kuhlman-spencer) combined with the Top Level Domain (org) of the URL, to an IP address like ```144.194.57.102```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows; U; Win 9x 4.90; SG; rv:1.9.2.4) Gecko/20101104 Netscape/9.1.0285```
...
<pre>
default   fe80:2ace:ab21:f34d:944%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {156.144.183.42, 138.136.99.52}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 12:b2:7a:07:a7:75
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr bd:4a:5c:69:07:bc
}</pre>
