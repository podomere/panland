...
layout: research
ip_v4_address: "154.75.255.193"
date: 2022-06-04T14:38:43+01:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like ```154.75.255.193``` or an IPv6 address like ```2000:941b:d6b7:3d56:9e3f:8de9:9d3:ff34```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```50:66:7e:17:d2:21```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://dubuque-fay.name you initially access a DNS server to translate the host portion (dubuque-fay) combined with the Top Level Domain (name) of the URL, to an IP address like ```36.191.234.144```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows; U; Win 9x 4.90; SG; rv:1.9.2.4) Gecko/20101104 Netscape/9.1.0285```
...
<pre>
default   fe80:ab98:485e:89ce:83ae%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {22.86.213.145, 43.211.45.226}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 50:66:7e:17:d2:21
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr ae:b0:d7:86:9d:3f
}</pre>
