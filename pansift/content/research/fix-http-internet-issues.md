...
layout: research
ip_v4_address: "14.141.90.12"
date: 2022-11-19T16:17:24+00:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like ```14.141.90.12``` or an IPv6 address like ```2000:184a:7c5a:b8db:9219:f051:d4c9:fd4b```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```2f:6b:ce:b6:f4:db```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://schinner.name you initially access a DNS server to translate the host portion (schinner) combined with the Top Level Domain (name) of the URL, to an IP address like ```201.59.137.26```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1; WOW64; Trident/7.0; AS; rv:11.0) like Gecko```

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```10.54.146.143``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  10.54.146.143    UGScg  en0
...
<pre>
default   fe80:42f8:f146:9f0:d3f1%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {15.107.141.107, 251.12.178.201}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 2f:6b:ce:b6:f4:db
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 39:6c:54:e2:72:91
}</pre>
