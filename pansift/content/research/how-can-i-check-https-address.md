...
subtitle: "Learnings?"
layout: research
ip_v4_address: "151.143.136.74"
date: 2022-11-19T16:17:25+00:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like ```151.143.136.74``` or an IPv6 address like ```2000:ff67:4e0:7a06:4b3b:6c15:778d:ea3f```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```e3:84:77:0f:6a:e3```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://nader-terry.name you initially access a DNS server to translate the host portion (nader-terry) combined with the Top Level Domain (name) of the URL, to an IP address like ```36.163.160.114```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows; U; Win 9x 4.90; SG; rv:1.9.2.4) Gecko/20101104 Netscape/9.1.0285```
...
<pre>
default   fe80:9fa1:58e3:c761:31ba%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {62.40.203.124, 237.124.27.217}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr e3:84:77:0f:6a:e3
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 38:07:a3:32:a7:9f
}</pre>
