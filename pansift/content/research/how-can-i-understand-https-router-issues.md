...
layout: research
ip_v4_address: "119.59.252.241"
date: 2023-02-04T17:08:41+00:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like ```119.59.252.241``` or an IPv6 address like ```2000:6ede:b028:2937:f82f:d51f:5227:1b73```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```70:85:1b:e6:4f:81```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://cruickshank-bednar.com you initially access a DNS server to translate the host portion (cruickshank-bednar) combined with the Top Level Domain (com) of the URL, to an IP address like ```251.49.207.232```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_3) AppleWebKit/537.75.14 (KHTML, like Gecko) Version/7.0.3 Safari/7046A194A```
...
<pre>
default   fe80:2b12:2e1d:3155:d567%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {210.68.114.126, 139.86.205.195}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 70:85:1b:e6:4f:81
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 81:46:bc:f8:03:b7
}</pre>
