...
layout: research
ip_v4_address: "247.97.132.135"
date: 2022-12-15T13:50:04+00:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like ```247.97.132.135``` or an IPv6 address like ```2000:2af1:56f2:5ed4:b32a:4d64:9923:da92```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```d6:8b:13:7a:59:68```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://pouros-white.com you initially access a DNS server to translate the host portion (pouros-white) combined with the Top Level Domain (com) of the URL, to an IP address like ```117.23.99.22```. Your computer and browser actually sends its type with all web requests e.g. <br>```Opera/9.80 (X11; Linux i686; Ubuntu/14.10) Presto/2.12.388 Version/12.16```
...
<pre>
default   fe80:642d:ae69:b2db:abd4%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {86.129.95.130, 229.246.242.168}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr d6:8b:13:7a:59:68
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 67:b0:0e:f6:39:b6
}</pre>
