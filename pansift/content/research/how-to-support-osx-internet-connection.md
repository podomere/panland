...
layout: research
ip_v4_address: "31.133.117.104"
date: 2022-04-24T19:00:24+01:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like <code>31.133.117.104</code> or an IPv6 address like <code>2000:b52b:8573:f9ae:a13:4ebe:c8:ab31</code>. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>36:da:24:3e:c3:8f</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://quigley-torp.org you initially access a DNS server to translate the host portion (quigley-torp) combined with the Top Level Domain (org) of the URL, to an IP address like <code>10.186.138.225</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_3) AppleWebKit/537.75.14 (KHTML, like Gecko) Version/7.0.3 Safari/7046A194A</code>
...
<pre><code>
default   fe80:84c1:b401:458d:4d8d%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {91.184.197.198, 19.131.16.119}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 36:da:24:3e:c3:8f
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr e4:97:ba:e0:61:51
}</code></pre>
