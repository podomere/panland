...
subtitle: "Etc. Etc.?"
layout: research
ip_v4_address: "225.185.48.47"
date: 2022-04-24T19:00:34+01:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like <code>225.185.48.47</code> or an IPv6 address like <code>2000:64ae:d069:7068:f4a0:40:6752:ed42</code>. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>7c:ba:cb:55:29:95</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://vandervort-roberts.co you initially access a DNS server to translate the host portion (vandervort-roberts) combined with the Top Level Domain (co) of the URL, to an IP address like <code>124.81.176.126</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_3) AppleWebKit/537.75.14 (KHTML, like Gecko) Version/7.0.3 Safari/7046A194A</code>
...
<pre><code>
default   fe80:65f3:6f3:8abe:12ef%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {162.163.231.204, 196.210.197.205}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 7c:ba:cb:55:29:95
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 4e:ce:e4:e0:b4:dd
}</code></pre>
