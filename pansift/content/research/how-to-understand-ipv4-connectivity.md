...
subtitle: "Etc. Etc.?"
layout: research
ip_v4_address: "7.14.4.207"
date: 2022-06-12T14:09:24+01:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like ```7.14.4.207``` or an IPv6 address like ```2000:cd2e:df0f:5979:d68f:afae:ef41:50b0```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```ce:c7:98:8f:29:cf```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://grant-mosciski.name you initially access a DNS server to translate the host portion (grant-mosciski) combined with the Top Level Domain (name) of the URL, to an IP address like ```157.191.116.27```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_3) AppleWebKit/537.75.14 (KHTML, like Gecko) Version/7.0.3 Safari/7046A194A```
...
<pre>
default   fe80:210c:6360:c6c:f5f5%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {46.47.88.53, 245.143.26.231}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr ce:c7:98:8f:29:cf
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 46:06:ce:f7:b3:55
}</pre>
