...
layout: research
ip_v4_address: "217.195.26.95"
date: 2022-11-02T11:32:55+00:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like ```217.195.26.95``` or an IPv6 address like ```2000:e11c:df80:23b5:4190:13a1:a8a2:977d```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```ac:d3:76:b9:87:54```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://smith.org you initially access a DNS server to translate the host portion (smith) combined with the Top Level Domain (org) of the URL, to an IP address like ```77.57.240.201```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_3) AppleWebKit/537.75.14 (KHTML, like Gecko) Version/7.0.3 Safari/7046A194A```
...
<pre>
default   fe80:f23:6b24:1672:7e81%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {190.252.145.157, 68.126.184.226}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr ac:d3:76:b9:87:54
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 96:dc:e1:59:d4:df
}</pre>
...
## Apple macOS / OSX
No matter what version of OSX/macOS you are on, ```10.14.2```, ```11.6.5```, or ```12.0.2```, there are a range of tools for troubleshooting. Unfortunately, between these manual actions and scripts, they don't give you a series of correlated values over time. This is where automated remote troubleshooting comes in to its own, especially for teams that embrace remote work and Work From Anywhere (WFA).
