...
subtitle: "Value Add?"
layout: research
ip_v4_address: "47.90.122.100"
date: 2022-11-19T16:17:23+00:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like ```47.90.122.100``` or an IPv6 address like ```2000:2877:bbd2:7f78:fa29:9294:343e:5f2d```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```35:a1:ce:28:31:01```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://lueilwitz.name you initially access a DNS server to translate the host portion (lueilwitz) combined with the Top Level Domain (name) of the URL, to an IP address like ```206.183.77.245```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT x.y; Win64; x64; rv:10.0) Gecko/20100101 Firefox/10.0```
...
<pre>
default   fe80:e10e:15f1:881f:106d%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {216.213.152.178, 123.109.103.17}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 35:a1:ce:28:31:01
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 19:bd:5b:b0:7a:e3
}</pre>
