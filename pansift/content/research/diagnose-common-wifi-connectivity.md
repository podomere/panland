...
layout: research
ip_v4_address: "194.227.227.88"
date: 2023-10-29T15:13:12+00:00
draft: false
---

## Internet Addressing
On the Internet you might get a Public IPv4 address like ```194.227.227.88``` or an IPv6 address like ```2000:39d2:a670:99c1:f01e:5fb5:3b0c:f4f0```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```72:48:7b:88:fa:64```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://pfannerstill-rempel.name you initially access a DNS server to translate the host portion (pfannerstill-rempel) combined with the Top Level Domain (name) of the URL, to an IP address like ```255.88.21.170```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_3) AppleWebKit/537.75.14 (KHTML, like Gecko) Version/7.0.3 Safari/7046A194A```
...
<pre>
default   fe80:f252:b0f6:f539:8393%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {109.49.33.43, 220.171.65.109}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 72:48:7b:88:fa:64
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr b7:30:a6:5c:f2:e8
}</pre>
