...
layout: research
ip_v4_address: "85.12.37.40"
date: 2022-06-12T14:09:05+01:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like ```85.12.37.40``` or an IPv6 address like ```2000:1133:e77a:62d9:9948:ddc2:b907:68a```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```07:08:b1:6c:be:07```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://robel.info you initially access a DNS server to translate the host portion (robel) combined with the Top Level Domain (info) of the URL, to an IP address like ```50.240.23.29```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows; U; Win 9x 4.90; SG; rv:1.9.2.4) Gecko/20101104 Netscape/9.1.0285```
...
<pre>
default   fe80:1b05:15cf:1437:d9d9%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {68.173.106.154, 112.182.12.63}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 07:08:b1:6c:be:07
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 8e:6d:e5:fd:bb:c6
}</pre>
