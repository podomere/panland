...
layout: research
ip_v4_address: "251.193.222.209"
date: 2022-04-24T19:00:06+01:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like <code>251.193.222.209</code> or an IPv6 address like <code>2000:9dfd:3396:f95:7ce7:aa42:ac33:3649</code>. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>b5:ed:05:35:eb:b4</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://johns-kihn.info you initially access a DNS server to translate the host portion (johns-kihn) combined with the Top Level Domain (info) of the URL, to an IP address like <code>234.167.147.241</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (Windows; U; Win 9x 4.90; SG; rv:1.9.2.4) Gecko/20101104 Netscape/9.1.0285</code>
...
<pre><code>
default   fe80:6192:b61d:5cd5:7281%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {195.69.212.154, 3.101.194.177}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr b5:ed:05:35:eb:b4
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr d4:58:22:cf:0b:8b
}</code></pre>
