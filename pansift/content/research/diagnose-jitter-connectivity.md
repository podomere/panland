...
layout: research
ip_v4_address: "101.175.161.83"
date: 2023-02-04T17:08:37+00:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like ```101.175.161.83``` or an IPv6 address like ```2000:4f9f:8e51:3b60:f0fc:b748:3247:a6```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```fd:99:0e:19:3f:3b```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://mills.io you initially access a DNS server to translate the host portion (mills) combined with the Top Level Domain (io) of the URL, to an IP address like ```102.237.93.168```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (compatible; MSIE 9.0; AOL 9.7; AOLBuild 4343.19; Windows NT 6.1; WOW64; Trident/5.0; FunWebProducts)```
...
<pre>
default   fe80:bdd6:da1b:8f9d:b30e%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {74.170.112.211, 30.223.91.206}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr fd:99:0e:19:3f:3b
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 8c:85:5a:d2:8d:57
}</pre>
