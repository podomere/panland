...
layout: research
ip_v4_address: "113.63.81.105"
date: 2022-06-04T14:38:43+01:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like ```113.63.81.105``` or an IPv6 address like ```2000:a52d:f607:86bb:33b5:c1ad:2c95:9bd4```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```ec:ca:b6:80:0b:7b```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://beahan.co you initially access a DNS server to translate the host portion (beahan) combined with the Top Level Domain (co) of the URL, to an IP address like ```99.202.42.60```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT x.y; Win64; x64; rv:10.0) Gecko/20100101 Firefox/10.0```
...
<pre>
default   fe80:7225:d048:ccef:11c2%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {43.101.184.152, 211.201.234.204}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr ec:ca:b6:80:0b:7b
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr eb:7b:df:d8:24:68
}</pre>
