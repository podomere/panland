---
title: "How Can I Latency Address"
subtitle: "Plug And Chug?"
layout: research
ip_v4_address: "48.185.113.102"
date: 2022-12-15T13:50:18+00:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like ```48.185.113.102``` or an IPv6 address like ```2000:736c:7611:d271:c3c7:fa12:f0e3:1d2d```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```56:59:ea:15:71:85```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://kunde-stiedemann.io you initially access a DNS server to translate the host portion (kunde-stiedemann) combined with the Top Level Domain (io) of the URL, to an IP address like ```31.248.22.71```. Your computer and browser actually sends its type with all web requests e.g. <br>```Opera/9.80 (X11; Linux i686; Ubuntu/14.10) Presto/2.12.388 Version/12.16```

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```172.30.108.99``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  172.30.108.99    UGScg  en0
...
<pre>
default   fe80:3983:89c6:f11b:1738%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {197.80.13.193, 220.30.254.193}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 56:59:ea:15:71:85
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 15:9f:b6:f1:3a:d3
}</pre>
