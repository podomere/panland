...
layout: research
ip_v4_address: "225.254.96.11"
date: 2022-11-19T16:17:20+00:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like ```225.254.96.11``` or an IPv6 address like ```2000:abd4:d763:5773:a872:5bd3:729c:dd46```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```84:9b:4a:24:8c:7a```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://zieme-batz.org you initially access a DNS server to translate the host portion (zieme-batz) combined with the Top Level Domain (org) of the URL, to an IP address like ```40.63.143.51```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows; U; Win 9x 4.90; SG; rv:1.9.2.4) Gecko/20101104 Netscape/9.1.0285```
...
<pre>
default   fe80:1bd9:2e38:5286:4357%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {59.74.121.89, 210.24.162.41}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 84:9b:4a:24:8c:7a
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr a2:63:f9:48:0e:8f
}</pre>
