---
title: "How Do You Understand Latency Internet Issues"
subtitle: "Data Points?"
layout: research
ip_v4_address: "176.124.128.114"
date: 2022-11-19T19:13:25+00:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like ```176.124.128.114``` or an IPv6 address like ```2000:ffe9:f8a0:e1fe:4376:afa3:808:decb```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```02:0d:c4:c7:9e:f9```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://schimmel.org you initially access a DNS server to translate the host portion (schimmel) combined with the Top Level Domain (org) of the URL, to an IP address like ```124.173.92.68```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (compatible; MSIE 9.0; AOL 9.7; AOLBuild 4343.19; Windows NT 6.1; WOW64; Trident/5.0; FunWebProducts)```

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```192.168.136.109``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  192.168.136.109    UGScg  en0
...
<pre>
default   fe80:6620:7901:5750:7637%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {252.98.226.144, 201.232.42.77}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 02:0d:c4:c7:9e:f9
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr ce:51:17:62:ce:e5
}</pre>
