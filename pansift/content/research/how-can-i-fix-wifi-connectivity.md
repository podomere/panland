...
layout: research
ip_v4_address: "73.171.120.230"
date: 2022-11-02T11:32:23+00:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like ```73.171.120.230``` or an IPv6 address like ```2000:9b4f:c920:27cf:3c33:a3f4:850b:b41e```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```80:76:9e:68:e0:a9```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://gleichner.name you initially access a DNS server to translate the host portion (gleichner) combined with the Top Level Domain (name) of the URL, to an IP address like ```128.122.173.167```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (compatible; MSIE 9.0; AOL 9.7; AOLBuild 4343.19; Windows NT 6.1; WOW64; Trident/5.0; FunWebProducts)```

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```10.154.5.130``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  10.154.5.130    UGScg  en0
...
<pre>
default   fe80:ba9f:650a:22b7:f6f6%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {157.146.97.38, 239.149.241.157}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 80:76:9e:68:e0:a9
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr c7:f6:fb:24:9c:a9
}</pre>
...
## Apple macOS / OSX
No matter what version of OSX/macOS you are on, ```10.15.1```, ```11.1.5```, or ```12.1.1```, there are a range of tools for troubleshooting. Unfortunately, between these manual actions and scripts, they don't give you a series of correlated values over time. This is where automated remote troubleshooting comes in to its own, especially for teams that embrace remote work and Work From Anywhere (WFA).
