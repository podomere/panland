...
subtitle: "Heads Down?"
layout: research
ip_v4_address: "118.93.32.46"
date: 2023-02-04T17:08:40+00:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like ```118.93.32.46``` or an IPv6 address like ```2000:665a:3452:3294:9eed:39d6:2fb7:5519```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```be:00:5e:12:93:15```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://simonis-kerluke.net you initially access a DNS server to translate the host portion (simonis-kerluke) combined with the Top Level Domain (net) of the URL, to an IP address like ```255.162.95.178```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT x.y; Win64; x64; rv:10.0) Gecko/20100101 Firefox/10.0```
...
<pre>
default   fe80:cf85:790b:c64f:9cd4%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {226.1.103.141, 5.197.80.170}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr be:00:5e:12:93:15
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 68:e5:c2:d9:9d:45
}</pre>
