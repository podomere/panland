...
layout: research
ip_v4_address: "39.34.229.52"
date: 2023-10-06T17:11:08+01:00
draft: false
---

## Internet Addressing
On the Internet you might have a Public IPv4 address like ```39.34.229.52``` or an IPv6 address like ```2000:2e67:3643:3f8f:bbae:df2b:3f68:4320```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```fe:7e:6b:94:59:53```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://emmerich-zieme.biz you initially access a DNS server to translate the host portion (emmerich-zieme) combined with the Top Level Domain (biz) of the URL, to an IP address like ```158.203.195.84```. Your computer and browser actually sends its type with all web requests e.g. <br>```Opera/9.80 (X11; Linux i686; Ubuntu/14.10) Presto/2.12.388 Version/12.16```
...
<pre>
default   fe80:56e4:bc6e:206e:8333%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {30.48.142.40, 108.28.92.179}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr fe:7e:6b:94:59:53
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 51:84:bb:e6:92:5c
}</pre>
