...
layout: research
ip_v4_address: "63.24.137.113"
date: 2022-11-19T19:13:16+00:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like ```63.24.137.113``` or an IPv6 address like ```2000:b8bf:ba7b:c6d3:473e:fe24:aa7b:b41c```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```4f:2d:cc:b2:8e:9d```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://barton-purdy.io you initially access a DNS server to translate the host portion (barton-purdy) combined with the Top Level Domain (io) of the URL, to an IP address like ```69.252.158.201```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT x.y; Win64; x64; rv:10.0) Gecko/20100101 Firefox/10.0```
...
default  172.30.50.67    UGScg  en0
...
<pre>
default   fe80:60d7:41f3:678d:3e51%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {102.112.115.213, 7.2.235.217}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 4f:2d:cc:b2:8e:9d
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr ec:1f:cd:d5:1f:e3
}</pre>
