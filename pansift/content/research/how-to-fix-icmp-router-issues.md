...
layout: research
ip_v4_address: "213.124.43.9"
date: 2023-10-29T15:13:27+00:00
draft: false
---

## Internet Addressing
On the Internet you might have a Public IPv4 address like ```213.124.43.9``` or an IPv6 address like ```2000:c2be:bbd:b35a:af69:6c53:2ef4:f661```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```44:33:2d:c2:99:f7```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://durgan-mills.name you initially access a DNS server to translate the host portion (durgan-mills) combined with the Top Level Domain (name) of the URL, to an IP address like ```172.31.122.33```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT x.y; Win64; x64; rv:10.0) Gecko/20100101 Firefox/10.0```
...
<pre>
default   fe80:73c0:1c96:12b6:9c73%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {50.205.186.161, 28.27.97.75}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 44:33:2d:c2:99:f7
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 03:01:3b:b2:97:e3
}</pre>
