...
layout: research
ip_v4_address: "67.104.200.128"
date: 2023-10-06T17:10:42+01:00
draft: false
---

## Internet Addressing
On the Internet you may have a Public IPv4 address like ```67.104.200.128``` or an IPv6 address like ```2000:7103:d736:5280:33d6:9c94:8a4a:8c73```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```6a:28:e9:de:6c:c4```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://veum-schoen.co you initially access a DNS server to translate the host portion (veum-schoen) combined with the Top Level Domain (co) of the URL, to an IP address like ```149.99.58.14```. Your computer and browser actually sends its type with all web requests e.g. <br>```Opera/9.80 (X11; Linux i686; Ubuntu/14.10) Presto/2.12.388 Version/12.16```
...
default  172.21.11.13    UGScg  en0
...
<pre>
default   fe80:8f23:217b:eaa5:2b88%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {146.101.157.226, 185.87.5.105}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 6a:28:e9:de:6c:c4
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 07:3d:6f:d4:96:1f
}</pre>
