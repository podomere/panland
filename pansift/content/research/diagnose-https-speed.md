...
subtitle: "Tee It Up?"
layout: research
ip_v4_address: "188.145.58.221"
date: 2022-12-15T13:50:21+00:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like ```188.145.58.221``` or an IPv6 address like ```2000:a3db:eef9:122f:1a50:da50:5f09:5955```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```7f:db:bd:18:e8:56```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://deckow-wuckert.com you initially access a DNS server to translate the host portion (deckow-wuckert) combined with the Top Level Domain (com) of the URL, to an IP address like ```79.37.199.210```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT x.y; Win64; x64; rv:10.0) Gecko/20100101 Firefox/10.0```

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```172.26.143.4``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  172.26.143.4    UGScg  en0
...
<pre>
default   fe80:640b:78a:3439:f0b%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {74.243.211.208, 181.10.200.147}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 7f:db:bd:18:e8:56
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 4d:9b:ed:b5:ae:75
}</pre>
