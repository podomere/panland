...
subtitle: "Tee It Up?"
layout: research
ip_v4_address: "136.76.96.189"
date: 2022-05-05T14:29:57+01:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like ```136.76.96.189``` or an IPv6 address like ```2000:9877:a8e7:20d6:b2d6:4e12:b88e:29b4```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```df:28:2e:e0:35:5f```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://kunde-hermann.co you initially access a DNS server to translate the host portion (kunde-hermann) combined with the Top Level Domain (co) of the URL, to an IP address like ```193.134.169.216```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT x.y; Win64; x64; rv:10.0) Gecko/20100101 Firefox/10.0```
...
<pre>
default   fe80:167c:d62b:4da8:f674%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {21.157.35.251, 122.175.216.17}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr df:28:2e:e0:35:5f
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 89:80:4c:dc:bb:e6
}</pre>
