...
layout: research
ip_v4_address: "165.248.226.216"
date: 2022-11-19T16:17:23+00:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like ```165.248.226.216``` or an IPv6 address like ```2000:4015:3913:9152:2442:60a0:f27d:3934```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```3b:5b:a6:20:d5:af```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://lang-rosenbaum.com you initially access a DNS server to translate the host portion (lang-rosenbaum) combined with the Top Level Domain (com) of the URL, to an IP address like ```221.45.23.95```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (compatible; MSIE 9.0; AOL 9.7; AOLBuild 4343.19; Windows NT 6.1; WOW64; Trident/5.0; FunWebProducts)```
...
<pre>
default   fe80:2c4f:1807:a749:3a8%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {144.80.197.196, 120.48.28.22}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 3b:5b:a6:20:d5:af
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 46:5c:3a:25:e2:9b
}</pre>
