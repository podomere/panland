...
layout: research
ip_v4_address: "238.157.52.156"
date: 2022-11-02T11:32:59+00:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like ```238.157.52.156``` or an IPv6 address like ```2000:f968:2b96:1e08:b8d6:1d15:f628:fd06```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```45:14:3c:10:e3:4e```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://gorczany-wilkinson.com you initially access a DNS server to translate the host portion (gorczany-wilkinson) combined with the Top Level Domain (com) of the URL, to an IP address like ```212.94.248.107```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1; WOW64; Trident/7.0; AS; rv:11.0) like Gecko```
...
<pre>
default   fe80:7ce1:b2fb:7c9f:1789%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {234.34.42.239, 170.231.28.150}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 45:14:3c:10:e3:4e
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr e2:b5:d4:4b:70:a3
}</pre>
