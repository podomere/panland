...
layout: research
ip_v4_address: "96.79.88.148"
date: 2022-11-02T11:32:56+00:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like ```96.79.88.148``` or an IPv6 address like ```2000:3ed2:8cd1:c778:5fae:5eb3:710e:6a8```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```1e:70:a4:53:03:2c```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://paucek.name you initially access a DNS server to translate the host portion (paucek) combined with the Top Level Domain (name) of the URL, to an IP address like ```150.160.184.177```. Your computer and browser actually sends its type with all web requests e.g. <br>```Opera/9.80 (X11; Linux i686; Ubuntu/14.10) Presto/2.12.388 Version/12.16```

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```10.205.239.134``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  10.205.239.134    UGScg  en0
...
<pre>
default   fe80:6455:508e:2908:bb20%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {77.83.219.43, 200.159.37.63}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 1e:70:a4:53:03:2c
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 3d:18:aa:80:8f:b3
}</pre>
