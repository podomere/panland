...
layout: research
ip_v4_address: "166.105.106.36"
date: 2023-10-29T15:13:29+00:00
draft: false
---

## Internet Addressing
On the Internet you might have a Public IPv4 address like ```166.105.106.36``` or an IPv6 address like ```2000:7746:6d74:377c:abcf:b367:d327:9e1e```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```ea:e5:ee:19:7c:cc```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://deckow-schoen.com you initially access a DNS server to translate the host portion (deckow-schoen) combined with the Top Level Domain (com) of the URL, to an IP address like ```137.172.134.150```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows; U; Win 9x 4.90; SG; rv:1.9.2.4) Gecko/20101104 Netscape/9.1.0285```
...
<pre>
default   fe80:690f:ef67:79de:68d0%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {25.190.64.67, 64.51.115.114}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr ea:e5:ee:19:7c:cc
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr c3:85:d5:62:4e:8c
}</pre>
