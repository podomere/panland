...
subtitle: "Learnings?"
layout: research
ip_v4_address: "232.218.190.223"
date: 2022-11-02T11:32:24+00:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like ```232.218.190.223``` or an IPv6 address like ```2000:89da:e870:d21b:8f04:12b:171e:e66e```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```fb:6b:f7:40:66:c9```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://blanda-pollich.co you initially access a DNS server to translate the host portion (blanda-pollich) combined with the Top Level Domain (co) of the URL, to an IP address like ```99.84.209.47```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_3) AppleWebKit/537.75.14 (KHTML, like Gecko) Version/7.0.3 Safari/7046A194A```
...
<pre>
default   fe80:fe3b:cd08:e7c6:d2a5%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {91.86.38.104, 227.134.224.84}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr fb:6b:f7:40:66:c9
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr ce:9f:0f:8b:6b:04
}</pre>
