...
layout: research
ip_v4_address: "76.94.178.41"
date: 2023-02-04T17:07:50+00:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like ```76.94.178.41``` or an IPv6 address like ```2000:e7d:94c3:8ba:ed64:3672:cbba:c594```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```fa:67:2f:57:b2:b9```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://ohara-schmeler.name you initially access a DNS server to translate the host portion (ohara-schmeler) combined with the Top Level Domain (name) of the URL, to an IP address like ```218.114.146.211```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (compatible; MSIE 9.0; AOL 9.7; AOLBuild 4343.19; Windows NT 6.1; WOW64; Trident/5.0; FunWebProducts)```

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```10.111.234.47``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  10.111.234.47    UGScg  en0
...
<pre>
default   fe80:69eb:3cf8:9b3d:8034%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {52.62.247.180, 187.60.184.213}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr fa:67:2f:57:b2:b9
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 5c:e5:1a:ba:2e:76
}</pre>
