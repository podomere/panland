...
layout: research
ip_v4_address: "83.225.73.23"
date: 2022-04-24T18:59:58+01:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like <code>83.225.73.23</code> or an IPv6 address like <code>2000:286e:9227:8944:5c6d:2ba1:509:f4ea</code>. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>1a:cc:40:41:ea:65</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://koss-reichert.net you initially access a DNS server to translate the host portion (koss-reichert) combined with the Top Level Domain (net) of the URL, to an IP address like <code>24.171.192.49</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (Windows NT x.y; Win64; x64; rv:10.0) Gecko/20100101 Firefox/10.0</code>
...
<pre><code>
default   fe80:e94b:eece:f8d8:6af3%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {72.0.105.38, 234.154.132.70}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 1a:cc:40:41:ea:65
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 9d:70:16:fa:a7:b6
}</code></pre>
