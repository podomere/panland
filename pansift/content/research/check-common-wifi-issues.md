...
layout: research
ip_v4_address: "157.139.104.236"
date: 2022-06-04T14:38:17+01:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like ```157.139.104.236``` or an IPv6 address like ```2000:9c96:9ae8:c417:aa7:8ea2:61b8:ad68```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```35:8a:d1:53:d7:4a```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://dooley.name you initially access a DNS server to translate the host portion (dooley) combined with the Top Level Domain (name) of the URL, to an IP address like ```41.164.192.32```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1; WOW64; Trident/7.0; AS; rv:11.0) like Gecko```
...
<pre>
default   fe80:5845:bac7:1edb:79be%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {230.94.179.204, 236.7.8.105}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 35:8a:d1:53:d7:4a
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr f8:7e:65:db:38:4d
}</pre>
