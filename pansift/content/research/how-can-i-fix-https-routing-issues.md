...
layout: research
ip_v4_address: "243.109.207.101"
date: 2023-02-04T17:08:41+00:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like ```243.109.207.101``` or an IPv6 address like ```2000:a093:7abe:9404:863d:7120:fa03:17f1```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```d6:2b:ff:50:08:24```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://waelchi-lakin.com you initially access a DNS server to translate the host portion (waelchi-lakin) combined with the Top Level Domain (com) of the URL, to an IP address like ```202.86.173.197```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_3) AppleWebKit/537.75.14 (KHTML, like Gecko) Version/7.0.3 Safari/7046A194A```
...
<pre>
default   fe80:d064:411e:d6da:fa5d%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {232.166.109.84, 61.174.106.219}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr d6:2b:ff:50:08:24
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 00:72:f1:5d:d1:42
}</pre>
