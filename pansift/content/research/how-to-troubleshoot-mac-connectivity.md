...
subtitle: "Deep Dive?"
layout: research
ip_v4_address: "50.100.107.174"
date: 2022-04-24T19:00:25+01:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like <code>50.100.107.174</code> or an IPv6 address like <code>2000:5229:c668:f75b:e335:cd3:1667:ef83</code>. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>90:3e:f2:4e:21:d4</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://huels-marquardt.name you initially access a DNS server to translate the host portion (huels-marquardt) combined with the Top Level Domain (name) of the URL, to an IP address like <code>73.56.13.52</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (Windows; U; Win 9x 4.90; SG; rv:1.9.2.4) Gecko/20101104 Netscape/9.1.0285</code>

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like <code>10.253.230.190</code> (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For <code>IPv6</code> we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  10.253.230.190    UGScg  en0
...
<pre><code>
default   fe80:501b:8e1d:c180:5ced%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {249.88.70.234, 77.39.67.234}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 90:3e:f2:4e:21:d4
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 9c:72:5a:42:c4:9b
}</code></pre>
