...
subtitle: "Etc. Etc.?"
layout: research
ip_v4_address: "38.145.57.90"
date: 2022-11-19T19:13:16+00:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like ```38.145.57.90``` or an IPv6 address like ```2000:7020:639a:b36b:ee4e:1803:f810:d327```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```38:2b:6b:24:30:1b```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://parisian-yost.info you initially access a DNS server to translate the host portion (parisian-yost) combined with the Top Level Domain (info) of the URL, to an IP address like ```140.170.52.59```. Your computer and browser actually sends its type with all web requests e.g. <br>```Opera/9.80 (X11; Linux i686; Ubuntu/14.10) Presto/2.12.388 Version/12.16```
...
<pre>
default   fe80:43c8:97f0:e783:486e%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {77.27.216.123, 102.57.207.250}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 38:2b:6b:24:30:1b
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 88:08:34:c9:aa:df
}</pre>
