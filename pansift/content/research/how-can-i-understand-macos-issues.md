...
layout: research
ip_v4_address: "136.10.202.211"
date: 2022-04-24T18:31:57+01:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like <code>136.10.202.211</code> or an IPv6 address like <code>2000:951d:9a9e:c8d4:7e70:9f53:dcf3:b195</code>. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>52:50:5f:86:f1:4a</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://kub-farrell.name you initially access a DNS server to translate the host portion (kub-farrell) combined with the Top Level Domain (name) of the URL, to an IP address like <code>234.54.198.47</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (Windows NT x.y; Win64; x64; rv:10.0) Gecko/20100101 Firefox/10.0</code>
...
<pre><code>
default   fe80:2792:cb9c:893b:7aaa%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {103.71.162.208, 116.234.98.86}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 52:50:5f:86:f1:4a
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 58:dc:f9:18:7e:09
}</code></pre>
