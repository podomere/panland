...
subtitle: "Learnings?"
layout: research
ip_v4_address: "72.74.249.123"
date: 2022-05-05T14:28:50+01:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like ```72.74.249.123``` or an IPv6 address like ```2000:aa83:8e05:2f36:8827:a221:b21a:300d```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```b4:41:b4:0a:b0:15```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://lueilwitz-rohan.info you initially access a DNS server to translate the host portion (lueilwitz-rohan) combined with the Top Level Domain (info) of the URL, to an IP address like ```108.87.31.26```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (compatible; MSIE 9.0; AOL 9.7; AOLBuild 4343.19; Windows NT 6.1; WOW64; Trident/5.0; FunWebProducts)```

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```192.168.155.99``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  192.168.155.99    UGScg  en0
...
<pre>
default   fe80:bf72:6233:4fb4:ed53%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {121.74.205.109, 61.23.125.17}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr b4:41:b4:0a:b0:15
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 04:a2:53:8a:20:68
}</pre>
