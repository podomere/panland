...
layout: research
ip_v4_address: "196.29.149.192"
date: 2022-04-24T19:00:25+01:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like <code>196.29.149.192</code> or an IPv6 address like <code>2000:439f:9ccf:2966:cb94:810c:e164:b1</code>. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>8f:ec:03:7c:5a:23</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://mayer-parisian.biz you initially access a DNS server to translate the host portion (mayer-parisian) combined with the Top Level Domain (biz) of the URL, to an IP address like <code>235.177.55.206</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (Windows NT 6.1; WOW64; Trident/7.0; AS; rv:11.0) like Gecko</code>
...
<pre><code>
default   fe80:e164:7db2:7295:d0f5%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {253.25.66.189, 150.164.65.68}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 8f:ec:03:7c:5a:23
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr ed:c6:14:4d:c1:3b
}</code></pre>
