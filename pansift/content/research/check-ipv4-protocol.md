...
layout: research
ip_v4_address: "133.158.29.68"
date: 2022-12-15T13:50:17+00:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like ```133.158.29.68``` or an IPv6 address like ```2000:d65d:4c4d:84c:a4c0:6e87:e46f:510e```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```d7:d7:fc:6a:4c:6d```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://ziemann-runolfsson.biz you initially access a DNS server to translate the host portion (ziemann-runolfsson) combined with the Top Level Domain (biz) of the URL, to an IP address like ```53.234.201.255```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT x.y; Win64; x64; rv:10.0) Gecko/20100101 Firefox/10.0```
...
<pre>
default   fe80:b34:8a33:aa30:6eec%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {22.117.38.156, 141.84.145.30}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr d7:d7:fc:6a:4c:6d
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 76:b7:f1:e7:65:b8
}</pre>
