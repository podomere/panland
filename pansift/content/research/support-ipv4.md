...
layout: research
ip_v4_address: "173.171.57.53"
date: 2023-10-29T15:13:25+00:00
draft: false
---

## Internet Addressing
On the Internet you may get a Public IPv4 address like ```173.171.57.53``` or an IPv6 address like ```2000:f9d0:8930:423a:def5:ca21:3f8c:a559```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```50:ff:55:ea:ad:26```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://denesik.name you initially access a DNS server to translate the host portion (denesik) combined with the Top Level Domain (name) of the URL, to an IP address like ```67.166.118.11```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows; U; Win 9x 4.90; SG; rv:1.9.2.4) Gecko/20101104 Netscape/9.1.0285```

## Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```172.26.176.246``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  172.26.176.246    UGScg  en0
...
<pre>
default   fe80:5464:1590:6938:3ebc%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {170.193.130.252, 146.53.127.54}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 50:ff:55:ea:ad:26
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr c5:0d:db:2f:bc:0a
}</pre>
