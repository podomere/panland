...
layout: research
ip_v4_address: "117.190.106.169"
date: 2022-11-19T16:17:19+00:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like ```117.190.106.169``` or an IPv6 address like ```2000:7076:fef2:ac31:9e97:dc5f:485d:18e3```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```3d:da:a6:6d:05:bc```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://huel.io you initially access a DNS server to translate the host portion (huel) combined with the Top Level Domain (io) of the URL, to an IP address like ```0.176.110.38```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows; U; Win 9x 4.90; SG; rv:1.9.2.4) Gecko/20101104 Netscape/9.1.0285```
...
<pre>
default   fe80:3804:95fb:ec33:eb7b%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {177.125.222.120, 186.201.14.166}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 3d:da:a6:6d:05:bc
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr af:98:fe:82:83:e2
}</pre>
