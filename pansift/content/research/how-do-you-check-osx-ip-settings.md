...
layout: research
ip_v4_address: "213.33.80.228"
date: 2022-04-24T19:00:24+01:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like <code>213.33.80.228</code> or an IPv6 address like <code>2000:506b:3950:4dc0:bcdd:1353:58ca:eef2</code>. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>d5:40:28:7e:cf:f3</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://kuhlman-roberts.net you initially access a DNS server to translate the host portion (kuhlman-roberts) combined with the Top Level Domain (net) of the URL, to an IP address like <code>114.36.18.243</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (Windows NT x.y; Win64; x64; rv:10.0) Gecko/20100101 Firefox/10.0</code>
...
<pre><code>
default   fe80:743c:2a6e:fe4e:7c21%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {129.191.155.8, 113.241.128.5}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr d5:40:28:7e:cf:f3
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 0f:94:54:9c:98:26
}</code></pre>
