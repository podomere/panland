...
layout: research
ip_v4_address: "222.138.213.45"
date: 2022-04-24T19:00:03+01:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like <code>222.138.213.45</code> or an IPv6 address like <code>2000:7fee:e687:486f:c670:66ab:8e:818d</code>. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>70:d7:80:1e:10:c2</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://hilpert-nienow.info you initially access a DNS server to translate the host portion (hilpert-nienow) combined with the Top Level Domain (info) of the URL, to an IP address like <code>203.224.14.66</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (compatible; MSIE 9.0; AOL 9.7; AOLBuild 4343.19; Windows NT 6.1; WOW64; Trident/5.0; FunWebProducts)</code>
...
default  172.31.220.173    UGScg  en0
...
<pre><code>
default   fe80:518b:37ee:2e86:165d%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {109.219.67.84, 177.222.187.163}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 70:d7:80:1e:10:c2
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 5c:3a:7f:f3:b5:2a
}</code></pre>
