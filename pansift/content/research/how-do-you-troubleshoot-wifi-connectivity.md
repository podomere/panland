...
layout: research
ip_v4_address: "222.245.55.204"
date: 2022-11-19T19:13:08+00:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like ```222.245.55.204``` or an IPv6 address like ```2000:e3ea:8740:528f:ba9d:1d0c:233a:4144```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```5f:ff:e7:7b:f5:d5```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://block.info you initially access a DNS server to translate the host portion (block) combined with the Top Level Domain (info) of the URL, to an IP address like ```216.245.57.127```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT x.y; Win64; x64; rv:10.0) Gecko/20100101 Firefox/10.0```
...
<pre>
default   43:e9d4:4d62:210f:e35:5110:3f0b:4d99%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {186.56.41.142, 147.162.248.147}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 5f:ff:e7:7b:f5:d5
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 8d:e1:b6:10:98:84
}</pre>
...
## Apple macOS / OSX
No matter what version of OSX/macOS you are on, ```10.13.8```, ```11.5.8```, or ```12.0.9```, there are a range of tools for troubleshooting. Unfortunately, between these manual actions and scripts, they don't give you a series of correlated values over time. This is where automated remote troubleshooting comes in to its own, especially for teams that embrace remote work and Work From Anywhere (WFA).
