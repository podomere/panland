...
layout: research
ip_v4_address: "30.79.111.215"
date: 2022-11-02T11:32:57+00:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like ```30.79.111.215``` or an IPv6 address like ```2000:7f0b:529d:52e4:59bc:227a:3941:479b```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```63:1e:a7:14:52:83```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://spencer-hamill.co you initially access a DNS server to translate the host portion (spencer-hamill) combined with the Top Level Domain (co) of the URL, to an IP address like ```182.192.33.129```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (compatible; MSIE 9.0; AOL 9.7; AOLBuild 4343.19; Windows NT 6.1; WOW64; Trident/5.0; FunWebProducts)```
...
<pre>
default   fe80:e779:fe3:9411:1458%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {26.8.163.247, 127.204.160.71}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 63:1e:a7:14:52:83
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 93:17:ed:d8:8d:3c
}</pre>
