...
layout: research
ip_v4_address: "136.125.20.248"
date: 2022-04-24T19:00:01+01:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like <code>136.125.20.248</code> or an IPv6 address like <code>2000:ca30:b65e:a765:9b1:6d27:2a77:7cc0</code>. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>8d:71:8e:17:3a:f7</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://mohr-hansen.biz you initially access a DNS server to translate the host portion (mohr-hansen) combined with the Top Level Domain (biz) of the URL, to an IP address like <code>6.170.130.228</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (Windows; U; Win 9x 4.90; SG; rv:1.9.2.4) Gecko/20101104 Netscape/9.1.0285</code>
...
<pre><code>
default   fe80:5726:7019:f23f:477e%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {63.80.117.163, 242.112.190.60}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 8d:71:8e:17:3a:f7
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 0a:9f:9a:65:ec:76
}</code></pre>
