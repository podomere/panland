...
layout: research
ip_v4_address: "178.71.165.87"
date: 2022-11-19T16:17:21+00:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like ```178.71.165.87``` or an IPv6 address like ```2000:e650:51b:25a5:81d3:4b83:7660:4084```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```fc:15:f2:fe:a1:75```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://ruecker-luettgen.net you initially access a DNS server to translate the host portion (ruecker-luettgen) combined with the Top Level Domain (net) of the URL, to an IP address like ```151.49.11.62```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows; U; Win 9x 4.90; SG; rv:1.9.2.4) Gecko/20101104 Netscape/9.1.0285```
...
<pre>
default   fe80:d3e0:60ee:f04d:84dd%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {13.100.190.209, 54.95.41.30}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr fc:15:f2:fe:a1:75
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr b6:29:91:1a:ab:48
}</pre>
