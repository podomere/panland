---
title: "How To Understand Jitter"
subtitle: "Put A Bow On It?"
layout: research
ip_v4_address: "68.119.253.118"
date: 2023-02-04T17:08:37+00:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like ```68.119.253.118``` or an IPv6 address like ```2000:7cd7:31b2:de33:3396:8c9d:de16:accb```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```a7:2c:47:a5:cd:e2```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://vandervort.io you initially access a DNS server to translate the host portion (vandervort) combined with the Top Level Domain (io) of the URL, to an IP address like ```202.94.175.132```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (compatible; MSIE 9.0; AOL 9.7; AOLBuild 4343.19; Windows NT 6.1; WOW64; Trident/5.0; FunWebProducts)```

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```10.213.10.253``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  10.213.10.253    UGScg  en0
...
<pre>
default   fe80:eec2:beed:42db:8310%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {50.32.165.197, 52.251.52.8}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr a7:2c:47:a5:cd:e2
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr c5:42:9a:99:57:84
}</pre>
