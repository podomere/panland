...
layout: research
ip_v4_address: "87.117.213.151"
date: 2022-11-19T16:17:24+00:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like ```87.117.213.151``` or an IPv6 address like ```2000:633c:3919:1081:4e09:749e:ae65:e589```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```11:5d:7f:52:ab:ff```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://beier-runolfsson.biz you initially access a DNS server to translate the host portion (beier-runolfsson) combined with the Top Level Domain (biz) of the URL, to an IP address like ```10.72.227.185```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT x.y; Win64; x64; rv:10.0) Gecko/20100101 Firefox/10.0```
...
<pre>
default   fe80:b6f2:8d37:6598:e99c%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {97.233.227.14, 21.54.94.86}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 11:5d:7f:52:ab:ff
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 6f:f0:95:cf:c7:26
}</pre>
