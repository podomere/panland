...
layout: research
ip_v4_address: "220.81.91.234"
date: 2023-10-29T15:13:26+00:00
draft: false
---

## Internet Addressing
On the Internet you may get a Public IPv4 address like ```220.81.91.234``` or an IPv6 address like ```2000:deff:19b:6ffb:59c1:ce6a:31b5:9efa```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```9b:d7:2b:8a:b2:95```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://oconner-maggio.name you initially access a DNS server to translate the host portion (oconner-maggio) combined with the Top Level Domain (name) of the URL, to an IP address like ```40.206.105.233```. Your computer and browser actually sends its type with all web requests e.g. <br>```Opera/9.80 (X11; Linux i686; Ubuntu/14.10) Presto/2.12.388 Version/12.16```
...
<pre>
default   fe80:43c1:7f5b:7d34:6c14%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {25.62.46.176, 175.48.96.252}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 9b:d7:2b:8a:b2:95
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 86:49:89:4a:12:4d
}</pre>
