...
layout: research
ip_v4_address: "3.81.13.159"
date: 2022-04-24T19:00:00+01:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like <code>3.81.13.159</code> or an IPv6 address like <code>2000:58fd:baee:dbe4:8e7f:71e0:5c57:1ed9</code>. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>bf:3b:3f:1b:c1:86</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://turner-hand.com you initially access a DNS server to translate the host portion (turner-hand) combined with the Top Level Domain (com) of the URL, to an IP address like <code>79.136.8.219</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (Windows NT 6.1; WOW64; Trident/7.0; AS; rv:11.0) like Gecko</code>
...
<pre><code>
default   fe80:2979:9241:2cb3:6084%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {7.181.132.253, 0.205.36.172}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr bf:3b:3f:1b:c1:86
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr d3:d0:96:e8:e1:b7
}</code></pre>
