...
layout: research
ip_v4_address: "39.239.186.176"
date: 2022-04-24T19:00:24+01:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like <code>39.239.186.176</code> or an IPv6 address like <code>2000:9588:95d3:ca81:b60d:c021:fe04:760</code>. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>43:9a:6e:a6:91:38</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://gulgowski.org you initially access a DNS server to translate the host portion (gulgowski) combined with the Top Level Domain (org) of the URL, to an IP address like <code>120.66.10.161</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_3) AppleWebKit/537.75.14 (KHTML, like Gecko) Version/7.0.3 Safari/7046A194A</code>

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like <code>172.17.49.160</code> (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For <code>IPv6</code> we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  172.17.49.160    UGScg  en0
...
<pre><code>
default   fe80:585c:6452:ae7a:2246%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {141.20.188.165, 40.198.228.155}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 43:9a:6e:a6:91:38
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr a6:d3:14:ce:83:7d
}</code></pre>
