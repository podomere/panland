...
layout: research
ip_v4_address: "119.143.127.82"
date: 2022-11-19T19:13:26+00:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like ```119.143.127.82``` or an IPv6 address like ```2000:8ddc:a1c1:f7cb:f37e:d096:1ed5:a785```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```66:6b:5e:a7:1a:6f```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://hagenes.io you initially access a DNS server to translate the host portion (hagenes) combined with the Top Level Domain (io) of the URL, to an IP address like ```61.204.144.195```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1; WOW64; Trident/7.0; AS; rv:11.0) like Gecko```

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```192.168.85.146``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  192.168.85.146    UGScg  en0
...
<pre>
default   fe80:caea:74f3:9a19:4e40%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {125.140.13.93, 47.94.234.246}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 66:6b:5e:a7:1a:6f
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 06:14:82:92:f4:c4
}</pre>
