...
layout: research
ip_v4_address: "152.221.15.97"
date: 2023-10-06T17:10:40+01:00
draft: false
---

## Internet Addressing
On the Internet you may get a Public IPv4 address like ```152.221.15.97``` or an IPv6 address like ```2000:b6d1:a73a:337:fdfd:2fd0:dece:9224```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```24:89:4d:b3:24:7c```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://herman.org you initially access a DNS server to translate the host portion (herman) combined with the Top Level Domain (org) of the URL, to an IP address like ```162.112.100.107```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (compatible; MSIE 9.0; AOL 9.7; AOLBuild 4343.19; Windows NT 6.1; WOW64; Trident/5.0; FunWebProducts)```
...
<pre>
default   fe80:2df5:a6c8:eda9:7439%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {239.157.168.44, 174.110.133.69}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 24:89:4d:b3:24:7c
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 18:37:9e:48:4a:b8
}</pre>
