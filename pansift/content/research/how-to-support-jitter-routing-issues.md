...
layout: research
ip_v4_address: "255.87.86.208"
date: 2022-05-05T14:29:45+01:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like ```255.87.86.208``` or an IPv6 address like ```2000:15d0:bcd3:2273:bb1c:8a24:54ed:e78a```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```a5:a9:f9:ef:b9:d1```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://lind-stokes.info you initially access a DNS server to translate the host portion (lind-stokes) combined with the Top Level Domain (info) of the URL, to an IP address like ```1.176.65.19```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1; WOW64; Trident/7.0; AS; rv:11.0) like Gecko```
...
<pre>
default   fe80:a557:bbaf:dd77:3677%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {146.81.24.122, 38.12.207.70}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr a5:a9:f9:ef:b9:d1
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 48:f9:04:18:43:67
}</pre>
