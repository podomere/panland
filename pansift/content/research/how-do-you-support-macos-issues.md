...
layout: research
ip_v4_address: "128.116.14.95"
date: 2022-12-15T13:50:10+00:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like ```128.116.14.95``` or an IPv6 address like ```2000:a80e:8b69:74f4:616a:1100:5ed5:a0f7```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```02:fb:f3:a8:55:2c```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://gerhold-dicki.info you initially access a DNS server to translate the host portion (gerhold-dicki) combined with the Top Level Domain (info) of the URL, to an IP address like ```174.82.104.124```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT x.y; Win64; x64; rv:10.0) Gecko/20100101 Firefox/10.0```
...
<pre>
default   fe80:274a:23b9:c82f:152e%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {10.39.57.99, 252.178.104.110}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 02:fb:f3:a8:55:2c
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 6f:e2:d9:c0:69:ed
}</pre>
