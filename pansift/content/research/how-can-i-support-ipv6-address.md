...
layout: research
ip_v4_address: "10.137.39.154"
date: 2023-02-04T17:08:35+00:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like ```10.137.39.154``` or an IPv6 address like ```2000:8d2d:ffa9:b762:d360:d4f7:3d28:939a```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```55:93:0b:7a:10:76```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://mertz-hessel.co you initially access a DNS server to translate the host portion (mertz-hessel) combined with the Top Level Domain (co) of the URL, to an IP address like ```128.69.93.64```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1; WOW64; Trident/7.0; AS; rv:11.0) like Gecko```
...
<pre>
default   fe80:f0b4:3b67:f98c:cff4%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {58.244.203.197, 101.43.99.62}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 55:93:0b:7a:10:76
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 88:9f:78:8d:59:1a
}</pre>
