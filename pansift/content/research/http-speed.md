...
layout: research
ip_v4_address: "52.199.140.173"
date: 2022-12-15T13:50:20+00:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like ```52.199.140.173``` or an IPv6 address like ```2000:7c63:8625:49c0:918b:28ea:b49:43fd```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```98:bb:66:bd:87:5b```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://lakin.name you initially access a DNS server to translate the host portion (lakin) combined with the Top Level Domain (name) of the URL, to an IP address like ```119.1.198.253```. Your computer and browser actually sends its type with all web requests e.g. <br>```Opera/9.80 (X11; Linux i686; Ubuntu/14.10) Presto/2.12.388 Version/12.16```
...
<pre>
default   fe80:b4bb:82e8:bd8c:6e86%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {72.108.37.20, 158.15.172.195}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 98:bb:66:bd:87:5b
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr f5:72:8e:bb:c0:0c
}</pre>
