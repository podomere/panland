...
layout: research
ip_v4_address: "16.57.163.241"
date: 2022-04-24T18:31:58+01:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like <code>16.57.163.241</code> or an IPv6 address like <code>2000:fab3:8d32:34c:964f:e728:fae7:1d68</code>. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>59:84:64:84:07:52</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://olson-brown.com you initially access a DNS server to translate the host portion (olson-brown) combined with the Top Level Domain (com) of the URL, to an IP address like <code>129.191.16.130</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (Windows NT 6.1; WOW64; Trident/7.0; AS; rv:11.0) like Gecko</code>
...
<pre><code>
default   fe80:d04f:627c:17f1:e0f5%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {119.27.190.192, 53.194.23.147}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 59:84:64:84:07:52
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 4d:0c:9f:16:34:7e
}</code></pre>
