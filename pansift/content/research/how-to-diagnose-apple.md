...
layout: research
ip_v4_address: "130.8.142.22"
date: 2022-12-15T13:50:10+00:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like ```130.8.142.22``` or an IPv6 address like ```2000:bdde:c05b:f0ac:4799:a1ce:cc08:d1f4```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```ec:93:15:76:c0:e5```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://auer-parisian.name you initially access a DNS server to translate the host portion (auer-parisian) combined with the Top Level Domain (name) of the URL, to an IP address like ```112.104.36.157```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1; WOW64; Trident/7.0; AS; rv:11.0) like Gecko```
...
<pre>
default   fe80:2c1e:ab30:7335:5646%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {45.208.241.5, 164.238.222.240}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr ec:93:15:76:c0:e5
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr b8:e5:b6:2f:8a:f9
}</pre>
