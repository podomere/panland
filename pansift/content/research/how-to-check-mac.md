...
subtitle: "Impact Map?"
layout: research
ip_v4_address: "48.131.34.134"
date: 2023-10-29T15:13:19+00:00
draft: false
---

## Internet Addressing
On the Internet you might get a Public IPv4 address like ```48.131.34.134``` or an IPv6 address like ```2000:dcde:32fe:f6be:4d8a:6cb6:3594:d2ea```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```da:50:44:68:d6:8f```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://jaskolski.org you initially access a DNS server to translate the host portion (jaskolski) combined with the Top Level Domain (org) of the URL, to an IP address like ```41.199.79.134```. Your computer and browser actually sends its type with all web requests e.g. <br>```Opera/9.80 (X11; Linux i686; Ubuntu/14.10) Presto/2.12.388 Version/12.16```

## Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```10.103.162.24``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  10.103.162.24    UGScg  en0
...
<pre>
default   fe80:c308:9cdb:2b1c:3f1d%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {255.147.180.70, 208.69.32.97}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr da:50:44:68:d6:8f
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 61:c4:b4:f4:0b:dd
}</pre>
...
### Apple macOS / OSX
No matter what version of OSX/macOS you are on, ```10.14.1```, ```11.6.6```, or ```12.0.4```, there are a range of tools for troubleshooting. Unfortunately, between these manual actions and scripts, they don't give you a series of correlated values over time. This is where automated remote troubleshooting comes in to its own, especially for teams that embrace remote work and Work From Anywhere (WFA).
