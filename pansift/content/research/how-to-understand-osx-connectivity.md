...
layout: research
ip_v4_address: "17.73.182.133"
date: 2022-11-19T16:17:12+00:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like ```17.73.182.133``` or an IPv6 address like ```2000:d3b3:62cb:7ccf:5e58:699c:5445:cf5```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```b0:3c:bc:08:fe:ea```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://koelpin-green.io you initially access a DNS server to translate the host portion (koelpin-green) combined with the Top Level Domain (io) of the URL, to an IP address like ```1.224.191.104```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows; U; Win 9x 4.90; SG; rv:1.9.2.4) Gecko/20101104 Netscape/9.1.0285```
...
<pre>
default   fe80:22e:7090:8781:a528%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {134.201.29.26, 160.212.75.75}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr b0:3c:bc:08:fe:ea
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 5a:6a:b4:16:26:a4
}</pre>
