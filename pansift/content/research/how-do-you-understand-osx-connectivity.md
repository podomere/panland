...
layout: research
ip_v4_address: "197.193.7.8"
date: 2023-10-29T15:13:19+00:00
draft: false
---

## Internet Addressing
On the Internet you may get a Public IPv4 address like ```197.193.7.8``` or an IPv6 address like ```2000:cd03:2453:778c:b5a9:94e6:43de:455e```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```2b:73:eb:13:77:54```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://bechtelar-adams.com you initially access a DNS server to translate the host portion (bechtelar-adams) combined with the Top Level Domain (com) of the URL, to an IP address like ```32.188.8.59```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows; U; Win 9x 4.90; SG; rv:1.9.2.4) Gecko/20101104 Netscape/9.1.0285```
...
<pre>
default   fe80:a071:b078:b506:13b7%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {232.224.115.206, 63.252.152.97}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 2b:73:eb:13:77:54
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr c5:81:f2:8f:d2:35
}</pre>
