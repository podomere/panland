...
subtitle: "Swag?"
layout: research
ip_v4_address: "114.237.213.221"
date: 2022-05-05T14:29:27+01:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like ```114.237.213.221``` or an IPv6 address like ```2000:988b:6b8e:9635:d56e:5d77:7962:b82f```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```a2:34:38:1a:4a:ad```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://leannon-howe.com you initially access a DNS server to translate the host portion (leannon-howe) combined with the Top Level Domain (com) of the URL, to an IP address like ```28.120.235.11```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (compatible; MSIE 9.0; AOL 9.7; AOLBuild 4343.19; Windows NT 6.1; WOW64; Trident/5.0; FunWebProducts)```

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```172.20.191.100``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  172.20.191.100    UGScg  en0
...
<pre>
default   fe80:f171:8dab:1ee:6b42%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {7.234.224.161, 21.234.190.132}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr a2:34:38:1a:4a:ad
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr ae:a4:ac:92:19:f7
}</pre>
