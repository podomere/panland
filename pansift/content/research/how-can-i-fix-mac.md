...
layout: research
ip_v4_address: "97.192.108.142"
date: 2022-11-02T11:33:12+00:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like ```97.192.108.142``` or an IPv6 address like ```2000:e3c8:1449:6ff2:2fc3:77d7:fab7:2e6a```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```a2:6e:40:d0:a2:47```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://ferry.net you initially access a DNS server to translate the host portion (ferry) combined with the Top Level Domain (net) of the URL, to an IP address like ```185.212.93.190```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows; U; Win 9x 4.90; SG; rv:1.9.2.4) Gecko/20101104 Netscape/9.1.0285```
...
<pre>
default   fe80:6e87:9a62:29fd:7c88%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {192.109.30.154, 208.181.147.4}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr a2:6e:40:d0:a2:47
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 10:73:5c:43:e6:97
}</pre>
