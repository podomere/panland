...
layout: research
ip_v4_address: "95.92.174.232"
date: 2022-12-15T13:50:16+00:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like ```95.92.174.232``` or an IPv6 address like ```2000:358a:6555:4d3e:ccf9:f470:c310:5b79```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```26:02:53:01:f6:e0```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://ward-rolfson.com you initially access a DNS server to translate the host portion (ward-rolfson) combined with the Top Level Domain (com) of the URL, to an IP address like ```253.168.66.129```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_3) AppleWebKit/537.75.14 (KHTML, like Gecko) Version/7.0.3 Safari/7046A194A```
...
<pre>
default   fe80:4aa5:505c:9115:d03c%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {255.125.64.170, 204.25.35.128}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 26:02:53:01:f6:e0
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 7d:a8:ef:34:5f:30
}</pre>
