...
layout: research
ip_v4_address: "241.199.25.135"
date: 2022-05-05T14:28:32+01:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like ```241.199.25.135``` or an IPv6 address like ```2000:4d74:b6e6:3d3d:861e:9bfe:e7bd:3cdf```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```01:79:99:8c:a5:e1```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://rodriguez.net you initially access a DNS server to translate the host portion (rodriguez) combined with the Top Level Domain (net) of the URL, to an IP address like ```157.28.52.187```. Your computer and browser actually sends its type with all web requests e.g. <br>```Opera/9.80 (X11; Linux i686; Ubuntu/14.10) Presto/2.12.388 Version/12.16```

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```172.24.120.123``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  172.24.120.123    UGScg  en0
...
<pre>
default   fe80:f859:ba41:ed36:e848%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {157.213.142.38, 163.178.225.1}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 01:79:99:8c:a5:e1
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 00:21:ea:c0:4e:ca
}</pre>
