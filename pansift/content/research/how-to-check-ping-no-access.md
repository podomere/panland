...
layout: research
ip_v4_address: "72.210.233.200"
date: 2023-10-29T15:13:28+00:00
draft: false
---

## Internet Addressing
On the Internet you might have a Public IPv4 address like ```72.210.233.200``` or an IPv6 address like ```2000:3639:de2e:3fd5:d7ec:2fc5:2f56:46d1```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```2e:dc:f1:81:09:7e```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://mcdermott-lind.io you initially access a DNS server to translate the host portion (mcdermott-lind) combined with the Top Level Domain (io) of the URL, to an IP address like ```207.204.113.194```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_3) AppleWebKit/537.75.14 (KHTML, like Gecko) Version/7.0.3 Safari/7046A194A```

## Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```192.168.203.88``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  192.168.203.88    UGScg  en0
...
<pre>
default   fe80:8a77:ea01:9008:2d82%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {153.196.151.112, 172.178.251.72}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 2e:dc:f1:81:09:7e
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 00:17:91:73:b1:65
}</pre>
