...
layout: research
ip_v4_address: "74.22.255.157"
date: 2022-11-19T16:17:06+00:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like ```74.22.255.157``` or an IPv6 address like ```2000:ee7c:5f29:ed66:da59:1fa5:5672:d070```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```6a:eb:c6:d1:56:0c```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://nader-olson.com you initially access a DNS server to translate the host portion (nader-olson) combined with the Top Level Domain (com) of the URL, to an IP address like ```155.127.227.215```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1; WOW64; Trident/7.0; AS; rv:11.0) like Gecko```
...
<pre>
default   fe80:db8e:f45e:9762:e9c8%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {2.132.199.96, 242.61.15.151}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 6a:eb:c6:d1:56:0c
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 7e:1e:02:df:db:fa
}</pre>
