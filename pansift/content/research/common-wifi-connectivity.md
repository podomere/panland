...
subtitle: "Deep Dive?"
layout: research
ip_v4_address: "232.78.58.215"
date: 2022-11-02T11:32:24+00:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like ```232.78.58.215``` or an IPv6 address like ```2000:cf1:57c2:4592:39a3:f5c3:a51d:df6f```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```6d:e4:41:ac:d4:4d```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://hilpert-towne.org you initially access a DNS server to translate the host portion (hilpert-towne) combined with the Top Level Domain (org) of the URL, to an IP address like ```11.32.106.101```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows; U; Win 9x 4.90; SG; rv:1.9.2.4) Gecko/20101104 Netscape/9.1.0285```
...
<pre>
default   fe80:49e9:ed91:1e87:b76f%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {105.253.39.19, 192.46.88.178}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 6d:e4:41:ac:d4:4d
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 5a:2f:07:f7:a4:7d
}</pre>
