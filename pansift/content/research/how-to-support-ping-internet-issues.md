...
layout: research
ip_v4_address: "63.67.126.130"
date: 2022-11-19T16:17:23+00:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like ```63.67.126.130``` or an IPv6 address like ```2000:86a3:5925:6f7b:9b5a:774b:fccd:a94```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```a5:67:28:ce:6b:e2```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://torphy-stark.info you initially access a DNS server to translate the host portion (torphy-stark) combined with the Top Level Domain (info) of the URL, to an IP address like ```134.246.216.233```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1; WOW64; Trident/7.0; AS; rv:11.0) like Gecko```
...
<pre>
default   fe80:b505:b546:2516:5e29%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {24.34.54.29, 31.163.43.198}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr a5:67:28:ce:6b:e2
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 03:f1:0f:05:a0:c0
}</pre>
