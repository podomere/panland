...
layout: research
ip_v4_address: "2.215.153.174"
date: 2022-05-05T14:29:38+01:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like ```2.215.153.174``` or an IPv6 address like ```2000:2cca:985a:bbc4:cee3:3ebc:7ff4:a266```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```f1:ee:f4:bb:e7:8a```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://bins.biz you initially access a DNS server to translate the host portion (bins) combined with the Top Level Domain (biz) of the URL, to an IP address like ```9.175.168.196```. Your computer and browser actually sends its type with all web requests e.g. <br>```Opera/9.80 (X11; Linux i686; Ubuntu/14.10) Presto/2.12.388 Version/12.16```
...
<pre>
default   fe80:50a1:cb1d:d4a5:eef2%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {246.171.175.47, 84.109.24.51}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr f1:ee:f4:bb:e7:8a
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 2d:0c:4d:48:5c:b3
}</pre>
