...
subtitle: "Streamline?"
layout: research
ip_v4_address: "81.86.145.150"
date: 2023-10-06T17:11:07+01:00
draft: false
---

## Internet Addressing
On the Internet you may have a Public IPv4 address like ```81.86.145.150``` or an IPv6 address like ```2000:4eb7:8a17:4c88:46b3:cf36:384d:4feb```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```43:2a:a4:7d:1b:58```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://kemmer-grimes.info you initially access a DNS server to translate the host portion (kemmer-grimes) combined with the Top Level Domain (info) of the URL, to an IP address like ```109.76.182.0```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows; U; Win 9x 4.90; SG; rv:1.9.2.4) Gecko/20101104 Netscape/9.1.0285```
...
<pre>
default   fe80:35d0:e716:d99e:3adf%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {155.38.239.7, 193.101.255.80}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 43:2a:a4:7d:1b:58
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 08:2c:f1:fb:b8:f2
}</pre>
