...
layout: research
ip_v4_address: "198.213.123.7"
date: 2022-11-02T11:32:24+00:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like ```198.213.123.7``` or an IPv6 address like ```2000:fe85:3b55:6066:880d:e242:9bcb:19e4```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```3a:55:5e:46:cf:62```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://keebler.name you initially access a DNS server to translate the host portion (keebler) combined with the Top Level Domain (name) of the URL, to an IP address like ```150.204.90.204```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT x.y; Win64; x64; rv:10.0) Gecko/20100101 Firefox/10.0```
...
<pre>
default   fe80:6601:758c:ed30:aa4b%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {132.70.49.50, 102.232.76.152}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 3a:55:5e:46:cf:62
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 62:eb:dc:25:c1:4b
}</pre>
