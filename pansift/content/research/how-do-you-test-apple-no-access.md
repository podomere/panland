...
layout: research
ip_v4_address: "13.71.46.178"
date: 2022-11-02T11:33:11+00:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like ```13.71.46.178``` or an IPv6 address like ```2000:4050:9886:4799:e3c0:bad2:30bf:f8fb```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```f2:64:e6:40:c5:b3```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://gorczany.info you initially access a DNS server to translate the host portion (gorczany) combined with the Top Level Domain (info) of the URL, to an IP address like ```241.252.144.10```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT x.y; Win64; x64; rv:10.0) Gecko/20100101 Firefox/10.0```

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```192.168.86.59``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  192.168.86.59    UGScg  en0
...
<pre>
default   fe80:d8c:174a:d502:adaa%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {62.140.123.115, 16.34.206.234}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr f2:64:e6:40:c5:b3
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 08:35:58:92:52:b6
}</pre>
