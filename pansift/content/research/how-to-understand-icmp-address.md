...
layout: research
ip_v4_address: "225.151.174.148"
date: 2023-10-29T15:13:28+00:00
draft: false
---

## Internet Addressing
On the Internet you may have a Public IPv4 address like ```225.151.174.148``` or an IPv6 address like ```2000:7ac7:1eb8:9aaf:cc7b:5684:9456:5492```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```ba:31:fd:0c:6a:04```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://robel.com you initially access a DNS server to translate the host portion (robel) combined with the Top Level Domain (com) of the URL, to an IP address like ```254.46.194.162```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_3) AppleWebKit/537.75.14 (KHTML, like Gecko) Version/7.0.3 Safari/7046A194A```
...
<pre>
default   fe80:f4a:41bc:6db7:919%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {33.172.205.105, 23.217.233.89}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr ba:31:fd:0c:6a:04
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr c2:12:69:b3:a4:0e
}</pre>
