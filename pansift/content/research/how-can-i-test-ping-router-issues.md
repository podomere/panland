...
layout: research
ip_v4_address: "193.151.4.47"
date: 2022-06-12T14:09:27+01:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like ```193.151.4.47``` or an IPv6 address like ```2000:36fd:ffc2:85e8:9f7:6654:f29e:aff3```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```cf:55:38:f7:18:42```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://morissette-schulist.name you initially access a DNS server to translate the host portion (morissette-schulist) combined with the Top Level Domain (name) of the URL, to an IP address like ```180.48.97.164```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_3) AppleWebKit/537.75.14 (KHTML, like Gecko) Version/7.0.3 Safari/7046A194A```
...
<pre>
default   fe80:1305:c089:eb6a:b5bb%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {63.19.125.176, 14.152.16.135}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr cf:55:38:f7:18:42
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 0d:26:c1:36:a7:13
}</pre>
