...
subtitle: "Synergy?"
layout: research
ip_v4_address: "232.50.75.203"
date: 2022-04-24T18:32:41+01:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like <code>232.50.75.203</code> or an IPv6 address like <code>2000:dbc5:dc6e:5714:5875:7277:a8fb:2546</code>. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>2d:f7:a3:d1:93:aa</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://dickinson-von.name you initially access a DNS server to translate the host portion (dickinson-von) combined with the Top Level Domain (name) of the URL, to an IP address like <code>47.207.156.36</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (compatible; MSIE 9.0; AOL 9.7; AOLBuild 4343.19; Windows NT 6.1; WOW64; Trident/5.0; FunWebProducts)</code>
...
<pre><code>
default   fe80:bde9:d28a:5069:a9%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {38.3.51.159, 118.232.108.35}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 2d:f7:a3:d1:93:aa
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr c3:6e:2e:0d:a6:1d
}</code></pre>
