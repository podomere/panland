...
layout: research
ip_v4_address: "158.228.70.0"
date: 2022-11-19T19:13:27+00:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like ```158.228.70.0``` or an IPv6 address like ```2000:7c5:6739:b65e:b757:3e9c:2bd9:d2ae```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```3f:7b:30:7a:f1:15```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://deckow-wuckert.name you initially access a DNS server to translate the host portion (deckow-wuckert) combined with the Top Level Domain (name) of the URL, to an IP address like ```2.71.82.78```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows; U; Win 9x 4.90; SG; rv:1.9.2.4) Gecko/20101104 Netscape/9.1.0285```
...
<pre>
default   fe80:65ae:c822:9ab6:c0c9%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {186.155.63.90, 116.204.234.101}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 3f:7b:30:7a:f1:15
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 21:b4:e4:8e:ba:6d
}</pre>
