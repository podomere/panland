...
subtitle: "Deep Dive?"
layout: research
ip_v4_address: "15.234.173.12"
date: 2022-05-05T14:30:16+01:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like ```15.234.173.12``` or an IPv6 address like ```2000:ad6d:af54:7553:6d47:908b:388b:d41d```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```b7:6f:78:74:5d:c0```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://abbott-anderson.co you initially access a DNS server to translate the host portion (abbott-anderson) combined with the Top Level Domain (co) of the URL, to an IP address like ```117.147.51.121```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT x.y; Win64; x64; rv:10.0) Gecko/20100101 Firefox/10.0```

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```10.237.13.22``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  10.237.13.22    UGScg  en0
...
<pre>
default   fe80:e0e8:1fd9:3d8f:fcd9%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {134.229.233.185, 128.173.255.60}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr b7:6f:78:74:5d:c0
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr ee:62:f4:1b:9d:d3
}</pre>
