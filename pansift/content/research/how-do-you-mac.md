...
layout: research
ip_v4_address: "98.140.215.88"
date: 2022-05-05T14:28:58+01:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like ```98.140.215.88``` or an IPv6 address like ```2000:4bf6:d113:17c:4a98:f103:8429:f35e```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```18:29:eb:1a:09:95```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://conn-predovic.co you initially access a DNS server to translate the host portion (conn-predovic) combined with the Top Level Domain (co) of the URL, to an IP address like ```179.51.224.91```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows; U; Win 9x 4.90; SG; rv:1.9.2.4) Gecko/20101104 Netscape/9.1.0285```
...
<pre>
default   fe80:9264:5472:311e:545%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {200.192.165.209, 82.244.210.181}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 18:29:eb:1a:09:95
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 91:1e:91:3d:cb:2b
}</pre>
