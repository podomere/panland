...
subtitle: "Ideate?"
layout: research
ip_v4_address: "54.102.93.44"
date: 2023-02-04T16:26:22+00:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like ```54.102.93.44``` or an IPv6 address like ```2000:ce20:1f9b:fd9b:3ecb:c956:fbd0:d30c```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```73:e9:d7:4d:1e:71```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://hane-marks.org you initially access a DNS server to translate the host portion (hane-marks) combined with the Top Level Domain (org) of the URL, to an IP address like ```42.77.249.131```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT x.y; Win64; x64; rv:10.0) Gecko/20100101 Firefox/10.0```
...
default  172.30.237.195    UGScg  en0
...
<pre>
default   fe80:21ef:17cd:df71:6e50%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {250.71.88.55, 186.171.80.195}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 73:e9:d7:4d:1e:71
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 22:90:74:5a:5a:e5
}</pre>
...
## Apple macOS / OSX
No matter what version of OSX/macOS you are on, ```10.11.4```, ```11.4.8```, or ```12.1.5```, there are a range of tools for troubleshooting. Unfortunately, between these manual actions and scripts, they don't give you a series of correlated values over time. This is where automated remote troubleshooting comes in to its own, especially for teams that embrace remote work and Work From Anywhere (WFA).
