...
subtitle: "Impact Map?"
layout: research
ip_v4_address: "52.130.169.244"
date: 2022-11-19T16:17:06+00:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like ```52.130.169.244``` or an IPv6 address like ```2000:559e:1e3d:d517:deba:2d36:6e68:a9d9```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```3e:83:7c:af:3f:47```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://luettgen.com you initially access a DNS server to translate the host portion (luettgen) combined with the Top Level Domain (com) of the URL, to an IP address like ```194.181.4.142```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT x.y; Win64; x64; rv:10.0) Gecko/20100101 Firefox/10.0```
...
<pre>
default   fe80:d71f:30c8:c3fc:88e%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {36.145.99.39, 44.188.43.132}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 3e:83:7c:af:3f:47
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr e8:ea:a5:c0:4f:5b
}</pre>
