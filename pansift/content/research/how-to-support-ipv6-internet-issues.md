...
layout: research
ip_v4_address: "102.198.248.254"
date: 2022-11-02T11:32:52+00:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like ```102.198.248.254``` or an IPv6 address like ```2000:c91e:5cb8:84a4:bc0:f7b0:b58b:7e2f```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```86:e5:55:ad:3a:5f```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://denesik.net you initially access a DNS server to translate the host portion (denesik) combined with the Top Level Domain (net) of the URL, to an IP address like ```152.194.168.198```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_3) AppleWebKit/537.75.14 (KHTML, like Gecko) Version/7.0.3 Safari/7046A194A```

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```10.195.222.214``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  10.195.222.214    UGScg  en0
...
<pre>
default   fe80:398b:b638:b632:cb78%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {125.132.119.175, 174.69.17.137}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 86:e5:55:ad:3a:5f
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 6b:34:ea:d0:14:46
}</pre>
