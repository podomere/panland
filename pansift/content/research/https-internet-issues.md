...
layout: research
ip_v4_address: "123.64.122.31"
date: 2023-10-29T15:13:30+00:00
draft: false
---

## Internet Addressing
On the Internet you might have a Public IPv4 address like ```123.64.122.31``` or an IPv6 address like ```2000:439b:f380:4082:a982:b1cd:4da6:b42```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```a1:37:ca:36:71:76```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://metz.co you initially access a DNS server to translate the host portion (metz) combined with the Top Level Domain (co) of the URL, to an IP address like ```244.70.42.159```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT x.y; Win64; x64; rv:10.0) Gecko/20100101 Firefox/10.0```

## Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```172.20.204.18``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  172.20.204.18    UGScg  en0
...
<pre>
default   fe80:ef75:e3d3:3651:b157%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {140.82.186.214, 65.69.42.224}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr a1:37:ca:36:71:76
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr c8:c7:e8:fc:09:de
}</pre>
