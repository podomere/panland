...
layout: research
ip_v4_address: "181.221.46.173"
date: 2022-11-19T19:13:24+00:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like ```181.221.46.173``` or an IPv6 address like ```2000:969c:37e5:9943:a7cd:5121:a71f:3acf```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```e4:97:4b:da:d7:11```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://effertz.org you initially access a DNS server to translate the host portion (effertz) combined with the Top Level Domain (org) of the URL, to an IP address like ```242.174.208.3```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1; WOW64; Trident/7.0; AS; rv:11.0) like Gecko```
...
<pre>
default   fe80:d28d:50e4:f496:b3fa%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {102.121.193.25, 50.242.75.62}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr e4:97:4b:da:d7:11
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 7d:e4:fb:e4:b1:cc
}</pre>
