...
layout: research
ip_v4_address: "90.75.121.138"
date: 2022-06-04T14:38:39+01:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like ```90.75.121.138``` or an IPv6 address like ```ce:4682:7394:b733:40f7:f55f:dc20:3350```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```d9:c1:c3:23:05:d2```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://rohan-heaney.org you initially access a DNS server to translate the host portion (rohan-heaney) combined with the Top Level Domain (org) of the URL, to an IP address like ```79.199.166.129```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT x.y; Win64; x64; rv:10.0) Gecko/20100101 Firefox/10.0```
...
<pre>
default   fe80:cb9c:57a3:a2ac:4f5d%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {227.243.246.229, 67.71.202.4}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr d9:c1:c3:23:05:d2
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 09:2e:c1:7b:5b:7d
}</pre>
