...
layout: research
ip_v4_address: "190.161.136.207"
date: 2022-04-24T18:59:58+01:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like <code>190.161.136.207</code> or an IPv6 address like <code>2000:8970:a495:1e3:f76:89c1:e6d3:ef4</code>. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>47:75:0a:21:64:50</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://greenholt-conroy.io you initially access a DNS server to translate the host portion (greenholt-conroy) combined with the Top Level Domain (io) of the URL, to an IP address like <code>155.165.159.145</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (Windows NT 6.1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/41.0.2228.0 Safari/537.36</code>
...
<pre><code>
default   fe80:406a:f8d:2d53:7e54%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {74.40.5.248, 228.128.246.239}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 47:75:0a:21:64:50
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr b8:80:f3:41:b1:a1
}</code></pre>
