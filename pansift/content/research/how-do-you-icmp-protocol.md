...
layout: research
ip_v4_address: "108.199.233.238"
date: 2022-12-15T13:50:19+00:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like ```108.199.233.238``` or an IPv6 address like ```2000:34f8:7ea4:f581:293d:3fb6:512:23bb```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```65:cb:71:eb:66:25```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://bogisich.io you initially access a DNS server to translate the host portion (bogisich) combined with the Top Level Domain (io) of the URL, to an IP address like ```250.210.16.105```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1; WOW64; Trident/7.0; AS; rv:11.0) like Gecko```
...
<pre>
default   fe80:7c83:da8a:7d09:cda7%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {203.152.128.139, 148.28.199.212}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 65:cb:71:eb:66:25
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 60:c0:13:88:65:6f
}</pre>
