...
layout: research
ip_v4_address: "236.189.253.94"
date: 2023-02-04T17:08:39+00:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like ```236.189.253.94``` or an IPv6 address like ```2000:52b9:41b3:6bc5:4de4:7603:7ac7:b493```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```1f:fa:19:39:6d:5c```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://marks-schuppe.biz you initially access a DNS server to translate the host portion (marks-schuppe) combined with the Top Level Domain (biz) of the URL, to an IP address like ```45.72.82.6```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_3) AppleWebKit/537.75.14 (KHTML, like Gecko) Version/7.0.3 Safari/7046A194A```
...
<pre>
default   fe80:529d:4eb9:a1a3:8d5%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {121.131.130.73, 173.56.94.16}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 1f:fa:19:39:6d:5c
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 10:e1:13:c4:97:97
}</pre>
