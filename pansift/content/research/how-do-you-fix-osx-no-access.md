...
layout: research
ip_v4_address: "134.208.158.150"
date: 2022-11-19T19:13:16+00:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like ```134.208.158.150``` or an IPv6 address like ```2000:809f:3964:aaba:1b5e:477d:9c2:9c17```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```9e:1e:a7:07:96:4d```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://rosenbaum-bruen.io you initially access a DNS server to translate the host portion (rosenbaum-bruen) combined with the Top Level Domain (io) of the URL, to an IP address like ```233.188.131.114```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT x.y; Win64; x64; rv:10.0) Gecko/20100101 Firefox/10.0```

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```10.11.223.171``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  10.11.223.171    UGScg  en0
...
<pre>
default   fe80:b365:7704:505e:d6d5%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {115.158.151.11, 137.48.123.133}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 9e:1e:a7:07:96:4d
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 5c:90:00:91:c1:7c
}</pre>
...
## Apple macOS / OSX
No matter what version of OSX/macOS you are on, ```10.12.5```, ```11.1.2```, or ```12.0.2```, there are a range of tools for troubleshooting. Unfortunately, between these manual actions and scripts, they don't give you a series of correlated values over time. This is where automated remote troubleshooting comes in to its own, especially for teams that embrace remote work and Work From Anywhere (WFA).
