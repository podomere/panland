---
title: "How Do You Check IPv4 No-access"
subtitle: "Get Value Out Of The Conversation?"
layout: research
ip_v4_address: "124.250.3.90"
date: 2022-11-19T19:13:24+00:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like ```124.250.3.90``` or an IPv6 address like ```2000:b513:403d:540e:9cb2:6b42:343b:23b8```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```26:c1:f1:1b:4c:d2```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://kutch-ratke.io you initially access a DNS server to translate the host portion (kutch-ratke) combined with the Top Level Domain (io) of the URL, to an IP address like ```6.150.132.196```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (compatible; MSIE 9.0; AOL 9.7; AOLBuild 4343.19; Windows NT 6.1; WOW64; Trident/5.0; FunWebProducts)```

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```192.168.117.159``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  192.168.117.159    UGScg  en0
...
<pre>
default   fe80:30fc:c651:96b:25e7%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {212.212.48.31, 149.254.175.159}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 26:c1:f1:1b:4c:d2
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 1f:30:68:5c:67:ac
}</pre>
