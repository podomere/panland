...
layout: research
ip_v4_address: "157.26.248.179"
date: 2023-02-04T17:07:50+00:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like ```157.26.248.179``` or an IPv6 address like ```2000:d1e0:621f:6611:240f:b129:ace2:2904```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```33:8c:d7:54:e9:c9```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://franecki-johnston.co you initially access a DNS server to translate the host portion (franecki-johnston) combined with the Top Level Domain (co) of the URL, to an IP address like ```195.180.213.62```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/41.0.2228.0 Safari/537.36```
...
<pre>
default   fe80:5721:1864:6b2b:69af%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {234.140.11.166, 26.81.251.7}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 33:8c:d7:54:e9:c9
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr ba:d7:3c:b1:21:a6
}</pre>
