...
layout: research
ip_v4_address: "169.60.184.126"
date: 2023-10-06T17:11:08+01:00
draft: false
---

## Internet Addressing
On the Internet you might have a Public IPv4 address like ```169.60.184.126``` or an IPv6 address like ```2000:6286:23f4:c9a1:7d8e:21eb:8c6c:b407```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```b8:ff:d6:59:ba:7b```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://goyette.io you initially access a DNS server to translate the host portion (goyette) combined with the Top Level Domain (io) of the URL, to an IP address like ```108.184.199.40```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT x.y; Win64; x64; rv:10.0) Gecko/20100101 Firefox/10.0```
...
<pre>
default   fe80:c6cb:b2d8:46f1:4bd5%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {190.64.241.11, 219.84.199.133}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr b8:ff:d6:59:ba:7b
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 88:ab:4d:7d:0c:71
}</pre>
