...
subtitle: "Ideate?"
layout: research
ip_v4_address: "165.161.32.168"
date: 2022-11-19T19:13:24+00:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like ```165.161.32.168``` or an IPv6 address like ```2000:6535:992:ee8:665b:2716:d522:ce30```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```b5:e2:4d:64:86:aa```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://leffler.info you initially access a DNS server to translate the host portion (leffler) combined with the Top Level Domain (info) of the URL, to an IP address like ```252.239.52.204```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1; WOW64; Trident/7.0; AS; rv:11.0) like Gecko```
...
<pre>
default   fe80:9ddd:87a8:8c87:5db6%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {94.172.206.79, 208.73.124.129}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr b5:e2:4d:64:86:aa
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 95:84:a7:84:ef:a4
}</pre>
...
## Apple macOS / OSX
No matter what version of OSX/macOS you are on, ```10.11.8```, ```11.4.7```, or ```12.2.4```, there are a range of tools for troubleshooting. Unfortunately, between these manual actions and scripts, they don't give you a series of correlated values over time. This is where automated remote troubleshooting comes in to its own, especially for teams that embrace remote work and Work From Anywhere (WFA).
