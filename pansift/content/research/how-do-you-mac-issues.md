...
subtitle: "Tee It Up?"
layout: research
ip_v4_address: "107.94.56.123"
date: 2023-02-04T17:07:50+00:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like ```107.94.56.123``` or an IPv6 address like ```2000:2ea8:c949:da60:feb6:c5b2:f84d:bed4```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```7c:29:bb:bc:70:67```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://rice-hand.com you initially access a DNS server to translate the host portion (rice-hand) combined with the Top Level Domain (com) of the URL, to an IP address like ```31.22.229.209```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1; WOW64; Trident/7.0; AS; rv:11.0) like Gecko```

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```172.22.25.35``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  172.22.25.35    UGScg  en0
...
<pre>
default   fe80:fd0a:22b:1ec2:8e1a%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {229.83.157.167, 57.200.198.127}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 7c:29:bb:bc:70:67
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 6d:20:09:f7:cc:fc
}</pre>
