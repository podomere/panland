---
title: "How Do You Jitter Connectivity"
subtitle: "Learnings?"
layout: research
ip_v4_address: "128.82.94.142"
date: 2022-04-24T19:00:00+01:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like <code>128.82.94.142</code> or an IPv6 address like <code>2000:c8e0:eba2:1427:f624:9930:43d4:7a95</code>. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>e9:3b:f7:82:cc:60</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://kub-gottlieb.info you initially access a DNS server to translate the host portion (kub-gottlieb) combined with the Top Level Domain (info) of the URL, to an IP address like <code>87.52.219.106</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (Windows NT x.y; Win64; x64; rv:10.0) Gecko/20100101 Firefox/10.0</code>

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like <code>10.84.221.70</code> (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For <code>IPv6</code> we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  10.84.221.70    UGScg  en0
...
<pre><code>
default   fe80:df7b:37bc:f1c4:b483%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {178.193.205.124, 3.145.211.167}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr e9:3b:f7:82:cc:60
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 1d:e1:59:ee:d6:35
}</code></pre>
