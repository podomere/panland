...
layout: research
ip_v4_address: "206.236.198.43"
date: 2022-11-02T11:33:01+00:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like ```206.236.198.43``` or an IPv6 address like ```2000:c48c:6a8a:f225:9335:3d13:3882:b6c3```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```ed:eb:28:aa:b3:cc```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://tromp-nicolas.com you initially access a DNS server to translate the host portion (tromp-nicolas) combined with the Top Level Domain (com) of the URL, to an IP address like ```84.5.227.234```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT x.y; Win64; x64; rv:10.0) Gecko/20100101 Firefox/10.0```
...
<pre>
default   fe80:bbb7:6b1c:4a1b:e983%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {53.246.220.87, 92.100.178.117}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr ed:eb:28:aa:b3:cc
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 4e:76:3e:35:c6:1c
}</pre>
