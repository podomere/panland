...
layout: research
ip_v4_address: "29.102.44.246"
date: 2022-04-24T18:31:57+01:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like <code>29.102.44.246</code> or an IPv6 address like <code>2000:30af:9fdf:4557:609f:8429:d07e:7be4</code>. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>7a:c4:99:9c:99:2d</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://gutmann-greenholt.com you initially access a DNS server to translate the host portion (gutmann-greenholt) combined with the Top Level Domain (com) of the URL, to an IP address like <code>91.13.131.26</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_3) AppleWebKit/537.75.14 (KHTML, like Gecko) Version/7.0.3 Safari/7046A194A</code>
...
<pre><code>
default   fe80:ccd6:da9e:2c36:372d%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {4.73.143.77, 114.80.206.32}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 7a:c4:99:9c:99:2d
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr ee:d6:12:7e:29:37
}</code></pre>
