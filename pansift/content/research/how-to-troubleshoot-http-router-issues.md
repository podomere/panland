...
layout: research
ip_v4_address: "200.6.216.244"
date: 2022-05-05T14:30:04+01:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like ```200.6.216.244``` or an IPv6 address like ```2000:36dd:9377:d79f:3714:4cdd:ab18:a7b```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```8f:34:9b:09:cb:11```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://lang.io you initially access a DNS server to translate the host portion (lang) combined with the Top Level Domain (io) of the URL, to an IP address like ```254.128.230.69```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (compatible; MSIE 9.0; AOL 9.7; AOLBuild 4343.19; Windows NT 6.1; WOW64; Trident/5.0; FunWebProducts)```
...
<pre>
default   fe80:4931:b676:c28:2c0f%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {149.206.234.124, 134.4.210.17}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 8f:34:9b:09:cb:11
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 40:0f:2a:f8:c4:f1
}</pre>
...
## Apple macOS / OSX
No matter what version of OSX/macOS you are on, ```10.13.1```, ```11.5.6```, or ```12.0.9```, there are a range of tools for troubleshooting. Unfortunately, between these manual actions and scripts, they don't give you a series of correlated values over time. This is where automated remote troubleshooting comes in to its own, especially for teams that embrace remote work and Work From Anywhere (WFA).
