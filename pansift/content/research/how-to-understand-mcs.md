...
subtitle: "Heads Down?"
layout: research
ip_v4_address: "122.120.99.239"
date: 2022-11-02T11:32:24+00:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like ```122.120.99.239``` or an IPv6 address like ```2000:c450:3970:47ff:8eed:68e2:4311:1ad9```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```da:37:0c:01:bc:1f```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://abshire-ankunding.name you initially access a DNS server to translate the host portion (abshire-ankunding) combined with the Top Level Domain (name) of the URL, to an IP address like ```59.32.115.80```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_3) AppleWebKit/537.75.14 (KHTML, like Gecko) Version/7.0.3 Safari/7046A194A```
...
<pre>
default   fe80:8ada:bfa9:9ee:495a%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {89.219.171.233, 67.151.240.123}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr da:37:0c:01:bc:1f
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr c2:79:f4:d1:ea:af
}</pre>
