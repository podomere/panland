...
layout: research
ip_v4_address: "64.104.151.10"
date: 2022-11-19T16:17:20+00:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like ```64.104.151.10``` or an IPv6 address like ```2000:5bf8:d829:9623:de12:940b:f8e3:cd25```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```06:ef:05:49:62:fe```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://kutch-cassin.info you initially access a DNS server to translate the host portion (kutch-cassin) combined with the Top Level Domain (info) of the URL, to an IP address like ```141.161.157.26```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_3) AppleWebKit/537.75.14 (KHTML, like Gecko) Version/7.0.3 Safari/7046A194A```
...
<pre>
default   fe80:718e:a347:5889:97e7%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {169.64.136.60, 249.225.24.152}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 06:ef:05:49:62:fe
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 5c:3a:06:af:dc:ea
}</pre>
