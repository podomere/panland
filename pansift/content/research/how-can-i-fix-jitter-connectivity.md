...
layout: research
ip_v4_address: "213.133.202.224"
date: 2022-05-05T14:29:46+01:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like ```213.133.202.224``` or an IPv6 address like ```2000:60f8:b81c:daaa:4f7:7d94:63be:7e69```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```3b:0e:ba:71:b3:b6```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://bergnaum-bailey.net you initially access a DNS server to translate the host portion (bergnaum-bailey) combined with the Top Level Domain (net) of the URL, to an IP address like ```55.212.189.206```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_3) AppleWebKit/537.75.14 (KHTML, like Gecko) Version/7.0.3 Safari/7046A194A```
...
<pre>
default   fe80:ecad:8901:da84:cae8%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {24.65.174.34, 64.55.26.86}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 3b:0e:ba:71:b3:b6
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr ae:41:0a:e1:2a:d7
}</pre>
