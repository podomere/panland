...
subtitle: "Granular?"
layout: research
ip_v4_address: "6.67.229.126"
date: 2023-10-29T15:13:12+00:00
draft: false
---

## Internet Addressing
On the Internet you might have a Public IPv4 address like ```6.67.229.126``` or an IPv6 address like ```2000:8a4c:4529:12b1:3ae0:72a3:1cec:f3b```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```ef:6b:aa:65:e7:2a```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://bode.biz you initially access a DNS server to translate the host portion (bode) combined with the Top Level Domain (biz) of the URL, to an IP address like ```45.44.61.53```. Your computer and browser actually sends its type with all web requests e.g. <br>```Opera/9.80 (X11; Linux i686; Ubuntu/14.10) Presto/2.12.388 Version/12.16```
...
<pre>
default   fe80:ac1c:5765:af85:e080%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {96.65.130.27, 185.197.22.105}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr ef:6b:aa:65:e7:2a
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr fc:2e:45:80:6a:f7
}</pre>
