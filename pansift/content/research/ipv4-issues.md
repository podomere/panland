...
layout: research
ip_v4_address: "39.87.165.9"
date: 2023-10-29T15:13:25+00:00
draft: false
---

## Internet Addressing
On the Internet you may get a Public IPv4 address like ```39.87.165.9``` or an IPv6 address like ```2000:e81b:f8d0:1e5b:91e2:6850:48fb:8ee```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```3b:c6:e5:e5:51:8f```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://bernhard-flatley.biz you initially access a DNS server to translate the host portion (bernhard-flatley) combined with the Top Level Domain (biz) of the URL, to an IP address like ```197.245.193.230```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows; U; Win 9x 4.90; SG; rv:1.9.2.4) Gecko/20101104 Netscape/9.1.0285```
...
<pre>
default   fe80:73fc:e805:fd2d:344%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {30.46.194.170, 5.217.229.166}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 3b:c6:e5:e5:51:8f
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr f7:69:3a:a2:4e:05
}</pre>
