...
subtitle: "Swim Lane?"
layout: research
ip_v4_address: "20.48.193.131"
date: 2022-11-02T11:32:58+00:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like ```20.48.193.131``` or an IPv6 address like ```2000:5c1d:f2bd:7353:4254:6ca4:8046:e8b5```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```61:b5:7c:8d:63:e0```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://mcdermott-grant.name you initially access a DNS server to translate the host portion (mcdermott-grant) combined with the Top Level Domain (name) of the URL, to an IP address like ```116.238.91.156```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_3) AppleWebKit/537.75.14 (KHTML, like Gecko) Version/7.0.3 Safari/7046A194A```
...
<pre>
default   fe80:3e56:a64a:a28e:22fd%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {50.250.152.87, 135.222.40.118}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 61:b5:7c:8d:63:e0
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr ae:4f:c2:f1:53:f3
}</pre>
