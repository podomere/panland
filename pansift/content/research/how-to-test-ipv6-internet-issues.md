...
layout: research
ip_v4_address: "142.236.131.234"
date: 2022-05-05T14:29:25+01:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like ```142.236.131.234``` or an IPv6 address like ```2000:634f:8cd8:d1ce:882c:406f:631b:4234```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```c7:7c:f6:98:2d:8a```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://schmidt-marks.com you initially access a DNS server to translate the host portion (schmidt-marks) combined with the Top Level Domain (com) of the URL, to an IP address like ```191.56.163.91```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_3) AppleWebKit/537.75.14 (KHTML, like Gecko) Version/7.0.3 Safari/7046A194A```
...
<pre>
default   fe80:8797:c559:ce45:7839%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {88.225.70.242, 27.255.56.74}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr c7:7c:f6:98:2d:8a
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 53:c5:1b:bf:ac:d9
}</pre>
