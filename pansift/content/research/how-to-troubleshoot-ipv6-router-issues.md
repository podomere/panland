...
layout: research
ip_v4_address: "250.157.85.158"
date: 2023-10-06T17:11:03+01:00
draft: false
---

## Internet Addressing
On the Internet you may have a Public IPv4 address like ```250.157.85.158``` or an IPv6 address like ```2000:c32c:83fc:b661:5f38:b03e:3a39:7237```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```1e:af:f4:f1:9a:08```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://kuhn-nitzsche.name you initially access a DNS server to translate the host portion (kuhn-nitzsche) combined with the Top Level Domain (name) of the URL, to an IP address like ```83.99.69.138```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (compatible; MSIE 9.0; AOL 9.7; AOLBuild 4343.19; Windows NT 6.1; WOW64; Trident/5.0; FunWebProducts)```
...
<pre>
default   fe80:2cbd:a9dc:cfc0:e606%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {214.6.212.14, 81.107.206.225}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 1e:af:f4:f1:9a:08
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 2c:75:27:65:9e:82
}</pre>
