...
layout: research
ip_v4_address: "183.163.5.91"
date: 2022-11-19T16:17:20+00:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like ```183.163.5.91``` or an IPv6 address like ```2000:b30a:361e:6d91:1f47:b513:ec16:9cf8```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```a9:bc:9a:cc:23:02```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://kohler-howe.com you initially access a DNS server to translate the host portion (kohler-howe) combined with the Top Level Domain (com) of the URL, to an IP address like ```231.218.193.224```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows; U; Win 9x 4.90; SG; rv:1.9.2.4) Gecko/20101104 Netscape/9.1.0285```
...
<pre>
default   fe80:7feb:17d5:4b17:130f%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {13.17.39.62, 104.35.64.191}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr a9:bc:9a:cc:23:02
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 86:2c:a6:2d:6d:e8
}</pre>
...
## Apple macOS / OSX
No matter what version of OSX/macOS you are on, ```10.11.5```, ```11.1.2```, or ```12.1.2```, there are a range of tools for troubleshooting. Unfortunately, between these manual actions and scripts, they don't give you a series of correlated values over time. This is where automated remote troubleshooting comes in to its own, especially for teams that embrace remote work and Work From Anywhere (WFA).
