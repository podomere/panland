...
layout: research
ip_v4_address: "116.186.233.220"
date: 2022-12-15T13:50:18+00:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like ```116.186.233.220``` or an IPv6 address like ```2000:1f6a:f7bd:c1b0:e5d7:21e:78da:bd98```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```76:8a:19:94:01:f3```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://bode-rowe.info you initially access a DNS server to translate the host portion (bode-rowe) combined with the Top Level Domain (info) of the URL, to an IP address like ```5.93.10.55```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT x.y; Win64; x64; rv:10.0) Gecko/20100101 Firefox/10.0```
...
<pre>
default   fe80:f18d:4ac4:ebc4:5828%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {253.3.194.204, 106.191.141.100}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 76:8a:19:94:01:f3
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 7d:7c:a7:2a:e1:7e
}</pre>
