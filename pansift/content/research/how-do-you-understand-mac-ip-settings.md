...
layout: research
ip_v4_address: "46.212.200.253"
date: 2022-04-24T18:31:59+01:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like <code>46.212.200.253</code> or an IPv6 address like <code>2000:d132:3f79:f06b:4736:b9ed:a2bc:8982</code>. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>14:fd:4f:be:f6:67</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://durgan.co you initially access a DNS server to translate the host portion (durgan) combined with the Top Level Domain (co) of the URL, to an IP address like <code>18.4.121.27</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (Windows NT 6.1; WOW64; Trident/7.0; AS; rv:11.0) like Gecko</code>
...
<pre><code>
default   fe80:ec63:d846:db38:d026%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {197.58.210.183, 173.57.97.23}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 14:fd:4f:be:f6:67
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 25:5a:a6:c3:f7:9d
}</code></pre>
