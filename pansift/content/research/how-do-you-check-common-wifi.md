...
layout: research
ip_v4_address: "234.250.189.131"
date: 2022-04-24T18:32:42+01:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like <code>234.250.189.131</code> or an IPv6 address like <code>2000:190d:f05e:7235:9ac:4800:ba88:cc45</code>. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>84:90:cc:8b:83:7e</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://mitchell-hamill.name you initially access a DNS server to translate the host portion (mitchell-hamill) combined with the Top Level Domain (name) of the URL, to an IP address like <code>147.124.204.88</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (Windows NT x.y; Win64; x64; rv:10.0) Gecko/20100101 Firefox/10.0</code>

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like <code>192.168.19.214</code> (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For <code>IPv6</code> we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  192.168.19.214    UGScg  en0
...
<pre><code>
default   fe80:8e9e:7637:b515:592e%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {56.196.185.61, 28.104.72.76}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 84:90:cc:8b:83:7e
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr a3:6d:80:0f:39:9e
}</code></pre>
