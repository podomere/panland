...
layout: research
ip_v4_address: "201.60.27.163"
date: 2022-12-15T13:50:19+00:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like ```201.60.27.163``` or an IPv6 address like ```2000:f26e:563:28e3:bb35:b480:12df:37c```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```a1:9b:b1:76:6a:9a```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://jones.net you initially access a DNS server to translate the host portion (jones) combined with the Top Level Domain (net) of the URL, to an IP address like ```150.182.180.80```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT x.y; Win64; x64; rv:10.0) Gecko/20100101 Firefox/10.0```

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```10.119.200.36``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  10.119.200.36    UGScg  en0
...
<pre>
default   1c:57e1:a9f:6159:7184:6b8d:f692:1954%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {101.206.47.52, 126.150.214.54}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr a1:9b:b1:76:6a:9a
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 2d:db:e6:70:30:bb
}</pre>
...
## Apple macOS / OSX
No matter what version of OSX/macOS you are on, ```10.14.7```, ```11.6.8```, or ```12.1.3```, there are a range of tools for troubleshooting. Unfortunately, between these manual actions and scripts, they don't give you a series of correlated values over time. This is where automated remote troubleshooting comes in to its own, especially for teams that embrace remote work and Work From Anywhere (WFA).
