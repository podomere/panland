...
layout: research
ip_v4_address: "235.28.167.59"
date: 2023-02-04T17:07:48+00:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like ```235.28.167.59``` or an IPv6 address like ```2000:32e8:ce8c:a201:e71b:9740:3cff:3034```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```45:a0:e8:36:53:80```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://lakin-fadel.name you initially access a DNS server to translate the host portion (lakin-fadel) combined with the Top Level Domain (name) of the URL, to an IP address like ```35.113.84.5```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows; U; Win 9x 4.90; SG; rv:1.9.2.4) Gecko/20101104 Netscape/9.1.0285```
...
<pre>
default   fe80:7b18:6a4e:983a:fa45%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {248.74.86.14, 61.223.179.153}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 45:a0:e8:36:53:80
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 9a:2f:08:16:03:94
}</pre>
