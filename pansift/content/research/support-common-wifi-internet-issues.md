...
layout: research
ip_v4_address: "57.78.133.44"
date: 2022-12-15T13:50:03+00:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like ```57.78.133.44``` or an IPv6 address like ```2000:57f2:6378:ea39:53c6:9b56:a53c:ef11```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```98:ee:70:67:f2:32```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://douglas-wolff.info you initially access a DNS server to translate the host portion (douglas-wolff) combined with the Top Level Domain (info) of the URL, to an IP address like ```235.31.27.95```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1; WOW64; Trident/7.0; AS; rv:11.0) like Gecko```
...
<pre>
default   fe80:540e:ba6c:92fc:35d%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {137.46.176.235, 26.8.221.21}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 98:ee:70:67:f2:32
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 2a:c6:60:52:a4:36
}</pre>
