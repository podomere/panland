...
layout: research
ip_v4_address: "171.37.242.91"
date: 2023-02-04T17:07:49+00:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like ```171.37.242.91``` or an IPv6 address like ```2000:eda4:c7db:46ca:2062:891b:1236:62bb```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```98:c9:17:31:0d:2a```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://kuhic-price.biz you initially access a DNS server to translate the host portion (kuhic-price) combined with the Top Level Domain (biz) of the URL, to an IP address like ```16.185.80.134```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (compatible; MSIE 9.0; AOL 9.7; AOLBuild 4343.19; Windows NT 6.1; WOW64; Trident/5.0; FunWebProducts)```
...
<pre>
default   fe80:36e4:c074:697d:3a05%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {177.213.151.151, 151.157.80.164}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 98:c9:17:31:0d:2a
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr d7:a8:93:5b:a2:8b
}</pre>
