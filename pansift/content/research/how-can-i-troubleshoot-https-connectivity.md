...
layout: research
ip_v4_address: "168.212.222.124"
date: 2022-12-15T13:50:21+00:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like ```168.212.222.124``` or an IPv6 address like ```2000:b42f:b1c6:243:f161:3ea3:deab:e2c```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```9a:c3:98:0b:9d:a3```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://robel-muller.io you initially access a DNS server to translate the host portion (robel-muller) combined with the Top Level Domain (io) of the URL, to an IP address like ```159.251.50.217```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (compatible; MSIE 9.0; AOL 9.7; AOLBuild 4343.19; Windows NT 6.1; WOW64; Trident/5.0; FunWebProducts)```
...
<pre>
default   fe80:5ec5:b5d2:2ff0:5557%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {44.119.238.61, 154.21.201.21}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 9a:c3:98:0b:9d:a3
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 00:00:b4:47:e4:d8
}</pre>
