...
layout: research
ip_v4_address: "87.116.161.52"
date: 2022-04-24T18:32:41+01:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like <code>87.116.161.52</code> or an IPv6 address like <code>2000:5afe:9a6a:8502:d8c9:2df8:332d:9099</code>. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>5b:4b:58:dc:91:85</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://schmeler-renner.biz you initially access a DNS server to translate the host portion (schmeler-renner) combined with the Top Level Domain (biz) of the URL, to an IP address like <code>85.3.195.109</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (Windows NT 6.1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/41.0.2228.0 Safari/537.36</code>
...
<pre><code>
default   fe80:3ed5:c703:b3ec:7ed0%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {141.7.66.38, 169.121.127.183}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 5b:4b:58:dc:91:85
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 78:86:7f:a5:5f:f0
}</code></pre>
