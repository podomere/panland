...
layout: research
ip_v4_address: "44.91.184.58"
date: 2022-11-19T19:13:08+00:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like ```44.91.184.58``` or an IPv6 address like ```2000:18b8:78dc:8300:a72e:c1b3:34c1:2105```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```f0:74:e2:d4:a9:04```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://lemke.io you initially access a DNS server to translate the host portion (lemke) combined with the Top Level Domain (io) of the URL, to an IP address like ```64.162.125.62```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1; WOW64; Trident/7.0; AS; rv:11.0) like Gecko```

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```172.30.255.47``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  172.30.255.47    UGScg  en0
...
<pre>
default   fe80:ddd9:768f:c6a7:ca24%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {120.227.155.132, 101.164.121.6}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr f0:74:e2:d4:a9:04
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr f0:d5:7b:09:77:73
}</pre>
