---
title: "How To Support Http Routing Issues"
subtitle: "Two-way Street?"
layout: research
ip_v4_address: "140.239.172.225"
date: 2023-02-04T16:26:23+00:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like ```140.239.172.225``` or an IPv6 address like ```2000:5fd7:fcdf:2083:8a9c:aab3:470f:60b5```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```51:29:9e:33:a1:1f```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://schmidt-hane.com you initially access a DNS server to translate the host portion (schmidt-hane) combined with the Top Level Domain (com) of the URL, to an IP address like ```80.129.149.43```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/41.0.2228.0 Safari/537.36```

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```192.168.21.231``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  192.168.21.231    UGScg  en0
...
<pre>
default   fe80:ac48:3bb3:64e4:3dee%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {149.96.88.56, 129.97.82.209}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 51:29:9e:33:a1:1f
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 7f:1a:35:90:d1:92
}</pre>
