...
layout: research
ip_v4_address: "205.79.16.40"
date: 2022-06-04T14:38:17+01:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like ```205.79.16.40``` or an IPv6 address like ```2000:df63:d836:3e5e:d163:5db0:c564:27fb```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```b2:58:51:42:0a:8f```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://mertz-okuneva.io you initially access a DNS server to translate the host portion (mertz-okuneva) combined with the Top Level Domain (io) of the URL, to an IP address like ```150.72.55.64```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1; WOW64; Trident/7.0; AS; rv:11.0) like Gecko```
...
<pre>
default   fe80:d130:1f1f:737a:9b00%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {166.167.31.63, 5.174.99.219}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr b2:58:51:42:0a:8f
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr cc:85:b9:b3:ab:0d
}</pre>
