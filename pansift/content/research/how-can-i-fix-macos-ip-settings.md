...
subtitle: "Value Add?"
layout: research
ip_v4_address: "91.37.36.228"
date: 2022-11-19T19:13:16+00:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like ```91.37.36.228``` or an IPv6 address like ```2000:f42:f0fc:d69d:73c7:a205:711:c1ef```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```e0:a8:e1:6c:33:e4```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://grady-langworth.biz you initially access a DNS server to translate the host portion (grady-langworth) combined with the Top Level Domain (biz) of the URL, to an IP address like ```209.72.211.158```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows; U; Win 9x 4.90; SG; rv:1.9.2.4) Gecko/20101104 Netscape/9.1.0285```
...
<pre>
default   fe80:be70:4cd3:b0e9:c33e%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {53.75.133.189, 191.217.120.131}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr e0:a8:e1:6c:33:e4
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 21:82:9c:c1:b1:56
}</pre>
