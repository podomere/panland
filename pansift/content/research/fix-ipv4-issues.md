...
layout: research
ip_v4_address: "243.118.47.61"
date: 2022-11-19T16:17:20+00:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like ```243.118.47.61``` or an IPv6 address like ```2000:f1d6:cdb9:e9b9:a79a:ed92:5484:ce7e```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```cc:57:e5:da:31:7a```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://bruen-kuhn.info you initially access a DNS server to translate the host portion (bruen-kuhn) combined with the Top Level Domain (info) of the URL, to an IP address like ```173.162.179.253```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1; WOW64; Trident/7.0; AS; rv:11.0) like Gecko```
...
<pre>
default   fe80:b3df:556f:6954:d639%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {127.204.143.80, 218.108.27.82}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr cc:57:e5:da:31:7a
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr e0:dc:dc:50:e3:a8
}</pre>
