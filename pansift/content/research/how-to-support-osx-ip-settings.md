...
layout: research
ip_v4_address: "24.113.90.105"
date: 2022-04-24T18:31:57+01:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like <code>24.113.90.105</code> or an IPv6 address like <code>2000:96:745e:e892:6daf:9636:778e:3076</code>. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>74:38:68:6d:a8:8c</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://hills-larkin.name you initially access a DNS server to translate the host portion (hills-larkin) combined with the Top Level Domain (name) of the URL, to an IP address like <code>177.75.234.160</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (compatible; MSIE 9.0; AOL 9.7; AOLBuild 4343.19; Windows NT 6.1; WOW64; Trident/5.0; FunWebProducts)</code>
...
<pre><code>
default   fe80:a81b:7d61:66b4:7703%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {190.32.74.170, 14.99.174.28}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 74:38:68:6d:a8:8c
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 94:b5:79:0b:3f:81
}</code></pre>
