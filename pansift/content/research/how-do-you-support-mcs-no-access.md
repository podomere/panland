...
layout: research
ip_v4_address: "158.52.35.16"
date: 2023-10-29T15:13:13+00:00
draft: false
---

## Internet Addressing
On the Internet you may have a Public IPv4 address like ```158.52.35.16``` or an IPv6 address like ```2000:9e0c:8252:f4f1:db7d:6d08:6048:4c```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```2a:2d:ee:06:9c:c1```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://parker.io you initially access a DNS server to translate the host portion (parker) combined with the Top Level Domain (io) of the URL, to an IP address like ```59.211.4.139```. Your computer and browser actually sends its type with all web requests e.g. <br>```Opera/9.80 (X11; Linux i686; Ubuntu/14.10) Presto/2.12.388 Version/12.16```

## Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```172.26.184.151``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  172.26.184.151    UGScg  en0
...
<pre>
default   fe80:7493:dfc1:cf0d:f66e%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {230.79.3.78, 196.216.37.120}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 2a:2d:ee:06:9c:c1
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 47:86:c9:1f:50:7a
}</pre>
