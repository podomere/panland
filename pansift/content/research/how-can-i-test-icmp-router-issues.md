...
subtitle: "Streamline?"
layout: research
ip_v4_address: "68.209.118.124"
date: 2022-04-24T19:00:01+01:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like <code>68.209.118.124</code> or an IPv6 address like <code>2000:dc04:f9b6:3bda:1d52:5300:7fb6:57b4</code>. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>69:16:03:23:e4:6d</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://reynolds-schneider.info you initially access a DNS server to translate the host portion (reynolds-schneider) combined with the Top Level Domain (info) of the URL, to an IP address like <code>243.201.87.120</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_3) AppleWebKit/537.75.14 (KHTML, like Gecko) Version/7.0.3 Safari/7046A194A</code>
...
default  172.22.197.168    UGScg  en0
...
<pre><code>
default   fe80:f5c1:b26d:c27c:770f%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {59.19.129.105, 218.208.226.226}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 69:16:03:23:e4:6d
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr b9:ed:fc:46:8f:96
}</code></pre>
