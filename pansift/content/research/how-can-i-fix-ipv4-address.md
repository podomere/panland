...
layout: research
ip_v4_address: "141.216.180.110"
date: 2022-05-05T14:29:33+01:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like ```141.216.180.110``` or an IPv6 address like ```2000:a9ae:b2d0:190d:aa4c:46f5:d87e:e24a```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```c0:59:22:0c:cf:fd```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://blanda-fahey.biz you initially access a DNS server to translate the host portion (blanda-fahey) combined with the Top Level Domain (biz) of the URL, to an IP address like ```230.34.205.113```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows; U; Win 9x 4.90; SG; rv:1.9.2.4) Gecko/20101104 Netscape/9.1.0285```
...
<pre>
default   fe80:5ef3:200:c97f:29d%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {0.11.147.57, 16.65.229.73}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr c0:59:22:0c:cf:fd
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr d5:e7:69:ff:a4:cd
}</pre>
