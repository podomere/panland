...
layout: research
ip_v4_address: "130.32.89.23"
date: 2022-05-05T14:30:03+01:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like ```130.32.89.23``` or an IPv6 address like ```2000:e555:e802:c6b3:c5d4:f3e:6705:80ab```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```7e:3b:ac:82:68:ff```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://klocko.com you initially access a DNS server to translate the host portion (klocko) combined with the Top Level Domain (com) of the URL, to an IP address like ```150.77.163.109```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows; U; Win 9x 4.90; SG; rv:1.9.2.4) Gecko/20101104 Netscape/9.1.0285```
...
<pre>
default   fe80:9cda:9655:9b37:bc45%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {88.27.245.12, 181.21.236.87}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 7e:3b:ac:82:68:ff
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr dd:34:32:82:cf:cb
}</pre>
