...
layout: research
ip_v4_address: "198.104.13.31"
date: 2023-02-04T17:07:42+00:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like ```198.104.13.31``` or an IPv6 address like ```2000:3d98:e56b:7f0b:281c:7270:e700:6fe5```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```3d:6a:76:26:20:53```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://bosco-graham.io you initially access a DNS server to translate the host portion (bosco-graham) combined with the Top Level Domain (io) of the URL, to an IP address like ```244.63.63.198```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/41.0.2228.0 Safari/537.36```
...
<pre>
default   fe80:182:a2e9:ae32:c9ba%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {254.120.196.85, 168.84.7.136}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 3d:6a:76:26:20:53
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 4d:b9:2c:af:31:e8
}</pre>
