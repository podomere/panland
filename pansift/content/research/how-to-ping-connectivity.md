...
layout: research
ip_v4_address: "66.92.162.79"
date: 2023-10-29T15:13:28+00:00
draft: false
---

## Internet Addressing
On the Internet you might have a Public IPv4 address like ```66.92.162.79``` or an IPv6 address like ```2000:4bb1:935d:8053:c5e2:4430:7f45:1a2a```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```fe:36:ec:77:b2:03```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://schneider-thiel.co you initially access a DNS server to translate the host portion (schneider-thiel) combined with the Top Level Domain (co) of the URL, to an IP address like ```118.121.122.12```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows; U; Win 9x 4.90; SG; rv:1.9.2.4) Gecko/20101104 Netscape/9.1.0285```
...
<pre>
default   fe80:12e1:e9e6:a55e:15a7%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {194.9.161.98, 204.26.191.104}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr fe:36:ec:77:b2:03
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 9f:de:18:e7:27:31
}</pre>
