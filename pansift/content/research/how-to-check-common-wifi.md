...
subtitle: "Impact Map?"
layout: research
ip_v4_address: "50.25.16.71"
date: 2022-05-05T14:28:28+01:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like ```50.25.16.71``` or an IPv6 address like ```2000:b9fc:c185:f70f:4ce2:bfc1:8c89:2e4c```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```10:9b:2e:3d:22:64```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://langworth-hackett.net you initially access a DNS server to translate the host portion (langworth-hackett) combined with the Top Level Domain (net) of the URL, to an IP address like ```212.205.18.209```. Your computer and browser actually sends its type with all web requests e.g. <br>```Opera/9.80 (X11; Linux i686; Ubuntu/14.10) Presto/2.12.388 Version/12.16```

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```172.17.222.74``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  172.17.222.74    UGScg  en0
...
<pre>
default   fe80:1412:dcba:29e8:9c22%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {69.207.63.222, 239.60.230.109}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 10:9b:2e:3d:22:64
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 63:0f:3a:71:89:29
}</pre>
