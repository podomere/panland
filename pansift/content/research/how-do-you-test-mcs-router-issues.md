...
subtitle: "Impact Map?"
layout: research
ip_v4_address: "187.8.205.78"
date: 2022-12-15T13:50:04+00:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like ```187.8.205.78``` or an IPv6 address like ```2000:5154:a42:30ac:665f:b972:af78:8695```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```33:b1:ce:cd:5c:34```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://haley-lynch.name you initially access a DNS server to translate the host portion (haley-lynch) combined with the Top Level Domain (name) of the URL, to an IP address like ```173.228.27.168```. Your computer and browser actually sends its type with all web requests e.g. <br>```Opera/9.80 (X11; Linux i686; Ubuntu/14.10) Presto/2.12.388 Version/12.16```
...
<pre>
default   fe80:a632:fc4d:f5de:31e2%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {101.54.119.12, 17.167.29.201}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 33:b1:ce:cd:5c:34
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 0b:d6:02:2d:29:08
}</pre>
