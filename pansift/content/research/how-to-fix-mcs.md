...
layout: research
ip_v4_address: "22.210.217.192"
date: 2023-02-04T17:07:42+00:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like ```22.210.217.192``` or an IPv6 address like ```2000:14df:6c15:b16f:7120:dff3:a812:a47c```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```f4:5e:8c:63:ef:ff```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://yundt-hartmann.biz you initially access a DNS server to translate the host portion (yundt-hartmann) combined with the Top Level Domain (biz) of the URL, to an IP address like ```249.144.189.255```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_3) AppleWebKit/537.75.14 (KHTML, like Gecko) Version/7.0.3 Safari/7046A194A```
...
<pre>
default   fe80:96fb:b459:e66f:36ee%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {159.25.131.212, 174.218.224.208}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr f4:5e:8c:63:ef:ff
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr f1:3e:1a:11:14:f1
}</pre>
