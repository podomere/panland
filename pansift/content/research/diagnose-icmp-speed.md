...
layout: research
ip_v4_address: "131.224.28.64"
date: 2022-05-05T14:29:49+01:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like ```131.224.28.64``` or an IPv6 address like ```2000:cc20:c2f8:5e22:42e:b72f:6636:2bda```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```ab:8c:01:3a:5a:7e```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://davis-von.biz you initially access a DNS server to translate the host portion (davis-von) combined with the Top Level Domain (biz) of the URL, to an IP address like ```90.177.232.107```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_3) AppleWebKit/537.75.14 (KHTML, like Gecko) Version/7.0.3 Safari/7046A194A```
...
<pre>
default   fe80:9834:f36b:5efe:abd2%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {132.179.203.158, 28.101.93.40}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr ab:8c:01:3a:5a:7e
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 2d:cb:7a:fe:be:61
}</pre>
