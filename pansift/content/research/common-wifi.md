...
layout: research
ip_v4_address: "74.153.111.20"
date: 2023-10-29T15:13:12+00:00
draft: false
---

## Internet Addressing
On the Internet you might get a Public IPv4 address like ```74.153.111.20``` or an IPv6 address like ```2000:5e1e:8aa2:8879:2d96:a7d4:e3f8:8d3```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```a3:da:d8:59:ad:50```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://champlin.co you initially access a DNS server to translate the host portion (champlin) combined with the Top Level Domain (co) of the URL, to an IP address like ```120.138.26.91```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/41.0.2228.0 Safari/537.36```

## Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```10.61.230.130``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  10.61.230.130    UGScg  en0
...
<pre>
default   fe80:e328:da41:adad:bb98%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {169.34.179.92, 188.37.123.84}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr a3:da:d8:59:ad:50
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 77:de:f2:7f:a9:71
}</pre>
