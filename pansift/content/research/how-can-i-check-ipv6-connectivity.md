...
layout: research
ip_v4_address: "132.131.125.70"
date: 2022-11-19T19:13:23+00:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like ```132.131.125.70``` or an IPv6 address like ```2000:f737:35e1:98e:e7ce:7a52:72c7:6745```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```81:50:00:b7:06:c3```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://leuschke-armstrong.biz you initially access a DNS server to translate the host portion (leuschke-armstrong) combined with the Top Level Domain (biz) of the URL, to an IP address like ```3.220.240.254```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows; U; Win 9x 4.90; SG; rv:1.9.2.4) Gecko/20101104 Netscape/9.1.0285```
...
<pre>
default   fe80:905b:e6c4:d535:8d5c%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {191.44.238.241, 131.59.153.131}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 81:50:00:b7:06:c3
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr a8:20:b2:3d:f9:31
}</pre>
