...
layout: research
ip_v4_address: "169.77.254.62"
date: 2023-02-04T16:26:20+00:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like ```169.77.254.62``` or an IPv6 address like ```2000:532b:fc7b:4fcd:7b38:e245:aad7:4c6d```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```f4:53:f4:7e:09:50```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://wehner-murray.com you initially access a DNS server to translate the host portion (wehner-murray) combined with the Top Level Domain (com) of the URL, to an IP address like ```185.219.168.153```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT x.y; Win64; x64; rv:10.0) Gecko/20100101 Firefox/10.0```
...
<pre>
default   fe80:243:2fc6:8aca:4483%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {16.73.211.13, 171.51.188.141}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr f4:53:f4:7e:09:50
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr f1:e2:e4:22:10:61
}</pre>
