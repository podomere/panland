...
layout: research
ip_v4_address: "100.101.103.161"
date: 2023-02-04T16:26:24+00:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like ```100.101.103.161``` or an IPv6 address like ```2000:6210:7c17:57c0:d33:e022:ce7d:ac4e```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```90:4f:e0:c1:ca:0e```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://gorczany-cummings.info you initially access a DNS server to translate the host portion (gorczany-cummings) combined with the Top Level Domain (info) of the URL, to an IP address like ```183.51.31.103```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1; WOW64; Trident/7.0; AS; rv:11.0) like Gecko```

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```192.168.195.128``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  192.168.195.128    UGScg  en0
...
<pre>
default   fe80:ab0:c493:83db:5dab%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {69.158.173.12, 98.173.237.8}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 90:4f:e0:c1:ca:0e
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 8f:61:a0:1c:50:8b
}</pre>
...
## Apple macOS / OSX
No matter what version of OSX/macOS you are on, ```10.13.7```, ```11.5.4```, or ```12.0.8```, there are a range of tools for troubleshooting. Unfortunately, between these manual actions and scripts, they don't give you a series of correlated values over time. This is where automated remote troubleshooting comes in to its own, especially for teams that embrace remote work and Work From Anywhere (WFA).
