...
layout: research
ip_v4_address: "143.198.240.44"
date: 2023-10-29T15:13:26+00:00
draft: false
---

## Internet Addressing
On the Internet you might get a Public IPv4 address like ```143.198.240.44``` or an IPv6 address like ```2000:edcc:71aa:1dc8:ca8a:9f07:afb1:596```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```08:a8:7c:9a:6c:70```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://wisoky.com you initially access a DNS server to translate the host portion (wisoky) combined with the Top Level Domain (com) of the URL, to an IP address like ```166.114.106.186```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_3) AppleWebKit/537.75.14 (KHTML, like Gecko) Version/7.0.3 Safari/7046A194A```

## Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```192.168.166.43``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  192.168.166.43    UGScg  en0
...
<pre>
default   fe80:ec5:c871:11e5:4676%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {239.57.229.70, 170.188.194.69}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 08:a8:7c:9a:6c:70
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 44:49:b6:9e:c8:e3
}</pre>
...
### Apple macOS / OSX
No matter what version of OSX/macOS you are on, ```10.14.7```, ```11.1.8```, or ```12.2.1```, there are a range of tools for troubleshooting. Unfortunately, between these manual actions and scripts, they don't give you a series of correlated values over time. This is where automated remote troubleshooting comes in to its own, especially for teams that embrace remote work and Work From Anywhere (WFA).
