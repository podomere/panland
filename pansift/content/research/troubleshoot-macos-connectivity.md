...
subtitle: "Swag?"
layout: research
ip_v4_address: "214.222.164.107"
date: 2022-06-12T14:09:15+01:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like ```214.222.164.107``` or an IPv6 address like ```2000:4f6f:ab2:6271:75a8:6df0:879d:f46d```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```97:47:1d:e4:fb:39```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://ohara-johnston.name you initially access a DNS server to translate the host portion (ohara-johnston) combined with the Top Level Domain (name) of the URL, to an IP address like ```248.110.48.4```. Your computer and browser actually sends its type with all web requests e.g. <br>```Opera/9.80 (X11; Linux i686; Ubuntu/14.10) Presto/2.12.388 Version/12.16```
...
<pre>
default   fe80:9df7:afa0:103a:7e59%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {35.24.204.115, 218.10.73.29}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 97:47:1d:e4:fb:39
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 1c:82:e8:70:73:83
}</pre>
