...
layout: research
ip_v4_address: "50.215.211.181"
date: 2022-11-02T11:32:24+00:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like ```50.215.211.181``` or an IPv6 address like ```2000:ec1a:ec6d:fcb5:e140:b502:8a05:fc8a```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```1d:bd:02:d8:ca:91```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://leuschke-olson.io you initially access a DNS server to translate the host portion (leuschke-olson) combined with the Top Level Domain (io) of the URL, to an IP address like ```99.57.96.80```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows; U; Win 9x 4.90; SG; rv:1.9.2.4) Gecko/20101104 Netscape/9.1.0285```
...
<pre>
default   fe80:15e:4137:cbf8:a3a2%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {198.14.29.149, 206.107.19.126}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 1d:bd:02:d8:ca:91
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr c3:1b:34:65:14:e3
}</pre>
