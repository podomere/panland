...
layout: research
ip_v4_address: "131.25.157.109"
date: 2022-12-15T13:50:19+00:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like ```131.25.157.109``` or an IPv6 address like ```2000:757:e333:8b84:d920:1a10:fbb2:1a56```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```c3:9e:a7:bb:61:99```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://bauch.info you initially access a DNS server to translate the host portion (bauch) combined with the Top Level Domain (info) of the URL, to an IP address like ```48.186.145.13```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows; U; Win 9x 4.90; SG; rv:1.9.2.4) Gecko/20101104 Netscape/9.1.0285```

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```10.251.54.62``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  10.251.54.62    UGScg  en0
...
<pre>
default   fe80:9121:bef:c551:73bd%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {177.144.190.210, 66.51.175.62}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr c3:9e:a7:bb:61:99
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 37:94:35:a0:90:54
}</pre>
