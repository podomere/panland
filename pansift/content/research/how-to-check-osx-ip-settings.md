...
layout: research
ip_v4_address: "47.203.64.164"
date: 2022-11-19T19:13:16+00:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like ```47.203.64.164``` or an IPv6 address like ```2000:b33:a610:ccda:f8f6:a9f8:dba1:d7a8```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```90:de:45:69:ea:d1```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://durgan.org you initially access a DNS server to translate the host portion (durgan) combined with the Top Level Domain (org) of the URL, to an IP address like ```220.5.21.50```. Your computer and browser actually sends its type with all web requests e.g. <br>```Opera/9.80 (X11; Linux i686; Ubuntu/14.10) Presto/2.12.388 Version/12.16```
...
<pre>
default   fe80:7296:ca0b:aad6:3dc9%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {3.25.89.242, 181.174.154.20}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 90:de:45:69:ea:d1
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 58:0c:e5:51:38:3d
}</pre>
