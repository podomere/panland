...
layout: research
ip_v4_address: "59.75.1.204"
date: 2022-05-05T14:30:01+01:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like ```59.75.1.204``` or an IPv6 address like ```2000:3b0e:1a26:6a17:b69e:5fd:afbf:7931```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```0c:cc:74:13:5a:ed```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://leannon-frami.org you initially access a DNS server to translate the host portion (leannon-frami) combined with the Top Level Domain (org) of the URL, to an IP address like ```187.203.207.2```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (compatible; MSIE 9.0; AOL 9.7; AOLBuild 4343.19; Windows NT 6.1; WOW64; Trident/5.0; FunWebProducts)```

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```172.27.246.93``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  172.27.246.93    UGScg  en0
...
<pre>
default   fe80:75cd:633c:8e81:ca9f%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {92.184.231.159, 30.26.37.43}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 0c:cc:74:13:5a:ed
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 28:ea:b1:20:eb:b2
}</pre>
