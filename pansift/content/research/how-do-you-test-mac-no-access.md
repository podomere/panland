...
layout: research
ip_v4_address: "8.108.9.240"
date: 2023-10-29T15:13:20+00:00
draft: false
---

## Internet Addressing
On the Internet you might have a Public IPv4 address like ```8.108.9.240``` or an IPv6 address like ```2000:7a55:7d7f:d1d0:7d5f:6d1a:42ee:8902```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```0f:25:10:e5:dd:cc```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://kub-schuppe.name you initially access a DNS server to translate the host portion (kub-schuppe) combined with the Top Level Domain (name) of the URL, to an IP address like ```2.131.215.26```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_3) AppleWebKit/537.75.14 (KHTML, like Gecko) Version/7.0.3 Safari/7046A194A```
...
<pre>
default   fe80:67bc:8a76:a19e:2517%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {110.190.241.51, 137.203.114.182}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 0f:25:10:e5:dd:cc
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 40:db:e2:64:4f:34
}</pre>
