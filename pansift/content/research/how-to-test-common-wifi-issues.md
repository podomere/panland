...
layout: research
ip_v4_address: "91.61.206.37"
date: 2022-06-12T14:09:05+01:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like ```91.61.206.37``` or an IPv6 address like ```2000:79df:c0be:3673:dd34:7d59:8891:823f```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```c8:e7:de:93:c0:69```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://predovic-halvorson.name you initially access a DNS server to translate the host portion (predovic-halvorson) combined with the Top Level Domain (name) of the URL, to an IP address like ```31.44.133.249```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1; WOW64; Trident/7.0; AS; rv:11.0) like Gecko```
...
<pre>
default   fe80:eccb:c949:b9e5:5aa7%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {71.18.255.148, 64.66.82.87}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr c8:e7:de:93:c0:69
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 38:0a:7f:a5:fb:1c
}</pre>
