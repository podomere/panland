...
subtitle: "Streamline?"
layout: research
ip_v4_address: "182.2.30.233"
date: 2023-10-06T17:10:43+01:00
draft: false
---

## Internet Addressing
On the Internet you may have a Public IPv4 address like ```182.2.30.233``` or an IPv6 address like ```2000:b91a:69ce:ae1e:1865:b61d:6f34:8fde```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```c9:35:4d:98:91:54```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://klein-rutherford.info you initially access a DNS server to translate the host portion (klein-rutherford) combined with the Top Level Domain (info) of the URL, to an IP address like ```43.84.253.148```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (compatible; MSIE 9.0; AOL 9.7; AOLBuild 4343.19; Windows NT 6.1; WOW64; Trident/5.0; FunWebProducts)```
...
<pre>
default   fe80:be2c:a42f:c65:b4b4%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {1.98.118.160, 68.191.255.202}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr c9:35:4d:98:91:54
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr aa:76:24:65:d4:5c
}</pre>
