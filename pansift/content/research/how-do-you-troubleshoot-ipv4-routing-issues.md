...
subtitle: "Value Add?"
layout: research
ip_v4_address: "219.159.57.55"
date: 2022-06-12T14:09:25+01:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like ```219.159.57.55``` or an IPv6 address like ```2000:d942:beb1:db7e:ad7c:ed59:ce4c:6c52```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```14:cc:73:20:2e:95```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://mertz-satterfield.biz you initially access a DNS server to translate the host portion (mertz-satterfield) combined with the Top Level Domain (biz) of the URL, to an IP address like ```93.86.233.131```. Your computer and browser actually sends its type with all web requests e.g. <br>```Opera/9.80 (X11; Linux i686; Ubuntu/14.10) Presto/2.12.388 Version/12.16```

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```192.168.223.156``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  192.168.223.156    UGScg  en0
...
<pre>
default   fe80:f769:937b:1261:57f9%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {150.147.254.14, 84.158.145.49}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 14:cc:73:20:2e:95
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr a8:57:4c:eb:ad:2a
}</pre>
