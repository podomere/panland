...
subtitle: "Learnings?"
layout: research
ip_v4_address: "35.73.221.112"
date: 2022-11-19T16:17:23+00:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like ```35.73.221.112``` or an IPv6 address like ```2000:5116:46ea:abf9:895:4633:4783:3eb6```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```7a:15:ac:74:90:e6```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://willms.org you initially access a DNS server to translate the host portion (willms) combined with the Top Level Domain (org) of the URL, to an IP address like ```100.107.21.127```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT x.y; Win64; x64; rv:10.0) Gecko/20100101 Firefox/10.0```
...
<pre>
default   fe80:bd9e:b340:d0de:ec2b%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {199.235.173.154, 187.196.234.133}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 7a:15:ac:74:90:e6
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr ad:fc:22:df:09:e5
}</pre>
...
## Apple macOS / OSX
No matter what version of OSX/macOS you are on, ```10.14.3```, ```11.4.8```, or ```12.1.2```, there are a range of tools for troubleshooting. Unfortunately, between these manual actions and scripts, they don't give you a series of correlated values over time. This is where automated remote troubleshooting comes in to its own, especially for teams that embrace remote work and Work From Anywhere (WFA).
