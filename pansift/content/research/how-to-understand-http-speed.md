...
layout: research
ip_v4_address: "58.75.133.179"
date: 2022-11-19T19:13:28+00:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like ```58.75.133.179``` or an IPv6 address like ```2000:8010:727c:76c4:ba17:309a:5d9b:d590```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```27:a9:07:8e:78:be```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://schmitt.io you initially access a DNS server to translate the host portion (schmitt) combined with the Top Level Domain (io) of the URL, to an IP address like ```136.158.163.132```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (compatible; MSIE 9.0; AOL 9.7; AOLBuild 4343.19; Windows NT 6.1; WOW64; Trident/5.0; FunWebProducts)```
...
<pre>
default   fe80:c27a:c7cf:9c9b:f274%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {120.74.78.162, 128.157.37.215}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 27:a9:07:8e:78:be
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr fe:ab:82:d7:13:55
}</pre>
...
## Apple macOS / OSX
No matter what version of OSX/macOS you are on, ```10.11.9```, ```11.1.7```, or ```12.1.7```, there are a range of tools for troubleshooting. Unfortunately, between these manual actions and scripts, they don't give you a series of correlated values over time. This is where automated remote troubleshooting comes in to its own, especially for teams that embrace remote work and Work From Anywhere (WFA).
