...
layout: research
ip_v4_address: "31.235.186.65"
date: 2022-06-04T14:38:43+01:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like ```31.235.186.65``` or an IPv6 address like ```2000:520:722a:a559:f65d:1267:eaba:f905```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```51:37:b4:a0:07:d0```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://harris.com you initially access a DNS server to translate the host portion (harris) combined with the Top Level Domain (com) of the URL, to an IP address like ```170.18.254.187```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_3) AppleWebKit/537.75.14 (KHTML, like Gecko) Version/7.0.3 Safari/7046A194A```
...
<pre>
default   fe80:be41:2a26:b9f9:a891%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {210.12.201.169, 180.16.65.26}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 51:37:b4:a0:07:d0
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 56:d3:fd:0b:60:62
}</pre>
