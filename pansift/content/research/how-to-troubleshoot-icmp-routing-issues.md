...
subtitle: "Learnings?"
layout: research
ip_v4_address: "99.131.251.224"
date: 2022-11-02T11:32:58+00:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like ```99.131.251.224``` or an IPv6 address like ```2000:11aa:9d57:3a31:16db:a19e:29a0:7568```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```06:69:0b:29:7a:86```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://dickens-okeefe.com you initially access a DNS server to translate the host portion (dickens-okeefe) combined with the Top Level Domain (com) of the URL, to an IP address like ```40.54.81.51```. Your computer and browser actually sends its type with all web requests e.g. <br>```Opera/9.80 (X11; Linux i686; Ubuntu/14.10) Presto/2.12.388 Version/12.16```
...
<pre>
default   fe80:1421:e425:ad91:3deb%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {146.74.131.116, 15.140.175.19}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 06:69:0b:29:7a:86
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 71:db:b1:94:a8:80
}</pre>
