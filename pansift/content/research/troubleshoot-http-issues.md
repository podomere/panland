...
layout: research
ip_v4_address: "152.96.111.108"
date: 2023-02-04T17:08:39+00:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like ```152.96.111.108``` or an IPv6 address like ```2000:7c6b:f6a4:1170:c8ee:4b7d:8dc5:9019```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```3b:43:d2:1b:bd:fe```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://bartell-sporer.net you initially access a DNS server to translate the host portion (bartell-sporer) combined with the Top Level Domain (net) of the URL, to an IP address like ```34.166.200.141```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows; U; Win 9x 4.90; SG; rv:1.9.2.4) Gecko/20101104 Netscape/9.1.0285```
...
<pre>
default   fe80:5546:6e8f:93b9:1d41%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {34.101.96.13, 177.25.93.230}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 3b:43:d2:1b:bd:fe
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 67:1c:ff:df:31:e9
}</pre>
