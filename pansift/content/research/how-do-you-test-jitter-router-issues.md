...
layout: research
ip_v4_address: "54.134.156.254"
date: 2022-11-19T19:13:26+00:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like ```54.134.156.254``` or an IPv6 address like ```2000:52ac:ae40:612a:9aa9:14f9:fe41:59de```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```2d:a9:fe:72:a2:15```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://hermann-collins.name you initially access a DNS server to translate the host portion (hermann-collins) combined with the Top Level Domain (name) of the URL, to an IP address like ```105.10.170.255```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_3) AppleWebKit/537.75.14 (KHTML, like Gecko) Version/7.0.3 Safari/7046A194A```
...
<pre>
default   fe80:4263:826b:3019:9268%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {179.82.31.108, 165.110.101.142}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 2d:a9:fe:72:a2:15
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 68:bc:17:af:9c:4a
}</pre>
