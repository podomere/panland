---
title: "How Do You Support Latency Address"
subtitle: "T-shirt Sizes?"
layout: research
ip_v4_address: "54.239.131.192"
date: 2023-10-06T17:11:05+01:00
draft: false
---

## Internet Addressing
On the Internet you might get a Public IPv4 address like ```54.239.131.192``` or an IPv6 address like ```2000:11ba:ecc1:6dc4:162a:450b:486a:eaad```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```49:3e:b9:f3:bc:1c```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://turcotte-ratke.io you initially access a DNS server to translate the host portion (turcotte-ratke) combined with the Top Level Domain (io) of the URL, to an IP address like ```83.213.4.188```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/41.0.2228.0 Safari/537.36```

## Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```172.31.161.203``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  172.31.161.203    UGScg  en0
...
<pre>
default   fe80:d804:8028:e8ee:a6ce%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {250.110.45.162, 85.90.187.72}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 49:3e:b9:f3:bc:1c
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 97:41:a5:93:ac:fe
}</pre>
...
### Apple macOS / OSX
No matter what version of OSX/macOS you are on, ```10.15.6```, ```11.6.9```, or ```12.3.2```, there are a range of tools for troubleshooting. Unfortunately, between these manual actions and scripts, they don't give you a series of correlated values over time. This is where automated remote troubleshooting comes in to its own, especially for teams that embrace remote work and Work From Anywhere (WFA).
