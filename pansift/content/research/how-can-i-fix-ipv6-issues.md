...
subtitle: "Swag?"
layout: research
ip_v4_address: "249.30.19.151"
date: 2023-10-06T17:11:03+01:00
draft: false
---

## Internet Addressing
On the Internet you might get a Public IPv4 address like ```249.30.19.151``` or an IPv6 address like ```2000:9680:657e:713a:65da:fe1:e5af:c685```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```55:61:ab:48:a7:ac```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://conn-williamson.biz you initially access a DNS server to translate the host portion (conn-williamson) combined with the Top Level Domain (biz) of the URL, to an IP address like ```139.195.125.30```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT x.y; Win64; x64; rv:10.0) Gecko/20100101 Firefox/10.0```

## Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```172.23.4.206``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  172.23.4.206    UGScg  en0
...
<pre>
default   fe80:d0dc:5904:c18e:4c1%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {137.80.171.177, 232.26.121.1}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 55:61:ab:48:a7:ac
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 7b:b7:47:39:8d:f3
}</pre>
