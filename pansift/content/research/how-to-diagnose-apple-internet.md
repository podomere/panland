...
subtitle: "Impact Map?"
layout: research
ip_v4_address: "12.142.216.7"
date: 2022-06-04T14:38:29+01:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like ```12.142.216.7``` or an IPv6 address like ```2000:8f34:ad2c:32f7:68a:10ce:3e52:2716```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```b6:83:3c:50:ee:39```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://wolf-heathcote.info you initially access a DNS server to translate the host portion (wolf-heathcote) combined with the Top Level Domain (info) of the URL, to an IP address like ```41.110.213.243```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_3) AppleWebKit/537.75.14 (KHTML, like Gecko) Version/7.0.3 Safari/7046A194A```
...
<pre>
default   fe80:1e0f:4f5c:1b42:f983%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {76.159.205.151, 18.36.70.62}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr b6:83:3c:50:ee:39
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr e1:3c:5e:24:ff:a1
}</pre>
...
## Apple macOS / OSX
No matter what version of OSX/macOS you are on, ```10.14.8```, ```11.5.3```, or ```12.3.7```, there are a range of tools for troubleshooting. Unfortunately, between these manual actions and scripts, they don't give you a series of correlated values over time. This is where automated remote troubleshooting comes in to its own, especially for teams that embrace remote work and Work From Anywhere (WFA).
