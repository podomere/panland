...
layout: research
ip_v4_address: "52.8.69.150"
date: 2023-02-04T17:08:35+00:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like ```52.8.69.150``` or an IPv6 address like ```2000:59c4:7552:a204:b083:3c10:c6a5:d5ac```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```62:e4:3b:aa:5e:d7```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://mcglynn.co you initially access a DNS server to translate the host portion (mcglynn) combined with the Top Level Domain (co) of the URL, to an IP address like ```228.101.184.24```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows; U; Win 9x 4.90; SG; rv:1.9.2.4) Gecko/20101104 Netscape/9.1.0285```
...
<pre>
default   fe80:6474:34d0:4567:64aa%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {159.131.23.46, 82.59.179.49}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 62:e4:3b:aa:5e:d7
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 81:c3:3f:6d:fe:45
}</pre>
