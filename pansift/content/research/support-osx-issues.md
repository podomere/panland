...
subtitle: "Synergy?"
layout: research
ip_v4_address: "70.186.148.152"
date: 2022-11-19T19:13:16+00:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like ```70.186.148.152``` or an IPv6 address like ```2000:90db:812f:ab11:992e:c80b:42f0:c8c5```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```c9:bd:bf:89:52:28```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://abshire-bernier.info you initially access a DNS server to translate the host portion (abshire-bernier) combined with the Top Level Domain (info) of the URL, to an IP address like ```73.151.34.138```. Your computer and browser actually sends its type with all web requests e.g. <br>```Opera/9.80 (X11; Linux i686; Ubuntu/14.10) Presto/2.12.388 Version/12.16```

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```172.21.57.79``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  172.21.57.79    UGScg  en0
...
<pre>
default   fe80:b8d7:8c35:39a6:9f37%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {249.111.62.12, 111.252.90.102}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr c9:bd:bf:89:52:28
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr e9:85:de:96:dc:34
}</pre>
