...
layout: research
ip_v4_address: "185.23.245.127"
date: 2022-06-04T14:38:44+01:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like ```185.23.245.127``` or an IPv6 address like ```2000:4dc5:6db9:9e5d:36b5:fc99:2089:7f68```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```f9:c2:ab:a6:ba:66```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://ortiz-jacobson.biz you initially access a DNS server to translate the host portion (ortiz-jacobson) combined with the Top Level Domain (biz) of the URL, to an IP address like ```148.50.18.12```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1; WOW64; Trident/7.0; AS; rv:11.0) like Gecko```
...
<pre>
default   fe80:e7eb:9086:a96b:88bd%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {13.115.104.27, 79.224.135.111}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr f9:c2:ab:a6:ba:66
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 89:a6:cd:2e:5d:fa
}</pre>
