...
layout: research
ip_v4_address: "185.248.16.107"
date: 2023-10-06T17:10:31+01:00
draft: false
---

## Internet Addressing
On the Internet you might have a Public IPv4 address like ```185.248.16.107``` or an IPv6 address like ```2000:3b8e:ef9:e5ba:9583:27f9:64e6:20ee```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```73:7e:7f:80:b4:63```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://mitchell-kutch.biz you initially access a DNS server to translate the host portion (mitchell-kutch) combined with the Top Level Domain (biz) of the URL, to an IP address like ```22.147.170.48```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT x.y; Win64; x64; rv:10.0) Gecko/20100101 Firefox/10.0```
...
<pre>
default   fe80:9eff:6696:b8ba:4fe2%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {144.7.91.146, 217.240.194.169}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 73:7e:7f:80:b4:63
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr d2:d6:79:cb:5f:f6
}</pre>
