...
subtitle: "Etc. Etc.?"
layout: research
ip_v4_address: "116.67.197.23"
date: 2023-02-04T17:08:37+00:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like ```116.67.197.23``` or an IPv6 address like ```2000:cf6d:9c1e:9524:f5bc:d712:9920:6f88```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```7b:f0:c7:5a:68:26```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://jenkins.com you initially access a DNS server to translate the host portion (jenkins) combined with the Top Level Domain (com) of the URL, to an IP address like ```2.219.21.110```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT x.y; Win64; x64; rv:10.0) Gecko/20100101 Firefox/10.0```
...
<pre>
default   fe80:8a7a:86c1:f36e:dde8%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {190.145.147.59, 66.49.255.135}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 7b:f0:c7:5a:68:26
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 20:54:b6:d3:18:e7
}</pre>
