...
layout: research
ip_v4_address: "23.127.73.253"
date: 2022-11-19T19:13:08+00:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like ```23.127.73.253``` or an IPv6 address like ```2000:8ad7:1045:a693:f30f:8d3d:79da:1010```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```fc:a2:b8:b9:4c:4a```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://braun.net you initially access a DNS server to translate the host portion (braun) combined with the Top Level Domain (net) of the URL, to an IP address like ```1.152.79.123```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT x.y; Win64; x64; rv:10.0) Gecko/20100101 Firefox/10.0```
...
<pre>
default   fe80:3c73:12e7:b430:6133%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {67.154.100.2, 219.41.81.108}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr fc:a2:b8:b9:4c:4a
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 43:53:fa:5f:53:2c
}</pre>
