...
layout: research
ip_v4_address: "112.98.207.222"
date: 2023-02-04T17:07:42+00:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like ```112.98.207.222``` or an IPv6 address like ```2000:6882:1eca:b54d:930a:7273:cdf8:7e84```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```24:e0:e0:fd:c1:a0```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://littel-vonrueden.co you initially access a DNS server to translate the host portion (littel-vonrueden) combined with the Top Level Domain (co) of the URL, to an IP address like ```199.236.14.108```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT x.y; Win64; x64; rv:10.0) Gecko/20100101 Firefox/10.0```

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```10.43.29.241``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  10.43.29.241    UGScg  en0
...
<pre>
default   fe80:b964:840a:c691:42ec%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {139.243.46.76, 106.204.183.9}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 24:e0:e0:fd:c1:a0
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr af:c2:76:05:52:d4
}</pre>
...
## Apple macOS / OSX
No matter what version of OSX/macOS you are on, ```10.12.8```, ```11.1.1```, or ```12.3.5```, there are a range of tools for troubleshooting. Unfortunately, between these manual actions and scripts, they don't give you a series of correlated values over time. This is where automated remote troubleshooting comes in to its own, especially for teams that embrace remote work and Work From Anywhere (WFA).
