...
layout: research
ip_v4_address: "20.228.151.247"
date: 2022-04-24T18:59:56+01:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like <code>20.228.151.247</code> or an IPv6 address like <code>2000:aebc:5629:96dd:2b96:23ae:18b9:4b64</code>. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>7b:f8:4a:33:76:6b</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://hoppe-hyatt.net you initially access a DNS server to translate the host portion (hoppe-hyatt) combined with the Top Level Domain (net) of the URL, to an IP address like <code>16.43.199.203</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (Windows NT 6.1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/41.0.2228.0 Safari/537.36</code>
...
<pre><code>
default   fe80:eb0f:88a2:b272:33fa%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {1.112.226.4, 177.119.110.77}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 7b:f8:4a:33:76:6b
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr e0:94:9b:11:c0:65
}</code></pre>
