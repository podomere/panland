...
layout: research
ip_v4_address: "66.87.203.88"
date: 2022-11-02T11:32:52+00:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like ```66.87.203.88``` or an IPv6 address like ```2000:b2d4:45d:d5a2:def9:fb60:fbcd:2722```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```bb:d0:d6:20:b1:a9```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://mohr-pouros.co you initially access a DNS server to translate the host portion (mohr-pouros) combined with the Top Level Domain (co) of the URL, to an IP address like ```101.112.65.203```. Your computer and browser actually sends its type with all web requests e.g. <br>```Opera/9.80 (X11; Linux i686; Ubuntu/14.10) Presto/2.12.388 Version/12.16```
...
<pre>
default   8e7a:54:7c4c:92ef:abff:9e68:980b:ca3b%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {41.63.162.225, 7.45.95.203}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr bb:d0:d6:20:b1:a9
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 1c:62:d2:d1:fc:22
}</pre>
