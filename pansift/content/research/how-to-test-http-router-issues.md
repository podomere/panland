...
layout: research
ip_v4_address: "40.114.242.127"
date: 2022-11-19T16:17:24+00:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like ```40.114.242.127``` or an IPv6 address like ```2000:473:9764:e47d:8152:5c9b:d527:5c65```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```ce:29:25:e6:f9:26```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://doyle.net you initially access a DNS server to translate the host portion (doyle) combined with the Top Level Domain (net) of the URL, to an IP address like ```168.64.140.129```. Your computer and browser actually sends its type with all web requests e.g. <br>```Opera/9.80 (X11; Linux i686; Ubuntu/14.10) Presto/2.12.388 Version/12.16```
...
<pre>
default   fe80:d0d1:298f:5a48:237d%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {255.59.224.64, 180.92.236.198}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr ce:29:25:e6:f9:26
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr aa:20:8a:56:7f:4f
}</pre>
