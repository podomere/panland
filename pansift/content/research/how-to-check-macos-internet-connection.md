...
layout: research
ip_v4_address: "104.94.140.116"
date: 2023-10-06T17:10:41+01:00
draft: false
---

## Internet Addressing
On the Internet you may have a Public IPv4 address like ```104.94.140.116``` or an IPv6 address like ```2000:eefd:deb2:945d:963b:4a2f:f8bb:8c92```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```04:09:30:0f:0d:1b```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://bogan-nader.name you initially access a DNS server to translate the host portion (bogan-nader) combined with the Top Level Domain (name) of the URL, to an IP address like ```82.146.60.38```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1; WOW64; Trident/7.0; AS; rv:11.0) like Gecko```
...
<pre>
default   fe80:1218:c414:8bc7:7bb5%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {84.222.175.76, 103.136.37.180}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 04:09:30:0f:0d:1b
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 67:13:38:4b:a6:fb
}</pre>
