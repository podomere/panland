...
layout: research
ip_v4_address: "163.187.60.223"
date: 2023-10-06T17:11:03+01:00
draft: false
---

## Internet Addressing
On the Internet you may have a Public IPv4 address like ```163.187.60.223``` or an IPv6 address like ```2000:49db:d58a:1954:b51c:9718:d8ea:18a3```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```b9:4b:ad:b3:87:41```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://casper.info you initially access a DNS server to translate the host portion (casper) combined with the Top Level Domain (info) of the URL, to an IP address like ```231.11.181.95```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (compatible; MSIE 9.0; AOL 9.7; AOLBuild 4343.19; Windows NT 6.1; WOW64; Trident/5.0; FunWebProducts)```
...
<pre>
default   fe80:566b:7fe4:6be8:e373%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {106.59.214.112, 161.96.213.189}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr b9:4b:ad:b3:87:41
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 81:d3:d7:2f:57:a8
}</pre>
...
### Apple macOS / OSX
No matter what version of OSX/macOS you are on, ```10.11.7```, ```11.6.5```, or ```12.2.7```, there are a range of tools for troubleshooting. Unfortunately, between these manual actions and scripts, they don't give you a series of correlated values over time. This is where automated remote troubleshooting comes in to its own, especially for teams that embrace remote work and Work From Anywhere (WFA).
