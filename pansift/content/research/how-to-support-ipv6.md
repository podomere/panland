...
layout: research
ip_v4_address: "151.124.72.60"
date: 2023-02-04T17:08:34+00:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like ```151.124.72.60``` or an IPv6 address like ```2000:8dfd:6c67:f39:6fb1:954b:4cec:2ee4```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```ff:97:25:5a:12:a0```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://wilkinson.name you initially access a DNS server to translate the host portion (wilkinson) combined with the Top Level Domain (name) of the URL, to an IP address like ```226.68.191.150```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (compatible; MSIE 9.0; AOL 9.7; AOLBuild 4343.19; Windows NT 6.1; WOW64; Trident/5.0; FunWebProducts)```

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```192.168.223.152``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  192.168.223.152    UGScg  en0
...
<pre>
default   fe80:6808:57ea:c0bc:ba26%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {23.233.209.67, 176.254.197.7}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr ff:97:25:5a:12:a0
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 5b:88:d6:27:52:aa
}</pre>
