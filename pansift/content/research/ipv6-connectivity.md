...
layout: research
ip_v4_address: "32.188.50.205"
date: 2022-06-12T14:09:23+01:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like ```32.188.50.205``` or an IPv6 address like ```2000:7610:fc65:45c9:9752:cefc:8fcf:bccc```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```a0:f7:0c:03:db:32```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://bogan-bayer.co you initially access a DNS server to translate the host portion (bogan-bayer) combined with the Top Level Domain (co) of the URL, to an IP address like ```228.27.162.228```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_3) AppleWebKit/537.75.14 (KHTML, like Gecko) Version/7.0.3 Safari/7046A194A```
...
<pre>
default   fe80:7741:e96f:6c26:f900%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {158.251.131.217, 105.22.64.234}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr a0:f7:0c:03:db:32
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 67:a4:b9:74:b8:2b
}</pre>
