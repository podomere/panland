...
layout: research
ip_v4_address: "179.193.91.240"
date: 2022-04-24T18:31:58+01:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like <code>179.193.91.240</code> or an IPv6 address like <code>2000:dbbe:c836:df00:6b5e:7e48:4695:f307</code>. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>d4:a0:7d:79:fb:07</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://emmerich-kilback.com you initially access a DNS server to translate the host portion (emmerich-kilback) combined with the Top Level Domain (com) of the URL, to an IP address like <code>225.8.135.37</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (Windows; U; Win 9x 4.90; SG; rv:1.9.2.4) Gecko/20101104 Netscape/9.1.0285</code>
...
<pre><code>
default   1a:8f4e:a511:882a:c4b8:b1af:287f:1cf4%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {230.34.20.209, 221.87.151.140}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr d4:a0:7d:79:fb:07
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr fa:70:e2:a2:96:2f
}</code></pre>
