...
subtitle: "Heads Down?"
layout: research
ip_v4_address: "235.16.225.143"
date: 2022-06-04T14:38:29+01:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like ```235.16.225.143``` or an IPv6 address like ```2000:e3f6:32d7:8a15:5d04:c59f:f324:2503```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```9a:01:f4:ed:05:a2```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://franecki-legros.org you initially access a DNS server to translate the host portion (franecki-legros) combined with the Top Level Domain (org) of the URL, to an IP address like ```222.145.240.27```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (compatible; MSIE 9.0; AOL 9.7; AOLBuild 4343.19; Windows NT 6.1; WOW64; Trident/5.0; FunWebProducts)```
...
<pre>
default   fe80:a60d:b2f4:8ba6:c6fc%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {188.173.65.116, 223.236.61.68}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 9a:01:f4:ed:05:a2
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 55:c9:96:2a:55:32
}</pre>
