...
layout: research
ip_v4_address: "71.227.34.2"
date: 2022-04-24T18:32:41+01:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like <code>71.227.34.2</code> or an IPv6 address like <code>2000:a30b:c438:9f27:502c:9463:3e45:20ef</code>. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>57:ed:07:fe:89:17</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://johnston-senger.org you initially access a DNS server to translate the host portion (johnston-senger) combined with the Top Level Domain (org) of the URL, to an IP address like <code>119.157.147.105</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (Windows NT x.y; Win64; x64; rv:10.0) Gecko/20100101 Firefox/10.0</code>
...
<pre><code>
default   fe80:8080:f7fd:6d79:2d4e%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {235.62.30.32, 9.156.159.193}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 57:ed:07:fe:89:17
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr f3:03:6d:85:b7:b0
}</code></pre>
