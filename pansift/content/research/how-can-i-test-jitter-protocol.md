...
layout: research
ip_v4_address: "221.208.6.123"
date: 2022-06-12T14:09:26+01:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like ```221.208.6.123``` or an IPv6 address like ```2000:f650:fd09:6f83:7ae2:3f2f:fb47:d6b```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```a6:6a:84:4a:2a:ea```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://daniel-kiehn.com you initially access a DNS server to translate the host portion (daniel-kiehn) combined with the Top Level Domain (com) of the URL, to an IP address like ```140.203.184.242```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/41.0.2228.0 Safari/537.36```
...
<pre>
default   fe80:dd14:44cf:400c:c97d%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {48.44.205.66, 207.19.30.197}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr a6:6a:84:4a:2a:ea
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 56:11:e2:4b:57:19
}</pre>
