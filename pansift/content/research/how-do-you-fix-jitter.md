...
subtitle: "Learnings?"
layout: research
ip_v4_address: "87.197.171.137"
date: 2023-10-06T17:11:05+01:00
draft: false
---

## Internet Addressing
On the Internet you might get a Public IPv4 address like ```87.197.171.137``` or an IPv6 address like ```2000:9d30:b4e5:89ea:112a:1eea:a75c:dbe0```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```d2:0f:5c:64:51:ee```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://heaney-greenfelder.name you initially access a DNS server to translate the host portion (heaney-greenfelder) combined with the Top Level Domain (name) of the URL, to an IP address like ```123.244.53.207```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (compatible; MSIE 9.0; AOL 9.7; AOLBuild 4343.19; Windows NT 6.1; WOW64; Trident/5.0; FunWebProducts)```
...
<pre>
default   fe80:42f1:6dd6:1668:d202%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {117.166.222.94, 213.206.171.79}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr d2:0f:5c:64:51:ee
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr b1:78:76:fc:d1:c1
}</pre>
