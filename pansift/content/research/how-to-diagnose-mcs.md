...
layout: research
ip_v4_address: "196.246.71.80"
date: 2023-02-04T17:07:42+00:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like ```196.246.71.80``` or an IPv6 address like ```2000:bdb3:afa9:6529:2131:ebcc:eab9:f8fc```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```8a:26:5c:d5:80:b6```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://pollich-abbott.biz you initially access a DNS server to translate the host portion (pollich-abbott) combined with the Top Level Domain (biz) of the URL, to an IP address like ```133.107.104.174```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (compatible; MSIE 9.0; AOL 9.7; AOLBuild 4343.19; Windows NT 6.1; WOW64; Trident/5.0; FunWebProducts)```
...
<pre>
default   fe80:6b34:fb87:466e:ffe8%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {5.149.128.79, 202.161.93.156}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 8a:26:5c:d5:80:b6
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr aa:3a:57:a1:e4:24
}</pre>
