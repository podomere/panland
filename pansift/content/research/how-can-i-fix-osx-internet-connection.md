...
subtitle: "Etc. Etc.?"
layout: research
ip_v4_address: "146.50.142.77"
date: 2022-04-24T19:00:24+01:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like <code>146.50.142.77</code> or an IPv6 address like <code>2000:8e03:f11a:8db6:64d0:7334:d12d:e2c1</code>. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>39:64:b6:ea:d2:2f</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://casper-casper.io you initially access a DNS server to translate the host portion (casper-casper) combined with the Top Level Domain (io) of the URL, to an IP address like <code>62.178.200.186</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_3) AppleWebKit/537.75.14 (KHTML, like Gecko) Version/7.0.3 Safari/7046A194A</code>
...
<pre><code>
default   fe80:5bdd:173c:9f76:430a%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {104.182.105.100, 172.95.164.109}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 39:64:b6:ea:d2:2f
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr ee:84:b7:c3:8d:35
}</code></pre>
