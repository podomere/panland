...
subtitle: "Swag?"
layout: research
ip_v4_address: "227.80.59.98"
date: 2022-04-24T19:00:24+01:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like <code>227.80.59.98</code> or an IPv6 address like <code>2000:f757:d411:17ca:c8b7:d58f:2947:80c5</code>. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>71:bd:57:55:7a:96</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://zulauf-thiel.info you initially access a DNS server to translate the host portion (zulauf-thiel) combined with the Top Level Domain (info) of the URL, to an IP address like <code>227.123.71.32</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (Windows NT 6.1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/41.0.2228.0 Safari/537.36</code>
...
<pre><code>
default   fe80:9405:6dfb:a272:d1cc%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {237.136.91.216, 133.142.247.224}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 71:bd:57:55:7a:96
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr c9:16:f2:eb:78:9e
}</code></pre>
