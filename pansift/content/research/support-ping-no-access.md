---
title: "Support Ping No-access"
subtitle: "Gamification?"
layout: research
ip_v4_address: "251.2.45.128"
date: 2023-02-04T17:08:39+00:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like ```251.2.45.128``` or an IPv6 address like ```2000:8f57:9213:8647:9e17:4659:efa9:947a```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```47:f7:f7:af:ff:7c```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://okeefe-goyette.info you initially access a DNS server to translate the host portion (okeefe-goyette) combined with the Top Level Domain (info) of the URL, to an IP address like ```11.61.26.210```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/41.0.2228.0 Safari/537.36```

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```192.168.40.132``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  192.168.40.132    UGScg  en0
...
<pre>
default   fe80:3a2a:c4e8:6bb1:8900%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {181.29.214.217, 48.209.147.189}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 47:f7:f7:af:ff:7c
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr f0:02:ea:00:22:db
}</pre>
