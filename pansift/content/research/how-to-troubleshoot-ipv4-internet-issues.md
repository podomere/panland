...
layout: research
ip_v4_address: "68.0.17.67"
date: 2022-12-15T13:50:17+00:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like ```68.0.17.67``` or an IPv6 address like ```2000:f884:21f5:7e67:b8f7:42a7:cfbb:fcc8```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```5f:5b:6a:f7:eb:0e```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://hegmann-fadel.io you initially access a DNS server to translate the host portion (hegmann-fadel) combined with the Top Level Domain (io) of the URL, to an IP address like ```182.168.139.74```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1; WOW64; Trident/7.0; AS; rv:11.0) like Gecko```
...
<pre>
default   fe80:a85b:598e:8931:34e6%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {153.245.229.64, 130.221.191.14}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 5f:5b:6a:f7:eb:0e
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr a9:d0:89:43:a1:3b
}</pre>
