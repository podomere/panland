...
layout: research
ip_v4_address: "208.234.255.182"
date: 2023-02-04T16:26:10+00:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like ```208.234.255.182``` or an IPv6 address like ```2000:5ed3:b4ea:4a33:8458:595f:16b2:4063```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```ab:ed:b8:53:69:43```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://wuckert.biz you initially access a DNS server to translate the host portion (wuckert) combined with the Top Level Domain (biz) of the URL, to an IP address like ```73.137.168.144```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1; WOW64; Trident/7.0; AS; rv:11.0) like Gecko```
...
default  172.26.121.238    UGScg  en0
...
<pre>
default   fe80:ba3c:18c9:54a7:3b1d%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {232.88.235.47, 71.151.11.42}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr ab:ed:b8:53:69:43
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 3a:65:ec:88:91:ae
}</pre>
