...
subtitle: "Branding?"
layout: research
ip_v4_address: "107.87.217.65"
date: 2022-11-02T11:32:24+00:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like ```107.87.217.65``` or an IPv6 address like ```2000:b4ec:e69d:82bc:7aa3:5255:fb6d:e501```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```2a:6d:7b:78:9e:8f```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://armstrong.co you initially access a DNS server to translate the host portion (armstrong) combined with the Top Level Domain (co) of the URL, to an IP address like ```13.191.93.123```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_3) AppleWebKit/537.75.14 (KHTML, like Gecko) Version/7.0.3 Safari/7046A194A```
...
<pre>
default   fe80:ff50:ef7b:2dda:79b6%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {70.156.113.114, 25.45.188.163}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 2a:6d:7b:78:9e:8f
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 64:64:f8:1a:b2:81
}</pre>
