...
subtitle: "Value Add?"
layout: research
ip_v4_address: "21.190.111.153"
date: 2022-12-15T13:50:10+00:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like ```21.190.111.153``` or an IPv6 address like ```2000:5390:1229:d2b2:a1d1:1012:b592:355e```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```19:0e:37:4c:3b:05```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://stanton-leffler.com you initially access a DNS server to translate the host portion (stanton-leffler) combined with the Top Level Domain (com) of the URL, to an IP address like ```97.95.53.249```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows; U; Win 9x 4.90; SG; rv:1.9.2.4) Gecko/20101104 Netscape/9.1.0285```
...
<pre>
default   fe80:e191:3ec:41b0:a531%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {183.77.237.71, 179.123.234.68}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 19:0e:37:4c:3b:05
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 2d:38:3b:7b:14:a7
}</pre>
