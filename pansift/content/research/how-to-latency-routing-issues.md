...
layout: research
ip_v4_address: "182.160.207.7"
date: 2022-04-24T18:59:57+01:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like <code>182.160.207.7</code> or an IPv6 address like <code>2000:28d5:5ae8:d654:7d31:202d:8de:f437</code>. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>a9:eb:a8:c5:2f:81</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://mills-rutherford.com you initially access a DNS server to translate the host portion (mills-rutherford) combined with the Top Level Domain (com) of the URL, to an IP address like <code>250.198.250.109</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Opera/9.80 (X11; Linux i686; Ubuntu/14.10) Presto/2.12.388 Version/12.16</code>
...
<pre><code>
default   fe80:807e:8930:6acb:c7bc%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {88.109.104.130, 132.118.121.95}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr a9:eb:a8:c5:2f:81
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr ae:89:31:51:68:c2
}</code></pre>
