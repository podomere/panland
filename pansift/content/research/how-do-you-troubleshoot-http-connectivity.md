...
subtitle: "Swim Lane?"
layout: research
ip_v4_address: "173.38.33.18"
date: 2023-02-04T16:26:23+00:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like ```173.38.33.18``` or an IPv6 address like ```2000:8700:e60b:8953:fd67:810a:d7c6:a9b5```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```6d:05:b9:cb:d0:83```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://fritsch-batz.net you initially access a DNS server to translate the host portion (fritsch-batz) combined with the Top Level Domain (net) of the URL, to an IP address like ```162.249.143.203```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT x.y; Win64; x64; rv:10.0) Gecko/20100101 Firefox/10.0```
...
<pre>
default   fe80:dd1:824b:6029:11b9%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {63.182.205.77, 157.70.43.56}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 6d:05:b9:cb:d0:83
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 59:d4:66:1b:a8:a2
}</pre>
