...
subtitle: "Etc. Etc.?"
layout: research
ip_v4_address: "52.215.151.184"
date: 2022-04-24T19:00:23+01:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like <code>52.215.151.184</code> or an IPv6 address like <code>2000:2201:442a:d8b:9f87:20aa:a604:be6a</code>. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>bb:a1:ab:02:c6:57</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://wehner-greenholt.io you initially access a DNS server to translate the host portion (wehner-greenholt) combined with the Top Level Domain (io) of the URL, to an IP address like <code>168.188.72.140</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (compatible; MSIE 9.0; AOL 9.7; AOLBuild 4343.19; Windows NT 6.1; WOW64; Trident/5.0; FunWebProducts)</code>
...
<pre><code>
default   fe80:1155:b8cf:4c53:ba7f%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {55.83.87.182, 250.162.191.28}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr bb:a1:ab:02:c6:57
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 4f:c5:c2:6f:47:bb
}</code></pre>
