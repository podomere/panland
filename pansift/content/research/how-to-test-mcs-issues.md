...
subtitle: "Learnings?"
layout: research
ip_v4_address: "197.77.203.63"
date: 2023-10-29T15:13:13+00:00
draft: false
---

## Internet Addressing
On the Internet you may have a Public IPv4 address like ```197.77.203.63``` or an IPv6 address like ```2000:7450:4a25:4dd8:717f:ceb7:dca9:8a32```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```97:a8:82:73:a2:8d```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://hayes-labadie.name you initially access a DNS server to translate the host portion (hayes-labadie) combined with the Top Level Domain (name) of the URL, to an IP address like ```241.44.119.71```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1; WOW64; Trident/7.0; AS; rv:11.0) like Gecko```

## Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```10.154.1.168``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  10.154.1.168    UGScg  en0
...
<pre>
default   fe80:5534:b1fb:107b:b8e0%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {50.237.101.184, 254.43.225.33}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 97:a8:82:73:a2:8d
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 88:cf:d5:c8:25:b0
}</pre>
