...
layout: research
ip_v4_address: "155.152.135.97"
date: 2022-11-02T11:32:59+00:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like ```155.152.135.97``` or an IPv6 address like ```2000:9e49:ec2a:3428:abb1:5179:96f1:a9bb```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```7a:54:15:f9:d1:46```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://kirlin.biz you initially access a DNS server to translate the host portion (kirlin) combined with the Top Level Domain (biz) of the URL, to an IP address like ```140.224.252.244```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows; U; Win 9x 4.90; SG; rv:1.9.2.4) Gecko/20101104 Netscape/9.1.0285```

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```10.21.252.233``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  10.21.252.233    UGScg  en0
...
<pre>
default   fe80:28fe:d06f:3843:1e8d%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {110.253.186.149, 29.103.70.123}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 7a:54:15:f9:d1:46
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr be:99:3a:d0:36:a2
}</pre>
...
## Apple macOS / OSX
No matter what version of OSX/macOS you are on, ```10.11.7```, ```11.6.6```, or ```12.1.9```, there are a range of tools for troubleshooting. Unfortunately, between these manual actions and scripts, they don't give you a series of correlated values over time. This is where automated remote troubleshooting comes in to its own, especially for teams that embrace remote work and Work From Anywhere (WFA).
