...
subtitle: "Swim Lane?"
layout: research
ip_v4_address: "52.184.234.44"
date: 2022-11-19T19:13:24+00:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like ```52.184.234.44``` or an IPv6 address like ```2000:daf:8f5a:f17d:1c09:3e54:4c15:8d9b```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```f4:26:5f:9e:41:55```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://ratke.org you initially access a DNS server to translate the host portion (ratke) combined with the Top Level Domain (org) of the URL, to an IP address like ```167.54.34.90```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (compatible; MSIE 9.0; AOL 9.7; AOLBuild 4343.19; Windows NT 6.1; WOW64; Trident/5.0; FunWebProducts)```
...
<pre>
default   fe80:bf2:d570:fb50:53df%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {179.111.78.26, 95.128.225.58}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr f4:26:5f:9e:41:55
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 6b:6e:21:58:fa:e1
}</pre>
