...
layout: research
ip_v4_address: "135.28.36.174"
date: 2023-10-29T15:13:25+00:00
draft: false
---

## Internet Addressing
On the Internet you might get a Public IPv4 address like ```135.28.36.174``` or an IPv6 address like ```2000:4c24:8aea:e709:8d25:563:bf55:c4d3```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```81:6f:56:39:44:01```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://labadie-padberg.io you initially access a DNS server to translate the host portion (labadie-padberg) combined with the Top Level Domain (io) of the URL, to an IP address like ```115.73.31.90```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows; U; Win 9x 4.90; SG; rv:1.9.2.4) Gecko/20101104 Netscape/9.1.0285```
...
<pre>
default   fe80:c23a:4d04:15b5:7444%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {146.92.7.239, 138.205.147.204}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 81:6f:56:39:44:01
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr d8:da:3e:67:60:b5
}</pre>
...
### Apple macOS / OSX
No matter what version of OSX/macOS you are on, ```10.14.5```, ```11.6.3```, or ```12.2.8```, there are a range of tools for troubleshooting. Unfortunately, between these manual actions and scripts, they don't give you a series of correlated values over time. This is where automated remote troubleshooting comes in to its own, especially for teams that embrace remote work and Work From Anywhere (WFA).
