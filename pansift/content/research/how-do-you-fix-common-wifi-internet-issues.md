...
layout: research
ip_v4_address: "54.91.253.149"
date: 2022-04-24T18:32:42+01:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like <code>54.91.253.149</code> or an IPv6 address like <code>2000:88f4:a593:ba58:14a6:d5e6:5e9:e510</code>. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>ae:e3:1c:9e:8c:50</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://altenwerth-weissnat.org you initially access a DNS server to translate the host portion (altenwerth-weissnat) combined with the Top Level Domain (org) of the URL, to an IP address like <code>67.90.215.176</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Opera/9.80 (X11; Linux i686; Ubuntu/14.10) Presto/2.12.388 Version/12.16</code>
...
<pre><code>
default   fe80:45eb:d3ed:cc26:83ba%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {116.17.74.42, 242.84.165.250}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr ae:e3:1c:9e:8c:50
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 83:f6:58:9e:1c:b0
}</code></pre>
