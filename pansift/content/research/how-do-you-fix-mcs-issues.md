...
layout: research
ip_v4_address: "238.189.141.245"
date: 2022-06-04T14:38:17+01:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like ```238.189.141.245``` or an IPv6 address like ```2000:da60:5279:25cb:7e37:6842:60e7:bc66```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```81:79:37:fc:e7:73```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://oberbrunner-cruickshank.io you initially access a DNS server to translate the host portion (oberbrunner-cruickshank) combined with the Top Level Domain (io) of the URL, to an IP address like ```14.153.138.214```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1; WOW64; Trident/7.0; AS; rv:11.0) like Gecko```
...
<pre>
default   fe80:40d1:f057:c1f1:7146%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {240.128.192.35, 138.52.235.5}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 81:79:37:fc:e7:73
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 9a:3f:cf:97:a0:39
}</pre>
