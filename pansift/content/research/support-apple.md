...
layout: research
ip_v4_address: "38.130.90.110"
date: 2023-10-06T17:10:42+01:00
draft: false
---

## Internet Addressing
On the Internet you might get a Public IPv4 address like ```38.130.90.110``` or an IPv6 address like ```2000:c39:86e1:4312:6f82:8fe5:a75:b922```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```09:04:7d:e3:50:13```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://mcglynn-oconner.net you initially access a DNS server to translate the host portion (mcglynn-oconner) combined with the Top Level Domain (net) of the URL, to an IP address like ```141.75.146.49```. Your computer and browser actually sends its type with all web requests e.g. <br>```Opera/9.80 (X11; Linux i686; Ubuntu/14.10) Presto/2.12.388 Version/12.16```

## Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```10.37.78.242``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  10.37.78.242    UGScg  en0
...
<pre>
default   fe80:6703:5408:cec0:a90e%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {6.163.146.19, 94.109.2.165}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 09:04:7d:e3:50:13
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 67:1a:87:23:d8:7f
}</pre>
