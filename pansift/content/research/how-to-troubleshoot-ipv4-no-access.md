---
title: "How To Troubleshoot IPv4 No-access"
subtitle: "Get Value Out Of The Conversation?"
layout: research
ip_v4_address: "61.136.60.154"
date: 2023-02-04T17:08:35+00:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like ```61.136.60.154``` or an IPv6 address like ```2000:707a:6cd8:7980:eafc:fc8c:f371:e400```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```fd:e2:c7:92:e4:be```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://krajcik-stiedemann.org you initially access a DNS server to translate the host portion (krajcik-stiedemann) combined with the Top Level Domain (org) of the URL, to an IP address like ```90.154.159.102```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows; U; Win 9x 4.90; SG; rv:1.9.2.4) Gecko/20101104 Netscape/9.1.0285```

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```172.19.163.89``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  172.19.163.89    UGScg  en0
...
<pre>
default   fe80:e792:e69f:da3a:3aff%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {10.74.16.117, 49.71.245.127}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr fd:e2:c7:92:e4:be
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr ef:84:39:da:0d:11
}</pre>
