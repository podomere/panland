...
layout: research
ip_v4_address: "48.152.191.166"
date: 2022-12-15T13:50:20+00:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like ```48.152.191.166``` or an IPv6 address like ```2000:1c5b:5246:1d68:36a1:7f25:f05:3453```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```06:ee:11:69:f1:f7```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://okuneva.com you initially access a DNS server to translate the host portion (okuneva) combined with the Top Level Domain (com) of the URL, to an IP address like ```200.167.189.8```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows; U; Win 9x 4.90; SG; rv:1.9.2.4) Gecko/20101104 Netscape/9.1.0285```
...
<pre>
default   fe80:632b:13a1:955b:342e%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {133.134.124.165, 44.72.32.209}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 06:ee:11:69:f1:f7
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 2f:05:15:6b:f5:b5
}</pre>
