...
layout: research
ip_v4_address: "228.117.207.145"
date: 2022-06-12T14:09:16+01:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like ```228.117.207.145``` or an IPv6 address like ```2000:8f5a:9134:3f89:dc9a:d9c5:937:e1d9```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```30:55:46:be:11:5e```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://koss-swaniawski.name you initially access a DNS server to translate the host portion (koss-swaniawski) combined with the Top Level Domain (name) of the URL, to an IP address like ```48.3.132.225```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_3) AppleWebKit/537.75.14 (KHTML, like Gecko) Version/7.0.3 Safari/7046A194A```
...
<pre>
default   fe80:c920:4cce:78b2:e129%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {60.81.187.199, 177.36.147.15}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 30:55:46:be:11:5e
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 4a:be:27:1c:f3:3a
}</pre>
