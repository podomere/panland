...
subtitle: "Swag?"
layout: research
ip_v4_address: "16.88.140.132"
date: 2023-02-04T16:26:11+00:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like ```16.88.140.132``` or an IPv6 address like ```2000:ed64:4f88:14ab:880b:2084:4ccc:5b3d```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```70:6f:95:9f:e1:35```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://leannon-kunde.info you initially access a DNS server to translate the host portion (leannon-kunde) combined with the Top Level Domain (info) of the URL, to an IP address like ```185.114.120.32```. Your computer and browser actually sends its type with all web requests e.g. <br>```Opera/9.80 (X11; Linux i686; Ubuntu/14.10) Presto/2.12.388 Version/12.16```
...
<pre>
default   fe80:4cc1:c593:4017:947a%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {81.208.215.47, 12.211.247.48}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 70:6f:95:9f:e1:35
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr f6:84:55:97:5f:30
}</pre>
