...
layout: research
ip_v4_address: "75.11.161.100"
date: 2023-10-06T17:10:42+01:00
draft: false
---

## Internet Addressing
On the Internet you may have a Public IPv4 address like ```75.11.161.100``` or an IPv6 address like ```2000:9b9f:2093:f210:5965:7dae:dcfb:e8d8```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```fa:c7:ec:46:03:18```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://bailey-wuckert.biz you initially access a DNS server to translate the host portion (bailey-wuckert) combined with the Top Level Domain (biz) of the URL, to an IP address like ```91.133.0.158```. Your computer and browser actually sends its type with all web requests e.g. <br>```Opera/9.80 (X11; Linux i686; Ubuntu/14.10) Presto/2.12.388 Version/12.16```
...
<pre>
default   fe80:5d20:ed9c:e8fa:79d2%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {1.121.237.89, 55.53.45.247}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr fa:c7:ec:46:03:18
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr fa:d8:31:ad:af:86
}</pre>
