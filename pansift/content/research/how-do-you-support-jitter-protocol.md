...
subtitle: "Heads Down?"
layout: research
ip_v4_address: "134.152.140.193"
date: 2022-04-24T19:00:00+01:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like <code>134.152.140.193</code> or an IPv6 address like <code>2000:7098:61b9:ebcd:637c:cb39:5b6d:13c7</code>. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>f3:65:97:38:52:9e</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://rutherford.net you initially access a DNS server to translate the host portion (rutherford) combined with the Top Level Domain (net) of the URL, to an IP address like <code>114.159.122.233</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (Windows; U; Win 9x 4.90; SG; rv:1.9.2.4) Gecko/20101104 Netscape/9.1.0285</code>
...
default  172.27.229.176    UGScg  en0
...
<pre><code>
default   aae:b0f7:90:3112:4608:8d15:49b4:752b%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {66.179.253.219, 132.206.165.65}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr f3:65:97:38:52:9e
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 53:43:92:56:fc:42
}</code></pre>
