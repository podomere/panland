...
layout: research
ip_v4_address: "35.241.30.157"
date: 2022-05-05T14:28:29+01:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like ```35.241.30.157``` or an IPv6 address like ```2000:1c19:c550:e7b:cc7e:b6c3:f320:e828```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```cd:cd:1e:af:93:a4```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://hilpert-muller.org you initially access a DNS server to translate the host portion (hilpert-muller) combined with the Top Level Domain (org) of the URL, to an IP address like ```61.64.111.50```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_3) AppleWebKit/537.75.14 (KHTML, like Gecko) Version/7.0.3 Safari/7046A194A```
...
<pre>
default   fe80:282:9613:8d2e:be98%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {205.234.151.181, 253.39.168.65}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr cd:cd:1e:af:93:a4
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 36:80:c4:4f:6b:36
}</pre>
