...
layout: research
ip_v4_address: "226.63.101.108"
date: 2022-11-02T11:32:56+00:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like ```226.63.101.108``` or an IPv6 address like ```2000:1fbe:7ade:a5f7:6ff5:1ff5:2a22:f3a0```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```bf:e7:67:ce:a9:09```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://weimann.biz you initially access a DNS server to translate the host portion (weimann) combined with the Top Level Domain (biz) of the URL, to an IP address like ```145.6.13.77```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1; WOW64; Trident/7.0; AS; rv:11.0) like Gecko```

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```172.29.25.45``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  172.29.25.45    UGScg  en0
...
<pre>
default   fe80:1676:10e7:ffa:74fd%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {201.120.90.177, 202.84.249.42}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr bf:e7:67:ce:a9:09
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 9a:44:c7:ea:ed:46
}</pre>
