...
layout: research
ip_v4_address: "167.216.149.89"
date: 2022-11-19T19:13:17+00:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like ```167.216.149.89``` or an IPv6 address like ```2000:5285:9bc6:68da:96cc:d07b:6709:72bd```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```06:b2:c9:af:ae:80```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://gerlach-mohr.org you initially access a DNS server to translate the host portion (gerlach-mohr) combined with the Top Level Domain (org) of the URL, to an IP address like ```194.140.51.114```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows; U; Win 9x 4.90; SG; rv:1.9.2.4) Gecko/20101104 Netscape/9.1.0285```
...
<pre>
default   fe80:65c5:d7ba:5c30:b67%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {64.60.255.188, 231.160.213.50}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 06:b2:c9:af:ae:80
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 98:52:ec:26:e9:11
}</pre>
