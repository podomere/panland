...
layout: research
ip_v4_address: "180.16.76.220"
date: 2022-11-02T11:32:55+00:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like ```180.16.76.220``` or an IPv6 address like ```2000:8c71:58ef:f9b3:e6cf:38fd:c1f:986e```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```d4:d1:df:4c:9e:f7```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://cummerata.net you initially access a DNS server to translate the host portion (cummerata) combined with the Top Level Domain (net) of the URL, to an IP address like ```234.13.152.114```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1; WOW64; Trident/7.0; AS; rv:11.0) like Gecko```
...
<pre>
default   fe80:df07:5d38:e96d:70f6%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {154.89.99.153, 247.21.136.17}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr d4:d1:df:4c:9e:f7
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr dd:36:1c:4e:c7:b6
}</pre>
