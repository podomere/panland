...
layout: research
ip_v4_address: "116.168.185.74"
date: 2022-06-12T14:09:24+01:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like ```116.168.185.74``` or an IPv6 address like ```2000:91f3:3ac7:35b9:3bd8:c49f:b68f:3218```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```e9:69:2d:8d:df:1e```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://romaguera-koepp.net you initially access a DNS server to translate the host portion (romaguera-koepp) combined with the Top Level Domain (net) of the URL, to an IP address like ```162.146.133.245```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_3) AppleWebKit/537.75.14 (KHTML, like Gecko) Version/7.0.3 Safari/7046A194A```
...
<pre>
default   fe80:803d:7a26:a90b:61f%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {254.22.255.225, 148.198.238.35}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr e9:69:2d:8d:df:1e
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 5d:79:df:c1:2c:d1
}</pre>
