...
subtitle: "Ideate?"
layout: research
ip_v4_address: "129.53.31.187"
date: 2022-11-19T16:17:20+00:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like ```129.53.31.187``` or an IPv6 address like ```2000:813f:ca63:7faf:b8ce:5fef:a1ae:8e4a```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```58:db:50:69:bf:26```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://zemlak.io you initially access a DNS server to translate the host portion (zemlak) combined with the Top Level Domain (io) of the URL, to an IP address like ```14.78.233.51```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1; WOW64; Trident/7.0; AS; rv:11.0) like Gecko```

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```10.93.110.235``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  10.93.110.235    UGScg  en0
...
<pre>
default   fe80:d180:3185:ec5c:a692%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {129.23.123.126, 27.136.39.99}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 58:db:50:69:bf:26
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr c9:c7:05:e8:1f:b5
}</pre>
