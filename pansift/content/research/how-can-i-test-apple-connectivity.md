...
subtitle: "Etc. Etc.?"
layout: research
ip_v4_address: "112.96.253.158"
date: 2022-11-02T11:33:11+00:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like ```112.96.253.158``` or an IPv6 address like ```2000:db9b:53c8:d575:2e17:b5f8:931f:28a7```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```a8:1d:82:2d:59:88```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://cassin-lehner.biz you initially access a DNS server to translate the host portion (cassin-lehner) combined with the Top Level Domain (biz) of the URL, to an IP address like ```89.183.25.194```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows; U; Win 9x 4.90; SG; rv:1.9.2.4) Gecko/20101104 Netscape/9.1.0285```

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```10.192.61.22``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  10.192.61.22    UGScg  en0
...
<pre>
default   fe80:df05:8185:74b7:ab34%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {137.216.226.123, 249.3.46.173}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr a8:1d:82:2d:59:88
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 83:1e:b7:35:22:1c
}</pre>
