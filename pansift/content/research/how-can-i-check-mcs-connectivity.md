...
layout: research
ip_v4_address: "237.8.215.190"
date: 2022-11-02T11:32:24+00:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like ```237.8.215.190``` or an IPv6 address like ```2000:6f2a:e508:c10f:6ab1:5a50:5df1:5ea6```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```ba:9f:89:37:bc:c9```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://mueller-kuhlman.io you initially access a DNS server to translate the host portion (mueller-kuhlman) combined with the Top Level Domain (io) of the URL, to an IP address like ```212.121.76.109```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows; U; Win 9x 4.90; SG; rv:1.9.2.4) Gecko/20101104 Netscape/9.1.0285```
...
<pre>
default   fe80:e407:567b:12c5:b467%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {244.201.26.37, 158.253.206.144}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr ba:9f:89:37:bc:c9
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr fc:32:08:47:6b:6c
}</pre>
