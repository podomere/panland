...
layout: research
ip_v4_address: "114.94.107.71"
date: 2022-04-24T18:31:58+01:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like <code>114.94.107.71</code> or an IPv6 address like <code>2000:57a0:20ec:8572:de09:e660:e2c5:91e5</code>. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>fb:ba:a8:e3:30:1b</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://lowe.org you initially access a DNS server to translate the host portion (lowe) combined with the Top Level Domain (org) of the URL, to an IP address like <code>4.123.124.200</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (Windows; U; Win 9x 4.90; SG; rv:1.9.2.4) Gecko/20101104 Netscape/9.1.0285</code>
...
<pre><code>
default   fe80:2223:a4ab:e6ab:5c25%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {221.7.244.59, 182.252.8.255}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr fb:ba:a8:e3:30:1b
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 6c:05:e3:f7:b4:66
}</code></pre>
