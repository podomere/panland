...
layout: research
ip_v4_address: "40.140.205.146"
date: 2022-04-24T19:00:01+01:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like <code>40.140.205.146</code> or an IPv6 address like <code>2000:cc05:7c18:fab:43b8:eaf0:d6bb:3ba7</code>. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>4a:63:cc:0d:66:7a</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://gibson-crooks.info you initially access a DNS server to translate the host portion (gibson-crooks) combined with the Top Level Domain (info) of the URL, to an IP address like <code>14.231.44.224</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_3) AppleWebKit/537.75.14 (KHTML, like Gecko) Version/7.0.3 Safari/7046A194A</code>
...
default  192.168.169.252    UGScg  en0
...
<pre><code>
default   fe80:36e3:cffa:32e5:5488%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {161.240.163.74, 193.24.188.40}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 4a:63:cc:0d:66:7a
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 90:64:89:6a:98:1e
}</code></pre>
