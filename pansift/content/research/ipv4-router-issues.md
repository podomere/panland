...
subtitle: "Value Add?"
layout: research
ip_v4_address: "252.155.204.133"
date: 2022-12-15T13:50:17+00:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like ```252.155.204.133``` or an IPv6 address like ```2000:b609:d398:6f97:6ce3:4e6b:181b:a0c7```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```68:a0:dc:e2:93:4d```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://grimes.name you initially access a DNS server to translate the host portion (grimes) combined with the Top Level Domain (name) of the URL, to an IP address like ```18.88.46.129```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_3) AppleWebKit/537.75.14 (KHTML, like Gecko) Version/7.0.3 Safari/7046A194A```
...
<pre>
default   fe80:ee90:6cb5:972a:3099%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {219.201.162.124, 14.39.179.81}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 68:a0:dc:e2:93:4d
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr cd:b3:46:21:5d:10
}</pre>
