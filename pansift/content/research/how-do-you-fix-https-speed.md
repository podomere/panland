...
layout: research
ip_v4_address: "152.96.191.250"
date: 2022-11-19T19:13:29+00:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like ```152.96.191.250``` or an IPv6 address like ```2000:fff9:5f0f:bd8e:6732:49fc:dd52:5b84```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```95:4a:69:19:de:ef```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://davis-gusikowski.co you initially access a DNS server to translate the host portion (davis-gusikowski) combined with the Top Level Domain (co) of the URL, to an IP address like ```167.51.218.185```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_3) AppleWebKit/537.75.14 (KHTML, like Gecko) Version/7.0.3 Safari/7046A194A```
...
<pre>
default   fe80:eec5:e3c9:81bc:7f9f%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {116.203.214.162, 193.169.94.143}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 95:4a:69:19:de:ef
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 08:75:ed:01:c4:60
}</pre>
