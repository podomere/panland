...
subtitle: "Swag?"
layout: research
ip_v4_address: "223.252.10.28"
date: 2022-04-24T18:32:42+01:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like <code>223.252.10.28</code> or an IPv6 address like <code>2000:e46c:df69:ff47:9391:5ea9:c20b:e245</code>. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>97:c7:3f:21:7f:99</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://hyatt.name you initially access a DNS server to translate the host portion (hyatt) combined with the Top Level Domain (name) of the URL, to an IP address like <code>51.64.35.209</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (Windows; U; Win 9x 4.90; SG; rv:1.9.2.4) Gecko/20101104 Netscape/9.1.0285</code>
...
<pre><code>
default   fe80:cae9:e35d:8838:a994%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {43.14.148.186, 74.225.240.16}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 97:c7:3f:21:7f:99
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 9f:c7:3d:8f:b0:d7
}</code></pre>
