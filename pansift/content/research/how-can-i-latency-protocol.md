...
layout: research
ip_v4_address: "76.43.34.190"
date: 2022-11-19T16:17:21+00:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like ```76.43.34.190``` or an IPv6 address like ```2000:ff48:4ae3:e53:b668:7ea1:3ce3:39fd```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```17:94:da:14:39:08```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://hackett.org you initially access a DNS server to translate the host portion (hackett) combined with the Top Level Domain (org) of the URL, to an IP address like ```215.167.216.229```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT x.y; Win64; x64; rv:10.0) Gecko/20100101 Firefox/10.0```
...
default  192.168.12.157    UGScg  en0
...
<pre>
default   fe80:ee94:aa13:e9c6:919a%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {235.187.185.68, 21.54.217.48}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 17:94:da:14:39:08
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 36:b7:98:e1:a3:82
}</pre>
