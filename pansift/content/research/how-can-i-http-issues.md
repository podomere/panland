...
layout: research
ip_v4_address: "5.22.19.74"
date: 2022-11-19T19:13:28+00:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like ```5.22.19.74``` or an IPv6 address like ```2000:ba96:32b2:3e8a:8cfe:6b94:52dc:b80```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```a3:ef:a6:f4:9f:ea```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://turner-beahan.net you initially access a DNS server to translate the host portion (turner-beahan) combined with the Top Level Domain (net) of the URL, to an IP address like ```233.79.157.73```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (compatible; MSIE 9.0; AOL 9.7; AOLBuild 4343.19; Windows NT 6.1; WOW64; Trident/5.0; FunWebProducts)```
...
<pre>
default   fe80:fdd2:2ed4:411f:5406%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {76.180.228.217, 82.98.35.128}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr a3:ef:a6:f4:9f:ea
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr f1:8d:12:da:44:49
}</pre>
