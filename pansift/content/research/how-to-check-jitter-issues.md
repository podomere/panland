...
layout: research
ip_v4_address: "47.243.45.110"
date: 2023-10-06T17:11:05+01:00
draft: false
---

## Internet Addressing
On the Internet you may have a Public IPv4 address like ```47.243.45.110``` or an IPv6 address like ```2000:5001:d166:5272:c42b:8557:9d59:4b8e```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```a5:c0:84:96:bb:81```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://okeefe.co you initially access a DNS server to translate the host portion (okeefe) combined with the Top Level Domain (co) of the URL, to an IP address like ```113.225.84.59```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_3) AppleWebKit/537.75.14 (KHTML, like Gecko) Version/7.0.3 Safari/7046A194A```

## Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```192.168.102.211``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  192.168.102.211    UGScg  en0
...
<pre>
default   fe80:a6f8:dd81:ed51:8e40%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {194.174.190.135, 209.199.140.142}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr a5:c0:84:96:bb:81
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr d2:82:d5:0c:83:f2
}</pre>
...
### Apple macOS / OSX
No matter what version of OSX/macOS you are on, ```10.13.7```, ```11.6.4```, or ```12.0.9```, there are a range of tools for troubleshooting. Unfortunately, between these manual actions and scripts, they don't give you a series of correlated values over time. This is where automated remote troubleshooting comes in to its own, especially for teams that embrace remote work and Work From Anywhere (WFA).
