...
layout: research
ip_v4_address: "39.245.32.18"
date: 2023-10-06T17:10:43+01:00
draft: false
---

## Internet Addressing
On the Internet you might get a Public IPv4 address like ```39.245.32.18``` or an IPv6 address like ```2000:eaf8:ed2b:dd0:160b:c6ac:ee2d:4149```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```89:83:95:b2:0b:9d```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://okuneva-boehm.info you initially access a DNS server to translate the host portion (okuneva-boehm) combined with the Top Level Domain (info) of the URL, to an IP address like ```206.182.39.81```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows; U; Win 9x 4.90; SG; rv:1.9.2.4) Gecko/20101104 Netscape/9.1.0285```
...
<pre>
default   fe80:bb19:2954:c8f9:38b8%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {92.17.32.219, 215.148.140.184}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 89:83:95:b2:0b:9d
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 80:dd:a2:21:e7:f0
}</pre>
