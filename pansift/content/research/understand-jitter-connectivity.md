...
layout: research
ip_v4_address: "217.132.158.159"
date: 2023-02-04T17:08:37+00:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like ```217.132.158.159``` or an IPv6 address like ```2000:ba4:d923:b0db:72bc:781f:6e4a:5b94```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```3b:c7:02:b8:e1:8d```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://rosenbaum.io you initially access a DNS server to translate the host portion (rosenbaum) combined with the Top Level Domain (io) of the URL, to an IP address like ```118.82.3.210```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1; WOW64; Trident/7.0; AS; rv:11.0) like Gecko```
...
<pre>
default   fe80:71d8:682c:c6c3:aa89%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {143.220.239.213, 62.119.68.19}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 3b:c7:02:b8:e1:8d
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr e4:16:c9:d8:a9:bb
}</pre>
