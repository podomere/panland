...
layout: research
ip_v4_address: "127.136.114.191"
date: 2022-11-02T11:32:58+00:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like ```127.136.114.191``` or an IPv6 address like ```2000:e98:90bb:188e:1a17:3b5f:6aea:2b05```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```4f:30:f6:46:b1:06```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://gibson-runolfsdottir.co you initially access a DNS server to translate the host portion (gibson-runolfsdottir) combined with the Top Level Domain (co) of the URL, to an IP address like ```124.23.220.193```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1; WOW64; Trident/7.0; AS; rv:11.0) like Gecko```
...
<pre>
default   fe80:659e:2a82:f79e:a8f8%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {130.67.105.143, 185.2.193.38}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 4f:30:f6:46:b1:06
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr a5:08:e4:6d:e4:85
}</pre>
