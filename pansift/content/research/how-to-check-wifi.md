...
layout: research
ip_v4_address: "244.136.26.126"
date: 2023-02-04T17:07:41+00:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like ```244.136.26.126``` or an IPv6 address like ```2000:a02c:325d:2345:cbf4:8296:2bf6:8efd```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```21:1b:61:27:86:44```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://prohaska-auer.co you initially access a DNS server to translate the host portion (prohaska-auer) combined with the Top Level Domain (co) of the URL, to an IP address like ```97.157.246.15```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows; U; Win 9x 4.90; SG; rv:1.9.2.4) Gecko/20101104 Netscape/9.1.0285```
...
<pre>
default   fe80:7a09:a85d:96a6:4f40%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {78.56.145.192, 56.38.127.178}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 21:1b:61:27:86:44
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr b1:86:ee:64:70:3a
}</pre>
