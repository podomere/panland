...
layout: research
ip_v4_address: "51.36.67.203"
date: 2022-06-12T14:09:26+01:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like ```51.36.67.203``` or an IPv6 address like ```2000:329c:d50b:27ff:11ee:afaf:e8ee:674b```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```1d:8e:b6:ce:c4:c3```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://cormier-kertzmann.co you initially access a DNS server to translate the host portion (cormier-kertzmann) combined with the Top Level Domain (co) of the URL, to an IP address like ```35.92.86.24```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (compatible; MSIE 9.0; AOL 9.7; AOLBuild 4343.19; Windows NT 6.1; WOW64; Trident/5.0; FunWebProducts)```
...
<pre>
default   fe80:a286:ad30:21af:5422%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {147.89.174.59, 172.40.253.193}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 1d:8e:b6:ce:c4:c3
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 5c:45:e6:84:00:01
}</pre>
