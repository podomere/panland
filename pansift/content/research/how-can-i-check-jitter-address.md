...
layout: research
ip_v4_address: "76.251.163.182"
date: 2022-12-15T13:50:19+00:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like ```76.251.163.182``` or an IPv6 address like ```2000:e7d2:eeae:f287:aa0f:69fe:90ed:e530```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```b6:3a:54:75:ed:b4```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://hackett-mcglynn.co you initially access a DNS server to translate the host portion (hackett-mcglynn) combined with the Top Level Domain (co) of the URL, to an IP address like ```59.91.100.160```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/41.0.2228.0 Safari/537.36```
...
<pre>
default   fe80:682:5868:2fe9:1dc8%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {252.7.44.116, 184.98.178.208}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr b6:3a:54:75:ed:b4
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 00:a2:68:61:13:99
}</pre>
