...
layout: research
ip_v4_address: "135.213.133.127"
date: 2022-12-15T13:50:22+00:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like ```135.213.133.127``` or an IPv6 address like ```2000:da11:fb33:4e1e:707e:b2f0:97d9:48c4```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```cf:de:37:5b:b0:df```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://kozey-johns.co you initially access a DNS server to translate the host portion (kozey-johns) combined with the Top Level Domain (co) of the URL, to an IP address like ```40.126.110.104```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1; WOW64; Trident/7.0; AS; rv:11.0) like Gecko```
...
<pre>
default   fe80:ac04:3913:25c6:c6e7%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {251.33.254.201, 151.64.242.200}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr cf:de:37:5b:b0:df
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr b5:21:be:3b:18:fe
}</pre>
