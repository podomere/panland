...
layout: research
ip_v4_address: "222.178.90.22"
date: 2022-04-24T19:00:34+01:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like <code>222.178.90.22</code> or an IPv6 address like <code>2000:184b:6d96:feea:4f8d:84be:5bc3:7c5e</code>. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>68:55:65:0e:e9:eb</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://corkery-ruecker.io you initially access a DNS server to translate the host portion (corkery-ruecker) combined with the Top Level Domain (io) of the URL, to an IP address like <code>231.31.211.228</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (Windows NT 6.1; WOW64; Trident/7.0; AS; rv:11.0) like Gecko</code>
...
<pre><code>
default   fe80:ac8d:7fb1:b459:992d%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {65.149.87.215, 204.162.92.180}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 68:55:65:0e:e9:eb
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 65:42:14:de:fe:2d
}</code></pre>
