...
subtitle: "Value Add?"
layout: research
ip_v4_address: "98.70.119.222"
date: 2022-05-05T14:30:12+01:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like ```98.70.119.222``` or an IPv6 address like ```2000:20eb:abaa:2570:2aa4:156d:396f:9457```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```79:c5:ce:40:bf:a6```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://champlin-grimes.info you initially access a DNS server to translate the host portion (champlin-grimes) combined with the Top Level Domain (info) of the URL, to an IP address like ```62.33.170.180```. Your computer and browser actually sends its type with all web requests e.g. <br>```Opera/9.80 (X11; Linux i686; Ubuntu/14.10) Presto/2.12.388 Version/12.16```
...
<pre>
default   fe80:e64a:a24c:40e7:efc%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {107.246.43.133, 90.189.24.79}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 79:c5:ce:40:bf:a6
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 05:5e:a1:50:c1:24
}</pre>
