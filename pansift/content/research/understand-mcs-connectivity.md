...
layout: research
ip_v4_address: "67.20.235.126"
date: 2022-04-24T19:00:34+01:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like <code>67.20.235.126</code> or an IPv6 address like <code>2000:d6fa:255a:e0ff:5764:6aec:f9d8:4078</code>. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>aa:58:08:52:9d:da</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://mante-lebsack.org you initially access a DNS server to translate the host portion (mante-lebsack) combined with the Top Level Domain (org) of the URL, to an IP address like <code>87.242.216.167</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (Windows; U; Win 9x 4.90; SG; rv:1.9.2.4) Gecko/20101104 Netscape/9.1.0285</code>
...
<pre><code>
default   6fb:7619:f1:c47d:21b5:6921:908c:e452%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {127.246.72.37, 41.86.6.117}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr aa:58:08:52:9d:da
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 06:ea:89:51:ac:33
}</code></pre>
