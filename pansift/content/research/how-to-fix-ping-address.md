...
subtitle: "Impact Map?"
layout: research
ip_v4_address: "102.251.202.87"
date: 2022-11-02T11:32:59+00:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like ```102.251.202.87``` or an IPv6 address like ```2000:7b52:791e:325e:206c:17f4:9b03:3ba2```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```57:60:ce:76:74:77```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://beatty-carter.net you initially access a DNS server to translate the host portion (beatty-carter) combined with the Top Level Domain (net) of the URL, to an IP address like ```133.252.142.56```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1; WOW64; Trident/7.0; AS; rv:11.0) like Gecko```

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```192.168.168.223``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  192.168.168.223    UGScg  en0
...
<pre>
default   fe80:c45c:62a7:c8c2:963%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {76.13.243.177, 149.210.22.177}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 57:60:ce:76:74:77
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr c1:e8:e1:de:5e:11
}</pre>
