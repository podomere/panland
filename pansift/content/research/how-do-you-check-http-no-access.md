...
layout: research
ip_v4_address: "36.148.189.3"
date: 2023-10-29T15:13:29+00:00
draft: false
---

## Internet Addressing
On the Internet you might have a Public IPv4 address like ```36.148.189.3``` or an IPv6 address like ```2000:a2e3:8702:6bc4:f0be:3018:f443:3177```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```8e:17:88:38:ea:b3```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://vandervort-fahey.co you initially access a DNS server to translate the host portion (vandervort-fahey) combined with the Top Level Domain (co) of the URL, to an IP address like ```157.243.131.27```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (compatible; MSIE 9.0; AOL 9.7; AOLBuild 4343.19; Windows NT 6.1; WOW64; Trident/5.0; FunWebProducts)```
...
<pre>
default   fe80:a157:6e32:cf6f:56d0%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {164.164.238.112, 109.194.133.159}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 8e:17:88:38:ea:b3
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr b6:a4:27:7c:fc:a1
}</pre>
