...
layout: research
ip_v4_address: "157.66.140.44"
date: 2022-05-05T14:29:34+01:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like ```157.66.140.44``` or an IPv6 address like ```2000:a29f:18c5:f75d:bcdc:cab9:3a7:b322```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```88:6c:ae:83:96:b4```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://runolfsson.name you initially access a DNS server to translate the host portion (runolfsson) combined with the Top Level Domain (name) of the URL, to an IP address like ```218.122.115.63```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1; WOW64; Trident/7.0; AS; rv:11.0) like Gecko```
...
<pre>
default   fe80:bf48:2af0:441:9a08%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {208.114.31.230, 141.128.215.19}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 88:6c:ae:83:96:b4
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 18:5a:99:7f:14:b7
}</pre>
