...
layout: research
ip_v4_address: "5.209.232.71"
date: 2022-05-05T14:28:44+01:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like ```5.209.232.71``` or an IPv6 address like ```2000:9132:4d9e:78f6:87c5:257f:d946:fcc4```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```77:d8:53:cb:24:c2```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://casper.biz you initially access a DNS server to translate the host portion (casper) combined with the Top Level Domain (biz) of the URL, to an IP address like ```218.227.116.134```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/41.0.2228.0 Safari/537.36```
...
default  172.18.131.238    UGScg  en0
...
<pre>
default   fe80:9d26:9a3d:d3e0:2c45%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {83.219.179.243, 15.40.82.197}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 77:d8:53:cb:24:c2
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 14:60:3f:dd:3a:5e
}</pre>
