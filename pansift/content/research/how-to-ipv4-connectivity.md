...
layout: research
ip_v4_address: "137.180.230.110"
date: 2023-10-29T15:13:25+00:00
draft: false
---

## Internet Addressing
On the Internet you may get a Public IPv4 address like ```137.180.230.110``` or an IPv6 address like ```2000:73e0:d07b:4d82:f00b:5913:4d25:19cf```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```ee:2c:a9:1f:11:56```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://barrows-huels.org you initially access a DNS server to translate the host portion (barrows-huels) combined with the Top Level Domain (org) of the URL, to an IP address like ```14.118.71.80```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_3) AppleWebKit/537.75.14 (KHTML, like Gecko) Version/7.0.3 Safari/7046A194A```
...
<pre>
default   fe80:56c9:fdd8:9d02:f5d3%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {178.8.251.7, 218.26.78.54}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr ee:2c:a9:1f:11:56
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 32:23:15:5a:db:cc
}</pre>
