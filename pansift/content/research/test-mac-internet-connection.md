...
layout: research
ip_v4_address: "124.103.57.98"
date: 2022-04-24T18:31:59+01:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like <code>124.103.57.98</code> or an IPv6 address like <code>2000:b0af:817:82d8:94e2:7a94:2311:37cd</code>. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>00:cc:1b:9c:06:74</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://hand-stokes.co you initially access a DNS server to translate the host portion (hand-stokes) combined with the Top Level Domain (co) of the URL, to an IP address like <code>143.61.250.141</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_3) AppleWebKit/537.75.14 (KHTML, like Gecko) Version/7.0.3 Safari/7046A194A</code>
...
<pre><code>
default   fe80:83e1:15fd:9c82:53b3%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {126.191.160.244, 110.99.125.100}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 00:cc:1b:9c:06:74
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 95:eb:43:df:15:2f
}</code></pre>
