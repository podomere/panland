...
layout: research
ip_v4_address: "89.22.196.216"
date: 2022-12-15T13:50:17+00:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like ```89.22.196.216``` or an IPv6 address like ```2000:b7c3:ed2b:f7a3:5756:746f:7f9e:6182```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```7a:26:2f:cc:27:09```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://weissnat-hamill.net you initially access a DNS server to translate the host portion (weissnat-hamill) combined with the Top Level Domain (net) of the URL, to an IP address like ```37.58.237.136```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_3) AppleWebKit/537.75.14 (KHTML, like Gecko) Version/7.0.3 Safari/7046A194A```
...
<pre>
default   fe80:dbc7:258f:493f:3684%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {250.231.85.142, 14.139.143.158}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 7a:26:2f:cc:27:09
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 57:58:d2:e2:37:cb
}</pre>
