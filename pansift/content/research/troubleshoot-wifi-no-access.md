...
layout: research
ip_v4_address: "136.153.44.53"
date: 2023-02-04T16:26:02+00:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like ```136.153.44.53``` or an IPv6 address like ```2000:647b:7d0c:a67e:ddcf:8e95:f105:5dca```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```3b:d9:0d:d4:10:69```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://collins-goodwin.io you initially access a DNS server to translate the host portion (collins-goodwin) combined with the Top Level Domain (io) of the URL, to an IP address like ```229.37.151.145```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows; U; Win 9x 4.90; SG; rv:1.9.2.4) Gecko/20101104 Netscape/9.1.0285```
...
<pre>
default   fe80:eb29:1ab7:a5a1:1d51%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {30.123.109.194, 238.185.192.231}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 3b:d9:0d:d4:10:69
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr d8:1b:e2:0e:1d:09
}</pre>
