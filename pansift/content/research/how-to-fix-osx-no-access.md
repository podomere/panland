...
subtitle: "Streamline?"
layout: research
ip_v4_address: "195.172.159.71"
date: 2022-06-12T14:09:15+01:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like ```195.172.159.71``` or an IPv6 address like ```2000:d67e:7eb5:e53d:34a0:7977:42fc:d81b```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```0f:65:63:77:6c:6d```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://bradtke-koepp.com you initially access a DNS server to translate the host portion (bradtke-koepp) combined with the Top Level Domain (com) of the URL, to an IP address like ```171.249.87.18```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/41.0.2228.0 Safari/537.36```

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```192.168.97.190``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  192.168.97.190    UGScg  en0
...
<pre>
default   fe80:e226:5017:18f5:2294%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {181.4.113.109, 207.242.14.242}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 0f:65:63:77:6c:6d
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 21:08:8b:7a:27:bb
}</pre>
