...
subtitle: "Etc. Etc.?"
layout: research
ip_v4_address: "89.205.27.175"
date: 2022-05-05T14:29:29+01:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like ```89.205.27.175``` or an IPv6 address like ```2000:7dd9:e8cc:6f2:665b:cae6:777:5634```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```b3:2b:2e:5c:3a:c2```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://welch-bruen.co you initially access a DNS server to translate the host portion (welch-bruen) combined with the Top Level Domain (co) of the URL, to an IP address like ```29.77.18.79```. Your computer and browser actually sends its type with all web requests e.g. <br>```Opera/9.80 (X11; Linux i686; Ubuntu/14.10) Presto/2.12.388 Version/12.16```
...
<pre>
default   fe80:b8d:344d:1a68:9a62%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {157.196.112.174, 187.169.31.219}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr b3:2b:2e:5c:3a:c2
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr be:d9:7e:c5:f6:d2
}</pre>
