...
layout: research
ip_v4_address: "18.250.192.77"
date: 2023-10-29T15:13:26+00:00
draft: false
---

## Internet Addressing
On the Internet you might have a Public IPv4 address like ```18.250.192.77``` or an IPv6 address like ```2000:7290:3cab:312d:dd1a:1de7:1f40:c0c0```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```4e:f0:4a:2f:95:c0```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://stanton.biz you initially access a DNS server to translate the host portion (stanton) combined with the Top Level Domain (biz) of the URL, to an IP address like ```103.112.200.113```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1; WOW64; Trident/7.0; AS; rv:11.0) like Gecko```
...
<pre>
default   fe80:36cd:6a19:3c34:8298%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {104.105.108.50, 40.110.121.229}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 4e:f0:4a:2f:95:c0
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 75:c1:cf:f3:97:93
}</pre>
...
### Apple macOS / OSX
No matter what version of OSX/macOS you are on, ```10.12.4```, ```11.4.7```, or ```12.2.6```, there are a range of tools for troubleshooting. Unfortunately, between these manual actions and scripts, they don't give you a series of correlated values over time. This is where automated remote troubleshooting comes in to its own, especially for teams that embrace remote work and Work From Anywhere (WFA).
