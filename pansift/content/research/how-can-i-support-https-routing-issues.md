...
layout: research
ip_v4_address: "108.0.173.233"
date: 2022-05-05T14:30:14+01:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like ```108.0.173.233``` or an IPv6 address like ```2000:da05:e3af:30c0:f910:5e96:4ef6:46e5```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```6f:f2:7d:d9:f2:ed```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://bosco-predovic.com you initially access a DNS server to translate the host portion (bosco-predovic) combined with the Top Level Domain (com) of the URL, to an IP address like ```41.194.198.15```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (compatible; MSIE 9.0; AOL 9.7; AOLBuild 4343.19; Windows NT 6.1; WOW64; Trident/5.0; FunWebProducts)```
...
<pre>
default   fe80:549d:ab0d:11e:b9d%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {61.13.168.244, 121.204.233.249}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 6f:f2:7d:d9:f2:ed
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 8e:cb:4b:f3:06:ee
}</pre>
