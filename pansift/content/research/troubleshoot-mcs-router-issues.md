...
layout: research
ip_v4_address: "56.254.146.219"
date: 2022-05-05T14:28:31+01:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like ```56.254.146.219``` or an IPv6 address like ```2000:91a0:1e91:fe9d:1350:73dd:7377:cbe8```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```29:2a:2c:f6:1f:28```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://wuckert-baumbach.co you initially access a DNS server to translate the host portion (wuckert-baumbach) combined with the Top Level Domain (co) of the URL, to an IP address like ```114.126.28.233```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/41.0.2228.0 Safari/537.36```
...
<pre>
default   fe80:1a5d:b697:70e7:8db0%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {183.48.93.219, 115.61.239.122}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 29:2a:2c:f6:1f:28
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr a0:a0:28:81:f1:7f
}</pre>
