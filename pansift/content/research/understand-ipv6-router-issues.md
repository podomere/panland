...
layout: research
ip_v4_address: "160.83.112.59"
date: 2022-05-05T14:29:25+01:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like ```160.83.112.59``` or an IPv6 address like ```2000:97e9:7fd2:ff13:db31:e4c5:41a3:92de```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```7f:fe:fd:64:6b:38```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://dooley.net you initially access a DNS server to translate the host portion (dooley) combined with the Top Level Domain (net) of the URL, to an IP address like ```128.179.165.215```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1; WOW64; Trident/7.0; AS; rv:11.0) like Gecko```
...
<pre>
default   fe80:1a40:8049:ab48:284b%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {21.85.224.214, 140.136.162.83}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 7f:fe:fd:64:6b:38
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr ab:20:90:9a:11:96
}</pre>
