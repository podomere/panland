...
layout: research
ip_v4_address: "22.121.143.42"
date: 2023-02-04T17:07:48+00:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like ```22.121.143.42``` or an IPv6 address like ```2000:d906:663a:4258:e3f6:69a6:a900:f8ff```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```a4:de:a1:f8:c8:e9```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://kulas-connelly.name you initially access a DNS server to translate the host portion (kulas-connelly) combined with the Top Level Domain (name) of the URL, to an IP address like ```153.75.70.252```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1; WOW64; Trident/7.0; AS; rv:11.0) like Gecko```
...
<pre>
default   fe80:a45c:390b:a8ec:93c7%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {4.139.244.158, 115.116.190.161}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr a4:de:a1:f8:c8:e9
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 29:64:02:82:46:47
}</pre>
