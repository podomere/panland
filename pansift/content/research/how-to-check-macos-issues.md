...
subtitle: "Tee It Up?"
layout: research
ip_v4_address: "191.144.7.222"
date: 2022-12-15T13:50:10+00:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like ```191.144.7.222``` or an IPv6 address like ```2000:f3b6:92ee:fc29:d76c:fcd0:1742:cf08```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```2b:96:0f:5e:aa:92```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://hane.net you initially access a DNS server to translate the host portion (hane) combined with the Top Level Domain (net) of the URL, to an IP address like ```108.16.204.179```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows; U; Win 9x 4.90; SG; rv:1.9.2.4) Gecko/20101104 Netscape/9.1.0285```
...
<pre>
default   fe80:2fbb:10c9:c29b:2fa8%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {147.208.248.175, 59.197.183.240}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 2b:96:0f:5e:aa:92
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 1d:5f:db:07:6d:c3
}</pre>
...
## Apple macOS / OSX
No matter what version of OSX/macOS you are on, ```10.14.6```, ```11.1.1```, or ```12.3.1```, there are a range of tools for troubleshooting. Unfortunately, between these manual actions and scripts, they don't give you a series of correlated values over time. This is where automated remote troubleshooting comes in to its own, especially for teams that embrace remote work and Work From Anywhere (WFA).
