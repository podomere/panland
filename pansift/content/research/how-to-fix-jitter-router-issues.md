...
layout: research
ip_v4_address: "175.115.125.152"
date: 2022-04-24T18:59:59+01:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like <code>175.115.125.152</code> or an IPv6 address like <code>2000:b78f:f8f1:81b2:b82:2b84:5805:5a90</code>. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>79:53:2d:06:a0:48</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://muller.co you initially access a DNS server to translate the host portion (muller) combined with the Top Level Domain (co) of the URL, to an IP address like <code>213.247.13.251</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_3) AppleWebKit/537.75.14 (KHTML, like Gecko) Version/7.0.3 Safari/7046A194A</code>
...
<pre><code>
default   fe80:3bcf:ea3c:944d:5727%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {212.10.113.108, 166.86.186.2}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 79:53:2d:06:a0:48
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr dd:92:a5:46:de:b0
}</code></pre>
