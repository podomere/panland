...
subtitle: "Deep Dive?"
layout: research
ip_v4_address: "89.192.99.168"
date: 2022-06-12T14:09:16+01:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like ```89.192.99.168``` or an IPv6 address like ```2000:3e88:2165:6cfa:f877:c879:2782:4068```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```e0:71:a3:50:61:a1```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://langworth-torp.com you initially access a DNS server to translate the host portion (langworth-torp) combined with the Top Level Domain (com) of the URL, to an IP address like ```114.115.254.208```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1; WOW64; Trident/7.0; AS; rv:11.0) like Gecko```
...
<pre>
default   fe80:8461:f706:84b:297b%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {39.47.196.0, 244.37.131.67}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr e0:71:a3:50:61:a1
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr f6:aa:25:99:50:5f
}</pre>
