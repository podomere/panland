...
layout: research
ip_v4_address: "76.242.101.173"
date: 2023-02-04T16:26:09+00:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like ```76.242.101.173``` or an IPv6 address like ```2000:a031:9699:1c24:f182:76d0:13df:b661```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```2a:37:f0:1c:00:1b```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://weber.org you initially access a DNS server to translate the host portion (weber) combined with the Top Level Domain (org) of the URL, to an IP address like ```230.114.245.92```. Your computer and browser actually sends its type with all web requests e.g. <br>```Opera/9.80 (X11; Linux i686; Ubuntu/14.10) Presto/2.12.388 Version/12.16```
...
<pre>
default   fe80:d311:71b3:176b:e441%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {114.183.252.56, 142.12.6.117}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 2a:37:f0:1c:00:1b
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 86:86:b5:d6:35:b7
}</pre>
