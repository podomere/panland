...
layout: research
ip_v4_address: "31.85.42.132"
date: 2023-02-04T17:08:37+00:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like ```31.85.42.132``` or an IPv6 address like ```2000:89fe:4f21:4ba:ee6e:3359:1418:35f7```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```19:73:90:77:4a:4a```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://ritchie-grimes.info you initially access a DNS server to translate the host portion (ritchie-grimes) combined with the Top Level Domain (info) of the URL, to an IP address like ```222.223.249.125```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_3) AppleWebKit/537.75.14 (KHTML, like Gecko) Version/7.0.3 Safari/7046A194A```
...
<pre>
default   fe80:111a:c1c7:f4d7:a566%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {17.171.107.240, 159.34.26.134}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 19:73:90:77:4a:4a
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 53:c0:ef:e0:2e:be
}</pre>
