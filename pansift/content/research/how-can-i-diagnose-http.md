...
layout: research
ip_v4_address: "199.45.79.24"
date: 2022-06-12T14:09:28+01:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like ```199.45.79.24``` or an IPv6 address like ```2000:f706:70b4:7dbf:be63:8999:29b4:e5af```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```04:c0:c3:ee:0d:4a```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://cormier.net you initially access a DNS server to translate the host portion (cormier) combined with the Top Level Domain (net) of the URL, to an IP address like ```179.97.85.83```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows; U; Win 9x 4.90; SG; rv:1.9.2.4) Gecko/20101104 Netscape/9.1.0285```

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```10.225.250.37``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  10.225.250.37    UGScg  en0
...
<pre>
default   fe80:bfb9:5e55:e339:ac93%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {208.56.169.102, 38.0.85.80}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 04:c0:c3:ee:0d:4a
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 1b:5a:f9:62:bc:f8
}</pre>
