...
layout: research
ip_v4_address: "149.17.182.216"
date: 2022-05-05T14:28:51+01:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like ```149.17.182.216``` or an IPv6 address like ```2000:d758:141b:a1f3:4729:9ee:9f7:36f2```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```b0:6c:b8:3c:43:d4```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://hirthe-hammes.co you initially access a DNS server to translate the host portion (hirthe-hammes) combined with the Top Level Domain (co) of the URL, to an IP address like ```89.128.125.231```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT x.y; Win64; x64; rv:10.0) Gecko/20100101 Firefox/10.0```
...
<pre>
default   fe80:269c:2215:b3d7:8f0%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {177.143.219.80, 52.5.219.173}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr b0:6c:b8:3c:43:d4
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 95:61:8c:94:29:ec
}</pre>
