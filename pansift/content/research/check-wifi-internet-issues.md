...
layout: research
ip_v4_address: "29.184.80.94"
date: 2022-04-24T19:00:32+01:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like <code>29.184.80.94</code> or an IPv6 address like <code>2000:77d0:3373:edc1:86d7:89c4:2b9e:bfe5</code>. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>8a:ea:18:ac:10:f2</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://gorczany.io you initially access a DNS server to translate the host portion (gorczany) combined with the Top Level Domain (io) of the URL, to an IP address like <code>189.195.29.236</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (Windows NT 6.1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/41.0.2228.0 Safari/537.36</code>

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like <code>10.78.235.70</code> (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For <code>IPv6</code> we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  10.78.235.70    UGScg  en0
...
<pre><code>
default   fe80:1834:8754:1bf:47ea%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {239.121.194.71, 164.1.133.170}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 8a:ea:18:ac:10:f2
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 20:3a:7e:dd:05:3f
}</code></pre>
