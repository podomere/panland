...
layout: research
ip_v4_address: "114.177.108.94"
date: 2022-04-24T18:31:57+01:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like <code>114.177.108.94</code> or an IPv6 address like <code>2000:d6b6:490:b70d:d999:98a5:7f4c:2d84</code>. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>20:fb:b3:b5:29:f9</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://cruickshank-jakubowski.biz you initially access a DNS server to translate the host portion (cruickshank-jakubowski) combined with the Top Level Domain (biz) of the URL, to an IP address like <code>98.128.148.71</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (Windows; U; Win 9x 4.90; SG; rv:1.9.2.4) Gecko/20101104 Netscape/9.1.0285</code>
...
<pre><code>
default   fe80:e374:5e7d:4a1b:e83d%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {80.241.17.255, 165.162.51.67}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 20:fb:b3:b5:29:f9
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 29:04:ff:a2:a4:a8
}</code></pre>
