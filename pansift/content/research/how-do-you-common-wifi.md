---
title: "How Do You Common Wifi"
subtitle: "Value Proposition?"
layout: research
ip_v4_address: "181.25.77.142"
date: 2022-11-19T16:17:06+00:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like ```181.25.77.142``` or an IPv6 address like ```2000:bf70:36b4:f868:5dc5:2ac1:a073:69ab```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```e1:5b:90:97:8d:1e```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://langosh-wintheiser.com you initially access a DNS server to translate the host portion (langosh-wintheiser) combined with the Top Level Domain (com) of the URL, to an IP address like ```0.13.92.237```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (compatible; MSIE 9.0; AOL 9.7; AOLBuild 4343.19; Windows NT 6.1; WOW64; Trident/5.0; FunWebProducts)```

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```10.201.173.133``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  10.201.173.133    UGScg  en0
...
<pre>
default   fe80:d653:f4e:b325:608f%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {193.62.249.122, 140.115.59.210}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr e1:5b:90:97:8d:1e
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr dc:57:23:11:3d:ed
}</pre>
