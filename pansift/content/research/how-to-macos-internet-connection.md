...
layout: research
ip_v4_address: "24.197.200.79"
date: 2022-04-24T18:31:57+01:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like <code>24.197.200.79</code> or an IPv6 address like <code>2000:c90c:2701:282e:3e9e:c856:9fd8:9f78</code>. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>9f:66:e5:03:ee:4c</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://jenkins-barrows.biz you initially access a DNS server to translate the host portion (jenkins-barrows) combined with the Top Level Domain (biz) of the URL, to an IP address like <code>147.170.15.78</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (Windows NT 6.1; WOW64; Trident/7.0; AS; rv:11.0) like Gecko</code>
...
<pre><code>
default   fe80:628f:c65f:2225:189e%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {136.112.4.228, 30.181.153.60}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 9f:66:e5:03:ee:4c
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 52:9e:cc:ae:ae:1d
}</code></pre>
