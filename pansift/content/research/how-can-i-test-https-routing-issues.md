...
layout: research
ip_v4_address: "3.124.166.235"
date: 2022-12-15T13:50:22+00:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like ```3.124.166.235``` or an IPv6 address like ```2000:4be4:137e:9ef:c8ff:ebd3:8d76:3228```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```61:16:9b:67:ef:d3```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://wolf-gleichner.io you initially access a DNS server to translate the host portion (wolf-gleichner) combined with the Top Level Domain (io) of the URL, to an IP address like ```144.128.106.168```. Your computer and browser actually sends its type with all web requests e.g. <br>```Opera/9.80 (X11; Linux i686; Ubuntu/14.10) Presto/2.12.388 Version/12.16```
...
<pre>
default   fe80:746c:55a6:c23c:f644%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {12.0.181.238, 208.11.233.31}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 61:16:9b:67:ef:d3
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 28:b9:7a:57:ec:48
}</pre>
