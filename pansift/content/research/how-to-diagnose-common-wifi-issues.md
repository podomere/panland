...
layout: research
ip_v4_address: "181.229.175.85"
date: 2022-11-02T11:32:24+00:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like ```181.229.175.85``` or an IPv6 address like ```2000:30ca:8d5f:b7fd:6e53:3ab3:b09a:5bb```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```94:0e:7a:24:b6:ea```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://williamson.com you initially access a DNS server to translate the host portion (williamson) combined with the Top Level Domain (com) of the URL, to an IP address like ```185.60.200.62```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (compatible; MSIE 9.0; AOL 9.7; AOLBuild 4343.19; Windows NT 6.1; WOW64; Trident/5.0; FunWebProducts)```
...
<pre>
default   fe80:4d39:c30f:89:c481%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {172.115.178.226, 13.91.4.200}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 94:0e:7a:24:b6:ea
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 00:29:8b:6d:df:58
}</pre>
