...
layout: research
ip_v4_address: "40.239.118.230"
date: 2022-12-15T13:50:20+00:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like ```40.239.118.230``` or an IPv6 address like ```2000:ffa0:3618:1aac:6f26:93ec:bcda:c57e```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```ce:b4:1f:72:ae:5b```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://ratke.biz you initially access a DNS server to translate the host portion (ratke) combined with the Top Level Domain (biz) of the URL, to an IP address like ```111.25.73.199```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_3) AppleWebKit/537.75.14 (KHTML, like Gecko) Version/7.0.3 Safari/7046A194A```
...
<pre>
default   fe80:181c:ac07:6430:47ae%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {239.210.158.7, 159.110.123.128}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr ce:b4:1f:72:ae:5b
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr c3:e9:84:5b:af:c5
}</pre>
