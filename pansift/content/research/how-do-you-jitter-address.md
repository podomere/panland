...
layout: research
ip_v4_address: "190.216.17.221"
date: 2022-04-24T19:00:00+01:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like <code>190.216.17.221</code> or an IPv6 address like <code>2000:3773:d71b:f742:d497:a924:6667:675f</code>. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>65:be:bc:3b:c4:d3</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://mitchell-howell.org you initially access a DNS server to translate the host portion (mitchell-howell) combined with the Top Level Domain (org) of the URL, to an IP address like <code>45.83.109.89</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (Windows NT 6.1; WOW64; Trident/7.0; AS; rv:11.0) like Gecko</code>
...
<pre><code>
default   fe80:298f:a0f:fb0d:614c%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {189.79.74.202, 23.224.136.129}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 65:be:bc:3b:c4:d3
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr b3:b7:e0:1f:de:d4
}</code></pre>
