...
layout: research
ip_v4_address: "0.53.143.212"
date: 2022-05-05T14:29:45+01:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like ```0.53.143.212``` or an IPv6 address like ```2000:eeee:f7ce:bcb6:240e:f2b:d646:ea85```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```7c:7c:57:9d:21:20```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://gutkowski.net you initially access a DNS server to translate the host portion (gutkowski) combined with the Top Level Domain (net) of the URL, to an IP address like ```61.144.158.144```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_3) AppleWebKit/537.75.14 (KHTML, like Gecko) Version/7.0.3 Safari/7046A194A```
...
<pre>
default   fe80:6ed9:2a33:b012:77e%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {81.33.149.195, 1.220.222.32}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 7c:7c:57:9d:21:20
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 92:29:72:38:ae:87
}</pre>
