...
layout: research
ip_v4_address: "9.244.214.113"
date: 2023-02-04T17:07:42+00:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like ```9.244.214.113``` or an IPv6 address like ```2000:6cb1:3c39:c6cd:4245:a19a:f991:5afe```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```40:0b:63:cf:04:db```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://lesch-shanahan.io you initially access a DNS server to translate the host portion (lesch-shanahan) combined with the Top Level Domain (io) of the URL, to an IP address like ```44.197.166.202```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_3) AppleWebKit/537.75.14 (KHTML, like Gecko) Version/7.0.3 Safari/7046A194A```
...
<pre>
default   4300:60:1695:f32c:d67b:fa52:6e6b:c101%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {215.130.157.225, 187.71.56.117}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 40:0b:63:cf:04:db
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 60:10:3b:c2:5b:57
}</pre>
