...
layout: research
ip_v4_address: "91.212.157.106"
date: 2022-11-02T11:32:24+00:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like ```91.212.157.106``` or an IPv6 address like ```2000:637c:5bf4:f4b:d939:8e23:d119:3e1```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```21:2c:34:f5:41:c3```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://schneider.com you initially access a DNS server to translate the host portion (schneider) combined with the Top Level Domain (com) of the URL, to an IP address like ```14.142.107.164```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT x.y; Win64; x64; rv:10.0) Gecko/20100101 Firefox/10.0```

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```192.168.142.69``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  192.168.142.69    UGScg  en0
...
<pre>
default   fe80:f95b:cc14:79a:a603%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {22.51.100.135, 183.50.221.66}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 21:2c:34:f5:41:c3
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr c0:90:68:1d:61:60
}</pre>
