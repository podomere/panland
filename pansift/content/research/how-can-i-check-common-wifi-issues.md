...
subtitle: "Learnings?"
layout: research
ip_v4_address: "70.22.248.120"
date: 2022-11-02T11:32:24+00:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like ```70.22.248.120``` or an IPv6 address like ```2000:26d:a7db:ea05:795e:da32:c609:a3ea```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```74:ad:7d:61:da:77```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://brakus.co you initially access a DNS server to translate the host portion (brakus) combined with the Top Level Domain (co) of the URL, to an IP address like ```112.175.247.244```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (compatible; MSIE 9.0; AOL 9.7; AOLBuild 4343.19; Windows NT 6.1; WOW64; Trident/5.0; FunWebProducts)```

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```172.16.208.215``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  172.16.208.215    UGScg  en0
...
<pre>
default   fe80:98ea:770b:e939:16ef%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {229.93.220.62, 219.114.197.125}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 74:ad:7d:61:da:77
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 4c:c0:61:5a:92:20
}</pre>
