...
layout: research
ip_v4_address: "154.29.245.247"
date: 2022-04-24T19:00:01+01:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like <code>154.29.245.247</code> or an IPv6 address like <code>2000:fc36:1175:e3fa:6a25:30f6:d31:97c2</code>. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>71:9d:fc:a5:0a:6f</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://cremin-welch.io you initially access a DNS server to translate the host portion (cremin-welch) combined with the Top Level Domain (io) of the URL, to an IP address like <code>109.112.180.246</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (Windows NT x.y; Win64; x64; rv:10.0) Gecko/20100101 Firefox/10.0</code>
...
<pre><code>
default   fe80:bc81:1461:b157:7fcb%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {253.47.49.213, 207.169.10.116}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 71:9d:fc:a5:0a:6f
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr c7:ea:b4:52:6c:0c
}</code></pre>
