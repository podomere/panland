...
layout: research
ip_v4_address: "13.237.183.208"
date: 2023-10-06T17:10:30+01:00
draft: false
---

## Internet Addressing
On the Internet you may have a Public IPv4 address like ```13.237.183.208``` or an IPv6 address like ```2000:1a6e:e8a:f3d8:7f61:a41a:36c8:7814```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```4d:3d:ff:a2:06:21```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://rath-green.biz you initially access a DNS server to translate the host portion (rath-green) combined with the Top Level Domain (biz) of the URL, to an IP address like ```44.80.177.164```. Your computer and browser actually sends its type with all web requests e.g. <br>```Opera/9.80 (X11; Linux i686; Ubuntu/14.10) Presto/2.12.388 Version/12.16```

## Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```172.19.109.3``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  172.19.109.3    UGScg  en0
...
<pre>
default   fe80:1f83:aa48:574d:8c2b%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {201.150.170.82, 138.105.187.115}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 4d:3d:ff:a2:06:21
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 79:bf:fb:24:2c:dc
}</pre>
...
### Apple macOS / OSX
No matter what version of OSX/macOS you are on, ```10.15.1```, ```11.1.8```, or ```12.0.3```, there are a range of tools for troubleshooting. Unfortunately, between these manual actions and scripts, they don't give you a series of correlated values over time. This is where automated remote troubleshooting comes in to its own, especially for teams that embrace remote work and Work From Anywhere (WFA).
