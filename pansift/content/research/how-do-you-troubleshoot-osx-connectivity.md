...
layout: research
ip_v4_address: "193.55.122.197"
date: 2023-10-29T15:13:19+00:00
draft: false
---

## Internet Addressing
On the Internet you might have a Public IPv4 address like ```193.55.122.197``` or an IPv6 address like ```2000:2778:c77b:71ca:770f:92de:b6e4:c2b2```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```5b:56:77:6f:7f:63```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://medhurst-kris.com you initially access a DNS server to translate the host portion (medhurst-kris) combined with the Top Level Domain (com) of the URL, to an IP address like ```55.196.137.60```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_3) AppleWebKit/537.75.14 (KHTML, like Gecko) Version/7.0.3 Safari/7046A194A```
...
<pre>
default   fe80:5740:cf7c:3ce3:7df8%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {1.158.20.77, 226.109.243.65}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 5b:56:77:6f:7f:63
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 59:3a:bf:a2:35:75
}</pre>
