...
subtitle: "Deep Dive?"
layout: research
ip_v4_address: "77.188.209.207"
date: 2022-05-05T14:28:56+01:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like ```77.188.209.207``` or an IPv6 address like ```2000:ec8e:7f83:6cd3:e6c8:e94e:a9be:edd7```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```ec:19:f1:0f:07:ea```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://hagenes-bruen.io you initially access a DNS server to translate the host portion (hagenes-bruen) combined with the Top Level Domain (io) of the URL, to an IP address like ```46.28.36.164```. Your computer and browser actually sends its type with all web requests e.g. <br>```Opera/9.80 (X11; Linux i686; Ubuntu/14.10) Presto/2.12.388 Version/12.16```
...
<pre>
default   fe80:ee69:7e24:2c22:3f71%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {61.235.177.80, 96.37.20.48}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr ec:19:f1:0f:07:ea
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr b8:dd:f6:88:f1:c8
}</pre>
