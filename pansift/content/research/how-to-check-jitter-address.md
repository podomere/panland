...
layout: research
ip_v4_address: "12.88.173.101"
date: 2023-10-29T15:13:27+00:00
draft: false
---

## Internet Addressing
On the Internet you might have a Public IPv4 address like ```12.88.173.101``` or an IPv6 address like ```2000:231e:2633:dcd3:d9a4:5d11:c944:2c7d```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```89:42:31:2e:31:6d```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://runolfsson-lindgren.net you initially access a DNS server to translate the host portion (runolfsson-lindgren) combined with the Top Level Domain (net) of the URL, to an IP address like ```150.167.129.105```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1; WOW64; Trident/7.0; AS; rv:11.0) like Gecko```
...
<pre>
default   fe80:931f:4cef:348c:50fd%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {185.122.182.232, 177.219.192.204}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 89:42:31:2e:31:6d
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr d2:27:84:30:3e:ae
}</pre>
