...
layout: research
ip_v4_address: "251.206.35.234"
date: 2022-06-04T14:38:43+01:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like ```251.206.35.234``` or an IPv6 address like ```2000:277e:5885:1d9b:59f1:7be7:1d83:fbd9```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```7d:01:84:01:a6:e9```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://kshlerin-feest.net you initially access a DNS server to translate the host portion (kshlerin-feest) combined with the Top Level Domain (net) of the URL, to an IP address like ```240.213.10.236```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/41.0.2228.0 Safari/537.36```
...
<pre>
default   fe80:c42a:64f6:9a8b:c633%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {96.189.63.38, 234.241.3.44}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 7d:01:84:01:a6:e9
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 5f:f7:31:44:fb:a3
}</pre>
