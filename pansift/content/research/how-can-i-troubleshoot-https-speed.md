...
layout: research
ip_v4_address: "143.162.241.5"
date: 2023-02-04T17:08:41+00:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like ```143.162.241.5``` or an IPv6 address like ```2000:152a:853e:32b:7e3d:403a:c269:f47```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```c2:2f:b8:52:b5:77```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://bartoletti-boyer.name you initially access a DNS server to translate the host portion (bartoletti-boyer) combined with the Top Level Domain (name) of the URL, to an IP address like ```156.82.216.65```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1; WOW64; Trident/7.0; AS; rv:11.0) like Gecko```
...
<pre>
default   fe80:5731:7442:2829:ac21%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {18.36.178.78, 87.29.193.229}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr c2:2f:b8:52:b5:77
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 24:fc:3e:bd:6f:4c
}</pre>
