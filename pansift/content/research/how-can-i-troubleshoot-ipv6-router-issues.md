...
layout: research
ip_v4_address: "138.65.40.153"
date: 2022-04-24T18:59:56+01:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like <code>138.65.40.153</code> or an IPv6 address like <code>2000:e214:2502:8813:c5de:aceb:9308:a00b</code>. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>4a:b2:aa:ca:c4:7e</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://cummings-baumbach.info you initially access a DNS server to translate the host portion (cummings-baumbach) combined with the Top Level Domain (info) of the URL, to an IP address like <code>76.125.108.148</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Opera/9.80 (X11; Linux i686; Ubuntu/14.10) Presto/2.12.388 Version/12.16</code>

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like <code>10.9.144.244</code> (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For <code>IPv6</code> we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  10.9.144.244    UGScg  en0
...
<pre><code>
default   fe80:9ccd:9029:ab86:8fee%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {255.28.135.89, 126.142.175.174}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 4a:b2:aa:ca:c4:7e
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 68:9b:66:37:60:80
}</code></pre>
