...
subtitle: "Branding?"
layout: research
ip_v4_address: "60.211.94.156"
date: 2022-06-12T14:09:24+01:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like ```60.211.94.156``` or an IPv6 address like ```2000:41d6:3e2c:ebd3:131f:40d6:93ac:a141```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```f4:62:9b:a4:df:ed```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://walsh-gleichner.io you initially access a DNS server to translate the host portion (walsh-gleichner) combined with the Top Level Domain (io) of the URL, to an IP address like ```208.67.91.119```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT x.y; Win64; x64; rv:10.0) Gecko/20100101 Firefox/10.0```

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```10.15.171.150``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  10.15.171.150    UGScg  en0
...
<pre>
default   fe80:f8c1:638c:ae05:7588%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {243.173.76.67, 35.205.97.7}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr f4:62:9b:a4:df:ed
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr ef:ab:ed:93:56:eb
}</pre>
