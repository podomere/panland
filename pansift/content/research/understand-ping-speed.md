...
layout: research
ip_v4_address: "105.169.163.242"
date: 2022-05-05T14:29:57+01:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like ```105.169.163.242``` or an IPv6 address like ```2000:ad81:f9a2:38a6:fb04:e355:b16a:841d```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```e8:7e:1d:b5:47:93```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://koch-pfannerstill.name you initially access a DNS server to translate the host portion (koch-pfannerstill) combined with the Top Level Domain (name) of the URL, to an IP address like ```78.99.220.34```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows; U; Win 9x 4.90; SG; rv:1.9.2.4) Gecko/20101104 Netscape/9.1.0285```
...
<pre>
default   fe80:2f35:c409:4bbe:9602%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {245.66.93.157, 28.0.86.61}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr e8:7e:1d:b5:47:93
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 6e:e1:0b:a8:3c:d4
}</pre>
