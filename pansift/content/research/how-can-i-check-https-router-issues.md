...
layout: research
ip_v4_address: "170.177.35.22"
date: 2022-11-19T19:13:29+00:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like ```170.177.35.22``` or an IPv6 address like ```2000:f10e:c690:a59e:12db:a4c4:8c05:a04a```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```db:bb:7b:fc:3c:29```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://tromp-fay.name you initially access a DNS server to translate the host portion (tromp-fay) combined with the Top Level Domain (name) of the URL, to an IP address like ```50.65.147.66```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT x.y; Win64; x64; rv:10.0) Gecko/20100101 Firefox/10.0```
...
<pre>
default   fe80:b1:afdd:6e95:66f6%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {213.9.93.200, 245.44.190.174}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr db:bb:7b:fc:3c:29
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 62:e5:3b:c5:3b:e9
}</pre>
