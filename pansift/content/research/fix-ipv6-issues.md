...
layout: research
ip_v4_address: "207.50.159.26"
date: 2022-05-05T14:29:23+01:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like ```207.50.159.26``` or an IPv6 address like ```2000:18c1:1567:9a46:98b1:7bbf:6d8f:28c8```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```82:33:df:45:76:7c```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://reynolds.net you initially access a DNS server to translate the host portion (reynolds) combined with the Top Level Domain (net) of the URL, to an IP address like ```233.31.101.67```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1; WOW64; Trident/7.0; AS; rv:11.0) like Gecko```
...
<pre>
default   fe80:cfba:545:4e60:ec2f%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {67.67.39.196, 99.48.131.61}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 82:33:df:45:76:7c
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr f4:db:51:f1:b8:49
}</pre>
...
## Apple macOS / OSX
No matter what version of OSX/macOS you are on, ```10.11.7```, ```11.4.8```, or ```12.3.1```, there are a range of tools for troubleshooting. Unfortunately, between these manual actions and scripts, they don't give you a series of correlated values over time. This is where automated remote troubleshooting comes in to its own, especially for teams that embrace remote work and Work From Anywhere (WFA).
