...
layout: research
ip_v4_address: "9.104.167.235"
date: 2022-11-19T19:13:16+00:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like ```9.104.167.235``` or an IPv6 address like ```2000:a9b9:abe5:1aa0:f18a:8fcd:697c:474e```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```34:70:8d:4f:bc:2e```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://doyle-lehner.com you initially access a DNS server to translate the host portion (doyle-lehner) combined with the Top Level Domain (com) of the URL, to an IP address like ```74.133.60.92```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (compatible; MSIE 9.0; AOL 9.7; AOLBuild 4343.19; Windows NT 6.1; WOW64; Trident/5.0; FunWebProducts)```
...
<pre>
default   fe80:f327:a0b8:7340:18d8%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {95.34.157.162, 181.134.40.209}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 34:70:8d:4f:bc:2e
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr b5:0c:d5:6e:ef:18
}</pre>
