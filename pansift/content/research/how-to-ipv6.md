...
subtitle: "Synergy?"
layout: research
ip_v4_address: "183.246.182.188"
date: 2022-04-24T18:59:55+01:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like <code>183.246.182.188</code> or an IPv6 address like <code>2000:cec3:f1fd:1fa0:14d4:3270:e0ea:a495</code>. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>dd:8a:82:c6:da:0a</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://roberts-wehner.io you initially access a DNS server to translate the host portion (roberts-wehner) combined with the Top Level Domain (io) of the URL, to an IP address like <code>82.83.88.244</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_3) AppleWebKit/537.75.14 (KHTML, like Gecko) Version/7.0.3 Safari/7046A194A</code>
...
<pre><code>
default   fe80:f07e:b5b9:33a1:9f7a%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {58.76.226.88, 78.4.68.66}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr dd:8a:82:c6:da:0a
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 3f:9b:c2:2b:2f:89
}</code></pre>
