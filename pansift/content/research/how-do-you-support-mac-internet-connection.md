...
subtitle: "Tee It Up?"
layout: research
ip_v4_address: "157.213.46.76"
date: 2022-06-12T14:09:17+01:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like ```157.213.46.76``` or an IPv6 address like ```2000:be0f:7082:7d2:ab71:5e62:ca4d:eb80```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```be:78:5d:39:79:11```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://jaskolski-carter.com you initially access a DNS server to translate the host portion (jaskolski-carter) combined with the Top Level Domain (com) of the URL, to an IP address like ```229.118.88.224```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT x.y; Win64; x64; rv:10.0) Gecko/20100101 Firefox/10.0```
...
<pre>
default   fe80:b9c4:507b:8d10:2a11%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {241.91.59.188, 34.159.149.62}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr be:78:5d:39:79:11
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 1b:39:f0:6d:c9:f9
}</pre>
