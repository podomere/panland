...
subtitle: "Etc. Etc.?"
layout: research
ip_v4_address: "123.230.245.65"
date: 2022-11-19T19:13:16+00:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like ```123.230.245.65``` or an IPv6 address like ```2000:9c79:9466:b072:c969:9189:34a3:1f80```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```a9:5f:fa:24:4f:52```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://donnelly.info you initially access a DNS server to translate the host portion (donnelly) combined with the Top Level Domain (info) of the URL, to an IP address like ```118.84.182.100```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_3) AppleWebKit/537.75.14 (KHTML, like Gecko) Version/7.0.3 Safari/7046A194A```
...
<pre>
default   fe80:adb1:62c5:2312:abf2%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {131.236.206.6, 208.110.244.155}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr a9:5f:fa:24:4f:52
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr aa:bb:1c:1c:55:3c
}</pre>
