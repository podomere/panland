...
layout: research
ip_v4_address: "149.65.188.182"
date: 2023-02-04T16:26:20+00:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like ```149.65.188.182``` or an IPv6 address like ```2000:9eb3:58ef:7d4f:477:2c6b:d552:4b59```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```da:2d:e6:d5:27:33```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://crist-buckridge.info you initially access a DNS server to translate the host portion (crist-buckridge) combined with the Top Level Domain (info) of the URL, to an IP address like ```193.223.160.171```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_3) AppleWebKit/537.75.14 (KHTML, like Gecko) Version/7.0.3 Safari/7046A194A```
...
<pre>
default   fe80:5610:d25e:9d01:b8d1%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {183.16.76.7, 209.173.182.7}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr da:2d:e6:d5:27:33
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 9e:1a:d9:36:11:52
}</pre>
