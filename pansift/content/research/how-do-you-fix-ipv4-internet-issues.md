...
subtitle: "Tee It Up?"
layout: research
ip_v4_address: "253.205.203.96"
date: 2023-10-06T17:11:04+01:00
draft: false
---

## Internet Addressing
On the Internet you might have a Public IPv4 address like ```253.205.203.96``` or an IPv6 address like ```2000:deaa:f5ec:2708:bfdb:6ae7:293f:1975```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```3e:3e:7b:69:73:f0```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://wilderman.name you initially access a DNS server to translate the host portion (wilderman) combined with the Top Level Domain (name) of the URL, to an IP address like ```202.157.98.145```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT x.y; Win64; x64; rv:10.0) Gecko/20100101 Firefox/10.0```

## Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```10.89.97.185``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  10.89.97.185    UGScg  en0
...
<pre>
default   fe80:9562:12ad:4c6e:4835%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {112.95.177.80, 198.228.41.157}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 3e:3e:7b:69:73:f0
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr c7:e8:de:21:de:01
}</pre>
...
### Apple macOS / OSX
No matter what version of OSX/macOS you are on, ```10.12.8```, ```11.6.7```, or ```12.0.3```, there are a range of tools for troubleshooting. Unfortunately, between these manual actions and scripts, they don't give you a series of correlated values over time. This is where automated remote troubleshooting comes in to its own, especially for teams that embrace remote work and Work From Anywhere (WFA).
