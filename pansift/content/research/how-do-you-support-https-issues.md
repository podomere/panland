...
subtitle: "Tee It Up?"
layout: research
ip_v4_address: "223.157.80.174"
date: 2022-11-19T19:13:29+00:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like ```223.157.80.174``` or an IPv6 address like ```2000:ae1e:1946:5faa:4486:9bf1:aa52:5d72```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```85:de:4f:7d:5a:0c```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://kozey-wisozk.com you initially access a DNS server to translate the host portion (kozey-wisozk) combined with the Top Level Domain (com) of the URL, to an IP address like ```174.247.170.244```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_3) AppleWebKit/537.75.14 (KHTML, like Gecko) Version/7.0.3 Safari/7046A194A```
...
<pre>
default   fe80:ebb5:c1a4:413b:2670%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {209.177.168.69, 146.190.178.16}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 85:de:4f:7d:5a:0c
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr ca:a3:d2:a3:80:c0
}</pre>
