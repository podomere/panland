...
layout: research
ip_v4_address: "148.201.182.21"
date: 2023-02-04T16:26:23+00:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like ```148.201.182.21``` or an IPv6 address like ```2000:28aa:c232:cd0e:45fd:f563:cd49:d7df```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```67:68:f6:16:01:99```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://heller.biz you initially access a DNS server to translate the host portion (heller) combined with the Top Level Domain (biz) of the URL, to an IP address like ```25.41.252.135```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (compatible; MSIE 9.0; AOL 9.7; AOLBuild 4343.19; Windows NT 6.1; WOW64; Trident/5.0; FunWebProducts)```
...
<pre>
default   fe80:4218:a9c2:fe03:a1a4%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {59.249.50.120, 47.255.132.62}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 67:68:f6:16:01:99
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 9e:0e:a9:f4:7a:af
}</pre>
