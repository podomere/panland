...
layout: research
ip_v4_address: "126.8.92.18"
date: 2022-04-24T19:00:33+01:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like <code>126.8.92.18</code> or an IPv6 address like <code>2000:c4e7:253c:625b:ea1:eaf5:ab12:834c</code>. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>db:8a:7e:9a:c1:1e</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://schulist-haag.com you initially access a DNS server to translate the host portion (schulist-haag) combined with the Top Level Domain (com) of the URL, to an IP address like <code>180.205.152.33</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (Windows NT 6.1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/41.0.2228.0 Safari/537.36</code>
...
<pre><code>
default   fe80:2cc8:8f4d:5953:ef5c%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {162.109.28.228, 230.19.12.18}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr db:8a:7e:9a:c1:1e
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 04:cd:82:40:4e:53
}</code></pre>
