...
layout: research
ip_v4_address: "179.184.147.119"
date: 2023-02-04T17:07:42+00:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like ```179.184.147.119``` or an IPv6 address like ```2000:4db4:a34f:d41d:8d2e:a01f:b12:4052```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```13:54:8e:f0:6f:02```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://parisian-bruen.org you initially access a DNS server to translate the host portion (parisian-bruen) combined with the Top Level Domain (org) of the URL, to an IP address like ```231.251.145.117```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_3) AppleWebKit/537.75.14 (KHTML, like Gecko) Version/7.0.3 Safari/7046A194A```
...
<pre>
default   fe80:db6d:1dc1:1613:ec3b%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {244.118.136.200, 190.21.212.57}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 13:54:8e:f0:6f:02
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 11:7b:8b:4a:63:1b
}</pre>
