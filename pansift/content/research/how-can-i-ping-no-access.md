---
title: "How Can I Ping No-access"
subtitle: "Synergy?"
layout: research
ip_v4_address: "218.154.9.31"
date: 2022-11-02T11:32:59+00:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like ```218.154.9.31``` or an IPv6 address like ```2000:608:9219:6e5b:cd96:f592:7302:ec78```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```8a:b3:78:a9:c9:c4```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://okeefe-langosh.info you initially access a DNS server to translate the host portion (okeefe-langosh) combined with the Top Level Domain (info) of the URL, to an IP address like ```9.104.158.238```. Your computer and browser actually sends its type with all web requests e.g. <br>```Opera/9.80 (X11; Linux i686; Ubuntu/14.10) Presto/2.12.388 Version/12.16```

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```192.168.251.184``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  192.168.251.184    UGScg  en0
...
<pre>
default   fe80:e8f0:5da2:245:afac%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {157.77.106.70, 17.109.0.66}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 8a:b3:78:a9:c9:c4
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 1a:4e:ed:5d:60:49
}</pre>
