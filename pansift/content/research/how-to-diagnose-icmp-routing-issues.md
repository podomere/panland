...
layout: research
ip_v4_address: "231.207.65.219"
date: 2022-05-05T14:29:51+01:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like ```231.207.65.219``` or an IPv6 address like ```2000:ef06:3e3:f8a8:a3b9:7aa7:6cf:1538```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```05:34:f2:ae:4c:e8```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://hilll-ziemann.name you initially access a DNS server to translate the host portion (hilll-ziemann) combined with the Top Level Domain (name) of the URL, to an IP address like ```175.197.5.75```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1; WOW64; Trident/7.0; AS; rv:11.0) like Gecko```

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```10.161.225.216``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  10.161.225.216    UGScg  en0
...
<pre>
default   fe80:6e88:5267:9852:4188%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {174.127.220.106, 132.191.156.254}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 05:34:f2:ae:4c:e8
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 2b:ba:cc:e9:97:a3
}</pre>
