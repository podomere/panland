...
layout: research
ip_v4_address: "9.68.61.3"
date: 2022-06-12T14:09:17+01:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like ```9.68.61.3``` or an IPv6 address like ```2000:d63d:d387:24c5:34c4:1dae:eb5c:612f```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```6c:b4:c8:34:69:1e```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://glover-lindgren.net you initially access a DNS server to translate the host portion (glover-lindgren) combined with the Top Level Domain (net) of the URL, to an IP address like ```159.10.82.9```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT x.y; Win64; x64; rv:10.0) Gecko/20100101 Firefox/10.0```
...
<pre>
default   fe80:f77e:6b57:c5c7:f36f%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {82.27.249.151, 185.86.238.151}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 6c:b4:c8:34:69:1e
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 38:9c:3c:ac:03:54
}</pre>
