...
layout: research
ip_v4_address: "178.58.76.40"
date: 2022-11-02T11:32:59+00:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like ```178.58.76.40``` or an IPv6 address like ```2000:a6ef:62f0:7e72:4be6:7612:da1:20db```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```31:cf:d6:38:8a:56```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://schuppe-grimes.io you initially access a DNS server to translate the host portion (schuppe-grimes) combined with the Top Level Domain (io) of the URL, to an IP address like ```228.109.4.8```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1; WOW64; Trident/7.0; AS; rv:11.0) like Gecko```
...
<pre>
default   fe80:7ef7:19e0:1f71:ce2c%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {248.10.0.89, 45.68.137.240}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 31:cf:d6:38:8a:56
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 86:d7:9e:a8:47:40
}</pre>
