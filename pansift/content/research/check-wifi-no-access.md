...
subtitle: "Swim Lane?"
layout: research
ip_v4_address: "166.151.112.197"
date: 2022-11-19T16:17:05+00:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like ```166.151.112.197``` or an IPv6 address like ```2000:1eb1:4737:aa2d:e1a:208d:42a4:ba7d```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```dd:dd:80:f1:eb:34```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://hackett-parisian.com you initially access a DNS server to translate the host portion (hackett-parisian) combined with the Top Level Domain (com) of the URL, to an IP address like ```226.243.11.48```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows; U; Win 9x 4.90; SG; rv:1.9.2.4) Gecko/20101104 Netscape/9.1.0285```
...
<pre>
default   fe80:8606:a53a:6554:e000%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {58.84.100.82, 150.22.64.129}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr dd:dd:80:f1:eb:34
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 78:d1:40:11:d1:f6
}</pre>
