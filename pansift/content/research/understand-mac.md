...
layout: research
ip_v4_address: "227.242.8.220"
date: 2022-04-24T18:31:59+01:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like <code>227.242.8.220</code> or an IPv6 address like <code>2000:93fc:de7e:d5c9:71bd:ebcb:ba3c:30d6</code>. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>b8:85:9d:e0:d3:8c</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://tromp-lockman.co you initially access a DNS server to translate the host portion (tromp-lockman) combined with the Top Level Domain (co) of the URL, to an IP address like <code>62.175.174.255</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (Windows NT x.y; Win64; x64; rv:10.0) Gecko/20100101 Firefox/10.0</code>
...
<pre><code>
default   fe80:987b:148f:c562:4bd5%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {241.229.4.43, 4.230.78.145}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr b8:85:9d:e0:d3:8c
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 21:e5:0d:46:91:8d
}</code></pre>
