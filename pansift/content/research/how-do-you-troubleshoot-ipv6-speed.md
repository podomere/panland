...
layout: research
ip_v4_address: "5.150.94.42"
date: 2022-06-12T14:09:24+01:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like ```5.150.94.42``` or an IPv6 address like ```2000:457b:c2c3:db33:70e8:a14a:d33b:947```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```e9:25:04:a4:b1:b9```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://wiza-bode.io you initially access a DNS server to translate the host portion (wiza-bode) combined with the Top Level Domain (io) of the URL, to an IP address like ```62.40.97.163```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_3) AppleWebKit/537.75.14 (KHTML, like Gecko) Version/7.0.3 Safari/7046A194A```
...
<pre>
default   fe80:173d:5871:2786:f23a%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {242.101.91.69, 157.158.184.31}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr e9:25:04:a4:b1:b9
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 68:c9:38:2a:12:04
}</pre>
