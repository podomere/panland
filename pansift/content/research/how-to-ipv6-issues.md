...
layout: research
ip_v4_address: "60.245.140.96"
date: 2023-02-04T17:08:34+00:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like ```60.245.140.96``` or an IPv6 address like ```2000:4e5:bbe3:a4b:2590:7efe:c201:234c```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```54:eb:1b:a0:5e:1f```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://harvey-kohler.co you initially access a DNS server to translate the host portion (harvey-kohler) combined with the Top Level Domain (co) of the URL, to an IP address like ```198.170.172.45```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1; WOW64; Trident/7.0; AS; rv:11.0) like Gecko```
...
<pre>
default   fe80:11f1:74e2:d121:96da%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {19.84.198.57, 61.221.133.3}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 54:eb:1b:a0:5e:1f
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 18:85:f4:6b:96:78
}</pre>
