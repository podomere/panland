...
layout: research
ip_v4_address: "235.93.150.32"
date: 2022-11-19T19:13:16+00:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like ```235.93.150.32``` or an IPv6 address like ```2000:b7d4:d3a6:59fc:2195:9824:2451:a8d7```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```72:6d:6a:cf:84:0e```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://kautzer-keebler.name you initially access a DNS server to translate the host portion (kautzer-keebler) combined with the Top Level Domain (name) of the URL, to an IP address like ```103.244.216.40```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows; U; Win 9x 4.90; SG; rv:1.9.2.4) Gecko/20101104 Netscape/9.1.0285```

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```172.18.122.82``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  172.18.122.82    UGScg  en0
...
<pre>
default   fe80:3588:481e:caa8:7581%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {145.53.127.30, 220.240.201.22}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 72:6d:6a:cf:84:0e
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 8d:1c:2e:ed:2e:2e
}</pre>
