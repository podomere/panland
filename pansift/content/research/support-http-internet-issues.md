...
layout: research
ip_v4_address: "189.78.10.0"
date: 2022-11-19T16:17:24+00:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like ```189.78.10.0``` or an IPv6 address like ```2000:ef55:790c:aec5:5f71:bc05:2e25:2c54```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```ef:11:dd:61:7f:e8```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://hettinger-gutkowski.biz you initially access a DNS server to translate the host portion (hettinger-gutkowski) combined with the Top Level Domain (biz) of the URL, to an IP address like ```35.61.17.67```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/41.0.2228.0 Safari/537.36```
...
<pre>
default   fe80:f1d1:4a39:be2f:b072%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {76.55.87.216, 32.230.195.113}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr ef:11:dd:61:7f:e8
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr de:78:fc:7a:5c:eb
}</pre>
