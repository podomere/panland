...
layout: research
ip_v4_address: "41.31.222.110"
date: 2022-12-15T13:50:17+00:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like ```41.31.222.110``` or an IPv6 address like ```2000:5045:e03c:feb4:c9de:26cf:74e6:2ae6```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```6a:88:d8:80:2b:21```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://schumm.biz you initially access a DNS server to translate the host portion (schumm) combined with the Top Level Domain (biz) of the URL, to an IP address like ```194.206.119.47```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (compatible; MSIE 9.0; AOL 9.7; AOLBuild 4343.19; Windows NT 6.1; WOW64; Trident/5.0; FunWebProducts)```
...
<pre>
default   fe80:f9b6:43c:37ca:5dbf%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {129.211.130.124, 59.198.220.61}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 6a:88:d8:80:2b:21
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr d9:e4:9b:98:2f:6b
}</pre>
...
## Apple macOS / OSX
No matter what version of OSX/macOS you are on, ```10.13.4```, ```11.5.2```, or ```12.3.7```, there are a range of tools for troubleshooting. Unfortunately, between these manual actions and scripts, they don't give you a series of correlated values over time. This is where automated remote troubleshooting comes in to its own, especially for teams that embrace remote work and Work From Anywhere (WFA).
