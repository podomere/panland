...
layout: research
ip_v4_address: "156.181.183.126"
date: 2022-04-24T19:00:01+01:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like <code>156.181.183.126</code> or an IPv6 address like <code>2000:810c:56b9:a534:de9:2025:30b3:8f74</code>. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>3c:1c:0f:2f:ad:95</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://turcotte-kovacek.io you initially access a DNS server to translate the host portion (turcotte-kovacek) combined with the Top Level Domain (io) of the URL, to an IP address like <code>163.204.48.174</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_3) AppleWebKit/537.75.14 (KHTML, like Gecko) Version/7.0.3 Safari/7046A194A</code>
...
<pre><code>
default   fe80:b13d:a34c:6f03:dd27%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {34.45.5.197, 139.144.57.10}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 3c:1c:0f:2f:ad:95
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 4c:d4:b9:4b:ee:d6
}</code></pre>
