---
title: "How Do You Check Icmp Internet Issues"
subtitle: "Ideate?"
layout: research
ip_v4_address: "32.208.122.17"
date: 2022-12-15T13:50:19+00:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like ```32.208.122.17``` or an IPv6 address like ```2000:65bc:8d39:253e:aec9:d493:d51d:8e35```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```fb:f7:a1:af:f9:9e```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://halvorson.co you initially access a DNS server to translate the host portion (halvorson) combined with the Top Level Domain (co) of the URL, to an IP address like ```41.86.239.35```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (compatible; MSIE 9.0; AOL 9.7; AOLBuild 4343.19; Windows NT 6.1; WOW64; Trident/5.0; FunWebProducts)```

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```172.31.137.31``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  172.31.137.31    UGScg  en0
...
<pre>
default   fe80:e7f9:a601:f22:c4e8%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {236.199.225.194, 165.204.229.63}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr fb:f7:a1:af:f9:9e
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr aa:96:63:06:9a:2f
}</pre>
...
## Apple macOS / OSX
No matter what version of OSX/macOS you are on, ```10.12.7```, ```11.2.5```, or ```12.0.3```, there are a range of tools for troubleshooting. Unfortunately, between these manual actions and scripts, they don't give you a series of correlated values over time. This is where automated remote troubleshooting comes in to its own, especially for teams that embrace remote work and Work From Anywhere (WFA).
