...
layout: research
ip_v4_address: "165.93.241.190"
date: 2022-11-02T11:32:59+00:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like ```165.93.241.190``` or an IPv6 address like ```2000:7f37:e99c:4cb5:4b6b:30e:ccb6:eae8```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```65:8f:e6:8b:df:f1```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://mills-bartoletti.name you initially access a DNS server to translate the host portion (mills-bartoletti) combined with the Top Level Domain (name) of the URL, to an IP address like ```15.235.241.78```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_3) AppleWebKit/537.75.14 (KHTML, like Gecko) Version/7.0.3 Safari/7046A194A```
...
<pre>
default   fe80:3ff7:fae8:3b6b:d8d7%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {62.198.154.164, 196.198.251.65}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 65:8f:e6:8b:df:f1
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 07:86:6f:a1:1f:7e
}</pre>
