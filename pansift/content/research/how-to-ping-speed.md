...
layout: research
ip_v4_address: "36.140.176.178"
date: 2022-11-19T16:17:23+00:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like ```36.140.176.178``` or an IPv6 address like ```2000:7629:557c:1b36:af66:7cae:7311:4248```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```0f:7b:3d:da:26:55```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://beier-hickle.info you initially access a DNS server to translate the host portion (beier-hickle) combined with the Top Level Domain (info) of the URL, to an IP address like ```61.131.156.238```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT x.y; Win64; x64; rv:10.0) Gecko/20100101 Firefox/10.0```
...
<pre>
default   fe80:409b:9a3:66d2:61d7%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {62.207.239.244, 177.56.239.36}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 0f:7b:3d:da:26:55
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 46:8c:9a:c0:28:0e
}</pre>
