...
layout: research
ip_v4_address: "56.61.69.23"
date: 2022-11-19T19:13:29+00:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like ```56.61.69.23``` or an IPv6 address like ```2000:701e:2ca2:f8e8:b8c2:7ac5:ce96:986f```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```e8:15:60:7a:8f:23```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://mills-paucek.info you initially access a DNS server to translate the host portion (mills-paucek) combined with the Top Level Domain (info) of the URL, to an IP address like ```168.237.190.14```. Your computer and browser actually sends its type with all web requests e.g. <br>```Opera/9.80 (X11; Linux i686; Ubuntu/14.10) Presto/2.12.388 Version/12.16```
...
<pre>
default   fe80:623a:a4d6:82e7:fba2%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {162.197.42.8, 128.182.210.87}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr e8:15:60:7a:8f:23
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr ce:3f:9b:f2:1a:54
}</pre>
