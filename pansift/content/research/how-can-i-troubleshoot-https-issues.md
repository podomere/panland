...
subtitle: "Swim Lane?"
layout: research
ip_v4_address: "7.127.44.24"
date: 2022-06-12T14:09:29+01:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like ```7.127.44.24``` or an IPv6 address like ```2000:551:9968:b1ca:f99c:7f5:e8d9:c369```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```e6:c7:36:6a:28:57```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://hermann-wolf.name you initially access a DNS server to translate the host portion (hermann-wolf) combined with the Top Level Domain (name) of the URL, to an IP address like ```227.247.182.166```. Your computer and browser actually sends its type with all web requests e.g. <br>```Opera/9.80 (X11; Linux i686; Ubuntu/14.10) Presto/2.12.388 Version/12.16```
...
<pre>
default   fe80:4e97:b5bd:8a34:469%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {17.88.74.6, 81.63.61.64}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr e6:c7:36:6a:28:57
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 79:76:ee:06:e1:81
}</pre>
