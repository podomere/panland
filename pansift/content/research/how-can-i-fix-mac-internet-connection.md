...
subtitle: "Streamline?"
layout: research
ip_v4_address: "217.133.42.17"
date: 2022-05-05T14:28:57+01:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like ```217.133.42.17``` or an IPv6 address like ```2000:15f2:1608:35a7:d4f3:70bc:292:ea77```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```c8:ab:e7:be:2b:68```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://kling-howe.com you initially access a DNS server to translate the host portion (kling-howe) combined with the Top Level Domain (com) of the URL, to an IP address like ```10.42.90.19```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (compatible; MSIE 9.0; AOL 9.7; AOLBuild 4343.19; Windows NT 6.1; WOW64; Trident/5.0; FunWebProducts)```
...
<pre>
default   fe80:ac8a:238a:5316:3220%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {13.94.119.139, 81.146.41.239}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr c8:ab:e7:be:2b:68
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 0e:d8:61:72:52:af
}</pre>
