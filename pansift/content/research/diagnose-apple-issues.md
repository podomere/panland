...
layout: research
ip_v4_address: "2.131.5.189"
date: 2023-02-04T16:26:11+00:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like ```2.131.5.189``` or an IPv6 address like ```2000:8daf:ae18:2bc9:f825:b971:afb2:c74f```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```b3:ce:fb:03:1d:fc```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://dicki-bode.net you initially access a DNS server to translate the host portion (dicki-bode) combined with the Top Level Domain (net) of the URL, to an IP address like ```114.73.250.5```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_3) AppleWebKit/537.75.14 (KHTML, like Gecko) Version/7.0.3 Safari/7046A194A```
...
<pre>
default   fe80:1893:8e39:3b0b:47d7%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {114.115.97.223, 70.170.19.193}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr b3:ce:fb:03:1d:fc
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 33:87:c0:06:38:6d
}</pre>
