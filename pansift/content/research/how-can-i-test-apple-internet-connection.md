...
layout: research
ip_v4_address: "218.130.235.132"
date: 2022-05-05T14:28:54+01:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like ```218.130.235.132``` or an IPv6 address like ```2000:6ebc:8b21:9732:7a74:4126:a6b1:4c56```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```28:1c:89:2d:31:15```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://spinka-ryan.io you initially access a DNS server to translate the host portion (spinka-ryan) combined with the Top Level Domain (io) of the URL, to an IP address like ```136.14.65.188```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_3) AppleWebKit/537.75.14 (KHTML, like Gecko) Version/7.0.3 Safari/7046A194A```
...
<pre>
default   fe80:b4f:968e:3d4f:828a%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {77.248.182.81, 138.115.97.150}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 28:1c:89:2d:31:15
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 08:86:0d:d8:cd:f2
}</pre>
