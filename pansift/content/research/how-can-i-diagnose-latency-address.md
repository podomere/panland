...
layout: research
ip_v4_address: "59.192.101.21"
date: 2022-04-24T18:59:58+01:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like <code>59.192.101.21</code> or an IPv6 address like <code>2000:59e4:f0e8:c85a:54cd:574d:71c2:7275</code>. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>a6:dd:f8:ce:d4:8f</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://aufderhar.info you initially access a DNS server to translate the host portion (aufderhar) combined with the Top Level Domain (info) of the URL, to an IP address like <code>86.66.194.228</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (Windows NT 6.1; WOW64; Trident/7.0; AS; rv:11.0) like Gecko</code>
...
<pre><code>
default   fe80:4789:ef2a:db04:b0ba%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {186.100.131.185, 124.87.231.34}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr a6:dd:f8:ce:d4:8f
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr d0:d2:3d:b1:03:5c
}</code></pre>
