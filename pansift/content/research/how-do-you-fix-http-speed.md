...
layout: research
ip_v4_address: "67.28.80.24"
date: 2022-04-24T19:00:04+01:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like <code>67.28.80.24</code> or an IPv6 address like <code>2000:1a6c:262d:1b5f:75ad:8353:344c:555f</code>. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>d8:9b:7c:8d:a6:e8</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://kulas-wisozk.io you initially access a DNS server to translate the host portion (kulas-wisozk) combined with the Top Level Domain (io) of the URL, to an IP address like <code>89.253.204.157</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Opera/9.80 (X11; Linux i686; Ubuntu/14.10) Presto/2.12.388 Version/12.16</code>
...
<pre><code>
default   fe80:9890:6017:7eff:722e%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {153.240.247.120, 158.115.53.87}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr d8:9b:7c:8d:a6:e8
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr f5:6c:58:a6:56:c2
}</code></pre>
