...
layout: research
ip_v4_address: "227.143.71.54"
date: 2022-06-04T14:38:17+01:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like ```227.143.71.54``` or an IPv6 address like ```83:c739:e309:ba8b:4a0b:6ace:d2bb:7c52```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```83:28:d3:5e:ca:32```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://haag-brekke.net you initially access a DNS server to translate the host portion (haag-brekke) combined with the Top Level Domain (net) of the URL, to an IP address like ```183.7.95.252```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_3) AppleWebKit/537.75.14 (KHTML, like Gecko) Version/7.0.3 Safari/7046A194A```
...
<pre>
default   fe80:25b9:78d7:d337:c8bd%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {6.195.4.192, 13.105.81.91}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 83:28:d3:5e:ca:32
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 57:11:6a:34:47:d3
}</pre>
