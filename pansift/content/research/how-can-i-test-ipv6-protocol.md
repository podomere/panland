...
layout: research
ip_v4_address: "30.82.105.162"
date: 2022-05-05T14:29:27+01:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like ```30.82.105.162``` or an IPv6 address like ```2000:2318:deff:deee:4b46:f204:d602:6f56```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```3f:06:c5:3c:48:7d```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://greenfelder-herzog.biz you initially access a DNS server to translate the host portion (greenfelder-herzog) combined with the Top Level Domain (biz) of the URL, to an IP address like ```222.253.184.251```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows; U; Win 9x 4.90; SG; rv:1.9.2.4) Gecko/20101104 Netscape/9.1.0285```

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```10.176.209.128``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  10.176.209.128    UGScg  en0
...
<pre>
default   fe80:a864:995e:bd10:852e%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {65.132.158.218, 76.226.88.161}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 3f:06:c5:3c:48:7d
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 1c:fe:9a:63:3c:90
}</pre>
