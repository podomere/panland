...
subtitle: "Ideate?"
layout: research
ip_v4_address: "89.147.214.204"
date: 2023-10-06T17:11:07+01:00
draft: false
---

## Internet Addressing
On the Internet you might have a Public IPv4 address like ```89.147.214.204``` or an IPv6 address like ```2000:7cbb:b4d:b31b:4b59:4f65:3b34:6a94```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```ed:d4:66:62:11:5e```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://jerde-kunde.net you initially access a DNS server to translate the host portion (jerde-kunde) combined with the Top Level Domain (net) of the URL, to an IP address like ```117.112.251.26```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1; WOW64; Trident/7.0; AS; rv:11.0) like Gecko```

## Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```192.168.35.48``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  192.168.35.48    UGScg  en0
...
<pre>
default   fe80:e55e:a248:d0c4:7882%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {254.24.134.55, 62.194.110.218}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr ed:d4:66:62:11:5e
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr f6:22:5a:43:b6:a4
}</pre>
