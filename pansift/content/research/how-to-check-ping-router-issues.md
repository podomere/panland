...
subtitle: "Swag?"
layout: research
ip_v4_address: "158.131.50.22"
date: 2022-11-02T11:32:59+00:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like ```158.131.50.22``` or an IPv6 address like ```2000:20d3:4fc1:7d5b:6649:165f:10e:3e4```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```9a:d9:0e:e8:5a:5a```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://reinger.co you initially access a DNS server to translate the host portion (reinger) combined with the Top Level Domain (co) of the URL, to an IP address like ```238.239.30.175```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_3) AppleWebKit/537.75.14 (KHTML, like Gecko) Version/7.0.3 Safari/7046A194A```

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```172.26.245.52``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  172.26.245.52    UGScg  en0
...
<pre>
default   fe80:de7f:c38e:540b:c3e7%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {253.139.129.109, 242.29.129.173}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 9a:d9:0e:e8:5a:5a
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr d6:a6:5a:49:b3:cf
}</pre>
