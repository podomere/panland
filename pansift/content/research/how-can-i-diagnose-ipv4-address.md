...
layout: research
ip_v4_address: "160.203.191.146"
date: 2023-02-04T17:08:35+00:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like ```160.203.191.146``` or an IPv6 address like ```2000:4494:fd29:8ade:cddd:cc90:bf5:d084```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```79:d4:b2:c9:81:e4```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://hills-okon.biz you initially access a DNS server to translate the host portion (hills-okon) combined with the Top Level Domain (biz) of the URL, to an IP address like ```222.231.152.118```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT x.y; Win64; x64; rv:10.0) Gecko/20100101 Firefox/10.0```

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```10.221.65.177``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  10.221.65.177    UGScg  en0
...
<pre>
default   fe80:e2ad:ac79:7f98:ed7%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {191.42.154.89, 134.221.51.99}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 79:d4:b2:c9:81:e4
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 89:f8:f3:c9:87:27
}</pre>
