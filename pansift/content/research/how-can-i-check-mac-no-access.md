...
layout: research
ip_v4_address: "56.116.3.145"
date: 2022-06-12T14:09:17+01:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like ```56.116.3.145``` or an IPv6 address like ```2000:755c:40ef:ce70:a81f:23d5:6e01:e295```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```fc:fc:42:25:61:59```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://windler-funk.net you initially access a DNS server to translate the host portion (windler-funk) combined with the Top Level Domain (net) of the URL, to an IP address like ```146.243.153.197```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows; U; Win 9x 4.90; SG; rv:1.9.2.4) Gecko/20101104 Netscape/9.1.0285```
...
<pre>
default   fe80:cc:afc3:5b89:1095%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {44.45.165.185, 27.51.154.194}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr fc:fc:42:25:61:59
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 50:1d:f7:ef:a0:80
}</pre>
