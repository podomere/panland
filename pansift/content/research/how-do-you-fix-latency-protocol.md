...
layout: research
ip_v4_address: "186.39.91.11"
date: 2023-02-04T16:26:19+00:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like ```186.39.91.11``` or an IPv6 address like ```2000:e27c:d3bc:ed35:1736:61fa:d0f4:57f2```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```02:ec:02:e2:f8:0e```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://herman-lind.org you initially access a DNS server to translate the host portion (herman-lind) combined with the Top Level Domain (org) of the URL, to an IP address like ```110.6.98.90```. Your computer and browser actually sends its type with all web requests e.g. <br>```Opera/9.80 (X11; Linux i686; Ubuntu/14.10) Presto/2.12.388 Version/12.16```
...
<pre>
default   fe80:e034:f587:e40e:f109%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {113.29.172.135, 174.4.30.124}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 02:ec:02:e2:f8:0e
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr c2:f9:2d:b9:34:e3
}</pre>
