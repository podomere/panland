...
layout: research
ip_v4_address: "169.249.202.198"
date: 2022-11-02T11:32:55+00:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like ```169.249.202.198``` or an IPv6 address like ```2000:956b:7b14:34b:86bc:636e:9d18:ea03```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```06:48:b5:b2:e3:5c```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://olson-hyatt.com you initially access a DNS server to translate the host portion (olson-hyatt) combined with the Top Level Domain (com) of the URL, to an IP address like ```3.217.32.166```. Your computer and browser actually sends its type with all web requests e.g. <br>```Opera/9.80 (X11; Linux i686; Ubuntu/14.10) Presto/2.12.388 Version/12.16```

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```172.23.66.53``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  172.23.66.53    UGScg  en0
...
<pre>
default   fe80:f8b9:5d3a:4492:56bf%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {116.151.130.44, 251.199.235.175}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 06:48:b5:b2:e3:5c
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 92:01:52:17:00:1d
}</pre>
...
## Apple macOS / OSX
No matter what version of OSX/macOS you are on, ```10.12.9```, ```11.3.4```, or ```12.1.4```, there are a range of tools for troubleshooting. Unfortunately, between these manual actions and scripts, they don't give you a series of correlated values over time. This is where automated remote troubleshooting comes in to its own, especially for teams that embrace remote work and Work From Anywhere (WFA).
