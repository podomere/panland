...
layout: research
ip_v4_address: "200.112.72.159"
date: 2023-02-04T16:26:03+00:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like ```200.112.72.159``` or an IPv6 address like ```2000:e098:c44a:c0f6:99d8:4dee:954f:4cc5```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```23:cc:54:57:a3:10```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://crona.io you initially access a DNS server to translate the host portion (crona) combined with the Top Level Domain (io) of the URL, to an IP address like ```36.32.25.2```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/41.0.2228.0 Safari/537.36```
...
<pre>
default   fe80:e185:c0f3:aa40:2dae%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {54.111.171.103, 146.202.41.19}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 23:cc:54:57:a3:10
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 71:2d:d3:da:cf:33
}</pre>
