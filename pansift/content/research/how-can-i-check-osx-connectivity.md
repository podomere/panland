...
layout: research
ip_v4_address: "240.202.84.232"
date: 2022-12-15T13:50:10+00:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like ```240.202.84.232``` or an IPv6 address like ```2000:ce21:fcc7:dc5:381a:a4ec:a995:83ed```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```b5:ae:2a:ee:6f:5e```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://kiehn-mraz.io you initially access a DNS server to translate the host portion (kiehn-mraz) combined with the Top Level Domain (io) of the URL, to an IP address like ```72.96.128.239```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/41.0.2228.0 Safari/537.36```
...
<pre>
default   fe80:c8f2:547c:b206:47f4%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {69.55.132.34, 44.252.48.116}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr b5:ae:2a:ee:6f:5e
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr ac:f5:9c:86:a4:13
}</pre>
