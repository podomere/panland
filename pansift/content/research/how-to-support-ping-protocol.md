...
subtitle: "Ideate?"
layout: research
ip_v4_address: "88.170.110.5"
date: 2022-04-24T19:00:02+01:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like <code>88.170.110.5</code> or an IPv6 address like <code>2000:b8da:5018:3f8:f9ee:178e:4e21:215</code>. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>05:fe:a0:30:29:ac</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://casper-hartmann.org you initially access a DNS server to translate the host portion (casper-hartmann) combined with the Top Level Domain (org) of the URL, to an IP address like <code>122.216.232.53</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (Windows NT 6.1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/41.0.2228.0 Safari/537.36</code>
...
<pre><code>
default   fe80:6864:d4c9:e2bd:d588%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {112.220.178.176, 188.193.182.30}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 05:fe:a0:30:29:ac
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 52:72:ed:70:87:8c
}</code></pre>
