...
layout: research
ip_v4_address: "37.60.117.208"
date: 2023-02-04T16:26:11+00:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like ```37.60.117.208``` or an IPv6 address like ```2000:463a:e306:ebf3:4a50:c828:57e7:9ed9```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```4f:5d:c9:b8:0e:34```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://orn-osinski.name you initially access a DNS server to translate the host portion (orn-osinski) combined with the Top Level Domain (name) of the URL, to an IP address like ```51.129.65.46```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/41.0.2228.0 Safari/537.36```
...
<pre>
default   fe80:16ff:8853:6591:f04f%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {11.29.235.146, 232.16.84.118}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 4f:5d:c9:b8:0e:34
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr fe:81:ae:5e:00:12
}</pre>
