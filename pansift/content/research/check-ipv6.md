...
layout: research
ip_v4_address: "39.73.48.177"
date: 2022-05-05T14:29:24+01:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like ```39.73.48.177``` or an IPv6 address like ```2000:8dc4:c3cc:7db5:4625:1796:8cea:5428```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```6b:de:76:3a:03:96```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://mueller-harber.com you initially access a DNS server to translate the host portion (mueller-harber) combined with the Top Level Domain (com) of the URL, to an IP address like ```219.120.255.31```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1; WOW64; Trident/7.0; AS; rv:11.0) like Gecko```

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```192.168.232.244``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  192.168.232.244    UGScg  en0
...
<pre>
default   fe80:f67b:72a2:bca:e6e4%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {184.216.137.65, 168.244.75.125}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 6b:de:76:3a:03:96
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr f5:3e:35:42:2c:da
}</pre>
