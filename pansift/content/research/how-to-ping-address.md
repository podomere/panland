...
layout: research
ip_v4_address: "56.143.161.148"
date: 2023-02-04T16:26:22+00:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like ```56.143.161.148``` or an IPv6 address like ```2000:2549:5e49:7d37:2c01:5e2b:1e11:ee0a```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```9f:45:8d:78:ae:24```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://williamson-monahan.co you initially access a DNS server to translate the host portion (williamson-monahan) combined with the Top Level Domain (co) of the URL, to an IP address like ```66.216.146.147```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows; U; Win 9x 4.90; SG; rv:1.9.2.4) Gecko/20101104 Netscape/9.1.0285```
...
<pre>
default   fe80:67c4:b8e2:e529:763b%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {73.231.232.101, 121.65.169.56}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 9f:45:8d:78:ae:24
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 8b:76:a7:03:d5:83
}</pre>
