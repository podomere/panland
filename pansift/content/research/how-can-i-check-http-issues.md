...
layout: research
ip_v4_address: "187.239.98.218"
date: 2022-11-19T19:13:28+00:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like ```187.239.98.218``` or an IPv6 address like ```2000:5305:a7b7:3974:c209:4384:49fe:4632```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```8c:28:d5:9b:47:fa```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://schmidt-orn.org you initially access a DNS server to translate the host portion (schmidt-orn) combined with the Top Level Domain (org) of the URL, to an IP address like ```234.221.170.60```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows; U; Win 9x 4.90; SG; rv:1.9.2.4) Gecko/20101104 Netscape/9.1.0285```
...
default  10.13.171.90    UGScg  en0
...
<pre>
default   fe80:c3ed:ebe8:558e:3641%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {113.3.163.103, 168.28.54.13}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 8c:28:d5:9b:47:fa
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr df:af:26:76:fb:d8
}</pre>
