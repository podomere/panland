  ...
  if(document.getElementById("mapid") !== null){
    ...
    function new_champion(lat,lng) {
      var popup = L.popup({closeButton:false})
        .setLatLng([lat, lng])
        .setContent('<a target="_blank" rel="nofollow" href="https://app.pansift.com/demo?first_insight=true" style="color: black;"><center><strong>Investigate Issue <i class="fas fa-external-link-alt"></i></strong></center></a>')
        .openOn(mymap);
