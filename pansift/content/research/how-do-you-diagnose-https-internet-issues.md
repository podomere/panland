...
layout: research
ip_v4_address: "139.222.141.221"
date: 2022-06-04T14:38:44+01:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like ```139.222.141.221``` or an IPv6 address like ```2000:e23a:792c:97c7:986b:199c:1a5e:5ab9```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```09:c9:e5:9e:0e:26```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://schmeler-ohara.biz you initially access a DNS server to translate the host portion (schmeler-ohara) combined with the Top Level Domain (biz) of the URL, to an IP address like ```63.32.12.71```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT x.y; Win64; x64; rv:10.0) Gecko/20100101 Firefox/10.0```
...
<pre>
default   fe80:a1d2:9660:2744:4151%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {75.187.248.61, 230.27.168.63}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 09:c9:e5:9e:0e:26
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 04:2d:50:60:90:8f
}</pre>
