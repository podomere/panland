...
layout: research
ip_v4_address: "234.144.184.117"
date: 2022-11-19T16:17:24+00:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like ```234.144.184.117``` or an IPv6 address like ```2000:9336:b97:17ab:2177:2a3c:9c0c:1e4c```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```5a:1d:18:cd:49:bd```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://nicolas-volkman.org you initially access a DNS server to translate the host portion (nicolas-volkman) combined with the Top Level Domain (org) of the URL, to an IP address like ```239.98.140.126```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (compatible; MSIE 9.0; AOL 9.7; AOLBuild 4343.19; Windows NT 6.1; WOW64; Trident/5.0; FunWebProducts)```
...
<pre>
default   fe80:98d:409f:fb0c:7327%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {88.153.151.207, 102.124.239.1}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 5a:1d:18:cd:49:bd
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr cf:ad:a0:df:68:d6
}</pre>
