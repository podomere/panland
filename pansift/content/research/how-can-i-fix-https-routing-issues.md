...
layout: research
ip_v4_address: "171.237.29.118"
date: 2023-02-04T16:26:23+00:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like ```171.237.29.118``` or an IPv6 address like ```2000:c59f:ea0b:1283:c124:73c4:1840:ffb3```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```0e:67:59:22:2e:ca```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://schroeder-bechtelar.info you initially access a DNS server to translate the host portion (schroeder-bechtelar) combined with the Top Level Domain (info) of the URL, to an IP address like ```98.55.52.147```. Your computer and browser actually sends its type with all web requests e.g. <br>```Opera/9.80 (X11; Linux i686; Ubuntu/14.10) Presto/2.12.388 Version/12.16```
...
<pre>
default   fe80:cba7:485:aa6b:85e3%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {76.248.31.21, 157.247.153.65}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 0e:67:59:22:2e:ca
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 60:07:6c:bf:13:e9
}</pre>
