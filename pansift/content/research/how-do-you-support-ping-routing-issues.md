...
layout: research
ip_v4_address: "215.13.197.184"
date: 2022-11-19T19:13:28+00:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like ```215.13.197.184``` or an IPv6 address like ```2000:e41a:5eba:1ae3:a1bb:32ae:59da:4196```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```9b:df:2a:bb:53:bc```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://reichert-medhurst.info you initially access a DNS server to translate the host portion (reichert-medhurst) combined with the Top Level Domain (info) of the URL, to an IP address like ```251.106.90.108```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows; U; Win 9x 4.90; SG; rv:1.9.2.4) Gecko/20101104 Netscape/9.1.0285```
...
<pre>
default   fe80:33c5:5ecb:4eac:b61a%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {118.95.124.148, 194.90.59.221}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 9b:df:2a:bb:53:bc
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr a8:15:f7:03:5a:d2
}</pre>
