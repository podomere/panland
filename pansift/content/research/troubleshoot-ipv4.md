...
layout: research
ip_v4_address: "61.47.93.181"
date: 2023-10-29T15:13:25+00:00
draft: false
---

## Internet Addressing
On the Internet you might get a Public IPv4 address like ```61.47.93.181``` or an IPv6 address like ```2000:41f0:b8e1:c16d:8cb:3555:538:e225```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```5c:3e:0f:96:3a:7d```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://schimmel-roob.name you initially access a DNS server to translate the host portion (schimmel-roob) combined with the Top Level Domain (name) of the URL, to an IP address like ```115.162.102.18```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows; U; Win 9x 4.90; SG; rv:1.9.2.4) Gecko/20101104 Netscape/9.1.0285```
...
<pre>
default   fe80:f932:1e54:f500:93ef%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {151.130.237.254, 213.255.80.67}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 5c:3e:0f:96:3a:7d
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 7a:72:04:73:4e:1d
}</pre>
