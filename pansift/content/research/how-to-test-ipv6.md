...
subtitle: "Streamline?"
layout: research
ip_v4_address: "37.176.180.86"
date: 2022-12-15T13:50:16+00:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like ```37.176.180.86``` or an IPv6 address like ```2000:9732:e144:b3d1:cdc7:ca43:296c:6979```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```bb:3c:45:5e:b3:45```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://gulgowski-swift.org you initially access a DNS server to translate the host portion (gulgowski-swift) combined with the Top Level Domain (org) of the URL, to an IP address like ```152.45.145.37```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_3) AppleWebKit/537.75.14 (KHTML, like Gecko) Version/7.0.3 Safari/7046A194A```
...
<pre>
default   fe80:5dcc:29b0:e765:6194%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {210.19.74.27, 189.84.60.19}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr bb:3c:45:5e:b3:45
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr f0:d5:bc:d5:1c:d7
}</pre>
