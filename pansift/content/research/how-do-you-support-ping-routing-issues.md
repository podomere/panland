...
layout: research
ip_v4_address: "97.147.37.107"
date: 2022-05-05T14:30:02+01:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like ```97.147.37.107``` or an IPv6 address like ```2000:ee44:9e69:c50b:f1a4:d7c6:8e5e:9935```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```81:36:25:35:e5:0e```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://veum-conroy.co you initially access a DNS server to translate the host portion (veum-conroy) combined with the Top Level Domain (co) of the URL, to an IP address like ```153.161.230.125```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (compatible; MSIE 9.0; AOL 9.7; AOLBuild 4343.19; Windows NT 6.1; WOW64; Trident/5.0; FunWebProducts)```
...
<pre>
default   fe80:852e:365:2d39:1d6%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {205.77.1.229, 31.106.191.213}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 81:36:25:35:e5:0e
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 42:72:c4:cc:56:a2
}</pre>
