...
subtitle: "Synergy?"
layout: research
ip_v4_address: "24.245.37.55"
date: 2023-10-06T17:11:06+01:00
draft: false
---

## Internet Addressing
On the Internet you might have a Public IPv4 address like ```24.245.37.55``` or an IPv6 address like ```2000:b26f:1c9d:8d52:7540:36b0:688e:d63b```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```84:a1:95:f6:07:02```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://kunde.org you initially access a DNS server to translate the host portion (kunde) combined with the Top Level Domain (org) of the URL, to an IP address like ```5.84.101.81```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1; WOW64; Trident/7.0; AS; rv:11.0) like Gecko```

## Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```10.28.226.186``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  10.28.226.186    UGScg  en0
...
<pre>
default   fe80:b67d:2763:8dea:a1cf%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {42.154.208.148, 120.200.229.247}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 84:a1:95:f6:07:02
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr a3:a1:6e:c0:4f:a1
}</pre>
