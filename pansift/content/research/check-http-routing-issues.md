...
layout: research
ip_v4_address: "25.117.205.184"
date: 2022-11-02T11:33:00+00:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like ```25.117.205.184``` or an IPv6 address like ```2000:3b2b:896f:ac2f:d82b:a8f9:97a5:dc04```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```8d:53:83:4d:d3:20```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://kohler.biz you initially access a DNS server to translate the host portion (kohler) combined with the Top Level Domain (biz) of the URL, to an IP address like ```19.48.5.28```. Your computer and browser actually sends its type with all web requests e.g. <br>```Opera/9.80 (X11; Linux i686; Ubuntu/14.10) Presto/2.12.388 Version/12.16```

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```10.43.171.25``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  10.43.171.25    UGScg  en0
...
<pre>
default   fe80:7bbd:526:8cae:1e95%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {85.246.21.245, 94.239.212.43}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 8d:53:83:4d:d3:20
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 12:a9:0d:c4:09:fd
}</pre>
