...
layout: research
ip_v4_address: "214.88.153.143"
date: 2022-04-24T19:00:23+01:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like <code>214.88.153.143</code> or an IPv6 address like <code>2000:8134:7e3b:4937:e361:ecc7:d70e:7cd4</code>. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>01:0b:b8:65:01:d0</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://hammes-streich.net you initially access a DNS server to translate the host portion (hammes-streich) combined with the Top Level Domain (net) of the URL, to an IP address like <code>21.142.133.218</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (Windows NT x.y; Win64; x64; rv:10.0) Gecko/20100101 Firefox/10.0</code>

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like <code>172.20.88.251</code> (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For <code>IPv6</code> we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  172.20.88.251    UGScg  en0
...
<pre><code>
default   fe80:9f15:107f:2ba5:9d50%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {206.131.46.180, 162.42.2.235}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 01:0b:b8:65:01:d0
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr ca:ca:0d:12:87:4c
}</code></pre>
