...
subtitle: "Tee It Up?"
layout: research
ip_v4_address: "170.52.196.250"
date: 2022-12-15T13:50:10+00:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like ```170.52.196.250``` or an IPv6 address like ```2000:4442:effd:d532:d0f7:334:5945:bb67```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```eb:1b:b5:6a:d8:06```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://cruickshank.name you initially access a DNS server to translate the host portion (cruickshank) combined with the Top Level Domain (name) of the URL, to an IP address like ```9.149.227.148```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (compatible; MSIE 9.0; AOL 9.7; AOLBuild 4343.19; Windows NT 6.1; WOW64; Trident/5.0; FunWebProducts)```

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```10.212.251.48``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  10.212.251.48    UGScg  en0
...
<pre>
default   fe80:60b9:9370:44e4:4c%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {226.160.195.163, 83.144.124.104}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr eb:1b:b5:6a:d8:06
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 11:fd:b0:d5:e2:9e
}</pre>
