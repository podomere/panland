...
subtitle: "Ideate?"
layout: research
ip_v4_address: "206.22.254.220"
date: 2022-04-24T18:59:56+01:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like <code>206.22.254.220</code> or an IPv6 address like <code>2000:7102:4555:dcff:7a9f:b0c:956c:8eaf</code>. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>73:02:3a:21:8a:34</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://koss.name you initially access a DNS server to translate the host portion (koss) combined with the Top Level Domain (name) of the URL, to an IP address like <code>229.163.241.219</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_3) AppleWebKit/537.75.14 (KHTML, like Gecko) Version/7.0.3 Safari/7046A194A</code>
...
<pre><code>
default   fe80:1644:5a5:2df0:f5cd%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {92.245.26.246, 57.226.204.112}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 73:02:3a:21:8a:34
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr fe:75:ac:4e:21:0a
}</code></pre>
