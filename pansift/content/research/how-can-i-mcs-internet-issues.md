...
layout: research
ip_v4_address: "145.158.115.120"
date: 2022-11-02T11:32:24+00:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like ```145.158.115.120``` or an IPv6 address like ```2000:dd41:f8da:30a8:87df:19e4:7480:2206```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```31:4d:bc:0c:a8:be```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://dibbert-kutch.org you initially access a DNS server to translate the host portion (dibbert-kutch) combined with the Top Level Domain (org) of the URL, to an IP address like ```244.244.16.46```. Your computer and browser actually sends its type with all web requests e.g. <br>```Opera/9.80 (X11; Linux i686; Ubuntu/14.10) Presto/2.12.388 Version/12.16```

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```172.29.232.7``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  172.29.232.7    UGScg  en0
...
<pre>
default   fe80:a4da:2dd6:1780:1f64%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {209.154.150.172, 132.118.156.240}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 31:4d:bc:0c:a8:be
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 5f:7e:ae:79:17:47
}</pre>
