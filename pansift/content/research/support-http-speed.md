...
layout: research
ip_v4_address: "246.114.197.172"
date: 2022-12-15T13:50:20+00:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like ```246.114.197.172``` or an IPv6 address like ```2000:6062:e38f:53b6:daf0:15e6:cbbc:a566```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```5e:bb:66:49:5a:ca```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://parker-barton.biz you initially access a DNS server to translate the host portion (parker-barton) combined with the Top Level Domain (biz) of the URL, to an IP address like ```233.50.235.235```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_3) AppleWebKit/537.75.14 (KHTML, like Gecko) Version/7.0.3 Safari/7046A194A```
...
<pre>
default   fe80:f60f:22b0:38c7:7b3f%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {111.94.112.137, 205.221.40.20}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 5e:bb:66:49:5a:ca
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr f2:ef:67:7e:4e:28
}</pre>
