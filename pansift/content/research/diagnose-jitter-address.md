...
layout: research
ip_v4_address: "177.67.16.48"
date: 2022-04-24T18:59:59+01:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like <code>177.67.16.48</code> or an IPv6 address like <code>2000:a910:73ee:8d14:5a55:9d25:d20b:7606</code>. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>b4:d8:cd:4c:1e:dc</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://will-cassin.com you initially access a DNS server to translate the host portion (will-cassin) combined with the Top Level Domain (com) of the URL, to an IP address like <code>181.196.135.12</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (Windows; U; Win 9x 4.90; SG; rv:1.9.2.4) Gecko/20101104 Netscape/9.1.0285</code>
...
<pre><code>
default   fe80:48ff:764a:6b5f:5a74%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {163.213.131.142, 180.32.181.218}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr b4:d8:cd:4c:1e:dc
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr ac:1c:59:5c:9c:54
}</code></pre>
