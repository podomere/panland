...
subtitle: "Streamline?"
layout: research
ip_v4_address: "185.3.57.41"
date: 2022-04-24T18:31:58+01:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like <code>185.3.57.41</code> or an IPv6 address like <code>2000:8474:440c:b120:432d:7e36:4898:b6ac</code>. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>1e:c0:78:c9:0a:a8</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://klein-bernhard.biz you initially access a DNS server to translate the host portion (klein-bernhard) combined with the Top Level Domain (biz) of the URL, to an IP address like <code>138.230.181.74</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Opera/9.80 (X11; Linux i686; Ubuntu/14.10) Presto/2.12.388 Version/12.16</code>

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like <code>10.247.98.139</code> (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For <code>IPv6</code> we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  10.247.98.139    UGScg  en0
...
<pre><code>
default   fe80:bf0d:8f37:3c12:b5fb%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {8.200.55.1, 186.34.153.44}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 1e:c0:78:c9:0a:a8
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 6c:e1:a6:fc:3d:74
}</code></pre>
