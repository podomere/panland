...
layout: research
ip_v4_address: "214.227.115.220"
date: 2023-02-04T16:26:22+00:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like ```214.227.115.220``` or an IPv6 address like ```2000:7b91:4b26:f080:260f:594:26ad:2b40```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```b7:6b:b6:4a:3b:ef```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://kuhlman-witting.info you initially access a DNS server to translate the host portion (kuhlman-witting) combined with the Top Level Domain (info) of the URL, to an IP address like ```112.207.138.54```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (compatible; MSIE 9.0; AOL 9.7; AOLBuild 4343.19; Windows NT 6.1; WOW64; Trident/5.0; FunWebProducts)```
...
<pre>
default   fe80:db63:5f68:447d:616e%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {79.128.235.105, 156.134.148.23}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr b7:6b:b6:4a:3b:ef
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 66:4e:3e:28:65:33
}</pre>
