...
subtitle: "Granular?"
layout: research
ip_v4_address: "204.216.246.76"
date: 2023-02-04T16:26:20+00:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like ```204.216.246.76``` or an IPv6 address like ```2000:8e98:e4b0:97b1:d8f4:67e9:657d:6842```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```18:73:72:b7:99:c6```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://cartwright-hoeger.biz you initially access a DNS server to translate the host portion (cartwright-hoeger) combined with the Top Level Domain (biz) of the URL, to an IP address like ```86.174.157.169```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_3) AppleWebKit/537.75.14 (KHTML, like Gecko) Version/7.0.3 Safari/7046A194A```
...
<pre>
default   fe80:106e:df5f:c1a2:924f%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {214.219.8.209, 75.190.114.250}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 18:73:72:b7:99:c6
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 29:15:14:31:4d:78
}</pre>
