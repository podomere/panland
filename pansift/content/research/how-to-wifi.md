...
layout: research
ip_v4_address: "237.145.105.26"
date: 2023-10-06T17:10:30+01:00
draft: false
---

## Internet Addressing
On the Internet you may have a Public IPv4 address like ```237.145.105.26``` or an IPv6 address like ```2000:9445:f6ae:dfaa:7c8c:15d0:f43d:f055```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```91:d5:c5:b4:e6:f4```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://beier.info you initially access a DNS server to translate the host portion (beier) combined with the Top Level Domain (info) of the URL, to an IP address like ```120.235.222.23```. Your computer and browser actually sends its type with all web requests e.g. <br>```Opera/9.80 (X11; Linux i686; Ubuntu/14.10) Presto/2.12.388 Version/12.16```

## Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```192.168.214.203``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  192.168.214.203    UGScg  en0
...
<pre>
default   fe80:c250:d11c:9905:9ad7%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {74.227.240.94, 120.62.82.1}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 91:d5:c5:b4:e6:f4
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 4c:8c:74:30:70:48
}</pre>
...
### Apple macOS / OSX
No matter what version of OSX/macOS you are on, ```10.11.5```, ```11.5.4```, or ```12.1.6```, there are a range of tools for troubleshooting. Unfortunately, between these manual actions and scripts, they don't give you a series of correlated values over time. This is where automated remote troubleshooting comes in to its own, especially for teams that embrace remote work and Work From Anywhere (WFA).
