...
layout: research
ip_v4_address: "109.165.123.191"
date: 2022-11-19T19:13:26+00:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like ```109.165.123.191``` or an IPv6 address like ```2000:834f:d4ad:c9bd:eaca:d208:1481:452a```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```10:bb:5f:41:0a:90```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://murazik-raynor.info you initially access a DNS server to translate the host portion (murazik-raynor) combined with the Top Level Domain (info) of the URL, to an IP address like ```221.216.252.131```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_3) AppleWebKit/537.75.14 (KHTML, like Gecko) Version/7.0.3 Safari/7046A194A```
...
<pre>
default   fe80:6992:b732:7ef6:62e6%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {36.103.69.49, 103.223.157.79}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 10:bb:5f:41:0a:90
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 1f:7b:15:47:a2:3e
}</pre>
