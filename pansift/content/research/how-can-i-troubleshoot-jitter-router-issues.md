...
subtitle: "Granular?"
layout: research
ip_v4_address: "224.187.252.108"
date: 2022-11-02T11:32:57+00:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like ```224.187.252.108``` or an IPv6 address like ```2000:52a5:3398:1232:6365:9993:2b6a:c3fe```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```8c:42:89:c8:06:80```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://orn-schmidt.com you initially access a DNS server to translate the host portion (orn-schmidt) combined with the Top Level Domain (com) of the URL, to an IP address like ```43.36.61.56```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (compatible; MSIE 9.0; AOL 9.7; AOLBuild 4343.19; Windows NT 6.1; WOW64; Trident/5.0; FunWebProducts)```
...
<pre>
default   fe80:5da9:2cea:9e8f:7297%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {174.7.221.58, 118.199.15.226}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 8c:42:89:c8:06:80
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr e7:33:9b:31:1b:79
}</pre>
