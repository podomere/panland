...
layout: research
ip_v4_address: "45.2.109.233"
date: 2022-06-12T14:09:15+01:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like ```45.2.109.233``` or an IPv6 address like ```2000:ee53:a913:19e0:50a:c300:acc5:a477```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```cf:cd:e2:ae:b8:11```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://zieme.net you initially access a DNS server to translate the host portion (zieme) combined with the Top Level Domain (net) of the URL, to an IP address like ```133.108.142.158```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows; U; Win 9x 4.90; SG; rv:1.9.2.4) Gecko/20101104 Netscape/9.1.0285```
...
<pre>
default   fe80:bb1f:d478:d504:71e7%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {243.35.200.217, 11.226.128.17}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr cf:cd:e2:ae:b8:11
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr f5:47:9c:56:13:f8
}</pre>
