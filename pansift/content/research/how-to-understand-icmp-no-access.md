...
subtitle: "Heads Down?"
layout: research
ip_v4_address: "175.29.139.12"
date: 2022-06-04T14:38:41+01:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like ```175.29.139.12``` or an IPv6 address like ```2000:9ccb:33dc:45b1:a64a:3275:db0e:c604```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```a2:e4:99:39:90:7c```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://sawayn-koss.io you initially access a DNS server to translate the host portion (sawayn-koss) combined with the Top Level Domain (io) of the URL, to an IP address like ```221.106.154.186```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT x.y; Win64; x64; rv:10.0) Gecko/20100101 Firefox/10.0```
...
<pre>
default   fe80:a9cb:cf7b:1c2:1d33%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {51.219.156.79, 73.212.89.173}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr a2:e4:99:39:90:7c
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 3b:0c:13:2d:2d:0d
}</pre>
