...
layout: research
ip_v4_address: "247.160.196.1"
date: 2022-11-19T16:17:12+00:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like ```247.160.196.1``` or an IPv6 address like ```2000:ce32:d0ce:8b4:f9ef:bcd0:dbbb:5712```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```cf:49:7a:d0:bd:5d```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://trantow-lindgren.name you initially access a DNS server to translate the host portion (trantow-lindgren) combined with the Top Level Domain (name) of the URL, to an IP address like ```46.246.120.170```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows; U; Win 9x 4.90; SG; rv:1.9.2.4) Gecko/20101104 Netscape/9.1.0285```
...
<pre>
default   fe80:d8fe:ea17:42c5:f5fc%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {43.73.218.224, 244.170.135.5}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr cf:49:7a:d0:bd:5d
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 29:4d:b9:80:cd:df
}</pre>
