...
subtitle: "Heads Down?"
layout: research
ip_v4_address: "128.164.253.96"
date: 2022-04-24T19:00:04+01:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like <code>128.164.253.96</code> or an IPv6 address like <code>2000:c73d:8bd:4afa:fe89:4d2a:69c9:ebb4</code>. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>b8:a3:40:39:29:b0</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://legros-batz.name you initially access a DNS server to translate the host portion (legros-batz) combined with the Top Level Domain (name) of the URL, to an IP address like <code>243.232.121.157</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_3) AppleWebKit/537.75.14 (KHTML, like Gecko) Version/7.0.3 Safari/7046A194A</code>
...
<pre><code>
default   fe80:77bf:772f:cf39:7169%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {228.4.45.6, 247.238.34.12}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr b8:a3:40:39:29:b0
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 27:12:e3:83:ea:c5
}</code></pre>
