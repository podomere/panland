...
layout: research
ip_v4_address: "76.178.247.201"
date: 2022-11-19T19:13:25+00:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like ```76.178.247.201``` or an IPv6 address like ```2000:eeed:d47d:bb37:113f:a6a6:9d1:6e94```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```fa:9d:73:85:26:a1```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://wiza-lind.biz you initially access a DNS server to translate the host portion (wiza-lind) combined with the Top Level Domain (biz) of the URL, to an IP address like ```139.133.26.9```. Your computer and browser actually sends its type with all web requests e.g. <br>```Opera/9.80 (X11; Linux i686; Ubuntu/14.10) Presto/2.12.388 Version/12.16```
...
<pre>
default   fe80:7c7c:12ad:1b50:4094%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {73.232.32.88, 89.201.9.194}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr fa:9d:73:85:26:a1
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr d4:da:e0:76:b1:68
}</pre>
