...
subtitle: "Granular?"
layout: research
ip_v4_address: "109.163.40.9"
date: 2023-02-04T17:08:37+00:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like ```109.163.40.9``` or an IPv6 address like ```2000:d047:93fd:f951:cbd3:358c:a318:adbb```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```fc:9b:e9:e1:e7:32```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://roob-corwin.name you initially access a DNS server to translate the host portion (roob-corwin) combined with the Top Level Domain (name) of the URL, to an IP address like ```6.198.127.177```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT x.y; Win64; x64; rv:10.0) Gecko/20100101 Firefox/10.0```
...
<pre>
default   fe80:257c:249:619a:7d56%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {116.192.175.121, 160.140.254.21}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr fc:9b:e9:e1:e7:32
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr c9:ae:63:71:3e:d0
}</pre>
