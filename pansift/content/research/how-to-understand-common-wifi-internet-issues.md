...
layout: research
ip_v4_address: "101.196.38.135"
date: 2023-10-06T17:10:31+01:00
draft: false
---

## Internet Addressing
On the Internet you may get a Public IPv4 address like ```101.196.38.135``` or an IPv6 address like ```2000:b994:9c84:41b2:8241:cbc3:395b:ff0f```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```2a:ac:10:13:4a:34```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://flatley-yundt.info you initially access a DNS server to translate the host portion (flatley-yundt) combined with the Top Level Domain (info) of the URL, to an IP address like ```255.90.187.172```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows; U; Win 9x 4.90; SG; rv:1.9.2.4) Gecko/20101104 Netscape/9.1.0285```
...
<pre>
default   fe80:b9f6:ba67:c8fd:798b%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {13.86.166.160, 81.36.247.144}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 2a:ac:10:13:4a:34
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 5d:35:ec:4e:54:e7
}</pre>
