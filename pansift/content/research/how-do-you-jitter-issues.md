...
subtitle: "Swag?"
layout: research
ip_v4_address: "198.114.147.138"
date: 2022-11-19T16:17:22+00:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like ```198.114.147.138``` or an IPv6 address like ```2000:f8e:e2c9:ff52:a080:89bf:fa07:c4a3```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```48:d9:a9:be:51:e3```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://hand-yundt.biz you initially access a DNS server to translate the host portion (hand-yundt) combined with the Top Level Domain (biz) of the URL, to an IP address like ```4.253.210.15```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1; WOW64; Trident/7.0; AS; rv:11.0) like Gecko```
...
<pre>
default   fe80:50a0:ba00:a92e:4979%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {132.65.205.8, 115.35.196.122}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 48:d9:a9:be:51:e3
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr bc:32:03:bd:a2:d0
}</pre>
