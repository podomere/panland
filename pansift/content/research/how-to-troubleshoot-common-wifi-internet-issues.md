...
layout: research
ip_v4_address: "186.143.221.209"
date: 2023-10-29T15:13:12+00:00
draft: false
---

## Internet Addressing
On the Internet you may have a Public IPv4 address like ```186.143.221.209``` or an IPv6 address like ```2000:81ab:a420:7af1:132e:1c16:c416:9c74```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```39:d0:f4:f0:49:9f```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://greenholt.com you initially access a DNS server to translate the host portion (greenholt) combined with the Top Level Domain (com) of the URL, to an IP address like ```59.194.209.102```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows; U; Win 9x 4.90; SG; rv:1.9.2.4) Gecko/20101104 Netscape/9.1.0285```

## Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```10.251.130.46``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  10.251.130.46    UGScg  en0
...
<pre>
default   fe80:df6c:834e:e30:8459%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {134.86.43.218, 110.199.105.163}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 39:d0:f4:f0:49:9f
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr f5:0d:4b:cb:e7:40
}</pre>
