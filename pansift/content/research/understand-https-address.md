...
layout: research
ip_v4_address: "29.176.39.88"
date: 2022-11-19T19:13:29+00:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like ```29.176.39.88``` or an IPv6 address like ```2000:6493:2378:faef:5866:a639:3213:f033```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```2d:5c:0c:dd:7d:5c```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://skiles-halvorson.co you initially access a DNS server to translate the host portion (skiles-halvorson) combined with the Top Level Domain (co) of the URL, to an IP address like ```162.157.205.153```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT x.y; Win64; x64; rv:10.0) Gecko/20100101 Firefox/10.0```
...
<pre>
default   fe80:c213:9a96:4129:9571%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {251.226.101.158, 205.205.163.202}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 2d:5c:0c:dd:7d:5c
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 37:d5:37:6c:c3:d2
}</pre>
