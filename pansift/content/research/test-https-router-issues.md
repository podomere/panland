...
layout: research
ip_v4_address: "46.198.244.100"
date: 2023-10-06T17:11:08+01:00
draft: false
---

## Internet Addressing
On the Internet you might have a Public IPv4 address like ```46.198.244.100``` or an IPv6 address like ```2000:26da:f6c3:6df1:7234:dc62:eb4f:f61```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```4f:72:3c:36:46:e3```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://erdman.com you initially access a DNS server to translate the host portion (erdman) combined with the Top Level Domain (com) of the URL, to an IP address like ```58.40.187.81```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (compatible; MSIE 9.0; AOL 9.7; AOLBuild 4343.19; Windows NT 6.1; WOW64; Trident/5.0; FunWebProducts)```

## Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```192.168.137.107``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  192.168.137.107    UGScg  en0
...
<pre>
default   fe80:50bf:c72b:61c9:5bbb%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {250.33.218.188, 67.29.62.42}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 4f:72:3c:36:46:e3
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr be:fd:e8:43:fd:4f
}</pre>
