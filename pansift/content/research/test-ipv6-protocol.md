...
layout: research
ip_v4_address: "232.87.151.165"
date: 2022-06-04T14:38:36+01:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like ```232.87.151.165``` or an IPv6 address like ```2000:e6dd:9b84:37e8:60a:707a:cd04:4f86```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```a2:55:8a:24:1e:bc```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://mcdermott.co you initially access a DNS server to translate the host portion (mcdermott) combined with the Top Level Domain (co) of the URL, to an IP address like ```85.51.18.207```. Your computer and browser actually sends its type with all web requests e.g. <br>```Opera/9.80 (X11; Linux i686; Ubuntu/14.10) Presto/2.12.388 Version/12.16```

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```192.168.15.160``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  192.168.15.160    UGScg  en0
...
<pre>
default   fe80:267d:7af7:4ff5:a08c%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {110.131.128.7, 188.75.145.217}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr a2:55:8a:24:1e:bc
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr f5:b7:ed:90:d1:82
}</pre>
