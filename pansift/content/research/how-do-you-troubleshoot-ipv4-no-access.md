...
subtitle: "Value Add?"
layout: research
ip_v4_address: "127.229.41.54"
date: 2022-06-04T14:38:38+01:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like ```127.229.41.54``` or an IPv6 address like ```2000:1f9b:379a:63a9:9317:530f:7d04:86c```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```47:03:29:22:8e:0f```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://littel.co you initially access a DNS server to translate the host portion (littel) combined with the Top Level Domain (co) of the URL, to an IP address like ```131.172.138.156```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1; WOW64; Trident/7.0; AS; rv:11.0) like Gecko```
...
<pre>
default   fe80:c78d:858c:e1bb:a87f%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {192.14.138.230, 26.195.192.72}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 47:03:29:22:8e:0f
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr c5:f7:d5:a2:9e:a8
}</pre>
