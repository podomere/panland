...
layout: research
ip_v4_address: "70.88.191.230"
date: 2022-04-24T19:00:04+01:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like <code>70.88.191.230</code> or an IPv6 address like <code>2000:337e:bf64:d244:aff6:9f77:ad54:ecd7</code>. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>de:90:34:73:69:69</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://smith-klocko.net you initially access a DNS server to translate the host portion (smith-klocko) combined with the Top Level Domain (net) of the URL, to an IP address like <code>2.214.82.155</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (Windows; U; Win 9x 4.90; SG; rv:1.9.2.4) Gecko/20101104 Netscape/9.1.0285</code>
...
<pre><code>
default   fe80:98d8:dd00:adbe:19ce%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {197.93.70.133, 14.39.93.128}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr de:90:34:73:69:69
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 97:a2:62:90:cf:38
}</code></pre>
