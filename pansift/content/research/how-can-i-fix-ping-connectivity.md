...
subtitle: "Heads Down?"
layout: research
ip_v4_address: "39.132.248.122"
date: 2022-06-12T14:09:27+01:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like ```39.132.248.122``` or an IPv6 address like ```2000:4b43:34d0:1a2c:68bd:f078:d18a:dbb```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```9c:ef:4f:d1:6c:25```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://hermann-thompson.org you initially access a DNS server to translate the host portion (hermann-thompson) combined with the Top Level Domain (org) of the URL, to an IP address like ```121.11.35.3```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1; WOW64; Trident/7.0; AS; rv:11.0) like Gecko```
...
<pre>
default   fe80:dbf8:ddb1:4a46:d0d2%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {217.16.110.0, 208.248.10.0}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 9c:ef:4f:d1:6c:25
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 77:51:9c:9f:ab:bf
}</pre>
