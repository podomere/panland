...
layout: research
ip_v4_address: "170.66.194.214"
date: 2022-06-12T14:09:16+01:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like ```170.66.194.214``` or an IPv6 address like ```2000:b2de:9c4c:8736:c266:54ff:e36b:42d```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```eb:dc:5b:18:da:de```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://hilpert-trantow.org you initially access a DNS server to translate the host portion (hilpert-trantow) combined with the Top Level Domain (org) of the URL, to an IP address like ```186.54.117.100```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1; WOW64; Trident/7.0; AS; rv:11.0) like Gecko```
...
<pre>
default   fe80:e05e:6a70:88fc:b60%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {241.102.7.233, 155.8.147.54}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr eb:dc:5b:18:da:de
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr fa:99:78:22:4c:27
}</pre>
