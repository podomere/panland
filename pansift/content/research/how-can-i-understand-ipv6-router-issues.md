...
layout: research
ip_v4_address: "142.57.146.138"
date: 2023-02-04T17:08:35+00:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like ```142.57.146.138``` or an IPv6 address like ```2000:bf9d:8707:be3:bedf:23fa:bb59:53e6```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```0a:6a:9f:39:5e:76```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://stanton-becker.io you initially access a DNS server to translate the host portion (stanton-becker) combined with the Top Level Domain (io) of the URL, to an IP address like ```207.19.201.196```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_3) AppleWebKit/537.75.14 (KHTML, like Gecko) Version/7.0.3 Safari/7046A194A```
...
<pre>
default   fe80:5e8f:5c71:bbe6:e9b2%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {234.234.108.213, 68.118.140.139}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 0a:6a:9f:39:5e:76
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr a6:78:4b:42:8a:80
}</pre>
...
## Apple macOS / OSX
No matter what version of OSX/macOS you are on, ```10.12.4```, ```11.6.6```, or ```12.3.4```, there are a range of tools for troubleshooting. Unfortunately, between these manual actions and scripts, they don't give you a series of correlated values over time. This is where automated remote troubleshooting comes in to its own, especially for teams that embrace remote work and Work From Anywhere (WFA).
