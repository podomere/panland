...
subtitle: "Deep Dive?"
layout: research
ip_v4_address: "185.79.156.244"
date: 2022-04-24T18:59:58+01:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like <code>185.79.156.244</code> or an IPv6 address like <code>2000:15f8:a901:b557:e479:43f:ea59:f046</code>. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>76:91:8b:33:40:cc</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://lesch.co you initially access a DNS server to translate the host portion (lesch) combined with the Top Level Domain (co) of the URL, to an IP address like <code>30.133.197.225</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (Windows NT 6.1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/41.0.2228.0 Safari/537.36</code>
...
default  172.23.116.173    UGScg  en0
...
<pre><code>
default   fe80:6112:3058:6cbd:fe95%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {152.234.230.115, 254.167.13.186}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 76:91:8b:33:40:cc
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 8b:94:7d:df:f1:37
}</code></pre>
