...
subtitle: "Branding?"
layout: research
ip_v4_address: "19.15.204.140"
date: 2022-12-15T13:50:17+00:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like ```19.15.204.140``` or an IPv6 address like ```2000:fcfc:e581:bd4:7570:d57e:ca3a:fe9f```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```8d:2f:b0:3c:ab:6c```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://runte.name you initially access a DNS server to translate the host portion (runte) combined with the Top Level Domain (name) of the URL, to an IP address like ```13.37.245.1```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_3) AppleWebKit/537.75.14 (KHTML, like Gecko) Version/7.0.3 Safari/7046A194A```

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```172.17.244.131``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  172.17.244.131    UGScg  en0
...
<pre>
default   fe80:4669:94cb:adf4:351d%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {122.202.54.9, 217.84.104.163}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 8d:2f:b0:3c:ab:6c
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 1f:0b:3d:83:2a:dd
}</pre>
