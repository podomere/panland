...
subtitle: "Synergy?"
layout: research
ip_v4_address: "176.85.43.96"
date: 2023-10-06T17:11:06+01:00
draft: false
---

## Internet Addressing
On the Internet you may get a Public IPv4 address like ```176.85.43.96``` or an IPv6 address like ```2000:efc1:17f:61dd:58d9:bc73:cc02:eb75```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```c5:44:8d:17:39:8a```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://hauck-douglas.com you initially access a DNS server to translate the host portion (hauck-douglas) combined with the Top Level Domain (com) of the URL, to an IP address like ```221.234.147.156```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows; U; Win 9x 4.90; SG; rv:1.9.2.4) Gecko/20101104 Netscape/9.1.0285```
...
<pre>
default   fe80:d542:4346:2b32:3d56%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {246.154.238.153, 179.239.245.131}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr c5:44:8d:17:39:8a
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr ca:ec:ae:02:55:9c
}</pre>
