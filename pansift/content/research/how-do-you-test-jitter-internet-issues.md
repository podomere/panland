...
layout: research
ip_v4_address: "223.147.22.130"
date: 2023-10-06T17:11:06+01:00
draft: false
---

## Internet Addressing
On the Internet you may get a Public IPv4 address like ```223.147.22.130``` or an IPv6 address like ```2000:6f3:23c8:b4ff:5144:afe1:74fe:8d95```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```3c:8a:59:f7:94:16```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://zulauf-kozey.org you initially access a DNS server to translate the host portion (zulauf-kozey) combined with the Top Level Domain (org) of the URL, to an IP address like ```177.105.141.133```. Your computer and browser actually sends its type with all web requests e.g. <br>```Opera/9.80 (X11; Linux i686; Ubuntu/14.10) Presto/2.12.388 Version/12.16```
...
<pre>
default   fe80:1822:6df6:207d:f48%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {197.116.106.43, 222.7.58.148}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 3c:8a:59:f7:94:16
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr a2:c9:8d:25:63:48
}</pre>
