---
title: "Test Http No-access"
subtitle: "Bandwidth-constrained?"
layout: research
ip_v4_address: "101.124.53.102"
date: 2022-11-02T11:33:00+00:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like ```101.124.53.102``` or an IPv6 address like ```2000:18d9:2df4:63de:b7b9:fa91:3e95:10fb```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```bc:64:38:e2:e3:d9```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://hudson-hansen.net you initially access a DNS server to translate the host portion (hudson-hansen) combined with the Top Level Domain (net) of the URL, to an IP address like ```208.65.188.24```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (compatible; MSIE 9.0; AOL 9.7; AOLBuild 4343.19; Windows NT 6.1; WOW64; Trident/5.0; FunWebProducts)```
...
<pre>
default   fe80:73b0:cd86:baba:d6a0%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {172.183.193.72, 202.104.164.214}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr bc:64:38:e2:e3:d9
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 1d:02:34:4e:16:83
}</pre>
...
## Apple macOS / OSX
No matter what version of OSX/macOS you are on, ```10.11.6```, ```11.2.6```, or ```12.2.2```, there are a range of tools for troubleshooting. Unfortunately, between these manual actions and scripts, they don't give you a series of correlated values over time. This is where automated remote troubleshooting comes in to its own, especially for teams that embrace remote work and Work From Anywhere (WFA).
