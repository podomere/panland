...
subtitle: "Heads Down?"
layout: research
ip_v4_address: "75.192.56.21"
date: 2023-10-29T15:13:27+00:00
draft: false
---

## Internet Addressing
On the Internet you might have a Public IPv4 address like ```75.192.56.21``` or an IPv6 address like ```2000:8f40:7de8:84d1:c590:1fde:3449:efba```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```9b:e0:04:4b:7e:9c```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://stroman.net you initially access a DNS server to translate the host portion (stroman) combined with the Top Level Domain (net) of the URL, to an IP address like ```125.40.52.10```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (compatible; MSIE 9.0; AOL 9.7; AOLBuild 4343.19; Windows NT 6.1; WOW64; Trident/5.0; FunWebProducts)```
...
<pre>
default   fe80:43ed:52b4:cc6c:9298%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {239.30.189.237, 172.45.162.90}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 9b:e0:04:4b:7e:9c
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr e2:7b:ae:74:a4:1d
}</pre>
...
### Apple macOS / OSX
No matter what version of OSX/macOS you are on, ```10.13.2```, ```11.1.5```, or ```12.2.8```, there are a range of tools for troubleshooting. Unfortunately, between these manual actions and scripts, they don't give you a series of correlated values over time. This is where automated remote troubleshooting comes in to its own, especially for teams that embrace remote work and Work From Anywhere (WFA).
