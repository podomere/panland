...
layout: research
ip_v4_address: "9.148.99.73"
date: 2022-11-19T19:13:23+00:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like ```9.148.99.73``` or an IPv6 address like ```2000:5428:971c:2695:9d7b:7442:48f6:17f8```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```72:e4:24:47:57:85```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://huels-dibbert.co you initially access a DNS server to translate the host portion (huels-dibbert) combined with the Top Level Domain (co) of the URL, to an IP address like ```151.29.219.189```. Your computer and browser actually sends its type with all web requests e.g. <br>```Opera/9.80 (X11; Linux i686; Ubuntu/14.10) Presto/2.12.388 Version/12.16```
...
<pre>
default   fe80:46d6:20fa:2764:bf81%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {71.7.198.189, 2.108.69.5}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 72:e4:24:47:57:85
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 13:2d:c6:ad:bc:99
}</pre>
