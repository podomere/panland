...
layout: research
ip_v4_address: "234.219.139.236"
date: 2022-04-24T18:32:41+01:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like <code>234.219.139.236</code> or an IPv6 address like <code>2000:3404:ff1b:22b8:b8a3:96be:6f32:fbfe</code>. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>aa:d4:13:a8:c8:54</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://reilly-purdy.org you initially access a DNS server to translate the host portion (reilly-purdy) combined with the Top Level Domain (org) of the URL, to an IP address like <code>144.96.195.180</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Opera/9.80 (X11; Linux i686; Ubuntu/14.10) Presto/2.12.388 Version/12.16</code>
...
<pre><code>
default   fe80:1f1e:d682:c3bd:3b00%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {142.243.94.165, 51.87.72.124}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr aa:d4:13:a8:c8:54
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 4e:75:ef:6d:a4:b2
}</code></pre>
