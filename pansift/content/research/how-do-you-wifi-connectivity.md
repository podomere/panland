...
layout: research
ip_v4_address: "139.174.18.58"
date: 2023-10-06T17:10:30+01:00
draft: false
---

## Internet Addressing
On the Internet you might get a Public IPv4 address like ```139.174.18.58``` or an IPv6 address like ```2000:ed5b:4320:69ec:e786:ccc9:753:1300```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```36:13:88:2f:c0:88```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://mclaughlin.io you initially access a DNS server to translate the host portion (mclaughlin) combined with the Top Level Domain (io) of the URL, to an IP address like ```151.229.226.223```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1; WOW64; Trident/7.0; AS; rv:11.0) like Gecko```

## Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```10.0.18.8``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
<pre>
default   fe80:ce64:d58f:8753:4116%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {87.176.181.11, 14.26.124.43}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 36:13:88:2f:c0:88
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 30:99:0c:d6:8f:32
}</pre>
...
### Apple macOS / OSX
No matter what version of OSX/macOS you are on, ```10.13.5```, ```11.6.3```, or ```12.2.6```, there are a range of tools for troubleshooting. Unfortunately, between these manual actions and scripts, they don't give you a series of correlated values over time. This is where automated remote troubleshooting comes in to its own, especially for teams that embrace remote work and Work From Anywhere (WFA).
