...
subtitle: "Ideate?"
layout: research
ip_v4_address: "134.192.57.142"
date: 2022-04-24T18:31:58+01:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like <code>134.192.57.142</code> or an IPv6 address like <code>2000:c81c:8aab:4779:77da:4914:86df:9865</code>. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>60:c0:3d:9b:4d:a4</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://harvey-miller.io you initially access a DNS server to translate the host portion (harvey-miller) combined with the Top Level Domain (io) of the URL, to an IP address like <code>207.84.118.157</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (compatible; MSIE 9.0; AOL 9.7; AOLBuild 4343.19; Windows NT 6.1; WOW64; Trident/5.0; FunWebProducts)</code>
...
<pre><code>
default   fe80:65b5:f97b:6dd1:4a95%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {93.100.26.43, 217.78.97.167}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 60:c0:3d:9b:4d:a4
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr bc:91:9a:44:9a:9a
}</code></pre>
