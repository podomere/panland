...
subtitle: "Streamline?"
layout: research
ip_v4_address: "149.59.119.141"
date: 2022-12-15T13:50:22+00:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like ```149.59.119.141``` or an IPv6 address like ```2000:cd9c:6756:986b:19d8:fceb:d11d:3aef```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```02:68:40:f8:12:a3```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://sauer.biz you initially access a DNS server to translate the host portion (sauer) combined with the Top Level Domain (biz) of the URL, to an IP address like ```2.254.72.69```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1; WOW64; Trident/7.0; AS; rv:11.0) like Gecko```
...
<pre>
default   fe80:e043:2a2a:68df:f5cc%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {135.47.187.244, 36.127.168.55}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 02:68:40:f8:12:a3
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr cd:69:de:70:89:12
}</pre>
...
## Apple macOS / OSX
No matter what version of OSX/macOS you are on, ```10.14.1```, ```11.2.1```, or ```12.2.7```, there are a range of tools for troubleshooting. Unfortunately, between these manual actions and scripts, they don't give you a series of correlated values over time. This is where automated remote troubleshooting comes in to its own, especially for teams that embrace remote work and Work From Anywhere (WFA).
