...
subtitle: "Learnings?"
layout: research
ip_v4_address: "39.148.14.199"
date: 2022-04-24T18:59:57+01:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like <code>39.148.14.199</code> or an IPv6 address like <code>2000:6665:f18e:3dab:187e:f76:e7c:79d6</code>. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>0a:67:69:13:49:f6</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://osinski-von.co you initially access a DNS server to translate the host portion (osinski-von) combined with the Top Level Domain (co) of the URL, to an IP address like <code>53.182.7.10</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (Windows NT x.y; Win64; x64; rv:10.0) Gecko/20100101 Firefox/10.0</code>
...
<pre><code>
default   fe80:f0ba:6734:2962:4317%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {94.57.68.49, 76.158.151.195}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 0a:67:69:13:49:f6
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 3a:37:25:6d:0a:07
}</code></pre>
