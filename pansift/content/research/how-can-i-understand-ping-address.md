...
layout: research
ip_v4_address: "245.209.203.64"
date: 2022-06-04T14:38:42+01:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like ```245.209.203.64``` or an IPv6 address like ```2000:21c1:a673:f65e:3924:3349:7451:ba8e```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```2d:01:4e:82:56:dc```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://hickle-hand.com you initially access a DNS server to translate the host portion (hickle-hand) combined with the Top Level Domain (com) of the URL, to an IP address like ```81.229.119.125```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (compatible; MSIE 9.0; AOL 9.7; AOLBuild 4343.19; Windows NT 6.1; WOW64; Trident/5.0; FunWebProducts)```
...
<pre>
default   fe80:a1e3:c53c:f45c:dbd3%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {104.0.136.3, 201.122.87.51}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 2d:01:4e:82:56:dc
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr b0:56:7c:94:ff:f6
}</pre>
