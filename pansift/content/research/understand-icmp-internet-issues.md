...
layout: research
ip_v4_address: "39.85.83.178"
date: 2023-02-04T16:26:21+00:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like ```39.85.83.178``` or an IPv6 address like ```2000:128a:ce60:242f:ad0a:bc7d:5ac5:67ce```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```cf:ab:17:2e:69:ca```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://bednar-casper.io you initially access a DNS server to translate the host portion (bednar-casper) combined with the Top Level Domain (io) of the URL, to an IP address like ```76.180.161.30```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1; WOW64; Trident/7.0; AS; rv:11.0) like Gecko```
...
<pre>
default   fe80:798c:b5c1:4ba7:1ed6%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {177.40.65.248, 66.193.137.71}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr cf:ab:17:2e:69:ca
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr ab:96:77:94:aa:1d
}</pre>
