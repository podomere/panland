...
subtitle: "Synergy?"
layout: research
ip_v4_address: "53.209.82.101"
date: 2022-05-05T14:30:03+01:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like ```53.209.82.101``` or an IPv6 address like ```2000:f60:b219:4e3c:c3a0:fa7e:153:c74d```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```ef:a5:d1:94:51:7e```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://mante.info you initially access a DNS server to translate the host portion (mante) combined with the Top Level Domain (info) of the URL, to an IP address like ```12.56.153.232```. Your computer and browser actually sends its type with all web requests e.g. <br>```Opera/9.80 (X11; Linux i686; Ubuntu/14.10) Presto/2.12.388 Version/12.16```
...
<pre>
default   fe80:e32b:f4e9:bf5f:3cc9%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {204.37.220.230, 132.96.199.244}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr ef:a5:d1:94:51:7e
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr c0:2c:65:42:0c:11
}</pre>
