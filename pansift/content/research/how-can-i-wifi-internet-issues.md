...
layout: research
ip_v4_address: "11.254.215.220"
date: 2022-04-24T18:32:41+01:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like <code>11.254.215.220</code> or an IPv6 address like <code>2000:34fb:152b:35ec:905a:553f:29a9:35b9</code>. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>08:07:d5:27:5b:d3</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://hegmann-macejkovic.org you initially access a DNS server to translate the host portion (hegmann-macejkovic) combined with the Top Level Domain (org) of the URL, to an IP address like <code>170.183.168.179</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (Windows; U; Win 9x 4.90; SG; rv:1.9.2.4) Gecko/20101104 Netscape/9.1.0285</code>
...
<pre><code>
default   fe80:1eb8:9478:38f7:6223%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {182.9.27.53, 48.191.216.147}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 08:07:d5:27:5b:d3
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 10:c0:54:9a:83:35
}</code></pre>
