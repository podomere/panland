...
layout: research
ip_v4_address: "231.223.18.118"
date: 2022-11-02T11:33:10+00:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like ```231.223.18.118``` or an IPv6 address like ```2000:3169:3c5f:8bc6:b809:f6a2:2004:7d1f```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```e2:f0:24:54:33:4f```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://zieme-spencer.co you initially access a DNS server to translate the host portion (zieme-spencer) combined with the Top Level Domain (co) of the URL, to an IP address like ```59.142.77.88```. Your computer and browser actually sends its type with all web requests e.g. <br>```Opera/9.80 (X11; Linux i686; Ubuntu/14.10) Presto/2.12.388 Version/12.16```
...
<pre>
default   fe80:5817:66d1:e6cf:50c1%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {158.100.215.43, 213.207.164.197}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr e2:f0:24:54:33:4f
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 9d:7b:53:4e:8c:89
}</pre>
