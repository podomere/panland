...
subtitle: "Heads Down?"
layout: research
ip_v4_address: "223.63.165.82"
date: 2022-04-24T18:31:57+01:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like <code>223.63.165.82</code> or an IPv6 address like <code>2000:af59:42da:4d27:d717:30b3:835b:847d</code>. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>4e:84:9b:2d:62:3c</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://grady-beahan.name you initially access a DNS server to translate the host portion (grady-beahan) combined with the Top Level Domain (name) of the URL, to an IP address like <code>146.95.34.113</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (Windows NT 6.1; WOW64; Trident/7.0; AS; rv:11.0) like Gecko</code>
...
<pre><code>
default   fe80:96bd:18ca:72b8:e33d%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {25.108.234.221, 196.72.166.22}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 4e:84:9b:2d:62:3c
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 88:ca:70:1f:9e:62
}</code></pre>
