...
subtitle: "Value Add?"
layout: research
ip_v4_address: "130.106.186.69"
date: 2022-11-02T11:33:00+00:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like ```130.106.186.69``` or an IPv6 address like ```2000:ff68:86e5:d36a:a106:e54a:eabf:c874```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```e9:d0:76:de:b1:b6```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://kshlerin-sipes.info you initially access a DNS server to translate the host portion (kshlerin-sipes) combined with the Top Level Domain (info) of the URL, to an IP address like ```251.171.206.246```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows; U; Win 9x 4.90; SG; rv:1.9.2.4) Gecko/20101104 Netscape/9.1.0285```

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```172.24.105.115``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  172.24.105.115    UGScg  en0
...
<pre>
default   ac22:2de2:5d:7f5:4dee:a70a:b5ba:fdeb%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {53.56.147.100, 69.237.89.131}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr e9:d0:76:de:b1:b6
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr bb:2d:de:2e:bb:e9
}</pre>
...
## Apple macOS / OSX
No matter what version of OSX/macOS you are on, ```10.15.6```, ```11.2.3```, or ```12.0.6```, there are a range of tools for troubleshooting. Unfortunately, between these manual actions and scripts, they don't give you a series of correlated values over time. This is where automated remote troubleshooting comes in to its own, especially for teams that embrace remote work and Work From Anywhere (WFA).
