...
layout: research
ip_v4_address: "115.36.253.76"
date: 2022-12-15T13:50:10+00:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like ```115.36.253.76``` or an IPv6 address like ```2000:6efa:f8b2:f5aa:f89a:caa8:278b:e86f```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```cb:23:13:1b:90:6c```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://hyatt-hills.info you initially access a DNS server to translate the host portion (hyatt-hills) combined with the Top Level Domain (info) of the URL, to an IP address like ```118.41.204.18```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT x.y; Win64; x64; rv:10.0) Gecko/20100101 Firefox/10.0```
...
<pre>
default   fe80:836f:86f6:142d:148f%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {92.247.3.218, 25.192.253.102}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr cb:23:13:1b:90:6c
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 97:d4:cd:b1:e9:43
}</pre>
