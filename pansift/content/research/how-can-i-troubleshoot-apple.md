...
layout: research
ip_v4_address: "191.58.106.2"
date: 2022-12-15T13:50:11+00:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like ```191.58.106.2``` or an IPv6 address like ```2000:f248:5fec:855d:5489:5f61:6ca9:161```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```1c:c4:8e:57:de:8d```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://larkin-hilpert.info you initially access a DNS server to translate the host portion (larkin-hilpert) combined with the Top Level Domain (info) of the URL, to an IP address like ```129.118.53.77```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_3) AppleWebKit/537.75.14 (KHTML, like Gecko) Version/7.0.3 Safari/7046A194A```
...
<pre>
default   fe80:357b:8485:1d06:4fe2%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {106.126.192.145, 58.10.201.99}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 1c:c4:8e:57:de:8d
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 4d:1a:96:30:27:8c
}</pre>
