...
layout: research
ip_v4_address: "221.34.138.244"
date: 2022-04-24T19:00:05+01:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like <code>221.34.138.244</code> or an IPv6 address like <code>2000:5067:77b0:9bc1:b604:c0cc:ad6b:fa0</code>. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>84:3c:c1:06:b2:5f</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://harber-cartwright.info you initially access a DNS server to translate the host portion (harber-cartwright) combined with the Top Level Domain (info) of the URL, to an IP address like <code>21.98.113.222</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (Windows NT 6.1; WOW64; Trident/7.0; AS; rv:11.0) like Gecko</code>
...
default  172.26.211.122    UGScg  en0
...
<pre><code>
default   fe80:8b61:3337:7251:70e0%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {34.40.24.43, 151.221.11.46}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 84:3c:c1:06:b2:5f
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr d5:aa:f9:bb:c5:14
}</code></pre>
