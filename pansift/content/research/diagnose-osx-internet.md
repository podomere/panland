...
subtitle: "Etc. Etc.?"
layout: research
ip_v4_address: "35.87.223.62"
date: 2023-02-04T16:26:10+00:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like ```35.87.223.62``` or an IPv6 address like ```2000:bf18:1aa5:dbbf:8765:39a7:31c8:689c```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```7e:4b:51:f0:35:f3```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://brekke-prosacco.biz you initially access a DNS server to translate the host portion (brekke-prosacco) combined with the Top Level Domain (biz) of the URL, to an IP address like ```179.123.32.71```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1; WOW64; Trident/7.0; AS; rv:11.0) like Gecko```
...
<pre>
default   fe80:8595:19d9:e800:2ce1%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {43.109.247.225, 4.142.62.35}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 7e:4b:51:f0:35:f3
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr c0:ca:d3:ee:bd:48
}</pre>
