...
layout: research
ip_v4_address: "183.101.53.130"
date: 2022-11-02T11:33:12+00:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like ```183.101.53.130``` or an IPv6 address like ```2000:a761:223a:ea9b:c575:86ed:d3d6:9928```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```1d:8f:e0:81:80:0a```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://halvorson-cartwright.info you initially access a DNS server to translate the host portion (halvorson-cartwright) combined with the Top Level Domain (info) of the URL, to an IP address like ```156.182.40.186```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT x.y; Win64; x64; rv:10.0) Gecko/20100101 Firefox/10.0```
...
default  192.168.170.213    UGScg  en0
...
<pre>
default   fe80:c18c:4f2b:3a0c:369e%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {90.91.51.109, 174.70.163.195}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 1d:8f:e0:81:80:0a
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr fc:46:e7:39:1d:34
}</pre>
...
## Apple macOS / OSX
No matter what version of OSX/macOS you are on, ```10.14.4```, ```11.6.9```, or ```12.0.3```, there are a range of tools for troubleshooting. Unfortunately, between these manual actions and scripts, they don't give you a series of correlated values over time. This is where automated remote troubleshooting comes in to its own, especially for teams that embrace remote work and Work From Anywhere (WFA).
