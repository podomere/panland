...
layout: research
ip_v4_address: "253.116.223.72"
date: 2023-02-04T17:07:48+00:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like ```253.116.223.72``` or an IPv6 address like ```2000:307c:b58d:d332:64ef:6219:8450:484c```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```05:8b:13:6f:23:f4```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://quitzon-bednar.info you initially access a DNS server to translate the host portion (quitzon-bednar) combined with the Top Level Domain (info) of the URL, to an IP address like ```135.64.71.242```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT x.y; Win64; x64; rv:10.0) Gecko/20100101 Firefox/10.0```
...
<pre>
default   fe80:fce1:545e:8144:435d%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {118.139.77.137, 188.254.14.143}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 05:8b:13:6f:23:f4
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr f1:36:81:d6:e3:e1
}</pre>
