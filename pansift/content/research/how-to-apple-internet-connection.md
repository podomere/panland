...
layout: research
ip_v4_address: "122.201.208.51"
date: 2022-04-24T19:00:24+01:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like <code>122.201.208.51</code> or an IPv6 address like <code>2000:d848:c8c7:5a7d:eef6:a925:186d:104a</code>. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>ba:ad:df:12:7d:4a</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://ward-kihn.org you initially access a DNS server to translate the host portion (ward-kihn) combined with the Top Level Domain (org) of the URL, to an IP address like <code>187.187.116.209</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (Windows NT x.y; Win64; x64; rv:10.0) Gecko/20100101 Firefox/10.0</code>
...
<pre><code>
default   fe80:e86e:4657:9722:708b%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {157.141.154.199, 221.182.237.40}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr ba:ad:df:12:7d:4a
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 6c:f7:14:9d:db:e6
}</code></pre>
