...
subtitle: "Heads Down?"
layout: research
ip_v4_address: "222.202.215.154"
date: 2022-11-19T19:13:26+00:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like ```222.202.215.154``` or an IPv6 address like ```2000:e25d:fb24:5e0f:b7e5:d718:b21e:7096```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```cc:d4:b0:19:47:7c```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://bode-ziemann.net you initially access a DNS server to translate the host portion (bode-ziemann) combined with the Top Level Domain (net) of the URL, to an IP address like ```214.90.115.4```. Your computer and browser actually sends its type with all web requests e.g. <br>```Opera/9.80 (X11; Linux i686; Ubuntu/14.10) Presto/2.12.388 Version/12.16```

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```172.18.98.12``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  172.18.98.12    UGScg  en0
...
<pre>
default   fe80:8c09:303f:75ee:1636%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {172.168.148.106, 164.30.81.82}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr cc:d4:b0:19:47:7c
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 84:73:4f:01:b8:76
}</pre>
