...
layout: research
ip_v4_address: "23.62.83.135"
date: 2022-05-05T14:28:31+01:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like ```23.62.83.135``` or an IPv6 address like ```2000:7f34:f48e:4d07:b1ae:9f73:5779:fef0```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```37:ae:b5:21:bd:c8```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://grimes-toy.net you initially access a DNS server to translate the host portion (grimes-toy) combined with the Top Level Domain (net) of the URL, to an IP address like ```195.111.180.192```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT x.y; Win64; x64; rv:10.0) Gecko/20100101 Firefox/10.0```
...
<pre>
default   fe80:a264:7c80:849e:5620%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {45.63.57.173, 70.129.128.29}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 37:ae:b5:21:bd:c8
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr a5:66:11:cc:2f:54
}</pre>
