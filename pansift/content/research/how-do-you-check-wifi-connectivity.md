...
layout: research
ip_v4_address: "228.70.70.44"
date: 2022-11-19T16:17:05+00:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like ```228.70.70.44``` or an IPv6 address like ```2000:6193:c70c:7448:559c:e743:ef8b:7b7```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```b9:c9:58:cc:a0:ef```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://mcglynn-schimmel.biz you initially access a DNS server to translate the host portion (mcglynn-schimmel) combined with the Top Level Domain (biz) of the URL, to an IP address like ```181.172.108.244```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_3) AppleWebKit/537.75.14 (KHTML, like Gecko) Version/7.0.3 Safari/7046A194A```
...
<pre>
default   fe80:60ea:57b3:b728:6c7b%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {236.212.88.151, 122.223.91.140}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr b9:c9:58:cc:a0:ef
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 75:ff:99:06:dd:b9
}</pre>
