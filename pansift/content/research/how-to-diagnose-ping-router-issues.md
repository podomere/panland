...
layout: research
ip_v4_address: "115.37.225.59"
date: 2023-10-06T17:11:07+01:00
draft: false
---

## Internet Addressing
On the Internet you may get a Public IPv4 address like ```115.37.225.59``` or an IPv6 address like ```2000:d4c0:d9b8:fb92:a4c1:b6cc:8754:5c22```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```d8:4b:d2:7f:58:8c```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://hills-goodwin.org you initially access a DNS server to translate the host portion (hills-goodwin) combined with the Top Level Domain (org) of the URL, to an IP address like ```124.188.104.203```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (compatible; MSIE 9.0; AOL 9.7; AOLBuild 4343.19; Windows NT 6.1; WOW64; Trident/5.0; FunWebProducts)```
...
<pre>
default   fe80:e610:a1b:46a1:f55e%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {136.228.182.167, 199.199.68.147}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr d8:4b:d2:7f:58:8c
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr c4:b3:f1:74:85:ae
}</pre>
