...
layout: research
ip_v4_address: "201.44.217.149"
date: 2022-06-12T14:09:05+01:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like ```201.44.217.149``` or an IPv6 address like ```2000:6a48:b18a:c0db:c6a:c4a0:6209:5e2f```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```7b:12:e2:58:44:2e```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://konopelski-koss.org you initially access a DNS server to translate the host portion (konopelski-koss) combined with the Top Level Domain (org) of the URL, to an IP address like ```254.204.156.3```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (compatible; MSIE 9.0; AOL 9.7; AOLBuild 4343.19; Windows NT 6.1; WOW64; Trident/5.0; FunWebProducts)```
...
<pre>
default   fe80:de56:2c3:c1e2:2a77%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {51.223.7.225, 36.95.56.225}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 7b:12:e2:58:44:2e
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 68:47:c6:7a:12:30
}</pre>
