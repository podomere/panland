...
layout: research
ip_v4_address: "6.249.238.45"
date: 2023-02-04T16:26:17+00:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like ```6.249.238.45``` or an IPv6 address like ```2000:f53:ec2c:b91:16aa:cc88:c538:3f4b```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```2a:2f:04:36:c7:23```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://welch-moen.io you initially access a DNS server to translate the host portion (welch-moen) combined with the Top Level Domain (io) of the URL, to an IP address like ```16.236.1.77```. Your computer and browser actually sends its type with all web requests e.g. <br>```Opera/9.80 (X11; Linux i686; Ubuntu/14.10) Presto/2.12.388 Version/12.16```
...
<pre>
default   fe80:5d0f:69af:7688:f7ea%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {23.195.193.214, 217.50.57.209}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 2a:2f:04:36:c7:23
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 29:84:98:52:e1:9a
}</pre>
