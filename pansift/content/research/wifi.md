...
layout: research
ip_v4_address: "60.44.75.199"
date: 2022-04-24T18:32:41+01:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like <code>60.44.75.199</code> or an IPv6 address like <code>2000:5c3d:8727:1f0a:c239:7d0e:5b72:ba52</code>. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>e2:57:80:91:1c:b8</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://king-schuppe.co you initially access a DNS server to translate the host portion (king-schuppe) combined with the Top Level Domain (co) of the URL, to an IP address like <code>235.78.111.173</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (Windows NT 6.1; WOW64; Trident/7.0; AS; rv:11.0) like Gecko</code>
...
default  172.26.80.74    UGScg  en0
...
<pre><code>
default   fe80:b965:f0f:9cbb:2542%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {94.71.96.72, 249.80.139.254}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr e2:57:80:91:1c:b8
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 0d:e0:cf:f2:29:46
}</code></pre>
