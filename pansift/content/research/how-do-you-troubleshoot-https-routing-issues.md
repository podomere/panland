---
title: "How Do You Troubleshoot Https Routing Issues"
subtitle: "Out Of The Box?"
layout: research
ip_v4_address: "116.253.179.155"
date: 2022-11-19T19:13:29+00:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like ```116.253.179.155``` or an IPv6 address like ```2000:8d59:252a:521:2f57:cc14:4eb2:38c7```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```44:d9:28:cc:f5:3d```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://daugherty-stracke.org you initially access a DNS server to translate the host portion (daugherty-stracke) combined with the Top Level Domain (org) of the URL, to an IP address like ```120.154.243.14```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/41.0.2228.0 Safari/537.36```

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```192.168.72.26``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  192.168.72.26    UGScg  en0
...
<pre>
default   fe80:5234:647:4a18:a56a%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {24.252.234.206, 251.48.189.86}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 44:d9:28:cc:f5:3d
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 67:83:4d:19:fd:d4
}</pre>
