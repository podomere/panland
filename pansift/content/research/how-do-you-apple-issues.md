...
layout: research
ip_v4_address: "91.70.131.154"
date: 2022-04-24T19:00:25+01:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like <code>91.70.131.154</code> or an IPv6 address like <code>2000:a6fe:ac35:3332:e9ec:af93:3f2f:d2a0</code>. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>6d:dc:5c:6c:31:c6</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://leannon-mayer.io you initially access a DNS server to translate the host portion (leannon-mayer) combined with the Top Level Domain (io) of the URL, to an IP address like <code>121.238.138.177</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (Windows; U; Win 9x 4.90; SG; rv:1.9.2.4) Gecko/20101104 Netscape/9.1.0285</code>
...
<pre><code>
default   fe80:1c27:33fb:fe2d:4459%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {233.159.50.173, 56.170.214.37}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 6d:dc:5c:6c:31:c6
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 14:52:87:18:57:0e
}</code></pre>
