...
layout: research
ip_v4_address: "13.137.66.33"
date: 2022-11-19T16:17:12+00:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like ```13.137.66.33``` or an IPv6 address like ```2000:1ea4:f852:7741:bcb9:6c44:ce00:9c17```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```e0:df:2c:89:96:fa```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://runte-haley.org you initially access a DNS server to translate the host portion (runte-haley) combined with the Top Level Domain (org) of the URL, to an IP address like ```70.35.234.31```. Your computer and browser actually sends its type with all web requests e.g. <br>```Opera/9.80 (X11; Linux i686; Ubuntu/14.10) Presto/2.12.388 Version/12.16```

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```192.168.60.144``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  192.168.60.144    UGScg  en0
...
<pre>
default   fe80:e5dd:bbd5:38d7:401a%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {195.176.180.173, 161.221.69.200}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr e0:df:2c:89:96:fa
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 8b:7c:f8:9d:ff:06
}</pre>
