...
layout: research
ip_v4_address: "73.65.183.10"
date: 2022-04-24T18:59:57+01:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like <code>73.65.183.10</code> or an IPv6 address like <code>2000:6404:2de8:8aae:21c:d150:39a2:f79e</code>. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>f3:85:40:f3:8b:0f</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://koch-klein.biz you initially access a DNS server to translate the host portion (koch-klein) combined with the Top Level Domain (biz) of the URL, to an IP address like <code>71.249.148.172</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (Windows NT 6.1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/41.0.2228.0 Safari/537.36</code>
...
<pre><code>
default   fe80:8d0:99d0:5efd:1976%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {138.254.237.101, 72.165.112.123}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr f3:85:40:f3:8b:0f
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 36:bb:30:e6:e2:aa
}</code></pre>
