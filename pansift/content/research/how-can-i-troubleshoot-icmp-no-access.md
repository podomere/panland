...
layout: research
ip_v4_address: "9.214.169.77"
date: 2023-10-06T17:11:06+01:00
draft: false
---

## Internet Addressing
On the Internet you may have a Public IPv4 address like ```9.214.169.77``` or an IPv6 address like ```2000:21b9:a007:d1c4:c33d:6ce4:2d0c:5155```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```ca:07:86:e5:3c:a0```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://kerluke.info you initially access a DNS server to translate the host portion (kerluke) combined with the Top Level Domain (info) of the URL, to an IP address like ```249.106.243.28```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT x.y; Win64; x64; rv:10.0) Gecko/20100101 Firefox/10.0```
...
<pre>
default   fe80:bbfe:d669:c9e5:fa65%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {95.107.171.244, 112.147.196.238}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr ca:07:86:e5:3c:a0
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr cc:d4:b2:cd:60:e8
}</pre>
