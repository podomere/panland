...
layout: research
ip_v4_address: "164.205.42.17"
date: 2022-06-12T14:09:26+01:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like ```164.205.42.17``` or an IPv6 address like ```2000:9c56:2273:c45a:83c0:1974:acba:2932```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```09:f2:6e:04:b8:f7```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://hammes-stiedemann.co you initially access a DNS server to translate the host portion (hammes-stiedemann) combined with the Top Level Domain (co) of the URL, to an IP address like ```166.48.240.64```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/41.0.2228.0 Safari/537.36```
...
<pre>
default   fe80:3db6:659b:451d:71a8%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {85.164.22.235, 154.208.156.238}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 09:f2:6e:04:b8:f7
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr bc:0a:01:b6:cb:9f
}</pre>
