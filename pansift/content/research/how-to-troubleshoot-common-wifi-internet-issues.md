...
layout: research
ip_v4_address: "168.90.244.158"
date: 2023-02-04T16:26:03+00:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like ```168.90.244.158``` or an IPv6 address like ```2000:21ca:3e36:3362:dea2:8212:f196:6d8b```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```97:c0:ed:b4:67:5d```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://hermiston-quigley.info you initially access a DNS server to translate the host portion (hermiston-quigley) combined with the Top Level Domain (info) of the URL, to an IP address like ```18.76.177.133```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1; WOW64; Trident/7.0; AS; rv:11.0) like Gecko```
...
<pre>
default   fe80:4aa4:3cac:805e:4fd9%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {86.163.93.150, 121.9.0.218}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 97:c0:ed:b4:67:5d
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 03:72:65:95:e0:47
}</pre>
