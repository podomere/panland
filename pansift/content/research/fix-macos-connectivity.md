...
subtitle: "Heads Down?"
layout: research
ip_v4_address: "26.47.188.48"
date: 2022-11-02T11:33:10+00:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like ```26.47.188.48``` or an IPv6 address like ```2000:a49f:7ecf:5320:71e1:bddc:441c:ba16```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```29:d9:55:43:30:85```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://kling-ratke.co you initially access a DNS server to translate the host portion (kling-ratke) combined with the Top Level Domain (co) of the URL, to an IP address like ```78.252.56.77```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (compatible; MSIE 9.0; AOL 9.7; AOLBuild 4343.19; Windows NT 6.1; WOW64; Trident/5.0; FunWebProducts)```
...
<pre>
default   fe80:904e:b9c9:c412:aa7e%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {3.79.233.214, 205.221.100.59}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 29:d9:55:43:30:85
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 84:02:04:8a:7a:3c
}</pre>
