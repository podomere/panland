...
layout: research
ip_v4_address: "120.202.224.213"
date: 2023-10-06T17:11:04+01:00
draft: false
---

## Internet Addressing
On the Internet you might have a Public IPv4 address like ```120.202.224.213``` or an IPv6 address like ```2000:c843:4126:914a:2f2:b1dd:38f8:6cb0```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```4b:a6:6d:91:17:8f```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://lueilwitz-reynolds.org you initially access a DNS server to translate the host portion (lueilwitz-reynolds) combined with the Top Level Domain (org) of the URL, to an IP address like ```107.196.54.180```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/41.0.2228.0 Safari/537.36```
...
<pre>
default   fe80:eaf4:3546:6111:6a4b%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {35.254.62.142, 15.230.219.254}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 4b:a6:6d:91:17:8f
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr a7:7e:02:08:1a:ce
}</pre>
