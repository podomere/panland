...
subtitle: "Etc. Etc.?"
layout: research
ip_v4_address: "140.52.96.91"
date: 2022-06-04T14:38:37+01:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like ```140.52.96.91``` or an IPv6 address like ```2000:2744:9544:86de:2c00:b7b4:650e:fdf9```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```a8:86:96:b5:cb:ab```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://ritchie-orn.name you initially access a DNS server to translate the host portion (ritchie-orn) combined with the Top Level Domain (name) of the URL, to an IP address like ```221.178.160.125```. Your computer and browser actually sends its type with all web requests e.g. <br>```Opera/9.80 (X11; Linux i686; Ubuntu/14.10) Presto/2.12.388 Version/12.16```
...
<pre>
default   fe80:8efb:7bb3:80af:cefb%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {92.181.115.203, 31.149.10.119}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr a8:86:96:b5:cb:ab
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 85:17:7b:76:49:7f
}</pre>
