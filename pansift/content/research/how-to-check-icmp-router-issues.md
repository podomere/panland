...
layout: research
ip_v4_address: "205.5.2.205"
date: 2023-02-04T17:08:38+00:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like ```205.5.2.205``` or an IPv6 address like ```2000:ebf7:54d0:9d78:e678:c58f:c14d:4c51```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```ef:e8:f0:24:3b:f6```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://williamson-mertz.name you initially access a DNS server to translate the host portion (williamson-mertz) combined with the Top Level Domain (name) of the URL, to an IP address like ```110.85.29.181```. Your computer and browser actually sends its type with all web requests e.g. <br>```Opera/9.80 (X11; Linux i686; Ubuntu/14.10) Presto/2.12.388 Version/12.16```
...
<pre>
default   fe80:fce1:3d89:64cf:1f86%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {168.247.205.250, 162.242.155.105}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr ef:e8:f0:24:3b:f6
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr dc:ed:b9:e6:87:0d
}</pre>
