...
layout: research
ip_v4_address: "246.148.164.75"
date: 2023-10-29T15:13:18+00:00
draft: false
---

## Internet Addressing
On the Internet you may get a Public IPv4 address like ```246.148.164.75``` or an IPv6 address like ```2000:ac50:a5dd:8667:7897:edc7:95c1:6cbd```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```6f:80:fd:dd:97:f8```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://prosacco-daugherty.org you initially access a DNS server to translate the host portion (prosacco-daugherty) combined with the Top Level Domain (org) of the URL, to an IP address like ```9.239.153.31```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/41.0.2228.0 Safari/537.36```
...
<pre>
default   fe80:a45c:124:f7ab:c818%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {211.142.240.50, 129.121.106.13}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 6f:80:fd:dd:97:f8
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 50:4b:ed:42:d6:28
}</pre>
