...
layout: research
ip_v4_address: "134.72.113.209"
date: 2023-02-04T17:08:34+00:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like ```134.72.113.209``` or an IPv6 address like ```2000:f961:20df:1be7:dc47:2be2:5fb4:c9a2```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```25:b1:ac:02:f7:7b```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://dare-rodriguez.com you initially access a DNS server to translate the host portion (dare-rodriguez) combined with the Top Level Domain (com) of the URL, to an IP address like ```127.168.178.205```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (compatible; MSIE 9.0; AOL 9.7; AOLBuild 4343.19; Windows NT 6.1; WOW64; Trident/5.0; FunWebProducts)```
...
<pre>
default   fe80:b7f1:b36f:77fe:8b88%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {127.226.58.197, 114.64.145.38}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 25:b1:ac:02:f7:7b
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr bb:19:b1:df:2c:25
}</pre>
