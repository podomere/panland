...
subtitle: "Ideate?"
layout: research
ip_v4_address: "61.79.221.251"
date: 2022-11-02T11:33:10+00:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like ```61.79.221.251``` or an IPv6 address like ```2000:7ac2:b533:64fe:db2f:ffc5:e936:7345```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```0e:c9:be:d3:04:5a```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://reinger-rath.com you initially access a DNS server to translate the host portion (reinger-rath) combined with the Top Level Domain (com) of the URL, to an IP address like ```158.225.25.78```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT x.y; Win64; x64; rv:10.0) Gecko/20100101 Firefox/10.0```

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```172.16.146.62``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  172.16.146.62    UGScg  en0
...
<pre>
default   fe80:b49f:77cb:bd22:61be%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {240.212.230.29, 114.137.222.23}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 0e:c9:be:d3:04:5a
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr c7:89:0c:2c:57:06
}</pre>
