...
layout: research
ip_v4_address: "21.20.184.165"
date: 2022-11-19T19:13:15+00:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like ```21.20.184.165``` or an IPv6 address like ```2000:cdcd:79f5:4a7c:b5d5:9777:d578:8cbf```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```2f:1f:1d:88:40:84```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://murazik-johnson.org you initially access a DNS server to translate the host portion (murazik-johnson) combined with the Top Level Domain (org) of the URL, to an IP address like ```131.14.20.182```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows; U; Win 9x 4.90; SG; rv:1.9.2.4) Gecko/20101104 Netscape/9.1.0285```
...
<pre>
default   fe80:a53c:1cd8:bef7:cdd%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {227.177.182.236, 89.139.248.10}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 2f:1f:1d:88:40:84
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 5b:9d:8e:ce:96:1b
}</pre>
