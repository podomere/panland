...
subtitle: "Value Add?"
layout: research
ip_v4_address: "250.236.34.108"
date: 2023-10-06T17:11:04+01:00
draft: false
---

## Internet Addressing
On the Internet you might have a Public IPv4 address like ```250.236.34.108``` or an IPv6 address like ```2000:c2bd:bd72:f3b5:b29f:8899:3d98:ca24```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```66:b9:45:2b:c4:ba```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://bogan.biz you initially access a DNS server to translate the host portion (bogan) combined with the Top Level Domain (biz) of the URL, to an IP address like ```103.177.239.28```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT x.y; Win64; x64; rv:10.0) Gecko/20100101 Firefox/10.0```

## Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```10.20.168.173``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  10.20.168.173    UGScg  en0
...
<pre>
default   fe80:324c:b1a3:6743:a2fb%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {65.140.252.4, 98.148.220.25}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 66:b9:45:2b:c4:ba
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 4b:5d:e2:22:af:08
}</pre>
