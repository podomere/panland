...
layout: research
ip_v4_address: "243.88.220.17"
date: 2022-06-12T14:09:29+01:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like ```243.88.220.17``` or an IPv6 address like ```2000:530f:993a:ce4f:c3e8:72a9:db21:ebec```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```43:92:0e:9e:aa:9d```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://larson.net you initially access a DNS server to translate the host portion (larson) combined with the Top Level Domain (net) of the URL, to an IP address like ```60.196.148.237```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (compatible; MSIE 9.0; AOL 9.7; AOLBuild 4343.19; Windows NT 6.1; WOW64; Trident/5.0; FunWebProducts)```
...
<pre>
default   fe80:c462:a9f3:2b4c:f606%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {42.45.138.11, 97.5.161.191}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 43:92:0e:9e:aa:9d
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 2e:97:c6:21:2f:7d
}</pre>
...
## Apple macOS / OSX
No matter what version of OSX/macOS you are on, ```10.13.5```, ```11.6.3```, or ```12.3.7```, there are a range of tools for troubleshooting. Unfortunately, between these manual actions and scripts, they don't give you a series of correlated values over time. This is where automated remote troubleshooting comes in to its own, especially for teams that embrace remote work and Work From Anywhere (WFA).
