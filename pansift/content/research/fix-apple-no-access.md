...
layout: research
ip_v4_address: "116.23.252.125"
date: 2022-11-19T19:13:17+00:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like ```116.23.252.125``` or an IPv6 address like ```2000:c6c1:ab27:2e43:d388:e160:bee3:8fd```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```25:f7:8c:ba:66:96```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://wisoky-heller.biz you initially access a DNS server to translate the host portion (wisoky-heller) combined with the Top Level Domain (biz) of the URL, to an IP address like ```182.60.40.176```. Your computer and browser actually sends its type with all web requests e.g. <br>```Opera/9.80 (X11; Linux i686; Ubuntu/14.10) Presto/2.12.388 Version/12.16```
...
<pre>
default   fe80:b8f8:be1b:5758:8c96%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {232.185.54.150, 149.112.34.60}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 25:f7:8c:ba:66:96
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 81:a5:8f:4d:47:31
}</pre>
