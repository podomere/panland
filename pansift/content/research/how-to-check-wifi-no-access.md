...
layout: research
ip_v4_address: "60.42.158.117"
date: 2022-11-02T11:32:23+00:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like ```60.42.158.117``` or an IPv6 address like ```2000:ecb:a884:4b7a:9025:674e:ceb1:15f5```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```17:73:3a:b1:5d:0a```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://gusikowski.io you initially access a DNS server to translate the host portion (gusikowski) combined with the Top Level Domain (io) of the URL, to an IP address like ```204.162.61.152```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_3) AppleWebKit/537.75.14 (KHTML, like Gecko) Version/7.0.3 Safari/7046A194A```
...
default  192.168.170.103    UGScg  en0
...
<pre>
default   fe80:48a6:535a:a7bf:fdc3%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {23.127.52.159, 31.218.79.7}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 17:73:3a:b1:5d:0a
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 75:1b:db:1e:3c:4d
}</pre>
...
## Apple macOS / OSX
No matter what version of OSX/macOS you are on, ```10.12.6```, ```11.6.3```, or ```12.1.3```, there are a range of tools for troubleshooting. Unfortunately, between these manual actions and scripts, they don't give you a series of correlated values over time. This is where automated remote troubleshooting comes in to its own, especially for teams that embrace remote work and Work From Anywhere (WFA).
