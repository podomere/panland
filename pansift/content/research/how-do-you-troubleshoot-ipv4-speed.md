...
subtitle: "Granular?"
layout: research
ip_v4_address: "59.156.38.106"
date: 2022-04-24T18:59:57+01:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like <code>59.156.38.106</code> or an IPv6 address like <code>2000:88f5:6adb:3fc5:f417:faf8:df66:c925</code>. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>9b:04:c8:94:70:cb</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://hand.net you initially access a DNS server to translate the host portion (hand) combined with the Top Level Domain (net) of the URL, to an IP address like <code>79.137.108.142</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (Windows NT x.y; Win64; x64; rv:10.0) Gecko/20100101 Firefox/10.0</code>
...
<pre><code>
default   fe80:23e5:dc6b:e85a:c1b9%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {181.110.159.85, 105.247.55.188}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 9b:04:c8:94:70:cb
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr de:24:1b:a9:c3:3a
}</code></pre>
