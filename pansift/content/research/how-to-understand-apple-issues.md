...
layout: research
ip_v4_address: "63.236.57.168"
date: 2022-06-12T14:09:16+01:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like ```63.236.57.168``` or an IPv6 address like ```2000:38e8:70b:a797:5377:2046:bd63:9790```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```28:1c:3c:1b:a7:8d```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://mckenzie-leannon.org you initially access a DNS server to translate the host portion (mckenzie-leannon) combined with the Top Level Domain (org) of the URL, to an IP address like ```86.50.21.57```. Your computer and browser actually sends its type with all web requests e.g. <br>```Opera/9.80 (X11; Linux i686; Ubuntu/14.10) Presto/2.12.388 Version/12.16```
...
<pre>
default   fe80:a43:424c:231d:3fb4%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {186.137.53.19, 138.118.162.155}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 28:1c:3c:1b:a7:8d
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 32:9b:f0:10:92:1a
}</pre>
