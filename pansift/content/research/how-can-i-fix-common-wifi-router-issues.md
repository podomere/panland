...
layout: research
ip_v4_address: "212.127.8.240"
date: 2023-10-29T15:13:12+00:00
draft: false
---

## Internet Addressing
On the Internet you may get a Public IPv4 address like ```212.127.8.240``` or an IPv6 address like ```2000:7906:3f13:26c5:d323:aca8:1cff:57cd```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```02:73:ec:c4:c5:ac```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://reichert.io you initially access a DNS server to translate the host portion (reichert) combined with the Top Level Domain (io) of the URL, to an IP address like ```173.18.239.71```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/41.0.2228.0 Safari/537.36```

## Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```10.34.235.133``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  10.34.235.133    UGScg  en0
...
<pre>
default   fe80:aa97:4bc0:ae8c:8b8d%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {176.214.63.213, 231.116.202.222}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 02:73:ec:c4:c5:ac
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 59:33:f4:ea:48:27
}</pre>
