...
layout: research
ip_v4_address: "178.160.137.227"
date: 2022-06-04T14:38:17+01:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like ```178.160.137.227``` or an IPv6 address like ```2000:2ff2:652a:5b86:16e9:71f4:ceb2:7dfc```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```9d:bf:31:3b:ce:0a```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://macgyver-wiza.com you initially access a DNS server to translate the host portion (macgyver-wiza) combined with the Top Level Domain (com) of the URL, to an IP address like ```14.100.68.23```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_3) AppleWebKit/537.75.14 (KHTML, like Gecko) Version/7.0.3 Safari/7046A194A```
...
<pre>
default   fe80:b6b:4ffa:c8a0:4cec%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {155.223.37.122, 193.89.166.240}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 9d:bf:31:3b:ce:0a
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 47:d2:c9:91:11:c2
}</pre>
