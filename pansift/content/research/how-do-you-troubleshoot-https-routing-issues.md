...
layout: research
ip_v4_address: "11.77.155.200"
date: 2022-06-12T14:09:29+01:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like ```11.77.155.200``` or an IPv6 address like ```2000:6f2:970:3807:e710:aada:d25a:3013```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```e0:5d:7a:08:a4:d7```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://labadie-price.name you initially access a DNS server to translate the host portion (labadie-price) combined with the Top Level Domain (name) of the URL, to an IP address like ```82.191.160.3```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (compatible; MSIE 9.0; AOL 9.7; AOLBuild 4343.19; Windows NT 6.1; WOW64; Trident/5.0; FunWebProducts)```
...
<pre>
default   fe80:c75d:d536:e911:31af%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {154.3.92.169, 121.71.229.236}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr e0:5d:7a:08:a4:d7
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr a4:59:0a:43:62:e8
}</pre>
