...
subtitle: "Synergy?"
layout: research
ip_v4_address: "233.45.46.230"
date: 2023-10-06T17:11:08+01:00
draft: false
---

## Internet Addressing
On the Internet you may get a Public IPv4 address like ```233.45.46.230``` or an IPv6 address like ```2000:ca22:c2c8:c7fb:553c:127c:ea5d:1dfe```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```10:3c:c9:c4:34:39```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://oberbrunner.io you initially access a DNS server to translate the host portion (oberbrunner) combined with the Top Level Domain (io) of the URL, to an IP address like ```209.128.233.214```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT x.y; Win64; x64; rv:10.0) Gecko/20100101 Firefox/10.0```
...
<pre>
default   fe80:a797:9b49:6df1:2c30%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {167.84.61.153, 18.32.196.145}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 10:3c:c9:c4:34:39
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 04:d1:d0:8e:8e:b2
}</pre>
...
### Apple macOS / OSX
No matter what version of OSX/macOS you are on, ```10.12.6```, ```11.4.9```, or ```12.2.3```, there are a range of tools for troubleshooting. Unfortunately, between these manual actions and scripts, they don't give you a series of correlated values over time. This is where automated remote troubleshooting comes in to its own, especially for teams that embrace remote work and Work From Anywhere (WFA).
