...
layout: research
ip_v4_address: "116.140.134.162"
date: 2022-11-19T19:13:26+00:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like ```116.140.134.162``` or an IPv6 address like ```2000:6369:abcc:4176:1515:70fc:568a:9e73```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```56:0d:f0:7a:eb:30```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://farrell.com you initially access a DNS server to translate the host portion (farrell) combined with the Top Level Domain (com) of the URL, to an IP address like ```135.213.237.9```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT x.y; Win64; x64; rv:10.0) Gecko/20100101 Firefox/10.0```

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```10.189.215.14``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  10.189.215.14    UGScg  en0
...
<pre>
default   fe80:5bb6:3ba3:e900:3a3a%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {222.108.162.193, 206.67.117.160}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 56:0d:f0:7a:eb:30
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 27:18:03:18:24:0d
}</pre>
