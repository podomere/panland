...
subtitle: "Granular?"
layout: research
ip_v4_address: "143.187.133.222"
date: 2023-10-29T15:13:24+00:00
draft: false
---

## Internet Addressing
On the Internet you may have a Public IPv4 address like ```143.187.133.222``` or an IPv6 address like ```2000:9228:2f92:5d58:264c:3fc:2c12:fae5```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```c2:91:70:ce:0b:87```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://damore-batz.name you initially access a DNS server to translate the host portion (damore-batz) combined with the Top Level Domain (name) of the URL, to an IP address like ```196.152.176.143```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows; U; Win 9x 4.90; SG; rv:1.9.2.4) Gecko/20101104 Netscape/9.1.0285```
...
<pre>
default   fe80:4eea:2baf:c01f:e2ae%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {116.119.143.87, 227.235.238.38}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr c2:91:70:ce:0b:87
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 61:27:3f:75:c7:4b
}</pre>
