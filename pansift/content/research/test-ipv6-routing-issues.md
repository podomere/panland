...
layout: research
ip_v4_address: "18.25.244.188"
date: 2023-10-29T15:13:24+00:00
draft: false
---

## Internet Addressing
On the Internet you may have a Public IPv4 address like ```18.25.244.188``` or an IPv6 address like ```2000:3707:37e:a551:edd7:9f26:a2c0:92e0```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```a8:ce:d4:2c:a1:0c```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://bartoletti.io you initially access a DNS server to translate the host portion (bartoletti) combined with the Top Level Domain (io) of the URL, to an IP address like ```156.47.137.43```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/41.0.2228.0 Safari/537.36```
...
<pre>
default   fe80:c6bc:5f89:87b7:59e8%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {20.147.160.16, 135.81.85.239}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr a8:ce:d4:2c:a1:0c
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 7d:75:69:50:56:f5
}</pre>
