...
subtitle: "Swim Lane?"
layout: research
ip_v4_address: "224.174.217.17"
date: 2022-11-02T11:32:53+00:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like ```224.174.217.17``` or an IPv6 address like ```2000:a9d:d3f4:5162:5077:279c:6d1f:6756```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```23:ce:96:94:0e:6d```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://cronin.net you initially access a DNS server to translate the host portion (cronin) combined with the Top Level Domain (net) of the URL, to an IP address like ```11.37.168.207```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT x.y; Win64; x64; rv:10.0) Gecko/20100101 Firefox/10.0```
...
<pre>
default   fe80:c6b0:78a8:b89e:71d5%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {183.143.146.131, 192.30.96.248}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 23:ce:96:94:0e:6d
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr fb:4b:5b:8a:4c:35
}</pre>
