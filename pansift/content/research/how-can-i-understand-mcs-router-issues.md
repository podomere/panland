...
layout: research
ip_v4_address: "128.41.153.80"
date: 2022-04-24T18:32:42+01:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like <code>128.41.153.80</code> or an IPv6 address like <code>92:2659:1c90:1e1f:39d5:afa4:4a2f:c92</code>. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>3e:70:b9:6f:c8:db</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://barrows-carroll.biz you initially access a DNS server to translate the host portion (barrows-carroll) combined with the Top Level Domain (biz) of the URL, to an IP address like <code>61.238.81.232</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Opera/9.80 (X11; Linux i686; Ubuntu/14.10) Presto/2.12.388 Version/12.16</code>

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like <code>10.201.203.144</code> (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For <code>IPv6</code> we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  10.201.203.144    UGScg  en0
...
<pre><code>
default   fe80:904a:a559:e388:ed7e%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {87.168.76.129, 141.170.176.68}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 3e:70:b9:6f:c8:db
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 68:a1:42:45:ca:64
}</code></pre>
