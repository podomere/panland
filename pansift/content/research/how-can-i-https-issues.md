...
layout: research
ip_v4_address: "203.58.51.152"
date: 2022-11-19T19:13:29+00:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like ```203.58.51.152``` or an IPv6 address like ```2000:de48:1d87:5866:863b:c326:db7:788f```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```a8:d7:6e:5d:5c:05```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://deckow.org you initially access a DNS server to translate the host portion (deckow) combined with the Top Level Domain (org) of the URL, to an IP address like ```192.72.229.143```. Your computer and browser actually sends its type with all web requests e.g. <br>```Opera/9.80 (X11; Linux i686; Ubuntu/14.10) Presto/2.12.388 Version/12.16```
...
<pre>
default   fe80:d20e:3164:307b:768e%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {91.70.148.138, 223.74.53.147}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr a8:d7:6e:5d:5c:05
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 9c:2f:7e:8d:ca:5e
}</pre>
