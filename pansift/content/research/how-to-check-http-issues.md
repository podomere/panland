...
subtitle: "Streamline?"
layout: research
ip_v4_address: "203.155.212.97"
date: 2022-11-02T11:33:00+00:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like ```203.155.212.97``` or an IPv6 address like ```2000:71e0:e99a:12bf:6519:5261:e46b:e9d1```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```8d:03:0a:ff:83:49```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://haag-corkery.biz you initially access a DNS server to translate the host portion (haag-corkery) combined with the Top Level Domain (biz) of the URL, to an IP address like ```211.221.60.127```. Your computer and browser actually sends its type with all web requests e.g. <br>```Opera/9.80 (X11; Linux i686; Ubuntu/14.10) Presto/2.12.388 Version/12.16```
...
<pre>
default   fe80:2984:3029:7b7:c9e7%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {120.182.15.130, 148.162.87.121}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 8d:03:0a:ff:83:49
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 2d:fe:76:de:7a:86
}</pre>
