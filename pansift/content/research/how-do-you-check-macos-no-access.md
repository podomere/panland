...
layout: research
ip_v4_address: "3.104.213.151"
date: 2023-02-04T16:26:10+00:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like ```3.104.213.151``` or an IPv6 address like ```2000:706e:5816:f5a2:de6f:f092:6d43:3e95```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```fd:6d:33:55:c4:e9```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://frami-damore.com you initially access a DNS server to translate the host portion (frami-damore) combined with the Top Level Domain (com) of the URL, to an IP address like ```27.133.29.65```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1; WOW64; Trident/7.0; AS; rv:11.0) like Gecko```
...
<pre>
default   fe80:5f56:46a6:c4ff:7782%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {74.1.87.166, 15.152.81.44}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr fd:6d:33:55:c4:e9
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr a4:e0:0f:51:ce:4f
}</pre>
