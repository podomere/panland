...
subtitle: "Ideate?"
layout: research
ip_v4_address: "215.234.17.30"
date: 2023-10-06T17:10:31+01:00
draft: false
---

## Internet Addressing
On the Internet you may get a Public IPv4 address like ```215.234.17.30``` or an IPv6 address like ```2000:35c8:e3ec:e913:98cd:994a:95e6:bd62```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```6b:af:a0:28:3d:39```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://greenfelder.co you initially access a DNS server to translate the host portion (greenfelder) combined with the Top Level Domain (co) of the URL, to an IP address like ```188.158.70.88```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows; U; Win 9x 4.90; SG; rv:1.9.2.4) Gecko/20101104 Netscape/9.1.0285```

## Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```172.29.120.28``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  172.29.120.28    UGScg  en0
...
<pre>
default   fe80:6d1c:93ed:a97d:7d23%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {126.206.176.129, 238.121.138.40}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 6b:af:a0:28:3d:39
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr c0:3f:d1:6c:77:40
}</pre>
...
### Apple macOS / OSX
No matter what version of OSX/macOS you are on, ```10.15.8```, ```11.5.2```, or ```12.3.5```, there are a range of tools for troubleshooting. Unfortunately, between these manual actions and scripts, they don't give you a series of correlated values over time. This is where automated remote troubleshooting comes in to its own, especially for teams that embrace remote work and Work From Anywhere (WFA).
