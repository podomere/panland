...
layout: research
ip_v4_address: "35.187.208.247"
date: 2022-04-24T18:59:55+01:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like <code>35.187.208.247</code> or an IPv6 address like <code>2000:75ba:7da6:fa0f:c866:2409:a8e7:4d4</code>. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>8f:aa:2f:a6:05:65</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://johnson.info you initially access a DNS server to translate the host portion (johnson) combined with the Top Level Domain (info) of the URL, to an IP address like <code>176.175.152.187</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (Windows NT 6.1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/41.0.2228.0 Safari/537.36</code>

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like <code>10.196.174.241</code> (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For <code>IPv6</code> we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  10.196.174.241    UGScg  en0
...
<pre><code>
default   fe80:fd95:14dc:a945:12ed%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {37.202.24.254, 251.156.20.123}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 8f:aa:2f:a6:05:65
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 94:f4:02:a3:48:2c
}</code></pre>
