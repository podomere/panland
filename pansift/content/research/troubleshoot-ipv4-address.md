...
subtitle: "Value Add?"
layout: research
ip_v4_address: "161.63.143.86"
date: 2022-06-12T14:09:24+01:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like ```161.63.143.86``` or an IPv6 address like ```2000:e267:21d6:10ac:bfd3:7a31:4ef3:ba10```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```07:76:33:3e:bd:32```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://hand-schmidt.info you initially access a DNS server to translate the host portion (hand-schmidt) combined with the Top Level Domain (info) of the URL, to an IP address like ```118.86.108.108```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1; WOW64; Trident/7.0; AS; rv:11.0) like Gecko```
...
<pre>
default   fe80:57ff:93b4:b909:5d8b%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {9.93.3.170, 215.25.141.1}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 07:76:33:3e:bd:32
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 36:bb:74:e1:12:f5
}</pre>
