...
layout: research
ip_v4_address: "205.103.82.206"
date: 2022-11-19T16:17:24+00:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like ```205.103.82.206``` or an IPv6 address like ```2000:67aa:5456:fb3d:4aa4:7ed8:55f6:3ee1```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```88:49:9f:b8:e2:a2```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://ullrich-schamberger.org you initially access a DNS server to translate the host portion (ullrich-schamberger) combined with the Top Level Domain (org) of the URL, to an IP address like ```63.164.30.148```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows; U; Win 9x 4.90; SG; rv:1.9.2.4) Gecko/20101104 Netscape/9.1.0285```

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```10.195.146.30``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  10.195.146.30    UGScg  en0
...
<pre>
default   fe80:ee8d:10ec:5ca1:d070%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {247.177.174.133, 97.226.243.99}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 88:49:9f:b8:e2:a2
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 8e:44:13:ba:02:70
}</pre>
...
## Apple macOS / OSX
No matter what version of OSX/macOS you are on, ```10.15.7```, ```11.2.1```, or ```12.0.9```, there are a range of tools for troubleshooting. Unfortunately, between these manual actions and scripts, they don't give you a series of correlated values over time. This is where automated remote troubleshooting comes in to its own, especially for teams that embrace remote work and Work From Anywhere (WFA).
