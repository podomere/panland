...
subtitle: "Granular?"
layout: research
ip_v4_address: "194.248.36.225"
date: 2022-04-24T19:00:02+01:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like <code>194.248.36.225</code> or an IPv6 address like <code>2000:48a0:c8f4:86f:d21d:d77c:747d:7466</code>. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>0c:72:23:d5:33:d2</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://heller-kessler.com you initially access a DNS server to translate the host portion (heller-kessler) combined with the Top Level Domain (com) of the URL, to an IP address like <code>4.151.62.108</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (Windows; U; Win 9x 4.90; SG; rv:1.9.2.4) Gecko/20101104 Netscape/9.1.0285</code>
...
<pre><code>
default   fe80:c583:a707:8664:1942%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {100.224.106.252, 249.219.43.90}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 0c:72:23:d5:33:d2
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 0b:87:8a:12:f7:0f
}</code></pre>
