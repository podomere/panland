---
title: "How Can I Troubleshoot Icmp Router Issues"
subtitle: "Granular?"
layout: research
ip_v4_address: "19.254.0.139"
date: 2023-02-04T17:08:38+00:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like ```19.254.0.139``` or an IPv6 address like ```2000:fd4b:34df:b0f:c8eb:c33a:9ce8:f808```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```1f:c1:75:f8:88:eb```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://reinger-gleason.org you initially access a DNS server to translate the host portion (reinger-gleason) combined with the Top Level Domain (org) of the URL, to an IP address like ```68.202.85.145```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (compatible; MSIE 9.0; AOL 9.7; AOLBuild 4343.19; Windows NT 6.1; WOW64; Trident/5.0; FunWebProducts)```

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```10.189.223.213``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  10.189.223.213    UGScg  en0
...
<pre>
default   fe80:39e0:857:ce7c:c0ac%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {41.221.208.42, 17.81.43.16}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 1f:c1:75:f8:88:eb
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr c7:4d:ae:59:67:07
}</pre>
...
## Apple macOS / OSX
No matter what version of OSX/macOS you are on, ```10.13.2```, ```11.6.3```, or ```12.0.3```, there are a range of tools for troubleshooting. Unfortunately, between these manual actions and scripts, they don't give you a series of correlated values over time. This is where automated remote troubleshooting comes in to its own, especially for teams that embrace remote work and Work From Anywhere (WFA).
