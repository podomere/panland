...
layout: research
ip_v4_address: "44.12.252.42"
date: 2023-10-29T15:13:18+00:00
draft: false
---

## Internet Addressing
On the Internet you might get a Public IPv4 address like ```44.12.252.42``` or an IPv6 address like ```2000:654d:907:21b3:eaba:c7be:dea4:3363```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```89:6d:fe:ca:d7:e6```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://mayert-keebler.name you initially access a DNS server to translate the host portion (mayert-keebler) combined with the Top Level Domain (name) of the URL, to an IP address like ```64.101.22.134```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/41.0.2228.0 Safari/537.36```
...
<pre>
default   fe80:55:9cef:549c:90af%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {237.226.186.19, 77.255.159.81}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 89:6d:fe:ca:d7:e6
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr a3:12:d1:46:0c:4f
}</pre>
