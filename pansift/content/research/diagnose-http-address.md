...
layout: research
ip_v4_address: "110.20.126.211"
date: 2022-11-19T19:13:28+00:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like ```110.20.126.211``` or an IPv6 address like ```2000:5c3a:6c22:6e3e:9798:4d3d:af98:b712```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```0f:a7:1e:da:ec:be```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://jerde.com you initially access a DNS server to translate the host portion (jerde) combined with the Top Level Domain (com) of the URL, to an IP address like ```221.40.214.6```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows; U; Win 9x 4.90; SG; rv:1.9.2.4) Gecko/20101104 Netscape/9.1.0285```
...
<pre>
default   fe80:f79d:315e:a87a:c621%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {176.54.115.19, 87.29.35.28}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 0f:a7:1e:da:ec:be
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 8b:76:16:db:a2:cf
}</pre>
