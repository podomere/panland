...
subtitle: "Heads Down?"
layout: research
ip_v4_address: "97.65.183.193"
date: 2022-04-24T18:31:57+01:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like <code>97.65.183.193</code> or an IPv6 address like <code>2000:b52:b8e1:b8c6:e628:5258:2086:6479</code>. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>8a:2a:d7:09:fd:a1</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://quitzon-gislason.name you initially access a DNS server to translate the host portion (quitzon-gislason) combined with the Top Level Domain (name) of the URL, to an IP address like <code>207.106.55.255</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (Windows NT x.y; Win64; x64; rv:10.0) Gecko/20100101 Firefox/10.0</code>
...
<pre><code>
default   fe80:1ef0:d8a5:c461:cf8f%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {72.179.91.182, 142.160.128.19}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 8a:2a:d7:09:fd:a1
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 15:45:37:d4:57:8a
}</code></pre>
