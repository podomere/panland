...
layout: research
ip_v4_address: "96.168.100.105"
date: 2022-05-05T14:28:45+01:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like ```96.168.100.105``` or an IPv6 address like ```2000:ed35:4396:15b5:6b4a:2f15:f18f:2e95```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```a5:60:14:39:99:59```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://rutherford-kerluke.co you initially access a DNS server to translate the host portion (rutherford-kerluke) combined with the Top Level Domain (co) of the URL, to an IP address like ```144.142.33.202```. Your computer and browser actually sends its type with all web requests e.g. <br>```Opera/9.80 (X11; Linux i686; Ubuntu/14.10) Presto/2.12.388 Version/12.16```
...
<pre>
default   fe80:c720:186b:fc64:ebac%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {254.42.170.189, 65.199.29.148}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr a5:60:14:39:99:59
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr ba:94:a2:30:10:59
}</pre>
