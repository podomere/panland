...
layout: research
ip_v4_address: "47.51.199.134"
date: 2022-06-04T14:38:43+01:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like ```47.51.199.134``` or an IPv6 address like ```2000:2145:9391:c05:8172:effd:e3c1:7a77```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```db:89:b3:1b:73:13```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://barton-dickinson.net you initially access a DNS server to translate the host portion (barton-dickinson) combined with the Top Level Domain (net) of the URL, to an IP address like ```128.240.61.70```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_3) AppleWebKit/537.75.14 (KHTML, like Gecko) Version/7.0.3 Safari/7046A194A```
...
<pre>
default   7fd7:90b7:2a5c:82:a103:83f:9695:e6d3%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {88.21.200.89, 66.102.170.242}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr db:89:b3:1b:73:13
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr b0:2b:8b:cc:ed:7d
}</pre>
