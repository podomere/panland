...
layout: research
ip_v4_address: "3.182.4.103"
date: 2022-06-04T14:38:43+01:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like ```3.182.4.103``` or an IPv6 address like ```2000:3956:f67d:8784:67c7:bf8c:8b7d:45be```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```8d:0a:94:39:58:9a```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://wisozk-lueilwitz.com you initially access a DNS server to translate the host portion (wisozk-lueilwitz) combined with the Top Level Domain (com) of the URL, to an IP address like ```143.250.168.80```. Your computer and browser actually sends its type with all web requests e.g. <br>```Opera/9.80 (X11; Linux i686; Ubuntu/14.10) Presto/2.12.388 Version/12.16```
...
<pre>
default   656c:ac70:35:2466:b430:9577:a039:c09b%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {54.137.200.160, 109.242.20.211}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 8d:0a:94:39:58:9a
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 42:15:2d:10:bf:8c
}</pre>
