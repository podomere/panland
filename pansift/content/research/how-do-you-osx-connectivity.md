---
title: "How Do You OSX Connectivity"
subtitle: "Two-way Street?"
layout: research
ip_v4_address: "2.139.105.183"
date: 2023-10-06T17:10:42+01:00
draft: false
---

## Internet Addressing
On the Internet you might get a Public IPv4 address like ```2.139.105.183``` or an IPv6 address like ```2000:9bd3:d4cc:fbc8:3160:ffa5:df9d:d482```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```0a:52:a6:b3:44:3f```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://cummings.biz you initially access a DNS server to translate the host portion (cummings) combined with the Top Level Domain (biz) of the URL, to an IP address like ```227.83.144.61```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/41.0.2228.0 Safari/537.36```

## Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```192.168.221.88``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  192.168.221.88    UGScg  en0
...
<pre>
default   fe80:5c97:26af:8e9e:3e3c%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {162.206.148.121, 104.145.2.171}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 0a:52:a6:b3:44:3f
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr a9:d1:66:e0:7d:5c
}</pre>
...
### Apple macOS / OSX
No matter what version of OSX/macOS you are on, ```10.11.1```, ```11.1.5```, or ```12.0.6```, there are a range of tools for troubleshooting. Unfortunately, between these manual actions and scripts, they don't give you a series of correlated values over time. This is where automated remote troubleshooting comes in to its own, especially for teams that embrace remote work and Work From Anywhere (WFA).
