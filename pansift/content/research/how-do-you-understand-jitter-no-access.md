...
layout: research
ip_v4_address: "155.110.82.17"
date: 2022-11-19T16:17:22+00:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like ```155.110.82.17``` or an IPv6 address like ```2000:ca46:e9e:a700:36ab:e98d:871:45aa```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```a7:b6:a2:95:e3:c5```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://schowalter-gulgowski.io you initially access a DNS server to translate the host portion (schowalter-gulgowski) combined with the Top Level Domain (io) of the URL, to an IP address like ```10.34.176.116```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows; U; Win 9x 4.90; SG; rv:1.9.2.4) Gecko/20101104 Netscape/9.1.0285```
...
<pre>
default   fe80:e6fb:eb8a:2896:e3cc%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {116.67.236.161, 27.74.56.184}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr a7:b6:a2:95:e3:c5
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr d3:ca:ac:d8:7f:98
}</pre>
