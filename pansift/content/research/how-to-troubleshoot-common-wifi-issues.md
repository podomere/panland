...
subtitle: "Impact Map?"
layout: research
ip_v4_address: "224.40.216.169"
date: 2022-06-12T14:09:05+01:00
draft: false
---

# Internet Addressing
On the Internet you may get a Public IPv4 address like ```224.40.216.169``` or an IPv6 address like ```2000:2c09:fd7d:420a:77e0:49ac:cb2f:e643```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```84:36:ab:0e:c0:be```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://kuvalis-rath.name you initially access a DNS server to translate the host portion (kuvalis-rath) combined with the Top Level Domain (name) of the URL, to an IP address like ```226.246.158.47```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (compatible; MSIE 9.0; AOL 9.7; AOLBuild 4343.19; Windows NT 6.1; WOW64; Trident/5.0; FunWebProducts)```
...
<pre>
default   fe80:25ec:1660:3192:d4ed%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {157.174.0.193, 179.38.23.172}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 84:36:ab:0e:c0:be
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 10:3f:31:06:6c:b4
}</pre>
