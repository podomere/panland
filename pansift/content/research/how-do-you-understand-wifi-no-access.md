...
layout: research
ip_v4_address: "71.3.167.130"
date: 2023-10-06T17:10:30+01:00
draft: false
---

## Internet Addressing
On the Internet you may get a Public IPv4 address like ```71.3.167.130``` or an IPv6 address like ```2000:2141:1aa6:c1db:66da:d84a:8c7c:aee3```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```0f:4b:3f:15:80:20```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://orn.name you initially access a DNS server to translate the host portion (orn) combined with the Top Level Domain (name) of the URL, to an IP address like ```91.80.247.21```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_3) AppleWebKit/537.75.14 (KHTML, like Gecko) Version/7.0.3 Safari/7046A194A```
...
<pre>
default   fe80:11f7:9fb7:5edd:dcab%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {107.48.174.147, 33.102.118.184}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 0f:4b:3f:15:80:20
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 59:7f:e6:06:80:d5
}</pre>
