...
subtitle: "Deep Dive?"
layout: research
ip_v4_address: "183.227.113.177"
date: 2022-06-04T14:38:41+01:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like ```183.227.113.177``` or an IPv6 address like ```2000:443c:4d53:2d24:e93:6023:d54c:15c```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```20:a1:83:6b:4f:78```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://schimmel-hintz.name you initially access a DNS server to translate the host portion (schimmel-hintz) combined with the Top Level Domain (name) of the URL, to an IP address like ```17.235.67.139```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows; U; Win 9x 4.90; SG; rv:1.9.2.4) Gecko/20101104 Netscape/9.1.0285```
...
<pre>
default   fe80:1c7c:45ef:bb6c:e81e%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {30.147.246.209, 138.58.15.163}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 20:a1:83:6b:4f:78
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 8c:d4:aa:3d:5d:b4
}</pre>
