...
layout: research
ip_v4_address: "97.44.18.1"
date: 2022-11-02T11:32:57+00:00
draft: false
---

# Internet Addressing
On the Internet you might get a Public IPv4 address like ```97.44.18.1``` or an IPv6 address like ```2000:2e39:e5ba:558a:22d6:6a79:148d:1a25```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```6f:65:da:0e:15:cb```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://goodwin.co you initially access a DNS server to translate the host portion (goodwin) combined with the Top Level Domain (co) of the URL, to an IP address like ```197.148.242.89```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (compatible; MSIE 9.0; AOL 9.7; AOLBuild 4343.19; Windows NT 6.1; WOW64; Trident/5.0; FunWebProducts)```
...
<pre>
default   fe80:11aa:4ac7:5017:5a9c%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {167.114.195.4, 193.223.83.98}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 6f:65:da:0e:15:cb
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 97:20:a3:21:7d:9b
}</pre>
