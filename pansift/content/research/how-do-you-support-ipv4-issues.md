...
layout: research
ip_v4_address: "203.220.5.76"
date: 2023-10-29T15:13:26+00:00
draft: false
---

## Internet Addressing
On the Internet you might have a Public IPv4 address like ```203.220.5.76``` or an IPv6 address like ```2000:8370:3431:f21f:2450:df7d:88a6:ab7f```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```c3:81:82:e7:d4:c3```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://frami.com you initially access a DNS server to translate the host portion (frami) combined with the Top Level Domain (com) of the URL, to an IP address like ```117.248.125.153```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT x.y; Win64; x64; rv:10.0) Gecko/20100101 Firefox/10.0```

## Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like ```172.22.177.223``` (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For ```IPv6``` we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  172.22.177.223    UGScg  en0
...
<pre>
default   fe80:b50b:3a6c:f559:8630%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {42.45.14.125, 11.135.15.7}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr c3:81:82:e7:d4:c3
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr f2:e5:3f:aa:64:e0
}</pre>
...
### Apple macOS / OSX
No matter what version of OSX/macOS you are on, ```10.14.8```, ```11.4.6```, or ```12.2.7```, there are a range of tools for troubleshooting. Unfortunately, between these manual actions and scripts, they don't give you a series of correlated values over time. This is where automated remote troubleshooting comes in to its own, especially for teams that embrace remote work and Work From Anywhere (WFA).
