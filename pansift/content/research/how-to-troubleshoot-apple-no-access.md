...
layout: research
ip_v4_address: "166.73.130.19"
date: 2022-05-05T14:28:52+01:00
draft: false
---

# Internet Addressing
On the Internet you might have a Public IPv4 address like ```166.73.130.19``` or an IPv6 address like ```2000:2408:e0e5:ecca:56f1:d72a:bdb6:89d5```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```a3:4c:fc:3f:1d:0b```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://ernser-damore.biz you initially access a DNS server to translate the host portion (ernser-damore) combined with the Top Level Domain (biz) of the URL, to an IP address like ```53.67.71.141```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT 6.1; WOW64; Trident/7.0; AS; rv:11.0) like Gecko```
...
<pre>
default   fe80:101d:7919:e9cc:4dce%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {117.113.23.150, 244.68.113.100}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr a3:4c:fc:3f:1d:0b
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 5b:e3:85:80:2e:98
}</pre>
