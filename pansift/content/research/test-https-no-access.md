...
layout: research
ip_v4_address: "173.46.8.231"
date: 2022-04-24T19:00:05+01:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like <code>173.46.8.231</code> or an IPv6 address like <code>2000:804c:4d58:d793:d9cd:de59:e168:fab8</code>. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like <code>d4:8f:3c:e8:03:48</code>, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://kris-hayes.info you initially access a DNS server to translate the host portion (kris-hayes) combined with the Top Level Domain (info) of the URL, to an IP address like <code>216.139.172.115</code>. Your computer and browser actually sends its type with all web requests e.g. <br><code>Mozilla/5.0 (Windows; U; Win 9x 4.90; SG; rv:1.9.2.4) Gecko/20101104 Netscape/9.1.0285</code>

# Default Gateways
Your default gateway is normally an automatically configured address via DHCP. You get a default gateway like <code>192.168.153.218</code> (though they normally end in .1 or .254 depending upon the scope size) and this is where your computer sends all its traffic to be routed onwards. For <code>IPv6</code> we have a deep dive on [how-to-fix-ipv6-connectivity/](/blog/how-to-fix-ipv6-connectivity/) but you can check on Mac or Linux with:
...
default  192.168.153.218    UGScg  en0
...
<pre><code>
default   9961:d02b:4637:2:7e59:80d9:7388:c800%en0  UGcg   en0
...
<pre><code>
...
domain_name_server (ip_mult): {77.203.226.53, 145.140.74.170}
end (none):
...</code></pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr d4:8f:3c:e8:03:48
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr c3:d1:56:a0:f8:58
}</code></pre>
