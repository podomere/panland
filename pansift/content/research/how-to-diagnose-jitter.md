...
subtitle: "Branding?"
layout: research
ip_v4_address: "144.57.241.85"
date: 2023-02-04T16:26:20+00:00
draft: false
---

# Internet Addressing
On the Internet you may have a Public IPv4 address like ```144.57.241.85``` or an IPv6 address like ```2000:e332:2df3:d0c4:96a9:3251:c836:3c8b```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```0e:d3:ed:34:c9:98```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

# Accessing the Web
To get to a web page like https://schumm.biz you initially access a DNS server to translate the host portion (schumm) combined with the Top Level Domain (biz) of the URL, to an IP address like ```244.253.67.208```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (compatible; MSIE 9.0; AOL 9.7; AOLBuild 4343.19; Windows NT 6.1; WOW64; Trident/5.0; FunWebProducts)```
...
<pre>
default   fe80:fcc8:9867:97fb:f7f7%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {45.150.99.246, 98.150.136.249}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr 0e:d3:ed:34:c9:98
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 61:c6:23:da:7c:7c
}</pre>
