...
subtitle: "Etc. Etc.?"
layout: research
ip_v4_address: "159.242.92.21"
date: 2023-10-29T15:13:30+00:00
draft: false
---

## Internet Addressing
On the Internet you may get a Public IPv4 address like ```159.242.92.21``` or an IPv6 address like ```2000:9536:364:8289:8254:d378:3dac:923```. We can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```f9:c9:51:4d:f5:29```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://armstrong-konopelski.info you initially access a DNS server to translate the host portion (armstrong-konopelski) combined with the Top Level Domain (info) of the URL, to an IP address like ```40.229.101.119```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_3) AppleWebKit/537.75.14 (KHTML, like Gecko) Version/7.0.3 Safari/7046A194A```
...
<pre>
default   fe80:d92d:c7e1:57e3:8330%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {208.11.66.229, 94.210.175.242}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr f9:c9:51:4d:f5:29
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 87:bc:ed:76:db:26
}</pre>
