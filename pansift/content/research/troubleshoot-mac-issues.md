...
layout: research
ip_v4_address: "182.106.1.225"
date: 2023-10-06T17:10:43+01:00
draft: false
---

## Internet Addressing
On the Internet you may get a Public IPv4 address like ```182.106.1.225``` or an IPv6 address like ```2000:de5e:3d74:2945:bb72:ef53:20a4:cebf```. You can check this from [https://test-ipv6.com/](https://test-ipv6.com/). Yet, for 'non-techies' to try and communicate these addresses, or even call out MAC addresses like ```b1:35:ea:41:12:4a```, it can be error prone and gets complicated quickly. Additionally, this doesn't give you any historical data (especially back when previous problems occured).

## Accessing the Web
To get to a web page like https://tromp-leannon.biz you initially access a DNS server to translate the host portion (tromp-leannon) combined with the Top Level Domain (biz) of the URL, to an IP address like ```199.207.89.131```. Your computer and browser actually sends its type with all web requests e.g. <br>```Mozilla/5.0 (Windows NT x.y; Win64; x64; rv:10.0) Gecko/20100101 Firefox/10.0```
...
<pre>
default   fe80:e4e5:f2b8:4f0a:f329%en0  UGcg   en0
...
<pre>
...
domain_name_server (ip_mult): {121.189.220.202, 19.143.145.15}
end (none):
...</pre>
...
Options[4] = {
  CLIENTID (1) Length 14: DUID LLT HW 1 Time 668691856 Addr b1:35:ea:41:12:4a
  DNS_SERVERS (23) Length 32: 2606:4700:4700::1111, 2001:4860:4860::8844
  DOMAIN_LIST (24) Length 0:  Invalid
  SERVERID (2) Length 10: DUID LL HW 1 Addr 62:7f:53:39:05:5c
}</pre>
